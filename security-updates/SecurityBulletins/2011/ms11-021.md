...
**已知问题。** [Microsoft 知识库文章 2489279](http://support.microsoft.com/kb/2489279) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
是。 Microsoft Excel 2003 Service Pack 3 (KB2502786) 和 Microsoft Excel 2007 Service Pack 2 (KB2464583) 的更新以及 [MS11-023](http://go.microsoft.com/fwlink/?linkid=210206) 中提供的更新可为 Office 文件验证功能提供支持。 有关 Office 文件验证功能的详细信息，请参阅 [Microsoft 安全通报 2501584](http://technet.microsoft.com/security/advisory/2501584)。
...
本公告中提供的 Microsoft Office 2004 for Mac (KB2505924)、Microsoft Office 2008 for Mac (KB2505927) 和 Open XML File Format Converter for Mac (KB2505935) 安全更新程序包也可解决 [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727) 和 [MS11-023](http://go.microsoft.com/fwlink/?linkid=210206) 安全公告中介绍的漏洞。 本公告中提供的 Microsoft Office for Mac 2011 (KB2525412) 安全更新程序包也可解决 [MS11-022](http://go.microsoft.com/fwlink/?linkid=210727) 中介绍的漏洞。安装了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac、Open XML File Format Converter for Mac 或 Microsoft Office for Mac 2011 的用户只需安装这些安全更新程序包一次。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0097](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0098](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0101](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0103](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0104](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0105](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0978](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0979](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0980](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2466169">Microsoft 知识库文章 2466169</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2502786">Microsoft 知识库文章 2502786</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2007，请参阅 <a href="http://support.microsoft.com/kb/2464583">Microsoft 知识库文章 2464583</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Excel Viewer，请参阅 <a href="http://support.microsoft.com/kb/2466158">Microsoft 知识库文章 2466158</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">有关 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包，请参阅 <a href="http://support.microsoft.com/kb/2466156">Microsoft 知识库文章 2466156</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2466146">Microsoft 知识库文章 2466146</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Secunia Research](http://secunia.com/) 的 Alin Rad Pop 报告了 Excel 整数溢出漏洞 (CVE-2011-0097)  
-   [Secunia Research](http://secunia.com/) 的 Alin Rad Pop 报告了 Excel 堆溢出漏洞 (CVE-2011-0098)  
-   [Telus Security Labs](http://www.telussecuritylabs.com) 的 Muhammad Junaid Bohio 报告了 Excel 记录分析 WriteAV 漏洞 (CVE-2011-0101)  
-   Aniway 与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Excel 记录分析 WriteAV 漏洞 (CVE-2011-0101)  
-   一位匿名研究人员与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 Excel 内存损坏漏洞 (CVE-2011-0103)  
-   [Check Point Vulnerability Discovery Team](http://www.checkpoint.com/) (VDT) 的 Rodrigo Rubira Branco 报告了 Excel 缓冲区覆盖漏洞 (CVE-2011-0104)  
-   Aniway 与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Excel 数据初始化漏洞 (CVE-2011-0105)  
-   Aniway 与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Excel 数组索引漏洞 (CVE-2011-0978)  
-   一位匿名研究员与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Excel 链接列表损坏漏洞 (CVE-2011-0979)  
-   一位匿名研究员与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Excel 无关联指针漏洞 (CVE-2011-0980)

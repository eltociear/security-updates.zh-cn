---
TOCTitle: 'MS11-021'
Title: 'Microsoft 安全公告 MS11-021 - 重要'
ms:assetid: 'ms11-021'
ms:contentKeyID: 61238159
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-021(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-021 - 重要
==================================

Microsoft Excel 中的漏洞可能允许远程执行代码 (2489279)
------------------------------------------------------
...
该更新通过更正 Microsoft Excel 管理数据结构、验证记录信息、初始化内存操作中使用的变量以及在分析特制文件时分配缓冲空间的分析来解决漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
**已知问题。** [Microsoft 知识库文章 2489279](https://support.microsoft.com/kb/2489279) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
是。 Microsoft Excel 2003 Service Pack 3 (KB2502786) 和 Microsoft Excel 2007 Service Pack 2 (KB2464583) 的更新以及 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206) 中提供的更新可为 Office 文件验证功能提供支持。 有关 Office 文件验证功能的详细信息，请参阅 [Microsoft 安全通报 2501584](https://technet.microsoft.com/security/advisory/2501584)。
...
**MS11-022** **和** **MS11-023** **也介绍了** **Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac** **和** **Open XML File Format Converter for Mac** **中的漏洞。** **MS11-022** **也介绍了** **Microsoft Office for Mac 2011** **中的漏洞。MS11-022** **和** **MS11-023** **与此公告** **MS11-021** **有什么联系？**  
本公告中提供的 Microsoft Office 2004 for Mac (KB2505924)、Microsoft Office 2008 for Mac (KB2505927) 和 Open XML File Format Converter for Mac (KB2505935) 安全更新程序包也可解决 [MS11-022](https://go.microsoft.com/fwlink/?linkid=210727) 和 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206) 安全公告中介绍的漏洞。 本公告中提供的 Microsoft Office for Mac 2011 (KB2525412) 安全更新程序包也可解决 [MS11-022](https://go.microsoft.com/fwlink/?linkid=210727) 中介绍的漏洞。安装了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac、Open XML File Format Converter for Mac 或 Microsoft Office for Mac 2011 的用户只需安装这些安全更新程序包一次。
...
<th>
Excel 整数溢出漏洞 - CVE-2011-0097
</th>
<th>
Excel 堆溢出漏洞 - CVE-2011-0098
</th>
<th>
Excel 记录分析 WriteAV 漏洞 - CVE-2011-0101
</th>
<th>
Excel 内存损坏漏洞 - CVE-2011-0103
</th>
<th>
Excel 缓冲区覆盖漏洞 - CVE-2011-0104
</th>
<th>
</th>
<th>
...
<th>
Excel 数据初始化漏洞 - CVE-2011-0105
</th>
<th>
Excel 数组索引漏洞 - CVE-2011-0978
</th>
<th>
Excel 链接列表损坏漏洞 - CVE-2011-0979
</th>
<th>
Excel 无关联指针漏洞 - CVE-2011-0980
</th>
<th>
综合严重等级
</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0097](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0097)。

#### Excel 整数溢出漏洞 (CVE-2011-0097) 的缓解因素
...
#### Excel 整数溢出漏洞 (CVE-2011-0097) 的变通办法
...
<p> </p>
  ...
  **如何撤消变通方法。** 根据下表  **变通办法的影响。** 由指示，运行命令以禁用 MOICE。
...
#### Excel 整数溢出漏洞 (CVE-2011-0097) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
如果 Microsoft Excel 在分析特制 Excel 文件中的记录信息时未正确地分配缓冲空间，则存在该漏洞。
...
**此更新有什么作用？**  
该更新通过更正 Microsoft Excel 在分析特制文件时分配缓冲空间的方式来解决漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0098](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0098)。

#### Excel 堆溢出漏洞 (CVE-2011-0098) 的缓解因素
...
#### Excel 堆溢出漏洞 (CVE-2011-0098) 的变通办法
...
#### Excel 堆溢出漏洞 (CVE-2011-0098) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
如果 Microsoft Excel 在分析特制的 Excel 文件时验证记录信息期间遇到内存处理错误，以一种攻击者可以执行任意代码的方式来破坏系统内存，则会导致该漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0101](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0101)。

#### Excel 记录分析 WriteAV 漏洞 (CVE-2011-0101) 的缓解因素
...
#### Excel 记录分析 WriteAV 漏洞 (CVE-2011-0101) 的变通办法
...
#### Excel 记录分析 WriteAV 漏洞 (CVE-2011-0101) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0103](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0103)。

#### Excel 内存损坏漏洞 (CVE-2011-0103) 的缓解因素
...
#### Excel 内存损坏漏洞 (CVE-2011-0103) 的变通办法
...
#### Excel 内存损坏漏洞 (CVE-2011-0103) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0104](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0104)。

#### Excel 缓冲区覆盖漏洞 (CVE-2011-0104) 的缓解因素
...
#### Excel 缓冲区覆盖漏洞 (CVE-2011-0104) 的变通办法
...
#### Excel 缓冲区覆盖漏洞 (CVE-2011-0104) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0105](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0105)。

#### Excel 数据初始化漏洞 (CVE-2011-0105) 的缓解因素
...
#### Excel 数据初始化漏洞 (CVE-2011-0105) 的变通办法
...
#### Excel 数据初始化漏洞 (CVE-2011-0105) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
如果 Microsoft Excel 在分析特制的 Excel 文件时未正确初始化用作 memcpy 操作长度的变量，则会导致该漏洞。 可以利用此情形引起缓冲区溢出，从而导致在登录用户的安全上下文下执行代码。
...
**此更新有什么作用？**  
该更新通过更正 Microsoft Excel 初始化内存操作中使用的变量的方式来解决漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0978](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0978)。

#### Excel 数组索引漏洞 (CVE-2011-0978) 的缓解因素
...
#### Excel 数组索引漏洞 (CVE-2011-0978) 的变通办法
...
#### Excel 数组索引漏洞 (CVE-2011-0978) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0979](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0979)。

#### Excel 链接列表损坏漏洞 (CVE-2011-0979) 的缓解因素
...
#### Excel 链接列表损坏漏洞 (CVE-2011-0979) 的变通办法
...
-   **使用** **Microsoft Office** **文件阻止策略在** **Microsoft Excel** **中禁止打开来自未知或不可信来源和位置的** **Office 2003** **以及更早版本的文档**
    ...
    **变通办法的影响。** 对于 Microsoft Office 2003 和 Microsoft Office 2007，配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](https://support.microsoft.com/kb/922848) 所述配置特殊例外目录或将文件移动到可信位置的用户将无法打开 Office 2003 文件或更早版本。 对于 Microsoft Office 2010、Office 2003 文件或更早版本，将阻止打开或在受保护的模式中打开 RTF 文件，具体取决于所选择的打开行为。
...
#### Excel 链接列表损坏漏洞 (CVE-2011-0979) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
如果 Microsoft Excel 在分析特制的 Excel 文件时未正确管理数据结构的成员，则会导致该漏洞。
...
**此更新有什么作用？**  
该更新通过更正 Microsoft Excel 管理数据结构的方式来解决漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0980](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0980)。

#### Excel 无关联指针漏洞 (CVE-2011-0980) 的缓解因素
...
#### Excel 无关联指针漏洞 (CVE-2011-0980) 的变通办法
...
-   **不要打开从不受信任来源或从受信任来源意外收到的** **Office文件**

    不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 无关联指针漏洞 (CVE-2011-0980) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
如果 Microsoft Excel 在分析特制的 Excel 文件时未正确管理数据结构，则会导致该漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2466169">Microsoft 知识库文章 2466169</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2502786">Microsoft 知识库文章 2502786</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2007，请参阅 <a href="https://support.microsoft.com/kb/2464583">Microsoft 知识库文章 2464583</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Excel Viewer，请参阅 <a href="https://support.microsoft.com/kb/2466158">Microsoft 知识库文章 2466158</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">有关 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包，请参阅 <a href="https://support.microsoft.com/kb/2466156">Microsoft 知识库文章 2466156</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2466146">Microsoft 知识库文章 2466146</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Secunia Research](https://secunia.com/) 的 Alin Rad Pop 报告了 Excel 整数溢出漏洞 (CVE-2011-0097)  
-   [Secunia Research](https://secunia.com/) 的 Alin Rad Pop 报告了 Excel 堆溢出漏洞 (CVE-2011-0098)  
-   [Telus Security Labs](https://www.telussecuritylabs.com) 的 Muhammad Junaid Bohio 报告了 Excel 记录分析 WriteAV 漏洞 (CVE-2011-0101)  
-   Aniway 与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Excel 记录分析 WriteAV 漏洞 (CVE-2011-0101)  
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel 内存损坏漏洞 (CVE-2011-0103)  
-   [Check Point Vulnerability Discovery Team](https://www.checkpoint.com/) (VDT) 的 Rodrigo Rubira Branco 报告了 Excel 缓冲区覆盖漏洞 (CVE-2011-0104)  
-   Aniway 与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Excel 数据初始化漏洞 (CVE-2011-0105)  
-   Aniway 与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Excel 数组索引漏洞 (CVE-2011-0978)  
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Excel 链接列表损坏漏洞 (CVE-2011-0979)  
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Excel 无关联指针漏洞 (CVE-2011-0980)

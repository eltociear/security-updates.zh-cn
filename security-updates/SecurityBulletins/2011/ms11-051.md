...
**已知问题。** [Microsoft 知识库文章 2518295](http://support.microsoft.com/kb/2518295) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
是的，Microsoft 建议编辑了其 Web 注册 ASP 页面的客户应该访问 [Microsoft 知识库文章 2518295](http://support.microsoft.com/kb/2518295) 以获取有关可能适用于其系统的已知问题的重要信息。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1264)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2518295">Microsoft 知识库文章 2518295</a></td>
</tr>  
<tr class="even">
...
-   Ruggero Strabla、[Emaze Networks](http://www.emaze.net/)、[Saipem Security Team](http://www.saipem.com/) 报告了 Active Directory 证书服务漏洞 (CVE-2011-1264)

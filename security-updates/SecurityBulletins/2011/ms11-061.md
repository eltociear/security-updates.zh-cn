...
**已知问题。** [Microsoft 知识库文章 2546250](http://support.microsoft.com/kb/2546250) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
是的，Microsoft 建议编辑了其 Web 注册 ASP 页面的客户应该访问 [Microsoft 知识库文章2546250](http://support.microsoft.com/kb/2546250) 以获取有关可能适用于其系统的已知问题的重要信息。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1263](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1263)。
...
**什么是远程桌面 Web 访问？**    
远程桌面 Web 访问（RD Web 访问）是远程桌面服务角色中的一个角色服务，使您能够使用 Web 浏览器向用户提供 RemoteApp 程序、虚拟桌面和基于会话的桌面。 此外，RD Web 访问使用户能够从 Web 浏览器连接到他们具有合适访问权限的任何服务器或客户端计算机的远程桌面。 有关详细信息，请参阅 TechNet 文章[远程桌面 Web 访问](http://technet.microsoft.com/en-us/library/ff608245(ws.10).aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2546250">Microsoft 知识库文章 2546250</a></td>
</tr>  
<tr class="odd">

---
TOCTitle: 'MS11-061'
Title: 'Microsoft 安全公告 MS11-061 - 重要'
ms:assetid: 'ms11-061'
ms:contentKeyID: 61238199
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-061(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-061 - 重要
==================================

远程桌面 Web 访问中的漏洞可能允许特权提升 (2546250)
---------------------------------------------------
...
对于 Windows Server 2008 R2 所有受支持的版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过更正远程桌面 Web 访问的登录页面验证输入参数的方式来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。** [Microsoft 知识库文章 2546250](https://support.microsoft.com/kb/2546250) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=777f3bbe-094c-411d-879d-34a5a20ae7f3)\*\* | 特权提升     | 重要         | 无               |
...
**我已经自定义了我的 Web 注册 ASP 页面。 我是否需要关注 Microsoft 知识库文章 2546250 中列出的已知问题？**  
是的，Microsoft 建议编辑了其 Web 注册 ASP 页面的客户应该访问 [Microsoft 知识库文章2546250](https://support.microsoft.com/kb/2546250) 以获取有关可能适用于其系统的已知问题的重要信息。
...
<tr class="header">
<th>受影响的软件</th>
<th>远程桌面 Web 访问漏洞 - CVE-2011-1263</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
远程桌面 Web 访问漏洞 - CVE-2011-1263  
-------------------------------------
  
<span></span>  
远程桌面 Web 访问中存在一个已反映的 XSS 漏洞，该漏洞可能允许攻击者在 Internet Explorer 的用户实例中注入客户端脚本。 此脚本可能欺骗内容、泄露信息或执行用户可以在远程桌面 Web 访问网站上执行的任何操作。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1263](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1263)。
  
#### 远程桌面 Web 访问漏洞 (CVE-2011-1263) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   当浏览到 Internet 区域中的远程桌面 Web 访问服务器时，Internet Explorer 8 和 Internet Explorer 9 中的 XSS 筛选器可针对其用户阻止此攻击。 默认情况下，Internet Explorer 8 和 Internet Explorer 9 中的 XSS 筛选器在 Intranet 区域中未启用。  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。  
-   默认情况下不安装远程桌面 Web 访问。 您必须在希望用户通过 Web 连接到的服务器上安装远程桌面 Web 访问角色服务才能访问 RemoteApp 程序。 当安装远程桌面 Web 访问时，也会将 Microsoft Internet Information Services (IIS) 安装为必需组件。
  
#### 远程桌面 Web 访问漏洞 (CVE-2011-1263) 的变通办法
...
#### 远程桌面 Web 访问漏洞 (CVE-2011-1263) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个可能允许特权提升的已反映的 XSS 漏洞。
  
**造成此漏洞的原因是什么？**    
当远程桌面 Web 访问的登录页面不正确地验证 URL 参数时，会导致该漏洞。
  
**什么是远程桌面 Web 访问？**    
远程桌面 Web 访问（RD Web 访问）是远程桌面服务角色中的一个角色服务，使您能够使用 Web 浏览器向用户提供 RemoteApp 程序、虚拟桌面和基于会话的桌面。 此外，RD Web 访问使用户能够从 Web 浏览器连接到他们具有合适访问权限的任何服务器或客户端计算机的远程桌面。 有关详细信息，请参阅 TechNet 文章[远程桌面 Web 访问](https://technet.microsoft.com/en-us/library/ff608245(ws.10).aspx)。
  
**什么是跨站点脚本执行 (XSS)？**    
跨站点脚本执行 (XSS) 是一种安全漏洞类别，允许攻击者在网页请求响应中注入脚本。 此脚本随后由发出请求的应用程序（通常是 Web 浏览器）运行。 该脚本可能欺骗内容、泄露信息或执行用户可以在受影响的网站上代表目标用户执行的任何操作。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以在用户的 Internet Explorer 实例中注入客户端脚本。 此脚本可能欺骗内容、泄露信息或执行用户可以在远程桌面 Web 访问网站上执行的任何操作。
  
**攻击者如何利用此漏洞？**    
在电子邮件攻击情形中，攻击者可以通过向用户发送特制的链接并诱使用户单击该链接来利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**    
运行远程桌面 Web 访问角色的服务器受到的威胁最大。 不运行此特定角色的服务器不受威胁。
  
**此更新有什么作用？**    
此更新通过更正远程桌面 Web 访问的登录页面验证输入参数的方式来解决漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2546250">Microsoft 知识库文章 2546250</a></td>
</tr>  
<tr class="odd">
...
-   Sven Taute 报告了远程桌面 Web 访问漏洞 (CVE-2011-1263)

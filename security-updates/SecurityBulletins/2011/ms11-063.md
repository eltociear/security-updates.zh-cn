---
TOCTitle: 'MS11-063'
Title: 'Microsoft 安全公告 MS11-063 - 重要'
ms:assetid: 'ms11-063'
ms:contentKeyID: 61238201
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-063(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-063 - 重要
==================================

Windows 客户端/服务器运行时子系统中的漏洞可能允许特权提升 (2567680)
-------------------------------------------------------------------

发布时间: 2011年8月9日 | 更新时间: 2011年8月17日
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=0231c103-c0cb-4705-9d92-5356b8cbb265)                                                                                           | 特权提升     | 重要         | [MS10-069](https://go.microsoft.com/fwlink/?linkid=197093) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=09276f6e-e3f4-4b7e-996e-4ec376c103e1)                                                                  | 特权提升     | 重要         | [MS10-069](https://go.microsoft.com/fwlink/?linkid=197093) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=870fdfdd-16bf-42a2-a23b-ed6045438d5e)                                                                                  | 特权提升     | 重要         | [MS10-069](https://go.microsoft.com/fwlink/?linkid=197093) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=31af27b8-7b73-4090-94bd-2fb89d3970fc)                                                                      | 特权提升     | 重要         | [MS10-069](https://go.microsoft.com/fwlink/?linkid=197093) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=410c72d8-3b78-4c4a-ad61-acb7f854ffc2)                                                                  | 特权提升     | 重要         | [MS10-069](https://go.microsoft.com/fwlink/?linkid=197093) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8f25ced5-ef86-4b9d-91fb-443c9a2c1458)                                                                                        | 特权提升     | 重要         | 无                                                        |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d5b8ff09-237e-49f1-a566-e323ca11fbc3)                                                                            | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1fbaabb9-8601-4760-813d-aeedfdcafb8b)\*                                                               | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2e7253d8-fdc7-4563-9714-21ca3c77e4b1)\*                                                          | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fe37eb6d-b1fa-496c-a0d3-19a6d35a6cb9)                                                        | 特权提升     | 重要         | 无                                                        |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=f4551b77-eb09-448a-9dc5-66de846035e7)                                             | 特权提升     | 重要         | [MS11-056](https://go.microsoft.com/fwlink/?linkid=217465) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0fc9a501-523d-4cbb-8d99-a773089afc4c)                                   | 特权提升     | 重要         | [MS11-056](https://go.microsoft.com/fwlink/?linkid=217465) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=2f4043df-c07c-4611-b06a-7fcbb7416e7d)\*       | 特权提升     | 重要         | [MS11-056](https://go.microsoft.com/fwlink/?linkid=217465) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b420cae3-de30-4c6c-8ed9-7431ad7ab4da) | 特权提升     | 重要         | [MS11-056](https://go.microsoft.com/fwlink/?linkid=217465) |
...
CSRSS 漏洞 - CVE-2011-1967  
--------------------------
  
<span></span>  
客户端/服务器运行时子系统 (CSRSS) 中存在一个特权提升漏洞，允许在另一个进程的上下文中执行任意代码。 如果此进程使用管理员特权运行，则攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1967](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1967)。
  
#### CSRSS 漏洞 (CVE-2011-1967) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### CSRSS 漏洞 (CVE-2011-1967) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### CSRSS 漏洞 (CVE-2011-1967) 的常见问题
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2567680$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2567680">Microsoft 知识库文章 2567680</a></td>
</tr>  
<tr class="even">
...
-   Winsider Seminars & Solutions Inc. 的 Alex Ionescu 报告了 CSRSS 漏洞 (CVE-2011-1967)
...
-   V1.1（2011 年 8 月 17 日）： 更正了 CVE-2011-1967 的超链接。

...
此安全更新也解决了最初在 [Microsoft 安全通报 2501696](https://technet.microsoft.com/security/advisory/2501696) 中描述的漏洞。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=7f0a4616-8e3e-4925-9d95-ce6e614e45ae)                                                                                           | 信息泄露     | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b01fe9a5-66a4-4683-963b-e78aea214579)                                                                  | 信息泄露     | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0209a004-f23a-40d9-991f-864046f4605f)                                                                                  | 信息泄露     | 低           | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6c287571-54ea-4298-8b7d-b98b2c830cc3)                                                                      | 信息泄露     | 低           | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=3fb450a0-d087-4f36-9301-05ffbf94cc1a)                                                                  | 信息泄露     | 低           | 无               |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c8fce0fb-4c90-479b-8ce9-75e60d52d256)                                                        | 信息泄露     | 重要         | 无               |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7da10b64-d0a9-4e42-aa3a-87c657122a8c)                                | 信息泄露     | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=036f1285-7484-4e3b-8799-2c6c08166596)\*\*                     | 信息泄露     | 低           | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1438cec8-8dab-4510-ad75-dc6959dac0d8)\*\*           | 信息泄露     | 低           | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f35ecdd1-6b5c-40e7-a00b-ca083bdf5cba)       | 信息泄露     | 低           | 无               |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=aed201c1-f1fb-4df9-8875-6f57ea0eb15b)                                             | 信息泄露     | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1a32bf04-7eed-4d27-a8e4-054b4a5b76cb)                                   | 信息泄露     | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=665faa7e-2368-4421-9dd5-ea6df2c79498)\*\*     | 信息泄露     | 低           | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=140ea384-2877-401f-ac3b-f84f6966e970) | 信息泄露     | 低           | 无               |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0096](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096)。
...
-   默认情况下，Windows Server 2003 和 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)”的受限模式下运行。 此模式可减轻此漏洞。 有关 Internet Explorer 增强安全配置的详细信息，请参阅下一小节中的常见问题条目“我当前运行的是 Windows Server 2003、Windows Server 2008 或 Windows Server 2008 R2 的 Internet Explorer。这是否会缓解此漏洞的影响？”
...
-   **禁用 MHTML 协议处理程序**
    ...
    **注意** 您可以通过将导出的 .reg 文件复制到目标系统，然后双击它来将该文件应用到各个系统。 您还可以使用组策略跨域应用该文件。 有关组策略的详细信息，请参阅 TechNet 文章[组策略收集](https://go.microsoft.com/fwlink/?linkid=215719)。
...
-   **启用 MHTML 协议锁定**
    ...
    **注意** 要使用自动 **Microsoft Fix it** 解决方案来启用和禁用此变通办法，请参阅 [Microsoft 知识库文章 2503658](https://support.microsoft.com/kb/2503658)。
    ...
    **对于 64 位版本的 Microsoft Windows：**
    ...
    [HKEY_LOCAL_MACHINE\SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\MAIN\FeatureControl\FEATURE_PROTOCOL_LOCKDOWN]"explorer.exe"=dword:00000001"iexplore.exe"=dword:00000001"*"=dword:00000001
...
**什么是 MHTML？**    
MHTML（聚合 HTML 文档的 MIME 封装）是一个 Internet 标准，定义用于封装 HTML 内容的 MIME 结构。 Windows 中的 MHTML 协议处理程序提供一种[可插入协议](https://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx)，其允许在应用程序中呈现 MHTML 编码的文档。
...
[Microsoft 知识库文章 2503658](https://support.microsoft.com/kb/2503658) 中的 Microsoft Fix it 解决方案启用 MHTML 锁定。 该安全更新可解决 MHTML 中的漏洞，但是无法还原 Microsoft Fix it 解决方案强制实施的 MHTML 协议锁定。 在安装该安全更新后，变通办法的影响仍然有效。 不想锁定 MHTML 协议的用户可以使用 Microsoft Fix it 解决方案禁用锁定。 有关 Microsoft Fix it 解决方案的详细信息，请参阅上一小节中的变通办法条目“启用 MHTML 协议锁定”。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-0096](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
是。 在发布此安全公告时，Microsoft 已收到有关此漏洞已被利用的信息。
  
**应用此安全更新是否有助于客户防止可能会尝试利用此漏洞的已公开发布的代码？**    
是。 此安全更新可消除目前被利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2011-0096](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0096)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2503658">Microsoft 知识库文章 2503658</a></td>
</tr>  
<tr class="even">
...
-   [Google Security Team](https://www.google.com/) 与我们合作处理了 MHTML MIME 格式 Web 请求漏洞 (CVE-2011-0096)

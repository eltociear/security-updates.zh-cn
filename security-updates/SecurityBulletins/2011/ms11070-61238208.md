...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1e6ac3b2-752e-49a0-84e5-5a8dfe955299)                                                                            | 特权提升     | 重要         | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f9378339-c58e-4e84-9427-85aeb35b0d99)                                                                | 特权提升     | 重要         | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=c35c71a8-13b4-47a6-9763-06f6f65327b1)                                                            | 特权提升     | 重要         | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a9039660-3cc2-470d-a0a5-a70f78074495)\*                                                         | 特权提升     | 重要         | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ea78a9b-b1f7-4e94-b69e-c984e1622ae9)\*                                                    | 特权提升     | 重要         | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f58cf343-946c-4e74-bd9c-40ac934a4986)\* | 特权提升     | 重要         | [MS11-035](http://go.microsoft.com/fwlink/?linkid=214807) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1984](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1984)。
...
**什么是 WINS？**   
Windows Internet 名称服务 (WINS) 专门为支持 TCP/IP 上的 NetBIOS (NetBT) 而设计的。用户在其中访问具有 NetBIOS 名称的资源的任何环境都需要 WINS。如果不在此类网络中使用 WINS，除非您使用 LMHOSTS 文件，否则无法使用其 NetBIOS 名称连接到远程网络资源，且可能无法建立文件和打印共享连接。有关详细信息，请参阅 TechNet 文章“[什么是 WINS？](http://technet.microsoft.com/en-us/library/cc784180.aspx)”
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2571621">Microsoft 知识库文章 2571621</a></td>
</tr>  
<tr class="even">

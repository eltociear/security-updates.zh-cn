...
**已知问题。**[Microsoft 知识库文章 2640241](https://support.microsoft.com/kb/2640241)介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
当 Microsoft Excel 2003 中启用了 Office 文件验证功能时，可用于利用 CVE-2011-3403 中所述的漏洞的特制文件不会自动打开；默认情况下，系统会提示用户选择是否打开此类文件。在漏洞可以被利用之前，用户必须单击警告才能打开文件。有关 Microsoft Excel 2003 中的 Office 文件验证的详细信息，请参阅 [Microsoft 安全通报 2501584](https://www.microsoft.com/technet/security/advisory/2501584.mspx)。

**如果在 Excel 2003 中禁止打开未通过文件验证的文件，则有何好处？**  
通过将 Office 文件验证设置为不允许在 Excel 2003 中打开可疑文件，[Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584) 中提供的 **Microsoft Fix it** 解决方案“禁止在 Excel 2003 和 2007 中打开文档”可阻止利用 CVE-2011-3403 中所述的漏洞的攻击媒介。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-3403](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3403)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2596954">Microsoft 知识库文章 2596954</a></td>
</tr>  
<tr class="even">
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=ef3b559c-0bd2-45dd-8049-6946f6431a2a)下载和安装 Microsoft Office 2004 for Mac 11.6.6 Update 的合适语言版本。
...
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了记录内存损坏漏洞 (CVE-2011-3403)

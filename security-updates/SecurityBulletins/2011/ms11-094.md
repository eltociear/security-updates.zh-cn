...
**已知问题。**[Microsoft 知识库文章 2639142](https://support.microsoft.com/kb/2639142)介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
以下严重等级假设漏洞的可能的最大影响。有关在安全公告发布 30 天内漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [12 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-dec)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/security/cc998259)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-3396](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3396)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-3413](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3413)。
...
<td style="border:1px solid black;">对于 PowerPoint 2007 Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/2596764">Microsoft 知识库文章 2596764</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 2 的 Microsoft Office 兼容包：<br />
请参阅 <a href="https://support.microsoft.com/kb/2596843">Microsoft 知识库文章 2596843</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 PowerPoint Viewer 2007 Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/2596912">Microsoft 知识库文章 2596912</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2553185">Microsoft 知识库文章 2553185</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=2c4d0381-f7ab-49ed-a0c0-b381387d1e68)下载和安装 Microsoft Office 2008 for Mac 12.3.2 Update 的合适语言版本。
...
-   [iSIGHT Partners Labs](https://www.isightpartners.com/) 的 Greg MacManus 报告了 PowerPoint 库加载不安全漏洞 (CVE-2011-3396)  
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了艺术字形状 RCE 漏洞 (CVE-2011-3413)

...
**已知问题。** [Microsoft 知识库文章 2489283](https://support.microsoft.com/kb/2489283) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2010（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid%20=%20549ca7f0-44bf-4965-a9d2-aa5e8dac2238)<sup>[1]</sup>  
(KB2519975)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft PowerPoint 2010（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=ef62deae-2b07-41c9-a4bf-b746566e59ee)<sup>[1]</sup>  
(KB2519975)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[MS09-017](https://go.microsoft.com/fwlink/?linkid=141704)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<sup>[1]</sup>[Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584) 中提供的适用于 PowerPoint 2010 的自动 **Microsoft Fix it** 解决方案“为 PowerPoint 2010 禁用受保护视图编辑操作”可阻止利用 CVE-2011-0655 和 CVE-2011-0656 中介绍的漏洞的攻击媒介。有关详细信息，请参阅下一节中的常见问题条目“如果应用 Microsoft Fix it 解决方案以禁用受保护视图编辑操作，则有何好处？”。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9847dc05-7d4a-4a64-9e6a-622d3fa171f9">Microsoft PowerPoint Web App</a><br />
(KB2520047)</td>
...
是。 Microsoft PowerPoint 2003 Service Pack 3 (KB2464588) 和 Microsoft PowerPoint 2007 Service Pack 2 (KB2464594) 的更新以及 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206) 中提供的更新可为 Office 文件验证功能提供支持。 有关 Office 文件验证功能的详细信息，请参阅 [Microsoft 安全通报 2501584](https://technet.microsoft.com/security/advisory/2501584)。
  
**此安全更新与 MS10-087 和 MS10-088 有什么联系？**    
本公告中提供的 Microsoft Office 2004 for Mac (KB2505924) 更新也可解决 [MS10-087](https://go.microsoft.com/fwlink/?linkid=203241) 和 [MS10-088](https://go.microsoft.com/fwlink/?linkid=198186) 安全公告中介绍的漏洞。
...
有关应用自动 Fix it 解决方案“为 PowerPoint 2010 禁用受保护视图编辑操作”的说明，请参阅 [Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584)；或者，有关手动应用该解决方案的说明，请参阅本公告的“漏洞信息”部分中 CVE-2011-0655 和 CVE-2011-0656 的“变通方法”部分。
...
本公告中提供的 Microsoft Office 2004 for Mac (KB2505924)、Microsoft Office 2008 for Mac (KB2505927) 和 Open XML File Format Converter for Mac (KB2505935) 安全更新程序包也可解决 [MS11-021](https://go.microsoft.com/fwlink/?linkid=210121) 和 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206) 安全公告中介绍的漏洞。 本公告中提供的 Microsoft Office for Mac 2011 (KB2525412) 安全更新程序包也可解决 [MS11-021](https://go.microsoft.com/fwlink/?linkid=210121) 中介绍的漏洞。安装了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac、Open XML File Format Converter for Mac 或 Microsoft Office for Mac 2011 的用户只需安装这些安全更新程序包一次。
...
对受影响软件应用此安全更新后，运行 Microsoft PowerPoint 2003 和 Microsoft PowerPoint 2007 受支持版本的客户可发布使用 PowerPoint 中的“[将演示文稿打包成 CD](https://support.microsoft.com/kb/828504)”功能创建的演示文稿的更新版本，以帮助确保其演示文稿中包含的 PowerPoint Viewer 免受本公告中所述的漏洞影响。
...
<span></span>  
以下严重等级假设漏洞的可能的最大影响。 有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [4 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-apr)中的利用指数。 有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0655](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0655)。
...
-   在 Microsoft PowerPoint 2010 中，攻击者成功利用此漏洞的可能性因 Microsoft Office 2010 中默认情况下启用的 Office 文件验证功能所提供的保护而降低。 用于利用此漏洞的特制文件在受保护的视图中打开，并警告用户该文件不安全，未通过验证，可能有害。 在漏洞可以被利用之前，用户必须单击多个警告，然后打开文件进行编辑或保存。 有关受保护的视图和 Office 文件验证的详细信息，请参阅 TechNet 文章 [Office 2010 安全概述](https://technet.microsoft.com/en-us/library/cc179050.aspx)。
...
-   **将 Office 文件验证设置为禁止在 PowerPoint 2010 的受保护视图中编辑**
    ...
    **注意**  请参阅 [Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584) 以使用自动 **Microsoft Fix it** 解决方案“为 PowerPoint 2010 禁用受保护视图编辑操作”启用或禁用此变通办法。
...
-   **使用 Microsoft Office 文件阻止策略在 Microsoft PowerPoint 中禁止打开来自未知或不可信来源和位置的 Office 2003 以及更早版本的文档**
    ...
    **变通办法的影响。** 对于 Microsoft Office 2007，配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](https://support.microsoft.com/kb/922848) 所述配置特殊例外目录或将文件移动到可信位置的用户将无法打开 Office 2003 文件或更早版本。
...
<p> </p>
  ...
  **如何撤消变通方法。** 根据  **变通办法的影响。** 由 MOICE 下表指示，运行命令以禁用 MOICE。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0656](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0656)。
...
-   **使用 Microsoft Office 文件阻止策略在 Microsoft PowerPoint 中禁止打开来自未知或不可信来源和位置的 Office 2003 以及更早版本的文档**
    ...
    **变通办法的影响。** 对于 Microsoft Office 2003 和 Microsoft Office 2007，配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](https://support.microsoft.com/kb/922848) 所述配置特殊例外目录或将文件移动到可信位置的用户将无法打开 Office 2003 文件或更早版本。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0976](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0976)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2464617">Microsoft 知识库文章 2464617</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2464588">Microsoft 知识库文章 2464588</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 PowerPoint 2007，请参阅 <a href="https://support.microsoft.com/kb/2464594">Microsoft 知识库文章 2464594</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 2 的 Microsoft Office 兼容包，请参阅 <a href="https://support.microsoft.com/kb/2464635">Microsoft 知识库文章 2464635</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 PowerPoint Viewer 2007 Service Pack 2，请参阅 <a href="https://support.microsoft.com/kb/2464623">Microsoft 知识库文章 2464623</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 PowerPoint 2010，请参阅 <a href="https://support.microsoft.com/kb/2519975">Microsoft 知识库文章 2519975</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 PowerPoint Viewer，请参阅 <a href="https://support.microsoft.com/kb/2519984">Microsoft 知识库文章 2519984</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 PowerPoint Web App，请参阅 <a href="https://support.microsoft.com/kb/2520047">Microsoft 知识库文章 2520047</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=ef1e612f-d8e3-4628-9fe4-ad136f0debd3)下载和安装 Microsoft Office for Mac 2011 14.1 Update 的合适语言版本。
...
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/)* *[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了浮点数字颜色时间窃取 RCE 漏洞 (CVE-2011-0655)  
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/)* *[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了永久目录 RCE 漏洞 (CVE-2011-0656)  
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/)* *[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了艺术字 Atom RCE 漏洞 (CVE-2011-0976)

...
**已知问题。**[Microsoft 知识库文章 2618444](https://support.microsoft.com/kb/2618444) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
Microsoft 修订此公告是为了宣布此更新 MS11-099 为 Internet Explorer 启用 [SSL/TLS 中的漏洞可能允许信息泄露](https://go.microsoft.com/fwlink/?linkid=232510)更新中提供的保护。有关详细信息，请参阅[MS12-006](https://go.microsoft.com/fwlink/?linkid=232510)。

**此安全更新与 MS12-006** **和 CVE-2011-3389** **有什么联系？**  
[SSL/TLS 中的漏洞可能允许信息泄露](https://go.microsoft.com/fwlink/?linkid=232510)更新 MS12-006 解决了影响 WinHTTP 的 SSL 和 TLS 协议漏洞 ([CVE-2011-3389](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3389)) 并提供了在系统范围内实施保护的可能性。此更新 MS11-099 为 Internet Explorer 启用这些保护。有关详细信息，请参阅[MS12-006](https://go.microsoft.com/fwlink/?linkid=232510)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1992](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1992)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2019)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-3404](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3404)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2618444">Microsoft 知识库文章 2618444</a></td>
</tr>  
<tr class="even">
...
-   [Citrix Security Team](https://www.citrix.com) 的 Andy Cooper 报告了 Internet Explorer 不安全库加载漏洞 (CVE-2011-2019)  
-   [Google Inc.](https://www.google.com/) 的 [Robert Swiecki](https://www.swiecki.net) 报告了内容处置信息泄露漏洞 (CVE-2011-3404)  
-   [Yosuke Hasegawa](https://utf-8.jp/) 与我们合作处理了内容处置信息泄露漏洞 (CVE-2011-3404)  
-   [Jan Schejbal](https://janschejbal.wordpress.com/) 与我们合作处理了此公告中包括的纵深防御更改。

...
**已知问题。** [Microsoft 知识库文章 2545814](http://support.microsoft.com/kb/2545814) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
Microsoft 修订此公告是为了宣布最初发布此公告时不可用的 Microsoft Office for Mac 安全更新现在在公告 [MS11-045](http://go.microsoft.com/fwlink/?linkid=217502) 中可用。

**哪里可以找到 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 和 Open XML File Format Converter for Mac 的安全更新？**  
除了解决公告 MS11-045 中介绍的漏洞之外，Microsoft Office 2004 for Mac (KB2555786)、Microsoft Office 2008 for Mac (KB2555785) 和 Open XML File Format Converter for Mac (KB2555787) 的安全更新也可解决本公告中介绍的漏洞。 有关更多信息和下载链接，请参阅 [MS11-045](http://go.microsoft.com/fwlink/?linkid=217502)。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**Office 文件验证功能如何帮助缓解漏洞？**  
当 Microsoft PowerPoint 2003 和 Microsoft PowerPoint 2007 中启用了 Office 文件验证功能时，可用于利用漏洞的特制文件不会自动打开；默认情况下，系统会提示用户选择是否打开此类文件。 在漏洞可以被利用之前，用户必须单击警告才能打开文件。 有关 Microsoft PowerPoint 2003 或 Microsoft PowerPoint 2007 中的 Office 文件验证的详细信息，请参阅 [Microsoft 安全通报 2501584](http://technet.microsoft.com/security/advisory/2501584)。

**如果在 PowerPoint 2003 和 PowerPoint 2007 中禁止打开未通过文件验证的文件，则有何好处？**  
通过设置 Office 文件验证以禁止在 PowerPoint 2003 和 PowerPoint 2007 中打开可疑文件，[Microsoft 知识库文章 2501584](http://support.microsoft.com/kb/2501584) 中提供的 **Microsoft Fix it** 解决方案“对 PowerPoint 2003 和 2007 禁止打开文档”可阻止利用 CVE-2011-1269 和 CVE-2011-1270 中介绍的漏洞的攻击媒介。如果客户选择当前不为 PowerPoint 2003 或 PowerPoint 2007 安装该安全更新，则可以选择应用该 Fix it 解决方案作为变通办法。
有关应用自动 Fix it 解决方案“对 PowerPoint 2003 和 2007 禁止打开文档”的说明，请参阅 [Microsoft 知识库文章 2501584](http://support.microsoft.com/kb/2501584)；有关手动应用解决方案的说明，请参阅本公告的“漏洞信息”部分中 CVE-2011-1269 和 CVE-2011-1270 的“变通办法”部分。
...
以下严重等级假设漏洞的可能的最大影响。 有关此安全公告发布 30 天内，漏洞利用的严重等级和安全影响的可能性的信息，请参阅 [5 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms11-may)中的利用指数。 有关详细信息，请参阅 [Microsoft 利用指数](http://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1269](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1269)。
...
-   **使用 Microsoft Office 文件阻止策略禁止打开来自未知或不可信来源和位置的 Office 2003 以及较早版本的文档**
    ...
    **对于 Microsoft Office 2003 和 Microsoft Office 2007**
    ...
    以下注册表脚本可以保存在注册表项 (.reg) 文件中，可用于设置文件阻止策略。 有关如何使用注册表脚本的详细信息，请参阅 [Microsoft 知识库文章 310516](http://support.microsoft.com/kb/310516)。使用适合您的 Office 软件的注册表脚本。
...
<p> </p>
  ...
  此外，对于 Microsoft Office 2007 也可使用组策略应用文件阻止。 有关详细信息，请参阅 TechNet 文章[在 Office 2007 中配置阻止文件格式](http://technet.microsoft.com/en-us/library/cc179186(office.12).aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1270](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1270)。
...
**注意** Microsoft 在 2011 年 4 月 12 日之后不再对 SMS 2.0 提供支持。对于 SMS 2003，Microsoft 在 2011 年 4 月 12 日之后也不再对安全更新清单工具 (SUIT) 提供支持。鼓励客户升级到 System Center Configuration Manager 2007。对于保留使用 SMS 2003 Service Pack 3 的客户，[Microsoft 更新清单工具](http://technet.microsoft.com/en-us/systemcenter/bb676783.aspx) (ITMU) 也是一种选择。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2535802">Microsoft 知识库文章 2535802</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2535812">Microsoft 知识库文章 2535812</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 PowerPoint 2007，请参阅 <a href="http://support.microsoft.com/kb/2535818">Microsoft 知识库文章 2535818</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 2 的 Microsoft Office 兼容包，请参阅 <a href="http://support.microsoft.com/kb/2540162">Microsoft 知识库文章 2540162</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [CERT/CC](http://www.cert.org/) 的 Will Dormann 与我们合作解决了演示内存损坏 RCE 漏洞 (CVE-2011-1269)  
-   [CERT/CC](http://www.cert.org/) 的 Will Dormann 与我们合作解决了演示缓冲区溢出 RCE 漏洞 (CVE-2011-1270)

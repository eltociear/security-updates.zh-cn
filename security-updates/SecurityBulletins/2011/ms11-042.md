...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1869](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2535512">Microsoft 知识库文章 2535512</a></td>
</tr>  
<tr class="even">
...
-   [NGS Software](http://www.ngssoftware.com/) 的 Laurent Gaffié 报告了 DFS 引用响应漏洞 (CVE-2011-1869)

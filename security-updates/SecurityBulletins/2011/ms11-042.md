---
TOCTitle: 'MS11-042'
Title: 'Microsoft 安全公告 MS11-042 - 严重'
ms:assetid: 'ms11-042'
ms:contentKeyID: 61238180
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-042(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-042 - 严重
==================================

分布式文件系统中的漏洞可能允许远程执行代码 (2535512)
----------------------------------------------------

发布时间: 2011年6月14日 | 更新时间: 2011年6月14日
...
对于 Windows XP 和 Windows Server 2003 的所有受支持版本，此安全更新的等级为“严重”；对 Windows Vista 和 Windows Server 2008 的所有受支持版本，此安全更新的等级为“重要”；对于 Windows 7（用于 32 位版本）、Windows 7（用于基于 x64 的系统）、Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统），此安全更新等级为重要。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

该安全更新通过更正 DFS 客户端验证特制 DFS 引用响应中的字段的方式以及更正 DFS 服务处理特制 DFS 引用响应的方式来解决漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=67a25abd-f43c-4b01-b507-a109b739238f)                                                                                     | 远程执行代码 | 严重         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=af6b7627-c462-45fe-8948-70da37e60659)                                                            | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3aa8f1bc-07de-451a-8244-1733247e6f2e)                                                                            | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e9018258-5a72-47a1-8584-3d1aa52317c3)                                                                | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=96309c49-4822-4c47-b364-2ba65327cac5)                                                            | 远程执行代码 | 严重         | 无               |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=aded8f20-479d-40c1-9560-c0581c6f77a2)                                                  | 拒绝服务     | 重要         | 无               |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=962cb40c-680c-4c37-98d4-ca9789ca7270)                          | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8ebfa067-0236-4454-8605-df1b99742f90)\*                 | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f1d76b82-9996-4d08-894b-9c16a4b3bb1e)\*       | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f80c89c6-27ab-4f6a-afad-9c8e92cbbce4) | 拒绝服务     | 重要         | 无               |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=9de1bf5d-6f25-496d-bc44-a32c5e8920fe)                                                                                   | 拒绝服务     | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=50d1c677-57aa-4e3f-bdfc-6f01b5d3bfe2)                                                                              | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=9d66b1e7-dbf9-4475-a973-49fb85557eca)\*                                                               | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=3c8455f1-b8a0-4ba2-84a2-043d25ef75c5)                                                             | 拒绝服务     | 重要         | 无               |
...
<tr class="header">
<th>受影响的软件</th>
<th>DFS 内存损坏漏洞 - CVE-2011-1868</th>
<th>DFS 引用响应漏洞 - CVE-2011-1869</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
DFS 内存损坏漏洞 - CVE-2011-1868  
--------------------------------
  
<span></span>  
分布式文件系统 (DFS) 客户端分析特制 DFS 响应的方式中存在未经身份验证的远程执行代码漏洞。 利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过将特制的 DFS 响应发送到客户端发起的 DFS 请求来利用该漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1868)。
  
#### DFS 内存损坏漏洞 (CVE-2011-1868) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。
  
#### DFS 内存损坏漏洞 (CVE-2011-1868) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### DFS 内存损坏漏洞 (CVE-2011-1868) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**    
此漏洞是由于 Microsoft 分布式文件系统 (DFS) 实施不正确地验证特制 DFS 响应中的所有字段而导致的。
  
**什么是分布式文件系统 (DFS)？**    
分布式文件系统 (DFS) 允许管理员通过透明地将不同服务器上的共享文件夹连接到一个或多个 DFS 命名空间来对这些文件夹进行分组。 DFS 命名空间是一个组织中的共享文件夹的虚拟视图。 使用 DFS 工具，管理员可选择在命名空间中呈现哪个共享文件夹、设计这些文件夹的层次结构，并确定共享文件夹在命名空间中显示的名称。 当用户查看命名空间时，文件夹看起来驻留在单个高容量的硬盘上。 用户可以导航命名空间中的文件夹，无需知道服务器名称或托管数据的共享文件夹。 有关详细信息，请参阅 [DFS 技术参考](https://technet.microsoft.com/en-us/library/cc757042(ws.10).aspx)。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以完全控制受影响的系统。 利用此漏洞的大多数尝试将导致受影响的系统停止响应和重新启动。
  
**攻击者如何利用此漏洞？**    
攻击者可能拥有旨在利用此漏洞的特制服务器，然后诱使用户与其建立 DFS 连接。 此外，本地网络上的攻击者可能会执行人为干预的攻击，以使用格式错误的 DFS 响应来响应合法的 DFS 请求。
  
**受此漏洞威胁最大的系统有哪些？**    
Windows XP 和 Windows Server 2003 的所有受支持版本均受此漏洞威胁。
  
**此更新有什么作用？**    
此安全更新通过更正 DFS 客户端验证特制 DFS 响应中的字段的方式来解决漏洞。
...
DFS 引用响应漏洞 - CVE-2011-1869  
--------------------------------
  
<span></span>  
Microsoft 分布式文件系统 (DFS) 处理特制 DFS 引用响应的方式中存在一个拒绝服务漏洞。 利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过向运行 Server 服务的计算机发送特制网络消息来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1869](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1869)。
  
#### DFS 引用响应漏洞 (CVE-2011-1869) 的缓解因素
...
#### DFS 引用响应漏洞 (CVE-2011-1869) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### DFS 引用响应漏洞 (CVE-2011-1869) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个拒绝服务漏洞。 利用此漏洞的攻击者可能会导致受影响系统停止响应，直至其被手动重新启动。 请注意，虽然攻击者无法利用拒绝服务漏洞来执行代码或提升他们的用户权限，但此漏洞可能导致受影响的系统停止接受请求。
  
**造成此漏洞的原因是什么？**    
此漏洞是由于分布式文件系统 (DFS) 实施不正确地处理特制 DFS 引用响应而导致的。
...
**受此漏洞威胁最大的系统有哪些？**    
Windows 的所有受支持版本均受此漏洞威胁。
  
**此更新有什么作用？**    
此安全更新通过更正 DFS 服务处理特制 DFS 引用响应的方式来解决漏洞。
...
| Windows 7（用于 32 位系统）                                                                                   | 是                  | 是                         |  
| Windows 7（用于基于 x64 的系统）                                                                              | 是                  | 是                         |  
| Windows Server 2008 R2（用于基于 x64 的系统）                                                                 | 是                  | 是                         |  
| Windows Server 2008 R2（用于基于 Itanium 的系统）                                                             | 是                  | 是                         |
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2535512$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2535512">Microsoft 知识库文章 2535512</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows 7（用于 32 位系统）：<br />
Windows6.1-KB2535512-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows 7（用于基于 x64 的系统）：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于所有 Windows 7（用于基于 x64 的系统）：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows 2008 R2（用于基于 x64 的系统）：<br />
Windows6.1-KB2535512-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows 2008 R2（用于基于 Itanium 的系统）：<br />
...
-   [NGS Software](https://www.ngssoftware.com/) 的 Laurent Gaffié 报告了 DFS 引用响应漏洞 (CVE-2011-1869)
...
-   V1.1（2011 年 6 月 14 日）： 将 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1、Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1 从受影响的软件表移动到不受影响的软件表。 这仅仅是一个信息更改。 没有更改安全更新文件或检测逻辑。

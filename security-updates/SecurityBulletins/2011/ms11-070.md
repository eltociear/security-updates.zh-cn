---
TOCTitle: 'MS11-070'
Title: 'Microsoft 安全公告 MS11-070 - 重要'
ms:assetid: 'ms11-070'
ms:contentKeyID: 61238208
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-070(v=Security.10)'
---


Microsoft 安全公告 MS11-070 - 重要
==================================
...
对于安装了 WINS 的 Windows Server 2003、Windows Server 2008（Itanium 除外）和 Windows Server 2008 R2（Itanium 除外）的所有受支持版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

该安全更新通过更正 WINS 处理环回地址上的内部通信的方式来解决该漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1e6ac3b2-752e-49a0-84e5-5a8dfe955299)                                                                            | 特权提升     | 重要         | [MS11-035](https://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f9378339-c58e-4e84-9427-85aeb35b0d99)                                                                | 特权提升     | 重要         | [MS11-035](https://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=c35c71a8-13b4-47a6-9763-06f6f65327b1)                                                            | 特权提升     | 重要         | [MS11-035](https://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a9039660-3cc2-470d-a0a5-a70f78074495)\*                                                         | 特权提升     | 重要         | [MS11-035](https://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5ea78a9b-b1f7-4e94-b69e-c984e1622ae9)\*                                                    | 特权提升     | 重要         | [MS11-035](https://go.microsoft.com/fwlink/?linkid=214807) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=f58cf343-946c-4e74-bd9c-40ac934a4986)\* | 特权提升     | 重要         | [MS11-035](https://go.microsoft.com/fwlink/?linkid=214807) |
...
<tr class="header">
<th>受影响的软件</th>
<th>WINS 本地特权提升漏洞 - CVE-2011-1984</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
WINS 本地特权提升漏洞 - CVE-2011-1984  
-------------------------------------
  
<span></span>  
WINS 中存在一个特权提升漏洞，允许在本地系统的上下文中执行任意代码。当 WINS 服务器不正确地处理环回接口上接收的一系列特制数据包时，会导致该漏洞。成功利用此漏洞的本地攻击者可执行任意代码，并可完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1984](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1984)。
  
#### WINS 本地特权提升漏洞 (CVE-2011-1984) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### WINS 本地特权提升漏洞 (CVE-2011-1984) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### WINS 本地特权提升漏洞 (CVE-2011-1984) 的常见问题
  
**此漏洞的影响范围有多大？**   
这是一个本地特权提升漏洞。
  
**造成此漏洞的原因是什么？**   
当 WINS 服务器不正确地处理环回接口上接收的一系列特制数据包时，会导致该漏洞。
...
**攻击者可能利用此漏洞执行什么操作？**   
在 Windows Server 2003 上成功利用此漏洞的攻击者可以在本地系统的上下文中运行任意代码。在 Windows Server 2008 或 Windows Server 2008 R2 上成功利用此漏洞的攻击者可以在本地服务的上下文中运行任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**攻击者如何利用此漏洞？**   
要利用此漏洞，攻击者必须先登录到系统。然后，攻击者可以运行一个特制应用程序，该应用程序通过向环回接口发送特制数据包来利用漏洞，从而允许攻击者完全控制受影响的系统。
  
**受此漏洞威胁最大的系统有哪些？**   
Windows Server 2003、Windows Server 2008 或 Windows Server 2008 R2 上运行的 WINS 服务器受此漏洞威胁最大。
  
**此更新有什么作用？**   
该更新通过更正 WINS 处理环回地址上的内部通信的方式来解决该漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2571621$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2571621">Microsoft 知识库文章 2571621</a></td>
</tr>  
<tr class="even">
...
-   的 Nicolas Economou 报告了WINS 本地特权提升漏洞 (CVE-2011-1984)

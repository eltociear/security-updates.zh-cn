...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1983](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1983)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2596785">Microsoft 知识库文章 2596785</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2589320">Microsoft 知识库文章 2589320</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   Nikita Tarakanov (CISS Research Team) 和 Alexey Sintsov (Digital Security Research Group) 与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Word 释放后使用漏洞 (CVE-2011-1983)

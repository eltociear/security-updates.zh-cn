...
**已知问题。**[Microsoft 知识库文章 2567951](https://support.microsoft.com/kb/2567951) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1978](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1978)。
...
-   没有用户交互，安装了 [KB2562394](https://support.microsoft.com/kb/2562394) 的客户不能被利用。此更新通过 [MS11-044](https://go.microsoft.com/fwlink/?linkid=216436) 提供，可防止 Internet 区域中的 ClickOnce 应用程序执行，而不提示用户。如果应用程序未使用“仅 Internet”之外的任何其他权限，没有安装 [KB2562394](https://support.microsoft.com/kb/2562394) 的客户不会收到一个对话框。有关此功能的更多信息，请参阅 [KB2562394](https://support.microsoft.com/kb/2562394)。
...
.NET Framework 中的 System.Net.Sockets 命名空间为需要密切控制网络访问的开发人员提供 Windows 套接字 (Winsock) 接口的受管理实施。有关详细信息，请参阅 MSDN 文章 [System.Net.Sockets 命名空间](https://msdn.microsoft.com/en-us/library/sb27wehh.aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2567951">Microsoft 知识库文章 2567951</a></td>
</tr>  
<tr class="odd">

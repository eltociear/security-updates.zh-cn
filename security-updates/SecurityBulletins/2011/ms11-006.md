...
此安全更新也解决了最初在 [Microsoft 安全通报 2490606](https://technet.microsoft.com/security/advisory/2490606) 中描述的漏洞。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=bbea7ead-6c5c-4da8-aa03-a40325fd2de3)                                                                                     | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=bcb7217e-624a-4d61-86a1-f2440a1afd57)                                                            | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2aa94528-5063-427b-97f7-2a0a55cbb6bf)                                                                            | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6e740922-6ce4-46ec-a35e-e94201a9e398)                                                                | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=a4f9ec46-35b2-44c9-abf6-647f7a474b99)                                                            | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0c18ecca-afb9-4738-bc7b-76a0e815dfb8)                                                  | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=62dc454f-4b1e-4ac0-8ffe-6c73112f8d4d)                          | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=253c47a0-69ac-437a-ad3e-778c37fa37cb)\*\*               | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ec7101aa-96c2-4931-a3e4-0c55cbc74d9c)\*\*     | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e62493cb-8d25-4975-bbe6-a368e039872b) | 远程执行代码 | 严重         | [MS10-046](https://go.microsoft.com/fwlink/?linkid=197393) |
...
是。 在安装此安全更新之前，您必须从您之前应用此更新的系统中撤消“修改 Windows XP 和 Windows Server 2003 系统上 shimgvw.dll 的访问控制列表 (ACL)”变通办法。 要使用自动化“Microsoft 修复”解决方案来禁用此变通办法，请参阅 [Microsoft 知识库文章 2483185](https://support.microsoft.com/kb/2483185)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3970](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970)。
...
-   **修改 Windows XP 和 Windows Server 2003 系统上 shimgvw.dll 的访问控制列表 (ACL)**
    ...
    **注意** 要使用自动化“**Microsoft 修复**”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 2483185](https://support.microsoft.com/kb/2483185)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3970](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970)。此漏洞已在 [Microsoft 安全通报 2490606](https://technet.microsoft.com/security/advisory/2490606) 中描述。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 看到了公开发布的概念证明代码示例，但未收到任何表明此漏洞已被公开用于攻击用户的直接报告。
  
**应用此安全更新有助于客户防止尝试利用此漏洞的已公开发布代码吗？**    
是。 此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2010-3970](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3970)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2483185">Microsoft 知识库文章 2483185</a></td>
</tr>  
<tr class="even">
...
-   Kobi Pariente 和 Yaniv Miron 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 关于 Windows Shell 图形处理溢出漏洞 (CVE-2010-3970) 的联合报告

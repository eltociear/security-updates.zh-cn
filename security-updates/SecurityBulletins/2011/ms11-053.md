...
**已知问题。** [Microsoft 知识库文章 2566220](https://support.microsoft.com/kb/2566220) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6bff74ac-45f3-4585-92da-316921b458fa">Windows Vista Service Pack 1</a>[1]<br />
(KB2561109)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a1e5aa7d-5f38-4ce2-9575-4b4cb7520160">Windows Vista Service Pack 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=849d2694-c8b3-4670-8203-912661bccabf">Windows Vista x64 Edition Service Pack 1</a>[1]<br />
(KB2561109)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4287eeb4-ab29-4727-83f2-260d838b44d4">Windows Vista x64 Edition Service Pack 2</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7f811b75-c3ff-411a-aaa9-126dce34cc01">Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=90b2da71-18f9-46ee-9e3d-b08620ca06aa">Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1</a><br />
(KB2532531)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
Windows Vista Service Pack 1 仅在支持 Bluetooth 2.1 技术的系统上受影响。 安装了 [Windows Vista Feature Pack for Wireless](https://support.microsoft.com/kb/942567) 的 Windows Vista Service Pack 1 客户具有 Bluetooth 2.1 技术支持，因此受此漏洞的影响。 这些客户需要安装安全更新 KB2561109。没有安装 Windows Vista Feature Pack for Wireless 的客户不具有 Bluetooth 2.1 支持，因此不受此漏洞的影响。 有关详细信息，请参阅 [Microsoft 知识库文章 2566220](https://support.microsoft.com/kb/2566220)。
...
为 Windows Vista Service Pack 1 启用了 [Windows Vista Feature Pack for Wireless](https://support.microsoft.com/kb/942567) 的 Windows Vista Service Pack 1 客户以及成功升级到 Windows Vista Service Pack 2 的客户需要安装安全更新 KB2532531。有关详细信息，请参阅 [Microsoft 知识库文章 2566220](https://support.microsoft.com/kb/2566220)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1265](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1265)。
...
**什么是 Bluetooth？**    
Bluetooth 是一种行业标准协议，它使得计算机、手持式设备、移动电话和其他设备能够实现无线连接。 有关详细信息，请参阅 MSDN 文章 [Bluetooth](https://msdn.microsoft.com/en-us/library/aa362932(vs.85).aspx)。
...
是。 Windows Vista 和 Windows 7 支持各种 Bluetooth 无线电设备，当系统中添加了可移除 Bluetooth 设备时将安装 Bluetooth 驱动程序。 因此，Windows Vista 和 Windows 7 所有受支持的版本受影响。 有关详细信息，请参阅 MSDN 文章 [Bluetooth 无线技术常见问题 - 2010](https://msdn.microsoft.com/en-us/windows/hardware/gg487349.aspx)。
...
请参阅 <a href="https://support.microsoft.com/kb/2561109">Microsoft 知识库文章 2561109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Vista Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/2532531">Microsoft 知识库文章 2532531</a></td>
</tr>
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2532531">Microsoft 知识库文章 2532531</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注意</strong> 没有用于验证此更新是否存在的注册表项。</td>

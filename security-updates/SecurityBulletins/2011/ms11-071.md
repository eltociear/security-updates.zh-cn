---
TOCTitle: 'MS11-071'
Title: 'Microsoft 安全公告 MS11-071 - 重要'
ms:assetid: 'ms11-071'
ms:contentKeyID: 61238209
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-071(v=Security.10)'
---


Microsoft 安全公告 MS11-071 - 重要
==================================

Windows 组件中的漏洞可能允许远程执行代码 (2570947)
--------------------------------------------------

发布时间: 2011年9月13日 | 更新时间: 2011年11月8日
...
此安全更新通过更正 Windows 组件加载外部库的方式来解决此漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=70f944b0-9bf0-4168-b150-67d2ff68df2d)                                                                                           | 远程执行代码 | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4b9debed-edbb-43e1-b755-0faf01980289)                                                                  | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d44274d2-0401-4fd8-bc4f-c59f6d81c34f)                                                                                  | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=935720ee-cee0-42c2-965e-ce1b07e95e1a)                                                                      | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=78c2ac72-da89-42a4-bff9-79551b5d3c4e)                                                                  | 远程执行代码 | 重要         | 无               |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=15840336-4886-4a1b-8c1e-2c535c3938f7)                                                                                        | 远程执行代码 | 重要         | 无               |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e80739b4-89bb-4317-8381-991244a71cb8)                                                                            | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=05c39ab3-7b57-4147-8913-df5df6005799)\*                                                               | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1499d988-fd55-4317-b859-ec170907d547)\*                                                          | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6e2d2ea9-0af6-4d23-875d-3211722cd62f)                                                        | 远程执行代码 | 重要         | 无               |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=76b99ab2-7e99-4aad-a419-7996bae05c48)                                             | 远程执行代码 | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0f6d32de-d3ff-4af9-9b26-a4f12581f5fe)                                   | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=a8a451bd-3e5c-4845-9941-daabd9418776)\*       | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0fdfb1f9-20b3-4d61-8019-33d1003290c8) | 远程执行代码 | 重要         | 无               |
...
**为什么在 2011 年 11 月 8 日重新发布此公告？**  
Microsoft 重新发布此公告是为了宣布 Windows 7 Embedded 的更新已可用。鼓励运行此平台的客户下载并向其系统应用此更新。安全更新可从 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 和 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 获得。没有其他更新程序包受此重新发布版本的影响。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“安全更新部署”部分中的参考表。

**此更新是否与 Microsoft 安全通报 2269637 有关？**  
是的，此安全更新解决的 Windows 组件不安全库加载漏洞 (CVE-2011-1991) 与 [Microsoft 安全通报 2269637](https://technet.microsoft.com/security/advisory/2269637) 中介绍的漏洞类别有关，其影响应用程序加载外部库的方式。此安全更新针对这种漏洞的特定实例。
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [9 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-sep)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 组件不安全库加载漏洞 - CVE-2011-1991</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Windows 组件不安全库加载漏洞 - CVE-2011-1991  
--------------------------------------------
  
<span></span>  
特定 Windows 组件处理 DLL 文件加载的方式中存在一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1991](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991)。
  
#### Windows 组件不安全库加载漏洞 (CVE-2011-1991) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   要成功进行攻击，用户必须访问不受信任的远程文件系统位置或 WebDAV 共享，并打开 RFT 文件 (.rtf)、文本文件 (.txt) 或 Word 文档 (.doc) 文件。  
-   外围防火墙通常禁用文件共享协议服务器消息块 (SMB)。这样可限制此漏洞的可能攻击媒介。  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
#### Windows 组件不安全库加载漏洞 (CVE-2011-1991) 的变通办法
...
#### Windows 组件不安全库加载漏洞 (CVE-2011-1991) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
当特定 Windows 组件不正确地限制用于加载外部库的路径时，则会导致该漏洞。
  
**此更新影响哪些漏洞？**  
该更新影响下列组件：显示摇曳 CPL 扩展 (deskpan.dll)、Microsoft EAPHost 验证器服务、Microsoft 管理控制台 (MMC)、文件夹重定向、日语输入法编辑器 (IME) 和超级终端。
  
**什么是显示摇曳控制面板应用程序 (CPL) 扩展？**  
显示摇曳 CPL 扩展 (deskpan.dll) 是一个与用户屏幕上出现的显示设置相关的模块。与相关联的 DLL 配合使用，此扩展使用户能够调整高级显示适配器属性和显示监视器属性。
  
**什么是 Microsoft** **EAPHost** **验证器服务？**  
EAPHost 是一个 Microsoft Windows 联网组件，针对“请求方”协议实施（如 802.1X）和点对点 (PPP) 的身份验证提供可扩展身份验证协议 (EAP) 基础结构。它也允许通过“验证器”技术（如 Microsoft 网络策略服务器 (NPS)）进行身份验证。有关详细信息，请参阅 MSDN 文章[可扩展身份验证协议主机](https://msdn.microsoft.com/en-us/library/aa364249(v=vs.85).aspx)。
  
**什么是 Microsoft 管理控制台 (MMC)？**  
Microsoft 管理控制台 (MMC) 是一项用于管理应用程序的可扩展的公共展示服务。MMC 为由 Microsoft 和第三方软件厂商所提供的管理单元提供了一个公用的主机环境。管理单元提供实际的管理行为，MMC 本身不提供任何管理功能。MMC 环境提供的是在管理单元之间的无缝集成。有关详细信息，请参阅 TechNet文章 [Microsoft 管理控制台 - 概述](https://technet.microsoft.com/en-us/library/bb742441.aspx)。
  
**什么是文件夹重定向组件？**  
文件夹重定向是一项 IntelliMirror 功能，该功能允许用户和管理员将文件夹的路径重定向到新位置。新位置可以是本地计算机的文件夹，或者网络共享中的目录。用户能够在服务器中使用文档，就像这些文档基于本地驱动器一样。例如，您可以将“我的文档”文件夹（通常存储在计算机的本地硬盘上）重定向到网络位置。用户可从网络上的任何计算机使用该文件夹中的文档。有关详细信息，请参阅 TechNet 文章[文件夹重定向概述](https://technet.microsoft.com/en-us/library/cc778976(ws.10).aspx)。
  
**什么是输入方法编辑器（日语）组件？**  
日语输入法编辑器 (IME) 允许用户在文档、工作表、演示文稿、邮件、出版物和网页中输入日语文本。有关此组件和其他可用 IME 的详细信息，请参阅 MSDN 文章[安装和使用输入法编辑器](https://msdn.microsoft.com/en-us/library/ee418266%28v=vs.85%29.aspx)。
  
**什么是超级终端？**  
超级终端是一种程序，可通过调制解调器、非调制解调器电缆或以太网连接连接到其他计算机、远程登录站点、公告板系统 (BBS)、在线服务和主机。
  
**为什么针对此漏洞列出了多个组件？**  
尽管针对此单个漏洞列出了多个组件，但是问题的根本原因在所有组件之间是通用的。
...
**攻击者如何利用此漏洞？**  
攻击者可能诱使用户打开与特制动态链接库 (DLL) 文件位于同一网络目录下的合法 RTF 文件 (.rtf)、文本文件 (.txt) 或 Word 文档 (.doc)。然后，在打开合法文件时，受影响的组件可能尝试加载 DLL 文件并执行其包含的任何代码。
  
在电子邮件攻击情形中，攻击者可能通过向用户发送合法 RTF 文件 (.rtf)、文本文件 (.txt) 或 Word 文档 (.doc)，并诱使用户将附件放在包含特制 DLL 文件的目录下并打开此合法文件，来利用此漏洞。然后，在打开合法文件时，受影响的组件可能尝试加载 DLL 文件并执行其包含的任何代码。
  
在网络攻击情形中，攻击者可能会将合法的 RTF 文件 (.rtf)、文本文件 (.txt) 或 Word 文档 (.doc) 与特制 DLL 文件一起放在网络共享（例如 UNC 或 WebDAV 位置）上，然后诱使用户打开该文件。
  
**受此漏洞威胁最大的系统有哪些？**  
工作站和终端服务器受到的威胁最大。如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**  
此更新通过更正 Windows 组件加载外部库的方式来解决此漏洞。该更新也更正了注册表项以限制外部库加载。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-1991](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1991)。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2570947$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">文件信息</td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2570947">Microsoft 知识库文章 2570947</a></td>
</tr>  
<tr class="even">
...
当您安装此安全更新时，安装程序将检查系统中正在更新的一个或多个文件是否已由 Microsoft *修补程序*更新。
...
-   V2.0（2011 年 11 月 8 日）： 重新发布此公告是为了宣布 Windows 7 Embedded 的更新已可用。没有其他更新程序包受此重新发布版本的影响。

---
TOCTitle: 'MS11-039'
Title: 'Microsoft 安全公告 MS11-039 - 严重'
ms:assetid: 'ms11-039'
ms:contentKeyID: 61238177
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-039(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-039 - 严重
==================================

.NET Framework 和 Microsoft Silverlight 中的漏洞可能允许远程执行代码 (2514842)
------------------------------------------------------------------------------

发布时间: 2011年6月14日 | 更新时间: 2011年10月26日
...
对于 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 以及 Microsoft Silverlight 4 的所有受影响的 Microsoft .NET Framework 版本，此安全更新的等级为“严重”。有关详细信息，请参阅本节的“**受影响和不受影响的软件**”小节。

该安全更新通过更正 .NET Framework 验证传递给受信任的 API 的值来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
**已知问题。**[Microsoft 知识库文章 2514842](https://support.microsoft.com/kb/2514842) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
**此安全更新是否与 MS11-044“NET Framework 中的漏洞可能允许远程执行代码”相关？**  
...
Microsoft Silverlight 内部版本 4.0.60531.0（此安全公告第一次发布时的最新 Microsoft Silverlight 内部版本）可解决该漏洞，不受影响。4.0.60531.0 之前的 Microsoft Silverlight 内部版本受影响。
...
随此安全更新安装的版本是 4.0.60531.0。如果您的版本号高于或等于该版本号，则您的系统将不容易受到攻击。
...
<th>
.NET Framework 数组偏移漏洞 - CVE-2011-0664
</th>
<th>
综合严重等级
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
安装在 Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2 上的 Microsoft .NET Framework 4.0<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
安装在 Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）上的 Microsoft .NET Framework 4.0<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
安装在 Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1 上的 Microsoft .NET Framework 4.0<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
Microsoft .NET Framework 中存在远程执行代码漏洞，它允许特制的 Microsoft .NET 应用程序以不安全方式访问存储器。成功利用此漏洞的攻击者可以在登录用户的安全上下文中运行任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0664](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0664)。

#### .NET Framework 数组偏移漏洞 (CVE-2011-0664) 的缓解因素
...
#### .NET Framework 数组偏移漏洞 (CVE-2011-0664) 的变通办法
...
#### .NET Framework 数组偏移漏洞 (CVE-2011-0664) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
此漏洞是由于 .NET Framework 和 Microsoft Silverlight 不正确地验证传递给内置网络函数的参数导致的。
...
**此更新有什么作用？**  
该更新通过更正 .NET Framework 验证传递给受信任的 API 的值来解决漏洞。
...
| 安装在 Mac 上的 Microsoft Silverlight 3                                                                             | 是   |
| 安装在 Microsoft Windows 客户端的所有版本上的 Microsoft Silverlight 3                                               | 是   |
| 安装在 Microsoft Windows 服务器所有版本上的 Microsoft Silverlight 3                                                 | 是   |
| 安装在 Mac 上的 Microsoft Silverlight 4                                                                             | 是   |
...
| 安装在 Mac 上的 Microsoft Silverlight 3                                                                             | 是                  | 是                         |
| 安装在 Microsoft Windows 客户端的所有版本上的 Microsoft Silverlight 3                                               | 是                  | 是                         |
| 安装在 Microsoft Windows 服务器所有版本上的 Microsoft Silverlight 3                                                 | 是                  | 是                         |
| 安装在 Mac 上的 Microsoft Silverlight 4                                                                             | 是                  | 是                         |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2514842">Microsoft 知识库文章 2514842</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 32 位系统上的 Microsoft .NET Framework 4.0：<br />
HKEY_LOCAL_MACHINE\SOFTWARE\ Microsoft\Updates\Microsoft .NET Framework 4 Client Profile\KB2478663<br />
&quot;ThisVersionInstalled&quot; = &quot;Y&quot;</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于基于 x64 系统上的 Microsoft .NET Framework 4.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于安装在 Windows Server 2003 32 位系统上的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2478663-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于安装在 Windows Server 2003 基于 x64 系统上的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2478663-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 基于 Itanium 的系统上的 Microsoft .NET Framework 3.5：<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于安装在 Windows Server 2003 基于 Itanium 系统上的 Microsoft .NET Framework 4.0：<br />
...
Microsoft .NET Framework 4.0 安全更新支持以下安装开关：
...
Microsoft .NET Framework 3.5.1 安全更新支持以下安装开关：
...
-   Michael J. Liu 报告了 .NET Framework 数组偏移漏洞 (CVE-2011-0664)

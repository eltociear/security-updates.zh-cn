---
TOCTitle: 'MS11-077'
Title: 'Microsoft 安全公告 MS11-077 - 重要'
ms:assetid: 'ms11-077'
ms:contentKeyID: 61238215
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-077(v=Security.10)'
---


Microsoft 安全公告 MS11-077 - 重要
==================================
...
该安全更新通过更正 Windows 内核模式驱动程序验证从用户模式传递的输入、处理 TrueType 字体类型、在写入内存之前分配正确的缓冲区大小和管理内核模式驱动程序对象的方式来解决漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=9157e677-ab3f-44b0-9735-192bc7421ba7)                                                                                           | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0f2444ac-61bd-47cf-9c1e-da86a2b0cfb5)                                                                  | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3bd62bf6-3400-4c03-95fe-148112b341e8)                                                                                  | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b73f4e87-9655-46d5-beb2-ea245dcd280d)                                                                      | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=a618cc19-5ebc-462e-a518-d9bfe41ed98e)                                                                  | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ff53d01b-97b7-40d2-af88-4978f1099a7c)                                                                                        | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=47322e11-f1cf-4f70-b939-8cac9bbfc2bc)                                                                            | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7c7498ee-eba4-44fd-8846-0b2e96c96705)\*                                                               | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=40386742-f397-402e-8810-63d3d6ba12a6)\*                                                          | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3633402b-96cb-4f36-b137-d07d1baf28c7)                                                        | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=9e40bc26-f77f-4b57-9b3d-9d053c19ac56)                                             | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=219554e6-eb5a-42d0-90c0-42b4d0772cfd)                                   | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=39bd4cfb-fe61-41b8-a5a2-73a9e720fc72)\*       | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0d35c6d0-6d2d-42bf-a97f-4c5e01b1937e) | 远程执行代码 | 重要         | [MS11-054](https://go.microsoft.com/fwlink/?linkid=220172) |
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [10 月份公告摘要](https://technet.microsoft.com/en-us/security/bulletin/ms11-oct)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
<tr class="header">
<th>受影响的软件</th>
<th>Win32k 空指针解除引用漏洞 - CVE-2011-1985</th>
<th>Win32k TrueType 字体类型转换漏洞 - CVE-2011-2002</th>
<th>字体库文件缓冲区溢出漏洞 - CVE-2011-2003</th>
<th>Win32k 释放后使用漏洞 - CVE-2011-2011</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
<td style="border:1px solid black;"><strong>中等<br />
</strong>拒绝服务</td>
<td style="border:1px solid black;">不适用</td>
<td style="border:1px solid black;"><strong>重要<br />
</strong>远程执行代码</td>
...
Win32k 空指针解除引用漏洞 - CVE-2011-1985  
-----------------------------------------
  
<span></span>  
Windows 内核模式驱动程序对从用户模式向内核模式提供的数据进行验证的方式存在特权提升漏洞。成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1985](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1985)。
  
#### Win32k 空指针解除引用漏洞 (CVE-2011-1985) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 空指针解除引用漏洞 (CVE-2011-1985) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 空指针解除引用漏洞 (CVE-2011-1985) 的常见问题
  
**此漏洞的影响范围有多大？**  
在 32 位操作系统上，这是一个特权提升漏洞。成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。在基于 x64 和基于 Itanium 的操作系统上，这是一个拒绝服务漏洞。
  
**造成此漏洞的原因是什么？**  
此漏洞由 Windows 内核模式驱动程序未正确验证从用户模式传递的输入而导致。
...
Win32k TrueType 字体类型转换漏洞 - CVE-2011-2002  
------------------------------------------------
  
<span></span>  
当系统不正确地处理特制 TrueType 字体文件时 Microsoft Windows 的实施中存在一个拒绝服务漏洞。成功利用此漏洞的攻击者可能会导致受影响系统停止响应。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2002](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2002)。
  
#### Win32k TrueType 字体类型转换漏洞 (CVE-2011-2002) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。但是在所有情况下，攻击者无法强制用户访问这些网站。相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。  
-   外围防火墙通常禁用文件共享协议 SMB。这样可限制此漏洞的可能远程攻击媒介。
  
#### Win32k TrueType 字体类型转换漏洞 (CVE-2011-2002) 的变通办法
...
-   **禁用** **Web 客户端服务**
    ...
    **变通办法的影响。**当禁用 Web 客户端服务时，不会传输 Web 分布式创作和版本管理 (WebDAV) 请求。此外，所有明确依赖于 WebClient 服务的任何服务将不会启动，并且会在系统日志中记录错误消息。例如，将无法从客户端计算机访问 WebDAV 共享。
...
#### Win32k TrueType 字体类型转换漏洞 (CVE-2011-2002) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个拒绝服务漏洞。
  
**造成此漏洞的原因是什么？**  
当 Windows 内核模式驱动程序无法正确地处理 TrueType 字体类型时会导致该漏洞。
...
**攻击者如何利用此** **漏洞？**  
攻击者可能会将特制 TrueType 字体文件放在网络共享上。然后，当用户导航到 Windows 资源管理器中的共享时，受影响的控制路径通过“详细信息”和“预览”窗格触发。特制 TrueType 字体然后可利用此漏洞并导致系统停止响应。
  
**受此漏洞威胁最大的系统有哪些？**  
工作站和终端服务器受到的威胁最大。如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**  
此更新通过更正 Windows 内核模式驱动程序处理 TrueType 字体类型的方式来解决此漏洞。
...
<span></span>  
由于不正确地处理特制 .fon 字体文件，Windows 内核中存在一个远程执行代码漏洞。该漏洞可能允许攻击者在内核模式中运行代码，然后安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2003](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2003)。
  
#### 字体库文件缓冲区溢出漏洞 (CVE-2011-2003) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   要成功进行远程攻击，用户必须访问不受信任的远程文件系统位置或 WebDAV 共享，并打开特制字体文件（例如 .fon 文件），或者作为电子邮件附件打开文件。  
-   外围防火墙通常禁用文件共享协议 SMB。这样可限制此漏洞的可能远程攻击媒介。
  
#### 字体库文件缓冲区溢出漏洞 (CVE-2011-2003) 的变通办法
...
#### 字体库文件缓冲区溢出漏洞 (CVE-2011-2003) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**造成此漏洞的原因是什么？**  
如果 Windows 内核模式驱动程序在写入缓冲区时未执行正确验证，则会导致该漏洞。
...
**攻击者如何利用此** **漏洞？**  
在网络攻击情形中，攻击者可能会将特制字体文件（例如 .fon 文件）放在网络共享、UNC 或 WebDAV 位置中，然后诱使用户打开该文件。
  
在电子邮件攻击情形中，攻击者可能通过向用户发送特制字体文件，然后诱使用户打开该文件来利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**  
工作站和终端服务器受到的威胁最大。如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**  
此更新通过更正 Windows 内核模式驱动程序在写入内存之前分配正确的缓冲区大小的方式来解决漏洞。
...
Win32k 释放后使用漏洞 - CVE-2011-2011  
-------------------------------------
  
<span></span>  
由于 Windows 内核模式驱动程序管理内核模式驱动程序对象的方式，因此存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2011](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2011)。
  
#### Win32k 释放后使用漏洞 (CVE-2011-2011) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### Win32k 释放后使用漏洞 (CVE-2011-2011) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 释放后使用漏洞 (CVE-2011-2011) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**造成此漏洞的原因是什么？**  
当内核模式驱动程序不正确地管理内核模式驱动程序对象时，会导致该漏洞。
...
**什么是 TrueType 字体？**  
TrueType 字体技术由两部分组成： 字体本身的说明（TrueType 字体文件）和读取字体说明并生成字体的位图表示的程序（TrueType 光栅器）。TrueType 光栅器是作为操作系统组成部分的一个计算机程序。
  
TrueType 字体文件包括多种不同的信息供 TrueType 光栅器和操作系统软件使用，确保计算机屏幕上的显示字符或打印出来的字符与字体设计师的想法完全相同。有关详细信息，请参阅 MSDN 文章“[关于字体嵌入](https://msdn.microsoft.com/en-us/library/ms533034.aspx)”。“受影响的软件”表中列出的所有操作系统默认情况下都支持 EOT 字体呈现。
...
**此更新有什么作用？**  
该更新通过更正 Windows 内核模式驱动程序管理内核模式驱动程序对象的方式来解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2567053$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2567053">Microsoft 知识库文章 2567053</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB2567053$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2567053](https://support.microsoft.com/kb/2567053)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [BitDefender](https://www.bitdefender.com/) 的 Andrei Lutas 报告了 Win32k 空指针解除引用漏洞 (CVE-2011-1985)  
-   [Norman](https://www.norman.com/) 的 Tarjei Mandt 报告了 Win32k 空指针解除引用漏洞 (CVE-2011-1985)  
-   Maik Wellmann 报告了 Win32k TrueType 字体类型转换漏洞 (CVE-2011-2002)  
-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了字体库文件缓冲区溢出漏洞 (CVE-2011-2003)

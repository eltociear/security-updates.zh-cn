---
TOCTitle: 'MS11-087'
Title: 'Microsoft 安全公告 MS11-087 - 严重'
ms:assetid: 'ms11-087'
ms:contentKeyID: 61238225
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-087(v=Security.10)'
---


Microsoft 安全公告 MS11-087 - 严重
==================================
...
此安全更新通过修改 Windows 内核模式驱动程序处理 TrueType 字体文件的方式来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。

此安全更新也解决了最初在 [Microsoft 安全通报 2639658](https://technet.microsoft.com/security/advisory/2639658) 中描述的漏洞。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=b01bb041-005c-48c4-a606-66aa264ba0fa)                                                                                           | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0a872cd2-5f4d-400c-a1c4-a2d194746fb6)                                                                  | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e84e6964-1580-41ef-9d3e-4d0c3ad4cb69)                                                                                  | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9d9f3667-3fd6-4948-83db-282783599f41)                                                                      | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=1ecf72cd-6732-4cf3-aa22-8caf15ea633e)                                                                  | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7f69ec9d-43ad-4106-90ef-c191e7ec43af)                                                                                        | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ae1f1f86-6f13-4e1e-9f93-4f70b6c9927e)                                                                            | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c4ba344d-dd0d-4cfb-81d9-d364d7f37e25)\*\*\*\*                                                         | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=058963f6-9654-41d0-86d2-f25a0c2ad416)\*\*\*\*                                                    | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=42cd1c33-11a7-4a29-ae85-f7272a626f91)                                                        | 远程执行代码 | 严重         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0526727a-f2fb-4846-9b04-f1899f52f1f6)                                             | 远程执行代码 | 严重         | [MS11-084](https://go.microsoft.com/fwlink/?linkid=229245) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=cfd42c42-1595-419a-bf04-b23b64663629)                                   | 远程执行代码 | 严重         | [MS11-084](https://go.microsoft.com/fwlink/?linkid=229245) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d64a31ca-cccd-488a-98fd-c059b9e9e1ea)\*\*\*\* | 远程执行代码 | 严重         | [MS11-084](https://go.microsoft.com/fwlink/?linkid=229245) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b46f6da7-6d24-4262-8e55-3b657db39813) | 远程执行代码 | 严重         | [MS11-084](https://go.microsoft.com/fwlink/?linkid=229245) |
...
**如果我应用了** **Microsoft 安全通报 2639658 中提供的变通办法，是否需要在应用此更新之前撤消变通办法？**  
否。在安装此安全更新之前，无需从之前应用了该更新的系统中撤消“拒绝访问 T2EMBED.DLL”变通办法。

然而，在应用此安全更新之后，您应该从之前应用了该更新的系统中撤销变通办法“拒绝访问 T2EMBED.DLL”以便还原变通办法禁用的功能。要使用自动 Microsoft Fix it 解决方案禁用此变通办法，请参阅 [Microsoft 知识库文章 2639417](https://support.microsoft.com/kb/2639417)。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**Windows Developer Preview 是否受此问题的影响？**  
是的，更新 KB2639417 适用于 Windows Developer Preview 版本。鼓励 Windows Developer Preview 客户向其系统应用此更新。该更新在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供。

**当使用服务器核心安装** **选项进行安装时，为什么此更新适用于 Windows Server 2008 和 Windows Server 2008 R2 的受支持版本，严重等级较低？**  
当使用服务器核心安装选项进行安装时，Windows Server 2008 和 Windows Server 2008 R2 仅容易遭受 CVE-2011-3402 的本地特权提升攻击情形。基于 Web 的攻击情形和文件共享攻击情形不适用。
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008（用于 32 位系统）Service Pack 2（当使用服务器核心安装选项时）
</td>
<td style="border:1px solid black;">
**重要**  
特权提升
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008（用于基于 x64 的系统）Service Pack 2（当使用服务器核心安装选项时）
</td>
<td style="border:1px solid black;">
**重要**  
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1（当使用服务器核心安装选项时）
</td>
<td style="border:1px solid black;">
**重要**  
特权提升
...
由于不正确地处理特制 TrueType 字体文件，Windows 内核中存在一个远程执行代码漏洞。该漏洞可能允许攻击者在内核模式中运行代码，然后安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
...
-   **拒绝访问 T2EMBED.DLL**
    ...
    **注意** 此变通办法仅缓解基于 Web 的攻击情形和文件共享攻击情形。此变通办法不会缓解本地攻击情形。
...
在基于 Web 的攻击情形中，攻击者可能拥有一个旨在利用此漏洞的特制网站，然后诱使用户查看该网站。攻击者无法强制用户查看由攻击者控制的内容。相反，攻击者必须说服用户采取行动，通常是单击电子邮件或即时消息中的链接（该链接会将用户定向到攻击者的网站），或者打开通过电子邮件发送的附件。
...
**此更新有什么作用？**  
此更新通过修改 Windows 内核模式驱动程序处理 TrueType 字体文件的方式来解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2639417$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2639417">Microsoft 知识库文章 2639417</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB2639417$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2639417](https://support.microsoft.com/kb/2639417)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Symantec 和 Laboratory of Cryptography and System Security (CrySyS) 与我们一起处理了 TrueType 字体分析引擎漏洞 (CVE-2011-3402)

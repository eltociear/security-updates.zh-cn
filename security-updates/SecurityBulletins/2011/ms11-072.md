...
**已知问题。** [Microsoft 知识库文章 2587505](https://support.microsoft.com/kb/2587505) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[Microsoft Excel 2010（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=4612c6e4-ac29-4cc4-9da5-88779ea3643e)  
(KB2553070)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 Service Pack 1（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=4612c6e4-ac29-4cc4-9da5-88779ea3643e)  
(KB2553070)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Excel 2010（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=d40db27b-1318-4ca7-b44f-c90bb6342109)  
(KB2553070)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Excel 2010 Service Pack 1（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=d40db27b-1318-4ca7-b44f-c90bb6342109)  
(KB2553070)
</td>
<td style="border:1px solid black;">
远程执行代码
...
当 Microsoft Excel 2003 中启用了 Office 文件验证功能时，可用于利用 CVE-2011-1986 和 CVE-2011-1987 中所述的漏洞的特制文件不会自动打开；默认情况下，系统会提示用户选择是否打开此类文件。在漏洞可以被利用之前，用户必须单击警告才能打开文件。有关 Microsoft Excel 2003 中的 Office 文件验证的详细信息，请参阅 [Microsoft 安全通报 2501584](https://www.microsoft.com/technet/security/advisory/2501584.mspx)。

当 Microsoft Excel 2007 中启用了 Office 文件验证功能时，可用于利用 CVE-2011-1987 中所述的漏洞的特制文件不会自动打开；默认情况下，系统会提示用户选择是否打开此类文件。在漏洞可以被利用之前，用户必须单击警告才能打开文件。有关 Microsoft Excel 2007 中的 Office 文件验证的详细信息，请参阅 [Microsoft 安全通报 2501584](https://www.microsoft.com/technet/security/advisory/2501584.mspx)。

默认情况下，Microsoft Excel 2010 中启用了 Office 文件验证。可用于利用 CVE-2011-1987 中所述的漏洞的特制文件未通过验证，将在[受保护的视图](https://www.microsoft.com/security/pc-security/office2010.aspx)中打开；然后，用户必须单击许多警告消息，才可以打开文件进行编辑，漏洞才可以被利用。

**如果在 Excel 2003 中禁止打开未通过文件验证的文件，则有何好处？**  
通过将 Office 文件验证设置为不允许在 Excel 2003 中打开可疑文件，[Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584) 中提供的 **Microsoft Fix it** 解决方案“禁止在 Excel 2003 和 2007 中打开文档”可阻止利用 CVE-2011-1986 和 CVE-2011-1987 中介绍的漏洞的攻击媒介。

有关应用自动 Fix it 解决方案“对 Excel 2003 和 2007 禁止打开文档”的说明，请参阅 [Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584)；有关手动应用解决方案的说明，请参阅本公告的“漏洞信息”部分中 CVE-2011-1986 和 CVE-2011-1987 的“变通办法”部分。

**如果在 Excel 2007 中禁止打开未通过文件验证的文件，则有何好处？**  
通过将 Office 文件验证设置为不允许在 Excel 2007 中打开可疑文件，[Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584) 中提供的 **Microsoft Fix it** 解决方案“禁止在 Excel 2003 和 2007 中打开文档”可阻止利用 CVE-2011-1987 中介绍的漏洞的攻击媒介。

有关应用自动 Fix it 解决方案“对 Excel 2003 和 2007 禁止打开文档”的说明，请参阅 [Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584)；有关手动应用解决方案的说明，请参阅本公告的“漏洞信息”部分中 CVE-2011-1987 的“变通办法”部分。

**如果在 Excel 2010 中禁止打开未通过文件验证的文件，则有何好处？**  
[Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584) 中提供的自动 **Microsoft Fix it** 解决方案“为 Excel 2010 禁用受保护视图编辑操作”可阻止利用 CVE-2011-1987 的攻击媒介。如果客户选择以后再安装 Excel 2010 的安全更新，则可以选择应用该 Fix it 解决方案作为变通办法。

有关应用自动 Fix it 解决方案“为 Excel 2010 禁用受保护视图编辑操作”的说明，请参阅 [Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584)；或者，有关手动应用该解决方案的说明，请参阅本公告的“漏洞信息”中 CVE-2011-1987 的“变通方法”部分。
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [9 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-sep)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/security/cc998259)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1986](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1986)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1987](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1987)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1988](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1988)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1989](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1989)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1990](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1990)。
...
-   **使用 Microsoft Office 文件阻止策略禁止打开来自未知或不可信来源和位置的 Office 2003 以及较早版本的文档。**
    ...
    **变通办法的影响。** 对于 Microsoft Office 2007，配置了文件阻止策略但是尚未配置特殊例外目录或将文件移动到可信位置的用户将无法打开 Office 2003 文件或更早版本。有关 Microsoft Office 软件中的文件阻止设置的影响的详细信息，请参阅 [Microsoft 知识库文章 922850](https://support.microsoft.com/kb/922850)。
...
**Microsoft Office SharePoint Server 2007 备注** 上述检测表基于单服务器 Microsoft Office SharePoint Server 2007 部署。检测工具不检测到配置为多系统 SharePoint 服务器场的一部分的系统上的更新的适用性。有关在独立和多服务器配置上部署更新的详细信息，请参阅 TechNet 文章“[为 Office SharePoint Server 2007 部署软件更新](https://technet.microsoft.com/en-us/library/cc263467(office.12).aspx)”。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2553072">Microsoft 知识库文章 2553072</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2007 Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/2553073">Microsoft 知识库文章 2553073</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office 2007 Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/2553089">Microsoft 知识库文章 2553089</a><br />
请参阅 <a href="https://support.microsoft.com/kb/2553090">Microsoft 知识库文章 2553090</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Excel Viewer Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/2553075">Microsoft 知识库文章 2553075</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包：<br />
请参阅 <a href="https://support.microsoft.com/kb/2553074">Microsoft 知识库文章 2553074</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2010 和 Microsoft Excel 2010 Service Pack 1（32 位版本）：<br />
请参阅 <a href="https://support.microsoft.com/kb/2553070">Microsoft 知识库文章 2553070</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office 2010 和 Microsoft Office 2010 Service Pack 1（32 位版本）：<br />
请参阅 <a href="https://support.microsoft.com/kb/2553091">Microsoft 知识库文章 2553091</a><br />
请参阅 <a href="https://support.microsoft.com/kb/2553096">Microsoft 知识库文章 2553096</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2010 和 Microsoft Excel 2010 Service Pack 1（64 位版本）：<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Excel Web App：<br />
请参阅 <a href="https://support.microsoft.com/kb/2553095">Microsoft 知识库文章 2553095</a></td>
</tr>
<tr class="even">
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=868f4d9f-3498-4d59-a017-59204553889c)下载和安装 Microsoft Office 2004 for Mac 11.6.5 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=afa79cfc-6e8a-4d0b-88aa-0d7e05031e44)下载和安装 Microsoft Office 2008 for Mac 12.3.1 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=535fcf4a-eeb2-44eb-b2a6-9c512509c49d)下载和安装 Microsoft Office for Mac 2011 14.1.3 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=9796588d-238f-4694-9598-1aa8d2becb55)下载和安装 Open XML File Format Converter for Mac 1.2.1 Update 的合适语言版本。
...
请参阅 <a href="https://support.microsoft.com/kb/2553093">Microsoft 知识库文章 2553093</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office SharePoint Server 2007 Service Pack 2 上安装的 Excel Services（64 位版本）：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2553094">Microsoft 知识库文章 2553094</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel 释放后使用 WriteAV 漏洞 (CVE-2011-1986)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了 Excel 超出界限数组索引漏洞 (CVE-2011-1987)  
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel 堆损坏漏洞 (CVE-2011-1988)  
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Excel 条件表达式分析漏洞 (CVE-2011-1989)  
-   Omair 与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Excel 超出界限数组索引漏洞 (CVE-2011-1990)

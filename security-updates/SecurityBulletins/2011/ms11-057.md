...
纵深防御更新之一可增强用户的系统配置能力，从而阻止 Internet Explorer 中的跨域拖放操作。 有关此已增强功能的详细信息，请参阅 [Microsoft 知识库文章 2581921](https://support.microsoft.com/kb/2581921)。

**什么是纵深防御？**
在信息安全性中，纵深防御指的是采取多层防御来帮助阻止攻击者危及网络或系统安全的一种方法。

**此更新是否包含任何其他与安全性无关的功能更改？**  
是的，此更新解决了保护模式旁路问题，公开引用 [CVE-2011-1347](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1347)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1257)。
...
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)”的受限模式下运行。 此模式可减轻此漏洞。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题解答”部分。
...
-   **以纯文本格式阅读电子邮件**
    ...
    Microsoft Outlook 2003、Microsoft Outlook 2007 和 Microsoft Outlook 2010 提供一个读取纯文本格式电子邮件的选项。 有关**读取所有纯文本标准邮件**选项的详细信息，请参阅 [Microsoft 知识库文章 831607](https://support.microsoft.com/kb/831607)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1960](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1960)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1961](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1961)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1962](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1962)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-1962](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1962)。

**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。

**应用此安全更新是否有助于客户防止可能会尝试利用此漏洞的已公开发布的代码？**  
是。 此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2011-1962](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1962)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1963](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1963)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1964](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1964)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2383](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2383)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-2383](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2383)。

**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。

**应用此安全更新是否有助于客户防止可能会尝试利用此漏洞的已公开发布的代码？**  
是。 此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2011-2383](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2383)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2559049">Microsoft 知识库文章 2559049</a></td>
</tr>  
<tr class="even">
...
-   [Opera Software ASA](https://www.opera.com/) 的Yngve N. Pettersen 报告了事件处理程序信息泄露漏洞 (CVE-2011-1960)  
-   [Lostmon Lords](https://lostmon.blogspot.com) 报告了窗口打开竞争条件漏洞 (CVE-2011-1257)  
-   Security Professionals Network Inc. 的 Makoto Shiotsuki 报告了 Telnet 处理程序远程执行代码漏洞 (CVE-2011-1961)  
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 XSLT 内存损坏漏洞 (CVE-2011-1963)  
-   [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了样式对象内存损坏漏洞 (CVE-2011-1964)  
-   [Google Inc.](https://www.google.com/) 的 Michal Zalewski 与我们一起努力处理了此公告中涵盖的纵深防御更改问题  
-   [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 和 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 与我们合作帮助改善 Internet Explorer 中的保护模式功能

...
截至 2011 年 12 月 13 日，Microsoft 不再支持 Microsoft Office Pinyin SimpleFast Style 2010 和 Microsoft Office Pinyin New Experience Style 2010。如要继续接收支持， Microsoft 建议所有使用这些版本的客户升级到 Microsoft Pinyin IME 2010 的最近版本（可通过 Micosoft Office 2010 获取）。对于此 Pinyin IME 版本的所有安全更新可通过标准分布渠道获得，包括[Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747)。

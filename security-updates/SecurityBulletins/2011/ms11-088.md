...
**已知问题。** [Microsoft 知识库文章 2652016](https://support.microsoft.com/kb/2652016) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
截至 2011 年 12 月 13 日，Microsoft 不再支持 Microsoft Office Pinyin SimpleFast Style 2010 和 Microsoft Office Pinyin New Experience Style 2010。如要继续接收支持， Microsoft 建议所有使用这些版本的客户升级到 Microsoft Pinyin IME 2010 的最近版本（可通过 Microsoft Office 2010 获取）。对于此 Pinyin IME 版本的所有安全更新可通过标准分布渠道获得，包括[Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2010](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2010)。
...
<a href="https://support.microsoft.com/kb/2596511">Microsoft 知识库文章 2596511</a></td>
</tr>
<tr class="even">

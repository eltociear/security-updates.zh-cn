...
**已知问题。**[Microsoft 知识库文章 2544641](https://support.microsoft.com/kb/2544641) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1895](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1895)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1896)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1897](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1897)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1969](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1969)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2012](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2012)。
...
<td style="border:1px solid black;">对于 Forefront Unified Access Gateway 2010 (KB2522482)：<br />
请参阅 <a href="https://support.microsoft.com/kb/2522482">Microsoft 知识库文章 2522482</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Forefront Unified Access Gateway 2010 Update 1 (KB2522483)：<br />
请参阅 <a href="https://support.microsoft.com/kb/2522483">Microsoft 知识库文章 2522483</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Forefront Unified Access Gateway 2010 Update 2 (KB2522484)：<br />
请参阅 <a href="https://support.microsoft.com/kb/2522484">Microsoft 知识库文章 2522484</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Forefront Unified Access Gateway 2010 Service Pack 1 (KB2522485)：<br />
请参阅 <a href="https://support.microsoft.com/kb/2522485">Microsoft 知识库文章 2522485</a></td>
</tr>
<tr class="even">
...
-   [Tenable Network Security](https://www.tenable.com/) 报告了 ExcelTable 响应拆分 XSS 漏洞 (CVE-2011-1895)
-   [Tenable Network Security](https://www.tenable.com/) 报告了 ExcelTable 响应拆分 XSS 漏洞 (CVE-2011-1895)
-   [Tenable Network Security](https://www.tenable.com/) 报告了 ExcelTable 反映的 XSS 漏洞 (CVE-2011-1896)
-   [SEC Consult Unternehmensberatung GmbH](https://www.sec-consult.com/) 的 Elisabeth Demeter 报告了中毒代码执行漏洞 (CVE-2011-1969)

...
**已知问题。**[Microsoft 知识库文章 2586448](https://support.microsoft.com/kb/2586448) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
Microsoft 修订此公告是为了宣布发布了一个修补程序，以解决影响 Internet Explorer 7 客户的问题，即他们在安装 KB2586448 安全更新后一些下拉列表和组合框在 Internet Explorer 7 中没有出现。有关此问题的详细信息以及有关如何应用此修补程序以解决问题的说明，请参阅 [Microsoft 知识库文章 2586448](https://support.microsoft.com/kb/2586448)。
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [10 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-oct)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1993](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1993)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1995](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1995)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1996](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1996)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1997](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1997)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1998](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1998)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1999](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1999)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2000](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2000)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2001](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2001)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2586448">Microsoft 知识库文章 2586448</a></td>
</tr>  
<tr class="even">
...
-   Ivan Fratric 与 [TippingPoint's](https://www.tippingpoint.com)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了选项元素远程执行代码漏洞 (CVE-2011-1996)  
-   [GWSlabs](https://www.gwslabs.com) 与 [VeriSign iDefense Labs](https://labs.idefense.com) 合作报告了 OnLoad 事件远程执行代码漏洞 (CVE-2011-1997)  
-   [Greplin](https://www.greplin.com) 的 David Bloom 报告了 Jscript9.dll 事件远程执行代码漏洞 (CVE-2011-1998)  
-   Ivan Fratric 与 [TippingPoint's](https://www.tippingpoint.com)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了选择元素远程执行代码漏洞 (CVE-2011-1999)  
-   Sebastian Apelt 与 [TippingPoint's](https://www.tippingpoint.com)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了主体元素远程执行代码漏洞 (CVE-2011-2000)  
-   一位匿名研究人员与 [TippingPoint's](https://www.tippingpoint.com)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了虚拟功能表损坏远程执行代码漏洞 (CVE-2011-2001)  
-   [Google Inc.](https://www.google.com) 的 Eduardo Vela Nava 和 [Greplin](https://www.greplin.com) 的 David Bloom 与我们一起努力处理了此公告中包括的纵深防御更改  
-   [Soroush Dalili](https://www.secproject.com) 与我们一起努力处理了此公告中包括的纵深防御更改  
-   [Google Inc.](https://www.google.com) 的 Billy Rios 与我们一起努力处理了此公告中包括的纵深防御更改

---
TOCTitle: 'MS11-013'
Title: 'Microsoft 安全公告 MS11-013 - 重要'
ms:assetid: 'ms11-013'
ms:contentKeyID: 61238151
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-013(v=Security.10)'
---
...
Kerberos 中的漏洞可能允许特权提升 (2496930)
-------------------------------------------

发布时间: 2011年2月8日 | 更新时间: 2011年3月16日
...
对于 Windows XP、Windows Server 2003、Windows 7 和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节的“**受影响和不受影响的软件**”小节。

此更新通过通过阻止在 Windows Kerberos 和 Windows KDC 中使用弱哈希算法，以及防止客户端将客户端和服务器之间的 Kerberos 通信加密标准降级到 DES 来解决这些漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=486d1969-6814-4556-8dc0-5bfbaee528b0">Windows XP Service Pack 3</a><br />
(KB2478971)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a210c796-7077-4617-a9a8-9ea99fe11a5e">Windows XP Professional x64 Edition Service Pack 2</a><br />
(KB2478971)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8a1e2675-0bf0-4d94-b48a-6e846dd6d9f5">Windows Server 2003 Service Pack 2</a><br />
(KB2478971)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=181196">MS10-014</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e79bbbd4-8d5a-4c4c-8427-21c14400f041">Windows Server 2003 x64 Edition Service Pack 2</a><br />
(KB2478971)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=181196">MS10-014</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=856fbcc2-ead9-4ec1-92dd-988e6d22dae9">Windows Server 2003 SP2（用于基于 Itanium 的系统）</a><br />
(KB2478971)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=181196">MS10-014</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ffed7c76-0b75-4f57-9b63-3961a8b449f6">Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1</a><br />
(KB2425227)</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c26cebcf-683f-4a51-be75-76535fb979a7">Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1</a><br />
(KB2425227)</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=46bb3ef1-24c3-41cb-8141-0fdbd85093f7">Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1</a>*<br />
(KB2425227)</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=01737933-e7de-451b-b02f-b7ca24693965">Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1</a><br />
(KB2425227)</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="header">  
<th>受影响的软件</th>  
<th>Kerberos Unkeyed 校验和漏洞 - CVE-2011-0043</th>  
<th>Kerberos 欺骗漏洞 - CVE-2011-0091</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
...
Kerberos Unkeyed 校验和漏洞 - CVE-2011-0043  
-------------------------------------------
  
<span></span>  
Kerberos 的实施中存在特权提升漏洞。 漏洞存在的原因是 Microsoft Kerberos 实施支持弱哈希机制，此机制允许伪造 Kerberos 服务票证的特定方面。 成功利用此漏洞的恶意攻击者可通过提升在受影响系统上的特权来获取一个令牌。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0043](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043)。
  
#### Kerberos Unkeyed 校验和漏洞 (CVE-2011-0043) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在域控制器运行 Windows Server 2008 或 Windows Server 2008 R2 的域中，可以防止此漏洞被利用。  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Kerberos Unkeyed 校验和漏洞 (CVE-2011-0043) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Kerberos Unkeyed 校验和漏洞 (CVE-2011-0043) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 通过身份验证的本地攻击者可在系统上运行恶意服务，然后该服务可发送特制服务票证来获取授予该攻击者在该系统上具有更高特权的令牌。
  
**造成此漏洞的原因是什么？**    
此漏洞由 Microsoft Windows 中的 Microsoft Kerberos 实施支持弱哈希机制（如 CRC32）导致。
...
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以在本地系统的安全上下文中运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建具有这些提升权限的新帐户。
  
**攻击者如何利用此漏洞？**    
通过身份验证并且可以使用有限特权安装恶意 Kerberos 应用程序的本地攻击者可以通过在已加入域的计算机上安装此类恶意服务来利用此漏洞。 然后，此服务可生成特制 Kerberos 服务票证，此票证允许攻击者获取本地计算机上的系统级别特权。
  
**受此漏洞威胁最大的系统有哪些？**    
工作站和终端服务器受到的威胁最大。 当没有足够管理权限的用户被授予登录到服务器并运行程序的权限时，服务器会更有危险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**    
此更新通过防止在 Windows Kerberos 和 Windows KDC 中使用弱哈希算法解决该漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-0043](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0043)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已被公开用于攻击客户的信息，也没有看到任何发布的概念代码证明示例。
  
Kerberos 欺骗漏洞 - CVE-2011-0091  
---------------------------------
  
<span></span>  
Windows 7 和 Windows Server 2008 R2 上的 Kerberos 实施中存在欺骗漏洞。此漏洞存在的原因是可以将 Kerberos 身份验证降级为使用 DES 代替 Windows 7 和 Windows Server 2008 R2 中包括的默认较强加密标准。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0091](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0091)。
  
#### Kerberos 欺骗漏洞 (CVE-2011-0091) 的缓解因素：
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   此漏洞仅影响 Kerberos 身份验证。
  
#### Kerberos 欺骗漏洞 (CVE-2011-0091) 的变通办法：
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Kerberos 欺骗漏洞 (CVE-2011-0091) 的常见问题：
  
**此漏洞的影响范围有多大？**    
这是欺骗漏洞。 此漏洞可使攻击者模仿合法用户的凭据或伪造受影响会话中的所有 Kerberos 通信。
  
**造成此漏洞的原因是什么？**    
此漏洞由 Windows 未正确强制执行 Windows 7 和 Windows Server 2008 R2 中包括的较强默认加密标准而导致，这使中间人攻击者可以强制客户端和服务器之间的 Kerberos 通信降级为弱于原始协商标准的加密标准。
...
**攻击者可能利用此漏洞执行什么操作？**    
攻击者可将默认加密标准降级为 DES。 然后，他们可以读取和伪造该会话中的所有 Kerberos 通信。 攻击者可使用此功能来模仿在该 Kerberos 会话期间进行身份验证的用户。
  
**攻击者如何利用此漏洞？**    
在中间人攻击情况中，攻击者必须介于目标客户端和服务器之间来截取通信和将默认加密标准降级为 DES。
  
**受此漏洞威胁最大的系统有哪些？**    
使用 Kerberos 身份验证的 Windows 7 和 Windows Server 2008 R2 系统容易受到此降级攻击的危害。
  
**此更新有什么作用？**    
此更新通过阻止中间人攻击者将客户端和服务器之间的 Kerberos 通信的加密标准降级为 DES 来解决该漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2478971$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2478971">Microsoft 知识库文章 2478971</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2425227">Microsoft 知识库文章 2425227</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [The MIT Kerberos Team](https://web.mit.edu/kerberos) 关于 Kerberos Unkeyed 校验和漏洞 (CVE-2011-0043) 的报告  
-   [iSEC Partners](https://www.isecpartners.com/) 的 Scott Stender 关于 Kerberos 欺骗漏洞 (CVE-2011-0091) 的报告
...
-   V2.0（2011 年 3 月 16 日）： 阐明了受影响的软件包括 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1、Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1。请参阅可说明此修订的“**与此安全更新相关的常见问题 (FAQ)**”部分的条目。

---
TOCTitle: 'MS11-060'
Title: 'Microsoft 安全公告 MS11-060 - 重要'
ms:assetid: 'ms11-060'
ms:contentKeyID: 61238198
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-060(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-060 - 重要
==================================
...
此安全更新解决 Microsoft Visio 中两个秘密报告的漏洞。 如果用户打开特制的 Visio 文件，这些漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

对于 Microsoft Visio 2003、Microsoft Visio 2007 和 Microsoft Visio 2010 的所有受支持版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过更正 Microsoft Visio 在分析特制 Visio 文件时验证内存中的对象的方式解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=866d64b3-7147-4b5f-80fe-4d3317f140df">Microsoft Visio 2003 Service Pack 3</a><br />
(KB2553009)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a0eeabde-5a92-45ae-aef6-81b7bdb4e0cd">Microsoft Visio 2007 Service Pack 2</a><br />
(KB2553010)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=204799">MS11-008</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6da236c2-0ef5-4c13-8393-673b70298a77">Microsoft Visio 2010 和 Microsoft Visio 2010 Service Pack 1（32 位版本）</a><br />
(KB2553008)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b7f5f2a9-116a-41ef-a19e-a7dd0947d2cb">Microsoft Visio 2010 和 Microsoft Visio 2010 Service Pack 1（64 位版本）</a><br />
(KB2553008)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="header">  
<th>受影响的软件</th>  
<th>pStream 释放 RCE 漏洞 - CVE-2011-1972</th>  
<th>移动块 RCE 漏洞 - CVE-2011-1979</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Visio 2010（32 位版本）和 Microsoft Visio 2010（32 位版本）Service Pack 1</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Visio 2010（64 位版本）和 Microsoft Visio 2010（64 位版本）Service Pack 1</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;">不适用</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
...
pStream 释放 RCE 漏洞 - CVE-2011-1972  
-------------------------------------
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1972](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1972)。
  
#### pStream 释放 RCE 漏洞 (CVE-2011-1972) 的缓解因素
...
#### pStream 释放 RCE 漏洞 (CVE-2011-1972) 的变通办法
...
#### pStream 释放 RCE 漏洞 (CVE-2011-1972) 的常见问题
...
移动块 RCE 漏洞 - CVE-2011-1979  
-------------------------------
  
<span></span>  
Microsoft Visio 在解析特制 Visio 文件时验证内存中对象的方式存在远程代码执行漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1979](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1979)。
  
#### 移动块 RCE 漏洞 (CVE-2011-1979) 的缓解因素
...
#### 移动块 RCE 漏洞 (CVE-2011-1979) 的变通办法
...
#### 移动块 RCE 漏洞 (CVE-2011-1979) 的常见问题
...
| Microsoft Visio 2010（32 位版本）和 Microsoft Visio 2010（32 位版本）Service Pack 1 | 是   |  
| Microsoft Visio 2010（64 位版本）和 Microsoft Visio 2010（64 位版本）Service Pack 1 | 是   |
...
| Microsoft Visio 2010（32 位版本）和 Microsoft Visio 2010（32 位版本）Service Pack 1 | 是                  | 是                         |  
| Microsoft Visio 2010（64 位版本）和 Microsoft Visio 2010（64 位版本）Service Pack 1 | 是                  | 是                         |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2553009">Microsoft 知识库文章 2553009</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2553010">Microsoft 知识库文章 2553010</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2553008">Microsoft 知识库文章 2553008</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Baidu Security Team](https://www.baidu.com) 的 Linlin Zhao 报告了 pStream 释放 RCE 漏洞 (CVE-2011-1972)  
-   [Baidu Security Team](https://www.baidu.com) 的 Linlin Zhao 报告了移动块 RCE 漏洞 (CVE-2011-1979)

...
**已知问题。**[Microsoft 知识库文章 2500212](https://support.microsoft.com/kb/2500212) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1a21c9db-dfa3-4a07-a1e0-89a8069b7c17">Microsoft Visual Studio 2010 Service Pack 1</a><br />
(KB2565057)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3190](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3190)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3190](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3190)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2465373">Microsoft 知识库文章 2465373</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2538218">Microsoft 知识库文章 2538218</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2538241">Microsoft 知识库文章 2538241</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Visual Studio 2010：<br />
请参阅 <a href="https://support.microsoft.com/kb/2542054">Microsoft 知识库文章 2542054</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Visual Studio 2010 Service Pack 1：<br />
请参阅 <a href="https://support.microsoft.com/kb/2565057">Microsoft 知识库文章 2565057</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Microsoft Visual Studio 2010：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2538242">Microsoft 知识库文章 2538242</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Microsoft Visual C++ 2005 Service Pack 1 Redistributable Package (x86)：<br />
...
有关如何使用产品代码验证安装的说明，请参阅 [Microsoft 知识库文章 974653](https://support.microsoft.com/kb/974653)。
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2538243">Microsoft 知识库文章 2538243</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Microsoft Visual C++ 2008 Service Pack 1 Redistributable Package (x86)：<br />
...
请参阅 <a href="https://support.microsoft.com/kb/2467173">Microsoft 知识库文章 2467173</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Visual C++ 2010 Redistributable Package Service Pack 1：<br />
请参阅 <a href="https://support.microsoft.com/kb/2565063">Microsoft 知识库文章 2565063</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>

---
TOCTitle: 'MS11-028'
Title: 'Microsoft 安全公告 MS11-028 - 严重'
ms:assetid: 'ms11-028'
ms:contentKeyID: 61238166
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-028(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-028 - 严重
==================================

.NET Framework 中的漏洞可能允许远程执行代码 (2484015)
-----------------------------------------------------

发布时间: 2011年4月12日 | 更新时间: 2011年11月30日
...
该安全更新通过更正 .NET Framework 处理某些类型的函数调用的方式来消除此漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。**[Microsoft 知识库文章 2484015](https://support.microsoft.com/kb/2484015) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
**为什么在 2011 年 6 月 14 日修订此公告？**  
Microsoft 修订此安全公告是为了宣布 KB2446709 的 Windows Update (WU) 程序包中的检测更改。WU 程序包现在可正确地列出此更新替代的公告。这只是检测更改。已经成功更新了其系统的客户不需要执行任何操作。

**为什么在 2011 年 5 月 10 日重新发布此公告？**  
Microsoft 重新发布此公告是为了重新提供修补程序 KB979744 和安全更新 KB2446709 和 KB2449742，可解决会影响 SQL 和 Exchange 服务器的已知问题。[Microsoft 知识库文章 2540222](https://support.microsoft.com/kb/2540222) 中详细介绍了此问题。对于安装了修补程序 KB979744 的原始版本 (V1) 的客户，此更新将自动提供并安装安全更新和修补程序 KB979744 的新版本。已成功更新其系统但是没有安装修补程序 KB979744 的客户不需要重新安装此更新。
...
两种配置文件中提供 .NET Framework 版本 4 可再次分发程序包： .NET Framework 4.0 和 .NET Framework 4.0 客户端配置文件。.NET Framework 4.0 客户端配置文件是优化用于客户端应用程序的 .NET Framework 4.0 配置文件的子集。它提供适用于大多数客户端应用程序的功能，包括 Windows Presentation Foundation (WPF)、Windows Forms、Windows Communication Foundation (WCF) 和 ClickOnce 功能。这可加快针对 .NET Framework 4.0 客户端配置文件的应用程序的部署速度并减小其安装程序包。有关详细信息，请参阅 [.NET Framework 客户端配置文件](https://msdn.microsoft.com/en-us/library/5a4x27ek.aspx)。
...
<th>
.NET Framework 堆栈损坏漏洞 - CVE-2010-3958
</th>
<th>
综合严重等级
</th>
...
<tr>
<td style="border:1px solid black;">
Windows XP Service Pack 3 上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition Service Pack 2 上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 SP2（用于基于 Itanium 的系统）上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2 上的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1\*\*
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1\*\*
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2 上的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
安装在 Windows XP Service Pack 3 上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
安装在 Windows XP Professional x64 Edition Service Pack 2 上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
安装在 Windows Server 2003 Service Pack 2 上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
安装在 Windows Server 2003 x64 Edition Service Pack 2 上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
安装在 Windows Server 2003 SP2（用于基于 Itanium 的系统）上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
安装在 Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
安装在 Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
安装在 Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2 上的 Microsoft .NET Framework 4.0\*\*
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
安装在 Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上的 Microsoft .NET Framework 4.0\*\*
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
安装在 Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2 上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
安装在 Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1 上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1 上安装的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
安装在 Windows Server 2008 R2（用于基于 x64 的系统）上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
安装在 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 上的 Microsoft .NET Framework 4.0\*
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
安装在 Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1 上的 Microsoft .NET Framework 4.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
Microsoft .NET Framework 处理某些函数调用的方式中存在一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3958](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958)。

#### .NET Framework 堆栈损坏漏洞 (CVE-2010-3958) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。但是在所有情况下，攻击者无法强制用户访问这些网站。相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“增强安全配置”的受限模式下运行。此模式仅在 Windows Server 2008 和 Windows Server 2008 R2 上，以及仅在基于 Web 的攻击情形中减轻此漏洞的影响。有关 Internet [Explorer 增强安全](https://go.microsoft.com/fwlink/?linkid=92039)配置的详细信息，请参阅此漏洞的“常见问题”部分。
...
#### .NET Framework 堆栈损坏漏洞 (CVE-2010-3958) 的变通办法
...
#### .NET Framework 堆栈损坏漏洞 (CVE-2010-3958) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
当 .NET Framework 中的 x86 JIT 编译器错误地编译某些类型的函数调用时，则会导致此漏洞。
...
**什么是 CLR？**  
Microsoft .NET Framework 提供一个称为公用语言运行时 (CLR) 的运行时环境，该环境运行代码并提供使开发过程变得更容易的服务。有关 CLR 的详细信息，请参阅 MSDN 文章“[公用语言运行时概述](https://msdn.microsoft.com/en-us/library/ddk909ch(vs.71).aspx)”。
...
**此更新有什么作用？**  
此更新通过更正 .NET Framework 中的 x86 JIT 编译器处理某些类型的函数调用的方式来解决此漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3958](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958)。
...
<td style="border:1px solid black;">对于 Windows XP Service Pack 3 上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1：<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Professional x64 Edition Service Pack 2 上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1：<br />
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2484015">Microsoft 知识库文章 2484015</a></td>
</tr>  
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2003 Service Pack 2 上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1：<br />
NDP20SP2-KB2446704-v2-x86.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 Service Pack 2 上安装的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2446708-x86.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 x64 Edition Service Pack 2 上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1：<br />
NDP20SP2-KB2446704-v2-x64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 x64 Edition Service Pack 2 上安装的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2446708-x64.exe /q</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 SP2（用于基于 Itanium 的系统）上安装的 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1：<br />
NDP20SP2-KB2446704-v2-IA64.exe /q</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 SP2（用于基于 Itanium 的系统）上安装的 Microsoft .NET Framework 4.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上安装的 Microsoft .NET Framework 4.0：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上安装的 Microsoft .NET Framework 4.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2 上安装的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2446708-x86.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上安装的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2446708-x64.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2 上安装的 Microsoft .NET Framework 4.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1 上安装的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2446708-x86.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1 上安装的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2446708-x64.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">安装而不重新启动</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 上安装的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2446708-x64.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 R2（用于基于 Itanium 的系统和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 上安装的 Microsoft .NET Framework 4.0：<br />
NDP40-KB2446708-ia64.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">安装而不重新启动</td>
...
-   V2.0（2011 年 5 月 10 日）： 重新发布此公告是为了重新提供更新 KB2446709 和 KB2449742。这可解决安装了修补程序 KB979744 的 SQL 和 Exchange 服务器的已知问题。  
-   V2.1（2011 年 6 月 14 日）： 添加了一个更新常见问题，以宣布可更正 Windows 7 和 Windows Server 2008 R2 的受支持版本上的 Microsoft .NET Framework 3.5.1 的替代公告的检测更改。这只是检测更改。没有更改安全更新文件。已经成功更新了其系统的客户不需要执行任何操作。  
-   V2.2（2011 年 6 月 22 日）： 更正了公告替代信息。这仅仅是一个公告更改。检测或安全更新文件未发生更改。  
-   V2.3（2011 年 10 月 26 日）： 更正了 Microsoft Windows 的 32 位版本上 .NET Framework 4 的公告替代信息。这仅仅是一个公告更改。检测或安全更新文件未发生更改。还更正了 Windows Server 2008 R2（用于基于 x64 的系统）上 .NET Framework 4 的服务器核心安装适用性。  
-   V2.4（2011 年 11 月 30 日）： 更正了 Windows 7（用于基于 x64 的系统）Service Pack 1、Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1 上 .NET Framework 4 的公告替代信息。这仅仅是一个公告更改。检测或安全更新文件未发生更改。

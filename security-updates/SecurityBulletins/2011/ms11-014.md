---
TOCTitle: 'MS11-014'
Title: 'Microsoft 安全公告 MS11-014 - 重要'
ms:assetid: 'ms11-014'
ms:contentKeyID: 61238152
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-014(v=Security.10)'
---
...
本地安全机构子系统服务中的漏洞可能允许本地特权提升 (2478960)
------------------------------------------------------------

发布时间: 2011年2月8日 | 更新时间: 2011年4月28日
...
此安全更新可解决 Windows XP 和 Windows Server 2003 中的本地安全授权子系统服务 (LSASS) 中秘密报告的漏洞。对于这些操作系统的所有受支持版本，此安全更新等级为“重要”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此漏洞在攻击者登录系统并运行特制应用程序时允许提升特权。 攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。

此安全更新通过更正 LSASS 处理身份验证过程中使用的特定值的方式解决该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。** [Microsoft 知识库文章 2478960](https://support.microsoft.com/kb/2478960) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=541f228f-79b3-402a-8ff9-366c1e595227)                          | 特权提升     | 重要         | 无                                                        |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=82189bf2-3f34-4949-92da-eea98036d18e) | 特权提升     | 重要         | [MS08-002](https://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4e31e6b1-577e-468e-9c94-67227d2273c2)                 | 特权提升     | 重要         | [MS08-002](https://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=76e3c229-d812-433c-ad05-7cbd1f9c6a6d)     | 特权提升     | 重要         | [MS08-002](https://go.microsoft.com/fwlink/?linkid=104921) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=a0cde8d8-7c85-4fcb-bcf7-205064970b41) | 特权提升     | 重要         | [MS08-002](https://go.microsoft.com/fwlink/?linkid=104921) |
...
<tr class="header">
<th>受影响的软件</th>
<th>LSASS 长度验证漏洞 - CVE-2011-0039</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
LSASS 长度验证漏洞 - CVE-2011-0039  
----------------------------------
  
<span></span>  
Microsoft Windows 本地安全授权子系统服务 (LSASS) 处理特制身份验证请求的方式存在特权提升漏洞。 该漏洞能够允许攻击者使用提升的特权运行代码。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0039](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0039)。
  
#### LSASS 长度验证漏洞 (CVE-2011-0039) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### LSASS 长度验证漏洞 (CVE-2011-0039) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### LSASS 长度验证漏洞 (CVE-2011-0039) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**造成此漏洞的原因是什么？**    
此漏洞由 Windows LSASS 处理特制身份验证请求而导致。
...
**此更新有什么作用？**    
此更新通过更正 LSASS 处理身份验证过程中使用的特定值的方式解决该漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2478960$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2478960">Microsoft 知识库文章 2478960</a></td>
</tr>  
<tr class="even">
...
-   Primavera BSS 的安全测试员 Jorge Moura 关于 LSASS 长度验证漏洞 (CVE-2011-0039) 的报告
...
-   V1.1（2011 年 4 月 28 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2478960 添加一个链接。

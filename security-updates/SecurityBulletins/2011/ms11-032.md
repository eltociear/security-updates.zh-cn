---
TOCTitle: 'MS11-032'
Title: 'Microsoft 安全公告 MS11-032 - 严重'
ms:assetid: 'ms11-032'
ms:contentKeyID: 61238170
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-032(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-032 - 严重
==================================

OpenType 压缩字体格式 (CFF) 驱动程序中的漏洞可能允许远程执行代码 (2507618)
--------------------------------------------------------------------------
...
此安全更新解决了 OpenType 压缩字体格式 (CFF) 驱动程序中一个秘密报告的漏洞。 如果用户查看用特制 CFF 字体呈现的内容，则该漏洞可能允许远程代码执行。 在所有情况下，攻击者无法强制用户查看特制内容。 相反，攻击者必须蛊惑用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
...
该安全更新通过更正 OpenType 字体 (OTF) 驱动程序分析特制 OpenType 字体的方式来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=9080c5a1-e638-4047-a70a-9367f1acced7)                                                                                           | 特权提升     | 重要         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2374e09a-cb3e-4bc3-bb4b-53b611025121)                                                                  | 特权提升     | 重要         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5d71d3f5-fd6b-4f3b-8389-37c899748d4b)                                                                                  | 特权提升     | 重要         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3a498ff0-21d9-493a-b127-6bc20f1baf95)                                                                      | 特权提升     | 重要         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=c71f4398-2e3b-4b81-a650-8806e618db7f)                                                                  | 特权提升     | 重要         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e7c4fc81-d1ef-4378-862b-e955d75fb2de)                                                        | 远程执行代码 | 严重         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8d654a78-0e4f-452c-8874-fbf478813857)                                | 远程执行代码 | 严重         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9105377e-83c7-4010-8fd6-26e42e98c2cc)\*                       | 远程执行代码 | 严重         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=060e8b20-edca-4427-9d60-eb57261eb668)\*             | 远程执行代码 | 严重         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2b8571cb-2dae-4bff-9f13-feb89840044c)       | 远程执行代码 | 严重         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=751c45ea-0943-4948-807f-8716c6ff9198)                                             | 远程执行代码 | 严重         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=976c882a-bc07-4128-927f-82a2df46cf45)                                   | 远程执行代码 | 严重         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=6f2a52cc-4833-448d-becc-2eac1a447410)\*       | 远程执行代码 | 严重         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c6ca0b7c-8151-4d54-aa9b-5ec2b75d8ab6) | 远程执行代码 | 严重         | [MS11-007](https://go.microsoft.com/fwlink/?linkid=208059) |
...
<tr class="header">
<th>受影响的软件</th>
<th>OpenType 字体堆栈溢出漏洞 - CVE-2011-0034</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
OpenType 字体堆栈溢出漏洞 - CVE-2011-0034  
-----------------------------------------
  
<span></span>  
OpenType 字体 (OTF) 驱动程序不正确分析特制 OpenType 字体的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0034](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0034)。
  
#### OpenType 字体堆栈溢出漏洞 (CVE-2011-0034) 的缓解因素
...
#### OpenType 字体堆栈溢出漏洞 (CVE-2011-0034) 的变通办法
...
#### OpenType 字体堆栈溢出漏洞 (CVE-2011-0034) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**    
此漏洞由 Windows OpenType 压缩字体格式 ( CFF ) 驱动程序未正确验证特制 OpenType 字体的参数值导致。
...
**什么是 OpenType 压缩字体格式 (CFF) 字体？**    
OpenType CFF 字体是包含 PostScript 类型 1 轮廓的一种 OpenType 字体。 OpenType 字体可以包含 PostScript 类型 1 或 TrueType 轮廓。 所有 Microsoft Windows 字体都包含 TrueType 轮廓。 Adobe InDesign 和 QuarkXpress 等桌面印刷应用支持大部分 OpenType 功能。 Adobe Photoshop 和 Adobe Illustrator 也支持多种功能。 Microsoft Office Publisher 和 Microsoft Office Word 中已增加了对通用 OpenType 功能的支持。 有关详细信息，请参阅 [Microsoft Typography OpenType 常见问题。](https://www.microsoft.com/typography/opentypefaq.mspx)
...
**此更新有什么作用？**    
该更新通过更正 OpenType 字体 (OTF) 驱动程序分析特制 OpenType 字体的方式来解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2507618$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2507618">Microsoft 知识库文章 2507618</a></td>
</tr>  
<tr class="even">
...
-   [Fontlab Ltd.](https://www.fontlab.com/) 的 Adam Twardoch 报告了 OpenType 字体堆栈溢出漏洞 (CVE-2011-0034)

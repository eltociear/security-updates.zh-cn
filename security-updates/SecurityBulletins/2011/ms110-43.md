---
TOCTitle: 'MS11-043'
Title: 'Microsoft 安全公告 MS11-043 - 严重'
ms:assetid: 'ms11-043'
ms:contentKeyID: 61238181
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-043(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-043 - 严重
==================================

SMB 客户端中的漏洞可能允许远程执行代码 (2536276)
------------------------------------------------

发布时间: 2011年6月14日 | 更新时间: 2013年7月9日
...
此安全更新可解决 Microsoft Windows 中一个秘密报告的漏洞。如果攻击者将特制的 SMB 响应发送到客户端发起的 SMB 请求，此漏洞可能允许远程执行代码。若要利用该漏洞，攻击者必须说服用户启动到特制 SMB 服务器的 SMB 连接。

对于 Microsoft Windows 所有受支持的版本，此安全更新的等级为“严重”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

通过更正 SMB 客户端处理特制的 SMB 响应的方式，此安全更新解决了该漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。**[Microsoft 知识库文章 2536276](http://support.microsoft.com/kb/2536276) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=492310d3-bbb4-4fff-b5fe-3470c17e7681)                                                                                     | 远程执行代码 | 严重         | [MS11-019](http://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e10a4c3c-2ef8-4cfc-ac9b-4d97bfa79ac1)                                                            | 远程执行代码 | 严重         | [MS11-019](http://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2719e0fb-3cfd-47b2-906d-3e07b0e3c978)                                                                            | 远程执行代码 | 严重         | [MS11-019](http://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c962531e-f580-4195-989b-cf348cc96fa7)                                                                | 远程执行代码 | 严重         | [MS11-019](http://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=ea18a916-03cf-4eac-bacc-ceb006491f24)                                                            | 远程执行代码 | 严重         | [MS11-019](http://go.microsoft.com/fwlink/?linkid=212314) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a62edfd8-9016-4bb5-bf48-885498fa0042)                                                  | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cb561ba6-af4d-40cc-947c-923f9cca9a7e)                          | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8ab9679e-6a69-4ca3-9210-7ca4fb1980c2)\*                 | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=22c63fc3-2c5a-4e50-9026-2e04a6e74210)\*       | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5bb889de-8ff6-4587-8ef9-ffb13e8d60fd) | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=19a15098-1754-4536-a9ca-ff07d16464b7)                                                                                   | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=19a15098-1754-4536-a9ca-ff07d16464b7)                                                                     | 远程执行代码 | 严重         | 无                                                        |
| [Windows 7（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=b449f23e-b3df-46e5-bfe3-98268d20ad54)                                                                              | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b449f23e-b3df-46e5-bfe3-98268d20ad54)                                                                | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=06008192-3cac-477b-a913-83eed39d8718)\*                                                               | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=06008192-3cac-477b-a913-83eed39d8718)\*                                                 | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=93a32bd9-7e67-4ace-8c45-116f91b032f9)                                                             | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=93a32bd9-7e67-4ace-8c45-116f91b032f9)                                               | 远程执行代码 | 严重         | 无                                                        |
...
Microsoft 重新发布此公告是为了在受支持的操作系统上重新提供安全更新 KB2536276。新提供的这个更新可解决更新 KB2536276 的原始版本 (V1) 带来的稳定性问题。所有受支持的操作系统将自动被提供此更新的新版本。已成功更新其系统的客户应该重新安装此更新。
...
<tr class="header">
<th>受影响的软件</th>
<th>SMB 响应分析漏洞 - CVE-2011-1268</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
SMB 响应分析漏洞 - CVE-2011-1268  
--------------------------------
  
<span></span>  
Microsoft 服务器消息块 (SMB) 客户端实施处理特制的 SMB 响应的方式中存在未经身份验证的远程执行代码漏洞。利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过将特制的 SMB 响应发送到客户端发起的 SMB 请求来利用该漏洞。成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1268](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1268)。
  
#### SMB 响应分析漏洞 (CVE-2011-1268) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。在这种情况下，应阻止从 Internet 入站和出站访问 SMB 端口。
  
#### SMB 响应分析漏洞 (CVE-2011-1268) 的变通办法
...
#### SMB 响应分析漏洞 (CVE-2011-1268) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**    
此漏洞的存在原因是 Microsoft 服务器消息块 (SMB) 客户端实施错误地处理特制 SMB 响应。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2536276$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2536276">Microsoft 知识库文章 2536276</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">要卸载 WUSA 安装的更新，请使用 /Uninstall 安装开关，或者单击“<strong>控制面板</strong>”，单击“<strong>系统和安全</strong>”，然后在 Windows Update 下单击“<strong>查看安装的更新</strong>”，并从更新列表中进行选择。
<p><strong>或者</strong></p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2536276">Microsoft 知识库文章 2536276</a></td>
...
-   V1.1（2011 年 6 月 22 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2536276 添加一个链接。  
-   V2.0（2011 年 8 月 9 日）： 重新发布了该公告，在受支持的所有操作系统上重新提供更新以解决稳定性问题。已成功更新其系统的客户应该重新安装此更新。  
-   V2.1（2011 年 9 月 21 日）： 更正了“**安全更新部署**”部分关于 Windows XP 和 Windows Server 2003 的注册表项验证条目。  
-   V2.2 （2013 年 7 月 9 日）： 公告经过修订，宣布在 2536276 更新的 Windows Vista 程序包中的一个检测更改，以解决一个 Windows Update 重新提供问题。这只是检测更改。已经成功更新了其系统的客户不需要执行任何操作。

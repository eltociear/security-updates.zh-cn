---
TOCTitle: 'MS11-050'
Title: 'Microsoft 安全公告 MS11-050 - 严重'
ms:assetid: 'ms11-050'
ms:contentKeyID: 61238188
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-050(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-050 - 严重
==================================

Internet Explorer 的累积性安全更新 (2530548)
--------------------------------------------

发布时间: 2011年6月14日 | 更新时间: 2011年8月9日
...
对于 Windows 客户端上的 Internet Explorer 6、Internet Explorer 7、Internet Explorer 8 和 Internet Explorer 9，此安全更新的等级为“严重”；对于 Windows 服务器上的 Internet Explorer 6，此安全更新的等级为“中等”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过修改 Internet Explorer 强制实施 Web 服务器提供的内容设置、使用 toStaticHTML 处理 HTML 清理、处理内存中的对象以及在某些过程中处理脚本的方式来解决漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[Internet Explorer 9](https://www.microsoft.com/download/details.aspx?familyid=392316fc-f531-469c-aa60-4ecf061a5354)
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 9](https://www.microsoft.com/download/details.aspx?familyid=44b2aa73-c318-47ac-ad87-0d24afd9cdd7)
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 9](https://www.microsoft.com/download/details.aspx?familyid=7f9b1ba2-8247-494b-990c-f62003188c5a)\*\*
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<td style="border:1px solid black;">
[Internet Explorer 9](https://www.microsoft.com/download/details.aspx?familyid=fdf88a52-c099-44eb-95a0-650129c0e678)\*\*
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
是。 除了本公告的“**漏洞信息**”部分列出的更改之外，此更新还包括一个纵深防御更新，可帮助改进 Internet Explorer 中的内存保护。 其中一个纵深防御更新可解决一个内存地址泄露问题，公开称为 [CVE-2011-1346](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1346)。
...
<th>
MIME 探查信息泄露漏洞 - CVE-2011-1246
</th>
<th>
链接属性处理内存损坏漏洞 - CVE-2011-1250
</th>
<th>
DOM 操作内存损坏漏洞 - CVE-2011-1251
</th>
<th>
toStaticHTML 信息泄露漏洞 - CVE-2011-1252
</th>
<th>
拖放内存损坏漏洞 - CVE-2011-1254
</th>
<th>
时间元素内存损坏漏洞 - CVE-2011-1255
</th>
</tr>
<tr>
...
<sup>[1]</sup>严重等级不适用于指定软件的此更新，因为本公告中讨论的漏洞的已知攻击媒介已在默认配置中阻止。 然而，由于容易受到攻击的代码存在，Microsoft 建议此软件的客户应用此安全更新。
...
<th>
DOM 修改内存损坏漏洞 - CVE-2011-1256
</th>
<th>
拖放信息泄露漏洞 - CVE-2011-1258
</th>
<th>
布局内存损坏漏洞 - CVE-2011-1260
</th>
<th>
选择对象内存损坏漏洞 - CVE-2011-1261
</th>
<th>
HTTP 重定向内存损坏漏洞 - CVE-2011-1262
</th>
<th>
综合严重等级
</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1246](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1246)。

#### MIME 探查信息泄露漏洞 (CVE-2011-1246) 的缓解因素
...
#### MIME 探查信息泄露漏洞 (CVE-2011-1246) 的变通办法
...
#### MIME 探查信息泄露漏洞 (CVE-2011-1246) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个信息泄露漏洞。 当用户下载 Web 内容时，利用此漏洞的攻击者可能会强制浏览器执行非预期操作，从而允许攻击者查看其他域或 Internet Explorer 区域而不是攻击者网页的域或区域中的内容。
...
**攻击者如何利用此漏洞？**  
攻击者可能会上载旨在通过 Internet Explorer 利用此漏洞的特制 Web 内容，然后诱使用户下载该 Web 内容。 攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。 这些网站可能包含可以利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站并下载其内容。 相反，攻击者必须说服用户访问该网站并下载其内容，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。

它还可能使用横幅广告或其他方式显示特制的 Web 内容，以便将 Web 内容传递至受影响的系统。

**受此漏洞威胁最大的系统有哪些？**  
要利用此漏洞执行任何恶意操作，需要用户登录，并访问网站和尝试下载特制的内容。 因此，任何频繁使用 Internet Explorer 的系统（如工作站或终端服务器）受此漏洞的威胁最大。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1250](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1250)。

#### 链接属性处理内存损坏漏洞 (CVE-2011-1250) 的缓解因素
...
#### 链接属性处理内存损坏漏洞 (CVE-2011-1250) 的变通办法
...
#### 链接属性处理内存损坏漏洞 (CVE-2011-1250) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1251](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1251)。

#### DOM 操作内存损坏漏洞 (CVE-2011-1251) 的缓解因素
...
#### DOM 操作内存损坏漏洞 (CVE-2011-1251) 的变通办法
...
#### DOM 操作内存损坏漏洞 (CVE-2011-1251) 的常见问题
...
#### toStaticHTML 信息泄露漏洞 (CVE-2011-1252) 的缓解因素
...
-   默认情况下，Microsoft Outlook、Microsoft Outlook Express 和 Windows Mail 的所有受支持版本在“受限站点”区域打开 HTML 电子邮件（会禁用脚本和 ActiveX 控件），可帮助降低攻击者使用此漏洞执行恶意代码的风险。 在基于 Web 的攻击情形中，如果用户单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)”的受限模式下运行。 此模式可减轻此漏洞。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题解答”部分。
-   Internet Explorer 6和 Internet Explorer 9 不受此漏洞影响。

#### toStaticHTML 信息泄露漏洞 (CVE-2011-1252) 的变通办法
...
#### toStaticHTML 信息泄露漏洞 (CVE-2011-1252) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个信息泄露漏洞。 当用户查看使用 toStaticHTML API 的网页时，利用此漏洞的攻击者可能会针对该站点在用户的安全上下文中执行脚本。

**造成此漏洞的原因是什么？**  
Internet Explorer 中包括的 toStaticHTML API 在清理 HTML 时处理使用特定字符串的内容的方式中存在漏洞。
...
**攻击者可能利用此漏洞执行什么操作？**  
当用户查看网站上的 HTML，并且绕过了通过 toStaticHTML API 执行的用户数据处理时，成功利用此漏洞的攻击者可能会针对该网站在用户的安全上下文中执行脚本。
...
**受此漏洞威胁最大的系统有哪些？**  
要利用此漏洞执行任何恶意操作，需要用户登录和访问使用 toStaticHTML API 处理用户数据的网站。 因此，任何频繁使用 Internet Explorer 的系统（如工作站或终端服务器）受此漏洞的威胁最大。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1254](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1254)。

#### 拖放内存损坏漏洞 (CVE-2011-1254) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   在基于 Web 的攻击情形中，攻击者可能拥有一个旨在通过 Internet Explorer 利用此漏洞的特制网站，然后诱使用户查看该网站，并对上面的内容执行拖放操作。 攻击者也可能在宿主 IE 呈现引擎的应用程序或 Microsoft Office 文档中嵌入标有“安全初始化”的 ActiveX 控件。 攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。 这些网站可能包含可以利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户查看由攻击者控制的内容。 相反，攻击者必须说服用户采取行动，通常是单击电子邮件或即时消息中的链接（该链接会将用户定向到攻击者的网站），或者打开通过电子邮件发送的附件；此外，攻击者必须说服用户执行拖放操作。
-   成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
-   默认情况下，Microsoft Outlook、Microsoft Outlook Express 和 Windows Mail 的所有受支持版本在“受限站点”区域打开 HTML 电子邮件（会禁用脚本和 ActiveX 控件），可帮助降低攻击者使用此漏洞执行恶意代码的风险。 在基于 Web 的攻击情形中，如果用户单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)”的受限模式下运行。 此模式可减轻此漏洞。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题解答”部分。
-   Internet Explorer 9 不受此漏洞的影响。

#### 拖放内存损坏漏洞 (CVE-2011-1254) 的变通办法
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1255](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1255)。

#### 时间元素内存损坏漏洞 (CVE-2011-1255) 的缓解因素
...
#### 时间元素内存损坏漏洞 (CVE-2011-1255) 的变通办法
...
#### 时间元素内存损坏漏洞 (CVE-2011-1255) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1256](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1256)。

#### DOM 修改内存损坏漏洞 (CVE-2011-1256) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   在基于 Web 的攻击情形中，攻击者可能拥有一个旨在通过 Internet Explorer 利用此漏洞的特制网站，然后诱使用户在攻击者的网站上执行复制/粘贴操作。 攻击者也可能在宿主 IE 呈现引擎的应用程序或 Microsoft Office 文档中嵌入标有“安全初始化”的 ActiveX 控件。 攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。 这些网站可能包含可以利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户查看由攻击者控制的内容。 相反，攻击者必须说服用户采取行动，通常是单击电子邮件或即时消息中的链接（该链接会将用户定向到攻击者的网站），或者打开通过电子邮件发送的附件。
-   要触发此漏洞，需要大量用户交互。
-   默认情况下，Microsoft Outlook、Microsoft Outlook Express 和 Windows Mail 的所有受支持版本在“受限站点”区域打开 HTML 电子邮件（会禁用脚本和 ActiveX 控件），可帮助降低攻击者使用此漏洞执行恶意代码的风险。 在基于 Web 的攻击情形中，如果用户单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)”的受限模式下运行。 此模式可减轻此漏洞。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题解答”部分。
-   Internet Explorer 9 不受此漏洞的影响。

#### DOM 修改内存损坏漏洞 (CVE-2011-1256) 的变通办法
...
#### DOM 修改内存损坏漏洞 (CVE-2011-1256) 的常见问题
...
**攻击者如何利用此漏洞？**  
攻击者可能拥有一个旨在通过 Internet Explorer 利用此漏洞的特制网站，然后诱使用户在攻击者的网站上执行复制/粘贴操作。 攻击者也可能在宿主 IE 呈现引擎的应用程序或 Microsoft Office 文档中嵌入标有“安全初始化”的 ActiveX 控件。 攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。 这些网站可能包含可以利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户查看由攻击者控制的内容。 相反，攻击者必须说服用户采取行动，通常是单击电子邮件或即时消息中的链接（该链接会将用户定向到攻击者的网站），或者打开通过电子邮件发送的附件。

**受此漏洞威胁最大的系统有哪些？**  
要利用此漏洞执行任何恶意操作，需要用户登录、访问网站并执行复制/粘贴操作。 因此，任何频繁使用 Internet Explorer 的系统（如工作站或终端服务器）受此漏洞的威胁最大。
...
Internet Explorer 中存在一个信息泄露漏洞，可能允许脚本访问另一个域或 Internet Explorer 区域中的信息。 攻击者可通过构建一个特制网页来利用该漏洞，如果用户查看该网页并执行拖放操作，则该网页可能允许信息泄露。 成功利用此漏洞的攻击者可查看其他域或 Internet Explorer 区域中的内容。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1258](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1258)。

#### 拖放信息泄露漏洞 (CVE-2011-1258) 的缓解因素
...
#### 拖放信息泄露漏洞 (CVE-2011-1258) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个信息泄露漏洞。 在用户查看网页并执行拖放操作时，利用此漏洞的攻击者可查看其他域或 Internet Explorer 区域而不是攻击者网页的域或区域中的内容。
...
**攻击者如何利用此漏洞？**  
攻击者可能拥有一个旨在通过 Internet Explorer 利用此漏洞的特制网站，然后诱使用户查看该网站，并执行拖放操作。 攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。 这些网站可能包含可以利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站，然后说服他们执行拖放操作。 它还可能使用横幅广告或其他方式显示特制的 Web 内容，以便将 Web 内容传递至受影响的系统。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1260](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1260)。

#### 布局内存损坏漏洞 (CVE-2011-1260) 的缓解因素
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1261](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1261)。

#### 选择对象内存损坏漏洞 (CVE-2011-1261) 的缓解因素
...
#### 选择对象内存损坏漏洞 (CVE-2011-1261) 的变通办法
...
#### 选择对象内存损坏漏洞 (CVE-2011-1261) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1262](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1262)。

#### HTTP 重定向内存损坏漏洞 (CVE-2011-1262) 的缓解因素
...
#### HTTP 重定向内存损坏漏洞 (CVE-2011-1262) 的变通办法
...
#### HTTP 重定向内存损坏漏洞 (CVE-2011-1262) 的常见问题
...
<p>使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2530548$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie7updates\KB2530548-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie8updates\KB2530548-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2530548">Microsoft 知识库文章 2530548</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2530548$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
-   [Google Inc.](https://www.google.com/) 的 Robert Swiecki 报告了 MIME 探查信息泄露漏洞 (CVE-2011-1246)  
-   [NSFocus Security Team](https://www.nsfocus.com/) 报告了 链接属性处理内存损坏漏洞 (CVE-2011-1250)  
-   一位匿名研究人员与 [Beyond Security's SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) 计划团队合作报告了 DOM 操作内存损坏漏洞 (CVE-2011-1251)  
-   [IBM Rational Application Security](https://blog.watchfire.com/) 的 Adi Cohen 报告了 toStaticHTML 信息泄露漏洞 (CVE-2011-1252)  
-   [Trend Micro](https://www.trendmicro.com/) 与我们一起努力处理了 toStaticHTML 信息泄露漏洞 (CVE-2011-1252)  
-   [Norman](https://www.norman.com) 的 Nirmal Singh Bhary 报告了拖放内存损坏漏洞 (CVE-2011-1254)  
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了时间元素内存损坏漏洞 (CVE-2011-1255)  
-   Damian Put 与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 DOM 修改内存损坏漏洞 (CVE-2011-1256)  
-   [salesforce.com](https://www.salesforce.com/) 的产品安全小组的 Yoel Gluck、Yogesh Badwe 和 Varun Badhwar 报告了拖放信息泄露漏洞 (CVE-2011-1258)  
-   Jose Antonio Vazquez Gonzalez 与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了布局内存损坏漏洞 (CVE-2011-1260)  
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了选择对象内存损坏漏洞 (CVE-2011-1261)  
-   Peter Winter-Smith 与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 HTTP 重定向内存损坏漏洞 (CVE-2011-1262)  
-   [Harmony Security](https://www.harmonysecurity.com/)的 Stephen Fewer 和 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 与我们一起处理了本公告中涉及的纵深防御更改
...
-   V1.1（2011 年 8 月 9 日）： 阐明此安全更新中包括的其中一个纵深防御更改可解决一个内存地址泄露问题，公开称为 CVE-2011-1346。这仅仅是一个信息更改。

...
是。 除了本公告的“**漏洞信息**”部分列出的更改之外，此更新还包括一个纵深防御更新，可帮助改进 Internet Explorer 中的内存保护。 其中一个纵深防御更新可解决一个内存地址泄露问题，公开称为 [CVE-2011-1346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1346)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1246](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1246)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1250)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1251)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1254)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1255)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1256)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1258)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1260)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1261)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1262](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1262)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2530548">Microsoft 知识库文章 2530548</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc.](http://www.google.com/) 的 Robert Swiecki 报告了 MIME 探查信息泄露漏洞 (CVE-2011-1246)  
-   [NSFocus Security Team](http://www.nsfocus.com/) 报告了 链接属性处理内存损坏漏洞 (CVE-2011-1250)  
-   一位匿名研究人员与 [Beyond Security's SecuriTeam Secure Disclosure](http://www.beyondsecurity.com/ssd.html) 计划团队合作报告了 DOM 操作内存损坏漏洞 (CVE-2011-1251)  
-   [IBM Rational Application Security](http://blog.watchfire.com/) 的 Adi Cohen 报告了 toStaticHTML 信息泄露漏洞 (CVE-2011-1252)  
-   [Trend Micro](http://www.trendmicro.com/) 与我们一起努力处理了 toStaticHTML 信息泄露漏洞 (CVE-2011-1252)  
-   [Norman](http://www.norman.com) 的 Nirmal Singh Bhary 报告了拖放内存损坏漏洞 (CVE-2011-1254)  
-   一位匿名研究人员与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了时间元素内存损坏漏洞 (CVE-2011-1255)  
-   Damian Put 与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 DOM 修改内存损坏漏洞 (CVE-2011-1256)  
-   [salesforce.com](http://www.salesforce.com/) 的产品安全小组的 Yoel Gluck、Yogesh Badwe 和 Varun Badhwar 报告了拖放信息泄露漏洞 (CVE-2011-1258)  
-   Jose Antonio Vazquez Gonzalez 与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了布局内存损坏漏洞 (CVE-2011-1260)  
-   一位匿名研究员与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了选择对象内存损坏漏洞 (CVE-2011-1261)  
-   Peter Winter-Smith 与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 HTTP 重定向内存损坏漏洞 (CVE-2011-1262)  
-   [Harmony Security](http://www.harmonysecurity.com/)的 Stephen Fewer 和 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 与我们一起处理了本公告中涉及的纵深防御更改

---
TOCTitle: 'MS11-012'
Title: 'Microsoft 安全公告 MS11-012 - 重要'
ms:assetid: 'ms11-012'
ms:contentKeyID: 61238150
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-012(v=Security.10)'
---
...
Windows 内核模式驱动程序中的漏洞可能允许特权提升 (2479628)
----------------------------------------------------------
...
此安全更新可解决 Microsoft Windows 中秘密报告的五个漏洞。 如果攻击者本地登录并运行特制应用程序，这些漏洞可能允许特权提升。 攻击者必须拥有有效的登录凭据并能本地登录才能利用这些漏洞。 匿名用户无法利用这些漏洞，也无法以远程方式利用这些漏洞。

对于 Microsoft Windows 所有受支持的版本，此安全更新的等级为“重要”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过更正 Windows 内核模式驱动程序验证从用户模式传递的输入的方式解决此漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=56f4f43e-c313-49dc-a278-e3e8a83a907e)                                                                                           | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e80db313-b470-4d71-bc34-70bfbfb6579f)                                                                  | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=54fe2669-8a63-4d96-8b82-5b10f45b293e)                                                                                  | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4632e1ce-6ae8-431c-9104-9a8840e5ac63)                                                                      | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=a09c3e6e-c55c-492a-b7ad-3e3d35711643)                                                                  | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6fb7ebcc-2052-457b-b5bc-1bbcb17696b9)                                                        | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=88d68757-1ab0-4585-9578-52a474b10882)                                | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=80494972-db45-475f-97cd-dac46b9486a1)\*                       | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5597d449-17e3-440f-8b0e-56a902a96569)\*             | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d10eda21-b3c3-4d8e-8596-bc45e4165f93)       | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=078fe6c0-1b2c-4896-a345-25cc1b1105e2)                                             | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b42642b3-fb78-4700-bfe8-bfa997b90c16)                                   | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d2c53f44-12eb-4293-9fa5-2a14075b636e)\*       | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=8c6bf720-f544-4f58-9b1c-2399957ec43d) | 特权提升     | 重要         | [MS10-098](https://go.microsoft.com/fwlink/?linkid=204869) |
...
<tr class="header">
<th>受影响的软件</th>
<th>Win32k 不正确用户输入验证漏洞 - CVE-2011-0086</th>
<th>Win32k 不充分用户输入验证漏洞 - CVE-2011-0087</th>
<th>Win32k 窗口类指针混乱漏洞 - CVE-2011-0088</th>
<th>Win32k 窗口类不正确指针漏洞 - CVE-2011-0089</th>
<th>Win32k 内存损坏漏洞 - CVE-2011-0090</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Win32k 不正确用户输入验证漏洞 - CVE-2011-0086  
---------------------------------------------
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0086](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0086)。
  
#### Win32k 不正确用户输入验证漏洞 (CVE-2011-0086) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 不正确用户输入验证漏洞 (CVE-2011-0086) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 不正确用户输入验证漏洞 (CVE-2011-0086) 的常见问题
...
Win32k 不充分用户输入验证漏洞 - CVE-2011-0087  
---------------------------------------------
  
<span></span>  
Windows 内核模式驱动程序对从用户模式向内核模式提供的数据进行验证的方式存在特权提升漏洞。 成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0087)。
  
#### Win32k 不充分用户输入验证漏洞 (CVE-2011-0087) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 不充分用户输入验证漏洞 (CVE-2011-0087) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 不充分用户输入验证漏洞 (CVE-2011-0087) 的常见问题
...
Win32k 窗口类指针混乱漏洞 - CVE-2011-0088  
-----------------------------------------
  
<span></span>  
Windows 内核模式驱动程序对从用户模式向内核模式提供的数据进行验证的方式存在特权提升漏洞。 成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0088)。
  
#### Win32k 窗口类指针混乱漏洞 (CVE-2011-0088) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 窗口类指针混乱漏洞 (CVE-2011-0088) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 窗口类指针混乱漏洞 (CVE-2011-0088) 的常见问题
...
Win32k 窗口类不正确指针漏洞 - CVE-2011-0089  
-------------------------------------------
  
<span></span>  
Windows 内核模式驱动程序对从用户模式向内核模式提供的数据进行验证的方式存在特权提升漏洞。 成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0089](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0089)。
  
#### Win32k 窗口类不正确指针漏洞 (CVE-2011-0089) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 窗口类不正确指针漏洞 (CVE-2011-0089) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 窗口类不正确指针漏洞 (CVE-2011-0089) 的常见问题
...
Win32k 内存损坏漏洞 - CVE-2011-0090  
-----------------------------------
  
<span></span>  
Windows 内核模式驱动程序对从用户模式向内核模式提供的数据进行验证的方式存在特权提升漏洞。 成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0090](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0090)。
  
#### Win32k 内存损坏漏洞 (CVE-2011-0090) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 内存损坏漏洞 (CVE-2011-0090) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 内存损坏漏洞 (CVE-2011-0090) 的常见问题
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2479628$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2479628">Microsoft 知识库文章 2479628</a></td>
</tr>  
<tr class="even">
...
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 关于 Win32k 不正确用户输入验证漏洞 (CVE-2011-0086) 的报告  
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 关于 Win32k 不充分用户输入验证漏洞 (CVE-2011-0087) 的报告  
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 关于 Win32k 窗口类指针混乱漏洞 (CVE-2011-0088) 的报告  
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 关于 Win32k 窗口类不正确指针验证漏洞 (CVE-2011-0089) 的报告  
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 关于 Windows 内存损坏漏洞 (CVE-2011-0090) 的报告
...
-   V2.0（2011 年 3 月 18 日）： 阐明了受影响的软件包括 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1、Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1。请参阅可说明此修订的“**与此安全更新相关的常见问题 (FAQ)**”部分的条目。

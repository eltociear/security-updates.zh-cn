...
**已知问题。** [Microsoft 知识库文章 2508062](https://support.microsoft.com/kb/2508062) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)。
...
<td style="border:1px solid black;">对于 Remote Desktop Connection 5.2：<br />
请参阅 <a href="https://support.microsoft.com/kb/2483618">Microsoft 知识库文章 2483618</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0 和 Remote Desktop Connection 6.1：<br />
请参阅 <a href="https://support.microsoft.com/kb/2481109">Microsoft 知识库文章 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 7.0：<br />
请参阅 <a href="https://support.microsoft.com/kb/2483614">Microsoft 知识库文章 2483614</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI)：<br />
请参阅 <a href="https://support.microsoft.com/kb/2483619">Microsoft 知识库文章 2483619</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2481109">Microsoft 知识库文章 2481109</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注意</strong> 没有用于验证此更新是否存在的注册表项。</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2483614">Microsoft 知识库文章 2483614</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注意</strong> 没有用于验证此更新是否存在的注册表项。</td>
...
-   [Versafe Anti Fraud](https://www.versafe-login.com/) 的 Eyal Gruner 报告了远程桌面库加载不安全漏洞 (CVE-2011-0029)

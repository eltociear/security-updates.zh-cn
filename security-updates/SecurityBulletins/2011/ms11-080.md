---
TOCTitle: 'MS11-080'
Title: 'Microsoft 安全公告 MS11-080 - 重要'
ms:assetid: 'ms11-080'
ms:contentKeyID: 61238218
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-080(v=Security.10)'
---
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=f1b2dceb-5bef-4522-9001-8dff0545d805)                          | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9a37864e-8543-4c52-aa73-e3c190860d76) | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=29228167-b811-43d7-b4a0-91e385b598a5)                 | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0816d729-6769-4ca6-a14e-71750eca8d29)     | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=42465652-2664-4fd5-9a22-ae847b08e7c8) | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
...
<tr class="header">
<th>受影响的软件</th>
<th>辅助功能驱动程序特权提升漏洞 - CVE-2011-2005</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2005](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2005)。
  
#### 辅助功能驱动程序特权提升漏洞 (CVE-2011-2005) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### 辅助功能驱动程序特权提升漏洞 (CVE-2011-2005) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### 辅助功能驱动程序特权提升漏洞 (CVE-2011-2005) 的常见问题
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2592799$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2592799">Microsoft 知识库文章 2592799</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB2592799$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2592799](https://support.microsoft.com/kb/2592799)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [National University of Defense Technology](https://www.nudt.edu.cn/) 的 Bo Zhou 报告了辅助功能驱动程序特权提升漏洞 (CVE-2011-2005)

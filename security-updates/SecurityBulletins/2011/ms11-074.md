...
**已知问题。**[Microsoft 知识库文章 2451858](https://support.microsoft.com/kb/2451858) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f6ee7e43-9da9-4b96-abd0-390cfcacb885">Microsoft SharePoint Workspace 2010 和 Microsoft SharePoint Workspace 2010 Service Pack 1（32 位版本）</a><br />
(KB2566445)</td>
<td style="border:1px solid black;">信息泄露</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=234efac1-4f09-41f5-90a9-4a3c2e81c05e">Microsoft SharePoint Workspace 2010 和 Microsoft SharePoint Workspace 2010 Service Pack 1 （64 位版本）</a><br />
(KB2566445)</td>
<td style="border:1px solid black;">信息泄露</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
[Microsoft Office Forms Server 2007 Service Pack 2（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=c4c8ad7e-50bd-460e-9678-d8c72c6ee7ab)  
（KB2553005）
</td>
<td style="border:1px solid black;">
不适用
...
<td style="border:1px solid black;">
[MS10-072](https://go.microsoft.com/fwlink/?linkid=202016) 中的 KB2345212 由 KB2508964 替代  
没有公告由 KB2553001 替代  
没有公告由 KB255002 替代  
[MS10-104](https://go.microsoft.com/fwlink/?linkid=206469)中的 KB2433089 由 KB2553003 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
(KB2553002)  
[Microsoft Office SharePoint Server 2007 Service Pack 2 (dlc)（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=e8e1a5bb-a552-45fe-8e81-e05fbfbb57ee)  
（KB2553003）
</td>
<td style="border:1px solid black;">
特权提升
...
HTML 清理漏洞 (CVE-2011-1252) 是由此更新 (MS11-074) 和 [Internet Explorer 的累积性安全更新](https://go.microsoft.com/fwlink/?linkid=217212) (MS11-050) 更新解决的。
...
对管理员和企业安装，或者想要根据其 Microsoft Office SharePoint Server 的配置手动安装此安全更新的最终用户，此公告中列出的服务器程序包更新并非全部都适用。有关 SharePoint 环境中这些服务器程序包更新的适用性的详细信息，请参阅 [Microsoft 知识库文章 2451858](https://support.microsoft.com/kb/2451858)。
...
[Microsoft Office Web Apps](https://office.microsoft.com/web-apps) 是 Office Word、Excel、PowerPoint 和 OneNote 应用程序的在线助理，不管用户的位置在哪里，都可使其访问和编辑文档。用户可在个人计算机、移动电话和 Web 上与他人查看、共享和处理文档。Office Web Apps 可提供给具有基于 Microsoft SharePoint 2010 产品的 Microsoft Office 2010 批量许可和文档管理解决方案的商业客户。
  
**Microsoft Office Web Apps 的更新应用在何处？**  
已在 SharePoint 环境中部署 Microsoft Office Web Apps 的客户将需要在安装这些组件的服务器上应用 Microsoft Office Web Apps 的更新。有关部署 Microsoft Office Web Apps 的详细信息，请参阅 Microsoft TechNet 文章“[了解 Office Web Apps](https://technet.microsoft.com/en-us/library/ff431685.aspx)”。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0653](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0653)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1252](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1252)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-1252](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1252)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1890](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1890)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1891](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1891)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1892](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1892)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1893](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1893)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2552997">Microsoft 知识库文章 2552997</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2566445">Microsoft 知识库文章 2566445</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Office SharePoint Server 2007，请参阅 <a href="https://support.microsoft.com/kb/2508964">Microsoft 知识库文章 2508964</a>、<a href="https://support.microsoft.com/kb/2553002">Microsoft 知识库文章 2553002</a> 和 <a href="https://support.microsoft.com/kb/2345212">Microsoft 知识库文章 2345212</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office Forms Server 2007，请参阅 <a href="https://support.microsoft.com/kb/2553005">Microsoft 知识库文章 2553005</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2494022">Microsoft 知识库文章 2494022</a>、<br />
<a href="https://support.microsoft.com/kb/2560885">Microsoft 知识库文章 2560885</a>、<br />  
<a href="https://support.microsoft.com/kb/2560890">Microsoft 知识库文章 2560890</a>、<br />  
<a href="https://support.microsoft.com/kb/2566456">Microsoft 知识库文章 2566456</a>、<br />  
<a href="https://support.microsoft.com/kb/2566954">Microsoft 知识库文章 2566954</a>、<br />  
<a href="https://support.microsoft.com/kb/2566958">Microsoft 知识库文章 2566958</a> 和<br />
<a href="https://support.microsoft.com/kb/2566960">Microsoft 知识库文章 2566960</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Office Groove Data Bridge Server 2007，请参阅 <a href="https://support.microsoft.com/kb/2552999">Microsoft 知识库文章 2552999</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office Groove Management Server 2007，请参阅 <a href="https://support.microsoft.com/kb/2552998">Microsoft 知识库文章 2552998</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2508965">Microsoft 知识库文章 2508965</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Windows SharePoint Services 2.0，请参阅 <a href="https://support.microsoft.com/kb/2494007">Microsoft 知识库文章 2494007</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2493987">Microsoft 知识库文章 2493987</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2494001">Microsoft 知识库文章 2494001</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Office Web Apps 2010 和 Office Web Apps 2010 Service Pack 1，请参阅 <a href="https://support.microsoft.com/kb/2566449">Microsoft 知识库文章 2566449</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Word Web App 2010 和 Word Web App 2010 Service Pack 1，请参阅 <a href="https://support.microsoft.com/kb/2566449">Microsoft 知识库文章 2566450</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Critical Path Training, LLC](https://www.criticalpathtraining.com/) 的 Andrew Connell 报告了 SharePoint 日历中的 XSS 漏洞 (CVE-2011-0653)  
-   [Raytheon](https://www.raytheon.com/) 的 David Feldman 报告了 SharePoint 日历中的 XSS 漏洞 (CVE-2011-0653)  
-   [IBM Rational Application Security](https://blog.watchfire.com/) 的 Adi Cohen 报告了 HTML 清理漏洞 (CVE-2011-1252)  
-   [Trend Micro](https://www.trendmicro.com/) 与我们合作处理了 HTML 清理漏洞 (CVE-2011-1252)  
-   [ITT](https://www.itt.com/) 的 Pedro Jimenez 报告了 Editform 脚本注入漏洞 (CVE-2011-1890)  
-   [Seeker 自动应用安全测试解决方案](https://www.seekersec.com)报告了联系详细信息反映的 XSS 漏洞 (CVE-2011-1891)  
-   [Agarri](https://www.agarri.fr/)的 Nicolas Grégoire 报告了 SharePoint 远程文件泄露漏洞 (CVE-2011-1892)  
-   [LaValley Consulting, LLC](https://www.lavalley.net) 的 Jim LaValley 报告了 SharePoint XSS 漏洞 (CVE-2011-1893)  
-   [Seeker](https://www.seekersec.com) 的 Irene Abezgauz 与我们合作提供了一个终身防御更新，可帮助改进 Microsoft SharePoint 中的跨应用程序重定向处理

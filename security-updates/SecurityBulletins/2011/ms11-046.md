---
TOCTitle: 'MS11-046'
Title: 'Microsoft 安全公告 MS11-046 - 重要'
ms:assetid: 'ms11-046'
ms:contentKeyID: 61238184
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-046(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-046 - 重要
==================================

辅助功能驱动程序中的漏洞可能允许特权提升 (2503665)
--------------------------------------------------

发布时间: 2011年6月14日 | 更新时间: 2011年6月30日
...
此安全更新通过更正 AFD 在将输入从用户模式传递到 Windows 内核之前验证输入的方式来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=a1db7736-f3e4-45df-af1d-52746978a0a8)                                                                                     | 特权提升     | 重要         | [MS08-066](https://go.microsoft.com/fwlink/?linkid=125709) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=71497891-41a2-476d-b524-4eb5cecb9639)                                                            | 特权提升     | 重要         | [MS08-066](https://go.microsoft.com/fwlink/?linkid=125709) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c614cb8b-223e-4f84-b94c-f15747760aa5)                                                                            | 特权提升     | 重要         | [MS08-066](https://go.microsoft.com/fwlink/?linkid=125709) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9a951087-25c5-4f5c-8407-a1585491ae0b)                                                                | 特权提升     | 重要         | [MS08-066](https://go.microsoft.com/fwlink/?linkid=125709) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=dd48b93b-24fa-45a3-91fb-9f9f9418c49f)                                                            | 特权提升     | 重要         | [MS08-066](https://go.microsoft.com/fwlink/?linkid=125709) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b69e3bda-940b-4524-a724-0af4ae0ec719)                                                  | 特权提升     | 重要         | 无                                                        |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e3a26bc5-1757-4b38-9cae-419c919f4877)                          | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e34e4cf9-cdae-4240-8574-950c0be00822)\*                 | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a3604f05-26b2-451b-9153-0e718158371e)\*       | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e8a82b44-e1d8-45f8-b8b8-b1f74e1efce0) | 特权提升     | 重要         | 无                                                        |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=63d8b801-5178-474b-a21e-72a0ce501d3e)                                                                                   | 特权提升     | 重要         | [MS10-058](https://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=63d8b801-5178-474b-a21e-72a0ce501d3e)                                                                     | 特权提升     | 重要         | 无                                                        |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=cd7d3cb9-cb60-4b62-b0df-a38fe21802e9)                                                                              | 特权提升     | 重要         | [MS10-058](https://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=cd7d3cb9-cb60-4b62-b0df-a38fe21802e9)                                                                | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=e67c73ca-d0f9-40c1-8b6e-25b1b13caa3a)\*                                                               | 特权提升     | 重要         | [MS10-058](https://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=e67c73ca-d0f9-40c1-8b6e-25b1b13caa3a)\*                                                 | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=72d1d6b6-e8bd-492b-b65a-82060beef441)                                                             | 特权提升     | 重要         | [MS10-058](https://go.microsoft.com/fwlink/?linkid=194562) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=72d1d6b6-e8bd-492b-b65a-82060beef441)                                               | 特权提升     | 重要         | 无                                                        |
...
<tr class="header">
<th>受影响的软件</th>
<th>辅助功能驱动程序特权提升漏洞 - CVE-2011-1249</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
辅助功能驱动程序特权提升漏洞 - CVE-2011-1249  
--------------------------------------------
  
<span></span>  
辅助功能驱动程序 (afd.sys) 错误地验证从用户模式传递到内核的输入的方式中存在一个特权提升漏洞。 该漏洞能够允许攻击者使用提升的特权运行代码。 成功利用此漏洞的本地攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1249](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)。
  
#### 辅助功能驱动程序特权提升漏洞 (CVE-2011-1249) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### 辅助功能驱动程序特权提升漏洞 (CVE-2011-1249) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### 辅助功能驱动程序特权提升漏洞 (CVE-2011-1249) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**    
如果 AFD 在将数据从用户模式传递到内核时未正确验证用户提供的输入，则会导致该漏洞。
  
**什么是辅助功能驱动程序 (AFD)？**    
辅功能驱动程序支持 Windows 套接字应用程序，并包含在 afd.sys 文件中。 afd.sys 驱动程序在内核模式中运行，并管理 Winsock TCP/IP 通信协议。 Winsock 内核界面提供对 TDI 传输的访问。
  
**什么是传输驱动程序界面 (TDI)？**    
该传输驱动程序界面 (TDI) 定义了出现在所有传输协议堆栈上边缘的内核模式网络界面。 每个堆栈中最高级别的协议驱动程序支持用于更高级内核模式网络客户端的 TDI 界面。 有关 TDI 组件的详细信息，请访问 MSDN 文章[传输驱动程序界面](https://msdn.microsoft.com/en-us/library/ff565685.aspx)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-1249](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
是。 Microsoft 获悉尝试使用此漏洞的有限目标攻击。
  
**应用此安全更新是否有助于客户防止可能会尝试利用此漏洞的已公开发布的代码？**    
是。 此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2011-1249](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2503665$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2503665">Microsoft 知识库文章 2503665</a></td>
</tr>  
<tr class="even">
...
-   [Shadowserver Foundation](https://www.shadowserver.org) 的 Steven Adair 和 Chris S. 报告了辅助功能驱动程序特权提升漏洞 (CVE-2011-1249)
...
-   V1.1（2011 年 6 月 30 日）： 更正了“受影响的软件”表以包括此更新取代的公告 MS10-058。 这仅仅是一个信息更改。 没有更改安全更新文件或检测逻辑。

...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=a1db7736-f3e4-45df-af1d-52746978a0a8)                                                                                     | 特权提升     | 重要         | [MS08-066](http://go.microsoft.com/fwlink/?linkid=125709) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=71497891-41a2-476d-b524-4eb5cecb9639)                                                            | 特权提升     | 重要         | [MS08-066](http://go.microsoft.com/fwlink/?linkid=125709) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c614cb8b-223e-4f84-b94c-f15747760aa5)                                                                            | 特权提升     | 重要         | [MS08-066](http://go.microsoft.com/fwlink/?linkid=125709) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9a951087-25c5-4f5c-8407-a1585491ae0b)                                                                | 特权提升     | 重要         | [MS08-066](http://go.microsoft.com/fwlink/?linkid=125709) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=dd48b93b-24fa-45a3-91fb-9f9f9418c49f)                                                            | 特权提升     | 重要         | [MS08-066](http://go.microsoft.com/fwlink/?linkid=125709) |
...
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=63d8b801-5178-474b-a21e-72a0ce501d3e)                                                                                   | 特权提升     | 重要         | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
...
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=cd7d3cb9-cb60-4b62-b0df-a38fe21802e9)                                                                              | 特权提升     | 重要         | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
...
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=e67c73ca-d0f9-40c1-8b6e-25b1b13caa3a)\*                                                               | 特权提升     | 重要         | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
...
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=72d1d6b6-e8bd-492b-b65a-82060beef441)                                                             | 特权提升     | 重要         | [MS10-058](http://go.microsoft.com/fwlink/?linkid=194562) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)。
...
**什么是传输驱动程序界面 (TDI)？**    
该传输驱动程序界面 (TDI) 定义了出现在所有传输协议堆栈上边缘的内核模式网络界面。 每个堆栈中最高级别的协议驱动程序支持用于更高级内核模式网络客户端的 TDI 界面。 有关 TDI 组件的详细信息，请访问 MSDN 文章[传输驱动程序界面](http://msdn.microsoft.com/en-us/library/ff565685.aspx)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-1249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
是。 Microsoft 获悉尝试使用此漏洞的有限目标攻击。
  
**应用此安全更新是否有助于客户防止可能会尝试利用此漏洞的已公开发布的代码？**    
是。 此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2011-1249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1249)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2503665">Microsoft 知识库文章 2503665</a></td>
</tr>  
<tr class="even">
...
-   [Shadowserver Foundation](http://www.shadowserver.org) 的 Steven Adair 和 Chris S. 报告了辅助功能驱动程序特权提升漏洞 (CVE-2011-1249)

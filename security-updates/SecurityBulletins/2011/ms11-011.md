---
TOCTitle: 'MS11-011'
Title: 'Microsoft 安全公告 MS11-011 - 重要'
ms:assetid: 'ms11-011'
ms:contentKeyID: 61238149
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-011(v=Security.10)'
---
...
此安全更新通过确保 Windows 内核在分配内存之前正确验证用户提供的数据解决漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
**已知问题。** [Microsoft 知识库文章 2393802](https://support.microsoft.com/kb/2393802) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=a511d33a-9ae0-46ee-a225-9d97390de7d1)                                                                                     | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e7273a85-ce96-464b-8c4f-2710701213e3)                                                            | 特权提升     | 重要         | [MS10-021](https://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6bf2eeec-8225-477f-a606-263d3ee434d6)                                                                            | 特权提升     | 重要         | [MS10-021](https://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ec544894-ee98-4a2b-ac4d-33b0c3754213)                                                                | 特权提升     | 重要         | [MS10-021](https://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=fcd48499-1bb4-4304-b9cc-27d9d92e11cd)                                                            | 特权提升     | 重要         | [MS10-021](https://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=66978514-bb7f-42cc-9360-2fd1c686f4e6)                                                  | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8fdb8c37-1b22-457b-bdc0-21f6a5061dd3)                          | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4b37418a-e044-415e-b566-4507f157934a)\*                 | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=163d3aca-3703-452e-b1cb-73932e2bcf8c)\*       | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=55b07bc0-dff5-4cd7-87c9-c08e5a49197d) | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=e1224c90-b0bc-4e4b-999a-efae327213b4)                                                                                   | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=ddcf352e-742c-485e-9ed5-19cdba673562)                                                                              | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=70f5056a-72ad-46ff-a43f-ee151639b9a7)\*                                                               | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=1646b3a5-714f-4ea5-b109-566fa9b933b6)                                                             | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
...
<tr class="header">
<th>受影响的软件</th>
<th>驱动程序与 Windows 内核漏洞交互不当漏洞 - CVE-2010-4398</th>
<th>Windows 内核整数截断漏洞 - CVE-2011-0045</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
驱动程序与 Windows 内核漏洞交互不当漏洞 - CVE-2010-4398  
-------------------------------------------------------
  
<span></span>  
因特定程序驱动与 Windows 内核交互不当而存在特权提升漏洞。 成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-4398](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398)。
  
#### 驱动程序与 Windows 内核漏洞交互不当漏洞 (CVE-2010-4398) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### 驱动程序与 Windows 内核漏洞交互不当漏洞 (CVE-2010-4398) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### 驱动程序与 Windows 内核漏洞交互不当漏洞 (CVE-2010-4398) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**造成此漏洞的原因是什么？**    
此漏洞由驱动程序与 Windows 内核交互不当导致。
...
**此更新有什么作用？**    
此更新通过确保受影响的驱动程序与 Windows 内核正确交互解决该漏洞。
  
**此更新是否包含任何与安全性相关的功能更改？**    
此更新包含与安全相关的功能更改。 有关详细信息，参阅 MSDN 文章 [RtlQueryRegistryValues 例程](https://msdn.microsoft.com/en-us/library/ff562046(v=vs.85).aspx)。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-4398](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-4398)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。
  
Windows 内核整数截断漏洞 - CVE-2011-0045  
----------------------------------------
  
<span></span>  
因 Windows 内核在读取用户提供的数据时分配内存的方式而存在特权提升漏洞。 成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0045](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0045)。
  
#### Windows 内核整数截断漏洞 (CVE-2011-0045) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### Windows 内核整数截断漏洞 (CVE-2011-0045) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核整数截断漏洞 (CVE-2011-0045) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**造成此漏洞的原因是什么？**    
Windows 内核在分配内存之前未正确验证用户提供的数据。
...
**此更新有什么作用？**    
此更新通过确保 Windows 内核在分配内存之前正确验证用户提供的数据解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2393802$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2393802">Microsoft 知识库文章 2393802</a></td>
</tr>  
<tr class="even">
...
-   [360safe](https://www.360.cn) 的 Zhengwenbin 关于驱动程序与 Windows 内核漏洞交互不当漏洞 (CVE-2010-4398) 的报告  
-   Guo Bojun 关于驱动程序与 Windows 内核漏洞交互不当漏洞 (CVE-2010-4398) 的报告  
-   Wei Zhang 关于驱动程序与 Windows 内核漏洞交互不当漏洞 (CVE-2010-4398) 的报告  
-   [Prevx](https://www.prevx.com/)的 Marco Giuliani 和我们关于驱动程序与 Windows 内核漏洞交互不当漏洞 (CVE-2010-4398) 的联合报告  
-   std\_logic 与 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 关于 Windows 内核整数截断漏洞 (CVE-2011-0045) 的联合报告
...
-   V1.1（2011 年 3 月 2 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2393802 添加一个链接。  
-   V1.2（2011 年 3 月 18 日）： 向“**不受影响的软件**”中添加了 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1、Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1。 这仅仅是一个信息更改。 没有更改安全更新文件或检测逻辑。

---
TOCTitle: 'MS11-084'
Title: 'Microsoft 安全公告 MS11-084 - 警告'
ms:assetid: 'ms11-084'
ms:contentKeyID: 61238222
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-084(v=Security.10)'
---


Microsoft 安全公告 MS11-084 - 警告
==================================
...
对于 Windows 7 和 Windows Server 2008 R2 的所有受支持版本，此安全更新等级为“中等”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过确保 Windows 内核模式驱动程序在加载 TrueType 字体文件时正确地验证数组索引来解决此漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=156c1bd9-55bc-482c-874b-61998d1ef153)                                             | 拒绝服务     | 中等         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=5c7db930-5495-43f0-928c-d586ac9e80d0)                                   | 拒绝服务     | 中等         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=5d810dae-5c52-4155-b5c2-163d27be6e78)\*\*\*   | 拒绝服务     | 中等         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=395819e2-1028-44b7-ace4-ca754b1a7543) | 拒绝服务     | 中等         | [MS11-077](https://go.microsoft.com/fwlink/?linkid=225915) |
...
<tr class="header">
<th>受影响的软件</th>
<th>TrueType 字体分析漏洞 - CVE-2011-2004</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
TrueType 字体分析漏洞 - CVE-2011-2004  
-------------------------------------
  
<span></span>  
Microsoft Windows 内核中存在一个拒绝服务漏洞。当 Windows 内核不正确地处理特制的 TrueType 字体文件时，会导致此漏洞。成功利用此漏洞的攻击者可能导致受影响的系统停止响应和重新启动。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2004](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2004)。
  
#### TrueType 字体分析漏洞 (CVE-2011-2004) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   要成功进行远程攻击，用户必须访问包含特制 TrueType 字体文件的不受信任的远程文件系统位置或 WebDAV 共享，或者作为电子邮件附件打开该文件。但是在所有情况下，攻击者无法强制用户执行这些操作。相反，攻击者必须说服用户这样做，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接。  
-   外围防火墙通常禁用文件共享协议 SMB。这样可限制此漏洞的可能远程攻击媒介。
  
#### TrueType 字体分析漏洞 (CVE-2011-2004) 的变通办法
...
#### TrueType 字体分析漏洞 (CVE-2011-2004) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个拒绝服务漏洞。
  
**造成此漏洞的原因是什么？**  
如果 Windows 内核模式驱动程序在加载 TrueType 字体文件时无法对数组索引执行充分验证，则会导致该漏洞。
...
**攻击者如何利用此** **漏洞？**  
攻击者可能会在网络共享上托管特制的 TrueType 字体，当用户在 Windows 资源管理器中导航到共享时，受影响的控制路径将通过“详细信息”和“预览”窗格触发。特制 TrueType 字体然后可利用此漏洞并导致系统停止响应。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2617657">Microsoft 知识库文章 2617657</a></td>
</tr>  
<tr class="odd">
...
-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了 TrueType 字体分析漏洞 (CVE-2011-2004)

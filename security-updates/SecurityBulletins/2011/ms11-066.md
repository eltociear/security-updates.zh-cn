...
**已知问题。**[Microsoft 知识库文章 2567943](http://support.microsoft.com/kb/2567943) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<sup>[1]</sup>**.NET Framework 4 客户端配置文件不受影响。**两种配置文件中提供 .NET Framework 版本 4 可再次分发程序包： .NET Framework 4 和 .NET Framework 4 客户端配置文件。.NET Framework 4 客户端配置文件是 .NET Framework 4 的子集。此更新中消除的漏洞只对 .NET Framework 4 有影响，而不会影响 .NET Framework 4 客户端配置文件。有关详细信息，请参阅 MSDN 文章“[安装 .NET Framework](http://msdn.microsoft.com/en-us/library/5a4x27ek.aspx)”。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1977](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1977)。
...
**Microsoft 图表控件是什么？**  
Microsoft 图表控件使您能够利用简单、直观且具有视觉冲击力的复杂统计或财政分析图表创建 ASP.NET 页面或 Windows 表单应用。有关图表控件的详细信息，请参阅 MSDN 文章“[图表控件](http://msdn.microsoft.com/en-us/library/dd456632.aspx)”。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2487367">Microsoft 知识库文章 2487367</a></td>
</tr>  
<tr class="even">
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2500170](http://support.microsoft.com/kb/2500170)                                                                                                                                         |

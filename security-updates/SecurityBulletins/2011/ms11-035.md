...
**已知问题。** [Microsoft 知识库文章 2524426](http://support.microsoft.com/kb/2524426) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0d289146-8470-45dd-a886-d1b35a2c6d4b)                                                                            | 远程执行代码 | 严重         | [MS09-039](http://go.microsoft.com/fwlink/?linkid=155974) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0d3e85a9-42ff-447b-ab8c-095a1c0b224c)                                                                | 远程执行代码 | 严重         | [MS09-039](http://go.microsoft.com/fwlink/?linkid=155974) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=4c388fe8-883a-4118-a7ff-50f1e9d0a071)                                                            | 远程执行代码 | 严重         | [MS09-039](http://go.microsoft.com/fwlink/?linkid=155974) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1248](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1248)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2524426">Microsoft 知识库文章 2524426</a></td>
</tr>  
<tr class="even">
...
-   Luigi Auriemma 与 [TippingPoint's](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 WINS 服务失败响应漏洞 (CVE-2011-1248)

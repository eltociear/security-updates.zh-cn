---
TOCTitle: 'MS11-002'
Title: 'Microsoft 安全公告 MS11-002 - 严重'
ms:assetid: 'ms11-002'
ms:contentKeyID: 61237947
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-002(v=Security.10)'
---
...
Microsoft Data Access Components 中的漏洞可能允许远程执行代码 (2451910)
-----------------------------------------------------------------------
...
对于 Windows XP、Windows Vista 和 Windows 7 的所有受支持版本，此安全更新的等级为“严重”；对于 Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过确保 MDAC 正确验证字符串长度和内存分配来解决这些漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7951fd7b-6b0a-4168-8519-312a62ff3289">Microsoft Data Access Components 2.8 Service Pack 1</a><br />
(KB2419632)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ce06bfdc-7b0d-4e65-9a13-e009e3a6a9f0">Microsoft Data Access Components 2.8 Service Pack 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d451ced7-c9c7-4c41-9d44-8f8929fca390">Microsoft Data Access Components 2.8 Service Pack 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">远程执行代码</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3f2c8cfa-819e-4fd9-93ba-b687eb2d46fe">Microsoft Data Access Components 2.8 Service Pack 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8dbcbb91-464b-4eb3-b7e5-afe82febf8d7">Microsoft Data Access Components 2.8 Service Pack 2</a><br />
(KB2419635)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=13445e4a-099a-4edd-864e-c44f42940500">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fd6b806e-50d4-4f4d-96e1-7c71fca4c543">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3d0885ac-97b3-46b5-970d-cc810270fba3">Windows Data Access Components 6.0</a>*<br />
(KB2419640)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8f33c57e-343c-4cdb-b667-af18a8779ad2">Windows Data Access Components 6.0</a>*<br />
(KB2419640)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5ecc8180-6baa-4f4b-a392-4b45a30469fc">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3dfd4f1c-e7a5-4686-8d2c-b7a5a53c5333">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cf30e5c0-811b-4ecd-a6b2-874000d25074">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cc9bac5a-3eaa-46fb-9ef4-c511b5f57996">Windows Data Access Components 6.0</a>*<br />
(KB2419640)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ba2612ec-ffad-4cd3-85c6-ba07f70a0d24">Windows Data Access Components 6.0</a><br />
(KB2419640)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
Windows 7 Service Pack 1 Beta 和 Windows Server 2008 R2 Service Pack 1 Beta 受此公告中介绍的漏洞影响。 鼓励运行这些测试版本的客户下载并向其系统应用此更新。 安全更新可从 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 和 [Windows Update](https://update.microsoft.com/microsoftupdate) 获得。 此安全更新也可以从 [Microsoft 下载中心](https://go.microsoft.com/fwlink/?linkid=21129)下载。
...
<span></span>  
以下严重等级假设漏洞的可能的最大影响。 有关在安全公告发布 30 天内漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [1 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms11-jan)中的利用指数。 有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
<tr class="header">  
<th>受影响的软件</th>  
<th>DSN 溢出漏洞 - CVE-2011-0026</th>  
<th>ADO 记录内存漏洞 - CVE-2011-0027</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
<tr class="odd">
<td style="border:1px solid black;">Windows XP Service Pack 3 上的 Microsoft Data Access Components 2.8 Service Pack 1</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>中等 </strong><br />
远程执行代码</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 SP2（用于基于 Itanium 的系统）上的 Microsoft Data Access Components 2.8 Service Pack 2</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>中等 </strong><br />
远程执行代码</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的 Windows Data Access Components 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的 Windows Data Access Components 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2 上的 Windows Data Access Components 6.0*</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>中等 </strong><br />
远程执行代码</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上的 Windows Data Access Components 6.0*</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>中等 </strong><br />
远程执行代码</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2 上的 Windows Data Access Components 6.0*</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>中等 </strong><br />
远程执行代码</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows 7（用于 32 位系统）上的 Windows Data Access Components 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows 7（用于基于 x64 的系统）上的 Windows Data Access Components 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2（用于基于 x64 的系统）上的 Windows Data Access Components 6.0*</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>中等 </strong><br />
远程执行代码</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2（用于基于 Itanium 的系统）上的 Windows Data Access Components 6.0</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>中等 </strong><br />
远程执行代码</td>
...
DSN 溢出漏洞 - CVE-2011-0026  
----------------------------
  
<span></span>  
Microsoft Data Access Components 验证第三方 API 使用的方式中存在一个远程执行代码漏洞。 如果用户访问了特制网页，此漏洞可能允许远程执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0026)。
  
#### DSN 溢出漏洞 (CVE-2011-0026) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   默认 Windows 配置中无法利用此漏洞。 为受此问题的影响，系统上必须安装以易受影响的方式使用特定[开放式数据库连接](https://support.microsoft.com/kb/110093) (ODBC) API 的第三方应用程序。
  
#### DSN 溢出漏洞 (CVE-2011-0026) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### DSN 溢出漏洞 (CVE-2011-0026) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**是否可以远程利用此漏洞？**    
没有披露此漏洞的 Microsoft 应用程序。 但是，第三方应用程序可能允许访问不受信任来源中的[开放式数据库连接](https://support.microsoft.com/kb/110093) (ODBC) API，从而远程披露此漏洞。 在这种情形中，此漏洞的利用可以使匿名用户使用完全管理特权执行代码。
  
**造成此漏洞的原因是什么？**    
可能被第三方应用程序使用的[开放式数据库连接](https://support.microsoft.com/kb/110093) (ODBC) API 的数据源名称 (DSN) 参数中存在缓冲区溢出。
  
**什么是 Microsoft Data Access Components？**    
[Microsoft Data Access Components](https://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) (MDAC) 是一个组件集合，可使程序轻松访问数据库并随后操作数据库中的数据。 当今的数据库可以采用各种形式（例如，SQL 数据库、Microsoft Access 数据库、XML 文件等），并且可以存放在各种位置（例如，在本地系统上或在远程数据库服务器上）。 MDAC 将一组功能整合在了一起，这样，用户就可以采用一种一致的方式使用不同种类的数据源。 从 Windows Vista 开始，MDAC 被称为 Windows 数据访问组件 (WDAC)。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**攻击者如何利用此漏洞？**    
攻击者可能拥有一个旨在通过 Web 浏览器利用此漏洞的特制网站，然后诱使用户查看该网站。 攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。 这些网站可能包含可以利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。 它还可能使用横幅广告或其他方式显示特制的 Web 内容，以便将 Web 内容传递至受影响的系统。
  
**受此漏洞威胁最大的系统有哪些？**    
工作站和终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**    
此更新通过确保 MDAC 正确验证 MDAC API 中的字符串长度来解决此漏洞。
...
ADO 记录内存漏洞 - CVE-2011-0027  
--------------------------------
  
<span></span>  
Microsoft Data Access Components 验证内存分配的方式中存在一个远程执行代码漏洞。 如果用户访问了特制网页，此漏洞可能允许远程执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0027)。
  
#### ADO 记录内存漏洞 (CVE-2011-0027) 的缓解因素
...
#### ADO 记录内存漏洞 (CVE-2011-0027) 的变通办法
...
-   **禁用 ActiveX 数据对象 (ADO) DLL**
    ...
    **变通办法的影响。** 禁用 ActiveX 数据对象 (ADO) DLL 将破坏 MDAC 功能。
...
#### ADO 记录内存漏洞 (CVE-2011-0027) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**造成此漏洞的原因是什么？**    
MDAC 在处理内部数据结构时未正确地分配内存。
  
**什么是 Microsoft Data Access Components？**    
[Microsoft Data Access Components](https://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) (MDAC) 是一个组件集合，可使程序轻松访问数据库并随后操作数据库中的数据。 当今的数据库可以采用各种形式（例如，SQL 数据库、Microsoft Access 数据库、XML 文件等），并且可以存放在各种位置（例如，在本地系统上或在远程数据库服务器上）。 MDAC 将一组功能整合在了一起，这样，用户就可以采用一种一致的方式使用不同种类的数据源。 从 Windows Vista 开始，MDAC 被称为 Windows 数据访问组件 (WDAC)。
  
作为 MDAC 一部分的 ActiveX 数据对象 (ADO) 是一种非特定语言对象模型，披露潜在的 OLE DB 提供程序引发的数据。
...
<td style="border:1px solid black;">Windows XP Service Pack 3 上的 Microsoft Data Access Components 2.8 Service Pack 1：<br />
WindowsXP-KB2419632-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
...
<td style="border:1px solid black;">Windows XP Service Pack 3 上的 Microsoft Data Access Components 2.8 Service Pack 1：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2419632$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2419635$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">Windows XP Service Pack 3 上的 Microsoft Data Access Components 2.8 Service Pack 1：<br />
请参阅 <a href="https://support.microsoft.com/kb/2419632">Microsoft 知识库文章 2419632</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/2419635">Microsoft 知识库文章 2419635</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2003 所有受支持的 32 位版本上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
WindowsServer2003-KB2419635-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 所有受支持的基于 x64 的版本上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
WindowsServer2003.WindowsXP-KB2419635-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 所有受支持的基于 Itanium 的版本上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2419635$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2419635">Microsoft 知识库文章 2419635</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Vista 所有受支持的 32 位版本上的 Windows Data Access Components 6.0：<br />
Windows6.0-KB2419640-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Vista 所有受支持的基于 x64 的版本上的 Windows Data Access Components 6.0：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2419640">Microsoft 知识库文章 2419640</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2008 所有受支持的 32 位版本上的 Windows Data Access Components 6.0：<br />
Windows6.0-KB2419640-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 所有受支持的基于 x64 的版本上的 Windows Data Access Components 6.0：<br />
Windows6.0-KB2419640-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 所有受支持的基于 Itanium 的版本上的 Windows Data Access Components 6.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows 7 所有受支持的 32 位版本上的 Windows Data Access Components 6.0：<br />
Windows6.1-KB2419640-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows 7 所有受支持的基于 x64 的版本上的 Windows Data Access Components 6.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2008 R2 所有受支持的基于 x64 的版本上的 Windows Data Access Components 6.0：<br />
Windows6.1-KB2419640-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 R2 所有受支持的基于 Itanium 的版本上的 Windows Data Access Components 6.0：<br />
...
-   Abdul Aziz Hariri 与 [TippingPoint 的](https://www.tippingpoint.com/)* *[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 DSN 溢出漏洞 (CVE-2011-0026)  
-   Peter Vreugdenhil 与 [TippingPoint 的](https://www.tippingpoint.com/)* *[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 ADO 记录内存漏洞 ( CVE-2011-0027)

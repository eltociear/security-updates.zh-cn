...
<span></span>  
以下严重等级假设漏洞的可能的最大影响。 有关在安全公告发布 30 天内漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [1 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms11-jan)中的利用指数。 有关详细信息，请参阅 [Microsoft 利用指数](http://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0026](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0026)。
  
#### DSN 溢出漏洞 (CVE-2011-0026) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   默认 Windows 配置中无法利用此漏洞。 为受此问题的影响，系统上必须安装以易受影响的方式使用特定[开放式数据库连接](http://support.microsoft.com/kb/110093) (ODBC) API 的第三方应用程序。
...
**是否可以远程利用此漏洞？**    
没有披露此漏洞的 Microsoft 应用程序。 但是，第三方应用程序可能允许访问不受信任来源中的[开放式数据库连接](http://support.microsoft.com/kb/110093) (ODBC) API，从而远程披露此漏洞。 在这种情形中，此漏洞的利用可以使匿名用户使用完全管理特权执行代码。
  
**造成此漏洞的原因是什么？**    
可能被第三方应用程序使用的[开放式数据库连接](http://support.microsoft.com/kb/110093) (ODBC) API 的数据源名称 (DSN) 参数中存在缓冲区溢出。
  
**什么是 Microsoft Data Access Components？**    
[Microsoft Data Access Components](http://msdn.microsoft.com/en-us/library/aa968814(v=vs.85).aspx) (MDAC) 是一个组件集合，可使程序轻松访问数据库并随后操作数据库中的数据。 当今的数据库可以采用各种形式（例如，SQL 数据库、Microsoft Access 数据库、XML 文件等），并且可以存放在各种位置（例如，在本地系统上或在远程数据库服务器上）。 MDAC 将一组功能整合在了一起，这样，用户就可以采用一种一致的方式使用不同种类的数据源。 从 Windows Vista 开始，MDAC 被称为 Windows 数据访问组件 (WDAC)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0027](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0027)。
...
<td style="border:1px solid black;">Windows XP Service Pack 3 上的 Microsoft Data Access Components 2.8 Service Pack 1：<br />
请参阅 <a href="http://support.microsoft.com/kb/2419632">Microsoft 知识库文章 2419632</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2：<br />
请参阅 <a href="http://support.microsoft.com/kb/2419635">Microsoft 知识库文章 2419635</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2419635">Microsoft 知识库文章 2419635</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2419640">Microsoft 知识库文章 2419640</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   Abdul Aziz Hariri 与 [TippingPoint 的](http://www.tippingpoint.com/)* *[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 DSN 溢出漏洞 (CVE-2011-0026)  
-   Peter Vreugdenhil 与 [TippingPoint 的](http://www.tippingpoint.com/)* *[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 ADO 记录内存漏洞 ( CVE-2011-0027)

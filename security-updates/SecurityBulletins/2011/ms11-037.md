---
TOCTitle: 'MS11-037'
Title: 'Microsoft 安全公告 MS11-037 - 重要'
ms:assetid: 'ms11-037'
ms:contentKeyID: 61238175
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-037(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-037 - 重要
==================================

MHTML 中的漏洞可能允许信息泄露 (2544893)
----------------------------------------

发布时间: 2011年6月14日 | 更新时间: 2011年11月15日
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=ce5bc2d7-9438-4bf0-be5e-be9dd00c3286)                                                                                           | 信息泄露     | 重要         | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7b211b02-a005-46a3-ad1d-d4baaeec8289)                                                                  | 信息泄露     | 重要         | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6427ea5d-05d0-4367-805c-9cb305802b3c)                                                                                  | 信息泄露     | 低           | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e7f65891-32c0-4817-b3b2-d8be73145df9)                                                                      | 信息泄露     | 低           | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=ca8b1d09-9f80-417b-99b1-8f86e86e1f11)                                                                  | 信息泄露     | 低           | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ebea38a7-1fbe-4141-a529-52d7a7326d6a)                                                        | 信息泄露     | 重要         | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=54833350-a385-4a31-995a-9ddc38798c21)                                | 信息泄露     | 重要         | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6a3bbd67-94db-40b2-8786-cb39a493ec92)\*\*                     | 信息泄露     | 低           | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4cb870f3-9878-4075-b8fd-2ee90c8e3bc8)\*\*           | 信息泄露     | 低           | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e1243011-00e6-49f2-a676-c04cb805d36a)       | 信息泄露     | 低           | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c3647646-658a-423b-b0cb-bba7613b67e7)                                             | 信息泄露     | 重要         | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7996511d-4b8e-49c3-a0fa-4da907a6c947)                                   | 信息泄露     | 重要         | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=40354f73-4f4d-4a4a-abac-f8a3d4c3ae5f)\*\*     | 信息泄露     | 低           | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=22853823-8f63-4258-8991-1ad50e58a0d9) | 信息泄露     | 低           | [MS11-026](https://go.microsoft.com/fwlink/?linkid=212523) |
...
**为什么在 2011 年 11 月 8 日重新发布此公** **告？**  
Microsoft 重新发布此公告是为了对 Windows XP 和 Windows Server 2003 的所有受支持版本重新提供安全更新 KB2544893。新提供的这个更新适用于运行 Windows XP 或 Windows Server 2003，提供的累积性保护与此更新为所有其他受影响的操作系统提供的相同。运行 Windows XP 和 Windows Server 2003 受支持的版本的系统将被自动提供此更新的新版本。使用这些操作系统的客户（包括成功安装了最初在 2011 年 6 月 14 日提供的更新的客户）应该安装重新提供的更新。
...
<tr class="header">
<th>受影响的软件</th>
<th>MHTML MIME 格式请求漏洞 - CVE-2011-1894</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
MHTML MIME 格式请求漏洞 - CVE-2011-1894  
---------------------------------------
  
<span></span>  
MHTML 针对 HTML 文档中嵌入的内容解释 MIME 格式请求的方式中存在一个信息泄露漏洞。与服务器跨站点脚本执行 (XSS) 漏洞类似，在某些情况下，此漏洞可能允许攻击者注入客户端脚本，以响应用户的 Internet Explorer 实例上下文中运行的 Web 请求。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1894](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894)。
  
#### MHTML MIME 格式请求漏洞 (CVE-2011-1894) 的缓解因素
...
#### MHTML MIME 格式请求漏洞 (CVE-2011-1894) 的变通办法
...
-   **禁用 MHTML 协议处理程序**
    ...
    **交互方法：**
    ...
    要手动禁用 MHTML 协议处理程序，请按照下列步骤执行操作：
  
    1.  打开注册表编辑器。  
    2.  定位到以下注册表项：  
        HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml  
    3.  备份 mhtml 注册表项，方法是右键单击它，选择“**导出**”，然后将其另存为注册表文件（如“mhtml pluggable protocol registry backup.reg”）。  
    4.  从注册表中删除 mhtml 注册表项，方法是右键单击它，然后选择“**删除**”。
  
    **使用被管理的部署脚本：**
  
    要使用被管理的部署脚本禁用 MHTML 协议处理程序，请按照下列步骤执行操作：
  
    1.  使用下列命令条目备份 mhtml 注册表项：  
        regedit /e mhtml\_pluggable\_protocol\_registry\_backup.reg HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml  
    2.  通过将下列内容保存到扩展名为 .reg 的文件（如 disable\_mhtml\_pluggable\_protocol.reg）来创建被管理的部署脚本：  
        Windows Registry Editor Version 5.00  
        \[-HKEY\_CLASSES\_ROOT\\PROTOCOLS\\Handler\\mhtml\]  
    3.  使用下列命令行条目在目标系统上运行被管理的部署脚本：  
        regedit.exe /s disable\_mhtml\_pluggable\_protocol.reg
  
    **变通办法的影响。** MHTML 协议将停止运行。使用 MHTML 的任何应用程序均将受此变通办法影响。
  
    **如何撤消变通方法。** 要撤消此变通办法，请双击使用上述过程创建的备份注册表文件。
  
#### MHTML MIME 格式请求漏洞 (CVE-2011-1894) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个信息泄露漏洞。
  
**造成此漏洞的原因是什么？**    
当 MHTML 针对 HTML 文档中嵌入的内容块解释 MIME 格式请求时，会导致此漏洞，攻击者可能会在错误的安全上下文中运行脚本（例如，一些脚本可能会在不正确的 Internet Explorer 安全区域中运行）。
  
**什么是 MHTML？**    
MHTML（聚合 HTML 文档的 MIME 封装）是一个 Internet 标准，定义用于封装 HTML 内容的 MIME 结构。Windows 中的 MHTML 协议处理程序提供一种允许在应用程序中呈现 MHTML 编码的文档的可插入协议 (MHTML:) 该协议允许在应用程序中呈现 MHTML 编码的文档。有关详细信息，请参阅 MSDN 文章[关于异步可插入协议](https://msdn.microsoft.com/en-us/library/aa767916(v=vs.85).aspx)。
  
**什么是跨站点脚本执行 (XSS)？**    
跨站点脚本执行 (XSS) 是一种安全漏洞类别，允许攻击者在网页响应中注入脚本。此脚本随后由发出请求的应用程序（通常是 Web 浏览器）运行。该脚本可能欺骗内容、泄露信息或执行用户可以在受影响的网站上代表目标用户执行的任何操作。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以在用户的 Internet Explorer 实例中注入客户端脚本。该脚本可能欺骗内容、泄露信息或执行用户可以在受影响的网站上代表目标用户执行的任何操作。
  
**攻击者如何利用此漏洞？**    
成功利用此漏洞的攻击者可以使用 HTML &lt;EMBED&gt; 标记创建在页面中嵌入了恶意脚本的网站。然后，攻击者可以说服用户访问站点，从而允许攻击者在错误的安全上下文中运行客户端脚本。该脚本可能欺骗内容、泄露信息或执行用户可以在网站上执行的任何操作。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-1894](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1894)。
...
**注意** Microsoft 在 2011 年 4 月 12 日之后不再对 SMS 2.0 提供支持。对于 SMS 2003，Microsoft 在 2011 年 4 月 12 日之后也不再对安全更新清单工具 (SUIT) 提供支持。鼓励客户升级到 [System Center Configuration Manager 2007](https://technet.microsoft.com/en-us/library/bb735860.aspx)。对于保留使用 SMS 2003 Service Pack 3 的客户，[Microsoft 更新清单工](https://technet.microsoft.com/en-us/systemcenter/bb676783.aspx)具 (ITMU) 也是一种选择。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2544893-v2$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2544893">Microsoft 知识库文章 2544893</a></td>
</tr>  
<tr class="even">
...
<br />  
<strong>注意</strong> 在安装了更新文件的初始版本的系统上，也会存在以下注册表项：<br />
...
-   [Google Security Team](https://www.google.com/) 的 Billy Rios 和 Eduardo Vela Nava 与我们一起努力处理了此公告更改。
...
-   V2.0（2011 年 11 月 8 日）： 重新发布此公告是位了对 Windows XP 和 Windows Server 2003 的所有受支持版本重新提供更新。使用 Windows XP 或 Windows Server 2003 的客户（包括成功安装了最初在 2011 年 6 月 14 日提供的更新的客户）应该安装重新提供的更新。有关详细信息，请参阅更新常见问题。  
-   V2.1（2011 年 11 月 15 日）： 更正了 Windows XP 和 Windows Server 2003 的安装验证注册表项、更新日志文件名和删除信息。这仅仅是信息更改。

---
TOCTitle: 'MS11-007'
Title: 'Microsoft 安全公告 MS11-007 - 严重'
ms:assetid: 'ms11-007'
ms:contentKeyID: 61238145
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-007(v=Security.10)'
---
...
OpenType 压缩字体格式 (CFF) 驱动程序中的漏洞可能允许远程执行代码 (2485376)
--------------------------------------------------------------------------

发布时间: 2011年2月8日 | 更新时间: 2013年7月9日
...
此安全更新通过更正 Windows OpenType Compact 字体格式 (CFF) 驱动程序验证特制 OpenType 字体参数值的方式解决该漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=f86e9e64-801a-431a-b24e-772011dfa66d)                                                                                           | 特权提升     | 重要         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=074396f0-a68c-4190-8dac-0b883d56e3f1)                                                                  | 特权提升     | 重要         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a99c2b13-db81-4f18-9cf7-c20614ba0132)                                                                                  | 特权提升     | 重要         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=aeed45fb-9395-4c2b-a674-e38b04fe0914)                                                                      | 特权提升     | 重要         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=bc09e42b-2eed-41b3-a03f-cb8cc94adfee)                                                                  | 特权提升     | 重要         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d60a2098-7351-4fce-83b2-2c1c3a24faa0)                                                        | 远程执行代码 | 严重         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=065ad8fe-1caf-488e-a2e1-96db29f2fa57)                                | 远程执行代码 | 严重         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=88ba83b9-c14e-499a-8335-04bac1c49c0c)\*                       | 远程执行代码 | 严重         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7c74d7f4-6372-4809-89b8-c79b05e54cdd)\*             | 远程执行代码 | 严重         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=91d5d34b-9d7e-4e83-89a4-f1aa388dc4e4)       | 远程执行代码 | 严重         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1da57fbc-9ea4-4fc4-911d-d5c7825e012c)                                             | 远程执行代码 | 严重         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=587adb89-2f6a-4893-9906-b6d6d9ada2bd)                                   | 远程执行代码 | 严重         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=638318ed-4000-4b1a-bb4b-65b795f59784)\*       | 远程执行代码 | 严重         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4688ea0d-a467-4f24-ac52-104d05c8cae8) | 远程执行代码 | 严重         | [MS10-091](https://go.microsoft.com/fwlink/?linkid=203895) |
...
<tr class="header">
<th>受影响的软件</th>
<th>OpenType 字体编码字符漏洞 - CVE-2011-0033</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
OpenType 字体编码字符漏洞 - CVE-2011-0033  
-----------------------------------------
  
<span></span>  
Windows OpenType 压缩字体格式 (CFF) 驱动程序不正确解析特制 OpenType 字体的方式中存在一个远程代码执行漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0033)。
  
#### OpenType 字体编码字符漏洞 (CVE-2011-0033) 的缓解因素
...
#### OpenType 字体编码字符漏洞 (CVE-2011-0033) 的变通办法
...
#### OpenType 字体编码字符漏洞 (CVE-2011-0033) 的常见问题
...
**此更新有什么作用？**  
此更新通过更正 Windows OpenType Compact 字体格式 (CFF) 驱动程序验证特制 OpenType 字体参数值的方式解决该漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2485376$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2485376">Microsoft 知识库文章 2485376</a></td>
</tr>  
<tr class="even">
...
-   V2.1 （2013 年 7 月9 日）： 已修订公告，宣布一个检测更改，从用于 Windows XP Professional x64 Edition Service Pack 2 的 2485376 更新中排除 Windows 7 语言包。这仅仅是一个检测更改。已经成功更新了其系统的客户不需要执行任何操作。

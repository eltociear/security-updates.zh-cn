...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|-------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=21b4b999-2dbf-4921-80bd-cc7ab2cd1190)                                                                                           | 远程执行代码 | 严重              | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=126e8092-980d-471a-867d-d5939671b7df)                                                                  | 远程执行代码 | 严重              | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=dfb948c5-8aee-4bcd-babf-3564b78712dd)                                                                                  | 远程执行代码 | 严重              | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2d37a8cb-2316-4db4-980c-11b6dcbdc696)                                                                      | 远程执行代码 | 严重              | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=7726ddbe-0578-44fb-a40f-49b804a45989)                                                                  | 远程执行代码 | 严重              | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1dd069a2-fb1a-4f31-88cc-bc031c3e2c80)                                                                                        | 无           | 没有严重等级<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=60fd5bf6-e820-44f6-8081-b98c0103acc1)                                                                            | 无           | 没有严重等级<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f485d4c3-a4af-4ae6-9404-e79afcbb4f6e)\*\*                                                             | 无           | 没有严重等级<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=28598ef6-13fb-44fd-8c76-599af7b0a01d)\*\*                                                        | 无           | 没有严重等级<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5915e19c-b576-453b-b621-5737774f5955)                                                        | 无           | 没有严重等级<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d112623c-86ce-434a-8fe1-ec3e3e632763)                                             | 无           | 没有严重等级<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=81114ecd-0c73-4ca6-8a66-09c6c636a5db)                                   | 无           | 没有严重等级<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=bc018647-08cb-431a-8e7c-5dc04980eaa9)\*\*     | 无           | 没有严重等级<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=9323b9b9-e9b0-4941-afe0-196d22df9ab4) | 无           | 没有严重等级<sup>[1]</sup> | [MS11-027](https://go.microsoft.com/fwlink/?linkid=214005) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-3397](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3397)。
...
-   **Dell IT Assistant。** 下列类标识符与 Dell 为易受攻击的 ActiveX 控件设置 kill bit 的要求相关。如果您对 Dell IT Assistant ActiveX 控件有任何问题或疑问，请联系 [Dell](https://www.dell.com/)。此 ActiveX 控件的类标识符 (CLSID) 为：
    -   {6286EF1A-B56E-48EF-90C3-743410657F3C}
-   **HP Easy Printer Care Software。** 下列类标识符与 Hewlett Packard 为易受攻击的此 ActiveX 控件设置 kill bit 的要求相关。可以在 [Hewlett Packard](https://www.hp.com) 发布的[通报](https://h20000.www2.hp.com/bizsupport/techsupport/document.jsp?objectid=c02949847)中找到更多详细信息。此 ActiveX 控件的类标识符 (CLSID) 为：
    -   {466576F3-19B6-4FF1-BD48-3E0E1BFB96E9}
-   **HP Photo Creative。** 下列类标识符与 RocketLife 为易受攻击的此 ActiveX 控件设置 kill bit 的请求相关。如果您对 HP Photo Creative ActiveX 控件有任何问题或疑问，请联系 [RocketLife](https://www.rocketlife.com)。此 ActiveX 控件的类标识符 (CLSID) 为：
    -   {3EEEBC9A-580F-46EF-81D9-55510266413D}
-   **Yahoo!CD Player。** 下列类标识符与 Yahoo! 为易受攻击的此 ActiveX 控件设置 kill bit 的要求相关。如果您对 Yahoo! CD Player ActiveX 控件有任何问题或疑问，请联系 [Yahoo!](https://www.yahoo.com)。此 ActiveX 控件的类标识符 (CLSID) 为：
...
-   一位匿名研究员与 [VeriSign iDefense Labs](https://labs.idefense.com) 合作报告了 Microsoft Time 远程执行代码漏洞 (CVE-2011-3397)

---
TOCTitle: 'MS11-030'
Title: 'Microsoft 安全公告 MS11-030 - 严重'
ms:assetid: 'ms11-030'
ms:contentKeyID: 61238168
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-030(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-030 - 严重
==================================

DNS 解析中的漏洞可能允许远程执行代码 (2509553)
----------------------------------------------
...
此安全更新可解决 Windows DNS 解析中一个秘密报告的漏洞。如果攻击者获得网络访问权限，然后创建一个自定义程序以将特制的 LLMNR 广播查询发送到目标系统，则该漏洞可能允许远程执行代码。采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。在这种情况下，应阻止从 Internet 访问 LLMNR 端口。

对于 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“严重”。对于 Windows XP 和 Windows Server 2003 的所有受支持版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

该安全更新通过更正 DNS 客户端处理特制 DNS 查询的方式来解决该漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。**[Microsoft 知识库文章 2509553](https://support.microsoft.com/kb/2509553) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f5ad6963-2d6a-4d59-9e25-4fc088647fcd">Windows Server 2003 SP2（用于基于 Itanium 的系统）</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=108231">MS08-020</a>，<br />
<a href="https://go.microsoft.com/fwlink/?linkid=119620">MS08-037</a>,<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9894be38-a582-4c15-ad0e-cc3afab2aebc">Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2</a>*</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2d7d2021-020f-4cc9-a027-258d7e5faec9">Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2</a>*</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c0275df0-10ac-4500-ab86-b7e9a34f8e1d">Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8fdae09b-d1bb-4ef5-aa45-2a05f2a5e12d">Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=40879dfb-efa4-41ba-8d5c-22e926a55eef">Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2084c726-187e-41f9-9bea-da18f490d29e">Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1</a>*</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=34d2793e-a2cd-49f6-b524-6598ea86175f">Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
DNS 查询漏洞 - CVE-2011-0657  
----------------------------
  
<span></span>  
DNS 客户端服务处理特制 LLMNR 查询的方式中存在一个远程执行代码漏洞。成功利用此漏洞的攻击者可以在 NetworkService 帐户的上下文中运行任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0657](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0657)。
  
#### DNS 查询漏洞 (CVE-2011-0657) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在 Windows Vista 和 Windows 7 中，如果网络配置文件设置为“公共”，则系统不受此漏洞的影响，因为非法入站网络数据包默认被阻止。  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。在这种情况下，应阻止从 Internet 访问 LLMNR 端口。有关在防火墙处阻止 TCP 端口 5355 和 UDP 端口 5355 的信息，请参阅下面的常见问题。
  
#### DNS 查询漏洞 (CVE-2011-0657) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **在防火墙处阻止 TCP 端口 5355 和 UDP 端口 5355**
  
    这些端口用于启动与受影响组件的连接。将其阻止在企业防火墙处（入站和出站），有助于保护位于防火墙后面的系统免受利用此漏洞进行的攻击。我们建议阻止所有来自 Internet 的未经请求的入站通信，以帮助防止可能使用其他端口进行的攻击。有关端口的详细信息，请参阅 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。有关 Windows 防火墙的详细信息，请参阅[如何在单台计算机上配置 Windows 防火墙](https://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx)。
  
    **变通办法的影响。** 阻止与这些端口进行连接可帮助防止防火墙后面的系统尝试利用此漏洞。
  
    **如何撤消变通方法。** 在防火墙处阻止 TCP 端口 5355 和 UDP 端口 5355。有关端口的详细信息，请参阅 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。
  
-   **使用组策略禁用链接-本地多播名称解析**
  
    要使用组策略禁用链接-本地多播名称解析，请执行以下步骤：
  
    1.  打开组策略编辑器。  
    2.  展开“**计算机配置**”，展开“**管理模板**”，展开“**网络**”，然后展开“**DNS 客户端**”。  
    3.  双击“**关闭多播名称解析**”，单击“**启用**”，然后单击“**确定**”。
  
    **变通办法的影响。** 该计算机对于网络上的其他计算机可能不可见。
  
    **如何撤消变通方法。**
  
    要使用组策略重新启用链接-本地多播名称解析，请执行以下步骤：
  
    1.  打开组策略编辑器。  
    2.  展开“**计算机配置**”，展开“**管理模板**”，展开“**网络**”，然后展开“**DNS 客户端**”。  
    3.  双击“**关闭多播名称解析**”，单击“**禁用**”，然后单击“**确定**”。
...
-   **关闭网络发现**
    ...
    1.  打开控制面板。  
    2.  单击“**网络和 Internet**”，单击“**网络和共享中心**”，然后单击“**更改高级共享设置**”。  
    3.  在“网络发现”下，单击“**关闭网络发现**”，然后单击“**保存更改**”。
    ...
    **如何撤消变通方法。**
    ...
    1.  打开控制面板。  
    2.  单击“**网络和 Internet**”，单击“**网络和共享中心**”，然后单击“**更改高级共享设置**”。  
    3.  在“网络发现”下，单击“**打开网络发现**”，然后单击“**保存更改**”。
  
#### DNS 查询漏洞 (CVE-2011-0657) 的常见问题
  
**此漏洞的影响范围有多大？**  
在 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 系统上，这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可以在 NetworkService 帐户的上下文中执行代码。
  
在 Windows XP 和 Windows Server 2003 系统上，这是一个特权提升漏洞。具有用户凭据的攻击者可以利用漏洞，导致特权提升，从而允许攻击者在 NetworkService 帐户的上下文中执行代码。
  
**造成此漏洞的原因是什么？**  
DNS 客户端处理特制 LLMNR 查询的方式导致该漏洞。
  
**哪个组件受此漏洞的影响？**  
DNSAPI.dll 是受影响的组件。
  
**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以在 NetworkService 帐户的上下文中运行任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**攻击者如何利用此漏洞？**  
在 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 系统上，成功利用此漏洞的攻击者需要访问网络。然后，攻击者可以创建一个自定义程序以将特制 LLMNR 广播查询发送到目标系统。
  
在 Windows XP 和 Windows Server 2003 系统上，攻击者必须先登录系统才能利用此漏洞。攻击者随后可以运行一个特制应用程序，该应用程序可以利用该漏洞并将攻击者特权提升到 NetworkService 帐户的。
  
**在 Windows XP 或 Windows Server 2003 中是否可远程利用此漏洞？**  
否。Windows XP 或 Windows Server 2003 中不支持 LLMNR。对于这些系统，DNS 客户端中的漏洞仍然存在，并且只能通过运行特制应用程序被利用。
  
**什么是 LLMNR？**  
链接-本地多播名称解析 (LLMNR) 是一种提供附加方法来解析相邻计算机的名称的新协议。LLMNR 对于没有域名系统 (DNS) 服务器的网络特别有用。LLMNR 使用简单的请求交换和回复消息来将计算机名称解析为 Internet 协议版本 6 (IPv6) 或 IP 版本 4 (IPv4) 地址。有关 LLMNR 的详细信息，请参阅 Microsoft TechNet 文章[链接-本地多播名称解析](https://technet.microsoft.com/en-us/library/bb878128.aspx)。
  
**受此漏洞威胁最大的系统有哪些？**  
工作站和终端服务器受到的威胁最大。如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**  
该更新通过更正 DNS 客户端处理特制 DNS 查询的方式来解决该漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2509553$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2509553">Microsoft 知识库文章 2509553</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc.](https://www.google.com/) 的 Neel Mehta 报告了 DNS 查询漏洞 (CVE-2011-0657)
...
-   V1.1（2012 年 3 月 13 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2509553 添加一个链接。

---
TOCTitle: 'MS11-083'
Title: 'Microsoft 安全公告 MS11-083 - 严重'
ms:assetid: 'ms11-083'
ms:contentKeyID: 61238221
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-083(v=Security.10)'
---


Microsoft 安全公告 MS11-083 - 严重
==================================
...
该安全更新通过修改 Windows TCP/IP 堆栈跟踪内存中的 UDP 数据包的方式来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fc3fe87c-2493-431d-a904-dec9310f6042)                                                                                        | 严重         | 远程执行代码 | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=042c1a8f-834d-4eed-8a59-9e030ccc6d39)                                                                            | 严重         | 远程执行代码 | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=79382bf2-d2cb-42ea-92dc-64f949353521)\*                                                               | 严重         | 远程执行代码 | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=71ff3a89-d7ad-4dda-9e59-fab54b21bd5d)\*                                                          | 严重         | 远程执行代码 | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b1c0cb05-c284-49b1-ae4f-92813fdf520f)                                                        | 严重         | 远程执行代码 | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4ddb4c2a-bada-49b0-ad78-e07e7e11ced7)                                             | 严重         | 远程执行代码 | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=05eef5d7-acf6-46e4-abfc-dc83f0a7cae5)                                   | 严重         | 远程执行代码 | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=3f9f74a6-e984-4aab-837c-ef7286e7305f)\*       | 严重         | 远程执行代码 | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b20bfcbd-a515-4074-b56e-b82539fe5bad) | 严重         | 远程执行代码 | [MS11-064](https://go.microsoft.com/fwlink/?linkid=221808) |
...
引用计数器溢出漏洞 - CVE-2011-2013  
----------------------------------
  
<span></span>  
由于处理特制 UDP 数据包的持续数据流，Windows TCP/IP 堆栈中存在一个远程执行代码漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2013](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2013)。
  
#### 引用计数器溢出漏洞 (CVE-2011-2013) 的缓解因素
  
Microsoft 并未发现此漏洞的任何缓解因素。
  
#### 引用计数器溢出漏洞 (CVE-2011-2013) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **在外围防火墙处阻止未使用的** **UDP** **端口**
  
    在外围防火墙处阻止未使用的（封闭）UDP 端口有助于防止防火墙后面的系统尝试利用此漏洞。有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。
  
#### 引用计数器溢出漏洞 (CVE-2011-2013) 的常见问题
  
**此漏洞的影响范围有多大？**   
这是 Windows 内核上下文中的远程执行代码漏洞。
  
**造成此漏洞的原因是什么？**   
当 Windows TCP/IP 堆栈处理特制 UDP 数据包的持续流，从而引发整数溢出时，则会导致该漏洞。
...
**什么是** **UDP？**  
用户数据报协议 (UDP) 是 RFC 768“用户数据报协议 (UDP)”中定义的一项 TCP/IP 标准。UDP 由一些程序（而不是 TCP）用于在 TCP/IP 主机之间执行快速、轻型且不可靠的数据传输。UDP 提供了一种无连接的数据报服务，该服务可提供最大努力交付，这意味着 UDP 不保证交付或验证任何数据报的序列。需要可靠通信的源主机必须使用 TCP 或者提供其自己的序列和确认服务的程序。有关详细信息，请参阅 TechNet 文章[用户数据报协议 (UDP)](https://technet.microsoft.com/en-us/library/cc785220(ws.10).aspx)。
  
**攻击者可能利用此漏洞执行什么操作？**   
成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**攻击者如何利用此漏洞？**   
攻击者可能通过向目标系统上的封闭端口发送特制 UDP 数据包的持续流来利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**   
工作站和服务器受此漏洞的威胁最大。
  
**此更新有什么作用？**   
该更新通过修改 Windows TCP/IP 堆栈跟踪内存中的 UDP 数据包的方式来解决此漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2588516">Microsoft 知识库文章 2588516</a></td>
</tr>  
<tr class="odd">
...
[Microsoft Active Protections Program (MAPP) 合作伙伴](https://go.microsoft.com/fwlink/?linkid=215201)

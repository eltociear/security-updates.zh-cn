---
TOCTitle: 'MS11-031'
Title: 'Microsoft 安全公告 MS11-031 - 严重'
ms:assetid: 'ms11-031'
ms:contentKeyID: 61238169
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-031(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-031 - 严重
==================================

JScript 和 VBScript 脚本引擎中的漏洞可能允许远程执行代码 (2514666)
------------------------------------------------------------------
...
[MS10-022](https://go.microsoft.com/fwlink/?linkid=184779)
</td>
</tr>
...
<sup>[1]</sup>安装了 Internet Explorer 9 的系统不受影响，不需要此更新。 尚未升级为 Internet Explorer 9 的系统需要其上安装的 JScript 和 VBScript 脚本引擎版本的正确更新。 有关如何确定系统上安装的 JScript 和 VBScript 脚本引擎版本的说明，请参阅下面的**与此安全更新相关的常见问题 (FAQ)**。

**不受影响的软件**

| 操作系统                                                                                                            | 组件                                                      |
|---------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|
| Windows Vista Service Pack 2                                                                                        | 安装了 Internet Explorer 9 的 JScript 5.8 和 VBScript 5.8 |
| Windows Vista x64 Edition Service Pack 2                                                                            | 安装了 Internet Explorer 9 的 JScript 5.8 和 VBScript 5.8 |
| Windows Server 2008（用于 32 位系统）Service Pack 2                                                                 | 安装了 Internet Explorer 9 的 JScript 5.8 和 VBScript 5.8 |
| Windows Server 2008（用于基于 x64 的系统）Service Pack 2                                                            | 安装了 Internet Explorer 9 的 JScript 5.8 和 VBScript 5.8 |
| Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1                                             | 安装了 Internet Explorer 9 的 JScript 5.8 和 VBScript 5.8 |
| Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1                                   | 安装了 Internet Explorer 9 的 JScript 5.8 和 VBScript 5.8 |
| Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1         | 安装了 Internet Explorer 9 的 JScript 5.8 和 VBScript 5.8 |
| Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1 | 安装了 Internet Explorer 9 的 JScript 5.8 和 VBScript 5.8 |
...
JScript 5.6 和 VBScript 5.6 脚本引擎
</th>
</tr>
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 上的 JScript 5.6 和 VBScript 5.6
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition Service Pack 2 上的 JScript 5.6 和 VBScript 5.6
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<th colspan="3" style="border:1px solid black;">
JScript 5.7 和 VBScript 5.7 脚本引擎
</th>
</tr>
<tr>
<td style="border:1px solid black;">
Windows XP Service Pack 3 上的 JScript 5.7 和 VBScript 5.7
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 上的 JScript 5.7 和 VBScript 5.7
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的 JScript 5.7 和 VBScript 5.7
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的 JScript 5.7 和 VBScript 5.7
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2 上的 JScript 5.7 和 VBScript 5.7\*\*
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上的 JScript 5.7 和 VBScript 5.7\*\*
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2 上的 JScript 5.7 和 VBScript 5.7\*\*
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<th colspan="3" style="border:1px solid black;">
JScript 5.8 和 VBScript 5.8 脚本引擎
</th>
</tr>
<tr>
<td style="border:1px solid black;">
Windows XP Service Pack 3 上的 JScript 5.8 和 VBScript 5.8
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 上的 JScript 5.8 和 VBScript 5.8
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 上的 JScript 5.8 和 VBScript 5.8
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition Service Pack 2 上的 JScript 5.8 和 VBScript 5.8
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的 JScript 5.8 和 VBScript 5.8
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的 JScript 5.8 和 VBScript 5.8
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2 上的 JScript 5.8 和 VBScript 5.8\*\*
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上的 JScript 5.8 和 VBScript 5.8\*\*
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<td style="border:1px solid black;">
Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1 上的 JScript 5.8 和 VBScript 5.8
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1 上的 JScript 5.8 和 VBScript 5.8
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 上的 JScript 5.8 和 VBScript 5.8\*\*
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 上的 JScript 5.8 和 VBScript 5.8
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
JScript 和 VBScript 脚本引擎中因内存损坏错误而存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以在本地登录用户的上下文中运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0663](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0663)。

#### 脚本内存重新分配漏洞 (CVE-2011-0663) 的缓解因素
...
#### 脚本内存重新分配漏洞 (CVE-2011-0663) 的变通办法
...
#### 脚本内存重新分配漏洞 (CVE-2011-0663) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
此漏洞由 JScript 和 VBScript 脚本引擎处理网页中脚本的方式导致。 如果脚本引擎在对脚本进行解码以便运行该脚本时尝试重新分配内存，则可能会发生整数溢出。
...
是。 默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“增强安全配置”的受限模式下运行。 [增强安全配置](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)是一组预先配置好的 Internet Explorer 设置，可以减小用户或管理员在服务器上下载并运行特制 Web 内容的可能性。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。
...
<td style="border:1px solid black;">对于 Windows XP Service Pack 3 上的 JScript 5.7 和 VBScript 5.7：<br />
windowsxp-kb2510581-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Service Pack 3 上的 JScript 5.8 和 VBScript 5.8：<br />
ie8-windowsxp-kb2510531-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Professional x64 Edition Service Pack 2 上的 JScript 5.6 和 VBScript 5.6：<br />
windowsserver2003.windowsxp-kb2510587-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Professional x64 Edition Service Pack 2 上的 JScript 5.7 和 VBScript 5.7：<br />
windowsserver2003.windowsxp-kb2510581-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Professional x64 Edition Service Pack 2 上的 JScript 5.8 和 VBScript 5.8：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Professional x64 Edition Service Pack 2 上的 JScript 5.6 和 VBScript 5.6： 对于 Windows XP Professional x64 Edition Service Pack 2 上的 JScript 5.6 和 VBScript 5.6：<br />
...
<td style="border:1px solid black;">对于 JScript 5.6 和 VBScript 5.6： KB2510587.log</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.7 和 VBScript 5.7： KB2510581.log</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.8 和 VBScript 5.8： KB2510531-IE8.log</td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;">对于 JScript 5.6 和 VBScript 5.6，使用控制面板中的“<strong>添加或删除程序</strong>”工具或位于 %Windir%\\$NTUninstallKB2510587$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.7 和 VBScript 5.7，使用控制面板中的“<strong>添加或删除程序</strong>”工具或位于 %Windir%\\$NTUninstallKB2510581$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.8 和 VBScript 5.8，使用控制面板中的“<strong>添加或删除程序</strong>”工具或位于 %Windir%\ie8updates\KB2510531-IE8$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 JScript 5.6 和 VBScript 5.6，请参阅 <a href="https://support.microsoft.com/kb/2510587">Microsoft 知识库文章 2510587</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.7 和 VBScript 5.7，请参阅 <a href="https://support.microsoft.com/kb/2510581">Microsoft 知识库文章 2510581</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.8 和 VBScript 5.8，请参阅 <a href="https://support.microsoft.com/kb/2510531">Microsoft 知识库文章 2510531</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2003 Service Pack 2 上的 JScript 5.6 和 VBScript 5.6：<br />
windowsserver2003-kb2510587-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 Service Pack 2 上的 JScript 5.7 和 VBScript 5.7：<br />
windowsserver2003-kb2510581-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 Service Pack 2 上的 JScript 5.8 和 VBScript 5.8：<br />
ie8-windowsserver2003-kb2510531-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 x64 Edition Service Pack 2 上的 JScript 5.6 和 VBScript 5.6：<br />
windowsserver2003.windowsxp-kb2510587-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 x64 Edition Service Pack 2 上的 JScript 5.7 和 VBScript 5.7：<br />
windowsserver2003.windowsxp-kb2510581-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 x64 Edition Service Pack 2 上的 JScript 5.8 和 VBScript 5.8：<br />
ie8-windowsserver2003.windowsxp-kb2510531-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 SP2（用于基于 Itanium 的系统）上的 JScript 5.6 和 VBScript 5.6：<br />
windowsserver2003-kb2510587-ia64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 SP2（用于基于 Itanium 的系统）上的 JScript 5.7 和 VBScript 5.7：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 JScript 5.6 和 VBScript 5.6：<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2510587\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.7 和 VBScript 5.7：<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB2510581\Filelist</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.8 和 VBScript 5.8：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Vista 的所有受支持 32 位版本上的 JScript 5.7 和 VBScript 5.7：<br />
windows6.0-kb2510581-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Vista 的所有受支持 32 位版本上的 JScript 5.8 和 VBScript 5.8：<br />
ie8-windows6.0-kb2510531-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Vista 的所有受支持的基于 x64 的版本上的 JScript 5.7 和 VBScript 5.7：<br />
windows6.0-kb2510581-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Vista 的所有受支持 64 位版本上的 JScript 5.8 和 VBScript 5.8：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2008 的所有受支持 32 位版本上的 JScript 5.7 和 VBScript 5.7：<br />
windows6.0-kb2510581-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 的所有受支持 32 位版本上的 JScript 5.8 和 VBScript 5.8：<br />
ie8-windows6.0-kb2510531-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 的所有受支持的基于 x64 的版本上的 JScript 5.7 和 VBScript 5.7：<br />
windows6.0-kb2510581-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 的所有受支持 64 位版本上的 JScript 5.8 和 VBScript 5.8：<br />
ie8-windows6.0-kb2510531-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 的所有受支持的基于 Itanium 的版本上的 JScript 5.7 和 VBScript 5.7：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2008 R2 的所有受支持 64 位版本上的 JScript 5.8 和 VBScript 5.8：<br />
windows6.1-kb2510531-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   [Mozilla](https://www.mozilla.org/) 的 [Jesse Ruderman](https://www.squarefree.com/) 与我们合作处理了脚本内存重新分配漏洞 (CVE-2011-0663)
...
-   V1.1（2011 年 4 月 20 日）： 已更新公告，阐述对于 Windows XP、Windows Server 2003、Windows Vista 和 Windows Server 2008 的所有受支持版本，JScript 5.8 和 VBScript 5.8 更新 (KB2510531) 除了取代 MS10-022 外，也取代 MS09-045。

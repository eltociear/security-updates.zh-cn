...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0663](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0663)。
...
是。 默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“增强安全配置”的受限模式下运行。 [增强安全配置](http://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)是一组预先配置好的 Internet Explorer 设置，可以减小用户或管理员在服务器上下载并运行特制 Web 内容的可能性。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。
...
<td style="border:1px solid black;">对于 JScript 5.6 和 VBScript 5.6，请参阅 <a href="http://support.microsoft.com/kb/2510587">Microsoft 知识库文章 2510587</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.7 和 VBScript 5.7，请参阅 <a href="http://support.microsoft.com/kb/2510581">Microsoft 知识库文章 2510581</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 JScript 5.8 和 VBScript 5.8，请参阅 <a href="http://support.microsoft.com/kb/2510531">Microsoft 知识库文章 2510531</a></td>
</tr>  
<tr class="even">
...
-   [Mozilla](http://www.mozilla.org/) 的 [Jesse Ruderman](http://www.squarefree.com/) 与我们合作处理了脚本内存重新分配漏洞 (CVE-2011-0663)

---
TOCTitle: 'MS11-098'
Title: 'Microsoft 安全公告 MS11-098 - 重要'
ms:assetid: 'ms11-098'
ms:contentKeyID: 61238236
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-098(v=Security.10)'
---


Microsoft 安全公告 MS11-098 - 重要
==================================

Windows 内核中的漏洞可能允许特权提升 (2633171)
----------------------------------------------

发布时间: 2011年12月13日 | 更新时间: 2012年2月1日
...
此安全更新可解决 Microsoft Windows 中一个秘密报告的漏洞。如果攻击者登录受影响的系统并运行旨在利用该漏洞的特制应用程序，该漏洞可能允许特权提升。攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。

对于 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008 和 Windows 7 的所有受支持的 32 位版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节的“**受影响和不受影响的软件**”小节。

此安全更新通过帮助确保 Windows 内核初始化内存中的对象来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。

**建议。** 对于管理员、企业安装或者想要手动安装此安全更新的最终用户，Microsoft 建议客户使用更新管理软件尽早应用此更新或者利用 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 服务检查更新。

另请参阅本公告后面部分中的“**检测和部署工具及指导**”一节。

**已知问题。**[Microsoft 知识库文章 2633171](https://support.microsoft.com/kb/2633171) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=7a6fcf8d-8c7b-4882-90d3-02db79a75238)                                               | 特权提升     | 重要         | [MS10-047](https://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=281e5bd4-4582-4aa9-af88-518ad3152132)                                      | 特权提升     | 重要         | [MS10-021](https://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a6c7c960-768d-40d4-8fe5-7d59f48ead1d)                                            | 特权提升     | 重要         | [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5a4443f8-fec8-42be-ad67-8475920f1460)\*                   | 特权提升     | 重要         | [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=eb2bd108-5ef1-45be-9157-e7cbfc8afd2a) | 特权提升     | 重要         | [MS11-068](https://go.microsoft.com/fwlink/?linkid=223578) |
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 内核异常处理程序漏洞 - CVE-2011-2018</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Windows 内核异常处理程序漏洞 - CVE-2011-2018  
--------------------------------------------
  
<span></span>  
由于内核访问未正确初始化的对象的方式，Windows 内核中存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2018)。
  
#### Windows 内核异常处理程序漏洞 (CVE-2011-2018) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核异常处理程序漏洞 (CVE-2011-2018) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核异常处理程序漏洞 (CVE-2011-2018) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
当 Windows 内核访问未正确地初始化的对象时，会导致该漏洞。
...
**此更新有什么作用？**  
此更新通过帮助确保 Windows 内核初始化内存中的对象来解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2633171$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2633171">Microsoft 知识库文章 2633171</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB2633171$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2633171](https://support.microsoft.com/kb/2633171)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Matthew Jurczyk 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Windows 内核异常处理程序漏洞 (CVE-2011-2018)
...
-   V1.1（2012 年 2 月 1 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2633171 添加一个链接。

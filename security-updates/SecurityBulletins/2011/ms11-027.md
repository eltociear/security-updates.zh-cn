---
TOCTitle: 'MS11-027'
Title: 'Microsoft 安全公告 MS11-027 - 严重'
ms:assetid: 'ms11-027'
ms:contentKeyID: 61238165
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-027(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-027 - 严重
==================================

ActiveX Kill Bit 的累积性安全更新 (2508272)
-------------------------------------------

发布时间: 2011年4月12日 | 更新时间: 2011年7月27日
...
对于 Windows XP、Windows Vista 和 Windows 7 的所有受支持版本，此安全更新的等级为“严重”；对于 Windows Server 2003（基于 Itanium 的版本除外）、Windows Server 2008（基于 Itanium 的版本除外）和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“中等”。对于 Windows Server 2003 和 Windows Server 2008 的基于 Itanium 的版本，此安全更新没有严重等级。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|-------------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=b031a496-aa74-4367-b2ae-24843c061745)                                                                                     | 远程执行代码 | 严重              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=eddd2964-9765-461d-9df8-2c05402948e8)                                                            | 远程执行代码 | 严重              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=53756404-39e4-43af-81e9-81471536aa66)                                                                            | 远程执行代码 | 中等              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c8d59f49-45ec-4527-b3a8-4925f710bbfd)                                                                | 远程执行代码 | 中等              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=9c784734-f44f-4a3c-8223-6289f7dc2ad8)                                                            | 无           | 没有严重等级<sup>[1]</sup> | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=80bf050a-9aff-4cd4-8e2f-196b0a92b1c0)                                                  | 远程执行代码 | 严重              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a81412d0-2516-4bf4-87f7-3e41ebf6b82b)                          | 远程执行代码 | 严重              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c3247886-76d0-4292-be9d-3e9b0221c46a)\*\*               | 远程执行代码 | 中等              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=51521b6b-94a7-4bcf-ad5f-fc304728b10f)\*\*     | 远程执行代码 | 中等              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e7c38b0d-7240-420a-88d3-2749a40e386f) | 无           | 没有严重等级<sup>[1]</sup> | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=46510959-e4a2-4c21-b33c-fd3d97b3ac3d)                                                                                   | 远程执行代码 | 严重              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=46510959-e4a2-4c21-b33c-fd3d97b3ac3d)                                                                     | 远程执行代码 | 严重              | 无                                                        |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=432555cf-aed8-4329-a74f-526441521082)                                                                              | 远程执行代码 | 严重              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=432555cf-aed8-4329-a74f-526441521082)                                                                | 远程执行代码 | 严重              | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=e4fa8ed0-acb0-4864-be18-29a27f8501de)\*\*                                                             | 远程执行代码 | 中等              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=e4fa8ed0-acb0-4864-be18-29a27f8501de)\*\*                                               | 远程执行代码 | 中等              | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=d7bcf4d7-b697-4c5f-adbc-a2b3700e0ad5)                                                             | 远程执行代码 | 中等              | [MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d7bcf4d7-b697-4c5f-adbc-a2b3700e0ad5)                                               | 远程执行代码 | 中等              | 无                                                        |
...
ActiveX Kill Bit 的此累积性安全更新包含新的 Kill Bit 和先前在 [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366)“ActiveX Kill Bit 的安全更新”、[MS08-032](https://go.microsoft.com/fwlink/?linkid=116368)“ActiveX Kill Bit 的累积性安全更新”、[MS09-032](https://go.microsoft.com/fwlink/?linkid=157386)“ActiveX Kill Bit 的累积性安全更新”、[MS09-055](https://technet.microsoft.com/security/bulletin/ms09-055)“ActiveX Kill Bit 的累积性安全更新”、[MS10-008](https://go.microsoft.com/fwlink/?linkid=179106)“ActiveX Kill Bit 的累积性安全更新”、[MS10-034](https://go.microsoft.com/fwlink/?linkid=185159)“ActiveX Kill Bit 的累积性安全更新”以及标题为“ActiveX Kill Bit 的更新汇总”的通报 [Microsoft 安全通报 953839](https://technet.microsoft.com/security/advisory/953839)、[Microsoft 安全通报 956391](https://technet.microsoft.com/security/advisory/956391)、[Microsoft 安全通报 960715](https://technet.microsoft.com/security/advisory/960715) 和 [Microsoft 安全通报 969898](https://technet.microsoft.com/security/advisory/969898) 中发布所有 kill bit。
...
**已经在 MS10-034 中设置了适用于 Microsoft Internet Explorer 8 开发工具漏洞 (CVE-2010-0811) 的 kill bit。为什么此更新要设置另一 kill bit？**  
Microsoft 向此 ActiveX 控件的 kill bit 列表额外添加了一个 CLSID。
...
此更新具有不同的严重等级，因为不同的操作系统对该漏洞有不同的缓解措施。 其中一种缓解措施是，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)”的受限模式下运行。
...
<tr class="header">
<th>受影响的软件</th>
<th>Microsoft Internet Explorer 8 开发工具漏洞 - CVE-2010-0811</th>
<th>Microsoft WMITools ActiveX 控件漏洞 - CVE-2010-3973</th>
<th>Microsoft Windows Messenger ActiveX 控件漏洞 - CVE-2011-1243</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
<sup>[2]</sup> 默认情况下，此操作系统上未安装 Internet Explorer 8。 只有当安装了 Internet Explorer 8 时，严重等级才适用。
  
**\*\*服务器核心安装不受影响。** 如果使用服务器核心安装选项安装如上所述的 Windows Server 2008 或 Windows Server 2008 R2，则此更新所解决的漏洞不会影响其的受支持版本。 有关此安装选项的详细信息，请参阅 TechNet 文章[管理服务器核心安装](https://technet.microsoft.com/en-us/library/ee441255(ws.10).aspx)和[服务服务器核心安装](https://technet.microsoft.com/en-us/library/ff698994(ws.10).aspx)。 注意，服务器核心安装选项不适用于 Windows Server 2008 和 Windows Server 2008 R2 的某些版本；请参阅[比较服务器核心安装选项](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)。
  
Microsoft Internet Explorer 8 开发工具漏洞 - CVE-2010-0811  
----------------------------------------------------------
  
<span></span>  
ActiveX 控件 Microsoft Internet Explorer 8 开发工具中存在一个远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0811](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0811)。
  
#### Microsoft Internet Explorer 8 开发工具漏洞 (CVE-2010-0811) 的缓解因素
...
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)”的受限模式下运行。 此模式可减轻此漏洞。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此安全更新的“常见问题”部分。
  
#### Microsoft Internet Explorer 8 开发工具漏洞 (CVE-2010-0811) 的变通办法
...
-   **阻止 COM 对象在 Internet Explorer 中运行**
    ...
    **警告** 如果不正确地使用注册表编辑器，可能导致严重的问题，或许需要您重新安装操作系统。 Microsoft 不保证您可以解决因错误运用注册表编辑器而产生的问题。 使用注册表编辑器的风险由您自己承担。
    ...
    要为值为 {1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1} 的 CLSID 设置 kill bit，请将以下文本粘贴到记事本等文本编辑器中。 然后，使用 .reg 文件扩展名保存文件。
...
#### Microsoft Internet Explorer 8 开发工具漏洞 (CVE-2010-0811) 的常见问题
...
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
...
**哪个组件受此漏洞的影响？**    
此漏洞影响 Microsoft Internet Explorer 8 开发工具空件。
  
**Internet Explorer 6 和 Internet Explorer 7 的可下载开发工具是否受此问题影响？**    
不，Internet Explorer 6 和 Internet Explorer 7 的可下载开发工具不受此问题影响。
  
**什么是 Microsoft Internet Explorer 8 开发工具？**    
Microsoft Internet Explorer 8 开发工具使网站开发人员可以快速调试 Microsoft JScript、调查 Internet Explorer 的特定行为或迅速建立新设计或解决方案的原型。 有关 IE8 工具的更多信息，请参阅 MSDN 文章[发现 Internet Explorer 开发工具](https://msdn.microsoft.com/en-us/library/dd565628(vs.85).aspx)。
  
**受此漏洞威胁最大的系统有哪些？**    
Microsoft Internet Explorer 8 开发工具中的这个漏洞要求用户应该登录和访问网站，从而使恶意操作发生。 因此，安装了 Microsoft Internet Explorer 8 开发工具以及经常使用 Internet Explorer 的任何系统（例如工作站或终端服务器）受此漏洞的威胁最大。
...
| 类标识符                               | 文件         | 描述                                   |  
|----------------------------------------|--------------|----------------------------------------|  
| {1a6fe369-f28c-4ad9-a3e6-2bcb50807cf1} | iedvtool.dll | Microsoft Internet Explorer 8 开发工具 |
  
**注意** 设置此 kill bit 可首先解决 [Microsoft 安全公告 MS10-034](https://go.microsoft.com/fwlink/?linkid=185159) 中介绍的 [CVE-2010-0811](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0811) 漏洞的变体。
...
Microsoft WMITools ActiveX 控件漏洞 - CVE-2010-3973  
---------------------------------------------------
  
<span></span>  
其中一个 Microsoft WMITools ActiveX 控件中存在远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3973](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973)。
  
#### Microsoft WMITools ActiveX 控件漏洞 (CVE-2010-3973) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   默认情况下不安装 WMI 管理工具程序包。  
-   WMITools ActiveX 控件未经签名。 默认情况下，Internet Explorer 会阻止未经签名的控件。 有关详细信息，请参阅 MSDN 文章 [ActiveX 阻止](https://msdn.microsoft.com/en-us/library/dd565667.aspx)。  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须诱使用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。  
-   默认情况下，Microsoft Outlook、Microsoft Outlook Express 和 Windows Mail 的所有支持版本在受限制的站点区域打开 HTML 电子邮件信息（会禁用脚本和 ActiveX 控件），同时删除可利用此漏洞的攻击者执行恶意代码的风险。 在基于 Web 的攻击情形中，如果用户单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
  
#### Microsoft WMITools ActiveX 控件漏洞 (CVE-2010-3973) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性。
  
-   **阻止 COM 对象在 Internet Explorer 中运行**
  
    您可以通过在注册表中为控件设置 kill bits 来禁止尝试在 Internet Explorer 中实例化 COM 对象。
  
    **警告** 如果不正确地使用注册表编辑器，可能导致严重的问题，或许需要您重新安装操作系统。 Microsoft 不保证您可以解决因错误运用注册表编辑器而产生的问题。 使用注册表编辑器的风险由您自己承担。
  
    有关阻止控件在 Internet Explorer 中运行的详细步骤，请参阅 [Microsoft 知识库文章 240797](https://support.microsoft.com/kb/240797)。按照文中所述的步骤在注册表内创建一个 Compatibility Flags 值，以阻止 COM 对象在 Internet Explorer 中实例化。
  
    要为值为 {2745E5F5-D234-11D0-847A-00C04FD7BB08}、{FF371BF4-213D-11D0-95F3-00C04FD9B15B} 和 {AC146530-87A5-11D1-ADBD-00AA00B8E05A} 的 CLSID 设置 kill bit，请将以下文本粘贴于记事本等文本编辑器中。 然后，使用 .reg 文件扩展名保存文件。
...
#### Microsoft WMITools ActiveX 控件漏洞 (CVE-2010-3973) 的常见问题
...
**受此漏洞威胁最大的系统有哪些？**    
其中一个 Microsoft WMITools ActiveX 控件中的这个漏洞要求用户登录和访问网站，从而使恶意操作发生。 因此，此漏洞对安装了 Microsoft WMITools ActiveX 控件且频繁使用 Internet Explorer 的任何系统（例如工作站或终端服务器）的威胁最大。
...
| 类标识符                               | 文件               | 描述                            |  
|----------------------------------------|--------------------|---------------------------------|  
| {2745E5F5-D234-11D0-847A-00C04FD7BB08} | WBEMSingleView.OCX | Microsoft WMITools ActiveX 控件 |  
| {FF371BF4-213D-11D0-95F3-00C04FD9B15B} | WBEMMultiView.OCX  | Microsoft WMITools ActiveX 控件 |  
| {AC146530-87A5-11D1-ADBD-00AA00B8E05A} | WBEMEventList.OCX  | Microsoft WMITools ActiveX 控件 |
  
**此 ActiveX 控件是否经过数字签名？**    
否，此 ActiveX 控件未经过数字签名。 有关 ActiveX 控件签名的详细信息，请参阅 MSDN 博客文章[授权代码签名须知概要](https://blogs.msdn.com/b/ieinternals/archive/2011/03/22/authenticode-code-signing-for-developers-for-file-downloads-building-smartscreen-application-reputation.aspx)。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3973](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。
  
**应用此安全更新是否有助于客户防止可能会尝试利用此漏洞的已公开发布的代码？**    
是。 此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2010-3973](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3973)。
  
Microsoft Windows Messenger ActiveX 控件漏洞 - CVE-2011-1243  
------------------------------------------------------------
  
<span></span>  
Microsoft Windows Messenger ActiveX 控件中存在一个远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1243](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1243)。
  
#### Microsoft Windows Messenger ActiveX 控件漏洞 (CVE-2011-1243) 的缓解因素
...
#### Microsoft Windows Messenger ActiveX 控件漏洞 (CVE-2011-1243) 的变通办法
...
-   **阻止 COM 对象在 Internet Explorer 中运行**
    ...
    **警告** 如果不正确地使用注册表编辑器，可能导致严重的问题，或许需要您重新安装操作系统。 Microsoft 不保证您可以解决因错误运用注册表编辑器而产生的问题。 使用注册表编辑器的风险由您自己承担。
    ...
    要为值为 {FB7199AB-79BF-11d2-8D94-0000F875C541} 的 CLSID 设置 kill bit，请将以下文本粘贴到记事本等文本编辑器中。 然后，使用 .reg 文件扩展名保存文件。
...
#### Microsoft Windows Messenger ActiveX 控件漏洞 (CVE-2011-1243) 的常见问题
...
**受此漏洞威胁最大的系统有哪些？**    
Microsoft Windows Messenger ActiveX 控件中的这个漏洞要求用户登录和访问网站，从而使恶意操作发生。 因此，此漏洞对安装了 Microsoft Windows Messenger ActiveX 控件且频繁使用 Internet Explorer 的任何系统（例如工作站或终端服务器）的威胁最大。
...
| 类标识符                               | 文件      | 描述                                     |  
|----------------------------------------|-----------|------------------------------------------|  
| {FB7199AB-79BF-11d2-8D94-0000F875C541} | msgsc.dll | Microsoft Windows Messenger ActiveX 控件 |
...
-   [Oracle](https://www.oracle.com) 为 ActiveX 控件 Java Deployment Toolkit 请求了一个 kill bit。 有关 Java Deployment Toolkit ActiveX 控件中的安全问题的详细信息，请参阅 [Oracle 安全警报 CVE-2010-0886](https://www.oracle.com/technetwork/topics/security/alert-cve-2010-0886-094541.html)。此 ActiveX 控件的类标识符为：  
    -   {CAFEEFAC-DEC7-0000-0000-ABCDEFFEDCBA}  
-   [CA](https://www.ca.com/us/) 发布了一个安全通报，针对 ActiveX 控件 WebScan 提供了建议。 如果对 WebScan ActiveX 控件有任何问题或疑虑，请访问 <https://www.ca.com> 联系 CA。 请参阅 CA 的安全公告了解详细信息。 此 ActiveX 控件的类标识符 (CLSID) 为：  
    -   {7B297BFD-85E4-4092-B2AF-16A91B2EA103}  
-   [IBM](https://technet.microsoft.com/zh-CN/library/%5c%5cwww.ibm.com(v=Security.10)) 为 Rational Suite License ActiveX 控件请求了一个 kill bit。 如果对 Rational Suite License ActiveX 控件有任何问题或疑虑，请访问 <https://www.ibm.com> 联系 CA。 此 ActiveX 控件的类标识符 (CLSID) 为：  
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2508272$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
...
-   Carnegie Mellon University Information Security Office 的 Chris Ries 报告了 Microsoft Internet Explorer 8 开发工具漏洞 (CVE-2010-0811)  
-   [TippingPoint's](https://www.tippingpoint.com/) [DVLabs](https://dvlabs.tippingpoint.com/) 的 Brian Gorenc 和我们合作处理了 Microsoft WMITools ActiveX 控件漏洞 (CVE-2010-3973)  
-   RadLSneak 与 [iSIGHT Partners](https://www.isightpartners.com/) Global Vulnerability Partnership 合作报告了 Microsoft Windows Messenger ActiveX 控件漏洞 (CVE-2011-1243)
...
-   V1.1（2011 年 7 月 27 日）： 向本公告 CVE-2010-3973“漏洞”部分介绍的 Microsoft WMITools ActiveX 控件添加类标识符。这仅仅是一个信息更改。 已针对该漏洞应用了“阻止 COM 对象在 Internet Explorer 中运行”这一变通办法的客户应通过其他类标识符重新应用变通办法。

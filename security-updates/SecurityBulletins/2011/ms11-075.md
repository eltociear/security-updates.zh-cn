...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1247](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1247)。
...
Microsoft Active Accessibility 组件是一种基于组件对象模型 (COM) 的技术，可改进辅助功能与 Microsoft Windows 上运行的应用程序一起使用的方式。它提供集成于操作系统中的动态链接库，以及 COM 接口和提供可靠的披露 UI 元素相关信息方法的 API 元素。有关详细信息，请参阅 MSDN 文章“[Microsoft Active Accessibility](http://msdn.microsoft.com/en-us/library/ms971350.aspx)”。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2564958">Microsoft 知识库文章 2564958</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的基于 32 位和基于 x64 的版本：  
请参阅 [Microsoft 知识库文章 2564958](http://support.microsoft.com/kb/2564958)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的基于 Itanium 的版本：  
请参阅 [Microsoft 知识库文章 2605295](http://support.microsoft.com/kb/2605295)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   [Mila Parkour](http://contagiodump.com) 与 [Adobe Systems, Inc.](http://www.adobe.com) 的 Anshul Kothari 和 Nishant Kaushik 合作报告了 Active Accessibility 不安全库加载漏洞 (CVE-2011-1247)

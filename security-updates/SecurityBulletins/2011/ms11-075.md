---
TOCTitle: 'MS11-075'
Title: 'Microsoft 安全公告 MS11-075 - 重要'
ms:assetid: 'ms11-075'
ms:contentKeyID: 61238213
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-075(v=Security.10)'
---


Microsoft 安全公告 MS11-075 - 重要
==================================

Microsoft Active Accessibility 中的漏洞可能允许远程执行代码 (2623699)
---------------------------------------------------------------------

发布时间: 2011年10月11日 | 更新时间: 2011年10月25日
...
此安全更新通过更正 Microsoft Active Accessibility 组件加载外部库的方式来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=96af60b9-4b8d-4a9b-b125-10775bb48252">Windows XP Service Pack 3</a><br />
(KB2564958)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c8fcf427-17d0-4caa-b406-50703f980862">Windows XP Professional x64 Edition Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=09e178f8-2bd2-46e1-b975-4938ee1f304d">Windows Server 2003 Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9b8030db-1f47-4666-8cb5-1c56577f2340">Windows Server 2003 x64 Edition Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=82653b8c-0e58-440d-9702-8847f599caed">Windows Server 2003 SP2（用于基于 Itanium 的系统）</a><br />
(KB2605295)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=96b089c0-a2e7-44cb-9fc4-9569b3993afa">Windows Vista Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b79a389c-8340-4dd2-9ab1-a0943c5a220f">Windows Vista x64 Edition Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7cd1ecec-8a3f-4cb2-833c-a177c9602ff5">Windows Server 2008（用于 32 位系统）Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=456e450c-3928-4130-8127-e4d3f482c1ca">Windows Server 2008（用于基于 x64 的系统）Service Pack 2</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2e9930d3-ba13-446d-bfa0-60720c48203b">Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=02d28e59-b38f-433a-a568-e86f9d43dd42">Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=904dec69-e8b9-4b23-a5ea-d3e7e9b9df07">Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c7bd50b7-03f1-4ea4-ad71-d428822c62f8">Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1</a>*<br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=aa816682-9652-433c-b1b4-5d0bc17b6a87">Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1</a><br />
(KB2564958)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=212284">MS11-038</a></td>
...
<tr class="header">  
<th>受影响的软件</th>  
<th>Active Accessibility 不安全库加载漏洞 - CVE-2011-1247</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
...
Active Accessibility 不安全库加载漏洞 - CVE-2011-1247  
-----------------------------------------------------
  
<span></span>  
Microsoft Active Accessibility 组件处理 DLL 文件加载的方式中存在一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1247](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1247)。
  
#### Active Accessibility 不安全库加载漏洞 (CVE-2011-1247) 的缓解因素
...
#### Active Accessibility 不安全库加载漏洞 (CVE-2011-1247) 的变通办法
...
#### Active Accessibility 不安全库加载漏洞 (CVE-2011-1247) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
此漏洞是由于 Microsoft Active Accessibility 组件不正确限制加载外部库使用的路径所导致的。
  
**什么是 Microsoft Active Accessibility 组件？**  
Microsoft Active Accessibility 组件是一种基于组件对象模型 (COM) 的技术，可改进辅助功能与 Microsoft Windows 上运行的应用程序一起使用的方式。它提供集成于操作系统中的动态链接库，以及 COM 接口和提供可靠的披露 UI 元素相关信息方法的 API 元素。有关详细信息，请参阅 MSDN 文章“[Microsoft Active Accessibility](https://msdn.microsoft.com/en-us/library/ms971350.aspx)”。
...
**攻击者如何利用此** **漏洞？**  
攻击者可能诱使用户打开与特制动态链接库 (DLL) 文件位于同一网络目录下的合法文件。然后，在打开合法文件时，Microsoft Active Accessibility 组件可能尝试加载 DLL 文件并执行其包含的任何代码。
  
在电子邮件攻击情形中，攻击者可能通过向用户发送合法的文件附件并诱使用户将此附件放在包含特制 DLL 文件的目录下并打开此合法的文件来利用此漏洞。然后，在打开合法文件时，Microsoft Active Accessibility 组件可能尝试加载 DLL 文件并执行其包含的任何代码。
...
**此更新有什么作用？**  
此更新通过更正 Microsoft Active Accessibility 组件加载外部库的方式来解决此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2564958$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2564958">Microsoft 知识库文章 2564958</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的基于 32 位和基于 x64 的版本：  
KB2564958.log
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的基于 32 位和基于 x64 的版本：  
使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB2564958$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的基于 Itanium 的版本：  
使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB2605295$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的基于 32 位和基于 x64 的版本：  
请参阅 [Microsoft 知识库文章 2564958](https://support.microsoft.com/kb/2564958)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的基于 Itanium 的版本：  
请参阅 [Microsoft 知识库文章 2605295](https://support.microsoft.com/kb/2605295)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   [Mila Parkour](https://contagiodump.com) 与 [Adobe Systems, Inc.](https://www.adobe.com) 的 Anshul Kothari 和 Nishant Kaushik 合作报告了 Active Accessibility 不安全库加载漏洞 (CVE-2011-1247)
...
-   V1.1（2011 年 10 月 12 日）： 更正了 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本的公告替代信息。这仅仅是信息更改。检测逻辑或更新文件未发生更改。  
-   V1.2（2011 年 10 月 25 日）： 根据 Microsoft 知识库文章 KB816915 中介绍的方案修订了 Windows XP 和 Windows Server 2003 的 32 位和基于 x64 的版本的更新文件名。这仅仅是文件名更改。检测逻辑或更新内容未发生更改。已经成功安装了此更新的客户不需要执行任何操作。

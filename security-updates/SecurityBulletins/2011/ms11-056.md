---
TOCTitle: 'MS11-056'
Title: 'Microsoft 安全公告 MS11-056 - 重要'
ms:assetid: 'ms11-056'
ms:contentKeyID: 61238194
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-056(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-056 - 重要
==================================

Windows 客户端/服务器运行时子系统中的漏洞可能允许特权提升 (2507938)
-------------------------------------------------------------------

发布时间: 2011年7月12日 | 更新时间: 2011年7月21日
...
该安全更新通过不允许多个控制台对象与一个进程相关联、修改 CSRSS 初始化内存的方式、在用户输入用作数组的索引之前验证用户输入以及修改边界检查以防止内存损坏来解决漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
**已知问题。** [Microsoft 知识库文章 2507938](https://support.microsoft.com/kb/2507938) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=425c705e-94f2-4fa6-9df2-dc71897215fa">Windows XP Service Pack 3</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>、</em><br />
<a href="https://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=dff4c67a-8c8b-4d7d-84c7-57429becf0ff">Windows Server 2003 Service Pack 2</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>、</em><br />
<a href="https://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1615a995-9a04-440a-ae52-5917738f0ecb">Windows Server 2003 x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>、</em><br />
<a href="https://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a81c011d-eeea-4383-9efb-df70515ab357">Windows Server 2003 SP2（用于基于 Itanium 的系统）</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=207840">MS11-010</a><em>、</em><br />
<a href="https://go.microsoft.com/fwlink/?linkid=197093">MS10-069</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a5e192af-dae5-47ef-a9d0-f761a8caa974">Windows Vista Service Pack 1 和 Windows Vista Service Pack 2</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1007f5d3-9be1-4f03-a3f0-12ddb555653c">Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=36e3dbaf-36f5-4c74-8f11-ecbef46f58e1">Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2</a>*</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b43d2ab5-e281-4c6b-bb37-1f1b5d86ac82">Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2</a>*</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b70209f2-1c51-45af-b3c4-3473aebcdb35">Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ac3b435c-8caf-40cc-8f13-b52261b3b9e6">Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=64e5f889-fa46-4884-9b22-3ba4e2fba1b9">Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b99a40cf-8a31-43d9-bd0b-a458a533068b">Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1</a>*</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=784efc20-3a41-42ab-b48d-51fd59d71523">Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1</a></td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<tr class="header">  
<th>受影响的软件</th>  
<th>CSRSS 本地 EOP AllocConsole 漏洞 - CVE-2011-1281</th>  
<th>CSRSS 本地 EOP SrvSetConsoleLocalEUDC 漏洞 - CVE-2011-1282</th>  
<th>CSRSS 本地 EOP SrvSetConsoleNumberOfCommand 漏洞 - CVE-2011-1283</th>  
<th>CSRSS 本地 EOP SrvWriteConsoleOutput 漏洞 - CVE-2011-1284</th>  
<th>CSRSS 本地 EOP SrvWriteConsoleOutputString 漏洞 - CVE-2011-1870</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
...
CSRSS 本地 EOP AllocConsole 漏洞 - CVE-2011-1281  
------------------------------------------------
  
<span></span>  
由于 CSRSS 子系统为特定用户交易分配内存的方式，Windows CSRSS 中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1281](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1281)。
  
#### CSRSS 本地 EOP AllocConsole 漏洞 (CVE-2011-1281) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### CSRSS 本地 EOP AllocConsole 漏洞 (CVE-2011-1281) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### CSRSS 本地 EOP AllocConsole 漏洞 (CVE-2011-1281) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 要尝试利用此漏洞，攻击者必须能够本地登录到系统并运行程序。
  
**造成此漏洞的原因是什么？**    
当多个控制台对象与一个进程相关联时出现的内存损坏情形导致了此漏洞。 当进程退出时，额外的控制台对象被孤立，此对象手柄可以由比预期拥有较高特权的另一繁衍进程获取。
  
**Windows 客户端/服务器运行时子系统 (CSRSS) 是什么？**    
客户端/服务器运行时子系统 (CSRSS) 是 Win32 子系统的用户模式部分（Win32.sys 是内核模式部分）。 CSRSS 是必须一直运行的基本子系统。 CSRSS 负责控制台窗口、线程的创建和/或删除。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者能够在系统上下文中运行恶意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
...
CSRSS 本地 EOP SrvSetConsoleLocalEUDC 漏洞 - CVE-2011-1282  
----------------------------------------------------------
  
<span></span>  
由于 CSRSS 子系统为特定用户交易分配内存的方式，Windows CSRSS 中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1282](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1282)。
  
#### CSRSS 本地 EOP SrvSetConsoleLocalEUDC 漏洞 (CVE-2011-1282) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### CSRSS 本地 EOP SrvSetConsoleLocalEUDC 漏洞 (CVE-2011-1282) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### CSRSS 本地 EOP SrvSetConsoleLocalEUDC 漏洞 (CVE-2011-1282) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 要尝试利用此漏洞，攻击者必须能够本地登录到系统并运行程序。
  
**造成此漏洞的原因是什么？**    
这是可以允许在系统上下文中执行代码的内存损坏漏洞。 没有验证 CSRSS 中的函数传递了一个空指针。 这允许 CSRSS 写入到其进程空间中的空页中。 在 Windows XP 系统上，在某些情况下，攻击者可能会利用此页面使用增加的权限执行代码。
...
**此更新有什么作用？**    
该更新通过修改 CSRSS 初始化内存以防止在系统上下文中执行任意代码的方式来解决此漏洞。
...
CSRSS 本地 EOP SrvSetConsoleNumberOfCommand 漏洞 - CVE-2011-1283  
----------------------------------------------------------------
  
<span></span>  
由于 CSRSS 子系统为特定用户交易分配内存的方式，Windows CSRSS 中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1283](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1283)。
  
#### CSRSS 本地 EOP SrvSetConsoleNumberOfCommand 漏洞 (CVE-2011-1283) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### CSRSS 本地 EOP SrvSetConsoleNumberOfCommand 漏洞 (CVE-2011-1283) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### CSRSS 本地 EOP SrvSetConsoleNumberOfCommand 漏洞 (CVE-2011-1283) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 要尝试利用此漏洞，攻击者必须能够本地登录到系统并运行程序。
  
**造成此漏洞的原因是什么？**    
当用户输入用作数字的索引，而没有首先检查其是否存在负值时，则会导致此漏洞。 这可能允许攻击者以一种可能执行代码的方式从内存中的区域或者从损坏内存中读取数据。
...
**此更新有什么作用？**    
该更新通过在用户输入用作数组的索引之前验证用户输入来解决此漏洞。
...
CSRSS 本地 EOP SrvWriteConsoleOutput 漏洞 - CVE-2011-1284  
---------------------------------------------------------
  
<span></span>  
由于 CSRSS 子系统为特定用户交易分配内存的方式，Windows CSRSS 中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1284](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1284)。
  
#### CSRSS 本地 EOP SrvWriteConsoleOutput 漏洞 (CVE-2011-1284) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### CSRSS 本地 EOP SrvWriteConsoleOutput 漏洞 (CVE-2011-1284) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### CSRSS 本地 EOP SrvWriteConsoleOutput 漏洞 (CVE-2011-1284) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**    
此漏洞是由整数溢出情形导致的，可能允许攻击者在系统帐户的上下文中执行代码。
...
CSRSS 本地 EOP SrvWriteConsoleOutputString 漏洞 - CVE-2011-1870  
---------------------------------------------------------------
  
<span></span>  
由于 CSRSS 子系统为特定用户交易分配内存的方式，Windows CSRSS 中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1870](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1870)。
  
#### CSRSS 本地 EOP SrvWriteConsoleOutputString 漏洞 (CVE-2011-1870) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### CSRSS 本地 EOP SrvWriteConsoleOutputString 漏洞 (CVE-2011-1870) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### CSRSS 本地 EOP SrvWriteConsoleOutputString 漏洞 (CVE-2011-1870) 的常见问题
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2507938$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2507938">Microsoft 知识库文章 2507938</a></td>
</tr>  
<tr class="even">
...
-   [Hispasec](https://www.hispasec.com/) [Virustotal](https://www.virustotal.com/) 的报告了 CSRSS 本地 EOP AllocConsole 漏洞 (CVE-2011-1281)  
-   [Hispasec](https://www.hispasec.com/) [Virustotal](https://www.virustotal.com/) 的报告了 CSRSS 本地 EOP SrvSetConsoleLocalEUD 漏洞 (CVE-2011-1282)  
-   [Hispasec](https://www.hispasec.com/) [Virustotal](https://www.virustotal.com/) 的报告了 CSRSS 本地 EOP SrvSetConsoleNumberOfCommand 漏洞 (CVE-2011-1283)  
-   [Hispasec](https://www.hispasec.com/) [Virustotal](https://www.virustotal.com/) 的报告了 CSRSS 本地 EOP SrvWriteConsoleOutput 漏洞 (CVE-2011-1284)  
-   [Hispasec](https://www.hispasec.com/) [Virustotal](https://www.virustotal.com/) 的报告了 CSRSS 本地 EOP SrvWriteConsoleOutputString 漏洞 (CVE-2011-1870)
...
-   V1.1（2011 年 7 月 21 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2507938 添加一个链接。

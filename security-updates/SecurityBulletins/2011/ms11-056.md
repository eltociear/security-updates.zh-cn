...
**已知问题。** [Microsoft 知识库文章 2507938](http://support.microsoft.com/kb/2507938) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1281)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1282](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1282)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1283](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1283)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1284](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1284)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1870)。
...
**注意** Microsoft 在 2011 年 4 月 12 日之后不再对 SMS 2.0 提供支持。对于 SMS 2003，Microsoft 在 2011 年 4 月 12 日之后也不再对安全更新清单工具 (SUIT) 提供支持。鼓励客户升级到 [System Center Configuration Manager 2007](http://technet.microsoft.com/en-us/library/bb735860.aspx)。对于保留使用 SMS 2003 Service Pack 3 的客户，[Microsoft 更新清单工具](http://technet.microsoft.com/en-us/systemcenter/bb676783.aspx) (ITMU) 也是一种选择。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2507938">Microsoft 知识库文章 2507938</a></td>
</tr>  
<tr class="even">
...
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) 的报告了 CSRSS 本地 EOP AllocConsole 漏洞 (CVE-2011-1281)  
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) 的报告了 CSRSS 本地 EOP SrvSetConsoleLocalEUD 漏洞 (CVE-2011-1282)  
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) 的报告了 CSRSS 本地 EOP SrvSetConsoleNumberOfCommand 漏洞 (CVE-2011-1283)  
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) 的报告了 CSRSS 本地 EOP SrvWriteConsoleOutput 漏洞 (CVE-2011-1284)  
-   [Hispasec](http://www.hispasec.com/) [Virustotal](http://www.virustotal.com/) 的报告了 CSRSS 本地 EOP SrvWriteConsoleOutputString 漏洞 (CVE-2011-1870)

...
**已知问题。**[Microsoft 知识库文章 2538814](https://support.microsoft.com/kb/2538814) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
除了本公告“漏洞信息”部分列出的更改外，此安全更新还否决对 MD2 和 MD4 哈希的 ClickOnce 支持。一旦应用该更新，使用 MD2 或 MD4 哈希进行了签名的应用程序将不再运行。有关完整的详细信息，请参阅 [Microsoft 知识库文章 2562394](https://support.microsoft.com/kb/2562394)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1271](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1271)。
...
#### .NET Framework JIT 优化漏洞 (CVE-2011-1271) 的变通办法
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-1271](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1271)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2538814">Microsoft 知识库文章 2538814</a></td>
</tr>  
<tr class="even">
...
-   Dan Kaminsky 与我们合作处理了本公告中涉及的 MD2 否决更改
...
-   V1.1（2011 年 10 月 11 日）： 添加了一个更新常见问题，以宣布更正安装问题的 KB2518870 和 KB2518864 的检测更改。这只是检测更改。没有更改安全更新文件。已经成功更新了其系统的客户不需要执行任何操作。
-   V1.2（2011 年 10 月 26 日）： 更正了 Windows Server 2008 R2（用于基于 x64 的系统）上 .NET Framework 4 的服务器核心安装适用性。
-   V1.3（2012 年 7 月 10 日）： Microsoft 修订此公告是为了表明针对适用于 Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5 Service Pack 1 的 KB2518864 提供微小检测更改。没有更改安全更新文件。已经成功更新了其系统的客户不需要执行任何操作。

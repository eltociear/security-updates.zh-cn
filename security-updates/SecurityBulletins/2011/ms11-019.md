---
TOCTitle: 'MS11-019'
Title: 'Microsoft 安全公告 MS11-019 - 严重'
ms:assetid: 'ms11-019'
ms:contentKeyID: 61238157
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-019(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-019 - 严重
==================================

SMB 客户端中的漏洞可能允许远程执行代码 (2511455)
------------------------------------------------

发布时间: 2011年4月12日 | 更新时间: 2011年4月13日
...
此安全更新解决 Microsoft Windows 中一个公开披露和一个秘密报告的漏洞。 如果攻击者将特制的 SMB 响应发送到客户端发起的 SMB 请求，则其中较严重的漏洞可能允许远程执行代码。 若要利用该漏洞，攻击者必须说服用户启动到特制 SMB 服务器的 SMB 连接。

对于 Microsoft Windows 所有受支持的版本，此安全更新的等级为“严重”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

该安全更新通过更正 CIFS 浏览器处理特制浏览器消息的方式并更正 SMB 客户端验证特制 SMB 响应的方式来解决漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=f5378e7b-4619-4c42-9d9f-87b209c6d878)                                                                                     | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c01441da-8933-4f60-923b-d9b00db8ba3d)                                                            | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d46fe0bf-28c2-4696-87bc-dd3c8287fc28)                                                                            | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ca0fb4d3-7651-4760-83fa-b71c86cbe459)                                                                | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=87eb8b93-9829-45ec-9528-52787732044e)                                                            | 远程执行代码 | 严重         | 无                                                        |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=da8dd55d-6630-484e-836c-9feeab5cc311)                                                  | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=040f8b46-f458-4a72-a1b0-ad8a65a1194c)                          | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f8c9390a-5ca1-492a-9e35-a516de48deb5)\*                 | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b0cfd5e0-6de5-4863-b5e4-b223a0e36d72)\*       | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8eaf51cd-2f6e-4bbc-bc4f-9deed03649ac) | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715)                                                                                   | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715)                                                                     | 远程执行代码 | 严重         | 无                                                        |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25)                                                                              | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25)                                                                | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945)\*                                                               | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945)\*                                                 | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=1e7d3f21-bdbd-4826-855d-85422aa5f836)                                                             | 远程执行代码 | 严重         | [MS10-020](https://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1e7d3f21-bdbd-4826-855d-85422aa5f836)                                               | 远程执行代码 | 严重         | 无                                                        |
...
<tr class="header">
<th>受影响的软件</th>
<th>浏览器池损坏漏洞 - CVE-2011-0654</th>
<th>SMB 客户端响应分析漏洞 - CVE-2011-0660</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
浏览器池损坏漏洞 - CVE-2011-0654  
--------------------------------
  
<span></span>  
通用 Internet 文件系统 (CIFS) 浏览器协议实施分析格式错误的浏览器消息的方式中存在一个未经身份验证的远程执行代码漏洞。 利用该漏洞的尝试不需要身份验证。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0654](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)。
  
#### 浏览器池损坏漏洞 (CVE-2011-0654) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。 在这种情况下，应该阻止从 Internet 访问 NetBIOS 数据报服务端口 (UDP 138)。
  
#### 浏览器池损坏漏洞 (CVE-2011-0654) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **在防火墙处阻止 TCP 端口 138**
  
    此端口用于启动与受影响组件的连接。 将 UDP 端口 138 阻止在防火墙处，有助于保护位于防火墙后面的系统尝试利用此漏洞。 Microsoft 建议阻塞所有来自 Internet 的未经请求的入站通信，以帮助阻止可能使用其他端口进行的攻击。 有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。
  
    **变通办法的影响。** 依赖计算机浏览器服务的应用程序无法运行。 这包括诸如“网上邻居”和 NET VIEW 命令之类的功能。
  
    **如何撤消变通方法。** 在防火墙处解除对 TCP 端口 138 的阻止。 有关端口的详细信息，请参阅 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。
  
#### 浏览器池损坏漏洞 (CVE-2011-0654) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**    
由于 CIFS 浏览器协议实施不正确地分析特制计算机浏览器消息而存在该漏洞。 这可能会导致内存损坏问题，允许以系统级特权执行代码。
...
**什么是浏览器服务？**  
浏览器服务维护计算机所在的域名或工作组名称的列表以及运行浏览器服务的计算机所服务的网络段上每台计算机使用的协议。 在每个网络段上，从段上运行浏览器服务的计算机组中选择一种主浏览器。 有关计算机浏览器服务的详细信息，请参阅 [Microsoft 知识库文章 188001](https://support.microsoft.com/kb/188001)。
  
**什么是通用 Internet 文件系统 (CIFS) 浏览器协议？**    
CIFS 浏览器协议定义下列对象发送和接收的消息：充当网络上可用服务的交换所的服务器；支持网络上可用服务（如打印或文件共享）的服务器；请求特定服务的详细信息的客户端。 在 CIFS 浏览器协议的上下文中，浏览是发现提供特殊服务的服务器的过程。 有关详细信息，请参阅 MSDN 文章 [\[MS-BRWS\]： 通用 Internet 文件系统 (CIFS) 浏览器协议规范](https://msdn.microsoft.com/en-us/library/cc224428(prot.10).aspx)。
  
**什么是主浏览器？**    
主浏览器负责收集主机或服务器宣告，这些宣告是由主浏览器的网络段上的每台服务器每 12 分钟作为数据报发送的。 主浏览器指示每个网络段的潜在浏览器成为备份浏览器。 给定网络段上的备份浏览器向相同段中的客户端计算机提供浏览列表。 有关计算机浏览器服务的详细信息，请参阅 [Microsoft 知识库文章 188001](https://support.microsoft.com/kb/188001)。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以完全控制受影响的系统。 利用此漏洞的大多数尝试将导致受影响的系统停止响应和重新启动。
  
**攻击者如何利用此漏洞？**    
攻击者可能通过创建特制的浏览器消息并将其发送到受影响的系统来尝试利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**    
对所有受影响的操作系统都构成威胁。 主域控制器 (PDC) 受到的威胁更大，因为它们通常是给定域中的主浏览器。 网络上的任何系统都可以成为主浏览器，因此容易受到攻击。
  
**此更新有什么作用？**    
该更新通过更正 CIFS 浏览器处理特制浏览器消息的方式来解决漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-0654](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。
  
SMB 客户端响应分析漏洞 - CVE-2011-0660  
--------------------------------------
  
<span></span>  
Microsoft 服务器消息块 (SMB) 客户端验证特制的 SMB 响应的方式中存在未经身份验证的远程执行代码漏洞。 利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过将特制的 SMB 响应发送到客户端发起的 SMB 请求来利用该漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0660](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0660)。
  
#### SMB 客户端响应分析漏洞 (CVE-2011-0660) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。 在这种情况下，应阻止从 Internet 访问出站 SMB 端口。
  
#### SMB 客户端响应分析漏洞 (CVE-2011-0660) 的变通办法
...
#### SMB 客户端响应分析漏洞 (CVE-2011-0660) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**    
此漏洞由于 Microsoft 服务器消息块 (SMB) 客户端实施错误地验证特制的 SMB 事务响应而存在。
...
**此更新有什么作用？**    
此安全更新通过更正 SMB 客户端验证特制 SMB 响应的方式来解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2511455$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2511455">Microsoft 知识库文章 2511455</a></td>
</tr>  
<tr class="even">
...
-   V1.1（2011 年 4 月 13 日）： 在“**摘要**”中阐明了漏洞描述。

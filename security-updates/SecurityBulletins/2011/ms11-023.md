...
**已知问题。** [Microsoft 知识库文章 2489293](https://support.microsoft.com/kb/2489293) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
是的，此安全更新解决的 Office 组件不安全库加载漏洞 (CVE-2011-0107) 与 [Microsoft 安全通报 2269637](https://technet.microsoft.com/security/advisory/2269637) 中介绍的漏洞类别有关，其影响应用程序加载外部库的方式。 此安全更新针对这种漏洞的特定实例。

**此更新是否包含任何与安全性相关的功能更改？**  
是。 Microsoft Office 2003 Service Pack 3 (KB2509503) 和 Microsoft Office 2007 Service Pack 2 (KB2509488) 的更新以及 Microsoft Word、Microsoft Excel 和 Microsoft PowerPoint 的更新可为 Office 文件验证功能提供支持。 有关 Office 文件验证功能的详细信息，请参阅 [Microsoft 安全通报 2501584](https://technet.microsoft.com/security/advisory/2501584)。

**此安全更新与 MS11-029 有什么联系？**  
此公告中提供的 Microsoft Office XP 安全更新程序包 (KB2509461) 也可解决 [MS11-029](https://go.microsoft.com/fwlink/?linkid=208524) 安全公告中介绍的漏洞。 安装了 Microsoft Office XP 的用户只需安装任一安全更新程序包。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0107](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-0107](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107)。

**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。

**应用此安全更新是否有助于客户防止可能会尝试利用此漏洞的已公开发布的代码？**  
是。 此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2011-0107](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0107)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0977](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0977)。
...
<p> </p>
  ...
  **注意** 在 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 上，通过提升的命令提示符运行以上命令。
  ...
  有关 MOICE 的详细信息，  **注意** 在 Windows Vista、请参阅 [Microsoft 知识库文章 935865](https://support.microsoft.com/kb/935865)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2509461">Microsoft 知识库文章 2509461</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2509503">Microsoft 知识库文章 2509503</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2509488">Microsoft 知识库文章 2509488</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Fortinet FortiGuard Labs](https://www.fortiguard.com/) 的 Haifei Li 报告了 Office 组件不安全库加载漏洞 (CVE-2011-0107)  
-   一名匿名研究员与 [TippingPoint 的](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Microsoft Office 图形对象解除引用漏洞 (CVE-2011-0977)

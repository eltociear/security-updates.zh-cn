...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2007](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2007)。
...
**发布此安全公告时，此漏洞是否已公开披露？**   
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-2007](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2007)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2008)。
...
**发布此安全公告时，此漏洞是否已公开披露？**   
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-2008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2008)。
...
<td style="border:1px solid black;">对于 Microsoft Host Integration Server 2004 Service Pack 1：<br />
请参阅 <a href="https://support.microsoft.com/kb/2578757">Microsoft 知识库文章 2578757</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Host Integration Server 2006 Service Pack 1：<br />
请参阅 <a href="https://support.microsoft.com/kb/2579597">Microsoft 知识库文章 2579597</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Host Integration Server 2009：<br />
请参阅 <a href="https://support.microsoft.com/kb/2579598">Microsoft 知识库文章 2579598</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Host Integration Server 2010：<br />
请参阅 <a href="https://support.microsoft.com/kb/2579599">Microsoft 知识库文章 2579599</a></td>
</tr>
<tr class="even">

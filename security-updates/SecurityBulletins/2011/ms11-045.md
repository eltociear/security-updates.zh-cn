...
**已知问题。** [Microsoft 知识库文章 2537146](https://support.microsoft.com/kb/2537146) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
当 Microsoft Excel 2003 和 Microsoft Excel 2007 中启用了 Office 文件验证功能时，可用于利用 CVE-2011-1272、CVE-2011-1273 和 CVE-2011-1279 中所述的漏洞的特制文件不会自动打开；默认情况下，系统会提示用户选择是否打开此类文件。 在漏洞可以被利用之前，用户必须单击警告才能打开文件。 有关 Microsoft Excel 2003 或 Microsoft Excel 2007 中的 Office 文件验证的详细信息，请参阅 [Microsoft 安全通报 2501584](https://technet.microsoft.com/security/advisory/2501584)。

默认情况下，Microsoft Excel 2010 中启用了 Office 文件验证。可用于利用 CVE-2011-1272、CVE-2011-1273 和 CVE-2011-1279 中所述的漏洞的特制文件未通过验证，将在[受保护的视图](https://www.microsoft.com/security/pc-security/office2010.aspx)中打开；然后，用户必须单击许多警告消息，才可以打开文件进行编辑，漏洞才可以被利用。

**如果在 Excel 2003 和 Excel 2007 中禁止打开未通过文件验证的文件，则有何好处？**  
通过将 Office 文件验证设置为不允许在 Excel 2003 和 Excel 2007 中打开可疑文件，[Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584) 中提供的 **Microsoft Fix it** 解决方案“禁止在 Excel 2003 和 2007 中打开文档”可阻止利用 CVE-2011-1272、CVE-2011-1273 和 CVE-2011-1279 中介绍的漏洞的攻击媒介。

有关应用自动 Fix it 解决方案“禁止在 Excel 2003 和 2007 中打开文档”的说明，请参阅 [Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584)；有关手动应用解决方案的说明，请参阅本公告的“漏洞信息”部分中 CVE-2011-1272、CVE-2011-1273 和 CVE-2011-1279 的“变通办法”部分。

**如果在 Excel 2010 中禁止打开未通过文件验证的文件，则有何好处？**  
Microsoft Excel 2010 仅受本公告中描述的 CVE-2011-1273 影响。 [Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584) 中提供的自动 **Microsoft Fix it** 解决方案“为 Excel 2010 禁用受保护视图编辑操作”可阻止利用 CVE-2011-1273 的攻击媒介。如果客户选择以后再安装 Excel 2010 的安全更新，则可以选择应用该 Fix it 解决方案作为变通办法。

有关应用自动 Fix it 解决方案“为 Excel 2010 禁用受保护视图编辑操作”的说明，请参阅 [Microsoft 知识库文章 2501584](https://support.microsoft.com/kb/2501584)；或者，有关手动应用该解决方案的说明，请参阅本公告的“漏洞信息”中 CVE-2011-1273 的“变通方法”部分。

**此更新为何消除了多个已报告的安全漏洞？**  
此更新之所以包含对某些漏洞的支持，是因为解决这些问题所需的修改位于相关的文件中。 客户只需安装此更新就可以了，而不用安装多个几乎相同的更新。

**此安全更新与 MS11-036 有什么联系？**  
本公告中提供的 Microsoft Office 2004 for Mac (KB2555786)、Microsoft Office 2008 for Mac (KB2555785) 和 Open XML File Format Converter for Mac (KB2555784) 安全更新程序包也可解决 [MS11-036](https://go.microsoft.com/fwlink/?linkid=217670) 安全公告中介绍的漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1272](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1272)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1273](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1273)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1274](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1274)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1275](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1275)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1276](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1276)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1277](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1277)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1278](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1278)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1279](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1279)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2541003">Microsoft 知识库文章 2541003</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2541025">Microsoft 知识库文章 2541025</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2007，请参阅 <a href="https://support.microsoft.com/kb/2541007">Microsoft 知识库文章 2541007</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Excel Viewer，请参阅 <a href="https://support.microsoft.com/kb/2541015">Microsoft 知识库文章 2541015</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">有关 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包，请参阅 <a href="https://support.microsoft.com/kb/2541012">Microsoft 知识库文章 2541012</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2523021">Microsoft 知识库文章 2523021</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=d12d0868-4f28-4c0a-ab61-338878064b70)下载和安装 Microsoft Office 2004 for Mac 11.6.4 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=9e2d348b-c753-4eab-838c-370cd5af5e14)下载和安装 Microsoft Office 2008 for Mac 12.3.0 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=3c58555c-1eba-42fe-a10f-b30af9031e44)下载和安装 Microsoft Office for Mac 2011 14.1.2 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=6118d5f5-b6fd-4584-be25-209534772379)下载和安装 Open XML File Format Converter for Mac 1.2.0 Update 的合适语言版本。
...
-   [Fortinet's FortiGuard Labs](https://www.fortiguard.com/) 的 Bing Liu 报告了 Excel 记录验证不足漏洞 (CVE-2011-1272)  
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel 记录分析不正确漏洞 (CVE-2011-1273)  
-   Omair 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel 溢出数组访问漏洞 (CVE-2011-1274)  
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel 内存堆覆盖漏洞 (CVE-2011-1275)  
-   [Agarri](https://www.agarri.fr/) 的 Nicolas Gregoire 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel 缓冲区溢出漏洞 (CVE-2011-1276)  
-   Omair 报告了 Excel 内存损坏漏洞 (CVE-2011-1277)  
-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了 Excel WriteAV 漏洞 (CVE-2011-1278)  
-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了 Excel 溢出 WriteAV 漏洞 (CVE-2011-1279)

---
TOCTitle: 'MS11-003'
Title: 'Microsoft 安全公告 MS11-003 - 严重'
ms:assetid: 'ms11-003'
ms:contentKeyID: 61237948
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-003(v=Security.10)'
---
...
Internet Explorer 的累积性安全更新 (2482017)
--------------------------------------------
...
对于 Windows 客户端上的 Internet Explorer 6、Internet Explorer 7 和 Internet Explorer 8，此安全更新的等级为“严重”；对于 Windows 服务器上的 Internet Explorer 6、Internet Explorer 7 和 Internet Explorer 8，此安全更新的等级为“中等”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过修改 Internet Explorer 处理内存中对象、处理级联样式表，以及加载外部库的方式来解决这些漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。

此安全更新也解决了最初在 [Microsoft 安全通报 2488013](https://technet.microsoft.com/security/advisory/2488013) 中描述的漏洞。
...
Internet Explorer 9 Beta 不受此公告中所述的漏洞的影响。 鼓励运行此试用版的客户下载并向其系统应用此更新。 安全更新可从 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 和 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 获得。 此 Beta 版本的安全更新也可从 [Microsoft 下载中心](https://go.microsoft.com/fwlink/?linkid=21129)下载。

**此更新为何消除了多个已报告的安全漏洞？**  
此更新之所以包含对某些漏洞的支持，是因为解决这些问题所需的修改位于相关的文件中。 客户只需安装此更新就可以了，而不用安装多个几乎相同的更新。

**如果我应用了**   
Microsoft 安全通报 2488013 中提供的变通办法，是否需要在应用此更新之前撤消变通办法？Microsoft 建议您在安装此安全更新之前，从之前应用此更新的系统中撤销“防止 Internet Explorer 中递归加载级联样式 (CSS) 表”变通办法。 要使用自动化“**Microsoft 修复**”解决方案来禁用此变通办法，请参阅 [Microsoft 知识库文章 2482017](https://support.microsoft.com/kb/2482017)。

**此更新是否与 Microsoft 安全通报 2269637 有关？**  
是的，此更新解决的漏洞 [CVE-2011-0038](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) 与 [Microsoft 安全通报 2269637](https://technet.microsoft.com/security/advisory/2269637) 中所述的影响应用程序如何加载外部库的漏洞类别有关。 此安全更新针对这种漏洞的特定实例。
...
Internet Explorer 在导入以递归方式参考自身的级联样式表的同时访问内存的方式中存在远程代码执行漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3971](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971)。

#### CSS 内存损坏漏洞 (CVE-2010-3971) 的缓解因素
...
#### CSS 内存损坏漏洞 (CVE-2010-3971) 的变通办法
...
-   **防止在 Internet Explorer 中以递归方式加载级联样式表 (CSS)**
    ...
    该变通办法通过在 Internet Explorer 中阻止级联样式表 (CSS) 攻击媒介，防止利用该漏洞。

    该变通办法仅可用作一种 **Microsoft Fix it** 解决方案。 要使用自动化“**Microsoft 修复**”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 2482017](https://support.microsoft.com/kb/2482017)。

    **注意** 尚未应用 [MS10-090](https://go.microsoft.com/fwlink/?linkid=206495) 更新的 Internet Explorer 客户在启用此变通办法之前也必须应用 MS10-090 更新。

    **变通办法的影响。** 阻止递归加载级联样式表 (CSS) 存在副作用。 由于阻止加载 CSS 文件所需的检查增加，用户可能遇到某些轻度性能问题。

    **注意** 在已启用此变通办法的系统上，Microsoft 建议在应用此安全更新之前禁用此变通办法。

#### CSS 内存损坏漏洞 (CVE-2010-3971) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成此漏洞的原因是什么？**  
Internet Explorer 在解析以递归方式参考自身的特制级联样式表时未正确处理内存
...
**此更新有什么作用？**  
此更新通过修改 Internet Explorer 处理级联样式表的方式来解决此漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3971](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971)。此漏洞已在 [Microsoft 安全通报 2488013](https://technet.microsoft.com/security/advisory/2488013) 中描述。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0035](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0035)。

#### 未初始化的内存损坏漏洞 (CVE-2011-0035) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2011-0035) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2011-0035) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成此漏洞的原因是什么？**  
Internet Explorer 在解析特制 Web 内容时未正确处理内存中的对象。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0036](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0036)。

#### 未初始化的内存损坏漏洞 (CVE-2011-0036) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2011-0036) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2011-0036) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0038](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038)。

#### Internet Explorer 不安全库加载漏洞 (CVE-2011-0038) 的缓解因素
...
#### Internet Explorer 不安全库加载漏洞 (CVE-2011-0038) 的变通办法
...
#### Internet Explorer 不安全库加载漏洞 (CVE-2011-0038) 的常见问题
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-0038](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038)。
...
<p>使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2482017$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie7updates\KB2482017-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie8updates\KB2482017-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2482017">Microsoft 知识库文章 2482017</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2482017$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
-   [Trend Micro](https://www.trendmicro.com) 的 Yuki Chen 报告了未初始化内存损坏漏洞 (CVE-2011-0035)  
-   [Google Inc.](https://www.google.com/) 的 Skylined 报告了未初始化内存损坏漏洞 (CVE-2011-0036)  
-   [Fortinet’s FortiGuard Labs](https://www.fortiguard.com/) 的 Haifei Li 报告了 Internet Explorer 不安全库加载漏洞 (CVE-2011-0038)

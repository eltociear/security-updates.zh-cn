...
此安全更新也解决了最初在 [Microsoft 安全通报 2488013](http://technet.microsoft.com/security/advisory/2488013) 中描述的漏洞。
...
Internet Explorer 9 Beta 不受此公告中所述的漏洞的影响。 鼓励运行此试用版的客户下载并向其系统应用此更新。 安全更新可从 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 和 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 获得。 此 Beta 版本的安全更新也可从 [Microsoft 下载中心](http://go.microsoft.com/fwlink/?linkid=21129)下载。

**此更新为何消除了多个已报告的安全漏洞？**  
此更新之所以包含对某些漏洞的支持，是因为解决这些问题所需的修改位于相关的文件中。 客户只需安装此更新就可以了，而不用安装多个几乎相同的更新。

**如果我应用了**   
Microsoft 安全通报 2488013 中提供的变通办法，是否需要在应用此更新之前撤消变通办法？Microsoft 建议您在安装此安全更新之前，从之前应用此更新的系统中撤销“防止 Internet Explorer 中递归加载级联样式 (CSS) 表”变通办法。 要使用自动化“**Microsoft 修复**”解决方案来禁用此变通办法，请参阅 [Microsoft 知识库文章 2482017](http://support.microsoft.com/kb/2482017)。

**此更新是否与 Microsoft 安全通报 2269637 有关？**  
是的，此更新解决的漏洞 [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038) 与 [Microsoft 安全通报 2269637](http://technet.microsoft.com/security/advisory/2269637) 中所述的影响应用程序如何加载外部库的漏洞类别有关。 此安全更新针对这种漏洞的特定实例。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3971](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971)。
...
-   **防止在 Internet Explorer 中以递归方式加载级联样式表 (CSS)**
    ...
    该变通办法仅可用作一种 **Microsoft Fix it** 解决方案。 要使用自动化“**Microsoft 修复**”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 2482017](http://support.microsoft.com/kb/2482017)。

    **注意** 尚未应用 [MS10-090](http://go.microsoft.com/fwlink/?linkid=206495) 更新的 Internet Explorer 客户在启用此变通办法之前也必须应用 MS10-090 更新。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3971](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3971)。此漏洞已在 [Microsoft 安全通报 2488013](http://technet.microsoft.com/security/advisory/2488013) 中描述。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0035](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0035)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0036](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0036)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-0038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0038)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2482017">Microsoft 知识库文章 2482017</a></td>
</tr>  
<tr class="even">
...
-   [Trend Micro](http://www.trendmicro.com) 的 Yuki Chen 报告了未初始化内存损坏漏洞 (CVE-2011-0035)  
-   [Google Inc.](http://www.google.com/) 的 Skylined 报告了未初始化内存损坏漏洞 (CVE-2011-0036)  
-   [Fortinet’s FortiGuard Labs](http://www.fortiguard.com/) 的 Haifei Li 报告了 Internet Explorer 不安全库加载漏洞 (CVE-2011-0038)

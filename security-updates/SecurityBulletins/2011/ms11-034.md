---
TOCTitle: 'MS11-034'
Title: 'Microsoft 安全公告 MS11-034 - 重要'
ms:assetid: 'ms11-034'
ms:contentKeyID: 61238172
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-034(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-034 - 重要
==================================

Windows 内核模式驱动程序中的漏洞可能允许特权提升 (2506223)
----------------------------------------------------------
...
此安全更新可解决 Microsoft Windows 中 30 个秘密报告的漏洞。 如果攻击者本地登录并运行特制应用程序，这些漏洞可能允许特权提升。 攻击者必须拥有有效的登录凭据并能本地登录才能利用这些漏洞。 匿名用户无法利用这些漏洞，也无法以远程方式利用这些漏洞。

对于 Microsoft Windows 所有受支持的版本，此安全更新的等级为“重要”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

该安全更新通过更正内核模式驱动程序管理内核模式驱动程序对象和跟踪至内核模式驱动程序对象的指针来解决漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=39e55bbf-c1c5-4696-bfe7-632e997cd98e)                                                                                           | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=83771177-284e-4918-86a9-980e8229c7c9)                                                                  | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=af320f27-bb3a-4e76-a279-4632267c8761)                                                                                  | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9c95f81c-9812-4070-88d7-34422c638e42)                                                                      | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=f58cf64a-bf31-4496-be75-5775a123338b)                                                                  | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b4743167-9614-445a-9e91-10efdac505a8)                                                        | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7e410d5c-b9f7-4a63-8300-36b2d57c6128)                                | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c6ac26b8-8cc8-40fe-baab-22bf13df1aa8)\*                       | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ac49f5d3-5e2f-4916-99be-a3254278da7e)\*             | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3b93de4f-01f4-4efd-afc1-31d87b92fad2)       | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=6e7ff003-ff3f-49bb-8e45-d869885dd8d7)                                             | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0c0aef7e-501c-4ca3-ae7f-497a8c169121)                                   | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=2fc66224-45c6-4e8f-ad00-6a1ec30b4505)\*       | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=485ccf96-27a0-499e-9f52-2836b73d26d2) | 特权提升     | 重要         | [MS11-012](https://go.microsoft.com/fwlink/?linkid=208362) |
...
<td style="border:1px solid black;"><strong>Win32k 使用释放后内存漏洞</strong><br />
<br />  
...
<td style="border:1px solid black;"><strong>Win32k 空指针解除引用漏洞</strong><br />
<br />
...
漏洞类型 1： Win32k 使用释放后内存漏洞  
--------------------------------------
  
<span></span>  
由于 Windows 内核模式驱动程序管理内核模式驱动程序对象的方式，因此存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅：
  
-   [CVE-2011-0662](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0662)  
-   [CVE-2011-0665](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0665)  
-   [CVE-2011-0666](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0666)  
-   [CVE-2011-0667](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0667)  
-   [CVE-2011-0670](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0670)  
-   [CVE-2011-0671](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0671)  
-   [CVE-2011-0672](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0672)  
-   [CVE-2011-0674](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0674)  
-   [CVE-2011-0675](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0675)  
-   [CVE-2011-1234](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1234)  
-   [CVE-2011-1235](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1235)  
-   [CVE-2011-1236](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1236)  
-   [CVE-2011-1237](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1237)  
-   [CVE-2011-1238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1238)  
-   [CVE-2011-1239](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1239)  
-   [CVE-2011-1240](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1240)  
-   [CVE-2011-1241](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1241)  
-   [CVE-2011-1242](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1242)
  
#### 漏洞类型 1 的缓解因素： Win32k 使用释放后内存漏洞
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### 漏洞类型 1 的变通办法： Win32k 使用释放后内存漏洞
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### 漏洞类型 1 的常见问题： Win32k 使用释放后内存漏洞
...
漏洞类型 2： Win32k 空指针解除引用漏洞  
--------------------------------------
  
<span></span>  
由于 Windows 内核模式驱动程序管理至内核模式驱动程序对象的指针的方式而存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅：
  
-   [CVE-2011-0673](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0673)  
-   [CVE-2011-0676](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0676)  
-   [CVE-2011-0677](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0677)  
-   [CVE-2011-1225](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1225)  
-   [CVE-2011-1226](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1226)  
-   [CVE-2011-1227](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1227)  
-   [CVE-2011-1228](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1228)  
-   [CVE-2011-1229](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1229)  
-   [CVE-2011-1230](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1230)  
-   [CVE-2011-1231](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1231)  
-   [CVE-2011-1232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1232)  
-   [CVE-2011-1233](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1233)
  
#### 漏洞类型 2 的缓解因素： Win32k 空指针解除引用漏洞
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### 漏洞类型 2 的变通办法： Win32k 空指针解除引用漏洞
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### 漏洞类型 2 的常见问题： Win32k 空指针解除引用漏洞
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2506223$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2506223">Microsoft 知识库文章 2506223</a></td>
</tr>  
<tr class="even">
...
-   [Norman](https://www.norman.com/) 的 Tarjei Mandt 报告了漏洞类型 1： Win32k 使用释放后内存漏洞  
    - CVE-2011-0662  
    - CVE-2011-0665  
    - CVE-2011-0666  
    - CVE-2011-0667  
    ...
    - CVE-2011-1241  
    - CVE-2011-1242  
-   [Norman](https://www.norman.com/) 的 Tarjei Mandt 报告了漏洞类型 2： Win32k 空指针解除引用漏洞  
    - CVE-2011-0673  
    - CVE-2011-0676  
    - CVE-2011-0677  
    - CVE-2011-1225  

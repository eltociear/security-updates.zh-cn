---
TOCTitle: 'MS06-023'
Title: 'Microsoft 安全公告 MS06-023 - 严重'
ms:assetid: 'ms06-023'
ms:contentKeyID: 61236786
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms06-023(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS06-023 - 严重
==================================
...
**注意事项：** Microsoft 发布此更新是为了补充 [Microsoft 安全公告 MS06-021： Internet Explorer 的累积性安全更新 (916281)](https://technet.microsoft.com/security/bulletin/ms06-021) 中包含的更新。 我们建议您同时安装这两个更新程序，因为该公告中的安全更新可能暴露此漏洞或导致应用程序兼容性问题。
...
-   Microsoft Windows 2000 Service Pack 4 上的 Microsoft JScript 5.1 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=23e79abd-b1fe-4734-b3d3-fb53d286c06f)
-   安装在 Windows 2000 Service Pack 4 上的 Microsoft JScript 5.6 和 5.5 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=16dd21a1-c4ee-4eca-8b80-7bd1dfefb4f8)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 上的 Microsoft JScript 5.6 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=d28c02be-cac3-4579-9b93-939fd5d3cde6)
-   Microsoft Windows XP Professional x64 Edition 上的 Microsoft JScript 5.6 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=2ee3dd28-7167-4a2c-941d-a236f8cc5c4b)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 上的 Microsoft JScript 5.6 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=8963ae25-2230-47fe-aece-49d7457d96d4)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）上的 Microsoft JScript 5.6 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=7764c7dc-a7e4-4b91-95c2-ef7d4dce0a00)
-   Microsoft Windows Server 2003 x64 Edition 上的 Microsoft JScript 5.6 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=bcf7ab2e-ee1c-45f9-8b1c-4b1cef683082)
...
此更新可解决一个新发现的漏洞。 Microsoft JScript 中存在的远程执行代码漏洞，可以允许攻击者完全控制受影响的系统。 本公告的“漏洞详细资料”部分中对此漏洞进行了说明。
...
|-------------------------------------------------------------------------------------------------------------------|--------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Microsoft JScript 内存损坏漏洞 - [CVE-2006-1313](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1313) | 远程执行代码 | 严重                  | 严重         | 严重                      | 严重                      | 中等                | 中等                               |

**注意** 默认情况下，Windows Server 2003 上的 Internet Explorer 在一种称为“增强安全配置”的受限模式下运行。 此模式可减轻此漏洞。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此安全更新的“常见问题解答”部分。
...
| 公告 ID      | Windows 2000 Service Pack 4 | 安装在 Windows 2000 Service Pack 4 上的 Microsoft JScript 5.6 和 5.5 | Windows XP Service Pack 1 | Windows XP Service Pack 2 | Windows Server 2003 | Windows Server 2003 Service Pack 1 |
|--------------|-----------------------------|----------------------------------------------------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| **MS03-008** | 不适用                      | 已取代                                                               | 已取代                    | 不适用                    | 不适用              | 不适用                             |
...
| 产品                         | MBSA 1.2.1 | 企业更新扫描工具 | MBSA 2.0 |
|------------------------------|------------|------------------|----------|
| Microsoft JScript 5.1        | 否         | 是               | 是       |
| Microsoft JScript 5.6 和 5.5 | 否         | 是               | 是       |
...
| 产品                         | SMS 2.0      | SMS 2003 |
|------------------------------|--------------|----------|
| Microsoft JScript 5.1        | 是（用 EST） | 是       |
| Microsoft JScript 5.6 和 5.5 | 是（用 EST） | 是       |
...
#### Microsoft JScript 内存损坏漏洞 - CVE-2006-1313：

JScript 中存在一个远程执行代码漏洞。 攻击者可以通过构建特制的 JScript 来利用此漏洞，如果用户访问了网站或查看了特制的电子邮件，此漏洞就可能允许远程执行代码。 成功利用此漏洞的攻击者可以完全控制受影响的系统。

#### Microsoft JScript 内存损坏漏洞 (CVE-2006-1313) 的缓解因素：

-   在基于 Web 的攻击中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
...
#### Microsoft JScript 内存损坏漏洞 (CVE-2006-1313) 的变通办法：
...
**变通办法的影响：** 在运行 ActiveX 控件和活动脚本之前提示有负面影响。 Internet 或 Intranet 上的许多网站都使用 ActiveX 或活动脚本来提供附加功能。 例如，在线电子商务站点或银行站点可能使用 ActiveX 控件来提供菜单、订购单或者帐户报表。 在运行 ActiveX 控件或活动脚本之前进行提示是一个全局设置，它影响所有 Internet 和 Intranet 站点。 在启用此变通方法后，将会频繁出现提示。 对于每一提示，如果您认为信任您所访问的站点，则单击“**是**”运行 ActiveX 控件或活动脚本。 如果您不想在访问所有这些网站时进行提示，请使用“将您信任的站点添加到 Internet Explorer 的“受信任的站点”区域”中概述的步骤。
...
-   **修改 JScript.dll 上的访问控制列表，从而暂时阻止其在 Internet Explorer 中运行**

    要对 JScritp.dll 文件修改访问控制列表 (ACL) 以增加限制，请按照下列步骤执行操作：
    ...
    **变通办法的影响：** 使用 JScript 的应用程序和网站可能将无法继续工作。

    要恢复功能，您必须撤消对 jscript.dll 文件上的访问控制列表所做的修改。

#### Microsoft JScript 内存损坏漏洞 (CVE-2006-1313) 的常见问题解答：
...
**造成漏洞的原因是什么？**  
Microsoft JScript 可能发布了之前潜在导致内存损坏的对象。

**什么是 Microsoft .JScript？**  
JScript 是 Microsoft 实现 ECMA 262 语言规格 (ECMAScript Edition 3) 的方式。 JScript 是一种解释型的、基于对象的脚本语言。 有关详细信息，请参阅[产品文档](https://msdn.microsoft.com/library/en-us/dnanchor/html/scriptinga.asp)。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以完全控制受影响的系统。

**攻击者能够如何利用此漏洞？**  
攻击者可能拥有一个旨在通过 Internet Explorer 利用此漏洞的网站，然后诱使用户查看该网站。 这还可以包括接受用户提供的内容或广告的网站、放置用户提供的内容或广告的网站以及受到破坏的网站。 这些网站可能包含可以利用此漏洞的特制 JScript 文件。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 请求中的链接以使用户链接到攻击者的网站。 它还可能使用横幅广告或其他方式显示特殊形式的 Web 内容，以便将 Web 内容传递至受影响的系统。
...
**此更新有什么作用？**  
此更新通过保护早期版本中的 JScript 正在使用的对象来消除此漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  
否。 Microsoft 发布此更新是为了补充 [Microsoft 安全公告 MS06-021： Internet Explorer 的累积性安全更新 (916281)](https://technet.microsoft.com/security/bulletin/ms06-021) 中包含的更新。 建议同时安装这两个更新程序，因为该公告中的安全更新可能暴露此漏洞或导致应用程序兼容性问题。
...
**注意** 使用 **/quiet** 开关将抑制所有消息。 这包括抑制失败消息。 管理员应该使用其中一种支持的方法，验证使用 **/quiet** 开关时安装是否成功。 管理员还应该检查 KB917344.log 文件，查看使用此开关时的任何失败消息。
...
系统管理员也可以使用 Spuninst.exe 实用工具删除此安全更新。 Spuninst.exe 实用工具位于 %Windir%\\$NTUninstallKB917344$\\Spuninst 文件夹中。
...
| 文件名      | 版本       | 日期               | 时间  | 大小    | 文件夹 |
|-------------|------------|--------------------|-------|---------|--------|
| Jscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 02:53 | 446,464 | RTMGDR |
| Jscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 03:10 | 446,464 | RTMQFE |
| Jscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 03:21 | 458,752 | SP1GDR |
| Jscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 03:46 | 458,752 | SP1QFE |
...
|--------------|------------|--------------------|-------|-----------|-------|-------------|
| Jscript.dll  | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:14 | 1,268,736 | IA-64 | RTMGDR      |
| Wjscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:14 | 446,464   | x86   | RTMGDR\\WOW |
| Jscript.dll  | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:14 | 1,268,736 | IA-64 | RTMQFE      |
| Wjscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:14 | 446,464   | x86   | RTMQFE\\WOW |
| Jscript.dll  | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:27 | 1,304,576 | IA-64 | SP1GDR      |
| Wjscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:27 | 458,752   | x86   | SP1GDR\\WOW |
| Jscript.dll  | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:14 | 1,304,576 | IA-64 | SP1QFE      |
| Wjscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:14 | 458,752   | x86   | SP1QFE\\WOW |
...
| 文件名       | 版本       | 日期               | 时间  | 大小    | CPU | 文件夹      |
|--------------|------------|--------------------|-------|---------|-----|-------------|
| Jscript.dll  | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:28 | 997,888 |     | SP1GDR      |
| Wjscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:28 | 458,752 | x86 | SP1GDR\\WOW |
| Jscript.dll  | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:14 | 997,888 |     | SP1QFE      |
| Wjscript.dll | 5.6.0.8831 | 2006 年 5 月 12 日 | 04:14 | 458,752 | x86 | SP1QFE\\WOW |
...
-   **注册表项验证**
    ...
    **注意** 此注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 917344 安全更新集成或组合到 Windows 安装源文件中，则可能无法正确创建此注册表项。
...
| 文件名      | 版本       | 日期               | 时间  | 大小    | 文件夹 |
|-------------|------------|--------------------|-------|---------|--------|
| Jscript.dll | 5.6.0.8831 | 2006 年 5 月 18 日 | 05:58 | 458,752 | SP1QFE |
| Jscript.dll | 5.6.0.8831 | 2006 年 5 月 18 日 | 05:24 | 450,560 | SP2GDR |
| Jscript.dll | 5.6.0.8831 | 2006 年 5 月 18 日 | 05:37 | 450,560 | SP2QFE |
...
-   **注册表项验证**
    ...
    **注意** 这些注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 917344 安全更新集成或组合到 Windows 安装源文件中，则可能无法正确创建这些注册表项。
...
| 文件名      | 版本        | 日期               | 时间  | 大小    |
|-------------|-------------|--------------------|-------|---------|
| Jscript.dll | 5.1.0.12512 | 2006 年 5 月 18 日 | 19:43 | 483,385 |
...
#### Windows 2000 上的 Microsoft JScript 5.6（所有版本）

**先决条件**
对于 Windows 2000，此安全更新需要 Service Pack 4 (SP4)。 对于 Small Business Server 2000，此安全更新需要 Small Business Server 2000 Service Pack 1a (SP1a) 或与 Windows 2000 Server Service Pack 4 (SP4) 一起运行的 Small Business Server 2000。

**注意** 具有 JScript 版本 5.1 的客户应安装在“Windows 2000（所有版本）”部分中讨论的更新。 版本 5.1 是包括在 Windows 2000 Service Pack 4 中的版本。
...
| 文件名      | 版本       | 日期               | 时间  | 大小    |
|-------------|------------|--------------------|-------|---------|
| Jscript.dll | 5.6.0.8831 | 2006 年 5 月 17 日 | 18:43 | 465,864 |

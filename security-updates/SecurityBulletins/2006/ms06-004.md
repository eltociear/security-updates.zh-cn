---
TOCTitle: 'MS06-004'
Title: 'Microsoft 安全公告 MS06-004 - 严重'
ms:assetid: 'ms06-004'
ms:contentKeyID: 61236667
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms06-004(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS06-004 - 严重
==================================

Internet Explorer 的累积性安全更新 (910620)
-------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 上的 Internet Explorer 5.01 Service Pack 4 - [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=c0df2fc3-2075-46b5-945f-6e0bd6806151)
...
|-------------------------------------------------------------------------------------------------------------|--------------|---------------------------------------|----------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|-------------------------------------------------------|
| WMF 图像分析内存损坏漏洞 - [CVE-2006-0020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0020) | 远程执行代码 | 严重                                  | 无                                                                                     | 无                                                                                    | 无                                                    |
...
-   用于 Windows XP Professional x64 Edition 的 Internet Explorer 6 的严重等级与 Internet Explorer 6 Service Pack 1（Windows Server 2003 之前所有受支持的操作系统版本）的严重等级相同。 因此它的严重等级也为“无”。
-   用于 Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Windows Server 2003 x64 Edition 的 Internet Explorer 6 的严重等级与用于 Windows Server 2003 的 Internet Explorer 6 的严重等级相同。 因此它们的严重等级也为“无”。
...
| 公告 ID      | Internet Explorer 5.01 Service Pack 4 | Internet Explorer 6 Service Pack 1（Windows Server 2003 之前的所有版本） | 用于 Windows Server 2003（包括 64-Bit Edition）的 Internet Explorer 6 | 用于 Windows XP Service Pack 2 的 Internet Explorer 6 |
|--------------|---------------------------------------|--------------------------------------------------------------------------|-----------------------------------------------------------------------|-------------------------------------------------------|
| **MS05-054** | 已替代                                | 不适用                                                                   | 不适用                                                                | 不适用                                                |

**当客户安装此安全更新时可能遇到什么已知问题？**  
[Microsoft 知识库文章 910620](https://support.microsoft.com/kb/910620) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 [Microsoft 知识库文章 910620](https://support.microsoft.com/kb/910620)。

**我从 Microsoft 或我的支持提供商那里获得自 MS04-004 发布后发布的修补程序。此安全更新是否包括该修补程序？**  
是。 对于 Internet Explorer 5.01 Service Pack 4、Internet Explorer 5.5 Service Pack 2 和 Windows 2000 Service Pack 4，[MS06-004](https://technet.microsoft.com/security/bulletin/ms06-004) 安全更新包含 [MS04-004](https://go.microsoft.com/fwlink/?linkid=22189) 之后直到 [MS06-004](https://technet.microsoft.com/security/bulletin/ms06-004) 的修补程序，并包括累积更新。不管先前是否已安装 Internet Explorer 修补程序来更新本公告的“安全更新信息”部分列出的任何文件，都会安装此安全更新中包括的文件的修补程序版本。
...
否。 带有 [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx) 的 Windows 98、Windows 98 Second Edition 或 Windows Millennium Edition 上不存在此漏洞。Internet Explorer 6 Service Pack 1 是这些 Windows 版本唯一支持的 Internet Explorer 版本。 有关严重等级的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21140)。 Microsoft 将在 2006 年 6 月 30 日之前在受影响且严重等级为“严重”的操作系统上提供安全更新。使用这些操作系统版本的客户应优先考虑迁移到受支持的版本，以防止可能会受到新出现漏洞的影响。 有关 Windows 产品生命周期的详细信息，请访问以下 [Microsoft 产品技术支持生命周期网站](https://support.microsoft.com/gp/lifean1)。

**Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 情况如何？**  
Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 的生命周期已经结束。 使用此 Internet Explorer 版本的客户应优先考虑迁移到 [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx)，以防止可能会受到漏洞的影响。 有关 Windows 产品生命周期的详细信息，请访问以下 [Microsoft 产品技术支持生命周期网站](https://support.microsoft.com/gp/lifean1)。 有关 Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 的具体支持日期，请访问以下 [Microsoft 产品技术支持生命周期网](https://support.microsoft.com/gp/lifesupsps)。

**当您发布该通报时，您表明 Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 会受此漏洞的影响。 我该怎么办？**  
Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 的生命周期已经结束，您应该迁移到 [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx)，以防止可能会受到漏洞（包括此漏洞）的影响。

**Pack 6a 和 Windows 2000 Service Pack 2 的延长安全更新支持已在 2004 年 6 月 30 日结束。Microsoft Windows NT Server 4.0 Service Pack 6a 的延长安全更新支持已在 2004 年 12 月 31 日结束。Microsoft Windows 2000 Service Pack 3 的延长安全更新支持已在 2005 年 6 月 30 日结束。我仍在使其中一种操作系统，我该怎么办？**  
...
是。 MBSA 1.2.1 将确定是否需要此更新。 MBSA 仅支持工作站类的操作系统（例如，Windows 2000 和更高版本）。 有关 MBSA 的详细信息，请访问 [MBSA 网站](https://go.microsoft.com/fwlink/?linkid=21134)。

**可否使用 Microsoft 基准安全分析器 (MBSA) 2.0 确定是否需要此更新？**  
是。 MBSA 2.0 将确定是否需要此更新。 MBSA 2.0 可以为 Microsoft Update 支持的产品检测安全更新。 MBSA 仅支持工作站类的操作系统（例如，Windows 2000 和更高版本）。 有关 MBSA 的详细信息，请访问 [MBSA 网站](https://go.microsoft.com/fwlink/?linkid=21134)。
...
#### WMF 图像分析内存损坏漏洞 (CVE-2006-0020) 的缓解因素：
...
-   在利用此漏洞的基于电子邮件的攻击中，客户必须打开恶意电子邮件、在 Outlook Express 预览窗格中预览恶意电子邮件、点击会将他们定向至恶意网站的链接或者打开可能利用该漏洞的附件。 用户可以禁用 Outlook Express 中的预览窗格，并在打开可疑的电子邮件之前删除它。 成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
...
-   安装了 [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx) 的客户不会受到此漏洞的影响，也不会受到使用电子邮件媒介尝试利用此漏洞的影响。
-   Internet Explorer 6 Service Pack 1 是 Windows 98、Windows 98 Second Edition 和 Windows Millennium 的唯一受支持版本。
-   此问题不会影响 Windows XP Service Pack 1、Windows XP Service Pack 2、Windows XP Professional x64 Edition、Windows Server 2003、Windows Server 2003 Service Pack 1、Windows Server 2003（用于基于 Itanium 的系统）、Windows Server 2003 Service Pack 1（用于基于 Itanium 的系统）或 Windows Server 2003 x64 Edition。 这些 Windows 版本包括 Internet Explorer 6 Service Pack 1 或更高版本。

#### WMF 图像分析内存损坏漏洞 (CVE-2006-0020) 的变通办法：

没有为此漏洞识别任何变通办法。

强烈建议使用带有 Internet Explorer 5.01 Service Pack 4 的 Windows 2000 Service pack 4 的客户应用该更新或安装 [Internet Explorer 6 Service Pack 1](https://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx)。

#### WMF 图像分析内存损坏漏洞 (CVE-2006-0020) 的常见问题解答：
...
**Windows 98、Windows 98 Second Edition 或 Windows Millennium Edition 是否会受到此安全公告中所描述的漏洞的严重影响？**  
否。 带有 Internet Explorer 6 Service Pack 1 的 Windows 98、Windows 98 Second Edition 或 Windows Millennium Edition 上不存在此漏洞。Internet Explorer 6 Service Pack 1 是这些 Windows 版本唯一支持的 Internet Explorer 版本。 有关严重等级的详细信息，请访问以下网站。 Microsoft 将在 2006 年 6 月 30 日之前在受影响且严重等级为“严重”的操作系统上提供安全更新。使用这些操作系统版本的客户应优先考虑迁移到受支持的版本，以防止可能会受到新出现漏洞的影响。 有关 Windows 产品生命周期的详细信息，请访问下面的 Microsoft 产品技术支持生命周期网站。

**哪一个 Internet Explorer 版本会受此漏洞的影响？**  
Windows 2000 上的 Internet Explorer 5.01 Service Pack 4 存在漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 CVE-2006-0020。
...
**注意** 使用 **/quiet** 开关将抑制所有消息。 这包括抑制失败消息。 管理员应该使用其中一种支持的方法，验证使用 **/quiet** 开关时安装是否成功。 管理员还应该检查 KB910620-IE501SP4-20060112.143924.log 文件，查看使用此开关时的任何失败消息。
...
系统管理员也可以使用 Spuninst.exe 实用工具删除此安全更新。 Spuninst.exe 实用工具位于 %Windir%\\$NTUninstallKB910620-IE501SP4-20060112.143924$\\Spuninst 文件夹中。
...
**注意** 此注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 910620 安全更新集成或组合到 Windows 安装源文件中，则可能无法正确创建此注册表项。

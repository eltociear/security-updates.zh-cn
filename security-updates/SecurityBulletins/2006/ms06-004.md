...
-   Microsoft Windows 2000 Service Pack 4 上的 Internet Explorer 5.01 Service Pack 4 - [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=c0df2fc3-2075-46b5-945f-6e0bd6806151)
...
|-------------------------------------------------------------------------------------------------------------|--------------|---------------------------------------|----------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|-------------------------------------------------------|
| WMF 图像分析内存损坏漏洞 - [CVE-2006-0020](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0020) | 远程执行代码 | 严重                                  | 无                                                                                     | 无                                                                                    | 无                                                    |
...
[Microsoft 知识库文章 910620](http://support.microsoft.com/kb/910620) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 [Microsoft 知识库文章 910620](http://support.microsoft.com/kb/910620)。

**我从 Microsoft 或我的支持提供商那里获得自 MS04-004 发布后发布的修补程序。此安全更新是否包括该修补程序？**  
是。 对于 Internet Explorer 5.01 Service Pack 4、Internet Explorer 5.5 Service Pack 2 和 Windows 2000 Service Pack 4，[MS06-004](http://technet.microsoft.com/security/bulletin/ms06-004) 安全更新包含 [MS04-004](http://go.microsoft.com/fwlink/?linkid=22189) 之后直到 [MS06-004](http://technet.microsoft.com/security/bulletin/ms06-004) 的修补程序，并包括累积更新。不管先前是否已安装 Internet Explorer 修补程序来更新本公告的“安全更新信息”部分列出的任何文件，都会安装此安全更新中包括的文件的修补程序版本。
...
否。 带有 [Internet Explorer 6 Service Pack 1](http://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx) 的 Windows 98、Windows 98 Second Edition 或 Windows Millennium Edition 上不存在此漏洞。Internet Explorer 6 Service Pack 1 是这些 Windows 版本唯一支持的 Internet Explorer 版本。 有关严重等级的详细信息，请访问以下[网站](http://go.microsoft.com/fwlink/?linkid=21140)。 Microsoft 将在 2006 年 6 月 30 日之前在受影响且严重等级为“严重”的操作系统上提供安全更新。使用这些操作系统版本的客户应优先考虑迁移到受支持的版本，以防止可能会受到新出现漏洞的影响。 有关 Windows 产品生命周期的详细信息，请访问以下 [Microsoft 产品技术支持生命周期网站](http://support.microsoft.com/gp/lifean1)。

**Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 情况如何？**  
Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 的生命周期已经结束。 使用此 Internet Explorer 版本的客户应优先考虑迁移到 [Internet Explorer 6 Service Pack 1](http://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx)，以防止可能会受到漏洞的影响。 有关 Windows 产品生命周期的详细信息，请访问以下 [Microsoft 产品技术支持生命周期网站](http://support.microsoft.com/gp/lifean1)。 有关 Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 的具体支持日期，请访问以下 [Microsoft 产品技术支持生命周期网](http://support.microsoft.com/gp/lifesupsps)。

**当您发布该通报时，您表明 Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 会受此漏洞的影响。 我该怎么办？**  
Windows Millennium Edition 上的 Internet Explorer 5.5 Service Pack 2 的生命周期已经结束，您应该迁移到 [Internet Explorer 6 Service Pack 1](http://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx)，以防止可能会受到漏洞（包括此漏洞）的影响。
...
是。 MBSA 1.2.1 将确定是否需要此更新。 MBSA 仅支持工作站类的操作系统（例如，Windows 2000 和更高版本）。 有关 MBSA 的详细信息，请访问 [MBSA 网站](http://go.microsoft.com/fwlink/?linkid=21134)。

**可否使用 Microsoft 基准安全分析器 (MBSA) 2.0 确定是否需要此更新？**  
是。 MBSA 2.0 将确定是否需要此更新。 MBSA 2.0 可以为 Microsoft Update 支持的产品检测安全更新。 MBSA 仅支持工作站类的操作系统（例如，Windows 2000 和更高版本）。 有关 MBSA 的详细信息，请访问 [MBSA 网站](http://go.microsoft.com/fwlink/?linkid=21134)。
...
-   安装了 [Internet Explorer 6 Service Pack 1](http://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx) 的客户不会受到此漏洞的影响，也不会受到使用电子邮件媒介尝试利用此漏洞的影响。
...
强烈建议使用带有 Internet Explorer 5.01 Service Pack 4 的 Windows 2000 Service pack 4 的客户应用该更新或安装 [Internet Explorer 6 Service Pack 1](http://www.microsoft.com/windows/ie/downloads/critical/ie6sp1/default.mspx)。

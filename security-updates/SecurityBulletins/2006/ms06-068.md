---
TOCTitle: 'MS06-068'
Title: 'Microsoft 安全公告 MS06-068 - 严重'
ms:assetid: 'ms06-068'
ms:contentKeyID: 61236839
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms06-068(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS06-068 - 严重
==================================

Microsoft Agent 中的漏洞可能允许远程执行代码 (920213)
-----------------------------------------------------

发布时间: 2006年11月14日 | 更新时间: 2007年10月10日
...
-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=c72ceec8-3e4d-4281-8183-11b724693217)
-   Microsoft Windows XP Service Pack 2 - [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=c16e1607-f396-4113-89f6-1fe89ec54b6a)
-   Microsoft Windows XP Professional x64 Edition — [下载此更](https://www.microsoft.com/download/details.aspx?familyid=b4002a2a-b03e-4428-a26a-84293270d149)新
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 - [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=8f1a3f85-830b-4662-a4cc-8dff9f59acea)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）- [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=b528f61d-ad54-4bad-b9a0-b650385de216)
-   Microsoft Windows Server 2003 x64 Edition - [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=3da7ff4a-2389-4ce4-a6bb-b7e02f646b74)
...
|-----------------------------------------------------------------------------------------------------------------|--------------|-----------------------------|---------------------------|---------------------|------------------------------------|
| Microsoft Agent 内存损坏漏洞 - [CVE-2006-3445](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3445) | 远程执行代码 | 严重                        | 严重                      | 中等                | 中等                               |
...
**此版本替代哪些更新？**  
没有收到 MS06-068 之前的更新的客户可能无法收到 MS05-032，因此应该立即应用 MS05-032。 但是，同时安装了 MS06-068 和 MS07-045 的客户将获得由 MS05-032 提供的安全更新，不需要单独安装 MS05-032。 仅安装了 MS06-068 或尚未安装 MS06-068 和 MS07-045 的客户应该安装 MS05-032。
...
-   “受限制的站点”区域可以通过防止在阅读 HTML 电子邮件时使用活动脚本和 ActiveX 控件来减少尝试利用此漏洞进行的攻击。 然而，在基于 Web 的攻击情形中，如果用户点击电子邮件中的链接，他们可能仍然容易受到此问题的影响。
    默认情况下，Outlook Express 6、Outlook 2002 和 Outlook 2003 在“受限制的站点”区域中打开 HTML 电子邮件。 此外，如果已经安装 [Outlook 电子邮件安全更新](https://go.microsoft.com/fwlink/?linkid=33334)，Outlook 2000 将在“受限制的站点”区域中打开 HTML 电子邮件。 如果安装了 Microsoft 安全公告 [MS04-018](https://go.microsoft.com/fwlink/?linkid=19527)，Outlook Express 5.5 Service Pack 2 将在“受限制的站点”区域打开 HTML 电子邮件。
-   默认情况下，Windows Server 2003 上的 Internet Explorer 在一种称为“[增强安全配置](https://msdn2.microsoft.com/en-us/library/ms537183.aspx)”的受限模式下运行。 此模式会将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此安全更新的“常见问题”部分。

#### Microsoft Agent 内存损坏漏洞 (CVE-2006-3445) 的变通办法：

-   **暂时禁止 Microsoft Agent ActiveX 控件在 Internet Explorer 中运行**
    ...
    **警告** 如果不正确地使用注册表编辑器，可能导致严重的问题，或许需要您重新安装操作系统。 Microsoft 不保证您可以解决因错误运用注册表编辑器而产生的问题。 使用注册表编辑器的风险由您自己承担。
    ...
    要为值为 {CLSID} 的 CLSID 设置 kill bit，请将以下文本粘贴于记事本等文本编辑器中。 然后，使用 .reg 文件扩展名保存文件。
    ...
    **变通办法的影响：** 使用 Microsoft Agent ActiveX 控件 的网站可能不再显示或正常工作。
...
#### Microsoft Agent 内存损坏漏洞 (CVE-2006-3445) 的常见问题：

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成漏洞的原因是什么？**  
当 Microsoft Agent 处理特制的 .ACF 文件时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
是。 运行采用默认设置的 Internet Explorer 7 的客户不受威胁，除非通过 Internet 区域中的 ActiveX 选择性加入功能激活了 MS Agent ActiveX 控件。
...
是。 默认情况下，Windows Server 2003 上的 Internet Explorer 在一种称为“[增强安全配置](https://msdn2.microsoft.com/en-us/library/ms537183.aspx)”的受限模式下运行。 此模式会将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此安全更新的“常见问题”部分。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Agent 在将消息传递到分配的缓冲区之前验证消息长度的方式来消除此漏洞。
...
**注意** 使用 **/quiet** 开关将抑制所有消息。 这包括抑制失败消息。 管理员应该使用其中一种支持的方法，验证使用 **/quiet** 开关时安装是否成功。 管理员还应该检查 KB920213.log 文件，查看使用此开关时的任何失败消息。
...
系统管理员也可以使用 Spuninst.exe 实用工具删除此安全更新。 Spuninst.exe 实用工具位于 %Windir%\\$NTUninstallKB920213$\\Spuninst 文件夹中。
...
-   V1.1（2007 年 5 月 8 日）： 常见问题解答已进行更改，显示公告 MS06-068 不能取代公告 MS05-032。详细信息，请参阅此公告的安全更新部分常见问题解答 (FAQ) 中的“此版本替代哪些更新”。 客户应该安装此公告 (MS06-068) 以及先前公告 (MS05-032) 提供的更新。
-   V1.2： 阐述只有当同时安装 MS06-068 和 MS07-045 时，才替换 MS05-032。 有关详细信息，请参阅“与此安全更新相关的常见问题 (FAQ)”部分中的“此版本替代哪些更新？”。

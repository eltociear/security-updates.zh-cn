...
-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=3ad5c57d-d3f6-46a1-8dee-3e16d0977f80)
-   Microsoft Windows XP Service Pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=f4c8e767-4ed2-4e36-aa43-612f3017efc7)
...
|-----------------------------------------------------------------------------------------------------------------|--------------|-----------------------------|---------------------------|
| Workstation 服务内存损坏漏洞 - [CVE-2006-4691](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4691) | 远程执行代码 | 严重                        | 低                        |
...
-   **在防火墙处阻止 TCP 端口 139 和 445：**
    ...
    这些端口用于启动与受影响组件的连接。 将 TCP 端口 139 和 445 阻止在防火墙处，有助于保护位于防火墙后面的系统尝试利用此漏洞。 我们建议阻止所有来自 Internet 的未经请求的入站通信，以帮助防止可能使用其他端口进行的攻击。 有关端口的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21312)。
...
-   **为帮助防止攻击者试图基于网络利用此漏洞，请使用个人防火墙，例如 Windows 防火墙，该防火墙包含在 Windows XP 中。**
    ...
    默认情况下，Windows XP 中的 [Windows 防火墙](https://go.microsoft.com/fwlink/?linkid=33335)功能可通过阻止未经请求传入的通信保护您的 Internet 连接。 我们建议您阻止所有来自 Internet 的非法传入通信。

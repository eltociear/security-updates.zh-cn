...
-   Microsoft Windows 2000 Service Pack 4 上的 Outlook Express 5.5 Service Pack 2 - [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=e61a3d64-14fd-4976-bb03-c31ca6ee61e2)
...
-   Stuart Pearson 与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 一起合作报告了使用 Windows 通讯簿文件时 Microsoft Outlook Express 中的漏洞 - [CVE-2006-0014](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1189)
-   [ATmaCA](https://www.microsoft.com/technet/security/bulletin/邮件地址：atmaca@icqmail.com) 报告了与使用 Windows 通讯簿文件时 Microsoft Outlook Express 中的漏洞 - [CVE-2006-0014](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1189) 类似的行为
...
-   V1.1（2006 年 4 月 15 日）： 已更新公告，论述此更新包含的 Microsoft Windows Server 2003、Microsoft Windows Server 2003 Service Pack 1 上的 Outlook Express 6 以及用于 Windows XP Service Pack 2 的 Outlook Express 6 的相关隐私更改，以忽略电子邮件标头中的“X-Unsent”字段。
-   V1.2（2006 年 4 月 26 日）： 已修订公告： 由于发现安全更新中存在的新问题而对“注意事项”部分进行了更新。 安装累积性安全更新之后打开 Windows 通讯簿或 Outlook Express 时出现错误消息。
-   V1.3（2007 年 1 月 10 日）： 已更新公告，在“安全更新信息”部分修改了 Windows Server 2003 的“文件信息”。

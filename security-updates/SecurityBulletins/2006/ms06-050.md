...
-   Microsoft Windows 2000 Service Pack 4 - [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=bfe3f869-08be-4f13-97a1-7274ad44c7fb)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=2d014bac-f03d-474a-a7ab-49e8ead8edb0)
-   Microsoft Windows XP Professional x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=cae094e4-64a0-4577-986b-4d6c131806d9)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=21d1e864-4517-4353-8477-b4cd3c6187c0)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）— [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=bc60b6c3-ada8-48ab-a63d-b2f1c9320b0d)
-   Microsoft Windows Server 2003 x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=9d2ba5d1-6f91-47b4-8cc1-dcd44baaa6ce)
...
|-------------------------------------------------------------------------------------------------------------|--------------|-----------------------------|--------------------------------------------------------|-----------------------------------------------------------|
| 超链接对象缓冲区溢出漏洞 - [CVE-2006-3086](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086) | 远程执行代码 | 重要                        | 重要                                                   | 重要                                                      |
| 超链接对象函数漏洞 - [CVE-2006-3438](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438)       | 远程执行代码 | 重要                        | 重要                                                   | 重要                                                      |
...
|-------------------------------------------------------------------------|--------------|--------------------------------------------------------|---------------------|------------------------------------|
| [**MS05-015**](https://technet.microsoft.com/security/bulletin/ms05-015) | 已替代       | 已替代                                                 | 已替代              | 不适用                             |
...
**什么是超链接对象库？**  
超链接对象库是应用程序编程接口的集合。 这些接口为软件开发者提供处理超链接的功能。 有关超链接的详细信息，请参阅[产品文档](https://msdn.microsoft.com/library/default.asp?url=/workshop/misc/hlink/overview/overview.asp)。
...
-   [TippingPoint Security Research Team](https://www.tippingpoint.com/security) 的 Pedram Amini 报告了超链接对象缓冲区溢出漏洞 - [CVE-2006-3086](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3086)。
-   [CSC Australia Pty Limited](https://au.country.csc.com/en/) 的 Steve Tai 报告了超链接对象函数漏洞 - [CVE-2006-3438](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3438)。
-   **获取其他安全更新：**

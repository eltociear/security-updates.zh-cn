---
TOCTitle: 'MS06-062'
Title: 'Microsoft 安全公告 MS06-062 - 严重'
ms:assetid: 'ms06-062'
ms:contentKeyID: 61236831
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms06-062(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS06-062 - 严重
==================================
...
-   Microsoft Office 2000 Service Pack 3 – [下载此更新 (KB923274)](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=e0c7e1e4-7859-4c7e-898e-1cf05014885b)
    ...
    -   Microsoft Word 2000
-   Microsoft Office XP Service Pack 3 – [下载此更新 (KB923273)](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=958ee063-d88d-4e45-8555-4d1c4730f5c8)
    ...
    -   Microsoft Word 2002
-   Microsoft Office 2003 Service Pack 1 或 Service Pack 2 - [下载此更新 (KB923272)](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=0d399f68-ec0d-4768-9846-b16b3dadf247)
...
-   Microsoft Project 2000 Service Release 1 - [下载此更新 (KB923274)](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=266a9870-cd03-45ca-877b-b5ad2c873fe5)
-   Microsoft Project 2002 Service Pack 1 – [下载此更新 (KB923273)](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=a77dea18-d237-4bb0-9464-ce31b6ae52d6)
-   Microsoft Visio 2002 Service Pack 2 – [下载此更新 (KB923273)](https://www.microsoft.com/download/details.aspx?familyid=fd4b7660-0fc5-43e5-9683-b6dae96136bb)
-   Microsoft Office 2004 for Mac - [下载此更新 (KB924999)](https://www.microsoft.com/mac/)
-   Microsoft Office v. X for Mac - [下载此更新 (KB924998)](https://www.microsoft.com/mac/)
...
| 漏洞标识符                                                                                                           | 漏洞的影响   | Microsoft Office 2000 | Microsoft Office XP | Microsoft Office 2003 | Microsoft Office 2004 for Mac 或 Microsoft Office v. X for Mac |
|----------------------------------------------------------------------------------------------------------------------|--------------|-----------------------|---------------------|-----------------------|----------------------------------------------------------------|
| Office 不正确的内存访问漏洞 - [CVE-2006-3434](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434)       | 远程执行代码 | 严重                  | 重要                | 重要                  | 重要                                                           |
| Office 格式错误的图表记录漏洞 - [CVE-2006-3650](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650)     | 远程执行代码 | 严重                  | 重要                | 重要                  | 重要                                                           |
| Office 格式错误的记录内存损坏漏洞 - [CVE-2006-3864](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864) | 远程执行代码 | 严重                  | 重要                | 重要                  | 重要                                                           |
| Microsoft Office 智能标记分析漏洞 - [CVE-2006-3868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3868) | 远程执行代码 | 无                    | 重要                | 重要                  | 无                                                             |
...
**管理安装点列出了 mso.msp 和 pvmso.msp。我是否需要安装这两个程序包？**  
...
此漏洞仅影响“受影响的软件”部分列出的产品。 但是，其他 Microsoft Office 应用程序使用的某些文件与“受影响的软件”中列出的安全更新影响的产品所使用的文件相同。 我们建议安装该更新，以免再次提供安全更新。
...
| 公告 ID                                                                 | Microsoft Office 2000 | Microsoft Office XP、Project 2002 Service Pack 1 或 Visio 2002 Service Pack 2 | Microsoft Office 2003 | Microsoft Office 2004 for Mac 或 Microsoft Office v. X for Mac |
|-------------------------------------------------------------------------|-----------------------|-------------------------------------------------------------------------------|-----------------------|----------------------------------------------------------------|
| [**MS06-048**](https://technet.microsoft.com/security/bulletin/ms06-048) | 已替代                | 已替代                                                                        | 已替代                | 已替代                                                         |
...
| Project 2000 Service Pack 2   | 是         | 是       |
| Project 2002 Service Pack 1   | 是         | 是       |
| Visio 2002 Service Pack 2     | 是         | 是       |
...
#### Office 不正确的内存访问漏洞 (CVE-2006-3434) 的变通办法：

-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Office 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Office 不正确的内存访问漏洞 (CVE-2006-3434) 的常见问题解答：
...
Office 在处理文件的内容时不执行足够的数据验证。 当 Office 打开特制文件并分析格式错误的字符串时，它可能破坏系统内存，从而使攻击者可以执行任意代码。
...
**我以为 Microsoft Works Suites 附带 Word，但是我看到 Microsoft Works Suites 列在不受影响的软件下面。 原因何在？**  

Microsoft Works Suites 并未与完全版本的 Word 捆绑，因此不受这些漏洞的影响。

**此更新有什么作用？**  

此更新通过修改 Office 在将字符串传递到分配的缓冲区之前验证字符串长度的方式来消除此漏洞。
...
#### Office 格式错误的图表记录漏洞 - CVE-2006-3650：

Office 中存在一个远程代码执行漏洞。 当 Office 分析带有格式错误的图表记录的文件时，攻击者可能利用此漏洞。

如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

#### Office 格式错误的图表记录漏洞 (CVE-2006-3650) 的缓解因素：
...
#### Office 格式错误的图表记录漏洞 (CVE-2006-3650) 的变通办法：

-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Office 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Office 格式错误的图表记录漏洞 (CVE-2006-3650) 的常见问题解答：
...
Office 在处理文件的内容时不执行足够的数据验证。 当 Office 打开特制文件并分析格式错误的图表记录时，它可能破坏系统内存，从而使攻击者可以执行任意代码。
...
#### Office 格式错误的记录内存损坏漏洞 - CVE-2006-3864：

Office 中存在一个远程代码执行漏洞。 当 Office 分析带有格式错误的记录的文件时，攻击者可能利用此漏洞。

如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

#### Office 格式错误的记录内存损坏漏洞 (CVE-2006-3864) 的缓解因素：
...
#### Office 格式错误的记录内存损坏漏洞 (CVE-2006-3864) 的变通办法：

-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Office 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Office 格式错误的记录内存损坏漏洞 (CVE-2006-3864) 的常见问题解答：
...
#### Microsoft Office 智能标记分析漏洞 - CVE-2006-3868：
...
#### Microsoft Office 智能标记分析漏洞 (CVE-2006-3868) 的缓解因素：

-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
-   在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的 Office 文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可以利用此漏洞的特制内容。攻击者无法强迫用户访问恶意网站。 相反，攻击者必须劝诱用户访问该网站，通常是让用户单击通向攻击者站点的链接。
-   此漏洞无法通过电子邮件自动加以利用。 用户必须打开电子邮件附件，以电子邮件为载体的攻击才会得逞。

#### Microsoft Office 智能标记分析漏洞 (CVE-2006-3868) 的变通办法：

-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Office 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Microsoft Office 智能标记分析漏洞 (CVE-2006-3868) 的常见问题解答：
...
当 Microsoft Office 打开特制 Office 文件和分析格式错误的智能标记时，它可能破坏系统内存，从而使攻击者可以执行任意代码。
...
此更新通过修改 Microsoft Office 在将消息传递到已分配缓冲区之前验证智能标记长度的方式来消除此漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  

是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 CVE-2006-3868。
...
1.  [下载 Office 2000](https://download.microsoft.com/download/5/a/a/5aa36269-5b5a-4597-b91d-a0e213f656e3/office2000-kb923274-fullfile-enu.exe) 和/或 [Project 2000 Service Pack 1](https://download.microsoft.com/download/0/0/f/00f68131-54bc-4e69-bfb7-fd66170cc33d/project2000-kb923274-fullfile-enu.exe) 的安全更新。
...
| 文件名   | 版本       | 日期              | 时间  | 大小      |
|----------|------------|-------------------|-------|-----------|
| Mso9.dll | 9.0.0.8950 | 2006 年 9 月 6 日 | 05:58 | 5,595,185 |
...
1.  [下载 Office XP](https://download.microsoft.com/download/4/8/4/4842fc39-5d06-4eeb-8293-ac84074106ac/officexp-kb923273-fullfile-enu.exe) 和/或 [Project 2002 Service Pack 1](https://download.microsoft.com/download/0/6/7/067865cf-7805-4933-bc3c-f9ed874e008e/officexp-kb923273-fullfile-enu.exe) 和/或 [Visio Service Pack 2](https://download.microsoft.com/download/e/3/0/e30ee874-8089-4bb9-bb44-a655e5e1017f/visio2002-kb923273-fullfile-enu.exe) 的安全更新。
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
| 文件名  | 版本        | 日期              | 时间  | 大小      |
|---------|-------------|-------------------|-------|-----------|
| Mso.dll | 10.0.6817.0 | 2006 年 9 月 1 日 | 23:02 | 9,816,840 |
...
1.  [下载 Office 2003 的安全更新。](https://download.microsoft.com/download/0/a/c/0ac9daa9-5d89-4613-a28e-de1e0c39c22d/office2003-kb923272-fullfile-enu.exe)
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
| Mso.dll   | 11.0.8107.0 | 2006 年 9 月 8 日  | 02:07 | 12,256,008 |
...
-   [Fortinet Inc.](https://www.fortinet.com/) 的 Dejun Meng 报告了 Office Office 不正确的内存访问漏洞 - [CVE-2006-3434](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434)
-   Arnaud Dovi 与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 一起报告了 Office 格式错误的图表记录漏洞 - [CVE-2006-3650](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650)
-   [Nevis Labs](https://www.nevisnetworks.com/) 的 Sowhat 报告了 Office 格式错误的记录内存损坏漏洞 - [CVE-2006-3864](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864)
...
-   V1.1（2006 年 10 月 11 日）： 已更新公告，在“与此安全更新相关的常见问题解答 (FAQ)”部分中增加有关“我正在更新管理安装点，发现存在两个 .msp。为什么？” 和“管理安装点列出了 mso.msp 和 pvmso.msp。我是否需要安装这两个程序包？”的附加阐述。

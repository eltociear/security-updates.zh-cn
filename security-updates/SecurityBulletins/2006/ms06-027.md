...
|--------------------------------------------------------------------------------------------------------------------------|--------------|---------------------|---------------------|-----------------------------------------|
| Microsoft Word 格式错误的对象指针漏洞 - [CVE-2006-2492](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492) | 远程执行代码 | 严重                | 重要                | 重要                                    |
...
|---------------------------------------------------------------------|---------------------|---------------------|------------------------------------|----------------------------|
| [MS06-012](http://technet.microsoft.com/security/bulletin/ms06-012) | 已取代              | 已取代              | 不适用                             | 不适用                     |
| [MS05-023](http://technet.microsoft.com/security/bulletin/ms05-023) | 不适用              | 不适用              | 已取代                             | 已取代                     |
...
MBSA 2.0 不支持检测 Office 2000。您应该使用 MBSA 1.2.1 来确定是否需要此更新。 MBSA 2.0 可以为 Microsoft Update 支持的产品检测安全更新。 有关 Microsoft Update 和 MBSA 2.0 当前不检测的程序的详细信息，请参阅 [Microsoft 知识库文章 895660](http://support.microsoft.com/kb/895660)。
...
-   **始终在安全模式下使用 Microsoft Word**
    ...
    **手动（用户交互）**
    ...
    有关启用或禁用 Word 作为电子邮件编辑器的详细信息，请参阅[启用或禁用 Word 作为电子邮件编辑器。](http://office.microsoft.com/en-us/assistance/hp052428491033.aspx)
    ...
    **使用组策略**
    ...
    有关将注册表项和组策略配合使用的信息，请参阅 [Using Administrative Template Files with Registry-Based Group Policy](http://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/management/gp/admtgp.mspx) 和 [Distributing Registry Changes](http://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnw2kmag01/html/distributingregistrychanges.asp)。
    ...
    **变通办法的影响：** 在安全模式下工作的用户将受到[关于 Office 安全模式](http://office.microsoft.com/en-us/assistance/hp030823931033.aspx)概述的限制。
...
-   必须安装 Office 2000 Service Pack 3 (SP3)。 在安装此更新之前，请安装 [Office 2000 SP3](https://www.microsoft.com/download/details.aspx?familyid=5c011c70-47d0-4306-9fa4-8e92d36332fe&displaylang=en)。有关如何安装 Office 2000 SP3 的更多信息，请参阅 [Microsoft 知识库文章 326585](http://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;326585)。
...
1.  [下载此安全更新。](http://download.microsoft.com/download/3/5/3/353ea965-4ce1-440a-947e-b3272578543c/office2000-kb917345-fullfile-enu.exe)
...
1.  [下载此安全更新。](http://download.microsoft.com/download/3/2/1/32142319-d15c-4370-af74-bafd1422f94e/officexp-kb917335-fullfile-enu.exe)
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
1.  [下载 Word 2003 的安全更新](http://download.microsoft.com/download/5/0/1/5018537a-628b-40d8-9d54-3fdbae8705a9/office2003-kb917334-fullfile-enu.exe)和/或[下载 Word 2003 Viewer 的安全更新。](http://download.microsoft.com/download/2/e/1/2e1188b9-3819-4bcf-9991-41013b6c7e24/office2003-kb917346-fullfile-enu.exe)
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
-   [Information & Communication Security Technology Center](http://www.icst.org.tw/) 的 Shih-hao Weng 报告了 Microsoft Word 格式错误地对象指针漏洞 - [CVE-2006-2492](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492)。
-   [AV-Test.org](http://av-test.com/) 的 Andreas Marx 与 Microsoft 一起努力处理了 Microsoft Word 格式错误的对象指针漏洞 - [CVE-2006-2492](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492)。

---
TOCTitle: 'MS06-027'
Title: 'Microsoft 安全公告 MS06-027 - 严重'
ms:assetid: 'ms06-027'
ms:contentKeyID: 61236790
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms06-027(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS06-027 - 严重
==================================

Microsoft Word 中的漏洞可能允许远程执行代码 (917336)
----------------------------------------------------

发布时间: 2006年6月13日 | 更新时间: 2006年7月12日
...
-   Microsoft Office 2000 Service Pack 3
    -   Microsoft Word 2000 - [下载此更新 (KB917345)](https://www.microsoft.com/download/details.aspx?familyid=507d97b5-8b20-41b2-ae8b-27f2bf5198cd)
-   Microsoft Office XP Service Pack 3
    -   Microsoft Word 2002 - [下载此更新 (KB917335)](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
-   Microsoft Office 2003 Service Pack 1 或 Service Pack 2
    -   Microsoft Word 2003 - [下载此更新 (KB917334)](https://www.microsoft.com/download/details.aspx?familyid=adea09b4-481a-4908-8b77-0630ac679cac)
    -   Microsoft Word Viewer 2003 - [下载此更新 (KB917346)](https://www.microsoft.com/download/details.aspx?familyid=6089b843-61ff-469f-a38b-bd4ffeff0552)
-   Microsoft Works Suites：
    -   Microsoft Works Suite 2000 - [下载此更新 (KB917345)（与 Microsoft Word 2000 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=507d97b5-8b20-41b2-ae8b-27f2bf5198cd)
    -   Microsoft Works Suite 2001 - [下载此更新 (KB917345)（与 Microsoft Word 2000 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=507d97b5-8b20-41b2-ae8b-27f2bf5198cd)
    -   Microsoft Works Suite 2002 - [下载此更新 (KB917335)（与 Microsoft Word 2002 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
    -   Microsoft Works Suite 2003 - [下载此更新 (KB917335)（与 Microsoft Word 2002 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
    -   Microsoft Works Suite 2004 - [下载此更新 (KB917335)（与 Microsoft Word 2002 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
    -   Microsoft Works Suite 2005 - [下载此更新 (KB917335)（与 Microsoft Word 2002 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
    -   Microsoft Works Suite 2006 - [下载此更新 (KB917335)（与 Microsoft Word 2002 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=4cde644b-be05-4680-b0ef-df563095563c)
...
此更新可解决一个新发现的公开漏洞。 本公告的“漏洞详细资料”部分对本公告中的漏洞进行了说明。
...
| 漏洞标识符                                                                                                               | 漏洞的影响   | Microsoft Word 2000 | Microsoft Word 2002 | Microsoft Word 2003 和 Word Viewer 2003 |
|--------------------------------------------------------------------------------------------------------------------------|--------------|---------------------|---------------------|-----------------------------------------|
| Microsoft Word 格式错误的对象指针漏洞 - [CVE-2006-2492](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492) | 远程执行代码 | 严重                | 重要                | 重要                                    |

**注意** Microsoft Works Suite 与 Microsoft Word 版本的严重等级按以下方式对应：

-   Microsoft Works Suite 2000 和 2001 的严重等级与 Microsoft Word 2000 的严重等级相同。
-   Microsoft Works Suite 2002、2003、2004、2005 和 2006 的严重等级与 Microsoft Word 2002 的严重等级相同。
...
| 公告 ID                                                             | Microsoft Word 2000 | Microsoft Word 2002 | Microsoft Word 2003 Service Pack 1 | Microsoft Word Viewer 2003 |
|---------------------------------------------------------------------|---------------------|---------------------|------------------------------------|----------------------------|
| [MS06-012](https://technet.microsoft.com/security/bulletin/ms06-012) | 已取代              | 已取代              | 不适用                             | 不适用                     |
| [MS05-023](https://technet.microsoft.com/security/bulletin/ms05-023) | 不适用              | 不适用              | 已取代                             | 已取代                     |

**注意** Microsoft Works 的所有受支持版本由 MS06-012 替代。
...
MBSA 使用 Office 检测工具 (ODT) 的综合版，它不支持对此问题进行远程扫描。

MBSA 2.0 不支持检测 Office 2000。您应该使用 MBSA 1.2.1 来确定是否需要此更新。 MBSA 2.0 可以为 Microsoft Update 支持的产品检测安全更新。 有关 Microsoft Update 和 MBSA 2.0 当前不检测的程序的详细信息，请参阅 [Microsoft 知识库文章 895660](https://support.microsoft.com/kb/895660)。
...
#### Microsoft Word 格式错误的对象指针漏洞 (CVE-2006-2492) 的缓解因素：
...
**注意** 使用 Word 2000 访问网站时，此漏洞不会被自动利用，但是在用户打开文档之前，Office 2000 不会提示用户**打开**、**保存**或**取消**。

#### 使用格式错误的对象指针的 Microsoft Word 远程执行代码漏洞 (CVE-2006-2492) 的变通办法：
...
-   **始终在安全模式下使用 Microsoft Word**
    ...
    **手动（用户交互）**
    ...
    1.  重新启动计算机。
    2.  打开 Outlook。
    3.  依次单击“**工具**”、“**选项**”，然后单击“**邮件格式**”选项卡。
    4.  清除“使用 Microsoft Word 编辑电子邮件”复选框**。**
    5.  清除“使用 Microsoft Word 阅读 RTF 电子邮件”复选框。
    6.  退出 Outlook。
    7.  重新启动计算机。

    有关启用或禁用 Word 作为电子邮件编辑器的详细信息，请参阅[启用或禁用 Word 作为电子邮件编辑器。](https://office.microsoft.com/en-us/assistance/hp052428491033.aspx)
    ...
    **使用组策略**
    ...
    有关将注册表项和组策略配合使用的信息，请参阅 [Using Administrative Template Files with Registry-Based Group Policy](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/management/gp/admtgp.mspx) 和 [Distributing Registry Changes](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnw2kmag01/html/distributingregistrychanges.asp)。
    ...
    **变通办法的影响：** 用户不能将 Word 用作其电子邮件编辑器或默认使用 RTF 阅读电子邮件。
    ...
    **对于企业用户**
    ...
    所有 Word 版本均具有允许在安全模式下运行 Word 的应用程序恢复功能。 安全模式会禁用该功能，并防止利用攻击性代码。 可以在下列位置找到完整的限制集： [https://office.microsoft.com/en-us/assistance/HP030823931033.aspx](https://office.microsoft.com/en-us/assistance/hp030823931033.aspx)。

    1.  如果 Word 在安全模式下运行，其标题栏将显示“**安全模式**”。
    2.  用鼠标右键单击桌面。
    3.  选择“**新建/快捷方式**”。
    4.  选择“**浏览**”。
    5.  找到 **winword.exe**。
    ...
    **变通办法的影响：** 在安全模式下工作的用户将受到[关于 Office 安全模式](https://office.microsoft.com/en-us/assistance/hp030823931033.aspx)概述的限制。

    **使用组策略的企业用户**

    域管理员可以使用组策略来启用安全模式。 不必重新启动计算机即可实施此缓解措施。

    **注意** 即使在应用实施注册表更改的变通办法之后，也不要通过双击直接打开来自非 Outlook 电子邮件客户端（例如 MSN Hotmail）的 Word 文件。
    ...
    **变通办法的影响：** 在安全模式下工作的用户将受到此联机帮助页面概述的限制： [https://office.microsoft.com/en-us/assistance/HP030823931033.aspx](https://office.microsoft.com/en-us/assistance/hp030823931033.aspx)

#### Microsoft Word 格式错误的对象指针漏洞 (CVE-2006-2492) 的常见问题解答：
...
**造成漏洞的原因是什么？**  
当用户使用格式错误的对象指针打开特制的 Word 文档时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
在电子邮件攻击情形中，攻击者可以通过作为附件向用户发送特制的文件并诱使用户打开该附件来利用此漏洞。

**受此漏洞威胁最大的系统有哪些？**  
工作站和终端服务器受到的威胁最大。 当没有足够管理权限的用户被授予登录到服务器并运行程序的权限时，服务器会更有危险。 不过，最佳做法是不要授予这样的权限。

**使用 Word 2000 访问网站时，是否可以自动利用该漏洞？**  
使用 Word 2000 访问网站时，此漏洞不会被自动利用，但是在用户打开文档之前，Office 2000 不会提示用户打开、保存或取消。

**此更新有什么作用？**  
此更新通过修改 Word 在将消息传递到已分配缓冲区之前验证消息长度的方式来消除此漏洞。
...
-   必须安装 Office 2000 Service Pack 3 (SP3)。 在安装此更新之前，请安装 [Office 2000 SP3](https://www.microsoft.com/download/details.aspx?familyid=5c011c70-47d0-4306-9fa4-8e92d36332fe&displaylang=en)。有关如何安装 Office 2000 SP3 的更多信息，请参阅 [Microsoft 知识库文章 326585](https://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;326585)。
...
1.  [下载此安全更新。](https://download.microsoft.com/download/3/5/3/353ea965-4ce1-440a-947e-b3272578543c/office2000-kb917345-fullfile-enu.exe)
...
-   必须安装 Office XP Service Pack 3 (SP3)。 安装此更新之前，请安装 [Office XP SP3](https://www.microsoft.com/download/details.aspx?familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e)。另外，如果您正在安装 Office XP Multilingual User Interface Packs，则必须安装 [Multilingual User Interface Packs Service Pack 3 (SP3)](https://www.microsoft.com/download/details.aspx?familyid=3c0a106c-fff1-4768-b3ab-483e46e73f7b)。 有关如何安装 Office XP SP3 的详细信息，请参阅 Microsoft 知识库文章 [832671](https://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;832671)。
...
1.  [下载此安全更新。](https://download.microsoft.com/download/3/2/1/32142319-d15c-4370-af74-bafd1422f94e/officexp-kb917335-fullfile-enu.exe)
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
-   要更新 Word 2003，必须安装 Word 2003 Service Pack 1 或 Word 2003 Service Pack 2。 安装此更新之前，请安装 [Office 2003 SP1](https://www.microsoft.com/download/details.aspx?familyid=9c51d3a6-7cb1-4f61-837e-5f938254fc47) 或 [Office 2003 SP2](https://www.microsoft.com/download/details.aspx?familyid=57e27a97-2db6-4654-9db6-ec7d5b4dd867&displaylang=en)。
-   要更新 Word Viewer 2003，必须安装 Word 2003 Viewer 的最新版本。 [下载最新的 Word 2003 Viewer。](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf)
...
1.  [下载 Word 2003 的安全更新](https://download.microsoft.com/download/5/0/1/5018537a-628b-40d8-9d54-3fdbae8705a9/office2003-kb917334-fullfile-enu.exe)和/或[下载 Word 2003 Viewer 的安全更新。](https://download.microsoft.com/download/2/e/1/2e1188b9-3819-4bcf-9991-41013b6c7e24/office2003-kb917346-fullfile-enu.exe)
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
-   [Information & Communication Security Technology Center](https://www.icst.org.tw/) 的 Shih-hao Weng 报告了 Microsoft Word 格式错误地对象指针漏洞 - [CVE-2006-2492](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492)。
-   [AV-Test.org](https://av-test.com/) 的 Andreas Marx 与 Microsoft 一起努力处理了 Microsoft Word 格式错误的对象指针漏洞 - [CVE-2006-2492](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2492)。
...
-   V1.1（2006 年 6 月 14 日）： 已修订公告： 已修订公告： 更新了 CVE-2006-2492 的“鸣谢”部分。
-   V1.2（2006 年 6 月 21 日）： 已修订公告： 针对 Word 2003 更新了“此版本取代哪些更新？”部分关于 MS06-012 的描述。
-   V1.3（2006 年 7 月 12 日）： 针对 Word 2003 更新了公告“此版本取代哪些更新？”部分关于 MS05-023 的描述。

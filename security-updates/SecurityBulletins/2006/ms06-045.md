...
-   Microsoft Windows 2000 Service Pack 4 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=38cee83e-b17a-4c08-90ce-fb836b9615ad)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=6ef68858-4c91-47fb-ae34-0be556f10ede)
-   Microsoft Windows XP Professional x64 Edition – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=50935f4e-e383-493e-97c6-599cbb2b87cc)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=759435a3-98f9-4115-b52e-d7fa9d024f16)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统） – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=462131c6-a728-4b3c-94de-85deccc42c3e)
-   Microsoft Windows Server 2003 x64 Edition – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=50eef5c5-861d-4802-85a2-6b0627aafc2a)
...
|-------------------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| 文件夹 GUID 代码执行漏洞 - [CVE-2006-3281](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3281) | 远程执行代码 | 重要         | 重要                      | 重要                      | 重要                | 重要                               |
...
-   **在所有不需要此功能的受影响系统上，使用组策略设置禁用 WebClient 服务。**
    ...
    **注意** 您也可以参阅 [Windows Server 2003 安全指南](https://www.microsoft.com/technet/security/prodtech/windowsserver2003/w2003hg/sgch00.mspx)。 此指南包含有关如何禁用服务的信息。
    ...
    -   [Windows Server 2003 中的组策略](https://www.microsoft.com/windowsserver2003/techinfo/overview/gpintro.mspx)
...
-   **在防火墙处阻止 TCP 端口 139 和 445：**
    ...
    尽管 WebDAV 使用 TCP 端口 80 进行出站通信，但是出站可以使用 TCP 端口 139 和 445 尝试连接到恶意服务并尝试利用此漏洞。 将其阻止在防火墙处，可以帮助保护位于防火墙后面的系统免受利用此漏洞进行的攻击。 我们建议阻止所有来自 Internet 的未经请求的入站通信，以帮助防止可能使用其他端口进行的攻击。 有关端口的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21312)。

...
-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=b207020d-90f7-4c41-8304-06af0ded6467)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=2592a44c-82fb-4ccd-82a6-fcac7ca33172)
-   Microsoft Windows XP Professional x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=b0f67167-7ede-4355-af6f-50c6615f6bbd)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=48f03ad7-38f9-48f4-bbfc-14c52e9c942a)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）— [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=41a4a07f-bea3-48d6-b8d2-d7a5600d7179)
-   Microsoft Windows Server 2003 x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=dfbf3fa6-9e11-48b4-894d-5436693d17f7)
...
|-----------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| 邮件槽堆溢出漏洞 - [CVE-2006-1314](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1314) | 远程执行代码 | 严重         | 严重                      | 严重                      | 严重                | 严重                               |
| SMB 信息泄露漏洞 - [CVE-2006-1315](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1315) | 信息泄露     | 低           | 低                        | 低                        | 低                  | 低                                 |
...
-   **在防火墙处阻止 TCP 端口 445：**
    ...
    此端口用于启动与受影响组件的连接。 将 TCP 端口 445 阻止在防火墙处，有助于保护位于防火墙后面的系统尝试利用此漏洞。 我们建议阻止所有来自 Internet 的未经请求的入站通信，以帮助防止可能使用其他端口进行的攻击。 有关端口的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21312)。
...
**什么是邮件槽？**  
邮件槽是应用程序和进程用于促进单向数据传输的临时机制。 有关邮件槽的详细信息，请访问以下[网站](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/ipc/base/writing_to_a_mailslot.asp)。
...
-   在 Windows 2000、Windows XP 和 Windows Server 2003 上，攻击者必须拥有有效的登录凭据才能利用此漏洞。 匿名用户无法利用此漏洞。 但是，具有标准用户帐户的用户可远程使用受影响组件。 在某些配置中，匿名用户可能作为 Guest 帐户进行身份验证。 有关详细信息，请参阅 [Microsoft 安全通报 906574](https://technet.microsoft.com/security/advisory/906574)。
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。
...
应用此安全更新之后，必须重新启动系统。
在包含 5.2.3790.2437 版本的 Srv.sys 文件的系统上，此安全更新支持 HotPatching。如果使用 HotPatching，您可以在运行 Microsoft Windows Server 2003 Service Pack 1 的系统上安装安全更新，而不必重新启动服务器。 有关 HotPatching 以及如何使用 HotPatching 部署安全更新的详细信息，请参阅 [Microsoft 知识库文章 897341](https://support.microsoft.com/kb/897341)。
...
-   [TippingPoint Security Research Team](https://www.tippingpoint.com/security) 的 Pedram Amini 与 H D Moore 合作报告了邮件槽堆溢出漏洞 (CVE-2006-1314)。
-   [Tenable Network Security](https://www.tenablesecurity.com/) 的 Nicolas Pouvesle 报告了 SMB 信息泄露漏洞 (CVE-2006-1315) 中描述的问题。
-   [McAfee Avert Labs](https://www.mcafee.com/us/threat_center/default.asp) 的 Mike Price 和 Rafal Wojtczuk 报告了 SMB 信息泄露漏洞 (CVE-2006-1315)。

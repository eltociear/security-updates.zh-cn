...
**注意事项：** [Microsoft 知识库文章 911565](https://support.microsoft.com/kb/911565)介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 [Microsoft 知识库文章 911565](https://support.microsoft.com/kb/911565)。

**测试过的软件和安全更新下载位置：**

**受影响的软件：**

-   Microsoft Windows XP Service Pack 1 上用于 XP 的 Windows Media Player – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=110054f2-244d-4036-b98c-e951cba7e9ba)
-   Microsoft Windows XP Service Pack 2 上的 Windows Media Player 9 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b)
-   Microsoft Windows Server 2003 上的 Windows Media Player 9 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b)
...
-   安装在 Windows 2000 Service Pack 4 上的 Microsoft Windows Media Player 7.1 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=26a0b9e1-1242-4e55-b3d4-8377b83257c6)
-   安装在 Windows 2000 Service Pack 4 或 Windows XP Service Pack 1 上的 Microsoft Windows Media Player 9 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b)
-   安装在 Windows XP Service Pack 1 或 Windows XP Service Pack 2 上的 Microsoft Windows Media Player 10 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=182735e1-9382-4f2e-a624-d2316a96b411)
-   **不受影响的软件：**
...
|--------------------------------------------------------------------------------------------------------------|--------------|----------------------------------------------------------------------------|-----------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| Windows Media Player 漏洞 - [CVE-2006-0006](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0006) | 远程执行代码 | 重要                                                                       | 重要                                                                              | 严重                                                                                                                   | 严重                                                                                   | 严重                                                                                                 |
...
[Microsoft 知识库文章 911565](https://support.microsoft.com/kb/911565)介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 [Microsoft 知识库文章 911565](https://support.microsoft.com/kb/911565)

-   [Microsoft 知识库文章 912226](https://support.microsoft.com/kb/912226)：应用某些更新后，当尝试在 Windows Media Player 10 中快速倒带或快进时，您可能会遇到一些问题。(912226)
...
|------------------------------------------------------------------------------------------------------------------------------|-----------------------|-----------------------------|---------------------------------------------|---------------------|
| [**MS05-009**](https://go.microsoft.com/fwlink/?linkid=38239) 的知识库文章[885492](https://support.microsoft.com/?kbid=885492) | 已取代                | 已取代                      | 已取代                                      | 已取代              |
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------------|-----------|-------------|
| [Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=26a0b9e1-1242-4e55-b3d4-8377b83257c6)Windows Media Player 7.1      | Wmpui.dll | 7.10.0.3077 |
| [Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b)Windows Media Player 9        | wmp.dll   | 9.0.0.3344  |
| [Windows XP Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=110054f2-244d-4036-b98c-e951cba7e9ba)用于 XP 的 Windows Media Player | Wmpui.dll | 8.0.0.4495  |
| [Windows XP Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b)Windows Media Player 9          | wmp.dll   | 9.0.0.3344  |
| [Windows XP Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=182735e1-9382-4f2e-a624-d2316a96b411)Windows Media Player 10         | wmp.dll   | 10.0.0.4019 |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b)Windows Media Player 9          | wmp.dll   | 9.0.0.3344  |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=182735e1-9382-4f2e-a624-d2316a96b411)Windows Media Player 10         | wmp.dll   | 10.0.0.4019 |
| [Windows Server 2003](https://www.microsoft.com/download/details.aspx?familyid=8f9eef16-04f7-4da8-a0ef-1797b52d0b4b)Windows Media Player 9                | wmp.dll   | 9.0.0.3344  |

**延长对 Windows 98、Windows 98 Second Edition 和 Windows Millennium Edition 的支持对这些操作系统的安全更新发布有何影响？**  
Microsoft 将只针对严重的安全问题发布安全更新。 在此支持期内，不会为不严重的安全问题提供更新。 有关针对这些操作系统的 Microsoft 技术支持生命周期策略的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=33327)。

有关严重等级的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21140)。

目前已经发布此平台的关键安全更新，而且本安全公告中也已提供，您还可以从 [Windows Update 网站](https://go.microsoft.com/fwlink/?linkid=21130)下载。 有关严重等级的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21140)。
...
是。 MBSA 1.2.1 可以确定 Windows Media Player 7.1、Windows Media Player 8 和 Windows Media Player 9 是否需要此更新。有关 MBSA 的详细信息，请访问 [MBSA 网站](https://go.microsoft.com/fwlink/?linkid=21134)。

MBSA 1.2.1 不支持检测 Windows Media Player 10。有关 MBSA 的详细信息，请访问 [MBSA 网站](https://go.microsoft.com/fwlink/?linkid=21134)。 有关 MBSA 1.2.1 当前不能检测的程序的详细信息，请参阅 [Microsoft 知识库文章 306460](https://support.microsoft.com/?kbid=306460)。但是，Microsoft 已开发出企业更新扫描工具 (EST) 的一个版本，帮助客户确定是否需要此安全公告中提供的安全更新。 有关详细信息，请参阅以下常见问题解答“是否可以使用企业更新扫描工具 (EST) 的某个版本来确定是否需要此更新？”。
...
是。 Microsoft 已开发出 EST 的一个版本，帮助您确定是否必须应用此更新。 有关本月发行的 EST 版本的下载链接和详细信息，请参阅下面的 [Microsoft 网站](https://support.microsoft.com/kb/894193)。 有关 SMS 和 EST 的详细信息，SMS 客户应该查看“可否使用 Systems Management Server (SMS) 确定是否需要此更新？” 常见问题解答。
...
SMS 可以使用适用于 Microsoft 更新的 SMS 2003 清单工具检测由 [Microsoft Update](https://update.microsoft.com/microsoftupdate) 提供和 [Windows Server 更新服务](https://go.microsoft.com/fwlink/?linkid=50120)支持的安全更新。 有关适用于 Microsoft 更新的 SMS 2003 清单工具的详细信息，请参阅以下 [Microsoft 网站](https://go.microsoft.com/fwlink/?linkid=50757)。
...
是。 此漏洞对 Windows、Windows 98 Second Edition 和 Windows Millennium Edition 上的 Windows Media Player 9 有严重影响。 这些平台的关键安全更新与此安全公告中提供的其他安全更新可能不同时提供。 在此次发布后，将尽早提供这些安全更新。 在这些安全更新发布时，您只能从 [Windows Update 网站](https://go.microsoft.com/fwlink/?linkid=21130)下载它们。 有关严重等级的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21140)。
...
-   Fang Xing 与 [eEye](https://eeye.com) 一起报告了 Windows Media Player 漏洞 - CVE-2006-0006

...
**注意** 不在受影响软件列表中的 Microsoft Windows 版本不附带 Flash Player。 鼓励将 Flash Player 安装在这些 Windows 版本上的客户按照 [Adobe 安全公告 ASPB06-11](https://www.adobe.com/go/apsb06-11/) 中的指导进行操作。

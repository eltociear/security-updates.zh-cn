...
**注意事项：** [Microsoft 知识库文章 921883](https://support.microsoft.com/kb/921883) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 [Microsoft 知识库文章 921883](https://support.microsoft.com/kb/921883)。
...
|------------------------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Server 服务中的缓冲区溢出漏洞 - [CVE-2006-3439](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3439) | 远程执行代码 | 严重         | 严重                      | 严重                      | 严重                | 严重                               |
...
-   **在防火墙处阻止 TCP 端口 139 和 445：**
    ...
    此端口用于启动与受影响组件的连接。 将 TCP 端口 139 和 445 阻止在防火墙处，有助于保护位于防火墙后面的系统尝试利用此漏洞。 我们建议阻止所有来自 Internet 的未经请求的入站通信，以帮助防止可能使用其他端口进行的攻击。 有关端口的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21312)。
...
-   [US-CERT](https://www.us-cert.gov/) 与我们一起处理了 Server 服务中的缓冲区溢出漏洞 (CVE-2006-3439)。
-   [SANS](https://www.sans.org/) 与我们一起处理了 Server 服务中的缓冲区溢出漏洞 (CVE-2006-3439)。
...
-   V2.0（2006 年 9 月 12 日）： 已针对 Microsoft Windows 2003 和 Microsoft Windows XP Professional x64 Edition 修订并重新发布了更新，以解决 [Microsoft 知识库文章 921883](https://support.microsoft.com/kb/921883) 中识别的问题。

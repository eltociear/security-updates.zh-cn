...
-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=144408a7-3011-458a-bc79-49b1658aa25d)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=c332b95a-2956-406b-9e06-07c5e96b02e3)
-   Microsoft Windows XP Professional x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=1be5310b-1995-4ef9-a462-04da9833f50b)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=6d027e72-1f94-44de-95f9-f52000a991cc)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）— [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=18477016-0b70-4c86-90c7-3535d365b7c1)
-   Microsoft Windows Server 2003 x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=583b741c-47e2-429d-9d50-44670bb2f452)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Winsock 主机名漏洞 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3440">CVE-2006-3440</a></td>
...
<tr class="even">
<td style="border:1px solid black;">DNS 客户端缓冲区溢出漏洞 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3441">CVE-2006-3441</a></td>
...
**什么是 Winsock？**    
Windows Sockets 2 (Winsock) 使程序员可以创建高级的 Internet、Intranet 以及其他支持网络的应用程序，从而独立于所使用的网络协议跨电缆传输应用程序数据。 通过 Winsock，系统向程序员提供了对高级 Microsoft® Windows® 网络功能（例如多播和服务质量 (QOS)）的访问。 有关 Winsock 的详细信息，请参阅下列 [MSDN 文章](https://windowssdk.msdn.microsoft.com/en-us/library/ms740673.aspx)。
...
**什么是 DNS？**    
域名系统 (DNS) 客户端服务可解析和缓存 DNS 名称。 DNS Client 服务必须在将执行 DNS 名称解析的每台计算机上运行。 解析 DNS 名称这一能力对于在 Active Directory 域中查找域控制器至关重要。 DNS Client 服务对于使用 DNS 名称解析查找识别的服务也至关重要。 有关 DNS Client 服务的详细信息，请参阅下列 [Microsoft TechNet 文件](https://technet2.microsoft.com/windowsserver/en/library/6715556b-dfe4-41c4-87a9-333d22e473b21033.mspx?mfr=true)。
...
攻击者可能试图通过 Internet 来利用此漏洞。 采用防火墙最佳做法和标准默认防火墙配置，有助于保证免受来自 Internet 的攻击。 Microsoft 提供了关于如何帮助保护您的 PC 的信息。 最终用户可以访问[保护您的 PC 网站](https://go.microsoft.com/fwlink/?linkid=21169)。 IT 专业人士可以访问[安全指南中心网站](https://go.microsoft.com/fwlink/?linkid=21171)。
...
-   [NGS Software](https://www.ngssoftware.com/) 的 Peter Winter Smith 报告了 Winsock 主机名漏洞 (CVE-2006-3440)。
-   Mark Dowd 在 [ISS X-Force](https://www.iss.net/) 从事研究期间报告了 DNS 客户端缓冲区溢出漏洞 (CVE-2006-3441)。

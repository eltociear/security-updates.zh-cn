...
-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=6ec86784-6b12-410b-8068-028c58ed5df7)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=c17ddc07-204b-4a7f-8c5a-36b7865a030c)
-   Microsoft Windows XP Professional x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=89fbbdd0-7504-4807-9337-08324aa457e7)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=43d69a41-6acb-4c64-89dc-2b9aef6e98fd)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）— [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=e1d13c18-72d1-40b8-95b3-08aef8db9213)
-   Microsoft Windows Server 2003 x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=b6018a61-b0ec-467e-9025-059d3c9f1c5f)
...
|-------------------------------------------------------------------------------------------------------------|------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| SMB 驱动程序特权提升漏洞 - [CVE-2006-2373](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2373) | 特权提升   | 重要         | 重要                      | 重要                      | 重要                | 重要                               |
| SMB 无效的句柄漏洞 - [CVE-2006-2374](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2374)       | 拒绝服务   | 中等         | 中等                      | 中等                      | 中等                | 中等                               |
...
**此漏洞的影响范围有多大？**  
这是一个[拒绝服务](https://go.microsoft.com/fwlink/?linkid=21142)漏洞。 利用此漏洞的攻击者可能会导致受影响系统停止响应。 在此期间，受影响的系统无法响应请求。 请注意，虽然攻击者无法利用拒绝服务漏洞来执行代码或提升他们的用户权限，但此漏洞可能导致受影响的系统停止响应。
...
应用此安全更新之后，必须重新启动系统。
在包含 5.2.3790.1830 版本的 Smb.sys 和 Rdbss.sys 文件的系统上，此安全更新支持 HotPatching。如果使用 HotPatching，您可以在运行 Microsoft Windows Server 2003 Service Pack 1 的系统上安装安全更新，而不必重新启动服务器。 有关 HotPatching 以及如何使用 HotPatching 部署安全更新的详细信息，请参阅 [Microsoft 知识库文章 897341](https://support.microsoft.com/kb/897341)。
...
-   [Rubén Santamarta](https://www.reversemode.com/) 与 iDefense [iDEFENSE](https://www.idefense.com/) 一起报告了 SMB 特权提升漏洞 - CVE-2006-2373
-   [Rubén Santamarta](https://www.reversemode.com/) 与 iDefense[iDEFENSE](https://www.idefense.com/) 一起报告了 SMB 无效的句柄漏洞 - CVE-2006-2374

...
-   安装在 Windows（所有版本）上的 Microsoft XML Core Services 4.0 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=24b7d141-6cdf-4fc4-a91b-6f18fe6921d4) (KB927978)
-   安装在 Windows（所有版本）上的 Microsoft XML Core Services 6.0 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=9ae7f4e9-8228-4098-af71-49c35684c17e) (KB927977)
...
|---------------------------------------------------------------------------------------------------------------|--------------|---------------------------------|---------------------------------|
| Microsoft XML 核心服务漏洞 - [CVE-2006-5745](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5745) | 远程执行代码 | 严重                            | 严重                            |
...
许多应用程序可能会安装 Microsoft XML 核心服务，无完整列表提供。 有关可用的不同 Microsoft XML 核心服务版本以及安装这些版本的主要 Microsoft 产品的详细信息，请参阅 [Microsoft 知识库文章 269238](https://support.microsoft.com/kb/269238)。
...
|-------------------------------------------------------------------------|---------------------------------|---------------------------------|
| [**MS06-061**](https://technet.microsoft.com/security/bulletin/ms06-061) | 已替代                          | 已替代                          |

这安全更新只是取代的**注意**用于 Microsoft XML Core 服务的[**MS06-061 的**](https://technet.microsoft.com/security/bulletin/ms06-061)安全更新 4.0 和 Microsoft XML Core 服务作为 Microsoft XML Core 服务的 6.0 3.0 和 Microsoft XML Core 服务 5.0 不被影响**。**
...
-   “受限制的站点”区域可以通过防止在阅读 HTML 电子邮件时使用活动脚本来减少利用此漏洞的攻击企图。 但是，如果用户单击电子邮件中的链接，他们仍然可能通过基于 Web 的攻击情形容易受到此问题的攻击。
    默认情况下，Outlook Express 6、Outlook 2002、和 Outlook 2003 在“受限制的站点”区域打开 HTML 电子邮件。 此外，如果已经安装 Outlook 电子邮件安全更新，Outlook 2000 将在“受限制的站点”区域中打开 HTML 电子邮件消息。 如果已经安装了 [Microsoft 安全公告 MS04-018](https://technet.microsoft.com/security/bulletin/ms04-018)，Outlook Express 5.5 Service Pack 2 将在“受限制的站点”区域打开 HTML 电子邮件。
...
-   [ISS](https://www.iss.net/) 的 Robert Freeman 与我们一起努力处理了 Microsoft XML 核心服务漏洞 ([CVE-2006-5745](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5745))。
-   [Checkpoint](https://www.checkpoint.com/) 的 Dror Shalev 和 Moti Jospeh 与我们一起努力处理了 Microsoft XML 核心服务漏洞 ([CVE-2006-5745](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5745))。

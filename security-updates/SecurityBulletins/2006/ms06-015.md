...
**注意事项：** [Microsoft 知识库文章 918165](https://support.microsoft.com/kb/918165) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 [Microsoft 知识库文章 918165](https://support.microsoft.com/kb/918165)。
...
|-------------------------------------------------------------------------------------------------------|--------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Windows Shell 漏洞 - [CVE-2006-0012](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-0012) | 远程执行代码 | 严重                  | 严重         | 严重                      | 严重                      | 严重                | 严重                               |
...
**注意** 已经应用 MS06-015 更新的客户不会遇到 [Microsoft 知识库文章 918165](https://support.microsoft.com/kb/918165) 中所述的问题，无需采取任何行动。

**修订安全更新包括哪些更改**？
修订安全更新不包含对初始安全更新中包括的二进制文件更改。 在安装期间，修订安全更新将下列各项放在允许列表中，如 [Microsoft 知识库文章 918165](https://support.microsoft.com/kb/918165) 中所述。
...
对于 Microsoft 基准安全分析器 (MBSA) 1.2.1，检测逻辑已更新，仅向没有安装初始安全更新的计算机提供修订程序包。 MBSA 1.2.1 不能用来确定标识的第三方 COM 控件是否已安装。 对于使用 MBSA 1.2.1 并遇到这些问题的客户，我们建议使用组策略或脚本手动将上述 COM 控件添加到允许列表，如 [Microsoft 知识库文章 918165](https://support.microsoft.com/kb/918165) 所述。

**当客户安装此安全更新时可能遇到什么已知问题？**  
[Microsoft 知识库文章 918165](https://support.microsoft.com/kb/918165) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 [Microsoft 知识库文章 918165](https://support.microsoft.com/kb/918165)。
...
是。 此漏洞会严重影响 Windows 98、Windows 98 Second Edition 和 Windows Millennium Edition。 这些平台的重要安全更新与此安全公告中提供的其他安全更新可能不同时提供。 在此次发布后，将尽早提供这些安全更新。 在这些安全更新发布时，您只能从 [Windows Update 网站](https://go.microsoft.com/fwlink/?linkid=21130)下载它们。 有关严重等级的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21140)。
...
-   [NISCC](https://www.niscc.gov.uk/) 报告了 Windows Shell 漏洞 (CVE-2006-0012)。

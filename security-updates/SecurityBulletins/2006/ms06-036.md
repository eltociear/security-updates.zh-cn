...
**注意事项：** [Microsoft 知识库文章 914388](https://support.microsoft.com/kb/xyz) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 [Microsoft 知识库文章 914388](https://support.microsoft.com/kb/xyz)。

**经过测试的软件和安全更新下载位置：**

**受影响的软件：**

-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=7a04fae4-6914-4ffa-b0ec-61b912d47873)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=bf08cc28-b359-4b27-99b2-342f832cdecc)
-   Microsoft Windows XP Professional x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=49b0da03-73a7-462a-9dc2-2eb5405e2505)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=2978c3d2-59e3-4dd4-8323-b1b2f9dfa7a5)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）— [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=01e7bbbd-dfb6-4524-aa35-39323b210aa4)
-   Microsoft Windows Server 2003 x64 Edition — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=d68730a7-bb7c-477a-a2a4-991629fc1402)
...
|-----------------------------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| DHCP Client 服务中的缓冲区溢出漏洞 - [CVE-2006-2372](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-2372) | 远程执行代码 | 严重         | 严重                      | 严重                      | 严重                | 严重                               |
...
有关 Microsoft Update 和 MBSA 2.0 当前不检测的软件的详细信息，请参阅 [Microsoft 知识库文章 895660](https://support.microsoft.com/kb/895660)
...
**什么是 DHCP？**  
动态主机配置协议 (DHCP) 是用于简化管理网络地址的 Internet 协议标准。 DHCP 通过使用服务器计算机集中管理网络中 IP 地址及其他相关配置细节以实现该目的。 Windows Server 提供了 DHCP Server 服务。如 DHCP IETF [RFC 2131](https://www.faqs.org/rfcs/rfc2131.html) 中所述，这项服务使该服务器计算机作为 DHCP Server 运行，并使用网络上的 DHCP Client 服务向启用了 DHCP 的客户端计算机提供配置设置。
...
应用此安全更新后，必须重新启动系统。有关重新启动计算机之前向您进行提示的原因的详细信息，请参阅 [Microsoft 知识库文章 887012](https://support.microsoft.com/kb/887012)。
...
应用此安全更新后，必须重新启动系统。 为了降低被迫重新启动的机率，请首先停止所有受影响的服务并且关闭所有可能使用受影响的文件的应用程序，然后安装安全更新。 有关可能提示您重新启动计算机的原因的详细信息，请参阅 [Microsoft 知识库文章 887012](https://support.microsoft.com/kb/887012)。
...
-   [Cybsec Security Systems](https://www.cybsec.com/) 的 Mariano Nuñez Di Croce 报告了 DHCP Client 服务中的缓冲区溢出漏洞 - CVE-2006-2372

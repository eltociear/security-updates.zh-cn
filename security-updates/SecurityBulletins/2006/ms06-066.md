...
|-----------------------------------------------------------------------------------------------------------------------------|--------------|-----------------------------|----------------------------------------|-----------------------------------------------------------|
| Microsoft NetWare 客户端服务内存损坏漏洞 - [CVE-2006-4688](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4688) | 远程执行代码 | 重要                        | 重要                                   | 中等                                                      |
| NetWare 驱动程序拒绝服务漏洞 - [CVE-2006-4689](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4689)             | 拒绝服务     | 中等                        | 中等                                   | 低                                                        |
...
-   **为帮助防止攻击者试图基于网络利用此漏洞，请使用个人防火墙，例如**[**Windows 防火墙**](https://go.microsoft.com/fwlink/?linkid=33335)**，该防火墙包含在 Windows XP 中。**
...
-   **为帮助防止攻击者试图基于网络利用此漏洞，请使用个人防火墙，例如**[**Windows 防火墙**](https://go.microsoft.com/fwlink/?linkid=33335)**，该防火墙包含在 Windows XP 中。**
    ...
    默认情况下，Windows XP 和 Windows Server 2003 中的 [Windows 防火墙功能](https://www.microsoft.com/athome/security/default.mspx)可通过阻止未经请求传入的通信保护您的 Internet 连接。 我们建议您阻止所有来自 Internet 的非法传入通信。
...
-   [NGS Software](https://www.ngssoftware.com/%20\t%20_blank) 的 Peter Winter-Smith 报告了 NetWare 客户端服务内存损坏漏洞 - CVE-2006-4688。
-   [McAfee](https://www.mcafee.com/us%20\t%20_blank) 的 Sam Arun Raj 报告了 NetWare 客户端服务内存损坏漏洞 (CVE-2006-4688) 和 Netware 客户端服务驱动程序拒绝服务漏洞 (CVE-2006-4689)。

...
|-------------------------------------------------------------------------------------------------------|--------------|-----------------------------|---------------------------|---------------------------|---------------------|------------------------------------|
| VML 缓冲区溢出漏洞 - [CVE-2006-4868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4868) | 远程执行代码 | 严重                        | 严重                      | 严重                      | 严重                | 中等                               |
...
-   默认情况下，Windows Server 2003 上的 Internet Explorer 在一种称为“[增强安全配置](http://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)”的受限模式下运行。 此模式可缓解 Windows Server 2003 Service Pack 1 中的漏洞，因为二进制和脚本行为在 Internet 区域中默认处于禁用状态。
...
-   [ISS X-Force](http://www.iss.net/) 与 Microsoft 一起努力处理了 VML 缓冲区溢出漏洞 (CVE-2006-4868)。
-   [iDEFENSE](http://www.idefense.com/) 与 Microsoft 一起努力处理了 VML 缓冲区溢出漏洞 (CVE-2006-4868)。
-   [Websense Security Labs](http://www.websense.com/securitylabs/) 的 Dan Hubbard 与 Microsoft 一起努力处理了 VML 缓冲区溢出漏洞 (CVE-2006-4868)。

...
**已知问题。**  [Microsoft 知识库文章 941568](https://support.microsoft.com/kb/941568) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
[Microsoft 知识库文章 941568](https://support.microsoft.com/kb/941568) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3901](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3901)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3895](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3895)。
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Jun Mao 报告了 Microsoft DirectX 在 SAMI 文件分析中的代码执行漏洞 (CVE-2007-3901)。  
-   [NGSSoftware](https://www.ngssoftware.com/) 的 Peter Winter-Smith 报告了 Microsoft DirectX 在 WAV 文件分析中的代码执行漏洞 (CVE-2007-3895)。  
-   [AhnLab](https://www.ahnlab.com/) 的 Jung-hyung Lee 和 Minseong Kim 与我们合作处理了对 DirectX 的纵深防御更改。

...
|----------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=7cd248ed-d154-4dce-89ef-ceefd2700965) | 远程执行代码 | 严重             | [MS07-020](https://technet.microsoft.com/security/bulletin/ms07-020) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)。
...
**什么是 Microsoft Agent？**    
Microsoft Agent 是 Microsoft Windows 操作系统的一个组件，它使用交互式动画字符指导用户，让使用以及学习使用计算机更容易。 有关详细信息，请参阅 [Microsoft Agent 网站](https://www.microsoft.com/msagent/)。
...
-   [Assurent Secure Technologies](https://www.assurent.com/) 的 Vulnerability Research 小组报告了 Agent 远程执行代码漏洞 – [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了 Agent 远程执行代码漏洞 – [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)
-   一名与 VeriSign [iDefense VCP](https://labs.idefense.com/) 合作的匿名研究员报告了 Agent 远程执行代码漏洞 – [CVE-2007-3040](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3040)

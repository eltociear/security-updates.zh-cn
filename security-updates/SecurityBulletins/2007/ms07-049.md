...
**已知问题。** [Microsoft 知识库文章 937986](https://support.microsoft.com/kb/937986) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|------------------|
| [Microsoft Virtual PC 2004](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=e2c72aab-00de-47c9-8ecb-09261c4b7deb)                | 特权提升     | 重要             | 无               |
| [Microsoft Virtual PC 2004 Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=2bda2b8b-9c1c-4bf8-9a65-491092276e7a) | 特权提升     | 重要             | 无               |
| [Microsoft Virtual Server 2005 Standard Edition](https://www.microsoft.com/download/details.aspx?familyid=f9ec76cd-0607-4394-bc49-35e95d02da51)             | 特权提升     | 重要             | 无               |
| [Microsoft Virtual Server 2005 Enterprise Edition](https://www.microsoft.com/download/details.aspx?familyid=a35e556c-2f7b-4b72-9662-ae7286573c3f)           | 特权提升     | 重要             | 无               |
| [Microsoft Virtual Server 2005 R2 Standard Edition](https://www.microsoft.com/download/details.aspx?familyid=d44b8669-a4fb-4cba-b130-e1bc08b10c6f)          | 特权提升     | 重要             | 无               |
| [Microsoft Virtual Server 2005 R2 Enterprise Edition](https://www.microsoft.com/download/details.aspx?familyid=84ca3ba9-6575-4c5b-8f8e-4e4a635a4705)        | 特权提升     | 重要             | 无               |
| [Microsoft Virtual PC for Mac 6.1 版](https://www.microsoft.com/mac/downloads.aspx%20vpc)                                                                    | 特权提升     | 重要             | 无               |
| [Microsoft Virtual PC for Mac Version 7](https://www.microsoft.com/mac/downloads.aspx%20vpc)                                                                 | 特权提升     | 重要             | 无               |
...
[Microsoft 知识库文章 937986](https://support.microsoft.com/kb/937986) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-0948](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0948)。
...
-   Microsoft Virtual PC 2007 不受此问题威胁。 您可以在 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=04d26402-3199-48a3-afa2-2dc0b40a73b6)下载 Microsoft Virtual PC 2007 完全版。  
-   Microsoft Virtual Server 2005 R2 SP1 不受此问题威胁。 您可以在 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=04d26402-3199-48a3-afa2-2dc0b40a73b6)下载 Microsoft Virtual Server 2005 R2 SP1 完全版。
...
有关安装程序的详细信息，请访问 [IExpress 技术和 IExpress 向导网站](https://www.microsoft.com/technet/prodtechnol/ie/ieak/techinfo/deploy/60/en/iexpress.mspx?mfr=true)。

有关本公告中出现的术语（如“*修补程序*”）的详细信息，请参阅 [Microsoft 知识库文章 824684](https://support.microsoft.com/kb/824684)。

[Microsoft 知识库文章 937987](https://support.microsoft.com/kb/937987) 介绍了客户在安装此安全更新时可能遇到的当前已知的安装问题。
...
-   计算机上必须安装 [Microsoft Virtual PC for Mac Version 6.1.1 更新](https://www.microsoft.com/mac/downloads.aspx%20vpc)。
...
从 [Microsoft Mactopia 网站](https://www.microsoft.com/mac/downloads.aspx%20vpc)下载和安装 Microsoft Virtual PC for Mac Version 6.1.2 更新的适当语言版本。
...
-   计算机上必须安装 [Microsoft Virtual PC for Mac Version 7.0.2 更新](https://www.microsoft.com/mac/downloads.aspx%20vpc)。
...
从 [Microsoft Mactopia 网站](https://www.microsoft.com/mac/downloads.aspx%20vpc)下载和安装 Microsoft Virtual PC for Mac Version 7.0.3 更新的适当语言版本。
...
-   [McAfee Avert Labs](https://www.avertlabs.com/) 的 Rafal Wojtczuk 与 Microsoft 一起处理了 Virtual PC 和 Virtual Server 可能允许特权提升的漏洞 – (CVE-2007-0948)。

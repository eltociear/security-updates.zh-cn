...
-   Microsoft Windows XP Service Pack 2 - [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=81fb6a72-ac8a-4b28-905f-a44691d69432)
-   Microsoft Windows XP Professional x64 Edition - [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=d06fd167-4f3e-4a2c-b52c-7426ddad6828)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 - [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=4fee481f-dace-4eac-9afe-bc28add70cc5)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）- [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=c517fb85-128e-43db-a659-38af32283716)
-   Microsoft Windows Server 2003 x64 Edition - [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=ff4a1f24-c1e9-4223-965b-14c4793aaf96)
...
-   Microsoft Windows 2000 Service Pack 4 上的 Internet Explorer 5.01 Service Pack 4 - [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=b1c7f765-772c-4eeb-9438-bc820cb929e1)
-   Microsoft Windows 2000 Service Pack 4 上的 Internet Explorer 6 Service Pack 1 - [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=922a3569-85d1-4584-9b84-4aa7304c69bb)
-   Microsoft Windows XP Service Pack 2 上的 Windows Internet Explorer 7 - [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=55a0a6ec-fefa-40bb-bb6b-3aab50275a73)
-   Microsoft Windows XP Professional x64 Edition 和 Microsoft Windows XP Professional x64 Edition Service Pack 2 上的 Windows Internet Explorer 7 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=b5a8b1f2-6af0-4f03-989c-c8de2eace71d)
-   Microsoft Windows Server 2003 Service Pack 1 和 Microsoft Windows Server 2003 Service Pack 2 上的 Windows Internet Explorer 7 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=08e5cd2e-55c0-4ac9-859f-1b24497b31ce)
-   Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP2（用于基于 Itanium 的系统）的 Windows Internet Explorer 7 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=48b4d271-d494-4a5c-aba8-11b3b4584902)
-   Microsoft Windows Server 2003 x64 Edition 和 Microsoft Windows Server 2003 x64 Edition Service Pack 2 上的 Windows Internet Explorer 7 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=f9c3e0de-db66-4d83-829f-c93052bdb1fa)
...
|-------------------------------------------------------------------------------------------------------|--------------|-----------------------------|---------------------------|---------------------|------------------------------------|
| VML 缓冲区溢出漏洞 - [CVE-2007-0024](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0024) | 远程执行代码 | 严重                        | 严重                      | 严重                | 中等                               |
...
如果应用了“修改 VGX.DLL 上的访问控制列表以增加限制”，则重新分发 vgx.dll 的软件可能无法安装， 例如 [Windows Internet Explorer 7](https://www.microsoft.com/windows/ie/default.mspx)。必须先针对 vgx.dll 将变通办法恢复到以前的 ACL 配置，才可以安装此软件。
...
|-------------------------------------------------------------------------|-----------------------------|--------------------------------------------------------------------------|---------------------------|---------------------|------------------------------------|
| [**MS06-055**](https://technet.microsoft.com/security/bulletin/ms06-055) | 已替代                      | 已替代                                                                   | 已替代                    | 已替代              | 已替代                             |
...
-   默认情况下，Windows Server 2003 上的 Internet Explorer 在一种称为“[增强安全配置](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)”的受限模式下运行。 此模式在 Windows Server 2003 Service Pack 1 和 Microsoft Windows Server 2003 Service Pack 2 中可缓解此漏洞 1，因为二进制和脚本行为在 Internet 区域中默认处于禁用状态。
...
**注意** 如果应用了此变通办法，则重新分发 vgx.dll 的软件可能无法安装。 例如 [Internet Explorer 7 Release Candidate 1](https://www.microsoft.com/windows/ie/default.mspx) 和 Windows Internet Explorer 7 的后续版本。必须先针对 vgx.dll 将此变通办法恢复到以前的 ACL 配置，才可以安装此软件。
...
-   Jospeh Moti 与 [iDEFENSE](https://www.idefense.com/) Contributor Program 一起报告了 VML 缓冲区溢出漏洞 - CVE-2007-0024。

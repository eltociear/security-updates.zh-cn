---
TOCTitle: 'MS07-025'
Title: 'Microsoft 安全公告 MS07-025 - 严重'
ms:assetid: 'ms07-025'
ms:contentKeyID: 61236891
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms07-025(v=Security.10)'
---



Microsoft 安全公告 MS07-025 - 严重
==================================
...
**注意事项：** [Microsoft 知识库文章 934873](http://support.microsoft.com/?kbid=934873) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 Microsoft [知识库文章 934873](http://support.microsoft.com/?kbid=934873)。

**测试过的软件和安全更新下载位置：**

**受影响的软件：**

-   Microsoft Office 2000 Service Pack 3 — [下载此更新 (KB934526)](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=a693c271-4b94-4541-953a-0a2db4587b23)
    -   Microsoft Excel 2000
    -   Microsoft FrontPage 2000
    -   Microsoft Publisher 2000
-   Microsoft Office XP Service Pack 3 — [下载此更新 (KB934705)](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=cb291ad9-348a-4c28-bec7-53d2f35d0b72)
    -   Microsoft Excel 2002
    -   Microsoft FrontPage 2002
    -   Microsoft Publisher 2002
-   Microsoft Office 2003 Service Pack 2 — [下载此更新 (KB934180)](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=819857cc-3777-4e4a-9cc3-685fc079a254)
    -   Microsoft Excel 2003
    -   Microsoft FrontPage 2003
    -   Microsoft Publisher 2003
    -   Microsoft Excel 2003 Viewer
-   2007 Microsoft Office System — [下载此更新 (KB934062)](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=a3dc8e3f-90dd-4d0c-88b8-2ec88ff3a588)
...
| 漏洞标识符                                                                                      | 漏洞的影响   | Microsoft Office 2000 Service Pack 3 | Microsoft Office XP Service Pack 3 | Microsoft Office 2003 Service Pack 2 | 2007 Microsoft Office System | Microsoft Office 2004 for Mac |
|-------------------------------------------------------------------------------------------------|--------------|--------------------------------------|------------------------------------|--------------------------------------|------------------------------|-------------------------------|
| 绘图对象漏洞 - [CVE-2007-1747](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1747) | 远程执行代码 | 严重                                 | 重要                               | 重要                                 | 重要                         | 重要                          |
...
[Microsoft 知识库文章 934873](http://support.microsoft.com/?kbid=934873) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 Microsoft [知识库文章 934873](http://support.microsoft.com/?kbid=934873)。
...
| 公告 ID                                                                 | Microsoft Office 2000 Service Pack 3 | Microsoft Office XP Service Pack 3 | Microsoft Office 2003 Service Pack 2 | 2007 Microsoft Office System | Microsoft Office 2004 for Mac |
|-------------------------------------------------------------------------|--------------------------------------|------------------------------------|--------------------------------------|------------------------------|-------------------------------|
| [**MS07-015**](http://technet.microsoft.com/security/bulletin/ms07-015) | 已替代                               | 已替代                             | 已替代                               | 不适用                       | 已替代                        |
...
**Windows Vista备注** MBSA 2.0.1 在 Windows Vista 上不受支持，但是支持对运行 Windows Vista 的计算机执行远程扫描。 有关 Windows Vista 的 MBSA 支持的其他信息，请访问 [MBSA 网站](http://go.microsoft.com/fwlink/?linkid=21134)。 请参阅 Microsoft 知识库文章 931943： Windows Vista 的 Microsoft 基准安全分析器 (MBSA) 支持。
...
#### 绘图对象漏洞 (CVE-2007-1747) 的变通办法：

-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Office 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### 绘图对象漏洞 (CVE-2007-1747) 的常见问题：

**此漏洞的影响范围有多大？**  
Microsoft Office 处理特制绘图对象的方式中存在一个远程执行代码漏洞。 攻击者可以通过让用户打开包含恶意绘图对象的特制文件来利用此漏洞。 此类特制文件可能包括在电子邮件附件中或宿主在恶意网站上。 打开特制文件会允许在登录用户的安全上下文中远程执行代码。

如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者随后可安装程序；查看、更改或删除数据；或者创建权限与已登录用户相同的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成漏洞的原因是什么？**  
Office 在分析 Office 绘图对象时没有执行足够的数据验证。 当 Office 打开特制的 Office 文件并分析格式错误的绘图对象时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
**我的系统上没有安装任何受影响的软件，但是存在 MSO.dll，我仍将获得提供的安全更新，为什么？**  
MSO.dll 是 Office 应用程序之间共享的一个文件；只有安装了受影响的 Office 应用程序的客户会受此漏洞的影响。 由于系统上存在该文件，如果您没有安装受影响的 Office 应用程序，Microsoft 建议您安装该安全更新。

**此更新有什么作用？**  
更新通过修改 Microsoft Office 处理特定绘图对象的方式删除漏洞。
...
1.  [下载 Office 2000 的此安全更新](http://download.microsoft.com/download/7/0/8/70852c45-03a8-45f2-ac74-abbb42f2d21d/office2000-kb934526-fullfile-enu.exe)。
...
1.  [下载 Office XP 的此安全更新](http://download.microsoft.com/download/d/e/0/de06eeb7-3bbe-478d-88c5-2cf7345e93ad/officexp-kb934705-fullfile-enu.exe)。
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
要安装所有功能，您可以使用 **REINSTALL=ALL** 或者可以安装以下功能： **(Comment**: Choose from the following or else enter unique.**)**
...
-   要更新 Excel Viewer 2003，必须安装 Excel Viewer 2003 的最新版本。 [下载最新的 Excel Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=c8378bf4-996c-4569-b547-75edbd03aaf0&displaylang=en)。
...
1.  [下载 Office 2003 的安全更新。](http://download.microsoft.com/download/01-6-7/671fe678-8823-4477-97f2-e2701cf8ad3f/office2003-kb934180-fullfile-enu.exe)
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
-   要更新 2007 Office System，必须安装 2007 Office System。
...
Microsoft 下载中心上的 Windows Installer 3.1 Redistributable (v2)。有关“**关于**”对话框中显示的版本信息的详细信息，请参阅 [Microsoft 知识库文章 328294](http://support.microsoft.com/kb/328294)。
...
1.  [下载 2007 Office System 的安全更新](http://download.microsoft.com/download/b/e/5/be5c2a49-ce23-4612-b46a-f4e189d72641/office2007-kb934062-fullfile-x86-glb.exe)。
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
-   V1.1（2007 年 5 月 16 日）： 公告变通办法部分已更新，删除了“使用 Microsoft Word Viewer 2003 打开并查看文件”变通办法。 这种变通办法对此安全公告中讨论的漏洞无效。
-   V1.2（2007 年 5 月 17 日）： 由于根据 [Microsoft 知识库文章中 934873](http://support.microsoft.com/?kbid=934873) 反映发现安全更新存在新问题而对本公告进行了修订。

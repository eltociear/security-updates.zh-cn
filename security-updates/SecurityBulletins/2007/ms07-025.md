...
**注意事项：** [Microsoft 知识库文章 934873](https://support.microsoft.com/?kbid=934873) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 Microsoft [知识库文章 934873](https://support.microsoft.com/?kbid=934873)。
...
|-------------------------------------------------------------------------------------------------|--------------|--------------------------------------|------------------------------------|--------------------------------------|------------------------------|-------------------------------|
| 绘图对象漏洞 - [CVE-2007-1747](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1747) | 远程执行代码 | 严重                                 | 重要                               | 重要                                 | 重要                         | 重要                          |
...
[Microsoft 知识库文章 934873](https://support.microsoft.com/?kbid=934873) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 Microsoft [知识库文章 934873](https://support.microsoft.com/?kbid=934873)。
...
|-------------------------------------------------------------------------|--------------------------------------|------------------------------------|--------------------------------------|------------------------------|-------------------------------|
| [**MS07-015**](https://technet.microsoft.com/security/bulletin/ms07-015) | 已替代                               | 已替代                             | 已替代                               | 不适用                       | 已替代                        |
...
**Windows Vista备注** MBSA 2.0.1 在 Windows Vista 上不受支持，但是支持对运行 Windows Vista 的计算机执行远程扫描。 有关 Windows Vista 的 MBSA 支持的其他信息，请访问 [MBSA 网站](https://go.microsoft.com/fwlink/?linkid=21134)。 请参阅 Microsoft 知识库文章 931943： Windows Vista 的 Microsoft 基准安全分析器 (MBSA) 支持。
...
1.  [下载 Office 2000 的此安全更新](https://download.microsoft.com/download/7/0/8/70852c45-03a8-45f2-ac74-abbb42f2d21d/office2000-kb934526-fullfile-enu.exe)。
...
1.  [下载 Office XP 的此安全更新](https://download.microsoft.com/download/d/e/0/de06eeb7-3bbe-478d-88c5-2cf7345e93ad/officexp-kb934705-fullfile-enu.exe)。
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
1.  [下载 Office 2003 的安全更新。](https://download.microsoft.com/download/01-6-7/671fe678-8823-4477-97f2-e2701cf8ad3f/office2003-kb934180-fullfile-enu.exe)
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
Microsoft 下载中心上的 Windows Installer 3.1 Redistributable (v2)。有关“**关于**”对话框中显示的版本信息的详细信息，请参阅 [Microsoft 知识库文章 328294](https://support.microsoft.com/kb/328294)。
...
**注意** 当删除此更新时，系统可能提示您在光驱中插入 2007 Microsoft Office System CD。 另外，您可能没有从控制面板“添加/删除程序”中卸载更新的选项。 此问题有诸多可能的原因。 有关删除的详细信息，请参阅 [Microsoft 知识库文章 903771](https://support.microsoft.com/kb/903771)。
...
1.  [下载 2007 Office System 的安全更新](https://download.microsoft.com/download/b/e/5/be5c2a49-ce23-4612-b46a-f4e189d72641/office2007-kb934062-fullfile-x86-glb.exe)。
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
-   V1.2（2007 年 5 月 17 日）： 由于根据 [Microsoft 知识库文章中 934873](https://support.microsoft.com/?kbid=934873) 反映发现安全更新存在新问题而对本公告进行了修订。

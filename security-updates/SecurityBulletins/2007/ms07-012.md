...
如果您正在使用 Visual Studio .NET 2003，则应该参阅 [Microsoft 知识库文章 933273](http://support.microsoft.com/kb/933273/) 并从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=48e4c8fa-7a8c-41dc-af1c-e9e3be107171)下载 MFC 源文件。 这在您从来源重新构建 MFC 库，并静态或动态链接到您构建的库时尤其重要。 在重新构建应用程序 ***之前***，您应该下载更新来源并重新构建 MFC 库。

...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Word 格式错误的字符串漏洞 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5994">CVE-2006-5994</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Word 格式错误的数据结构漏洞 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-6456">CVE-2006-6456</a></td>
<td style="border:1px solid black;">远程执行代码<br />
</td>
...
<tr class="odd">
<td style="border:1px solid black;">字数统计漏洞 – <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-xxxx">CVE-2006-6561</a></td>
<td style="border:1px solid black;">远程执行代码<br />
</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="even">
<td style="border:1px solid black;">Word 宏漏洞 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0208">CVE-2007-0208</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Word 格式错误的绘图对象漏洞 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0209">CVE-2007-0209</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="even">
<td style="border:1px solid black;">Word 格式错误的功能漏洞 - <a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0515">CVE-CVE-2007-0515</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
<td style="border:1px solid black;">无</td>
...
|-------------------------------------------------------------------------|---------------------|---------------------|---------------------|-------------------------------|----------------------------|  
| [**MS06-060**](http://technet.microsoft.com/security/bulletin/ms06-060) | 已替代              | 已替代              | 已替代              | 已替代                        | 已替代                     |
...
1.  [下载 Word 2000 的安全更新。](http://download.microsoft.com/download/e/e/2/ee2c73dd-a33c-4d79-bd50-f772cccce765/office2000-kb929139-fullfile-enu.exe)  
...
-   必须安装 Office XP Service Pack 3 (SP3)。 在安装此更新之前，请安装 [Office XP SP3](https://www.microsoft.com/download/details.aspx?familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e)。有关如何安装 Office XP SP3 的更多信息，请参阅 [Microsoft 知识库文章 832671](http://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;832671)。
...
1.  [下载 Word 2002 的安全更新。](http://download.microsoft.com/download/d/0/9/d09d67ff-cba7-436e-88df-3db2327dee2a/officexp-kb929061-fullfile-enu.exe)  
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。  
3.  单击“**保存**”。  
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。  
5.  如果系统提示您安装更新，则单击“**是**”。  
...
1.  [下载 Word 2003](http://download.microsoft.com/download/4/a/0/4a0bcc02-9b89-458b-8629-ac9da6d1e470/office2003-kb929057-fullfile-enu.exe) 和/或 [Word Viewer 2003 的安全更新](http://download.microsoft.com/download/0/d/7/0d7d95fa-12f1-4bb9-ba66-5fa99042e24a/office2003-kb924883-fullfile-enu.exe)。  
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。  
3.  单击“**保存**”。  
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。  
5.  如果系统提示您安装更新，则单击“**是**”。  
...
-   [Information and Communication Security Technology Center](http://www.icst.org.tw/) 的 Shih-hao Weng 报告了 Word 格式错误的字符串漏洞 (CVE-2006-5994)。  
-   [Information and Communication Security Technology Center](http://www.icst.org.tw/) 的 Shih-hao Weng 报告了 Word 格式错误的字符串漏洞 (CVE-2006-6456)。  

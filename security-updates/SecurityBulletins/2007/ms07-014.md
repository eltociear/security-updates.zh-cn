---
TOCTitle: 'MS07-014'
Title: 'Microsoft 安全公告 MS07-014 - 严重'
ms:assetid: 'ms07-014'
ms:contentKeyID: 61236869
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms07-014(v=Security.10)'
---



Microsoft 安全公告 MS07-014 - 严重
==================================

Microsoft Word 中的漏洞可能允许远程执行代码 (929434)
----------------------------------------------------
...
**本文的目标读者：** 使用 Microsoft Office 或 Microsoft Works 的客户
...
-   Microsoft Office 2000 Service Pack 3
    -   Microsoft Word 2000 - [下载此更新 (KB929139)](https://www.microsoft.com/download/details.aspx?familyid=f1e61e6a-be3d-4536-af76-a11d5ce67199)
-   Microsoft Office XP Service Pack 3
    -   Microsoft Word 2002 - [下载此更新 (KB929061)](https://www.microsoft.com/download/details.aspx?familyid=a1ca8dd7-0622-4d66-a85f-a6586545ef9d)
-   Microsoft Office 2003 Service Pack 2
    -   Microsoft Word 2003 - [下载此更新 (KB929057)](https://www.microsoft.com/download/details.aspx?familyid=882f8503-da72-43c9-b556-a002ec58f289)
    -   Microsoft Word Viewer 2003 - [下载此更新 (KB924883)](https://www.microsoft.com/download/details.aspx?familyid=fb59798b-afe2-4103-9991-cbdd7686f9ad)
-   Microsoft Works Suite：
    -   Microsoft Works Suite 2004 - [下载此更新 (KB929061)（与 Microsoft Word 2002 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=a1ca8dd7-0622-4d66-a85f-a6586545ef9d)
    -   Microsoft Works Suite 2005 - [下载此更新 (KB929061)（与 Microsoft Word 2002 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=a1ca8dd7-0622-4d66-a85f-a6586545ef9d)
    -   Microsoft Works Suite 2006 - [下载此更新 (KB929061)（与 Microsoft Word 2002 更新相同）](https://www.microsoft.com/download/details.aspx?familyid=a1ca8dd7-0622-4d66-a85f-a6586545ef9d)
-   Microsoft Office 2004 for Mac - [下载此更新 (KB932185)](https://www.microsoft.com/mac/)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Word 格式错误的字符串漏洞 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5994">CVE-2006-5994</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Word 格式错误的数据结构漏洞 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-6456">CVE-2006-6456</a></td>
<td style="border:1px solid black;">远程执行代码<br />
</td>
...
<tr class="odd">
<td style="border:1px solid black;">字数统计漏洞 – <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-xxxx">CVE-2006-6561</a></td>
<td style="border:1px solid black;">远程执行代码<br />
</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="even">
<td style="border:1px solid black;">Word 宏漏洞 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0208">CVE-2007-0208</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Word 格式错误的绘图对象漏洞 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0209">CVE-2007-0209</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<tr class="even">
<td style="border:1px solid black;">Word 格式错误的功能漏洞 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0515">CVE-CVE-2007-0515</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
<td style="border:1px solid black;">无</td>
...
Microsoft Works Suite 2004、2005 和 2006 的严重等级与 Microsoft Word 2002 的严重等级相同。
...
| 公告 ID                                                                 | Microsoft Word 2000 | Microsoft Word 2002 | Microsoft Word 2003 | Microsoft Office 2004 for Mac | Microsoft Word Viewer 2003 |  
|-------------------------------------------------------------------------|---------------------|---------------------|---------------------|-------------------------------|----------------------------|  
| [**MS06-060**](https://technet.microsoft.com/security/bulletin/ms06-060) | 已替代              | 已替代              | 已替代              | 已替代                        | 已替代                     |
...
| Microsoft Word 2003         | 是      | 是       |  
| Microsoft Word Viewer 2003  | 是      | 是       |  
| Microsoft Word v.X for Mac  | 否      | 否       |  
...
-   要了解如何将客户计算机从更新的管理安装点更改为 Office 2003 原始基准来源 或 Service Pack 2 (SP2) 的更多信息请参阅，[Microsoft 知识库文章 902349](https://support.microsoft.com/kb/902349)。
...
#### Word 格式错误的字符串漏洞 (CVE-2006-5994) 的缓解因素：
...
-   Microsoft Word Viewer 2003 不受此漏洞影响。
  
#### Word 格式错误的字符串漏洞 (CVE-2006-5994) 的避免方法：
  
-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Word 文件。 当用户打开文件时，攻击者就有可能利用此漏洞。  
-   使用 Microsoft Word Viewer 2003 打开并查看文件。 Microsoft Word Viewer 2003 不受此问题影响。 用户可以从 Microsoft 下载中心下载 [Microsoft Word Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf)。
  
#### Word 格式错误的字符串漏洞 (CVE-2006-5994) 的常见问题解答：
  
**此漏洞的影响范围有多大？**    
Microsoft Word 中存在一个远程执行代码漏洞。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**造成漏洞的原因是什么？**    
Word 处理文件的内容时没有执行足够的数据验证。 当 Word 打开特制的 Word 文件并分析格式错误的字符串时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以完全控制受影响的系统。
  
**攻击者如何利用此漏洞？**    
在电子邮件攻击情形中，攻击者可以通过向用户发送特制的文件并诱使用户打开该文件来利用此漏洞。 不能通过 HTML 或者丰富文本格式 (RTF) 电子邮件利用此漏洞，即便用户设置 Word 作为其电子邮件编辑器。
  
在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的 Word 文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问恶意网站。 相反，攻击者必须劝诱用户访问该网站，通常是让用户单击通向攻击者站点的链接。
  
**此更新有什么作用？**    
更新通过修改 Microsoft Word 处理特定字符串的方式删除漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 CVE-2006-5994。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
是。 在发布此安全公告时，Microsoft 已收到有关此漏洞已被利用的信息。
  
#### Word 格式错误的数据结构漏洞 - CVE-2006-6456：
  
在 Microsoft Word 以一个特制的数据结构处理 Word 文件的方式中存在一个远程执行代码漏洞。 此类特制文件可能包括在电子邮件附件中或宿主在恶意网站上。 攻击者可以通过构建特制的 Word 文件来利用此漏洞，此文件可能允许远程执行代码。 在受影响的 Outlook 版本中查看或预览格式错误的电子邮件不会导致利用此漏洞。
  
#### Word 格式错误的数据结构漏洞的缓解因素 - CVE-2006-6456：
...
#### Word 格式错误的数据结构漏洞的避免方法 - CVE-2006-6456：
  
-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Word 文件。 当用户打开文件时，攻击者就有可能利用此漏洞。
  
#### Word 格式错误的数据结构漏洞的常见问题解答 - CVE-2006-6456：
  
**此漏洞的影响范围有多大？**    
Microsoft Word 中存在一个远程执行代码漏洞。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**造成漏洞的原因是什么？**    
Word 处理文件的内容时没有执行足够的数据验证。 当 Word 打开特制的 Word 文件并分析格式错误的数据结构时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
**此更新有什么作用？**    
更新通过修改 Microsoft Word 处理特定数据结构的方式删除漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 CVE-2006-6456。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
是。 在发布此安全公告时，Microsoft 已收到有关此漏洞已被利用的信息。
  
#### 字数统计漏洞 – CVE-2006-6561：
  
Microsoft Word 中存在一个远程执行代码漏洞。 在 Word 分析文件和处理未经检查的计数时攻击者可利用此漏洞。 此类特制文件可能包括在电子邮件附件中或宿主在恶意网站上。 攻击者可以通过构建特制的 Word 文件来利用此漏洞，此文件可能允许远程执行代码。 在受影响的 Outlook 版本中查看或预览格式错误的电子邮件不会导致利用此漏洞。
  
#### 字数统计漏洞 (CVE-2006-6561) 的缓解因素：
...
#### 字数统计漏洞 (CVE-2006-6561) 的避免方法：
  
-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Word 文件。 当用户打开文件时，攻击者就有可能利用此漏洞。
  
#### 字数统计漏洞 (CVE-2006-6561) 的常见问题解答：
  
**此漏洞的影响范围有多大？**    
Microsoft Word 中存在一个远程执行代码漏洞。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**造成漏洞的原因是什么？**    
Word 处理文件的内容时没有执行足够的数据验证。 当 Word 打开特制的 Word 文件并分析未经检查的计数时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
**此更新有什么作用？**    
此更新通过修改 Microsoft Word 在将消息传递到已分配缓冲区之前检查计数的方式来消除此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 CVE-2006-6561。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
是。 在发布此安全公告时，Microsoft 已收到有关此漏洞已被利用的信息。
  
#### Word 宏漏洞 - CVE-2007-0208：
  
Microsoft Word 中存在一个远程执行代码漏洞。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
#### Word 宏漏洞的缓解因素 - CVE-2007-0208：
...
-   如果 Office 2000 用户安装并使用 [Office 文档打开确认工具](https://www.microsoft.com/download/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f)，则在打开文档之前，系统将提示该用户**打开**、**保存**或**取消**。 Office 文档打开确认工具的功能包含在 Office XP 和 Office 2003 中。  
-   Microsoft Office Word 2007 不受此漏洞影响。  
-   Microsoft Word 2000 和 Microsoft Word Viewer 2003 不受此漏洞影响。
  
#### Word 宏漏洞的避免方法 - CVE-2007-0208：
  
-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Word 文件。 当用户打开文件时，攻击者就有可能利用此漏洞。  
-   使用 Word Viewer 2003 打开并查看文件。 Word Viewer 2003 不受此问题影响。 用户可以从 Microsoft 下载中心下载 [Microsoft Word Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf)。
  
#### Word 宏漏洞的常见问题解答 - CVE-2007-0208：
  
**此漏洞的影响范围有多大？**    
Microsoft Word 中存在一个远程执行代码漏洞。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**造成漏洞的原因是什么？**    
产生此漏洞的原因是，Word 对经过修改的文档进行错误的属性检查，导致文档中出现宏时，它没有通过宏安全警告提示用户。
  
**什么是宏？**    
通常，术语宏指操作系统或程序内自动执行常见任务的小程序。 例如，Office 产品系列的所有成员均支持使用宏。 这可以使各家公司开发运行在 Word、Excel 或其他程序中的宏，这些宏可以作为完善的生产工具来执行。 如同其他计算机程序一样，宏也可能会被不适当地使用。 恶意软件可能以宏的形式编写，然后嵌入在 Office 文档中。 为了缓解此威胁，Office 提供了一种安全模式，以确保只在用户允许的情况下才运行宏。 通过使用此漏洞，攻击者也许可以在没有警告用户文档中存在宏的情况下运行宏。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以完全控制受影响的系统。
  
**攻击者如何利用此漏洞？**    
攻击者能够试图通过创建包含恶意宏的特制 Word 文档利用此漏洞。 攻击者随后可以将此文档发送给用户（通常通过电子邮件发送），然后诱使用户打开该文件。 因此，如果用户遭受此漏洞的攻击，用户的宏安全级别可能会降低，而 Word 禁用的其它宏也可以运行了。 攻击者也可以将特制的 Word 文档放在网络共享或网站上；但是，攻击者仍需要诱使用户打开该文档。
  
在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的 Word 文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问恶意网站。 相反，攻击者必须劝诱用户访问该网站，通常是让用户单击通向攻击者站点的链接。
  
**此更新有什么作用？**    
更新通过修改 Microsoft Word 打开文档时执行宏安全控件的方式删除漏洞。
...
#### Word 格式错误的绘图对象漏洞 - CVE-2007-0209：
...
#### Word 格式错误的绘图对象漏洞的缓解因素 - CVE-2007-0209：
  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。  
-   在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的 Word 文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问恶意网站。 相反，攻击者必须劝诱用户访问该网站，通常是让用户单击通向攻击者站点的链接。  
-   此漏洞无法通过电子邮件自动加以利用。 用户必须打开电子邮件附件，以电子邮件为载体的攻击才会得逞。  
-   如果 Office 2000 用户安装并使用 [Office 文档打开确认工具](https://www.microsoft.com/download/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f)，则在打开文档之前，系统将提示该用户**打开**、**保存**或**取消**。 Office 文档打开确认工具的功能包含在 Office XP 和 Office 2003 中。  
-   Microsoft Word 2003 和 Microsoft Word Viewer 2003 不受此漏洞影响。  
-   Microsoft Office Word 2007 不受此漏洞影响。
  
#### Word 格式错误的绘图对象漏洞的避免方法 - CVE-2007-0209：
  
-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Word 文件。 当用户打开文件时，攻击者就有可能利用此漏洞。  
-   使用 Word Viewer 2003 打开并查看文件。 Word Viewer 2003 不受此问题影响。 用户可以从 Microsoft 下载中心下载 [Microsoft Word Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf)。
  
#### Word 格式错误的绘图对象漏洞的常见问题解答 - CVE-2007-0209：
  
**此漏洞的影响范围有多大？**    
Microsoft Word 中存在一个远程执行代码漏洞。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**造成漏洞的原因是什么？**    
Word 处理文件的内容时没有执行足够的数据验证。 当 Word 打开特制的 Word 文件并分析格式错误的绘图对象时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
**此更新有什么作用？**    
更新通过修改 Microsoft Word 处理特定绘图对象的方式删除漏洞。
...
#### Word 格式错误的功能漏洞 - CVE-2007-0515：
  
Microsoft Word 中存在一个远程执行代码漏洞。 当 Word 分析文件和处理格式错误功能时，攻击者可以利用此漏洞。 此类特制文件可能包括在电子邮件附件中或宿主在恶意网站上。 在受影响的 Outlook 版本中查看或预览格式错误的电子邮件不会导致利用此漏洞。 攻击者可以通过构建特制的 Word 文件来利用此漏洞，此文件可能允许远程执行代码。
  
#### Word 格式错误的功能漏洞的缓解因素 - CVE-2007-0515：
  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。  
-   在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的 Word 文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问恶意网站。 相反，攻击者必须劝诱用户访问该网站，通常是让用户单击通向攻击者站点的链接。  
-   此漏洞无法通过电子邮件自动加以利用。 用户必须打开电子邮件附件，以电子邮件为载体的攻击才会得逞。  
-   如果 Office 2000 用户安装并使用 [Office 文档打开确认工具](https://www.microsoft.com/download/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f)，则在打开文档之前，系统将提示该用户**打开**、**保存**或**取消**。 Office 文档打开确认工具的功能包含在 Office XP 和 Office 2003 中。  
-   Microsoft Word 2002、Microsoft Word 2003 和 Microsoft Word Viewer 2003 不受此漏洞影响。  
-   Microsoft Office Word 2007 不受此漏洞影响。
  
#### Word 格式错误的功能漏洞的避免方法 - CVE-2007-0515：
  
-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Word 文件。 当用户打开文件时，攻击者就有可能利用此漏洞。  
-   使用 Word Viewer 2003 打开并查看文件。 Word Viewer 2003 不受此问题影响。 用户可以从 Microsoft 下载中心下载 [Microsoft Word Viewer 2003](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf)。
  
#### Word 格式错误的功能漏洞的常见问题解答 - CVE-2007-0515：
...
**造成漏洞的原因是什么？**    
Word 处理文件的内容时没有执行足够的数据验证。 当 Word 打开特制的 Word 文件并分析格式错误的功能时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 CVE-2007-0515。
...
-   必须安装 Office 2000 Service Pack 3 (SP3)。 在安装此更新之前，请安装 [Office 2000 SP3](https://www.microsoft.com/download/details.aspx?familyid=5c011c70-47d0-4306-9fa4-8e92d36332fe)。有关如何安装 Office 2000 SP3 的更多信息，请参阅 [Microsoft 知识库文章 326585](https://support.microsoft.com/default.aspx?scid=kb;%5bln%5d;326585)。
...
1.  [下载 Word 2000 的安全更新。](https://download.microsoft.com/download/e/e/2/ee2c73dd-a33c-4d79-bd50-f772cccce765/office2000-kb929139-fullfile-enu.exe)  
...
1.  [下载 Word 2002 的安全更新。](https://download.microsoft.com/download/d/0/9/d09d67ff-cba7-436e-88df-3db2327dee2a/officexp-kb929061-fullfile-enu.exe)  
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。  
3.  单击“**保存**”。  
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。  
5.  如果系统提示您安装更新，则单击“**是**”。  
...
-   要更新 Word Viewer 2003，必须安装 Word Viewer 2003 的最新版本。 [下载最新的 Word Viewer](https://www.microsoft.com/download/details.aspx?familyid=95e24c87-8732-48d5-8689-ab826e7b8fdf) 2003。
...
1.  [下载 Word 2003](https://download.microsoft.com/download/4/a/0/4a0bcc02-9b89-458b-8629-ac9da6d1e470/office2003-kb929057-fullfile-enu.exe) 和/或 [Word Viewer 2003 的安全更新](https://download.microsoft.com/download/0/d/7/0d7d95fa-12f1-4bb9-ba66-5fa99042e24a/office2003-kb924883-fullfile-enu.exe)。  
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。  
3.  单击“**保存**”。  
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。  
5.  如果系统提示您安装更新，则单击“**是**”。  
...
| 文件名       | 版本        | 日期               | 时间  | 大小      |  
|--------------|-------------|--------------------|-------|-----------|  
| Wordview.exe | 11.0.8125.0 | 2007 年 1 月 23 日 | 23:03 | 6,963,552 |
...
-   [Information and Communication Security Technology Center](https://www.icst.org.tw/) 的 Shih-hao Weng 报告了 Word 格式错误的字符串漏洞 (CVE-2006-5994)。  
-   [Information and Communication Security Technology Center](https://www.icst.org.tw/) 的 Shih-hao Weng 报告了 Word 格式错误的字符串漏洞 (CVE-2006-6456)。  
-   [USAA](https://www.usaa.com/) 报告了 Word 宏漏洞 CVE-2007-0208。

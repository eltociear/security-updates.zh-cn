---
TOCTitle: 'MS07-062'
Title: 'Microsoft 安全公告 MS07-062 - 重要'
ms:assetid: 'ms07-062'
ms:contentKeyID: 61237118
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms07-062(v=Security.10)'
---
...
这是针对所有受支持版本 Microsoft Windows 2000 Server 和 Windows Server 2003 的重要安全更新。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=c80fcd9b-d0f8-44db-96fc-bf2ead054ff4)                                            | 欺骗         | 重要             | [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=ed8e2cb4-bcd9-40fc-9ad6-46b364d0656d)                | 欺骗         | 重要             | [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d1323e14-ffa7-4d03-a2a7-9240c192a75e)                         | 欺骗         | 重要             | [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=f3ad67de-85ad-452d-a1e0-0af3faf969d6) | 欺骗         | 重要             | [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) |
...
<th style="border:1px solid black;">DNS 欺骗攻击漏洞 - CVE-2007-3898</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3898](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3898)。
  
#### DNS 欺骗攻击漏洞 - CVE-2007-3898的的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。
  
-   Microsoft 尚未发现此漏洞的任何缓解因素。
  
#### DNS 欺骗攻击漏洞 - CVE-2007-3898的的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。
  
-   Microsoft 并未发现此漏洞的任何变通办法。
  
#### DNS 欺骗攻击漏洞 - CVE-2007-3898的常见问题解答
  
**此漏洞的影响范围有多大？**    
Windows DNS 服务器中存在欺骗漏洞。 成功利用此漏洞的攻击者可能模拟合法的地址。
  
**造成漏洞的原因是什么？**    
Windows DNS 服务器服务在向上游 DNS 服务器发出查询时，不能在事务值随机选择上提供足够的熵。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以获得关于 DNS 服务器事务 ID 的信息，并使用该信息向 DNS 请求发送恶意响应，从而将 Internet 流量从合法位置重定向到攻击者选择的地址。
  
**攻击者如何利用此漏洞？**    
成功利用此漏洞的攻击者可以使用虚假或误导信息响应 DNS 查询，从而从合法位置重定向 Internet 通信量。
  
**是否可以通过 Internet 利用此漏洞？**    
是，攻击者可以通过将特定响应发送到执行递归查找的面向 Internet 的 DNS 服务器，通过 Internet 利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**    
此漏洞适用于执行递归查找的 Windows DNS 服务器。 有关递归查询的详细信息，请参阅关于 [DNS 查询如何工作](https://technet2.microsoft.com/windowsserver/en/library/0bcd97e6-b75d-48ce-83ca-bf470573ebdc1033.mspx?mfr=true)的 Technet 文章。
  
**此更新有什么作用？**    
此更新通过增大递归 DNS 服务器通讯中事务 ID 的随机性来消除此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB941672$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
...
对于 Microsoft Windows 2000 Service Pack 4 的所有受支持版本：
...
<p>对于 Windows Server 2003 所有受支持的基于 Itanium 的版本：</p>  
<p>WindowsServer2003-KB941672-ia64-enu /quiet</p>  
<p>对于 Windows Server 2003 所有受支持的基于 x64 的版本：</p>
...
<p>使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB941672$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关完整的文件清单，请参阅下一小节“<strong>文件信息</strong>”</td>
...
-   [Scanit](https://www.scanit.be/) 的 Alla Berzroutchko 报告了 DNS 欺骗攻击漏洞漏洞 (CVE-2007-3898)。
-   [Trusteer](https://www.trusteer.com/) 的 Amit Klein 报告了 DNS 欺骗攻击漏洞漏洞 (CVE-2007-3898)。

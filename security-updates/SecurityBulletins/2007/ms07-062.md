...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=c80fcd9b-d0f8-44db-96fc-bf2ead054ff4)                                            | 欺骗         | 重要             | [MS07-029](http://technet.microsoft.com/security/bulletin/ms07-029) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=ed8e2cb4-bcd9-40fc-9ad6-46b364d0656d)                | 欺骗         | 重要             | [MS07-029](http://technet.microsoft.com/security/bulletin/ms07-029) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d1323e14-ffa7-4d03-a2a7-9240c192a75e)                         | 欺骗         | 重要             | [MS07-029](http://technet.microsoft.com/security/bulletin/ms07-029) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=f3ad67de-85ad-452d-a1e0-0af3faf969d6) | 欺骗         | 重要             | [MS07-029](http://technet.microsoft.com/security/bulletin/ms07-029) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3898](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3898)。
...
**受此漏洞威胁最大的系统有哪些？**    
此漏洞适用于执行递归查找的 Windows DNS 服务器。 有关递归查询的详细信息，请参阅关于 [DNS 查询如何工作](http://technet2.microsoft.com/windowsserver/en/library/0bcd97e6-b75d-48ce-83ca-bf470573ebdc1033.mspx?mfr=true)的 Technet 文章。
...
-   [Scanit](http://www.scanit.be/) 的 Alla Berzroutchko 报告了 DNS 欺骗攻击漏洞漏洞 (CVE-2007-3898)。
-   [Trusteer](http://www.trusteer.com/) 的 Amit Klein 报告了 DNS 欺骗攻击漏洞漏洞 (CVE-2007-3898)。

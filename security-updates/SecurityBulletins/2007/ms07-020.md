...
-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=49dc470b-64e2-47ec-be90-622b407c7751)
-   Microsoft Windows XP Service Pack 2 - [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=e16ededa-6e8c-40d6-a3c0-d61362411acc)
-   Microsoft Windows XP Professional x64 Edition 和 Microsoft Windows XP Professional x64 Edition Service Pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=23909036-898f-41af-a3de-4a899a15d25d)
-   Microsoft Windows Server 2003、Microsoft Windows Server 2003 Service Pack 1 和 Microsoft Server 2003 Service Pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=281f10d2-d754-44cd-8318-9ce94b8d01b4)
-   Microsoft Windows Server 2003 x64 Edition 和 Microsoft Windows Server 2003 x64 Edition Service Pack 2 - [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=50469b54-b6ff-46ed-b2bc-3b00b0984e1e)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）、Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Microsoft Windows Server 2003 SP2（用于基于 Itanium 的系统）- [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=883660ca-e976-460f-8e50-c19d1b02b42f)
...
|-------------------------------------------------------------------------------------------------------------------|--------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| Microsoft Agent URL 分析漏洞 - [CVE-2007-1205](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1205)： | 远程执行代码 | 严重                                  | 严重                                | 中等                          | 中等                                         | 中等                                         |
...
**什么是 Microsoft Agent？**  
Microsoft Agent 是一个使用交互式动画字符指导用户的组件，让使用以及学习使用计算机更容易。 有关详细信息，请参阅 [Microsoft Agent 网站](https://www.microsoft.com/msagent/default.asp)。
...
是。 默认情况下，Windows Server 2003 上的 Internet Explorer 在受限模式下运行。 这称为[增强安全配置](https://msdn.microsoft.com/library/default.asp?url=/workshop/security/szone/overview/esc_changes.asp)。 此模式会将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此安全更新的“常见问题”部分。
...
**先决条件**
此安全更新需要 Windows XP Service Pack 2 或者 Windows XP Professional x64 Edition。 有关如何获得最新的 Windows XP Service Pack 的详细信息，请参阅 [Microsoft 知识库文章 322389](https://support.microsoft.com/kb/322389)。有关如何获得 Windows XP Professional x64 Edition Service Pack 2 的详细信息，请参阅下载中心。
...
-   [Secunia](https://secunia.com/) 的 JJ Reyes 和 Carsten Eiram 报告了 Microsoft Agent URL 分析漏洞 (CVE-2007-1205)。

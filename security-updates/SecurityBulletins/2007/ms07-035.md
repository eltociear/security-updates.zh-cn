...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|---------------------------------------------------------------------|
| [Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=3918ac76-ebb6-4886-9a9e-808eafb96b1b)                                                                               | 远程执行代码 | 严重             | [MS06-051](http://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=27c7f1b9-2d1d-40cb-ad7e-bfedb6156a9c)                                                                                 | 远程执行代码 | 严重             | [MS06-051](http://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0ba12191-1e6f-443b-9150-7ab8b2deb7c2)                 | 远程执行代码 | 严重             | [MS06-051](http://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d554dff4-bcfb-4bbc-8fa0-af2f939d2610)                                  | 远程执行代码 | 严重             | [MS06-051](http://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=170473d8-6bb1-4fbd-8494-a059dbfdf182)                         | 远程执行代码 | 严重             | [MS06-051](http://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=f5e45e3c-4cac-41a5-99f7-42c2c2c73e99) | 远程执行代码 | 严重             | [MS06-051](http://technet.microsoft.com/security/bulletin/ms06-051) |
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-2219](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2219)。
...
Microsoft Win 32 应用程序编程接口 (API) 提供所有基于 Windows 的应用程序使用的 32 位服务。 您可以向您的应用程序提供一个图形用户界面；访问内存和设备等系统资源；显示图形和格式文本；合并音频、视频、网络或安全。 有关详细信息，请参阅 [Microsoft 开发人员网络](http://msdn2.microsoft.com/en-us/library/aa383750.aspx)。
...
-   [VeriSign](http://www.verisign.com) 的 Billy Rios 报告了 Win32 API 漏洞 (CVE-2007-2219)。

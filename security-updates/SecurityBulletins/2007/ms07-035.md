---
TOCTitle: 'MS07-035'
Title: 'Microsoft 安全公告 MS07-035 - 严重'
ms:assetid: 'ms07-035'
ms:contentKeyID: 61237091
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms07-035(v=Security.10)'
---



Microsoft 安全公告 MS07-035 - 严重
==================================
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|---------------------------------------------------------------------|
| [Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=3918ac76-ebb6-4886-9a9e-808eafb96b1b)                                                                               | 远程执行代码 | 严重             | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=27c7f1b9-2d1d-40cb-ad7e-bfedb6156a9c)                                                                                 | 远程执行代码 | 严重             | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0ba12191-1e6f-443b-9150-7ab8b2deb7c2)                 | 远程执行代码 | 严重             | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d554dff4-bcfb-4bbc-8fa0-af2f939d2610)                                  | 远程执行代码 | 严重             | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=170473d8-6bb1-4fbd-8494-a059dbfdf182)                         | 远程执行代码 | 严重             | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=f5e45e3c-4cac-41a5-99f7-42c2c2c73e99) | 远程执行代码 | 严重             | [MS06-051](https://technet.microsoft.com/security/bulletin/ms06-051) |
...
<th style="border:1px solid black;">Win32 API 漏洞 - CVE-2007-2219</th>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-2219](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2219)。
  
#### Win32 API 漏洞 (CVE-2007-2219) 的缓解因素
...
#### Win32 API 漏洞 (CVE-2007-2219) 的变通办法
...
#### Win32 API 漏洞 (CVE-2007-2219) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以远程完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Win32 API 不能正确验证在函数调用中传递给它的参数。
  
**What is the Win 32 API？**    
Microsoft Win 32 应用程序编程接口 (API) 提供所有基于 Windows 的应用程序使用的 32 位服务。 您可以向您的应用程序提供一个图形用户界面；访问内存和设备等系统资源；显示图形和格式文本；合并音频、视频、网络或安全。 有关详细信息，请参阅 [Microsoft 开发人员网络](https://msdn2.microsoft.com/en-us/library/aa383750.aspx)。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以完全控制受影响的系统。
  
**攻击者如何利用此漏洞？**    
攻击者可能拥有一个旨在通过 Internet Explorer 利用此漏洞的特制网站，然后诱使用户查看该网站。 这还可以包括接受用户提供的内容或广告的网站、放置用户提供的内容或广告的网站以及受到破坏的网站。 这些网站可能包含可以利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 请求中的链接以使用户链接到攻击者的网站。
  
**受此漏洞威胁最大的系统有哪些？**    
此漏洞要求用户本地登录并运行特制的应用程序，或者用户登录并访问网站，才能使任何恶意操作得以运行。
  
因此，任何频繁使用 Internet Explorer 或者多个用户有权限本地登录的系统（如工作站或终端服务器）受此漏洞的威胁最大。
  
**此更新有什么作用？**    
此更新通过修改 Win API 验证在函数调用中传递给它的参数来消除此漏洞。
...
<td style="border:1px solid black;">Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB935839$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB935839$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关完整的文件清单，请参阅本节中的“<strong>文件信息</strong>”小节</td>
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2：<br />
使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB935839$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关完整的文件清单，请参阅本节中的“<strong>文件信息</strong>”小节</td>
...
-   [VeriSign](https://www.verisign.com) 的 Billy Rios 报告了 Win32 API 漏洞 (CVE-2007-2219)。

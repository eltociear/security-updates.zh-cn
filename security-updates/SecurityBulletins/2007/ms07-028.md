...
-   CAPICOM — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=ca930018-4a66-4da6-a6c5-206df13af316)
-   Platform SDK Redistributable: CAPICOM — [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=ca930018-4a66-4da6-a6c5-206df13af316)
-   BizTalk Server 2004 Service Pack 1 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=ca930018-4a66-4da6-a6c5-206df13af316)
-   BizTalk Server 2004 Service Pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=ca930018-4a66-4da6-a6c5-206df13af316)
...
|--------------------------------------------------------------------------------------------------------------|--------------|---------|-------------------------------|
| CAPICOM.Certificates 漏洞 - [CVE-2007-0940](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0940) | 远程执行代码 | 严重    | 严重                          |
...
有关 MBSA 的详细信息，请访问 [MBSA 网站](https://www.microsoft.com/technet/security/tools/mbsahome.mspx)。 有关 Microsoft Update 和 MBSA 2.0 当前不检测的软件的详细信息，请参阅 [Microsoft 知识库文章 895660](https://support.microsoft.com/kb/895660)。
...
CAPICOM.Certificates 是一种 ActiveX 控件，它向脚本程序（VBS、ASP、ASP.NET 等）提供一种方法，用于根据安全的基本 Windows CryptoAPI 功能加密数据。 CAPICOM 套件也可象 [Platform SDK Redistributable: CAPICOM](https://www.microsoft.com/download/details.aspx?familyid=860ee43a-a843-462f-abb5-ff88ea5896f6) 那样进行下载，也属于 Windows Platform SDK 和 Windows Driver Kit 的一部分。

**如果我开发应用程序或软件并重新分发 CAPICOM 该怎么办？**  
您需要下载最新版本的 [Platform SDK Redistributable: CAPICOM](https://www.microsoft.com/download/details.aspx?familyid=860ee43a-a843-462f-abb5-ff88ea5896f6)。 此新版本包含与此安全更新相关联的、经过更新的 CAPICOM.dll。
...
-   [VigilantMinds Inc.](https://www.vigilantminds.com/) 的 Chris Ries 报告了 CAPICOM.Certificates 漏洞 (CVE-2007-0940)

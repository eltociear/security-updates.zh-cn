...
**已知问题：** [Microsoft 知识库文章 939373](https://support.microsoft.com/kb/939373) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2005-4360](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2005-4360)。
...
-   **使用 URLScan 2.5**   
    安装 [URLScan](https://www.microsoft.com/technet/security/tools/urlscan.mspx) 有助于防止受影响的系统尝试利用此漏洞。  
    1.  使用默认 URLScan.ini 设置安装 URLScan。  
    2.  重新启动 IISAdmin 和 WWW 发布服务，更改才会生效。  
-   **为帮助防止攻击者试图基于网络利用此漏洞，请禁止使用下列各项来访问端口 80 (TCP)：**
  
    -   Windows 防火墙。  
    -   Internet 协议安全性 (IPSec)。 有关 IPSec 以及如何应用筛选器的详细信息，请参阅 [Microsoft 知识库文章 313190](https://support.microsoft.com/kb/313190) 和 [813878](https://support.microsoft.com/kb/813878)。
...
-   [Watchfire](https://www.watchfire.com/) 的 Jonathan Afek 和 Adi Sharabani 与 Microsoft 合作并提供关于 IIS 内存请求漏洞 (CVE-2005-4360) 的其他信息。
-   [NGSSoftware](https://www.ngssoftware.com/) 的 Peter Winter-Smith 与 Microsoft 合作并提供关于 IIS 内存请求漏洞 (CVE-2005-4360) 的其他信息。

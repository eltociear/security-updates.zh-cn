---
TOCTitle: 'MS07-022'
Title: 'Microsoft 安全公告 MS07-022 - 重要'
ms:assetid: 'ms07-022'
ms:contentKeyID: 61236885
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms07-022(v=Security.10)'
---



Microsoft 安全公告 MS07-022 - 重要
==================================

Windows 内核中的漏洞可能允许特权提升 (931784)
---------------------------------------------

发布时间: 2007年4月10日 | 更新时间: 2007年6月26日
...
-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=b3599afb-7673-4ef6-a2b1-d77e39fd782c)
-   Microsoft Windows XP Service Pack 2 - [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=eeaee4a7-4858-4b6b-9c6d-a9f1eae19b51)
-   Microsoft Windows Server 2003、Microsoft Windows Server 2003 Service Pack 1 和 Microsoft 2003 Service pack 2 — [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=5e94a29c-7ec0-4459-92eb-d43b524fd6fd)
...
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）以及 Microsoft Windows Server 2003 SP1 和 SP2（用于基于 Itanium 的系统）
-   Windows Vista
...
|---------------------------------------------------------------------------------------------------------|------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| 内核本地特权提升漏洞 - [CVE-2007-1206](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1206) | 特权提升   | 重要                                  | 重要                                | 重要                          | 重要                                         | 重要                                         |
...
**为什么 Microsoft 在 2007 年 6 月 26 日重新发布此公告？**  
Microsoft 已更新此公告，告知在 NEC 98 系统上安装了 Windows 2000 Service Pack 4 的客户现已提供安全更新的修订版本。 这些系统在尝试连接到 Windows Update 时可能遇到问题，因为 NEC 98 系统的安全更新内部版本不正确。 本安全公告已对成功消除了漏洞的原始安全更新作过介绍。

Microsoft 建议使用 Windows 2000 Service Pack 4 的 NEC 98 客户从 Microsoft 下载中心网站下载修订的安全更新，以确保 Windows Update 正确地提供将来的更新。 运行 Windows 2000 Service pack 4 的 NEC 98 客户也可以卸载此安全更新，以便自动从 Windows Update 接收修订的安全更新。

有关此问题的详细信息，请参阅 [Microsoft 知识库文章 931784](https://support.microsoft.com/kb/931784/)。[Microsoft 知识库文章 931784](https://support.microsoft.com/kb/931784/) 介绍了客户在安装此修订的安全更新时可能遇到的当前已知问题。

**此版本替代哪些更新？**  
此安全更新取代以前的一个安全更新。 下表列出了相应的安全公告 ID 和受影响的操作系统。

| 公告 ID                                                                 | Microsoft Windows 2000 Service Pack 4 | Microsoft Windows XP Service Pack 2 | Microsoft Windows Server 2003 | Microsoft Windows Server 2003 Service Pack 1 | Microsoft Windows Server 2003 Service Pack 2 |
|-------------------------------------------------------------------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| [**MS06-049**](https://technet.microsoft.com/security/bulletin/ms06-049) | 已取代                                | 不适用                              | 不适用                        | 不适用                                       | 不适用                                       |
...
#### 内核本地特权提升漏洞 (CVE-2007-1206) 的变通办法：

我们并未发现此漏洞的任何变通办法。

#### 内核本地特权提升漏洞 (CVE-2007-1206) 的常见问题：

**为什么重新提供此公告？**  
在 NEC 98 计算机上运行 Windows 2000 的客户无法正确地收到修订的安全更新 931784。为解决此问题，Microsoft 重新发布了此公告。 仅运行 NEC 98 计算机的客户受此重发版本的影响，所有其他客户不受影响。

**此漏洞的影响范围有多大？**  
由于映射的内存段上的权限不正确，Windows 内核中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 要尝试利用此漏洞，攻击者必须能够本地登录到系统。

**造成漏洞的原因是什么？**  
Windows 内核在映射内存段时允许使用不正确的权限。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者能够使用提升的特权在用户系统上运行恶意代码。 这可能使攻击者能够完全控制受影响的系统。
...
**此更新有什么作用？**  
此更新通过修改 Windows 内核在映射内存期间验证权限的方式来消除此漏洞。
...
**注意** 使用 **/quiet** 开关将抑制所有消息。 这包括抑制失败消息。 管理员应该使用其中一种支持的方法，验证使用 **/quiet** 开关时安装是否成功。 管理员还应该检查 KB931784.log 文件，查看使用此开关时的任何失败消息。
...
系统管理员也可以使用 Spuninst.exe 实用工具删除此安全更新。 Spuninst.exe 实用工具位于 %Windir%\\$NTUninstallKB931784$\\Spuninst 文件夹中。
...
-   **注册表项验证**
    ...
    **注意** 此注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 931784 安全更新集成或组合到 Windows 安装源文件中，则可能无法正确创建此注册表项。

#### Windows XP（所有版本）

**先决条件**
此安全更新需要 Windows XP Service Pack 2。有关如何获得最新的 Windows XP Service Pack 的详细信息，请参阅 Microsoft 知识库文章 322389。有关如何获得 Windows XP Professional Service Pack 2 的详细信息，请参阅[下载中心](https://www.microsoft.com/download/details.aspx?familyid=893fd6c0-6283-44c3-bb84-b2f0315b2ae6&displaylang=en)。
...
-   **注册表项验证**
    ...
    **注意** 这些注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 931784 安全更新集成或组合到 Windows 安装源文件中，则可能无法正确创建这些注册表项。
...
-   [eEye](https://www.eeye.com/) 报告了内核本地特权提升漏洞 (CVE-2007-1206)。

**获取其他安全更新：**

可从以下位置获得针对其他安全问题的更新：

-   [Microsoft 下载中心](https://go.microsoft.com/fwlink/?linkid=21129)提供了安全更新。 通过输入关键字“安全修补程序”可以非常方便地找到些更新。
...
-   V2.0（2007 年 6 月 26 日）：已更新此公告，告知在 NEC 98 系统上运行 Windows 2000 Service Pack 4 的客户现已提供安全更新的修订版本。

...
**已知问题：** [Microsoft 知识库文章 921503](https://support.microsoft.com/kb/921503) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|------------------|
| [Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=5c35b6e8-732a-4451-b5d4-23ed63e6e792)                                                             | 远程执行代码 | 严重             | 无               |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=6e8de050-8589-4831-ae19-075c93509485)                                                               | 远程执行代码 | 严重             | 无               |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b85bb583-dc61-4d37-b458-208f5bb07ece)                 | 远程执行代码 | 严重             | 无               |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=15d4d4fa-9bab-4da5-978e-f89c78c8086a)                | 远程执行代码 | 中等             | 无               |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6608d722-3ef8-4085-b771-7b17bb0ba06e)                         | 远程执行代码 | 中等             | 无               |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=fc04451a-0696-4a21-b2b6-f02d4e2c33bf) | 远程执行代码 | 中等             | 无               |
| [Microsoft Office 2004 for Mac](https://www.microsoft.com/mac/downloads.aspx)                                                                                                                               | 远程执行代码 | 严重             | 无               |
| [Microsoft Visual Basic 6.0 Service Pack 6 (KB924053)](https://www.microsoft.com/download/details.aspx?familyid=e1646fb0-29d5-4a6e-a8d2-304c4d7735b7)                                                      | 远程执行代码 | 严重             | 无               |
...
[Microsoft 知识库文章 921503](https://support.microsoft.com/kb/921503) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
<th style="border:1px solid black;">OLE 自动化内存损坏漏洞 (CVE-2007-2224)</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-2224](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-2224)。
...
Visual Basic 6.0 是唯一受此安全更新影响的开发平台。 本公告提供了为 Visual Basic 6.0 Service Pack 6 [下载](https://www.microsoft.com/download/details.aspx?familyid=)更新的链接。鼓励开发人员在使用共享组件时遵循建议的最佳做法。 有关使用共享组件的最佳做法的详细信息，请参阅关于独立应用程序的 [Microsoft 知识库文章 835322](https://support.microsoft.com/kb/835322)。
  
**如果第三方应用程序使用或安装受影响的 OLE 组件，那么安装所有需要的 Microsoft 安全更新之后是否仍然容易受到攻击？**    
否，此安全更新替换并重新注册随操作系统提供的受影响的 OLE 组件。 如果第三方应用程序遵循建议的最佳实践，即将共享组件用作并列组件，那么它们也不会受到影响。 [Microsoft 知识库文章 921503](https://support.microsoft.com/kb/921503) 也包含就某些客户希望手动检查已注册的受影响 OLE 组件而提供的说明。 鼓励客户联系第三方解决方案开发商以获取详细信息。
...
MBSA 1.2.1 不支持检测受此安全更新影响的某些平台。 客户可以使用企业更新扫描工具，而不使用 MBSA 1.2.1。有关本月发行的 EST 版本的下载链接和详细信息，请参阅 [Microsoft 知识库文章 894193](https://support.microsoft.com/kb/894193)。SMS 客户也应参阅标题 **Systems Management Server** 获取有关 SMS 和 EST 的详细信息。
...
[iDefense](https://idefense.com/) 报告了 OLE 自动化内存损坏漏洞 (CVE-2007-2224)。

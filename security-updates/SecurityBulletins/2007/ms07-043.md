...
Visual Basic 6.0 是唯一受此安全更新影响的开发平台。 本公告提供了为 Visual Basic 6.0 Service Pack 6 [下载](https://www.microsoft.com/download/details.aspx?familyid=)更新的链接。鼓励开发人员在使用共享组件时遵循建议的最佳做法。 有关使用共享组件的最佳做法的详细信息，请参阅关于独立应用程序的 [Microsoft 知识库文章 835322](http://support.microsoft.com/kb/835322)。

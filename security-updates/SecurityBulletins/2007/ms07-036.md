...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-023">MS07-023</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/mac/downloads.aspx?pid=download&amp;location=/mac/download/office2004/office2004_1136.xml&amp;secid=4&amp;ssid=35&amp;flgnosysreq=true">Microsoft Office 2004 for Mac</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-023">MS07-023</a></td>
</tr>  
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-1756](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1756)。
...
-   **当打开来自未知来源或不可信来源的文件时使用 Microsoft Office Isolated Conversion Environment (MOICE)。**
    ...
    适用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包新增了 Microsoft Office Isolated Conversion Environment (MOICE)，用于更安全地打开 Word、Excel 和 PowerPoint 二进制文件格式。 有关 MOICE 的详细信息，请参阅下列 [Microsoft 知识库 935865](https://support.microsoft.com/kb/935865)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3029](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3029)。
...
-   **当打开来自未知来源或不可信来源的文件时使用 Microsoft Office Isolated Conversion Environment (MOICE)。**
    ...
    Microsoft Office Isolated Conversion Environment (MOICE) 功能随适用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包附带提供，用于更安全地打开 Word、Excel 和 PowerPoint 二进制文件格式。 有关 MOICE 的详细信息，请参阅下列 [Microsoft 知识库 935865](https://support.microsoft.com/kb/935865)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3030](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3030)。
...
-   **当打开来自未知来源或不可信来源的文件时使用 Microsoft Office Isolated Conversion Environment (MOICE)。**
    ...
    适用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包新增了 Microsoft Office Isolated Conversion Environment (MOICE) 功能，用于更安全地打开 Word、Excel 和 PowerPoint 二进制文件格式。 有关 MOICE 的详细信息，请参阅下列 [Microsoft 知识库 935865](https://support.microsoft.com/kb/935865)。
...
**注意** MBSA 1.2.1 使用 Office 检测工具 (ODT) 的综合版，它不支持对此安全更新进行远程扫描。 有关 MBSA 的详细信息，请访问 MBSA 网站 &lt;[https://go.microsoft.com/fwlink/?LinkId=21134](https://go.microsoft.com/fwlink/?linkid=21134)&gt;。
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加/删除程序”工具。
<p><strong>注意</strong> 当删除此更新时，系统可能提示您在光驱中插入 2007 Microsoft Office System CD。 另外，您可能没有从控制面板“添加/删除程序”工具中卸载更新的选项。 此问题有诸多可能的原因。 有关删除的详细信息，请参阅 <a href="https://support.microsoft.com/kb/903771">Microsoft 知识库文章 903771</a>。</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关完整的文件清单，请参阅本节中的“<strong>文件信息</strong>”小节</td>

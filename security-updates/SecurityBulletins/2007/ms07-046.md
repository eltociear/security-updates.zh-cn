...
|----------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=8fc8340b-c2b3-4559-835c-caa00cf086b9) | 远程执行代码 | 严重             | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=dc29475d-c0bb-4d35-8dd6-4ca1cac32315)             | 远程执行代码 | 严重             | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| [Windows XP Professional x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=3c81730a-981a-4649-b2d9-45144230d512)                     | 远程执行代码 | 严重             | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| [Windows Server 2003 Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=5374583d-de68-4d65-bca8-598d6b98b8b3)    | 远程执行代码 | 严重             | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| [Windows Server 2003 x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=c3359f27-e03e-4a4f-b896-3bda39f69f7e)                         | 远程执行代码 | 严重             | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=92822479-2060-4357-a340-ed096f180b2b)      | 远程执行代码 | 严重             | [MS06-001](https://technet.microsoft.com/security/bulletin/ms06-001) |
...
<th style="border:1px solid black;">GDI 中的远程执行代码漏洞 - CVE-2007-3034</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3034](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3034)。
...
-   [eEye Digital Security](https://www.eeye.com/html/index.html) 报告了 GDI 中的远程执行代码漏洞 – CVE-2007-3034。

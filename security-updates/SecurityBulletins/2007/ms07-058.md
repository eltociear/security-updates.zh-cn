...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=6c7fb9a8-1d8d-4307-b5c6-bc6c28ee09de)                                                                     | 信息泄露     | 低               | [MS06-031](https://technet.microsoft.com/security/bulletin/ms06-031) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1fee539c-ab86-4298-b6f4-22ce31ee7b8b)                                                                                 | 拒绝服务     | 重要             | 无                                                                  |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ac7bd100-0a03-426b-adc8-0516c602a280)                 | 拒绝服务     | 重要             | 无                                                                  |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=011593a0-f37e-4578-bee1-a985639b521b)                                  | 拒绝服务     | 重要             | 无                                                                  |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e9bb8df5-f39e-4473-9d0c-e84430c7f859)                         | 拒绝服务     | 重要             | 无                                                                  |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=492ae87c-047c-45c1-ad04-ee36352de85b) | 拒绝服务     | 重要             | 无                                                                  |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=ceca7f8c-7b56-48fc-8c17-87ffadf25629)                                                                                             | 拒绝服务     | 重要             | 无                                                                  |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=7625f5a4-2921-41ce-986d-4cc0c264135c)                                                                                 | 拒绝服务     | 重要             | 无                                                                  |
...
<th style="border:1px solid black;">RPC 身份验证漏洞 CVE-2007-2228</th>
...
要完成任何远程过程调用，所有分布式应用程序必须在客户端和服务器之间创建一个绑定。 Microsoft RPC 提供多种级别的身份验证。 根据身份验证级别，可在连接建立时、客户端开始一个新远程过程调用，或者在客户端和服务器之间的每次数据包交换期间验证通信量的来源（发送通信量的安全主体）。 有关 RPC 和 RPC 身份验证的更多信息，请参见下面的[MSDN 文章](https://msdn2.microsoft.com/en-us/library/aa378646.aspx)。
...
是。 攻击者可能试图通过 Internet 来利用此漏洞。 采用防火墙最佳做法和标准默认防火墙配置，有助于保证免受来自 Internet 的攻击。 Microsoft 提供了关于如何帮助保护您的系统的信息。 终端用户可以访问[家庭安全](https://go.microsoft.com/fwlink/?linkid=85102)。 IT 专业人士可以访问 [TechNet 安全中心](https://go.microsoft.com/fwlink/?linkid=21171)。
...
-   [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了 Windows RPC 身份验证漏洞 (CVE-2007-2228)。

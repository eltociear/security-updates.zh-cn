---
TOCTitle: 'MS07-060'
Title: 'Microsoft 安全公告 MS07-060 - 严重'
ms:assetid: 'ms07-060'
ms:contentKeyID: 61237116
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms07-060(v=Security.10)'
---



Microsoft 安全公告 MS07-060 - 严重
==================================
...
这是 Microsoft Office 2000、Microsoft Office XP 和 Microsoft Office 2004 for Mac 所有受支持版本的严重安全更新。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。
...
|------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|----------------------------------------------------------|
| Microsoft Office 2000 Service Pack 3                                         | [Microsoft Word 2000 Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=8b3072fb-5933-47f7-a498-13a93e268e57) | 远程执行代码 | 严重             | [MS07-024](https://go.microsoft.com/fwlink/?linkid=85636) |
| Microsoft Office XP Service Pack 3                                           | [Microsoft Word 2002 Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=d6b787bb-03ff-4f67-8b69-6011fb18ba75) | 远程执行代码 | 重要             | [MS07-024](https://go.microsoft.com/fwlink/?linkid=85636) |
| [Microsoft Office 2004 for Mac](https://www.microsoft.com/mac/downloads.aspx) |                                                                                                                                     | 远程执行代码 | 重要             | [MS07-024](https://go.microsoft.com/fwlink/?linkid=85636) |
...
<th style="border:1px solid black;">Word 内存损坏漏洞 - CVE-2007-3899</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3899](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3899)。
  
#### Word 内存损坏漏洞 (CVE-2007-3899) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   不能在 2007 Microsoft Office system 上利用该漏洞。  
-   不能作为远程执行代码在 Microsoft Office 2003 上利用该漏洞。 但是，Microsoft Office 2003 可能意外退出。  
...
#### Word 内存损坏漏洞 (CVE-2007-3899) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Office 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。
  
#### Word 内存损坏漏洞 (CVE-2007-3899) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可能使用与登录用户相同的特权运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
...
**此更新有什么作用？**    
该更新通过修改 Microsoft Word 在打开文件时验证内容的方式来消除此漏洞。
...
-   您的计算机上必须安装 [Microsoft Office 2004 for Mac 11.3.7 更新](https://www.microsoft.com/download/details.aspx?familyid=f151bc90-e985-4cdf-aea7-285920693f26)。  
-   700 MHz 本机 PowerPC G3、G4 或 G5 处理器（不支持 Intel 处理器）上的 Mac OS X 10.2.8 或更高版本的 Mac OS  
-   Mac OS X 用户帐户必须拥有管理特权才能安装此安全更新。
  
**安装更新**
  
从 [Microsoft Mactopia 网站](https://www.microsoft.com/mac/downloads.aspx?pid=download&location=/mac/download/office2004/office2004_1138.xml&secid=4&ssid=35&flgnosysreq=true)下载和安装 Microsoft Office 2004 for Mac 11.3.8 更新合适的语言版本。
...
-   Information and Communication Security Technology Center 的 Liu Kun-Hao 报告了 Word 内存损坏漏洞 (CVE-2007-3899)。
...
-   V1.1（2007 年 10 月 10 日）： 已更新公告： 已更新了 Microsoft Mactopia 网站的超链接，以更正“部署信息”部分中 11.3.8 更新的下载位置。

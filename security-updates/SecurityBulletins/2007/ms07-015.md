---
TOCTitle: 'MS07-015'
Title: 'Microsoft 安全公告 MS07-015 - 严重'
ms:assetid: 'ms07-015'
ms:contentKeyID: 61236871
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms07-015(v=Security.10)'
---



Microsoft 安全公告 MS07-015 - 严重
==================================

Microsoft Office 中的漏洞可能允许远程执行代码 (932554)
------------------------------------------------------
...
-   Microsoft Office 2000 Service Pack 3 — [下载此更新 (KB929062)](https://www.microsoft.com/download/details.aspx?familyid=20e089e7-7dd3-44a4-abfe-6d8c27721683)
    ...
    -   Microsoft Word 2000
-   Microsoft Office XP Service Pack 3 — [下载此更新 (KB926063)](https://www.microsoft.com/download/details.aspx?familyid=c54b1fda-1237-48f7-ad19-f0830ee0e8ff)
    ...
    -   Microsoft Word 2002
-   Microsoft Office 2003 Service Pack 2 — [下载此更新 (KB929064)](https://www.microsoft.com/download/details.aspx?familyid=bb0973e7-275d-4491-9ba1-91eaea84eefd)
...
-   Microsoft Project 2000 Service Release 1 — [下载此更新 (KB929062)](https://www.microsoft.com/download/details.aspx?familyid=3df54b5c-cb82-4a99-9b90-edab38ad6310)
-   Microsoft Project 2002 Service Pack 1 — [下载此更新 (KB929063)](https://www.microsoft.com/download/details.aspx?familyid=419191dc-01b8-4e2a-ba5b-71bf3066c169)
-   Microsoft Visio 2002 Service Pack 2 — [下载此更新 (KB929063)](https://www.microsoft.com/download/details.aspx?familyid=f50a5111-0926-4221-96df-18294230ed1e)
...
|--------------------------------------------------------------------------------------------------------------------------|--------------|-----------------------|---------------------|-----------------------|-------------------------------|
| PowerPoint 格式错误的记录内存损坏漏洞 - [CVE-2006-3877](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3877) | 远程执行代码 | 严重                  | 重要                | 重要                  | 重要                          |
| Excel 格式错误的记录漏洞 - [CVE-2007-0671](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0671)              | 远程执行代码 | 严重                  | 重要                | 重要                  | 重要                          |
...
| 公告 ID                                                                 | Microsoft Office 2000 | Microsoft Office XP | Microsoft 2003 | Microsoft Office 2004 for Mac |
|-------------------------------------------------------------------------|-----------------------|---------------------|----------------|-------------------------------|
| [**MS06-062**](https://technet.microsoft.com/security/bulletin/ms06-062) | 已替代                | 已替代              | 已替代         | 已替代                        |

**此更新与 MS06-058 有什么联系？**  
对原先在 MS06-058 中详细描述的 CVE-2006-3877 的深入研究显示，该更新无法从受影响系统上有效地消除漏洞。 此安全公告是为解决 CVE-2006-3877 而发布的，用户应立即应用此公告中的更新。

**为何此更新取代的是 MS06-062 而非 MS06-058？**  
对 CVE-2006-3877 的深入研究显示，PowerPoint.exe 中的漏洞未能得到有效修复。 已发布此更新并将安装一种 MSO.dll 版本，它能有效地解决 CVE-2006-3877。因为此安全公告是一项 MSO.dll 更新，它取代了先前的 MSO.Dll 更新 MS06-062。
...
-   PowerPoint 2003 Viewer 不受此漏洞影响。
...
Excel 中存在一个远程执行代码漏洞，当 Excel 打开特制文件时，该漏洞可能被利用。 此类文件可能包括在电子邮件附件中或宿主在恶意网站上。 攻击者可以通过构建特制的 Excel 文件来利用此漏洞，此文件可能允许远程执行代码。

如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

#### Excel 格式错误的记录漏洞 (CVE-2007-0671) 的缓解因素：
...
#### Excel 格式错误的记录漏洞 (CVE-2007-0671) 的变通办法：

-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 格式错误的记录漏洞 (CVE-2007-0671) 的常见问题解答：

**此漏洞的影响范围有多大？**  
Excel 中存在一个远程执行代码漏洞，当 Excel 打开包含格式错误的记录时，该漏洞可能会被利用。 此类文件可能包括在电子邮件附件中或宿主在恶意网站上。 攻击者可以通过构建特制的 Excel 文件来利用此漏洞，此文件可能允许远程执行代码。

如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成漏洞的原因是什么？**  
当 Excel 打开特制的 Excel 文件时，会引起该漏洞。该文件将导致在分析占位符数据时访问预期区域之外的内存。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已将此漏洞分配为“常见漏洞”并分配了披露号码 CVE-2007-0671。
...
-   要安装 Project 2000 Service Release 1 (SR1) 更新，则必须安装 Project 2000 Service Release 1 (SR1)。 安装此更新之前，请安装 Project 2000 SR1。有关如何安装 Project 2000 SR1 的详细信息，请参阅 [Microsoft 知识库文章 288953](https://support.microsoft.com/kb/288953)。
...
1.  [下载 Office 2000 的此项安全更新](https://download.microsoft.com/download)和/或 [Project 2000 Service Pack 1](https://download.microsoft.com/download/7/e/0/7e09640b-1bfb-426a-87e9-2c452d458560/project2000-kb929062-fullfile-enu.exe)。
...
-   必须安装 Office XP Service Pack 3 (SP3)。 在安装此更新之前，请安装 [Office XP SP3](https://www.microsoft.com/download/details.aspx?familyid=85af7bfd-6f69-4289-8bd1-eb966bcdfb5e)。有关如何安装 Office XP SP3 的更多信息，请参阅 [Microsoft 知识库文章 832671](https://support.microsoft.com/kb/832671)。
-   要安装 Project 2002 Service Pack 1 (SP1) 更新，则必须安装 Project 2002 Service Pack 1 (SP1)。 在安装此更新前，请先安装 Project 2000 SR1。有关如何安装的更多信息请参阅 [Project 2002 Service Pack 1 (SP1)。](https://www.microsoft.com/download/details.aspx?familyid=d64ea65b-9519-4061-9b3a-32af1a9bf888)
...
1.  [下载 Office XP](https://download.microsoft.com/download/a/8/1/a81b5bde-c873-44a6-8eab-026139ab8c47/officexp-kb929063-fullfile-enu.exe) 和/或 [Project 2002 Service Pack 1](https://download.microsoft.com/download/5/2/3/5238f1f9-f4bb-45ea-ad83-b84f4434895c/project2002-kb929063-fullfile-enu.exe) 和/或 [Visio 2002 Service Pack 2](https://download.microsoft.com/download/1/1/3/113f4037-a4d1-4af8-a5b3-dac87e255808/visio2002-kb929063-fullfile-enu.exe) 的安全更新。
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
1.  [下载 Office 2003 的安全更新。](https://download.microsoft.com/download/1/e/9/1e99615b-adca-4722-9bc6-4069ace587d9/office2003-kb929064-fullfile-enu.exe)
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
-   [VigilantMinds Inc.](https://www.microsoft.com/technet/security/bulletin/www.vigilantminds.com) 的 Chris Ries 报告了 PowerPoint 格式错误的记录内存损坏漏洞 (CVE-2006-3877)。

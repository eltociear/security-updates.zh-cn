...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-5350](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5350)。
...
**注意** 有关受支持版本的完整列表，请参阅技术支持生命周期索引。 关于 Service Pack 的完整列表，请参阅[生命周期支持的 Service Pack](https://support.microsoft.com/gp/lifesupsps)。 有关技术支持生命周期策略的详细信息，请参阅 [Microsoft 技术支持生命周期](https://support.microsoft.com/lifecycle/)。
...
-   [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 报告了 Windows 内存漏洞 (CVE-2007-5350)。

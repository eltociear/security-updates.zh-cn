...
<td style="border:1px solid black;">
[**Windows DNS 释放后使用漏洞 - CVE-2015-6125**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-6125)
...
<td style="border:1px solid black;">
[MS12-017](https://technet.microsoft.com/zh-cn/security/bulletin/ms12-017) 中的 2647170
...
**注意** Windows Server Technical Preview 3 和 Windows Server Technical Preview 4 均会受到影响。 鼓励运行该操作系统的客户应用此更新，此更新通过 [Windows 更新](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-cn)提供。

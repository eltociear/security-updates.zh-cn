...
<sup>[1]</sup>只有在安装了[桌面体验](https://technet.microsoft.com/zh-cn/library/cc772567.aspx)功能的情况下，运行 Windows Server 2008、Windows Server 2008 R2、Windows Server 2012 或 Windows Server 2012 R2 的系统才会受到影响。 如果没有安装“桌面体验”功能，则不会向这些系统提供更新。
...
<td style="border:1px solid black;">
[**WebDAV 特权提升漏洞 - CVE-2015-0011**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-0011)

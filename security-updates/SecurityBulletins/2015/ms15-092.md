...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.6](https://www.microsoft.com/zh-cn/download/details.aspx?id=48450)  
(3083186)
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.6](https://www.microsoft.com/zh-cn/download/details.aspx?id=48461)  
(3083184)
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 4.6](https://www.microsoft.com/zh-cn/download/details.aspx?id=48460)  
(3083185)
...
<td style="border:1px solid black;">
[**RyuJIT 优化特权提升漏洞 - CVE-2015-2479**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-2479)

</td>
<td style="border:1px solid black;">
[**RyuJIT 优化特权提升漏洞 - CVE-2015-2480**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-2480)

</td>
<td style="border:1px solid black;">
[**RyuJIT 优化特权提升漏洞 - CVE-2015-2481**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-2481)
...
-   V1.2（2015 年 9 月 25 日）：向“受影响的软件”表添加了一个脚注以通知客户 Windows Server Technical Preview 2 受到影响。鼓励运行该操作系统的客户应用此更新，此更新通过 [Windows 更新](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-cn)提供。

...
<td style="border:1px solid black;">
[Internet Explorer 9](https://www.microsoft.com/download/details.aspx?familyid=a5572d37-3020-4f14-b3cf-492b3a2fc861)  
(3078071)
...
<td style="border:1px solid black;">
[Internet Explorer 11](https://www.microsoft.com/download/details.aspx?familyid=31a2541e-7d4d-452d-b059-228744ada709)  
(3078071)
...
\*在取代的更新链中，“替代的更新”列仅显示最新的更新。有关替代的更新的完整列表，请转到 [Microsoft 更新目录](https://catalog.update.microsoft.com/v7/site/home.aspx)，搜索更新知识库编号，然后查看更新详细信息（替代的更新信息位于“程序包详细信息”选项卡）。此更新仅通过 Windows 更新目录提供。有关更多信息和下载链接，请参阅 [Microsoft 知识库文章 3081436](https://support.microsoft.com/zh-cn/kb/3081436)。
...
是。若要免受 CVE-2015-2423 侵害，客户必须将本公告中提供的所有更新应用于其受影响软件，以及 [MS15-081](https://go.microsoft.com/fwlink/?linkid=619678) 中提供的 Microsoft Office 更新。同样，运行受影响 Microsoft Windows 版本的客户必须还要安装 [MS15-088](https://go.microsoft.com/fwlink/?linkid=619622) 中提供的适用更新。没有为其受影响软件安装所有可用更新的客户将不会得到针对此漏洞的完整保护。
...
**重要**若要免受此漏洞侵害，客户必须应用本公告中提供的更新，以及 [MS15-088](https://go.microsoft.com/fwlink/?linkid=619632) 中提供的 Windows 更新。同样，运行受影响 Microsoft Office 产品的客户必须还要应用 [MS15-081](https://go.microsoft.com/fwlink/?linkid=619678) 中提供的适用更新。没有为其受影响软件安装所有可用更新的客户将不会得到针对此漏洞的完整保护。

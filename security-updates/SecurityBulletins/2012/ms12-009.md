---
TOCTitle: 'MS12-009'
Title: 'Microsoft 安全公告 MS12-009 - 重要'
ms:assetid: 'ms12-009'
ms:contentKeyID: 61238351
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-009(v=Security.10)'
---

Microsoft 安全公告 MS12-009 - 重要
==================================

辅助功能驱动程序中的漏洞可能允许特权提升 (2645640)
--------------------------------------------------
...
对于 Windows XP（不包括基于 x86 的系统）、Windows Server 2003、Windows Vista（不包括基于 x86 的系统）、Windows Server 2008（不包括基于 x86 的系统）、Windows 7（不包括基于 x86 的系统）和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过更正 AFD 在将输入从用户模式传递到 Windows 内核之前验证输入的方式来解决这些漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。

**建议。** 大多数客户均启用了“自动更新”，他们不必采取任何操作，因为此安全更新将自动下载并安装。尚未启用“自动更新”的客户必须检查更新，并手动安装此更新。有关自动更新中特定配置选项的信息，请参阅 [Microsoft 知识库文章 294871](https://support.microsoft.com/kb/294871)。Microsoft 建议客户使用更新管理软件尽早应用此更新或者利用 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 服务检查更新。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=82f5c503-d2ea-4fed-8f9d-f30bee2f60b3)                                                                  | 特权提升     | 重要         | [MS11-080](https://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5ee4bef7-b355-4aae-8bba-834a16d44744)                                                                                  | 特权提升     | 重要         | [MS11-080](https://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b53cf810-0ea3-4cb0-91f9-de1406ccfc96)                                                                      | 特权提升     | 重要         | [MS11-080](https://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=3b18d22d-e192-498b-a105-b946a5f5bfad)                                                                  | 特权提升     | 重要         | [MS11-080](https://go.microsoft.com/fwlink/?linkid=227486) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=73e240a6-2d5e-4ceb-8500-8dacca0e4a43)                                                                            | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0e06e77d-7e5d-4d57-98b2-0817f68a1ebb)\*                                                          | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=56cbeba9-0c39-4418-9042-7244ac9d03db)                                                        | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=299d107d-ab9f-42b6-8f94-a2f1d242c127)                                   | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=576192d3-f050-4718-a7da-c84fce6bf744)\*       | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d6a9b2c9-7582-4953-8ab1-a55c63fcc8dc) | 特权提升     | 重要         | [MS11-046](https://go.microsoft.com/fwlink/?linkid=217464) |
...
**为什么在此公告中 Windows Server 2003 Service Pack 2 是唯一受影响的 Windows 的 32 位版本？** **  
**此安全更新可解决两个漏洞，即 CVE-2012-0148 和 CVE-2012-0149。前者不影响 Windows 的任何 32 位版本，而后者仅影响 Windows Server 2003 的受支持版本，包括 32 位版本。因此，Windows Server 2003 Service Pack 2 是此公告中作为受影响的软件列出的唯一一个 Windows 的 32 位版本。
...
<th style="border:1px solid black;">AfdPoll 特权提升漏洞 - CVE-2012-0148</th>
<th style="border:1px solid black;">辅助功能驱动程序特权提升漏洞 - CVE-2012-0149</th>
...
AfdPoll 特权提升漏洞 - CVE-2012-0148  
------------------------------------
  
<span></span>  
辅助功能驱动程序 (afd.sys) 错误地验证从用户模式传递到 Windows 内核的输入的方式中存在一个特权提升漏洞。该漏洞能够允许攻击者使用提升的特权运行代码。成功利用此漏洞的本地攻击者可执行任意代码，并可完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0148](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0148)。
  
#### AfdPoll 特权提升漏洞 (CVE-2012-0148) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。  
-   在 Microsoft Windows 的 32 位版本上，此漏洞不可利用。
  
#### AfdPoll 特权提升漏洞 (CVE-2012-0148) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### AfdPoll 特权提升漏洞 (CVE-2012-0148) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**造成此漏洞的原因是什么？**  
如果 afd.sys 驱动程序在从用户模式接收数据时未正确验证输入，则会导致该漏洞。
...
**什么是传输驱动程序界面 (UI)？**  
该传输驱动程序界面 (TDI) 定义了出现在所有传输协议堆栈上边缘的内核模式网络界面。每个堆栈中最高级别的协议驱动程序支持用于更高级内核模式网络客户端的 TDI 界面。有关 TDI 组件的详细信息，请参阅 MSDN 文章“[传输驱动程序界面](https://msdn.microsoft.com/en-us/library/ff565685.aspx)”。
...
**此更新有什么作用？**  
此更新通过更正 AFD 在将输入从用户模式传递到 Windows 内核之前验证输入的方式来解决此漏洞。
...
辅助功能驱动程序特权提升漏洞 - CVE-2012-0149  
--------------------------------------------
  
<span></span>  
辅助功能驱动程序 (afd.sys) 错误地验证从用户模式传递到 Windows 内核的输入的方式中存在一个特权提升漏洞。该漏洞能够允许攻击者使用提升的特权运行代码。成功利用此漏洞的本地攻击者可执行任意代码，并可完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0149](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0149)。
  
#### 辅助功能驱动程序特权提升漏洞 (CVE-2012-0149) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### 辅助功能驱动程序特权提升漏洞 (CVE-2012-0149) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### 辅助功能驱动程序特权提升漏洞 (CVE-2012-0149) 的常见问题
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2645640$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2645640">Microsoft 知识库文章 2645640</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2645640$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2645640](https://support.microsoft.com/kb/2645640)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Azimuth Security](https://www.azimuthsecurity.com/) 的 Tarjei Mandt 报告了 AfdPoll 特权提升漏洞 (CVE-2012-0148)  
-   [Azimuth Security](https://www.azimuthsecurity.com/) 的 Tarjei Mandt 报告了 AfdPoll 特权提升漏洞 (CVE-2012-0149)

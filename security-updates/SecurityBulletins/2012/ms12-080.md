...
<td style="border:1px solid black;">
[MS12-058](https://go.microsoft.com/fwlink/?linkid=259630) 中的 KB2756497 由 KB2746157 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-058](https://go.microsoft.com/fwlink/?linkid=259630) 中的 KB2756496 由 KB2787763 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-058](https://go.microsoft.com/fwlink/?linkid=259630) 中的 KB2756485 由 KB2785908 替代
</td>
</tr>
</table>
...
[Oracle 关键修补程序更新通报 - 2012 年 10 月](https://www.oracle.com/technetwork/topics/security/cpuoct2012-1515893.html)中讨论的 CVE-2012-3214 和 CVE-2012-3217 影响 Microsoft Exchange Server，可由此更新解决。

**此更新是否包含** **任何** **其他与安全性无关的功能更改？**  
是。除了本公告的“漏洞信息”部分列出的更改外，此更新还包括每个更新汇总的相关知识库文章中所述的其他功能性更改。

-   对于 Exchange Server 2007 Service Pack 3 的更新汇总 9 (KB2746157)，请参阅 [Microsoft 知识库文章 2746157](https://support.microsoft.com/kb/2746157)。
-   对于 Exchange 2010 Service Pack 1 的更新汇总 8 (KB2787763)，请参阅 [Microsoft 知识库文章 2787763](https://support.microsoft.com/kb/2787763)。
-   对于 Exchange 2010 Service Pack 2 的更新汇总 5 (KB2785908)，请参阅 [Microsoft 知识库文章 2785908](https://support.microsoft.com/kb/2785908)。

**我以前** **在 Exchange Server 2010 邮箱服务器上安装了了高版本存储段修补程序。我是否需要安装此更新？**  
是。虽然已经应用了 [Microsoft 知识库文章 2786772](https://support.microsoft.com/kb/2786772) 中所述的修补程序的系统受到保护，可免遭 [CVE-2012-4791](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4791) 中漏洞的影响，但是这些系统仍然容易遭受此更新解决的Oracle Outside In 漏洞的攻击。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4791](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4791)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2784126">Microsoft 知识库文章 2784126</a></td>
</tr>  
<tr class="even">

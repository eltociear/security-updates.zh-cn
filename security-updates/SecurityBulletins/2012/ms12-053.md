...
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=246927">MS12-036</a> 中的 KB2685939 由 KB2723135 替代</td>
</tr>  
</tbody>  
</table>
...
Microsoft 修订此公告是为了重新发布针对 Windows XP 提供的 KB2723135 更新，以便解决涉及 Microsoft 生成的、没有正确时间戳属性的特定数字证书的问题。有关详细信息，请参阅 [Microsoft 安全通报 KB 973811](https://go.microsoft.com/fwlink/?linkid=265301)。
  
**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。
  
**安全更新的哈希位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2723135](https://support.microsoft.com/kb/2723135)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2526](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2526)。
...
-   **如果不再需要，请禁用远程桌面功能**
    ...
    有关远程协助的信息（包括如何使用组策略手动禁用远程协助的说明），请参阅 TechNet 文章[远程协助](https://technet.microsoft.com/library/bb457177.aspx)。
...
**什么是远程桌面协议 (RDP)？**  
远程桌面协议 (RDP) 允许用户在其桌面计算机上创建虚拟会话。RDP 允许远程用户访问其计算机上的所有数据和应用程序。有关详细信息，请参阅 MSDN 文章[远程桌面协议](https://msdn.microsoft.com/library/aa383015.aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2723135">Microsoft 知识库文章 2723135</a></td>
</tr>  
<tr class="even">

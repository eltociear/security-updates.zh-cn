---
TOCTitle: 'MS12-013'
Title: 'Microsoft 安全公告 MS12-013 - 严重'
ms:assetid: 'ms12-013'
ms:contentKeyID: 61238355
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-013(v=Security.10)'
---

Microsoft 安全公告 MS12-013 - 严重
==================================

C 运行时库中的漏洞可能允许远程执行代码 (2654428)
------------------------------------------------

发布时间: 2012年2月14日 | 更新时间: 2012年7月31日
...
此安全更新通过修改 msvcrt 动态链接库 (DLL) 计算内存中数据结构大小的方式来解决此漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。**[Microsoft 知识库文章 2654428](https://support.microsoft.com/kb/2654428) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c503c7b1-24f8-40a4-8283-c1e4abf90b57)                                                                                        | 严重         | 远程执行代码 | 无               |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ddbd9fcf-10c4-4089-88c0-c2a6c288222b)                                                                            | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0c1812af-f57d-455d-a81d-5e03db99b2f7)\*                                                               | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e1b66bb5-ea12-44a5-807a-f21ede0dc76d)\*                                                          | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3a96ab34-8f45-48bf-a98b-9e683b50aaa0)                                                        | 严重         | 远程执行代码 | 无               |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=403f355c-2273-42ac-8263-d662f5d7740c)                                             | 严重         | 远程执行代码 | 无               |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=8bd8e804-ca4d-4326-bc60-345e2975b7aa)                                   | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d868c5ef-165a-46a0-b832-e6ca55a910f9)\*       | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=e5416371-495b-4dc7-a239-f9185f968969) | 严重         | 远程执行代码 | 无               |
...
是。KB 更新适用于 Windows Developer Preview 版本。鼓励使用 Windows Developer Preview 的客户向其系统应用此更新。此更新仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供。
...
<th style="border:1px solid black;">Msvcrt.dll 缓冲区溢出漏洞 - CVE-2012-0150</th>
...
Msvcrt.dll 缓冲区溢出漏洞 - CVE-2012-0150  
-----------------------------------------
  
<span></span>  
msvcrt DLL 计算内存中缓冲区大小的方式中存在一个远程执行代码漏洞，使得数据可以复制到尚未正确分配的内存中。如果用户打开特制媒体文件，此漏洞可能允许远程执行代码。如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0150](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0150)。
  
#### Msvcrt.dll 缓冲区溢出漏洞 (CVE-2012-0150) 的缓解因素
...
#### Msvcrt.dll 缓冲区溢出漏洞 (CVE-2012-0150) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Msvcrt.dll 缓冲区溢出漏洞 (CVE-2012-0150) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是本地用户上下文中的远程执行代码漏洞。
  
**造成此漏洞的原因是什么？**  
此漏洞是由于 msvcrt.dll 误算缓冲区大小导致的，使得数据可以复制到尚未正确分配的内存中。
  
**什么是** **msvcrt.dll？**  
Msvcrt.dll 是系统级组件使用的多线程、C 运行时动态链接库。有关 msvcrt.dll 的更多信息，请参阅 MSDN 文章 [C 运行时库](https://msdn.microsoft.com/en-us/library/abx4dbyh.aspx)。
  
**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的未经身份验证的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**攻击者如何利用此** **漏洞？**  
在电子邮件攻击情形中，未经身份验证的攻击者可能通过向用户发送包含特制媒体文件的电子邮件，并诱使用户打开该媒体文件来利用此漏洞。
  
在基于 Web 的攻击情形中，未经身份验证的攻击者必须拥有一个包含特制媒体文件的网站。另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可用于利用此漏洞的特制内容。攻击者无法强迫用户访问宿主特制媒体文件的网站。相反，攻击者必须诱使用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
  
**受此漏洞威胁最大的系统有哪些？**  
工作站和服务器受此漏洞的威胁最大。
  
**第三方应用程序是否受此漏洞的影响？**  
是的，使用 msvcrt.dll 的任何应用程序都可能受此漏洞影响。Microsoft 建议应用此安全更新以帮助在 Microsoft Windows 的受影响版本上修复此漏洞。有关此问题的详细信息，请参阅 [Microsoft 知识库文章 2654428](https://support.microsoft.com/kb/2654428) 中的“此安全更新的已知问题”部分。
  
**此更新有什么作用？**  
此更新通过修改 msvcrt DLL 计算内存中数据结构大小的方式来解决此漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2654428">Microsoft 知识库文章 2654428</a></td>
</tr>  
<tr class="odd">
...
-   Alexander Gavrun 与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Msvcrt.dll 缓冲区溢出漏洞 (CVE-2012-0150)
...
-   V1.1（2012 年 7 月 31 日）： 公告经过修订，宣布在 KB2654428 的 Windows Vista 程序包中的一个检测更改，以解决一个 Windows Update 重新提供问题。这只是检测更改。已经成功更新了其系统的客户不需要执行任何操作。

...
**已知问题。**[Microsoft 知识库文章 2654428](http://support.microsoft.com/kb/2654428) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c503c7b1-24f8-40a4-8283-c1e4abf90b57)                                                                                        | 严重         | 远程执行代码 | 无               |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ddbd9fcf-10c4-4089-88c0-c2a6c288222b)                                                                            | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0c1812af-f57d-455d-a81d-5e03db99b2f7)\*                                                               | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e1b66bb5-ea12-44a5-807a-f21ede0dc76d)\*                                                          | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3a96ab34-8f45-48bf-a98b-9e683b50aaa0)                                                        | 严重         | 远程执行代码 | 无               |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=403f355c-2273-42ac-8263-d662f5d7740c)                                             | 严重         | 远程执行代码 | 无               |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8bd8e804-ca4d-4326-bc60-345e2975b7aa)                                   | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d868c5ef-165a-46a0-b832-e6ca55a910f9)\*       | 严重         | 远程执行代码 | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=e5416371-495b-4dc7-a239-f9185f968969) | 严重         | 远程执行代码 | 无               |
...
是。KB 更新适用于 Windows Developer Preview 版本。鼓励使用 Windows Developer Preview 的客户向其系统应用此更新。此更新仅在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0150](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0150)。
...
**什么是** **msvcrt.dll？**  
Msvcrt.dll 是系统级组件使用的多线程、C 运行时动态链接库。有关 msvcrt.dll 的更多信息，请参阅 MSDN 文章 [C 运行时库](http://msdn.microsoft.com/en-us/library/abx4dbyh.aspx)。
...
**第三方应用程序是否受此漏洞的影响？**  
是的，使用 msvcrt.dll 的任何应用程序都可能受此漏洞影响。Microsoft 建议应用此安全更新以帮助在 Microsoft Windows 的受影响版本上修复此漏洞。有关此问题的详细信息，请参阅 [Microsoft 知识库文章 2654428](http://support.microsoft.com/kb/2654428) 中的“此安全更新的已知问题”部分。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2654428">Microsoft 知识库文章 2654428</a></td>
</tr>  
<tr class="odd">
...
-   Alexander Gavrun 与 [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Msvcrt.dll 缓冲区溢出漏洞 (CVE-2012-0150)

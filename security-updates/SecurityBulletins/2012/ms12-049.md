...
<td style="border:1px solid black;">
[MS10-049](http://go.microsoft.com/fwlink/?linkid=197104) 中的 KB980436 由 KB2655992 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-006](http://go.microsoft.com/fwlink/?linkid=232510) 中的 KB2585542 由 KB2655992 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS10-085](http://go.microsoft.com/fwlink/?linkid=201705) 中的 KB2207566 由 KB2655992 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=97030267-6b19-46ae-84ce-0bb1f91ab951)（服务器核心安装）  
(KB2655992)
</td>
<td style="border:1px solid black;">
信息泄露
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8a5f6e84-5e5b-42c3-a5b7-65defdb0665f)（服务器核心安装）  
(KB2655992)
</td>
<td style="border:1px solid black;">
信息泄露
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4)（服务器核心安装）  
(KB2655992)
</td>
<td style="border:1px solid black;">
信息泄露
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9ef728f-abef-4076-bb13-7488af471aa4)（服务器核心安装）  
(KB2655992)
</td>
<td style="border:1px solid black;">
信息泄露
...
**安全更新的** **哈希位于**何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2655992](http://support.microsoft.com/kb/2655992)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-1870](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1870)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2655992">Microsoft 知识库文章 2655992</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2655992](http://support.microsoft.com/kb/2655992)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">

---
TOCTitle: 'MS12-054'
Title: 'Microsoft 安全公告 MS12-054 - 严重'
ms:assetid: 'ms12-054'
ms:contentKeyID: 61238396
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-054(v=Security.10)'
---

Microsoft 安全公告 MS12-054 - 严重
==================================
...
对于 Windows XP 和 Windows Server 2003 的所有受支持版本，此安全更新的等级为“严重”；对于 Windows Vista 的所有受支持版本，此安全更新的等级为“重要”；对于 Windows Server 2008、Windows 7 和 Windows 2008 R2 的所有受支持版本，此安全更新的等级为“中等”。有关详细信息，请参阅本节的“**受影响和不受影响的软件**”小节。

该安全更新通过更正 Windows 打印后台处理程序处理特制响应的方式以及 Windows 网络组件处理远程管理协议 (RAP) 响应的方式来解决漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[MS08-067](https://go.microsoft.com/fwlink/?linkid=130719) 中的 KB958644 由 KB2705219 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS09-022](https://go.microsoft.com/fwlink/?linkid=141786) 中的 KB961501 由 KB2712808 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=354e502b-3016-4c5e-8611-bc1b35e1a7eb)（服务器核心安装）  
(KB2705219)
</td>
<td style="border:1px solid black;">
拒绝服务
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=35fb03b1-162a-4552-8bb9-6b564acbd57b)（服务器核心安装）  
(KB2712808)
</td>
<td style="border:1px solid black;">
拒绝服务
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2b8a730c-46ac-49b7-b9ae-73062d5a79f2)（服务器核心安装）  
(KB2705219)
</td>
<td style="border:1px solid black;">
拒绝服务
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e89024ca-a9e8-4ebf-91eb-cbf8e05398e7)（服务器核心安装）  
(KB2712808)
</td>
<td style="border:1px solid black;">
拒绝服务
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=e15d2bae-1511-4d74-93cb-0d614820e175)（服务器核心安装）  
(KB2705219)
</td>
<td style="border:1px solid black;">
拒绝服务
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=20c9a72f-a8b6-4b4c-a9ea-de93069cff3a)（服务器核心安装）  
(KB2712808)
</td>
<td style="border:1px solid black;">
拒绝服务
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=e15d2bae-1511-4d74-93cb-0d614820e175)（服务器核心安装）  
(KB2705219)
</td>
<td style="border:1px solid black;">
拒绝服务
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=20c9a72f-a8b6-4b4c-a9ea-de93069cff3a)（服务器核心安装）  
(KB2712808)
</td>
<td style="border:1px solid black;">
拒绝服务
...
**我已成功安装了原始 KB2705219 更新。我需要应用在 2012 年 10 月 9 日重新发布的 KB2705219 更新程序包吗？**  
对于 Windows XP 和 Windows Server 2003，此重新发布的更新仅适用于未安装原始更新的系统。已经在系统上成功安装了原始 KB2705219 更新的 Windows XP 和 Windows Server 2003 客户不需要执行任何操作。如果这些客户的系统中已经安装此更新，则不再为其提供。

对 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2，客户需要应用重新发布的 KB2705219 更新程序包。

**注意** 2012 年 10 月 9 日仅重新发布了 KB2705219 更新。KB2712808 更新不属于此重新发布。

**为什么在 2012 年 10 月 9 日修订此公告？**  
Microsoft 修订此公告是为了重新发布针对 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 提供的 KB2705219 更新，以便解决涉及 Microsoft 生成的、没有正确时间戳属性的特定数字证书的问题。有关详细信息，请参阅 [Microsoft 安全通报 2749655](https://technet.microsoft.com/security/advisory/2749655)。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**安全更新的哈希位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2733594](https://support.microsoft.com/kb/2733594)。
...
**我正在运行 Windows Server 2008 R2 （服务器核心安装），它列 出在 “受影响的软件”表中。为什么没有向我提供　KB2712808 更新？**  
KB2712808 更新仅提供给运行启用了 Printing-ServerCore-Role 设置的 Windows Server 2008 R2 服务器核心安装选项的系统。
...
<th>
远程管理协议拒绝服务漏洞 - CVE-2012-1850
</th>
<th>
打印后台处理程序服务格式字符串漏洞 - CVE-2012-1851
</th>
<th>
远程管理协议堆溢出漏洞 - CVE-2012-1852
</th>
<th>
远程管理协议堆栈溢出漏洞 - CVE-2012-1853
</th>
<th>
综合严重等级
</th>
...
Windows 网络组件中存在一个拒绝服务漏洞。该漏洞是由于服务不正确地处理特制的 RAP 请求导致的。成功利用此漏洞的攻击者可能会导致一些 Windows 网络组件停止响应。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1850](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1850)。

#### 远程管理协议拒绝服务漏洞 (CVE-2012-1850) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。按照最佳做法，应使直接连接到 Internet 的系统所暴露的端口数尽可能少。

#### 远程管理协议拒绝服务漏洞 (CVE-2012-1850) 的变通办法
...
-   **禁** **用** **Lanman工作站服务**
    ...
    **使用交互方法：**
    ...
    3.  单击“**LanmanWorkstation**”，然后单击“**文件**”菜单并选择“**导出**”。
    4.  在“导出注册表文件”对话框中，键入 **lanmanworkstation\_configuration\_backup.reg**，然后单击“**保存**”。
    5.  双击“**Start**”注册表项，将“**数值数据**”字段更改为 **4**，然后单击“**确定**”。
    ...
    **使用被** **管理** **的部署脚本：**
    ...
    2.  将下列脚本保存到扩展名为 .REG 的文件（例如 **Disable\_lanmanworkstation.reg**）：
    ...
    **使用交互方法：**
    ...
    1.  单击“**开始**”，单击“**运行**”，键入 **regedit**，然后单击“**确定**”。
    2.  单击“**文件**”菜单并选择“**导入**”。
    3.  在“导入注册表文件”窗口中，选择 **lanmanworkstation\_configuration\_backup.reg**，然后单击“**打开**”。
...
#### 远程管理协议拒绝服务漏洞 (CVE-2012-1850) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个拒绝服务漏洞。

**造成此漏洞的原因是什么？**  
当 Windows 网络组件无法正确地处理远程管理协议 (RAP) 响应时，会导致该漏洞。

**什么是远程管理协议？**  
远程管理协议 (RAP) 处理管理功能，其中包括 LAN 管理器服务器上的共享维护和打印机维护等任务。有关详细信息，请参阅[\[MS-RAP\]： 远程管理协议规范](https://msdn.microsoft.com/en-us/library/cc240191(v=prot.13))。

**哪个组件受此漏洞的影响？**  
Netapi32.dll 组件受此漏洞影响。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可能导致服务停止响应。

**攻击者如何利用此** **漏洞？**  
未经身份验证的远程攻击者可以通过向目标系统发送一系列特制 RAP 数据包来利用此漏洞。

**受此漏洞威胁最大的系统有哪些？**  
工作站和服务器受此漏洞的威胁最大。

**此更新有什么作用？**  
此更新通过更正 Windows 网络组件处理 RAP 响应的方式来解决漏洞。
...
Windows Print Spooler 服务中存在一个远程执行代码漏洞，可能允许未经身份验证的远程攻击者在受影响的系统上执行任意代码。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1851](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1851)。

#### Print Spooler 服务格式字符串漏洞 (CVE-2012-1851) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。按照最佳做法，应使直接连接到 Internet 的系统所暴露的端口数尽可能少。

#### Print Spooler 服务格式字符串漏洞 (CVE-2012-1851) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **禁用 Print Spooler 服务**

    禁用打印后台程序服务将帮助防止受影响的系统尝试利用此漏洞。若要禁用 Print Spooler 服务，请按照以下步骤操作：
...
#### Print Spooler 服务格式字符串漏洞 (CVE-2012-1851) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。

**造成此漏洞的原因是什么？**  
当 Windows Print Spooler 无法处理特制响应时，会导致此漏洞。

**哪个组件受此漏洞的影响？**  
Windows Print Spooler 服务是受此漏洞影响的组件。

**什么是 Print Spooler 服务？**  
打印后台程序服务是作为服务安装的可执行文件。当操作系统启动时加载后台处理程序时，它将持续运行，直到操作系统关闭。打印后台程序服务管理打印进程，包括检索正确的打印机驱动程序位置、加载该驱动程序、后台处理高级级函数调用至打印作业以及计划打印作业等任务。当某个特定打印作业的任务完成时，打印后台程序服务将把此作业传给打印路由器。有关详细信息，请参阅 [网络打印的工作原理](https://technet.microsoft.com/en-us/library/cc783789(v=ws.10).aspx)。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者能够使用系统特权在用户系统上运行恶意代码。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建新帐户。

**攻击者如何利用此** **漏洞？**  
未经身份验证的远程攻击者可能通过响应打印后台处理程序的带有特制响应的请求来利用此漏洞。

**受此漏洞威胁最大的系统有哪些？**  
工作站和服务器受此漏洞的威胁最大。

**此更新有什么作用？**  
该更新通过更正 Windows Print Spooler 处理特制响应的方式来解决漏洞。
...
Windows 网络组件处理特制 RAP 响应的方式中存在一个远程执行代码漏洞。成功利用此漏洞的攻击者可以在目标系统上运行任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1852](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1852)。

#### 远程管理协议堆溢出漏洞 (CVE-2012-1852) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。按照最佳做法，应使直接连接到 Internet 的系统所暴露的端口数尽可能少。

#### 远程管理协议堆溢出漏洞 (CVE-2012-1852) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **禁用 lanmanworkstation 服务**
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1853](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1853)。

#### 远程管理协议堆栈溢出漏洞 (CVE-2012-1853) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。按照最佳做法，应使直接连接到 Internet 的系统所暴露的端口数尽可能少。

#### 远程管理协议堆栈溢出漏洞 (CVE-2012-1853) 的变通办法
...
#### 远程管理协议堆栈溢出漏洞 (CVE-2012-1853) 的常见问题
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或下列文件夹中的 Spuninst.exe 实用程序：<br />
%Windir%\\$NTUninstallKB2705219-v2$\Spuninst<br />
%Windir%\\$NTUninstallKB2712808$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2705219">Microsoft 知识库文章 2705219</a><br />
请参阅 <a href="https://support.microsoft.com/kb/2712808">Microsoft 知识库文章 2712808</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2705219](https://support.microsoft.com/kb/2705219)
请参阅 [Microsoft 知识库文章 2712808](https://support.microsoft.com/kb/2712808)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2705219">Microsoft 知识库文章 2705219</a><strong><br />
</strong>请参阅 <a href="https://support.microsoft.com/kb/2712808">Microsoft 知识库文章 2712808</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了远程管理协议拒绝服务漏洞 (CVE-2012-1850)  
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了 Print Spooler 服务格式字符串漏洞 (CVE-2012-1851)  
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了远程管理协议堆溢出漏洞 (CVE-2012-1852)  
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了远程管理协议堆栈溢出漏洞 (CVE-2012-1853)
...
-   V1.1（2012 年 8 月 15 日）： 阐明了 KB2712808 更新仅提供给运行启用了 Printing-ServerCore-Role 设置的 Windows Server 2008 R2 服务器核心安装选项的系统。  
-   V2.0（2012 年 10 月 9 日）： 修订公告是为了重新发布针对 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 提供的 KB2705219 更新。使用 Windows XP 和 Windows Server 2003 的客户不需要应用此重新发布的更新程序包以避免 Microsoft 安全通报 2749655 中所述的数字证书问题。使用 Windows Vista、Windows 7 和 Windows Server 2008 的用户不需要应用此重新发布的更新程序包以避免 Microsoft 安全通报 2749655 中所述的数字证书问题。  
-   V2.1（2012 年 10 月 10 日）： 添加了关于重新发布的 KB2705219 更新的常见问题条目，以提供部署指南。有关详细信息，请参阅更新常见问题。  
-   V2.2 （2013 年 7 月 9 日）： 公告经过修订，宣布在 2705219 更新的 Windows Vista 程序包中的一个检测更改，以解决一个 Windows Update 重新提供问题。这只是检测更改。已经成功更新了其系统的客户不需要执行任何操作。

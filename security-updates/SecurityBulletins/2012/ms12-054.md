...
<td style="border:1px solid black;">
[MS08-067](http://go.microsoft.com/fwlink/?linkid=130719) 中的 KB958644 由 KB2705219 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS09-022](http://go.microsoft.com/fwlink/?linkid=141786) 中的 KB961501 由 KB2712808 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
Microsoft 修订此公告是为了重新发布针对 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 提供的 KB2705219 更新，以便解决涉及 Microsoft 生成的、没有正确时间戳属性的特定数字证书的问题。有关详细信息，请参阅 [Microsoft 安全通报 2749655](http://technet.microsoft.com/security/advisory/2749655)。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**安全更新的哈希位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2733594](http://support.microsoft.com/kb/2733594)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1850](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1850)。
...
**什么是远程管理协议？**  
远程管理协议 (RAP) 处理管理功能，其中包括 LAN 管理器服务器上的共享维护和打印机维护等任务。有关详细信息，请参阅[\[MS-RAP\]： 远程管理协议规范](http://msdn.microsoft.com/en-us/library/cc240191(v=prot.13))。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1851](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1851)。
...
打印后台程序服务是作为服务安装的可执行文件。当操作系统启动时加载后台处理程序时，它将持续运行，直到操作系统关闭。打印后台程序服务管理打印进程，包括检索正确的打印机驱动程序位置、加载该驱动程序、后台处理高级级函数调用至打印作业以及计划打印作业等任务。当某个特定打印作业的任务完成时，打印后台程序服务将把此作业传给打印路由器。有关详细信息，请参阅 [网络打印的工作原理](http://technet.microsoft.com/en-us/library/cc783789(v=ws.10).aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1852](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1852)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1853](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1853)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2705219">Microsoft 知识库文章 2705219</a><br />
请参阅 <a href="http://support.microsoft.com/kb/2712808">Microsoft 知识库文章 2712808</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2705219](http://support.microsoft.com/kb/2705219)
请参阅 [Microsoft 知识库文章 2712808](http://support.microsoft.com/kb/2712808)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2705219">Microsoft 知识库文章 2705219</a><strong><br />
</strong>请参阅 <a href="http://support.microsoft.com/kb/2712808">Microsoft 知识库文章 2712808</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) 的 Yamata Li 报告了远程管理协议拒绝服务漏洞 (CVE-2012-1850)  
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) 的 Yamata Li 报告了 Print Spooler 服务格式字符串漏洞 (CVE-2012-1851)  
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) 的 Yamata Li 报告了远程管理协议堆溢出漏洞 (CVE-2012-1852)  
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) 的 Yamata Li 报告了远程管理协议堆栈溢出漏洞 (CVE-2012-1853)

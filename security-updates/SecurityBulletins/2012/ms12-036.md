...
<td style="border:1px solid black;">
[MS12-020](https://go.microsoft.com/fwlink/?linkid=232664) 中的 KB2621440 由 KB2685939 替代
</td>
</tr>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0173](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0173)。
...
-   **在运行 Windows Vista、Windows 7、Windows Server 2008 和 Windows Server 2008 R2 的受支持版本的系统上启用网络级别身份验证**
    ...
    **
    注意** 要使用自动 **Microsoft 修复** 解决方案来启用此变通办法，请参阅 [Microsoft 知识库文章 2685939](https://support.microsoft.com/kb/2685939)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2685939">Microsoft 知识库文章 2685939</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2685939](https://support.microsoft.com/kb/2685939)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">

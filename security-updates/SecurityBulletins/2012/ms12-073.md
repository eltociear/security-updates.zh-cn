...
<td style="border:1px solid black;">
[MS11-004](https://go.microsoft.com/fwlink/?linkid=208522) 中的 KB 2489256 由 KB 2716513 替代
</td>
</tr>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2531](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2531)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2532](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2532)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-2532](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2532)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2716513">Microsoft 知识库文章 2716513</a></td>
</tr>  
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2716513">Microsoft 知识库文章 2716513</a> 和 <a href="https://support.microsoft.com/kb/2719033">Microsoft 知识库文章 2719033</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注</strong> 没有用于验证此更新是否存在的注册表项。</td>

...
<td style="border:1px solid black;">
没有公告由 KB2598479 替代  
[MS10-033](https://go.microsoft.com/fwlink/?linkid=191065)中的 KB975562 由 KB2631813 替代
</td>
</tr>
...
(KB2628259)  
[DirectShow](https://www.microsoft.com/download/details.aspx?familyid=4b168ee8-eb15-4c2c-afb0-e63d62b4a6dc)<sup>[1]</sup>  
(KB2631813)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f345e093-336d-4464-b7f8-a14398b62ebf">Windows Vista 的 Windows Media Center TV Pack（32 位版本）</a>[2]<br />
(KB2628642)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=559d028f-9810-4c50-b65d-f567cbb15427">Windows Vista 的 Windows Media Center TV Pack（64 位版本）</a>[2]<br />
(KB2628642)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0003](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0003)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0004](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2004)。
...
**什么是 DirectShow 筛选器？**  
DirectShow 提供一套默认筛选器，由 Microsoft Windows 自动安装。这些筛选器支持多种数据格式，同时提供高度的硬件独立性。应用程序还可在目标系统上注册和安装定制筛选器。有关完整的筛选器列表和进一步信息，请参阅 MSDN 文章 [DirectShow 筛选器](https://msdn.microsoft.com/en-us/library/dd375464(v=vs.85).aspx)。
...
<td style="border:1px solid black;">对于 Windows XP 所有受支持版本上的 Windows 多媒体库：<br />
请参阅 <a href="https://support.microsoft.com/kb/2598479">Microsoft 知识库文章 2598479</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP 所有受支持版本上的 DirectShow：<br />
请参阅 <a href="https://support.microsoft.com/kb/2631813">Microsoft 知识库文章 2631813</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Media Center Edition 2005 Service Pack 3：<br />
请参阅 <a href="https://support.microsoft.com/kb/2628259">Microsoft 知识库文章 2628259</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的版本上的 Windows 多媒体库：  
请参阅 [Microsoft 知识库文章 2598479](https://support.microsoft.com/kb/2598479)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受影响的版本上的 DirectShow：  
请参阅 [Microsoft 知识库文章 2631813](https://support.microsoft.com/kb/2631813)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
请参阅 <a href="https://support.microsoft.com/kb/2628642">Microsoft 知识库文章 2628642</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2631813">Microsoft 知识库文章 2631813</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注</strong> 没有用于验证此更新是否存在的注册表项。</td>
...
-   [IBM Security System's X-Force Research](https://xforce.iss.net/) 的 Shane Garrett 报告了 MIDI 远程执行代码漏洞 (CVE-2012-0003)  
-   [Google Inc.](https://www.google.com/) 的 Neel Mehta 报告了 DirectShow 远程执行代码漏洞 (CVE-2012-0004)

---
TOCTitle: 'MS12-071'
Title: 'Microsoft 安全公告 MS12-071 - 严重'
ms:assetid: 'ms12-071'
ms:contentKeyID: 61238413
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-071(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-071 - 严重
==================================
...
<td style="border:1px solid black;">
[MS12-063](https://go.microsoft.com/fwlink/?linkid=255505) 中的 KB2744842 由 KB2761451 替代
</td>
</tr>
...
**安全更新的哈希位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2761451](https://support.microsoft.com/kb/2761451)。
...
<th>
CFormElement 释放后使用漏洞 - CVE-2012-1538
</th>
<th>
CTreePos 释放后使用漏洞 - CVE-2012-1539
</th>
<th>
CTreeNode 释放后使用漏洞 - CVE-2012-4775
</th>
<th>
综合严重等级
</th>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1538](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1538)。

#### CFormElement 释放后使用漏洞 (CVE-2012-1538)　的缓解因素
...
#### CFormElement 释放后使用漏洞 (CVE-2012-1538)　的变通办法
...
#### CFormElement 释放后使用漏洞 (CVE-2012-1538)　的常见问题
...
**受此漏洞威胁最大的系统有哪些？**  
要利用此漏洞执行任何恶意操作，需要用户登录并访问网站。因此，频繁使用 Internet Explorer 9 的系统（如工作站或终端服务器）受此漏洞的威胁最大。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1539](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1539)。

#### CTreePos 释放后使用漏洞 (CVE-2012-1539)　的缓解因素
...
#### CTreePos 释放后使用漏洞 (CVE-2012-1539)　的变通办法
...
#### CTreePos 释放后使用漏洞 (CVE-2012-1539)　的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4775](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4775)。

#### CTreeNode 释放后使用漏洞 (CVE-2012-4775) 的缓解因素
...
#### CTreeNode 释放后使用漏洞 (CVE-2012-4775) 的变通办法
...
#### CTreeNode 释放后使用漏洞 (CVE-2012-4775) 的常见问题
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2761451">Microsoft 知识库文章 2761451</a></td>
</tr>  
<tr class="odd">
...
-   spa-s3c.blogspot.com 的 Jose A. Vazquez 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 CFormElement 释放后使用漏洞 (CVE-2012-1538)  
-   [Omair](https://krash.in/) 报告了 CFormElement 释放后使用漏洞 (CVE-2012-1538)  
-   spa-s3c.blogspot.com 的 Jose A. Vazquez 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 CTreePos 释放后使用漏洞 (CVE-2012-1539)  
-   [Trend Micro](https://www.trendmicro.com/) 的 Cheng-da Tsai (Orange)、Sung-ting Tsai 和 Ming-chieh Pan (Nanika) 报告了 CTreeNode 释放后使用漏洞 (CVE-2012-4775)

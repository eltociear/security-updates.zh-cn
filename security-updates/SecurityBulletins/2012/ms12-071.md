...
<td style="border:1px solid black;">
[MS12-063](http://go.microsoft.com/fwlink/?linkid=255505) 中的 KB2744842 由 KB2761451 替代
</td>
</tr>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1538](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1538)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1539](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1539)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4775](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4775)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2761451">Microsoft 知识库文章 2761451</a></td>
</tr>  
<tr class="odd">
...
-   spa-s3c.blogspot.com 的 Jose A. Vazquez 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 CFormElement 释放后使用漏洞 (CVE-2012-1538)  
-   [Omair](http://krash.in/) 报告了 CFormElement 释放后使用漏洞 (CVE-2012-1538)  
-   spa-s3c.blogspot.com 的 Jose A. Vazquez 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 CTreePos 释放后使用漏洞 (CVE-2012-1539)  
-   [Trend Micro](http://www.trendmicro.com/) 的 Cheng-da Tsai (Orange)、Sung-ting Tsai 和 Ming-chieh Pan (Nanika) 报告了 CTreeNode 释放后使用漏洞 (CVE-2012-4775)

...
此安全更新也解决了最初在 [Microsoft 安全通报 2588513](http://technet.microsoft.com/en-us/security/advisory/2588513) 中描述的漏洞。
...
**已知问题。**[Microsoft 知识库文章 2643584](http://support.microsoft.com/kb/2643584) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=197104">MS10-049</a> 中的 KB980436 由 KB2585542 替代</td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;">信息泄露</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=163843">MS09-059</a> 中的 KB975467 和 <a href="http://go.microsoft.com/fwlink/?linkid=197104">MS10-049</a> 中的 KB980436 由 KB2585542 替代<br />
<br />
...
<td style="border:1px solid black;">信息泄露</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=163843">MS09-059</a> 中的 KB975467 和 <a href="http://go.microsoft.com/fwlink/?linkid=201705">MS10-085</a> 中的 KB2207566 由 KB2585542 替代</td>
</tr>  
<tr class="odd">
...
<td style="border:1px solid black;">信息泄露</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=201705">MS10-085</a> 中的 KB2207566 和 <a href="http://go.microsoft.com/fwlink/?linkid=206683">MS10-095</a> 中的 KB2385678 由 KB2585542 替代</td>
</tr>  
<tr class="even">
...
为了免遭基于 Web 的攻击媒介因为 SSL 和 TLS 协议漏洞 (CVE-2011-3389)（如此公告中所述）通过 Internet Explorer 的攻击，客户必须安装更新 MS12-006 和 [Internet Explorer 的累积性安全更新](http://go.microsoft.com/fwlink/?linkid=232505) MS11-099。
...
是。默认情况下，此更新仅在使用 WinHTTP 组件的应用程序中启用。如果您是一位开发人员，想要在您的应用程序中启用此安全功能，请参阅 MSDN 文章 [AcquireCredentialsHandle (Schannel) 功能](http://msdn.microsoft.com/en-us/library/windows/desktop/aa374716(v=vs.85).aspx)和[SCHANNEL\_CRED 结构](http://msdn.microsoft.com/en-us/library/windows/desktop/aa379810(v=vs.85).aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-3389](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3389)。
...
-   **在运行 Windows Vista、Windows Server 2008、Windows 7 或 Windows Server 2008 R2 的系统上区分服务器软件中 RC4 算法的优先次序**  
    ...
    攻击仅影响在 CBC 模式中使用对称加密算法的密码套件（例如 AES），但不影响 RC4 算法。您可以区分服务器软件中 RC4 算法的优先次序以使用 RC4（而不是 CBC）促进安全的通信。请参阅此 MSDN 文章[区分 Schannel 密码套件的优先次序](http://msdn.microsoft.com/en-us/library/bb870930%28v=vs.85%29.aspx)以了解如何执行此操作。
...
-   **在运行 Windows 7 或 Windows Server 2008 R2 的系统上的客户端软件中启用 TLS 1.1 和/或 1.2**  
    ...
    **注意** 要使用自动 **Microsoft Fix it** 解决方案来为 TLS 1.1 启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 2643584](http://support.microsoft.com/kb/2643584)。
...
-   **在运行 Windows 7 或 Windows Server 2008 R2 的系统上的服务器软件中启用 TLS 1.1**  
    ...
    要使用自动 **Microsoft Fix it** 解决方案来为 TLS 1.1 启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 2643584](http://support.microsoft.com/kb/2643584)。
...
**此更新有什么作用？**  
此更新修改了 Windows 安全通道 (SChannel) 组件发送和接收经过加密的网络数据包的方式。此更新解决了影响 WinHTTP 的漏洞并提供了在系统范围内实施保护的可能性。但是，为了免遭基于 Web 的攻击媒介因为此漏洞通过 Internet Explorer 的攻击，客户必须安装更新 MS12-006 和 [Internet Explorer 的累积性安全更新](http://go.microsoft.com/fwlink/?linkid=232505) (2618444) MS11-099。
  
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-3389](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-3389)。
...
<td style="border:1px solid black;">对于 Windows XP Service Pack 3：<br />
请参阅 <a href="http://support.microsoft.com/kb/2585542">Microsoft 知识库文章 2585542</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Professional x64 Edition Service Pack 2：<br />
请参阅 <a href="http://support.microsoft.com/kb/2585542">Microsoft 知识库文章 2585542</a> 和 <a href="http://support.microsoft.com/kb/2638806">Microsoft 知识库文章 2638806</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2585542](http://support.microsoft.com/kb/2585542)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2638806](http://support.microsoft.com/kb/2638806)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2585542">Microsoft 知识库文章 2585542</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>

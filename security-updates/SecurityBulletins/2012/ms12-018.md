---
TOCTitle: 'MS12-018'
Title: 'Microsoft 安全公告 MS12-018 - 重要'
ms:assetid: 'ms12-018'
ms:contentKeyID: 61238360
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-018(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-018 - 重要
==================================
...
此安全更新通过更正 Windows 内核模式驱动程序处理窗口消息传递的方式来解决此漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=2922411c-9755-461b-9904-f6940322af19)                                                                                           | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e72b6b1f-68f5-4e1a-878e-290a5f03ca30)                                                                  | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=599e5db1-3bf1-4d44-bc7c-81bc545c58ec)                                                                                  | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=482c2890-8d4c-4e13-820f-d5ff256b6a3a)                                                                      | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=ccd0f116-73c2-4471-a6d9-e07d1dbdd406)                                                                  | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f4e73a92-583b-4352-b19d-7a8e3ef162b7)                                                                                        | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ead9d29b-becf-448e-bff4-d5bb12d02c64)                                                                            | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=dd547364-f6bb-453c-9e4d-6b80dfc47fbb)\*                                                               | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=%205ff65fc2-5969-4d7e-9c72-9a2096dafdcf)\*                                                       | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=eeb5385c-fb81-4d33-af2a-986e6cf14ee2)                                                        | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=75fd93ff-5be5-42b5-ab00-3378e545c271)                                             | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=71ffba4c-d816-45a9-abef-131915885bc8)                                   | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=22d6a234-6447-4854-8119-4fddd3c6e1bb)\*       | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=cb5ac981-e8e5-4df7-84bb-7a2a916d0ce9) | 特权提升     | 重要         | [MS12-008](https://go.microsoft.com/fwlink/?linkid=238387) |
...
<tr class="header">
<th>受影响的软件</th>
<th>PostMessage 函数漏洞 - CVE-2012-0157</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
PostMessage 函数漏洞 - CVE-2012-0157  
------------------------------------
  
  
Windows 内核模式驱动程序管理 PostMessage 函数的方式中存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0157](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0157)。
  
#### PostMessage 漏洞 (CVE-2012-0157) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### PostMessage 漏洞 (CVE-2012-0157) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### PostMessage 漏洞 (CVE-2012-0157) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。
  
**造成此漏洞的原因是什么？**  
当 Windows 内核模式驱动程序不正确地处理通过 PostMessage 函数传递的输入时，会导致该漏洞。
...
**此更新有什么作用？**  
此更新通过更正 Windows 内核模式驱动程序处理窗口消息传递的方式来解决此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2641653$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2641653">Microsoft 知识库文章 2641653</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2641653$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2641653](https://support.microsoft.com/kb/2641653)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Nikolaos Bougalis](https://technet.microsoft.com/zh-CN/mailto:nikb@bougalis.net) 报告了 PostMessage 函数漏洞 (CVE-2012-0157)

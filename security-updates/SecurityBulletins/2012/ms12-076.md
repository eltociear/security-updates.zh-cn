...
<td style="border:1px solid black;">
[MS12-030](http://go.microsoft.com/fwlink/?linkid=238499) 中的 KB2597086 由 KB2687481 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-030](http://go.microsoft.com/fwlink/?linkid=238499) 中的 KB2597161 由 KB2687307 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-030](http://go.microsoft.com/fwlink/?linkid=238499) 中的 KB2597166 由 KB2597126 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-030](http://go.microsoft.com/fwlink/?linkid=238499) 中的 KB2665346 由 KB2764048 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-051](http://go.microsoft.com/fwlink/?linkid=255000) 中的 KB2721015 由 KB2764047 替代
</td>
</tr>
<tr>
<th colspan="5" style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-030](http://go.microsoft.com/fwlink/?linkid=238499) 中的 KB2596842 由 KB2687313 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-030](http://go.microsoft.com/fwlink/?linkid=238499) 中的 KB2597162 由 KB2687311 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [11 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms12-nov)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](http://technet.microsoft.com/security/cc998259)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1885](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1885)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1886](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1886)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1887](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1887)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2543](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2543)。
...
**变通办法的影响。** 对于 Microsoft Office 2007，配置了文件阻止策略但是尚未配置特殊例外目录或将文件移动到可信位置的用户将无法打开 Office 2003 文件或更早版本。对于 Microsoft Office 2010、Office 2003 文件或更早版本，将阻止打开或在受保护的模式中打开 RTF 文件，具体取决于所选择的打开行为。有关 Microsoft Office 软件中的文件阻止设置的影响的详细信息，请参阅 [Microsoft 知识库文章 922850](http://support.microsoft.com/kb/922850)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2687481">Microsoft 知识库文章 2687481</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2687307">Microsoft 知识库文章 2687307</a><br />
请参阅 <a href="http://support.microsoft.com/kb/2687313">Microsoft 知识库文章 2687313</a><br />
请参阅 <a href="http://support.microsoft.com/kb/2687311">Microsoft 知识库文章 2687311</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2597126">Microsoft 知识库文章 2597126</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   Sean Larsson 与 [iDefense VCP](http://labs.idefense.com) 合作报告了 Excel SerAuxErrBar 堆溢出漏洞 (CVE-2012-1885)  
-   一位匿名研究人员与 [iDefense VCP](http://labs.idefense.com) 合作报告了 Excel 内存损坏漏洞 (CVE-2012-1886)  
-   一位匿名研究人员与 [iDefense VCP](http://labs.idefense.com) 合作报告了 Excel SST 无效长度释放后使用漏洞 (CVE-2012-1887)  
-   一名匿名研究人员与 [HP TippingPoint's](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 FEAT 记录堆栈溢出漏洞 (CVE-2012-2543)

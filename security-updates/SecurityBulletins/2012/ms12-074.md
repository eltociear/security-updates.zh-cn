...
<td style="border:1px solid black;">
[MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572066 由 KB2698035 替代  
[MS11-100](https://go.microsoft.com/fwlink/?linkid=232432) 中的 KB2656353 由 KB2698023 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) 中的 KB2633880 和 [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572073 由 KB2729450 替代  
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) 中的 KB2633870 和 [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572078 由 KB2729449 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-034](https://go.microsoft.com/fwlink/?linkid=251038) 中的 KB2656405 由 KB2737019 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572069 由 KB2698032 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) 中的 KB2633874 和 [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572075 由 KB2729453 替代  
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) 中的 KB2633870 和 [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572078 由 KB2729449 替代  
没有更新由 KB2729460 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) 中的 KB2633879 和 [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572076 由 KB2729451 替代  
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) 中的 KB2633870 和 [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572078 由 KB2729449 替代
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) 中的 KB2633873 和 [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572077 由 KB2729452 替代  
[MS12-016](https://go.microsoft.com/fwlink/?linkid=235370) 中的 KB2633870 和 [MS11-078](https://go.microsoft.com/fwlink/?linkid=227075) 中的 KB2572078 由 KB2729449 替代  
没有更新由 KB2729460 替代
</td>
</tr>
...
是的，此更新解决的 .NET Framework 不安全库加载漏洞 (CVE-2012-2519) 与 [Microsoft 安全通报 2269637](https://technet.microsoft.com/security/advisory/2269637) 中介绍的漏洞类别有关，其影响应用程序加载外部库的方式。此安全更新针对这种漏洞的特定实例。

**.Net Framework 4.5 Release Candidate** **是否** **受** **此公告中** **解决的漏洞影响？**  
是。更新适用于 Windows Vista、Windows Server 2008、Windows 7, Windows Server 2008 R2、Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 上的 Microsoft .NET Framework 4.5 Release Candidate。更新也适用于 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 上的 Microsoft .NET Framework 3.5。鼓励运行这些配置的客户向其系统应用此更新。这些更新通过 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 提供。

**此更新为何消除了多个已报告的安全漏洞？**  
此更新之所以包含对某些漏洞的支持，是因为解决这些问题所需的修改位于相关的文件中。

**此更新是否包含任何其他与安全性无关的功能更改？**  
是。除了此公告的""漏洞信息""部分中列出的更改之外，KB2756872 更新包括 [Microsoft 知识库文章2756872](https://support.microsoft.com/kb/2756872) 中描述的其他功能更改。请注意,此更新最初在 2012 年 10 月 10 日提供。已经安装了此更新的客户不需要执行任何操作，而且不会对其重新提供更新。
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [11 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms12-nov)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1895](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1895)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1896](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1896)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2519](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2519)。
...
Entity Framework 是 ADO.NET 中支持开发面向数据的软件应用程序的一组技术。有关详细信息，请参阅 MSDN 文章 [Entity Framework 概述](https://msdn.microsoft.com/en-us/library/bb399567.aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4776](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4776)。
...
-   **注册WPAD**
    ...
    请按照 [Microsoft 知识库文章 934864 中](https://support.microsoft.com/kb/934864)提供的步骤执行操作注册WPAD。

    **变通办法的影响。**管理员将会注册 WPAD 使攻击者没有可趁之机。

    **如何撤消变通方法。**有关详细信息，请参阅 [Microsoft 知识库文章 934864](https://support.microsoft.com/kb/934864)。
...
-   **不要依赖您的** **.NET应用程序中的默认 Web 代理设置**
    ...
    有关 webrequest.defaultwebproxy 属性的文档资料,请参阅[webrequest.defaultwebproxy 属性](https://msdn.microsoft.com/en-us/library/system.net.webrequest.defaultwebproxy.aspx)。
...
**什么是 Web 代理自动发现 (WPAD)？**  
Web 代理自动发现 (WPAD) 功能使 Web 客户端能够自动检测代理设置，无需用户干预。WPAD 功能预先考虑主机名称“wpad”直到完全限定的域名，并且逐渐删除子域名，直到其找到应答域名的 WPAD 服务器。有关详细信息，请参阅 [WinHTTP 自动代理支持](https://msdn.microsoft.com/en-us/library/system.net.webproxy.getdefaultproxy(v=vs.110).aspx)。
...
**此更新有什么作用？**  
该更新通过更新 System.Net 中的 Microsoft.Jscript 并限制 .NET Framework 如何执行 WPAD 配置文件中包含的 JavaScript 来解决漏洞。此更新还更改使用 WinHTTP 而不是 Microsoft.Jscript 处理 WPAD 的方式。此更改不太可能对具有非标准代理自动配置环境的环境造成一些兼容性问题。有关此更改的详细信息，请参阅 [Microsoft 知识库文章 2745030](https://support.microsoft.com/kb/2745030) 的“更多信息”部分。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4777](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4777)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2745030">Microsoft 知识库文章 2745030</a></td>
</tr>  
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>部署</strong></td>
<td style="border:1px solid black;">Windows RT 更新仅通过 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">更多信息</td>
<td style="border:1px solid black;">请参阅“<strong>检测和部署工具及指导</strong>”小节</td>

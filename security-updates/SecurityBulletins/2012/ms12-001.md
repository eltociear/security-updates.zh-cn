---
TOCTitle: 'MS12-001'
Title: 'Microsoft 安全公告 MS12-001 - 重要'
ms:assetid: 'ms12-001'
ms:contentKeyID: 61238239
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-001(v=Security.10)'
---


Microsoft 安全公告 MS12-001 - 重要
==================================

Windows 内核中的漏洞可能允许绕过安全功能 (2644615)
--------------------------------------------------

发布时间: 2012年1月10日 | 更新时间: 2012年2月22日
...
此安全更新可解决 Microsoft Windows 中一个秘密报告的漏洞。此漏洞可能允许攻击者在软件应用程序中绕过 SafeSEH 安全功能。然后，攻击者可能利用其他漏洞，借助结构化异常处理工具，运行任意代码。只能使用由 Microsoft Visual C++ .NET 2003 编译的软件应用程序才能利用此漏洞。

对于 Windows XP 受支持的基于 x64 的版本以及 Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节的“**受影响和不受影响的软件**”小节。

此安全更新通过修改 Windows 内核加载结构化异常处理表的方式来解决此漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。**[Microsoft 知识库文章 2644615](https://support.microsoft.com/kb/2644615) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                                  | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                                  | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                      | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                                  | 安全功能绕过 | 重要         | 无               |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                        | 安全功能绕过 | 重要         | 无               |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                            | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                               | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                          | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                        | 安全功能绕过 | 重要         | 无               |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                             | 安全功能绕过 | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | 安全功能绕过 | 重要         | 无               |
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 内核 SafeSEH 绕过漏洞 - CVE-2012-0001</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Windows 内核 SafeSEH 绕过漏洞 - CVE-2012-0001  
---------------------------------------------
  
<span></span>  
在 Windows 中存在一个由于内核加载结构化异常处理表的方式而导致的安全功能绕过漏洞。成功利用此漏洞的攻击者可以绕过 SafeSEH 的纵深防御机制，以便利用其他漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0001](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001)。
  
#### Windows 内核 SafeSEH 绕过漏洞 (CVE-2012-0001) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   只能使用由 Microsoft Visual C++ .NET 2003 编译的软件应用程序才能利用此漏洞。
  
    **注意** 有关如何确定编译特定的软件应用程序所使用的产品方面的帮助，请参阅 [Microsoft 知识库文章 2644615](https://support.microsoft.com/kb/2644615)。
  
#### Windows 内核 SafeSEH 绕过漏洞 (CVE-2012-0001) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **使用** **更新版本** **的** **Microsoft Visual** C++ 重新编译软件
  
    只能使用由 Microsoft Visual C++ .NET 2003 编译的软件应用程序才能利用此漏洞。要解决此问题，请使用 Microsoft Visual C++ 2005、Microsoft Visual C++ 2008 或 Microsoft Visual C++ 2010 重新编译此模型。
  
-   **启用** **结构化异常处理覆盖保护 (SEHOP)**
  
    对于 Windows Vista、Windows 7、Windows Server 2008 以及 Windows Server 2008 R2 系统，请参阅 [如何在 Windows 操作系统中启用结构化异常处理覆盖保护 (SEHOP)](https://support.microsoft.com/kb/956607)，了解有关为现有应用程序启用 SEHOP 的说明。
  
#### Windows 内核 SafeSEH 绕过漏洞 (CVE-2012-0001) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个安全功能绕过漏洞。成功利用此漏洞的攻击者可以绕过 SafeSEH 安全功能，以便利用其他漏洞。
  
**造成此漏洞的原因是什么？**  
此漏洞是在二进制执行期间 Windows 内核将一个结构化异常处理表加载到“加载配置” PE 标头时导致的。
...
**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可能在软件应用程序中绕过 SafeSEH 安全功能。然后，攻击者可能利用其他漏洞，借助结构化异常处理工具，运行任意代码。
  
**攻击者如何利用此** **漏洞？**  
为了利用此漏洞执行任意代码，攻击者首先必须绕过 SafeSEH 安全功能，然后借助此安全绕过条件的优势利用另一个漏洞来执行任意代码。
  
**什么** **是结构化** **异常** **处理工具？**  
结构化异常处理工具 (SEH) 是软件应用程序中的一个用于处理硬件和软件异常的机制。SEH 让程序员能够完全控制对异常的处理，提供对调试程序的支持，并且可以用于所有编程语言和计算机。
  
**什么是** **SafeSEH？**  
SafeSEH 是一种在出现缓冲区溢出的情况下保护结构化异常处理工具不被破坏或劫持的安全功能。
  
**受此漏洞威胁最大的系统有哪些？**  
工作站和服务器均受此漏洞威胁。
  
**此更新有什么作用？**  
此更新通过修改 Windows 内核加载结构化异常处理表的方式来解决此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2644615$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2644615">Microsoft 知识库文章 2644615</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2644615$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2644615](https://support.microsoft.com/kb/2644615)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Accuvant LABS](https://www.accuvant.com/) 的 Joshua J. Drake 报告了 Windows 内核 SafeSEH 绕过漏洞 (CVE-2012-0001)
...
-   V1.1（2012 年 2 月 22 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2644615 添加一个链接。

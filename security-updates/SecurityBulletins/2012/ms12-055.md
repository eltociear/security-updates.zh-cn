...
<td style="border:1px solid black;">
[MS12-047](https://go.microsoft.com/fwlink/?linkid=254380) 中的 KB2718523 由 KB2731847 替代
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ec759712-2f38-41a9-8b6d-c6908cc58479)（服务器核心安装）  
(KB2731847)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=caf68d77-3315-4383-a901-ba0385ffe561)（服务器核心安装）  
(KB2731847)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242)（服务器核心安装）  
(KB2731847)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=fc5b9df9-c836-407a-a1d4-364c1a885242)（服务器核心安装）  
(KB2731847)
</td>
<td style="border:1px solid black;">
特权提升
...
Microsoft 修订此公告是为了重新发布针对 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 提供的 KB2731847 更新，以便解决涉及 Microsoft 生成的、没有正确时间戳属性的特定数字证书的问题。有关详细信息，请参阅 [Microsoft 安全通报 2749655](https://technet.microsoft.com/security/advisory/2749655)。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**安全更新的哈希位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2731847](https://support.microsoft.com/kb/2731847)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2527](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2527)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2731847">Microsoft 知识库文章 2731847</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2731847](https://support.microsoft.com/kb/2731847)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Google Inc](https://www.google.com/) 的 Matthew Jurczyk 报告了 Win32k 释放后使用漏洞 (CVE-2012-2527)

...
**已知问题。**[Microsoft 知识库文章 2722913](https://support.microsoft.com/kb/2722913) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS12-037](https://go.microsoft.com/fwlink/?linkid=249045) 中的 KB2699988 由 KB2722913 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-044](https://go.microsoft.com/fwlink/?linkid=254377) 中的 KB2719177 由 KB2722913 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
**安** **全更新的**哈希位于何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2722913](https://support.microsoft.com/kb/2722913)。
...
此安全公告中所述的的 JavaScript 整数溢出远程执行代码漏洞 (CVE-2012-2523) 也由 [MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) 解决。

对于其系统上安装了 Internet Explorer 8 的客户，请安装 [MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) 中描述的 KB2706045 更新以免遭受 CVE-2012-2523 中描述的漏洞攻击。
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [8 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms12-aug)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1526](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1526)。
...
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/library/dd883248.aspx)”的受限模式下运行。此模式可减轻此漏洞。有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题解答”部分。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2521)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2522](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2522)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2523](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2523)。
...
**注意** 此更新不解决 Internet Explorer 8 的此漏洞。对于 Internet Explorer 8，此更新通过 [MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) 中描述的 KB2706045 更新提供。

**我的系统上安装了 Internet Explorer 8。在哪里可以找到解决 CVE-2012-2523 的更新？**  
其系统上安装了 Internet Explorer 8 的客户可以通过安装 [MS12-056](https://go.microsoft.com/fwlink/?linkid=256487) 中描述的 KB2706045 更新来解决 CVE-2012-2523 中描述的漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2722913">Microsoft 知识库文章 2722913</a></td>
</tr>  
<tr class="even">
...
-   GWSlabs 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了布局内存损坏漏洞 (CVE-2012-1526)  
-   Derek Soeder 与 [Beyond Security 的 SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) 计划合作报告了异步空对象访问远程执行代码漏洞 (CVE-2012-2521)  
-   [Trend Micro](https://www.trendmicro.com/) 的 Sung-ting Tsai 和 Ming-Chieh Pan 报告了虚拟功能表损坏远程执行代码漏洞 (CVE-2012-2522)  
-   [Google's Chrome Security Team](https://chrome.google.com/) 的 Cris Neckar 报告了 JavaScript 整数溢出远程执行代码漏洞 (CVE-2012-2523)

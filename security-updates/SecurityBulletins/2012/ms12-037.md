...
<td style="border:1px solid black;">
[MS12-023](http://go.microsoft.com/fwlink/?linkid=242739) 中的 KB2675157 由 KB2699988 替代
</td>
</tr>
...
本公告中描述的 HTML 清理漏洞 (CVE-2011-1252) 也会影响 Microsoft Lync。但您只能安装与您的系统上安装的软件对应的更新。如果您已安装 Internet Explorer，请根据此公告应用所需更新。如果您已安装 Microsoft Lync，请根据 [MS12-039](http://go.microsoft.com/fwlink/?linkid=252488) 应用所需更新。
...
是。KB2699988 更新适用于 Windows 8 Consumer Preview 版本。鼓励使用 Windows 8 Consumer Preview 的客户向其系统应用更新。仅在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1523](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1523)。
...
**什么是 toStaticHTML方法？**  
toStaticHTML 方法可用于在将用户输入显示为 HTML 之前从中删除事件属性和脚本。有关详细信息，请参阅 [toStaticHTML 方法](http://msdn.microsoft.com/en-us/library/cc848922.aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1872](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1872)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1873](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1873)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1874](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1874)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1875](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1875)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1876](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1876)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1877](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1877)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1878](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1878)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1879](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1879)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1880](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1880)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1881](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1881)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1882](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1882)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-1882](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1882)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2699988">Microsoft 知识库文章 2699988</a></td>
</tr>  
<tr class="even">
...
-   一位匿名研究员与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了中心元素远程执行代码漏洞 (CVE-2012-1523)  
...
-   [VulnHunt](http://www.vulnhunt.com) 的 Code Audit Labs 报告了开发工具栏远程执行代码漏洞 (CVE-2012-1874)  
-   [VulnHunt](http://www.vulnhunt.com) 的 Dark Son 报告了相同 ID 属性远程执行代码漏洞 (CVE-2012-1875)  
-   [Qihoo 360 Security Center](http://www.360.cn/) 与我们一起处理了相同 ID 属性远程执行代码漏洞 (CVE-2012-1875)  
-   McAfee Labs 的 Yichong Lin 与我们一起处理了相同 ID 属性远程执行代码漏洞 (CVE-2012-1875)  
-   [Google Inc.](http://www.google.com/) 与我们一起处理了相同 ID 属性远程执行代码漏洞 (CVE-2012-1875)  
-   [VUPEN Security](http://www.vupen.com) 与 [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Col 元素远程执行代码漏洞 (CVE-2012-1876)  
-   一位匿名研究人员与 [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了标题元素更改远程执行代码漏洞 (CVE-2012-1877)  
-   一位匿名研究人员与 [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 OnBeforeDeactivate 事件远程执行代码漏洞 (CVE-2012-1878)  
-   一位匿名研究人员与 [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 insertAdjacentText 远程执行代码漏洞 (CVE-2012-1879)  
-   一位匿名研究人员与 [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 insertRow 远程执行代码漏洞 (CVE-2012-1880)  
-   一位匿名研究人员与 [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 OnRowsInserted 事件远程执行代码漏洞 (CVE-2012-1881)

---
TOCTitle: 'MS12-037'
Title: 'Microsoft 安全公告 MS12-037 - 严重'
ms:assetid: 'ms12-037'
ms:contentKeyID: 61238379
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-037(v=Security.10)'
---
...
该更新通过修改 Internet Explorer 处理内存中对象的方式、使用 toStaticHTML 的 HTML 清理、Internet Explorer 在某些进程中呈现数据的方式以及 Internet Explorer 创建和初始化字符串的方式来解决这些漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[MS12-023](https://go.microsoft.com/fwlink/?linkid=242739) 中的 KB2675157 由 KB2699988 替代
</td>
</tr>
...
**此安全更新与　MS12-039 有什么联系？**  
本公告中描述的 HTML 清理漏洞 (CVE-2011-1252) 也会影响 Microsoft Lync。但您只能安装与您的系统上安装的软件对应的更新。如果您已安装 Internet Explorer，请根据此公告应用所需更新。如果您已安装 Microsoft Lync，请根据 [MS12-039](https://go.microsoft.com/fwlink/?linkid=252488) 应用所需更新。
...
**Windows 8 Consumer Preview 是否受此公告解决的任何漏洞影响？**  
是。KB2699988 更新适用于 Windows 8 Consumer Preview 版本。鼓励使用 Windows 8 Consumer Preview 的客户向其系统应用更新。仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
**此更新是否包含 任何其他与安全性无关 的功能更改？**  
是。除了本公告的“漏洞信息”部分列出的更改之外，此更新还包括适用于 Internet Explorer 7 的与安全性无关的更改。这些更改可帮助确保安装此更新之后不存在兼容性问题。
...
<th>
中心元素远程执行代码漏洞 - CVE-2012-1523
</th>
<th>
HTML 清理漏洞 - CVE-2012-1858
</th>
<th>
EUC-JP 字符编码漏洞 - CVE-2012-1872
</th>
<th>
空字节信息泄露漏洞 - CVE-2012-1873
</th>
<th>
开发工具栏远程执行代码漏洞 - CVE-2012-1874
</th>
</tr>
<tr>
...
<th>
相同 ID 属性远程执行代码漏洞 - CVE-2012-1875
</th>
<th>
Col 元素远程执行代码漏洞 - CVE-2012-1876
</th>
<th>
标题元素更改远程执行代码漏洞 - CVE-2012-1877
</th>
<th>
OnBeforeDeactivate 事件远程执行代码漏洞 - CVE-2012-1878
</th>
<th>
insertAdjacentText 远程执行代码漏洞 - CVE-2012-1879
</th>
</tr>
<tr>
<th colspan="6" style="border:1px solid black;">
...
<th>
insertRow 远程执行代码漏洞 - CVE-2012-1880
</th>
<th>
OnRowsInserted 事件远程执行代码漏洞 - CVE-2012-1881
</th>
<th>
滚动事件信息泄露漏洞 - CVE-2012-1882
</th>
<th>
综合严重等级
</th>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1523](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1523)。

#### 中心元素远程执行代码漏洞 (CVE-2012-1523) 的缓解因素
...
#### 中心元素远程执行代码漏洞 (CVE-2012-1523) 的变通办法
...
#### 中心元素远程执行代码漏洞 (CVE-2012-1523) 的常见问题
...
Internet Explorer 在清理 HTML 时处理使用特定字符串的方式中存在一个信息泄露漏洞。如果用户查看网页，攻击者可通过构建一个允许信息泄露的特制网页来利用漏洞。成功利用此漏洞的攻击者会干扰用户的跨站点脚本执行，允许攻击者在使用 toStaticHTML 方法的站点上的用户安全上下文中执行脚本。
...
-   **以纯文本格式读取电子邮件**
    ...
    已应用了 Office XP Service Pack 1、Office XP Service Pack 2 或 Office XP Service Pack 3 的 Microsoft Office Outlook 2002 用户可以启用此设置，并仅以纯文本格式查看未经过数字签名的电子邮件或者未加密的电子邮件。
...
**此漏洞的影响范围有多大？**  
这是一个信息泄露漏洞。在用户查看使用 toStaticHTML 方法的网页时，利用此漏洞的攻击者可能会对用户执行跨站点脚本攻击。

**造成此漏洞的原因是什么？**  
Internet Explorer 中包括的 toStaticHTML API 在清理 HTML 时处理使用特定字符串的内容的方式中存在漏洞。

**什么是 toStaticHTML方法？**  
toStaticHTML 方法可用于在将用户输入显示为 HTML 之前从中删除事件属性和脚本。有关详细信息，请参阅 [toStaticHTML 方法](https://msdn.microsoft.com/en-us/library/cc848922.aspx)。

**此漏洞与 MS12-039 中的 CVE-2012-1858“Lync　中的漏洞可能允许远程执行代码？” 是否相关？**  
是的，HTML 清理漏洞 (CVE-2012-1858) 也影响 Microsoft Lync。

**攻击者可能利用此漏洞执行什么操作？**  
如果用户查看使用 toStaticHTML 方法清理 HTML 的网站，则成功利用该漏洞的攻击者可能会对这些用户执行跨站点脚本攻击。然后，攻击者可能会代表站点上的受害用户运行脚本。
...
**此更新有什么作用？**  
此更新通过修改 Internet Explorer 使用 toStaticHTML 方法处理 HTML 清理的方式来解决此漏洞。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1872](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1872)。

#### EUC-JP 字符编码漏洞 (CVE-2012-1872) 的缓解因素
...
#### EUC-JP 字符编码漏洞 (CVE-2012-1872) 的变通办法
...
#### EUC-JP 字符编码漏洞 (CVE-2012-1872) 的常见问题

**此漏洞的影响范围有多大？**  
这是可能会导致信息泄露的跨站点脚本执行漏洞。
...
Internet Explorer 中存在一个信息泄露漏洞，可能允许攻击者访问和读取 Internet Explorer 的进程内存。如果用户查看网页，攻击者可通过构建一个允许信息泄露的特制网页来利用此漏洞。成功利用此漏洞的攻击者可以从 Internet Explorer 进程内存中查看内容。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1873](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1873)。

#### 空字节信息泄露漏洞 (CVE-2012-1873) 的缓解因素
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1874](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1874)。

#### 开发工具栏远程执行代码漏洞 (CVE-2012-1874) 的缓解因素
...
-   默认情况下，Microsoft Outlook、Microsoft Outlook Express 和 Windows Mail 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。“受限站点”区域（禁用脚本和 ActiveX 控件）可帮助降低攻击者使用此漏洞执行恶意代码的风险。在基于 Web 的攻击情形中，如果用户单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/en-us/library/dd883248(ws.10).aspx)”的受限模式下运行。此模式可减轻此漏洞。有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题解答”部分。
-   要利用此漏洞，需要进行用户交互。用户在访问特制网站时必须打开 Internet Explorer 开发工具栏。

#### 开发工具栏远程执行代码漏洞 (CVE-2012-1874) 的变通办法
...
#### 开发工具栏远程执行代码漏洞 (CVE-2012-1874) 的常见问题
...
**攻击者如何利用此漏洞？**  
攻击者可能拥有一个旨在通过 Internet Explorer 利用此漏洞的特制网站，然后诱使用户查看该网站并打开 Internet Explorer 开发工具栏。攻击者也可能在宿主 IE 呈现引擎的应用程序或 Microsoft Office 文档中嵌入标有“安全初始化”的 ActiveX 控件。攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。这些网站可能包含可以利用此漏洞的特制内容。但是在所有情况下，攻击者无法强制用户查看由攻击者控制的内容。相反，攻击者必须诱使用户采取行动，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站，或者让用户打开通过电子邮件发送的附件。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1875](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1875)。

#### 相同 ID 属性远程执行代码漏洞 (CVE-2012-1875) 的缓解因素
...
#### 相同 ID 属性远程执行代码漏洞 (CVE-2012-1875) 的变通办法
...
#### 相同 ID 属性远程执行代码漏洞 (CVE-2012-1875) 的常见问题
...
**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
是。Microsoft 获悉尝试使用此漏洞的有限攻击。但是，当安全公告重新发布时，Microsoft 尚未发现已发布任何概念证明代码示例。

Col 元素远程执行代码漏洞 - CVE-2012-1876
----------------------------------------

Internet Explorer 访问不存在的对象的方式中存在一个远程执行代码漏洞。该漏洞可能以一种攻击者可以在当前用户的上下文中执行任意代码的方式损坏内存。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1876](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1876)。

#### Col 元素远程执行代码漏洞 (CVE-2012-1876) 的缓解因素
...
#### Col 元素远程执行代码漏洞 (CVE-2012-1876) 的变通办法
...
#### Col 元素远程执行代码漏洞 (CVE-2012-1876) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。

**造成此漏洞的原因是什么？**  
当 Internet Explorer 尝试访问不存在的对象时，可能破坏内存而使攻击者能够在当前用户的上下文中执行任意代码。
...
**此更新有什么作用？**  
此更新通过修改 Internet Explorer 访问内存中对象的方式来消除此漏洞。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1877](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1877)。

#### 标题元素更改远程执行代码漏洞 (CVE-2012-1877) 的缓解因素
...
#### 标题元素更改远程执行代码漏洞 (CVE-2012-1877) 的变通办法
...
#### 标题元素更改远程执行代码漏洞 (CVE-2012-1877) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1878](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1878)。

#### OnBeforeDeactivate 事件远程执行代码漏洞 (CVE-2012-1878) 的缓解因素
...
#### OnBeforeDeactivate 事件远程执行代码漏洞 (CVE-2012-1878) 的变通办法
...
#### OnBeforeDeactivate 事件远程执行代码漏洞 (CVE-2012-1878) 的常见问题
...
Internet Explorer 访问未定义的内存位置的方式中存在一个远程执行代码漏洞。该漏洞可能以一种攻击者可以在当前用户的上下文中执行任意代码的方式损坏内存。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1879](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1879)。

#### insertAdjacentText 远程执行代码漏洞 (CVE-2012-1879) 的缓解因素
...
#### insertAdjacentText 远程执行代码漏洞 (CVE-2012-1879) 的变通办法
...
#### insertAdjacentText 远程执行代码漏洞 (CVE-2012-1879) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。

**造成此漏洞的原因是什么？**  
当 Internet Explorer 尝试访问未定义的内存位置时，可能破坏内存而使攻击者能够在当前用户的上下文中执行任意代码。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1880](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1880)。

#### insertRow 远程执行代码漏洞 (CVE-2012-1880) 的缓解因素
...
#### insertRow 远程执行代码漏洞 (CVE-2012-1880) 的变通办法
...
#### insertRow 远程执行代码漏洞 (CVE-2012-1880) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1881](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1881)。

#### OnRowsInserted 事件远程执行代码漏洞 (CVE-2012-1881) 的缓解因素
...
#### OnRowsInserted 事件远程执行代码漏洞 (CVE-2012-1881) 的变通办法
...
#### OnRowsInserted 事件远程执行代码漏洞 (CVE-2012-1881) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1882](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1882)。

#### 滚动事件信息泄露漏洞 (CVE-2012-1882) 的缓解因素
...
#### 滚动事件信息泄露漏洞 (CVE-2012-1882) 的变通办法
...
#### 滚动事件信息泄露漏洞 (CVE-2012-1882) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个信息泄露漏洞。

**造成此漏洞的原因是什么？**  
Internet Explorer 不会阻止跨域滚动事件，允许攻击者从不同域访问内容。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-1882](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1882)。
...
<p>使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2699988$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie7updates\KB2699988-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie8updates\KB2699988-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2699988">Microsoft 知识库文章 2699988</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2699988$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
-   一位匿名研究员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了中心元素远程执行代码漏洞 (CVE-2012-1523)  
-   [IBM Security Systems - Application Security](https://blog.watchfire.com/) 的 Adi Cohen 报告了 HTML 清理漏洞 (CVE-2012-1858)  
-   Masato Kinugawa 报告了 EUC-JP 字符编码漏洞 (CVE-2012-1872)  
-   LinkedIn 的 Roman Shafigullin 报告了空字节信息泄露漏洞 (CVE-2012-1873)  
-   [VulnHunt](https://www.vulnhunt.com) 的 Code Audit Labs 报告了开发工具栏远程执行代码漏洞 (CVE-2012-1874)  
-   [VulnHunt](https://www.vulnhunt.com) 的 Dark Son 报告了相同 ID 属性远程执行代码漏洞 (CVE-2012-1875)  
-   [Qihoo 360 Security Center](https://www.360.cn/) 与我们一起处理了相同 ID 属性远程执行代码漏洞 (CVE-2012-1875)  
-   McAfee Labs 的 Yichong Lin 与我们一起处理了相同 ID 属性远程执行代码漏洞 (CVE-2012-1875)  
-   [Google Inc.](https://www.google.com/) 与我们一起处理了相同 ID 属性远程执行代码漏洞 (CVE-2012-1875)  
-   [VUPEN Security](https://www.vupen.com) 与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Col 元素远程执行代码漏洞 (CVE-2012-1876)  
-   一位匿名研究人员与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了标题元素更改远程执行代码漏洞 (CVE-2012-1877)  
-   一位匿名研究人员与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 OnBeforeDeactivate 事件远程执行代码漏洞 (CVE-2012-1878)  
-   一位匿名研究人员与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 insertAdjacentText 远程执行代码漏洞 (CVE-2012-1879)  
-   一位匿名研究人员与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 insertRow 远程执行代码漏洞 (CVE-2012-1880)  
-   一位匿名研究人员与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 OnRowsInserted 事件远程执行代码漏洞 (CVE-2012-1881)

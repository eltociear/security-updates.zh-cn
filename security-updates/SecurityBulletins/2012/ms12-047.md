---
TOCTitle: 'MS12-047'
Title: 'Microsoft 安全公告 MS12-047 - 重要'
ms:assetid: 'ms12-047'
ms:contentKeyID: 61238389
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-047(v=Security.10)'
---
Microsoft 安全公告 MS12-047 - 重要
==================================

Windows 内核模式驱动程序中的漏洞可能允许特权提升 (2718523)
----------------------------------------------------------
...
该安全更新通过更正 Windows 内核模式驱动程序在创建挂接过程时处理键盘布局文件和验证回叫参数的方式来解决漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[MS12-041](https://go.microsoft.com/fwlink/?linkid=251707) 中的 KB2709162 由 KB2718523 替代
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc)（服务器核心安装）  
(KB2718523)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1)（服务器核心安装）  
(KB2718523)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)（服务器核心安装）  
(KB2718523)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)（服务器核心安装）  
(KB2718523)
</td>
<td style="border:1px solid black;">
特权提升
...
**安** **全更新的**哈希位于何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2718523](https://support.microsoft.com/kb/2718523)。
...
<th>
键盘布局漏洞 - CVE-2012-1890
</th>
<th>
Win32k 错误类型处理漏洞 - CVE-2012-1893
</th>
<th>
综合严重等级
</th>
...
Windows 内核模式驱动程序处理特定键盘布局的方式中存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1890](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890)。

#### 键盘布局漏洞 (CVE-2012-1890) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### 键盘布局漏洞 (CVE-2012-1890) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 键盘布局漏洞 (CVE-2012-1890) 的常见问题
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-1890](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890)。
...
如果 Windows 内核模式驱动程序在创建挂接过程时不正确地验证参数，则存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1893](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893)。

#### Win32k 错误类型处理漏洞 (CVE-2012-1893) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### Win32k 错误类型处理漏洞 (CVE-2012-1893) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### Win32k 错误类型处理漏洞 (CVE-2012-1893) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。

**造成此漏洞的原因是什么？**  
如果 Windows 内核模式驱动程序在创建挂接过程时不正确地验证参数，则会导致该漏洞。
...
**此更新有什么作用？**  
该更新通过更正 Windows 内核模式驱动程序在创建挂接过程时验证回叫参数的方式来解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2718523$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2718523">Microsoft 知识库文章 2718523</a></td>
</tr>  
<tr class="even">
...
WindowsServer2003-KB2718523-x86-ENU.exe /quiet
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
WindowsServer2003.WindowsXP-KB2718523-x64-ENU.exe /quiet
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
WindowsServer2003-KB2718523-ia64-ENU.exe /quiet
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的 32 位版本：  
WindowsServer2003-KB2718523-x86-ENU.exe /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的基于 x64 的版本：  
WindowsServer2003.WindowsXP-KB2718523-x64-ENU.exe /norestart
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
对于 Windows Server 2003 所有受支持的基于 Itanium 的版本：  
WindowsServer2003-KB2718523-ia64-ENU.exe /norestart
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2718523$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2718523](https://support.microsoft.com/kb/2718523)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows Server 2003\\SP3\\KB2718523\\Filelist
</td>
</tr>
</table>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><strong>包括在</strong> <strong>以后的</strong> <strong>Service Pack 中</strong></td>
<td style="border:1px solid black;">此问题的更新程序将包含在以后的 Service Pack 或更新汇总中</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>部署</strong></td>
...
-   [Core Security Technologies](https://www.coresecurity.com/) 的 Nicolas Economou 报告了键盘布局漏洞 (CVE-2012-1890)  
-   [Qihoo 360 Security Center](https://www.360.cn/) 报告了键盘布局漏洞 (CVE-2012-1890)  
-   Neusoft Corporation 的 Lufeng Li 与 [Secunia Research](https://secunia.com/) 合作报告了 Win32k 错误类型处理漏洞 (CVE-2012-1893)

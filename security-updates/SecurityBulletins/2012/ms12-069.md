...
<td style="border:1px solid black;">
[MS11-013](https://go.microsoft.com/fwlink/?linkid=208523) 中的 KB2425227 由 KB2743555 替代
</td>
</tr>
...
**安全更新的哈希位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 KB2743555](https://support.microsoft.com/kb/2743555)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2551](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2551)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2743555">Microsoft 知识库文章 2743555</a></td>
</tr>  
<tr class="odd">

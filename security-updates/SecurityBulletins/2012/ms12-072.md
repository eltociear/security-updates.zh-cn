---
TOCTitle: 'MS12-072'
Title: 'Microsoft 安全公告 MS12-072 - 严重'
ms:assetid: 'ms12-072'
ms:contentKeyID: 61238414
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-072(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-072 - 严重
==================================
...
此安全更新可解决 Microsoft Windows 中两个秘密报告的漏洞。如果用户在 Windows 资源管理器中浏览到特制公文包，则该漏洞可能允许远程执行代码。成功利用漏洞的攻击者可能以当前用户的身份运行任意代码。如果当前用户使用管理用户权限登录，攻击者便可完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

对于 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008（Windows Server 2008（用于基于 Itanium 的系统）除外）、Windows 7、Windows Server 2008 R2（Windows Server 2008 R2（用于基于 Itanium 的系统）除外）、Windows 8（Windows RT 除外）以及 Windows Server 2012 的所有受支持版本，此安全更新的等级为“重要”。Windows Server 2008（用于基于 Itanium 的系统）、Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows RT 不受漏洞影响。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

该安全更新通过修改 Microsoft Windows 处理特制公文包的方式来解决漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
**我正在运行 Windows Server 2008。为什么不向我提供安全更新 KB2727528？**  
仅当已安装并启用了可选[桌面体验功能](https://technet.microsoft.com/library/cc772567(v=ws.10))时，KB2727528 更新才适用于运行 Windows Server 2008 受支持版本的系统。安装并启用了桌面体验功能的 Windows Server 2008 客户将拥有 KB2727528 更新解决的容易受到攻击的组件，因此需要安装此安全更新。未安装桌面体验功能或安装了但未启用该功能的客户不会拥有容易受到攻击的组件，因此不被提供安全更新程序包 KB2727528。

**我正在运行 Windows Server 2008 R2。为什么不向我提供安全更新 KB2727528？**  
仅当已安装并启用了可选[桌面体验功能](https://technet.microsoft.com/library/cc772567)时，KB2727528 更新才适用于运行 Windows Server 2008 R2 受支持版本的系统。安装并启用了桌面体验功能的 Windows Server 2008 R2 客户将拥有 KB2727528 更新解决的容易受到攻击的组件，因此需要安装此安全更新。未安装桌面体验功能或安装了但未启用该功能的客户不会拥有容易受到攻击的组件，因此不被提供安全更新程序包 KB2727528。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**安** **全更新的**哈希位于何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2727528](https://support.microsoft.com/kb/2727528)。

**Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 是否受此公告中解决的漏洞影响？**  
是。KB2727528 更新适用于 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。此更新仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供。
...
<th>
Windows 公文包整数下溢漏洞 - CVE-2012-1527
</th>
<th>
Windows 公文包整数溢出漏洞 - CVE-2012-1528
</th>
<th>
综合严重等级
</th>
...
Windows 中的公文包功能中存在一个远程执行代码漏洞。攻击者可通过诱使用户打开特制公文包来利用此漏洞。成功利用此漏洞的攻击者可以在当前用户的安全上下文中执行任意代码。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1527](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1527)。

#### Windows 公文包整数下溢漏洞 (CVE-2012-1527) 的缓解因素
...
#### Windows 公文包整数下溢漏洞 (CVE-2012-1527) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **卸载 Briefcase Namespace Shell Extension**
    ...
    **警告** 如果不正确地使用注册表编辑器，可能导致严重的问题，或许需要您重新安装操作系统。Microsoft 不保证您可以解决因错误运用注册表编辑器而产生的问题。使用注册表编辑器的风险由您自己承担。
    ...
    2.  创建一个包含下列内容并且名为 Disable\_briefcase.reg 的文本文件：

        `Windows Registry Editor Version 5.00[-HKEY_CLASSES_ROOT\CLSID\{85BBD920-42A0-1069-A2E4-08002B30309D}]`

    3.  从提升命令提示符处使用下列命令运行 Disable\_briefcase.reg：

        `Regedit.exe /s Disable_briefcase.reg`

    **变通办法的影响。** 如果您卸载 Briefcase Namespace Shell Extension，则公文包同步机制将不再可用。
...
#### Windows 公文包整数下溢漏洞 (CVE-2012-1527) 的常见问题

**此漏洞的影响范围有多大？**  
这是当前用户上下文中的远程执行代码漏洞。

**造成此漏洞的原因是什么？**  
当 Windows 不正确地处理特制公文包时，会导致该漏洞。

**什么是公文包？**  
公文包是 Windows 中同步两个文件夹的内容的一项功能。公文包有助于用户在设备（如 USB 拇指驱动器）和计算机之间同步文件夹。有关详细信息，请参阅[使用公文包同步](https://windows.microsoft.com/en-us/windows7/sync-using-briefcase)。
...
**攻击者如何利用此** **漏洞？**  
攻击者可能会将特制公文包放在网络共享上，并诱使用户使用 Windows 资源管理器浏览到位置。

**受此漏洞威胁最大的系统有哪些？**  
用户可能浏览到不受信任的网络位置的工作站。如果管理员允许用户登录服务器并运行程序，服务器同样可能面临风险。不过，最佳做法是不要授予这样的权限。

**此更新有什么作用？**  
该更新通过修改 Microsoft Windows 处理特制公文包的方式来解决漏洞。
...
Windows 中的公文包功能中存在一个远程执行代码漏洞。攻击者可通过诱使用户打开特制 Windows 公文包来利用此漏洞。成功利用此漏洞的攻击者可以在当前用户的安全上下文中执行任意代码。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1528](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1528)。

#### Windows 公文包整数溢出漏洞 (CVE-2012-1528) 的缓解因素
...
#### Windows 公文包整数溢出漏洞 (CVE-2012-1528) 的变通办法
...
-   **卸载 Briefcase Namespace Shell Extension**
    ...
    **变通办法的影响。** 如果您卸载 Briefcase Namespace Shell Extension，则公文包同步机制将停止工作。
...
#### Windows 公文包整数溢出漏洞 (CVE-2012-1528) 的常见问题
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2727528$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2727528">Microsoft 知识库文章 2727528</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2727528$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2727528](https://support.microsoft.com/kb/2727528)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Tal Zeltzer 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Windows 公文包整数下溢漏洞 (CVE-2012-1527)  
-   Tal Zeltzer 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 报告了 Windows 公文包整数溢出漏洞 (CVE-2012-1528)
...
-   V1.1（2012 年 11 月 14 日）： 阐明了在运行 Windows Server 2008 和 Windows Server 2008 R2 的受支持版本的系统上，仅当已安装并启用了可选桌面体验功能时，此更新才适用。有关详细信息，请参阅更新常见问题。

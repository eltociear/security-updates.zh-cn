---
TOCTitle: 'MS12-032'
Title: 'Microsoft 安全公告 MS12-032 - 重要'
ms:assetid: 'ms12-032'
ms:contentKeyID: 61238374
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-032(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-032 - 重要
==================================
...
该安全更新通过修改 Windows 防火墙处理出站广播数据包的方式以及 Windows TCP/IP 堆栈处理 IPv6 地址与本地接口绑定的方式来解决漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[MS11-083](https://go.microsoft.com/fwlink/?linkid=229071) 中的 KB2588516 由 KB2688338 替代
</td>
</tr>
...
<th>
Windows 防火墙绕过漏洞 - CVE-2012-0174
</th>
<th>
TCP/IP 双重释放漏洞 - CVE-2012-0179
</th>
<th>
综合严重等级
</th>
...
由于 Windows 防火墙处理出站广播数据包的方式，Windows 中存在一个安全功能绕过漏洞。成功利用此漏洞的攻击者可以绕过 Windows 防火墙的纵深防御机制，以便利用其他漏洞。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0174](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0174)。

#### Windows 防火墙绕过漏洞 (CVE-2012-0174) 的缓解因素

Microsoft 并未发现此漏洞的任何缓解因素。

#### Windows 防火墙绕过漏洞 (CVE-2012-0174) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### Windows 防火墙绕过漏洞 (CVE-2012-0174) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个安全功能绕过漏洞。成功利用此漏洞的攻击者可以绕过 Windows 防火墙以便利用其他漏洞。

**造成此漏洞的原因是什么？**  
当 Windows 防火墙使用应用的出站防火墙规则无法正确地筛选出站广播数据包时，会导致该漏洞。

**哪个 组件受此漏洞的影响？**  
受此漏洞影响的组件是 TCP/IP 堆栈 (tcpip.sys)。
...
**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以绕过 Windows 防火墙。然后，攻击者可以使用其他漏洞获取有关目标系统的信息或在目标系统上执行代码。

**攻击者如何利用此 漏洞？**  
为使用此漏洞，攻击者首先必须获得目标计算机的本地子网的访问权限。然后，攻击者可以使用其他漏洞获取有关目标系统的信息或在目标系统上执行代码。

**受此漏洞威胁最大的系统有哪些？**  
工作站和服务器受此漏洞的威胁最大。

**此更新有什么作用？**  
该更新通过修改 Windows 防火墙处理出站广播数据包的方式来解决漏洞。

**默认出站防火墙策略是什么？**  
配置默认出站防火墙策略以允许来自主机的所有出站网络通信。为阻止不需要的出站网络通信，客户需要创建防火墙规则来阻止通信。有关添加出站防火墙规则的详细信息，请参阅 TechNet 文章[创建可阻止不需要的出站网络通信的规则](https://technet.microsoft.com/en-us/library/cc732306(v=ws.10).aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0179](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179)。

#### TCP/IP 双重释放漏洞 (CVE-2012-0179) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### TCP/IP 双重释放漏洞 (CVE-2012-0179) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### TCP/IP 双重释放漏洞 (CVE-2012-0179) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。

**造成此漏洞的原因是什么？**  
当 Windows TCP/IP 堆栈无法正确处理 IPv6 地址与本地接口的绑定时，会导致该漏洞。
...
**此更新有什么作用？**  
该更新通过修改 Windows TCP/IP 堆栈处理 IPv6 地址与本地接口绑定的方式来解决漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-0179](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2688338">Microsoft 知识库文章 2688338</a></td>
</tr>  
<tr class="odd">
...
-   [INFIGO IS](https://www.infigo.hr/) 的 Bojan Zdrnja 报告了 Windows 防火墙绕过漏洞 (CVE-2012-0174)  
-   [Genesys Telecommunications](https://www.genesyslab.com/) 的 Anatoliy Glagolev 与我们合作处理了 TCP/IP 双重释放漏洞 (CVE-2012-0179)
...
-   V1.1（2012 年 5 月 9 日）： 在“**漏洞信息**”部分更正了 CVE-2012-0174 和 CVE-2012-0179 的缓解因素。

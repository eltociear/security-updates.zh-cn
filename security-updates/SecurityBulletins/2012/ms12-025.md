...
**\*服务器核心安装受到影响。**此更新适用于所示 Windows Server 2008 R2 的受支持版本（无论是否使用“服务器核心”安装选项进行安装），严重等级相同。有关此安装选项的详细信息，请参阅 TechNet 文章[管理服务器核心安装](https://technet.microsoft.com/en-us/library/ee441255(ws.10).aspx)和[服务服务器核心安装](https://technet.microsoft.com/en-us/library/ff698994(ws.10).aspx)。注意，“服务器核心”安装选项不适用于某些 Windows Server 2008 R2版本；请参阅["比较服务器核心”安装选项](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)。
...
|------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| Windows Developer Preview 上的 Microsoft .NET Framework 3.5                                          | [Microsoft 知识库文章 2656380](https://support.microsoft.com/kb/2656380) |
| Windows Developer Preview 上的 Microsoft .NET Framework 4.5                                          | [Microsoft 知识库文章 2656371](https://support.microsoft.com/kb/2656371) |
| Windows Server 2008、Windows 7 和 Windows Server 2008 R2 上的 Microsoft .NET Framework 4.5 Developer | [Microsoft 知识库文章 2656381](https://support.microsoft.com/kb/2656381) |
...
此公告描述了 .NET Framework 2.0 功能层中的一个漏洞。.NET Framework 3.0 Service Pack 2 安装程序链接在 .NET Framework 2.0 Service Pack 2 安装程序中，因此安装前者也就安装了后者。因此，安装了 .NET Framework 3.0 Service Pack 2 的客户需要安装 .NET Framework 2.0 Service Pack 2 的安全更新。有关详细信息，请参阅 [Microsoft 知识库文章 2695500](https://go.microsoft.com/fwlink/?linkid=247462)。

**我安装了 .NET Framework 3.5 Service Pack 1。我需要安装任何更新吗？**  
此公告描述了 .NET Framework 2.0 功能层中的一个漏洞。.NET Framework 3.5 Service Pack 1 安装程序链接在 .NET Framework 2.0 Service Pack 2 安装程序和 .NET Framework 3.0 Service Pack 2 安装程序中。因此，安装了 .NET Framework 3.5 Service Pack 1 的客户需要安装 .NET Framework 2.0 Service Pack 2 的安全更新。有关详细信息，请参阅 [Microsoft 知识库文章 2695500](https://go.microsoft.com/fwlink/?linkid=247462)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0163](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0163)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2671605">Microsoft 知识库文章 2671605</a></td>
</tr>  
<tr class="odd">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2671605](https://support.microsoft.com/kb/2671605)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
-   Vitaliy Toropov 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 .NET Framework 参数验证漏洞 (CVE-2012-0163)

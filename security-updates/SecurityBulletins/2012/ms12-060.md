...
**已知问题。**[Microsoft 知识库文章 2720573](https://support.microsoft.com/kb/2720573) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2597112 由 KB2687323 或 KB2726929 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2598041 由 KB2687441 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2598039 由 KB2597986 替代
</td>
</tr>
</table>
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB983808 由 KB983812 替代  
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB983809 由 KB983811 替代
</td>
</tr>
</table>
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB983807 由 KB983813 替代
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2645025 由 KB2716389 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2658677 由 KB2716390 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2655547 由 KB2716392 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2658676 由 KB2716393 替代
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2647488 由 KB2708940 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2647490 由 KB2708941 替代
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-027](https://go.microsoft.com/fwlink/?linkid=246275) 中的 KB2641426 由 KB2708437 替代
</td>
</tr>
</table>
...
为了解决涉及 Microsoft 生成的、没有正确时间戳属性的特定数字证书的问题，Microsoft 重新发布了此公告以将更新 KB2687323 替换为适用于 Microsoft Office 2003 的所有受影响变体上的 Windows 通用控件的更新 KB2726929。有关详细信息，请参阅 [Microsoft 安全通报 2749655](https://technet.microsoft.com/security/advisory/2749655)。
...
重新分发 ActiveX 控件的开发人员应通过下载此公告中提供的更新，确保更新随他们的应用程序安装的 ActiveX 控件的版本。有关使用重新分发的组件的最佳做法的详细信息，请参阅 [Microsoft 知识库文章 835322](https://support.microsoft.com/kb/835322)以及[隔离的应用程序和并行程序集](https://msdn.microsoft.com/library/dd408052.aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1856](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1856)。
...
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/en-us/library/dd883248.aspx)”的受限模式下运行。此模式可减轻此漏洞。有关 Internet Explorer 增强安全配置的详细信息，请参阅此安全更新的“常见问题”部分。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2726929">Microsoft 知识库文章 2726929</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2687441">Microsoft 知识库文章 2687441</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2597986">Microsoft 知识库文章 2597986</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 SQL Server 2000 Analysis Services Service Pack 4：<br />
请参阅 <a href="https://support.microsoft.com/kb/983813">Microsoft 知识库文章 983813</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft SQL Server 2000 Service Pack 4 的 GDR 更新：<br />
请参阅 <a href="https://support.microsoft.com/kb/983812">Microsoft 知识库文章 983812</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft SQL Server 2000 Service Pack 4 的 QFE 更新：<br />
请参阅 <a href="https://support.microsoft.com/kb/983811">Microsoft 知识库文章 983811</a></td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2716389">Microsoft 知识库文章 2716389</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2716390">Microsoft 知识库文章 2716390</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">注册表项文件 (mscomctl.ocx) 的版本用于验证更新的安装</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2716392">Microsoft 知识库文章 2716392</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">注册表项文件 (mscomctl.ocx) 的版本用于验证更新的安装</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2716393">Microsoft 知识库文章 2716393</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">注册表项文件 (mscomctl.ocx) 的版本用于验证更新的安装</td>
...
-   **文件版本验证**
    ...
    3.  在“**完整或部分文件名** ”框中，键入相应文件信息表中的一个文件名，然后单击“**搜索**”。  
    4.  在文件列表中，用鼠标右键单击相应文件信息表中的一个文件名，然后单击“**属性**”。  
    5.  **注意** 由于安装的操作系统或程序的版本不同，因此文件信息表中所列的某些文件可能并未安装。  
    6.  在“**版本**”选项卡上，通过将系统上安装的文件与相应文件信息表中记录的版本进行比较来确定该文件的版本。
  
        **注意** 在安装过程中，除文件版本以外的其他属性均可能会发生变化。不支持通过将其他文件属性与文件信息表中的信息进行比较这种方法来验证是否应用了更新。另外，在某些情况下，在安装过程中还可能会重命名文件。如果没有文件或版本信息，请使用另外一种方法来验证更新安装。
  
#### Host Integration Server 2004（所有版本）
...
| **部署**                         |                                                                                                                                                           |  
| 没有用户干预的安装               | HIS2004-SP1-KB2711207-ENU.exe /quiet                                                                                                                      |  
| 安装而不重新启动                 | HIS2004-SP1-KB2711207-ENU.exe /norestart                                                                                                                  |  
| 更新日志文件                     | setup.log                                                                                                                                                 |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节。                                                                                                                    |  
| **重新启动要求**                 |                                                                                                                                                           |  
| 要求重新启动？                   | 此更新不需要重新启动。                                                                                                                                    |  
| HotPatching                      | 不适用                                                                                                                                                    |  
| **删除信息**                     | 使用控制面板中的“**添加或删除程序**”项或者 /u 安装开关 (HIS2004-SP1-KB2711207-ENU.exe /u)。有关可用安装开关的列表，请参阅下面的**部署信息**下方提供的表。 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2711207](https://support.microsoft.com/kb/2711207)                                                                            |  
| **注册表项验证**                 | 注册表项文件（mscomctl.ocx 版本 6.0.98.34）的版本用于验证更新的安装                                                                                       |
...
|---------------------------------------------------|--------------------------------------------------------------------------------------------|  
| **/u**                                            | 卸载                                                                                       |  
| **/s 或 /passive**                                | 被动安装。仅显示进度栏                                                                     |  
| **/quiet**                                        | 无提示安装                                                                                 |  
| **/norestart**                                    | 抑制重新启动                                                                               |  
| **/forcerestart**                                 | 安装后始终重新启动                                                                         |  
| **/promptrestart**                                | 在重新启动之前提示。此选项不能与 /quiet 选项一起使用。                                     |  
| **/warnrestart 或 /warnrestart:&lt;秒数&gt;** | 警告用户系统将在 30 秒后重新启动。默认秒数可以通过命令行进行更改（例如 /warnrestart:60）。 |  
| **/log &lt;Logfile&gt;**                          | 将日志信息写入到指定路径的日志文件。始终使用详细 MSI 日志并在现有文件后面追加。            |  
| **/w**                                            | 关闭向导                                                                                   |  
| **/? 或 /help 或 /h**                             | 帮助和快速参考选项                                                                         |
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2708940">Microsoft 知识库文章 2708940</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2708941">Microsoft 知识库文章 2708941</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2708437">Microsoft 知识库文章 2708437</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   V1.1（2012 年 8 月 17 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2720573 添加一个链接。
-   V1.2（2012 年 8 月 22 日）： 更正了 Microsoft SQL Server 2000 Analysis Services Service Pack 4 的更新替代信息。这仅仅是一个信息更改。检测逻辑或更新文件未发生更改。
-   V2.0（2012 年 12 月 11 日）： 重新发布了此公告以将更新 KB2687323 替换为适用于 Microsoft Office 2003、Microsoft Office 2003 Web Components 和 Microsoft SQL Server 2005 的所有受影响变体上的 Windows 通用控件的更新 KB2726929。
-   V2.1 (2013 年 1 月 30 日)： 阐明了将向安装了 KB2687323 更新的客户提供适用于 Microsoft Office 2003、Microsoft Office 2003 Web Components 和 Microsoft SQL Server 2005 的所有受影响变体上的 Windows 通用控件的更新 KB2726929。有关详细信息，请参阅更新常见问题。

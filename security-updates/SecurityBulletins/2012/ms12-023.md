...
<td style="border:1px solid black;">
[MS12-010](http://go.microsoft.com/fwlink/?linkid=236989) 中的 KB2647516 由 KB2675157 替代
</td>
</tr>
...
是。KB2675157 更新适用于 Windows Developer Preview 版本。鼓励使用 Windows 开发者预览版的客户向其系统应用此更新。此更新仅在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0168](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0168)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0169](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0169)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0170](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0170)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0171](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0171)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0172](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0172)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2675157">Microsoft 知识库文章 2675157</a></td>
</tr>  
<tr class="even">
...
-   [AISec](http://www.aisec.cn/) 的 linx2008 报告了打印功能远程执行代码漏洞 (CVE-2012-0168)  
-   [TOPdesk](http://www.topdesk.com) 的 Roel Spilker 报告了 JScript9 远程执行代码漏洞 (CVE-2012-0169)  
-   Jose Antonio Vazquez Gonzalez 与 [VeriSign iDefense Labs](http://labs.idefense.com) 合作报告了 OnReadyStateChange 远程执行代码漏洞 (CVE-2012-0170)  
-   一位匿名研究人员与 [TippingPoint 的](http://www.tippingpoint.com)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 SelectAll 远程执行代码漏洞 (CVE-2012-0171)  
-   一位匿名研究人员与 [TippingPoint 的](http://www.tippingpoint.com)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 VML 样式远程执行代码漏洞 (CVE-2012-0172)  

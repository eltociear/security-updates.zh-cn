---
TOCTitle: 'MS12-023'
Title: 'Microsoft 安全公告 MS12-023 - 严重'
ms:assetid: 'ms12-023'
ms:contentKeyID: 61238365
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-023(v=Security.10)'
---
...
此安全更新通过修改 Internet Explorer 处理特制 HTML 内容的打印的方式以及 Internet Explorer 处理内存中对象的方式来解决这些漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[MS12-010](https://go.microsoft.com/fwlink/?linkid=236989) 中的 KB2647516 由 KB2675157 替代
</td>
</tr>
...
**Windows Developer Preview 版本是否受此公告中解决的漏洞的影响？**  
是。KB2675157 更新适用于 Windows Developer Preview 版本。鼓励使用 Windows 开发者预览版的客户向其系统应用此更新。此更新仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供。
...
<th>
打印功能远程执行代码漏洞 - CVE-2012-0168
</th>
<th>
JScript9 远程执行代码漏洞 - CVE-2012-0169
</th>
<th>
OnReadyStateChange 远程执行代码漏洞 - CVE-2012-0170
</th>
<th>
SelectAll 远程执行代码漏洞 - CVE-2012-0171
</th>
<th>
VML 样式远程执行代码漏洞 - CVE-2012-0172
</th>
<th>
综合严重等级
</th>
...
当 Internet Explorer 尝试打印特制的 HTML 页面时，存在一个远程执行代码漏洞。该漏洞可能允许攻击者在当前用户的上下文中执行任意代码。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0168](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0168)。

#### 打印功能远程执行代码漏洞 (CVE-2012-0168) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   当从 Internet Explorer 打印时，默认情况下不启用“打印链接列表”选项。只有打印网页时手动选择此功能的客户才可能受此问题的影响。
-   成功利用此漏洞的攻击者可以获得与当前用户相同的用户权限。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

#### 打印功能远程执行代码漏洞 (CVE-2012-0168) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 打印功能远程执行代码漏洞 (CVE-2012-0168) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。

**造成此漏洞的原因是什么？**  
在某些情况下，Internet Explorer 会不正确地处理特制的 HTML 页面。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以获得与当前用户相同的用户权限。如果当前用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**攻击者如何利用此 漏洞？**  
此漏洞要求用户在启用“打印链接列表”选项的情况下打印特制 HTML 内容。

在基于 Web 的攻击情形中，攻击者可能托管一个旨在通过 Internet Explorer 利用此漏洞的特制网站，然后诱使用户查看网站并在启用“打印链接列表”选项的情况下打印内容。攻击者也可能在宿主 IE 呈现引擎的应用程序或 Microsoft Office 文档中嵌入标有“安全初始化”的 ActiveX 控件。攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。这些网站可能包含可以利用此漏洞的特制内容。但是在所有情况下，攻击者无法强制用户查看和打印由攻击者控制的内容。此外，攻击者不能自动启用“打印链接列表”选项。相反，攻击者必须说服用户采取行动，通常是单击电子邮件或 Instant Messenger 消息中的链接（该链接会将用户定向到攻击者的网站），或者打开通过电子邮件发送的附件，并说服用户在启用“打印链接列表”选项的情况下打印特制内容。

在基于电子邮件的攻击情形中，攻击者可以将特制电子邮件发送给潜在受害者，然后说服潜在受害者尝试在启用“打印链接列表”选项的情况下打印电子邮件。仅支持“打印链接列表”选项的电子邮件应用程序（例如，Microsoft Outlook 2003、Microsoft Outlook Express、Windows Mail 和 Windows Live Mail）可以被此攻击媒介利用。但是，如果使用基于 Web 的电子邮件服务，则基于 Web 的攻击情形适用。

**受此漏洞威胁最大的系统有哪些？**  
频繁使用 Internet Explorer 的系统（如工作站或终端服务器）受此漏洞的威胁最大。

**此更新有什么作用？**  
该更新通过修改 Internet Explorer 处理特制 HTML 内容打印的方式来解决漏洞。对 Internet Explorer 所做的更也通过 Microsoft Outlook 2003、Microsoft Outlook Express、Windows Mail 和 Windows Live Mail 解决电子邮件攻击媒介。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0169](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0169)。

#### JScript9 远程执行代码漏洞 (CVE-2012-0169) 的缓解因素
...
#### JScript9 远程执行代码漏洞 (CVE-2012-0169) 的变通办法
...
#### JScript9 远程执行代码漏洞 (CVE-2012-0169) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0170](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0170)。

#### OnReadyStateChange 远程执行代码漏洞 (CVE-2012-0170) 的缓解因素
...
#### OnReadyStateChange 远程执行代码漏洞 (CVE-2012-0170) 的变通办法
...
#### OnReadyStateChange 远程执行代码漏洞 (CVE-2012-0170) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0171](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0171)。

#### SelectAll 远程执行代码漏洞 (CVE-2012-0171) 的缓解因素
...
#### SelectAll 远程执行代码漏洞 (CVE-2012-0171) 的变通办法
...
#### SelectAll 远程执行代码漏洞 (CVE-2012-0171) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0172](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0172)。

#### VML 样式远程执行代码漏洞 (CVE-2012-0172) 的缓解因素
...
#### VML 样式远程执行代码漏洞 (CVE-2012-0172) 的变通办法
...
#### VML 样式远程执行代码漏洞 (CVE-2012-0172) 的常见问题
...
<p>使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2675157$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie7updates\KB2675157-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie8updates\KB2675157-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2675157">Microsoft 知识库文章 2675157</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2675157$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
-   [AISec](https://www.aisec.cn/) 的 linx2008 报告了打印功能远程执行代码漏洞 (CVE-2012-0168)  
-   [TOPdesk](https://www.topdesk.com) 的 Roel Spilker 报告了 JScript9 远程执行代码漏洞 (CVE-2012-0169)  
-   Jose Antonio Vazquez Gonzalez 与 [VeriSign iDefense Labs](https://labs.idefense.com) 合作报告了 OnReadyStateChange 远程执行代码漏洞 (CVE-2012-0170)  
-   一位匿名研究人员与 [TippingPoint 的](https://www.tippingpoint.com)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 SelectAll 远程执行代码漏洞 (CVE-2012-0171)  
-   一位匿名研究人员与 [TippingPoint 的](https://www.tippingpoint.com)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 VML 样式远程执行代码漏洞 (CVE-2012-0172)  

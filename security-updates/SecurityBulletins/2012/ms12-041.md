...
<td style="border:1px solid black;">
[MS12-018](https://go.microsoft.com/fwlink/?linkid=235364) 中的 KB2641653 由 KB2709162 替代
</td>
</tr>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1864](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1864)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1865](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1865)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1866](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1866)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1867](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1867)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1868](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1868)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2709162">Microsoft 知识库文章 2709162</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2709162](https://support.microsoft.com/kb/2709162)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Azimuth Security](https://www.azimuthsecurity.com/) 的 Tarjei Mandt 报告了 字符串 Atom 类名处理漏洞 (CVE-2012-1864)  
-   [Azimuth Security](https://www.azimuthsecurity.com/) 的 Tarjei Mandt 报告了 Win32k.sys 争用条件漏洞 (CVE-2012-1865)  
-   [Azimuth Security](https://www.azimuthsecurity.com/) 的 Tarjei Mandt 报告了剪贴板格式 Atom 名称处理漏洞 (CVE-2012-1866)  
-   [Google Inc.](https://www.google.com) 的 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org) 报告了字体资源引用计数整数溢出漏洞 (CVE-2012-1867)

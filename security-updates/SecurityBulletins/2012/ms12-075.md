---
TOCTitle: 'MS12-075'
Title: 'Microsoft 安全公告 MS12-075 - 严重'
ms:assetid: 'ms12-075'
ms:contentKeyID: 61238417
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-075(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-075 - 严重
==================================

Windows 内核模式驱动程序中的漏洞可能允许远程执行代码 (2761226)
--------------------------------------------------------------

发布时间: 2012年11月13日 | 更新时间: 2012年11月13日
...
<td style="border:1px solid black;">
[MS12-055](https://go.microsoft.com/fwlink/?linkid=257907)中的 KB2731847 由 KB2761226 替代
</td>
</tr>
...
**安** **全更新的**哈希位于何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2761226](https://support.microsoft.com/kb/2761226)。

**Windows 8 Release Preview and Windows Server 2012 Release Candidate** **是否受此公告中解决的漏洞影响？**  
是。KB2761226 更新适用于 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
<th>
Win32k 释放后使用漏洞 - CVE-2012-2530
</th>
<th>
Win32k 释放后使用漏洞 - CVE-2012-2553
</th>
<th>
TrueType 字体分析漏洞 - CVE-2012-2897
</th>
<th>
综合严重等级
</th>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2530](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530)。

#### Win32k 释放后使用漏洞 (CVE-2012-2530) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### Win32k 释放后使用漏洞 (CVE-2012-2530) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### Win32k 释放后使用漏洞 (CVE-2012-2530) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2553](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553)。

#### Win32k 释放后使用漏洞 (CVE-2012-2553) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### Win32k 释放后使用漏洞 (CVE-2012-2553) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### Win32k 释放后使用漏洞 (CVE-2012-2553) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2897](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897)。

#### TrueType 字体分析漏洞 (CVE-2012-2897) 的缓解因素
...
#### TrueType 字体分析漏洞 (CVE-2012-2897) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### TrueType 字体分析漏洞 (CVE-2012-2897) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞

**造成此漏洞的原因是什么？**  
当 Windows 未正确处理特制 TrueType 字体 (TTF) 时，会导致该漏洞。
...
**此更新有什么作用？**  
此更新通过更正 Windows 处理特制 TrueType 字体文件的方式来解决此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或下列文件夹中的 Spuninst.exe 实用程序： %Windir%\\$NTUninstallKB2761226$\Spuninst</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2761226">Microsoft 知识库文章 2761226</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或下列文件夹中的 Spuninst.exe 实用程序： %Windir%\\$NTUninstallKB2761226$\\Spuninst
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2761226](https://support.microsoft.com/kb/2761226)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **删除信息**                     | 单击“**控制面板**”，单击“**系统和安全性**”，然后在“Windows Update”下单击“**查看安装的更新**”，并从更新列表中选择。 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2761226](https://support.microsoft.com/kb/2761226)                                     |
...
-   [Google Inc](https://www.google.com) 的 Matthew Jurczyk 报告了 Windows 内核 win32k.sys 释放后使用漏洞 (CVE-2012-2553)  
-   [Documill](https://www.documill.com) 的 Eetu Luodemaa 和 Joni Vähämäki 与 Chromium Security Rewards Program 合作报告了 TrueType 字体分析漏洞 (CVE-2012-2897)
...
-   V1.1（2012 年 11 月 13 日）： 更正了 CVE-2012-2897 的漏洞标题及常见问题条目。这仅仅是一个信息更改。

...
此安全更新也首先针对 Microsoft Exchange Server 的受影响版本解决 [Microsoft 安全通报 2737111](http://technet.microsoft.com/security/advisory/2737111) 中描述的漏洞。
...
实施了 [Microsoft 安全通报 2737111](http://technet.microsoft.com/security/advisory/2737111) 中的变通办法以禁用 WebReady Document Viewing 的客户在应用此更新之前无需撤消该变通办法。然而，要重新启用 WebReady Document Viewing 功能，客户可能需要在应用更新之后撤销变通办法。

Microsoft 建议在重新启用 WebReady Document Viewing 功能之前向所有服务器应用更新。

**Microsoft 安全通报 2737111“** **此更新** **如何** **解决漏洞** **？”** **中讨论了** **多个漏洞。**  
[Microsoft 安全通报 2737111] (http://technet.microsoft.com/security/advisory/2737111) 中讨论的 CVE-2012-1766、CVE-2012-1767、CVE-2012-1768、CVE-2012-1769、CVE-2012-1770、CVE-2012-1771、CVE-2012-1772、CVE-2012-1773、CVE-2012-3106、CVE-2012-3107、CVE-2012-3108、CVE-2012-3109 和 CVE-2012-3110 影响 Microsoft Exchange Server，由此更新解决。

**此更新是否包含** **任何** **其他与安全性无关的功能更改？**  
是。除了本公告的“漏洞信息”部分列出的更改外，此更新还包括每个更新汇总的相关知识库文章中所述的其他功能性更改。

-   有关 Exchange Server 2007 Service Pack 的更新汇总 8 (KB2756497) 的相关信息，请参阅 [Microsoft 知识库文章 2756497](http://support.microsoft.com/kb/2756497)。
-   有关 Exchange 2010 Service Pack 1 的更新汇总 7 (KB2756496) 的相关信息，请参阅 [Microsoft 知识库文章 2756496](http://support.microsoft.com/kb/2756496)。
-   对于 Exchange 2010 Service Pack 2 的更新汇总 4 (KB2756485)，请参阅 [Microsoft 知识库文章 2756485](http://support.microsoft.com/kb/2756485)。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**安** **全更新的**哈希位于何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2740358](http://support.microsoft.com/kb/2740358)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2740358">Microsoft 知识库文章 2740358</a></td>
</tr>  
<tr class="even">

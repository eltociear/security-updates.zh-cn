---
TOCTitle: 'MS12-058'
Title: 'Microsoft 安全公告 MS12-058 - 严重'
ms:assetid: 'ms12-058'
ms:contentKeyID: 61238400
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-058(v=Security.10)'
---

Microsoft 安全公告 MS12-058 - 严重
==================================

Microsoft Exchange Server WebReady Document Viewing 中的漏洞可能允许远程执行代码 (2740358)
------------------------------------------------------------------------------------------

发布时间: 2012年8月14日 | 更新时间: 2012年11月20日
...
此安全更新也首先针对 Microsoft Exchange Server 的受影响版本解决 [Microsoft 安全通报 2737111](https://technet.microsoft.com/security/advisory/2737111) 中描述的漏洞。
...
**我已成功安装了原始 KB2734323、KB2743248 或 KB2706690 更新。我需要应用在 2012 年 10 月 9 日重新发布的更新程序包( KB2756497， KB2756496 或 KB2756485 )吗？**  
是。所有情况下客户都需要应用此重新发布的更新程序包。

**注意** 这些重新发布的更新程序包的适用性并不取决于安装 Microsoft Exchange 的 Microsoft Windows 版本。

**为什么在 2012 年 10 月 9 日修订此公告？**  
Microsoft 修订此公告是为了针对 Microsoft Exchange Server 2007 Service Pack 3 (KB2756497)、Microsoft Exchange Server 2010 Service Pack 1 (KB2756496) 和 Microsoft Exchange Server 2010 Service Pack 2 (KB2756485) 提供重新发布的更新，以便解决涉及 Microsoft 生成的、没有正确时间戳属性的特定数字证书的问题。有关详细信息，请参阅 [Microsoft 安全通报 2749655](https://technet.microsoft.com/security/advisory/2749655)。

重新发布的更新 KB2756497、KB2756496 和 KB2756485 分别取代了原始 KB2734323、KB2743248 和 KB2706690 更新。

**如果我应用了 Microsoft 安全通报 2737111 中适用于 Microsoft Exchange Server 的变通办法，我是否需要撤消该变通办法，然后再应用此更新？**  
实施了 [Microsoft 安全通报 2737111](https://technet.microsoft.com/security/advisory/2737111) 中的变通办法以禁用 WebReady Document Viewing 的客户在应用此更新之前无需撤消该变通办法。然而，要重新启用 WebReady Document Viewing 功能，客户可能需要在应用更新之后撤销变通办法。

Microsoft 建议在重新启用 WebReady Document Viewing 功能之前向所有服务器应用更新。

**Microsoft 安全通报 2737111“** **此更新** **如何** **解决漏洞** **？”** **中讨论了** **多个漏洞。**  
[Microsoft 安全通报 2737111] (https://technet.microsoft.com/security/advisory/2737111) 中讨论的 CVE-2012-1766、CVE-2012-1767、CVE-2012-1768、CVE-2012-1769、CVE-2012-1770、CVE-2012-1771、CVE-2012-1772、CVE-2012-1773、CVE-2012-3106、CVE-2012-3107、CVE-2012-3108、CVE-2012-3109 和 CVE-2012-3110 影响 Microsoft Exchange Server，由此更新解决。

**此更新是否包含** **任何** **其他与安全性无关的功能更改？**  
是。除了本公告的“漏洞信息”部分列出的更改外，此更新还包括每个更新汇总的相关知识库文章中所述的其他功能性更改。

-   有关 Exchange Server 2007 Service Pack 的更新汇总 8 (KB2756497) 的相关信息，请参阅 [Microsoft 知识库文章 2756497](https://support.microsoft.com/kb/2756497)。
-   有关 Exchange 2010 Service Pack 1 的更新汇总 7 (KB2756496) 的相关信息，请参阅 [Microsoft 知识库文章 2756496](https://support.microsoft.com/kb/2756496)。
-   对于 Exchange 2010 Service Pack 2 的更新汇总 4 (KB2756485)，请参阅 [Microsoft 知识库文章 2756485](https://support.microsoft.com/kb/2756485)。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**安** **全更新的**哈希位于何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2740358](https://support.microsoft.com/kb/2740358)。
...
<span></span>  
Microsoft Exchange Server 的 WebReady Document Viewing 功能中存在远程执行代码漏洞。如果用户在浏览器中通过 Outlook Web Access 查看特制文件，则这些漏洞可能允许作为本地系统远程执行代码。成功利用这些漏洞的攻击者可能在受影响的服务器上作为 LocalService 运行代码。LocalService 帐户在本地计算机上具有最低特权，在网络上提供匿名凭据。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2740358">Microsoft 知识库文章 2740358</a></td>
</tr>  
<tr class="even">
...
-   V2.0（2012 年 10 月 9 日）： 修订了公告以针对 Microsoft Exchange Server 2007 Service Pack 3 (KB2756497)、Microsoft Exchange Server 2010 Service Pack 1 (KB2756496) 和 Microsoft Exchange Server 2010 Service Pack 2 (KB2756485) 重新发布了更新。客户需要应用重新发布的更新以避免 Microsoft 安全通报 2749655 中所述的数字证书问题。
-   V2.1（2012 年 10 月 10 日）： 添加了关于重新发布的 KB2756497、KB2756496、KB2756485 更新的常见问题条目，以提供部署指南。有关详细信息，请参阅更新常见问题。
-   V2.2（2012 年 11 月 20 日）： 纠正了此公告中错误的 KB2756497 和 KB2756496 更新的更新程序包名称、注册验证密钥以及日志文件名称。这些只是信息更改。下载页面和相关知识库文章已经包含正确的信息。

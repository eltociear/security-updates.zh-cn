---
TOCTitle: 'MS12-003'
Title: 'Microsoft 安全公告 MS12-003 - 重要'
ms:assetid: 'ms12-003'
ms:contentKeyID: 61238241
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-003(v=Security.10)'
---


Microsoft 安全公告 MS12-003 - 重要
==================================

Windows 客户端/服务器运行时子系统中的漏洞可能允许特权提升 (2646524)
-------------------------------------------------------------------
...
此安全更新解决 Microsoft Windows 中一个秘密报告的漏洞。对于 Windows XP、Windows Server 2003、Windows Vista 和 Windows Server 2008 的所有受支持版本，此安全更新的等级为“重要”。Windows 7 和 Windows Server 2008 R2 的所有受支持版本不受此漏洞的影响。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

如果攻击者登录受影响的系统并运行特制应用程序，此漏洞可能允许特权提升。攻击者随后可完全控制受影响的系统并安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户等。此漏洞只能在配置有中文、日文或韩文系统区域设置的系统上才能被利用。

此安全更新通过更改客户端/服务器运行时子系统 (CSRSS) 处理 Unicode 字符的方式来解决此漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=cfc38dc2-c4c7-4a44-8e5a-b98bb9bc0396)                                    | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3956db98-88d9-49fc-be51-247b40bfc272)           | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=39f5f8fb-ee4d-4b7a-9cd7-3d1e9c8abd8c)                           | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e27d85f8-a285-4e95-85a0-0868286cc2b9)               | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=b69bd01d-9925-4ff1-bfeb-b4473631578c)           | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=73682d4b-3179-4488-8ba9-94ed68c4896b)                                 | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b5c33025-13d9-43d2-a415-a8a4d683a821)                     | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fbf119cf-a8ed-4266-a673-442149992f7c)\*        | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e8e68f89-27f4-4142-94ca-58f086a98157)\*   | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fc6491e8-6c3e-43a1-bc56-16c9a2fd2749) | 特权提升     | 重要         | [MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) |
...
**此漏洞会影响 Windows 的所有语言版本吗？**  
受影响的操作系统的所有语言版本均包含此漏洞，但是如果该系统区域设置未设置为中文、日文或韩文，此漏洞不可利用。作为纵深防御措施，Microsoft 建议在受影响的操作系统的所有语言版本上安装此更新。不论系统的语言配置如何，均将通过自动更新提供程序包。

**系统区域设置是什么？**  
系统区域设置确定默认字符集（字母、符号和数字）和字体，用于在未使用 Unicode 的程序中显示和输入信息。这可以让非 Unicode 程序在您所使用的特定语言的计算机上运行。系统区域设置不会影响 Windows 或未使用 Unicode 的其他程序的菜单和对话框中的语言。

**我如何确定或更改我的计算机上的当前系统区域设置？**  
默认系统区域设置取决于安装的 Windows 的语言版本。查看或更改系统区域设置：

1.  单击“**开始**”，然后单击“**控制面板**”。
2.  在“**区域和语言选项**”中，单击“**高级**”选项卡。
3.  在“**非 Unicode 程序的语言**”部分，选择所需的系统区域设置。

**注意** 您必须使用管理员帐户登录才能查看或更改系统区域设置。
...
<tr class="header">
<th>受影响的软件</th>
<th>CSRSS 特权提升漏洞 - CVE-2012-0005</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
CSRSS 特权提升漏洞 - CVE-2012-0005  
----------------------------------
  
<span></span>  
由于 CSRSS 处理一系列特制 Unicode 字符的方式而导致在 Windows CSRSS 中存在一个特权提升漏洞。成功利用此漏洞的攻击者可以在本地系统的安全上下文中运行任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0005](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0005)。
  
#### CSRSS 特权提升漏洞 (CVE-2012-0005) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地或远程登录才能利用此漏洞。  
-   此漏洞只能在配置有中文、日文或韩文系统区域设置的系统上才能被利用。
  
#### CSRSS 特权提升漏洞 (CVE-2012-0005) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### CSRSS 特权提升漏洞 (CVE-2012-0005) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是本地系统的上下文中的一个特权提升漏洞。
  
**造成此漏洞的原因是什么？**  
此漏洞是在配置有中文、日文或韩文系统区域设置的 Windows 系统上，当 CSRSS 处理一系列特制 Unicode 字符并尝试访问尚未正确初始化的内存缓冲区的内容时所导致的。
...
**受此漏洞威胁最大的系统有哪些？**  
使用多字节语言系统区域设置（中文、日文或韩文）运行的工作站和终端服务器受到的威胁最大。如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**  
此更新解决 CSRSS 处理 Unicode 字符的方式。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2646524$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2646524">Microsoft 知识库文章 2646524</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2646524$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2646524](https://support.microsoft.com/kb/2646524)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Shenzhen Jowto Research Dep](https://www.jowto.com) 的 Kang Wu 报告了 CSRSS 特权提升漏洞 (CVE-2012-0005)

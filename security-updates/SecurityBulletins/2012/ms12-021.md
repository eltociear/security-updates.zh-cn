...
**已知问题。**[Microsoft 知识库文章 2651019](https://support.microsoft.com/kb/2651019) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0008)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2669970">Microsoft 知识库文章 2669970</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Visual Studio 2010：<br />
请参阅 <a href="https://support.microsoft.com/kb/2644980">Microsoft 知识库文章 2644980</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Visual Studio 2010 Service Pack 1：<br />
请参阅 <a href="https://support.microsoft.com/kb/2645410">Microsoft 知识库文章 2645410</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Microsoft Visual Studio 2010：<br />
...
-   [Laplinker](https://www.laplinker.com) 报告了 Visual Studio 加载项漏洞 (CVE-2012-0008)

...
<td style="border:1px solid black;">
[MS12-063](https://go.microsoft.com/fwlink/?linkid=255505) 中的 KB2744842 由 KB2761465 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-071](https://go.microsoft.com/fwlink/?linkid=268299) 中的 KB2761451 由 KB2761465 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
是。KB2761465 更新适用于 Windows 8 Release Preview 中的 Internet Explorer 10 和 Windows Server 2012 Release Candidate 中的 Internet Explorer 10。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。

**适用于** **Windows 7 和 Windows Server 2008 R2** **的 Internet Explorer 10** **是否** **受此漏洞中解决的漏洞影响？**  
是。KB2761465 更新适用于适用于 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview。鼓励使用适用于 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview 的客户向其系统应用更新。在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4781](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4781)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4782](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4782)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4787](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4787)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2761465">Microsoft 知识库文章 2761465</a></td>
</tr>  
<tr class="even">
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2761465](https://support.microsoft.com/kb/2761465)                                                                                           |
...
-   [Google Inc](https://www.google.com) 的 Fermin J. Serna 报告了不正确的引用计数释放后使用漏洞 (CVE-2012-4787)

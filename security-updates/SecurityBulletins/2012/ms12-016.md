---
TOCTitle: 'MS12-016'
Title: 'Microsoft 安全公告 MS12-016 - 严重'
ms:assetid: 'ms12-016'
ms:contentKeyID: 61238358
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-016(v=Security.10)'
---

Microsoft 安全公告 MS12-016 - 严重
==================================

.NET Framework 和 Microsoft Silverlight 中的漏洞可能允许远程执行代码 (2651026)
------------------------------------------------------------------------------

发布时间: 2012年2月14日 | 更新时间: 2012年7月10日
...
对于 Microsoft Windows 的所有受支持版本上的 Microsoft .NET Framework 2.0 Service Pack 2、Microsoft .NET Framework 3.5.1 和 Microsoft .NET Framework 4，以及对于 Microsoft Silverlight 4，此安全更新的等级为“严重”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过更正 Microsoft .NET Framework 和 Microsoft Silverlight 使用不受管理的对象的方式来解决这些漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
<td style="border:1px solid black;">
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539631 由 KB2633880 替代  
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 由 KB2633870 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539633 由 KB2633874 替代  
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 由 KB2633870 替代
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539634 由 KB2633879 替代  
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 由 KB2633870 替代
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539635 由 KB2633873 替代  
[MS11-069](https://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 由 KB2633870 替代
</td>
</tr>
<tr>
...
| 安装在 Microsoft Windows 客户端的所有版本上的 Microsoft Silverlight 5 |
| 安装在 Microsoft Windows 服务器的所有版本上的 Microsoft Silverlight 5 |

与此安全更新相关的常见问题 (FAQ)
--------------------------------

**为什么在 2012 年 2 月 14 日修订此公告？**  
Microsoft 修订此公告是为了宣布安装在 Windows 客户端和服务器上的 Microsoft Silverlight 4 的 KB2668562 的检测更改以更正安装问题。这只是检测更改。没有更改安全更新文件。已经成功更新了其系统的客户不需要执行任何操作。

**Windows Developer Preview 上的** **Microsoft .NET Framework 3.5 和 Microsoft .NET Framework 4.5** **以及Microsoft .NET Framework 4.5 Developer Preview** **是否** **受此漏洞影响？**  
...
|------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| Windows Developer Preview 上的 Microsoft .NET Framework 3.5                                          | [Microsoft 知识库文章 2633877](https://support.microsoft.com/kb/2633877) |
| Windows Developer Preview 上的 Microsoft .NET Framework 4.5                                          | [Microsoft 知识库文章 2633869](https://support.microsoft.com/kb/2633869) |
| Windows Server 2008、Windows 7 和 Windows Server 2008 R2 上的 Microsoft .NET Framework 4.5 Developer | [Microsoft 知识库文章 2638804](https://support.microsoft.com/kb/2638804) |
...
Microsoft Silverlight 内部版本 4.1.10111（此安全公告第一次发布时的最新 Microsoft Silverlight 内部版本）可解决该漏洞，不受影响。4.1.10111 之前的 Microsoft Silverlight 内部版本受影响。
...
随此安全更新安装的版本是 4.1.10111。如果您的版本号高于或等于该版本号，则您的系统将不容易受到攻击。
...
此公告描述了 .NET Framework 2.0 功能层中的一个漏洞。.NET Framework 3.0 Service Pack 2 安装程序链接在 .NET Framework 2.0 Service Pack 2 安装程序中，因此安装前者也就安装了后者。因此，安装了 .NET Framework 3.0 Service Pack 2 的客户需要安装 .NET Framework 2.0 Service Pack 2 的安全更新。

**我安装了 .NET Framework 3.5 Service Pack 1。我需要安装任何更新吗？**  
此公告描述了 .NET Framework 2.0 功能层中的一个漏洞。.NET Framework 3.5 Service Pack 1 安装程序链接在 .NET Framework 2.0 Service Pack 2 安装程序和 .NET Framework 3.0 Service Pack 2 安装程序中。因此，安装了 .NET Framework 3.5 Service Pack 1 的客户需要安装 .NET Framework 2.0 Service Pack 2 的安全更新。
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的严重等级和安全影响的可能性的信息，请参阅 [2 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms12-feb)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
<th style="border:1px solid black;">
.NET Framework 不受管理的对象漏洞 - CVE-2012-0014
</th>
<th style="border:1px solid black;">
.NET Framework 堆损坏漏洞 - CVE-2012-0015
</th>
...
Microsoft .NET Framework 和 Silverlight 中存在一个远程执行代码漏洞，它允许特制的 Microsoft .NET Framework 应用程序以不安全方式访问存储器。成功利用此漏洞的攻击者可以在登录用户的安全上下文中运行任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0014](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0014)。

#### .NET Framework 不受管理的对象漏洞 (CVE-2012-0014) 的缓解因素
...
-   默认情况下，部分受信任的 ASP.NET 应用程序不被授予 Socket Permission。因此，在服务器端方案中，在信任级别为中等或更低级别的 ASP.NET 应用程序中无法利用此漏洞，除非管理员为这些应用程序明确授予了 SocketPermission。有关 ASP.NET 信任级别的详细信息，请参阅 MSDN 文章 [ASP.NET 信任级别和策略文件](https://msdn.microsoft.com/en-us/library/wyts434y.aspx)。

#### .NET Framework 不受管理的对象漏洞 (CVE-2012-0014) 的变通办法
...
#### .NET Framework 不受管理的对象漏洞 (CVE-2012-0014) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
此漏洞是由于 Microsoft .NET Framework 和 Microsoft Silverlight 未正确使用不受管理的对象导致的。
...
在 Web 主机情形中，成功利用此漏洞的攻击者可以获得与 Microsoft .NET 应用程序运行所在应用程序池的应用程序池标识关联服务帐户相同的权限。根据应用程序池隔离配置以及授予服务帐户的权限，攻击者可能能够控制 Web 服务器上的其他应用程序池，或者能够完全控制受影响的系统。有关应用程序池标识和配置的详细信息，请参阅 TechNet 文章“[配置应用程序池标识](https://technet.microsoft.com/en-us/library/cc781986(ws.10).aspx)”。
...
**此更新有什么作用？**  
此更新通过更正 Microsoft .NET Framework 和 Microsoft Silverlight 使用不受管理的对象的方式来解决此漏洞。
...
由于 Microsoft .NET Framework 在处理特制输入时未正确计算缓冲区长度而导致在其中存在一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。

#### .NET Framework 堆损坏漏洞 (CVE-2012-0015) 的缓解因素
...
#### .NET Framework 堆损坏漏洞 (CVE-2012-0015) 的变通办法
...
#### .NET Framework 堆损坏漏洞 (CVE-2012-0015) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
此漏洞是由于 .NET Framework 在处理特制输入时未正确计算缓冲区长度导致的。
...
**攻击者如何利用此漏洞？**  
此漏洞的利用有三种可能的攻击情形： Web 浏览情形、Web 主机情形和 Windows .NET 应用程序绕过代码访问安全性 (CAS) 限制情形。这些情形如下所示：
...
**此更新有什么作用？**  
此更新通过更正 Microsoft .NET Framework 计算缓冲区长度的方式来解决此漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。

**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
否。在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。

**应用此安全更新是否有助于客户防止可能会尝试利用此漏洞的已公开发布的代码？**  
是。此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2012-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。
...
KB2633870\_\*\_\*-Microsoft .NET Framework 4 Client Profile-MSP0.txt<br />
KB2633870\_\*\_\*.html</td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2651026">Microsoft 知识库文章 2651026</a></td>
</tr>  
<tr class="odd">
...
**安装** **Microsoft .NET** **Framework 2.0 Service Pack 2 的更新**  
...
**安** **装Microsoft .NET Framework 4 的更新**  

此安全更新支持适用于 Microsoft .NET Framework 4 的以下安装开关。
...
**安** **装Microsoft** **.NET Framework 3.5.1 的更新**  

此安全更新支持适用于 Microsoft .NET Framework 3.5.1 的以下安装开关。
...
-   [Sumatra](https://www.sumatra.nl/) 的 Jeroen Frijters 报告了 .NET Framework 不受管理的对象漏洞 (CVE-2012-0014)
...
-   V1.1（2012 年 2 月 14 日）： 添加了一个更新常见问题条目，以宣布安装在 Windows 客户端和服务器上的 Microsoft Silverlight 4 的 KB2668562 的检测更改以更正安装问题。这只是检测更改。没有更改安全更新文件。已经成功更新了其系统的客户不需要执行任何操作。
-   V1.2（2012 年 2 月 15 日）： 删除了“**摘要**”中对已知问题的错误引用。
-   V1.3（2012 年 7 月 10 日）： Microsoft 修订此公告是为了表明针对适用于 Microsoft .NET Framework 2.0 Service Pack 2 的 KB2633880 提供微小检测更改。没有更改安全更新文件。已经成功更新了其系统的客户不需要执行任何操作。

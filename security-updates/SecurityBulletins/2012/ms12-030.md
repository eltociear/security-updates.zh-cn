...
<td style="border:1px solid black;">
[MS11-096](https://go.microsoft.com/fwlink/?linkid=232696) 中的 KB2596954 由 KB2597086 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-072](https://go.microsoft.com/fwlink/?linkid=225047) 中的 KB2553073 由 KB2597161 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](https://go.microsoft.com/fwlink/?linkid=225047) 中的 KB2553070 由 KB2597166 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](https://go.microsoft.com/fwlink/?linkid=225047) 中的 KB2553075 由 KB2596842 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](https://go.microsoft.com/fwlink/?linkid=225047) 中的 KB2553074 由 KB2597162 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
本公告中提供的 Microsoft Office 2008 for Mac (KB2665346) 和 Microsoft Office for Mac 2011 (KB2665351) 安全更新程序包也可解决 [MS12-029](https://go.microsoft.com/fwlink/?linkid=248419) 安全公告中介绍的漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0141](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0141)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0142](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0142)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0143](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-0143](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0184](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0184)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0185](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0185)。
...
-   **在 Excel 2007 中设置 Office 文件验证以禁止打开未通过文件验证的文件**
    ...
    **注意** 在应用此变通办法之前，必须为您的 Microsoft Office 版本启用 Office 文件验证。有关如何在 Microsoft Office 2007 中启用 Office 文件验证的信息，请参阅 TechNet 文章 [Office 2003 和 Office 2007 的 Office 文件验证](https://technet.microsoft.com/en-us/library/gg985445(office.12).aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1847](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1847)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2597086">Microsoft 知识库文章 2597086</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2007，请参阅 <a href="https://support.microsoft.com/kb/2597161">Microsoft 知识库文章 2597161</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office 2007，请参阅 <a href="https://support.microsoft.com/kb/2597969">Microsoft 知识库文章 2597969</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Excel Viewer，请参阅 <a href="https://support.microsoft.com/kb/2596842">Microsoft 知识库文章 2596842</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office 兼容包，请参阅 <a href="https://support.microsoft.com/kb/2597162">Microsoft 知识库文章 2597162</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2597166">Microsoft 知识库文章 2597166</a> 和 <a href="https://support.microsoft.com/kb/2553371">Microsoft 知识库文章 2553371</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Omair](https://krash.in/) 报告了 Excel 文件格式内存损坏漏洞 (CVE-2012-0141)  
-   [Omair](https://krash.in/) 报告了 OBJECTLINK 记录中的 Excel 文件格式内存损坏漏洞 (CVE-2012-0142)  
-   Omair 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel SXLI 记录内存损坏漏洞 (CVE-2012-0184)  
-   Sean Larsson 和 Jun Mao 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel 合并单元格记录堆溢出漏洞 (CVE-2012-0185)  
-   Sean Larsson 和 Jun Mao 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Excel 系列记录分析类型不匹配漏洞 (CVE-2012-1847)  
-   匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Excel 系列记录分析类型不匹配漏洞 (CVE-2012-1847)

...
<td style="border:1px solid black;">
[MS11-065](https://go.microsoft.com/fwlink/?linkid=232424) 中的 KB2633171 由 KB2707511 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-068](https://go.microsoft.com/fwlink/?linkid=223578) 中的 KB2556532 由 KB2709715 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0217)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1515](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-1515](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2707511">Microsoft 知识库文章 2707511</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2707511](https://support.microsoft.com/kb/2707511)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2709715">Microsoft 知识库文章 2709715</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [Bromium](https://www.bromium.com/) 的 Rafal Wojtczuk 和 [SUSE](https://www.suse.com/) 的 Jan Beulich 报告了用户模式计划程序内存损坏漏洞 (CVE-2012-0217)

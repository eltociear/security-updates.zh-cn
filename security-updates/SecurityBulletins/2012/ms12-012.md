...
是的，此更新解决的颜色控制面板不安全库加载漏洞 (CVE-2010-5082) 与 [Microsoft 安全通报 2269637](http://technet.microsoft.com/security/advisory/2269637) 中介绍的漏洞类别有关，其影响应用程序加载外部库的方式。此安全更新针对这种漏洞的特定实例。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082)。
...
-   **在 Windows Server 2008 和 Windows Server 2008 R2 上安装桌面体验**  
    ...
    有关其他信息（包括如何安装和删除桌面体验的说明），请参阅 TechNet 文章 [桌面体验概述](http://technet.microsoft.com/en-us/library/cc772567.aspx)。
...
默认情况下，Windows Server 2008 上有许多桌面功能（如颜色控制面板）不会安装。但是，您可以通过在 Windows Server 2008 上安装桌面体验功能将它们一起安装。有关详细信息，请参阅 TechNet 文章 [桌面体验概述](http://technet.microsoft.com/en-us/library/cc772567.aspx)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-5082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-5082)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2643719">Microsoft 知识库文章 2643719</a></td>
</tr>  
<tr class="odd">

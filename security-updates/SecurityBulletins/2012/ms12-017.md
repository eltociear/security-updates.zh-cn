...
**已知问题。**[Microsoft 知识库文章 2647170](http://support.microsoft.com/kb/2647170) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0006](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0006)。
...
-   **定期清除 DNS 缓存**
    ...
    按 [Dnscmd 语法](http://technet.microsoft.com/en-us/library/cc756116(v=ws.10).aspx)一文所述运行以下 dnscmd 命令：
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2647170](http://support.microsoft.com/kb/2647170)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2647170">Microsoft 知识库文章 2647170</a></td>
</tr>  
<tr class="odd">

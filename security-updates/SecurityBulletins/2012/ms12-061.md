...
**已知问题。**[Microsoft 知识库文章 2719584](https://support.microsoft.com/kb/2719584) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=721c4a38-b255-4792-83a5-7526a680a79a">Microsoft Visual Studio Team Foundation Server 2010 Service Pack 1</a><br />
(KB2719584)</td>
...
**安全更新的哈希位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2719584](https://support.microsoft.com/kb/2719584)。
  
**此更新是否包含任何其他与安全性无关的功能更改？**  
是。除了本公告的“漏洞信息”部分列出的更改外，此更新还包括 [Microsoft 知识库文章 2719584](https://support.microsoft.com/kb/2719584) 中所述的其他功能性更改。请注意，此更新 (KB2719584) 是累积性更新，将替代 Team Foundation Server 2010 Service Pack 1 的以前累积性更新。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1892](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1892)。
...
<td style="border:1px solid black;">对于 Microsoft Visual Studio Team Foundation Server 2010 Service Pack 1：<br />
请参阅 <a href="https://support.microsoft.com/kb/2719584">Microsoft 知识库文章 2719584</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
-   INR 实验室 ([Network Intelligence India](https://niiconsulting.com/)) 的 Sunil Yadav 报告了 XSS 漏洞 (CVE-2012-1892)

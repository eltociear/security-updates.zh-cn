...
是。KB2647516 更新适用于 Windows Developer Preview 版本。鼓励使用 Windows Developer Preview 的客户向其系统应用此更新。此更新仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供。
...
如果用户需要获得较旧软件的定制支持，则必须与其 Microsoft 客服小组代表、其技术客户经理或适当的 Microsoft 合作伙伴代表联系以了解定制支持选项。没有联合合同、优先支持合同或授权合同的客户可与其当地的 Microsoft 销售分支机构联系。有关联系信息，请访问 [Microsoft Worldwide Information](https://technet.microsoft.com/security/advisory/) 网站，在联系信息列表中选择国家/地区，然后单击“**Go**”以查看电话号码列表。在拨打电话时，请找当地的“企业技术咨询支持服务”销售经理进行洽谈。有关详细信息，请参阅 [Microsoft 技术支持生命周期策略常见问题](https://support.microsoft.com/kb/887012)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0010](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0010)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0011](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0011)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0012](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0012)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0155](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0155)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2647516">Microsoft 知识库文章 2647516</a></td>
</tr>  
<tr class="even">
...
-   [Jan Schejbal](https://janschejbal.wordpress.com/) 报告了复制和粘贴信息泄露漏洞 (CVE-2012-0010)  
-   [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 HTML 布局远程执行代码漏洞 (CVE-2012-0011)  
-   [HP Cloud Services](https://www.hpcloud.com/) 的 Jason Hullinger 报告了空字节信息泄露漏洞 (CVE-2012-0012)  
-   [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 VML 远程执行代码漏洞 (CVE-2012-0155)

---
TOCTitle: 'MS12-063'
Title: 'Microsoft 安全公告 MS12-063 - 严重'
ms:assetid: 'ms12-063'
ms:contentKeyID: 61238405
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-063(v=Security.10)'
---

Microsoft 安全公告 MS12-063 - 严重
==================================

Internet Explorer 的累积性安全更新 (2744842)
--------------------------------------------
...
对于 Windows 客户端上的 Internet Explorer 6、Internet Explorer 7、Internet Explorer 8 和 Internet Explorer 9，此安全更新的等级为“严重”；对于 Windows 服务器上的 Internet Explorer 6、Internet Explorer 7、Internet Explorer 8 和 Internet Explorer 9，此安全更新的等级为“中等”。Internet Explorer 10 不受影响。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过修改 Internet Explorer 处理内存中对象的方式来消除此漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。

此安全更新也解决了最初在 [Microsoft 安全通报 2757760](http://technet.microsoft.com/security/advisory/2757760) 中描述的漏洞。
...
<td style="border:1px solid black;">
[MS12-052](http://go.microsoft.com/fwlink/?linkid=255327) 中的 KB2722913 由 KB2744842 替代
</td>
</tr>
...
**如果我已经应用了 Microsoft 安全通报 2757760 中针对 Internet Explorer 的自动化 Microsoft Fix it 解决方案，是否需要在应用此更新之前撤消此变通方法？**  
已经部署了 [Microsoft 安全通报 2757760](http://technet.microsoft.com/security/advisory/2757760) 中的 **Microsoft Fix it 解决方案**，“通过 Internet Explorer 中的 ExecCommand 防止内存损坏”的客户，无需在应用此更新之前撤消 **Microsoft Fix it 解决方案**。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**安 全更新的**哈希位于何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2744842](http://support.microsoft.com/kb/2744842)。
...
<th>
OnMove 释放后使用漏洞 - CVE-2012-1529
</th>
<th>
事件侦听器释放后使用漏洞 - CVE-2012-2546
</th>
<th>
布局释放后使用漏洞 - CVE-2012-2548
</th>
<th>
cloneNode 释放后使用漏洞 - CVE-2012-2557
</th>
<th>
execCommand 释放后使用漏洞 - CVE-2012-4969
</th>
<th>
综合严重等级
</th>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1529)。

#### OnMove 释放后使用漏洞 (CVE-2012-1529) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或可能包含可利用此漏洞的特制内容的广告的网站。但是在所有情况下，攻击者无法强制用户访问这些网站。相反，攻击者必须诱使用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
...
#### OnMove 释放后使用漏洞 (CVE-2012-1529) 的变通办法
...
#### OnMove 释放后使用漏洞 (CVE-2012-1529) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2546](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2546)。

#### 事件侦听器释放后使用漏洞 (CVE-2012-2546) 的缓解因素
...
#### 事件侦听器释放后使用漏洞 (CVE-2012-2546) 的变通办法
...
#### 事件侦听器释放后使用漏洞 (CVE-2012-2546) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2548](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2548)。

#### 布局释放后使用漏洞 (CVE-2012-2548) 的缓解因素
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2557](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2557)。

#### cloneNode 释放后使用漏洞 (CVE-2012-2557) 的缓解因素
...
#### cloneNode 释放后使用漏洞 (CVE-2012-2557) 的变通办法
...
#### cloneNode 释放后使用漏洞 (CVE-2012-2557) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4969](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969)。

#### execCommand 释放后使用漏洞 (CVE-2012-4969)　的缓解因素
...
#### execCommand 释放后使用漏洞　(CVE-2012-4969)　的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **应用可防止利用此漏洞的 Microsoft Fix it 解决方案，“ 通过 Internet Explorer 中的 ExecCommand 防止内存损坏”**

    请参阅 [Microsoft 知识库文章 2744842](http://support.microsoft.com/kb/2744842) 以使用自动化 **Microsoft Fix it** 解决方案来启用或禁用此变通方法。

-   **部署 Enhanced Mitigation Experience Toolkit**

    Enhanced Mitigation Experience Toolkit (EMET) 是通过向 EMET 中配置的应用程序应用内置缓解因素来帮助防止软件中的漏洞被成功利用的实用工具。

    此时，EMET 会通过有限支持提供并且只提供英语版本。有关详细信息，请参阅 [Microsoft 知识库文章 2458544](http://support.microsoft.com/kb/2458544)。
    ...
    **注意** 有关组策略的详细信息，请参阅[组策略集](http://go.microsoft.com/fwlink/?linkid=215719)。
...
#### execCommand 释放后使用漏洞 (CVE-2012-4969) 的常见问题
...
**什么是地址空间布局随机化 (ASLR)？**  
实施地址空间布局随机化 (ASLR) 的系统在内存中伪随机地重新部署通常可预测的函数入口点。Windows ASLR 将系统 DLL 和可执行文件重新放在内存中 256 个随机位置之一。因此，使用硬编码地址的攻击者“正确猜出”位置的概率为 256 分之一。有关 ASLR 的详细信息，请访问 TechNet 杂志文章[深入了解 Windows Vista 内核： 第 3 部分](http://technet.microsoft.com/en-us/magazine/2007.04.vistakernel.aspx?pr=blog)。

**此更新有什么作用？**  
此更新通过修改 Internet Explorer 处理内存中对象的方式来消除此漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-4969](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969)。此漏洞最初是在 [Microsoft 安全通报 2757760](http://technet.microsoft.com/security/advisory/2757760) 中介绍的。
...
<p>使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2733631$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie7updates\KB2744842-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie8updates\KB2744842-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2744842">Microsoft 知识库文章 2744842</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2744842$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
-   一位匿名研究人员与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 OnMove 释放后使用漏洞 (CVE-2012-1529)  
-   [Rosario Valotta](https://sites.google.com/site/tentacoloviola) 报告了事件侦听器释放后使用漏洞 (CVE-2012-2546)  
-   [Harmony Security](http://www.harmonysecurity.com/) 的 Stephen Fewer 与 [TippingPoint's](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了布局释放后使用漏洞 (CVE-2012-2548)  
-   一位匿名研究人员与 [TippingPoint's](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 cloneNode 释放后使用漏洞 (CVE-2012-2557)  
-   一位匿名研究人员与 [TippingPoint's](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](http://www.zerodayinitiative.com/)合作报告了 execCommand 释放后使用漏洞 (CVE-2012-4969)  
-   [Mitre](http://www.mitre.org/) 与我们合作处理了 execCommand 释放后使用漏洞 (CVE-2012-4969)

...
此安全更新也解决了最初在 [Microsoft 安全通报 2757760](https://technet.microsoft.com/security/advisory/2757760) 中描述的漏洞。
...
<td style="border:1px solid black;">
[MS12-052](https://go.microsoft.com/fwlink/?linkid=255327) 中的 KB2722913 由 KB2744842 替代
</td>
</tr>
...
已经部署了 [Microsoft 安全通报 2757760](https://technet.microsoft.com/security/advisory/2757760) 中的 **Microsoft Fix it 解决方案**，“通过 Internet Explorer 中的 ExecCommand 防止内存损坏”的客户，无需在应用此更新之前撤消 **Microsoft Fix it 解决方案**。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**安 全更新的**哈希位于何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2744842](https://support.microsoft.com/kb/2744842)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1529](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1529)。
...
-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/library/dd883248)”的受限模式下运行。此模式可减轻此漏洞。有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题解答”部分。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2546](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2546)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2548](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2548)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2557](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2557)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4969](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969)。
...
-   **应用可防止利用此漏洞的 Microsoft Fix it 解决方案，“ 通过 Internet Explorer 中的 ExecCommand 防止内存损坏”**
    ...
    请参阅 [Microsoft 知识库文章 2744842](https://support.microsoft.com/kb/2744842) 以使用自动化 **Microsoft Fix it** 解决方案来启用或禁用此变通方法。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-4969](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969)。此漏洞最初是在 [Microsoft 安全通报 2757760](https://technet.microsoft.com/security/advisory/2757760) 中介绍的。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2744842">Microsoft 知识库文章 2744842</a></td>
</tr>  
<tr class="even">
...
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 OnMove 释放后使用漏洞 (CVE-2012-1529)  
-   [Rosario Valotta](https://sites.google.com/site/tentacoloviola) 报告了事件侦听器释放后使用漏洞 (CVE-2012-2546)  
-   [Harmony Security](https://www.harmonysecurity.com/) 的 Stephen Fewer 与 [TippingPoint's](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了布局释放后使用漏洞 (CVE-2012-2548)  
-   一位匿名研究人员与 [TippingPoint's](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 cloneNode 释放后使用漏洞 (CVE-2012-2557)  
-   一位匿名研究人员与 [TippingPoint's](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](https://www.zerodayinitiative.com/)合作报告了 execCommand 释放后使用漏洞 (CVE-2012-4969)  
-   [Mitre](https://www.mitre.org/) 与我们合作处理了 execCommand 释放后使用漏洞 (CVE-2012-4969)

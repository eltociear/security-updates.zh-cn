...
**已知问题。**[Microsoft 知识库文章 2758857](https://support.microsoft.com/kb/2758857) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS07-035](https://go.microsoft.com/fwlink/?linkid=91397) 中的 KB935839 由 KB2758857 替代
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
[安全通报 2269637](https://technet.microsoft.com/security/advisory/2269637) 中的 KB2533623 由 KB2758857 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-063](https://go.microsoft.com/fwlink/?linkid=221864) 中的 KB2567680 由 KB2758857 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
是。KB2758857 更新适用于 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4774](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4774)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2758857">Microsoft 知识库文章 2758857</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2758857](https://support.microsoft.com/kb/2758857)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [IOActive](https://ioactive.co.uk/) 的 Lucas Apa 报告了 Windows 文件名分析漏洞 (CVE-2012-4774)

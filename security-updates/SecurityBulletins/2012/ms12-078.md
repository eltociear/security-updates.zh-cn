...
**已知问题**。[Microsoft 知识库文章 2783534](https://support.microsoft.com/kb/2783534) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS11-032](https://go.microsoft.com/fwlink/?linkid=212224) 中的 KB2507618 由 KB2753842 替代  
[MS12-075](https://go.microsoft.com/fwlink/?linkid=270856) 中的 KB2761226 由 KB2779030 替代
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=fedee43c-0065-42bf-9714-171b5b74f099)（服务器核心安装）  
(KB2753842)  
[Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=3dfa40ef-86a2-44a0-b523-f4a85c7ac82c)（服务器核心安装）  
(KB2779030)
</td>
<td style="border:1px solid black;">
特权提升
...
是。KB2753842 和 KB2779030 更新适用于 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-2556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4786](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4786)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2753842">Microsoft 知识库文章 2753842</a> 和 <a href="https://support.microsoft.com/kb/2779030">Microsoft 知识库文章 2779030</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2753842](https://support.microsoft.com/kb/2753842) 和 [Microsoft 知识库文章 2779030](https://support.microsoft.com/kb/2779030)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2753842](https://support.microsoft.com/kb/2753842) 和 [Microsoft 知识库文章 2779030](https://support.microsoft.com/kb/2779030) |
...
-   [Documill](https://www.documill.com) 的 Eetu Luodemaa 和 Joni Vähämäki 与 Chromium Security Rewards Program 合作报告了 Windows 字体分析漏洞 (CVE-2012-2556)

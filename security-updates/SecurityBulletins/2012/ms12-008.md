---
TOCTitle: 'MS12-008'
Title: 'Microsoft 安全公告 MS12-008 - 严重'
ms:assetid: 'ms12-008'
ms:contentKeyID: 61238350
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-008(v=Security.10)'
---

Microsoft 安全公告 MS12-008 - 严重
==================================

Windows 内核模式驱动程序中的漏洞可能允许远程执行代码 (2660465)
--------------------------------------------------------------
...
此安全更新通过修改 Windows 内核模式驱动程序处理用户模式调用 GDI 以及处理键盘布局错误的方式来解决这些漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=832afe5e-d61e-4554-b889-9174df042b32)                                                                                           | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ff2c141c-08b4-42c6-9f66-580f8678c01f)                                                                  | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f0e6e06d-89db-45ad-9660-7959c6f9b546)                                                                                  | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b81decda-9d82-4ffb-baae-78b190e553ea)                                                                      | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=8dcd71c8-82ad-4f86-b386-7f1ea09e157f)                                                                  | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5852118c-fc39-45e2-8b44-ce1401d310e2)                                                                                        | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5161d16d-1037-49d5-8d4d-c353288cb41c)                                                                            | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=45c6c511-a4fa-4c3b-af26-6c113f6f5f5e)\*\*\*\*                                                         | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=046932cf-0671-49e6-8ddf-98abfc97c5f0)\*\*\*\*                                                    | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=304bd0c5-f4ee-4f8c-89b4-4cbaaf418679)                                                        | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=3e5ca1bf-9415-412c-9dff-dd1abc57e74d)                                             | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=78cbbe02-a3d3-4cef-9b54-a3e78c1b885a)                                   | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=6b228ad6-d5a4-4b91-8aa8-0874deb22116)\*\*\*\* | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=922b2438-0cfc-49e3-b9a0-52c68b69126a) | 严重         | 远程执行代码 | [MS11-087](https://go.microsoft.com/fwlink/?linkid=233008) |
...
**当使用服务器核心安装选项进行安装时，为什么此更新适用于 Windows Server 2008 和 Windows Server 2008 R2 的受支持版本，严重等级较低？**  
当使用服务器核心安装选项进行安装时，Windows Server 2008 和 Windows Server 2008 R2 仅容易遭受 CVE-2011-5046 的本地特权提升攻击情形。基于 Web 的攻击情形和文件共享攻击情形不适用。
...
<th style="border:1px solid black;">GDI 访问冲突漏洞 - CVE-2011-5046</th>
<th style="border:1px solid black;">键盘布局释放后使用漏洞 - CVE-2012-0154</th>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008（用于 32 位系统）Service Pack 2（当使用服务器核心安装选项时）</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
特权提升</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
特权提升</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008（用于基于 x64 的系统）Service Pack 2（当使用服务器核心安装选项时）</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
特权提升</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
特权提升</td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1（当使用服务器核心安装选项时）</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
特权提升</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
特权提升</td>
...
GDI 访问冲突漏洞 - CVE-2011-5046  
--------------------------------
  
<span></span>  
Windows 内核中存在一个由于未能正确验证从用户模式通过 GDI 内核组件传递的输入而产生的远程执行代码漏洞。该漏洞可能允许攻击者在内核模式中运行代码，然后安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0146](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0146)。
  
#### GDI 访问冲突漏洞 (CVE-2011-5046) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。但是在所有情况下，攻击者无法强制用户访问此类网站。相反，攻击者必须诱使用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
  
#### GDI 访问冲突漏洞 (CVE-2011-5046) 的变通办法
...
#### GDI 访问冲突漏洞 (CVE-2011-5046) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**造成此漏洞的原因是什么？**  
此漏洞是由于 Windows 内核模式驱动程序无法正确地验证从用户模式通过 GDI 的内核组件传递的输入导致的。
...
**此更新有什么作用？**  
此更新通过修改 Windows 内核模式驱动程序处理用户模式调用 GDI 的方式来解决此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-5046](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-5046)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
否。在最初发布此安全公告时，Microsoft 看到了公开发布的概念证明代码示例，但未收到任何表明此漏洞已被公开用于攻击客户的信息。
  
键盘布局释放后使用漏洞 - CVE-2012-0154  
--------------------------------------
  
<span></span>  
由于 Windows 内核模式驱动程序管理特定键盘布局的方式而导致存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0154](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0154)。
  
#### 键盘布局释放后使用漏洞 (CVE-2012-0154) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
  
#### 键盘布局释放后使用漏洞 (CVE-2012-0154) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### 键盘布局释放后使用漏洞 (CVE-2012-0154) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。成功利用此漏洞的攻击者可在内核模式下运行任意代码，并可完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**造成此漏洞的原因是什么？**  
此漏洞是由于 Windows 内核模式驱动程序未正确处理键盘布局错误导致的。
...
**此更新有什么作用？**  
此更新通过更正 Windows 内核模式驱动程序处理键盘布局错误的方式来解决此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2660465$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2660465">Microsoft 知识库文章 2660465</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2660465$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2660465](https://support.microsoft.com/kb/2660465)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Azimuth Security](https://www.azimuthsecurity.com/) 的 Tarjei Mandt 报告了键盘布局释放后使用漏洞 (CVE-2012-0154)

...
**已知问题。**[Microsoft 知识库文章 2671387](https://support.microsoft.com/kb/2671387) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221880">MS11-065</a> 中的 KB2570222 由 KB2621440 替代</td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=521baa02-5d7a-4cba-8a1a-2af1b6e4cbe4">Windows Server 2003 SP2（用于基于 Itanium 的系统）</a><br />
(KB2621440)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=221880">MS11-065</a> 中的 KB2570222 由 KB2621440 替代</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=fef2c1d7-2004-43d7-aa49-673c6f374670">Windows Server 2008（用于 32 位系统）Service Pack 2</a>\*<br />
(KB2621440)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">没有公告由 KB2621440 替代</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4ffae13f-3432-4849-a2da-a76f96d7ceb3">Windows Server 2008（用于基于 x64 的系统）Service Pack 2</a>\*<br />
(KB2621440)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">没有公告由 KB2621440 替代</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=67581250-50fd-4f4c-a3cc-45ce2662b0c3">Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2</a><br />
(KB2621440)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">没有公告由 KB2621440 替代</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=16b0195c-84d3-4c08-8b98-ff2c80d144e1">Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1</a><br />
(KB2621440)<br />  
<br />  
<a href="https://www.microsoft.com/download/details.aspx?familyid=3a6c7fdf-105a-4886-ad52-c892f37e32d1">Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1</a><br />
(KB2667402)</td>
<td style="border:1px solid black;">远程执行代码</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=40b62d08-d2a2-4900-b01c-46fc761973d0">Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1</a><br />
(KB2621440)<br />  
<br />  
<a href="https://www.microsoft.com/download/details.aspx?familyid=1bbe7cda-4bee-4d65-8127-3c13624a1168">Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1</a><br />
(KB2667402)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重[1]</td>
<td style="border:1px solid black;">没有公告由 KB2621440 替代<br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7c1774cc-e00c-47f3-97a2-bc90de857793">Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1</a>\*<br />
(KB2621440)<br />  
<br />  
<a href="https://www.microsoft.com/download/details.aspx?familyid=7ec21f41-1673-4592-b45c-6438ad57e08c">Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1</a>\*<br />
(KB2667402)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重[1]</td>
<td style="border:1px solid black;">没有公告由 KB2621440 替代<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6a07f99c-8ab4-4e44-8d48-6ac787dd2b51">Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1</a><br />
(KB2621440)<br />  
<br />  
<a href="https://www.microsoft.com/download/details.aspx?familyid=469aa1f6-ed89-4649-8736-eaa5e2ad44ee">Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1</a><br />
(KB2667402)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重[1]</td>
<td style="border:1px solid black;">没有公告由 KB2621440 替代<br />
...
是。KB2621440 更新适用于 Windows Developer Preview 版本。鼓励使用 Windows Developer Preview 的客户向其系统应用此更新。此更新仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0002](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0002)。
...
-   **禁用终端服务、远程桌面、远程协助和 Windows Small Business Server 2003 远程工作网站功能（如果不再需要它们）**
    ...
    有关如何手动禁用远程桌面的信息，请参阅[禁用远程桌面](https://www.microsoft.com/resources/documentation/windows/xp/all/proddocs/en-us/rdesktop_disable.mspx)。
  
    有关如何使用组策略禁用远程桌面的信息，请参阅 [Microsoft 知识库文章 306300](https://support.microsoft.com/kb/306300)。
  
    有关远程协助的信息（包括如何使用组策略手动禁用远程协助的说明），请参阅 TechNet 文章[远程协助](https://technet.microsoft.com/en-us/library/bb457177.aspx)。
  
    有关如何禁用 Windows Small Business Server 2003 终端服务和远程工作网站功能的信息，请参阅 TechNet 文章[保护您的 Windows Small Business Server 2003 网络](https://www.microsoft.com/technet/security/secnews/articles/sec_sbs2003_network.mspx)。
...
-   **在运行 Windows Vista、Windows 7、Windows Server 2008 和 Windows Server 2008 R2 的受支持版本的系统上启用网络级别身份验证**
    ...
    **注意** 要使用自动 **Microsoft Fix it** 解决方案来启用此变通办法，请参阅 [Microsoft 知识库文章 2671387](https://support.microsoft.com/kb/2671387)。
    ...
    **变通办法的影响。** 不支持凭据安全支持提供程序 (CredSSP) 协议的客户端计算机不能访问受网络级别身份验证保护的服务器。**注意** 对于在 Windows XP Service Pack 3 系统需要使用远程桌面的混合网络环境中部署此变通办法的管理员，请参阅 [Microsoft 知识库文章 951608](https://support.microsoft.com/kb/951608) 了解有关如何 Windows XP Service Pack 3 上启用 CredSSP 的信息。
  
    有关网络级别身份验证的更多信息，包括如何使用组策略启用网络级别身份验证，请参阅参阅 Technet 文章[为远程桌面服务连接配置网络级别身份验证](https://technet.microsoft.com/en-us/library/cc732713.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0152](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0152)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2621440">Microsoft 知识库文章 2621440</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2621440](https://support.microsoft.com/kb/2621440)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2621440">Microsoft 知识库文章 2621440</a> 和 <a href="https://support.microsoft.com/kb/2667402">Microsoft 知识库文章 2667402</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注</strong> 没有用于验证此更新是否存在的注册表项。</td>
...
-   Luigi Auriemma 与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了远程桌面协议漏洞 (CVE-2012-0002)

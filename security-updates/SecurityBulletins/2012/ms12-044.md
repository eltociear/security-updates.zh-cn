---
TOCTitle: 'MS12-044'
Title: 'Microsoft 安全公告 MS12-044 - 严重'
ms:assetid: 'ms12-044'
ms:contentKeyID: 61238386
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-044(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-044 - 严重
==================================

Internet Explorer 的累积性安全更新 (2719177)
--------------------------------------------

发布时间: 2012年7月10日 | 更新时间: 2012年7月18日
...
对于 Windows 客户端上的 Internet Explorer 9，此安全更新的等级为“严重”；对于 Windows 服务器上的 Internet Explorer 9，此安全更新的等级为“中等”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。
...
<td style="border:1px solid black;">
[MS12-037](https://go.microsoft.com/fwlink/?linkid=249045) 中的 KB2699988 由 KB2719177 替代
</td>
</tr>
...
**安全更新的 哈希 位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2719177](https://support.microsoft.com/kb/2719177)。
...
**Windows 8 Consumer Preview 或 Windows Server 2012 Consumer Preview 是否受本公告中解决的任何漏洞影响？**  
是。KB2719177 更新适用于 Windows 8 Consumer Preview 和 Windows Server 2012 Consumer Preview。鼓励使用 Windows 8 Consumer Preview 和 Windows Server 2012 Consumer Preview 的客户向其系统应用更新。仅在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
<th>
缓存对象远程执行代码漏洞 - CVE-2012-1522
</th>
<th>
属性删除远程执行代码漏洞 - CVE-2012-1524
</th>
<th>
综合严重等级
</th>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1522](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1522)。

#### 缓存对象远程执行代码漏洞 (CVE-2012-1522) 的缓解因素
...
#### 缓存对象远程执行代码漏洞 (CVE-2012-1522) 的变通办法
...
#### 缓存对象远程执行代码漏洞 (CVE-2012-1522) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1524](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1524)。

#### 属性删除远程执行代码漏洞 (CVE-2012-1524) 的缓解因素
...
#### 属性删除远程执行代码漏洞 (CVE-2012-1524) 的变通办法
...
#### 属性删除远程执行代码漏洞 (CVE-2012-1524) 的常见问题
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2719177">Microsoft 知识库文章 2719177</a></td>
</tr>  
<tr class="odd">
...
-   spa-s3c.blogspot.com 的 Jose A. Vazquez 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了缓存对象远程执行代码漏洞 (CVE-2012-1522)  
-   Omair 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了属性删除远程执行代码漏洞 (CVE-2012-1524)
...
-   V1.1（2012 年 7 月 18 日）： 在运行 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的系统中删除了与该更新的适用性相关的错误更新常见问题 (FAQ)。Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 不受本公告中所述的漏洞影响。

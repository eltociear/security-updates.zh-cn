...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2549)。
...
-   **禁用与被吊销的客户端证书相关联的** **域计算机帐户。**
    ...
    有关如何在 Windows Server 2008 R2 和 Windows Server 2012 中禁用计算机帐户的说明，请参阅[启用或禁用计算机帐户](http://technet.microsoft.com/en-us/library/cc732965.aspx)。

    有关使用脚本禁用多个计算机帐户的说明，请参阅[禁用计算机帐户](http://gallery.technet.microsoft.com/scriptcenter/ac6c44dd-db2f-487a-a51f-3ecb69b9386c)。
...
**什么是 IP-HTTPS？**  
IP over HTTPS (IP-HTTPS) 是一种协议，它允许使用安全 HTTP 连接建立安全的 IP 隧道。它常用在 Microsoft DirectAccess 部署中。有关详细信息，请参阅 [IP over HTTPS (IP-HTTPS) 隧道协议](http://msdn.microsoft.com/en-us/library/dd358571(v=prot.20).aspx)。

**什么是 DirectAccess？**  
DirectAccess 是在 Windows 7 和 Windows Server 2008 R2 操作系统中引入的，允许远程用户使用安全协议（如 IP-HTTPS）安全地访问企业共享、网站和应用程序。有关详细信息，请参阅 [DirectAccess](http://technet.microsoft.com/en-us/network/dd420463.aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2765809">Microsoft 知识库文章 2765809</a></td>
</tr>  
<tr class="odd">

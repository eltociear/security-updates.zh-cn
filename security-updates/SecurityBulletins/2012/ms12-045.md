---
TOCTitle: 'MS12-045'
Title: 'Microsoft 安全公告 MS12-045 - 严重'
ms:assetid: 'ms12-045'
ms:contentKeyID: 61238387
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-045(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-045 - 严重
==================================

Microsoft Data Access Components 中的漏洞可能允许远程执行代码 (2698365)
-----------------------------------------------------------------------

发布时间: 2012年7月10日 | 更新时间: 2012年9月11日
...
对于 Windows XP、Windows Vista 和 Windows 7 的所有受支持版本，此安全更新的等级为“严重”；对于 Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“中等”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过更改 Microsoft Data Access Components 处理内存中对象的方式来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。**[Microsoft 知识库文章 2698365](https://support.microsoft.com/kb/2698365) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[Windows Data Access Components 6.0](https://www.microsoft.com/download/details.aspx?familyid=ed997ae7-2e45-4620-bcbe-a5006aaca448)<sup>[1]</sup>  
(KB2698365)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Windows Data Access Components 6.0](https://www.microsoft.com/download/details.aspx?familyid=4040c290-bf41-4e14-8269-da95ee06d8e7)<sup>[1]</sup>  
(KB2698365)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Windows Data Access Components 6.0](https://www.microsoft.com/download/details.aspx?familyid=e749883d-221a-411a-9c85-759d50cefa9d)<sup>[1]</sup>  
(KB2698365)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Windows Data Access Components 6.0](https://www.microsoft.com/download/details.aspx?familyid=eeab7dbb-f6ca-44bd-a172-c07fc5803fd6)<sup>[1]</sup>  
(KB2698365)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<sup>[1]</sup>更新 KB2698365 也适用于 Windows Data Access Components 6.1。Windows Data Access Components 6.1 会在已经安装了更新 [KB2640696](https://www.microsoft.com/download/details.aspx?id=28422) 的客户的系统上进行安装，这些客户应安装更新 KB2698365 以解决该漏洞。

**不受影响的软件**

| **操作系统**（服务器核心安装）                                           | **组件**                           |
|-------------------------------------------------------------------------------|------------------------------------|
| Windows Server 2008（用于 32 位系统）Service Pack 2（服务器核心安装）         | Windows Data Access Components 6.0 |
| Windows Server 2008（用于基于 x64 的系统）Service Pack 2（服务器核心安装）    | Windows Data Access Components 6.0 |
| Windows Server 2008 R2（用于基于 x64 的系统）（服务器核心安装）               | Windows Data Access Components 6.0 |
| Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1（服务器核心安装） | Windows Data Access Components 6.0 |
...
**安全更新的 哈希 位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2698365](https://support.microsoft.com/kb/2698365)。
...
<th>
ADO 缓存大小堆溢出 RCE 漏洞 - CVE-2012-1891
</th>
<th>
综合严重等级
</th>
...
<tr>
<td style="border:1px solid black;">
Windows XP Service Pack 3 上的 Microsoft Data Access Components 2.8 Service Pack 1
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2
</td>
<td style="border:1px solid black;">
**中等**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition Service Pack 2 上的 Microsoft Data Access Components 2.8 Service Pack 2
</td>
<td style="border:1px solid black;">
**中等**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 SP2（用于基于 Itanium 的系统）上的 Microsoft Data Access Components 2.8 Service Pack 2
</td>
<td style="border:1px solid black;">
**中等**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista Service Pack 2 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 2 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008（用于 32 位系统）Service Pack 2 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中等**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中等**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中等**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中等**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1 上的 Windows Data Access Components 6.0
</td>
<td style="border:1px solid black;">
**中等**  
远程执行代码
...
Microsoft Data Access Components 访问内存中未正确初始化的对象的方式中存在一个远程执行代码漏洞。成功利用此漏洞的攻击者可以在目标系统上运行任意代码。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1891](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1891)。

#### ADO 缓存大小堆溢出 RCE 漏洞 (CVE-2012-1891) 的缓解因素
...
#### ADO 缓存大小堆溢出 RCE 漏洞 (CVE-2012-1891) 的变通办法
...
#### ADO 缓存大小堆溢出 RCE 漏洞 (CVE-2012-1891) 的常见问题

**此漏洞的影响范围有多大？**  
这是当前用户上下文中的远程执行代码漏洞。

**造成此漏洞的原因是什么？**  
当 Microsoft Data Access Components 处理特制 XML 代码时，将导致该漏洞，允许访问内存中未正确初始化的对象。
...
**此更新有什么作用？**  
此更新通过更改 Microsoft Data Access Components 处理内存中对象的方式来解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2698365$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2698365">Microsoft 知识库文章 2698365</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2698365$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2698365](https://support.microsoft.com/kb/2698365)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   一位匿名研究员与 [TippingPoint 的](https://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 ADO 缓存大小堆溢出 RCE 漏洞 (CVE-2012-1891)
...
-   V1.1（2012 年 7 月 31 日）： 公告经过修订，宣布在 KB2698365 的 Windows Vista 程序包中的一个检测更改，以解决一个 Windows Update 重新提供问题。这只是检测更改。已经成功更新了其系统的客户不需要执行任何操作。  
-   V1.2（2012 年 8 月 15 日）： 阐明了此更新也适用于 Windows 7 Service Pack 1 和 Windows Server 2008 R2 Service Pack 1 中的 Windows Data Access Components 6.1。这仅仅是信息更改。已经成功更新了其系统的客户不需要执行任何操作。  
-   V1.3（2012 年 9 月 11 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2698365 添加一个链接。

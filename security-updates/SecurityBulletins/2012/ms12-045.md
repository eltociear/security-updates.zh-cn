...
**已知问题。**[Microsoft 知识库文章 2698365](http://support.microsoft.com/kb/2698365) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<sup>[1]</sup>更新 KB2698365 也适用于 Windows Data Access Components 6.1。Windows Data Access Components 6.1 会在已经安装了更新 [KB2640696](http://www.microsoft.com/download/details.aspx?id=28422) 的客户的系统上进行安装，这些客户应安装更新 KB2698365 以解决该漏洞。
...
**安全更新的 哈希 位于何处？**  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2698365](http://support.microsoft.com/kb/2698365)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1891](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1891)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2698365">Microsoft 知识库文章 2698365</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2698365](http://support.microsoft.com/kb/2698365)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   一位匿名研究员与 [TippingPoint 的](http://www.hpenterprisesecurity.com/products/hp-tippingpoint-network-security/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 ADO 缓存大小堆溢出 RCE 漏洞 (CVE-2012-1891)

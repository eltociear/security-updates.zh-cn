...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=1bcb1d1e-9261-4a36-9256-90d3df9bd4fb)                                                                                           | 远程执行代码 | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2c687796-4c41-4d17-b738-511d2fbfc126)                                                                  | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2c39be84-1eab-4794-b3ed-e529643aca21)                                                                                  | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3cf29dfd-239e-4707-92e6-952133c1c1c2)                                                                      | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=623c1c7d-6902-4876-9614-1b6e1ef80831)                                                                  | 远程执行代码 | 重要         | 无               |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=038970b6-aeec-4e18-8dfe-887b260a7c87)                                                                                        | 远程执行代码 | 重要         | 无               |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=23abeb12-f2fe-43fd-9c4a-4d3d244832f8)                                                                            | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d089d9cb-382c-4e64-94c5-69b9864010b1)\*\*                                                             | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1ac8a368-4298-4c1d-9cfd-924d6df563af)\*\*                                                        | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3e08b242-2516-4cf6-b38e-35ec2b8b788d)                                                        | 远程执行代码 | 重要         | 无               |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7422605b-7a02-4161-b7f8-92b3ccffef64)                                             | 远程执行代码 | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4ba46bc7-af7a-445a-84f2-b0c13674409b)                                   | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=db3a4814-a409-4def-944d-4eaa540b83b0)\*\*     | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=2101663a-ed3d-4850-b79a-16960ab56b45) | 远程执行代码 | 重要         | 无               |
...
以下严重等级假设漏洞的可能的最大影响。有关在此安全公告发布 30 天内漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [1 月份公告摘要](https://technet.microsoft.com/en-us/security/bulletin/ms12-jan)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0013](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0013)。
...
-   **删除** **.application** **文件关联**
    ...
    **使用被管理的部署脚本**
    ...
    1.  使用下列命令创建注册表项副本：
        ...
        Regedit.exe /e application_HKCU_registry_backup.reg HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\FileExts\.application
        ```
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2584146">Microsoft 知识库文章 2584146</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2584146](https://support.microsoft.com/kb/2584146)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Yorick Koster 与 [Beyond Security's SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) 计划团队合作报告了程序集执行漏洞 - (CVE-2012-0013)

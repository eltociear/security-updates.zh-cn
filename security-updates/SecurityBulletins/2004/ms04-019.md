...
**安全更新替代：**本公告替代 [**MS03-025**](https://www.microsoft.com/china/security/bulletins/ms03-025.asp)。有关详细信息，请参见本公告的“常见问题解答 (FAQ)”部分。
...
此更新可消除一个秘密报告的新发现漏洞。在工具管理器启动应用程序的方式中存在一个[权限提升](https://go.microsoft.com/fwlink/?linkid=21142)漏洞。已登录的用户可以强制工具管理器以系统权限启动应用程序，从而完全控制系统。本公告的“漏洞详细资料”部分中对此漏洞进行了说明。
...
|---------------------------------------------------------------------------------------------------|----------------|--------------|
| 工具管理器漏洞 — [CAN-2004-0213](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2004-0213) | 提升权限       | 重要         |
...
|--------------------------------------------------------------------------------|----------------|--------------|------------|---------------------|
| [**MS03-025**](https://www.microsoft.com/china/security/bulletins/ms03-025.asp) | 不适用         | 已替代       | 不适用     | 不适用              |
...
使用此操作系统版本的用户最好迁移到受支持的版本，以防止可能会受到以后新出现的漏洞的影响。有关 Windows 产品生命周期的详细信息，请访问以下 [Microsoft 产品技术支持生命周期 Web 站点](https://go.microsoft.com/fwlink/?linkid=21742)。有关此操作系统版本的延长安全更新支持周期的详细信息，请访问以下 [Microsoft 产品支持服务 Web 站点](https://support.microsoft.com/default.aspx?scid=fh;%5bln%5d;lifeanoct2003)。
...
在工具管理器启动应用程序的方式中存在一个[权限提升](https://go.microsoft.com/fwlink/?linkid=21142)漏洞。已登录的用户可以强制工具管理器以系统权限启动应用程序，从而完全控制系统。
...
因为工具管理器可能会成为攻击媒介，所以应使用组策略设置将其禁用。工具管理器进程的名称是 Utilman.exe。以下指南提供了有关如何要求用户使用[组策略](https://www.microsoft.com/windows2000/techinfo/howitworks/management/grouppolwp.asp)设置只运行认可的应用程序的信息。
...
**变通办法的影响：**使用工具管理器可以便捷地使用操作系统的许多辅助功能。在取消限制前，将无法使用这些辅助功能。有关如何手动启动某些辅助功能的详细信息，请访问以下 [Web 站点](https://www.microsoft.com/enable/training/windows2000/default.aspx)。
...
**什么是工具管理器？**  
工具管理器是一个[辅助功能实用工具](https://www.microsoft.com/enable/at/default.aspx)，用户可以使用它确定辅助功能程序（如 Microsoft 放大镜、讲述人、屏幕键盘）的状态，以及启动或停止这些程序。
...
-   [Application Security Inc.](https://www.appsecinc.com) 的 Cesar Cerrudo 报告了工具管理器漏洞 (CAN-2004-0213)。

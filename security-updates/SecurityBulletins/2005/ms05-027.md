---
TOCTitle: 'MS05-027'
Title: 'Microsoft 安全公告 MS05-027 - 严重'
ms:assetid: 'ms05-027'
ms:contentKeyID: 61236635
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms05-027(v=Security.10)'
---



Microsoft 安全公告 MS05-027 - 严重
==================================

服务器消息块中的漏洞可能允许远程执行代码 (896422)
-------------------------------------------------

发布时间: 2005年6月14日 | 更新时间: 2005年6月29日
...
-   Microsoft Windows 2000 Service Pack 3 和 Microsoft Windows 2000 Service Pack 4 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=1e83f120-01fb-4029-a524-f3ae08f8bb28)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=9cc719ad-5e57-4aef-9fb3-9f7ab7bb5d32)
-   Microsoft Windows XP 64-Bit Edition Service Pack 1 (Itanium) – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=b3a61221-0dac-452c-87e9-3362dd97273a)
-   Microsoft Windows XP 64-Bit Edition Version 2003 (Itanium) – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=7d97522f-f322-44d4-9e60-bdfed4a7a079)
-   Microsoft Windows XP Professional x64 Edition – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=716b9cde-5ef1-4005-903f-fc720863f03c)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=3ea61158-e7c5-49a8-a701-b16aaf83a188)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统） – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=7d97522f-f322-44d4-9e60-bdfed4a7a079)
-   Microsoft Windows Server 2003 x64 Edition – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=b455a686-eff2-44d7-bafa-ac73f0f68fb1)
...
|-----------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| 服务器消息块漏洞 - [CAN-2005-1206](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1206) | 远程执行代码 | 严重         | 严重                      | 严重                      | 严重                | 严重                               |
...
|-------------------------------------------------------------|--------------|------------|---------------------|
| [**MS02-070**](https://go.microsoft.com/fwlink?linkid=11970) | 未取代       | 已取代     | 不适用              |
| [**MS03-024**](https://go.microsoft.com/fwlink?linkid=17340) | 已取代       | 已取代     | 不适用              |
...
#### 服务器消息块漏洞 - CAN-2005-1206

服务器消息块 (SMB) 中存在远程执行代码漏洞，成功利用此漏洞的攻击者可以完全控制受影响的系统。

#### 服务器消息块漏洞 (CAN-2005-1206) 的缓解因素：
...
#### 服务器消息块漏洞 (CAN-2005-1206) 的变通办法：

Microsoft 已测试过以下变通办法。 尽管这些变通办法不能从根本上消除此漏洞，但它们有助于阻止已知的攻击媒介。 如果某种变通办法导致功能下降，下一节中将进行说明。

**注** 其他协议（如网间数据包交换 (IPX) 和顺序包交换 (SPX)）可能受此问题的影响。 如果正在使用易受攻击的协议（如 IPX 和 SPX），对这些协议阻止相应的端口也很重要。 有关 IPX 和 SPX 的详细信息，请访问以下 [Microsoft 网站](https://www.microsoft.com/resources/documentation/windows/xp/all/reskit/en-us/prch_cnn_goue.asp)。
...
#### 服务器消息块漏洞 (CAN-2005-1206) 的常见问题解答：
...
**什么是 SMB？**  
服务器消息块 (SMB) 及其后续版本[公共 Internet 文件系统](https://www.microsoft.com/mind/1196/cifs.asp) (CIFS) 是 Windows 用来共享文件、打印机、串行端口以及 在计算机之间进行通信的 Internet 标准协议。 为此，SMB 使用命名管道和邮件插槽。 在网络环境中，服务器使客户端可以使用文件系统和资源。 客户端发出 SMB 资源请求。 服务器作出 SMB 响应。 可描述为客户端服务器请求-响应协议。

**此漏洞同样影响 CIFS 吗？**  
公共 Internet 文件系统 (CIFS) 是 Internet 标准协议。 此处所述之漏洞存在于 Microsoft 的协议实施之中，而非协议本身内。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以完全控制受影响的系统。 而且，攻击者可能使用此漏洞执行远程拒绝服务攻击和本地特权提升攻击。

**哪些人可能会利用此漏洞？**  
任何可向受影响的系统传送特制消息的匿名用户都可以尝试利用此漏洞。

**攻击者能够如何利用此漏洞？**  
攻击者可通过各种方式利用此漏洞。 攻击者可以使用以下方式通过网络直接利用此漏洞：创建一系列特制消息，并将这些消息发送至受影响的系统。 这样，这些消息可能导致受影响的系统执行代码。

攻击者也可能通过其他媒介访问受影响的组件。 例如，攻击者可以通过使用其他程序，将参数传递给容易受到攻击的组件（本地或远程）。

**受此漏洞威胁最大的系统有哪些？**  
这一漏洞对所有受影响的操作系统都构成威胁。 默认情况下，作为 Windows XP Service Pack 2 和 Windows Server 20003 的一部分提供的 Windows 防火墙会阻止受影响的端口响应基于网络利用此漏洞的尝试。

**是否可以通过 Internet 利用此漏洞？**  
是。 攻击者可能试图通过 Internet 来利用此漏洞。 采用防火墙最佳做法和标准默认防火墙配置，有助于保证免受来自 Internet 的攻击。 Microsoft 提供了关于如何帮助保护您的 PC 的信息。 最终用户可以访问[保护您的 PC 网站](https://www.microsoft.com/china/security/protect/)。 IT 专业人士可以访问[安全中心网站](https://www.microsoft.com/china/technet/security/guidance/default.mspx)。
...
**这个漏洞与由 MS05-011 纠正的 服务器消息块漏洞之间有什么关系？**  
两个漏洞都存在于服务器消息块中。 但是，此更新解决了一个 MS05-011 没有消除的新漏洞。MS05-011 可帮助防止受到该公告中所述漏洞的影响，但没有消除此新的漏洞。 此更新不能替代 MS05-011。您必须安装此更新和 MS05-011 安全公告中提供的更新，以帮助防止系统受到这两个漏洞的影响。
...
**注** 使用 **/quiet** 开关将抑制所有消息。 这包括抑制失败消息。 管理员应该使用其中一种支持的方法，验证使用 **/quiet** 开关时安装是否成功。 管理员还应该检查 KB896422.log 文件，查看使用此开关时的任何失败消息。
...
系统管理员也可以使用 Spuninst.exe 实用工具删除此安全更新。 Spuninst.exe 实用工具位于 %Windir%\\$NTUninstallKB896422$\\Spuninst 文件夹中。
...
| 文件名  | 版本          | 日期              | 时间  | 大小    | 文件夹 |
|---------|---------------|-------------------|-------|---------|--------|
| Srv.sys | 5.2.3790.324  | 2005 年 5 月 4 日 | 00:49 | 355,328 | RTMGDR |
| Srv.sys | 5.2.3790.324  | 2005 年 5 月 4 日 | 00:47 | 355,840 | RTMQFE |
| Srv.sys | 5.2.3790.2437 | 2005 年 5 月 4 日 | 02:48 | 358,912 | SP1GDR |
| Srv.sys | 5.2.3790.2437 | 2005 年 5 月 4 日 | 02:42 | 358,912 | SP1QFE |
...
|---------|---------------|-------------------|-------|-----------|-------|--------|
| Srv.sys | 5.2.3790.324  | 2005 年 5 月 4 日 | 22:40 | 990,720   | IA-64 | RTMGDR |
| Srv.sys | 5.2.3790.324  | 2005 年 5 月 4 日 | 22:40 | 994,304   | IA-64 | RTMQFE |
| Srv.sys | 5.2.3790.2437 | 2005 年 5 月 4 日 | 22:40 | 1,104,896 | IA-64 | SP1GDR |
| Srv.sys | 5.2.3790.2437 | 2005 年 5 月 4 日 | 22:40 | 1,104,896 | IA-64 | SP1QFE |
...
| 文件名  | 版本          | 日期              | 时间  | 大小    | CPU | 文件夹 |
|---------|---------------|-------------------|-------|---------|-----|--------|
| Srv.sys | 5.2.3790.2437 | 2005 年 5 月 4 日 | 22:40 | 667,648 | x64 | SP1GDR |
| Srv.sys | 5.2.3790.2437 | 2005 年 5 月 4 日 | 22:40 | 667,648 | x64 | SP1QFE |
...
-   **注册表项验证**
    ...
    **注** 此注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 896422 安全更新集成或组合到 Windows 安装源文件中，可能无法正确创建此注册表项。
...
| 文件名  | 版本          | 日期               | 时间  | 大小    | 文件夹 |
|---------|---------------|--------------------|-------|---------|--------|
| Srv.sys | 5.1.2600.1683 | 2005 年 5 月 10 日 | 00:39 | 321,280 | SP1QFE |
| Srv.sys | 5.1.2600.2673 | 2005 年 5 月 10 日 | 00:17 | 332,544 | SP2GDR |
| Srv.sys | 5.1.2600.2673 | 2005 年 5 月 10 日 | 00:22 | 332,544 | SP2QFE |

Windows XP 64-Bit Edition Service Pack 1 (Itanium)：

| 文件名  | 版本          | 日期               | 时间  | 大小      | CPU   |
|---------|---------------|--------------------|-------|-----------|-------|
| Srv.sys | 5.1.2600.1683 | 2005 年 5 月 10 日 | 00:54 | 1,137,024 | IA-64 |
...
-   **注册表项验证**
    ...
    **注** 这些注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 896422 安全更新集成或组合到 Windows 安装源文件中，可能无法正确创建这些注册表项。
...
| 文件名     | 版本          | 日期               | 时间  | 大小    |
|------------|---------------|--------------------|-------|---------|
| Srv.sys    | 5.0.2195.7044 | 2005 年 5 月 3 日  | 08:10 | 238,928 |
| Srvsvc.dll | 5.0.2195.6697 | 2003 年 1 月 19 日 | 20:05 | 83,728  |
...
-   **注册表项验证**
    ...
    **注** 此注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 896422 安全更新集成或组合到 Windows 安装源文件中，则可能无法正确创建此注册表项。
...
-   [Qualys](https://www.qualys.com) 报告了服务器消息块漏洞 (CAN-2005-1206)。

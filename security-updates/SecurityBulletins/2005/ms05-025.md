...
-   [ISS X-Force](http://www.iss.net/) 的 Mark Dowd 报告了 PNG 图像呈现内存损坏漏洞 (CAN-2005-1211)。
-   [Next Generation Security Software Ltd.](http://www.ngssoftware.com/) 的 Mark Litchfield 报告了 DigWebX ActiveX 控件中的问题，已在此安全更新中为此问题设置了 kill bit。
-   [PivX Solutions, Inc.](http://www.pivx.com/) 的 Thor Larholm 报告了已作为本安全更新的一部分而解决的弹出窗口阻止程序问题。
-   [UK National Infrastructure Security Co-ordination Centre (NISCC)](http://www.niscc.gov.uk/) 报告了已作为本安全更新的一部分而解决的 GIF 和 XBM 呈现问题。

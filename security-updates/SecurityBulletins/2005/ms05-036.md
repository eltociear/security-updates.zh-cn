---
TOCTitle: 'MS05-036'
Title: 'Microsoft 安全公告 MS05-036 - 严重'
ms:assetid: 'ms05-036'
ms:contentKeyID: 61236644
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms05-036(v=Security.10)'
---



Microsoft 安全公告 MS05-036 - 严重
==================================

Microsoft 颜色管理模块中的漏洞可能允许远程执行代码 (901214)
-----------------------------------------------------------
...
-   Microsoft Windows 2000 Service Pack 4 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=fa8d18ec-ebf4-4c49-afa0-f6a215b3624f)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=c5bcf2db-adce-42bd-abee-1380f258158b)
-   Microsoft Windows XP Professional x64 Edition – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=c54bb4ba-fb9b-4615-9bbe-ef6d3885467d)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 – [下载此更新](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=44275ecb-2e79-4ce8-8269-e81219ce8f6c)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统） – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=97a903bc-90e1-4fde-9487-1816c4a647bb)
-   Microsoft Windows Server 2003 x64 Edition – [下载此更新](https://www.microsoft.com/download/details.aspx?familyid=52167b42-8790-4965-9f26-dc5edc2e84f8)
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;">颜色管理模块漏洞 - <a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1219">CAN-2005-1219</a></td>
...
由于 Windows XP Professional x64 Edition 的发布，Microsoft Windows XP 64-Bit Edition Service Pack 1 (Itanium) 和 Microsoft Windows XP 64-Bit Edition Version 2003 (Itanium) 将不再收到安全更新支持。 使用这些操作系统版本的客户应优先考虑迁移到受支持的版本，以防止可能会受到新出现漏洞的影响。 由于 64 位的计算需求，Microsoft 将继续完全支持 Windows Server 2003（用于基于 Itanium 的系统）、Windows XP Professional x64 Edition 和 Windows Server 2003 x64 Editions。 Microsoft 继续授权和支持 Windows Server 2003 Enterprise 和 Datacenter 版本（用于 Itanium 的系统）以及 SQL Server 2000 Enterprise Edition 的 64 位版本。 将来，我们会将 Itanium 支持扩展到 Visual Studio 2005、.NET Framework 2005 和 SQL Server 2005。
...
检测 Microsoft Windows 及其他受影响的 Microsoft 产品需要安全更新清单工具。 有关安全更新清单工具的限制的详细信息，请参阅 [Microsoft 知识库文章 306460](https://support.microsoft.com/kb/306460)
...
#### 颜色管理模块漏洞 - CAN-2005-1219：
  
Microsoft 颜色管理模块中存在远程执行代码漏洞，原因在于其处理 ICC 配置文件格式标记验证的方式。 攻击者可以通过建立恶意的图像文件来利用此漏洞，如果用户访问了恶意网站或查看了恶意的电子邮件，此恶意的图像文件就可能允许远程执行代码。 成功利用此漏洞的攻击者可以完全控制受影响的系统。
  
#### 颜色管理模块漏洞 (CAN-2005-1219) 的缓解因素：
  
-   在基于 Web 的攻击中，攻击者必须拥有一个网站，并在上面放置用来利用此漏洞的网页。 攻击者无法强迫用户访问恶意网站。 相反，攻击者必须诱使用户访问该网站，所采用的方式通常是让用户单击指向攻击者网站的链接。  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
#### 颜色管理模块漏洞 (CAN-2005-1219) 的变通办法：
  
我们并未发现此漏洞的任何变通办法。
  
#### 颜色管理模块漏洞 (CAN-2005-1219) 的常见问题解答：
...
**造成漏洞的原因是什么？**  
Microsoft 颜色管理模块中未经检查的缓冲区。
  
**什么是 Microsoft 颜色管理模块？**  
Microsoft 颜色管理模块允许操作系统在不同的设备和应用程序之间提供一致的颜色映射。 此外，此模块用于将颜色从一个颜色空间转换到另一个颜色空间（例如，从 RGB 转换到 CMYK）。 有关颜色管理的其他信息，请访问以下[网站](https://www.microsoft.com/whdc/device/display/color/icmwp.mspx)
  
**什么是国际色彩联盟 (ICC)？**  
国际色彩联盟这一组织旨在提供供应商可以实施颜色管理的标准，从而确保跨供应商兼容性。 有关国际色彩联盟 (ICC) 的其他信息，请访问以下[网站](https://www.color.org/)
...
**攻击者能够如何利用此漏洞？**  
攻击者可能通过创建特制的恶意图像并诱使用户以下列方式查看该图像，从而尝试利用此漏洞：查看本地文件、预览包含恶意图像的电子邮件或打开包含恶意图像的电子邮件附件。 然后，这些操作可能导致受影响的系统执行代码。
...
否。尽管 Windows 98、Windows 98 Second Edition 和 Windows Millennium Edition 的确包含受影响的组件，但是由于此漏洞不可通过关键的攻击媒介加以利用，因而并不严重。此外，当前已知的攻击媒介需要用户交互操作才能利用此漏洞。有关严重等级的详细信息，请访问以下[网站](https://go.microsoft.com/fwlink/?linkid=21140)。
  
**此更新有什么作用？**  
此更新通过修改 Microsoft 颜色管理模块在将数据传递到分配的缓冲区之前验证 ICC 配置文件信息的方式来消除此漏洞。
...
**注意** 使用 **/quiet** 开关将抑制所有消息。 这包括抑制失败消息。 管理员应该使用其中一种支持的方法，验证使用 **/quiet** 开关时安装是否成功。 管理员还应该检查 KB901214.log 文件，查看使用此开关时的任何失败消息。
...
系统管理员也可以使用 Spuninst.exe 实用工具删除此安全更新。 Spuninst.exe 实用工具位于 %Windir%\\$NTUninstallKB901214$\\Spuninst 文件夹中。
...
| 文件名    | 版本          | 日期               | 时间  | 大小    | 文件夹 |
|-----------|---------------|--------------------|-------|---------|--------|
| Icm32.dll | 5.2.3790.359  | 2005 年 6 月 29 日 | 05:09 | 239,616 | RTMGDR |
| Mscms.dll | 5.2.3790.359  | 2005 年 6 月 29 日 | 05:09 | 70,656  | RTMGDR |
| Icm32.dll | 5.2.3790.359  | 2005 年 6 月 29 日 | 05:05 | 239,616 | RTMQFE |
| Mscms.dll | 5.2.3790.359  | 2005 年 6 月 29 日 | 05:05 | 70,656  | RTMQFE |
| Icm32.dll  | 5.2.3790.2476 | 2005 年 6 月 29 日 | 05:47 | 292,352 | x64 | SP1GDR      |
| Mscms.dll  | 5.2.3790.2476 | 2005 年 6 月 29 日 | 05:47 | 154,112 | x64 | SP1GDR      |
| Wicm32.dll | 5.2.3790.2476 | 2005 年 6 月 29 日 | 05:47 | 255,488 | x86 | SP1GDR\\WOW |
| Wmscms.dll | 5.2.3790.2476 | 2005 年 6 月 29 日 | 05:47 | 75,264  | x86 | SP1GDR\\WOW |
| Icm32.dll  | 5.2.3790.2476 | 2005 年 6 月 29 日 | 05:47 | 292,352 | x64 | SP1QFE      |
| Mscms.dll  | 5.2.3790.2476 | 2005 年 6 月 29 日 | 05:47 | 154,112 | x64 | SP1QFE      |
| Wicm32.dll | 5.2.3790.2476 | 2005 年 6 月 29 日 | 05:47 | 255,488 | x86 | SP1QFE\\WOW |
| Wmscms.dll | 5.2.3790.2476 | 2005 年 6 月 29 日 | 05:47 | 75,264  | x86 | SP1QFE\\WOW |
...
-   **注册表项验证**
    ...
    **注意** 此注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 901214 安全更新集成或组合到 Windows 安装源文件中，可能无法正确创建此注册表项。
...
| 文件名    | 版本          | 日期               | 时间  | 大小    | 文件夹 |
|-----------|---------------|--------------------|-------|---------|--------|
| Icm32.dll | 5.1.2600.1710 | 2005 年 6 月 29 日 | 01:54 | 237,056 | SP1QFE |
| Mscms.dll | 5.1.2600.1710 | 2005 年 6 月 29 日 | 01:54 | 68,608  | SP1QFE |
| Icm32.dll | 5.1.2600.2709 | 2005 年 6 月 29 日 | 01:46 | 254,976 | SP2GDR |
| Mscms.dll | 5.1.2600.2709 | 2005 年 6 月 29 日 | 01:46 | 74,240  | SP2GDR |
| Icm32.dll | 5.1.2600.2709 | 2005 年 6 月 29 日 | 01:49 | 254,976 | SP2QFE |
| Mscms.dll | 5.1.2600.2709 | 2005 年 6 月 29 日 | 01:49 | 73,728  | SP2QFE |
...
-   **注册表项验证**
    ...
    **注意** 这些注册表项可能不包含已安装文件的完整列表。 另外，如果管理员或 OEM 将 901214 安全更新集成或组合到 Windows 安装源文件中，可能无法正确创建这些注册表项。
...
| 文件名    | 版本          | 日期               | 时间  | 大小    |
|-----------|---------------|--------------------|-------|---------|
| Icm32.dll | 5.0.0.3       | 2005 年 6 月 29 日 | 07:30 | 246,032 |
| Mscms.dll | 5.0.2195.7054 | 2005 年 6 月 29 日 | 07:30 | 69,904  |
...
-   [Information & Communication Security Technology Center (ICST)](https://www.icst.org.tw) 的 Shih-hao Weng 报告了颜色管理模块漏洞 (CAN-2005-1219)。

...
|-----------------------------------------------------------------------------------------------------|------------|--------------|
| Windows 内核漏洞 - [CAN-2005-2827](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2827) | 特权提升   | 重要         |
...
可以。 SMS 可以帮助您检测和部署此安全更新。 有关 SMS 的信息，请访问 [SMS 网站](https://go.microsoft.com/fwlink/?linkid=21158)。
...
内核中处理异步过程调用的方式中存在一个[特权提升](https://go.microsoft.com/fwlink/?linkid=21142)漏洞。 已登录的用户可通过利用此漏洞完全控制系统。
...
**什么是异步过程调用 (APC)？**  
异步过程调用 (APC) 是在特定线程的上下文中异步执行的一个函数。 有关详细信息，请访问以下 [Microsoft 网站](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/dllproc/base/asynchronous_procedure_calls.asp)。
...
-   [eEye Digital Security](https://www.eeye.com/) 报告了 Windows 内核漏洞 (CAN-2005-2827)。

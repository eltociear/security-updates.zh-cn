...
**注意事项：** [Microsoft 知识库文章 908506](http://support.microsoft.com/kb/908506) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 有关详细信息，请参阅 [Microsoft 知识库文章 908506](http://support.microsoft.com/kb/908506)。
...
|---------------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------|---------------------------|---------------------|
| 打印后台处理程序漏洞 - [CAN-2005-1984](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1984) | 远程执行代码 | 严重         | 严重                      | 中等                      | 中等                |
...
[Microsoft 知识库文章 908506](http://support.microsoft.com/kb/908506): 在运行 Windows 2000 Service Pack 4 的计算机上安装安全更新 896423 之后，您可能无法打印到网络打印机。
...
此更新不需要重新启动。 为了降低被迫重新启动的机率，请首先停止后台处理程序服务并且关闭所有可能使用受影响的文件的应用程序，然后安装安全更新。 有关可能提示您重新启动计算机的原因的详细信息，请参阅 [Microsoft 知识库文章 887012](http://support.microsoft.com/kb/887012)。
...
-   CERT RENATER 的 [Kostya Kortchinsky](http://www.microsoft.com/technet/security/bulletin/邮件地址：kostya.kortchinsky@renater.fr) 报告了打印后台处理程序漏洞 (CAN-2005-1984)。

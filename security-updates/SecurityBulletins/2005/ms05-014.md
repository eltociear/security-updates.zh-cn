...
有关此公告中出现的术语详细信息（如修复程序），请参见 [Microsoft 知识库文章 824684](http://support.microsoft.com/kb/824684)。
...
-   [Michael Krax](http://www.mikx.de/)，他非常负责地与我们一起致力于消除“拖放操作漏洞”(CAN-2005-0053)。
-   [Secunia](http://secunia.com/) 的 Andreas Sandblad，他非常负责地与我们一起致力于消除“拖放操作漏洞”(CAN-2005-0053)。
-   [Jouko Pynnönen](http://jouko.iki.fi/index-en.html)，他报告了 URL 解码区欺骗漏洞 (CAN-2005-0054)。
-   [Secunia](http://secunia.com/) 的 Andreas Sandblad，他报告了 DHTML 方法堆内存损坏漏洞 (CAN-2005-0055)。

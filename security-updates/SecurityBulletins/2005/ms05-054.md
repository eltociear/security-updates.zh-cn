...
-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了 COM 对象实例化内存损坏漏洞 ([CAN-2005-2831](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2831)) 中介绍的许多类标识符。
-   [Secunia](https://www.secunia.com/) 的 Andreas Sandblad 和 Jakob Balle 报告了文件下载对话框操作漏洞 - ([CAN-2005-2829](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-2829))。

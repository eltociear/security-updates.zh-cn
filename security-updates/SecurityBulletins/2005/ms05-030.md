...
|-----------------------------------------------------------------------------------------------------------------|------------|-----------------------------------------------------------------|----------------------------------------------------------------------|----------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| Outlook Express 新闻阅读漏洞 - [CAN-2005-1213](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1213) | 特权提升   | 重要                                                            | 重要                                                                 | 重要                                                                                   | 重要                                                                                       |
...
MBSA 不支持 Outlook Express，不检测 Outlook Express 是否需要更新。 但是，Microsoft 已开发 [Enterprise Update Scan Tool](https://support.microsoft.com/kb/894193) (EST) 的一个版本。 此工具可帮助客户确定是否需要此安全更新。
有关 MBSA 当前不检测的程序的详细信息，请参阅 [Microsoft 知识库文章 306460](https://support.microsoft.com/kb/306460)。有关 MBSA 的详细信息，请访问 [MBSA 网站](https://go.microsoft.com/fwlink/?linkid=21134)。

**什么是 Enterprise Update Scan Tool (EST)？**  
Microsoft 始终坚持为公告级别的安全更新提供检测工具，一旦 Microsoft Baseline Security Analyzer (MBSA) 和 Office Detection Tool (ODT) 不能检测 MSRC 发行周期是否需要更新，Microsoft 将提供独立的检测工具。 此独立工具称为“Enterprise Update Scan Tool (EST)”，是为企业管理员设计的。 在为特定公告创建 Enterprise Update Scan Tool 的某个版本之后，客户可以通过命令行界面 (CLI) 来运行该工具并查看 XML 输出文件的结果。 为帮助客户更好地使用此工具，此工具附带[详细说明文档](https://support.microsoft.com/kb/894193)。 另外，此工具还有一个版本，用来为 SMS 管理员提供的综合体验。

**是否可以使用 Enterprise Update Scan Tool 的某个版本来确定是否需要此更新？**  
是。 Microsoft 已创建 Enterprise Update Scan Tool 新版本，可确定是否必须应用此更新。 有关本月发布的 Enterprise Update Scan Tool 版本的详细信息，请参阅以下 [Microsoft 网站](https://support.microsoft.com/kb/894193)。 此工具还有一个适用于 Systems Management Server (SMS) 客户的版本。 要获得该工具的此版本，请访问以下 [Microsoft 网站](https://support.microsoft.com/kb/894154)。 SMS 客户也可从 [SMS 网站](https://go.microsoft.com/fwlink/?linkid=21158)获得此工具。

**可否使用 Systems Management Server (SMS) 确定是否需要此更新？**  
是。 SMS 可以帮助您检测和部署此安全更新。 SMS 使用 MBSA 进行检测；因此，SMS 具有本公告前面所列的与 MBSA 不检测的程序有关的相同限制。
但是，SMS 客户还可获得另一个 Enterprise Update Scan Tool 版本，该版本为 SMS 管理员提供综合体验。 要获得该工具的此版本，请访问以下 [Microsoft 网站](https://support.microsoft.com/kb/894194)。 有关 SMS 的详细信息，请访问 [SMS 网站](https://go.microsoft.com/fwlink/?linkid=21158)。
...
-   在受影响的系统上使用 IPSec 来阻塞受影响的端口。 使用 Internet 协议安全 (IPSec) 有助于保护网络通信。 有关 IPSec 以及如何应用筛选器的详细信息，请参阅 [Microsoft 知识库文章 313190](https://support.microsoft.com/kb/313190) 和 [813878](https://support.microsoft.com/kb/813878)。
-   不要连接到不受信任的新闻组服务器。
...
**什么是网络新闻传输协议 (NNTP）组件**
NNTP 组件提供在 Internet 社区之间分发、检索和发布新闻文章的服务。 NNTP 设计为可将新闻文章存储在中央数据库中，允许订阅者仅选择他们要读取的那些项目。 有关 NNTP 的详细信息，请参见 [NNTP 产品文档](https://www.microsoft.com/resources/documentation/windowsserv/2003/standard/proddocs/en-us/default.asp?url=/resources/documentation/windowsserv/2003/standard/proddocs/en-us/nntp_administration.asp?frame=true)。 在请求注释 (RFC) 文档 [RFC 977](https://www.ietf.org/rfc/rfc977.txt) 和 [RFC 2980](https://www.ietf.org/rfc/rfc2980.txt) 中对 NNTP 进行了定义。
...
有关受支持的安装开关的详细信息，请参阅 [Microsoft 知识库文章 262841](https://support.microsoft.com/kb/262841)。

有关 Update.exe 安装程序的详细信息，请访问 [Microsoft TechNet 网站](https://go.microsoft.com/fwlink/?linkid=38951)。 有关本公告中出现的术语（如“*更新*”）的详细信息，请参阅 [Microsoft 知识库文章 824684](https://support.microsoft.com/kb/824684)。
...
在某些情况下，此更新不需要重新启动。 如果所需的文件正在使用，则此更新将需要重新启动。 如果发生这种情况，将显示一条消息建议您重新启动。 有关可能提示您重新启动的原因的详细信息，请参阅 [Microsoft 知识库文章 887012](https://support.microsoft.com/kb/887012)。
...
有关本公告中出现的术语（如“更新”）的详细信息，请参阅 [Microsoft 知识库文章 824684](https://support.microsoft.com/kb/824684)。
...
-   [iDEFENSE](https://www.idefense.com/) 报告了 Outlook Express 新闻阅读漏洞 ([CAN-2005-1213](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2005-1213))。

...
对于 Microsoft Windows 2000 Service Pack 4、Windows XP、Windows Server 2003、Windows Vista 和 Windows Server 2008 的所有受支持版本，此安全更新的等级为“严重”。有关受此更新影响的软件的详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。 有关可能受这些问题攻击的控件和组件的影响、变通办法和缓解因素的详细信息，请参阅 [Microsoft 安全通报 (973882)](https://technet.microsoft.com/security/advisory/973882)。
...
<td style="border:1px solid black;">
[MS08-048](https://go.microsoft.com/fwlink/?linkid=117705)
</td>
</tr>
...
<td style="border:1px solid black;">
[MS07-047](https://go.microsoft.com/fwlink/?linkid=88628)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS05-013](https://go.microsoft.com/fwlink/?linkid=41142)
</td>
</tr>
<tr>
<th style="border:1px solid black;" colspan="5">
...
<td style="border:1px solid black;">
[Windows Media Player 9](https://www.microsoft.com/download/details.aspx?familyid=ec84c98b-6bc7-442f-9280-d6e204280b2f)  
(KB973540)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Windows Media Player 10 和 Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=ec84c98b-6bc7-442f-9280-d6e204280b2f)  
(KB973540)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[HtmlInput 对象 ActiveX 控件](https://www.microsoft.com/download/details.aspx?familyid=46aa443c-4e7b-4bd5-8b4e-0068c3dc0e79)  
(KB973768)  
...
<td style="border:1px solid black;">
[HtmlInput 对象 ActiveX 控件](https://www.microsoft.com/download/details.aspx?familyid=59fefa17-0ad4-4a62-82be-e6a2b7a0aec3)  
(KB973768)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[HtmlInput 对象 ActiveX 控件](https://www.microsoft.com/download/details.aspx?familyid=92de8a2e-2d50-4278-937e-ccb862c5ab8f)  
(KB973768)
</td>
<td style="border:1px solid black;">
远程执行代码
...
HtmlInput 对象 ActiveX 控件允许 Windows Media Center 托管 HTML 应用程序在其 HTML 页面上包括软键盘 ActiveX 控件的实例。 该控件提供一个标准接口，用于检索用户的文本输入，从而允许他们使用远程控制输入文本。 有关详细信息，请参阅 MSDN 文章 [HtmlInput 对象](https://msdn.microsoft.com/en-us/library/ms814716.aspx)。
...
此公告解决受 [Microsoft 安全通报 (973882)](https://technet.microsoft.com/security/advisory/973882) 中描述的活动模板库 (ATL) 漏洞影响的 Windows 组件。
...
是，您需要安装第三方提供的更新控件（发布时）。 [MS09-034](https://go.microsoft.com/fwlink/?linkid=158199) Internet Explorer 缓解措施没有从根本上解决使用活动模板库开发的特定组件和控件内的漏洞。 Microsoft 建议开发人员按照此公告中提供的指导修改和重新构建所有受此公告中描述的漏洞影响的组件和控件。

**ATL 是什么？**
活动模板库 (ATL) 是一组基于模板的 C++ 类，使开发人员能够创建小型快速的组件对象模型 (COM) 对象。 它专门支持关键的 COM 特性，包括栈实现、双接口、标准 COM 枚举接口、连接点、tear-off 接口 和 ActiveX 控件。 有关详细信息，请参阅以下 [MSDN 文章](https://msdn.microsoft.com/en-us/library/3ax346b7(vs.71).aspx)。

**什么是 DHTML 编辑组件 ActiveX 控件？**
DHTML 编辑组件 ActiveX 控件提供了一个 HTML 编辑器，开发人员可以使用它在软件中进行动态网站 HTML 编辑。 有关 DHTML 编辑组件 ActiveX 控件的详细信息，请参阅 [MSDN 文章](https://msdn.microsoft.com/en-us/library/aa753630(vs.85).aspx)。

**什么是 Microsoft MSWebDVD ActiveX 控件？**
Microsoft MSWebDVD ActiveX 控件用于通过使 MSWebDVD 对象暴露于应用程序创建基于脚本的 DVD 应用程序。 有关详细信息，请参阅以下 [MSDN 文章](https://msdn.microsoft.com/en-us/library/dd390904(vs.85).aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0015)。
...
是。 Microsoft 安全公告 [MS09-032](https://go.microsoft.com/fwlink/?linkid=157386)“ActiveX Kill Bit 的累积性安全更新”包括 msvidctl.dll 的 ActiveX kill bit 作为 CVE-2008-0015 的一部分。此公告 MS09-037 还解决受 CVE-2008-0015 影响的组件。在 MS09-032 中，为 msvidctl.dll 提供了 kill bit，因为该组件从未设计为要在 Internet Explorer 中进行实例化。 此公告中解决的组件可进行实例化，并且已更新以解决 CVE-2008-0015 包括的核心问题。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0020)。
...
**第三方 ActiveX 控件是否受此问题影响？**  
如果在创建组件和控件的过程中满足某种特定条件，某些第三方组件和控件可能受此问题影响。 Microsoft 建议开发人员按照 [MS09-035](https://go.microsoft.com/fwlink/?linkid=158131) Visual Studio 公告中提供的指导修改和重新构建所有受此公告中描述的漏洞影响的组件和控件。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2494](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2494)。
...
<td style="border:1px solid black;">对于 Microsoft Outlook Express 5.5 Service Pack 2 或 Outlook Express 6 Service Pack 1 (KB973354)：<br />
请参阅 <a href="https://support.microsoft.com/kb/973354">Microsoft 知识库文章 973354</a><br />  
<br />  
对于 Windows Media Player 9 (KB973540)：<br />  
请参阅 <a href="https://support.microsoft.com/kb/973540">Microsoft 知识库文章 973540</a><br />  
<br />  
对于 Windows ATL 组件 (KB973507)：<br />  
请参阅 <a href="https://support.microsoft.com/kb/973507">Microsoft 知识库文章 973507</a><br />  
<br />  
对于 DHTML 编辑组件 ActiveX 控件 (KB973869)：<br />
请参阅 <a href="https://support.microsoft.com/kb/973869">Microsoft 知识库文章 973869</a></td>
</tr>
<tr class="even">
...
<br />  
对于 DHTML 编辑组件 ActiveX 控件 (KB973869)：<br />  
请参阅 <a href="https://support.microsoft.com/kb/973869">Microsoft 知识库文章 973869</a><br />  
<br />  
对于 Microsoft MSWebDVD ActiveX 控件 (KB973815)：<br />  
请参阅 <a href="https://support.microsoft.com/kb/973815">Microsoft 知识库文章 973815</a><br />  
<br />  
对于 HtmlInput 对象 ActiveX 控件 (KB973768)：<br />
请参阅 <a href="https://support.microsoft.com/kb/973768">Microsoft 知识库文章 973768</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<br />  
对于 Microsoft MSWebDVD ActiveX 控件 (KB973815)：<br />
请参阅 <a href="https://support.microsoft.com/kb/973815">Microsoft 知识库文章 973815</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Microsoft Outlook Express 6 (KB973354)：<br />
...
<br />  
对于 Windows ATL 组件 (KB973507)：<br />
请参阅 <a href="https://support.microsoft.com/kb/973507">Microsoft 知识库文章 973507</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注意</strong> 没有用于验证此更新是否存在的注册表项。</td>
...
-   [IBM ISS X-Force](https://www.iss.net/) 的 Ryan Smith 和 Alex Wheeler 最初报告了 Microsoft Video ActiveX 控件远程执行代码漏洞 (CVE-2008-0015)  
-   [IBM ISS X-Force](https://www.iss.net/) 的 Robert Freeman 报告了 ATL 标头 Memcopy 漏洞 (CVE-2008-0020)  
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Ryan Smith 报告了 ATL 对象类型不匹配漏洞 (CVE-2009-2494)

---
TOCTitle: 'MS09-025'
Title: 'Microsoft 安全公告 MS09-025 - 重要'
ms:assetid: 'ms09-025'
ms:contentKeyID: 61237476
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-025(v=Security.10)'
---
...
此安全更新通过更正验证特定内核对象中的更改、验证从用户模式传递给内核的输入以及验证传递给系统调用的参数所使用的方法来解决这些漏洞。 此安全更新还通过确保 Windows 内核在错误情况下清除指针来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=79b0481d-a3d7-477b-928a-a98cc79374af)                                  | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=6349e046-a3f8-4ae5-b8c3-c9879cc99e8f)                 | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3769800e-af93-4a44-8a1e-b30cc54b226f)                     | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9356404c-d89a-4de0-b9b4-f6e1bdadf745)                                     | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5a3123af-173d-49eb-9997-14e82e764aee)                         | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=13b50993-410f-4e7a-a33a-6d9b48dbb4d1)                     | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows Vista 和 Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c31b36f8-330c-4a0c-9a3d-7cbe9a1ab8c8)                          | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c31b36f8-330c-4a0c-9a3d-7cbe9a1ab8c8)                                           | 特权提升     | 重要         | 无                                                        |
| [Windows Vista x64 Edition and Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7d70a65f-07ce-4992-8bec-28fefd7587bc) | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7d70a65f-07ce-4992-8bec-28fefd7587bc)                               | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=98ba52b2-da1a-4939-a10e-d43b3a7e7ed4)\*                                | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=98ba52b2-da1a-4939-a10e-d43b3a7e7ed4)\*                  | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=dbaa5a72-c267-4907-a207-525c2803d7b9)\*                           | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=dbaa5a72-c267-4907-a207-525c2803d7b9)\*             | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=e0e3ad56-a363-44ba-af4d-b7f551c88afd)                         | 特权提升     | 重要         | [MS09-006](https://go.microsoft.com/fwlink/?linkid=132503) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e0e3ad56-a363-44ba-af4d-b7f551c88afd)           | 特权提升     | 重要         | 无                                                        |
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 内核桌面漏洞 - CVE-2009-1123</th>
<th>Windows 内核指针验证漏洞 - CVE-2009-1124</th>
<th>Windows 驱动器类注册漏洞 - CVE-2009-1125</th>
<th>Windows 桌面参数编辑漏洞 - CVE-2009-1126</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Windows 内核桌面漏洞 - CVE-2009-1123  
------------------------------------
  
<span></span>  
Windows 内核未正确验证某些内核对象中的更改的方式中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1123](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1123)。
  
#### Windows 内核桌面漏洞 (CVE-2009-1123) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核桌面漏洞 (CVE-2009-1123) 的变通方法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核桌面漏洞 (CVE-2009-1123) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核未正确验证某些内核对象中的更改。
...
**此更新有什么作用？**    
此更新通过更正验证特定内核对象中的更改所使用的方法来解决此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-1123](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1123)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 看到了公开发布的概念证明代码示例，但未收到任何表明此漏洞已被公开用于攻击用户的直接报告。
  
Windows 内核指针验证漏洞 - CVE-2009-1124  
----------------------------------------
  
<span></span>  
Windows 内核中存在一个由于未充分验证从用户模式传递的某些指针而产生的特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1124](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1124)。
  
#### Windows 内核指针验证漏洞 (CVE-2009-1124) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核指针验证漏洞 (CVE-2009-1124) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核指针验证漏洞 (CVE-2009-1124) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核未正确验证从用户模式传递的某些指针。
...
Windows 驱动器类注册漏洞 - CVE-2009-1125  
----------------------------------------
  
<span></span>  
由于 Windows 内核未正确验证传递给 Windows 内核系统调用的参数而导致存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1125](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1125)。
  
#### Windows 驱动器类注册漏洞 (CVE-2009-1125) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 驱动器类注册漏洞 (CVE-2009-1125) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 驱动器类注册漏洞 (CVE-2009-1125) 的常见问题
...
Windows 桌面参数编辑漏洞 - CVE-2009-1126  
----------------------------------------
  
<span></span>  
在编辑特定的桌面参数时，Windows 内核未正确验证从用户模式传递到内核的输入而导致存在一个特权提升漏洞。 该漏洞能够允许攻击者使用提升的特权运行代码。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1126](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1126)。
  
#### Windows 桌面参数编辑漏洞 (CVE-2009-1126) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 桌面参数编辑漏洞 (CVE-2009-1126) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 桌面参数编辑漏洞 (CVE-2009-1126) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核在编辑特定的桌面参数时未正确验证从用户模式传递到内核的输入。
...
**此更新有什么作用？**    
此更新通过更正在设置特定的桌面参数时验证从用户模式传递到内核的输入所使用的方法来解决此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-1126](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1126)。
...
| **部署**                         |                                                                                                                       |  
| 没有用户干预的安装               | Windows2000-KB968537-x86-ENU /quiet                                                                                   |  
| 在不重新启动的情况下安装         | Windows2000-KB968537-x86-ENU /norestart                                                                               |  
| 更新日志文件                     | kb968537.log                                                                                                          |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节                                                                                  |  
| **重新启动要求**                 |                                                                                                                       |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                                |  
| HotPatching                      | 不适用                                                                                                                |  
| **删除信息**                     | 使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB968537$\\Spuninst 文件夹中的 Spuninst.exe 实用程序 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 968537。](https://support.microsoft.com/kb/968537)                                        |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB968537\\Filelist                             |
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB968537$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/968537">Microsoft 知识库文章 968537。</a></td>
</tr>  
<tr class="even">
...
-   Thomas Garnier 报告了 Windows 内核指针验证漏洞 (CVE-2009-1124) 和 Windows 驱动器类注册漏洞 (CVE-2009-1125)

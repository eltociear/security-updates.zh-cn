...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Works 8.5：<br />
请参阅 <a href="https://support.microsoft.com/kb/977304">Microsoft 知识库文章 977304</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/974882">Microsoft 知识库文章 974882</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [VeriSign iDefense](https://labs.idefense.com/) Labs 的 Sean Larsson 和 Jun Mao 报告了写字板和 Office 文本转换器内存损坏漏洞 (CVE-2009-2506)

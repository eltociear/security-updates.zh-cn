...
**已知问题。** [Microsoft 知识库文章 969693](https://support.microsoft.com/kb/969693) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d4b0665d-5744-49c7-a3c0-f231fd08d3b8">Microsoft Office Publisher 2007 Service Pack 1</a><br />
(KB969693)</td>
...
[Microsoft 知识库文章 969693](https://support.microsoft.com/kb/969693) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
  
**此更新是否包含任何其他安全或非安全相关更改？**    
是，作为 Microsoft Office 2007 的服务模型的一部分。当 Microsoft Office 2007 Service Pack 1 的用户安装此更新时，他们的系统将升级到最初随 [Microsoft Office 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b444bf18-79ea-46c6-8a81-9db49b4ab6e5&displaylang=en) 发布的功能。2009 年 2 月之后发布的所有更新都包含 [Microsoft 知识库文章 953195](https://support.microsoft.com/kb/953195)“Service Pack 2 改进概述”中列出的更新。 我们已经对此更新进行了彻底测试，但是与所有更新一样，我们建议用户对其环境和系统的配置执行适合的测试。 有关 Microsoft 如何更新 2007 Microsoft Office 产品的详细信息，请参阅 [Microsoft 知识库文章 949370](https://support.microsoft.com/kb/949370)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0566](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0566)。
...
-   **禁用 Publisher Converter DLL**
    ...
    **注意** 使用适用于您的系统的 Windows 路径，如 “%ProgramFiles(86)%” 或 “%windir%\\SysWOW64”。
    ...
    ```
    takeown /f <64BIT_PATH_AND_FILENAME>icacls <64BIT_PATH_AND_FILENAME> /save %TEMP%\ FILENAME _ACL.TXT
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/969693">Microsoft 知识库文章 969693</a></td>
</tr>  
<tr class="even">
...
-   [Labo Skopia](https://www.laboskopia.com/) 的 Lionel d'Hauenens 与 [VeriSign iDefense Labs](https://www.idefense.com/) 合作，报告了指针解除引用漏洞 (CVE-2009-0566)。

...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1544](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1544)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/971657">Microsoft 知识库文章 971657</a></td>
</tr>  
<tr class="even">
...
-   [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/) 的 Cody Pierce 报告了 Workstation 服务内存损坏漏洞 (CVE-2009-1544)

---
TOCTitle: 'MS09-041'
Title: 'Microsoft 安全公告 MS09-041 - 重要'
ms:assetid: 'ms09-041'
ms:contentKeyID: 61237492
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-041(v=Security.10)'
---
...
此安全更新通过纠正 Workstation 服务分配和释放内存的方式来解决此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=9c0e5bff-c248-4e87-a83b-82ba52f5299d)                                                          | 特权提升     | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7b64a454-d383-47e3-b469-b87e2b3c1a9f)                                                              | 特权提升     | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9cb0477f-0656-47f5-bd35-5716e0572fbd)                                                                              | 特权提升     | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=96fbf65f-1db2-432d-92a0-6669d8abaeb0)                                                                  | 特权提升     | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=11321f48-8997-4b99-982a-3ba4ad3f5992)                                                              | 特权提升     | 重要         | 无               |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=979ac9da-940f-49e7-91a2-b12db3708076)                                     | 拒绝服务     | 中等         | 无               |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b9aa04cc-a5c5-47ae-bf0f-250cff275d26) | 拒绝服务     | 中等         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=24c77c27-0b7d-4a35-a871-b453f90e5913)\*                   | 拒绝服务     | 中等         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=48d0432e-704a-4bbb-b0a1-cd14069a8e93)\*         | 拒绝服务     | 中等         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c119223c-f4e0-449b-8e7b-a6bf11c98f94)   | 拒绝服务     | 中等         | 无               |
...
<tr class="header">
<th>受影响的软件</th>
<th>Workstation 服务内存损坏漏洞 - CVE-2009-1544</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Workstation 服务内存损坏漏洞 - CVE-2009-1544  
--------------------------------------------
  
  
Windows Workstation 服务中存在一个特权提升漏洞，原因是该服务中可能出现“双重释放”条件。 成功利用此漏洞的攻击者可以使用提升的特权运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1544](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1544)。
  
#### Workstation 服务内存损坏漏洞 (CVE-2009-1544) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。  
-   攻击者必须拥有对易受攻击的系统的有效登录凭据才能利用此漏洞。 匿名用户无法利用此漏洞。
  
#### Workstation 服务内存损坏漏洞 (CVE-2009-1544) 的变通办法
...
#### Workstation 服务内存损坏漏洞 (CVE-2009-1544) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows Workstation 服务在收到特制 RPC 消息时不能正确地分配和释放内存。
  
**什么是 Workstation 服务？**    
Workstation 服务是一个 Windows 组件，它支持远程文件和网打印资源请求的路由。 本地文件系统请求和远程文件或打印网络请求都通过 Workstation 服务进行路由。 此服务确定资源的位置，然后将请求路由到本地文件系统或网络组件。 如果停止 Workstation 服务，则会将所有请求假定为本地请求。
...
**什么是远程过程调用 (RPC)？**    
Microsoft 远程过程调用 (RPC) 是一种进程间的通信机制 (IPC)，该机制可以实现不同过程中的数据交换和功能创新。 该过程可以在同一台计算机、局域网 (LAN) 或 Internet 上进行。 Microsoft RPC 机制使用其他 IPC 机制（如命名管道、NetBIOS 或 Winsock）在客户端和服务器之间建立通信。 利用 RPC，重要的程序逻辑和相关过程代码可以存在于不同的计算机上，这对分布式应用程序非常重要。 有关详细信息，请参阅 TechNet 文章，什么是 RPC？
  
**我可以禁用 Workstation 服务以阻止此攻击成功吗？**    
禁用 Workstation 服务不是解决此漏洞的推荐方法。 如果禁用 Workstation 服务，则系统无法连接到网络上的任何共享文件资源或共享打印资源。 请只在未连接到网络上的独立系统（如许多家庭系统）上使用此变通办法。 如果禁用 Workstation 服务，则所有明确地依赖于 Workstation 服务的服务将不会启动，并且将错误消息记录到系统事件日志中。 以下服务依赖于 Workstation 服务：
...
访问网络上的资源以及执行域身份验证需要使用这些服务。 如果禁用这些服务，对于独立系统的 Internet 连接和浏览，如使用拨号连接、DSL 连接或电缆调制解调器连接的用户，应该不会受到影响。
  
**注意：** 如果禁用 Workstation 服务，Microsoft Baseline Security Analyzer 将无法运行。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以使用提升的特权运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**攻击者如何利用此漏洞？**    
攻击者可以通过创建特制的 RPC 消息并将其发送到受影响的系统来利用此漏洞。 该消息然后可以允许经过身份验证的客户端将任意数据写入到 Workstation 服务地址空间中的内存。
  
**受此漏洞威胁最大的系统有哪些？**    
启用了 Workstation 服务的所有系统均受到威胁。
  
**此更新有什么作用？**    
此更新通过纠正 Workstation 服务分配和释放内存的方式来解决此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB971657$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/971657">Microsoft 知识库文章 971657</a></td>
</tr>  
<tr class="even">
...
-   [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) 的 Cody Pierce 报告了 Workstation 服务内存损坏漏洞 (CVE-2009-1544)

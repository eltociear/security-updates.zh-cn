...
**已知问题。** [Microsoft 知识库文章 969897](http://support.microsoft.com/kb/969897) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[无](http://go.microsoft.com/fwlink/?linkid=146659)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 969897](http://support.microsoft.com/kb/969897) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2007-3091](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1140](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1140)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1141](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1141)。
...
**DHTML 是什么？**  
动态 HTML (DHTML) 是 Microsoft 在 Internet Explorer 4.0 中最初引入的一组功能，使作者能够在用户与它交互时动态更改网页的呈现和内容。 有关详细信息，请参阅 MSDN 文章 [DHTML 对象](http://msdn.microsoft.com/en-us/library/ms533054(vs.85).aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1528](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1528)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1529)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1530)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1531](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1531)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1532](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1532)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969897">Microsoft 知识库文章 969897</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc.](http://www.google.com/) 的 David Bloom 与我们一起处理了竞争状态跨域信息泄露漏洞 (CVE-2007-3091)  
-   [Core Security Technologies](http://www.coresecurity.com/) 的 Jorge Luis Alvarez Medina 报告了跨域信息泄露漏洞 (CVE-2009-1140)  
-   [Fortinet](http://www.fortinet.com) 的 Haifei Li 报告了 DHTML 对象内存损坏 (CVE-2009-1141)  
-   [Tippingpoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 报告了 HTML 对象内存损坏 (CVE-2009-1528)  
-   Peter Vreugdenhil 与 [Tippingpoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了未初始化的内存损坏漏洞 (CVE-2009-1529)  
-   Wushi 与 [Tippingpoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 (CVE-2009-1530)  
-   Wushi 与 [Tippingpoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 (CVE-2009-1531)  
-   Nils 与 [Tippingpoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 (CVE-2009-1532)

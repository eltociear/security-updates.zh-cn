---
TOCTitle: 'MS09-019'
Title: 'Microsoft 安全公告 MS09-019 - 严重'
ms:assetid: 'ms09-019'
ms:contentKeyID: 61237470
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-019(v=Security.10)'
---
...
对于在 Microsoft Windows 2000 的支持版本上运行的 Internet Explorer 5.01 和 Internet Explorer 6 Service Pack 1，此安全更新的等级为分别“严重”和“重要”；对于在 Windows XP 和 Windows Vista 的支持版本上运行的 Internet Explorer 6、Internet Explorer 7 和 Internet Explorer 8，此安全更新的等级为“严重”；对于在 Windows Server 2003 和 Windows Server 2008 的支持版本上运行的 Internet Explorer 6、Internet Explorer 7 和 Internet Explorer 8，此安全更新的等级为“中等”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过修改 Internet Explorer 处理脚本和缓存内容及初始化内存的方式来解决该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面的常见问题 (FAQ) 小节。
...
**已知问题。** [Microsoft 知识库文章 969897](https://support.microsoft.com/kb/969897) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[MS09-014](https://go.microsoft.com/fwlink/?linkid=146659)
</td>
</tr>
...
<td style="border:1px solid black;">
[无](https://go.microsoft.com/fwlink/?linkid=146659)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Windows Internet Explorer8](https://www.microsoft.com/download/details.aspx?familyid=d9e27ce1-4e7c-437f-9477-e7805a33da08)
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 969897](https://support.microsoft.com/kb/969897) 中找到文件信息详细资料。
...
<th style="border:1px solid black;">
竞争状态跨域信息泄露漏洞 - CVE-2007-3091
</th>
<th style="border:1px solid black;">
跨域信息泄露漏洞 - CVE-2009-1140
</th>
<th style="border:1px solid black;">
DHTML 对象内存损坏 - CVE-2009-1141
</th>
<th style="border:1px solid black;">
HTML 对象内存损坏 - CVE-2009-1528
</th>
<th style="border:1px solid black;">
未初始化的内存损坏漏洞 – CVE-2009-1529
</th>
<th style="border:1px solid black;">
HTML 对象内存损坏漏洞 - CVE-2009-1530
</th>
<th style="border:1px solid black;">
HTML 对象内存损坏漏洞 - CVE-2009-1531
</th>
<th style="border:1px solid black;">
HTML 对象内存损坏漏洞 - CVE-2009-1532
</th>
<th style="border:1px solid black;">
综合严重等级
</th>
...
Internet Explorer 中存在信息泄露漏洞，可能允许脚本在另一个域或 Internet Explorer 区域内访问另一个浏览器窗口中的上下文。 如果用户查看网页，攻击者可通过构建一个允许信息泄露的特制网页来利用漏洞。 成功利用此漏洞的攻击者可以查看另一个 Internet Explorer 域中的网页的数据。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-3091](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091)。

#### 竞争状态跨域信息泄露漏洞 (CVE-2007-3091) 的缓解因素
...
#### 竞争状态跨域信息泄露漏洞 (CVE-2007-3091) 的变通办法
...
#### 竞争状态跨域信息泄露漏洞 (CVE-2007-3091) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个信息泄露漏洞。 用户在查看网页时成功利用此漏洞的攻击者可从攻击者的域或区访问某个域或 Internet Explorer 区域中另一个浏览器窗口中的上下文。

**造成漏洞的原因是什么？**  
脚本可以创建能破坏 Internet Explorer 同源策略的竞争状态，还能从不同的域读取内容。

**攻击者可能利用此漏洞执行什么操作？**  
攻击者可以在攻击者的域或区以外的域或 Internet Explorer 区域内查看另一个浏览器窗口中的上下文。
...
**此更新有什么作用？**  
此更新修改 Internet Explorer 标识执行脚本的域的方式，限制它在其原始域的上下文中执行。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2007-3091](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-3091)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1140](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1140)。

#### 跨域信息泄露漏洞 (CVE-2009-1140) 的缓解因素
...
-   在 Windows Vista 或 Windows Server 2008 上使用 Windows Internet Explorer 7 可减轻该漏洞的影响。

#### 跨域信息泄露漏洞 (CVE-2009-1140) 的变通办法
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1141](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1141)。

#### DHTML 对象内存损坏 (CVE-2009-1141) 的缓解因素
...
-   默认情况下，Microsoft Outlook 和 Microsoft Outlook Express 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。 “受限制的站点”区域可以通过防止在阅读 HTML 电子邮件时使用活动脚本和 ActiveX 控件来缓解尝试利用此漏洞进行的攻击。 然而，在基于 Web 的攻击情形中，如果攻击者单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的受限模式下运行。 此模式将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题”部分。
-   在 Microsoft Windows 2000 上运行的 Microsoft Internet Explorer 5.01 Service Pack 4 和 Microsoft Internet Explorer 6 Service Pack 1、Windows Internet Explorer 7 和 Windows Internet Explorer 8 不受该漏洞影响。

#### DHTML 对象内存损坏 (CVE-2009-1141) 的变通办法
...
#### DHTML 对象内存损坏 (CVE-2009-1141) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成漏洞的原因是什么？**  
当 Internet Explorer 显示包含针对 HTML 对象的异常方法调用的网页时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
**DHTML 是什么？**  
动态 HTML (DHTML) 是 Microsoft 在 Internet Explorer 4.0 中最初引入的一组功能，使作者能够在用户与它交互时动态更改网页的呈现和内容。 有关详细信息，请参阅 MSDN 文章 [DHTML 对象](https://msdn.microsoft.com/en-us/library/ms533054(vs.85).aspx)。
...
**此更新有什么作用？**  
更新修改 Internet Explorer 处理 DHTML 对象的方式。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1528](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1528)。

#### HTML 对象内存损坏 (CVE-2009-1528) 的缓解因素
...
-   默认情况下，Microsoft Outlook 和 Microsoft Outlook Express 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。 “受限制的站点”区域可以通过防止在阅读 HTML 电子邮件时使用活动脚本和 ActiveX 控件来缓解尝试利用此漏洞进行的攻击。 然而，在基于 Web 的攻击情形中，如果攻击者单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的受限模式下运行。 此模式将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题”部分。
-   在 Microsoft Windows 2000 上运行的 Microsoft Internet Explorer 5.01 Service Pack 4 和 Microsoft Internet Explorer 6.0 Service Pack 1、Windows Internet Explorer 7 和 Windows Internet Explorer 8 不受该漏洞影响。

#### HTML 对象内存损坏 (CVE-2009-1528) 的变通办法
...
#### HTML 对象内存损坏 (CVE-2009-1528) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1529](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1529)。

#### 未初始化的内存损坏漏洞 (CVE-2009-1529) 的缓解因素
...
-   默认情况下，Microsoft Outlook 和 Microsoft Outlook Express 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。 “受限制的站点”区域可以通过防止在阅读 HTML 电子邮件时使用活动脚本和 ActiveX 控件来缓解尝试利用此漏洞进行的攻击。 然而，在基于 Web 的攻击情形中，如果攻击者单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的受限模式下运行。 此模式将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题”部分。
-   在 Microsoft Windows 2000 上运行的 Microsoft Internet Explorer 5.01 Service Pack 4 和 Microsoft Internet Explorer 6.0 Service Pack 1、Microsoft Internet Explorer 6.0 和 Windows Internet Explorer 8 不受该漏洞影响。

#### 未初始化的内存损坏漏洞 (CVE-2009-1529) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2009-1529) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1530](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1530)。

#### HTML 对象内存损坏漏洞 (CVE-2008-1530) 的缓解因素
...
-   默认情况下，Microsoft Outlook 和 Microsoft Outlook Express 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。 “受限制的站点”区域可以通过防止在阅读 HTML 电子邮件时使用活动脚本和 ActiveX 控件来缓解尝试利用此漏洞进行的攻击。 然而，在基于 Web 的攻击情形中，如果攻击者单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的受限模式下运行。 此模式将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题”部分。
-   Microsoft Internet Explorer 5.01 Service Pack 4、Microsoft Internet Explorer 6.0、Microsoft Internet Explorer 6.0 Service Pack 1 和 Windows Internet Explorer 8 不受此漏洞影响。

#### HTML 对象内存损坏漏洞 (CVE-2008-1530) 的变通办法
...
#### HTML 对象内存损坏漏洞 (CVE-2008-1530) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1531](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1531)。

#### HTML 对象内存损坏漏洞 (CVE-2008-1531) 的缓解因素
...
#### HTML 对象内存损坏漏洞 (CVE-2008-1531) 的变通办法
...
#### HTML 对象内存损坏漏洞 (CVE-2008-1531) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1532](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1532)。
...
-   默认情况下，Microsoft Outlook 和 Microsoft Outlook Express 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。 “受限制的站点”区域可以通过防止在阅读 HTML 电子邮件时使用活动脚本和 ActiveX 控件来缓解尝试利用此漏洞进行的攻击。 然而，在基于 Web 的攻击情形中，如果攻击者单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的受限模式下运行。 此模式将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题”部分。
-   Microsoft Internet Explorer 5.01 Service Pack 4、Microsoft Internet Explorer 6.0、Microsoft Internet Explorer 6.0 Service Pack 1 和 Windows Internet Explorer 7 不受此漏洞影响。

#### HTML 对象内存损坏漏洞 (CVE-2008-1532) 的变通办法
...
#### HTML 对象内存损坏漏洞 (CVE-2008-1532) 的常见问题
...
<td style="border:1px solid black;">对于所有受支持的 Windows 2000 版本上的 Internet Explorer 5.01 Service Pack 4：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB969897-IE501SP4- 20090522.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序<br />  
<br />  
对于所有受支持的 Windows 2000 版本上的 Internet Explorer 6 Service Pack 1：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB969897-IE6SP1-20090501.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/969897">Microsoft 知识库文章 969897</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB969897$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie7updates\KB969897-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie8updates\KB969897-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/969897">Microsoft 知识库文章 969897</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本和基于 x64 版本的 Windows Server 2003 上的 Internet Explorer 8：
...
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB969897$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
-   [Google Inc.](https://www.google.com/) 的 David Bloom 与我们一起处理了竞争状态跨域信息泄露漏洞 (CVE-2007-3091)  
-   [Core Security Technologies](https://www.coresecurity.com/) 的 Jorge Luis Alvarez Medina 报告了跨域信息泄露漏洞 (CVE-2009-1140)  
-   [Fortinet](https://www.fortinet.com) 的 Haifei Li 报告了 DHTML 对象内存损坏 (CVE-2009-1141)  
-   [Tippingpoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了 HTML 对象内存损坏 (CVE-2009-1528)  
-   Peter Vreugdenhil 与 [Tippingpoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 一起报告了未初始化的内存损坏漏洞 (CVE-2009-1529)  
-   Wushi 与 [Tippingpoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 (CVE-2009-1530)  
-   Wushi 与 [Tippingpoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 (CVE-2009-1531)  
-   Nils 与 [Tippingpoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 (CVE-2009-1532)

...
<td style="border:1px solid black;">
[MS09-009](https://go.microsoft.com/fwlink/?linkid=143568)
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=2bcd565a-6acb-407d-80da-0398526ddf99)\*  
(KB969682)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2bcd565a-6acb-407d-80da-0398526ddf99)\*  
(KB969682)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 1 的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
不适用
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 2 的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2)  
(KB969679)
</td>
<td style="border:1px solid black;">
不适用
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
不适用
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=862e6ad1-8124-4060-93b1-2b882ef5ce3d)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
不适用
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
不适用
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=b7b6e611-2c5d-4639-add9-972055789ecd)\*\*  
(KB969737)
</td>
<td style="border:1px solid black;">
不适用
...
\*对于 Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2，除了安全更新程序包 KB969682 之外，客户还需要安装[用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 1 和用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a8be8457-b0b6-455e-907e-d13be883adf2) 的安全更新 (KB969679)，以免受本公告中所描述的漏洞影响。
...
本公告中的 Microsoft Office 2004 for Mac (KB969661)、Microsoft Office 2008 for Mac (KB971822) 和 Open XML File Format Converter for Mac (KB971824) 安全更新包还解决了 [MS09-017](https://go.microsoft.com/fwlink/?linkid=141704) 和 [MS09-027](https://go.microsoft.com/fwlink/?linkid=147416) 中描述的漏洞。安装了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 或 Open XML File Format Converter for Mac 的用户只需安装此安全更新一次。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0549)。

#### 记录指针损坏漏洞 (CVE-2009-0549) 的缓解因素
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0557](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0557)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0558](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0558)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0559](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0559)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0560](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0560)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0561](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0561)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1134](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1134)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/969683">Microsoft 知识库文章 969683。</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/969680">Microsoft 知识库文章 969680</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2003：<br />
请参阅 <a href="https://support.microsoft.com/kb/969681">Microsoft 知识库文章 969681</a><br />  
<br />  
对于 Excel Viewer 2003：<br />
请参阅 <a href="https://support.microsoft.com/kb/969685">Microsoft 知识库文章 969685</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2007：<br />
请参阅 <a href="https://support.microsoft.com/kb/969682">Microsoft 知识库文章 969682</a><br />  
<br />  
对于 Excel Viewer：<br />  
请参阅 <a href="https://support.microsoft.com/kb/969682=6">Microsoft 知识库文章 969686</a><br />  
<br />  
对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包：<br />  
请参阅 <a href="https://support.microsoft.com/kb/969679">Microsoft 知识库文章 969679</a><br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=5557bfb7-ebb4-4c42-8042-41e830c4e550)下载和安装 Microsoft Office 2004 for Mac 11.5.5 Update 合适的语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Microsoft Office 2004 for Mac 11.5.5 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Microsoft Office 2004 for Mac 11.5.5 Update 卷窗口中双击 Microsoft Office 2004 for Mac 11.5.5 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2004 for Mac 11.5.5 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=58326da2-eb75-4b42-b1bc-e70319defb58)下载和安装 Microsoft Office 2008 for Mac 12.1.9 Update 合适的语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Microsoft Office 2008 for Mac 12.1.9 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Microsoft Office 2008 for Mac 12.1.9 Update 卷窗口中双击 Microsoft Office 2008 for Mac 12.1.9 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2008 for Mac 12.1.9 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=9d6d9eaa-8442-4184-8886-faab2803bde6)下载和安装 Open XML File Converter for Mac 1.0.3 Update 合适的语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Open XML File Converter for Mac 1.0.3 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Open XML File Converter for Mac 1.0.3 Update 卷窗口中双击 Open XML File Converter for Mac 1.0.3 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Open XML File Converter for Mac 1.0.3 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
  
**验证更新安装**
  
要验证受影响的系统上是否安装了安全更新，请执行下列步骤：
  
1.  在查找程序中，浏览到应用程序文件夹 (Open XML File Converter for Mac : Office)。  
2.  选择文件 Microsoft Component Plugin。  
3.  在“**文件**”菜单上，单击“**获取信息**”或“显示信息”。
  
如果版本号为 1.0.3，则说明此更新已成功安装。
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/969737">Microsoft 知识库文章 969737</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   Fortinet [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) 的 Bing Liu 报告了指针损坏漏洞 (CVE-2009-0549)  
-   Fortinet [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) 的 Bing Liu 报告了对象记录损坏漏洞 (CVE-2009-0557)  
-   [Secunia](https://secunia.com/) 的 Carsten H. Eiram 报告了阵列索引内存损坏漏洞 (CVE-2009-0558)  
-   [TELUS Security Labs Vulnerability Research Team](https://telussecuritylabs.com/) 报告了基于堆栈的字符串复制溢出漏洞 (CVE-2009-0559)  
-   Fortinet [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) 的 Bing Liu 报告了字段清理损坏漏洞 (CVE-2009-0560)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 和 Joshua Drake 报告了记录整数溢出漏洞 (CVE-2009-0561)  
-   [Secunia](https://secunia.com/) 的 Carsten H. Eiram 报告了记录整数溢出漏洞 (CVE-2009-0561)  
-   [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了记录指针损坏漏洞 (CVE-2009-1134)

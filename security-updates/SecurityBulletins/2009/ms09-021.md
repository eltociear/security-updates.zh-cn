...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969683">Microsoft 知识库文章 969683。</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969680">Microsoft 知识库文章 969680</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2003：<br />
请参阅 <a href="http://support.microsoft.com/kb/969681">Microsoft 知识库文章 969681</a><br />  
<br />  
对于 Excel Viewer 2003：<br />
请参阅 <a href="http://support.microsoft.com/kb/969685">Microsoft 知识库文章 969685</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2007：<br />
请参阅 <a href="http://support.microsoft.com/kb/969682">Microsoft 知识库文章 969682</a><br />  
<br />  
对于 Excel Viewer：<br />  
请参阅 <a href="http://support.microsoft.com/kb/969682=6">Microsoft 知识库文章 969686</a><br />  
<br />  
对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包：<br />  
请参阅 <a href="http://support.microsoft.com/kb/969679">Microsoft 知识库文章 969679</a><br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969737">Microsoft 知识库文章 969737</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   Fortinet [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) 的 Bing Liu 报告了指针损坏漏洞 (CVE-2009-0549)  
-   Fortinet [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) 的 Bing Liu 报告了对象记录损坏漏洞 (CVE-2009-0557)  
-   [Secunia](http://secunia.com/) 的 Carsten H. Eiram 报告了阵列索引内存损坏漏洞 (CVE-2009-0558)  
-   [TELUS Security Labs Vulnerability Research Team](http://telussecuritylabs.com/) 报告了基于堆栈的字符串复制溢出漏洞 (CVE-2009-0559)  
-   Fortinet [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) 的 Bing Liu 报告了字段清理损坏漏洞 (CVE-2009-0560)  
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Sean Larsson 和 Joshua Drake 报告了记录整数溢出漏洞 (CVE-2009-0561)  
-   [Secunia](http://secunia.com/) 的 Carsten H. Eiram 报告了记录整数溢出漏洞 (CVE-2009-0561)  
-   [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 报告了记录指针损坏漏洞 (CVE-2009-1134)

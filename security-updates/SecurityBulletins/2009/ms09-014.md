...
**已知问题。**[Microsoft 知识库文章 963027](http://support.microsoft.com/kb/963027) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 963027](http://support.microsoft.com/kb/963027) 中找到文件信息详细资料。

**此安全更新与 MS09-013 有什么联系？**  
此安全公告中描述的 WinINet 凭据反射漏洞 [CVE-2009-0550](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550) 也影响 Windows HTTP 服务。 Microsoft 建议用户也安装 [MS09-013](http://go.microsoft.com/fwlink/?linkid=139852) Windows HTTP 服务中的漏洞可能允许远程执行代码 (960803) 提供的安全更新。

**此更新是否包含任何与安全性相关的功能更改？**  
是。 除了本公告“**漏洞信息**”部分列出的更改外，该更新还包含以下更改：

-   对 [MS09-010](http://go.microsoft.com/fwlink/?linkid=139849)（写字板和 Office 文本转换器中的漏洞可能允许远程执行代码 (960477)）内修补程序的更改
-   可加强**以下**内容的更改： 以限制欺骗为目的的协议
-   还包括对 [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803)（SearchPath 中的混合威胁漏洞可能允许特权升级 (959426)）内修改程序的更改。 此更新还提供关于众所周知的 Apple Safari、Microsoft Windows 和 Microsoft Internet Explorer 的混合威胁问题的缓解措施，且已为此漏洞分配常见漏洞和披露号码 [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)。请参阅以下关于混合威胁的常见问题**。**

**此更新能解决在 Microsoft 知识库文章 967941 中介绍的 MS09-002 的已知问题吗?**  
可以，此更新能解决在 [Microsoft 知识库文章 967941](http://support.microsoft.com/kb/967941) 中介绍的 [MS09-002](http://go.microsoft.com/fwlink/?linkid=139814) 的已知问题，“当您浏览到位于不同 Internet Explorer 安全区域内的网页时取消了导航。”

**如果我已经对在 Microsoft 知识库文章 967941 中介绍的问题执行了注册表变通办法，我还需要采取什么措施？**  
如果您已按照 [Microsoft 知识库文章 967941](http://support.microsoft.com/kb/967941) 中对手动编辑或运行向导编辑注册表来启用 feature control 注册表项（此注册表项禁用了在[MS09-002](http://go.microsoft.com/fwlink/?linkid=139814)中介绍的功能）的说明执行了操作，那么您现在必须逆转此 feature control 注册表项。 有关说明，请参阅[Microsoft 知识库文章 967941](http://support.microsoft.com/kb/967941)。

**如果我只应用此更新，我是否会完全不受 CVE-2008-2540 中描述的混合威胁问题的影响？**  
不，在应用 [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803)（SearchPath 中的混合威胁漏洞可能允许特权升级 (959426)）以外，您必须单独启用由此累积性安全更新提供的关于 Internet Explorer 的纵深防御保护。 但是，您必须验证对混合威胁问题启用此纵深防御保护是否适用于您的环境。
...
有关混合威胁问题的详细信息，请参阅 [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803)（SearchPath 中的混合威胁漏洞可能允许特权升级 (959426)）和常见漏洞和披露号码 [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)。

**是否能够在 Microsoft Windows 2000 上启用混合威胁漏洞的 Internet Explorer 纵深防御保护？**  
否。 由于体系结构的不同，在 [MS09-015](http://go.microsoft.com/fwlink/?linkid=146803)（SearchPath 中的混合威胁漏洞可能允许特权升级 (959426)）中介绍的纵深防御保护不适用于 Microsoft Windows 2000 平台。 在 Microsoft Windows 2000 上启用 Internet Explorer 的纵深防御保护将毫无影响。 但是，Microsoft 没有收到关于以 Microsoft Windows 2000 上的此漏洞为目标的任何有效攻击媒介的报告。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2008-2540](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)。此漏洞最初是在 [Microsoft 安全通报 953818](http://technet.microsoft.com/security/advisory/953818) 中介绍的。
...
CVE-2009-0550 对 Internet Explorer 使用的 WinINet 以及 Windows 操作系统的组件 Windows HTTP Services 都有影响。 Microsoft 建议用户也安装 [MS09-013](http://go.microsoft.com/fwlink/?linkid=139852) Windows HTTP 服务中的漏洞可能允许远程执行代码 (960803) 提供的安全更新。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0551)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0552](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0552)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0553)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0554](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0554)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/963027">Microsoft 知识库文章 963027</a></td>
</tr>  
<tr class="even">
...
-   [Aviv Raff](http://aviv.raffon.net) 报告了混合威胁远程执行代码漏洞 (CVE-2008-2540)  
-   [Google Inc.](http://www.google.com/) 的 Michal Zalewski 报告了页面过渡内存损坏漏洞 (CVE-2009-0551)  
-   [iSIGHT Partners Labs](http://www.isightpartners.com) 的 Ivan Fratric 报告了未初始化的内存损坏漏洞 (CVE-2009-0552)  
-   [Google Inc.](http://www.google.com/) 的 Skylined 报告了未初始化的内存损坏漏洞 (CVE-2009-0553)  
-   [VenusTech](http://www.venustech.com.cn/) 的 ADLab 报告了未初始化的内存损坏漏洞 (CVE-2009-0554)

---
TOCTitle: 'MS09-014'
Title: 'Microsoft 安全公告 MS09-014 - 严重'
ms:assetid: 'ms09-014'
ms:contentKeyID: 61237465
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-014(v=Security.10)'
---
...
此安全更新通过修改 Internet Explorer 在系统中搜索加载文件的方式、执行身份验证回复验证、处理在网页间导航时出现的过渡错误和内存对象来解决这些漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面的常见问题 (FAQ) 小节。

此安全更新也解决了 [Microsoft 安全通报 953818](https://technet.microsoft.com/security/advisory/953818) 中最初描述的漏洞。
...
**已知问题。**[Microsoft 知识库文章 963027](https://support.microsoft.com/kb/963027) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[MS09-002](https://go.microsoft.com/fwlink/?linkid=139814)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
| 操作系统                                                                                                  | 组件                        |
|-----------------------------------------------------------------------------------------------------------|-----------------------------|
| Windows XP Service Pack 2 和 Windows XP Service Pack 3                                                    | Windows Internet Explorer 8 |
| Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2                 | Windows Internet Explorer 8 |
| Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2                                  | Windows Internet Explorer 8 |
| Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2                         | Windows Internet Explorer 8 |
| Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统） | Windows Internet Explorer 8 |
...
| Windows Server 2008（用于 32 位系统）                                                                     | Windows Internet Explorer 8 |
| Windows Server 2008（用于基于 x64 的系统）                                                                | Windows Internet Explorer 8 |
| Windows Server 2008（用于基于 Itanium 的系统）                                                            | Windows Internet Explorer 8 |

与此安全更新相关的常见问题 (FAQ)
--------------------------------

**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 963027](https://support.microsoft.com/kb/963027) 中找到文件信息详细资料。

**此安全更新与 MS09-013 有什么联系？**  
此安全公告中描述的 WinINet 凭据反射漏洞 [CVE-2009-0550](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550) 也影响 Windows HTTP 服务。 Microsoft 建议用户也安装 [MS09-013](https://go.microsoft.com/fwlink/?linkid=139852) Windows HTTP 服务中的漏洞可能允许远程执行代码 (960803) 提供的安全更新。

**此更新是否包含任何与安全性相关的功能更改？**  
是。 除了本公告“**漏洞信息**”部分列出的更改外，该更新还包含以下更改：

-   对 [MS09-010](https://go.microsoft.com/fwlink/?linkid=139849)（写字板和 Office 文本转换器中的漏洞可能允许远程执行代码 (960477)）内修补程序的更改
-   可加强**以下**内容的更改： 以限制欺骗为目的的协议
-   还包括对 [MS09-015](https://go.microsoft.com/fwlink/?linkid=146803)（SearchPath 中的混合威胁漏洞可能允许特权升级 (959426)）内修改程序的更改。 此更新还提供关于众所周知的 Apple Safari、Microsoft Windows 和 Microsoft Internet Explorer 的混合威胁问题的缓解措施，且已为此漏洞分配常见漏洞和披露号码 [CVE-2008-2540](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)。请参阅以下关于混合威胁的常见问题**。**

**此更新能解决在 Microsoft 知识库文章 967941 中介绍的 MS09-002 的已知问题吗?**  
可以，此更新能解决在 [Microsoft 知识库文章 967941](https://support.microsoft.com/kb/967941) 中介绍的 [MS09-002](https://go.microsoft.com/fwlink/?linkid=139814) 的已知问题，“当您浏览到位于不同 Internet Explorer 安全区域内的网页时取消了导航。”

**如果我已经对在 Microsoft 知识库文章 967941 中介绍的问题执行了注册表变通办法，我还需要采取什么措施？**  
如果您已按照 [Microsoft 知识库文章 967941](https://support.microsoft.com/kb/967941) 中对手动编辑或运行向导编辑注册表来启用 feature control 注册表项（此注册表项禁用了在[MS09-002](https://go.microsoft.com/fwlink/?linkid=139814)中介绍的功能）的说明执行了操作，那么您现在必须逆转此 feature control 注册表项。 有关说明，请参阅[Microsoft 知识库文章 967941](https://support.microsoft.com/kb/967941)。

**如果我只应用此更新，我是否会完全不受 CVE-2008-2540 中描述的混合威胁问题的影响？**  
不，在应用 [MS09-015](https://go.microsoft.com/fwlink/?linkid=146803)（SearchPath 中的混合威胁漏洞可能允许特权升级 (959426)）以外，您必须单独启用由此累积性安全更新提供的关于 Internet Explorer 的纵深防御保护。 但是，您必须验证对混合威胁问题启用此纵深防御保护是否适用于您的环境。

要启用纵深防御保护，请执行以下步骤：

1.  将以下内容保存到具有 .REG 扩展名的文件（如 Enable\_SearchPath.reg）以添加 feature control 注册表项：
...
2.  然后从提升命令提示符处使用下列命令运行 Enable\_SearchPath.reg：
    Regedit.exe /s Enable\_SearchPath.reg

有关混合威胁问题的详细信息，请参阅 [MS09-015](https://go.microsoft.com/fwlink/?linkid=146803)（SearchPath 中的混合威胁漏洞可能允许特权升级 (959426)）和常见漏洞和披露号码 [CVE-2008-2540](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)。

**是否能够在 Microsoft Windows 2000 上启用混合威胁漏洞的 Internet Explorer 纵深防御保护？**  
否。 由于体系结构的不同，在 [MS09-015](https://go.microsoft.com/fwlink/?linkid=146803)（SearchPath 中的混合威胁漏洞可能允许特权升级 (959426)）中介绍的纵深防御保护不适用于 Microsoft Windows 2000 平台。 在 Microsoft Windows 2000 上启用 Internet Explorer 的纵深防御保护将毫无影响。 但是，Microsoft 没有收到关于以 Microsoft Windows 2000 上的此漏洞为目标的任何有效攻击媒介的报告。
...
<th style="border:1px solid black;">
混合威胁远程执行代码漏洞 - CVE-2008-2540
</th>
<th style="border:1px solid black;">
WinINet 凭据反射漏洞 - CVE-2009-0550
</th>
<th style="border:1px solid black;">
页面过渡内存损坏漏洞 - CVE-2009-0551
</th>
<th style="border:1px solid black;">
未初始化的内存损坏漏洞 – CVE-2009-0552
</th>
<th style="border:1px solid black;">
未初始化的内存损坏漏洞 – CVE-2009-0553
</th>
<th style="border:1px solid black;">
未初始化的内存损坏漏洞 – CVE-2009-0554
</th>
<th style="border:1px solid black;">
综合严重等级
</th>
...
在 Internet Explorer 在系统上查找和打开文件的方式中存在一个混合威胁远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2540](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)。

#### 混合威胁远程执行代码漏洞 (CVE-2008-2540) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   Windows Internet Explorer 8 不受此漏洞的影响。

#### 混合威胁远程执行代码漏洞 (CVE-2008-2540) 的变通方法

Microsoft 并未发现此漏洞的任何变通办法。

#### 混合威胁远程执行代码漏洞 (CVE-2008-2540) 的常见问题
...
**攻击者如何利用此漏洞？**  
攻击者可通过创建一个供用户使用 Apple Safari 下载到桌面的特制文件来利用此漏洞。 然后，攻击者可能拥有一个旨在通过 Internet Explorer 利用此漏洞的特制网站，并诱使用户查看该网站。 攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。 这些网站可能包含可以利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。 它还可能使用横幅广告或其他方式显示特制的 Web 内容，以便将 Web 内容传递至受影响的系统。

**受此漏洞威胁最大的系统有哪些？**  
用户用于下载文件和启动应用程序的所有系统（例如工作站和服务器）都将受此漏洞的威胁。

**此更新有什么作用？**  
此更新修改了 Internet Explorer 从桌面加载文件的方式。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2008-2540](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2540)。此漏洞最初是在 [Microsoft 安全通报 953818](https://technet.microsoft.com/security/advisory/953818) 中介绍的。
...
当用户通过 HTTP 协议连接到攻击者的服务器时，在 WinINet 处理 NTLM 凭据的方式中存在一个远程执行代码漏洞。 此漏洞允许攻击者重放用户凭据，并在登录用户的上下文中执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0550](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0550)。

#### WinINet 凭据反射漏洞 (CVE-2009-0550) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
-   最可能的利用此漏洞的攻击媒介是 SMB。 默认情况下，Windows Vista 防火墙阻止了 SMB 通信。 易受攻击的客户端需要运行接受 NTLM 身份验证的服务才能使攻击取得成功以及反映凭据。 默认情况下，如果 Vista 系统未部署到 Windows 域环境中，Windows Vista 防火墙的配置文件为“公用”，从而阻止 SMB 通信。
-   Internet Explorer 不自动向 Internet 区域提供凭据。 用户需要通过浏览器来提供凭据。
-   Windows Internet Explorer 8 不受此漏洞的影响。

#### WinINet 凭据反射漏洞 (CVE-2009-0550) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### WinINet 凭据反射漏洞 (CVE-2009-0550) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成漏洞的原因是什么？**  
WinINet 协议未正确地选择加入 NTLM 凭据反射保护，此保护可确保用户凭据不被反射回来并被用于用户。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**攻击者如何利用此漏洞？**  
此漏洞需要具有受影响的 WinINet 实施的用户访问特制的服务器。
...
**什么是 WinINet？**  
WinINet 指 Windows Internet 应用程序编程接口 (API)，可使应用程序与标准协议（例如 FTP 和 HTTP）交互以访问 Internet 资源。 随着标准的演变，WinINet 处理基础协议中的更改，使应用程序能够保持一致行为。

**受此漏洞威胁最大的系统有哪些？**  
此漏洞需要用户登录、访问网站并分享文件和打印机以允许 SMB 通信，才能发生恶意操作。 因此，任何在域环境中频繁使用 Internet Explorer 的系统（如工作站或终端服务器）受此漏洞的威胁最大。

**此更新有什么作用？**  
此更新修改了 WinINet 执行身份验证回复验证的方式，以防止凭据重播。

**为什么此漏洞和 Windows HTTP 服务凭据反射漏洞在 MS09-013 Windows HTTP 服务中的漏洞可能允许远程执行代码 (960803) 中分配了相同的 CVE 编号 (CVE-2009-0550)？**  
CVE-2009-0550 对 Internet Explorer 使用的 WinINet 以及 Windows 操作系统的组件 Windows HTTP Services 都有影响。 Microsoft 建议用户也安装 [MS09-013](https://go.microsoft.com/fwlink/?linkid=139852) Windows HTTP 服务中的漏洞可能允许远程执行代码 (960803) 提供的安全更新。
...
在 Internet Explorer 处理在网页间导航时的过渡的方式中存在一个远程指向代码漏洞。 因此，如果用户访问了特制网站，系统内存就可能以一种攻击者可以执行任意代码的方式受到破坏。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0551](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0551)。

#### 网页过渡内存损坏漏洞 (CVE-2009-0551) 的缓解因素
...
#### 网页过渡内存损坏漏洞 (CVE-2009-0551) 的变通办法
...
#### 网页过渡内存损坏漏洞 (CVE-2009-0551) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成漏洞的原因是什么？**  
当 Internet Explorer 在网页之间导航时处理过渡时，攻击者可以在登录用户的上下文中执行任意代码，从而破坏内存。
...
**此更新有什么作用？**  
更新修改 Internet Explorer 在网页之间导航时处理过渡错误的方式。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0552](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0552)。

#### 未初始化的内存损坏漏洞 (CVE-2009-0552) 的缓解因素
...
-   默认情况下，Microsoft Outlook 和 Microsoft Outlook Express 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。 “受限制的站点”区域可以通过防止在阅读 HTML 电子邮件时使用活动脚本和 ActiveX 控件来缓解尝试利用此漏洞进行的攻击。 然而，在基于 Web 的攻击情形中，如果攻击者单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的受限模式下运行。 此模式将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题”部分。
-   Windows Internet Explorer 7 和 Windows Internet Explorer 8 不受此漏洞影响。

#### 未初始化的内存损坏漏洞 (CVE-2009-0552) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2009-0552) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成漏洞的原因是什么？**  
当 Internet Explorer 尝试访问未初始化或已删除的对象时，攻击者可以在登录用户的上下文中执行任意代码，从而破坏内存。
...
**此更新有什么作用？**  
更新修改 Internet Explorer 处理内存对象的方式。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0553](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0553)。

#### 未初始化的内存损坏漏洞 (CVE-2009-0553) 的缓解因素
...
-   默认情况下，Microsoft Outlook 和 Microsoft Outlook Express 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。 “受限制的站点”区域可以通过防止在阅读 HTML 电子邮件时使用活动脚本和 ActiveX 控件来缓解尝试利用此漏洞进行的攻击。 然而，在基于 Web 的攻击情形中，如果攻击者单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的受限模式下运行。 此模式将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题”部分。
-   Microsoft Internet Explorer 5.01 Service Pack 4 和 Windows Internet Explorer 8 不受此漏洞影响。

#### 未初始化的内存损坏漏洞 (CVE-2009-0553) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2009-0553) 的常见问题
...
Internet Explorer 访问尚未初始化或已被删除的对象的方式中存在一个远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0554](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0554)。

#### 未初始化的内存损坏漏洞 (CVE-2009-0554) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2009-0554) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2009-0554) 的常见问题
...
<td style="border:1px solid black;">对于所有受支持的 Windows 2000 版本上的 Internet Explorer 5.01 Service Pack 4：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或者 %Windir%\\$NTUninstallKB963027-IE501SP4-20090303.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序<br />  
<br />  
对于所有受支持的 Windows 2000 版本上的 Internet Explorer 6 Service Pack 1：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或者 %Windir%\\$NTUninstallKB963027-IE6SP1-20090303.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/963027">Microsoft 知识库文章 963027</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB963027$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或者 %Windir%\ie7updates\KB963027-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/963027">Microsoft 知识库文章 963027</a></td>
...
使用控制面板中的“<strong>添加或删除程序</strong>”工具或者 %Windir%\\$NTUninstallKB963027$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
-   [Aviv Raff](https://aviv.raffon.net) 报告了混合威胁远程执行代码漏洞 (CVE-2008-2540)  
-   [Google Inc.](https://www.google.com/) 的 Michal Zalewski 报告了页面过渡内存损坏漏洞 (CVE-2009-0551)  
-   [iSIGHT Partners Labs](https://www.isightpartners.com) 的 Ivan Fratric 报告了未初始化的内存损坏漏洞 (CVE-2009-0552)  
-   [Google Inc.](https://www.google.com/) 的 Skylined 报告了未初始化的内存损坏漏洞 (CVE-2009-0553)  
-   [VenusTech](https://www.venustech.com.cn/) 的 ADLab 报告了未初始化的内存损坏漏洞 (CVE-2009-0554)

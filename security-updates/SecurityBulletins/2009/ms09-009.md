---
TOCTitle: 'MS09-009'
Title: 'Microsoft 安全公告 MS09-009 - 严重'
ms:assetid: 'ms09-009'
ms:contentKeyID: 61237460
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-009(v=Security.10)'
---
...
此安全更新也解决了 [Microsoft 安全通报 968272](https://technet.microsoft.com/security/advisory/968272) 中最初描述的漏洞。
...
<tr>
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 1 的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?familyid=05f7c517-e551-4dcd-b24a-5d548f2d09cf)  
(KB960003)
</td>
<td style="border:1px solid black;">
不适用
...
\*对于 Microsoft Office Excel 2007 Service Pack 1，除了安全更新程序包 KB959997 之外，客户还需要安装[用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?familyid=05f7c517-e551-4dcd-b24a-5d548f2d09cf) Service Pack 1 的安全更新 (KB960003)，以免受本公告中所描述的漏洞影响。
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 968557](https://support.microsoft.com/kb/968557) 中找到文件信息详细资料。
...
**为什么此更新对于 Excel 2000 为“严重”，而对于所有其他受影响的 Excel 版本只为“重要”？**  
...
<th style="border:1px solid black;">
内存损坏漏洞 – CVE-2009-0100
</th>
<th style="border:1px solid black;">
内存损坏漏洞 - CVE-2009-0238
</th>
<th style="border:1px solid black;">
综合严重等级
</th>
...
Microsoft Office Excel 中存在一个远程执行代码漏洞，如果用户打开一个含有格式错误的对象的特制 Excel 文件，就可能允许远程代码执行。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0100](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0100)。

#### 内存损坏漏洞 (CVE-2009-0100) 的缓解因素
...
**攻击者如何利用此漏洞？**  
此漏洞需要用户使用受影响版本的 Microsoft Office Excel 打开特制的 Excel 电子表格。
...
**此更新有什么作用？**  
此更新通过更改 Microsoft Office Excel 打开特制的 Excel 文件的方式来消除漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0238)。

#### 内存损坏漏洞 (CVE-2009-0238) 的缓解因素
...
#### 内存损坏漏洞 (CVE-2009-0238) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成漏洞的原因是什么？**  
Microsoft Office Excel 中存在一个漏洞，打开特制的 Excel 电子表格时允许远程执行代码。 Microsoft Office Excel 分析 Excel 电子表格文件格式的方式中存在漏洞。
...
**此更新有什么作用？**  
此更新通过更改 Microsoft Excel 打开特制的 Excel 文件的方式来消除漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2009-0238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0238)。此漏洞最初是在 [Microsoft 安全通报 968272](https://technet.microsoft.com/security/advisory/968272) 中介绍的。
...
| Excel Viewer                                                                           | 是       |
| Office 2004 for Mac                                                                    | 否       |
| Office 2008 for Mac                                                                    | 否       |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/968557">Microsoft 知识库文章 968557</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具。
<p><strong>注意</strong> 当删除此更新时，系统可能提示您在光驱中插入 Microsoft Office 2003 光盘。 另外，您可能没有从控制面板“<strong>添加/删除程序</strong>”工具中卸载更新的选项。 此问题有诸多可能的原因。 有关删除的详细信息，请参阅 <a href="https://support.microsoft.com/kb/903771">Microsoft 知识库文章 903771</a>。</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/968557">Microsoft 知识库文章 968557</a></td>
...
<br />  
对于用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 1 的 Microsoft Office 兼容包：<br />  
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=52271140-89be-4b9c-baa2-cea09097d703)下载和安装 Microsoft Microsoft Office 2004 for Mac 11.5.4 更新合适的语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Microsoft Office 2004 for Mac 11.5.4 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Microsoft Office 2004 for Mac 11.5.4 Update 卷窗口中双击 Microsoft Office 2004 for Mac 11.5.4 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2004 for Mac 11.5.4 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=f6e407eb-11a5-433f-8006-4b822953ca98)下载和安装 Microsoft Microsoft Office 2008 for Mac 12.1.7 更新合适的语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Microsoft Office 2008 for Mac 12.1.7 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Microsoft Office 2008 for Mac 12.1.7 Update 卷窗口中双击 Microsoft Office 2008 for Mac 12.1.7 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2008 for Mac 12.1.7 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
-   Fortinet [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) 的 Haifei Li 报告了内存损坏漏洞 (CVE-2009-0100)

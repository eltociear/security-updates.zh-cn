...
此安全更新也解决了 [Microsoft 安全通报 968272](http://technet.microsoft.com/security/advisory/968272) 中最初描述的漏洞。
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 968557](http://support.microsoft.com/kb/968557) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0100](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0100)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0238](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0238)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2009-0238](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0238)。此漏洞最初是在 [Microsoft 安全通报 968272](http://technet.microsoft.com/security/advisory/968272) 中介绍的。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/968557">Microsoft 知识库文章 968557</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具。
<p><strong>注意</strong> 当删除此更新时，系统可能提示您在光驱中插入 Microsoft Office 2003 光盘。 另外，您可能没有从控制面板“<strong>添加/删除程序</strong>”工具中卸载更新的选项。 此问题有诸多可能的原因。 有关删除的详细信息，请参阅 <a href="http://support.microsoft.com/kb/903771">Microsoft 知识库文章 903771</a>。</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/968557">Microsoft 知识库文章 968557</a></td>
...
-   Fortinet [FortiGuard Global Security Research Team](http://www.fortiguardcenter.com/) 的 Haifei Li 报告了内存损坏漏洞 (CVE-2009-0100)

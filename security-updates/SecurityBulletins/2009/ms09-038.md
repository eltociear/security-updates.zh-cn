...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1545](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1545)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1546](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1546)。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 971557](http://support.microsoft.com/kb/971557)                                          |  
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/971557">Microsoft 知识库文章 971557</a></td>
</tr>  
<tr class="even">
...
-   [Adobe Systems, Inc.](http://www.adobe.com/) 的 Vinay Anantharaman 报告了格式错误的 AVI 标头漏洞 (CVE-2009-1545)  
-   [Adobe Systems, Inc.](http://www.adobe.com/) 的 Vinay Anantharaman 报告了 AVI 整数溢出漏洞 (CVE-2009-1546)

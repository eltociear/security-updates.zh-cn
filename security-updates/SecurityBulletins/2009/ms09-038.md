---
TOCTitle: 'MS09-038'
Title: 'Microsoft 安全公告 MS09-038 - 严重'
ms:assetid: 'ms09-038'
ms:contentKeyID: 61237489
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-038(v=Security.10)'
---
...
安全更新通过更正 AVI 标头的处理方式并更正 AVI 数据的验证方式来解决该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=5f80bf0b-898c-46ca-b20c-21e0e729c332)                                                                           | 远程执行代码 | 严重         | 无               |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=2e8a68ee-eb24-424c-b084-450636ccaeec)                                                          | 远程执行代码 | 严重         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a1ff2ace-b9dc-4cf3-a151-ac6959bcb3a6)                                                              | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=cba78658-899c-428f-8b04-cfe14ce3c255)                                                                              | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=58a7c8d9-ec36-46a6-a89b-d8dfd989fda4)                                                                  | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=187b02bd-73d6-4f72-81d1-d9477d495499)                                                              | 远程执行代码 | 严重         | 无               |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=81fce7bd-f33c-4586-949d-ac40d415f755)                                     | 远程执行代码 | 严重         | 无               |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a6cea61a-4ad9-4e18-bf18-348ae4ae51c4) | 远程执行代码 | 严重         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fdc96a07-ed79-4798-8077-b2e9ca64cd0f)\*                   | 远程执行代码 | 严重         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8e3afba4-6761-4b3d-98bb-4b4145e27b7f)\*         | 远程执行代码 | 严重         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=aa1bb13a-5905-48c4-8e74-a41104593046)   | 远程执行代码 | 严重         | 无               |
...
<tr class="header">
<th>受影响的软件</th>
<th>格式错误的 AVI 标头漏洞 - CVE-2009-1545</th>
<th>AVI 整数溢出漏洞 - CVE-2009-1546</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
格式错误的 AVI 标头漏洞 - CVE-2009-1545  
---------------------------------------
  
  
Microsoft Windows 处理特制 AVI 格式文件的方式中存在一个远程执行代码漏洞。 如果用户打开特制的 AVI 文件，此漏洞可能允许执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1545](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1545)。
  
#### 格式错误的 AVI 标头漏洞 (CVE-2009-1545) 的缓解因素
...
#### 格式错误的 AVI 标头漏洞 (CVE-2009-1545) 的变通方法
...
```
takeown /f %windir%\syswow64\avifil32.dllicacls %windir%\syswow64\avifil32.dll /save %TEMP%\ AVIFIL32 _ACL.TXT
icacls %windir%\syswow64\avifil32.dll /deny everyone:(F)takeown /f
```
  
**变通办法的影响：** 依赖 AVIFile API 的应用程序将无法正确呈现 AVI 视频内容
...
-   **删除 HKEY\_CLASSES\_ROOT\\CLSID\\{40C3D757-D6E4-4b49-BB41-0E5BBEA28817}**
  
删除此注册表将阻止 Windows 资源管理器预览 AVI 文件。
...
4.在“导出注册表文件”对话框中，键入 **Video\_Media\_Properties\_Handler\_Backup.reg**，然后单击“**保存**”。  
...
4.在“导出注册表文件”对话框中，键入 **Video\_Media\_Properties\_Handler\_Backup1.reg**，然后单击“**保存**”。  
**注意** 默认情况下，此操作将在“我的文档”文件夹中创建此注册表项的备份。
...
9.在“导出注册表文件”对话框中，键入 **Video\_Media\_Properties\_Handler\_Backup2.reg**，然后单击“**保存**”。  
**注意** 默认情况下，此操作将在“我的文档”文件夹中创建此注册表项的备份。
  
10.按键盘上的“**Delete**”键删除该注册表项。 当系统提示您通过“确认项删除”对话框删除注册表项时，单击“**是**”。
  
**变通办法的影响：** Windows 资源管理器将不提供 AVI 文件的预览图像。
...
2.接下来，将下列内容保存到扩展名为 .REG 的文件，例如 Disable\_Video\_Media\_Properties\_Handler.reg：  
...
#### 格式错误的 AVI 标头漏洞 (CVE-2009-1545) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
负责处理 AVI 文件的 Windows 组件无法正确处理标题格式错误的特制 AVI 文件。
  
**什么是音频视频交错 (AVI) 文件？**    
音频视频交错 (AVI) 是资源交换文件格式 (RIFF) 的一个特例。 .avi 文件格式是计算机上最常见的音频和视频数据容器格式。 应用程序采用此文件类型来捕获、编辑和回放音频-视频序列。 一般 AVI 文件包含多个不同类型的数据流。 大多数 AVI 序列同时使用音频和视频流。 AVI 序列的一个简单变形变种使用视频数据，不需要音频流。
  
**Windows Media Player 是否受此漏洞影响？**    
否。 受影响组件与系统上安装的 Windows Media Player 版本无关。
  
**攻击者可能利用此漏洞执行什么操作？**    
如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**攻击者如何利用此漏洞？**    
利用此漏洞要求用户打开特制的 AVI 文件，或者从网站或提供 Web 内容的任何应用程序接收特制的流式内容。
...
在 Windows Vista 和 Windows Server 2008 上，攻击者可通过将特制 AVI 文件放到文件系统上并说服用户浏览文件位置来利用此漏洞。 在这些平台上，Windows 资源管理器将加载受影响的 DLL 以便为 AVI 文件提供缩略图和预览信息。
  
**受此漏洞威胁最大的系统有哪些？**    
工作站和终端服务器受到的威胁最大。 当应该没有足够管理权限的用户被授予登录到服务器并运行程序的权限时，服务器会更有危险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**    
该更新通过更正处理 AVI 标头的方式来解决该漏洞。
...
AVI 整数溢出漏洞 - CVE-2009-1546  
--------------------------------
  
  
Microsoft Windows 处理特制 AVI 格式文件的方式中存在一个远程执行代码漏洞。 如果用户打开特制的 AVI 文件，此漏洞可能允许执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1546](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1546)。
  
#### AVI 整数溢出漏洞 (CVE-2009-1546) 的缓解因素
...
#### AVI 整数溢出漏洞 (CVE-2009-1546) 的变通办法
...
#### AVI 整数溢出漏洞 (CVE-2009-1546) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
负责处理 AVI 文件的 Windows 组件无法正确验证特制 AVI 文件中的数据。
...
| **部署**                         |                                                                                                                       |  
| 没有用户干预的安装               | Windows2000-kb971557-x86-enu /quiet                                                                                   |  
| 在不重新启动的情况下安装         | Windows2000-kb971557-x86-enu /norestart                                                                               |  
| 更新日志文件                     | kb971557.log                                                                                                          |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节                                                                                  |  
| **重新启动要求**                 |                                                                                                                       |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                                |  
| HotPatching                      | 不适用                                                                                                                |  
| **删除信息**                     | 使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB971557$\\Spuninst 文件夹中的 Spuninst.exe 实用程序 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 971557](https://support.microsoft.com/kb/971557)                                          |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971557\\Filelist                             |
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB971557$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/971557">Microsoft 知识库文章 971557</a></td>
</tr>  
<tr class="even">
...
-   [Adobe Systems, Inc.](https://www.adobe.com/) 的 Vinay Anantharaman 报告了格式错误的 AVI 标头漏洞 (CVE-2009-1545)  
-   [Adobe Systems, Inc.](https://www.adobe.com/) 的 Vinay Anantharaman 报告了 AVI 整数溢出漏洞 (CVE-2009-1546)

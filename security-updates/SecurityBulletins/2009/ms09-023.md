---
TOCTitle: 'MS09-023'
Title: 'Microsoft 安全公告 MS09-023 - 警告'
ms:assetid: 'ms09-023'
ms:contentKeyID: 61237474
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-023(v=Security.10)'
---

Microsoft 安全公告 MS09-023 - 警告
==================================
...
对于 Windows XP 和 Windows Server 2003 的所有受支持版本上安装的 Windows Search，此安全更新的等级为“中等”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过修改 Windows Search 限制执行脚本的环境的方式来解决此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。** [Microsoft 知识库文章 963093](https://support.microsoft.com/kb/963093) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|--------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| Windows XP Service Pack 2 和 Windows XP Service Pack 3 | [Windows Search 4.0](https://www.microsoft.com/download/details.aspx?familyid=759f22cb-ea7f-49dd-a200-19cb83fffd8d) | 信息泄露     | 中等         | 无               |
| Windows XP Professional x64 Edition Service Pack 2     | [Windows Search 4.0](https://www.microsoft.com/download/details.aspx?familyid=50c56dd6-c34d-4632-a779-8bcf8fdb341b) | 信息泄露     | 中等         | 无               |
| Windows Server 2003 Service Pack 2                     | [Windows Search 4.0](https://www.microsoft.com/download/details.aspx?familyid=e72ef31f-5161-4fe6-8ed3-6206e02cef31) | 信息泄露     | 中等         | 无               |
| Windows Server 2003 x64 Edition Service Pack 2         | [Windows Search 4.0](https://www.microsoft.com/download/details.aspx?familyid=7ffc3680-f9bf-423b-96a7-102f4cc9c240) | 信息泄露     | 中等         | 无               |
...
| Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2                                     | Windows Search 4.0 |
| Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 | Windows Search 4.0 |
| Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2                     | Windows Search 4.0 |
| Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2           | Windows Search 4.0 |
...
<tr class="header">
<th>软件</th>
<th>Windows Search 漏洞 (CVE-2009-0239) 中的脚本执行</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">安装在 Windows XP Service Pack 2 上的 Windows Search 4.0</td>
<td style="border:1px solid black;"><strong>中等</strong> <br />
信息泄露</td>
<td style="border:1px solid black;"><strong>中等</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">安装在 Windows XP Service Pack 3 上的 Windows Search 4.0</td>
<td style="border:1px solid black;"><strong>中等</strong> <br />
信息泄露</td>
<td style="border:1px solid black;"><strong>中等</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">安装在 Windows XP Professional x64 Edition Service Pack 2 上的 Windows Search 4.0</td>
<td style="border:1px solid black;"><strong>中等</strong> <br />
信息泄露</td>
<td style="border:1px solid black;"><strong>中等</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">安装在 Windows Server 2003 Service Pack 2 上的 Windows Search 4.0</td>
<td style="border:1px solid black;"><strong>中等</strong> <br />
信息泄露</td>
<td style="border:1px solid black;"><strong>中等</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">安装在 Windows Server 2003 x64 Edition Service Pack 2 上的 Windows Search 4.0</td>
<td style="border:1px solid black;"><strong>中等</strong> <br />
信息泄露</td>
<td style="border:1px solid black;"><strong>中等</strong></td>
</tr>  
...
Windows Search 漏洞 (CVE-2009-0239) 中的脚本执行  
------------------------------------------------

由于生成文件预览的方式，Windows Search 中存在一个信息泄露漏洞。 要试图利用此漏洞，需要进行用户交互。 成功利用此漏洞的攻击者可以运行可能泄露信息的恶意 HTML 脚本、将用户数据转发给第三方或者访问受影响的系统上登录用户可以访问的任何数据。 请注意，虽然攻击者无法利用此漏洞来执行代码或直接提升他们的用户权限，但此漏洞可用于产生信息，这些信息可用于试图进一步危及受影响系统的安全。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0239](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0239)。
  
#### Windows Search 漏洞 (CVE-2009-0239) 中脚本执行的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   默认情况下，Microsoft Windows XP 和 Windows Server 2003 上不会预安装 Windows Search 组件。它是一个可以下载的可选组件。  
-   Windows Vista 和 Windows Server 2008 的受支持版本上安装的 Windows Search 不会受此漏洞的影响。
  
#### Windows Search 漏洞 (CVE-2009-0239) 中脚本执行的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows Search 漏洞 (CVE-2009-0239) 中脚本执行的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个信息泄露漏洞。 成功利用此漏洞的攻击者可以运行可能泄露信息的恶意 HTML 脚本、将用户数据转发给第三方或者访问受影响的系统上登录用户可以访问的任何数据。 请注意，虽然攻击者无法利用此漏洞来执行代码或提升他们的用户权限，但此漏洞用于生成有用信息，这些信息可用于试图进一步危及受影响系统的安全。
  
**造成漏洞的原因是什么？**  
Windows Search 未正确限制脚本执行的环境。
  
**什么是 Windows Search？**  
Windows Search 允许即时搜索大多数公共文件和数据类型，例如电子邮件、联系人、日历约会、文档、照片、多媒体和由第三方扩展的其他格式。 这些功能使使用者和信息工作者能够在家庭和企业环境中更加高效地查找、管理和整理日益增加的数据量。 有关详细信息，请参阅 [Microsoft 知识库文章 940157](https://support.microsoft.com/kb/940157)。
  
**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以运行恶意的客户端脚本。 如果运行此恶意脚本，该脚本将以通常不会授予给在 Internet 网页上运行的脚本的特权运行。 这些权限可能导致泄露敏感信息、用户数据转发给第三方或者访问受影响的系统上登录用户可以访问的数据。
  
**攻击者如何利用此漏洞？**  
此漏洞要求特制文件在系统上或者在索引邮箱的电子邮件中。 如果用户执行搜索，搜索返回的第一个结果为特制文件，则可能发生任意的 HTML 脚本执行。 如果特制文件不是第一个结果，则用户必须选择并预览此文件才能发生利用的情况。
  
**受此漏洞威胁最大的系统有哪些？**  
工作站和终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**  
此安全更新通过修改 Windows Search 限制执行脚本的环境的方式来解决此漏洞。
...
| 软件                                                                                  | MBSA 2.1 |  
|---------------------------------------------------------------------------------------|----------|  
| 安装在 Windows XP Service Pack 2 和 Windows XP Service Pack 3 上的 Windows Search 4.0 | 是       |  
| 安装在 Windows XP Professional x64 Edition Service Pack 2 上的 Windows Search 4.0     | 是       |  
| 安装在 Windows Server 2003 Service Pack 2 上的 Windows Search 4.0                     | 是       |  
| 安装在 Windows Server 2003 x64 Edition Service Pack 2 上的 Windows Search 4.0         | 是       |
...
|---------------------------------------------------------------------------------------|---------|----------------------|---------------------|----------------------------|  
| 安装在 Windows XP Service Pack 2 和 Windows XP Service Pack 3 上的 Windows Search 4.0 | 否      | 否                   | 是                  | 是                         |  
| 安装在 Windows XP Professional x64 Edition Service Pack 2 上的 Windows Search 4.0     | 否      | 否                   | 是                  | 是                         |  
| 安装在 Windows Server 2003 Service Pack 2 上的 Windows Search 4.0                     | 否      | 否                   | 是                  | 是                         |  
| 安装在 Windows Server 2003 x64 Edition Service Pack 2 上的 Windows Search 4.0         | 否      | 否                   | 是                  | 是                         |
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB963093$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/963093">Microsoft 知识库文章 963093。</a></td>
</tr>  
<tr class="even">
...
-   [IBM Rational Application Security](https://www-01.ibm.com/software/rational/offerings/websecurity/webappsecurity.html) 的 Yair Amit 报告了 Windows Search 漏洞 (CVE-2009-0239) 中的脚本执行

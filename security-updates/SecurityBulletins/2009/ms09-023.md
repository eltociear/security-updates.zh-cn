...
**已知问题。** [Microsoft 知识库文章 963093](http://support.microsoft.com/kb/963093) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0239](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0239)。
...
**什么是 Windows Search？**  
Windows Search 允许即时搜索大多数公共文件和数据类型，例如电子邮件、联系人、日历约会、文档、照片、多媒体和由第三方扩展的其他格式。 这些功能使使用者和信息工作者能够在家庭和企业环境中更加高效地查找、管理和整理日益增加的数据量。 有关详细信息，请参阅 [Microsoft 知识库文章 940157](http://support.microsoft.com/kb/940157)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/963093">Microsoft 知识库文章 963093。</a></td>
</tr>  
<tr class="even">
...
-   [IBM Rational Application Security](http://www-01.ibm.com/software/rational/offerings/websecurity/webappsecurity.html) 的 Yair Amit 报告了 Windows Search 漏洞 (CVE-2009-0239) 中的脚本执行

...
此安全更新也解决了 [Microsoft 安全通报 960906](https://technet.microsoft.com/security/advisory/960906) 中最初描述的漏洞。

**建议。** Microsoft 建议用户立即应用此更新。

**已知问题。** [Microsoft 知识库文章 960477](https://support.microsoft.com/kb/960477) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------|--------------|--------------|------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=552d322a-5282-42c7-9c1e-1d8c494a7318)                                                                     | 不适用 | 远程执行代码 | 重要         | 无               |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=50a8519a-503e-43dd-a78a-c1bc764fd213)                                                    | 不适用 | 远程执行代码 | 重要         | 无               |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=323f4211-5add-4e02-bce1-e5a1b489982c)                 | 不适用 | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2233a4d2-7c8a-4c89-b020-100d9afb43c8)                                  | 不适用 | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=323f4211-5add-4e02-bce1-e5a1b489982c)                         | 不适用 | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=e840b9cb-f1f4-482a-aa07-eb6b42b477c4) | 不适用 | 远程执行代码 | 重要         | 无               |
...
<td style="border:1px solid black;">
[MS04-027](https://go.microsoft.com/fwlink/?linkid=33948)
</td>
</tr>
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 960477](https://support.microsoft.com/kb/960477) 中找到文件信息详细资料。

**客户在安装此安全更新时可能遇到哪些已知问题？**  
[Microsoft 知识库文章 960477](https://support.microsoft.com/kb/960477) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。

**此更新为何消除了多个已报告的安全漏洞？**  
此更新之所以包含对某些漏洞的支持，是因为解决这些问题所需的修改位于相关的文件中。 客户只需安装此更新就可以了，而不用安装多个几乎相同的更新。

**此更新是否包含任何与安全性相关的功能更改？**  
是的，除了实施安全漏洞解决方案之外，此安全更新还通过阻止受影响平台上的写字板打开 Word 6.0 和 Write 文件来解决该漏洞。 当写字板试图打开 Word 6.0 或 Write 文件时，该文件不会打开，也不会显示任何对话框。 有关详细信息，请参阅 [Microsoft 知识库文章 960477](https://support.microsoft.com/kb/960477)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0087)。
...
-   由于受影响的组件默认情况下处于禁用状态，此漏洞对 Windows XP 和 Windows Server 2003 的所有受支持版本威胁不大。 这些操作系统仅在管理员手动启用受影响组件时才会出现漏洞。 Windows Vista 和 Windows Server 2008 的所有受支持版本不包含受影响的组件，也不会受影响。
    Microsoft Windows 2000 Service Pack 4 受到的威胁最大，因为转换器在默认安装中仍处于活动状态。 但是，在应用了 [MS04-041](https://go.microsoft.com/fwlink/?linkid=36667) 更新的 Microsoft Windows 2000 Service Pack 4 系统上，Word for Windows 6.0 转换器默认情况下处于禁用状态。
...
Windows XP 和 Windows Server 2003 的受支持版本上运行的系统默认情况下未启用 Word for Windows 6.0 转换器。但是，如果手动启用了 Word for Windows 6.0 转换器，例如按照 [Microsoft 知识库文章 870883](https://support.microsoft.com/kb/870883) 中的说明执行操作，则系统将受此漏洞的威胁。 有关禁用已启用的 Word for Windows 6.0 转换器的详细信息，请参阅变通办法**通过限制访问来禁用 Word 6 转换器**。
在 Microsoft Windows 2000 Service Pack 4 上，该公告的严重等级为“重要”，因为转换器在默认安装中仍处于活动状态。 但是，在应用了 [MS04-041](https://go.microsoft.com/fwlink/?linkid=36667) 更新的 Microsoft Windows 2000 Service Pack 4 系统上，Word for Windows 6.0 转换器默认情况下处于禁用状态。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-0087](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0087)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4841](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4841)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 在最初发布此安全公告时，此漏洞已被公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2008-4841](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4841)。此漏洞最初是在 [Microsoft 安全通报 960906](https://technet.microsoft.com/security/advisory/960906) 中介绍的。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0088)。
...
Microsoft Office Converter Pack 结合了 Office 较早版本中未提供的文件转换器和筛选器。 这些转换器和筛选器使 Office 可以使用其本身不支持的其他文档格式。 Microsoft Office Converter Pack 可[从 Web 下载](https://go.microsoft.com/fwlink/?linkid=34318)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0235](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0235)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/960477">Microsoft 知识库文章 960477</a></td>
</tr>  
<tr class="even">
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 和 Jun Mao 报告了写字板 Word 97 文本转换器堆栈溢出漏洞 (CVE-2009-0235)。  
-   Fortinet [FortiGuard Global Security Research Team](https://www.fortiguardcenter.com/) 的一位研究人员报告了 写字板和 Office 文本转换器内存损坏漏洞 (CVE-2009-0087)。  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的一位研究人员报告了 Word 2000 WordPerfect 6.x 转换器堆栈损坏漏洞 (CVE-2009-0088)。

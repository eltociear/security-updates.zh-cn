...
此安全更新也解决了最初在 [Microsoft 安全通报 975191](https://technet.microsoft.com/security/advisory/975191) 中描述的漏洞。
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://technet.microsoft.com/security/bulletin/ms09-053)
</td>
<td style="border:1px solid black;">
Microsoft Internet Information Services 6.0
</td>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2521)。
...
**发布此安全公告时，此漏洞是否已公开披露？**??
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2521)。

**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**??
是。 Microsoft 获悉尝试使用此漏洞的有限目标攻击。

**应用此安全更新有助于客户防止尝试利用此漏洞的已公开发布代码吗？**?
是。 此安全更新可消除目前被利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2009-2521](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2521)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3023)。
...
**攻击者可能利用此漏洞执行什么操作？**??
访问 FTP 服务的攻击者可以利用此漏洞造成基于堆栈的溢出，从而允许在运行 IIS 5.0 的系统上的 LocalSystem 帐户上下文中执行任意代码，或在运行 IIS 5.1、IIS 6.0 的受影响系统上拒绝服务。 在允许匿名验证的 FTP 服务的配置中，攻击者不需要通过身份验证即可利用漏洞。 有关 LocalSystem 帐户的详细信息，请参阅 MSDN 文章 [LocalSystem 帐户](https://msdn.microsoft.com/en-us/library/ms684190(vs.85).aspx)。
...
**发布此安全公告时，此漏洞是否已公开披露？**??
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-3023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3023)。

**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**??
是。 Microsoft 获悉尝试使用此漏洞的有限目标攻击。

**应用此安全更新有助于客户防止尝试利用此漏洞的已公开发布代码吗？**??
是。 此安全更新可消除目前被利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2009-3023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3023)。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 975254](https://support.microsoft.com/kb/975254)                                          |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/975254">Microsoft 知识库文章 975254</a></td>
</tr>  
<tr class="even">

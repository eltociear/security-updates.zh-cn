...
**已知问题。** [Microsoft 知识库文章 971726](https://support.microsoft.com/kb/971726) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
[Microsoft 知识库文章 971726](https://support.microsoft.com/kb/971726) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
有关 Windows Server 2003 R2 的具体信息，请参阅 [Windows Server 2003 R2](https://www.microsoft.com/windowsserver2003/default.mspx) 站点。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2508](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2508)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2509](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2509)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/971726">Microsoft 知识库文章 971726</a></td>
</tr>  
<tr class="even">

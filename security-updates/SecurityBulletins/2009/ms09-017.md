...
此安全更新也解决了 [Microsoft 安全通报 969136](https://technet.microsoft.com/security/advisory/969136) 中最初描述的漏洞。

**建议。** Microsoft 建议用户立即应用此更新。

**已知问题。** [Microsoft 知识库文章 967340](https://support.microsoft.com/kb/967340) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=11f8380f-ffb6-4c22-a89c-3dc55d0f9834)\*  
(KB957789)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=11f8380f-ffb6-4c22-a89c-3dc55d0f9834)\*  
(KB957789)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 1 的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?familyid=e1d3a4c3-538a-4f98-8d60-250803a80e2a)  
(KB969618)
</td>
<td style="border:1px solid black;">
不适用
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 2 的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?familyid=e1d3a4c3-538a-4f98-8d60-250803a80e2a)  
(KB969618)
</td>
<td style="border:1px solid black;">
不适用
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 967340](https://support.microsoft.com/kb/967340) 中找到文件信息详细资料。
...
安装此更新之后，Microsoft Office PowerPoint 2000 和 Microsoft Office PowerPoint 2002 中默认情况下将禁用打开 PowerPoint 4.0 文件格式的功能。在 Microsoft Office PowerPoint 2003 Service Pack 3 中，此功能在默认情况下已被禁用。此功能在 Microsoft Office PowerPoint 2007 中不再存在。有关此更改的详细信息，请参阅 [Microsoft 知识库文章 970980](https://support.microsoft.com/kb/970980)。
...
以下严重等级假设漏洞的可能的最大影响。 有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [5 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms09-may)中的利用指数。 有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0220](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0220)。

#### 旧文件格式漏洞 (CVE-2009-0220) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   安装时，Microsoft Office 2003 Service Pack 3 默认为阻止打开和保存某些文件。 对于 Microsoft Office PowerPoint 2003 Service Pack 3，这些文件包括比 PowerPoint 97 更旧的文件和格式为 .ppt、.pot、.pps 和 .ppa 的文件。请注意此功能不适用于 Microsoft Office PowerPoint 97 文件。 有关详细信息，请参阅 [Microsoft 知识库文章 938810](https://support.microsoft.com/kb/938810)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0221](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0221)。
...
-   **使用 Microsoft Office 文件阻止策略禁止打开来自未知或不可信来源和位置的 Office 2003 以及较早版本的文档**
    ...
    **变通办法的影响：** 配置了文件阻止策略但是尚未按照[Microsoft 知识库文章 970980](https://support.microsoft.com/kb/970980) 所述配置特殊“例外目录”的用户在 Office 2003 或 2007 Microsoft Office System 中无法打开 Office 2003 或更早版本的文件。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0222](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0222)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0223](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0223)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0224](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0224)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0225](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0225)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0226](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0226)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0227](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0227)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0556)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2009-0556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0556)。此漏洞最初是在 [Microsoft 安全通报 969136](https://technet.microsoft.com/security/advisory/969136) 中介绍的。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1128](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1128)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1129](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1129)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1130](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1130)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1131](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1131)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1137](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1137)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/967340">Microsoft 知识库文章 967340</a></td>
</tr>  
<tr class="even">
...
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/)合作，报告了旧文件格式漏洞 (CVE-2009-0220)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了整数溢出漏洞 (CVE-2009-0221)  
-   [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 报告了旧文件格式漏洞 (CVE-2009-0222)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Marsu Pilami 报告了旧文件格式漏洞 (CVE-2009-0223)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了内存损坏漏洞 (CVE-2009-0224)  
-   [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 报告了内存损坏漏洞 (CVE-2009-0225)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Marsu Pilami 报告了旧文件格式漏洞 (CVE-2009-0226)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Marsu Pilami 报告了旧文件格式漏洞 (CVE-2009-0227)  
-   Marsu Pilami 与[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了内存损坏漏洞 (CVE-2009-0556)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Marsu Pilami 报告了 PP7 内存损坏漏洞 (CVE-2009-1128)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Marsu Pilami 报告了 PP7 内存损坏漏洞 (CVE-2009-1129)  
-   [team509](https://www.team509.com/) 的 Ling 和 Wushi 与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 以及 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 合作，报告了堆损坏漏洞 (CVE-2009-1130)  
-   [Secunia](https://secunia.com/) 的Carsten H. Eiram 报告了数据溢出漏洞 (CVE-2009-1131)  
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/)合作，报告了旧文件格式漏洞 (CVE-2009-1137)

---
TOCTitle: 'MS09-006'
Title: 'Microsoft 安全公告 MS09-006 - 严重'
ms:assetid: 'ms09-006'
ms:contentKeyID: 61237457
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-006(v=Security.10)'
---
...
此安全更新通过验证从用户模式通过 GDI 内核组件传递的输入，并纠正内核验证句柄的方式以及更改 Windows 内核处理特制的无效指针的方式来消除漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=98bb7d40-89a0-470a-8eb7-06f15072a635)                                                                     | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=e09641ba-6cbe-4095-82b5-703d3a7dc33b)                                                    | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d0d704c6-48c2-4907-b6c3-2455d7cf21c8)                 | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f5cfb8da-e7cc-4183-8631-507c2a406500)                                  | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ecf75c70-8489-41ad-9759-3a07e13957be)                         | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=04be3d7e-7dda-4dca-887a-e7a8156ede1c) | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Vista 和 Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4b1aaaba-f355-4265-83c0-50b901856ced)                                                             | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=0fcac480-d6db-4a94-8c7d-b7319282cf56)                                     | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2008（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=38851df2-4fb5-4d28-9d15-181c260cf8cf)\*                                                                   | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2008（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=ec15acc4-3e0f-4414-9383-61c122ff1382)\*                                                              | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2008（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=eead6f93-10fd-4492-8137-481d9876a5fe)                                                            | 远程执行代码 | 严重         | [MS08-061](https://go.microsoft.com/fwlink/?linkid=121738) |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 958690](https://support.microsoft.com/kb/958690) 中找到文件信息详细资料。
...
以下严重等级假设漏洞的可能的最大影响。 有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [3 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms09-mar)中的利用指数。 有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
<th style="border:1px solid black;">Windows 内核输入验证漏洞 - CVE-2009-0081</th>
<th style="border:1px solid black;">Windows 内核句柄验证漏洞 - CVE-2009-0082</th>
<th style="border:1px solid black;">Windows 内核无效指针漏洞 - CVE-2009-0083</th>
...
Windows 内核输入验证漏洞 - CVE-2009-0081  
----------------------------------------
  
  
Windows 内核中存在一个由于未能正确验证从用户模式通过 GDI 内核组件传递的输入而产生的远程执行代码漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0081](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0081)。
  
#### Windows 内核输入验证漏洞 (CVE-2009-0081) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
  
#### Windows 内核输入验证漏洞 (CVE-2009-0081) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **通过修改注册表禁用元文件处理**  
    应用了与 Microsoft 安全公告 MS07-017 关联的安全更新的用户，或者使用 Windows Vista 或 Windows Server 2008 的用户可以通过修改注册表禁用元文件处理。 此设置将帮助防止受影响的系统尝试利用此漏洞。
...
#### Windows 内核输入验证漏洞 (CVE-2009-0081) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核无法正确地验证从用户模式通过 GDI 内核组件传递的输入。
  
**什么是 Windows 内核？**    
Windows 内核是操作系统的核心。 它提供设备管理和内存管理等系统级服务，为进程分配处理器时间，并管理错误处理。
  
**什么是 GDI？**    
Microsoft Windows 图形设备接口 (GDI) 允许应用程序在视频显示和打印机上使用图形和格式化文本。 基于 Windows 的应用程序不直接访问图形硬件。 而是 GDI 代表应用程序与设备驱动程序进行交互。 有关 GDI 的详细信息，请访问 [Windows GDI 起始页](https://msdn.microsoft.com/en-us/library/dd145203(vs.85).aspx)。
...
有关图像类型和格式的详细信息，请参阅 [Microsoft 知识库文章 320314](https://support.microsoft.com/kb/320314)。有关这些文件格式的其他信息，请访问 [MSDN 技术资源库网站](https://msdn2.microsoft.com/en-us/library/ms536391.aspx)。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**攻击者如何利用此漏洞？**    
对于远程执行代码，此漏洞要求用户查看特制的图像文件。 此漏洞还可能被登录到本地系统的攻击者所利用。 然后，攻击者可以运行一个为利用此漏洞而特制的应用程序，从而完全控制受影响的系统。
  
在电子邮件攻击情形中，攻击者可以通过向用户发送内嵌有特制的 EMF 或 WMF 图像文件的电子邮件并诱使用户查看或预览该电子邮件来利用此漏洞。 攻击者还可以在 Office 文档中嵌入特制的 EMF 或 WMF 图像文件并诱使用户打开该文件。
...
Windows 内核句柄验证漏洞 - CVE-2009-0082  
----------------------------------------
  
  
Windows 内核中存在一个由于内核处理句柄的方式而产生的特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0082](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0082)。
  
#### Windows 内核句柄验证漏洞 (CVE-2009-0082) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录易受攻击的系统才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核句柄验证漏洞 (CVE-2009-0082) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核句柄验证漏洞 (CVE-2009-0082) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
在执行某些操作时，Windows 内核无法正确地验证句柄。
...
Windows 内核无效指针漏洞 - CVE-2009-0083  
----------------------------------------
  
  
Windows 内核中存在一个由于无法正确处理特制无效指针而产生的特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0083](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0083)。
  
#### Windows 内核无效指针漏洞 (CVE-2009-0083) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录易受攻击的系统才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核无效指针漏洞 (CVE-2009-0083) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核无效指针漏洞 (CVE-2009-0083) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核无法正确处理特制无效指针。
...
**此更新有什么作用？**    
此更新通过更改 Windows 内核处理特制无效指针的方式来解决漏洞。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB958690$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/958690">Microsoft 知识库文章 958690</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB958690$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/958690">Microsoft 知识库文章 958690</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB958690$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/958690">Microsoft 知识库文章 958690</a></td>
...
-   Helmut Buhler (<https://home.arcor.de/clipboarder/>) 报告了 Windows 内核输入验证漏洞 (CVE-2009-0081)  
-   [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 报告了 Windows 内核句柄验证漏洞 (CVE-2009-0082)

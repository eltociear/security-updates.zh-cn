...
|-----------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Microsoft Windows 2000 Server Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=365a8dff-2383-42f6-b567-e545461fd135) | 远程执行代码 | 严重         | 无               |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2523](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2523)。
...
-   **禁用许可证记录服务**
    ...
    **变通办法的影响。** 如果禁用许可证记录服务，显式依赖许可证记录服务的任何服务将在系统事件日志中记录错误消息。 有关详细信息，请参阅 [Microsoft 知识库文章 316631](https://support.microsoft.com/kb/316631)
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 974783](https://support.microsoft.com/kb/974783)                                          |  
...
-   [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) 的 Cody Pierce 报告了 License Logging Server 堆溢出漏洞 (CVE-2009-2523)

---
TOCTitle: 'MS09-067'
Title: 'Microsoft 安全公告 MS09-067 - 重要'
ms:assetid: 'ms09-067'
ms:contentKeyID: 61237518
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-067(v=Security.10)'
---
...
**已知问题。** [Microsoft 知识库文章 972652](https://support.microsoft.com/kb/972652) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=322b24ca-aff6-4ca0-acf1-440cae0f9693)\*  
(KB973593)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 1 以及用于 Word、Excel 和 PowerPoint 2007 文件格式 的 Microsoft Office 兼容包 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa)  
(KB973704)
</td>
<td style="border:1px solid black;">
不适用
...
\*对于 Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2，除了安全更新程序包 KB969682 之外，客户还需要安装[用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 1 和用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c4c92d2e-e87d-446f-8d3e-8f4be10c70aa) 的安全更新 (KB973704)，以免受本公告中所描述的漏洞影响。
...
[Microsoft 知识库文章 972652](https://support.microsoft.com/kb/972652) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。

**此更新是否包含任何其他与安全性无关的功能更改？**  
是。 安装此安全更新后，如果用户打开特制的 Excel 文件，Excel 可能会意外退出，但是此更新解决的漏洞不会被利用。
...
**MS09-068 还描述 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 和 Open XML File Format Converter for Mac 中的漏洞。 MS09-068 与此公告 (MS09-067) 有何关联？**  
此公告 MS09-067 中的 Microsoft Office 2004 for Mac (KB976830)、Microsoft Office 2008 for Mac (KB976828) 和 Open XML File Format Converter for Mac (KB976831) 安全更新包还解决了 MS09-068 中描述的漏洞。安装了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 或 Open XML File Format Converter for Mac 的用户只需安装这些安全更新包一次。
...
<th>
Excel 高速缓存损坏漏洞 - CVE-2009-3127
</th>
<th>
Excel SxView 内存损坏漏洞 - CVE-2009-3128
</th>
<th>
Excel Featheader 记录内存损坏漏洞 - CVE-2009-3129
</th>
<th>
Excel 文档分析堆溢出漏洞 - CVE-2009-3130
</th>
<th>
Excel 公式分析内存损坏漏洞 - CVE-2009-3131
</th>
<th>
Excel 索引分析漏洞 - CVE-2009-3132
</th>
<th>
Excel 文档分析内存损坏漏洞 - CVE-2009-3133
</th>
<th>
Excel 字段清理漏洞 - CVE-2009-3134
</th>
<th>
综合严重等级
</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3127](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127)。

#### Excel 高速缓存损坏漏洞 (CVE-2009-3127) 的缓解因素
...
#### Excel 高速缓存损坏漏洞 (CVE-2009-3127) 的变通办法
...
#### Excel 高速缓存损坏漏洞 (CVE-2009-3127) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成漏洞的原因是什么？**  
Microsoft Office Excel 在打开特制的 Excel 电子表格时分析 Excel 电子表格文件格式的方式中存在一个漏洞。
...
**攻击者如何利用此漏洞？**  
此漏洞需要用户打开受影响的 Microsoft Office Excel 版本的特制 Excel 电子表格才能利用。
...
Microsoft Office Excel 处理包含格式错误记录对象的特制 Excel 文件的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3128](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128)。

#### Excel SxView 内存损坏漏洞 (CVE-2009-3128) 的缓解因素
...
#### Excel SxView 内存损坏漏洞 (CVE-2009-3128) 的变通办法
...
#### Excel SxView 内存损坏漏洞 (CVE-2009-3128) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3129](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129)。

#### Excel Featheader 记录内存损坏漏洞 (CVE-2009-3129) 的缓解因素
...
#### Excel Featheader 记录内存损坏漏洞 (CVE-2009-3129) 的变通办法
...
#### Excel Featheader 记录内存损坏漏洞 (CVE-2009-3129) 的常见问题
...
Microsoft Office Excel 处理包含格式错误 BIFF 记录的特制 Excel 文件的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3130](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130)。

#### Excel 文档分析堆溢出漏洞 (CVE-2009-3130) 的缓解因素
...
#### Excel 文档分析堆溢出漏洞 (CVE-2009-3130) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 文档分析堆溢出漏洞 (CVE-2009-3130) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成漏洞的原因是什么？**  
此漏洞是由于 Excel 使用格式错误的二进制文件格式 (BIFF) 记录错误处理 Excel 文件而引起的，这可能以一种攻击者可以执行任意代码的方式导致内存损坏。
...
Microsoft Office Excel 分析包含单元格中嵌入的特制公式的文档的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者然后可以安装程序；查看、更改或删除数据；或者在当前已登录用户的上下文中使用完全用户权限创建新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3131](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131)。

#### Excel 公式分析内存损坏漏洞 (CVE-2009-3131) 的缓解因素
...
#### Excel 公式分析内存损坏漏洞 (CVE-2009-3131) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 公式分析内存损坏漏洞 (CVE-2009-3131) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成漏洞的原因是什么？**  
Microsoft Office Excel 分析包含特制公式的 Excel 电子表格的方式中存在漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3132](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132)。

#### Excel 索引分析漏洞 (CVE-2009-3132) 的缓解因素
...
#### Excel 索引分析漏洞 (CVE-2009-3132) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 索引分析漏洞 (CVE-2009-3132) 的常见问题
...
**受此漏洞威胁最大的系统有哪些？**  
使用 Microsoft Office Excel 的系统（包括工作站和终端服务器）受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 但是，最佳做法严禁这样做

**此更新有什么作用？**  
此更新通过修改 Microsoft Office Excel 处理打开特制 Excel 文件的方式来解决该漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3133](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133)。

#### Excel 文档分析内存损坏漏洞 (CVE-2009-3133) 的缓解因素
...
#### Excel 文档分析内存损坏漏洞 (CVE-2009-3133) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 文档分析内存损坏漏洞 (CVE-2009-3133) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3134](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134)。

#### Excel 字段清理漏洞 (CVE-2009-3134) 的缓解因素
...
#### Excel 字段清理漏洞 (CVE-2009-3134) 的变通办法
...
#### Excel 字段清理漏洞 (CVE-2009-3134) 的常见问题
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------|---------------------|---------------------|----------------------------|
| Microsoft Office Excel 2002 Service Pack 3                                                                                                                                       | 否      | 否                  | 是                  | 是                         |
| Microsoft Office Excel 2003 Service Pack 3                                                                                                                                       | 否      | 否                  | 是                  | 是                         |
...
| Microsoft Office Excel Viewer 2003 Service Pack 3                                                                                                                                | 否      | 否                  | 是                  | 是                         |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/973471">Microsoft 知识库文章 973471</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2003：<br />
请参阅 <a href="https://support.microsoft.com/kb/973475">Microsoft 知识库文章 973475</a><br />  
<br />  
对于 Excel Viewer 2003：<br />
请参阅 <a href="https://support.microsoft.com/kb/973484">Microsoft 知识库文章 973484</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2007：<br />
请参阅 <a href="https://support.microsoft.com/kb/973593">Microsoft 知识库文章 973593</a><br />  
<br />  
对于 Excel Viewer：<br />  
请参阅 <a href="https://support.microsoft.com/kb/973707">Microsoft 知识库文章 973707</a><br />  
<br />  
对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包：<br />
请参阅 <a href="https://support.microsoft.com/kb/973704">Microsoft 知识库文章 973704</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=8f115b1c-1e28-4ecf-937c-99c4b60c7c8e)下载和安装 Microsoft Office 2004 for Mac 11.5.6 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=b84fe57d-ddda-451e-9ead-69e10aee7928)下载和安装 Microsoft Office 2008 for Mac 12.2.3 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=4dd4bc05-1217-497e-8f65-4347f2544ed6)下载和安装 Open XML File Format Converter for Mac 1.1.3 Update 的合适语言版本。
...
-   [Fortinet's FortiGuard Labs](https://www.fortiguard.com) 的 Bing Liu 报告了 Excel 缓存内存损坏漏洞 (CVE-2009-3127)  
-   [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了 Excel 缓存内存损坏漏洞 (CVE-2009-3127)  
-   [Fortinet's FortiGuard Labs](https://www.fortiguard.com) 的 Bing Liu 报告了 Excel SxView 内存损坏漏洞 (CVE-2009-3128)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了 Excel Featheader 记录内存损坏漏洞 (CVE-2009-3129)  
-   [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 文档分析堆溢出漏洞 (CVE-2009-3130)  
-   [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 公式分析内存损坏漏洞 (CVE-2009-3131)  
-   [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 索引分析漏洞 (CVE-2009-3132)  
-   [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 文档分析内存损坏漏洞 (CVE-2009-3133)  
-   [Fortinet's FortiGuard Labs](https://www.fortiguard.com) 的 Bing Liu 报告了 Excel 字段清理漏洞 (CVE-2009-3134)

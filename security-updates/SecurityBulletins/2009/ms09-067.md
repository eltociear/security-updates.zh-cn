...
**已知问题。** [Microsoft 知识库文章 972652](http://support.microsoft.com/kb/972652) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
[Microsoft 知识库文章 972652](http://support.microsoft.com/kb/972652) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3127](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3127)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3128](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3128)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3129](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3129)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3130](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3130)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3131](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3131)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3132](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3132)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3133](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3133)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3134](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3134)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/973471">Microsoft 知识库文章 973471</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2003：<br />
请参阅 <a href="http://support.microsoft.com/kb/973475">Microsoft 知识库文章 973475</a><br />  
<br />  
对于 Excel Viewer 2003：<br />
请参阅 <a href="http://support.microsoft.com/kb/973484">Microsoft 知识库文章 973484</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2007：<br />
请参阅 <a href="http://support.microsoft.com/kb/973593">Microsoft 知识库文章 973593</a><br />  
<br />  
对于 Excel Viewer：<br />  
请参阅 <a href="http://support.microsoft.com/kb/973707">Microsoft 知识库文章 973707</a><br />  
<br />  
对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包：<br />
请参阅 <a href="http://support.microsoft.com/kb/973704">Microsoft 知识库文章 973704</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Fortinet's FortiGuard Labs](http://www.fortiguard.com) 的 Bing Liu 报告了 Excel 缓存内存损坏漏洞 (CVE-2009-3127)  
-   [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 报告了 Excel 缓存内存损坏漏洞 (CVE-2009-3127)  
-   [Fortinet's FortiGuard Labs](http://www.fortiguard.com) 的 Bing Liu 报告了 Excel SxView 内存损坏漏洞 (CVE-2009-3128)  
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Sean Larsson 报告了 Excel Featheader 记录内存损坏漏洞 (CVE-2009-3129)  
-   [VUPEN Security](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 文档分析堆溢出漏洞 (CVE-2009-3130)  
-   [VUPEN Security](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 公式分析内存损坏漏洞 (CVE-2009-3131)  
-   [VUPEN Security](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 索引分析漏洞 (CVE-2009-3132)  
-   [VUPEN Security](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 文档分析内存损坏漏洞 (CVE-2009-3133)  
-   [Fortinet's FortiGuard Labs](http://www.fortiguard.com) 的 Bing Liu 报告了 Excel 字段清理漏洞 (CVE-2009-3134)

---
TOCTitle: 'MS09-011'
Title: 'Microsoft 安全公告 MS09-011 - 严重'
ms:assetid: 'ms09-011'
ms:contentKeyID: 61237462
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-011(v=Security.10)'
---
...
此安全更新通过更正 DirectShow 解压缩媒体文件的方式来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 961373](https://support.microsoft.com/kb/961373) 中找到文件信息详细资料。
...
<tr>
<td style="border:1px solid black;">
带 DirectX 8.1 的 Microsoft Windows 2000 Service Pack
</td>
<td style="border:1px solid black;">
**严重**  
**远程执行代码**
...
<tr class="alternateRow">
<td style="border:1px solid black;">
带 DirectX 9.0 的 Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2\*
</td>
<td style="border:1px solid black;">
**严重**  
**远程执行代码**
...
<tr>
<td style="border:1px solid black;">
带 DirectX 9.0 的 Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2\*
</td>
<td style="border:1px solid black;">
**严重**  
**远程执行代码**
...
<tr class="alternateRow">
<td style="border:1px solid black;">
带 DirectX 9.0 的 Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2\*
</td>
<td style="border:1px solid black;">
**严重**  
**远程执行代码**
...
<tr>
<td style="border:1px solid black;">
带 DirectX 9.0 的 Windows Server 2003 SP1（用于基于 Itanium 的系统）和 Windows Server 2003 SP2（用于基于 Itanium 的系统）\*
</td>
<td style="border:1px solid black;">
**严重**  
**远程执行代码**
...
Microsoft DirectShow 处理受支持格式文件的方式中存在一个远程执行代码漏洞。 如果用户打开特制的 MJPEG 文件，此漏洞可能允许执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0084](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0084)。

#### MJPEG 解压缩漏洞 (CVE-2009-0084) 的缓解因素
...
#### MJPEG 解压缩漏洞 (CVE-2009-0084) 的变通办法
...
-   **禁用 Quartz.dll 中 MJPEG 内容的解码**
    ...
    **使用交互方法**
    ...
    2.  找到并随后单击下列注册表子项： HKEY\_CLASSES\_ROOT\\CLSID\\{301056D0-6DFF-11D2-9EEB-006008039E37}
    3.  单击“**文件**”菜单并选择“**导出**”。
    4.  在“导出注册表文件”对话框中，键入 **MJPEG\_Decoder\_Backup.reg**，然后单击“**保存**”。  
    ...
    **如何撤消变通方法。**
    ...
    1.  单击“**开始**”，单击“**运行**”，在“**打开**”框中键入 **Regedit**，然后单击“**确定**”。
    2.  单击“**文件**”菜单并选择“**导入**”。
    3.  在“导入注册表文件”对话框中，选择 **MJPEG\_Decoder\_Backup.reg**，然后选择“**打开**”。
...
**攻击者如何利用此漏洞？**  
此漏洞要求用户打开特制的 MJPEG 文件，或者从网站或提供 Web 内容的任何应用程序接收特制的流式内容。
...
**此更新有什么作用？**  
此更新通过更正 DirectShow 解压缩媒体文件的方式来解决问题。
...
<td style="border:1px solid black;">对于带 DirectX 8.1 的 Microsoft Windows 2000 Service Pack 4：<br />
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/961373">Microsoft 知识库文章 961373</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">在不重新启动的情况下安装</td>
<td style="border:1px solid black;">对于带 DirectX 9.0、DirectX 9.0a、DirectX 9.0b 或 DirectX 9.0c 的 Windows XP Service Pack 3 的所有受支持的 32 位版本：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB961373$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/961373">Microsoft 知识库文章 961373</a></td>
...
-   [Kryptos Logic](https://www.kryptoslogic.com/) 的 Piotr Bania 报告了 MJPEG 解压缩漏洞 (CVE-2009-0084)

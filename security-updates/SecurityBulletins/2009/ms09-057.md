...
|---------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=b34d94b5-b828-4e16-a636-04344c60d945)                  | 远程执行代码 | 重要         | [MS06-053](http://go.microsoft.com/fwlink/?linkid=70257) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=768fd74e-0a2f-4353-ac22-65d0d6321739) | 远程执行代码 | 重要         | [MS06-053](http://go.microsoft.com/fwlink/?linkid=70257) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2507](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2507)。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 969059](http://support.microsoft.com/kb/969059)                                          |  
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969059">Microsoft 知识库文章 969059</a></td>
</tr>  
<tr class="even">
...
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) 的 Yamata Li 报告了索引服务内存损坏漏洞 (CVE-2009-2507)

...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1138)。
...
-   **对 Microsoft Windows 2000 服务器禁用匿名 LDAP 访问**
    ...
    对 Microsoft Windows 2000 服务器禁用匿名 LDAP 访问仅会将对此漏洞的利用限制为经验证的用户。 有关 LDAP NULL 基本（匿名）连接的详细信息，包括禁用这些连接的影响描述，请参阅 [Microsoft 知识库文章 837964](http://support.microsoft.com/kb/837964)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1139](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1139)。
...
**什么是 LDAP over SSL (LDAPS)？**    
默认情况下，LDAP 流量被不安全地进行传输。 但是，可以使用安全套接字层 (SSL)/传输层安全性 (TLS) 技术确保 LDAP 流量的机密性和安全性。 管理员可以通过从 Microsoft 证书颁发机构 (CA) 或非 Microsoft CA 安装正确设置了格式的证书来启用 LDAP over SSL (LDAPS)。 有关详细信息，请参阅 [Microsoft 知识库文章 321051](http://support.microsoft.com/kb/321051)。
...
ADAM 是一种轻型目录访问协议 (LDAP) 目录服务，作为用户服务运行，而非作为系统服务运行。 有关详细信息，请参阅 TechNet 文章“[ADAM 概念？](http://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true)”。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 969805](http://support.microsoft.com/kb/969805)                                          |  
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/970437">Microsoft 知识库文章 970437</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969805">Microsoft 知识库文章 969805</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Joshua J. Drake 报告了 Active Directory 无效释放漏洞 (CVE-2009-1138)
-   [Beaverton School District](http://www.beaverton.k12.or.us/home/) 的 Justin Wyatt 报告了 Active Directory 内存泄漏漏洞 (CVE-2009-1139)

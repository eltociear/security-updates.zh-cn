---
TOCTitle: 'MS09-018'
Title: 'Microsoft 安全公告 MS09-018 - 严重'
ms:assetid: 'ms09-018'
ms:contentKeyID: 61237469
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-018(v=Security.10)'
---
...
对于 Microsoft Windows 2000 Server 的所有受支持版本，此安全更新等级为“严重”；对于 Windows XP Professional 和 Windows Server 2003 的支持版本，此安全更新等级为“重要”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过更正 LDAP 服务在处理特制 LDAP 或 LDAPS 请求时分配和释放内存的方式，来解决此漏洞。
...
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=128125">MS08-060</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional Service Pack 2 和 Windows XP Professional Service Pack 3</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cb2c9b76-0c65-4754-9941-d45a7c74a29a">Active Directory 应用程序模式 (ADAM)</a> <br />
(KB970437)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=111953">MS08-035</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2ef3aaf0-a2a9-4c17-99ab-a0dc3d3f7e86">Active Directory 应用程序模式 (ADAM)</a> <br />
(KB970437)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=111953">MS08-035</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f6f99957-f74f-4446-8734-a468283eebae">Active Directory 应用程序模式 (ADAM)</a> <br />
(KB970437)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=111953">MS08-035</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1a2badc7-c0a5-4032-a009-73ebe9d76313">Active Directory 应用程序模式 (ADAM)</a> <br />
(KB970437)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=111953">MS08-035</a></td>
...
<th style="border:1px solid black;">Active Directory 无效释放漏洞 - CVE-2009-1138</th>
<th style="border:1px solid black;">Active Directory 内存泄漏漏洞 - CVE-2009-1139</th>
<th style="border:1px solid black;">综合严重等级</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">安装在 Windows XP Professional Service Pack 2 和 Windows XP Professional Service Pack 3 上的 Active Directory 应用程序模式 (ADAM)</td>
...
<tr class="odd">
<td style="border:1px solid black;">安装在 Windows XP Professional x64 Edition Service Pack 2 上的 Active Directory 应用程序模式 (ADAM)</td>
<td style="border:1px solid black;">不适用</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
拒绝服务</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">安装在 Windows Server 2003 Service Pack 2 上的 Active Directory 应用程序模式 (ADAM)</td>
<td style="border:1px solid black;">不适用</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
拒绝服务</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">安装在 Windows Server 2003 x64 Edition Service Pack 2 上的 Active Directory 应用程序模式 (ADAM)</td>
<td style="border:1px solid black;">不适用</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
拒绝服务</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
...
Active Directory 无效释放漏洞 - CVE-2009-1138  
---------------------------------------------
  
  
Microsoft Windows 2000 Server 上的 Active Directory 实施中存在一个远程执行代码漏洞。 该漏洞是由在处理特制 LDAP 或 LDAPS 请求时不正确释放内存导致的。 成功利用此漏洞的攻击者可以完全控制受影响的系统。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1138](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1138)。
  
#### Active Directory 无效释放漏洞 (CVE-2009-1138) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。
  
#### Active Directory 无效释放漏洞 (CVE-2009-1138) 的变通办法
...
-   **在防火墙处阻止 TCP 端口 389、636、3268 和 3269**
    ...
    这些端口用于启动与受影响组件的连接。 将其阻止在企业防火墙处（入站和出站），有助于保护位于防火墙后面的系统免受利用此漏洞进行的攻击。 端口 389 和 636 分别提供 LDAP 和安全 LDAP 服务，而端口 3268 和 3269 供全局编录服务器使用，该服务器还处理 LDAP 请求。
  
    Microsoft 建议阻塞所有来自 Internet 的未经请求的入站通信，以帮助阻止可能使用其他端口进行的攻击。 有关端口的详细信息，请参阅 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。 有关 Windows 防火墙的详细信息，请参阅[如何在单台计算机上配置 Windows 防火墙](https://www.microsoft.com/technet/security/smallbusiness/prodtech/windowsxp/cfgfwall.mspx)。
  
-   **对 Microsoft Windows 2000 服务器禁用匿名 LDAP 访问**
  
    对 Microsoft Windows 2000 服务器禁用匿名 LDAP 访问仅会将对此漏洞的利用限制为经验证的用户。 有关 LDAP NULL 基本（匿名）连接的详细信息，包括禁用这些连接的影响描述，请参阅 [Microsoft 知识库文章 837964](https://support.microsoft.com/kb/837964)。
  
#### Active Directory 无效释放漏洞 (CVE-2009-1138) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
LDAP 服务在处理特制的 LDAP 或 LDAPS 请求后不正确地释放内存。
...
默认情况下，LDAP 流量被不安全地进行传输。 但是，使用安全套接字层 (SSL)/传输层安全 (TLS) 技术可以防止 LDAP 流量泄密并保护其不会被修改。 管理员可以通过从 Microsoft 证书颁发机构 (CA) 或非 Microsoft CA 安装正确设置了格式的证书来启用 LDAP over SSL (LDAPS)。 有关详细信息，请参阅 Microsoft 知识库文章 321051。
  
**LDAP over SSL 默认情况下是否可用？**    
否。 在 LDAP 服务器可以参与 SSL 会话之前，管理员必须已经获得了数字证书并在服务器上安装它。 除非完成这些操作，否则 LDAP over SSL 不可用。
  
**如何确认服务器是否在运行 LDAP 服务？**    
要确认服务器是否正在侦听 LDAP 或 LDAPS 查询，请从管理员命令提示符处运行下列命令，并查看其是否正在侦听 LDAP 端口 (389) 或 LDAPS 端口 (636)，或者全局编录服务器端口（3268 或 3269）：  
netstat –a  
...
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以使用管理员特权运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建新帐户。
  
**攻击者如何利用此漏洞？**    
攻击者可能通过向运行 Microsoft Windows 2000 的域控制器发送特制的 LDAP 或 LDAPS 数据包来利用该漏洞。任何可以访问目标网络的匿名用户均可以向受影响的系统传递特制网络数据包以便利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**    
LDAP 是 Active Directory 所必需的。 任何角色作为 Active Directory 服务器运行 Microsoft Windows 2000 Server 的服务器均受此漏洞影响。
  
**此更新有什么作用？**    
此更新通过更正 LDAP 服务在处理特制客户端 LDAP 或 LDAPS 请求时释放内存的方式，来解决此漏洞。
...
Active Directory 内存泄漏漏洞 - CVE-2009-1139  
---------------------------------------------
  
  
Microsoft Windows 2000 Server 和 Windows Server 2003 上的 Active Directory 实施中存在一个拒绝服务漏洞。安装在 Windows XP Professional 和 Windows Server 2003 上的 Active Directory 应用程序模式 (ADAM) 的实施中也存在该漏洞。该漏洞是由于在执行某些类型的 LDAP 或 LDAPS 请求时未适当管理内存导致的。 成功利用此漏洞的攻击者可能会导致受影响服务器停止响应。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1139](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1139)。
  
#### Active Directory 内存泄漏漏洞 (CVE-2009-1139) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。
  
#### Active Directory 内存泄漏漏洞 (CVE-2009-1139) 的变通办法
...
-   **在防火墙处阻止 TCP 端口 389、636、3268 和 3269**
    ...
    这些端口用于启动与受影响组件的连接。 将其阻止在企业防火墙处（入站和出站），有助于保护位于防火墙后面的系统免受利用此漏洞进行的攻击。
...
#### Active Directory 内存泄漏漏洞 (CVE-2009-1139) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个拒绝服务漏洞。 利用此漏洞的攻击者可能会导致受影响系统停止响应并要求系统重新启动。 请注意，虽然攻击者无法利用拒绝服务漏洞来执行代码或提升他们的用户权限，但此漏洞可能导致受影响的系统停止接受请求。
  
**造成漏洞的原因是什么？**    
LDAP 服务在执行包含特定 OID 筛选器的 LDAP 或 LDAPS 请求时未正确管理内存。
  
**什么是 LDAP？**    
轻型目录访问协议 (LDAP) 是旨在提供对分布式目录访问的一种开放网络协议标准。
  
**什么是 LDAP over SSL (LDAPS)？**    
默认情况下，LDAP 流量被不安全地进行传输。 但是，可以使用安全套接字层 (SSL)/传输层安全性 (TLS) 技术确保 LDAP 流量的机密性和安全性。 管理员可以通过从 Microsoft 证书颁发机构 (CA) 或非 Microsoft CA 安装正确设置了格式的证书来启用 LDAP over SSL (LDAPS)。 有关详细信息，请参阅 [Microsoft 知识库文章 321051](https://support.microsoft.com/kb/321051)。
...
**什么是 OID 筛选器？**    
OID 或对象标识符用于命名 LDAP 对象。 LDAP 查询可以包含一个筛选器，以从 LDAP 名称空间中选择仅与特定 OID 相符的数据。
  
**什么是 Active Directory 应用程序模式 (ADAM)？**    
ADAM 是一种轻型目录访问协议 (LDAP) 目录服务，作为用户服务运行，而非作为系统服务运行。 有关详细信息，请参阅 TechNet 文章“[ADAM 概念？](https://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true)”。
  
**Active Directory 轻型目录服务 (AD LDS) 是否受此漏洞影响？**    
Active Directory 轻型目录服务是 Active Directory 的独立模式，可为应用程序提供专用目录服务。 AD LDS 当前仅用于 Microsoft Windows Server 2008 操作系统，不受此漏洞影响。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可能导致受影响的系统停止响应并且需要重新启动。
  
**攻击者如何利用此漏洞？**    
攻击者可能通过向 Active Directory 或 ADAM 服务器发送特制的 LDAP 或 LDAPS 数据包来尝试利用该漏洞。 对于 Microsoft Windows 2000 Server，任何可以访问目标网络的匿名用户均可以向受影响的系统传递特制网络数据包以便利用此漏洞。 在 Windows Server 2003 或安装了 ADAM 的系统上，攻击者必须具有有效的身份验证凭据才能利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**    
轻型目录访问协议 (LDAP) 是 Active Directory 和 ADAM 所必需的。 因此，作为 Active Directory 或 ADAM 服务器运行的任何系统均受此漏洞影响。
  
**此更新有什么作用？**    
此更新通过更正 LDAP 服务在处理特制 LDAP 或 LDAPS 请求时分配内存的方式，来解决此漏洞。
...
#### 带 Active Directory 的 Windows 2000 Server Service Pack 4：
...
| **部署**                         |                                                                                                                       |  
| 没有用户干预的安装               | Windows2000-KB969805-x86-ENU /quiet                                                                                   |  
| 在不重新启动的情况下安装         | Windows2000-KB969805-x86-ENU /norestart                                                                               |  
| 更新日志文件                     | kb969805.log                                                                                                          |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节                                                                                  |  
| **重新启动要求**                 |                                                                                                                       |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                                |  
| HotPatching                      | 不适用                                                                                                                |  
| **删除信息**                     | 使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB969805$\\Spuninst 文件夹中的 Spuninst.exe 实用程序 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 969805](https://support.microsoft.com/kb/969805)                                          |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB969805\\Filelist                             |
...
#### 带 Active Directory 应用程序模式 (ADAM) 的 Windows XP Professional（所有版本）
...
<td style="border:1px solid black;">对于带 ADAM 的 Windows XP Professional Service Pack 2 和带 ADAM 的 Windows XP Professional Service Pack 3：<br />
WindowsXP-KB970437-x86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于带 ADAM 的 Windows XP Professional x64 Edition Service Pack 2:<br />
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB970437$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/970437">Microsoft 知识库文章 970437</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于带 ADAM 的 Windows XP 所有受支持的 32 位版本：<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB970437\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于带 ADAM 的 Windows XP 所有受支持的基于 x64 的版本：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB969805$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/969805">Microsoft 知识库文章 969805</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
#### 带 Active Directory 应用程序模式 (ADAM) 的 Windows Server 2003（所有版本）
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Joshua J. Drake 报告了 Active Directory 无效释放漏洞 (CVE-2009-1138)
-   [Beaverton School District](https://www.beaverton.k12.or.us/home/) 的 Justin Wyatt 报告了 Active Directory 内存泄漏漏洞 (CVE-2009-1139)

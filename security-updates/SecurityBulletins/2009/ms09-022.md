...
**已知问题。**  [Microsoft 知识库文章 961501](https://support.microsoft.com/kb/961501) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=86378753-db24-44c2-a27d-cc0239f40ab8)                                                                           | 远程执行代码 | 严重         | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=f2119aca-a98e-4810-be52-f38241443baf)                                                          | 特权提升     | 中等         | 无                                                       |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=22699d09-1e68-456a-8733-bfad6667ebf5)                                                              | 特权提升     | 中等         | 无                                                       |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=865414f8-3f77-4fee-acc6-6684a3dc0aa4)                                                                              | 特权提升     | 中等         | 无                                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=197a6cc7-4ba3-4d2e-b621-0ef3da645ef2)                                                                  | 特权提升     | 中等         | 无                                                       |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=719efd62-fb33-447d-b6dd-2aaafbbad881)                                                              | 特权提升     | 中等         | 无                                                       |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3ad8f037-2434-4dea-bfc3-9d3b4008b828)                                     | 特权提升     | 重要         | 无                                                       |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=85c317cd-2a14-4747-9f50-3af3ddd3ae1b) | 特权提升     | 重要         | 无                                                       |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0f18356d-9f09-4d24-8361-970c0d1ccac4)\*                   | 特权提升     | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7d0a6e8d-a31d-4f3d-a7d7-e61215bfebed)\*         | 特权提升     | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=bbac3deb-6c93-45aa-832c-02b915ac7f44)   | 特权提升     | 重要         | 无                                                       |
...
是。 除了本公告的“漏洞信息”部分所列出的更改外，此安全更新还限制分隔符文件和 @F*pathname* 嵌入文件应位于的路径。 在安装更新之前，用户可以从任何位置应用具有嵌入文件的分隔页。 安装此更新后，系统只会打印驻留在受限制位置的具有嵌入文件的分隔页。 有关这些文件的正确位置的详细信息，请参阅 [Microsoft 知识库文章 102712](https://support.microsoft.com/kb/102712)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0228](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0228)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0229](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0229)。
...
**什么是分隔页？**  
分隔页或标题页通常说明谁将文件发送至打印机及提供打印日期和时间。 您可以使用标准分隔页之一或创建自定义页。 Windows 提供了三个分隔页文件，位于 %systemroot%\\System32 文件夹中。 有关详细信息，请参阅 TechNet 文章[使用分隔页](https://technet.microsoft.com/en-us/library/cc737357.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0230](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0230)。
...
**什么是 DLL？**  
动态链接库 (DLL) 是一个模块，其中包含其他模块（应用程序或 DLL）可以使用的函数和数据。 DLL 可以定义两类函数： 导出的函数和内部函数。 导出的函数往往由其他模块调用，以及从定义这些函数的 DLL 中被调用。 内部函数通常仅从定义这些函数的 DLL 中被调用。 虽然 DLL 可以导出数据，但是其数据通常仅由其函数使用。 但是，没有什么可阻止其他模块读取或写入该地址。 DLL 提供了一种模块化应用程序的方式，这样可以更轻松地更新和重新使用其功能。 DLL 还可以在许多应用程序同时使用相同的功能时帮助减少内存开销，原因在于虽然每个应用程序收到其自身的 DLL 数据副本，但是应用程序会共享 DLL 代码。 有关详细信息，请参阅 MSDN 文章“[动态链接库](https://msdn.microsoft.com/en-us/library/ms682589.aspx)”。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 961501](https://support.microsoft.com/kb/961501)                                          |  
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/961501">Microsoft 知识库文章 961501</a></td>
</tr>  
<tr class="even">
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Jun Mao 报告了打印后台处理程序中的缓冲区溢出漏洞 (CVE-2009-0228)

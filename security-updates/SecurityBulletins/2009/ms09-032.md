---
TOCTitle: 'MS09-032'
Title: 'Microsoft 安全公告 MS09-032 - 严重'
ms:assetid: 'ms09-032'
ms:contentKeyID: 61237483
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-032(v=Security.10)'
---
...
发布时间: 2009年7月14日 | 更新时间: 2009年7月23日
...
对于 Windows XP 的所有受支持版本，此安全更新的等级为“严重”；对于 Windows Server 2003 的所有受支持版本，此安全更新的等级为“中等”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过设置 kill bit 以使存在漏洞的控件不在 Internet Explorer 中运行来消除漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面的常见问题 (FAQ) 小节。

此安全更新也解决了 [Microsoft 安全通报 972890](https://technet.microsoft.com/security/advisory/972890) 中最初描述的漏洞。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=89d941f0-3f71-46e3-8096-716561396b72)                                                                           | 无           | None\*\*     | 无                                                        |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=24701af8-b87e-4e85-9463-f50755a1b6ad)                                                          | 远程执行代码 | 严重         | [MS08-032](https://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2cbf3699-7f79-4006-99e9-0a4c0d394c48)                                                              | 远程执行代码 | 严重         | [MS08-032](https://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b0a458d6-c34c-41c7-964a-c130cfcb0d01)                                                                              | 远程执行代码 | 中等         | [MS08-032](https://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8b7a7bb0-80ef-4f25-bc70-3d0ac06007c5)                                                                  | 远程执行代码 | 中等         | [MS08-032](https://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=7be36edf-02af-402f-983a-f9ca8128b6b5)                                                              | 远程执行代码 | 中等         | [MS08-032](https://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6c90240e-c201-4dad-9835-ea71e3527b45)                                     | 无           | None\*\*     | 无                                                        |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d2084e8d-212b-4c39-9163-a71ec6d1b1c7) | 无           | None\*\*     | 无                                                        |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2\*](https://www.microsoft.com/download/details.aspx?familyid=0194f994-5821-4fb9-b9e1-ed6af248c995)                   | 无           | None\*\*     | 无                                                        |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2\*](https://www.microsoft.com/download/details.aspx?familyid=4127b125-fdaa-489a-a80c-14b5647ac7e0)         | 无           | None\*\*     | 无                                                        |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4082c776-318c-4e0c-83fc-2f3f472c039a)   | 无           | None\*\*     | 无                                                        |
...
**如果我应用了 Microsoft 安全通报 972890 中的变通办法，我是否需要安装此安全更新？**  
[Microsoft 安全通报 972890](https://technet.microsoft.com/security/advisory/972890)描述了阻止 Microsoft Video ActiveX 控件在 Internet Explorer 中运行的变通办法。 客户可以手动应用此变通办法，也可以自动使用 [Microsoft 知识库文章 972890](https://support.microsoft.com/kb/972890)中的“Microsoft 修复”解决方案来启用此变通办法。 使用任何一种方法应用此变通办法的客户不需要安装此安全更新。

无论是否应用了此变通办法，Windows Vista 和 Windows Server 2008 系统中均将提供此更新。 但是，如果安装 Windows Server 2008 时使用“服务器核心”安装选项，则此更新所解决的漏洞不会影响 Windows Server 2008 的受支持版本，并且将不会向这种服务器核心安装提供此更新。 如果已对 Microsoft Windows 2000、Windows XP 和 Windows Server 2003 系统应用变通办法，将不向它们提供此更新。 所有客户均可以安装此安全更新，不会有任何负面影响。

想要其 Microsoft Windows 2000、Windows XP 和 Windows Server 2003 系统获得此更新的客户必须通过删除变通办法“阻止 COM 对象在 Internet Explorer 中运行”中引用的注册表项，删除先前由变通办法应用的 kill bit设置。

**在安装此安全更新前，我是否需要撤消 Microsoft 安全通报 972890 中的变通办法？**  
在安装此更新之前，无论是手动应用此变通办法，还是自动使用 [Microsoft 知识库文章 972890](https://support.microsoft.com/kb/972890) 中的“Microsoft 修复”解决方案启用此变通办法，客户均不需要撤消 [Microsoft 安全通报 972890](https://technet.microsoft.com/security/advisory/972890) 中所述的变通办法。

**如果我安装此更新，然后撤消 Microsoft 安全通报 972890 中的变通办法，会发生什么情况？**  
在这种情况下，Windows Vista 和 Windows Server 2008 的客户安装此安全更新用于纵深防御，然后手动撤消 [Microsoft 安全通报 972890](https://technet.microsoft.com/security/advisory/972890) 中的变通办法，或者自动使用 [Microsoft 知识库文章 972890](https://support.microsoft.com/kb/972890) 中的“Microsoft 修复”解决方案禁用此变通办法。 这些客户将无法再阻止 Microsoft Video ActiveX 控件在 Internet Explorer 中运行，他们的系统也会很容易受到攻击。 此外，将不会再向这些系统提供此更新，因为未来的检测结果将使变通办法撤消的安装成功。

**ActiveX Kill Bit 的此累积性安全更新是否包含 Microsoft 安全通报 973472 中描述的 kill bit？**  
否，此更新不包含 [Microsoft 安全通报 973472](https://technet.microsoft.com/security/advisory/973472) 中描述的用于阻止 Office Web Components (OWC) 库在 Internet Explorer 中运行的 kill bit。要设置那些 kill bit，请遵循该通报的“变通办法”部分中的指导。

**ActiveX Kill Bit 的此累积性安全更新包含什么 kill bit？**  
ActiveX Kill Bit 的此累积性安全更新包含先前在 [MS08-023](https://technet.microsoft.com/security/bulletin/ms08-023)“ActiveX Kill Bit 的安全更新”、[MS08-032](https://technet.microsoft.com/security/bulletin/ms08-032)“ActiveX Kill Bit 的累积性安全更新”以及标题为“ActiveX Kill Bit 的更新汇总”的通报 [Microsoft 安全通报 953839](https://technet.microsoft.com/security/advisory/953839)、[Microsoft 安全通报 956391](https://technet.microsoft.com/security/advisory/956391)、[Microsoft 安全通报 960715](https://technet.microsoft.com/security/advisory/960715) 和 [Microsoft 安全通报 969898](https://technet.microsoft.com/security/advisory/969898) 中发布所有 kill bit。
...
<td style="border:1px solid black;">None**<br />
</td>
...
Microsoft Video ActiveX 控件 msvidctl.dll 中存在远程执行代码漏洞。攻击者可以通过构造特制网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。
...
-   使用 Windows Vista 或 Windows Server 2008 的客户不会受到影响，因为将数据传送到 Internet Explorer 内此控件的能力已受到限制。  
...
-   **阻止 COM 对象在 Internet Explorer 中运行**
    ...
    **注意** “**Microsoft Video ActiveX 控件漏洞(CVE-2008-0015) 的常见问题**”小节的“此更新有什么作用？”之下介绍了类标识符和 ActiveX 对象所在的对应文件。 使用本部分中找到的类标识符替换下列 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}。
...
**造成漏洞的原因是什么？**    
当 Microsoft Video ActiveX 控件在 Internet Explorer 中实例化时，此控件可能破坏系统状态，使攻击者可以运行任意代码。
  
**什么是 Microsoft Video ActiveX 控件？**  
Microsoft 视频控件对象是一种连接 Microsoft DirectShow 筛选器用于捕获、录制和播放视频的 Microsoft ActiveX 控件。 它是 Microsoft Windows Media Center 用于创建筛选图形以录制和播放电视视频的主组件。
...
**此更新有什么作用？**    
Microsoft Video ActiveX 控件从不在 Internet Explorer 中实例化，因此可以通过设置 msvidctl.dll 中类标识符的 kill bit 来禁用它：
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB973346$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB973346$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">Windows XP 所有受支持的 32 位版本：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB973346$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   V1.1（2009 年 7 月 15 日）： 阐明了关于 Microsoft 安全通报 972890 中的变通办法的一个常见问题，添加了关于 Microsoft 安全通报 973472 的一个常见问题，并添加了关于此公告中包含的 kill bit 的一个常见问题。  
-   V1.2（2009 年 7 月 23 日）： 阐明了关于此更新中包含的特定于 Microsoft 的 kill bit 的常见问题。

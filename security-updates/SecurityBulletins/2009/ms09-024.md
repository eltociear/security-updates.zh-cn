...
本公告 MS09-024 中的 Microsoft Works 8.5 (KB967043) 和 Microsoft Works 9 (KB967044) 安全更新包也解决了 [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704) 中的漏洞。安装了 Microsoft Works 8.5 或 Microsoft Works 9 的用户只需安装该安全更新包一次。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1533](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1533)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/957838">Microsoft 知识库文章 957838</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/957646">Microsoft 知识库文章 957646</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/968326">Microsoft 知识库文章 968326</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969559">Microsoft 知识库文章 969559</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Works 8.5：<br />
请参阅 <a href="http://support.microsoft.com/kb/967043">Microsoft 知识库文章 967043</a><br />  
<br />  
对于 Microsoft Works 9：<br />
请参阅 <a href="http://support.microsoft.com/kb/967044">Microsoft 知识库文章 967044</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [NGS Software](http://www.ngssoftware.com/) 的 Shaun Colley 报告了文件转换器缓冲区溢出漏洞 (CVE-2009-1533)。

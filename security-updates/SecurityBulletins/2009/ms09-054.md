---
TOCTitle: 'MS09-054'
Title: 'Microsoft 安全公告 MS09-054 - 严重'
ms:assetid: 'ms09-054'
ms:contentKeyID: 61237505
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-054(v=Security.10)'
---
...
此安全更新通过修改 Internet Explorer 处理数据流标题、验证参数以及处理内存中对象的方式来解决这些漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面的常见问题 (FAQ) 小节。
...
此安全更新包括一处纵深防御更改，允许 WinINET 使用验证的扩展保护。 有关详细信息，请参阅 [Microsoft 安全通报 973811](https://technet.microsoft.com/security/advisory/973811)。

此更新还包括一处对 Windows 7 和 Windows Server 2008 R2 上的 Internet Explorer 8 的纵深防御更改以解决 [Microsoft 安全通报 973882](https://technet.microsoft.com/security/advisory/973882) 中披露的问题。 对于使用此通报中描述的 ATL 版本开发的组件和控件，这些更改减轻了 Internet Explorer 8 中的已知攻击媒介的影响。

**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 974455](https://support.microsoft.com/kb/974455) 中找到文件信息详细资料。
...
<th>
数据流标题损坏漏洞 - CVE-2009-1547
</th>
<th>
HTML 组件处理漏洞 - CVE-2009-2529
</th>
<th>
未初始化的内存损坏漏洞 - CVE-2009-2530
</th>
<th>
未初始化的内存损坏漏洞 - CVE-2009-2531
</th>
<th>
综合严重等级
</th>
...
Internet Explorer 在特定情况下处理数据流标题的方式中存在一个远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1547](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1547)。

#### 数据流标题损坏漏洞 (CVE-2009-1547) 的缓解因素
...
#### 数据流标题损坏漏洞 (CVE-2009-1547) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 数据流标题损坏漏洞 (CVE-2009-1547) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成漏洞的原因是什么？**  
Internet Explorer 处理特制的数据流标题时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
**此更新有什么作用？**  
此更新修改了 Internet Explorer 处理数据流标题的方式。
...
Internet Explorer 在特定情况下处理变量的参数验证的方式中存在一个远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2529](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2529)。

#### HTML 组件处理漏洞 (CVE-2009-2529) 的缓解因素
...
#### HTML 组件处理漏洞 (CVE-2009-2529) 的变通办法
...
-   **在 Internet Explorer 中禁用 XAML 浏览器应用程序**
    ...
    通过更改设置，以在 Internet 和本地 Intranet 安全区域中运行 XAML 浏览器应用程序之前进行提示或完全禁用 XAML 浏览器应用程序，可帮助防止利用此漏洞。 为此，请执行以下步骤：
    ...
    **变通办法的影响。** 在运行 XAML 浏览器应用程序之前提示有负面影响。 Internet 或 Intranet 上的许多网站都使用 XAML 浏览器应用程序来提供附加功能。 例如，在线电子商务站点或银行站点可能使用 XAML 浏览器应用程序来提供菜单、订购单乃至帐户报表。 在运行 XAML 浏览器应用程序之前给出提示是一个全局设置，它影响所有 Internet 和 Intranet 站点。 在启用此变通方法后，将会频繁出现提示。 对于每一提示，如果您认为信任您所访问的站点，则单击“**是**”运行 XAML 浏览器应用程序。 如果您不想在访问所有这些网站时进行提示，请使用“将您信任的站点添加到 Internet Explorer 的“受信任的站点”区域”中概述的步骤。

    **将您信任的站点添加到 Internet Explorer 的“受信任的站点”区域**

    在将 Internet Explorer 设置为在 Internet 区域和本地 Intranet 区域运行 XAML 浏览器应用程序之前需要提示之后，可以将受信任的站点添加到 Internet Explorer 的“受信任的站点”区域。 这样，您就可以照常使用受信任的网站，同时又有助于防范非受信任站点上的此类攻击。 我们建议您只将信任的站点添加到“受信任的站点”区域。
...
#### HTML 组件处理漏洞 (CVE-2009-2529) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**造成漏洞的原因是什么？**  
Internet Explorer 在特定情况下不正确地验证了参数。 因此，特制网页可能以一种攻击者可以在登录用户的上下文中执行任意代码的方式显示。
...
**我当前运行的是 Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer。 这是否会缓解此漏洞的影响？**  
是。 [增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)是一组预先配置好的 Internet Explorer 设置，可以减小用户或管理员在服务器上下载并运行特制 Web 内容的可能性。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 另请参阅[管理 Internet Explorer 增强安全配置](https://go.microsoft.com/fwlink/?linkid=92055)。

**此更新有什么作用？**  
此更新修改了 Internet Explorer 验证参数的方式。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-2529](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2529)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2530](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2530)。

#### 未初始化的内存损坏漏洞 (CVE-2009-2530) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2009-2530) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2009-2530) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2531](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2531)。

#### 未初始化的内存损坏漏洞 (CVE-2009-2531) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2009-2531) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 未初始化的内存损坏漏洞 (CVE-2009-2531) 的常见问题
...
**注意** 从 2009 年 8 月 1 日起，Microsoft 将不再对 Office Update 和 Office Update 清单工具提供支持。 要继续获得 Microsoft Office 产品的最新更新，请使用 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747)。 有关详细信息，请参阅[关于 Office 更新：常见问题](https://office.microsoft.com/en-us/downloads/fx010402221033.aspx)。
...
<td style="border:1px solid black;">对于所有受支持的 Windows 2000 版本上的 Internet Explorer 5.01 Service Pack 4：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或者 %Windir%\$NTUninstallKB974455-IE501SP4-20090901.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序<br />  
<br />  
对于所有受支持的 Windows 2000 版本上的 Internet Explorer 6 Service Pack 1：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或者 %Windir%\$NTUninstallKB974455-IE6SP1- 20090828.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/974455">Microsoft 知识库文章 974455</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 6：<br />
使用控制面板中的<strong>“添加或删除程序”</strong>工具或 %Windir%\$NTUninstallKB974455$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie7updates\KB974455-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie8updates\KB974455-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/974455">Microsoft 知识库文章 974455</a></td>
...
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB974455$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
-   [Google Inc.](https://www.google.com/) 的 Skylined 报告了数据流标题损坏漏洞 (CVE-2009-1547)  
-   [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了未初始化的内存损坏漏洞 (CVE-2009-2530)  
-   eshu.co.uk 的 Sam Thomas 与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/)一起报告了 未初始化的内存损坏漏洞 (CVE-2009-2531)

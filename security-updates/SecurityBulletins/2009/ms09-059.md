...
**已知问题。** [Microsoft 知识库文章 975467](https://support.microsoft.com/kb/975467) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法
...
\***<sup>[2]</sup>**该操作系统仅在安装了 KB968389“对身份验证的扩展保护”（请参阅 [Microsoft 安全通报 973811](https://support.microsoft.com/kb/973811)）时才受影响。 有关详细信息，请参阅**与此安全更新相关的常见问题 (FAQ)** 中的该条目。
...
**\*该操作系统仅在安装了 KB968389“对身份验证的扩展保护”（请参阅** [**Microsoft 安全通报 973811**](https://support.microsoft.com/kb/973811)**）时才受影响。** 有关详细信息，请参阅**与此安全更新相关的常见问题 (FAQ)** 中的该条目。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2524](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2524)。
...
-   **从 Windows XP 或 Windows Server 2003 计算机卸载 KB968389**
    ...
    **如何撤销变通办法。**通过从 [Microsoft 知识库文章 936389](https://support.microsoft.com/default.aspx/kb/968389?wa=wsignin1.0) 下载适用于您操作系统的安装包来安装 KB968389。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 已公开披露此漏洞的有限相关信息。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-2524](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2524)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/975467">Microsoft 知识库文章 975467</a></td>
</tr>  
<tr class="even">

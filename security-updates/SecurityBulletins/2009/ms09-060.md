...
**已知问题。** [Microsoft 知识库文章 973965](https://support.microsoft.com/kb/973965) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[MS08-015](https://go.microsoft.com/fwlink/?linkid=112113)
</td>
</tr>
...
**\*** Microsoft 建议 Microsoft Visio Viewer 2002 和 Microsoft Visio Viewer 2003 的用户升级到 [Microsoft Office Visio Viewer 2007 Service Pack 2](https://office.microsoft.com/en-us/downloads/cd102071301033.aspx)。
...
是，Microsoft Office Outlook 2007 Service Pack 1 和 Microsoft Office Outlook 2007 Service Pack 2 的更新程序包 (KB972363) 包括 [Microsoft 知识库文章 969907](https://support.microsoft.com/kb/969907) 中描述的对 Outlook 2007 的更改。
...
[Microsoft 知识库文章 973965](https://support.microsoft.com/kb/973965) 也包含这些 Microsoft 知识库文章的链接。
...
是，您需要安装第三方提供的更新控件（发布时）。 [MS09-034](https://go.microsoft.com/fwlink/?linkid=158199) Internet Explorer 缓解措施没有从根本上解决使用活动模板库开发的特定组件和控件内的漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/973702">Microsoft 知识库文章 973702</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/973705">Microsoft 知识库文章 973705</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Outlook 2007 所有受支持的版本：<br />
请参阅 <a href="https://support.microsoft.com/kb/972363">Microsoft 知识库文章 972363</a><br />  
<br />  
对于 Visio Viewer 2007 的所有受支持版本：<br />
请参阅 <a href="https://support.microsoft.com/kb/973709">Microsoft 知识库文章 973709</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>

...
**已知问题。** [Microsoft 知识库文章 961371](https://support.microsoft.com/kb/961371) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=1efbbd95-cd72-43df-b1ce-7e2b0c0cb9e2)                                                                           | 远程执行代码 | 严重         | [MS06-002](https://go.microsoft.com/fwlink/?linkid=55919) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b)                                                                                       | 远程执行代码 | 严重         | [MS06-002](https://go.microsoft.com/fwlink/?linkid=55919) |
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=6914167b-6961-480c-a4d4-808cd58a035b)                                                                                       | 远程执行代码 | 严重         | 无                                                       |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3b8b019e-e6d8-4ce2-8f1f-3a6399b252d1)                                                              | 远程执行代码 | 严重         | 无                                                       |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=018ef53d-f78e-4084-940d-7c86bf59d83c)                                                                              | 远程执行代码 | 严重         | 无                                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7f5fc902-f5d8-4a87-a73f-68632f9a0935)                                                                  | 远程执行代码 | 严重         | 无                                                       |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=7df0fce2-543c-4e82-85e6-012bfc8bf130)                                                              | 远程执行代码 | 严重         | 无                                                       |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c67d85c4-25c5-4821-8db9-91764888f893)                                     | 远程执行代码 | 严重         | 无                                                       |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3f8ae651-59f7-48e1-9e8c-8e07c6806964) | 远程执行代码 | 严重         | 无                                                       |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=91f6ee68-0e39-4ec3-b4cd-45f05404e2fb)\*                   | 远程执行代码 | 严重         | 无                                                       |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=5cdc3014-97b3-47b5-a6b7-cd0e12ec60e4)\*         | 远程执行代码 | 严重         | 无                                                       |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=03330a14-9cfa-4146-a3d3-4b7a76975d2d)   | 远程执行代码 | 严重         | 无                                                       |
...
有关此已知问题的详细信息，请参阅 [Microsoft 知识库文章 961371](https://support.microsoft.com/kb/961371)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0231](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0231)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0232)。
...
**什么是 Embedded OpenType (EOT) 字体？**    
Embedded OpenType (EOT) 字体是为在网页上使用而设计的一种小型字体。 这些字体可以嵌入在文档中。 这确保用户看到的文档正是作者希望他们看到的形式。 Web Embedding Fonts Tool (WEFT) 让 Web 作者能够创建链接到他们的网页的字体对象，以便通过浏览器查看时，页面以字体对象中包含的样式显示。 有关详细信息，请参阅 MSDN 文章“[关于字体嵌入](https://msdn.microsoft.com/en-us/library/ms533034.aspx)”。 “受影响的软件”表中列出的所有平台默认情况下都支持 EOT 字体呈现。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/961371">Microsoft 知识库文章 961371</a></td>
</tr>  
<tr class="even">
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 报告了 Embedded OpenType 字体堆溢出漏洞 (CVE-2009-0231)  

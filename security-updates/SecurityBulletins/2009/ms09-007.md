...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=bf7065bc-c183-4a78-8d46-72fe7385c07c)                                                                     | 欺骗         | 重要         | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=942d87f6-3cb1-4d36-a70a-70d9c34488f3)                                                                                 | 欺骗         | 重要         | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
...
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6d02306e-9e2e-4ae8-bd21-8a2c1a229472)                 | 欺骗         | 重要         | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0b3f6fdd-276e-4267-99d8-8f00d91ad6a2)                                  | 欺骗         | 重要         | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ce98ff55-f565-469d-bbd2-32b681faf908)                         | 欺骗         | 重要         | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=5ca3c72c-cadb-4b0a-b3a3-fb81d0bfd7b3) | 欺骗         | 重要         | [MS07-031](http://go.microsoft.com/fwlink/?linkid=91396) |
...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 960225](http://support.microsoft.com/kb/960225) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0085](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0085)。
...
-   客户可以实施 Active Directory 证书映射，该映射不受此漏洞影响。 Active Directory 证书映射使具有受信任公钥的用户可以访问域资源，而无需输入用户名和密码。 客户证书将被直接映射到 Active Directory 用户帐户。  
    有关配置证书映射的不同方法的详细信息，请参阅[将证书映射到用户帐户](http://technet.microsoft.com/en-us/library/cc736706.aspx)。
...
安全通道 (SChannel) 安全程序包是实现安全套接字层 (SSL) 和传输层安全 (TLS) Internet 标准身份验证协议的安全支持提供程序 (SSP)。 这些组件用于实施安全通信以支持多个公共 Internet 和网络应用程序（例如 web 浏览）。 SChannel 是安全程序包的一部分，它帮助提供身份验证服务以便在客户端和服务器之间提供安全的通信。 有关 SChannel 的详细信息，请访问 MSDN 上的[SChannel](http://msdn.microsoft.com/en-us/library/ms678421.aspx)网站。
...
这些协议在服务器和客户端系统之间提供加密连接。 当用户通过公共网络（如 Internet）进行连接时，SSL 可以帮助保护信息。 SSL 支持需要 SSL 证书，该证书必须安装在服务器上。 有关 SSL 的详细信息，请参阅 [XADM: 安全套接字层的作用](http://support.microsoft.com/default.aspx?scid=kb;en-us;q245152)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/960225">Microsoft 知识库文章 960225</a></td>
</tr>  
<tr class="even">
...
-   [Secretaria da Fazenda do Estado do Rio Grande do Sul](http://www.sefaz.rs.gov.br/) 报告了 SChannel 欺骗漏洞 (CVE-2009-0085)  
-   [Cia de Processamento de Dados do Estado do Rio Grande do Sul](http://www.procergs.rs.gov.br/) 报告了 SChannel 欺骗漏洞 (CVE-2009-0085)

---
TOCTitle: 'MS09-007'
Title: 'Microsoft 安全公告 MS09-007 - 重要'
ms:assetid: 'ms09-007'
ms:contentKeyID: 61237458
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-007(v=Security.10)'
---
...
此安全更新可解决 Windows 中的安全通道 (SChannel) 安全数据包中一个秘密报告的漏洞。 如果攻击者获得对最终用户用于身份验证的证书的访问，此漏洞可能允许欺骗。 只有当攻击者通过其他手段获得用于身份验证的证书公钥组件时，客户才会受到影响。
...
此安全更新通过修改服务器在 TLS 握手过程中分析密钥交换数据的方式来消除该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=bf7065bc-c183-4a78-8d46-72fe7385c07c)                                                                     | 欺骗         | 重要         | [MS07-031](https://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=942d87f6-3cb1-4d36-a70a-70d9c34488f3)                                                                                 | 欺骗         | 重要         | [MS07-031](https://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=942d87f6-3cb1-4d36-a70a-70d9c34488f3)                                                                                 | 欺骗         | 重要         | 无                                                       |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6d02306e-9e2e-4ae8-bd21-8a2c1a229472)                 | 欺骗         | 重要         | [MS07-031](https://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0b3f6fdd-276e-4267-99d8-8f00d91ad6a2)                                  | 欺骗         | 重要         | [MS07-031](https://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ce98ff55-f565-469d-bbd2-32b681faf908)                         | 欺骗         | 重要         | [MS07-031](https://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=5ca3c72c-cadb-4b0a-b3a3-fb81d0bfd7b3) | 欺骗         | 重要         | [MS07-031](https://go.microsoft.com/fwlink/?linkid=91396) |
| [Windows Vista 和 Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=21086a04-402a-4940-8358-7fa63508102b)                                                             | 欺骗         | 重要         | 无                                                       |
| [Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c75a2ea9-b42f-457b-be09-5c8fa0339388)                                     | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2008（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=47b361ce-624b-466c-b5c5-8703f6532615)\*                                                                   | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=5c81ac45-60e6-4121-ab6b-d3b3179aacc4)\*                                                              | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=bf8f5a86-1757-4f9b-b632-d4aa7005a9f8)                                                            | 欺骗         | 重要         | 无                                                       |
...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 960225](https://support.microsoft.com/kb/960225) 中找到文件信息详细资料。
...
<th style="border:1px solid black;">SChannel 欺骗漏洞 - CVE-2009-0085</th>
...
SChannel 欺骗漏洞 - CVE-2009-0085  
---------------------------------
  
  
使用基于证书的身份验证时，Microsoft Windows SChannel 身份验证组件中存在一个欺骗漏洞。 成功利用此漏洞的攻击者只需使用授权用户的数字证书而不用提供关联的私钥即可向服务器进行身份验证。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0085](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0085)。
  
#### SChannel 欺骗漏洞 (CVE-2009-0085) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   客户只有在用于身份验证的证书通过其他方式披露给攻击者时才会受到影响。 在有 IIS web 服务器的情况下，证书不会在身份验证过程中以明文形式传输。  
-   只有本地配置的用户帐户容易受到攻击。 将其应用程序的经过身份验证的证书用户映射到 Active Directory 域的客户不受此漏洞影响。
  
#### SChannel 欺骗漏洞 (CVE-2009-0085) 的变通方法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   客户可以实施 Active Directory 证书映射，该映射不受此漏洞影响。 Active Directory 证书映射使具有受信任公钥的用户可以访问域资源，而无需输入用户名和密码。 客户证书将被直接映射到 Active Directory 用户帐户。  
    有关配置证书映射的不同方法的详细信息，请参阅[将证书映射到用户帐户](https://technet.microsoft.com/en-us/library/cc736706.aspx)。
  
#### SChannel 欺骗漏洞 (CVE-2009-0085) 的常见问题
  
**此漏洞的影响范围有多大？**  
使用基于证书的身份验证时，Microsoft Windows SChannel 身份验证组件中存在一个欺骗漏洞。 成功利用此漏洞的攻击者可以使用用户身份验证凭据的公共组建模拟另一用户并通过受保护服务器的身份验证。
  
**造成漏洞的原因是什么？**  
SChannel 身份验证组件没有对特定的传输层安全 (TLS) 握手消息执行足够的验证以确保客户端实际上有权访问链接到用于身份验证的证书的私钥。
  
**什么是安全通道 (SChannel) 安全程序包？**  
安全通道 (SChannel) 安全程序包是实现安全套接字层 (SSL) 和传输层安全 (TLS) Internet 标准身份验证协议的安全支持提供程序 (SSP)。 这些组件用于实施安全通信以支持多个公共 Internet 和网络应用程序（例如 web 浏览）。 SChannel 是安全程序包的一部分，它帮助提供身份验证服务以便在客户端和服务器之间提供安全的通信。 有关 SChannel 的详细信息，请访问 MSDN 上的[SChannel](https://msdn.microsoft.com/en-us/library/ms678421.aspx)网站。
  
**什么是 x.509 数字证书？**  
使用公钥和私钥的加密技术需要公钥基本结构 (PKI) 来支持公钥的分发和认证。 数字证书软件包公钥、有关使用的算法的信息、所有者或主题数据、已验证主题数据的证书颁发机构的数字签名以及证书被视为有效的日期范围。
  
数字证书可由客户端（如 Internet Explorer）验证，以确保用户连接的服务器实际上是该主机名的合法服务器。 但是，证书也可以用作用户身份验证和授权的安全凭据。
  
**什么是 Microsoft 安全套接库？**  
Microsoft 安全套接字层库支持多种安全通信协议。 这些协议包括传输层安全 1.0 (TLS 1.0)、安全套接字层 3.0 (SSL 3.0)、较老且很少使用的安全套接字层 2.0 (SSL 2.0) 和专用通信技术 1.0 (PCT 1.0) 协议。
  
这些协议在服务器和客户端系统之间提供加密连接。 当用户通过公共网络（如 Internet）进行连接时，SSL 可以帮助保护信息。 SSL 支持需要 SSL 证书，该证书必须安装在服务器上。 有关 SSL 的详细信息，请参阅 [XADM: 安全套接字层的作用](https://support.microsoft.com/default.aspx?scid=kb;en-us;q245152)。
...
**什么是安全支持提供程序 (SSP)？**  
安全支持提供程序在传输层应用程序（如 Microsoft 远程过程调用 (RPC)）和安全提供程序（如 Windows 分布式安全）之间实施公用接口。 它通过向应用程序提供一个或多个安全程序包来完成此操作。 每个安全程序包都在应用程序的安全支持提供程序接口函数调用与实际安全协议的函数之间提供映射。 安全程序包支持安全协议，例如 Kerberos 身份验证和 Microsoft LAN Manager。
  
**攻击者可能利用此漏洞执行什么操作？**  
攻击者可以使用此漏洞通过受保护服务的身份验证并模拟授权用户，尽管他无权访问授权用户的密钥（这通常是在服务器被配置为要求客户身份验证时成功进行身份验证所需要的）。
  
**攻击者如何利用此漏洞？**  
攻击者需要获得对用户用于身份验证的实际证书的公共组建的访问权限。 然后他可以创建一个传输层安全 (TLS) 数据包，来绕过 SChannel 组件用于确保私钥在身份验证过程中实际存在的验证。
  
在最常见的部署中，用于客户身份验证的证书只在一个 Windows 客户端中配置了一个预期用途。 传输这些证书只有一个特定目的，例如 Web 验证。 在 SSL 连接 Internet 信息服务 (IIS) web 服务器的情况下，公钥从不以明文形式传输。 但是，在单个证书同时被用于客户身份验证和其他目的的情况下（例如电子邮件签名，或该证书被用于通过多个网站的身份验证），此公钥可能被更广泛地分发。
  
**受此漏洞威胁最大的系统有哪些？**  
此漏洞影响诸如使用基于证书的身份验证的 web 服务器等服务，并要求用户在身份验证过程中证明其拥有证书相应的私钥。
  
**此更新有什么作用？**  
此更新通过修改服务器在 TLS 握手过程中分析密钥交换数据的方式来消除该漏洞。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB960225$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/960225">Microsoft 知识库文章 960225</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB960225$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/960225">Microsoft 知识库文章 960225</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB960225$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/960225">Microsoft 知识库文章 960225</a></td>
...
-   [Secretaria da Fazenda do Estado do Rio Grande do Sul](https://www.sefaz.rs.gov.br/) 报告了 SChannel 欺骗漏洞 (CVE-2009-0085)  
-   [Cia de Processamento de Dados do Estado do Rio Grande do Sul](https://www.procergs.rs.gov.br/) 报告了 SChannel 欺骗漏洞 (CVE-2009-0085)

...
**已知问题。** [Microsoft 知识库文章 973812](https://support.microsoft.com/kb/973812) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2498](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2498)。

#### Windows 媒体标头分析无效释放漏洞 (CVE-2009-2498) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://msdn.microsoft.com/en-us/library/ms537180(vs.85).aspx)”的受限模式下运行。 此模式可减轻此漏洞。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此安全更新的“常见问题”部分。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2499](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2499)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/968816">Microsoft 知识库文章 968816</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Windows Media Format Runtime：<br />
请参阅 <a href="https://support.microsoft.com/kb/968816">Microsoft 知识库文章 968816</a><br />  
<br />  
对于 Windows Media Services：<br />
请参阅 <a href="https://support.microsoft.com/kb/972554">Microsoft 知识库文章 972554</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [NGS Software](https://www.ngssoftware.com/) 的 Peter Winter-Smith 报告了 Windows 媒体标头分析无效释放漏洞 (CVE-2009-2498)  

...
**已知问题。** [Microsoft 知识库文章 969514](http://support.microsoft.com/kb/969514) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
[Microsoft 知识库文章 969514](http://support.microsoft.com/kb/969514) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
本公告 MS09-027 中的 Microsoft Office 2004 for Mac (KB969661)、Microsoft Office 2008 for Mac (KB971822) 和 Open XML File Format Converter for Mac (KB971824) 安全更新包还解决了 [MS09-017](http://go.microsoft.com/fwlink/?linkid=141704) 和 [MS09-021](http://go.microsoft.com/fwlink/?linkid=147294) 中描述的漏洞。安装了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 或 Open XML File Format Converter for Mac 的用户只需安装这些安全更新包一次。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0563](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0563)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0565](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0565)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969600">Microsoft 知识库文章 969600</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969602">Microsoft 知识库文章 969602</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Word 2003：<br />
请参阅 <a href="http://support.microsoft.com/kb/969603">Microsoft 知识库文章 969603</a><br />  
<br />  
对于 Word Viewer 2003 和 Word Viewer：<br />
请参阅 <a href="http://support.microsoft.com/kb/969614">Microsoft 知识库文章 969614</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Word 2007：<br />
请参阅 <a href="http://support.microsoft.com/kb/969604">Microsoft 知识库文章 969604</a><br />  
<br />  
对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包：<br />
请参阅 <a href="http://support.microsoft.com/kb/969613">Microsoft 知识库文章 969613</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [team509](http://www.team509.com/) 的 Wushi 与[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Word 缓冲区溢出漏洞 (CVE-2009-0563)  
-   [VUPEN Security](http://www.vupen.com/) 的 Nicolas Joly 报告了 Word 缓冲区溢出漏洞 (CVE-2009-0565)

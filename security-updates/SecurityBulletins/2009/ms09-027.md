---
TOCTitle: 'MS09-027'
Title: 'Microsoft 安全公告 MS09-027 - 严重'
ms:assetid: 'ms09-027'
ms:contentKeyID: 61237478
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-027(v=Security.10)'
---
...
此更新通过修改 Word 打开和分析文件的方式来解决此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。

**建议。** Microsoft 建议用户立即应用此更新。

**已知问题。** [Microsoft 知识库文章 969514](https://support.microsoft.com/kb/969514) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7e205108-4c28-4cab-a4d0-4ed3fd696473)  
(KB969604)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office Word 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7e205108-4c28-4cab-a4d0-4ed3fd696473)  
(KB969604)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 1 的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
不适用
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 2 的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?familyid=63bd8f14-e736-46ce-af66-d30f17461e5a)  
(KB969613)
</td>
<td style="border:1px solid black;">
不适用
...
[Microsoft 知识库文章 969514](https://support.microsoft.com/kb/969514) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。

**MS09-017 和 MS09-021 也描述了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 和 Open XML File Format Converter for Mac 中的漏洞。 MS09-017 和 MS09-021 与此公告 (MS09-027) 有何关联？**  
本公告 MS09-027 中的 Microsoft Office 2004 for Mac (KB969661)、Microsoft Office 2008 for Mac (KB971822) 和 Open XML File Format Converter for Mac (KB971824) 安全更新包还解决了 [MS09-017](https://go.microsoft.com/fwlink/?linkid=141704) 和 [MS09-021](https://go.microsoft.com/fwlink/?linkid=147294) 中描述的漏洞。安装了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 或 Open XML File Format Converter for Mac 的用户只需安装这些安全更新包一次。
...
Microsoft Office Word Viewer 是 Word Viewer 2003 及 Word Viewer 的所有之前版本的替代品。 有关如何获得最新 Word Viewer 的详细信息，请参阅 [Microsoft 知识库文章 891090](https://support.microsoft.com/kb/891090)。
...
<th>
Word 缓冲区溢出漏洞 - CVE-2009-0563
</th>
<th>
Word 缓冲区溢出漏洞 - CVE-2009-0565
</th>
<th>
综合严重等级
</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0563](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0563)。

#### Word 缓冲区溢出漏洞 (CVE-2009-0563) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的 Office 文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问特制的网站。 相反，攻击者必须说服他们访问该网站，通常是让其单击指向攻击者网站的链接，然后诱使他们打开特制的 Office 文件。
-   此漏洞无法通过电子邮件自动加以利用。 用户必须打开电子邮件附件，以电子邮件为载体的攻击才会得逞。
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

#### Word 缓冲区溢出漏洞 (CVE-2009-0563) 的变通办法
...
#### Word 缓冲区溢出漏洞 (CVE-2009-0563) 的常见问题解答
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0565](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0565)。

#### Word 缓冲区溢出漏洞 (CVE-2009-0565) 的缓解因素
...
#### Word 缓冲区溢出漏洞 (CVE-2009-0565) 的变通办法
...
#### Word 缓冲区溢出漏洞 (CVE-2009-0565) 的常见问题解答
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/969600">Microsoft 知识库文章 969600</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/969602">Microsoft 知识库文章 969602</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Word 2003：<br />
请参阅 <a href="https://support.microsoft.com/kb/969603">Microsoft 知识库文章 969603</a><br />  
<br />  
对于 Word Viewer 2003 和 Word Viewer：<br />
请参阅 <a href="https://support.microsoft.com/kb/969614">Microsoft 知识库文章 969614</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
#### Word 2007（所有版本）以及用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Word 2007：<br />
请参阅 <a href="https://support.microsoft.com/kb/969604">Microsoft 知识库文章 969604</a><br />  
<br />  
对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包：<br />
请参阅 <a href="https://support.microsoft.com/kb/969613">Microsoft 知识库文章 969613</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2004 for 11.5.5 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
-   [team509](https://www.team509.com/) 的 Wushi 与[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Word 缓冲区溢出漏洞 (CVE-2009-0563)  
-   [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 报告了 Word 缓冲区溢出漏洞 (CVE-2009-0565)

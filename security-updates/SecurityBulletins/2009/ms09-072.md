...
此安全更新也解决了最初在 [Microsoft 安全通报 977981](https://technet.microsoft.com/security/advisory/977981) 中描述的漏洞。
...
是。 此安全更新 (976325) 包括 [Microsoft 知识库文章 976749](https://support.microsoft.com/kb/976749) 中描述的可解决 Microsoft 安全公告 [MS09-054](https://go.microsoft.com/fwlink/?linkid=163979) 中安全更新 974455 的已知问题的修补程序。

**此安全公告与 MS09-035 中描述的 ATL 问题有何关系？**  
Microsoft 安全公告 [MS09-035](https://go.microsoft.com/fwlink/?linkid=158131) 描述了使用活动模板库 (ATL) 的易受攻击公共版本开发的组件和控件中的漏洞。 此安全更新 (976325) 有助于为利用在 [Microsoft 安全通报 973882](https://technet.microsoft.com/security/advisory/973882) 和 MS09-035 中描述的 ATL 版本开发的这些组件和控件缓解 Internet Explorer 中的已知攻击平台。另请参阅下一部分**漏洞信息**中的 ATL COM 初始化漏洞 [CVE-2009-2493](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493)。

**此安全公告与 Microsoft 安全通报中描述的 ATL 问题有什么关系？**  
[Microsoft 安全通报 973882](https://technet.microsoft.com/security/advisory/973882) 描述活动模板库 (ATL) 的公用和专用版本中的漏洞。 此安全更新 (976325) 更新了用在 Microsoft 安全通报 973882 和 [MS09-035](https://go.microsoft.com/fwlink/?linkid=158131) 中描述的 ATL 版本开发的控件。另请参阅下一部分**漏洞信息**中的 ATL COM 初始化漏洞 [CVE-2009-2493](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2493)。
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 976325](https://support.microsoft.com/kb/976325) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3671](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3671)。
...
#### 未初始化的内存损坏漏洞 (CVE-2009-3671) 的变通办法
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3672](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672)。
...
-   **通过自动化“Microsoft 修复”为 Internet Explorer 6 或 Internet Explorer 7 启用 DEP**
    ...
    要使用自动化“**Microsoft 修复**”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 976325](https://support.microsoft.com/kb/976325)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-3672](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3672)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3673](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3673)。
...
#### 未初始化的内存损坏漏洞 (CVE-2009-3673) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2009-3673) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3674](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3674)。

#### 未初始化的内存损坏漏洞 (CVE-2009-3674) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2009-3674) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2009-3674) 的常见问题
...
<td style="border:1px solid black;">对于所有受支持的 Windows 2000 版本上的 Internet Explorer 5.01 Service Pack 4：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或者 %Windir%\$NTUninstallKB976325-IE501SP4-20091027.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序<br />  
<br />  
对于所有受支持的 Windows 2000 版本上的 Internet Explorer 6 Service Pack 1：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或者 %Windir%\$NTUninstallKB976325-IE6SP1-20091027.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/976325">Microsoft 知识库文章 976325</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB976325$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie7updates\KB976325-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie8updates\KB976325-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/976325">Microsoft 知识库文章 976325</a></td>
...
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB976325$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
-   eshu.co.uk 的 Sam Thomas 与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/)一起报告了 未初始化的内存损坏漏洞 (CVE-2009-3671)  
-   [team509](https://www.team509.com/) 与 [Verisign IDefense Labs](https://labs.idefense.com/) 共同工作，报告 HTML 对象内存损坏漏洞 (CVE-2009-3672)  
-   一名匿名研究人员与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了未初始化的内存损坏漏洞 (CVE-2009-3673)  
-   一名匿名研究人员与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了未初始化的内存损坏漏洞 (CVE-2009-3674)
...
-   V1.1（2009 年 12 月 9 日）： 纠正了“**与此安全更新相关的常见问题 (FAQ)**”部分中对 Microsoft 知识库文章 976749 的参考。 还纠正了“**安全更新部署**”部分中 Windows XP 所有受支持的基于 x64 版本的 Internet Explorer 7 更新的注册表项验证。

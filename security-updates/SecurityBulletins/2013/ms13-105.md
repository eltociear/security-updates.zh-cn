...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Exchange Server 2013 累积更新 2](https://www.microsoft.com/download/details.aspx?familyid=e5c9ecf5-e36f-4164-9960-c91d01a83521)  
(2880833)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[Microsoft Exchange Server 2013 累积更新 3](https://www.microsoft.com/download/details.aspx?familyid=35f891ce-8a0d-4d25-abe1-ea45ec81b4e0)  
(2880833)
</td>
<td style="border:1px solid black;">
远程执行代码
...
此更新解决两个漏洞： CVE-2013-5763 和 CVE-2013-5791，已在 [Oracle 重要修补程序更新通告 - 2013 年 10 月](https://www.oracle.com/technetwork/topics/security/cpuoct2013-1899837.html)中进行过讨论。
...
要在“常见漏洞和披露”列表中以标准条目查看这些漏洞，请参阅 [CVE-2013-5763](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5763) 和 [CVE-2013-5791](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5791)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2013-1330](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1330)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-5072](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5072)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2903911">Microsoft 知识库文章 2903911</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2903903">Microsoft 知识库文章 2903903</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2905616">Microsoft 知识库文章 2905616</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Microsoft Exchange Server 2010 Service Pack 3：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2880833">Microsoft 知识库文章 2880833</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>

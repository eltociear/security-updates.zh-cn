...
<td style="border:1px solid black;">
[MS13-053](https://go.microsoft.com/fwlink/?linkid=301423) 中的 2850851
</td>
</tr>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d9dec420-6a1c-45df-8cb1-115c9adff896)  
(2876315)
</td>
<td style="border:1px solid black;">
特权提升
...
| 漏洞标题            | CVE 编号                                                                         |
|---------------------|----------------------------------------------------------------------------------|
| Win32k 多重提取漏洞 | [CVE-2013-1341](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1341) |
| Win32k 多重提取漏洞 | [CVE-2013-1342](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1342) |
| Win32k 多重提取漏洞 | [CVE-2013-1343](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1343) |
| Win32k 多重提取漏洞 | [CVE-2013-1344](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1344) |
| Win32k 多重提取漏洞 | [CVE-2013-3864](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3864) |
| Win32k 多重提取漏洞 | [CVE-2013-3865](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3865) |
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3866](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3866)
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2876315">Microsoft 知识库文章 2876315</a></td>
</tr>  
<tr class="even">
...
| **文件信息**     | 请参阅 [Microsoft 知识库文章 2876315](https://support.microsoft.com/kb/2876315)                                                     |

...
<td style="border:1px solid black;">
[MS10-084](https://go.microsoft.com/fwlink/?linkid=201720) 中的 2360937
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=388a7f9f-4fbf-4de5-ae77-69d97d52553b)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<td style="border:1px solid black;">
[MS09-026](https://go.microsoft.com/fwlink/?linkid=150174) 中的 970238
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6b5be500-e491-4a6e-9b90-be438978a36f)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e3c7a0b0-17cb-4a71-883e-7652153b9104)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=16f782fb-02e5-4fef-a54a-8c0d8d1719c7)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1c9abc68-86b6-40d2-8455-c4c2836c1049)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=4d5bbce7-2da1-47fc-b874-083fd4f288f0)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=59340c68-fe74-4fc4-bc7d-f042efde24e1)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b3c52cfd-972c-4125-8ef4-ad1e6a511871)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows 8（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=7d991c84-48fe-4bf3-8efc-8ff5c32c2e80)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8（用于 64 位系统）](https://www.microsoft.com/download/details.aspx?familyid=992c5c00-8170-4199-8327-87b303ce6574)  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6b5be500-e491-4a6e-9b90-be438978a36f)（服务器核心安装）  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e3c7a0b0-17cb-4a71-883e-7652153b9104)（服务器核心安装）  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=59340c68-fe74-4fc4-bc7d-f042efde24e1)（服务器核心安装）  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=0fda801d-ca7d-4ebe-ac95-04ee5505b55e)（服务器核心安装）  
(2849470)
</td>
<td style="border:1px solid black;">
特权提升
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3175](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve2013-3175)。
...
**什么是远程过程调用 (RPC)？**  
Microsoft 远程过程调用 (RPC) 是一种进程间的通信机制 (IPC)，该机制可以实现不同过程中的数据交换和功能创新。该过程可以在同一台计算机、局域网 (LAN) 或 Internet 上进行。Microsoft RPC 机制使用其他 IPC 机制（如命名管道、NetBIOS 或 Winsock）在客户端和服务器之间建立通信。利用 RPC，重要的程序逻辑和相关过程代码可以存在于不同的计算机上，这对分布式应用程序非常重要。有关详细信息，请参阅 TechNet 文章[什么是 RPC？](https://technet.microsoft.com/library/cc787851)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2849470">Microsoft 知识库文章 2849470</a></td>
</tr>  
<tr class="even">
...
| **文件信息**          | 请参阅 [Microsoft 知识库文章 2849470](https://support.microsoft.com/kb/2849470)                                                     |

...
<td style="border:1px solid black;">
[MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) 中的 2809289 和  
[MS13-010](https://go.microsoft.com/fwlink/?linkid=275837) 中的 2797052
</td>
</tr>
...
<td style="border:1px solid black;">
[MS13-021](https://go.microsoft.com/fwlink/?linkid=279923) 中的 2809289
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
是。2817183 更新适用于适用于 Windows 7（用于 32 位系统）Service Pack 1 和 Windows 7（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview。鼓励使用适用于 Windows 7（用于 32 位系统）Service Pack 1 和 Windows 7（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview 的客户向其系统应用更新。在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [4 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms13-apr)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
| 漏洞标题                         | CVE 编号                                                                         |
|----------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1303](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1303) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1304](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1304) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1338) |
...
| CVE 编号                                                                         | 公开披露 |
|----------------------------------------------------------------------------------|----------|
| [CVE-2013-1303](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1303) | 否       |
| [CVE-2013-1304](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1304) | 否       |
| [CVE-2013-1338](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1338) | 否       |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2817183">Microsoft 知识库文章 2817183</a></td>
</tr>  
<tr class="even">
...
| **文件信息**      | 请参阅 [Microsoft 知识库文章 2817183](https://support.microsoft.com/kb/2817183)                                                         |

...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1281](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1281)。
...
**什么是** **NFS？**
网络文件系统 (NFS) 是 [RFC 1094](https://www.ietf.org/rfc/rfc1094.txt?number=1094) 中定义的一种行业标准协议，它跨网络对共享文件提供透明的远程访问。网络文件系统 (NFS) 服务面向具有混合 Windows 和 UNIX 环境的企业提供文件共享解决方案。NFS 服务使用户能够使用 NFS 协议在运行 Windows 操作系统的计算机和基于 UNIX 的计算机之间传输文件。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2790978">Microsoft 知识库文章 2790978</a></td>
</tr>  
<tr class="odd">

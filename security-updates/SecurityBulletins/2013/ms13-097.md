---
TOCTitle: 'MS13-097'
Title: 'Microsoft 安全公告 MS13-097 - 严重'
ms:assetid: 'ms13-097'
ms:contentKeyID: 61238522
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms13-097(v=Security.10)'
---
...
| 知识库文章     | [2898785](https://support.microsoft.com/kb/2898785) |
|----------------|-----------------------------------------------------|
| 文件信息       | 是                                                  |
| SHA1/SHA2 哈希 | 是                                                  |
| 已知问题       | 无                                                  |
...
<td style="border:1px solid black;">
[MS13-088](http://go.microsoft.com/fwlink/?linkid=325357) 中的 2888505
</td>
</tr>
...
<td style="border:1px solid black;">
[Internet Explorer 7](https://www.microsoft.com/download/details.aspx?familyid=13e2d498-d173-452b-aa3a-f50a0c4ddc41)  
(2898785)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Internet Explorer 9](https://www.microsoft.com/download/details.aspx?familyid=33c2963e-8114-4ab9-9699-2a32a5093ba4)  
(2898785)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Internet Explorer 11](https://www.microsoft.com/download/details.aspx?familyid=548e66d6-2f83-4e40-81ad-1f787d4fdbfe)  
(2898785)
</td>
<td style="border:1px solid black;">
远程执行代码
...
是。2898785 更新适用于 Windows 8.1 Preview 和 Windows RT 8.1 Preview 的 Internet Explorer 11 Preview。鼓励使用 Internet Explorer 11 Preview 的客户向其系统应用更新。在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
以下严重等级假设漏洞的可能的最大影响。有关在安全公告发布 30 天内漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [12 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms13-dec)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](http://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
<th style="border:1px solid black;">
Internet Explorer 特权提升漏洞 - CVE-2013-5045
</th>
<th style="border:1px solid black;">
Internet Explorer 特权提升漏洞 - CVE-2013-5046
</th>
<th style="border:1px solid black;">
Internet Explorer 内存损坏漏洞 - CVE-2013-5047
</th>
<th style="border:1px solid black;">
Internet Explorer 内存损坏漏洞 - CVE-2013-5048
</th>
<th style="border:1px solid black;">
Internet Explorer 内存损坏漏洞 - CVE-2013-5049
</th>
<th style="border:1px solid black;">
Internet Explorer 内存损坏漏洞 - CVE-2013-5051
</th>
<th style="border:1px solid black;">
Internet Explorer 内存损坏漏洞 - CVE-2013-5052
</th>
<th style="border:1px solid black;">
综合严重等级
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
用于 Windows 7 Service Pack 1（用于 32 位系统）的 Internet Explorer 11
</td>
<td style="border:1px solid black;">
**重要**  
特权提升
...
<tr>
<td style="border:1px solid black;">
用于 Windows 7 Service Pack 1（用于基于 x64 的系统）的 Internet Explorer 11
</td>
<td style="border:1px solid black;">
**重要**  
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
用于 Windows Server 2008 R2 Service Pack 1（用于基于 x64 的系统）的 Internet Explorer 11
</td>
<td style="border:1px solid black;">
**重要**  
特权提升
...
| 漏洞标题                       | CVE 编号                                                                         |
|--------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 特权提升漏洞 | [CVE-2013-5045](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5045) |
| Internet Explorer 特权提升漏洞 | [CVE-2013-5046](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5046) |
...
**造成漏洞的原因是什么？**  
当 Internet Explorer 无法正确地验证权限时会导致这些漏洞，它们可能允许攻击者获得特权提升。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用这些漏洞的攻击者可以在受影响的 Internet Explorer 版本中提升特权。攻击者随后可将这些特权与另一个漏洞一起用于通过中等完整性级别特权（当前用户的权限）运行任意代码。

**攻击者如何利用此漏洞？**  
在基于 Web 的攻击情形中，攻击者可能拥有一个网站用于试图利用这些漏洞。另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用这些漏洞的特制内容。但是在所有情况下，攻击者无法强制用户查看由攻击者控制的内容。相反，攻击者必须说服用户执行操作。例如，攻击者可能哄骗用户单击链接以使用户链接到攻击者的网站。

很有可能的是，这些漏洞将与允许远程执行代码的另一个漏洞一起使用。例如，攻击者可以利用另一个漏洞以通过 Internet Explorer 运行任意代码，但是由于 Internet Explorer 启动的进程的上下文，代码可能被限制为在较低的完整性级别（权限非常有限）运行。但是，攻击者随后可能利用这些漏洞导致任意代码在中等完整性级别（当前用户的权限）运行。
...
| 漏洞标题                       | CVE 编号                                                                         |
|--------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 内存损坏漏洞 | [CVE-2013-5047](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5047) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-5048](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5048) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-5049](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5049) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-5051](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5051) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-5052](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5052) |
...
**我当前运行适用于 Windows Server 2003、Windows Server 2008、Windows Server 2008** **R2、Windows Server 2012** **或 Windows Server 2012 R2** **的 Internet Explorer。是否可以减轻这些漏洞** **的影响？**  
...
| CVE 编号                                                                         | 公开披露 |
|----------------------------------------------------------------------------------|----------|
| [CVE-2013-5047](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5047) | 否       |
| [CVE-2013-5048](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5048) | 否       |
| [CVE-2013-5049](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5049) | 否       |
| [CVE-2013-5051](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5051) | 否       |
| [CVE-2013-5052](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5052) | 否       |
...
<td style="border:1px solid black;">对于 Windows XP 所有受支持的版本上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2898785$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP 所有受支持的版本上的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie7updates\KB2898785-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP 所有受支持的版本上的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie8updates\KB2898785-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文</strong> <strong>件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2898785">Microsoft 知识库文章 2898785</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows 7 Service Pack 1（用于 32 位系统）上的 Internet Explorer 11：<br />
<strong>IE11-Windows6.1-KB2898785-x86.msu</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows 7 Service Pack 1（用于基于 x64 的系统）上的 Internet Explorer 11：<br />
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 R2 Service Pack 1（用于基于 x64 的系统）上的 Internet Explorer 11：<br />
<strong>IE11-Windows6.1-KB2898785-x64.msu</strong></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>安装开关</strong></td>

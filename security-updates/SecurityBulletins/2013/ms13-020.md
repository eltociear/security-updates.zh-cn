...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1313](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1313)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2802968">Microsoft 知识库文章 2802968</a></td>
</tr>  
<tr class="even">
...
-   一位匿名研究人员与 [HP 的](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/), 合作报告了 OLE 自动化远程执行代码漏洞 (CVE-2013-1313)

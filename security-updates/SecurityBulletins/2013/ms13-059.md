...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [8 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms13-aug)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](http://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3186](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3186)。
...
**什么是 Windows 完整性机制？**  
Windows 完整性机制是 Windows 安全体系结构的一个核心组件，它限制相同用户帐户下运行的并且不值得信赖的应用程序的访问权限。有关详细信息，请参阅[什么是 Windows 完整性机制？](http://msdn.microsoft.com/library/bb625957)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3192](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3192)。
...
| 漏洞标题                       | CVE 编号                                                                         |
|--------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3184](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3184) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3187](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3187) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3188](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3188) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3189](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3189) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3190](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3190) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3191](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3191) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3193](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3193) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3194](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3194) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3199](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3199) |
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2862772">Microsoft 知识库文章 2862772</a></td>
</tr>  
<tr class="even">
...
| **文件信息**     | 请参阅 [Microsoft 知识库文章 2862772](http://support.microsoft.com/kb/2862772)                                                     |

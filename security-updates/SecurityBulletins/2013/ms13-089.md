...
<td style="border:1px solid black;">
[MS08-071](https://go.microsoft.com/fwlink/?linkid=125440) 中的 956802
</td>
</tr>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3940](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3940)。
...
**什么是图形设备接口 (GDI)？**   .
GDI 是一个 Microsoft Windows 图形设备接口 (GDI)，允许应用程序在视频显示器和打印机上使用图形和格式化文本。基于 Windows 的应用程序不直接访问图形硬件。而是 GDI 代表应用程序与设备驱动程序进行交互。有关 GDI 的详细信息，请参阅 [Windows GDI](https://msdn.microsoft.com/en-us/library/dd145203(v=vs.85).aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2876331">Microsoft 知识库文章 2876331</a></td>
</tr>  
<tr class="even">
...
| **文件信息**     | 请参阅 [Microsoft 知识库文章 2876331](https://support.microsoft.com/kb/2876331)                                                     |

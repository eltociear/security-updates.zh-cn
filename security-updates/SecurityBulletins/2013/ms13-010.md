...
**已知问题。**[Microsoft 知识库文章 2797052](https://support.microsoft.com/kb/2797052) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS11-052](https://go.microsoft.com/fwlink/?linkid=218115) 中的 KB2544521
</td>
</tr>
...
是。KB2797052 更新适用于适用于 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview。鼓励使用适用于 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview 的客户向其系统应用更新。适用于 Windows 7（用于 32 位系统）Service Pack 1 和 Windows 7（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview 的 KB2797052 更新在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供，可从 [Microsoft 下载中心](https://go.microsoft.com/fwlink/?linkid=21129)下载。适用于 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview 的 KB2797052 更新可从 [Microsoft 下载中心](https://go.microsoft.com/fwlink/?linkid=21129)下载。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-0030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0030)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2797052">Microsoft 知识库文章 2797052</a></td>
</tr>  
<tr class="even">
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2797052](https://support.microsoft.com/kb/2797052)                                                                                                                                         |

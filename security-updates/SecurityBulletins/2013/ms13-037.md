---
TOCTitle: 'MS13-037'
Title: 'Microsoft 安全公告 MS13-037 - 严重'
ms:assetid: 'ms13-037'
ms:contentKeyID: 61238462
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms13-037(v=Security.10)'
---

Microsoft 安全公告 MS13-037 - 严重
==================================

Internet Explorer 的累积性安全更新 (2829530)
--------------------------------------------
...
通过修改 Internet Explorer 授权数据脚本访问数据和处理内存中对象的方式，此安全更新解决了漏洞问题。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
| 知识库文章     | [2829530](https://support.microsoft.com/kb/2829530) |
|----------------|-----------------------------------------------------|
| 文件信息       | 是                                                  |
| SHA1/SHA2 哈希 | 是                                                  |
| 已知问题       | 是                                                  |
...
<td style="border:1px solid black;">
[MS13-028](https://go.microsoft.com/fwlink/?linkid=285215) 中的 2817183
</td>
</tr>
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的严重等级和安全影响的可能性的信息，请参阅 [5 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms13-may)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-0811
</th>
<th>
JSON 数组信息泄露漏洞 - CVE-2013-1297
</th>
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-1306
</th>
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-1307
</th>
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-1308
</th>
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-1309
</th>
</tr>
<tr>
...
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-1310
</th>
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-1311
</th>
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-1312
</th>
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-2551
</th>
<th>
Internet Explorer 释放后使用漏洞 - CVE-2013-3140
</th>
<th>
综合严重等级
</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1297](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1297)。
...
**造成此漏洞的原因是什么？**  
在某些过程中，Internet Explorer 不正确地允许 VBScript 读取来自未加载 VBScript 的域中的 JSON 数据文件。

**什么是 JSON？**  
JSON (JavaScript Object Notation) 是一种开放的、基于文本的数据交换格式（请参阅 [RFC4627](https://www.ietf.org/rfc/rfc4627.txt)）。JSON 类似于 XML，人可识读、平台独立并具备各种实施可用性。根据 JSON 标准格式化的数据都是轻型数据，几乎适用于任何需要将应用程序转换成文本或将结构化信息存储为文本的情形。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以读取 JSON 数据文件的内容。

**攻击者如何利用此漏洞？**  
攻击者可能拥有旨在通过 Internet Explorer 来利用此漏洞的特制网站。攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。这些网站可能包含可以利用此漏洞的特制内容。但是在所有情况下，攻击者无法强制用户查看由攻击者控制的内容。相反，攻击者必须诱使用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。它还可能使用横幅广告或其他方式显示特制的 Web 内容，以便将 Web 内容传递至受影响的系统。
...
**此更新有什么作用？**  
此更新通过修改 Internet Explorer 授权脚本访问数据的方式来解决此漏洞。
...
| 漏洞标题                         | CVE 编号                                                                         |
|----------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 释放后使用漏洞 | [CVE-2013-0811](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0811) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1306](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1306) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1307](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1307) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1308](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1308) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1309](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1309) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1310](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1310) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1311](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1311) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1312](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1312) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-2551](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-2551) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-3140](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3140) |
...
| CVE 编号                                                                         | 公开披露 |
|----------------------------------------------------------------------------------|----------|
| [CVE-2013-0811](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0811) | 否       |
| [CVE-2013-1306](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1306) | 否       |
| [CVE-2013-1307](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1307) | 否       |
| [CVE-2013-1308](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1308) | 否       |
| [CVE-2013-1309](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1309) | 否       |
| [CVE-2013-1310](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1310) | 否       |
| [CVE-2013-1311](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1311) | 否       |
| [CVE-2013-1312](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1312) | 否       |
| [CVE-2013-2551](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-2551) | 否       |
| [CVE-2013-3140](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3140) | 否       |
...
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2829530$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie7updates\KB2829530-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie8updates\KB2829530-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文</strong> <strong>件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2829530">Microsoft 知识库文章 2829530</a></td>
</tr>  
<tr class="even">
...
| **文件信息**     | 请参阅 [Microsoft 知识库文章 2829530](https://support.microsoft.com/kb/2829530)                                                     |
...
-   V1.1 （2013 年 5 月 22 日）： 更改了常见漏洞和披露号码 CVE-2013-3140。这仅仅是信息更改。

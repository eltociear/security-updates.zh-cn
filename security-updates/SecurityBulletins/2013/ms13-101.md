...
<td style="border:1px solid black;">
[MS13-081](https://go.microsoft.com/fwlink/?linkid=314048) 中的 2883150
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3899](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3899)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3902](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3902)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3903](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3903)。
...
**什么是字体嵌入？**  
通过 Microsoft OpenType 和 TrueType 规范支持的字体嵌入是 Microsoft 应用程序的一项功能，使字体能够嵌入在文档中。这确保用户看到的文档正是作者希望他们看到的形式。Web Embedding Fonts Tool (WEFT) 让 Web 作者能够创建链接到他们的网页的字体对象，以便通过浏览器查看时，页面以字体对象中包含的样式显示。有关详细信息，请参阅 MSDN 文章“[关于字体嵌入](https://msdn.microsoft.com/library/ms533034)”。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3907](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3907)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-5058](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-5052)。
...
<td style="border:1px solid black;"><p>请参阅 <a href="https://support.microsoft.com/kb/2893984">Microsoft 知识库文章 2893984</a></p></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><p><strong>文件信息</strong></p></td>
<td style="border:1px solid black;"><p>请参阅 <a href="https://support.microsoft.com/kb/2893984">Microsoft 知识库文章 2893984</a><br />
请参阅 <a href="https://support.microsoft.com/kb/2887069">Microsoft 知识库文章 2887069</a></p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><p><strong>注册表项验证</strong></p></td>

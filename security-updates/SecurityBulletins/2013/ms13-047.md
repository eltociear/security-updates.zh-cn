...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [6 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms13-jun)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3126](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3126)。
...
-   默认情况下，Windows Server 2003、Windows Server 2008、Windows Server 2008 R2 和 Windows Server 2012 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/library/dd883248)”的受限模式下运行。此模式可减轻此漏洞。有关 Internet Explorer 增强安全配置的详细信息，请参阅漏洞的“常见问题解答”部分。
...
| 漏洞标题                       | CVE 编号                                                                         |
|--------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3110](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3110) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3111](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3111) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3112](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3112) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3113](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3113) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3114](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3114) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3116](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3116) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3117](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3117) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3118](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3118) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3119](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3119) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3120](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3120) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3121](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3121) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3122](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3122) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3123](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3123) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3124](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3124) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3125](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3125) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3139](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3139) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3141](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3141) |
| Internet Explorer 内存损坏漏洞 | [CVE-2013-3142](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3142) |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2838727">Microsoft 知识库文章 2838727</a></td>
</tr>  
<tr class="even">
...
| **文件信息**     | 请参阅 [Microsoft 知识库文章 2838727](https://support.microsoft.com/kb/2838727)                                                     |

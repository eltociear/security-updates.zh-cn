...
<td style="border:1px solid black;">
[MS12-080](https://go.microsoft.com/fwlink/?linkid=272389) 中的 KB2746157
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-080](https://go.microsoft.com/fwlink/?linkid=272389) 中的 KB2785908
</td>
</tr>
</table>
...
[Oracle 关键修补程序更新通报 - 2013 年 1 月](https://www.oracle.com/technetwork/topics/security/cpujan2013-1515902.html)中讨论的 CVE-2013-0393 和 CVE-2013-0418 影响 Microsoft Exchange Server，可由此更新解决。

**此更新是否包含** **任何** **其他与安全性无关的功能更改？**
是。除了本公告的“漏洞信息”部分列出的更改外，此更新还包括每个更新汇总的相关知识库文章中所述的其他功能性更改。

-   对于 Exchange Server 2007 Service Pack 3 的更新汇总 10 (KB2788321)，请参阅 [Microsoft 知识库文章 2788321](https://support.microsoft.com/kb/2788321)。
-   对于 Exchange 2010 Service Pack 2 的更新汇总 6 (KB2746164)，请参阅 [Microsoft 知识库文章 2746164](https://support.microsoft.com/kb/2746164)。
...
要在“常见漏洞和披露”列表中以标准条目查看这些漏洞，请参阅 [CVE-2013-0418](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0418) 和 [CVE-2013-0393](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0393)。
...
-   [CVE-2013-0393](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0393)  
-   [CVE-2013-0418](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0418)
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2809279">Microsoft 知识库文章 2809279</a></td>
</tr>  
<tr class="even">

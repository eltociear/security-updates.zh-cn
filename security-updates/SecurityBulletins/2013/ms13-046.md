...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1332](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1332)。
...
Dxgkrnl.sys 是 Microsoft DirectX 图形内核子系统。它是一种由显示微型端口驱动程序调用用于将 [DXGKRNL\_INTERFACE](https://msdn.microsoft.com/en-us/library/windows/hardware/ff560942%28v=vs.85%29.aspx) 结构传递到显示微型端口驱动程序的 [DxgkDdiStartDevice](https://msdn.microsoft.com/en-us/library/windows/hardware/ff560775%28v=vs.85%29.aspx) 功能的内核模式驱动程序。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1333](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1333)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1334](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1334)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2829361">Microsoft 知识库文章 2829361</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2830290">Microsoft 知识库文章 2830290</a><br />
请参阅 <a href="https://support.microsoft.com/kb/2829361">Microsoft 知识库文章 2829361</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注</strong> <strong>册表</strong> <strong>验证</strong></td>

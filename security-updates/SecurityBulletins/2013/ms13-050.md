...
[Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?%20familyid=ddb%20__lw_at__864__lw_at__%20bf-5b0%20__lw_at__-46__lw_at__一个3-b07f%20__lw_at__-5714__lw_at__%20bd%20__lw_at__136959)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=995799f3-f4e7-4e5b-9aed-5ec62d06b6ea)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ab227846-c6cc-4ac1-87bc-e5da62df73cc)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ac2a6e07-b568-4b28-9f2b-2209f53c8074)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=932eafc1-bf51-4e02-9d54-b7a520db3242)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<td style="border:1px solid black;">
[MS13-001](https://go.microsoft.com/fwlink/?linkid=273848) 中的 2769369
</td>
</tr>
<tr>
<td style="border:1px solid black;">
[Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=15ec4662-a237-42ed-bb4b-3b82eabf1ccd)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=3b6596dd-1159-4088-bcda-13c29507a977)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=68123bbf-4786-4080-87c5-9c5c0caf774a)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?%20familyid=b5cf9e%20__lw_at__24-596__lw_at__%20f-4%20__lw_at__43__lw_at__-b0d0-e%20__lw_at__36__lw_at__%20c%20__lw_at__113334__lw_at__%20ea)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows 8（用于 64 位系统）](https://www.microsoft.com/download/details.aspx?familyid=1404b8b9-e3e7-478e-9591-7a7f0804b57a)  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=995799f3-f4e7-4e5b-9aed-5ec62d06b6ea)（服务器核心安装）  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ab227846-c6cc-4ac1-87bc-e5da62df73cc)（服务器核心安装）  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=3b6596dd-1159-4088-bcda-13c29507a977)（服务器核心安装）  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](https://www.microsoft.com/download/details.aspx?familyid=3beef4ee-327f-48c2-a7d5-1e3f9e054081)（服务器核心安装）  
(2839894)
</td>
<td style="border:1px solid black;">
特权提升
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1339](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1339)。
...
**什么是打印后台程序服务？**  
打印后台程序服务是作为服务安装的可执行文件。当操作系统启动时加载后台处理程序时，它将持续运行，直到操作系统关闭。打印后台程序服务管理打印进程，包括检索正确的打印机驱动程序位置、加载该驱动程序、后台处理高级级函数调用至打印作业以及计划打印作业等任务。当某个特定打印作业的任务完成时，打印后台程序服务将把此作业传给打印路由器。有关详细信息，请参阅 [网络打印的工作原理](https://technet.microsoft.com/library/cc783789)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2839894">Microsoft 知识库文章 2880833</a></td>
</tr>  
<tr class="odd">
...
| **文件信息**     | 请参阅 [Microsoft 知识库文章 2880833](https://support.microsoft.com/kb/2839894)                                                     |

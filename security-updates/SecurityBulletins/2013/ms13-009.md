...
**已知问题。**[Microsoft 知识库文章 2792100](https://support.microsoft.com/kb/2792100) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS12-077](https://go.microsoft.com/fwlink/?linkid=268393) 中的 KB2761465 和 [MS13-008](https://go.microsoft.com/fwlink/?linkid=275222) 中的 KB2799329
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-077](https://go.microsoft.com/fwlink/?linkid=268393) 中的 KB2761465
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
是。此 Internet Explorer 累积性安全更新可解决 [MS13-008](https://go.microsoft.com/fwlink/?linkid=275222) 中的漏洞。有关此更新取代以前哪些更新的详细信息，请参阅“**受影响和不受影响的软件**”小节中的“**取代的更新**”。

**适用于** **Windows 7 的** **Internet Explorer 10** **Release Preview** **是否受此公告中解决的漏洞的影响？**
是。KB2792100 更新适用于适用于 Windows 7（用于 32 位系统）Service Pack 1 和 Windows 7（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview。鼓励使用适用于 Windows 7（用于 32 位系统）Service Pack 1 和 Windows 7（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview 的客户向其系统应用更新。在 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
以下严重等级假设漏洞的可能的最大影响。有关此安全公告发布 30 天内，漏洞利用的严重等级和安全影响的可能性的信息，请参阅 [2 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms13-feb)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-0015](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0015)。
...
| 漏洞标题                                        | CVE 编号                                                                         |
|-------------------------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer SetCapture 释放后使用漏洞     | [CVE-2013-0018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0018) |
| Internet Explorer COmWindowProxy 释放后使用漏洞 | [CVE-2013-0019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0019) |
| Internet Explorer CMarkup 释放后使用漏洞        | [CVE-2013-0020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0020) |
| Internet Explorer vtable 释放后使用漏洞         | [CVE-2013-0021](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0021) |
| Internet Explorer LsGetTrailInfo 释放后使用漏洞 | [CVE-2013-0022](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0022) |
| Internet Explorer CDispNode 释放后使用漏洞      | [CVE-2013-0023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0023) |
| Internet Explorer pasteHTML 释放后使用漏洞      | [CVE-2013-0024](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0024) |
| Internet Explorer SLayoutRun 释放后使用漏洞     | [CVE-2013-0025](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0025) |
| Internet Explorer InsertElement 释放后使用漏洞  | [CVE-2013-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0026) |
| Internet Explorer CPasteCommand 释放后使用漏洞  | [CVE-2013-0027](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0027) |
| Internet Explorer CObjectElement 释放后使用漏洞 | [CVE-2013-0028](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0028) |
| Internet Explorer CHTML 释放后使用漏洞          | [CVE-2013-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0029) |
...
-   默认情况下，Microsoft Outlook、Microsoft Outlook Express 和 Windows Mail 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。“受限站点”区域（禁用脚本和 ActiveX 控件）可帮助降低攻击者使用这些漏洞执行恶意代码的风险。在基于 Web 的攻击情形中，如果用户单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003、Windows Server 2008、Windows Server 2008 R2 和 Windows Server 2012 上的 Internet Explorer 在一种称为“[增强安全配置](https://technet.microsoft.com/library/dd883248)”的受限模式下运行。此模式可缓解这些漏洞。有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题解答”部分。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2792100">Microsoft 知识库文章 2792100</a></td>
</tr>  
<tr class="even">
...
| **部署**                         |                                                                                                                                                                          |  
|                                  | 此更新仅通过 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 提供。                                                                                       |  
| **重新启动要求**                 |                                                                                                                                                                          |  
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2792100](https://support.microsoft.com/kb/2792100)                                                                                           |
...
-   [Omair](https://krash.in/) 与 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer SetCapture 释放后使用漏洞 (CVE-2013-0018)  
-   SkyLined 与 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer COmWindowProxy 释放后使用漏洞 (CVE-2013-0019)  
-   Arthur Gerkis 与 Exodus Intelligence 合作报告了 Internet Explorer CMarkup 释放后使用漏洞 (CVE-2013-0020)  
-   [Harmony Security](https://www.harmonysecurity.com) 的 Stephen Fewer 与 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CMarkup 释放后使用漏洞 (CVE-2013-0020)  
-   Tencent PC 经理报告了 Internet Explorer vtable 释放后使用漏洞 (CVE-2013-0021)  
-   [Omair](https://krash.in/) 报告了 Internet Explorer LsGetTrailInfo 释放后使用漏洞 (CVE-2013-0022)  
-   Arthur Gerkis 与 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CDispNode 释放后使用漏洞 (CVE-2013-0023)  
-   一名匿名研究人员与 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer pasteHTML 释放后使用漏洞 (CVE-2013-0024)  
-   [Security-Assessment.com](https://www.security-assessment.com) 的 Scott Bell 报告了 Internet Explorer SLayoutRun 释放后使用漏洞 (CVE-2013-0025)  
...
-   [Security-Assessment.com](https://www.security-assessment.com) 的 Scott Bell 报告了 Internet Explorer CObjectElement 释放后使用漏洞 (CVE-2013-0028)  
-   Yenteasy Security Research 的 Jose A Vazquez 与 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CObjectElement 释放后使用漏洞 (CVE-2013-0028)  
-   [Harmony Security](https://www.harmonysecurity.com) 的 Stephen Fewer 与 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CHTML 释放后使用漏洞 (CVE-2013-0029)  
-   [Aniway.Aniway@gmail.com](mailto:aniway.aniway@gmail.com) 与 [HP 的](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CHTML 释放后使用漏洞 (CVE-2013-0029)  
-   [NCC Group](https://www.nccgroup.com/) 的 Ollie Whitehouse 与我们一起努力处理了此公告中包括的其他纵深防御更改

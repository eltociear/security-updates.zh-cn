...
注意 有关 wusa.exe 安装程序的命令行开关的详细信息，请参阅 [用于 Windows 软件更新程序包的命令行开关](http://support.microsoft.com/kb/262841)。
...
-   [Context Information Security](http://www.contextis.com/) 的 James Forshaw 报告了 WinForms 回叫提升漏洞 (CVE-2013-0073)

...
**已知问题。**[Microsoft 知识库文章 2799494](https://support.microsoft.com/kb/2799494) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS12-068](https://go.microsoft.com/fwlink/?linkid=257912) 中的 KB2724197
</td>
</tr>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1278](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1278)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1279](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1279)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1280](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1280)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2799494">Microsoft 知识库文章 2799494</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2799494](https://support.microsoft.com/kb/2799494)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2799494](https://support.microsoft.com/kb/2799494)                               |
...
-   [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Google Inc](https://www.google.com) 的 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 报告了内核争用条件漏洞 (CVE-2013-1278)  
-   [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Google Inc](https://www.google.com) 的 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 报告了内核争用条件漏洞 (CVE-2013-1279)

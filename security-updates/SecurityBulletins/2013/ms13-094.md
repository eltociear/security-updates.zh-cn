...
<td style="border:1px solid black;">
[MS13-068](https://go.microsoft.com/fwlink/?linkid=307055) 中的 2825999
</td>
</tr>
<tr>
<th colspan="5" style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Outlook 2010 Service Pack 1（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=2a3960f0-5094-45b4-9f63-180b991727dc)  
(2837597)
</td>
<td style="border:1px solid black;">
信息泄露
...
<td style="border:1px solid black;">
[MS13-068](https://go.microsoft.com/fwlink/?linkid=307055) 中的 2794707
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Outlook 2010 Service Pack 2（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=2a3960f0-5094-45b4-9f63-180b991727dc)  
(2837597)
</td>
<td style="border:1px solid black;">
信息泄露
...
<td style="border:1px solid black;">
[Microsoft Outlook 2010 Service Pack 1（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=74e035bb-cdcc-4ea6-a933-b4acd227ce85)  
(2837597)
</td>
<td style="border:1px solid black;">
信息泄露
...
<td style="border:1px solid black;">
[Microsoft Outlook 2010 Service Pack 2（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=74e035bb-cdcc-4ea6-a933-b4acd227ce85)  
(2837597)
</td>
<td style="border:1px solid black;">
信息泄露
...
<td style="border:1px solid black;">
[Microsoft Outlook 2013（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=ee644350-f64b-471a-a26b-79701b39a1b3)  
(2837618)
</td>
<td style="border:1px solid black;">
信息泄露
...
<td style="border:1px solid black;">
[Microsoft Outlook 2013（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=7c83b545-42ed-49d8-980a-8c2ad11e6e3c)  
(2837618)
</td>
<td style="border:1px solid black;">
信息泄露
...
是。除了此公告的“漏洞信息”部分中列出的更改之外，此更新还增加以下功能：通过注册表项设置指定 Microsoft Outlook 是否需要检索授权信息访问 (AIA) 扩展中引用的远程证书。有关此更改的详细信息，请参阅 [Microsoft 知识库文章 2894514](https://support.microsoft.com/kb/2894514)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3905](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3905)。
...
-   **禁用** **Outlook 中的阅读窗格**
    ...
    要禁用 Outlook 2013 中的阅读窗格，请参阅[打开或关闭阅读窗格](https://office.microsoft.com/en-us/outlook-help/turn-the-reading-pane-on-and-off-ha102830304.aspx)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2013-3905](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3905)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2825644">Microsoft 知识库文章 2825644</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2837597">Microsoft 知识库文章 2837597</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件</strong> <strong>信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2837618">Microsoft 知识库文章 2837618</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;">Microsoft Outlook 2013 RT 的 2837618 更新通过 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>重新启动要求</strong></td>
<td style="border:1px solid black;">在某些情况下，此更新不需要重新启动。如果所需的文件正在使用，则此更新将需要重新启动。如果发生这种情况，将显示一条消息建议您重新启动。<br />

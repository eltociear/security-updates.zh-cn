...
<td style="border:1px solid black;">
[MS11-091](https://go.microsoft.com/fwlink/?linkid=235287) 中的 2553084
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-091](https://go.microsoft.com/fwlink/?linkid=235287) 中的 2596705
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[Microsoft Publisher 2010 Service Pack 1（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=2524228d-5e6f-4520-b18b-668309e71a9d)  
(2553147)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Publisher 2010 Service Pack 1（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=bc3bedf6-9ee1-4de5-a6e4-cb92cbb16acc)  
(2553147)
</td>
<td style="border:1px solid black;">
远程执行代码
...
| 漏洞标题                       | CVE 编号                                                                         |  
|--------------------------------|----------------------------------------------------------------------------------|  
| Publisher 负值分配漏洞         | [CVE-2013-1316](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1316) |  
| Publisher 整数溢出漏洞         | [CVE-2013-1317](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1317) |  
| Publisher 损坏界面指针漏洞     | [CVE-2013-1318](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1318) |  
| Publisher 返回值处理漏洞       | [CVE-2013-1319](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1319) |  
| Publisher 缓冲区溢出漏洞       | [CVE-2013-1320](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1320) |  
| Publisher 返回值验证漏洞       | [CVE-2013-1321](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1321) |  
| Publisher 无效的范围检查漏洞   | [CVE-2013-1322](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1322) |  
| Publisher 不正确的空值处理漏洞 | [CVE-2013-1323](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1323) |  
| Publisher 签名整数漏洞         | [CVE-2013-1327](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1327) |  
| Publisher 指针处理漏洞         | [CVE-2013-1328](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1328) |  
| Publisher 缓冲区下溢漏洞       | [CVE-2013-1329](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1329) |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2810047">Microsoft 知识库文章 2810047</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2597971">Microsoft 知识库文章 2597971</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件</strong> <strong>信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2553147">Microsoft 知识库文章 2553147</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>

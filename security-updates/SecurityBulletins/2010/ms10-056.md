...
**已知问题。** [Microsoft 知识库文章 2269638](https://support.microsoft.com/kb/2269638) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS09-068](https://go.microsoft.com/fwlink/?linkid=165890)
</td>
</tr>
...
Microsoft Office Word Viewer 是 Word Viewer 2003 及 Word Viewer 的所有之前版本的替代品。 通过使用 Word Viewer，即使没有安装 Word，您也可以查看、打印和复制 Word 文档。 有关当前支持的 Office 查看器，请参阅[受支持的 Office 查看器版本](https://support.microsoft.com/kb/979860/en-us)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1900](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1900)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1901](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1901)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1902](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1902)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1903](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1903)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2251389">Microsoft 知识库文章 2251389</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Word 2003，请参阅 <a href="https://support.microsoft.com/kb/2251399">Microsoft 知识库文章 2251399</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Word Viewer，请参阅 <a href="https://support.microsoft.com/kb/2251437">Microsoft 知识库文章 2251437</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Word 2007，请参阅 <a href="https://support.microsoft.com/kb/2251419">Microsoft 知识库文章 2251419</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">有关 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包，请参阅 <a href="https://support.microsoft.com/kb/2277947">Microsoft 知识库文章 2277947</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2092914">Microsoft 知识库文章 2092914</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [team509](https://www.team509.com/) 的 L.W.Z 与 [TippingPoint 的](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了 Word 记录分析漏洞 (CVE-2010-1900)  
-   [team509](https://www.team509.com/) 的 Wushi 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Word RTF 分析引擎内存损坏漏洞 (CVE-2010-1901)  
-   [team509](https://www.team509.com/) 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 Word RTF 分析缓冲区溢出漏洞 (CVE-2010-1902)  
-   [Check Point](https://www.checkpoint.com/) IPS Research Team 的 Rodrigo Rubira Branco 报告了 Word HTML 链接对象内存损坏漏洞 (CVE-2010-1903)  
-   一名匿名研究人员与 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了 Word HTML 链接对象内存损坏漏洞 (CVE-2010-1903)

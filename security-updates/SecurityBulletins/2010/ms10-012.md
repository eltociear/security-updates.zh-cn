...
对于管理员、企业安装或者想要手动安装此安全更新的最终用户，Microsoft 建议客户尽早应用此更新来更新管理软件或者利用 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 服务检查更新。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=267ce982-54a0-418f-ad52-e4963610f714)                                                                           | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=8f7adee3-e68e-41b3-b835-d84691774f31)                                                          | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=91ee57f2-81e5-49bd-bdfc-d3e385efc8a5)                                                              | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3d18cbc4-ac48-458c-8aa3-90708fd854ff)                                                                              | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7d63c95e-311a-446f-8852-dffd217a89f6)                                                                  | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=ee7f8cc4-f7fd-4dc7-808c-436204ee80cb)                                                              | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=16494dac-553a-4de9-b751-0d6b51cb43f0)                                     | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=cec582b3-e37f-448e-a5c3-6abdcee9e57c) | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=597b2310-2cd8-4d0f-8248-781eb8b7450a)\*                   | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=67119fb6-e517-46f4-ab0b-2351cdc3d670)\*         | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f90fc0c8-babe-4224-be07-614ea7ddf102)   | 远程执行代码 | 重要         | [MS09-001](https://go.microsoft.com/fwlink/?linkid=132991) |
...
否。 Microsoft 安全公告 [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850)“SMB 客户端中的漏洞可能允许远程执行代码”解决了不同的 SMB 组件。 此安全更新可独立于任何其他更新进行应用。

**如果我已经安装了 MS10-006 更新，还需要安装此更新吗？**  
是。 此安全公告更新解决了 Windows SMB 服务器组件中的漏洞，而 [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) 解决了 Windows SMB 客户端组件中的漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0020)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0021](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0021)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0022](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0022)。
...
-   **禁用 SMB v2**
    ...
    **注意** 要使用自动化“**Microsoft 修复**”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 975517](https://support.microsoft.com/kb/975517)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0022](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0022)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0231](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0231)。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 971468](https://support.microsoft.com/kb/971468)                                          |  
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/971468">Microsoft 知识库文章 971468</a></td>
</tr>  
<tr class="even">
...
-   [Codenomicon](https://www.codenomicon.com/) 的 Joshua Morin 报告了 SMB 路径名溢出漏洞 (CVE-2010-0020)  
-   [BSI](https://www.bsi.bund.de/) 的 Florian Rienhardt 报告了 SMB 内存损坏漏洞 (CVE-2010-0021)  

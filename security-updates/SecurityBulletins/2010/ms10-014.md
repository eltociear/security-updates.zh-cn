...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0035](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0035)。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 977290](https://support.microsoft.com/kb/977290)                                          |  
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/977290">Microsoft 知识库文章 977290</a></td>
</tr>  
<tr class="even">

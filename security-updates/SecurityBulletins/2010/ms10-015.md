...
此安全更新也解决了最初在 [Microsoft 安全通报 979682](http://technet.microsoft.com/security/advisory/979682) 中描述的漏洞。
...
**已知问题。** [Microsoft 知识库文章 977165](http://support.microsoft.com/kb/977165) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=ed8ac6a5-c8bb-4ed4-8994-810e9a1863c3)                                                                           | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e2b348f5-ec8d-4782-bb03-5de550adea77)                                                          | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e534d00c-6ddc-4eb3-9464-5db6e90afa3e)                                                              | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=defd8603-ed9b-42f9-a539-2b6a690e9575)                                                                              | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9873c962-9d3d-46ef-b54b-2a50696fb6b2)                                                                  | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=c3c21225-8534-4c7f-96b6-20a743dcea74)                                                              | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2761c7b4-d472-4f00-949b-af3ebafdc08d)                                     | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=38b40dab-6b4d-434b-9997-12ef70d6bbcc) | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=21e87558-9bd2-4aa9-aaa5-7fd26a5b60e6)\*                   | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0b93047d-f2c6-403b-9200-c251898bc1e0)\*         | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd6b234b-8e96-4128-a77a-645a0882996a)   | 特权提升     | 重要         | [MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows 7（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=66f14bb4-40fc-4ae3-9baf-429b7106cd91)                                                                                     | 特权提升     | 重要         | 无                                                        |
...
Microsoft 修订了此公告，以宣布在 Windows Update 中提供 MS10-015 更新的修订程序包。 进行此修订的原因是：如果系统中存在某些异常情况，程序包安装逻辑中的更改会阻止安装安全更新。 系统中的这些异常情况可能是感染了会修改某些操作系统文件的计算机病毒造成的，从而导致受感染的计算机与 MS10-015 更新不兼容。 在某些情况下，在感染了病毒的计算机中安装安全更新 MS10-015 可能会导致计算机重复重新启动。 有关此问题的详细信息，请参阅以下[网页](http://www.microsoft.com/security/updates/015)。 这仅更改通过 Windows Update 分发的更新中的程序包安装逻辑；没有更改安全更新二进制或 Windows Update 检测逻辑。 Microsoft 下载中心上的可用更新没有更改，且不包含这个新的程序包安装逻辑。 已经成功地更新了其系统的客户（包括启用了自动更新的客户）不需要执行任何操作。 如果客户启用了自动更新，而以前未安装过此更新，应考虑尽早应用该更新。
...
是的，所有受影响 Windows 平台的更新程序包 (KB977165) 包括在 [Microsoft 知识库文章 977165](http://support.microsoft.com/kb/977165) 中描述的对 Windows 内核的更改。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232)。此问题最初是在 [Microsoft 安全通报 979682](http://technet.microsoft.com/security/advisory/979682) 中讨论的。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0233](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0233)。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 977165](http://support.microsoft.com/kb/977165)                                          |  
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/977165">Microsoft 知识库文章 977165</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc.](http://www.google.com/) 的 Tavis Ormandy 报告了 Windows 内核双重释放漏洞 (CVE-2010-0233)

---
TOCTitle: 'MS10-015'
Title: 'Microsoft 安全公告 MS10-015 - 重要'
ms:assetid: 'ms10-015'
ms:contentKeyID: 61237854
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-015(v=Security.10)'
---

Microsoft 安全公告 MS10-015 - 重要
==================================

Windows 内核中的漏洞可能允许特权提升 (977165)
---------------------------------------------

发布时间: 2010年2月9日 | 更新时间: 2010年3月2日
...
对于 Microsoft Windows 2000、Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008 和 Windows 7（用于 32 位系统）的所有受支持版本，此安全更新的等级为“重要”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

通过确保 Windows 内核正确处理异常，此安全更新解决了漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。

此安全更新也解决了最初在 [Microsoft 安全通报 979682](https://technet.microsoft.com/security/advisory/979682) 中描述的漏洞。
...
**已知问题。** [Microsoft 知识库文章 977165](https://support.microsoft.com/kb/977165) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=ed8ac6a5-c8bb-4ed4-8994-810e9a1863c3)                                                                           | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=e2b348f5-ec8d-4782-bb03-5de550adea77)                                                          | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e534d00c-6ddc-4eb3-9464-5db6e90afa3e)                                                              | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=defd8603-ed9b-42f9-a539-2b6a690e9575)                                                                              | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9873c962-9d3d-46ef-b54b-2a50696fb6b2)                                                                  | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=c3c21225-8534-4c7f-96b6-20a743dcea74)                                                              | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2761c7b4-d472-4f00-949b-af3ebafdc08d)                                     | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=38b40dab-6b4d-434b-9997-12ef70d6bbcc) | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=21e87558-9bd2-4aa9-aaa5-7fd26a5b60e6)\*                   | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0b93047d-f2c6-403b-9200-c251898bc1e0)\*         | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=cd6b234b-8e96-4128-a77a-645a0882996a)   | 特权提升     | 重要         | [MS09-058](https://go.microsoft.com/fwlink/?linkid=162442) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=66f14bb4-40fc-4ae3-9baf-429b7106cd91)                                                                                     | 特权提升     | 重要         | 无                                                        |
...
**为什么在 2010 年 3 月 2 日修订此公告？**  
Microsoft 修订了此公告，以宣布在 Windows Update 中提供 MS10-015 更新的修订程序包。 进行此修订的原因是：如果系统中存在某些异常情况，程序包安装逻辑中的更改会阻止安装安全更新。 系统中的这些异常情况可能是感染了会修改某些操作系统文件的计算机病毒造成的，从而导致受感染的计算机与 MS10-015 更新不兼容。 在某些情况下，在感染了病毒的计算机中安装安全更新 MS10-015 可能会导致计算机重复重新启动。 有关此问题的详细信息，请参阅以下[网页](https://www.microsoft.com/security/updates/015)。 这仅更改通过 Windows Update 分发的更新中的程序包安装逻辑；没有更改安全更新二进制或 Windows Update 检测逻辑。 Microsoft 下载中心上的可用更新没有更改，且不包含这个新的程序包安装逻辑。 已经成功地更新了其系统的客户（包括启用了自动更新的客户）不需要执行任何操作。 如果客户启用了自动更新，而以前未安装过此更新，应考虑尽早应用该更新。
...
是的，所有受影响 Windows 平台的更新程序包 (KB977165) 包括在 [Microsoft 知识库文章 977165](https://support.microsoft.com/kb/977165) 中描述的对 Windows 内核的更改。
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 内核异常处理程序漏洞 - CVE-2010-0232</th>
<th>Windows 内核双重释放漏洞 - CVE-2010-0233</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Windows 内核异常处理程序漏洞 - CVE-2010-0232  
--------------------------------------------
  
   
Windows 内核中存在一个由于内核处理某些异常的方式而产生的特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232)。
  
#### Windows 内核异常处理程序漏洞 (CVE-2010-0232) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   64 位 Microsoft Windows 操作系统不受此漏洞影响。  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核异常处理程序漏洞 (CVE-2010-0232) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   禁用 NTVDM 子系统
  
    **注意** 有关如何自动实施此变通办法的信息，请参阅 [Microsoft 知识库文章 979682](https://support.microsoft.com/kb/979682)。
  
    1.  单击“**开始**”，单击“**运行**”，在“**打开**”框中键入 **gpedit.msc**，然后单击“**确定**”。  
        这将打开组策略控制台。  
    2.  展开“**管理模板**”文件夹，然后单击“**Windows 组件**”。  
    3.  单击“**应用程序兼容性**”文件夹。  
    4.  在详细信息窗格中，双击“**防止访问 16 位应用程序**”策略设置。 默认情况下，此选项设置为“**未配置**”。  
    5.  将策略设置更改为“**启用**”，然后单击“**确定**”。
  
    **变通办法的影响。** 用户将不能运行 16 位应用程序。
  
#### Windows 内核异常处理程序漏洞 (CVE-2010-0232) 的常见问题解答
...
Windows 虚拟 DOS 机 (NTVDM) 子系统是一个环保型子系统，模仿 MS-DOS 和基于 Windows NT 的操作系统中的 16 位 Windows。 用户在基于 Windows NT 的操作系统中启动 MS-DOS 应用程序时，就会自动创建 VDM。
...
**此更新有什么作用？**    
通过确保 Windows 内核正确处理异常，此更新解决了漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0232)。此问题最初是在 [Microsoft 安全通报 979682](https://technet.microsoft.com/security/advisory/979682) 中讨论的。
  
**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。
  
Windows 内核双重释放漏洞 - CVE-2010-0233  
----------------------------------------
  
   
Windows 内核中存在由于双重释放条件而产生的特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0233](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0233)。
  
#### Windows 内核双重释放漏洞 (CVE-2010-0233) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核双重释放漏洞 (CVE-2010-0233) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核双重释放漏洞 (CVE-2010-0233) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
当释放内存时，Windows 内核未正确地重置指针。 这导致 Windows 内核中出现双重释放条件。
...
**此更新有什么作用？**    
通过确保 Windows 内核在释放内存时正确地重置指针，此更新解决了该漏洞。
...
| **部署**                         |                                                                                                                       |  
| 没有用户干预的安装               | Windows2000-KB977165-x86-enu /quiet                                                                                   |  
| 在不重新启动的情况下安装         | Windows2000-KB977165-x86-enu /norestart                                                                               |  
| 更新日志文件                     | KB977165.log                                                                                                          |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节                                                                                  |  
| **重新启动要求**                 |                                                                                                                       |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                                |  
| HotPatching                      | 不适用                                                                                                                |  
| **删除信息**                     | 使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB977165$\\Spuninst 文件夹中的 Spuninst.exe 实用程序 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 977165](https://support.microsoft.com/kb/977165)                                          |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB977165\\Filelist                             |
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB977165 $\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/977165">Microsoft 知识库文章 977165</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Windows XP 所有受支持的 32 位版本：<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP4\KB977165\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows Server 2003\SP3\KB977165\Filelist</td>
</tr>  
</tbody>  
</table>
...
-   [Google Inc.](https://www.google.com/) 的 Tavis Ormandy 报告了 Windows 内核双重释放漏洞 (CVE-2010-0233)
...
-   V1.1（2010 年 2 月 10 日）： 更正了 Windows XP 的所有受支持的基于 x64 的版本的验证注册表项。 这仅仅是一个信息更改。  
-   V1.2（2010 年 3 月 2 日）： 已向“**关于此安全更新的常见问题 (FAQ)**”添加条目，以宣布在 Windows Update 中提供修订程序包。 已经成功更新了其系统的客户不需要执行任何操作。

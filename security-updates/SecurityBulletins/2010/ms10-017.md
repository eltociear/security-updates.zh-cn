---
TOCTitle: 'MS10-017'
Title: 'Microsoft 安全公告 MS10-017 - 重要'
ms:assetid: 'ms10-017'
ms:contentKeyID: 61237856
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-017(v=Security.10)'
---
...
此更新通过更改 Microsoft Office Excel 分析特制的 Excel 文件的方式来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。**）**

**建议。** Microsoft 建议客户尽早应用此更新。

**已知问题。** [Microsoft 知识库文章 980150](https://support.microsoft.com/kb/980150) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[MS09-067](https://go.microsoft.com/fwlink/?linkid=165431)
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=03429f8a-8aab-4a59-97e4-7ce047f100a5)<sup>[1]</sup>  
(KB978382)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office Excel 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=03429f8a-8aab-4a59-97e4-7ce047f100a5)<sup>[1]</sup>  
(KB978382)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 1 以及用于 Word、Excel 和 PowerPoint 2007 文件格式 的 Microsoft Office 兼容包 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=314f076e-8f9d-46c2-b666-86599a02bf15)  
(KB978380)
</td>
<td style="border:1px solid black;">
不适用
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=94ddf6ef-3392-4d77-a02b-3bc0470721cd)<sup>[2]</sup>  
(KB979439)
</td>
<td style="border:1px solid black;">
不适用
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2（32 位版本）](https://www.microsoft.com/download/details.aspx?familyid=94ddf6ef-3392-4d77-a02b-3bc0470721cd)<sup>[2]</sup>  
(KB979439)
</td>
<td style="border:1px solid black;">
不适用
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 1（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=06f6bffb-3fad-4fb5-878b-39550812e9b5)<sup>[2]</sup>  
(KB979439)
</td>
<td style="border:1px solid black;">
不适用
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=06f6bffb-3fad-4fb5-878b-39550812e9b5)<sup>[2]</sup>  
(KB979439)
</td>
<td style="border:1px solid black;">
不适用
...
[Microsoft 知识库文章 980150](https://support.microsoft.com/kb/980150) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
是的，作为 Microsoft Office 2007 的服务模型的一部分，当 Microsoft Office 2007 Service Pack 1 用户安装此更新时，用户的系统将升级为 Microsoft Office 2007 Service Pack 2 最初版本的安全功能。2009年 4 月 24 日之后发行的所有更新将包含 [Microsoft Office 2007 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b444bf18-79ea-46c6-8a81-9db49b4ab6e5&displaylang=en) 中所介绍的这些安全功能。我们已经对此更新进行了彻底测试，但是与所有更新一样，我们建议用户对其环境和系统的配置执行适合的测试。
...
<th>
Microsoft Office Excel 记录内存损坏漏洞 – CVE-2010-0257
</th>
<th>
Microsoft Office Excel 工作表对象类型混淆漏洞 - CVE-2010-0258
</th>
<th>
Microsoft Office Excel MDXTUPLE 记录堆溢出漏洞 – CVE-2010-0260
</th>
<th>
Microsoft Office Excel MDXSET 记录堆溢出漏洞 – CVE-2010-0261
</th>
<th>
Microsoft Office Excel FNGROUPNAME 记录未初始化的内存漏洞 – CVE-2010-0262
</th>
<th>
Microsoft Office Excel XLSX 文件分析代码执行漏洞 – CVE-2010-0263
</th>
<th>
Microsoft Office Excel DbOrParamQry 记录分析漏洞 – CVE-2010-0264
</th>
<th>
综合严重等级
</th>
...
<tr>
<td style="border:1px solid black;">
Microsoft Office SharePoint Server 2007 Service Pack 1（32 位版本）和 Microsoft Office SharePoint Server 2007 Service Pack 2（32 位版本）
</td>
<td style="border:1px solid black;">
不适用
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Microsoft Office SharePoint Server 2007 Service Pack 1（64 位版本）和 Microsoft Office SharePoint Server 2007 Service Pack 2（64 位版本）
</td>
<td style="border:1px solid black;">
不适用
</td>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0257)。

#### Microsoft Office Excel 记录内存损坏漏洞 (CVE-2010-0257) 的缓解因素
...
#### Microsoft Office Excel 记录内存损坏漏洞 (CVE-2010-0257) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Microsoft Office Excel 记录内存损坏漏洞 (CVE-2010-0257) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0258](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0258)。

#### Microsoft Office Excel 工作表对象类型混淆漏洞 (CVE-2010-0258) 的缓解因素
...
#### Microsoft Office Excel 工作表对象类型混淆漏洞 (CVE-2010-0258) 的变通办法
...
#### Microsoft Office Excel 工作表对象类型混淆漏洞 (CVE-2010-0258) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0260](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0260)。

#### Microsoft Office Excel MDXTUPLE 记录堆溢出漏洞 (CVE-2010-0260) 的缓解因素
...
#### Microsoft Office Excel MDXTUPLE 记录堆溢出漏洞 (CVE-2010-0260) 的变通办法
...
#### Microsoft Office Excel MDXTUPLE 记录堆溢出漏洞 (CVE-2010-0260) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0261](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0261)。

#### Microsoft Office Excel MDXSET 记录堆溢出漏洞 (CVE-2010-0261) 的缓解因素
...
#### Microsoft Office Excel MDXSET 记录堆溢出漏洞 (CVE-2010-0261) 的变通办法
...
#### Microsoft Office Excel MDXSET 记录堆溢出漏洞 (CVE-2010-0261) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0262](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0262)。

#### Microsoft Office Excel FNGROUPNAME 记录未初始化的内存漏洞 (CVE-2010-0262) 的缓解因素
...
#### Microsoft Office Excel FNGROUPNAME 记录未初始化的内存漏洞 (CVE-2010-0262) 的变通办法
...
#### Microsoft Office Excel FNGROUPNAME 记录未初始化的内存漏洞 (CVE-2010-0262) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0263](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0263)。

#### Microsoft Office Excel XLSX 文件分析代码执行漏洞 (CVE-2010-0263) 的缓解因素
...
#### Microsoft Office Excel XLSX 文件分析代码执行漏洞 (CVE-2010-0263) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **使用 Microsoft Office 文件阻止策略禁止打开来自未知或不可信来源和位置的 Office 2007 文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 Microsoft [知识库文章 922848](https://support.microsoft.com/kb/922848) 所述配置特殊“例外目录”的用户在 Office 2003 或 2007 Microsoft Office System 中无法打开 Office 2007 文件。
...
#### Microsoft Office Excel XLSX 文件分析代码执行漏洞 (CVE-2010-0263) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0264](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0264)。

#### Microsoft Office Excel DbOrParamQry 记录分析漏洞 (CVE-2010-0264) 的缓解因素
...
#### Microsoft Office Excel DbOrParamQry 记录分析漏洞 (CVE-2010-0264) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### Microsoft Office Excel DbOrParamQry 记录分析漏洞 (CVE-2010-0264) 的常见问题
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/978471">Microsoft 知识库文章 978471</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/978474">Microsoft 知识库文章 978474</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
#### Excel 2007（所有版本）、Excel Viewer 以及用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2007，请参阅：<br />
<a href="https://support.microsoft.com/kb/978382">Microsoft 知识库文章 978382</a><br />  
<br />  
对于 Excel Viewer，请参阅：<br />  
<a href="https://support.microsoft.com/kb/978383">Microsoft 知识库文章 978383</a><br />  
<br />  
对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包，请参阅：<br />
<a href="https://support.microsoft.com/kb/978380">Microsoft 知识库文章 978380</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=ae5936f8-fe3f-4d23-a37c-d80f228e475e)下载和安装 Microsoft Office 2004 for Mac 11.5.8 Update 的合适语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Microsoft Office 2004 for Mac 11.5.8 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Microsoft Office 2004 for Mac 11.5.8 Update 卷窗口中双击 Microsoft Office 2004 for Mac 11.5.8 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2004 for Mac 11.5.8 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=e0ed1569-ab2f-407c-b728-4eddc463c385)下载和安装 Microsoft Office 2008 for Mac 12.2.4 Update 的合适语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Microsoft Office 2008 for Mac 12.2.4 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Microsoft Office 2008 for Mac 12.2.4 Update 卷窗口中双击 Microsoft Office 2008 for Mac 12.2.4 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2008 for Mac 12.2.4 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=4c5487d5-c912-4087-8c83-769e3fb78ea9)下载和安装 Open XML File Format Converter for Mac 1.1.4 Update 的合适语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Open XML File Format Converter for Mac 1.1.4 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Open XML File Format Converter for Mac 1.1.4 Update 卷窗口中双击 Open XML File Format Converter for Mac 1.1.4 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Open XML File Format Converter for Mac 1.1.4 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
<br />  
对于 Microsoft Office SharePoint Server 2007 Service Pack 1 和 Microsoft Office SharePoint Server 2007 Service Pack 2（64 位版本）：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979439">Microsoft 知识库文章 979439</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Microsoft Office Excel 记录内存损坏漏洞 (CVE-2010-0257)  
-   VeriSign iDefense Labs 的 Sean Larsson 报告了 Microsoft Office Excel 工作表对象类型混淆漏洞 (CVE-2010-0258)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了 Microsoft Office Excel MDXTUPLE 记录堆溢出漏洞 (CVE-2010-0260)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了 Microsoft Office Excel MDXSET 记录堆溢出漏洞 (CVE-2010-0261)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了 Microsoft Office Excel FNGROUPNAME 记录未初始化的内存漏洞 (CVE-2010-0262)  
-   一名匿名研究员与 TippingPoint 的 [Zero Day Initiative](https://www.tippingpoint.com/) 一起报告了 Microsoft Office Excel XLSX 文件分析代码执行漏洞 (CVE-2010-0263)  
-   [Core Security Technologies](https://www.coresecurity.com/) 的 Damián Frizza 报告了 Microsoft Office Excel DbOrParamQry 记录分析漏洞 (CVE-2010-0264)

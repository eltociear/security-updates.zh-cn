...
**已知问题。** [Microsoft 知识库文章 980150](http://support.microsoft.com/kb/980150) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
[Microsoft 知识库文章 980150](http://support.microsoft.com/kb/980150) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0257)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0258)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0260)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0261)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0262](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0262)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0263](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0263)。
...
-   **使用 Microsoft Office 文件阻止策略禁止打开来自未知或不可信来源和位置的 Office 2007 文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 Microsoft [知识库文章 922848](http://support.microsoft.com/kb/922848) 所述配置特殊“例外目录”的用户在 Office 2003 或 2007 Microsoft Office System 中无法打开 Office 2007 文件。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0264)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/978471">Microsoft 知识库文章 978471</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/978474">Microsoft 知识库文章 978474</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<a href="http://support.microsoft.com/kb/978382">Microsoft 知识库文章 978382</a><br />  
<br />  
对于 Excel Viewer，请参阅：<br />  
<a href="http://support.microsoft.com/kb/978383">Microsoft 知识库文章 978383</a><br />  
<br />  
对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包，请参阅：<br />
<a href="http://support.microsoft.com/kb/978380">Microsoft 知识库文章 978380</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/979439">Microsoft 知识库文章 979439</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 Microsoft Office Excel 记录内存损坏漏洞 (CVE-2010-0257)  
-   VeriSign iDefense Labs 的 Sean Larsson 报告了 Microsoft Office Excel 工作表对象类型混淆漏洞 (CVE-2010-0258)  
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Sean Larsson 报告了 Microsoft Office Excel MDXTUPLE 记录堆溢出漏洞 (CVE-2010-0260)  
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Sean Larsson 报告了 Microsoft Office Excel MDXSET 记录堆溢出漏洞 (CVE-2010-0261)  
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Sean Larsson 报告了 Microsoft Office Excel FNGROUPNAME 记录未初始化的内存漏洞 (CVE-2010-0262)  
-   一名匿名研究员与 TippingPoint 的 [Zero Day Initiative](http://www.tippingpoint.com/) 一起报告了 Microsoft Office Excel XLSX 文件分析代码执行漏洞 (CVE-2010-0263)  
-   [Core Security Technologies](http://www.coresecurity.com/) 的 Damián Frizza 报告了 Microsoft Office Excel DbOrParamQry 记录分析漏洞 (CVE-2010-0264)

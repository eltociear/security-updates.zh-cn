...
**已知问题。** [Microsoft 知识库文章 2423930](https://support.microsoft.com/kb/2423930) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[MS10-003](https://go.microsoft.com/fwlink/?linkid=178812)
</td>
</tr>
...
Microsoft 已修订此公告，宣布 [MS11-021](https://go.microsoft.com/fwlink/?linkid=210121)、[MS11-022](https://go.microsoft.com/fwlink/?linkid=210727) 和 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206) 安全公告中提供的 Microsoft Office 2004 for Mac (KB2505924) 安全更新除了解决各自公告中介绍的漏洞外，也可以解决本安全公告中介绍的漏洞。 虽然 KB2505924 更新程序包在三个单独的安全公告中提供，但是安装了 Microsoft Office 2004 for Mac 的用户只需安装安全更新程序包一次。 有关下载链接的详细信息，请参阅 [MS11-021](https://go.microsoft.com/fwlink/?linkid=210121)、[MS11-022](https://go.microsoft.com/fwlink/?linkid=210727) 或 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206)。

**为什么在 2010 年 12 月 15 日修订此公告？**  
Microsoft 修订此公告是为了宣布 [Microsoft Office 2008 for Mac](https://www.microsoft.com/download/details.aspx?familyid=ad1b1984-b2b2-49b3-a1dd-385b77d9248a) (KB2476512) 和 [Open XML File Format Converter for Mac](https://www.microsoft.com/download/details.aspx?familyid=b846d255-a7d4-4a2c-a084-d434c29fe676) (KB2476511) 的安全更新已可用。 Microsoft 建议 Microsoft Office 2008 for Mac 和 Open XML File Format Converter for Mac 的用户尽早应用这些更新以解决此公告中所述的漏洞。 Microsoft Office 2004 for Mac 的更新此时不可用。

**为什么在 2010 年 11 月 17 日修订此公告？**  
Microsoft 修订此公告，是为了将 [CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573) 添加至此更新所解决的漏洞。 对于 Microsoft PowerPoint 2002 和 Microsoft PowerPoint 2003，此公告 (MS10-087) 中提供的 Microsoft Office 更新也可解决 CVE-2010-2573。 这仅仅是一个信息更改。 成功应用了 MS10-087 和 MS10-088 的更新的客户不必采取任何行动。

**哪里可以找到 Microsoft Office 2004 for Mac 的更新？**  
[MS11-021](https://go.microsoft.com/fwlink/?linkid=210121)、[MS11-022](https://go.microsoft.com/fwlink/?linkid=210727) 和 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206) 安全公告中提供的 Microsoft Office 2004 for Mac (KB2505924) 更新除了解决各自公告中介绍的漏洞外，也可以解决本安全公告中介绍的漏洞。 虽然 KB2505924 更新程序包在三个单独的安全公告中提供，但是安装了 Microsoft Office 2004 for Mac 的用户只需安装安全更新程序包一次。 有关下载链接的详细信息，请参阅 [MS11-021](https://go.microsoft.com/fwlink/?linkid=210121)、[MS11-022](https://go.microsoft.com/fwlink/?linkid=210727) 或 [MS11-023](https://go.microsoft.com/fwlink/?linkid=210206)。

**MS10-088 与此公告 (MS10-087) 有何关联？**  
在此公告 (MS10-087) 和 [MS10-088](https://go.microsoft.com/fwlink/?linkid=198186) 中均可解决 [CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573)，Microsoft PowerPoint 中的漏洞可能允许远程执行代码 (2293386)。 对于 Microsoft PowerPoint 2002 和 Microsoft PowerPoint 2003，此更新 (MS10-087) 可解决漏洞。 MS10-088 可解决所有其他软件中的漏洞，包括受 CVE-2010-2573 影响的 PowerPoint Viewer。
...
以下严重等级假设漏洞的可能的最大影响。 有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [11 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms10-nov)中的利用指数。 有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2573](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2573)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3333](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3333)。
...
-   **使用 Microsoft Office 文件阻止策略禁止打开来自未知或不可信来源和位置的 RTF 文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](https://support.microsoft.com/kb/922848)所述配置特殊例外目录或将文件移动到可信位置的用户在 Office 2003 或 2007 Microsoft Office System 中将无法打开 RTF 文件。 对于 Microsoft Office 2010，将阻止打开或在受保护的模式中打开 RTF 文件，具体取决于所选择的打开行为。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3334](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3334)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3335](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3335)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3336](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3336)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3337](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3337)。
...
是的，此漏洞与 [Microsoft 安全通报 2269637](https://technet.microsoft.com/security/advisory/2269637) 中所述的影响应用程序如何加载外部库的漏洞类别有关。此安全公告针对这种漏洞的特定实例。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2289169">Microsoft 知识库文章 2289169</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2289187">Microsoft 知识库文章 2289187</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2289158">Microsoft 知识库文章 2289158</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Office 2010，请参阅 <a href="https://support.microsoft.com/kb/2289161">Microsoft 知识库文章 2289161</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=ad1b1984-b2b2-49b3-a1dd-385b77d9248a)下载和安装 Microsoft Office 2008 for Mac 12.2.8 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=8bd6ca3b-8004-4e8d-a09d-220dcbbce799)下载和安装 Microsoft Office for Mac 2011 14.0.1 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=b846d255-a7d4-4a2c-a084-d434c29fe676)下载和安装 Open XML File Format Converter for Mac 1.1.8 Update 的合适语言版本。
...
-   一位匿名研究员与 [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 PowerPoint 整数下溢导致堆损坏漏洞 (CVE-2010-2573)  
-   [team509](https://www.team509.com/) 与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作报告了 RTF 堆栈缓冲区溢出漏洞 (CVE-2010-3333)  
-   [Secunia](https://secunia.com/) 的 Dyon Balding 报告了 Office 艺术绘制记录漏洞 (CVE-2010-3334)  
-   [CERT Coordination Center](https://www.cert.org/) 的 Will Dorman 报告了 Office 艺术绘制记录漏洞 (CVE-2010-3334)  
-   [TippingPoint's](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了绘制异常处理漏洞 (CVE-2010-3335)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/)的 Chaouki Bekrar 报告了 MSO 大型 SPID 读取 AV 漏洞 (CVE-2010-3336)  
-   [Fortinet’s FortiGuard Labs](https://www.fortiguard.com/) 的 Haifei Li 报告了库加载不安全漏洞 (CVE-2010-3337)  
-   [ACROS Security](https://www.acrossecurity.com/) 的 Simon Raner 报告了库加载不安全漏洞 (CVE-2010-3337)

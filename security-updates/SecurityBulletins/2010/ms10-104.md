...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3c8fb9f9-7920-43ea-b618-e26dc3360c60">Microsoft Office SharePoint Server 2007 Service Pack 2（32 位版本）</a><br />
(KB2433089)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3db09280-24bd-42e0-9ae3-02c9bf3e8ee3">Microsoft Office SharePoint Server 2007 Service Pack 2（64 位版本）</a><br />
(KB2433089)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3964](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3964)。
...
-   **在防火墙处阻止 Office 文档转换启动器服务使用的端口**
    ...
    此端口用于启动与受影响组件的连接。 将此端口阻止在企业防火墙处（入站和出站），有助于保护位于防火墙后面的系统免受利用此漏洞进行的攻击。 Microsoft 建议阻塞所有来自 Internet 的未经请求的入站通信，以帮助阻止可能使用其他端口进行的攻击。 有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。
  
    **变通办法的影响。** 应用程序和服务可能使用受影响的端口。 阻止与端口进行连接可能导致各种应用程序或服务无法正常运行。
  
    **如何撤消变通方法。**
  
    在防火墙处解除对 TCP 端口 8082 的阻止。 有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2433089">Microsoft 知识库文章 2433089</a></td>
</tr>  
<tr class="even">
...
-   Oleksandr Mirosh 与 [TippingPoint 的](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了格式错误的请求执行代码漏洞 (CVE-2010-3964)

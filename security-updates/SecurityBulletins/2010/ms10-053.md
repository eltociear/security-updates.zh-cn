---
TOCTitle: 'MS10-053'
Title: 'Microsoft 安全公告 MS10-053 - 严重'
ms:assetid: 'ms10-053'
ms:contentKeyID: 61237892
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-053(v=Security.10)'
---

Microsoft 安全公告 MS10-053 - 严重
==================================

Internet Explorer 的累积性安全更新 (2183461)
--------------------------------------------
...
通过修改 Internet Explorer 强制执行安全检查和处理内存中对象的方式，此安全更新解决了漏洞问题。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
此更新包括 Internet Explorer 8 XSS 筛选器纵深防御更新。
...
<th>
事件处理跨域漏洞 - CVE-2010-1258
</th>
<th>
未初始化的内存损坏漏洞 - CVE-2010-2556
</th>
<th>
未初始化的内存损坏漏洞 - CVE-2010-2557
</th>
<th>
竞争状态内存损坏漏洞 - CVE-2010-2558
</th>
<th>
未初始化的内存损坏漏洞 - CVE-2010-2559
</th>
<th>
HTML 布局内存损坏漏洞 - CVE-2010-2560
</th>
<th>
综合严重等级
</th>
...
Internet Explorer 中存在信息泄露漏洞，可能允许脚本访问另一个域或 Internet Explorer 区域中的浏览器窗口。 攻击者可能通过构建特制网页来利用此漏洞，如果用户查看该网页，然后使用鼠标与浏览器窗口交互，则可能允许信息泄露。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1258)。

#### 事件处理跨域漏洞 (CVE-2010-1258) 的缓解因素
...
#### 事件处理跨域漏洞 (CVE-2010-1258) 的常见问题解答
...
**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以在查看网页的用户上下文中执行脚本，这可能允许攻击者查看用户信息。
...
**此更新有什么作用？**  
该更新在验证脚本的来源时会将 Internet Explorer 修改为强制执行安全检查。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2556)。

#### 未初始化的内存损坏漏洞 (CVE-2010-2556) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2010-2556) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2010-2556) 的常见问题解答
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2557](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2557)。

#### 未初始化的内存损坏漏洞 (CVE-2010-2557) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2010-2557) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2010-2557) 的常见问题解答
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2558](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2558)。

#### 竞争状态内存损坏漏洞 (CVE-2010-2558) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。

#### 竞争状态内存损坏漏洞 (CVE-2010-2558) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 竞争状态内存损坏漏洞 (CVE-2010-2558) 的常见问题解答
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2559](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2559)。

#### 未初始化的内存损坏漏洞 (CVE-2010-2559) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2010-2559) 的变通办法
...
#### 未初始化的内存损坏漏洞 (CVE-2010-2559) 的常见问题解答
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2560](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2560)。

#### HTML 布局内存损坏漏洞 (CVE-2010-2560) 的缓解因素
...
#### HTML 布局内存损坏漏洞 (CVE-2010-2560) 的变通办法
...
#### HTML 布局内存损坏漏洞 (CVE-2010-2560) 的常见问题解答
...
<p>使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2183461$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie7updates\KB2183461-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie8updates\KB2183461-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2183461">Microsoft 知识库文章 2183461</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2183461$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
-   [Google Inc.](http://www.google.com/) 的 David Bloomfor 报告了事件处理跨域漏洞 - CVE-2010-1258  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com) 的 Nicolas Joly 报告了未初始化内存损坏漏洞 (CVE-2010-2556)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了未初始化内存损坏漏洞 (CVE-2010-2557)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了竞争状态内存损坏漏洞 (CVE-2010-2558)  
-   Gambino ZaDarkSide 报告了未初始化内存损坏漏洞 - CVE-2010-2559  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 HTML 布局内存损坏漏洞 (CVE-2010-2560)

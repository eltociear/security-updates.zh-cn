...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1883](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1883)。
...
- **禁用对分析 Internet Explorer 中的嵌入字体的支持**
  ...
  **注意** 组策略 MMC 管理单元可用于为系统、组织单位或整个域设置策略。 有关组策略的详细信息，请访问以下 Microsoft 网站：
  ...
  -   [组策略](https://technet2.microsoft.com/windowsserver/en/library/6d7cb788-b31d-4d17-9f1e-b5ddaa6deecd1033.mspx?mfr=true)集合  
  -   [什么是](https://technet2.microsoft.com/windowsserver/en/library/47ba1311-6cca-414f-98c9-2d7f99fca8a31033.mspx?mfr=true)组策略对象编辑器？  
  -   [核心组策略](https://technet2.microsoft.com/windowsserver/en/library/e926577a-5619-4912-b5d9-e73d4bdc94911033.mspx?mfr=true)工具和设置
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/982132">Microsoft 知识库文章 982132</a></td>
</tr>  
<tr class="even">
...
-   Sebastian Apelt 与 [Tipping Point](https://www.tippingpoint.com) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Embedded OpenType 字体整数溢出漏洞 (CVE-2010-1883)  

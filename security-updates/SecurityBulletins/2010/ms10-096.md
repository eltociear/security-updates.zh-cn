---
TOCTitle: 'MS10-096'
Title: 'Microsoft 安全公告 MS10-096 - 重要'
ms:assetid: 'ms10-096'
ms:contentKeyID: 61237935
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-096(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS10-096 - 重要
==================================

Windows 通讯簿中的漏洞可能允许远程执行代码 (2423089)
----------------------------------------------------
...
此安全更新通过更正 Windows 通讯簿加载外部库的方式来解决此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=46baa431-126c-4fa5-9a7b-525008e2817d)                                                                                     | 远程执行代码 | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b9ce9d62-2eaa-48d8-bb6d-ea137e63d077)                                                            | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e0b2837c-019b-419b-954d-5bdc71a3a332)                                                                            | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4c5cb600-9a39-40a0-be42-1593b1e0b97d)                                                                | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=9abc8270-f3ac-474d-9ebc-410aaa6262cc)                                                            | 远程执行代码 | 重要         | 无               |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a1c7f1b5-e054-4cd6-857d-2ab0a2fe9f62)                                                  | 远程执行代码 | 重要         | 无               |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=73624b68-a69d-4517-b971-f0b7d2ccc9d6)                          | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=118f528f-bd05-49c2-a4a4-78314cd00992)\*\*               | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=77e288fb-b51f-4f57-baac-1443d8fbd37b)\*\*     | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=82f71194-6f1f-4f43-8752-4bf5e5f94a93) | 远程执行代码 | 重要         | 无               |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=4e8ad5cd-af27-4f00-9378-ad778b8ee7b3)                                                                                   | 远程执行代码 | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=35a3e821-b463-411c-858b-d01eb5aed42b)                                                                              | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=9e2c95f6-9381-4484-b11b-814ab9138118)\*\*                                                             | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=cb4211f3-1082-4245-8f03-7cbac90e9a31)                                                             | 远程执行代码 | 重要         | 无               |
...
库加载不安全漏洞 - CVE-2010-3147  
--------------------------------
  
<span></span>  
Microsoft 通讯簿处理 DLL 文件加载的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3147](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147)。
  
#### 库加载不安全漏洞 (CVE-2010-3147) 的缓解因素
...
#### 库加载不安全漏洞 (CVE-2010-3147) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**    
此漏洞是由于 Windows 通讯簿不正确限制加载外部库使用的路径所导致的。
  
**什么是 Windows 通讯簿？**    
Windows 提供一个用于存储联系人信息的通讯簿。 Windows 通讯簿 (WAB) 是一个允许用户跟踪联系人的应用程序和服务。 WAB 有一个本地数据库和用户界面，用于查找和编辑联系人的信息，它可以使用轻量目录访问协议 (LDAP) 查询网络目录服务器。 其他应用程序可使用 WAB。 例如，Microsoft Outlook 使用 WAB 作为其电子邮件通讯簿。
...
**攻击者如何利用此漏洞？**    
攻击者可能诱使用户打开与特制动态链接库 (DLL) 文件位于同一网络目录下的合法 Windows 通讯簿 (WAB) 文件。 然后，在用户打开 WAB 文件时，Windows 通讯簿可能尝试加载 DLL 文件并执行其包含的任何代码。
  
在电子邮件攻击情形中，攻击者可能通过向用户发送合法的 WAB 文件附件并诱使用户将 WAB 放在包含特制 DLL 文件的目录下并打开此 WAB 文件来利用此漏洞。 然后，在用户打开 WAB 文件时，Windows 通讯簿可能尝试加载 DLL 文件并执行其包含的任何代码。
  
在网络情形中，攻击者可能将合法的 WAB 文件与特制 DLL 一起放在 UNC 或 WebDAV 位置上，并诱使用户打开该 WAB 文件。
  
**受此漏洞威胁最大的系统有哪些？**    
此漏洞主要影响可能期望用户从不受信任的网络位置打开附件的工作站。 如果管理员允许用户登录服务器并运行程序，服务器同样可能面临风险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**    
此更新通过更正 Windows 通讯簿加载外部库的方式来解决此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3147](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3147)。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2423089$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2423089">Microsoft 知识库文章 2423089</a></td>
</tr>  
<tr class="even">
...
-   [ACROS Security](https://www.acrossecurity.com/) 的 Simon Raner 报告了库加载不安全漏洞 (CVE-2010-3147)  
-   [Rapid7](https://www.rapid7.com/) 的 HD Moore 报告了库加载不安全漏洞 (CVE-2010-3147)  
-   [NGS Software](https://www.ngssoftware.com/) 的 Muhaimin Dzulfakar 报告了库加载不安全漏洞 (CVE-2010-3147)

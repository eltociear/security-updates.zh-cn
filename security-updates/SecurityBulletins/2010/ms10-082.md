---
TOCTitle: 'MS10-082'
Title: 'Microsoft 安全公告 MS10-082 - 重要'
ms:assetid: 'ms10-082'
ms:contentKeyID: 61237921
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-082(v=Security.10)'
---



Microsoft 安全公告 MS10-082 - 重要
==================================

Windows Media Player 中的漏洞可能允许远程执行代码 (2378111)
-----------------------------------------------------------
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bbf153e7-e764-46a0-a33b-81b7288d346c">Windows Media Player 9 系列</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=184071">MS10-027</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows XP Service Pack 3</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bbf153e7-e764-46a0-a33b-81b7288d346c">Windows Media Player 10</a><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=bbf153e7-e764-46a0-a33b-81b7288d346c">Windows Media Player 11</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0663e0e8-c5d1-4cd2-b6d3-ff78fb56bba1">Windows Media Player 10</a><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=474b5618-dfe6-40de-b59b-1fd61a05749e">Windows Media Player 11</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5479fd20-50d1-447a-8555-a98ce0723f71">Windows Media Player 10</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a9515e69-c147-4810-8c5a-6cb94c398a95">Windows Media Player 10</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=95e24a63-d21a-4756-a16e-17a977595396">Windows Media Player 11</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=277151a2-b74f-4da6-8203-e774af75e44c">Windows Media Player 11</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=67eb3a70-9ca7-4184-b9fe-cc3e66b1bf36">Windows Media Player 11</a>&#42;&#42;</td>
<td style="border:1px solid black;">远程执行代码</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=33a06f0e-81ab-445a-bc89-14350ebfe688">Windows Media Player 11</a>&#42;&#42;</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=59a2ef36-9c32-488b-b5b1-30b5bcd83358">Windows Media Player 12</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=00176d56-8a93-4780-96fc-a7ab715e7291">Windows Media Player 12</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4cf0e3b1-4b72-4f99-b716-2489ea42ed72">Windows Media Player 12</a>**</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<th style="border:1px solid black;">  
Windows Media Player 内存损坏漏洞 - CVE-2010-2745  
</th>  
<th style="border:1px solid black;">  
综合严重等级  
</th>  
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2 上的 Windows Media Player 11\*\*
</td>
<td style="border:1px solid black;">
**中等**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上的 Windows Media Player 11\*\*
</td>
<td style="border:1px solid black;">
**中等**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
用于 32 位系统的 Windows 7 上的 Windows Media Player 12
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
用于基于 x64 的系统的 Windows 7 上的 Windows Media Player 12
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
用于基于 x64 的系统的 Windows Server 2008 R2 上的 Windows Media Player 12\*
</td>
<td style="border:1px solid black;">
**中等**   
远程执行代码
...
Windows Media Player 在重新加载操作过程中通过 Web 浏览器取消分配对象的方式中存在一个远程执行代码漏洞。 如果用户访问特制网页，此漏洞可能允许远程执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2745](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2745)。

#### Windows Media Player 内存损坏漏洞 (CVE-2010-2745) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
-   除非安装桌面体验功能，否则 Windows Server 2008 和 Windows Server 2008 R2 的支持版本不会受此问题的影响。 默认情况下，这些平台不加载受影响的 Windows Media Player 组件。 有关桌面体验功能的详细信息，请参阅 TechNet 文章“[桌面体验概述](https://technet.microsoft.com/en-us/library/cc772567.aspx)”。

#### Windows Media Player 内存损坏漏洞 (CVE-2010-2745) 的变通办法
...
-   **注销 wmp.dll**
    ...
    **变通办法的影响。** Windows Media Player 不能播放支持的文件格式。
...
#### Windows Media Player 内存损坏漏洞 (CVE-2010-2745) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
Windows Media Player 在重新加载操作过程中通过 Web 浏览器不正确地取消分配对象。
...
**利用此漏洞是否需要用户交互？**  
是。 为成功进行攻击，用户必须在浏览网页时点击通过一个或多个弹出对话框。 访问特制网页时，无法自动利用此漏洞。

**攻击者可能利用此漏洞执行什么操作？**  
如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**攻击者如何利用此漏洞？**  
攻击者可能拥有一个旨在通过 Windows Media Player 利用此漏洞的特制网站，然后诱使用户查看该网站。 用户还需要点击通过一个或多个弹出对话框，攻击者才能成功利用此漏洞。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问特制的网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。

**受此漏洞威胁最大的系统有哪些？**  
工作站和终端服务器受到的威胁最大。 当应该没有足够管理权限的用户被授予登录到服务器并运行程序的权限时，服务器会更有危险。 不过，最佳做法是不要授予这样的权限。

**此更新有什么作用？**  
此更新通过更正 Windows Media Player 在重新加载操作过程中取消分配对象的方式来解决此问题。
...
<td style="border:1px solid black;">对于 Windows XP Service Pack 3 上的 Windows Media Player 9、Windows Media Player 10 和 Windows Media Player 11：<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Professional x64 Edition Service Pack 2 上的 Windows Media Player 10：<br />
windowsserver2003.windowsxp-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Professional x64 Edition Service Pack 2 上的 Windows Media Player 11：<br />
windowsmedia11-kb2378111-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">在不重新启动的情况下安装</td>
<td style="border:1px solid black;">对于 Windows XP Service Pack 3 上的 Windows Media Player 9：<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Service Pack 3 上的 Windows Media Player 10 和 Windows Media Player 11：<br />
windowsxp-windowsmedia-kb2378111-x86-enu.exe /norestart</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或下列位置的 Spuninst.exe 实用程序：<br />
<br />  
对于 Windows XP Service Pack 3 上的 Windows Media Player 9、Windows Media Player 10 和 Windows Media Player 11：<br />  
%Windir%\\$NTUninstallKB2378111_WM9$\Spuninst 文件夹<br />  
<br />  
对于 Windows XP Professional x64 Edition Service Pack 2 上的 Windows Media Player 10：<br />  
%Windir%\\$NTUninstallKB2378111$\Spuninst 文件夹<br />  
<br />  
对于 Windows XP Professional x64 Edition Service Pack 2 上的 Windows Media Player 11：<br />
%Windir%\\$NTUninstallKB2378111_WM11x64$\Spuninst 文件夹</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2378111">Microsoft 知识库文章 2378111</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Windows XP 的受支持的 32 位版本上的 Windows Media Player 9、Windows Media Player 10 和 Windows Media Player 11：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP 所有受支持的基于 x64 的版本上的 Windows Media Player 10：<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP Version 2003\SP3\KB2378111\Filelist<br />  
<br />  
对于 Windows XP 所有受支持的基于 x64 的版本上的 Windows Media Player 11：<br />  
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2378111$\Spuninst 文件夹中的 Spuninst.exe 实用工具</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2378111">Microsoft 知识库文章 2378111</a></td>
...
-   [Google Inc.](https://www.google.com/)的 SkyLined 报告了 Windows Media Player 内存损坏漏洞 (CVE-2010-2745)
...
-   V1.1（2010 年 10 月 13 日）： 针对 Windows XP Professional x64 Edition Service Pack 2 上的 Windows Media Player 11 更正了“**受影响的软件**”表中的下载链接。使用自动更新安装了此特定软件包的客户不需要执行任何操作。 从 Microsoft 下载中心手动安装的客户需要手动安装此新软件包。

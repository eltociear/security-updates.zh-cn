...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2745](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2745)。
...
-   除非安装桌面体验功能，否则 Windows Server 2008 和 Windows Server 2008 R2 的支持版本不会受此问题的影响。 默认情况下，这些平台不加载受影响的 Windows Media Player 组件。 有关桌面体验功能的详细信息，请参阅 TechNet 文章“[桌面体验概述](http://technet.microsoft.com/en-us/library/cc772567.aspx)”。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2378111">Microsoft 知识库文章 2378111</a></td>
</tr>  
<tr class="odd">
...
-   [Google Inc.](http://www.google.com/)的 SkyLined 报告了 Windows Media Player 内存损坏漏洞 (CVE-2010-2745)

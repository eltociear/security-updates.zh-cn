...
<tr class="alternateRow">
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 1 以及用于 Word、Excel 和 PowerPoint 2007 文件格式 的 Microsoft Office 兼容包 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7f89a734-cda4-4abb-9a10-f6dfe560e8d0)  
(KB982331)
</td>
<td style="border:1px solid black;">
不适用
...
此公告 [MS10-036](https://go.microsoft.com/fwlink/?linkid=190554) 中的 Microsoft Office Excel 2003 (KB982133) 和 Microsoft Office Excel 2007 (KB982308) 安全更新包还解决了本公告 MS10-038 中描述的漏洞。安装了Microsoft Office Excel 2003 或 Microsoft Office Excel 2007 的用户只需安装这些安全更新包一次。 此外，[MS10-036](https://go.microsoft.com/fwlink/?linkid=190554) 提供了相关的 Microsoft Office 更新（KB982311 或 KB982312），用户也必须安装以解决 [MS10-036](https://go.microsoft.com/fwlink/?linkid=190554) 中描述的漏洞。

**此更新为何消除了多个已报告的安全漏洞？**  
此更新之所以包含对某些漏洞的支持，是因为解决这些问题所需的修改位于相关的文件中。 客户只需安装此更新就可以了，而不用安装多个几乎相同的更新。

**此更新是否包含任何其他与安全性无关的功能更改？**  
是，Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2 的更新程序包 (KB982308) 包括 [Microsoft 知识库文章 981046](https://support.microsoft.com/kb/981046) 中描述的对 Excel 2007 的更改。
...
是的，作为 2007 Microsoft Office System 服务模型的一部分，当 Microsoft Office 2007 Service Pack 1 用户安装此更新时，用户的系统将升级为 Microsoft Office 2007 Service Pack 2 最初版本的安全功能。2009年 4 月 24 日之后发行的 Microsoft Office 2007 的所有更新将包含 [2007 Microsoft Office System Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b444bf18-79ea-46c6-8a81-9db49b4ab6e5&displaylang=en) 中所介绍的这些安全功能。我们已经对此更新进行了彻底测试，但是与所有更新一样，我们建议用户对其环境和系统的配置执行适合的测试。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0822](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0822)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0823](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0823)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0824](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0824)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1245](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1245)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1246](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1246)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1247](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1247)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1248](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1248)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1249](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1249)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1250](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1250)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1251](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1251)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1252](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1252)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1253)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1254](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1254)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/982299">Microsoft 知识库文章 982299</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/982133">Microsoft 知识库文章 982133</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2007：<br />
请参阅 <a href="https://support.microsoft.com/kb/982308">Microsoft 知识库文章 982308</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Excel Viewer：<br />
请参阅 <a href="https://support.microsoft.com/kb/982333">Microsoft 知识库文章 982333</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包：<br />
请参阅 <a href="https://support.microsoft.com/kb/982331">Microsoft 知识库文章 982331</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=16c71ab8-9284-407a-856a-93c67995f125)下载和安装 Microsoft Office 2004 for Mac 11.5.9 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=d46255bd-6470-4106-9fe2-ea67acd3f1bd)下载和安装 Microsoft Office 2008 for Mac 12.2.5 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=b6ca7b05-cf97-43a2-95eb-7b5caf7c1528)下载和安装 Open XML File Format Converter for Mac 1.1.5 Update 的合适语言版本。
...
-   一名匿名研究人员与 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了 Excel 记录分析内存损坏漏洞 (CVE-2010-0821)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 对象堆栈溢出漏洞 (CVE-2010-0822)  
-   [Fortinet's FortiGuard Labs](https://www.fortiguard.com/) 的 Bing Liu 报告了 Excel 内存损坏漏洞 (CVE-2010-0823)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 记录内存损坏漏洞 (CVE-2010-0824)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 记录内存损坏漏洞 (CVE-2010-1245)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel RTD 内存损坏漏洞 (CVE-2010-1246)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 内存损坏漏洞 (CVE-2010-1247)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel HFPicture 内存损坏漏洞 (CVE-2010-1248)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 内存损坏漏洞 (CVE-2010-1249)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Excel EDG 内存损坏漏洞 (CVE-2010-1250)  
-   [Secunia](https://secunia.com/) 的 Carsten Eiram 报告了 Excel 记录堆栈损坏漏洞 (CVE-2010-1251)  
-   [Secunia](https://secunia.com/) 的 Carsten Eiram 报告了 Excel 字符串变量漏洞 (CVE-2010-1252)  
-   一名匿名研究人员与 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了 Excel ADO 对象漏洞 (CVE-2010-1253)  

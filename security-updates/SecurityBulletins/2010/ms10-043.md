...
此安全更新也解决了最初在 [Microsoft 安全通报 2028859](https://technet.microsoft.com/security/advisory/2028859) 中描述的漏洞。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=33ec8c0e-1617-46bf-bd7f-2ce750f89d7f)                    | 远程执行代码 | 严重         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=2a9998fc-beac-4ccf-aa61-4232106adae1)\*\*\* | 远程执行代码 | 重要         | 无               |
...
是，Windows 7 Service Pack 1 Beta 和 Windows Server 2008 R2 Service Pack 1 Beta 的基于 x64 的版本受此公告中描述的漏洞影响。 鼓励运行受影响操作系统的这些 beta 版本的客户下载并向其系统应用此更新。 安全更新可从 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 和 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 获得。 此安全更新也可以从 [Microsoft 下载中心](https://go.microsoft.com/fwlink/?linkid=21129)下载。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**为什么 Windows Server 2008 R2（用于基于 Itanium 的系统）不受影响？**  
要受到此问题的伤害，系统必须启用 Windows Aero 主题。 Windows Server 2008 R2（用于基于 Itanium 的系统）不支持 Windows Aero 主题。 有关支持功能的列表，请参阅 TechNet 文章“[Windows Server 2008 R2（用于基于 Itanium 的系统）功能支持](https://technet.microsoft.com/en-us/library/cc772344(ws.10).aspx)”。
...
要在“常见漏洞和披露”列表中以标准条目的形式查看此漏洞，请参阅 [CVE-2009-3676](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3678)。
...
**什么是 GDI？**    
Microsoft Windows 图形设备接口 (GDI) 允许应用程序在视频显示和打印机上使用图形和格式化文本。 基于 Windows 的应用程序不直接访问图形硬件。 而是 GDI 代表应用程序与设备驱动程序进行交互。 有关 GDI 的详细信息，请参阅 MSDN 文章 [Windows GDI](https://msdn.microsoft.com/en-us/library/dd145203.aspx)。
...
**什么是地址空间布局随机化 (ASLR)？**    
实施地址空间布局随机化的系统在内存中伪随机地重新部署通常可预测的函数入口点。 有关 ASLR 的详细信息，请参阅 TechNet 杂志文章[深入了解 Windows Vista 内核： 第 3 部分](https://technet.microsoft.com/en-us/magazine/2007.04.vistakernel.aspx?pr=blog)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2009-3678](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3678)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2032276">Microsoft 知识库文章 2032276</a></td>
</tr>  
<tr class="odd">
...
-   [Reactive Systems, Inc](https://www.reactive-systems.com/) 的 David Hansel，报告了 Canonical Display Driver 数溢出漏洞 (CVE-2009-3678)

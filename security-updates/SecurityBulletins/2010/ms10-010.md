---
TOCTitle: 'MS10-010'
Title: 'Microsoft 安全公告 MS10-010 - 重要'
ms:assetid: 'ms10-010'
ms:contentKeyID: 61237535
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-010(v=Security.10)'
---

Microsoft 安全公告 MS10-010 - 重要
==================================
...
此安全更新通过更正 Hyper-V 服务器在客户虚拟机内部执行的计算机指令上验证编码的方式来解决该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3463a63c-e88a-4036-ab60-f84d4bf4191a)\* | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=3214b347-d901-4aac-85ce-676e4602de87)\*                                                         | 拒绝服务     | 重要         | 无               |
...
**即使没有启用 Hyper-V 角色，也可将此更新**手动安装到受影响的平台。 但是，如果启用了 Hyper-V 角色，则此更新只能通过“自动更新”提供。

**此更新是否需要应用于 Hyper-V 客户虚拟机？**  
此更新一定不能应用于 Hyper-V 客户机，而只能应用于启用了 Hyper-V 角色的计算机。 它只能通过“自动更新”提供给 Hyper-V 服务器系统，而不是源自虚拟的客户机。

**什么是 Hyper-V Server，它是否也受此漏洞影响？**  
...
Microsoft Hyper-V Server 2008、Microsoft Hyper-V Server 2008 Service Pack 2 和 Microsoft Hyper-V Server 2008 R2 受此漏洞影响，Windows Server 2008 和 Windows Server 2008 R2 更新必须分别应用，以帮助修复此漏洞。 启用“自动更新”的客户将被自动授予这些更新用于安装。
...
<tr class="header">
<th>受影响的软件</th>
<th>Hyper-V 指令集验证漏洞 - CVE-2010-0026</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Hyper-V 指令集验证漏洞 - CVE-2010-0026  
--------------------------------------
  
   
Windows Server 2008 和 Windows Server 2008 R2 上的 Hyper-V 中存在一个拒绝服务。该漏洞是由于 Hyper-V 执行的特定计算机指令顺序验证不充分造成的。 成功利用此漏洞的攻击者可能会导致 Hyper-V 系统停止响应。 这将影响受该系统托管的所有虚拟机。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0026)。
  
#### Hyper-V 指令集验证漏洞 (CVE-2010-0026) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录 Hyper-V 虚拟机才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Hyper-V 指令集验证漏洞 (CVE-2010-0026) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Hyper-V 指令集验证漏洞 (CVE-2010-0026) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个拒绝服务漏洞。 利用此漏洞的攻击者可能会导致受影响的 Hyper-V 服务器停止响应并要求系统重新启动。 请注意，虽然攻击者无法利用拒绝服务漏洞来执行代码或提升他们的用户权限，但此漏洞可能导致受影响的系统停止接受请求。
  
**造成漏洞的原因是什么？**    
此漏洞由 Hyper-V 服务器错误验证客户虚拟机内执行的特定计算机指令编码而造成。 由于缺少验证，处理这些指令可能导致 Hyper-V 服务器应用程序无响应。
...
**攻击者如何利用此漏洞？**    
攻击者必须是由 Hyper-V 服务器托管的其中一个客户虚拟机中的经身份验证的用户，且需要具有在系统上执行任意代码的能力。 然后，攻击者可以在系统上运行不受信任的可执行文件而调用错误的计算机指令顺序，从而导致 Hyper-V 服务器无响应。
  
**受此漏洞威胁最大的系统有哪些？**    
允许访问不受信任的用户的托管客户虚拟机的 Hyper-V 服务器受此漏洞的威胁最大。
  
**此更新有什么作用？**    
此更新通过更正 Hyper-V 服务器在客户虚拟机内部执行的计算机指令上验证编码的方式来解决该漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/977894">Microsoft 知识库文章 977894</a></td>
</tr>  
<tr class="odd">
...
-   Jan Bottorff 报告了 Hyper-V 指令集验证漏洞 (CVE-2010-0026)

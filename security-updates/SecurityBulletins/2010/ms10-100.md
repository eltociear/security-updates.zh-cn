...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3961](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3961)。
...
**什么是 Consent 用户界面 (UI)？**    
Consent UI 是用户帐户控制 (UAC) 的部件。 完全启用 UAC 后，交互式管理员通常以最小用户权限运行，但他们可以通过 Consent UI 给予明确同意来自我提升以执行管理任务。 此类管理任务包括安装软件和驱动程序、更改系统范围设置、查看或更改其他用户帐户，以及运行管理工具。 有关详细信息，请参阅 MSDN 文章[用户帐户控制](http://msdn.microsoft.com/en-us/library/aa511445.aspx)。
  
**什么是 SeImpersonatePrivilege？**    
SeImpersonatePrivilege 或“身份验证之后模拟客户端”用户权限是 Microsoft Windows 2000 Service Pack 4 中首次引用的安全设置。默认情况下，设备的本地管理员组的成员和设备的 LocalService 帐户被分配此用户权限。 [Microsoft 知识库文章 821546](http://support.microsoft.com/kb/821546) 中介绍了 SeImpersonatePrivilege 设置。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2442962">Microsoft 知识库文章 2442962</a></td>
</tr>  
<tr class="odd">
...
-   [Argeniss](http://www.argeniss.com/) 的 Cesar Cerrudo 报告了 Consent UI 模拟漏洞 (CVE-2010-3961)

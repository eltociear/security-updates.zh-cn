...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=d3955983-0079-476e-a488-99713097259c)                                                                         | 远程执行代码 | 严重         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=8c3f2e81-c0ea-494a-a47c-4f8982effb49)                                                        | 远程执行代码 | 严重         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f3e462fb-df95-4b79-a8bc-5359c2967503)                                                            | 远程执行代码 | 严重         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3c0bd349-aa77-47de-ba1d-1fcc72dcad28)                                                                            | 远程执行代码 | 中等         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4aa0ec4f-5502-4f2a-9732-975518c34444)                                                                | 远程执行代码 | 中等         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=55d9d7f0-f9d9-4833-b5cc-eb87a62da6a8)                                                            | 远程执行代码 | 中等         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2ddaa4b3-1a98-4183-94af-ebdae4e7b76a)                                                  | 远程执行代码 | 严重         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ddf55e74-dbaa-45f7-ac5b-ae3da24e0e33)                          | 远程执行代码 | 严重         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a06b9f42-47ac-4ff2-ac32-e4958cdb611e)\*\*               | 远程执行代码 | 中等         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6d0a3f7c-2617-4bc6-a4c7-cda26c6471e1)\*\*     | 远程执行代码 | 中等         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=38347fa6-5946-4bb5-9fea-a5b2f4e7c1f2) | 远程执行代码 | 中等         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=5bce87fe-dcbb-4638-b248-3f0755537b00)                                                                                   | 远程执行代码 | 严重         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=ee68ecd0-5b8a-4c1e-bdee-bd8616558d43)                                                                              | 远程执行代码 | 严重         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=901f7c89-02af-4f87-8592-dad318997d77)\*\*                                                             | 远程执行代码 | 中等         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=4958b221-2776-43d7-9e1c-1e1cb318a694)                                                             | 远程执行代码 | 中等         | [MS10-008](http://go.microsoft.com/fwlink/?linkid=179106) |
...
此更新为先前在 Microsoft 安全公告 [MS09-060](http://go.microsoft.com/fwlink/?linkid=160633) 中处理的 Outlook 查看控件 ActiveX 控件设置 kill bit。

有关此 ActiveX 控件以及如何更新它的更多信息，请查阅 Microsoft 安全公告 [Microsoft Office 的 Microsoft 活动模板库 (ATL) ActiveX 控件中的漏洞可能允许远程执行代码 (973965)](http://go.microsoft.com/fwlink/?linkid=160633)。
...
-   [Danske Bank](http://www.danskebank.dk/) 为 ActiveX 控件 Danske eSec 请求一个 kill bit。 如果您对 Danske eSec ActiveX 控件有任何疑问或担心，请联系 [Danske 银行](http://www.danskebank.dk/)。 此 ActiveX 控件的类标识符 (CLSID) 为：  
    -   {F6A56D95-A3A3-11D2-AC26-400000058481}  
-   [CA](http://www.ca.com/us/)为 Pest Scan 产品中的 ActiveX 控件 PSFormX 的建议发布了安全通报。 请参阅 CA 的安全公告了解详细信息。 此 kill-bit 是应 ActiveX 控件所有者的请求而设置的。 此 ActiveX 控件的类标识符 (CLSID) 为：  
    -   {56393399-041A-4650-94C7-13DFCB1F4665}  
-   [Eastman Kodak Company](http://www.kodakgallery.com/) 为“Ofoto Upload Manager / Kodak Gallery Easy Upload Manager ActiveX 控件”中的 ActiveX 控件请求了一个 kill bit。 Eastman Kodak Gallery 提供了以下页面来提供各种上载选项： <http://www.kodakgallery.com/gallery/photo-service/upload-photos.jsp>。在此更新中为其设置了 kill bit 的控件的替代控件可在以下地址找到： [http://classic.kodakgallery.com/UploadChoicesAll.jsp](http://classic.kodakgallery.com/uploadchoicesall.jsp)。如果您有关于此 kill bit 的任何疑问或担心，请联系 Kodak Gallery：[http://www.kodakgallery.com/gallery/footerLinksContent.jsp?pageID=600002](http://www.kodakgallery.com/gallery/footerlinkscontent.jsp?pageid=600002)。此 ActiveX 控件的类标识符 (CLSID) 为：  
    -   {6f750200-1362-4815-a476-88533de61d0c}  
    -   {6f750201-1362-4815-a476-88533de61d0c}  
-   [Avaya](http://www.avaya.com/) 为 CallPilot 统一消息传递请求一个 kill bit。 如果您对 CallPilot 统一消息传递的 kill bit 有任何疑问或担心，请与 Avaya Security 联系：securityalerts@avaya.com。此 ActiveX 控件的类标识符 (CLSID) 为：  

---
TOCTitle: 'MS10-034'
Title: 'Microsoft 安全公告 MS10-034 - 严重'
ms:assetid: 'ms10-034'
ms:contentKeyID: 61237873
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-034(v=Security.10)'
---

Microsoft 安全公告 MS10-034 - 严重
==================================
...
此安全更新可解决 Microsoft 软件的两个秘密报告的漏洞。 对于 Microsoft Windows 2000、Windows XP、Windows Vista 和 Windows 7 的所有受支持版本，此安全更新的等级为“严重”；对于 Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“中等”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=d3955983-0079-476e-a488-99713097259c)                                                                         | 远程执行代码 | 严重         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=8c3f2e81-c0ea-494a-a47c-4f8982effb49)                                                        | 远程执行代码 | 严重         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f3e462fb-df95-4b79-a8bc-5359c2967503)                                                            | 远程执行代码 | 严重         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3c0bd349-aa77-47de-ba1d-1fcc72dcad28)                                                                            | 远程执行代码 | 中等         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4aa0ec4f-5502-4f2a-9732-975518c34444)                                                                | 远程执行代码 | 中等         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=55d9d7f0-f9d9-4833-b5cc-eb87a62da6a8)                                                            | 远程执行代码 | 中等         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2ddaa4b3-1a98-4183-94af-ebdae4e7b76a)                                                  | 远程执行代码 | 严重         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ddf55e74-dbaa-45f7-ac5b-ae3da24e0e33)                          | 远程执行代码 | 严重         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a06b9f42-47ac-4ff2-ac32-e4958cdb611e)\*\*               | 远程执行代码 | 中等         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6d0a3f7c-2617-4bc6-a4c7-cda26c6471e1)\*\*     | 远程执行代码 | 中等         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=38347fa6-5946-4bb5-9fea-a5b2f4e7c1f2) | 远程执行代码 | 中等         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=5bce87fe-dcbb-4638-b248-3f0755537b00)                                                                                   | 远程执行代码 | 严重         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=ee68ecd0-5b8a-4c1e-bdee-bd8616558d43)                                                                              | 远程执行代码 | 严重         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=901f7c89-02af-4f87-8592-dad318997d77)\*\*                                                             | 远程执行代码 | 中等         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=4958b221-2776-43d7-9e1c-1e1cb318a694)                                                             | 远程执行代码 | 中等         | [MS10-008](https://go.microsoft.com/fwlink/?linkid=179106) |
...
此更新为先前在 Microsoft 安全公告 [MS09-060](https://go.microsoft.com/fwlink/?linkid=160633) 中处理的 Outlook 查看控件 ActiveX 控件设置 kill bit。

有关此 ActiveX 控件以及如何更新它的更多信息，请查阅 Microsoft 安全公告 [Microsoft Office 的 Microsoft 活动模板库 (ATL) ActiveX 控件中的漏洞可能允许远程执行代码 (973965)](https://go.microsoft.com/fwlink/?linkid=160633)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0252](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0252)。
...
-   恶意网站无法在尚未安装 Microsoft Data Analyzer 的系统上利用这个漏洞。 默认情况下，Microsoft Office 系统中不安装 Microsoft Data Analyzer。
...
**Microsoft Office 中默认情况下是否安装此控件？**    
否，此控件需要用户独立于 Office 安装手动安装。 如果事先未安装在用户系统上，则不能由网站托管和实例化。
  
**什么是 Microsoft Data Analyzer ActiveX 控件？**  
Microsoft Data Analyzer ActiveX 控件允许从基于 COM 的开发应用程序（例如 Microsoft Visual Basic）以编程方式控制 Data Analyzer。 有关详细信息，请参阅 MSDN 文章“[探索 Microsoft Data Analyzer 可编程性](https://msdn.microsoft.com/en-us/library/aa155447(office.10).aspx)”。
...
| 类标识符                               | 文件            | 描述                                     |  
|----------------------------------------|-----------------|------------------------------------------|  
| {14FD1463-1F3F-4357-9C03-2080B442F503} | max3activex.dll | 用于数据分析的 Office Excel ActiveX 控件 |  
| {E9CB13DB-20AB-43C5-B283-977C58FB5754} | max3activex.dll | 用于数据分析的 Office Excel ActiveX 控件 |
...
Microsoft Internet Explorer 8 开发工具存在一个远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。
...
-   **阻止 COM 对象在 Internet Explorer 中运行**
    ...
    **注意**“**Microsoft Internet Explorer 8 开发工具 (CVE-2010-0811) 的常见问题**”小节的“此更新有什么作用？”之下介绍了类标识符和 ActiveX 对象所在的对应文件。 使用本部分中找到的类标识符替换下列 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}。
...
**攻击者如何利用此漏洞？**  
攻击者可能拥有一个旨在通过 Internet Explorer 利用此漏洞的特制网站，然后诱使用户查看该网站。 攻击者也可能在宿主 IE 呈现引擎的应用程序或 Microsoft Office 文档中嵌入标有“安全初始化”的 ActiveX 控件。 这还包括受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。 这些网站可能包含可以利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 请求中的链接以使用户链接到攻击者的网站。 它还可能使用横幅广告或其他方式显示特制的 Web 内容，以便将 Web 内容传递至受影响的系统。
...
**受此漏洞威胁最大的系统有哪些？**  
Microsoft Internet Explorer 8 开发工具中的这个漏洞要求用户应该登录和访问网站，从而使恶意操作发生。 因此，安装了 Microsoft Internet Explorer 8 开发工具控件以及经常使用 Internet Explorer 的任何系统（例如工作站或终端服务器）受此漏洞的威胁最大。。
...
| 类标识符                               | 文件         | 描述                                   |  
|----------------------------------------|--------------|----------------------------------------|  
| {8fe85d00-4647-40b9-87e4-5eb8a52f4759} | iedvtool.dll | Microsoft Internet Explorer 8 开发工具 |
...
-   [Danske Bank](https://www.danskebank.dk/) 为 ActiveX 控件 Danske eSec 请求一个 kill bit。 如果您对 Danske eSec ActiveX 控件有任何疑问或担心，请联系 [Danske 银行](https://www.danskebank.dk/)。 此 ActiveX 控件的类标识符 (CLSID) 为：  
    -   {F6A56D95-A3A3-11D2-AC26-400000058481}  
-   [CA](https://www.ca.com/us/)为 Pest Scan 产品中的 ActiveX 控件 PSFormX 的建议发布了安全通报。 请参阅 CA 的安全公告了解详细信息。 此 kill-bit 是应 ActiveX 控件所有者的请求而设置的。 此 ActiveX 控件的类标识符 (CLSID) 为：  
    -   {56393399-041A-4650-94C7-13DFCB1F4665}  
-   [Eastman Kodak Company](https://www.kodakgallery.com/) 为“Ofoto Upload Manager / Kodak Gallery Easy Upload Manager ActiveX 控件”中的 ActiveX 控件请求了一个 kill bit。 Eastman Kodak Gallery 提供了以下页面来提供各种上载选项： <https://www.kodakgallery.com/gallery/photo-service/upload-photos.jsp>。在此更新中为其设置了 kill bit 的控件的替代控件可在以下地址找到： [https://classic.kodakgallery.com/UploadChoicesAll.jsp](https://classic.kodakgallery.com/uploadchoicesall.jsp)。如果您有关于此 kill bit 的任何疑问或担心，请联系 Kodak Gallery：[https://www.kodakgallery.com/gallery/footerLinksContent.jsp?pageID=600002](https://www.kodakgallery.com/gallery/footerlinkscontent.jsp?pageid=600002)。此 ActiveX 控件的类标识符 (CLSID) 为：  
    -   {6f750200-1362-4815-a476-88533de61d0c}  
    -   {6f750201-1362-4815-a476-88533de61d0c}  
-   [Avaya](https://www.avaya.com/) 为 CallPilot 统一消息传递请求一个 kill bit。 如果您对 CallPilot 统一消息传递的 kill bit 有任何疑问或担心，请与 Avaya Security 联系：securityalerts@avaya.com。此 ActiveX 控件的类标识符 (CLSID) 为：  
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的添加或删除程序工具或 %Windir%\\$NTUninstallKB980195$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的<strong>添加或删除程序</strong>工具或 %Windir%\\$NTUninstallKB980195$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">Windows XP 所有受支持的 32 位版本：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB980195$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [NGS Software](https://www.ngssoftware.com/) 的 Shaun Colley 报告了 Microsoft Data Analyzer ActiveX 控件漏洞 (CVE-2010-0252)  
-   Carnegie Mellon University Computing Services 的 Chris Ries 报告了 Microsoft internet Explorer 8 开发工具漏洞 (CVE-2010-0811)

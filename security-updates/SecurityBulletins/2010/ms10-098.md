---
TOCTitle: 'MS10-098'
Title: 'Microsoft 安全公告 MS10-098 - 重要'
ms:assetid: 'ms10-098'
ms:contentKeyID: 61237937
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-098(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS10-098 - 重要
==================================

Windows 内核模式驱动程序中的漏洞可能允许特权提升 (2436673)
----------------------------------------------------------
...
此安全更新通过更正 Windows 内核模式驱动程序分配内存、释放不再使用的对象的空间、管理内核模式驱动程序对象以及对从用户模式传递的输入进行验证的方式来解决这些漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=bb9d1657-5beb-4372-b74c-a612a6fff5a8)                                                                                     | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1f277ae4-4f85-4c8a-bfc5-dcdc8afed133)                                                            | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4aa39f59-2177-459f-9b8a-9543330d48ec)                                                                            | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=bca61d61-d5cf-49a4-ab99-b61e50e8f619)                                                                | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=4fce129d-2b4e-4a66-af27-bbbde1e65ba1)                                                            | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b824d3b9-2ce1-4abc-ae06-68aef1250be9)                                                  | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f4c42cfe-b7f2-4436-919e-4bd305a3439a)                          | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6e2f572a-4169-47f2-a872-5466997122ed)\*                 | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=09a4b646-989d-43ef-a3e8-64af8b380a14)\*       | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=46522323-837e-4a74-9cf0-45f69343e776) | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=aa7de2e4-ba48-4d58-b034-05349f0eb920)                                                                                   | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=b21db627-91c2-4ebf-b7c0-38ac58ae5b6c)                                                                              | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=d417ebce-7841-4bbb-8abc-b15ef5f4b733)\*                                                               | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=7eeac1bb-9f86-4ea5-b30f-980d52be5044)                                                             | 特权提升     | 重要         | [MS10-073](https://go.microsoft.com/fwlink/?linkid=201093) |
...
<tr class="header">
<th>受影响的软件</th>
<th>Win32k 缓冲区溢出漏洞 - CVE-2010-3939</th>
<th>Win32k PFE 指针双重释放漏洞 - CVE-2010-3940</th>
<th>Win32k 双重释放漏洞 - CVE-2010-3941</th>
<th>Win32k WriteAV 漏洞 - CVE-2010-3942</th>
<th>Win32k 光标链接漏洞 - CVE-2010-3943</th>
<th>Win32k 内存损坏漏洞 - CVE-2010-3944</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Win32k 缓冲区溢出漏洞 - CVE-2010-3939  
-------------------------------------
  
<span></span>  
Windows 内核模式驱动程序在通过用户模式复制数据时未正确分配内存的方式中存在特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3939](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3939)。
  
#### Win32k 缓冲区溢出漏洞 (CVE-2010-3939) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 缓冲区溢出漏洞 (CVE-2010-3939) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 缓冲区溢出漏洞 (CVE-2010-3939) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
此漏洞是由于 Windows 内核模式驱动程序在通过用户模式复制数据时未正确分配内存所导致的。
...
**此更新有什么作用？**    
此更新通过更正 Windows 内核模式驱动程序分配内存的方式来解决此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3939](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3939)。
  
**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。
  
Win32k PFE 指针双重释放漏洞 - CVE-2010-3940  
-------------------------------------------
  
<span></span>  
由于 Windows 内核模式驱动程序释放不再使用的对象空间的方式，因此存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3940](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3940)。
  
#### Win32k PFE 指针双重释放漏洞 (CVE-2010-3940) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k PFE 指针双重释放漏洞 (CVE-2010-3940) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k PFE 指针双重释放漏洞 (CVE-2010-3940) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
此漏洞是由“双重释放”条件将指针包含到内核模式驱动程序对象中所导致的。
  
**什么是“双重释放”条件？**    
双重释放条件是程序导致多次释放内存这样一种条件。 释放已经释放的内存可以导致内存故障。 攻击者可以将任意代码添加到内存中，并在内存出现故障时执行。 这种代码可以在系统级权限下执行。
...
**此更新有什么作用？**    
此更新通过更改内核模式驱动程序释放不再使用的对象空间的方式来解决此漏洞。
...
Win32k 双重释放漏洞 - CVE-2010-3941  
-----------------------------------
  
<span></span>  
由于 Windows 内核模式驱动程序释放不再使用的对象空间的方式，因此存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3941](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3941)。
  
#### Win32k 双重释放漏洞 (CVE-2010-3941) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。  
-   受影响的系统必须能够运行 16 位程序，攻击者才能利用此漏洞。 此漏洞无法在 64 位服务器上加以利用，因为它们无法运行 16 位程序。
  
#### Win32k 双重释放漏洞 (CVE-2010-3941) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **通过编辑组策略来禁用 NTVDM 子系统**
  
    无需 NT 虚拟 DOS 模式 (NTVDM) 的用户可以通过禁用 NTVDM 子系统来缓解利用此漏洞的影响。
  
    在 Windows XP 系统上禁用 NTVDM 子系统：
  
    1.  在使用管理员特权登录后，请依次“**开始**”、“**运行**”，键入 **gpedit.msc**，然后单击“**确定**”。  
    2.  在组策略编辑器的导航窗格中，双击“**管理模板**”，双击“**Windows 组件**”，然后单击“**应用程序兼容性**”。  
    3.  在“应用程序兼容性”窗格中，双击“**防止访问 16 位应用程序**”，将“设置”选项卡上的选择更改为“**已启用**”，单击“**确定**”，然后退出组策略编辑器。
  
    对于 Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 系统，可使用与用于 Windows XP 系统相同的模板通过组策略来部署此设置。
  
    对于 Windows NT 4.0 系统，请参阅 Microsoft 知识库文章“[禁用终端服务器上的 MSDOS 和 WOWEXEC 子系统](https://support.microsoft.com/kb/220159)”。
  
    **变通办法的影响。**  将禁用对 16 位应用程序的访问。
  
    **如何撤消变通方法。**
  
    在 Windows XP 系统上重新启用 NTVDM 子系统：
  
    1.  在使用管理员特权登录后，请依次“**开始**”、“**运行**”，键入 **gpedit.msc**，然后单击“**确定**”。  
    2.  在组策略编辑器的导航窗格中，双击“**管理模板**”，双击“**Windows 组件**”，然后单击“**应用程序兼容性**”。  
    3.  在“应用程序兼容性”窗格中，双击“**防止访问 16 位应用程序**”，将“设置”选项卡上的选择更改为“**未配置**”，单击“**确定**”，然后退出组策略编辑器。
  
    对于 Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 系统，可使用与用于 Windows XP 系统相同的模板通过组策略来部署此设置。
  
    对于 Windows NT 4.0 系统，请参阅 Microsoft 知识库文章“[禁用终端服务器上的 MSDOS 和 WOWEXEC 子系统](https://support.microsoft.com/kb/220159)”。
  
-   **通过编辑系统注册表来禁用 NTVDM 子系统**
  
    **警告** 不正确地使用注册表编辑器，可能导致严重的问题，可能需要您重新安装操作系统。 Microsoft 不保证您可以解决因错误运用注册表编辑器而产生的问题。 使用注册表编辑器的风险由您自己承担。 有关如何编辑注册表的信息，请查看注册表编辑器 (Regedit.exe) 中的“更改项和值”帮助主题，或查看 Regedt32.exe 中的“在注册表中添加和删除信息”和“编辑注册表数据”帮助主题。
  
    **注意** 我们建议在编辑注册表之前先对其进行备份。
  
    要通过编辑系统注册表来禁用 NTVDM 子系统，请执行下列步骤：
  
    1.  单击“**开始**”，单击“**运行**”，键入 **regedit**，然后单击“**确定**”。  
    2.  在系统注册表中找到以下注册表项：  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\WOW  
    3.  添加名为 **DisallowedPolicyDefault** 的 DWORD 表项并将其值设为 **1**（这样做可有效地禁用 NTVDM）。  
    4.  关闭“注册表编辑器”。
    ...
    **如何撤消变通方法。**
    ...
    要通过编辑系统注册表来重新启用 NTVDM 子系统，请执行下列步骤：
  
    1.  单击“**开始**”，单击“**运行**”，键入 **regedit**，然后单击“**确定**”。  
    2.  在系统注册表中找到以下注册表项：  
        HKEY\_LOCAL\_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\WOW  
    3.  将 **DisallowedPolicyDefault** 值更改为 **0**（这样做可有效地重新启用 NTVDM）。  
    4.  关闭“注册表编辑器”。
  
#### Win32k 双重释放漏洞 (CVE-2010-3941) 的常见问题
...
Win32k WriteAV 漏洞 - CVE-2010-3942  
-----------------------------------
  
<span></span>  
Windows 内核模式驱动程序在通过用户模式复制数据时未正确分配内存的方式中存在特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3942](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3942)。
  
#### Win32k WriteAV 漏洞 (CVE-2010-3942) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k WriteAV 漏洞 (CVE-2010-3942) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k WriteAV 漏洞 (CVE-2010-3942) 的常见问题
...
Win32k 光标链接漏洞 - CVE-2010-3943  
-----------------------------------
  
<span></span>  
由于 Windows 内核模式驱动程序管理内核模式驱动程序对象的方式，因此存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3943](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3943)。
  
#### Win32k 光标链接漏洞 (CVE-2010-3943) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 光标链接漏洞 (CVE-2010-3943) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 光标链接漏洞 (CVE-2010-3943) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
此漏洞是由于链接内核模式驱动程序对象时发生逻辑错误造成链接列表损坏而导致的。
...
Win32k 内存损坏漏洞 - CVE-2010-3944  
-----------------------------------
  
<span></span>  
由于 Windows 内核模式驱动程序对从用户模式传递的输入进行错误验证的方式，因此存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3944](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3944)。
  
#### Win32k 内存损坏漏洞 (CVE-2010-3944) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 内存损坏漏洞 (CVE-2010-3944) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 内存损坏漏洞 (CVE-2010-3944) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
此漏洞是由于 Windows 内核模式驱动程序未正确验证从用户模式传递的输入而导致的。
...
**此更新有什么作用？**    
此更新通过更正 Windows 内核模式驱动程序验证从用户模式传递的输入的方式来解决此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2436673$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2436673">Microsoft 知识库文章 2436673</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb2436673">Microsoft 知识库文章 2436673</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 报告了 Windows 内核双重释放漏洞 (CVE-2010-3941)  
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 报告了 Windows 内核 WriteAV 漏洞 (CVE-2010-3942)  
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 报告了 Windows 内核指针链接漏洞 (CVE-2010-3943)  
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 报告了 Windows 内核内存损坏漏洞 (CVE-2010-3944)  
-   [Sysdream](https://www.sysdream.com) 的 Stéfan Le Berre 报告了 Windows 内核内存损坏漏洞 (CVE-2010-3944)

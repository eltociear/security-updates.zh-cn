...
**已知问题。** [Microsoft 知识库文章 972270](https://support.microsoft.com/kb/972270) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=47f85cbd-282e-4c92-9809-68bba49e0a12)                                                                           | 远程执行代码 | 严重         | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=793a6b3f-7660-40be-b7d5-7b0eec55e1cd)                                                          | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=31609ce9-656a-4f7d-a501-709a31ca34c3)                                                              | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e1d6e338-dea9-458e-b35d-796e069d74d7)                                                                              | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ddbcf231-9fde-4dc2-ad04-a01b69d1a980)                                                                  | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=c71a13cf-7e2f-4b02-8684-1a4e4b46ddda)                                                              | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6387228c-eedc-4511-b3c6-8922606f4c84)                                     | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7b4f5089-13b1-421b-a00b-22632bba4229) | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e175c436-37e0-497f-8b7f-6cacaa25ad7c)\*                   | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1b10a177-fd45-406f-8edc-b8d4b84881b7)\*         | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e8bc9a24-a794-4827-a6bb-785c6b2189f4)   | 远程执行代码 | 低           | [MS09-029](https://go.microsoft.com/fwlink/?linkid=139788) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=75491ad0-40a6-4efb-9574-d82210f6d0da)                                                                                     | 远程执行代码 | 低           | 无                                                        |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=8a53f0e9-0616-440e-90f2-a12524e1bee4)                                                                                | 远程执行代码 | 低           | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=308166e4-571b-4d6c-bd9f-3ed4afa4eafe)\*                                                                 | 远程执行代码 | 低           | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=1d0da42b-9755-4fd2-afd1-0d023d187133)                                                               | 远程执行代码 | 低           | 无                                                        |
...
此更新包含与安全性无关的功能更改。 有关详细信息，请参阅 [Microsoft 知识库文章 978909](https://support.microsoft.com/kb/978909)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0018)。
...
Embedded OpenType (EOT) 字体是一种用于在文档或网页中嵌入的小型字体。 这些字体可能嵌入在某些文档格式（例如 Word .doc 文件）中，或者使用指向 Web 服务器上 .eot 文件的链接合并到网页中。 使用 EOT 字体确保用户看到的文档正是作者希望他们看到的形式。 Web Embedding Fonts Tool (WEFT) 让 Web 作者能够创建链接到他们的网页的字体对象，以便通过浏览器查看时，页面以字体对象中包含的样式显示。 有关详细信息，请参阅 MSDN 文章“[关于字体嵌入](https://msdn.microsoft.com/en-us/library/ms533034.aspx)”。 “受影响的软件”表中列出的所有平台默认情况下都支持 EOT 字体呈现。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/972270">Microsoft 知识库文章 972270</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc.](https://www.google.com/) 的 Tavis Ormandy 报告了 LZCOMP 解压缩器中的 Microtype Express 压缩字体整数缺陷漏洞 (CVE-2010-0018)

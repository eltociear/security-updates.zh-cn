---
TOCTitle: 'MS10-051'
Title: 'Microsoft 安全公告 MS10-051 - 严重'
ms:assetid: 'ms10-051'
ms:contentKeyID: 61237890
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-051(v=Security.10)'
---

Microsoft 安全公告 MS10-051 - 严重
==================================

Microsoft XML Core Services 中的漏洞可能允许远程执行代码 (2079403)
------------------------------------------------------------------
...
对于 Windows XP、Windows Vista 和 Windows 7 所有受支持版本上的 Microsoft XML Core Services 3.0，此安全更新的等级为“严重”；对于 Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 所有受支持版本上的 Microsoft XML Core Services 3.0，此安全更新的等级为“中等”。有关详细信息，请参阅本节的**“受影响和不受影响的软件”**小节。
...
|--------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| Windows XP Service Pack 3                                    | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=dbdbbe5e-2ef9-4704-80c4-27ef28fd95ef) | 远程执行代码 | 严重         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows XP Professional x64 Edition Service Pack 2           | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=4d4e8eeb-a0b2-41c6-9ee4-3f4beb44195e) | 远程执行代码 | 严重         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows Server 2003 Service Pack 2                           | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=31ce233e-4d2d-404b-84a8-683319ba8ef7) | 远程执行代码 | 中等         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows Server 2003 x64 Edition Service Pack 2               | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=4d784b57-8564-4e7e-8f61-f897398e7ea5) | 远程执行代码 | 中等         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows Server 2003 SP2（用于基于 Itanium 的系统）           | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=d87ac8b3-41fb-4cdd-b305-181a0024d85c) | 远程执行代码 | 中等         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows Vista Service Pack 1                                 | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=bbfaadf8-ab38-456c-956a-ea18c64236c9) | 远程执行代码 | 严重         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows Vista Service Pack 2                                 | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=bbfaadf8-ab38-456c-956a-ea18c64236c9) | 远程执行代码 | 严重         | 无                                                        |
| Windows Vista x64 Edition Service Pack 1                     | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=577131cd-1229-4746-89d7-84d75f29e1f0) | 远程执行代码 | 严重         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows Vista x64 Edition Service Pack 2                     | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=577131cd-1229-4746-89d7-84d75f29e1f0) | 远程执行代码 | 严重         | 无                                                        |
| Windows Server 2008（用于 32 位系统）\*                      | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=73b5f45c-c9d6-491f-8483-98838b2a7c04) | 远程执行代码 | 中等         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows Server 2008（用于 32 位系统）Service Pack 2\*        | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=73b5f45c-c9d6-491f-8483-98838b2a7c04) | 远程执行代码 | 中等         | 无                                                        |
| Windows Server 2008（用于基于 x64 的系统）\*                 | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=43ece408-4aa7-4819-b3f6-7f0719ed3213) | 远程执行代码 | 中等         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows Server 2008（用于基于 x64 的系统）Service Pack 2\*   | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=43ece408-4aa7-4819-b3f6-7f0719ed3213) | 远程执行代码 | 中等         | 无                                                        |
| Windows Server 2008（用于基于 Itanium 的系统）               | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=b6faee94-e821-432d-bfa2-9008664566af) | 远程执行代码 | 中等         | [MS08-069](https://go.microsoft.com/fwlink/?linkid=128803) |
| Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2 | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=b6faee94-e821-432d-bfa2-9008664566af) | 远程执行代码 | 中等         | 无                                                        |
| Windows 7（用于 32 位系统）                                  | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=31d0f5ac-2cff-42a1-8f18-128bbfc4e57d) | 远程执行代码 | 严重         | 无                                                        |
| Windows 7（用于基于 x64 的系统）                             | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=a4f6d7c2-b475-4900-82f0-75f5be0b7b63) | 远程执行代码 | 严重         | 无                                                        |
| Windows Server 2008 R2（用于基于 x64 的系统）\*              | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=a48cdac5-4d78-49b5-a6d8-ecf6c58cace2) | 远程执行代码 | 中等         | 无                                                        |
| Windows Server 2008 R2（用于基于 Itanium 的系统）            | [Microsoft XML Core Services 3.0](https://www.microsoft.com/download/details.aspx?familyid=b4d3210e-f3ad-4dbb-9390-6e98eeb99eaa) | 远程执行代码 | 中等         | 无                                                        |
...
<tr>
<td style="border:1px solid black;">
Microsoft Office 套件的所有受支持版本；Microsoft Office 组件、查看器和兼容包；Microsoft Office SharePoint Server；Microsoft Office Groove Server；以及 Microsoft Office Expression Web
</td>
<td style="border:1px solid black;">
...
<tr class="header">
<th>受影响的软件</th>
<th>Msxml2.XMLHTTP.3.0 响应处理内存损坏漏洞 - CVE-2010-2561</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Msxml2.XMLHTTP.3.0 响应处理内存损坏漏洞 - CVE-2010-2561  
-------------------------------------------------------
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2561](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2561)。
  
#### Msxml2.XMLHTTP.3.0 响应处理内存损坏漏洞的缓解因素 - CVE-2010-2561
...
#### Msxml2.XMLHTTP.3.0 响应处理内存损坏漏洞的变通办法 - CVE-2010-2561
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **阻止 COM 对象在 Internet Explorer 中运行**
  
    您可以通过在注册表中为控件设置 kill bit 来禁止尝试在 Internet Explorer 中实例化 COM 对象。 按这种变通办法，不会在 Internet Explorer 中实例化的 COM 对象是 Msxml2.XMLHTTP.3.0 ActiveX 控件。
    ...
    **警告** 如果不正确地使用注册表编辑器，可能导致严重的问题，或许需要您重新安装操作系统。 Microsoft 不保证您可以解决因错误运用注册表编辑器而产生的问题。 使用注册表编辑器的风险由您自己承担。
    ...
    要为值为 {F5078F35-C551-11D3-89B9-0000F81FE221} 的 CLSID 设置 kill bit，请将以下文本粘贴到记事本等文本编辑器中。 然后，使用 .reg 文件扩展名保存文件。
...
-   **将网站限于只是您信任的网站**
    ...
    添加您相信不会在您的计算机上执行恶意操作的任何站点。 特别是，您可能需要添加两个站点：**\*.windowsupdate.microsoft.com** 和 **\*.update.microsoft.com**。这些站点将提供此更新，需要使用 ActiveX 控件来安装更新。
  
#### Msxml2.XMLHTTP.3.0 响应处理内存损坏漏洞的常见问题解答 - CVE-2010-2561
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**造成漏洞的原因是什么？**    
MSXML 处理 HTTP 响应的方式中存在错误，这可以一种攻击者可以运行任意代码的方式来破坏系统状态。
...
**此更新有什么作用？**    
通过确保 MSXML 正确处理 HTTP 响应，此更新消除了漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2079403$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2079403">Microsoft 知识库文章 2079403</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc](https://www.google.com/). 的 SkyLined 报告了 Msxml2.XMLHTTP.3.0 响应处理内存损坏漏洞 (CVE-2010-2561)

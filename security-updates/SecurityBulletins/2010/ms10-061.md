...
**已知问题。** [Microsoft 知识库文章 2347290](https://support.microsoft.com/kb/2347290) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2729](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729)。
...
-   **在防火墙处阻止与 RPC 关联的端口**
    ...
    这些端口用于启动与 RPC 的连接。 将其阻止在防火墙处，有助于保护位于防火墙后面的系统免受利用此漏洞进行的攻击。 此外，还要确保阻塞远程系统上任何其他特殊配置的 PRC 端口。 Microsoft 建议阻塞所有来自 Internet 的未经请求的入站通信，以帮助阻止可能使用其他端口进行的攻击。 有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-2729](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2729)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2347290">Microsoft 知识库文章 2347290</a></td>
</tr>  
<tr class="even">
...
-   [Kaspersky Lab](https://www.kaspersky.com) 的 Sergey Golovanov、Alexander Gostev、Maxim Golovkin 和 Alexey Monastyrsky 以及 [Design and Test Lab](https://www.dnt-lab.com) 的 Vitaly Kiktenko 和 Alexander Saprykin 报告了打印后台程序服务模拟漏洞 (CVE-2010-2729)  
-   [Symantec](https://www.symantec.com/index.jsp) 的Liam O Morchu 报告了打印后台程序服务模拟漏洞 (CVE-2010-2729)

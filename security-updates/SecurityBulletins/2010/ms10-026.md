---
TOCTitle: 'MS10-026'
Title: 'Microsoft 安全公告 MS10-026 - 严重'
ms:assetid: 'ms10-026'
ms:contentKeyID: 61237865
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-026(v=Security.10)'
---

Microsoft 安全公告 MS10-026 - 严重
==================================

Microsoft MPEG Layer-3 编码解码器中的漏洞可能允许远程执行代码 (977816)
----------------------------------------------------------------------

发布时间: 2010年4月13日 | 更新时间: 2010年6月22日
...
对于 Microsoft Windows 2000、Windows XP、Windows Server 2003（基于 Itanium 的版本除外）和 Windows Server 2008（基于 Itanium 的版本除外）的所有受支持版本，此安全更新的等级为“严重”。 对于 Windows Vista 的所有受支持版本，此安全更新的等级为“重要”。 Windows Server 2003 和 Windows Server 2008 的基于 Itanium 的版本以及 Windows 7 和 Windows Server 2008 R2 的所有受支持版本不受此漏洞的影响。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

通过更正 Microsoft MPEG Layer-3 音频编码解码器对特制 AVI 文件中的 MPEG Layer-3 音频流进行解码的方式，此安全更新解决了该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|-----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| Microsoft Windows 2000 Service Pack 4                                                                           | [MPEG Layer-3 编码解码器](https://www.microsoft.com/download/details.aspx?familyid=f6394fc2-b9d0-46cf-9265-a0d4aeb1448f) | 远程执行代码 | 严重         | 无               |
| Windows XP Service Pack 2 和 Windows XP Service Pack 3                                                          | [MPEG Layer-3 编码解码器](https://www.microsoft.com/download/details.aspx?familyid=b1582a74-4a7b-4540-beb1-7c89c86eae87) | 远程执行代码 | 严重         | 无               |
| Windows XP Professional x64 Edition Service Pack 2                                                              | [MPEG Layer-3 编码解码器](https://www.microsoft.com/download/details.aspx?familyid=8afca317-a647-44aa-a771-5d85cd5d62ea) | 远程执行代码 | 严重         | 无               |
| Windows Server 2003 Service Pack 2                                                                              | [MPEG Layer-3 编码解码器](https://www.microsoft.com/download/details.aspx?familyid=9f89746c-181e-4177-a851-ec1826e78b6d) | 远程执行代码 | 严重         | 无               |
| Windows Server 2003 x64 Edition Service Pack 2                                                                  | [MPEG Layer-3 编码解码器](https://www.microsoft.com/download/details.aspx?familyid=b97e7ea1-a163-4ce4-8cbc-5f933773c4b2) | 远程执行代码 | 严重         | 无               |
| Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2                                     | [MPEG Layer-3 编码解码器](https://www.microsoft.com/download/details.aspx?familyid=0e7140bb-42d3-48b3-9f4b-d55b17770de8) | 远程执行代码 | 重要         | 无               |
| Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 | [MPEG Layer-3 编码解码器](https://www.microsoft.com/download/details.aspx?familyid=b885aef4-3a5d-4c3e-bef6-5efef2965752) | 远程执行代码 | 重要         | 无               |
| Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2\*\*                 | [MPEG Layer-3 编码解码器](https://www.microsoft.com/download/details.aspx?familyid=8e9c04c9-898f-4ed2-949d-f4343cc0d9f6) | 远程执行代码 | 严重         | 无               |
| Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2\*\*       | [MPEG Layer-3 编码解码器](https://www.microsoft.com/download/details.aspx?familyid=d6f2e1ae-48d3-4d2c-b329-32cff00afee5) | 远程执行代码 | 严重         | 无               |
...
Microsoft 已修订此公告，宣布一个检测逻辑更改，从而解决下列问题：Microsoft Windows 2000 Service Pack 4 上 MPEG Layer-3 编码解码器的 2010 年 4 月 13 日安全更新 (KB977816) 被错误地重新提供给 Microsoft Windows 2000 上一些运行 Microsoft Office 的系统。这只是检测更改，不影响初始更新中包含的文件。 成功地更新了其系统的客户不需要重新安装此更新。

此检测更改可能导致此安全更新对于使用 Windows Server Update Services (WSUS) 的客户显示为新更新。 如果您未设置自动批准规则，可能必须手动重新批准更新。 不重新批准更新可能导致更新继续提供给更新不适用的系统。 有关此检测更改的详细信息，请参阅 [Microsoft 知识库文章 894199](https://support.microsoft.com/kb/894199)。
...
<tr class="header">
<th>受影响的软件</th>
<th>MPEG Layer-3 音频解码器堆栈溢出漏洞 - CVE-2010-0480</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
<tr class="odd">
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4 上的 MPEG Layer-3 编码解码器</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows XP Service Pack 2 和 Windows XP Service Pack 3 上的 MPEG Layer-3 编码解码器</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition Service Pack 2 上的 MPEG Layer-3 编码解码器</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 2 上的 MPEG Layer-3 编码解码器</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2 上的 MPEG Layer-3 编码解码器</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的 MPEG Layer-3 编码解码器</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的 MPEG Layer-3 编码解码器</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2 上的 MPEG Layer-3 编码解码器**</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上的 MPEG Layer-3 编码解码器**</td>
<td style="border:1px solid black;"><strong>严重</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong></td>
</tr>  
...
MPEG Layer-3 音频解码器堆栈溢出漏洞 - CVE-2010-0480  
---------------------------------------------------
  
   
Microsoft MPEG Layer-3 编码解码器处理 AVI 媒体文件的方式中存在远程执行代码漏洞。 如果用户打开包含 MPEG Layer-3 音频流的特制的 AVI 文件，此漏洞可能允许远程执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0480](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0480)。
  
#### MPEG Layer-3 音频解码器堆栈溢出漏洞 (CVE-2010-0480) 的缓解因素
...
-   虽然 Windows Vista 系统上存在容易受到攻击的编码解码器，但在默认情况下，Windows Vista 上的 Windows Media Player 不会使用容易受到攻击的编码解码器来对包含 MPEG Layer-3 音频流的 AVI 文件进行解码。 它将使用另一个不容易受到攻击的编码解码器。
  
#### MPEG Layer-3 音频解码器堆栈溢出漏洞 (CVE-2010-0480) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **限制访问 MPEG Layer-3 音频编码解码器**
  
    管理员可以对编码解码器应用访问控制列表，以确保它们不再被加载。 这样做可有效地防止借助此攻击媒介利用该漏洞。
  
    要限制访问编码解码器：
  
    -   对于 Microsoft Windows 2000 的所有受支持版本以及 Windows XP 与 Windows Server 2003 的所有受支持的 32 位版本，请从命令提示符运行下列命令：  
        ```
        cacls "%windir%\system32\l3codeca.acm" /E /P everyone:N   
        cacls "%windir%\system32\l3codecx.ax" /E /P everyone:N
        ```  
    -   对于 Windows XP 与 Windows Server 2003 的所有受支持的 64 位版本，请从命令提示符运行下列命令：  
        ```
        cacls "%windir%\system32\l3codeca.acm" /E /P everyone:N   
        cacls "%windir%\system32\l3codecx.ax" /E /P everyone:N  
        ...
        ```  
    -   对于 Windows Vista 和 Windows Server 2008 的所有受支持的 32 位版本，请从提升的命令提示符运行下列命令：  
        ```
        ...
        ```  
    -   对于 Windows Vista 和 Windows Server 2008 的所有受支持的 64 位版本，请从提升的命令提示符运行下列命令：  
        ```
        takeown /f "%windir%\system32\l3codeca.acm"  
        cacls "%windir%\system32\l3codeca.acm" /E /P everyone:N   
        takeown /f "%windir%\system32\l3codecp.acm"  
    ...
    **变通办法的影响。** 将不会播放 MPEG Layer-3 音频编码的文件。
...
#### MPEG Layer-3 音频解码器堆栈溢出漏洞 (CVE-2010-0480) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Microsoft MPEG Layer-3 音频编码解码器不能正确处理包含 MPEG Layer-3 音频流的特制 AVI 文件。
  
**什么是容易受到攻击的 Microsoft MPEG Layer-3 音频编码解码器？**    
容易受到攻击的 MPEG Layer-3 音频编码解码器是用于 Microsoft DirectShow (l3codecx.ax) 和 Fraunhofer IIS MPEG Layer-3 ACM 编码解码器（L3codeca.acm 与 L3codecp.acm）的 MPEG Layer-3 音频编码解码器。 这些 MPEG Layer-3 音频编码解码器作为 Windows Media 的一部分提供。 有关详细信息，请参阅 [Window Media](https://www.microsoft.com/windows/windowsmedia/default.mspx) 主页。
  
**什么是编码解码器？**    
编码解码器是用于压缩或解压缩歌曲或视频等数字媒体文件的软件。 Windows Media Player 与其他程序使用编码解码器来播放和创建数字媒体文件。
  
编码解码器包含两个组件： 编码器和解码器。 编码器执行压缩（编码）功能，解码器执行解压缩（解码）功能。 一些编码解码器包含这两个组件，而另一些编码解码器则仅包含一个组件。
  
例如，当您将歌曲从音频 CD 传输到计算机后，Windows Media Player 在默认情况下会使用 Windows Media 音频编码解码器将歌曲压缩为紧凑的 WMA 文件。 当播放该 WMA 文件（或可能从网站以媒体流方式传输的任何 WMA 文件）时，Windows Media Player 会使用 Windows Media 音频编码解码器对文件进行解压缩，以便可通过扬声器播放该音乐。
...
在电子邮件攻击情形中，攻击者可以通过向用户发送内嵌有特制 AVI 文件的媒体文件并诱使用户打开该媒体文件来利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**    
工作站和终端服务器受到的威胁最大。 当应该没有足够管理权限的用户被授予登录到服务器并运行程序的权限时，服务器会更有危险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**    
通过更正 Microsoft MPEG Layer-3 音频编码解码器处理特制 AVI 文件中的 MPEG Layer-3 音频流的方式，此更新解决了该问题。
...
<td style="border:1px solid black;">使用控制面板中的<strong>添加或删除程序</strong>工具或 %Windir%\\$NTUninstallKB977816_wm9$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/977816">Microsoft 知识库文章 977816</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的<strong>添加或删除程序</strong>工具或 %Windir%\\$NTUninstallKB977816$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/977816">Microsoft 知识库文章 977816</a></td>
...
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了 MPEG Layer-3 音频解码器堆栈溢出漏洞 (CVE-2010-0480)
...
-   V1.1（2010 年 6 月 22 日）： 已修订此公告，宣布一个检测逻辑更改，从而解决 Microsoft Windows 2000 Service Pack 4 上 MPEG Layer-3 编码解码器的重新提供问题。这只是检测更改，不影响初始更新中包含的文件。 成功地更新了其系统的客户不需要重新安装此更新。

...
<sup>[1]</sup>该操作系统仅在安装了 “对身份验证的扩展保护”时才受影响。 参阅[Microsoft 知识库文章 973917](https://support.microsoft.com/kb/973917)。有关详细信息，请参阅“**与此安全更新相关的常见问题 (FAQ)**”中的该条目。
...
**哪些系统会受到此漏洞的影响？**  
此漏洞影响 Windows 7 和 Windows Server 2008 R2 系统。 此外，还影响安装了实施对身份验证的扩展保护的 [KB973917](https://support.microsoft.com/kb/973917) 非安全更新的 Windows Server 2003、Windows Vista 和 Windows Server 2008 系统。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1256](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1256)。
...
-   **要求令牌检查**
    ...
    Internet Information Services 配置为使用“扩展保护”以“要求”令牌检查的系统（如 [Microsoft 知识库文章 973917](https://support.microsoft.com/kb/973917) 所述）不受此漏洞的影响。
...
扩展保护可作为 Windows Server 2003、Windows Vista 和 Windows Server 2008 的非安全更新提供（请参阅 [Microsoft 知识库文章 973917](https://support.microsoft.com/kb/973917)）。 Windows 7 和 Windows Server 2008 R2 提供此功能作为操作系统中的可选组件，在安装 Internet Information Services (IIS) Web 服务器的 Windows 身份验证角色服务时启用。
  
**我如何验证是否启用了“对身份验证的扩展保护”？**    
有多种方法可以配置“对身份验证的扩展保护”。 有关配置此功能（可用于验证）的信息，请参阅 [Microsoft 知识库文章 973917](https://support.microsoft.com/kb/973917)。
...
**受此漏洞威胁最大的系统有哪些？**    
所存放内容要求身份验证，并支持“对身份验证的扩展保护”的 Web 服务器最容易受此漏洞影响。 只有安装了 [Microsoft 知识库文章 973917](https://support.microsoft.com/kb/973917) 中描述的扩展保护更新的系统才会受影响。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/982666">Microsoft 知识库文章 982666</a></td>
</tr>  
<tr class="even">

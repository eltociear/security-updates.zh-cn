...
**已知问题。**  [Microsoft 知识库文章 2345316](https://support.microsoft.com/kb/2345316) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b8c06bbc-6e84-4cf1-89f0-c0d34cfffaed)\* | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=39b7abc7-65a4-4dfd-92ba-c638e3de1118)\*                                                         | 拒绝服务     | 重要         | 无               |
...
由于存在更新中所提供的特定二进制文件，因此需要重新启动两次才能卸载此更新。 如果在卸载更新后未让系统重新启动两次，则可能会遇到失去网络连接的问题。 有关此已知问题的详细信息，请参阅 [Microsoft 知识库文章 2345316](https://support.microsoft.com/kb/2345316)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3960](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3960)。
...
**什么是 VMBus？**    
VMBus 是逻辑分区间通信通道。 有关 VMBus 和 Hyper-V 体系结构的详细信息，请参阅 MSDN 文章“[Hyper-V 体系结构](https://msdn.microsoft.com/en-us/library/cc768520(bts.10).aspx)”。
...
<br />
卸载此更新需要重新启动两次，目的是避免失去网络连接。 有关此卸载方案的详细信息，请参阅 <a href="https://support.microsoft.com/kb/2345316">Microsoft 知识库文章 2345316</a>。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2345316">Microsoft 知识库文章 2345316</a></td>
</tr>  
<tr class="odd">
...
-   [HP](https://www.hp.com) 和 [techit](https://www.techit.de) 报告了 Hyper-V VMBus 漏洞 (CVE-2010-3960)

...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2409055">Microsoft 知识库文章 2409055</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [VUPEN 漏洞调查小组](https://www.vupen.com/)的 Chaouki Bekrar 报告了 pubconv.dll 中的大小值堆损坏漏洞 (CVE-2010-2569)  
-   [VUPEN 漏洞调查小组](https://www.vupen.com/)的 Chaouki Bekrar 报告了 pubconv.dll 中的堆溢出漏洞 (CVE-2010-2570)  
-   [VUPEN 漏洞调查小组](https://www.vupen.com/)的 Chaouki Bekrar 报告了 Pubconv.dll 中由于索引到数组无效而导致的内存损坏漏洞 (CVE-2010-2571)  
-   [VUPEN 漏洞调查小组](https://www.vupen.com/)的 Chaouki Bekrar 报告了 Microsoft Publisher 内存损坏漏洞 (CVE-2010-3954)  
-   [VUPEN 漏洞调查小组](https://www.vupen.com/)的 Chaouki Bekrar 报告了数组索引内存损坏漏洞 (CVE-2010-3955)

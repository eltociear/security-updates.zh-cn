---
TOCTitle: 'MS10-081'
Title: 'Microsoft 安全公告 MS10-081 - 重要'
ms:assetid: 'ms10-081'
ms:contentKeyID: 61237920
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-081(v=Security.10)'
---



Microsoft 安全公告 MS10-081 - 重要
==================================
...
此安全更新通过纠正 Windows 公共控件处理从第三方可伸缩矢量图形 (SVG) 查看器传递的消息的方式来解决此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=912a7c20-8177-4f65-b986-43fca6375ec1)                                                                                     | 远程执行代码 | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6c651bca-adb1-4172-9714-cd5a6e5d2c2a)                                                            | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3b2eb449-ad55-4dfb-a3c5-aac767de6f45)                                                                            | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=54fc4bc6-f46c-447c-8307-afd8338e7ffb)                                                                | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=64f5c311-d74a-4665-9775-ac91c6885ed3)                                                            | 远程执行代码 | 重要         | 无               |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=95ceafc6-e37a-4c77-b16e-c9c94a7d89bd)                                                  | 远程执行代码 | 重要         | 无               |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=dfe7cd18-53a3-433e-9a33-bd96b04b4deb)                          | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d5f079b0-d8e1-47fe-b9dd-41eeb463a93c)\*\*               | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8e88d9c5-eb57-4d39-a880-a478c5f286da)\*\*     | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=76e46d08-22d9-4a0c-82cd-d2753d07efe6) | 远程执行代码 | 重要         | 无               |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=bdff9057-381a-44e8-b093-84f07d8d7e3c)                                                                                   | 远程执行代码 | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=35a2b1a9-6dd6-4a7e-bc0a-b4fcffa06b28)                                                                              | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=25fff010-3abc-45e6-979e-21d2bae49418)\*\*                                                             | 远程执行代码 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=d0742526-b5ec-4658-82f1-c3680f33a790)                                                             | 远程执行代码 | 重要         | 无               |
...
<th style="border:1px solid black;">Comctl32 堆溢出漏洞 - CVE-2010-2746</th>
...
Comctl32 堆溢出漏洞 - CVE-2010-2746  
-----------------------------------
  
  
在使用第三方可伸缩矢量图形 (SVG) 查看器时，Windows 公共控件库呈现特制网站的方式中存在一个远程执行代码漏洞。 如果用户访问了特制网页，此漏洞可能允许远程执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2746](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2746)。
  
#### Comctl32 堆溢出漏洞 (CVE-2010-2746) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。  
-   默认 Windows 配置中无法利用此漏洞。 为受此问题的影响，系统上必须安装呈现可伸缩矢量图形 (SVG) 的第三方应用程序。
  
#### Comctl32 堆溢出漏洞 (CVE-2010-2746) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Comctl32 堆溢出漏洞 (CVE-2010-2746) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以使用提升的特权在容易受攻击的系统上运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
在呈现从第三方可伸缩矢量图形 (SVG) 查看器传递的可伸缩矢量图形时，Windows 公共控件库没有正确处理某些消息。
...
**默认的 Windows 配置中是否可以利用此漏洞？**  
否。 为受此问题的影响，系统上必须安装呈现可伸缩矢量图形 (SVG) 的第三方应用程序。 在系统上未安装此第三方查看器的情况下，Microsoft 尚未确定任何攻击媒介。 有关 SVG 实施列表，请参阅 [SVG 实施](http://www.w3.org/graphics/svg/wg/wiki/implementations)的 World Wide Web Consortium (W3C) 列表。
  
**什么是可伸缩矢量图形？**  
可伸缩矢量图形 (SVG) 是使用 XML 文档创作和部署二维矢量图形的标准。 它是已由多个行业组织创作和认证的 World Wide Web Consortium (W3C) 建议。 SVG 本质上是符合定义为 SVG 认证过程一部分的架构的 XML 文档。 规格中定义了各种基本几何形状，如矩形、圆形、椭圆形、线条、折线、多边形和 glyph 元素（如文本）。 更多复杂形状可使用路径元素创建，允许您将形状定义为一系列线条、弧线和复杂的贝塞尔曲线。 使用这些基本形状，再通过一些创新，即使是最复杂的几何构造也可创建。
...
**此更新有什么作用？**  
此更新通过纠正 Windows 公共控件库处理从第三方可伸缩矢量图形 (SVG) 查看器传递的某些消息的方式来解决此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2296011$\Spuninst 文件夹中的 Spuninst.exe 实用工具</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2296011">Microsoft 知识库文章 2296011</a></td>
</tr>  
<tr class="even">
...
-   Krystian Kloskowski (h07) 与 [Secunia](http://secunia.com/) 合作报告了 Comctl32 堆溢出漏洞 (CVE-2010-2746)

...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2746](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2746)。
...
否。 为受此问题的影响，系统上必须安装呈现可伸缩矢量图形 (SVG) 的第三方应用程序。 在系统上未安装此第三方查看器的情况下，Microsoft 尚未确定任何攻击媒介。 有关 SVG 实施列表，请参阅 [SVG 实施](https://www.w3.org/graphics/svg/wg/wiki/implementations)的 World Wide Web Consortium (W3C) 列表。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2296011">Microsoft 知识库文章 2296011</a></td>
</tr>  
<tr class="even">
...
-   Krystian Kloskowski (h07) 与 [Secunia](https://secunia.com/) 合作报告了 Comctl32 堆溢出漏洞 (CVE-2010-2746)

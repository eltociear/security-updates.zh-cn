...
**已知问题。** [Microsoft 知识库文章 2412048](https://support.microsoft.com/kb/2412048) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
此更新 (MS10-072) 和[Internet Explorer 的累积性安全更新](https://go.microsoft.com/fwlink/?linkid=202013) (MS10-071) 消除了 HTML 清理漏洞 (CVE-2010-3243) 和 HTML 清理漏洞 (CVE-2010-3324)。
...
<td style="border:1px solid black;">对于 Microsoft Windows SharePoint Services 3.0，请参阅 <a href="https://support.microsoft.com/kb/2345304">Microsoft 知识库文章 2345304</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft SharePoint Foundation 2010，请参阅 <a href="https://support.microsoft.com/kb/2345322">Microsoft 知识库文章 2345322</a></td>
</tr>  
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2345212">Microsoft 知识库文章 2345212</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2346298">Microsoft 知识库文章 2346298</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2346411">Microsoft 知识库文章 2346411</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Google Inc.](https://www.google.com/)的 [Sirdarckcat](https://www.sirdarckcat.net/)报告了 HTML 清理漏洞 (CVE-2010-3243)  

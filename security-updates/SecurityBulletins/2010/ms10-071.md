...
Windows 7 Service Pack 1 Beta 和 Windows Server 2008 R2 Service Pack 1 Beta 受此公告中介绍的漏洞影响。 鼓励运行这些测试版本的客户下载并向其系统应用此更新。 安全更新可从 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 和 [Windows Update](https://go.microsoft.com/fwlink/?linkid=21130) 获得。 此安全更新也可以从 [Microsoft 下载中心](https://go.microsoft.com/fwlink/?linkid=21129)下载。

**此安全更新与** **MS10-072** **有什么联系？**  
此公告中描述的 HTML 清理漏洞 (CVE-2010-3243) 和 HTML 清理漏洞 (CVE-2010-3324) 也影响 Microsoft SharePoint。 但您只能安装与您的系统上安装的软件对应的更新。 如果您已安装 Internet Explorer，请根据此公告应用所需更新。 如果您已安装 Microsoft SharePoint，请根据 [MS10-072](https://go.microsoft.com/fwlink/?linkid=202016) 应用所需更新。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0808](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0808)。
...
**什么是** **AutoComplete** **功能？**  
AutoComplete 是 Internet Explorer 中的一项功能，可帮助用户在表单字段中快速输入信息。 有关详细信息，请参阅 MSDN 文章“[在 HTML 表单中使用 AutoComplete](https://msdn.microsoft.com/en-us/library/ms533032.aspx)”。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0808](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0808)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3243](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3243)。
...
toStaticHTML API 可用于在将用户输入显示为 HTML 之前从中删除事件属性和脚本。 有关详细信息，请参阅下列 MSDN 库文章 [toStaticHTML 方法](https://msdn.microsoft.com/en-us/library/cc848922.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3324](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3324)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3324](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3324)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3325](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3325)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3325](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3325)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3326](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3326)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3327](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3327)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3328](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3328)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3329](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3329)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3330](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3330)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3331](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3331)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2360131">Microsoft 知识库文章 2360131</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc.](https://www.google.com/) 的 Sirdarckcat 报告了 HTML 清理漏洞 (CVE-2010-3243)  
-   Mario Heiderich 报告了 HTML 清理漏洞 (CVE-2010-3324)  
-   [IBM ISS X-Force](https://www.iss.net/) 的 Takehiro Takahashi 报告了未初始化的内存损坏漏洞 (CVE-2010-3326)  
-   [Peter Vreugdenhil](https://vreugdenhilresearch.nl) 与 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了未初始化的内存损坏漏洞 (CVE-2010-3328)  
-   [Core Security Technologies](https://www.coresecurity.com/) 的 Damián Frizza 报告了未初始化的内存损坏漏洞 (CVE-2010-3329)  
-   [Cigital](https://www.cigital.com) 的 Aldwin Saugere 和 Radoslav Vasilev 报告了跨域信息泄露漏洞 (CVE-2010-3330)  
-   [Check Point](https://www.checkpoint.com/) IPS Research Center 的 Rodrigo Rubira Branco 报告了未初始化的内存损坏漏洞 (CVE-2010-3331)

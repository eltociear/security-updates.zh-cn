---
TOCTitle: 'MS10-037'
Title: 'Microsoft 安全公告 MS10-037 - 重要'
ms:assetid: 'ms10-037'
ms:contentKeyID: 61237876
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-037(v=Security.10)'
---

Microsoft 安全公告 MS10-037 - 重要
==================================
...
此安全更新通过确保 OpenType 压缩字体格式 (CFF) 驱动程序正确地验证数据来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=5d645891-31e9-42c4-b12b-eb351473fd0c)                                                                         | 特权提升     | 重要         | 无               |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=b42a17c5-997e-4504-ba5b-bfa62166b460)                                                        | 特权提升     | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=dc835b94-3368-4c1c-8f29-40517c73540e)                                                            | 特权提升     | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ca49b5b5-db8e-4ebc-9a3c-b1ace09ac3c0)                                                                            | 特权提升     | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b0794e7e-c925-4672-b7a5-4bb3f847f045)                                                                | 特权提升     | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=6e76ebea-bde1-4352-a283-dd71c2cc51a1)                                                            | 特权提升     | 重要         | 无               |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=363b503a-2e1e-4284-a029-9695d2acfcb6)                                                  | 特权提升     | 重要         | 无               |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3f512b86-3a99-47f7-a90e-1ae9b291385c)                          | 特权提升     | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e78ad607-d209-48c4-b0f3-ed4c70993174)\*                 | 特权提升     | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=85f6fc5d-efd1-4351-b4c0-b9b7080e6173)\*       | 特权提升     | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c6f1aae5-e8fd-4121-89b2-b97c571e8223) | 特权提升     | 重要         | 无               |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=969af8d6-f6da-4dd1-a7d7-2de54a5a8978)                                                                                   | 特权提升     | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=b069e5b2-aa2d-452e-b687-8734b5ba0051)                                                                              | 特权提升     | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=45242c7c-3752-44bf-a766-024ad7d28f53)\*                                                               | 特权提升     | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=0a271fb5-da5b-4a17-9593-e56b9a843b8f)                                                             | 特权提升     | 重要         | 无               |
...
<tr class="header">
<th>受影响的软件</th>
<th>OpenType CFF 字体驱动程序内存损坏漏洞 - CVE-2010-0819</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
OpenType CFF 字体驱动程序内存损坏漏洞 - CVE-2010-0819  
-----------------------------------------------------
  
   
Windows OpenType 压缩字体格式 (CFF) 驱动程序中存在一个由于从用户模式传递到内核模式的某些数据验证不正确而产生的特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0819](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0819)。
  
#### OpenType CFF 字体驱动程序内存损坏漏洞 (CVE-2010-0819) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### OpenType CFF 字体驱动程序内存损坏漏洞 (CVE-2010-0819) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### OpenType CFF 字体驱动程序内存损坏漏洞 (CVE-2010-0819) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
当 OpenType 压缩字体格式 (CFF) 驱动程序未正确验证从用户模式传递到内核模式的数据时，会引起该漏洞。
  
**什么是 OpenType 压缩字体格式 (CFF) 字体？**    
OpenType CFF 字体是包含 PostScript 类型 1 轮廓的一种 OpenType 字体。 OpenType 字体可以包含 PostScript 类型 1 或 TrueType 轮廓。 所有 Microsoft Windows 字体都包含 TrueType 轮廓。 Adobe InDesign 和 QuarkXpress 等桌面印刷应用支持大部分 OpenType 功能。 Adobe Photoshop 和 Adobe Illustrator 也支持多种功能。 Microsoft Publisher 和 Microsoft Word 中也增加来对通用 OpenType 功能的支持。 有关详细信息，请参阅 [Microsoft Typography OpenType 常见问题。](https://www.microsoft.com/typography/opentypefaq.mspx)
...
**此更新有什么作用？**    
此更新通过确保 OpenType 压缩字体格式 (CFF) 驱动程序正确地验证从用户模式复制到内核模式的数据来解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的<strong>添加或删除程序</strong>工具或 %Windir%\\$NTUninstallKB980218$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/980218">Microsoft 知识库文章 980218</a></td>
</tr>  
<tr class="even">
...
-   Laserforce International 的 Chris Carton 与 [Secunia](https://secunia.com/) 一起报告了OpenType CFF 字体驱动程序内存损坏漏洞 (CVE-2010-0819)

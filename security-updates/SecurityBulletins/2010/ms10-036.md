---
TOCTitle: 'MS10-036'
Title: 'Microsoft 安全公告 MS10-036 - 重要'
ms:assetid: 'ms10-036'
ms:contentKeyID: 61237875
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-036(v=Security.10)'
---

Microsoft 安全公告 MS10-036 - 重要
==================================
...
对于 Microsoft Office 2003 和 2007 Microsoft Office System，此安全更新等级为“重要”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过更正 Microsoft Office 验证要实例化的 COM 对象的方式来解决该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。

**建议。** Microsoft 建议客户尽早应用此更新。

**已知问题。** [Microsoft 知识库文章 983235](https://support.microsoft.com/kb/983235) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[MS08-055](https://go.microsoft.com/fwlink/?linkid=125229)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS10-004](https://go.microsoft.com/fwlink/?linkid=163639)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS10-023](https://go.microsoft.com/fwlink/?linkid=184751)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS10-028](https://go.microsoft.com/fwlink/?linkid=182935)
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
一些不受影响的软件（包括用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包、Microsoft Office Word Viewer、Microsoft Office Excel Viewer、Microsoft Office PowerPoint Viewer 2007 和 Visual Studio 2008）包含容易受到攻击的共享 Office 组件，但是它们不会访问容易受到攻击的代码，因此不受此漏洞的影响。 但是，由于存在容易受到攻击的代码，仍会提供此更新。
...
**既然 Microsoft Office XP 被列为受影响产品，为何 Microsoft 不为其发布更新？**  
Microsoft Office XP 上没有可正确支持更正验证的修补程序的体系结构，因此不可能构建 Microsoft Office XP 产品的修补程序以消除该漏洞。 这样做将需要重新设计很大一部分 Microsoft Office XP 产品，而不仅仅是受影响的组件。 这样重新设计结构得到的产品可能导致与其他应用程序明显不兼容，无法保证这些 Microsoft Office 产品在更新的系统上会继续按预期操作。

Microsoft 为安装了 Office XP 的 Windows XP 系统的用户提供 **Microsoft Fix it** 解决方案。 虽然这不是 Office 产品本身的代码修复，但是 **Microsoft Fix it** 解决方案提供防止此公告中所述漏洞的类似保护。 虽然应用程序兼容性风险降到最低，但是 Microsoft 建议用户在广泛地分布它之前测试此 **Microsoft Fix it** 解决方案。 有关下载位置和其他详细信息，请参阅 [Microsoft 知识库文章 983235](https://support.microsoft.com/kb/983235)。

**组件更新是否还需要安装相关的 Microsoft Office 2003 或 2007 Microsoft Office System 更新？**  
是的，此安全更新需要安装 Microsoft Office 2003 Service Pack 3 (KB982311) 或 2007 Microsoft Office System Service Pack 1 和 2007 Microsoft Office System Service Pack 2 (KB982312) 的更新，以及受影响软件表中列出的 Excel、Word、Visio、Publisher 或 PowerPoint 的相关更新，以避免此公告中描述的漏洞。

**MS10-038 还描述了 Microsoft Office Excel 中的漏洞。 MS10-038 与此公告 (MS10-036) 有何关联？**  
此公告 MS10-036 中的 Microsoft Office Excel 2003 (KB982133) 和 Microsoft Office Excel 2007 (KB982308) 安全更新包还解决了 [MS10-038](https://go.microsoft.com/fwlink/?linkid=191053) 中描述的漏洞。安装了Microsoft Office Excel 2003 或 Microsoft Office Excel 2007 的用户只需安装这些安全更新包一次。 用户还必须安装此公告中提供相关 Microsoft Office 更新（KB982311 或 KB982312），才能免遭此公告 MS10-036 中描述的漏洞的攻击。

**此更新是否包含任何其他与安全性无关的功能更改？**  
此更新包含与安全性无关的功能更改。 有关详细信息，请参阅 [Microsoft 知识库文章 983632](https://support.microsoft.com/kb/983632)。

除了此公告的“**漏洞信息**”部分列出的更改之外，此更新还包含一个纵深防御更改。 此更新包含一种缓解措施，帮助防止使用 ATL 的易受攻击版本构建的组件和控件在此公告的“漏洞信息”部分列出的 Microsoft Office 产品中受攻击。 此更新监控器中提供了新的纵深防御保护，可帮助防止成功利用所有已知的公共和专用库 ATL 漏洞。

该缓解措施解决 [Microsoft 安全通报 (973882)](https://technet.microsoft.com/security/advisory/973882)和 [MS09-035](https://go.microsoft.com/fwlink/?linkid=158131) 中描述的 ATL 漏洞。该更改在默认情况下对所有受影响的平台启用，并将帮助防止 Microsoft Office 中加载的控件的 ATL 漏洞，包括不是由 Microsoft 创建的控件。

**什么是纵深防御？**  
在信息安全性中，纵深防御指的是采取多层防御来帮助阻止攻击者危及网络或系统安全的一种方法。

**这篇文章中讨论的 Office 组件是我的系统上安装的 Office 套件的一部分；但是我没有选择安装所有特定组件。 我是否需要所有更新？**  
是，如果您的系统上安装的 Office 套件的版本附带本公告中讨论的组件，无论是否安装各个组件，系统都将需要更新。 已设计用于扫描受影响系统的检测逻辑，以检查特定 Office 套件附带的所有组件的更新并为系统提供更新。 如果用户选择不对尚未安装但在 Office 套件版本中包括的组件应用更新，不会增加该系统的安全风险。 另一方面，选择安装更新的用户不会对系统的安全或性能产生负面影响。
...
受影响的 Microsoft Office 软件验证 COM 对象实例化的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1263](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1263)。
...
-   在打开文档之前，系统将提示 Microsoft Office 2002 和更高版本的用户打开、保存或取消。 这是一个缓解因素，因为此漏洞需要多次用户操作才能完成利用。
...
**造成漏洞的原因是什么？**  
在各个 Excel、PowerPoint、Publisher、Visio 和 Word 应用程序中实例化时，Microsoft Office 对 COM 对象的验证不足够。

**什么是 COM？**  
Microsoft Windows 操作系统中的 Microsoft COM（组件对象模型）技术使软件组件可以通信。 开发人员采用 COM 来创建可重复使用的软件组件，将组件链接到一起以构建应用程序，并利用 Windows 服务。 有关 COM 的详细信息，请参阅 Microsoft 文章“[什么是 COM](https://www.microsoft.com/com/default.mspx)”？
...
**攻击者如何利用此漏洞？**  
此漏洞需要用户使用 Microsoft Office 的受影响版本打开特制的 Excel、PowerPoint、Publisher、Visio 或 Word 文件。

在电子邮件攻击情形中，攻击者可以通过向用户发送特制的 Microsoft Office 文件并诱使用户打开该文件来利用此漏洞。

在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的特制Microsoft Office 文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问特制的网站。 相反，攻击者必须诱使用户访问该网站，所采用的方式通常是让用户单击指向攻击者网站的链接。

**受此漏洞威胁最大的系统有哪些？**  
使用 Excel、PowerPoint、Publisher、Visio 和 Word 的系统（包括工作站和终端服务器）受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。

**此更新有什么作用？**  
此更新更正 Microsoft Office 验证要实例化的 COM 对象的方式。
...
<td style="border:1px solid black;">Microsoft Office 2003 Service Pack 3：<br />
请参阅 <a href="https://support.microsoft.com/kb/982311">Microsoft 知识库文章 982311</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2003 Service Pack 3：<br />
请参阅 <a href="https://support.microsoft.com/kb/982133">Microsoft 知识库文章 982133</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2003 Service Pack 3：<br />
请参阅 <a href="https://support.microsoft.com/kb/982157">Microsoft 知识库文章 982157</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2003 Service Pack 3：<br />
请参阅 <a href="https://support.microsoft.com/kb/982122">Microsoft 知识库文章 982122</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2003 Service Pack 3：<br />
请参阅 <a href="https://support.microsoft.com/kb/982126">Microsoft 知识库文章 982126</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2003 Service Pack 3：<br />
请参阅 <a href="https://support.microsoft.com/kb/982134">Microsoft 知识库文章 982134</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 2007 Microsoft Office System Service Pack 1 和 2007 Microsoft Office System Service Pack 2：<br />
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 2007 Microsoft Office System Service Pack 1 和 2007 Microsoft Office System Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/982312">Microsoft 知识库文章 982312</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2：<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2007 Service Pack 1 和 Microsoft Office PowerPoint 2007 Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/982158">Microsoft 知识库文章 982158</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2007 Service Pack 1 和 Microsoft Office Publisher 2007 Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/982124">Microsoft 知识库文章 982124</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2007 Service Pack 1 和 Microsoft Office Visio 2007 Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/982127">Microsoft 知识库文章 982127</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2007 Service Pack 1 和 Microsoft Office Word 2007 Service Pack 2：<br />
请参阅 <a href="https://support.microsoft.com/kb/982135">Microsoft 知识库文章 982135</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [IBM ISS X-Force](https://www.iss.net/) 的 David Dewey 和 [Accuvant](https://www.accuvant.com/)（以前称 [VeriSign iDefense Labs](https://labs.idefense.com/)）的 Ryan Smith 与我们合作处理此公告中解决的纵深防御更改。
...
-   V1.1（2010 年 6 月 16 日）： 更正了“**安全更新部署**”部分中 Microsoft Office Word 2007 的更新文件名称。 也向“更新常见问题”添加了条目，以阐明当系统上不存在受影响的软件时可能仍提供更新的原因。

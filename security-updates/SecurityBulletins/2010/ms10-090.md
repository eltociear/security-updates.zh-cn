...
此安全更新也解决了最初在 [Microsoft 安全通报 2458511](https://technet.microsoft.com/security/advisory/2458511) 中描述的漏洞。
...
**已知问题。** [Microsoft 知识库文章 2416400](https://support.microsoft.com/kb/2416400) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3340](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3340)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3342](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3342](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3342)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3343](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3343)。
...
-   **禁用** **LMClassFactory**
    ...
    **变通办法的影响**。 使用 Liquid Motion 的功能已禁用。 有关 Liquid Motion 的详细信息，请参阅 [Microsoft 知识库文章 257557](https://support.microsoft.com/kb/257557)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3345](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3345)。
...
#### HTML 元素内存损坏漏洞 (CVE-2010-3345) 的变通办法
...
#### HTML 元素内存损坏漏洞 (CVE-2010-3345) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3346](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3346)。

#### HTML 元素内存损坏漏洞 (CVE-2010-3346) 的缓解因素
...
#### HTML 元素内存损坏漏洞 (CVE-2010-3346) 的变通办法
...
#### HTML 元素内存损坏漏洞 (CVE-2010-3346) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3348](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348)。

#### 跨域信息泄露漏洞 (CVE-2010-3348) 的缓解因素
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3348](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348)。
...
Internet Explorer 访问尚未正确初始化或已被删除的对象的方式中存在一个远程执行代码漏洞。 攻击者可通过诱使用户打开恶意 Word 文档来利用此漏洞。 当用户关闭该文档时，此漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3962](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962)。

#### 未初始化的内存损坏漏洞 (CVE-2010-3962) 的缓解因素
...
#### 未初始化的内存损坏漏洞 (CVE-2010-3962) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **使用用户定义的样式表覆盖网站** **CSS**

    要应用自定义级联样式表 (CSS) 用于编排 Internet Explorer 中加载的文档格式，可将以下文本另存为扩展名为 .CSS 的文件，例如 KB2458511.CSS：
    TABLE
    {
        POSI\\TION: relative !important;
    }

    **注意** 上面的“POSI”和“TION”之间显示的“\\”是有意为之。

    **变通办法的影响。** 应用用户定义的 CSS 可能导致网站样式表出现问题。 如果您以前应用过此变通办法，在应用此安全更新之前必须撤消此变通办法。 使用 [Microsoft 知识库文章 2458511](https://support.microsoft.com/kb/2458511)中的自动化“**Microsoft** **修复**”解决方案以禁用此变通办法。

    **交互应用更改**

    1.  在 Internet Explorer 中，单击“**工具**”，然后单击“**Internet** **选项**”。
    2.  在“**常规**”选项卡上，单击“**辅助功能**”按钮。
    3.  选择“**使用样式表编排文档格式**”，单击“**浏览**”，然后浏览到上述文件的位置并选择该文件。
    4.  单击“**打开**”，单击“**确定**”两次，然后重新启动 Internet Explorer。

    **如何撤消变通方法。** 重复上述步骤（步骤 3 除外），清除“**使用样式表编排文档格式**”框。
    ...
    **警告** 如果不正确地使用注册表编辑器，可能导致严重的问题，或许需要您重新安装操作系统。 Microsoft 不保证您可以解决因错误运用注册表编辑器而产生的问题。 使用注册表编辑器的风险由您自己承担。
    ...
    1.  通过从提升命令提示符处运行下列命令来创建注册表项的备份副本：
        ...
        如果未创建 CSS-backup.reg，则表示没有用户定义的 CSS。
    2.  接下来，将下列内容保存到扩展名为 .REG 的文件，例如 Apply\_user\_CSS.reg：
        Windows Registry Editor Version 5.00
        ...
        **注意** \[目录位置\] 必须与本地系统上的 KB2458511.css 的位置相匹配。
    3.  然后运行 Apply\_user\_CSS.reg 以应用设置。

    **如何撤消变通方法。** 如果存在以前用户定义的 CSS，则使用 CSS-backup.reg 文件还原以前的设置。 如果没有，则将下列内容保存到扩展名为 .REG 的文件，例如 Remove\_user\_CSS.reg：
    Windows Registry Editor Version 5.00
    \[-HKEY\_CURRENT\_USER\\Software\\Microsoft\\Internet Explorer\\Styles\]

    然后从提升命令提示符处使用以下命令运行 Remove\_user\_CSS.reg：
    Regedit.exe /s Remove\_user\_CSS.reg

    **使用自动化“Microsoft** **修复”解决方案应用更改**

    要使用自动化“**Microsoft** **修复**”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 2458511](https://support.microsoft.com/kb/2458511)。

-   **为** **Internet Explorer 7** **启用数据执行保护** **(DEP)**

    本地**管理员**可以通过以管理员身份运行 Internet Explorer 来控制 DEP/NX。 要启用 DEP，使用以下方法之一：
    ...
    **变通办法的影响。** 某些浏览器扩展可能与 DEP 不兼容，可能会意外退出。

    **如何撤消变通办法。** 如果发生这种情况，您可以禁用该附加功能，或者使用 Internet 控制面板恢复 DEP 设置。 这也可以使用系统控制面板来实现。

    **使用自动化“Microsoft** **修复”为** **Internet Explorer 7** **启用** **DEP**

    要使用自动化“Microsoft 修复”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 2458511](https://support.microsoft.com/kb/2458511)。

    **变通办法的影响。** 某些浏览器扩展可能与 DEP 不兼容，可能会意外退出。

    **如何撤消变通方法。** 如果发生这种情况，您可以禁用加载项，或者通过使用自动化“Microsoft 修复”解决方案禁用变通办法来还原 DEP 设置。
...
#### 未初始化的内存损坏漏洞 (CVE-2010-3962) 的常见问题
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3962](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962)。此漏洞最初是在 [Microsoft 安全通报 2458511](https://technet.microsoft.com/security/advisory/2458511) 中介绍的。

**在发布此安全公告时，Microsoft** **是否收到任何有关此漏洞已被利用的报告？**  
是。 Microsoft 获悉尝试利用此漏洞的主动攻击。

**应用此安全更新有助于客户防止尝试利用此漏洞的已公开发布代码吗？**  
是。 此安全更新可消除目前被利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2010-3962](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962)。

**如果我应用了**[**Microsoft** **安全通报** **2458511**](https://technet.microsoft.com/security/advisory/2458511)**中提供的变通办法，是否需要在应用此更新之前撤消变通办法？**  
Microsoft 建议您在安装此安全更新前，从您之前应用的系统中撤消“覆盖网站 CSS”变通办法。 但是，您可以保留“部署 Enhanced Mitigation Experience Toolkit”(EMET) 和“为 Internet Explorer 7 启用数据执行保护 (DEP)”变通办法作为纵深防御措施。
...
<p>使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2416400$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie7updates\KB2416400-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\ie8updates\KB2416400-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2416400">Microsoft 知识库文章 2416400</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2416400$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Aniway 报告了 HTML 对象内存损坏漏洞 (CVE-2010-3340)  
-   [VUPEN 漏洞调查小组](https://www.vupen.com/)的 Nicolas Joly 报告了 HTML 对象内存损坏漏洞 (CVE-2010-3343)  
-   Stephen Fewer 与 [TippingPoint 的](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 HTML 元素内存损坏漏洞 (CVE-2010-3345)  
-   [Peter Vreugdenhil](https://vreugdenhilresearch.nl/) 与 [TippingPoint](https://www.tippingpoint.com/)的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 HTML 元素内存损坏漏洞 (CVE-2010-3346)  
-   [AZIA CO., LTD.](https://www.azia.jp) 的 Masatoshi Sato 报告了跨域信息泄露漏洞 (CVE-2010-3348)  
-   [Yosuke Hasegawa](https://utf-8.jp) 与我们一起努力处理了跨域信息泄露漏洞 (CVE-2010-3348)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Jose Antonio Vazquez Gonzalez 报告了未初始化的内存损坏漏洞 (CVE-2010-3962)
...
-   V1.1（2011 年 1 月 4 日）： 添加了一个更新常见问题，以宣布帮助确保以前发布的 Internet Explorer 累积性更新按照其发布的顺序正确提供的检测更改。 这只是检测更改。 没有更改安全更新文件。

...
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=155976">MS10-012</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=163970">MS09-050</a>、<br />
<a href="https://go.microsoft.com/fwlink/?linkid=132991">MS09-001</a></td>
</tr>
<tr class="odd">
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2550](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2550)。
...
Microsoft 服务器消息块 (SMB) 协议是 Microsoft Windows 中使用的一项 Microsoft 网络文件共享协议。 有关详细信息，请参阅 [Microsoft SMB 协议和 CIFS 协议概述](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2551](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2551)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2552](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2552)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/982214">Microsoft 知识库文章 982214</a></td>
</tr>  
<tr class="even">
...
-   [stratsec](https://www.stratsec.net) 的 Laurent Gaffié 报告了 SMB 池溢出漏洞 (CVE-2010-2550)  
-   [Sourcefire VRT](https://www.sourcefire.com/services/sf_vrt.html) 的 Todd Wease 和 Richard Johnson 报告了 SMB 堆栈枯竭漏洞 (CVE-2010-2552)  
-   [Codenomicon](https://www.codenomicon.com/) 的 Riku Hietamaki 和 Joshua Morin 报告了 SMB 堆栈枯竭漏洞 (CVE-2010-2552)

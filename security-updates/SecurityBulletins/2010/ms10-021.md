---
TOCTitle: 'MS10-021'
Title: 'Microsoft 安全公告 MS10-021 - 重要'
ms:assetid: 'ms10-021'
ms:contentKeyID: 61237860
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-021(v=Security.10)'
---

Microsoft 安全公告 MS10-021 - 重要
==================================
...
对于 Microsoft Windows 2000、Windows XP 和 Windows Server 2003 的所有受支持版本以及 Windows Vista 的原始发行版本，此安全更新的等级为“重要”。 对于 Windows Vista Service Pack 1 与 Windows Vista Service Pack 2、Windows Server 2008、Windows 7 以及 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“中等”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

通过更正验证、创建符号链接、解析虚拟注册表项路径以及处理异常，此安全更新解决了这些漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
**已知问题。** [Microsoft 知识库文章 979683](https://support.microsoft.com/kb/979683) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=c5f4577e-7546-40e9-8bcd-be11c1b260a6)                                                                         | 特权提升     | 重要         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=142710fd-9cd4-4dd0-aaba-2aace03c008f)                                                        | 特权提升     | 重要         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3c0cb02e-3484-4cdf-8c64-c697ad3e2889)                                                            | 特权提升     | 重要         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0a7ea2d0-61ce-4b68-ad82-d917b1a56f9d)                                                                            | 特权提升     | 重要         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1fc66f54-260a-4219-a0b4-056ba9dd0abe)                                                                | 特权提升     | 重要         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=8dcb8be8-fb78-4518-aa7e-f8b17f7dfb86)                                                            | 特权提升     | 重要         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=86d7b054-af4f-4d8a-9873-cb5246466374)                                                                                                 | 特权提升     | 重要         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=86d7b054-af4f-4d8a-9873-cb5246466374)                                                  | 拒绝服务     | 中等         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=7c84aa24-6331-427a-969c-27f7d39db3d7)                                                                                     | 特权提升     | 重要         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7c84aa24-6331-427a-969c-27f7d39db3d7)                          | 拒绝服务     | 中等         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=25e3ce7f-53a0-4049-a65c-011d2143c4c2)\*                 | 拒绝服务     | 中等         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8b99e54d-955b-4a06-9a04-b2f4596efd72)\*       | 拒绝服务     | 中等         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b1f9746d-61a2-406f-b707-60646bd5b5bb) | 拒绝服务     | 中等         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=ff58d80c-33ce-4d9e-aaa5-0b1841458931)                                                                                   | 拒绝服务     | 中等         | [MS10-015](https://go.microsoft.com/fwlink/?linkid=179062) |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=7f1dc055-2ec9-407a-9e69-da12338587e3)                                                                              | 拒绝服务     | 中等         | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=28389c1d-2a12-4bef-a59b-726bb6449c8b)\*                                                               | 拒绝服务     | 中等         | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=d4ea3984-5183-47f1-814e-29cb6c90ae06)                                                             | 拒绝服务     | 中等         | 无                                                        |
...
**此更新包含的程序包安装逻辑是否与 MS10-015 安全更新包含的程序包安装逻辑相同？**  
是。 如果 32 位系统上存在某些异常情况，此安全更新包含的程序包检测逻辑会阻止安装此安全更新。 系统中的这些异常情况可能是感染了会修改某些操作系统文件的计算机病毒造成的，从而导致受感染的计算机与内核更新不兼容。 有关此问题的详细信息，请参阅 Microsoft 安全页中的[获得 Microsoft 安全公告 MS10-015 不兼容消息方面的帮助](https://www.microsoft.com/security/updates/015)。
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 内核空指针漏洞 - CVE-2010-0234</th>
<th>Windows 内核符号链接值漏洞 - CVE-2010-0235</th>
<th>Windows 内核内存分配漏洞 - CVE-2010-0236</th>
<th>Windows 内核符号链接创建漏洞 - CVE-2010-0237</th>
<th>Windows 内核注册表项漏洞 - CVE-2010-0238</th>
<th>Windows 虚拟路径分析漏洞 - CVE-2010-0481</th>
<th>Windows 内核格式错误的图像漏洞 - CVE-2010-0482</th>
<th>Windows 内核异常处理程序漏洞 - CVE-2010-0810</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Windows 内核空指针漏洞 - CVE-2010-0234  
--------------------------------------
  
   
Windows 内核中存在由于未充分验证已传递到 Windows 内核系统调用的注册表项而产生的拒绝服务漏洞。 攻击者可以通过运行导致系统变得没有响应并自动重新启动的特制应用程序来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0234](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0234)。
  
#### Windows 内核空指针漏洞 (CVE-2010-0234) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核空指针漏洞 (CVE-2010-0234) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核空指针漏洞 (CVE-2010-0234) 的常见问题
...
**攻击者如何利用此漏洞？**    
要利用此漏洞，攻击者必须先登录到系统。 攻击者随后可以运行特制的应用程序，该应用程序可能利用该漏洞，导致系统停止响应并自动重新启动。
...
Windows 内核符号链接值漏洞 - CVE-2010-0235  
------------------------------------------
  
   
Windows 内核中存在由于内核处理符号链接值的方式而产生的拒绝服务漏洞。 攻击者可以通过运行导致系统变得没有响应并自动重新启动的特制应用程序来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0235](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0235)。
  
#### Windows 内核符号链接值漏洞 (CVE-2010-0235) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核符号链接值漏洞 (CVE-2010-0235) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核符号链接值漏洞 (CVE-2010-0235) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个拒绝服务漏洞。 利用此漏洞的攻击者可能会导致受影响系统停止响应和自动重新启动。 请注意，虽然攻击者无法利用拒绝服务漏洞来运行代码或提升他们的用户权限，但此漏洞可能导致受影响的系统停止接受请求。
  
**造成漏洞的原因是什么？**    
Windows 内核未正确处理某些特制的符号链接。
...
**此更新有什么作用？**    
通过确保在可创建符号链接之前 Windows 内核正确地验证符号链接值，此更新解决了该漏洞。
...
Windows 内核内存分配漏洞 - CVE-2010-0236  
----------------------------------------
  
   
Windows 内核中存在由于从注册表项提取符号链接时分配内存的方式而产生的特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0236](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0236)。
  
#### Windows 内核内存分配漏洞 (CVE-2010-0236) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核内存分配漏洞 (CVE-2010-0236) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核内存分配漏洞 (CVE-2010-0236) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
从符号链接类型的注册表项提取目标项时，Windows 内核未正确地分配内存。
...
Windows 内核符号链接创建漏洞 - CVE-2010-0237  
--------------------------------------------
  
   
当 Windows 内核未正确地限制不可信注册表配置单元和可信注册表配置单元之间的符号链接创建时，存在特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0237](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0237)。
  
#### Windows 内核符号链接创建漏洞 (CVE-2010-0237) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   此漏洞允许计算机上不具有特权的用户在稍后登录同一台计算机的用户的上下文中运行任意代码。 攻击者无法选择要模拟的用户。  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核符号链接创建漏洞 (CVE-2010-0237) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核符号链接创建漏洞 (CVE-2010-0237) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核未正确限制不可信注册表配置单元和可信注册表配置单元之间的符号链接创建。
...
**此更新有什么作用？**    
通过正确地阻止符号链接从不可信配置单元遍历到可信配置单元，此更新解决了该漏洞。
...
Windows 内核注册表项漏洞 - CVE-2010-0238  
----------------------------------------
  
   
Windows 内核验证注册表项的方式中存在拒绝服务漏洞。 攻击者可以通过运行导致系统变得没有响应并自动重新启动的特制应用程序来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0238)。
  
#### Windows 内核注册表项漏洞 (CVE-2010-0238) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核注册表项漏洞 (CVE-2010-0238) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核注册表项漏洞 (CVE-2010-0238) 的常见问题
...
**此更新有什么作用？**    
通过更正 Windows 内核验证注册表项的方式，此更新解决了该漏洞。
...
Windows 虚拟路径分析漏洞 - CVE-2010-0481  
----------------------------------------
  
   
Windows 内核中存在由于内核从虚拟路径中解析注册表项的实际路径的方式而产生的拒绝服务漏洞。 攻击者可以通过运行导致系统变得没有响应并自动重新启动的特制应用程序来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0481](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0481)。
  
#### Windows 虚拟路径分析漏洞 (CVE-2010-0481) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 虚拟路径分析漏洞 (CVE-2010-0481) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 虚拟路径分析漏洞 (CVE-2010-0481) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个拒绝服务漏洞。 利用此漏洞的攻击者可能会导致受影响系统停止响应和自动重新启动。 请注意，虽然攻击者无法利用拒绝服务漏洞来运行代码或提升他们的用户权限，但此漏洞可能导致受影响的系统停止接受请求。
  
**造成漏洞的原因是什么？**    
Windows 内核未充分验证虚拟路径以确保它有效。
...
**此更新有什么作用？**    
通过更正 Windows 内核解析虚拟注册表项路径的方式，此更新解决了该漏洞。
...
Windows 内核格式错误的图像漏洞 - CVE-2010-0482  
----------------------------------------------
  
   
Windows 内核中存在由于未正确验证特制的图像文件而产生的拒绝服务漏洞。 攻击者可以通过运行导致系统变得没有响应并自动重新启动的特制应用程序来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0482](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0482)。
  
#### Windows 内核格式错误的图像漏洞 (CVE-2010-0482) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核格式错误的图像漏洞 (CVE-2010-0482) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核格式错误的图像漏洞 (CVE-2010-0482) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个拒绝服务漏洞。 利用此漏洞的攻击者可能会导致受影响系统停止响应和自动重新启动。 请注意，虽然攻击者无法利用拒绝服务漏洞来运行代码或提升他们的用户权限，但此漏洞可能导致受影响的系统停止接受请求。
  
**造成漏洞的原因是什么？**    
Windows 内核未正确验证特制的图像文件的重新安置部分。
...
**此更新有什么作用？**    
通过更正 Windows 内核验证特制图像文件的重新安置部分的方式，此更新解决了该漏洞。
...
Windows 内核异常处理程序漏洞 - CVE-2010-0810  
--------------------------------------------
  
   
Windows 内核中存在由于内核处理某些异常的方式而产生的拒绝服务漏洞。 攻击者可以通过运行导致系统变得没有响应并自动重新启动的特制应用程序来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0810](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0810)。
  
#### Windows 内核异常处理程序漏洞 (CVE-2010-0810) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核异常处理程序漏洞 (CVE-2010-0810) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核异常处理程序漏洞 (CVE-2010-0810) 的常见问题
...
**此更新有什么作用？**    
通过确保 Windows 内核正确处理异常，此更新解决了该漏洞。
...
| **部署**                         |                                                                                                                     |  
| 没有用户干预的安装               | Windows2000-KB979683-x86-enu /quiet                                                                                 |  
| 在不重新启动的情况下安装         | Windows2000-KB979683-x86-enu /norestart                                                                             |  
| 更新日志文件                     | KB979683.log                                                                                                        |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节                                                                                |  
| **重新启动要求**                 |                                                                                                                     |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                              |  
| HotPatching                      | 不适用                                                                                                              |  
| **删除信息**                     | 使用控制面板中的**添加或删除程序**工具或 %Windir%\\$NTUninstallKB979683$\\Spuninst 文件夹中的 Spuninst.exe 实用程序 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 979683](https://support.microsoft.com/kb/979683)                                        |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB979683\\Filelist                           |
...
<td style="border:1px solid black;">使用控制面板中的<strong>添加或删除程序</strong>工具或 %Windir%\\$NTUninstallKB979683$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979683">Microsoft 知识库文章 979683</a></td>
</tr>  
<tr class="even">
...
-   [Hispasec](https://www.hispasec.com/)[Virustotal](https://www.virustotal.com/) 的 Matthew 'j00ru' Jurczyk 和 Gynvael Coldwind 报告了 Windows 内核空指针漏洞 (CVE-2010-0234)  
-   [Hispasec](https://www.hispasec.com/)[Virustotal](https://www.virustotal.com/) 的 Matthew 'j00ru' Jurczyk 和 Gynvael Coldwind 报告了 Windows 内核符号链接值漏洞 (CVE-2010-0235)  
-   [Hispasec](https://www.hispasec.com/)[Virustotal](https://www.virustotal.com/) 的 Matthew 'j00ru' Jurczyk 和 Gynvael Coldwind 报告了 Windows 内核内存分配漏洞 (CVE-2010-0236)  
-   [Hispasec](https://www.hispasec.com/)[Virustotal](https://www.virustotal.com/) 的 Gynvael Coldwind 和 Matthew 'j00ru' Jurczyk 报告了 Windows 内核符号链接创建漏洞 (CVE-2010-0237)  
-   [Hispasec](https://www.hispasec.com/)[Virustotal](https://www.virustotal.com/) 的 Matthew 'j00ru' Jurczyk 和 Gynvael Coldwind 报告了 Windows 内核注册表项漏洞 (CVE-2010-0238)  
-   [Google Inc.](https://www.google.com/) 的 Tavis Ormandy 报告了 Windows 虚拟路径分析漏洞 (CVE-2010-0481)  
-   [Obsidium Software](https://www.obsidium.de/) 的 Martin Tofall 报告了 Windows 内核格式错误的图像漏洞 (CVE-2010-0482)  
-   [Google Inc.](https://www.google.com/) 的 Tavis Ormandy 报告了 Windows 内核异常处理程序漏洞 (CVE-2010-0810)

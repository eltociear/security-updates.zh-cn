...
**已知问题。** [Microsoft 知识库文章 978212](https://support.microsoft.com/kb/978212) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
是。 除了此安全公告的漏洞信息部分中列出的更改外，此更新还包括有关阻止电子邮件附件的更改（使用 PR\_ATTACH\_METHOD 属性的 ATTACH\_BY\_REFERENCE 值）。 有关详细信息，请参阅 [Microsoft 知识库文章 2271150](https://support.microsoft.com/kb/2271150)。
...
要在“常见漏洞和披露”列表中以标准条目的形式查看此漏洞，请参阅 [CVE-2010-0266](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0266)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/980371">Microsoft 知识库文章 980371</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/980373">Microsoft 知识库文章 980373</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/980376">Microsoft 知识库文章 980376</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   Yorick Koster，使用 [SSD/SecuriTeam Secure Disclosure 程序](https://www.beyondsecurity.com/ssd.html)报告了 Microsoft Outlook SMB 附件漏洞 (CVE-2010-0266)

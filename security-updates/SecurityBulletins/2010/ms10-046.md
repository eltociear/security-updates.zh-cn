...
此安全更新解决了最初在 [Microsoft 安全通报 2286198](https://technet.microsoft.com/security/advisory/2286198) 中描述的漏洞。
...
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3b44bd67-48e2-497f-9165-42a702e2cc0d)                                                            | 远程执行代码 | 严重         | [MS07-061](https://go.microsoft.com/fwlink/?linkid=103190) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=32fe91ef-5a8d-4095-90ee-2ca216696b09)                                                                            | 远程执行代码 | 严重         | [MS07-061](https://go.microsoft.com/fwlink/?linkid=103190) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=923de214-c4fa-41e6-8307-2c5a37f13e8e)                                                                | 远程执行代码 | 严重         | [MS07-061](https://go.microsoft.com/fwlink/?linkid=103190) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=63aa5f8a-fe47-4892-b905-b54e4f3b6580)                                                            | 远程执行代码 | 严重         | [MS07-061](https://go.microsoft.com/fwlink/?linkid=103190) |
...
Microsoft Windows 的受影响版本中存在远程执行代码漏洞。 造成该漏洞的原因是 Windows 错误地分析快捷方式，当操作系统显示恶意快捷方式文件的图标时，可能执行恶意代码。 成功利用此漏洞的攻击者可能以登录用户的身份运行任意代码。 此更新解决了 [Microsoft 安全通报 2286198](https://technet.microsoft.com/security/advisory/2286198) 以前论述过的一个漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2568](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568)。
...
-   **禁用快捷方式的图标显示**
    ...
    **注意** 要使用自动化 **Microsoft Fix it** 解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 2286198](https://support.microsoft.com/kb/2286198)。 此修复解决方案将要求完成时重新启动才能生效。 此修复解决方案部署变通办法，因此具有相同的用户影响。 我们建议管理员在部署此修复解决方案之前仔细阅读知识库文章。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-2568](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2568)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2286198">Microsoft 知识库文章 2286198</a></td>
</tr>  
<tr class="even">
...
-   [VirusBlokAda](https://www.anti-virus.by/) 的 Sergey I. Ulasen 和 Uleg Kopreev 报告了快捷方式图标加载漏洞 (CVE-2010-2568)  
-   [AV-Test](https://www.av-test.org/) 的 Andreas Marx 和 Maik Morgenstern 报告了快捷方式图标加载漏洞 (CVE-2010-2568)  
-   [CERT/CC](https://www.cert.org) 的 Will Dormann 与我们一起处理了快捷方式图标加载漏洞 (CVE-2010-2568)  

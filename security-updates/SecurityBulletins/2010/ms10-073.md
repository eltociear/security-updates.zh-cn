...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=3966d754-d298-4e4a-9ce6-8205accd2215)                                                                                     | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7fd7c675-0675-4a87-a709-edc47a30f1e2)                                                            | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8ef4378e-21ff-4290-96ba-e00a60f372d1)                                                                            | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4a95c74b-cfd8-45b5-8887-777429d21745)                                                                | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=21637cd8-c75c-43b4-9948-be7be54af6bf)                                                            | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e9f735ab-d995-4209-b2dc-197f53fdee0f)                                                  | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=738c8f70-b46a-4a59-bea6-078074a9c4db)                          | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4dff0ebe-ccba-4675-98ca-9903f1cb6763)&#42;                 | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=da7905a9-9587-4184-8fca-ecc636a3b67e)&#42;       | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b9096046-8c7a-450c-b8c5-6e9fb001e6cd) | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=b5b31499-d242-42bf-ac78-b787ffb4d602)                                                                                   | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=c47e8b74-8cfe-42d9-9362-8786687c88ad)                                                                              | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=98e0c6ac-c30b-4d39-8ed9-1fe69e7644e5)\*                                                               | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=44080c75-036e-4bd0-914a-74ab72189ee3)                                                             | 特权提升     | 重要         | [MS10-048](http://go.microsoft.com/fwlink/?linkid=194552) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-2549](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2743](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-2743](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2744](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744)。
...
**什么是窗口类？**  
窗口类是一组系统用作模板以创建窗口的属性。 每个窗口都是窗口类的成员。 所有窗口类都特定于进程。 有三种窗口类。 系统类是由系统注册的窗口类。 许多系统类适用于要使用的所有进程，但其他类仅由系统在内部使用。 由于系统注册这些类，进程无法损坏它们。 应用程序全局类是由可执行文件或提供给进程中所有其他模板的 DLL 注册的窗口类。 应用程序本地类是可执行文件或 .dll 注册供其专用的任意窗口类。 尽管您可以注册任意数量的本地类，但通常只注册一个。 此窗口类支持应用程序主窗口的窗口过程。 有关窗口类的详细信息，请参阅 MSDN 文章“[窗口类](http://msdn.microsoft.com/en-us/library/ms632596(v=vs.85).aspx)”。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-2744](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/981957">Microsoft 知识库文章 981957</a></td>
</tr>  
<tr class="even">
...
-   [Kaspersky Lab](http://www.kaspersky.com) 的 Sergey Golovanov、Alexander Gostev、Maxim Golovkin 和 Alexey Monastyrsky 以及 [Design and Test Lab](http://www.dnt-lab.com) 的 Vitaly Kiktenko 和 Alexander Saprykin 报告了 Win32k 键盘布局漏洞 (CVE-2010-2743)  
-   [Symantec](http://www.symantec.com/index.jsp) 的 Eric Chien 报告了 Win32k 键盘布局漏洞 (CVE-2010-2743)  
-   [Norman](http://www.norman.com) 的 Tarjei Mandt 与我们一起处理了 Win32k 窗口类漏洞 (CVE-2010-2744)

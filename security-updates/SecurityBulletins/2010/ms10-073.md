---
TOCTitle: 'MS10-073'
Title: 'Microsoft 安全公告 MS10-073 - 重要'
ms:assetid: 'ms10-073'
ms:contentKeyID: 61237912
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-073(v=Security.10)'
---



Microsoft 安全公告 MS10-073 - 重要
==================================
...
此安全更新通过更正 Windows 内核模式驱动程序维护对象的引用计数，从磁盘加载键盘布局时索引函数指针表格，以及验证窗口类数据的方式来消除这些漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=3966d754-d298-4e4a-9ce6-8205accd2215)                                                                                     | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7fd7c675-0675-4a87-a709-edc47a30f1e2)                                                            | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8ef4378e-21ff-4290-96ba-e00a60f372d1)                                                                            | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4a95c74b-cfd8-45b5-8887-777429d21745)                                                                | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=21637cd8-c75c-43b4-9948-be7be54af6bf)                                                            | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e9f735ab-d995-4209-b2dc-197f53fdee0f)                                                  | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=738c8f70-b46a-4a59-bea6-078074a9c4db)                          | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4dff0ebe-ccba-4675-98ca-9903f1cb6763)&#42;                 | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=da7905a9-9587-4184-8fca-ecc636a3b67e)&#42;       | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b9096046-8c7a-450c-b8c5-6e9fb001e6cd) | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=b5b31499-d242-42bf-ac78-b787ffb4d602)                                                                                   | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=c47e8b74-8cfe-42d9-9362-8786687c88ad)                                                                              | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=98e0c6ac-c30b-4d39-8ed9-1fe69e7644e5)\*                                                               | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=44080c75-036e-4bd0-914a-74ab72189ee3)                                                             | 特权提升     | 重要         | [MS10-048](https://go.microsoft.com/fwlink/?linkid=194552) |
...
<th style="border:1px solid black;">Win32k 引用计数漏洞 - CVE-2010-2549</th>
<th style="border:1px solid black;">Win32k 键盘布局漏洞 - CVE-2010-2743</th>
<th style="border:1px solid black;">Win32k 窗口类漏洞 - CVE-2010-2744</th>
...
Win32k 引用计数漏洞 - CVE-2010-2549  
-----------------------------------
  
  
由于 Windows 内核模式驱动程序维护对象的引用计数的方式，因此存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549)。
  
#### Win32k 引用计数漏洞 (CVE-2010-2549) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 引用计数漏洞 (CVE-2010-2549) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 引用计数漏洞 (CVE-2010-2549) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
此漏洞是由 Windows 内核模式驱动程序未正确维护对象的引用计数造成的。
...
**什么是引用计数？**  
引用计数是对象管理器已分配给操作系统流程的对象指针数量的记录。 对象管理器每次分发指针给对象时都会为对象增加一个引用计数；当内核模式组件使用完指针后，它们会呼叫对象管理器减少对象的引用计数。
...
**此更新有什么作用？**  
此更新通过更正 Windows 内核模式驱动程序维护对象引用计数的方式来消除此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-2549](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2549)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已被公开用于攻击客户的信息，也没有看到任何发布的概念代码证明示例。
  
Win32k 键盘布局漏洞 - CVE-2010-2743  
-----------------------------------
  
  
由于 Windows 内核模式驱动程序加载特定键盘布局的方式，因此存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2743](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743)。
  
#### Win32k 键盘布局漏洞 (CVE-2010-2743) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 键盘布局漏洞 (CVE-2010-2743) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 键盘布局漏洞 (CVE-2010-2743) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
此漏洞是由 Windows 内核模式驱动程序在从磁盘加载键盘布局时未正确索引函数指针表造成的。
  
**对于 Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本，此漏洞的严重等级为何为“低”？**  
在 Windows 的这些版本上，存在与此漏洞相关的代码，但攻击者没有任何已知方式来获取此代码。 但是，此更新作为纵深防御措施解决此代码，以防未来找到方式利用此代码来提升特权。
...
**此更新有什么作用？**  
此更新通过更正 Windows 内核模式驱动程序在从磁盘加载键盘布局时索引函数指针表的方式来消除此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-2743](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2743)。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
是。 发由此公告时，此漏洞在有限规模上被恶意软件所利用。
  
Win32k 窗口类漏洞 - CVE-2010-2744  
---------------------------------
  
  
当 Windows 内核模式驱动程序未正确验证窗口类数据时，存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2744](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744)。
  
#### Win32k 窗口类漏洞 (CVE-2010-2744) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 窗口类漏洞 (CVE-2010-2744) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 窗口类漏洞 (CVE-2010-2744) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
此漏洞是由 Windows 内核模式驱动程序未正确管理窗口类造成的。
...
**什么是窗口类？**  
窗口类是一组系统用作模板以创建窗口的属性。 每个窗口都是窗口类的成员。 所有窗口类都特定于进程。 有三种窗口类。 系统类是由系统注册的窗口类。 许多系统类适用于要使用的所有进程，但其他类仅由系统在内部使用。 由于系统注册这些类，进程无法损坏它们。 应用程序全局类是由可执行文件或提供给进程中所有其他模板的 DLL 注册的窗口类。 应用程序本地类是可执行文件或 .dll 注册供其专用的任意窗口类。 尽管您可以注册任意数量的本地类，但通常只注册一个。 此窗口类支持应用程序主窗口的窗口过程。 有关窗口类的详细信息，请参阅 MSDN 文章“[窗口类](https://msdn.microsoft.com/en-us/library/ms632596(v=vs.85).aspx)”。
...
**此更新有什么作用？**  
此更新通过更正 Windows 内核模式驱动程序验证窗口类数据的方式来消除此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-2744](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2744)。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB981957$\Spuninst 文件夹中的 Spuninst.exe 实用工具</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/981957">Microsoft 知识库文章 981957</a></td>
</tr>  
<tr class="even">
...
-   [Kaspersky Lab](https://www.kaspersky.com) 的 Sergey Golovanov、Alexander Gostev、Maxim Golovkin 和 Alexey Monastyrsky 以及 [Design and Test Lab](https://www.dnt-lab.com) 的 Vitaly Kiktenko 和 Alexander Saprykin 报告了 Win32k 键盘布局漏洞 (CVE-2010-2743)  
-   [Symantec](https://www.symantec.com/index.jsp) 的 Eric Chien 报告了 Win32k 键盘布局漏洞 (CVE-2010-2743)  
-   [Norman](https://www.norman.com) 的 Tarjei Mandt 与我们一起处理了 Win32k 窗口类漏洞 (CVE-2010-2744)

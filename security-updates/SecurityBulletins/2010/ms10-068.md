---
TOCTitle: 'MS10-068'
Title: 'Microsoft 安全公告 MS10-068 - 重要'
ms:assetid: 'ms10-068'
ms:contentKeyID: 61237907
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-068(v=Security.10)'
---



Microsoft 安全公告 MS10-068 - 重要
==================================

本地安全机构子系统服务中的漏洞可能允许特权提升 (983539)
-------------------------------------------------------
...
对于 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本上安装的 Active Directory、ADAM 和 AD LDS，此安全更新的等级为“重要”。有关详细信息，请参阅本节的“**受影响和不受影响的软件**”小节。

通过纠正本地安全授权子系统服务 (LSASS) 处理某些 LDAP 消息的方式，此安全更新解决了漏洞问题。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=6554f98f-4dc5-4784-b92c-b0aae1fa22ca">Active Directory 应用程序模式 (ADAM)</a><br />
(KB982000)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5bc00f9a-3028-4c9d-be06-f2b78fa444c4">Active Directory 应用程序模式 (ADAM)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=3fe6e78c-c60a-4903-9273-27b37e129f0a">Active Directory</a><br />
(KB981550)<br />  
<br />  
<a href="https://www.microsoft.com/download/details.aspx?familyid=c42731f1-6393-42ed-b59f-5310c832fdc4">Active Directory 应用程序模式 (ADAM)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=22412eed-33cd-4dfc-8ef7-b74dcd7c5faf">Active Directory</a><br />
(KB981550)<br />  
<br />  
<a href="https://www.microsoft.com/download/details.aspx?familyid=79fb639d-2cc1-4bea-9df6-c67ed95890e3">Active Directory 应用程序模式 (ADAM)</a><br />
(KB982000)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cab75c8a-0d12-4a91-82b2-9f9b70610f67">Active Directory</a><br />
(KB981550)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=853a71f3-fb0d-43af-a2b8-45bf8ca1a588">Active Directory 轻型目录服务 (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=566f468b-22b6-400a-a656-ae64cfcb52df">Active Directory 轻型目录服务 (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1452befe-b7b8-4131-b36f-dded2bd16d5e">Active Directory 和 Active Directory 轻型目录服务 (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=38eb875f-1869-401b-b7d3-9f18f4ba4f24">Active Directory 和 Active Directory 轻型目录服务 (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=157862">MS09-066</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=454fc025-bfa2-4552-9522-3585f523ecb2">Active Directory 轻型目录服务 (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b15ad533-3cf1-4dcf-847c-05ebffb84e26">Active Directory 轻型目录服务 (AD LDS)</a><br />
(KB981550)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=54f36389-8be4-4a0c-9640-dc32addac9d7">Active Directory 和 Active Directory 轻型目录服务 (AD LDS)</a>*<br />
(KB981550)</td>
<td style="border:1px solid black;">特权提升</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
| Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2<sup>[1]</sup> |  
...
由于本地安全授权子系统服务 (LSASS) 处理某些轻型目录访问协议 (LDAP) 消息的方式不适当，Microsoft Windows 中存在经验证的特权提升漏洞。 Active Directory、Active Directory 应用程序模式 (ADAM) 和 Active Directory 轻型目录服务 (AD LDS) 的实施中存在漏洞。 在利用此漏洞之前，攻击者之前已通过 LSASS 服务器的身份验证。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0820](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0820)。

#### LSASS 堆溢出漏洞 (CVE-2010-0820) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。
-   要成功利用此漏洞，攻击者必须在目标 Windows 域内拥有成员帐户。 然而，攻击者不需要有加入 Windows 域的工作站。

#### LSASS 堆溢出漏洞 (CVE-2010-0820) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **在防火墙处阻止 TCP 端口 389**

    在防火墙处阻止 TCP 端口 389。 此端口用于启动与受影响组件的连接。
...
#### LSASS 堆溢出漏洞 (CVE-2010-0820) 的常见问题解答

**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成漏洞的原因是什么？**  
当 Windows LSASS 实施没有正确地处理 LDAP 消息中格式错误的特定数据包时，存在此漏洞。

**什么是 LSASS？**  
本地安全机构子系统服务 (LSASS) 提供一个用于管理本地安全、域身份验证和 Active Directory 服务进程的接口。 LSASS 处理客户端和服务器的身份验证。 LSASS 还包含支持 Active Directory 实用工具的功能。
...
Active Directory 轻型目录服务 (AD LDS) 是 Active Directory 的独立模式，可为应用程序提供专用目录服务。 AD LDS 可用于 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2。AD LDS 取代 Active Directory 应用程序模式 (ADAM)，后者可用于 Windows XP 和 Windows Server 2003。
...
**攻击者如何利用此漏洞？**  
攻击者可通过向侦听 LSASS 服务器发送特制的 LDAP 消息来利用此漏洞。 在利用此漏洞之前，攻击者之前已通过 LSASS 服务器的身份验证。

**受此漏洞威胁最大的系统有哪些？**  
所有运行受影响的操作系统并且安装了 Active Directory 服务的系统都会受到此漏洞的影响。 此漏洞不会直接影响仅客户端系统。

**此更新有什么作用？**  
通过纠正 LSASS 处理某些 LDAP 消息的方式，此安全更新解决了漏洞问题。
...
| Windows Vista Service Pack 2                                                                          | 否      | 否                  | 是                  | 是                         |
| Windows Vista x64 Edition Service Pack 2                                                              | 否      | 否                  | 是                  | 是                         |
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB982000$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/982000">Microsoft 知识库文章 982000</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">对于 Active Directory，使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB981550$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Active Directory 应用程序模式 (ADAM)，使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB982000$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关 Windows Server 2003 上的 Active Directory，请参阅 <a href="http://support.microsoft.com/kb/981550">Microsoft 知识库文章 981550</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">有关 Windows Server 2003 上的 Active Directory 应用程序模式 (ADAM)，请参阅 <a href="http://support.microsoft.com/kb/982000">Microsoft 知识库文章 982000</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/981550">Microsoft 知识库文章 981550</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>

...
**已知问题。** [Microsoft 知识库文章 2293211](https://support.microsoft.com/kb/2293211) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[MS10-057](https://go.microsoft.com/fwlink/?linkid=196275)
</td>
</tr>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3230](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3230)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3231](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3231)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3232](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3232)。
...
-   **使用** **Microsoft Office** **文件阻止策略禁止打开来自未知或不可信来源和位置的** **Office 2003** **以及较早版本的文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](https://support.microsoft.com/kb/922848) 所述配置特殊“例外目录”的用户在 Office 2003 或 Office 2007 中无法打开 Office 2003 文件或更早版本。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3233](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233)。
...
默认情况下，阻止在 Microsoft Excel 2003 Service Pack 3 中打开 Lotus 1-2-3 文件。此缓解因素降低了 CVE-2010-3233 在 Microsoft Excel 2003 Service Pack 3 上的严重等级。有关安装 Microsoft Office 2003 Service Pack 3 后被阻止的文件类型的详细信息，请参阅 [Microsoft 知识库文章 938810](https://support.microsoft.com/kb/938810/)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3234](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3235](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3235)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3236](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3236)。
...
-   **使用** **Microsoft Office** **文件阻止策略禁止打开来自未知或不可信来源和位置的** **Office 2003** **以及较早版本的文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](https://support.microsoft.com/kb/922848) 所述配置特殊“例外目录”的用户在 Office 2003 中无法打开 Office 2003 文件或更早版本。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3237](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3238](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3238)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3239](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3240](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240)。
...
-   **使用** **Microsoft Office** **文件阻止策略禁止打开来自未知或不可信来源和位置的** **Office 2003** **以及较早版本的文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](https://support.microsoft.com/kb/922848) 所述配置特殊“例外目录”的用户在 Office 2007 中无法打开 Office 2003 文件或更早版本。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3241](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3242](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2345017">Microsoft 知识库文章 2345017</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2344893">Microsoft 知识库文章 2344893</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2007，请参阅 <a href="https://support.microsoft.com/kb/2345035">Microsoft 知识库文章 2345035</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Excel Viewer，请参阅 <a href="https://support.microsoft.com/kb/2345088">Microsoft 知识库文章 2345088</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包，请参阅 <a href="https://support.microsoft.com/kb/2344875">Microsoft 知识库文章 2344875</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Secunia](https://secunia.com/) 的 Alin Rad Pop 报告了 Excel 记录分析整数溢出漏洞 (CVE-2010-3230)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Excel 记录分析内存损坏漏洞 (CVE-2010-3231)  
-   Omair 报告了 Excel 文件格式分析漏洞 (CVE-2010-3232)  
-   [Secunia](https://secunia.com/) 的 Carsten H. Eiram 报告了 Lotus 1-2-3 工作簿分析漏洞 (CVE-2010-3233)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了公式子流内存损坏漏洞 (CVE-2010-3234)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了公式 Biff 记录漏洞 (CVE-2010-3235)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了溢出数组漏洞 (CVE-2010-3236)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了合并单元格记录指针漏洞 (CVE-2010-3237)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了负值未来函数漏洞 (CVE-2010-3238)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了额外超出边界记录分析漏洞 (CVE-2010-3239)  
-   [Secunia](https://secunia.com/)的 Alin Rad Pop 报告了额外超出边界记录分析漏洞 (CVE-2010-3239)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了实时数据数组记录漏洞 (CVE-2010-3240)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了溢出内存写入分析漏洞 (CVE-2010-3241)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Ghost 记录类型分析漏洞 (CVE-2010-3242)  
-   [Secunia](https://secunia.com/) 的 Carsten H. Eiram 报告了 Ghost 记录类型分析漏洞 (CVE-2010-3242)

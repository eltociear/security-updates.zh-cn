---
TOCTitle: 'MS10-078'
Title: 'Microsoft 安全公告 MS10-078 - 重要'
ms:assetid: 'ms10-078'
ms:contentKeyID: 61237917
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-078(v=Security.10)'
---



Microsoft 安全公告 MS10-078 - 重要
==================================

OpenType 字体 (OTF) 格式驱动程序中的漏洞可能允许特权提升 (2279986)
------------------------------------------------------------------
...
此安全更新可解决 Windows OpenType 字体 (OTF) 格式驱动程序中的两个秘密报告的漏洞。 对于 Windows XP 和 Windows Server 2003 的所有受支持版本，此安全更新等级为“重要”。Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本不受此漏洞影响。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

如果用户查看以特制 OpenType 字体呈现的内容，则该漏洞可能允许特权提升。 攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。

此安全更新通过更正处理 OpenType 字体时 OpenType 字体 (OTF) 格式驱动程序分配内存和执行整数计算的方式来消除这些漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=0553fc7c-deed-4594-a133-d621551310dc)                          | 特权提升     | 重要         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1ad30596-bac6-4d48-8b15-0245960c443b) | 特权提升     | 重要         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f94763e7-b1db-4043-aa79-d5be1a42307d)                 | 特权提升     | 重要         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6fca5cab-7e11-4911-a6a8-f73f113b2963)     | 特权提升     | 重要         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=e8f297e2-0dfd-421a-b598-a78199ad6baa) | 特权提升     | 重要         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
...
<th style="border:1px solid black;">OpenType 字体分析漏洞 - CVE-2010-2740</th>
<th style="border:1px solid black;">OpenType 字体验证漏洞 - CVE-2010-2741</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2740](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2740)。
  
#### OpenType 字体分析漏洞 (CVE-2010-2740) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### OpenType 字体分析漏洞 (CVE-2010-2740) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### OpenType 字体分析漏洞 (CVE-2010-2740) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**  
在分析特制字体时，OpenType 字体 (OTF) 格式驱动程序未正确分配内存会导致此漏洞。
  
**什么是 OpenType 字体格式？**  
OpenType 是由 Microsoft 和 Adobe 联合开发的一种字体格式，作为 Apple 的 TrueType 字体格式的扩展。 OpenType 字体文件包含表格格式的数据，该数据包括 TrueType 或 PostScript 轮廓字体。 光栅器使用字体中包含的表格中的数据组合以呈现 TrueType 或 PostScript glyph 轮廓。 不管使用哪种轮廓格式，都可使用此支持数据中的部分数据；部分支持数据特定于 TrueType 或 PostScript。 有关详细信息，请参阅 [Microsoft Typography OpenType 常见问题。](https://www.microsoft.com/typography/opentypefaq.mspx)
...
是。 如果第三方 Web 浏览器在本机呈现 OpenType 字体 (OTF)，则会受此漏洞的影响。 如果这些应用程序用于以嵌入的特制字体查看网站，则此漏洞可能允许在登录用户上下文中远程执行代码。 默认情况下，Internet Explorer 不受此问题的影响。
  
**此更新有什么作用？**  
此更新通过更正分析字体时 OpenType 字体 (OTF) 格式驱动程序分配内存的方式来消除此漏洞。
...
OpenType 字体验证漏洞 - CVE-2010-2741  
-------------------------------------
  
  
Windows OpenType 字体 (OTF) 格式驱动程序不正确分析特制 OpenType 字体的方式中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2741](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2741)。
  
#### OpenType 字体验证漏洞 (CVE-2010-2741) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### OpenType 字体验证漏洞 (CVE-2010-2741) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### OpenType 字体验证漏洞 (CVE-2010-2741) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**  
在处理特制 OpenType 字体时，OpenType 字体 (OTF) 格式驱动程序未正确执行整数计算时会导致此漏洞。
...
**第三方 Web 浏览器是否受此漏洞的影响？**  
是。 如果第三方 Web 浏览器在本机呈现 OpenType 字体 (OTF)，则会受此漏洞的影响。 如果这些应用程序用于以嵌入的特制字体查看网站，则此漏洞可能允许在登录用户上下文中远程执行代码。
  
**此更新有什么作用？**  
此更新通过更正处理 OpenType 字体时 OpenType 字体 (OTF) 格式驱动程序执行整数计算的方式来消除此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2279986$\Spuninst 文件夹中的 Spuninst.exe 实用工具</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2279986">Microsoft 知识库文章 2279986</a></td>
</tr>  
<tr class="even">
...
-   [Siberas](https://www.siberas.de/) 的 Sebastian Apelt 报告了 OpenType 字体分析漏洞 (CVE-2010-2740)
-   [Core Security Technologies](https://www.coresecurity.com) 的 Diego Juarez 报告了 OpenType 字体验证漏洞 (CVE-2010-2741)

---
TOCTitle: 'MS10-028'
Title: 'Microsoft 安全公告 MS10-028 - 重要'
ms:assetid: 'ms10-028'
ms:contentKeyID: 61237867
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-028(v=Security.10)'
---

Microsoft 安全公告 MS10-028 - 重要
==================================
...
对于 Microsoft Office Visio 2002 Service Pack 2、Microsoft Office Visio 2003 Service Pack 3、Microsoft Office Visio 2007 Service Pack 1 和 Microsoft Office Visio 2007 Service Pack 2，此安全更新的等级为“重要”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

通过更正在打开特制的 Visio 文件时 Microsoft Office Visio 验证属性和计算索引的方式，此安全更新解决了这些漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2d563cbc-d8f7-486b-8c54-25d168085376">Microsoft Office Visio 2002 Service Pack 2</a><br />
(KB979364)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=803a7ea0-a9da-46dd-9548-0177d3774be7">Microsoft Office Visio 2003 Service Pack 3</a><br />
(KB979356)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=128107">MS09-005</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=56fe020f-4444-4a43-aa98-e99a622f6a69">Microsoft Office Visio 2007 Service Pack 1</a><br />
(KB979365)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=128107">MS09-005</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=56fe020f-4444-4a43-aa98-e99a622f6a69">Microsoft Office Visio 2007 Service Pack 2</a><br />
(KB979365)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
...
Microsoft Office Visio 2002 和更高版本具有下列内置功能：打开文档之前，系统将提示用户打开、保存或取消。 此缓解因素将该远程执行代码漏洞从“严重”降级为“重要”，因为该漏洞需要多次用户操作才能完成利用。
  
**在哪里可以找到有关 Microsoft Office Viewer 的详细信息？**    
有关 Microsoft Office Viewer 的当前版本和淘汰版本的信息，请参阅 [Microsoft 知识库文章 979860](https://support.microsoft.com/?id=979860)。
...
<tr class="header">  
<th>受影响的软件</th>  
<th>Visio 属性验证内存损坏漏洞 - CVE-2010-0254</th>  
<th>Visio 索引计算内存损坏漏洞 - CVE-2010-0256</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office Visio 2007 Service Pack 1 和 Microsoft Office Visio 2007 Service Pack 2</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
远程执行代码</td>
...
Visio 属性验证内存损坏漏洞 - CVE-2010-0254  
------------------------------------------
  
   
在处理特制的 Visio 文件时，Microsoft Office Visio 验证属性的方式中存在远程执行代码漏洞。
  
成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0254](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0254)。
  
#### Visio 属性验证内存损坏漏洞 (CVE-2010-0254) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在打开文档之前，系统将提示 Microsoft Office Visio 2002 和更高版本的用户打开、保存或取消。 这是一个缓解因素，因为此漏洞需要多次用户操作才能完成利用。  
-   此漏洞无法通过电子邮件自动加以利用。 用户必须打开电子邮件附件，以电子邮件为载体的攻击才会得逞。 攻击者必须说服用户打开附件以利用此漏洞。  
-   在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的特制 Visio 文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问特制的网站。 相反，攻击者必须诱使用户访问该网站，方法通常是让用户单击链接以使用户链接到攻击者的网站，然后诱使用户打开特制的 Visio 文件。  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
#### Visio 属性验证内存损坏漏洞 (CVE-2010-0254) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   不要打开从不受信任来源或从受信任来源意外收到的 Visio 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。 文件扩展名 .vsd 通常与 Visio 文件关联。
  
#### Visio 属性验证内存损坏漏洞 (CVE-2010-0254) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
在打开特制的 Visio 文件时，Microsoft Office Visio 处理内存的方式中存在漏洞。
...
**此更新有什么作用？**    
通过更正在打开特制的 Visio 文件时 Microsoft Office Visio 验证属性的方式，此更新解决了该漏洞。
...
Visio 索引计算内存损坏漏洞 - CVE-2010-0256  
------------------------------------------
  
   
在处理特制的 Visio 文件时，Microsoft Office Visio 计算索引的方式中存在远程执行代码漏洞。
  
成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0256](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0256)。
  
#### Visio 索引计算内存损坏漏洞 (CVE-2010-0256) 的缓解因素
...
#### Visio 索引计算内存损坏漏洞 (CVE-2010-0256) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   不要打开从不受信任来源或从受信任来源意外收到的 Visio 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。
  
#### Visio 索引计算内存损坏漏洞 (CVE-2010-0256) 的常见问题
...
**此更新有什么作用？**    
通过更正在打开特制的 Visio 文件时 Microsoft Office Visio 计算索引的方式，此更新解决了该漏洞。
...
| Microsoft Office Visio 2007 Service Pack 2 | 是         |
...
| Microsoft Office Visio 2003 Service Pack 3 | 否      | 否                  | 是                  | 是                         |  
| Microsoft Office Visio 2007 Service Pack 1 | 否      | 否                  | 是                  | 是                         |  
| Microsoft Office Visio 2007 Service Pack 2 | 否      | 否                  | 是                  | 是                         |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979364">Microsoft 知识库文章 979364</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979356">Microsoft 知识库文章 979356</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979365">Microsoft 知识库文章 979365</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   Fortinet's [FortiGuard Labs](https://www.fortiguard.com/) 的 Bing Liu 报告了 Visio 属性验证内存损坏漏洞 (CVE-2010-0254)  
-   Fortinet's [FortiGuard Labs](https://www.fortiguard.com/) 的 Bing Liu 报告了 Visio 索引计算内存损坏漏洞 (CVE-2010-0256)

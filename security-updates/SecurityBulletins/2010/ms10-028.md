...
有关 Microsoft Office Viewer 的当前版本和淘汰版本的信息，请参阅 [Microsoft 知识库文章 979860](http://support.microsoft.com/?id=979860)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0254)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0256)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/979364">Microsoft 知识库文章 979364</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/979356">Microsoft 知识库文章 979356</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/979365">Microsoft 知识库文章 979365</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   Fortinet's [FortiGuard Labs](http://www.fortiguard.com/) 的 Bing Liu 报告了 Visio 属性验证内存损坏漏洞 (CVE-2010-0254)  
-   Fortinet's [FortiGuard Labs](http://www.fortiguard.com/) 的 Bing Liu 报告了 Visio 索引计算内存损坏漏洞 (CVE-2010-0256)

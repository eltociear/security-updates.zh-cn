...
**已知问题。** [Microsoft 知识库文章 2293386](https://support.microsoft.com/kb/2293386) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
Microsoft 修订此公告，是为了阐明使用 Microsoft PowerPoint 2002 和 Microsoft PowerPoint 2003 的客户也需要安装 [MS10-087](https://go.microsoft.com/fwlink/?linkid=203241) 中提供的 Microsoft Office 更新（Microsoft Office 中的漏洞可能允许远程执行代码 (2423930)）以避免受 CVE-2010-2573 中描述的漏洞影响。这仅仅是信息更改。 成功应用了 MS10-087 和 MS10-088 的更新的客户不必采取任何行动。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2572](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2572)。
...
-   默认情况下，Microsoft PowerPoint 2003 Service Pack 3 中禁止打开 PowerPoint 95 文件。有关安装 Microsoft Office 2003 Service Pack 3 后阻止的文件类型的更多信息，请参阅 [Microsoft 知识库文章 938810](https://support.microsoft.com/kb/938810/)。
...
-   **限制 Microsoft PowerPoint 2002 用户访问 pp7x32.dll**
    ...
    **如何撤消变通方法：**
    ...
    4.  单击“**安全**”选项卡。
        **注意** 如果“属性”对话框中没有“安全”选项卡，则按照 [Microsoft 知识库文章 307874](https://support.microsoft.com/kb/307874/) 的“如何关闭简单文件共享”部分中的步骤查看“安全”选项卡。
    5.  单击“**高级**”。
    6.  单击“**所有者**”选项卡。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2413272">Microsoft 知识库文章 2413272</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2413304">Microsoft 知识库文章 2413304</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2413381">Microsoft 知识库文章 2413381</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Secunia Research](https://secunia.com/) 的 Alin Rad Pop 报告了 PowerPoint 分析缓冲区溢出漏洞 (CVE-2010-2572)  

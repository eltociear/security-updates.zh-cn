...
此安全更新也解决了最初在 [Microsoft 安全通报 983438](https://technet.microsoft.com/security/advisory/983438) 中描述的漏洞。

**建议。** Microsoft 建议客户尽早应用此更新。

**已知问题。** [Microsoft 知识库文章 2028554](https://support.microsoft.com/kb/2028554) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office SharePoint Server 2007 Service Pack 2（64 位版本）](https://www.microsoft.com/download/details.aspx?familyid=4d84a25b-532f-4319-9ab2-90e5b82ebd90)  
(KB979445)<sup>[1]</sup>
</td>
<td style="border:1px solid black;">
信息泄露
...
此公告中描述的 toStaticHTML 信息泄露漏洞 [CVE-2010-1257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257) 也影响 Internet Explorer。 [MS10-035](https://go.microsoft.com/fwlink/?linkid=190898) Internet Explorer 的累积性安全更新 (982381) 解决了 Internet Explorer 的漏洞。 如果您已安装 Internet Explorer，请根据 [MS10-035](https://go.microsoft.com/fwlink/?linkid=190898) 应用所需更新。如果已安装 Microsoft SharePoint，请根据此公告应用所需更新。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**客户在安装此安全更新时可能遇到哪些已知问题？**  
[Microsoft 知识库文章 2028554](https://support.microsoft.com/kb/2028554) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0817](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0817)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0817](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0817)。此漏洞最初是在 [Microsoft 安全通报 983438](https://technet.microsoft.com/security/advisory/983438) 中介绍的。

**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
是。 在发布此安全公告时，Microsoft 已收到有关此漏洞已被利用的信息。

**应用此安全更新有助于客户防止尝试利用此漏洞的已公开发布代码吗？**  
是。 此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2010-0817](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0817)。
...
**什么是 toStaticHTML？**  
toStaticHTML API 可用于在将用户输入显示为 HTML 之前从中清除事件属性和脚本。 有关详细信息，请参阅下列 MSDN 库文章 [toStaticHTML 方法](https://msdn.microsoft.com/en-us/library/cc848922(vs.85).aspx)。
...
**此漏洞与**[**MS10-035**](https://go.microsoft.com/fwlink/?linkid=190898)**（Internet Explorer 的累积性安全更新 (982381)）中的 CVE-2010-1857 是否相关？**  
是的，toStaticHTML 信息泄露漏洞 [CVE-2010-1257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257) 也影响 Internet Explorer。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1264](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1264)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/980923">Microsoft 知识库文章 980923</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979441">Microsoft 知识库文章 979441</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979445">Microsoft 知识库文章 979445</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/983444">Microsoft 知识库文章 983444</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>

...
**已知问题。** [Microsoft 知识库文章 975416](https://support.microsoft.com/kb/975416) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2004 for Mac](https://www.microsoft.com/download/details.aspx?familyid=7c985595-00c5-44b8-81c3-59d9967220f8)  
(KB979674)
</td>
<td style="border:1px solid black;">
不适用
...
[Microsoft 知识库文章 975416](https://support.microsoft.com/kb/975416) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
这是因为 PowerPoint Viewer 2003 的独立安装的[支持生命周期已结束](https://blogs.technet.com/office_sustained_engineering/archive/2008/12/09/excel-viewer-2003-word-viewer-2003-and-powerpoint-viewer-2003-to-retire.aspx)，并且厂商将不会提供此更新。 相反，此更新会提供给 Microsoft Office PowerPoint 2003 的客户，以便他们可以发布通过使用 PowerPoint Viewer 2003 的 PowerPoint 中的[为 CD 打包演示](https://support.microsoft.com/kb/828504)功能创建的演示的更新版本。

使用 PowerPoint Viewer 2003 的独立安装的客户应优先考虑迁移到受支持的版本，以防止可能会受到漏洞的影响。 PowerPoint Viewer 2007 不受此公告中描述的漏洞影响，并且用户可从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en)获得它。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0029](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0029)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0030](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0030)。
...
-   **使用 Microsoft Office 文件阻止策略禁止打开来自未知或不可信来源和位置的 Office 2003 以及较早版本的文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922847](https://support.microsoft.com/kb/922847) 所述配置特殊“例外目录”的用户在 Office 2003 中无法打开 Office 2003 文件或更早版本。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0031](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0031)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0032](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0032)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0033](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0033)。
...
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站，然后说服他们打开特制的 PowerPoint 文件。
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
-   Microsoft Office PowerPoint Viewer 2007 不受此漏洞影响。 用户可以安装来自 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=048dc840-14e1-467d-8dca-19d2a8fd7485&displaylang=en)的 Microsoft Office PowerPoint Viewer 2007。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0034](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0034)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/973143">Microsoft 知识库文章 973143</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/976881">Microsoft 知识库文章 976881</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=7c985595-00c5-44b8-81c3-59d9967220f8)下载和安装 Microsoft Office 2004 for Mac 11.5.7 Update 的合适语言版本。
...
-   [Secunia](https://secunia.com/) 的 Carsten Eiram 报告了 PowerPoint 文件路径处理缓冲区溢出 (CVE-2010-0029)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了 PowerPoint LinkedSlideAtom 堆溢出漏洞 (CVE-2010-0030)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了 PowerPoint OEPlaceholderAtom 'placementId' 无效的数组索引漏洞 (CVE-2010-0031)  
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了 PowerPoint OEPlaceholderAtom 使用释放后内存漏洞 (CVE-2010-0032)  
-   SkD 与 [TippingPoint 的](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 PowerPoint Viewer TextBytesAtom 记录堆栈溢出漏洞 (CVE-2010-0033)  
-   [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) 的 Cody Pierce 报告了 Office PowerPoint Viewer TextCharsAtom 记录堆栈溢出 (CVE-2010-0034)

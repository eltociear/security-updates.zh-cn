...
**已知问题。** [Microsoft 知识库文章 978213](https://support.microsoft.com/kb/978213) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<sup>[3]</sup>可通过 [Summit Software Company](https://www.summsoft.com/) 为独立软件供应商 (ISV) 提供 Visual Basic for Applications SDK 的更新版本以解决此公告中描述的漏洞。 有关详细信息，请参阅下一节“**与此安全更新相关的常见问题 (FAQ)**”。
...
支持 VBA 的第三方应用程序可能在一个此安全更新没有更新的位置部署 VBE6.DLL。 有关如何检测您的系统上使用了 VBE6.DLL 的第三方应用程序，请参阅 [Microsoft 知识库文章 978213](https://support.microsoft.com/kb/978213)。如果您的第三方应用程序附带自己的 VBE6.DLL 副本，为帮助确保您的系统完全不受此公告中描述的漏洞的影响，您应直接联系负责支持第三方应用程序的开发商或供应商。
  
**我是第三方应用程序开发人员，我在我的应用程序中使用 Microsoft Visual Basic for Applications runtime。 我的应用程序是否容易受到攻击，如何进行更新？**    
重新分配 Microsoft Visual Basic for Applications runtime VBE6.DLL 的开发人员应确保通过从 [Summit Software Company](https://www.summsoft.com/) 下载 Microsoft Visual Basic for Applications SDK 的更新版本，更新随其应用程序安装的 Microsoft Visual Basic for Applications runtime 的版本。 有关使用重新分发的组件的最佳做法的详细信息，请参阅 [Microsoft 知识库文章 835322](https://support.microsoft.com/kb/835322)以及 MSDN 文章[隔离的应用程序和并行程序集](https://msdn.microsoft.com/en-us/library/aa375193.aspx)。
  
**我是 ISV。 Microsoft Visual Basic for Applications SDK 的更新在哪里？**    
此更新可从 [Summit Software Company](https://www.summsoft.com/) 下载。 Summit Software Company 是一家全球供应商，为独立软件供应商 (ISV) 和公司开发人员提供应用程序自定义软件产品和集成支持服务。 1996 年 6 月，Summit Software 与 Microsoft 签订一项协议，销售 Microsoft Visual Basic for Applications 以及相关的增值技术和服务。 Summit 继续销售和支持 Microsoft VBA。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0815](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0815)。

#### VBE6.DLL 堆栈内存损坏漏洞 (CVE-2010-0815) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   默认情况下，在 Office 文档中激活嵌入式 ActiveX 控件之前，2007 Microsoft Office System 通过安全警告提示用户。 选择不启用该控件的用户受此默认设置保护。 有关详细信息，请参阅 Microsoft Office Online 文章[启用或禁用 Office 文档中的 ActiveX 控件](https://office.microsoft.com/en-us/help/ha100310671033.aspx)。
...
-   **禁用 2007 Microsoft Office System 中的 ActiveX 控件**
    ...
    您可以使用“**信任中心**”禁用 2007 Microsoft Office System 中的 ActiveX 控件。 请参阅 Microsoft Office Online 文章[启用或禁用 Office 文档中的 ActiveX 控件](https://office.microsoft.com/en-us/help/ha100310671033.aspx)中有关如何“禁用所有控件而不通知”的说明
...
**如何撤消变通方法。 **有关如何撤消此变通办法的信息，请参阅 [Microsoft 知识库文章 935865](https://support.microsoft.com/kb/935865)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/976380">Microsoft 知识库文章 976380</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/976382">Microsoft 知识库文章 976382</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/976321">Microsoft 知识库文章 976321</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/974945">Microsoft 知识库文章 974945</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [NSFocus Security Team](https://www.nsfocus.com/) 报告了 VBE6.DLL 堆栈内存损坏漏洞 (CVE-2010-0815)

---
TOCTitle: 'MS10-032'
Title: 'Microsoft 安全公告 MS10-032 - 重要'
ms:assetid: 'ms10-032'
ms:contentKeyID: 61237871
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-032(v=Security.10)'
---

Microsoft 安全公告 MS10-032 - 重要
==================================
...
此安全更新通过更正对象更改和回叫参数验证，以及通过更正 Windows 向用户模式应用程序提供 TrueType 字体轮廓的方法来解决此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=60c8579b-1540-40d8-80a0-956edadd63ce)                                                                         | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=023a777a-3d83-4a4e-8029-da8b095b074b)                                                        | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8e3aac9d-7747-435f-9678-f621e314e070)                                                            | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=79a11dcd-5d88-4d83-beae-6580ef6fc2c0)                                                                            | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f42cc5d4-1bea-4a4a-8a08-b3eb92503588)                                                                | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=50efb1cf-9d89-4522-929d-f87fd98d6fe8)                                                            | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7cb64633-d2a0-4e38-be35-ec32ea655a04)                                                  | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=bbfc4d80-67eb-4deb-9595-cb67942a0df2)                          | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=22d550fe-ba35-4750-a9d6-624858b67c94)\*                 | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=09025626-4116-4a31-8700-215382898ee2)\*       | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0035cfe2-d38d-41cd-b704-ec1feda307d8) | 特权提升     | 重要         | [MS09-065](https://go.microsoft.com/fwlink/?linkid=162428) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=3e0ff389-4612-4c92-bbff-bb45b5bdfc6a)                                                                                   | 特权提升     | 重要         | 无                                                        |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=2b1e4aff-605a-4e94-88f9-135ce35f0646)                                                                              | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=4272277f-b2dd-4406-8bbd-bc461c9923b8)\*                                                               | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=7d636f82-e828-468c-ac36-808ff9d37c7f)                                                             | 特权提升     | 重要         | 无                                                        |
...
<tr class="header">
<th>受影响的软件</th>
<th>Win32k 数据验证不正确漏洞 - CVE-2010-0484</th>
<th>Win32k 窗口创建漏洞 - CVE-2010-0485</th>
<th>Win32k TrueType 字体分析漏洞 - CVE-2010-1255</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Win32k 数据验证不正确漏洞 - CVE-2010-0484  
-----------------------------------------
  
   
由于 Windows 内核模式驱动程序未正确验证某些内核对象中的更改，因此存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0484](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0484)。
  
#### Win32k 数据验证不正确漏洞 (CVE-2010-0484) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 数据验证不正确漏洞 (CVE-2010-0484) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 数据验证不正确漏洞 (CVE-2010-0484) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核模式驱动程序未正确验证某些内核对象中的更改。
...
Win32k 窗口创建漏洞 - CVE-2010-0485  
-----------------------------------
  
   
由于 Windows 内核模式驱动程序在创建窗口时未正确验证所有参数，因此存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0485](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485)。
  
#### Win32k 窗口创建漏洞 (CVE-2010-0485) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k 窗口创建漏洞 (CVE-2010-0485) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k 窗口创建漏洞 (CVE-2010-0485) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核模式驱动程序在创建窗口时未正确验证所有回叫参数。
...
**此更新有什么作用？**    
此更新通过更正 Windows 内核模式驱动程序在创建窗口时验证回叫参数的方式来解决该漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0485](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485)。
  
**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已被公开用于攻击客户的信息，也没有看到任何发布的概念代码证明示例。
  
Win32k TrueType 字体分析漏洞 - CVE-2010-1255  
--------------------------------------------
  
   
特权提升漏洞由于操作系统向应用程序提供字体相关信息的方式而存在。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1255](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255)。
  
#### Win32k TrueType 字体分析漏洞 (CVE-2010-1255) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Win32k TrueType 字体分析漏洞 (CVE-2010-1255) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Win32k TrueType 字体分析漏洞 (CVE-2010-1255) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
该漏洞是由于 Windows 向应用程序提供 glyph 轮廓信息的方式引起的。
...
**是否可以远程利用此漏洞？**    
没有可通过远程媒介暴露此漏洞的 Microsoft 应用程序。 然而，第三方应用程序可能分析来自不信任源的特定字体，从而远程暴露此漏洞。 在此情形中，此漏洞的利用可以导致匿名用户使用完全管理特权执行代码。
  
**受此漏洞威胁最大的系统有哪些？**    
工作站和终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**    
此更新通过更正 Windows 向用户模式应用程序提供 TrueType 字体轮廓的方法来解决此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-1255](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255)。
...
| **部署**                         |                                                                                                                     |  
| 没有用户干预的安装               | Windows2000-KB979559-x86-enu /quiet                                                                                 |  
| 在不重新启动的情况下安装         | Windows2000-KB979559-x86-enu /norestart                                                                             |  
| 更新日志文件                     | KB979559.log                                                                                                        |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节                                                                                |  
| **重新启动要求**                 |                                                                                                                     |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                              |  
| HotPatching                      | 不适用                                                                                                              |  
| **删除信息**                     | 使用控制面板中的**添加或删除程序**工具或 %Windir%\\$NTUninstallKB979559$\\Spuninst 文件夹中的 Spuninst.exe 实用程序 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 979559](https://support.microsoft.com/kb/979559)                                        |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB979559\\Filelist                           |
...
<td style="border:1px solid black;">使用控制面板中的<strong>添加或删除程序</strong>工具或 %Windir%\\$NTUninstallKB979559$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979559">Microsoft 知识库文章 979559</a></td>
</tr>  
<tr class="even">
...
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Sebastien Renaud 报告了 Win32k 数据验证不正确漏洞 (CVE-2010-0484)  
-   [Secunia Research](https://secunia.com/) 与我们一起处理了 Win32k TrueType 字体分析漏洞 (CVE-2010-1255)

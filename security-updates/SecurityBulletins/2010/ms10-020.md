...
此安全更新也解决了最初在 [Microsoft 安全通报 977544](https://technet.microsoft.com/security/advisory/977544) 中描述的漏洞。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=67ccac04-e5c8-4381-9d1a-9b676dd516a6)                                                                           | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=dec38c02-3d4a-41c5-8954-e57f56b8fa5b)                                                          | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c5a21239-a9a3-4ec5-9de8-7d2fc16fc6b8)                                                              | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1189304f-d626-426d-960c-a86dc2d2b528)                                                                              | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=52e4f66b-b76c-46a1-aeff-74efa21fc743)                                                                  | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=b2b6d8b1-63cc-459c-b5fa-1355386273c8)                                                              | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=25eeaeb3-c0a3-4a02-9912-acd0342648ba)                                     | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=394c1caa-97e4-47a3-9aac-a4a88508bd31) | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=51c9c420-4507-4911-a8f5-82331a696882)\*                   | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=61c26a1f-c885-4474-9843-204c41628889)\*         | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=bcf8b919-08a9-487f-8dfd-3ca24328c4f3)   | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=389184c5-9001-497d-bdf4-81f97ecb617f)                                                                                     | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=f3495dae-71f3-421d-a191-d26965f26ad1)                                                                                | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=cd1a046e-915d-4904-b753-5a24be10c504)\*                                                                 | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=541e9e2f-ec1d-42b2-aae5-481c0d435169)                                                               | 远程执行代码 | 严重         | [MS10-006](https://go.microsoft.com/fwlink/?linkid=178850) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-3676](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3676)。
...
-   **在防火墙处阻止 TCP 端口 139 和 445**
    ...
    这些端口用于启动与受影响组件的连接。 将 TCP 端口 139 和 445 阻止在防火墙处，有助于保护位于防火墙后面的系统尝试利用此漏洞。 对于此特定漏洞，应该阻塞入站和出站 SMB 流量，以降低风险。 Microsoft 建议阻塞所有来自 Internet 的未经请求的入站通信，以帮助阻止可能使用其他端口进行的攻击。 有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2009-3676](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3676)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0269](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0269)。
...
**什么是 Microsoft 服务器消息块 (SMB) 协议？**    
Microsoft 服务器消息块 (SMB) 协议是 Microsoft Windows 中使用的一项 Microsoft 网络文件共享协议。 有关 SMB 的详细信息，请参阅 MSDN 文章 [Microsoft SMB 协议和 CIFS 协议概述](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0270](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0270)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0476](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0476)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0477](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0477)。
...
**什么是 Winsock 内核？**    
Winsock 内核 (WSK) 是内核模式的网络编程接口 (NPI)。 利用 WSK，内核模式的软件模块可以使用受用户模式 Winsock2 支持的相同套接字编程概念执行网络 I/O 操作。WSK NPI 支持类似的套接字操作，例如套接字创建、捆绑、连接建立和数据传输（发送和接收）。 但是，虽然 WSK NPI 支持大部分与用户模式 Winsock2 相同的套接字编程概念，但它实际上是具有独特特性的全新且与众不同的接口，例如，具有异步 I/O 功能，可使用 IRP 和事件回叫以提高性能。 有关详细信息，请参阅 MSDN 文章 [Winsock 内核](https://msdn.microsoft.com/en-us/library/ff571084.aspx)。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 980232](https://support.microsoft.com/kb/980232)                                        |  
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/980232">Microsoft 知识库文章 980232</a></td>
</tr>  
<tr class="even">
...
-   [Visuality Systems Ltd.](https://www.visualitynq.com/) 的 Mark Rabinovich 报告了 SMB 客户端内存分配漏洞 (CVE-2010-0269)  
-   [stratsec](https://www.stratsec.net/) 的 Laurent Gaffié 报告了 SMB 客户端事务漏洞 (CVE-2010-0270)  
-   [stratsec](https://www.stratsec.net/) 的 Laurent Gaffié 报告了 SMB 客户端响应分析漏洞 (CVE-2010-0476)  
-   [stratsec](https://www.stratsec.net/) 的 Laurent Gaffié 报告了 SMB 客户端消息大小漏洞 (CVE-2010-0477)

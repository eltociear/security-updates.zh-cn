...
**已知问题。** [Microsoft 知识库文章 981832](https://support.microsoft.com/kb/981832) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
随着 Microsoft Exchange 2007 的发布，Microsoft Exchange 转向了新的服务模型。 为了更好地了解 Microsoft Exchange 服务模型，请参阅 TechNet 文章 [Exchange 2007 服务](https://go.microsoft.com/fwlink/?linkid=89577)。 有关新的 Microsoft Exchange 服务模型的问题，请联系 [Microsoft 帮助和支持](https://support.microsoft.com/)。

**此更新为何消除了多个已报告的安全漏洞？**  
此更新之所以包含对某些漏洞的支持，是因为解决这些问题所需的修改位于相关的文件中。 客户只需安装此更新就可以了，而不用安装多个几乎相同的更新。

**此更新是否包含任何与安全性相关的功能更改？**  
是。 除了此公告的“漏洞信息”部分列出的更改之外，此更新包括对 Microsoft Exchange 2000 Server Service Pack 3 的纵深防御更改，解决在使用 Outlook Web Access (OWA) 时出现的中文字符集问题。 此问题仅影响 Exchange 2000 系统。 请注意，要安装 Microsoft Exchange 2000 Server Service Pack 3 的更新，首先要具备 Exchange 2000 Server Post-Service Pack 3 (SP3) 更新汇总。 只有在安装 Exchange 2000 (KB870540) 更新汇总之后，您才能安装随此安全公告提供的纵深防御更新。 此更新会检测是否安装了更新汇总。 如果未安装，它会指导您定位至下载网站。 有关详细信息，请参阅 [Microsoft 知识库文章 870540](https://support.microsoft.com/kb/870540)。要下载必须预先具备的更新，请参阅[Exchange 2000 更新汇总 (KB870540)](https://www.microsoft.com/download/details.aspx?familyid=363a57a4-8bed-4bbb-bbe4-abc11ab04611)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0024](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0024)。
...
**什么是 SMTP 服务？**  
用于传输电子邮件的简单邮件传输协议 (SMTP) 服务已作为电子邮件服务或 Internet 信息服务 (IIS) 的一部分进行安装。 SMTP 控制如何在 Internet 上传输电子邮件并将其传递到目标服务器。 SMTP 服务发送和接收服务器之间的电子邮件。 有关详细信息，请参阅 TechNet 文章[简单邮件传输协议 (SMTP) 服务](https://technet.microsoft.com/en-us/library/cc759281(ws.10).aspx)。

**什么是 MX 资源记录？**  
邮件交换 (MX) 资源记录为 DNS 域名指定邮件交换服务器。 邮件交换服务器是为 DNS 域名处理和转发邮件的主机。 处理邮件意味着将其交付给收件人或传递到另一类型的邮件运输。 转发邮件意味着将其发送到最终目标服务器，使用简单邮件传输协议 (SMTP) 将其发送到接近于最终目标的另一邮件交换服务器，或者将其放在队列中排队等候指定的时间量。 有关 MX 资源记录的详细信息，请参阅 TechNet 文章[资源记录类型](https://technet.microsoft.com/en-us/library/cc958958.aspx)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0024](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0024)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0025](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0025)。
...
**什么是 SSL？**  
安全套接字层 (SSL) 是传输层安全协议的前身。 SSL 使用公钥和密钥技术组合执行相同的功能并支持安全的网络通信。 有关详细信息，请参阅 TechNet 文章 [TLS/SSL 的工作原理](https://technet.microsoft.com/en-us/library/cc783349(ws.10).aspx)。

**什么是 SChannel 安全程序包？**  
安全通道 (SChannel) 安全程序包是实现 Internet 标准身份验证协议、安全套接字层 (SSL) 和传输层安全 (TLS) 的安全支持提供程序 (SSP)。 这些组件用于实现安全通信以支持多个公共 Internet 和网络应用程序（例如 Web 浏览）。 SChannel 是安全程序包的一部分，它帮助提供身份验证服务以便在客户端和服务器之间提供安全的通信。 有关详细信息，请参阅 MSDN 文章[安全通道](https://msdn.microsoft.com/en-us/library/aa380123(vs.85).aspx)。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 976323](https://support.microsoft.com/kb/976323)                                        |
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/976323">Microsoft 知识库文章 976323</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/976703">Microsoft 知识库文章 976703</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/976702">Microsoft 知识库文章 976702</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Exchange Server 2007 Service Pack 1（用于基于 x64 的系统）：<br />
请参阅 <a href="https://support.microsoft.com/kb/981407">Microsoft 知识库文章 981407</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Exchange Server 2007 Service Pack 2（用于基于 x64 的系统）：<br />
请参阅 <a href="https://support.microsoft.com/kb/981383">Microsoft 知识库文章 981383</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Microsoft Exchange Server 2007 Service Pack 1（用于基于 x64 的系统）：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/981401">Microsoft 知识库文章 981401</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Microsoft Exchange Server 2010（用于基于 x64 的系统）：<br />

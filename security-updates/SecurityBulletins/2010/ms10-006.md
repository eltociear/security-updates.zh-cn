---
TOCTitle: 'MS10-006'
Title: 'Microsoft 安全公告 MS10-006 - 严重'
ms:assetid: 'ms10-006'
ms:contentKeyID: 61237531
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-006(v=Security.10)'
---

Microsoft 安全公告 MS10-006 - 严重
==================================
...
对于 Microsoft Windows 2000、Windows XP、Windows Server 2003、Windows 7 和 Windows Server 2008 R2，此安全更新的等级为“严重”；对于 Windows Vista 和 Windows Server 2008，此安全更新的等级为“重要”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

该安全更新通过更正 SMB 客户端验证响应的方式来解决该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=80b49bab-6c2f-48a8-a901-ca3f76e4fe6b)                                 | 远程执行代码 | 严重         | [MS06-030](https://go.microsoft.com/fwlink/?linkid=62073)  |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=f6c4472e-385c-4412-bda9-c2e615e50713)                | 远程执行代码 | 严重         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=63e15ff0-73b3-46c9-96f8-c18977d35a10)                    | 远程执行代码 | 严重         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=feb8c145-7c30-45fa-a6f0-8b6453ddd521)                                    | 远程执行代码 | 严重         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=36d88c1b-814c-4371-9ed2-d4576f419fc3)                        | 远程执行代码 | 严重         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=622442b0-cffe-4fc2-94a8-edff9d71ecd3)                    | 远程执行代码 | 严重         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows Vista 和 Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=1902fc93-0f4b-4261-9da3-17d1931daf2e)                         | 特权提升     | 重要         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=1902fc93-0f4b-4261-9da3-17d1931daf2e)                                          | 特权提升     | 重要         | 无                                                        |
| [Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=7c2f89b5-a3b3-42cd-857d-923fe8b8f1da) | 特权提升     | 重要         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7c2f89b5-a3b3-42cd-857d-923fe8b8f1da)                              | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=09e19263-18ba-495e-bcf7-719e957204a7)\*                               | 特权提升     | 重要         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=09e19263-18ba-495e-bcf7-719e957204a7)\*                 | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=180c2313-5e3e-4d84-87cd-64048f51e0f6)\*                          | 特权提升     | 重要         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=180c2313-5e3e-4d84-87cd-64048f51e0f6)\*            | 特权提升     | 重要         | 无                                                        |
| [Windows Server 2008（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=614eaf7e-95aa-4f8f-910c-1980e1f14d11)                        | 特权提升     | 重要         | [MS08-068](https://go.microsoft.com/fwlink/?linkid=133434) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=614eaf7e-95aa-4f8f-910c-1980e1f14d11)          | 特权提升     | 重要         | 无                                                        |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=a589431a-93dc-42cd-a74e-d9c1e3452fef)                                           | 远程执行代码 | 严重         | 无                                                        |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=3c1edcf8-d304-45c4-9818-1cd86383b3fe)                                      | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=ecb06350-47a7-48eb-825f-3e8f89c5ca8e)\*                       | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=badd6cab-7738-4401-a68c-c15414388601)                     | 远程执行代码 | 严重         | 无                                                        |
...
**此安全更新是否与 2010 年 2 月 9 日发布的 MS10-012 相关？**  
否。 Microsoft 安全公告 [MS10-012](https://go.microsoft.com/fwlink/?linkid=158199)“SMB 服务器中的漏洞可能允许远程执行代码”解决不同的 SMB 组件问题。 此安全更新可独立于任何其他更新进行应用。

**如果我已经安装了 MS10-012 更新，还需要安装此更新吗？**  
是。 此安全公告更新解决 Windows SMB 客户端组件中的漏洞，而 [MS10-012](https://go.microsoft.com/fwlink/?linkid=158199) 解决 Windows SMB 服务器组件中的漏洞。
...
<tr class="header">
<th>受影响的软件</th>
<th>SMB 客户端池损坏漏洞 - CVE-2010-0016</th>
<th>SMB 客户端竞争状态漏洞 - CVE-2010-0017</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
SMB 客户端池损坏漏洞 - CVE-2010-0016  
------------------------------------
  
   
Microsoft 服务器消息块 (SMB) 协议软件处理特制 SMB 响应的方式中存在一个未经身份验证的远程执行代码漏洞。 利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过将特制的 SMB 响应发送到客户端发起的 SMB 请求来利用该漏洞。 成功利用此漏洞的攻击者可以完全控制系统。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0016](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0016)。
  
#### SMB 客户端池损坏漏洞 (CVE-2010-0016) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   这是一个 SMB 客户端漏洞。 要利用此漏洞，攻击者必须诱使用户建立与恶意 SMB 服务器的 SMB 连接。 采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。 在这种情况下，应阻止从 Internet 访问 SMB 端口。
  
#### SMB 客户端池损坏漏洞 (CVE-2010-0016) 的变通办法
...
#### SMB 客户端池损坏漏洞 (CVE-2010-0016) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
此漏洞是由于 Microsoft 服务器消息块 (SMB) 客户端实施未正确验证 SMB 响应中的字段造成的。 这可能会导致池损坏问题，从而以系统级特权执行代码。
  
**什么是 Microsoft 服务器消息块 (SMB) 协议？ **  
Microsoft 服务器消息块 (SMB) 协议是 Microsoft Windows 中使用的一项 Microsoft 网络文件共享协议。 有关 SMB 的详细信息，请参阅 [Microsoft SMB 协议和 CIFS 协议概述](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以完全控制受影响的系统。 利用此漏洞的大多数尝试将导致受影响的系统停止响应和重新启动。
  
**攻击者如何利用此漏洞？**    
攻击者可能拥有一台旨在利用此漏洞的恶意 SMB 服务器，然后诱使用户建立 SMB 连接。 此外，本地网络上的攻击者可能会执行人为干预的攻击，以使用格式错误的 SMB 响应来响应合法的 SMB 请求。
  
**受此漏洞威胁最大的系统有哪些？**    
对所有受影响的操作系统都构成威胁。
  
**是否能够使用 Internet Explorer 利用此漏洞？**    
否。 然而，无论浏览器类型如何，都可能通过 Web 事务利用此漏洞。 在基于 Web 的攻击情形中，攻击者必须制造包含特造 URI 的网页。 浏览该网站的用户将使系统与攻击者控制的 SMB 服务器建立 SMB 连接，然后将格式错误的响应发回给用户。 此响应将导致在用户的系统执行代码。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问特制的网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
...
SMB 客户端竞争状态漏洞 - CVE-2010-0017  
--------------------------------------
  
   
Microsoft 服务器消息块 (SMB) 协议软件处理特制 SMB 数据包的方式中存在一个未经身份验证的远程执行代码漏洞。 利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过将特制的 SMB 响应发送到客户端发起的 SMB 请求来利用该漏洞。 成功利用此漏洞的攻击者可以完全控制系统。
  
在 Windows Vista 和 Windows Server 2008 上，此漏洞可能会由于 Microsoft 服务器消息块 (SMB) 协议软件处理特制的 SMB 协商响应而导致特权提升漏洞。 成功利用此漏洞的攻击者可以使用系统级特权运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 攻击者必须拥有有效的登录凭据并能本地登录才能以此方式提升特权。
  
此漏洞也可能会导致拒绝服务。 以此方式利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过将特制的 SMB 响应发送到客户端发起的 SMB 请求来利用该漏洞。 成功利用此漏洞的攻击者可能会导致计算机停止响应，直至重新启动。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0017](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0017)。
  
#### SMB 客户端竞争状态漏洞 (CVE-2010-0017) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   要在 Windows Vista 和 Windows Server 2008 上提升特权，攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 这些平台上的特权提升漏洞不能以远程方式利用或被匿名用户利用。 采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。
  
#### SMB 客户端竞争状态漏洞 (CVE-2010-0017) 的变通办法
...
#### SMB 客户端竞争状态漏洞 (CVE-2010-0017) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
在 Windows 7 和 Windows Server 2008 R2 上，这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
在 Windows Vista 和 Windows Server 2008 上，这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
对于所有受影响的平台，此漏洞也可能会导致拒绝服务。 在这种情况下，利用此漏洞的攻击者可能会导致受影响系统停止响应，直至其被手动重新启动。 请注意，虽然攻击者无法利用拒绝服务漏洞来执行代码或提升他们的用户权限，但此漏洞可能导致受影响的系统停止接受请求。
  
**造成漏洞的原因是什么？**    
此漏洞是由于 Microsoft 服务器消息块 (SMB) 客户端实施未正确处理在处理协商响应时可能发生的竞争状态导致的。
  
**什么是 Microsoft 服务器消息块 (SMB) 协议？ **  
Microsoft 服务器消息块 (SMB) 协议是 Microsoft Windows 中使用的一项 Microsoft 网络文件共享协议。 有关 SMB 的详细信息，请参阅 [Microsoft SMB 协议和 CIFS 协议概述](https://msdn.microsoft.com/en-us/library/aa365233(vs.85).aspx)。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以完全控制受影响的系统。 在 Windows Vista 和 Windows Server 2008 上，成功利用此漏洞的攻击者可以使用系统级特权运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
成功利用此导致拒绝服务的漏洞的攻击者可能导致用户的系统停止响应,直至被手动重新启动。
  
**攻击者如何利用此漏洞？**    
要利用此漏洞以导致远程执行代码或拒绝服务，攻击者可能拥有一台旨在利用此漏洞的恶意 SMB 服务器，然后诱使用户建立 SMB 连接。 此外，本地网络上的攻击者可能会执行人为干预的攻击，以使用格式错误的 SMB 响应来响应合法的 SMB 请求。
  
要利用此漏洞提升特权，攻击者必须先登录到系统。 然后，攻击者可以运行一个为利用此漏洞而特制的应用程序，从而完全控制受影响的系统。
...
**此更新有什么作用？**    
此更新通过更正 SMB 客户端处理在处理 SMB 协商响应时可能发生的竞争状态的方式来解决该漏洞。
...
| **部署**                         |                                                                                                                       |  
| 没有用户干预的安装               | Windows2000-KB978251-x86-enu /quiet                                                                                   |  
| 在不重新启动的情况下安装         | Windows2000-KB978251-x86-enu /norestart                                                                               |  
| 更新日志文件                     | KB978251.log                                                                                                          |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节                                                                                  |  
| **重新启动要求**                 |                                                                                                                       |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                                |  
| HotPatching                      | 不适用                                                                                                                |  
| **删除信息**                     | 使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB978251$\\Spuninst 文件夹中的 Spuninst.exe 实用程序 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 978251](https://support.microsoft.com/kb/978251)                                          |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB978251\\Filelist                             |
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB978251$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/978251">Microsoft 知识库文章 978251</a></td>
</tr>  
<tr class="even">
...
-   [stratsec](https://www.stratsec.net/) 的 Laurent Gaffié 报告了 SMB 客户端池损坏漏洞 (CVE-2010-0016) 和 SMB 客户端竞争状态漏洞 (CVE-2010-0017)

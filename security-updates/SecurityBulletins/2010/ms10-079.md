...
**已知问题。** [Microsoft 知识库文章 2293194](https://support.microsoft.com/kb/2293194) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;">
[MS10-056](https://go.microsoft.com/fwlink/?linkid=196938)
</td>
</tr>
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=8fb56eb9-9601-4c1e-905a-9fe4802b2c8d">Microsoft Office Web Apps</a>[2]<br />
(KB2346411)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=13b24264-ec3d-44e8-81e3-82ac767defd3">Microsoft Word Web App</a>[2]<br />
(KB2345015)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
Microsoft Word Web App 是 Microsoft Office Web Apps 的组成部分，用于在 Microsoft SharePoint Server 2010 上配置 Office Web Apps 的组织。Word Web App 将 Microsoft Word 体验延伸到了 Web 浏览器中，供用户在存储文档的网站上直接编辑文档。 有关 Word Web App 的详细信息，请参阅[Word Web App 简介](https://office.microsoft.com/en-us/web-apps-help/introduction-to-word-web-app-ha010378341.aspx)。
  
**Microsoft Office Web Apps** **的更新应用在何处？**  
已在 SharePoint 环境中部署 Microsoft Office Web Apps 的客户将需要在安装这些组件的服务器上应用 Microsoft Office Web Apps 的更新。 有关部署 Microsoft Web Apps 的详细信息，请参阅 Microsoft TechNet 文章“[了解 Office Web Apps](https://technet.microsoft.com/en-us/library/ff431685.aspx)”。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2747](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2747)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2748](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2748)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2750](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2750)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3214](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3214)。
...
-   **使用** **Microsoft Office** **文件阻止策略禁止打开来自未知或不可信来源和位置的** **Office 2003** **以及较早版本的文档**
    ...
    **变通办法的影响。** 对于 Microsoft Office 2003 和 Microsoft Office 2007，配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](https://support.microsoft.com/kb/922848) 所述配置特殊“例外目录”的用户将无法打开 Office 2003 文件或更早版本。 对于 Microsoft Office 2007、Office 2003 或更早版本，将会是阻止打开或在受保护的模式中打开这两种选择，具体取决于所选择的打开行为。
...
-   **当打开来自未知来源或不可信来源的文件时使用** **Microsoft Office Isolated Conversion Environment (MOICE)**
    ...
    **注意** 要使用自动化 **Microsoft Fix it** 解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 935865](https://support.microsoft.com/kb/935865)。
    ...
    <thead>
    <tr class="header">
    <th style="border:1px solid black;">使 MOICE 成为注册的处理程序的命令</th>
    </tr>
    </thead>
    <tbody>
    <tr class="odd">
  ...
  **如何撤消变通方法。** 根据下表指示，运行命令以禁用 MOICE。
  ...
  <thead>
  <tr class="header">
  <th style="border:1px solid black;">禁止 MOICE 充当注册的处理程序的命令</th>
  </tr>
  </thead>
  <tbody>
  <tr class="odd">
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3215](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3215)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3216](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3216)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3217)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3218](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3218)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3219](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3219)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3220](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3220)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3221](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3221)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2328360">Microsoft 知识库文章 2328360</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2344911">Microsoft 知识库文章 2344911</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Word 2007，请参阅 <a href="https://support.microsoft.com/kb/2344993">Microsoft 知识库文章 2344993</a><br />
<br />
对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包，请参阅 <a href="https://support.microsoft.com/kb/2345043">Microsoft 知识库文章 2345043</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Office 2010，请参阅 <a href="https://support.microsoft.com/kb/2345000">Microsoft 知识库文章 2345000</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Word Web App，请参阅 <a href="https://support.microsoft.com/kb/2345015">Microsoft 知识库文章 2345015</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office Web Apps，请参阅 <a href="https://support.microsoft.com/kb/2346411">Microsoft 知识库文章 2346411</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=464965fa-971a-49dd-bcee-c4d91fac86a9)下载和安装 Microsoft Office 2004 for Mac 11.6.1 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=abd05074-8ffc-41a4-a2f3-1d8047574552)下载和安装 Microsoft Office 2008 for Mac 12.2.7 Update 的合适语言版本。
...
从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?familyid=5c759c46-ead3-44ea-b7c8-a308b3140d2e)下载和安装 Open XML File Format Converter for Mac 1.1.7 Update 的合适语言版本。
...
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 未初始化的指针漏洞 (CVE-2010-2747)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 边界检查漏洞 (CVE-2010-2748)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 索引漏洞 (CVE-2010-2750)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 Word 堆栈溢出漏洞 (CVE-2010-3214)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 返回值漏洞 (CVE-2010-3215)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 书签漏洞 (CVE-2010-3216)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 指针漏洞 (CVE-2010-3217)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 堆溢出漏洞 (CVE-2010-3218)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 索引分析漏洞 (CVE-2010-3219)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 分析漏洞 (CVE-2010-3220)  
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Chaouki Bekrar 报告了 Word 分析漏洞 (CVE-2010-3221)

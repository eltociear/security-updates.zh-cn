...
**已知问题。** [Microsoft 知识库文章 968095](https://support.microsoft.com/kb/968095) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
使用 Microsoft Office XP 和 Microsoft Office 2003 的客户也需要安装 [MS10-087](https://go.microsoft.com/fwlink/?linkid=203241)中提供的 Microsoft Office 更新，Microsoft Office 中的漏洞可能允许远程执行代码 (2423930) 以免受此公告 (MS10-105) 中所述的漏洞影响。 MS10-087 和 MS10-105 更新都需要安装，但是客户不必以任何特定顺序安装这些更新。
...
是。 此更新包括对覆盖 Microsoft Office 2007 和 Microsoft Office 2010 中默认阻止的转换器和筛选器列表提供支持的非安全更改。有关 Microsoft Office 图形筛选器安全设置的详细信息，请参阅 [Microsoft 知识库文章 2479871](https://support.microsoft.com/kb/2479871)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3945](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3945)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3946](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3946)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3947](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3947)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3949](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3949)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3950](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3950)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3951](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3951)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3952](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3952)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2289162">Microsoft 知识库文章 2289162</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2289163">Microsoft 知识库文章 2289163</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2288931">Microsoft 知识库文章 2288931</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2289078">Microsoft 知识库文章 2289078</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2456849">Microsoft 知识库文章 2456849</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2431831">Microsoft 知识库文章 2431831</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了 CGM 图像转换器缓冲区溢出漏洞 (CVE-2010-3945)  
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了 PICT 图像转换器整数溢出漏洞 (CVE-2010-3946)  
-   [Secunia Research](https://secunia.com/) 的 Alin Rad Pop 报告了 PICT 图像转换器整数溢出漏洞 (CVE-2010-3946)  
-   [Secunia Research](https://secunia.com/) 的 Carsten Eiram 报告了 TIFF 图像转换器堆溢出漏洞 (CVE-2010-3947)  
-   [Secunia Research](https://secunia.com/) 的 Carsten Eiram 报告了 TIFF 图像转换器缓冲区溢出漏洞 (CVE-2010-3949)  
-   [Secunia Research](https://secunia.com/) 的 Carsten Eiram 报告了 TIFF 图像转换器内存损坏漏洞 (CVE-2010-3950)  
-   [Secunia Research](https://secunia.com/) 的 Dyon Balding 报告了 FlashPix 图像转换器缓冲区溢出漏洞 (CVE-2010-3951)  
-   [Secunia Research](https://secunia.com/) 的 Dyon Balding 报告了 FlashPix 图像转换器堆损坏漏洞 (CVE-2010-3952)

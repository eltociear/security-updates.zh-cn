---
TOCTitle: 'MS10-029'
Title: 'Microsoft 安全公告 MS10-029 - 警告'
ms:assetid: 'ms10-029'
ms:contentKeyID: 61237868
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-029(v=Security.10)'
---

Microsoft 安全公告 MS10-029 - 警告
==================================
...
此安全更新解决 Microsoft Windows 中一个秘密报告的漏洞。 对于 Windows XP、Windows Server 2003、Windows Vista 和 Windows Server 2008，此安全更新的等级为“中等”。由于 Windows 7 和 Windows Server 2008 R2 包含由此安全更新部署的功能，所以这些操作系统不容易受到攻击。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613)                                                          | 欺骗         | 中等         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f)                                                              | 欺骗         | 中等         | 无               |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477)                                                                              | 欺骗         | 中等         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb)                                                                  | 欺骗         | 中等         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d)                                                              | 欺骗         | 中等         | 无               |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176)                                     | 欺骗         | 中等         | 无               |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36) | 欺骗         | 中等         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be)\*                   | 欺骗         | 中等         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84)\*         | 欺骗         | 中等         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842)   | 欺骗         | 中等         | 无               |

**\*服务器核心安装受到影响。** 此更新适用于所示 Windows Server 2008 的受支持版本（无论是否使用“服务器核心”安装选项进行安装），严重等级相同。 有关该安装选项的详细信息，请参阅 MSDN 文章，[服务器核心](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)。 注意，“服务器核心”安装选项不适用于某些 Windows Server 2008 版本；请参阅[比较“服务器核心”安装选项](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)。
...
-   **ISATAP 客户端上的潜在路由器列表 (PRL)：** PRL 使客户能够对传入的 ISATAP 隧道传输数据包执行源地址检查。 默认情况下，一旦安装此安全更新，PRL 就处于启用状态，可帮助解决 CVE-2010-0812 中描述的 ISATAP IPv6 源地址欺骗漏洞。有关 PRL 的详细信息，您可以在 [Microsoft 知识库文章 978338](https://support.microsoft.com/kb/978338) 中找到。
-   **ISATAP 接口上的邻居不可达检测 (NUD)：** NUD 用于验证是否可以到达附近的设备。 在发送 ISATAP 数据包之前，ISATAP 节点会执行 NUD。 默认情况下，NUD 处于禁用状态，需要由网络管理员手动配置。 有关 NUD 和如何启用它的详细信息，您可以在 [Microsoft 知识库文章 978338](https://support.microsoft.com/kb/978338) 中找到。

**为什么 Microsoft Windows 2000 不受此漏洞的影响？**  
Microsoft Windows 2000 未包含对 IPv6 的支持，因此这个操作系统不容易受到攻击。

**为什么 Windows 7 和 Windows Server 2008 R2 不受此漏洞的影响？**  
Windows 7 和 Windows Server 2008 R2 中已经存在此安全更新、潜在路由器列表 (PRL) 和邻居不可达检测 (NUD) 部署的功能。

**注意** 默认情况下，虽然 PRL 在这些平台上已启用，但 NUD 仍处于禁用状态，它必须由网络管理员手动配置。 有关此功能的其他信息，请查阅 [Microsoft 知识库文章 978338](https://support.microsoft.com/kb/978338)。

**即使我没有启用 IPv6，仍然可获得此更新吗？**  
是的，由于这些系统上存在容易受到攻击的代码，所以将通过自动更新提供此安全更新。 如果客户准备将来部署 IPv6，我们建议客户安装安全更新。
...
<tr class="header">
<th>受影响的软件</th>
<th>ISATAP IPv6 源地址欺骗漏洞 - CVE-2010-0812</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
**\*服务器核心安装受到影响。** 此更新适用于 Windows Server 2008 的受支持版本（无论是否使用“服务器核心”安装选项进行安装），严重等级相同。 有关该安装选项的详细信息，请参阅 MSDN 文章，[服务器核心](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)。 注意，“服务器核心”安装选项不适用于某些 Windows Server 2008 版本；请参阅[比较“服务器核心”安装选项](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)。
  
ISATAP IPv6 源地址欺骗漏洞 - CVE-2010-0812  
------------------------------------------
  
   
Microsoft Windows IPv6 堆栈中存在由于 Windows 检查经过隧道传输的 ISATAP 数据包中内部数据包的 IPv6 源地址的方式而产生的欺骗漏洞。 成功利用此漏洞的攻击者可以模拟地址以绕过边缘或主机防火墙。 此外，当目标计算机使用攻击者指定的源 IPv6 地址应答消息时，信息可能会泄露。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0812](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812)。
  
#### ISATAP IPv6 源地址欺骗漏洞 (CVE-2010-0812) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   此漏洞仅影响配置了 ISATAP 接口的 Windows 系统。
  
#### ISATAP IPv6 源地址欺骗漏洞 (CVE-2010-0812) 的变通办法
...
-   **禁用 ISATAP IPv6 接口**
    ...
    要禁用 ISATAP IPv6 接口，请通过提升的命令提示符运行下列命令：
    ...
    **变通办法的影响。** 禁用 ISATAP 接口将阻止系统使用 ISATAP 作为 IPv6 隧道机制。
  
    **如何撤消变通方法。**
  
    要重新启用 ISATAP IPv6 接口，请通过提升的命令提示符运行下列命令：
...
#### ISATAP IPv6 源地址欺骗漏洞 (CVE-2010-0812) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是欺骗漏洞。 此漏洞可能允许攻击者欺骗 IPv4 地址，以便绕过依赖源 IPv4 地址的筛选设备。
  
**造成漏洞的原因是什么？**    
漏洞存在的原因是 Windows TCP/IP 堆栈未正确检查经过隧道传输的 ISATAP 数据包中的源 IPv6 地址。
  
**什么是 ISATAP？**    
站内自动隧道寻址协议 (ISATAP) 提供 IPv4 Intranet 内的 IPv6 连接。 有关 ISATAP 的信息，请参阅 [RFC5214： 站内自动隧道寻址协议 (ISATAP)](https://www.ietf.org/rfc/rfc5214.txt)，ISATAP 协议定义为协议类型 41。
  
**攻击者可能利用此漏洞执行什么操作？**    
攻击者可模拟允许绕过源地址筛选器（例如，边缘或主机防火墙）的另一用户或系统。
  
**攻击者如何利用此漏洞？**    
通过使用 ISATAP 连接中与相应 IPv4 源地址不匹配的特制 IPv6 源地址创建特制的网络数据包，攻击者可以尝试利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**    
所有启用 IPv6 ISATAP 功能的操作系统均受此漏洞威胁。
  
**此更新有什么作用？**    
通过更改 Windows TCP/IP 堆栈检查经过隧道传输的 ISATAP 数据包中的源 IPv6 地址的方式，此更新解决了该漏洞。
...
<td style="border:1px solid black;">使用控制面板中的<strong>添加或删除程序</strong>工具或 %Windir%\\$NTUninstallKB978338$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/978338">Microsoft 知识库文章 978338</a></td>
</tr>  
<tr class="even">
...
National EW Research & Simulation Center（隶属于 Rafael 公司）的 Gabi Nakibly 报告了 ISATAP IPv6 源地址欺骗漏洞 (CVE-2010-0812)

...
此安全更新也解决了最初在 [Microsoft 安全通报 980088](https://technet.microsoft.com/security/advisory/980088) 中描述的漏洞。
...
<sup>[1]</sup>严重等级不适用于此更新，因为此公告中讨论的漏洞不影响此软件。然而，提供此更新以解决 [MS09-054](https://go.microsoft.com/fwlink/?linkid=163979) 产生的回归问题。有关详细信息，请参阅“**与此安全更新相关的常见问题 (FAQ)**”中的“此更新是否包含任何其他与安全性无关的功能更改？”。

与此安全更新相关的常见问题 (FAQ)
--------------------------------

 
**此安全更新与** [**MS10-039**](https://go.microsoft.com/fwlink/?linkid=191905)**有什么联系？**  
此安全公告中描述的 toStaticHTML 信息泄露漏洞 [CVE-2010-1257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257) 也影响 Microsoft SharePoint。但您只能安装与您的系统上安装的软件对应的更新。如果您已安装 Internet Explorer，请根据此公告应用所需更新。如果您已安装 Microsoft SharePoint，请根据 [MS10-039](https://go.microsoft.com/fwlink/?linkid=191905) 应用所需更新。
...
此更新提供给 Microsoft Windows 2000 Service Pack 4 上的 Internet Explorer 5.01 Service Pack 4 的客户以解决 [MS09-054](https://go.microsoft.com/fwlink/?linkid=163979) 产生的回归问题，其中在下载操作时，下载对话框在服务器发送具有附加字节的压缩数据时可能变得响应迟缓。Microsoft 建议此软件的所有客户应用此安全更新，甚至没有遇到回归问题的客户也这样做，以防止他们的系统上产生回归问题。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0255](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0255)。
...
-   **使用自动 Microsoft Fix it 为文件协议启用网络协议锁定**
    ...
    要使用自动 Microsoft **Fix it** 解决方案启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 980088](https://support.microsoft.com/kb/980088)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0255](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0255)。此漏洞最初是在 [Microsoft 安全通报 980088](https://technet.microsoft.com/security/advisory/980088) 中介绍的。

**我已部署** [**Microsoft 安全通报 980088**](https://technet.microsoft.com/security/advisory/980088)**中的变通办法为文件协议启用网络协议锁定。在安装此安全更新之前是否需要禁用此变通办法？**  
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257)。
...
toStaticHTML API 可用于在将用户输入显示为 HTML 之前从中删除事件属性和脚本。有关详细信息，请参阅下列 MSDN 库文章 [toStaticHTML 方法](https://msdn.microsoft.com/en-us/library/cc848922(vs.85).aspx)。
...
**此漏洞是否与** [**MS10-039**](https://go.microsoft.com/fwlink/?linkid=191905) **中的 CVE-2010-1257“Microsoft SharePoint 中的漏洞可能允许特权提升 (2028554)”有关？**  
是的，toStaticHTML 信息泄露漏洞 [CVE-2010-1257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257) 也影响 Microsoft SharePoint。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1259](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1259)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1260](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1260)。
...
Internet Explorer 7 开发工具已更新，以避免此问题。可从 Microsoft 下载中心 [Internet Explorer 开发工具栏](https://www.microsoft.com/download/details.aspx?familyid=e59c3964-672d-4511-bb3e-2d5e1db91038&displaylang=en)获得更新的工具栏。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1261](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1261)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1262](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1262)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/982381">Microsoft 知识库文章 982381</a></td>
</tr>  
<tr class="even">
...
-   [Casaba Security](https://www.casabasecurity.com/) 的 Chris Weber 报告了 toStaticHTML 信息泄露漏洞 (CVE-2010-1257)  
-   [Mitsui Bussan Secure Directions, Inc.](https://www.mbsd.jp/) 的 Takeshi Terada 报告了 toStaticHTML 信息泄露漏洞 (CVE-2010-1257)  
-   [Google Inc.](https://www.google.com/) 的 Michal Zalewski 报告了未初始化的内存损坏漏洞 (CVE-2010-1259)  
-   [Matasano Security](https://www.matasano.com/) 的 Chris Rohlf 报告了 HTML 元素内存损坏漏洞 (CVE-2010-1260)  
-   [Matasano Security](https://www.matasano.com/) 的 Chris Rohlf 报告了未初始化的内存损坏漏洞 (CVE-2010-1261)  
-   Peter Vreugdenhil 与 [TippingPoint 的](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了内存损坏漏洞 (CVE-2010-1262)

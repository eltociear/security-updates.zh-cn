...
**已知问题。** [Microsoft 知识库文章 982335](https://support.microsoft.com/kb/982335) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=93768ac6-e6d7-4175-a6e3-666210494678">Microsoft Office Access 2003 Service Pack 3</a><br />
(KB981716)</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=af2862e2-da37-4cbe-8974-e517eb666f14">Microsoft Office Access 2007 Service Pack 1 和 Microsoft Office Access 2007 Service Pack 2</a><br />
（KB979440）</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
以下严重等级假设漏洞的可能的最大影响。 有关此安全公告发布 30 天内，漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [7 月份公告摘要](https://technet.microsoft.com/security/bulletin/ms10-jul)中的利用指数。 有关详细信息，请参阅 [Microsoft 利用指数](https://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目的形式查看此漏洞，请参阅 [CVE-2010-0814](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0814)。
...
要在“常见漏洞和披露”列表中以标准条目的形式查看此漏洞，请参阅 [CVE-2010-1881](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1881)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/981716">Microsoft 知识库文章 981716</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979440">Microsoft 知识库文章 979440</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   一名与 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作的匿名研究人员，报告了Access ActiveX 控件漏洞 (CVE-2010-0814)  
-   [IBM ISS X-Force](https://www.iss.net/) 的 Robert Freeman，报告了 ACCWIZ.dll 未初始化的变量漏洞 (CVE-2010-1881)

...
此安全更新解决了最初在 [Microsoft 安全通报 981169](https://technet.microsoft.com/security/advisory/981169) 中描述的漏洞。
...
**已知问题。** [Microsoft 知识库文章 981169](https://support.microsoft.com/kb/981169) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
系统上的 VBScript 版本由 Internet Explorer、Windows 操作系统或系统上安装的 Windows Scripting Host 包含的最高版本决定，如果您安装更高版本的 Microsoft Internet Explorer、Windows Service Pack 或 Windows Scripting Host，则它可能会发生变化。 有关详细信息，请参阅 MSDN 文章 [VBScript 版本信息](https://msdn.microsoft.com/en-us/library/4y5y7bh5(vs.85).aspx)。
...
是的，安全更新 KB981350 适用于您的系统，它会将您的 VBScript 版本升级至 VBScript 5.6。有关此更新的详细信息，请参阅 [Microsoft 知识库文章 981350](https://support.microsoft.com/kb/981350)。
...
如果已应用 [Microsoft 安全通报 981169](https://technet.microsoft.com/security/advisory/981169) 中提供的变通办法，您不需要在安装此更新之前将其撤消。 如果要撤消变通办法，最好在安装更新之后执行此操作，这样做较为安全。 该通报使用此公告中建议的变通办法。 请查看**变通办法的影响**的相应信息，以了解有关保留变通办法将发生的事情的详情。
...
-   默认情况下，Windows Server 2003 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的受限模式下运行。 此模式将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。
...
**什么是不安全的文件类型？**  
Microsoft 使用“不安全的文件类型”的概念来帮助更好地保护用户，防止其访问攻击者可能在此类文件中嵌入的可执行内容。 有关详细信息，请参阅白皮书 Understanding Executable Content in Microsoft Products（了解 Microsoft 产品中的可执行内容）以及 [Microsoft 知识库文章 291369](https://support.microsoft.com/kb/291369)。
...
默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的可缓解此漏洞的受限模式下运行。 增强安全配置是一组预先配置好的 Internet Explorer 设置，可以减小用户或管理员在服务器上下载并运行特制 Web 内容的可能性。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 另请参阅[管理 Internet Explorer 增强安全配置](https://go.microsoft.com/fwlink/?linkid=92055)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0483](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0483)。此漏洞是在 [Microsoft 安全通报 981169](https://technet.microsoft.com/security/advisory/981169) 中介绍的。
...
<p>为了降低被迫重新启动的机率，请首先停止所有受影响的服务并且关闭所有可能使用受影响的文件的应用程序，然后安装安全更新。 有关可能提示您重新启动的原因的详细信息，请参阅 <a href="https://support.microsoft.com/?id=887012">Microsoft 知识库文章 887012</a>。</p></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">对于 VBScript 5.1 和 VBScript 5.6，请参阅 <a href="https://support.microsoft.com/kb/981350">Microsoft 知识库文章 981350</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 VBScript 5.7，请参阅 <a href="https://support.microsoft.com/kb/981349">Microsoft 知识库文章 981349</a></td>
</tr>  
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 VBScript 5.6，请参阅 <a href="https://support.microsoft.com/kb/981350">Microsoft 知识库文章 981350</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 VBScript 5.7，请参阅 <a href="https://support.microsoft.com/kb/981349">Microsoft 知识库文章 981349</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 VBScript 5.8，请参阅 <a href="https://support.microsoft.com/kb/981332">Microsoft 知识库文章 981332</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Windows XP Service Pack 2 上的 VBScript 5.6：<br />

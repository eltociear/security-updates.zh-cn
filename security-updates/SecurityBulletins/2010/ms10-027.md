...
|---------------------------------------|------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4 | [Windows Media Player 9 系列](https://www.microsoft.com/download/details.aspx?familyid=c0b8b362-a321-4ac9-be98-15c71bb7a043) | 远程执行代码 | 严重         | [MS07-047](https://go.microsoft.com/fwlink/?linkid=88628) |
| Windows XP Service Pack 2             | [Windows Media Player 9 系列](https://www.microsoft.com/download/details.aspx?familyid=5c748c6d-84d1-45a9-8a33-9372eb5504d5) | 远程执行代码 | 严重         | [MS07-047](https://go.microsoft.com/fwlink/?linkid=88628) |
| Windows XP Service Pack 3             | [Windows Media Player 9 系列](https://www.microsoft.com/download/details.aspx?familyid=9e4277b4-2dc5-4163-a6aa-7e07dd32b721) | 远程执行代码 | 严重         | 无                                                       |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0268](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0268)。
...
有关如何确定系统上的 Windows Media Player 的版本的说明，请参阅 [Microsoft 知识库文章](https://support.microsoft.com/kb/190990) 190990。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/979402">Microsoft 知识库文章 979402</a></td>
</tr>  
<tr class="even">
...
-   一位匿名研究人员与 [TippingPoint 的](https://www.tippingpoint.com/) [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了媒体播放器远程执行代码漏洞 (CVE-2010-0268)

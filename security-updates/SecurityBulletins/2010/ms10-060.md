...
**已知问题。** [Microsoft 知识库文章 2265906](https://support.microsoft.com/kb/2265906) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要运行 Silverlight 应用程序，大多数 Web 浏览器（包括 Microsoft Internet Explorer）需要安装 Silverlight 并启用相应的插件。 有关 Silverlight 的详细信息，请参阅 [Microsoft Silverlight](https://www.microsoft.com/silverlight/) 官方网站。 请参阅浏览器的文档，更多了解如何禁用或删除插件。
...
如果您的计算机上已安装 Silverlight，您可以访问[获取 Microsoft Silverlight](https://www.microsoft.com/silverlight/get-started/install/) 页面，它将指明您的系统上当前安装的 Silverlight 版本和内部版本。 或者，您也可以使用当前版本的 Microsoft Internet Explorer 的“管理加载项”功能确定当前安装的版本和内部版本信息。
...
Silverlight 自动更新功能帮助确保 Silverlight 安装在 Silverlight 最新版本、Silverlight 功能性和安全功能方面保持最新。 有关 Silverlight 自动更新功能的详细信息，请参阅 [Microsoft Silverlight Updater](https://www.microsoft.com/getsilverlight/resources/documentation/updater.aspx)。 禁用了 Silverlight 自动更新功能的客户可以在 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747) 中注册以获取 Silverlight 的最新版本，或者使用上一节“**受影响和不受影响的软件**”的“受影响的软件”表中的下载链接手动下载 Silverlight 的最新版本。 有关在企业环境中部署 Silverlight 的信息，请参阅 [Silverlight 企业部署指南](https://go.microsoft.com/fwlink/?linkid=119611)。

**此更新是否包含任何其他与安全性无关的功能更改？**  
有关 Silverlight 当前版本中包括的与安全性无关的更改的详细信息，请参阅 [Microsoft Silverlight 版本历史记录](https://go.microsoft.com/fwlink/?linkid=92598)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0019)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1898](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1898)。
...
-   Microsoft Silverlight 的当前版本 Silverlight 4 不受此漏洞影响。 默认情况下，Silverlight 将定期在 Microsoft 网站让检查更新，为您提供最新的功能和改进。 如果有较新的版本，将下载并安装到您的计算机上。 大多数系统已在运行 Silverlight 4 的版本。有关详细信息，请参阅 [Microsoft Silverlight Updater](https://www.microsoft.com/silverlight/resources/documentation/updater.aspx)。
...
-   **升级到 Microsoft Silverlight 的最新版本**
    ...
    Silverlight 4 并不受此漏洞的影响。 客户可升级到 Silverlight 的最新版本，而不是安装 Silverlight 安全更新。 有关详细信息，请参阅 [Microsoft Silverlight](https://www.microsoft.com/silverlight/)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2265906">Microsoft 知识库文章 2265906</a></td>
</tr>  
<tr class="odd">
...
-   [Eamon Nerbonne](https://eamon.nerbonne.org) 报告了 Microsoft Silverlight 和 Microsoft .NET Framework CLR 虚拟方法委派漏洞 (CVE-2010-1898)

...
**已知问题。** [Microsoft 知识库文章 981997](https://support.microsoft.com/kb/981997) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=183077">MS10-016</a></td>
</tr>  
<tr class="even">
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2564](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2564)。
...
-   **删除 Movie Maker .MSWMM 文件关联**
    ...
    **注意** 要使用自动化 **Microsoft Fix it** 解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 981997](https://support.microsoft.com/kb/981997)。 此修复解决方案部署变通办法，因此具有相同的用户影响。 我们建议管理员在部署此修复解决方案之前仔细阅读知识库文章。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/981997">Microsoft 知识库文章 981997</a></td>
</tr>  
<tr class="even">
...
-   [Secunia](https://secunia.com/) 的 Dyon Balding 报告了 Movie Maker 内存损坏漏洞 (CVE-2010-2564)

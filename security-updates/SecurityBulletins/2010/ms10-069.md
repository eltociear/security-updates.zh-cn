---
TOCTitle: 'MS10-069'
Title: 'Microsoft 安全公告 MS10-069 - 重要'
ms:assetid: 'ms10-069'
ms:contentKeyID: 61237908
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-069(v=Security.10)'
---



Microsoft 安全公告 MS10-069 - 重要
==================================

Windows 客户端/服务器运行时子系统中的漏洞可能允许特权提升 (2121546)
-------------------------------------------------------------------
...
此安全更新通过更正客户端/服务器运行时子系统 (CSRSS) 在处理某些事务时分配内存的方式来解决此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=20091358-7127-4ace-bf96-4319461ad305)                          | 特权提升     | 重要         | 无                                                       |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=107eb958-b60f-40ae-a785-5d5b4d13d8c6) | 特权提升     | 重要         | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=fd46ba66-8ca1-4aa2-b91b-9e5861a173f7)                 | 特权提升     | 重要         | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=ff5976e0-579c-4e6e-a225-c0d3913cdc85)     | 特权提升     | 重要         | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=e450ca08-1d75-4419-ad9f-c5e5efb55cd5) | 特权提升     | 重要         | [MS07-021](https://go.microsoft.com/fwlink/?linkid=80251) |
...
**我现在使用的不是中文、日文或韩文版本的 Windows。 此安全公告对我适用吗？**
受影响的操作系统的所有语言版本均包含此公告中解决的漏洞，但是如果该系统未配置中文、日文或韩文系统区域设置，此漏洞不可利用。
...
<th style="border:1px solid black;">CSRSS 本地特权提升漏洞 - CVE-2010-1891</th>
...
CSRSS 本地特权提升漏洞 - CVE-2010-1891  
--------------------------------------
  
  
由于 CSRSS 为特定用户交易分配内存的方式，因此在 Windows CSRSS 中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以在本地系统的安全上下文中运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1891](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1891)。
  
#### CSRSS 本地特权提升漏洞 (CVE-2010-1891) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   只有配置有中文、日文或韩文系统区域设置的系统才会受到影响。  
-   攻击者必须拥有有效的登录凭据并能本地或远程登录才能利用此漏洞。
  
#### CSRSS 本地特权提升漏洞 (CVE-2010-1891) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### CSRSS 本地特权提升漏洞 (CVE-2010-1891) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**  
Windows CSRSS 在处理配置有中文、日文或韩文系统区域设置的 Windows 系统上的特定用户交易时，并不总是能分配足够的内存。
...
**受此漏洞威胁最大的系统有哪些？**  
使用多字节语言（中文、日文或韩文）系统区域设置运行的工作站和终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。
...
**此更新有什么作用？**      
此更新通过更正 CSRSS 在处理某些事务时分配内存的方式来解决此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2121546$\Spuninst folder 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2121546">Microsoft 知识库文章 2121546</a></td>
</tr>  
<tr class="even">
...
-   [IBM 日本](https://www.ibm.com/jp/ja/)报告了 CSRSS 本地特权提升漏洞 - CVE-2010-1891

---
TOCTitle: 'MS10-091'
Title: 'Microsoft 安全公告 MS10-091 - 严重'
ms:assetid: 'ms10-091'
ms:contentKeyID: 61237930
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-091(v=Security.10)'
---



Microsoft 安全公告 MS10-091 - 严重
==================================

OpenType 字体 (OTF) 驱动程序中的漏洞可能允许远程执行代码 (2296199)
------------------------------------------------------------------
...
对于 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“严重”。对于 Windows XP 和 Windows Server 2003 的所有受支持版本，此安全更新的等级也为“重要”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过更正 OpenType 字体 (OTF) 驱动程序在分析 OpenType 字体时索引数组，释放内存时重置指针，以及呈现 OpenType 字体时分析 CMAP 表的方式来解决这些漏洞。 有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=cdef3358-ad3e-40a6-9ba5-3be220a56a65)                                                                                     | 特权提升     | 重要         | [MS10-078](https://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=070fef8e-ba09-40f4-abaa-9cebf08983c3)                                                            | 特权提升     | 重要         | [MS10-078](https://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9b70334c-490d-446c-988a-a88a75595fd4)                                                                            | 特权提升     | 重要         | [MS10-078](https://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=08328e82-b012-4ea5-bf89-becb4881084f)                                                                | 特权提升     | 重要         | [MS10-078](https://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=15588d6a-f576-4e3d-95e8-d422af8a94de)                                                            | 特权提升     | 重要         | [MS10-078](https://go.microsoft.com/fwlink/?linkid=201084) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2ddb8a06-c9cc-4d33-b6d1-22dbda2d871f)                                                  | 远程执行代码 | 严重         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=9a245f3c-ffb6-4ccd-956c-e7d1231fca30)                          | 远程执行代码 | 严重         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=87149ec2-74a8-4dea-b7e3-873558e0103e)\*                 | 远程执行代码 | 严重         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=523a47d3-771d-471a-889b-16311c276a00)\*       | 远程执行代码 | 严重         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=959146ee-0e70-4e56-9012-72ed59aeb24b) | 远程执行代码 | 严重         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows 7（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=ff590db8-4264-42ba-9e07-88d100e1c4f5)                                                                                   | 远程执行代码 | 严重         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows 7（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=4ea4e339-9db2-4b99-b567-80ee55ecdf92)                                                                              | 远程执行代码 | 严重         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=e52f7869-474a-44c8-a102-e766c576fc01)\*                                                               | 远程执行代码 | 严重         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=a21d061a-794a-4012-b3cd-c67445c074f5)                                                             | 远程执行代码 | 严重         | [MS10-037](https://go.microsoft.com/fwlink/?linkid=190508) |
...
<th style="border:1px solid black;">OpenType 字体索引漏洞 - CVE-2010-3956</th>
<th style="border:1px solid black;">OpenType 字体双重释放漏洞 - CVE-2010-3957</th>
<th style="border:1px solid black;">OpenType CMAP 表漏洞 - CVE-2010-3959</th>
...
OpenType 字体索引漏洞 - CVE-2010-3956  
-------------------------------------
  
  
OpenType 字体 (OTF) 驱动程序不正确分析特制 OpenType 字体的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3956](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3956)。
  
#### OpenType 字体索引漏洞 (CVE-2010-3956) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
  
#### OpenType 字体索引漏洞 (CVE-2010-3956) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **禁用 Windows 资源管理器中的“预览”窗格和“详细信息”窗格**
  
    禁用 Windows 资源管理器中的“预览”和“详细信息”窗格可防止在 Windows 资源管理器中查看 OTF 字体。 尽管这样可防止在 Windows 资源管理器中查看恶意文件，但不能防止经过验证的本地用户运行特制的程序来利用此漏洞。 要禁用 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 中的这些窗格，请执行以下步骤：
    ...
    **如何撤消变通方法。**
    ...
    在 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 中重新启用 Windows 资源管理器的“预览”和“详细信息”窗格：
  
    1.  打开 Windows 资源管理器，单击“**组织**”。然后单击“**布局**”。  
    2.  选择“**详细信息”窗格**和“**预览”窗格**菜单选项。  
    3.  关闭 Windows 资源管理器所有打开的实例以使更改生效。
  
#### OpenType 字体索引漏洞 (CVE-2010-3956) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
此漏洞是由于 OpenType 字体 (OTF) 驱动程序在分析 OpenType 字体时未正确索引数组所导致的。
...
**攻击者如何利用此漏洞？**  
在 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 系统上，攻击者可能将特制 OpenType 字体放在网络共享上。 然后，当用户导航到 Windows 资源管理器中的共享时，受影响的控制路径通过“详细信息”和“预览”窗格触发。 特制的 OpenType 字体然后可利用此漏洞并全面控制受影响的系统。
  
在 Windows XP 和 Windows Server 2003 系统上，攻击者必须先登录系统才能利用此漏洞。 然后，攻击者可以运行一个为利用此漏洞而特制的应用程序，从而完全控制受影响的系统。
  
**第三方 Web 浏览器是否受此漏洞的影响？**  
是。 如果第三方 Web 浏览器在本机呈现 OpenType 字体，则会受此漏洞的影响。 如果这些应用程序用于以嵌入的特制 OpenType 字体查看网站，则此漏洞可能允许在登录用户上下文中远程执行代码。 默认情况下，Internet Explorer 不受此问题的影响。
  
**受此漏洞威胁最大的系统有哪些？**  
工作站和终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。
  
**在 Windows XP 或 Windows Server 2003 中是否可远程利用此漏洞？**  
否。 在这些系统上，不会自动在 Windows 资源管理器中预览 OpenType 字体。 要在这些系统上成功利用此漏洞，攻击者必须先登录本地系统。 然后，攻击者可以运行一个为利用此漏洞而特制的应用程序，从而完全控制受影响的系统。
  
**此更新有什么作用？**  
此更新通过更正 OpenType 字体 (OTF) 驱动程序在分析 OpenType 字体时索引数组的方式来解决此漏洞。
...
OpenType 字体双重释放漏洞 - CVE-2010-3957  
-----------------------------------------
  
  
OpenType 字体 (OTF) 驱动程序不正确分析特制 OpenType 字体的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3957](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3957)。
  
#### OpenType 字体双重释放漏洞 (CVE-2010-3957) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
  
#### OpenType 字体双重释放漏洞 (CVE-2010-3957) 的变通办法
...
#### OpenType 字体双重释放漏洞 (CVE-2010-3957) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
此漏洞是由于 OpenType 字体 (OTF) 驱动程序在释放内存时未正确重置指针所导致的。 这样就产生了“双重释放”条件。
...
**此更新有什么作用？**  
此更新通过更正 OpenType 字体 (OTF) 驱动程序在释放内存时重置指针的方式来解决此漏洞。
...
OpenType CMAP 表漏洞 - CVE-2010-3959  
------------------------------------
  
  
OpenType 字体 (OTF) 驱动程序不正确分析特制 OpenType 字体的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3959](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3959)。
  
#### OpenType CMAP 表漏洞 (CVE-2010-3959) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
  
#### OpenType CMAP 表漏洞 (CVE-2010-3959) 的变通办法
...
#### OpenType CMAP 表漏洞 (CVE-2010-3959) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成此漏洞的原因是什么？**  
此漏洞是由于 OpenType 字体 (OTF) 驱动程序在呈现特制 OpenType 字体时未正确分析 CMAP 表所导致的。
  
**什么是 Embedded OpenType (EOT) 字体？**  
Embedded OpenType (EOT) 字体是为在网页上使用而设计的一种小型字体。 这些字体可以嵌入在文档中。 这确保用户看到的文档正是作者希望他们看到的形式。 Web Embedding Fonts Tool (WEFT) 让 Web 作者能够创建链接到他们的网页的字体对象，以便通过浏览器查看时，页面以字体对象中包含的样式显示。 有关详细信息，请参阅 MSDN 文章“[关于字体嵌入](https://msdn.microsoft.com/en-us/library/ms533034.aspx)”。 “受影响的软件”表中列出的所有操作系统默认情况下都支持 EOT 字体呈现。
...
**第三方 Web 浏览器是否受此漏洞的影响？**  
是。 如果第三方 Web 浏览器在本机呈现 OpenType 字体，则会受此漏洞的影响。 对于这些应用程序，如果用户浏览至采用嵌入的特制 OpenType 字体的网站，则此漏洞可能允许远程拒绝服务。 默认情况下，Internet Explorer 不受此问题的影响。
  
**此更新有什么作用？**  
此更新通过更正 OpenType 字体 (OTF) 驱动程序在呈现 OpenType 字体时分析 CMAP 表的方式来解决此漏洞。
  
**什么是 CMAP 表？**  
此表定义字符代码到字体中使用的 glyph 索引值的映射。 它可能包含多个子表以便支持多个字符编码方案。 表头指示呈现子表的字符编码。 每个子表采用 7 种可能的格式之一，并以表示所使用的格式的格式代码开始。 有关详细信息，请参阅标题为 [Glyph 索引映射表字符](https://www.microsoft.com/typography/otspec/cmap.htm)的文章。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB2296199$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/2296199">Microsoft 知识库文章 2296199</a></td>
</tr>  
<tr class="even">
...
-   [Red Hat Security Response Team](https://www.redhat.com/security/team/) 的 Marc Schoenefeld 与 [Opera Security Team](https://www.opera.com/security/) 合作报告了 OpenType 字体索引漏洞 (CVE-2010-3956)  
-   [Red Hat Security Response Team](https://www.redhat.com/security/team/)的 Marc Schoenefeld 报告了 OpenType 字体双重释放漏洞 (CVE-2010-3957)  
-   Paul-Kenji Cahier Furuya 报告了 OpenType CMAP 表漏洞 (CVE-2010-3959)

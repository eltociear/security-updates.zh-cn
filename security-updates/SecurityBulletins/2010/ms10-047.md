---
TOCTitle: 'MS10-047'
Title: 'Microsoft 安全公告 MS10-047 - 重要'
ms:assetid: 'ms10-047'
ms:contentKeyID: 61237886
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-047(v=Security.10)'
---

Microsoft 安全公告 MS10-047 - 重要
==================================

Windows 内核中的漏洞可能允许特权提升 (981852)
---------------------------------------------
...
对于 Windows XP、Windows Vista 和 Windows Server 2008，此安全更新的等级为“重要”；对于 Windows 7 和 Windows Server 2008 R2，此安全更新的等级为“中等”。有关详细信息，请参阅本节的**“受影响和不受影响的软件”**小节。

通过纠正 Windows 内核对象初始化和访问控制列表验证，以及通过引入更多运行时间验证到线程创建机制，安全更新解决了漏洞问题。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e3574047-5ce5-4461-94aa-4eb3258d5e71)                                                                                     | 特权提升     | 重要         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4486f97c-4cf8-4236-bfc3-b50e72e2a5c1)                                                  | 特权提升     | 重要         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b547898e-f8a9-49dc-b49d-cffec5a001bc)                          | 特权提升     | 重要         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=611765ab-b3f3-45db-92b2-ee040b9cfd27)\*                 | 特权提升     | 重要         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=131f3512-1585-462e-a4f1-3f359aac44bd)\*       | 特权提升     | 重要         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=972efd3a-ec1e-49b2-835e-76f4b21b5b79) | 特权提升     | 重要         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows 7（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=a7d60864-5942-47ed-a6f3-1c07b4833a14)                                                                                   | 拒绝服务     | 中等         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows 7（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=b00ec47c-402e-4207-a4c9-6c1900f254f8)                                                                              | 拒绝服务     | 中等         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=c1ad1248-07f1-42d4-baa4-8a20837ec7b4)\*                                                               | 拒绝服务     | 中等         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=f23dec0f-a33b-4d8c-a86d-0e9368ae7ff5)                                                             | 拒绝服务     | 中等         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 内核数据初始化漏洞 - CVE-2010-1888</th>
<th>Windows 内核双重释放漏洞 - CVE-2010-1889</th>
<th>Windows 内核不正确验证漏洞 - CVE-2010-1890</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Windows 内核数据初始化漏洞 - CVE-2010-1888  
------------------------------------------
  
   
由于内核处理特定线程创建尝试的方式，Windows 内核中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1888](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1888)。
  
#### Windows 内核数据初始化漏洞 (CVE-2010-1888) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核数据初始化漏洞 (CVE-2010-1888) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核数据初始化漏洞 (CVE-2010-1888) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
此漏洞是由于创建特定类型的线程时的竞争状态造成的。
...
Windows 内核双重释放漏洞 - CVE-2010-1889  
----------------------------------------
  
   
由于内核在处理特定错误时初始化对象的方式，Windows 内核中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1889](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1889)。
  
#### Windows 内核双重释放漏洞 (CVE-2010-1889) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核双重释放漏洞 (CVE-2010-1889) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核双重释放漏洞 (CVE-2010-1889) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核在处理特定错误时未正确初始化对象。
...
**此更新有什么作用？**    
通过确保 Windows 内核在处理特定错误时正确初始化对象，更新解决了漏洞问题。
...
Windows 内核不正确验证漏洞 - CVE-2010-1890  
------------------------------------------
  
   
Windows 内核验证内核对象上的访问控制列表的方式中存在一个拒绝服务漏洞。 攻击者可以通过运行导致系统变得没有响应并自动重新启动的特制应用程序来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1890)。
  
#### Windows 内核不正确验证漏洞 (CVE-2010-1890) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核不正确验证漏洞 (CVE-2010-1890) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核不正确验证漏洞 (CVE-2010-1890) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个拒绝服务漏洞。 利用此漏洞的攻击者可能会导致受影响系统停止响应和自动重新启动。 请注意，虽然攻击者无法利用拒绝服务漏洞来运行代码或提升他们的用户权限，但此漏洞可能导致受影响的系统停止接受请求。
  
**造成漏洞的原因是什么？**    
Windows 内核未正确验证内核对象上的访问控制列表。
...
**此更新有什么作用？**    
通过纠正 Windows 内核对应用到内核对象的访问控制列表的验证方式，更新解决了此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB981852$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/981852">Microsoft 知识库文章 981852</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc.](http://www.google.com/) 的 Tavis Ormandy 报告了 Windows 内核数据初始化漏洞 (CVE-2010-0810)  
-   [Google Inc.](http://www.google.com/) 的 Tavis Ormandy 报告了 Windows 内核双重释放漏洞 (CVE-2010-1889)  
-   [Google Inc.](http://www.google.com/) 的 Tavis Ormandy 报告了 Windows 内核不正确验证漏洞 (CVE-2010-1890)

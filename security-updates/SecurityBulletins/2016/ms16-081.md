...
<td style="border:1px solid black;">
[**Active Directory 拒绝服务漏洞 – CVE-2016-3226**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3226)
...
**注意** Windows Server 2016 Technical Preview 5 受到影响。鼓励运行这些操作系统的客户应用此更新，此更新通过[Windows 更新](https://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-cn)提供。
...
<td style="border:1px solid black;"><p><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-3226">CVE-2016-3226</a></p></td>

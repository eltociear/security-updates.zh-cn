...
<td style="border:1px solid black;">
[**微软 Video Control 远程代码执行漏洞 - CVE-2016-7248**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248)
...
<td style="border:1px solid black;">
[MS16-122](https://go.microsoft.com/fwlink/?linkid=829051) 中的 [3190847](https://support.microsoft.com/zh-cn/kb/3190847)
...
请注意，如果**受影响软件和漏洞严重等级**表中严重程度为“严重”，则 Outlook 预览窗格将是 [CVE-2016-7248](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248) 的攻击向量。
...
<td style="border:1px solid black;"><p><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-7248">CVE-2016-7248</a></p></td>

...
<td style="border:1px solid black;">
[**.NET Framework 远程执行代码漏洞 - CVE-2016-0148**](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-0148)
...
<sup>[1]</sup>若要了解 NET Framework 4.x 支持变更，请参阅 [Internet Explorer 和 .NET Framework 4.x 支持公告](https://support2.microsoft.com/gp/msl-ie-dotnet-an/zh-cn)。
...
<td style="border:1px solid black;"><p><a href="https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2016-0148">CVE-2016-0148</a></p></td>

...
<td style="border:1px solid black;">
[MS13-052](https://go.microsoft.com/fwlink/?linkid=299844) 中的 2833951
...
<td style="border:1px solid black;">
[MS11-100](https://go.microsoft.com/fwlink/?linkid=232432) 中的 2656352
...
<td style="border:1px solid black;">
[MS13-052](https://go.microsoft.com/fwlink/?linkid=299844) 中的 2833940
...
<td style="border:1px solid black;">
[MS11-100](https://go.microsoft.com/fwlink/?linkid=232432) 中的 2656351
...
<td style="border:1px solid black;">
[MS13-052](https://go.microsoft.com/fwlink/?linkid=299844) 中的 2835393
...
<td style="border:1px solid black;">
[MS11-100](https://go.microsoft.com/fwlink/?linkid=232432) 中的 2656358
...
<td style="border:1px solid black;">
[MS13-052](https://go.microsoft.com/fwlink/?linkid=299844) 中的 2833949
...
<td style="border:1px solid black;">
[MS11-100](https://go.microsoft.com/fwlink/?linkid=232432) 中的 2656362
...
<td style="border:1px solid black;">
[MS13-052](https://go.microsoft.com/fwlink/?linkid=299844) 中的 2833947
...
<td style="border:1px solid black;">
[MS13-052](https://go.microsoft.com/fwlink/?linkid=299844) 中的 2833957
...
<td style="border:1px solid black;">
[MS13-052](https://go.microsoft.com/fwlink/?linkid=299844) 中的 2833946
...
<td style="border:1px solid black;">
[MS13-052](https://go.microsoft.com/fwlink/?linkid=299844) 中的 2833959
...
<td style="border:1px solid black;">
[MS13-052](https://go.microsoft.com/fwlink/?linkid=299844) 中的 2833958
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2014-0253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0253)。
...
- **配置&lt;serverRuntime&gt;、&lt;requestLimits&gt; 和 &lt;httpRuntime&gt; 元素，以便拒绝试图利用该漏洞的请求**
  ...
  1.  将 **httpRuntime/maxRequestLength** 属性设置为适合您的应用程序的特定值。默认值为 4096KB。
      有关此属性的详细信息，请参阅 [httpRuntime 元素（ASP.NET 设置架构）](https://msdn.microsoft.com/library/e1f13641(v=vs.100).aspx)。
  2.  将 **requestLimits/maxAllowedContentLength** 属性设置为等于在步骤 1 中配置的 maxRequestLength 的值。请注意，此值以字节而不是千字节为单位。
      有关此属性的详细信息，请参阅 [请求限制 &lt;requestLimits&gt;](https://www.iis.net/configreference/system.webserver/security/requestfiltering/requestlimits)。
  3.  将 **serverRuntime/uploadReadAheadSize** 属性设置为等于在步骤 1 中配置的 maxRequestLength 的值。请注意，此值以字节而不是千字节为单位。
      有关此属性的详细信息，请参阅 [服务器运行时 &lt;serverRuntime&gt;](https://www.iis.net/configreference/system.webserver/serverruntime)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2014-0253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0253)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2014-0257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0257)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2014-0295](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0295)。
...
- **安装 Force ASLR 功能修补程序并启用 IFEO 注册表项**
  ...
  有关详细信息和安装说明，请参阅 [Microsoft 知识库文章 2639308](https://support.microsoft.com/kb/2639308)。

  **变通办法的影响。** 强制性地重新定位非使用 ASLR 支持构建的映像，这可能导致应用程序兼容性问题。

  **如何撤消变通方法。**

  **注意** 有关将 IFEO 注册表项设置为默认设置的信息，请参阅 [Microsoft 知识库文章 2639308](https://support.microsoft.com/kb/2639308)。
...
有关 EMET 的详细信息，请参阅 [Enhanced Mitigation Experience Toolkit](https://support.microsoft.com/kb/2458544)。

**此更新有什么作用？**  
该更新通过帮助确保 .NET Framework 组件正确实施 ASLR 来解决漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2014-0295](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0295)。
...
<td style="border:1px solid black;"><p>请参阅 <a href="https://support.microsoft.com/kb/2916607">Microsoft 知识库文章 2916607</a></p></td>
</tr>  
<tr class="odd">
...
2901119 更新通过 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。<br />
2898865 更新通过 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>对于 Windows RT 上的 Microsoft .NET Framework 4.5.1:<br />
2901127 更新通过 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。<br />
2898870 更新通过 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><br />
</td>
<td style="border:1px solid black;"><p>对于 Windows RT 8.1 的 Microsoft .NET Framework 4.5.1:<br />
2901128 更新通过 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。<br />
2898871 更新通过 <a href="https://go.microsoft.com/fwlink/?linkid=21130">Windows Update</a> 提供。</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><p><strong>重新启动要求</strong></p></td>

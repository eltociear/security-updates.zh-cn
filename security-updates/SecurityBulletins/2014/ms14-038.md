...
**注意** 在 Windows Server 2012 R2 的受支持版本上，只有当启用了 “[墨迹和手写服务](https://technet.microsoft.com/en-us/library/dd759248.aspx)” 功能时，Journal 更新才适用。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2014-1824](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1824)。

...
是。此更新向开发人员用于创作低级键盘和鼠标输入挂接程序的结构添加新的安全相关标记。有关功能更改的详细信息，请参阅 [KBDLLHOOKSTRUCT 结构](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644967(v=vs.85).aspx)和 [MSLLHOOKSTRUCT 结构](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644970(v=vs.85).aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2014-2781](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-2781)。
...
**此更新有什么作用？**   
该更新通过更正某些程序与不同完整性级别程序进行通信的方式来解决漏洞。有关已使用此更新实施的功能更改的详细信息，请参阅 [KBDLLHOOKSTRUCT 结构](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644967(v=vs.85).aspx)和 [MSLLHOOKSTRUCT 结构](https://msdn.microsoft.com/en-us/library/windows/desktop/ms644970(v=vs.85).aspx)。

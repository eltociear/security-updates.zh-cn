...
[Windows 7（用于 32 位系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=43779b6d-d8d5-40b0-a09e-d0009ec0cbcd)  
(2912390)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Windows 7（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=870a136b-81f9-4d4c-9174-28092cc7fc10)  
(2912390)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=2fd74351-304a-4b27-b44a-c08ff58c9aa6)  
(2912390)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=a92130ec-0795-4f98-9219-c50571e33d35)  
(2912390)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[Windows 8（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=3a86ba25-1f1f-498f-a95c-39819157f5db)  
(2912390)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8.1（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=a4809d9e-bd56-4b68-8af9-3f3a0a0ea4e0)  
(2912390)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=99460009-b897-4e62-8e36-8d5453341e78)  
(2912390)
</td>
<td style="border:1px solid black;">
远程执行代码
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2014-0263](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-0263)。
...
**什么是 Direct2D？**  
Direct2D 是一个硬件加速、即时模式 2D 图形 API，针对 2-D 几何形状、位图和文本提供高性能和高质量呈现。Direct2D API 设计为与现有使用 GDI、GDI+ 或 Direct3D 的代码互操作。有关 Direct2D 的详细信息，请参阅 MSDN 文章 [Direct2D](https://msdn.microsoft.com/library/windows/desktop/dd370990)。

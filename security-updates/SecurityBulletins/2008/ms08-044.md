...
[Microsoft Office 2000 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=3ab323ec-9f92-453c-b7c7-9a95a9efcaea)  
(KB921595)
</td>
<td style="border:1px solid black;">
远程执行代码
...
是的，作为 Microsoft Office 2003 的服务模型的一部分，当 Microsoft Office 2003 Service Pack 2 用户安装此更新时，用户的系统将升级为 Microsoft Office 2003 Service Pack 3 最初版本的安全功能。2008年 1 月 1 日之后发行的所有更新将包含 [Microsoft Office 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=e25b7049-3e13-433b-b9d2-5e3c1132f206) 中所介绍的这些安全功能。我们已经对此更新进行了彻底测试，但是与所有更新一样，我们建议用户对其环境和系统的配置执行适合的测试。 有关此问题的详细信息，请参阅 [Microsoft 知识库文章 951646](https://support.microsoft.com/kb/951646)。

**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 924090](https://support.microsoft.com/kb/924090) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3019](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3019)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3018](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3018)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3021](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3021)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3020](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3020)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3460](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3460)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/921595">Microsoft 知识库文章 921595</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/921596">Microsoft 知识库文章 921596</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/921598">Microsoft 知识库文章 921598</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/925256">Microsoft 知识库文章 925256</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/955428">Microsoft 知识库文章 955428</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [NGS Software](https://www.nextgenss.com/) 的 Shaun Colley 报告了 Microsoft 格式错误的 PICT 筛选器漏洞 (CVE-2008-3018)。  
-   [Zero Day Initiative (ZDI)](https://www.zerodayinitiative.com/) 报告了 Microsoft PICT 筛选器分析漏洞 (CVE-2008-3021)。  
-   一名匿名研究员和 [iDefense VCP](https://labs.idefense.com/) 一起报告了 Microsoft 格式错误的 BMP 筛选器漏洞 (CVE-2008-3020)。  
-   Damian Put 与 [iDefense VCP](https://labs.idefense.com/) 一起报告了 Microsoft Office WPG 图像文件堆损坏漏洞 (CVE-2008-3460)。

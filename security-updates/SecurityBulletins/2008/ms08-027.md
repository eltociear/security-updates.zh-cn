...
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=110054">MS08-012</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=93448">MS07-037</a></td>
</tr>  
<tr class="even">
...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 951208](https://support.microsoft.com/kb/951208) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0119](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0119)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/951208">Microsoft 知识库文章 951208</a></td>
</tr>  
<tr class="even">
...
| 更新日志文件                     | 用户可以使用 /log 开关启用详细日志记录。 有关详细信息，请参阅 [Microsoft 知识库文章 912203](https://support.microsoft.com/kb/912203)。 |  
| 更多信息                         | 有关检测和部署，请参阅前面的部分“**检测和部署工具及指导**”。                                                                          |  
| **重新启动要求**                 |                                                                                                                                       |  
| 要求重新启动？                   | 此更新不需要重新启动。                                                                                                                |  
| Hotpatching                      | 不适用                                                                                                                                |  
| **删除信息**                     | 使用控制面板中的“添加或删除程序”工具。                                                                                                |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 951208](https://support.microsoft.com/kb/951208)                                                          |  
| **注册表项验证**                 | 不适用                                                                                                                                |
...
-   [Fortinet Security Research](https://www.fortinet.com/) 的 Cocoruder 报告了 Publisher 对象处理程序验证漏洞 - CVE-2008-0119。

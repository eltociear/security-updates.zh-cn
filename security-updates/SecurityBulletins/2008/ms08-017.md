...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2006-4695](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4695)。
...
**什么是 kill bit？**  
kill bit 是一种防止通过 Internet Explorer 调用 ActiveX 控件（即使系统上存在 ActiveX 控件）的方法。 （有关 kill bit 的详细信息，请参阅 [Microsoft 知识库文章 240797](http://support.microsoft.com/default.aspx?scid=kb;en-us;q240797&id=kb;en-us;q240797)）。 通常，当安全漏洞影响 ActiveX 控件时，安全更新会提供新的控件并在存在漏洞的控件上设置 kill bit。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-1201](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1201)。
...
**此更新有什么作用？**    
此更新可解决已知的安全问题并为 Office Web Components 的类标识符 (CLSIDs) 设置 kill bit。 为帮助保护客户，此更新阻止这些 CLSID 在 Internet Explorer 中实例化。 有关 kill bit 的详细信息，请参阅 [Microsoft 知识库文章 240797](http://support.microsoft.com/default.aspx?scid=kb;en-us;q240797&id=kb;en-us;q240797)。
...
**注意** 可以将这些开关组合到一个命令中。 为了保持向后兼容，此安全更新还支持以前版本的安装程序所使用的安装开关。 有关受支持的安装开关的详细信息，请参阅 [Microsoft 知识库文章 262841](http://support.microsoft.com/kb/262841)。有关安装程序的详细信息，请访问 [Microsoft TechNet 网站](http://go.microsoft.com/fwlink/?linkid=38951)。 有关本公告中出现的术语（如“*修补程序*”）的详细信息，请参阅 [Microsoft 知识库文章 824684](http://support.microsoft.com/kb/824684)。
...
-   [VigilantMinds Inc.](http://www.vigilantminds.com) 的 Chris Ries 报告了 Office Web Components URL 分析漏洞 – (CVE-2006-4695)。  
-   [NCNIPC](http://www.nipc.org.cn) 的 Xiaohui 报告了 Office Web Components URL 分析漏洞 – (CVE-2006-4695)。  
-   [Finjan](http://www.finjan.com/) 的 Yuval Ben-Itzhak 报告了 Office Web Components 数据源漏洞 – (CVE-2007-1201)。

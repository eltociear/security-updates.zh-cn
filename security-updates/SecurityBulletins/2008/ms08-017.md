---
TOCTitle: 'MS08-017'
Title: 'Microsoft 安全公告 MS08-017 - 严重'
ms:assetid: 'ms08-017'
ms:contentKeyID: 61237142
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-017(v=Security.10)'
---

Microsoft 安全公告 MS08-017 - 严重
==================================
...
这是 Microsoft Office 2000 Service Pack 3、Microsoft Office XP Service Pack 3、Visual Studio .NET 2002 Service Pack 1、Visual Studio .NET 2003 Service Pack 1、Microsoft BizTalk Server 2000 和 Microsoft BizTalk Server 2002、Microsoft Commerce Server 2000 以及 Internet Security and Acceleration Server 2000 Service Pack 2 的受支持版本上的 Microsoft Office Web Components 2000 实现的严重安全更新。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过修改 Microsoft Office Web Components 处理错误条件和管理内存资源的方式，以及为 Microsoft Office Spreadsheet 2000 控件设置 kill bit 来消除安全漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?familyid=806c654a-35e3-4385-855a-4b803249bfcf)  
(KB931660)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?familyid=f54d2a5e-c0ed-4f70-9746-38dd61c8e9d7)  
(KB932031)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?familyid=d71b23fa-a873-406d-bad7-e38e565dee39)  
(KB933367)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?familyid=2fe10ccd-40cb-4090-b83d-eae3d4eca174)  
(KB933369)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?familyid=e0993e49c0a811d2973d00c04f79e4b3)  
(KB939714)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office Web Components 2000](https://www.microsoft.com/download/details.aspx?familyid=12b7d09a92ab4596996670799837d961)  
(KB939714)
</td>
<td style="border:1px solid black;">
远程执行代码
...
Microsoft Office 中存在此安全更新中描述的漏洞，但是不能被“不受影响的软件”表格中列出的任何一种应用程序利用。 “不受影响的软件”表格中列出的 Microsoft Office 应用程序使用的某些文件与“受影响的软件”中列出的安全更新影响的应用程序所使用的文件相同。 我们建议安装该更新，以免再次提供安全更新。
...
<tr class="header">
<th>受影响的软件</th>
<th>Office Web Components URL 分析漏洞 - CVE-2006-4695</th>
<th>Office Web Components 数据源漏洞 - CVE-2007-1201</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2006-4695](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-4695)。
  
#### Office Web Components URL 分析漏洞 (CVE-2006-4695) 的缓解因素
...
#### Office Web Components URL 分析漏洞 (CVE-2006-4695) 的变通办法
...
-   **阻止 Office Web Components 库在 Internet Explorer 中运行**。
    ...
    **注意** 常见问题“此更新有什么作用？”中介绍了包含库对象的类标识符和相应的文件 使用本部分中找到的类标识符替换下列 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}。
  
    -   要为值为 {0002E510-0000-0000-C000-000000000046} 和 {0002E511-0000-0000-C000-000000000046} 的 CLSID 设置 kill bit，请将以下文本粘贴于记事本等文本编辑器中。 然后，使用 .reg 文件扩展名保存文件。  
    ...
    **注意** 我们建议在编辑注册表之前先对其进行备份。
    ...
    -   要为值为 {0002E510-0000-0000-C000-000000000046} 的 CLSID 撤消 kill bit，请将以下文本粘贴于记事本等文本编辑器中。 然后，使用 .reg 文件扩展名保存文件。  
        Windows Registry Editor Version 5.00  
...
-   **注销 Office Web Components 2000 库**
    ...
    **如何撤消变通方法：** 要重新注册 Office Web Components 2000，请执行以下步骤：
...
**受此漏洞威胁最大的系统有哪些？**  
工作站和安装了 Microsoft Office Web Components 的终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。
...
**此更新有什么作用？**    
此更新可解决已知的安全问题并为 Office Web Components 的类标识符 (CLSIDs) 设置 kill bit。 为帮助保护客户，此更新阻止这些 CLSID 在 Internet Explorer 中实例化。 有关 kill bit 的详细信息，请参阅 Microsoft 知识库文章 240797。
...
**什么是 kill bit？**  
kill bit 是一种防止通过 Internet Explorer 调用 ActiveX 控件（即使系统上存在 ActiveX 控件）的方法。 （有关 kill bit 的详细信息，请参阅 [Microsoft 知识库文章 240797](https://support.microsoft.com/default.aspx?scid=kb;en-us;q240797&id=kb;en-us;q240797)）。 通常，当安全漏洞影响 ActiveX 控件时，安全更新会提供新的控件并在存在漏洞的控件上设置 kill bit。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-1201](https://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1201)。
  
#### Office Web Components 数据源漏洞 (CVE-2007-1201) 的缓解因素
...
#### Office Web Components 数据源漏洞的变通办法
...
-   **阻止 Office Web Components 库在 Internet Explorer 中运行**。
    ...
    **注意** 常见问题“此更新有什么作用？”中介绍了包含库对象的类标识符和相应的文件 使用本部分中找到的类标识符替换下列 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}。
    ...
    -   要为值为 {2E533-0000-0000-C000-000000000046} 的 CLSID 设置 kill bit，请将以下文本粘贴于记事本等文本编辑器中。 然后，使用 .reg 文件扩展名保存文件。  
        Windows Registry Editor Version 5.00  
        \[HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Internet Explorer\\ActiveX Compatibility\\{ 0002E533-0000-0000-C000-000000000046}\]  
        "Compatibility Flags"=dword:00000400  
    -   要为值为 {2E530-0000-0000-C000-000000000046} 的 CLSID 设置 kill bit，请将以下文本粘贴于记事本等文本编辑器中。 然后，使用 .reg 文件扩展名保存文件。  
...
#### Office Web Components 数据源漏洞 ( CVE-2007-1201) 的常见问题
...
**此更新有什么作用？**    
此更新可解决已知的安全问题并为 Office Web Components 的类标识符 (CLSIDs) 设置 kill bit。 为帮助保护客户，此更新阻止这些 CLSID 在 Internet Explorer 中实例化。 有关 kill bit 的详细信息，请参阅 [Microsoft 知识库文章 240797](https://support.microsoft.com/default.aspx?scid=kb;en-us;q240797&id=kb;en-us;q240797)。
...
| 开关         | 描述                                                                               |  
|--------------|------------------------------------------------------------------------------------|  
| **/passive** | 指定安静模式，或在提取文件时禁止显示提示信息。                                     |  
...
| **部署**                         |                                                                                                                                                                                                                                             |  
| 没有用户干预的安装               | VS7.0sp1-KB933367-X86 /passive                                                                                                                                                                                                              |  
| 在不重新启动的情况下安装         | VS7.0sp1-KB933367-X86 /norestart                                                                                                                                                                                                            |  
| 更新日志文件                     | 不适用                                                                                                                                                                                                                                      |  
...
对于 Visual Studio .NET 2002 的所有受支持版本：
...
| **包括在以后的 Service Pack 中** | 没有为此软件计划其他 Service Pack。 此问题的更新程序将包含在以后的更新汇总中。                                                                                                                                                              |  
| **部署**                         |                                                                                                                                                                                                                                             |  
| 没有用户干预的安装               | VS7.1sp1-KB933369-X86-INTL /passive                                                                                                                                                                                                         |  
| 在不重新启动的情况下安装         | VS7.1sp1-KB933369-X86-INTL /norestart                                                                                                                                                                                                       |  
| 更新日志文件                     | 不适用                                                                                                                                                                                                                                      |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节。                                                                                                                                                                                                      |  
| **重新启动要求**                 |                                                                                                                                                                                                                                             |  
| 要求重新启动                     | 为了降低被迫重新启动的机率，请首先停止所有受影响的服务并且关闭所有可能使用受影响的文件的应用程序，然后安装安全更新。 有关可能提示您重新启动的原因的详细信息，请参阅 [Microsoft 知识库文章 887012](https://support.microsoft.com/kb/887012)。 |  
...
对于 Visual Studio .NET 2003 的所有受支持版本：
...
| **包括在以后的 Service Pack 中** | 没有为此软件计划其他 Service Pack。 此问题的更新程序将包含在以后的更新汇总中。                                                                                                                                                              |  
| **部署**                         |                                                                                                                                                                                                                                             |  
| 没有用户干预的安装               | CommerceServer2000-KB941305-FullFile-x86-ENU /q:a                                                                                                                                                                                           |  
| 在不重新启动的情况下安装         | CommerceServer2000-KB941305-FullFile-x86-ENU /r:n                                                                                                                                                                                           |  
| 更新日志文件                     | 不适用                                                                                                                                                                                                                                      |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节。                                                                                                                                                                                                      |  
| **重新启动要求**                 |                                                                                                                                                                                                                                             |  
| 要求重新启动                     | 为了降低被迫重新启动的机率，请首先停止所有受影响的服务并且关闭所有可能使用受影响的文件的应用程序，然后安装安全更新。 有关可能提示您重新启动的原因的详细信息，请参阅 [Microsoft 知识库文章 887012](https://support.microsoft.com/kb/887012)。 |  
...
对于 Commerce Server 2002 所有受支持的版本：
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 BizTalk Server 2000：<br />
MicrosoftBizTalkServer2000-KB939714-ENU /q:a<br />  
<br />  
对于 BizTalk Server 2002：<br />
...
对于 BizTalk Server 2002 所有受支持的版本：
...
| **包括在以后的 Service Pack 中** | 没有为此软件计划其他 Service Pack。 此问题的更新程序将包含在以后的更新汇总中。                                   |  
| **部署**                         |                                                                                                                  |  
| 没有用户干预的安装               | isaserver2000-kb948257-fullfile-x86-glb /q:a                                                                     |  
| 在不重新启动的情况下安装         | isaserver2000-kb948257-fullfile-x86-glb /r:n                                                                     |  
| 更新日志文件                     | 不适用                                                                                                           |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节。                                                                           |  
| **重新启动要求**                 |                                                                                                                  |  
| 要求重新启动                     | 不需要                                                                                                           |  
...
注意： 此更新中未包括用于 ISA 2000 的文件。此更新只包含通过为漏洞设置 killbit 防止该漏洞的注册表设置。
...
-   **更新安装验证**
    ...
    由于此更新中未包括用于 ISA 2000 的文件，可以通过验证以下注册表项以及双字值是否如下设置来验证安装是否成功：
...
-   [VigilantMinds Inc.](https://www.vigilantminds.com) 的 Chris Ries 报告了 Office Web Components URL 分析漏洞 – (CVE-2006-4695)。  
-   [NCNIPC](https://www.nipc.org.cn) 的 Xiaohui 报告了 Office Web Components URL 分析漏洞 – (CVE-2006-4695)。  
-   [Finjan](https://www.finjan.com/) 的 Yuval Ben-Itzhak 报告了 Office Web Components 数据源漏洞 – (CVE-2007-1201)。

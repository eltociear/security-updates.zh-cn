---
TOCTitle: 'MS08-054'
Title: 'Microsoft 安全公告 MS08-054 - 严重'
ms:assetid: 'ms08-054'
ms:contentKeyID: 61237178
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-054(v=Security.10)'
---
...
对于 Windows Media Player 11 的所有受支持且受影响的版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

该安全更新通过更正 Windows Media Player 11 处理从服务器播放列表 (SSPL) 流式传输的音频文件的方式来消除漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| Windows XP Service Pack 2 和 Windows XP Service Pack 3                                    | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=d5891180-5dd1-49ec-bcc6-3030a544202c) | 远程执行代码 | 严重         | 无               |
| Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=caf8a45e-a9f8-4e91-98fd-87eddbeae64c) | 远程执行代码 | 严重         | 无               |
| Windows Vista 和 Windows Vista Service Pack 1                                             | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=2f4118fd-1ffb-46da-b922-cd4ca4f9d84e) | 远程执行代码 | 严重         | 无               |
| Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1                     | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=334352e7-d41f-494f-866d-f1f1745ffd17) | 远程执行代码 | 严重         | 无               |
| Windows Server 2008（用于 32 位系统）\*                                                   | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=72fc6028-6af4-44ec-8d2a-28c53807d6bc) | 远程执行代码 | 严重         | 无               |
| Windows Server 2008（用于基于 x64 的系统）\*                                              | [Windows Media Player 11](https://www.microsoft.com/download/details.aspx?familyid=3906512b-26db-473e-b522-3883ff34a21c) | 远程执行代码 | 严重         | 无               |
...
| Windows XP Service Pack 2 和 Windows XP Service Pack 3                            | Windows Media Player 9   |
| Windows XP Service Pack 2 和 Windows XP Service Pack 3                            | Windows Media Player 10  |
...
| Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2          | Windows Media Player 10  |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 954154](https://support.microsoft.com/kb/954154) 中找到文件信息详细资料。
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows Media Player 采样率漏洞 - CVE-2008-2253</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;">用于 32 位系统的 Windows Server 2008 上的 Windows Media Player 11\*</td>
<td style="border:1px solid black;"><strong>严重</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">用于基于 x64 的系统的 Windows Server 2008 上的 Windows Media Player 11\*</td>
<td style="border:1px solid black;"><strong>严重</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>严重</strong></td>
</tr>  
...
Windows Media Player 采样率漏洞 - CVE-2008-2253  
-----------------------------------------------
  
  
Windows Media Player 11 中存在一个远程执行代码漏洞。攻击者可能通过构建一个特制音频文件来利用该漏洞；当使用 Windows Media Player 11 从 Windows Media 服务器流式传输时，该文件可能允许远程执行代码。成功利用此漏洞的攻击者可能完全控制受影响的系统。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2253)。
  
#### Windows Media Player 采样率漏洞 (CVE-2008-2253) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。  
-   此漏洞只能通过实时流协议 (RTSP) 被利用。 不允许来自 Internet 的 RTSP 入站的组织受此漏洞的威胁较小。 有关 RTSP 使用的端口的详细信息，请参阅 [Microsoft 知识库文章 827562](https://support.microsoft.com/kb/827562)。
  
#### Windows Media Player 采样率漏洞 (CVE-2008-2253) 的变通办法
...
-   **注销 wmpeffects.dll**  
    ...
    -   **变通办法的影响：** 可视化效果无法显示在 Windows Media Player 的“正在播放”视图中。  
...
#### Windows Media Player 采样率漏洞 (CVE-2008-2253) 的常见问题
...
**造成漏洞的原因是什么？**    
Windows Media Player 11 不正确地处理从服务器播放列表 (SSPL) 中的 Windows Media 服务器流式传输的特制音频文件。
  
**什么是服务器播放列表 (SSPL)？**    
SSPL 是指一个用于识别为客户端播放哪些内容、播放时间以及播放顺序的列表。 Windows Media 服务器的 SSPL 是一个 XML 文档。 有关 SSPL 的详细信息，请参阅[服务器播放列表](https://msdn.microsoft.com/en-us/library/ms753585(vs.85).aspx)。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**攻击者如何利用此漏洞？**    
此漏洞要求用户从 Windows Media 服务器打开特制的音频文件。
  
在基于 Web 的攻击情形中，攻击者必须拥有一台 Windows Media 服务器，其中包含用于试图利用此漏洞的特制音频文件。 攻击者无法强迫用户访问特制的网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
  
**受此漏洞威胁最大的系统有哪些？**    
使用 Windows Media Player 的任何系统（如工作站或终端服务器）受此漏洞的威胁。
  
**此更新有什么作用？**    
该更新通过更正 Windows Media Player 11 处理从 SSPL 流式传输的音频文件的方式来消除漏洞。
...
<td style="border:1px solid black;">对于 Windows XP 所有受支持的 32 位版本上的 Windows Media Player 11：<br />
WindowsMedia11-KB954154-X86-ENU /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP 所有受支持的 x64 位版本上的 Windows Media Player 11：<br />
...
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB954154_WM11$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/954154">Microsoft 知识库文章 954154</a></td>
</tr>  
<tr class="even">
...
<br />  
对于 Windows XP 所有受支持的 x64 位版本上的 Windows Media Player 11：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于带桌面体验的 Windows Server 2008 所有受支持的 32 位版本：<br />
Windows6.0-KB954154-x86 /quiet<br />  
<br />  
对于带桌面体验的 Windows Server 2008 所有受支持的基于 x64 的版本：<br />
Windows6.0-KB954154-x64 /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">在不重新启动的情况下安装</td>
...
<tr class="odd">
<td style="border:1px solid black;">更多信息</td>
<td style="border:1px solid black;">有关 Windows Server 2008 桌面体验的详细信息，请参阅 TechNet 文章、Windows Mail、Windows Media Player 以及 Windows Server 2008 桌面体验中的其他功能。<br />
<br />
有关部署此更新的详细信息，请参阅“<strong>检测和部署工具及指导</strong>”小节。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>重新启动要求</strong></td>
<td style="border:1px solid black;"></td>

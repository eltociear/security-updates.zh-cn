---
TOCTitle: 'MS08-063'
Title: 'Microsoft 安全公告 MS08-063 - 重要'
ms:assetid: 'ms08-063'
ms:contentKeyID: 61237187
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-063(v=Security.10)'
---
...
此安全更新解决了 Microsoft 服务器消息块 (SMB) 中一个秘密报告的漏洞。 该漏洞可能允许在共享文件或文件夹的服务器上远程执行代码。 成功利用此漏洞的攻击者可以安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
...
该安全更新通过修改 SMB 处理文件名长度验证和文件共享的方式来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=9ed29c3a-0682-4586-bbc2-a73deaa18e4c)                                 | 远程执行代码 | 重要         | [MS06-063](https://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2f7e5981-6eef-4f08-86c0-c6a7607ea5d0)                                             | 远程执行代码 | 重要         | [MS06-063](https://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=2f7e5981-6eef-4f08-86c0-c6a7607ea5d0)                                             | 远程执行代码 | 重要         | 无                                                       |
| [Windows XP Professional x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=4e1675eb-6b06-48e9-9765-23a2c7737bdc)                                   | 远程执行代码 | 重要         | [MS06-063](https://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=4e1675eb-6b06-48e9-9765-23a2c7737bdc)                    | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2003 Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=dbbebb3f-f1c7-402c-bd16-6f88da0d042c)                                    | 远程执行代码 | 重要         | [MS06-063](https://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=dbbebb3f-f1c7-402c-bd16-6f88da0d042c)                                    | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2003 x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=989ac6f1-515c-467d-a200-2aabe66d9319)                                       | 远程执行代码 | 重要         | [MS06-063](https://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=989ac6f1-515c-467d-a200-2aabe66d9319)                        | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=91589cfb-15ba-4dd2-9e3b-107899fbcba6)                    | 远程执行代码 | 重要         | [MS06-063](https://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=91589cfb-15ba-4dd2-9e3b-107899fbcba6)                    | 远程执行代码 | 重要         | 无                                                       |
| [Windows Vista 和 Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=72dd6015-25d1-45f4-a769-88ac43074b44)                         | 远程执行代码 | 重要         | 无                                                       |
| [Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=f793af16-5464-4db1-a42b-1c5f17c538ed) | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2008（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=cf6744e6-b54c-40f6-a78d-7ba9453133c0)\*                               | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=223236e8-7b19-4b47-8a90-bfc35eb9318a)\*                          | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=077b697c-04a0-45bd-b08c-331d5c30cb47)                        | 远程执行代码 | 重要         | 无                                                       |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 957095](https://support.microsoft.com/kb/957095) 中找到文件信息详细资料。
...
<tr class="header">
<th>受影响的软件</th>
<th>SMB 缓冲区下溢漏洞 - CVE-2008-4038</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
SMB 缓冲区下溢漏洞 - CVE-2008-4038  
----------------------------------
  
  
Microsoft 服务器消息块 (SMB) 协议处理特制文件名的方式中存在一个远程执行代码漏洞。 利用该漏洞的尝试要求进行身份验证，因为只有当共享类型为磁盘时，容易受到攻击的功能才可访问，默认情况下，所有磁盘共享均要求进行身份验证。 成功利用此漏洞的攻击者可以安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4038](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4038)。
  
#### SQL 缓冲区下溢漏洞 (CVE-2008-4038) 的缓解因素
...
#### SQL 缓冲区下溢漏洞 (CVE-2008-4038) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### SQL 缓冲区下溢漏洞 (CVE-2008-4038) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
该漏洞是由于 Microsoft 服务器消息块 (SMB) 协议没有充分验证特制的文件名导致的。
...
**攻击者如何利用此漏洞？**    
恶意客户端上的攻击者可能通过向服务器发送特制数据包来利用此漏洞。 为利用此漏洞，攻击者必须有目标主机的 IP 地址、NetBIOS 计算机名称和端口号才能发送恶意流量。
  
**受此漏洞威胁最大的系统有哪些？**    
允许文件共享的任何 Windows 系统都将受到威胁。
  
**此更新有什么作用？**    
该更新通过添加特殊文件名长度的 SMB 验证来消除漏洞。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB957095$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/957095">Microsoft 知识库文章 957095</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB957095$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/957095">Microsoft 知识库文章 957095</a></td>
...
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">Windows XP Service Pack 2 和 Windows XP Service Pack 3：<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP\SP3\KB957095\Filelist</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB957095$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/957095">Microsoft 知识库文章 957095</a></td>
...
-   [Codenomicon](https://www.codenomicon.com/) 的 Joshua Morin 报告了 SMB Buffer 缓冲区下溢漏洞 (CVE-2008-4038)

...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=9ed29c3a-0682-4586-bbc2-a73deaa18e4c)                                 | 远程执行代码 | 重要         | [MS06-063](http://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2f7e5981-6eef-4f08-86c0-c6a7607ea5d0)                                             | 远程执行代码 | 重要         | [MS06-063](http://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=2f7e5981-6eef-4f08-86c0-c6a7607ea5d0)                                             | 远程执行代码 | 重要         | 无                                                       |
| [Windows XP Professional x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=4e1675eb-6b06-48e9-9765-23a2c7737bdc)                                   | 远程执行代码 | 重要         | [MS06-063](http://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e1675eb-6b06-48e9-9765-23a2c7737bdc)                    | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2003 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=dbbebb3f-f1c7-402c-bd16-6f88da0d042c)                                    | 远程执行代码 | 重要         | [MS06-063](http://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=dbbebb3f-f1c7-402c-bd16-6f88da0d042c)                                    | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2003 x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=989ac6f1-515c-467d-a200-2aabe66d9319)                                       | 远程执行代码 | 重要         | [MS06-063](http://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=989ac6f1-515c-467d-a200-2aabe66d9319)                        | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=91589cfb-15ba-4dd2-9e3b-107899fbcba6)                    | 远程执行代码 | 重要         | [MS06-063](http://go.microsoft.com/fwlink/?linkid=73850) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=91589cfb-15ba-4dd2-9e3b-107899fbcba6)                    | 远程执行代码 | 重要         | 无                                                       |
| [Windows Vista 和 Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=72dd6015-25d1-45f4-a769-88ac43074b44)                         | 远程执行代码 | 重要         | 无                                                       |
| [Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f793af16-5464-4db1-a42b-1c5f17c538ed) | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2008（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=cf6744e6-b54c-40f6-a78d-7ba9453133c0)\*                               | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=223236e8-7b19-4b47-8a90-bfc35eb9318a)\*                          | 远程执行代码 | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=077b697c-04a0-45bd-b08c-331d5c30cb47)                        | 远程执行代码 | 重要         | 无                                                       |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 957095](http://support.microsoft.com/kb/957095) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4038](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4038)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/957095">Microsoft 知识库文章 957095</a></td>
</tr>  
<tr class="even">
...
-   [Codenomicon](http://www.codenomicon.com/) 的 Joshua Morin 报告了 SMB Buffer 缓冲区下溢漏洞 (CVE-2008-4038)

...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d8b085fb-858f-4c7e-96de-edff8f49d62a">Microsoft Office Publisher 2000</a><br />
(KB946255)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=56398">MS06-054</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Microsoft Office XP Service Pack 3</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1135c63a-6ce7-4051-81ba-bfbba8d857fb">Microsoft Office Publisher 2002</a><br />
(KB946216)</td>
<td style="border:1px solid black;">远程执行代码</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=7078b952-09f6-4c47-8c05-40667e1f1c3b">Microsoft Office Publisher 2003 Service Pack 2</a><br />
(KB946254)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=56398">MS06-054</a></td>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0102](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0102)。
...
<tr class="odd">
<td style="border:1px solid black;">更新日志文件</td>
<td style="border:1px solid black;">用户可以通过使用 /log 开关启用详细日志记录。有关详细信息，请参阅 <a href="https://support.microsoft.com/kb/912203">Microsoft 知识库文章 912203</a>。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">更多信息</td>
<td style="border:1px solid black;">请参阅“<strong>检测和部署工具及指导</strong>”小节。
...
-   [Fortinet Security Research](https://www.fortinet.com/) 的 Bing Liu 报告了 Publisher 无效的内存引用漏洞 - CVE-2008-0102。  
-   [Fortinet Security Research](https://www.fortinet.com/) 的 Bing Liu 报告了 Publisher 内存损坏漏洞 - CVE-2008-0104。

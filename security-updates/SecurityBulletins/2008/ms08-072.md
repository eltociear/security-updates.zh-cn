...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4031](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4031)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4837](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4837)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/957173">Microsoft 知识库文章 957173</a></td>
</tr>  
<tr class="even">
...
-   [Core Security Technologies](http://www.coresecurity.com/) 的 Ricardo Narvaja 报告了 Word Word 内存损坏漏洞 (CVE-2008-4024)  
-   [Secunia Research](http://secunia.com/) 的 Dyon Balding 报告了 Word RTF 对象分析漏洞 (CVE-2008-4025)  
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) 的 Yamata Li 报告了 Word 内存损坏漏洞 (CVE-2008-4026)  
-   Wushi 与 [Tipping Point](http://www.tippingpoint.com/) 和 [Zero Day Initiativ](http://www.zerodayinitiative.com/)e 一起报告了 Word RTF 对象分析漏洞 (CVE-2008-4027)  
-   [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/) 的 Aaron Portnoy 报告了 Word RTF 对象分析漏洞 (CVE-2008-4030)  
-   [team509](http://www.team509.com/) 的 Wushi 与 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，报告了 Word RTF 对象分析漏洞 - (CVE-2008-4028)  
-   [TippingPoint DVLabs](http://dvlabs.tippingpoint.com/) 的 Aaron Portnoy 报告了 Word RTF 对象分析漏洞 (CVE-2008-4031)  
-   Wushi 和 Ling 与 [Tipping Point](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 Word 内存损坏漏洞 (CVE-2008-4837)

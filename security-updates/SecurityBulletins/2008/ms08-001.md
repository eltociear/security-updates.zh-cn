---
TOCTitle: 'MS08-001'
Title: 'Microsoft 安全公告 MS08-001 - 严重'
ms:assetid: 'ms08-001'
ms:contentKeyID: 61237126
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-001(v=Security.10)'
---
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=980f5457-c7b5-421c-8643-0e57429ec156)                                                   | 拒绝服务     | 中等             | [MS06-032](https://technet.microsoft.com/security/bulletin/ms06-032) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=0a766242-2342-4fa0-9b66-8953c54a2211)                                                               | 远程执行代码 | 严重             | [MS06-032](https://technet.microsoft.com/security/bulletin/ms06-032) |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2e8bc7d5-fe81-4ed5-9efa-360738d160ee)                 | 远程执行代码 | 严重             | [MS06-032](https://technet.microsoft.com/security/bulletin/ms06-032) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=fda060a5-9a1e-4036-9899-13eb61fdd8be)                | 远程执行代码 | 重要             | [MS06-032](https://technet.microsoft.com/security/bulletin/ms06-032) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=19d993f9-06dd-4dc4-b0cc-c59e822eb8fa)                         | 远程执行代码 | 重要             | [MS06-032](https://technet.microsoft.com/security/bulletin/ms06-032) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=2c2264f7-ebbb-40ab-9dbf-9b4e313665a7) | 远程执行代码 | 重要             | [MS06-032](https://technet.microsoft.com/security/bulletin/ms06-032) |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=23c0e03a-db66-4618-bce0-af55e5c1b067)                                                                           | 远程执行代码 | 严重             | 无                                                                  |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=5f6a37b1-c604-47c9-932f-485db2eda133)                                                                                 | 远程执行代码 | 严重             | 无                                                                  |
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 内核 TCP/IP/IGMPv3 和 MLDv2 漏洞 CVE-2007-0069</th>
<th>Windows 内核 TCP/IP/ICMP 漏洞 CVE-2007-0066</th>
<th>综合严重程度等级</th>
</tr>
</thead>
<tbody>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-0069](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0069)。
...
**什么是 MLD？**  
多播侦听程序发现 (MLD) 使您能够管理 IPv6 的子网多播成员身份。MLD 是一个系列，包括 IPv6 消息的三个 Internet 控制消息协议 (ICMPv6)，取代用于 IPv4 的 Internet 组管理协议 (IGMP)。请参阅 MSDN 网站上关于 [MLD](https://msdn2.microsoft.com/en-us/library/ms882958.aspx) 的详细信息。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-0066](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0066)。
  
#### Windows 内核 TCP/IP/ICMP 漏洞 (CVE-2007-0066) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   默认情况下不启用路由器发现协议 (RDP)，利用此漏洞需要该协议。 有关详细信息，请参阅 [Microsoft 知识库文章 269734](https://technet2.microsoft.com/windowsserver/en/library/db56b4d4-a351-40d5-b6b1-998e9f6f41c91033.mspx?mfr=true)“默认情况下禁用路由器发现协议”。  
...
-   **禁用路由器发现协议处理**
    ...
    **注意** 我们建议在编辑注册表之前先对其进行备份。
    ...
    5.  选择 **interface\_name** 并将 **PerformRouterDiscovery** 值设置为 **0**。
...
**什么是 ICMP？**  
Internet 控制消息协议 (ICMP) 是用于管理连接和路由的维护协议。 有关 ICMP 的功能和实现的详细信息，请参阅 [RFC 792： Internet 控制消息协议 DARPA Internet 程序协议规范](https://www.ietf.org/rfc/rfc0792.txt?number=792)。
...
| Windows Vista                                                                                             | 否      | 请参阅下面的 **Windows** **Vista** 注释 | 是        |  
| Windows Vista x64 Edition                                                                                 | 否      | 请参阅下面的 **Windows** **Vista** 注释 | 是        |
...
<td style="border:1px solid black;">Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB941644$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
...
<p>Windowsserver2003.WindowsXP-kb941644-x86-enu /quiet</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">在不重新启动的情况下安装</td>
<td style="border:1px solid black;">Windows XP Service Pack 2：<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2：
<p>Windowsserver2003.WindowsXP-kb941644-x86-enu /norestart</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">更新日志文件</td>
<td style="border:1px solid black;">Windows XP Service Pack 2：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB941644$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关完整的文件清单，请参阅下一小节“<strong>文件信息</strong>”。</td>
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2003 的 32 位版本：<br />
Windowsserver2003-kb941644-x86-enu /quiet<br />
</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 的基于 x64 的版本：<br />
Windowsserver2003.WindowsXP-kb941644-x64-enu /quiet<br />
</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 的基于 Itanium 的版本：<br />
...
<p>Windows6.0-KB941644-x86 /quiet</p>  
<p>Windows Vista 所有受支持的基于 x64 的版本：</p>
<p>Windows6.0-KB941644-x64 /quiet</p></td>
</tr>
<tr class="even">
<td style="border:1px solid black;">在不重新启动的情况下安装</td>
<td style="border:1px solid black;">Windows Vista 所有受支持的 32 位版本：
<p>Windows6.0-KB941644-x86 /norestart</p>  
<p>Windows Vista 所有受支持的基于 x64 的版本：</p>
<p>Windows6.0-KB941644-x64 /norestart</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">更多信息</td>
<td style="border:1px solid black;">请参阅“<strong>检测和部署工具及指导</strong>”小节</td>
...
-   [IBM Internet Security Systems X-Force](https://www.iss.net/) 的 Alex Wheeler 和 Ryan Smith 报告了 Windows 远程内核 TCP/IP IGMP 漏洞 (CVE-2007-0069)。  
-   [IBM Internet Security Systems X-Force](https://www.iss.net/) 的 Alex Wheeler 和 Ryan Smith 报告了 Windows 远程内核 TCP/IP ICMP 漏洞 (CVE-2007-0066))。

---
TOCTitle: 'MS08-022'
Title: 'Microsoft 安全公告 MS08-022 - 严重'
ms:assetid: 'ms08-022'
ms:contentKeyID: 61237146
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-022(v=Security.10)'
---

Microsoft 安全公告 MS08-022 - 严重
==================================
...
这是 Microsoft Windows 2000、Windows XP 和 Windows Server 2003 所有受支持版本的重要安全更新。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过修改 VBScript 和 JScript 引擎解码网页中的脚本的方式来消除此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|-----------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4                                                                     | [VBScript 5.1 和 JScript 5.1](https://www.microsoft.com/download/details.aspx?familyid=8e3ff44f-145b-4a68-9ad4-4a55d74b216e) | 远程执行代码 | 严重         | [MS06-023](https://go.microsoft.com/fwlink/?linkid=66975) |
| Microsoft Windows 2000 Service Pack 4                                                                     | [VBScript 5.6 和 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=8e3ff44f-145b-4a68-9ad4-4a55d74b216e) | 远程执行代码 | 严重         | [MS06-023](https://go.microsoft.com/fwlink/?linkid=66975) |
| Windows XP Service Pack 2                                                                                 | [VBScript 5.6 和 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=c0124698-3b94-4474-9473-22a2f39a4a56) | 远程执行代码 | 严重         | [MS06-023](https://go.microsoft.com/fwlink/?linkid=66975) |
| Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2                 | [VBScript 5.6 和 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=87b80ae3-e299-4d15-a135-3b1bcf943652) | 远程执行代码 | 严重         | [MS06-023](https://go.microsoft.com/fwlink/?linkid=66975) |
| Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2                                  | [VBScript 5.6 和 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=88518aa6-e334-4529-aa63-0bf2ef417ce3) | 远程执行代码 | 严重         | [MS06-023](https://go.microsoft.com/fwlink/?linkid=66975) |
| Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2                         | [VBScript 5.6 和 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=12cefefc-8553-4dca-9850-c653371de61e) | 远程执行代码 | 严重         | [MS06-023](https://go.microsoft.com/fwlink/?linkid=66975) |
| Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统） | [VBScript 5.6 和 JScript 5.6](https://www.microsoft.com/download/details.aspx?familyid=fe22a828-cca4-4b51-bbd5-995c65fead21) | 远程执行代码 | 严重         | [MS06-023](https://go.microsoft.com/fwlink/?linkid=66975) |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 944338](https://support.microsoft.com/kb/944338) 中找到文件信息详细资料。

**我正在使用 JScript 5.1 和/或 VBScript 5.1。我是否会受到影响？**  
是的，您的软件会受到影响。 此更新将适用于您的软件，并将版本级别更改为 JScript 5.6 和/或 VBScript 5.6。[Microsoft 知识库文章 944338](https://support.microsoft.com/kb/944338) 中的文件信息将适用于您。

**我正在使用本安全公告中讨论的早于 JScript 5.1 和 VBScript 5.1 的软件版本。 我该怎么办？**  
...
<th>
VBScript 和 JScript 远程执行代码漏洞 - CVE-2008-0083
</th>
<th>
综合严重等级
</th>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 上的 VBScript 5.6
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 1 或 Windows Server 2003 Service Pack 2 上的 VBScript 5.6
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 和 Windows 2003 Server x64 Edition Service Pack 2 上的 VBScript 5.6
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 SP1（用于基于 Itanium 的系统）和 Windows Server 2003 SP2（用于基于 Itanium 的系统）上的 VBScript 5.6
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 上的 JScript 5.6
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 1 或 Windows Server 2003 Service Pack 2 上的 JScript 5.6
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition 和 Windows 2003 Server x64 Edition Service Pack 2 上的 JScript 5.6
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 SP1（用于基于 Itanium 的系统）和 Windows Server 2003 SP2（用于基于 Itanium 的系统）上的 JScript 5.6
</td>
<td style="border:1px solid black;">
**严重**  
远程执行代码
...
VBScript/JScript 远程执行代码漏洞 - CVE-2008-0083
-------------------------------------------------
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0083](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0083)。

#### VBScript/JScript 远程执行代码漏洞 (CVE-2008-0083) 的缓解因素
...
-   带有 Internet Explorer 7（随 VBScript.dll 5.7 版和 JScript.dll 5.7 版提供）的系统不受此漏洞的影响。
-   默认情况下，Windows Server 2003 上的 Internet Explorer 在一种称为“[增强安全配置](https://msdn2.microsoft.com/en-us/library/ms537180.aspx)”的受限模式下运行。 此模式会将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题”部分。

#### VBScript/JScript 远程执行代码漏洞 (CVE-2008-0083) 的变通办法
...
-   注销 VBScript.Encode 和 JScript.Encode COM 对象。
    **警告** 如果注册表编辑器使用不当，则可能导致严重的问题，也许会要求您重新安装操作系统。 Microsoft 不保证能够解决因注册表编辑器使用不当而导致的问题。 使用注册表编辑器的风险由您自己承担。 有关如何编辑注册表的信息，请查看注册表编辑器 (Regedit.exe) 中的“更改项和值”帮助主题，或查看 Regedt32.exe 中的“在注册表中添加和删除信息”和“编辑注册表数据”帮助主题。
    ...
    -   使用交互方法：
        ...
        4.  单击“**文件**”，并选择“**导出**”。
        5.  在“导出注册表文件”对话框中，键入 **vvbscript\_encode\_configuration\_backup.reg** 
            ，然后单击“**保存**”。
        6.  按 **Delete**。
        7.  单击“**确定**”。
        8.  对于 **JScript.Encode** 重复步骤 3 至 7。
        9.  关闭 Internet Explorer 的任何打开实例。
    -   使用被管理的部署脚本：
        ...
        2.  接下来，将下列内容保存到扩展名为 .REG 的文件，例如 Disable\_vbscript\_and\_jscript\_encode.reg：
    ...
    **变通办法的影响。** 编码的脚本无法正常工作，但是常规脚本将继续工作。
...
#### VBScript/JScript 远程执行代码漏洞 (CVE-2008-0083) 的常见问题
...
**造成漏洞的原因是什么？**  
漏洞是由 VBScript 和 JScript 脚本引擎解码网页中的脚本以允许脚本加载到内存中运行造成的。

**什么是脚本解码？**  
Web 设计人员在网页和服务器 Active Server Pages (.ASP) 上使用脚本来为网页添加功能。 Web 设计人员还会对这些脚本进行编码，使得用户难以读取页面中嵌入的脚本或复制脚本并根据个人用途对其进行改编。 当脚本需要运行时，脚本引擎会对脚本进行解码以便将脚本加载到内存。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
...
**受此漏洞威胁最大的系统有哪些？**  
客户端或使用 Internet Explorer 浏览网页的系统以及使用低于 5.6.0.8835 的 VBScript.dll 和 JScript.dll 版本的系统受到的威胁最大。

**我当前是在 Windows Server 2003 上运行的 Internet Explorer，这是否可以缓解此漏洞的影响？**  
...
Internet Explorer [增强安全配置](https://msdn2.microsoft.com/en-us/library/ms537180.aspx)是一组预先配置的 Internet Explorer 设置，可以降低用户或管理员在服务器上下载并运行特制 Web 内容的可能性。 Internet Explorer 增强安全配置通过修改许多与安全有关的设置降低此风险。 这些设置包括“**Internet 选项**”对话框中的“**安全**”和“**高级**”选项卡设置。 一些重要的修改包括：
...
有关 Internet Explorer 增强安全配置的详细信息，请参阅指南[管理 Internet Explorer 增强安全配置](https://www.microsoft.com/download/details.aspx?familyid=d41b036c-e2e1-4960-99bb-9757f7e9e31b&displaylang=en)。

**此更新有什么作用？**  
此安全更新通过修改 VBScript 和 JScript 引擎解码网页中的脚本的方式来消除此漏洞。 VBScript 脚本引擎被命名为 VBScript.dll；JScript 脚本引擎被命名为 JScript.dll。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB944338$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/944338">Microsoft 知识库文章 944338</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB944338$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/944338">Microsoft 知识库文章 944338</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">HotPatching</td>
<td style="border:1px solid black;">此安全更新不支持 HotPatching。 有关 HotPatching 的详细信息，请参阅 <a href="https://support.microsoft.com/kb/897341/en-us">Microsoft 知识库文章 897341</a>。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB944338$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/944338">Microsoft 知识库文章 944338</a></td>
...
-   [Symantec](https://www.symantec.com/) 的 Peter Ferrie 报告了 VBScript/Jscript 缓冲区溢出漏洞 (CVE-2008-0083)。

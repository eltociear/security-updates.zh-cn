...
|----------------------------------------------|-------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| Microsoft Windows 2000 Server Service Pack 4 | [Active Directory](https://www.microsoft.com/download/details.aspx?familyid=8ed7bb9a-4b26-49d7-8c14-60226d2bc20d) | 远程执行代码 | 严重         | [MS08-035](https://go.microsoft.com/fwlink/?linkid=111953) |
...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 957280](https://support.microsoft.com/kb/957280) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4023](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4023)。
  
#### Active Directory 溢出漏洞 (CVE-2008-4023) 的缓解因素
...
**什么是 LDAP？**    
轻型目录访问协议 ([LDAP](https://msdn2.microsoft.com/en-us/library/aa503238.aspx)) 是旨在提供对分布式目录访问的一种开放网络协议标准。
  
**什么是 LDAP over SSL？**    
默认情况下，LDAP 流量被不安全地进行传输。 但是，可以使用安全套接字层 (SSL)/传输层安全性 (TLS) 技术确保 LDAP 流量的机密性和安全性。 管理员可以按照 [Microsoft 知识库文章 321051](https://support.microsoft.com/kb/321051/en-us) 中的指南，通过从 Microsoft 证书颁发机构 (CA) 或非 Microsoft CA 安装正确设置了格式的证书来启用 LDAP over SSL (LDAPS)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/957280">Microsoft 知识库文章 957280</a></td>
</tr>  
<tr class="even">
...
-   [nCircle](https://www.ncircle.com/) 的 Paul Miseiko 报告了 Active Directory 溢出漏洞 (CVE-2008-4023)

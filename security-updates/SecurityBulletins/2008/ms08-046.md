---
TOCTitle: 'MS08-046'
Title: 'Microsoft 安全公告 MS08-046 - 严重'
ms:assetid: 'ms08-046'
ms:contentKeyID: 61237170
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-046(v=Security.10)'
---
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=db455d17-435f-46d7-b2dd-5babb5a1eeb3)                                                   | 远程执行代码 | 严重         | 无               |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=d313f42c-f43f-48ea-82ef-3bc33077c7fa)                                                    | 远程执行代码 | 严重         | 无               |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=3150c6b8-f50b-4b84-a7ce-c8daf77c080c)                 | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=828d8fdc-8534-4621-85a5-08aec255496f)                | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0a13776f-d543-41df-b904-d51e368c81cc)                         | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=9566493f-4260-4072-947a-527887d2cd63) | 远程执行代码 | 严重         | 无               |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 952954](https://support.microsoft.com/kb/952954) 中找到文件信息详细资料。
...
<tr class="header">
<th>受影响的软件</th>
<th>Microsoft 颜色管理系统漏洞 - CVE-2008-2245</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Microsoft 颜色管理系统漏洞 - CVE-2008-2245  
------------------------------------------
  
  
Microsoft ICM 组件的 Microsoft 颜色管理系统 (MSCMS) 模块处理内存分配的方式中存在一个远程执行代码漏洞。 如果用户打开特制的图像文件，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2245](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2245)。
  
#### Microsoft 颜色管理系统漏洞 (CVE-2008-2245) 的缓解因素
...
#### Microsoft 颜色管理系统漏洞 (CVE-2008-2245) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **通过修改注册表禁用元文件处理**  
    应用了 MS07-017 的客户可以通过修改注册表禁用元文件处理。 此设置将帮助防止受影响的系统尝试利用此漏洞。
...
#### Microsoft 颜色管理系统漏洞 (CVE-2008-2245) 的常见问题
...
**造成漏洞的原因是什么？**    
漏洞是由 Microsoft ICM 组件的 Microsoft 颜色管理系统 (MSCMS) 模块为特制图像文件不正确地分配内存时出现的堆溢出导致的。
  
**什么是 ICM？**    
图像颜色管理 (ICM) 是一个分析和使用 ICC 配置文件中的数据以执行颜色转换操作的颜色管理系统。 对内容出版商而言，要使各种显示和输出类型的颜色一致可能会很困难。 例如，在出版行业，整个商业出版过程的颜色一致既能节省时间又省钱。 设计人员想确保其客户的打印资料与它送到服务机构、商贸店和打印机有同样的效果，并且在 Internet 上获取该资料时也有不错的效果。 由于相关设备或媒体的限制，大多数情况下，颜色空间、整个范围和整个曲线图出现差异是不可避免的。 但是，使用目前市场上提供的任意一款软件和硬件产品均可测试出这些差异，并将其记录在 ICC 配置文件中。 然后，这些 ICC 配置文件用于通过其余的 ICM 系统进行通信，以确保颜色准确呈现给用户，无论他们使用哪种设备。 有关 ICM 的详细信息，请访问下列 [Microsoft 网站](https://www.microsoft.com/whdc/archive/icmwp.mspx)。
...
在电子邮件攻击情形中，攻击者可以通过向用户发送特制的图像文件或者其中嵌入了特制图像文件的 Office 文档，并诱使用户打开文档或查看内含特制图像文件的电子邮件来利用此漏洞。
  
在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的图像文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问特制的网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
  
**受此漏洞威胁最大的系统有哪些？**    
工作站和终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法强烈反对授予这样的权限。
  
**此更新有什么作用？**    
此安全更新通过修改 Microsoft 颜色管理系统 (MSCMS) 分配内存以处理图像文件的方式来消除此漏洞。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB952954$Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/952954">Microsoft 知识库文章 952954</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB952954$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/952954">Microsoft 知识库文章 952954</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB952954$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/952954">Microsoft 知识库文章 952954</a></td>
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Jun Mao 报告了 Microsoft 颜色管理系统漏洞 (CVE-2008-2245)

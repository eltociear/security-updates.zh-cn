...
**已知问题。** [Microsoft 知识库文章 953230](https://support.microsoft.com/kb/953230) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=269c219c-9d6b-4b12-b621-c70cd07cdd22">Microsoft Windows 2000 Service Pack 4</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=332aa92f-a1ad-42a0-87d0-485d2d41335b">Microsoft Windows 2000 Server Service Pack 4</a></td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=99391">MS07-062</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ed989a33-7a9e-4423-93a8-b38907467cdf">Windows XP Service Pack 2</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=ed989a33-7a9e-4423-93a8-b38907467cdf">Windows XP Service Pack 3</a></td>
<td style="border:1px solid black;">不适用</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4ef5033c-9843-4e0b-bfad-fcaf05d7dab9">Windows Server 2003 Service Pack 1</a></td>
<td style="border:1px solid black;">请参见下面的行</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=73864">MS06-064</a>,<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=4ef5033c-9843-4e0b-bfad-fcaf05d7dab9">Windows Server 2003 Service Pack 2</a></td>
<td style="border:1px solid black;">请参见下面的行</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=104919">MS08-001</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">请参见上面的行</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=d1fcb794-e6a5-4c28-b3b3-9cd88f468a42">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2</a></td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=99391">MS07-062</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=66624a1f-38bf-4af7-936d-3131474ffe1f">Windows Server 2003 x64 Edition</a></td>
<td style="border:1px solid black;">请参见下面的行</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=73864">MS06-064</a>,<br />
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=66624a1f-38bf-4af7-936d-3131474ffe1f">Windows Server 2003 x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">请参见下面的行</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=104919">MS08-001</a></td>
...
<tr class="even">
<td style="border:1px solid black;">请参见上面的行</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=040a1ba8-21b0-439e-bf21-1acd1c43b162">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2</a></td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=99391">MS07-062</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=facc80da-61d6-49c5-872d-a1980b66ae3e">Windows Server 2003 SP1（用于基于 Itanium 的系统）</a></td>
<td style="border:1px solid black;">请参见下面的行</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=73864">MS06-064</a>,<br />
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=facc80da-61d6-49c5-872d-a1980b66ae3e">Windows Server 2003 SP2（用于基于 Itanium 的系统）</a></td>
<td style="border:1px solid black;">请参见下面的行</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=104919">MS08-001</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">请参见上面的行</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c63e3ee6-6055-4313-b0f1-fec7408886bb">Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）</a></td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=99391">MS07-062</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">不适用</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=1fcea8f4-b233-42e1-b913-c4fcae276c7b">Windows Server 2008（用于 32 位系统）</a>\*</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">不适用</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=afac5bbc-71fa-457b-8b0a-f5902d37bfd0">Windows Server 2008（用于基于 x64 的系统）</a>\*</td>
<td style="border:1px solid black;">欺骗</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
-   **客户在安装此更新之后可能遇到的端口冲突问题是什么？**  
    如果 DNS 服务器执行其他服务，这些服务需要静态 UDP 端口，这些端口在 DNS 服务器为其套接字池分配的端口范围内，那么 DNS 服务器可能会遇到端口冲突而导致服务失败。 有关详细信息，[Microsoft 知识库文章 953230](https://support.microsoft.com/kb/953230) 说明了客户在安装此安全更新时可能遇到的当前已知问题。  
-   **SBS 客户在安装此更新之后可能遇到的问题是什么？**  
    Windows Small Business Server (SBS) 2003 的受支持版本包含与 Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 相同的受影响代码。但是，SBS 系统在安装此公告中提供的 DNS 服务器安全更新之后可能遇到服务失败或无法正常工作。 有关详细信息，[Microsoft 知识库文章 953230](https://support.microsoft.com/kb/953230) 说明了客户在安装此安全更新时可能遇到的当前已知问题。  
-   **外围防火墙和外围 NAT 设备在安装此更新之后可能遇到的问题是什么？**  
    在基于 Windows 的计算机上安装此公告提供的安全更新之后，来自跨越防火墙的主机的 DNS 查询可能无法再使用随机源端口。 有关详细信息，[Microsoft 知识库文章 953230](https://support.microsoft.com/kb/953230) 说明了客户在安装此安全更新时可能遇到的当前已知问题。
  
**为什么在 2008 年 7 月 23 日修订此安全公告？**  
Microsoft 已修订此安全公告，将 MS06-064、MS07-062 和 MS08-001 列为此更新替代的公告。
  
**为什么在 2008 年 7 月 10 日修订此安全公告？**  
Microsoft 修订此安全公告旨在通知使用 [Check Point Software Technologies Ltd.](https://www.checkpoint.com/) 的 ZoneAlarm 和 Check Point Endpoint Security（以前称为 Check Point Integrity）的用户，有关以下常见问题中详细说明的 Internet 连接问题。 修订版本不会更改本公告中的安全更新文件。 已经应用了更新的客户不必重新应用该更新。 但是，使用 Check Point 提供的上述软件的用户应阅读以下常见问题以获得进一步指导。
  
**安装此更新后，ZoneAlarm 和 Check Point Endpoint Security 的用户可能会遇到什么问题？**  
Microsoft 获悉的最新报告显示，使用 Check Point Software Technologies Ltd. 提供的 ZoneAlarm 和 Check Point Endpoint Security（以前称为 Check Point Integrity）的用户在应用本安全公告 MS08-037 提供的安全更新后遇到 Internet 连接问题。Microsoft 将与 Check Point 继续调查此问题。 Microsoft 鼓励 [ZoneAlarm](https://download.zonealarm.com/bin/free/pressreleases/2008/lossofinternetaccessissue.html) 和 Check Point Endpoint Security 的用户查看适当的 [Check Point](https://supportcenter.checkpoint.com/supportcenter/index.jsp) 网站和本安全公告，以获得最新指导或软件更新。
...
受支持版本的 Microsoft Windows 2000 和 Windows 2003 系统将收到 DNS 服务器和 DNS 客户端更新。 DNS 服务器更新和 DNS 客户端更新共享二进制文件，卸载顺序必须与安装顺序相反，以避免共享的二进制文件回归到之前的版本。 [Microsoft 知识库文章 823836](https://support.microsoft.com/kb/823836) 介绍了客户在卸载这些安全更新时可能遇到的当前已知问题。
...
**定义套接字池范围是什么？**  
定义 DNS 能够从其中选择的套接字范围可能是避免与其他在通信时需要相同套接字池的应用程序或服务发生冲突所必需的。 请参阅 [MaxUserPort](https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/regentry/58791.mspx?mfr=true) 和 [Microsoft 知识库文章 812873](https://support.microsoft.com/kb/812873) 以了解有关这些注册表项注册的更多信息。
  
**定义套接字池范围时操作系统之间的差异是什么？**  
MaxUserPort 注册表项在 Windows Vista 和 Windows Server 2008 上的含义与其在 Microsoft Windows Server 2000 和 Windows Server 2003 上的含义不同。[Microsoft 知识库文章 929851](https://support.microsoft.com/kb/929851) 详细说明了 Windows Vista 和 Windows Server 2008 在操作上的变化。
  
在 Microsoft Windows Server 2000 和 Windows Server 2003 中，设置 MaxUserPort 定义了动态端口范围的结束点。 范围始于 1024，一直继续到用户在 MaxUserPort 注册表项设置中定义的值。 在安装由安全公告提供的更新后，Microsoft Windows Server 2000 和 Windows Server 2003 上的默认行为将从 49152 至 65535 的端口范围随机分配套接字。如果已定义 MaxUserPort 范围，则将从 1024 到在 MaxUserPort 注册表项设置中定义的值之间随机分配端口。 有关在 Microsoft Windows 2000 服务器和 Windows Server 2003 上保留端口范围的详细信息，请访问 [Microsoft 知识库文章 812873](https://support.microsoft.com/kb/812873)。
...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 953230](https://support.microsoft.com/kb/953230) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1447](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1447)。
...
**什么是域名系统 (DNS)？**  
域名系统 (DNS) 是一套包含 TCP/IP 的行业标准协议的其中之一。 DNS 是通过使用两个软件组件来实现的： DNS 服务器和 DNS 客户端（或者解析器）。 两个组件是作为背景服务应用程序运行。 网络资源是由数字 IP 地址标识，但是这些 IP 地址让网络用户很难记住。 DNS 数据库包含将网络资源的用户友好字母数字名称（例如 www.microsoft.com）映射到这些资源用于通信的 IP 地址的记录。 因此，DNS 便充当一个助记键设备，使网络资源更容易被网络用户记住。 有关更多信息以及查看说明 DNS 如何适合其他 Windows 技术的逻辑图表，请阅读文章“[什么是 DNS](https://technet2.microsoft.com/windowsserver/en/library/ff937311-03ce-4d04-b72c-b39c4d51cb361033.mspx)”。
  
**DNS 缓存是什么？**  
域名系统 (DNS) 缓存解析程序服务是保存 DNS 查询响应的一项服务，这样 DNS 服务器就不必重复查询相同的信息。 有关详细信息，请参阅 [DNSCache](https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/regentry/30643.mspx?mfr=true) Technet 文章或者 [DNS 解析程序缓存服务](https://www.microsoft.com/technet/prodtechnol/windows2000serv/reskit/cnet/cnbc_imp_qxht.mspx?mfr=true) Technet 文章。 有关 DNS 缓存中毒的更多信息，请参阅[攻击检测](https://www.microsoft.com/technet/isa/2004/help/fw_alertattack.mspx?mfr=true)的 TechNet 文章。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1454](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1454)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/953230">Microsoft 知识库文章 953230</a></td>
</tr>  
<tr class="even">
...
-   [IOActive](https://www.ioactive.com/) 的 Dan Kaminsky 报告了 DNS 套接字加密不充分的漏洞 (CVE-2008-1447)

---
TOCTitle: 'MS08-064'
Title: 'Microsoft 安全公告 MS08-064 - 重要'
ms:assetid: 'ms08-064'
ms:contentKeyID: 61237437
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-064(v=Security.10)'
---
...
对于 Windows XP、Windows Server 2003、Windows Vista 和 Windows Server 2008 的所有受支持版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节的“**受影响和不受影响的软件**”小节。

此安全更新通过修改虚拟地址描述符处理内存分配变量的方式来解决该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------------------|
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c)                                                                                 | 特权提升     | 重要         | [MS07-022](https://go.microsoft.com/fwlink/?linkid=85165)              |
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=25997b73-a640-49c1-b19e-768a18bbe22c)                                                                                 | 特权提升     | 重要         | 无                                                                    |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=50fae854-0bde-46f8-9444-b9e0d9bfecad)                 | 特权提升     | 重要         | [Microsoft 安全通报 (932596)](https://support.microsoft.com/kb/932596) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=e8ef3d5f-dd8e-4945-92cd-9d3e30b16667)                                  | 特权提升     | 重要         | [MS07-022](https://go.microsoft.com/fwlink/?linkid=85165)              |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=c2e754f9-086a-494c-bc19-5feed7df8b65)                         | 特权提升     | 重要         | [Microsoft 安全通报 (932596)](https://support.microsoft.com/kb/932596) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=5a3832ec-3f8f-42c1-a603-b1330d527547) | 特权提升     | 重要         | 无                                                                    |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2)                                                                                             | 特权提升     | 重要         | [MS07-066](https://go.microsoft.com/fwlink/?linkid=104898)             |
| [Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=b4212db5-093e-497d-b999-2e3780f9f7c2)                                                                              | 特权提升     | 重要         | 无                                                                    |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3)                                                                                 | 特权提升     | 重要         | [MS07-066](https://go.microsoft.com/fwlink/?linkid=104898)             |
| [Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=c20808cb-c30a-4b53-91e5-810eb6b4b2e3)                                                                  | 特权提升     | 重要         | 无                                                                    |
| [Windows Server 2008（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=ec9eeb82-0497-4c55-94bb-9a47cb3521b4)\*                                                                   | 特权提升     | 重要         | 无                                                                    |
| [Windows Server 2008（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=0bc178b8-f8ae-4f41-8f88-fb6a75be1bca)\*                                                              | 特权提升     | 重要         | 无                                                                    |
| [Windows Server 2008（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=0af72663-4945-4916-8c55-090ba4d82793)                                                            | 特权提升     | 重要         | 无                                                                    |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 956841](https://support.microsoft.com/kb/956841) 中找到文件信息详细资料。
...
<tr class="header">
<th>受影响的软件</th>
<th>虚拟地址描述符特权提升漏洞 - CVE-2008-4036</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
虚拟地址描述符特权提升漏洞 - CVE-2008-4036  
------------------------------------------
  
  
内存管理器处理内存分配和虚拟地址描述符 (VADs) 的方式中存在一个特权提升漏洞。 如果经过身份验证的攻击者在受影响的系统上允许特制的程序，此漏洞可能允许特权提升。 成功利用此漏洞的攻击者可以在受影响的系统上获得特权提升。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4036](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4036)。
  
#### 虚拟地址描述符特权提升漏洞 (CVE-2008-4036) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须经过身份验证才能利用此漏洞。
  
#### 虚拟地址描述符特权提升漏洞 (CVE-2008-4036) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### 虚拟地址描述符特权提升漏洞 (CVE-2008-4036) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可以在受影响的系统上获得特权提升。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**造成漏洞的原因是什么？**    
内存管理器在递减某个变量时未正确处理整数溢出，从而导致了内存分配映射错误。
  
**什么是虚拟地址描述符？**    
VAD 是应用程序的一种虚拟内存形式，它让每个应用程序都有其自己的专用地址空间。 有关 VAD 的详细信息，请参阅 MSDN 文章 [Windows NT 中的虚拟内存管理器](https://msdn.microsoft.com/en-us/library/ms810616.aspx)和[Win32 中的虚拟内存管理](https://msdn.microsoft.com/en-us/library/ms810616.aspx)。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以在受影响的系统上获得特权提升。 攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。
  
**攻击者如何利用此漏洞？**    
经过身份验证的攻击者可能运行会导致整数溢出的特制程序，从而破坏内存并允许执行代码。
  
**受此漏洞威胁最大的系统有哪些？**    
Windows XP、Windows Server 2003、Windows Vista 和 Windows Server 2008 均受此漏洞的威胁。
  
**此更新有什么作用？**    
此漏洞是由整数溢出引起的。 此更新通过添加对 VAD 参数的附加验证来消除此漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB956841$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/956841">Microsoft 知识库文章 956841</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB956841$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/956841">Microsoft 知识库文章 956841</a></td>

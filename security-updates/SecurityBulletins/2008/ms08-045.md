---
TOCTitle: 'MS08-045'
Title: 'Microsoft 安全公告 MS08-045 - 严重'
ms:assetid: 'ms08-045'
ms:contentKeyID: 61237169
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-045(v=Security.10)'
---
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 5.01 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=1557b93b-ecba-4f42-b89d-db0ee067d65b)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[MS08-031](https://go.microsoft.com/fwlink/?linkid=122772)
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6 Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=aa780735-5928-4c46-89a4-63a814954796)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=69af2f30-138e-4b15-ab8d-4fce44cc0bc2)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=4780b89e-9735-4d3f-8def-34e7337ff604)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=0617a5dd-dce9-4de0-b0a0-ce38efe13524)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=8e2125c7-52cb-4052-82a3-2d3c6a953752)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=b3c2e2fd-1cb9-491b-937c-053dd59a65bf)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=13cba012-dd20-48f9-8e44-e4cb104c4cad)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 953838](https://support.microsoft.com/kb/953838) 中找到文件信息详细资料。
...
<tr class="header">
<th>受影响的软件</th>
<th>HTML 对象内存损坏漏洞 - CVE-2008-2254</th>
<th>HTML 对象内存损坏漏洞 - CVE-2008-2255</th>
<th>未初始化的内存损坏漏洞 - CVE-2008-2256</th>
<th>HTML 对象内存损坏漏洞 - CVE-2008-2257</th>
<th>HTML 对象内存损坏漏洞 - CVE-2008-2258</th>
<th>HTML 组件处理漏洞 - CVE-2008-2259</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2254](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2254)。
  
#### HTML 对象内存损坏漏洞 (CVE-2008-2254) 的缓解因素
...
#### HTML 对象内存损坏漏洞 (CVE-2008-2254) 的变通办法
...
#### HTML 对象内存损坏漏洞 (CVE-2008-2254) 的常见问题
...
HTML 对象内存损坏漏洞 - CVE-2008-2255  
-------------------------------------
  
  
由于在特定情形下尝试访问未初始化的内存，Internet Explorer 中存在远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2255](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2255)。
  
#### HTML 对象内存损坏漏洞 (CVE-2008-2255) 的缓解因素
...
#### HTML 对象内存损坏漏洞 (CVE-2008-2255) 的常见问题
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 CVE-2008-2255。
  
**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已被公开用于攻击客户的信息，也没有看到任何发布的概念代码证明示例。
  
未初始化的内存损坏漏洞 - CVE-2008-2256  
--------------------------------------
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2256](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2256)。
  
#### 未初始化的内存损坏漏洞 (CVE-2008-2256) 的缓解因素
  
-   无
  
#### 未初始化的内存损坏漏洞 (CVE-2008-2256) 的变通办法
  
-   无
  
#### 未初始化的内存损坏漏洞 (CVE-2008-2256) 的常见问题
...
HTML 对象内存损坏漏洞（CVE-2008-2257 和 CVE-2008-2258）的常见问题：  
-------------------------------------------------------------------
  
  
由于在特定情形下尝试访问未初始化的内存，Internet Explorer 中存在远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2257) 和 [CVE-2008-2258](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2258)。
  
#### HTML 对象内存损坏漏洞（CVE-2008-2257 和 CVE-2008-2258）的缓解因素：
...
#### HTML 对象内存损坏漏洞（CVE-2008-2257 和 CVE-2008-2258）的变通办法：
...
HTML 组件处理漏洞 - CVE-2008-2259  
---------------------------------
  
  
Internet Explorer 在打印预览处理过程中处理参数验证的方式中存在一个远程执行代码漏洞。 攻击者可以通过构建特制的网页来利用该漏洞。 当用户查看网页时，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以获得与登录用户相同的权限。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2259](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2259)。
  
#### HTML 组件处理漏洞 (CVE-2008-2259) 的缓解因素
  
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。  
-   默认情况下，Windows Server 2003 和 Windows Server 2008 上的 Internet Explorer 在一种称为“[增强安全配置](https://go.microsoft.com/fwlink/?linkid=92039)”的受限模式下运行。 此模式会将 Internet 区域的安全级别设置为“高”。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题”部分。
  
#### HTML 组件处理漏洞 (CVE-2008-2259) 的变通办法
...
#### HTML 组件处理漏洞 (CVE-2008-2259) 的常见问题
...
**造成漏洞的原因是什么？**    
在某些情况下，Internet Explorer 在处理打印预览过程中不正确地处理了数据的验证。 因此，内存可能以一种攻击者可以在登录用户的上下文中执行任意代码的方式受到破坏。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
...
**此更新有什么作用？**    
此更新通过修改 Internet Explorer 处理传递给打印预览的参数的方式来消除此漏洞。
...
\* SMS 2.0 和 SMS 2003 支持除 IE7 以外的所有其他受影响的 Internet Explorer 版本。有关详细信息，请参阅 [Microsoft 知识库文章 924178](https://support.microsoft.com/kb/924178)。
...
<td style="border:1px solid black;">对于所有受支持的 Windows 2000 版本上的 Internet Explorer 5.01 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB953838-IE501SP4- 20080620.120000 $\Spuninst 文件夹中的 Spuninst.exe 实用程序<br />  
<br />  
对于所有受支持的 Windows 2000 版本上的 Internet Explorer 6 Service Pack 1：<br />
使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB953838-IE6SP1- 20080620.120000 $\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/953838">Microsoft 知识库文章 953838</a></td>
</tr>  
<tr class="even">
...
使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstal\KB953838$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 for Windows XP：<br />
使用控制面板中的“添加或删除程序”工具或者 %Windir%\ie7updates\KB953838-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/953838">请参阅 Microsoft 知识库文章 953838</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB953838$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/953838">请参阅 Microsoft 知识库文章</a>953838</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了 HTML 对象内存损坏漏洞 CVE-2008-2254。  
-   [Google Security Team](https://www.google.com/) 的 Tavis Ormandy 报告了未初始化的内存损坏漏洞 CVE-2008-2256。  
-   Sam Thomas 与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 CVE-2008-2257。  
-   [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了 HTML 对象内存损坏漏洞 CVE-2008-2258。

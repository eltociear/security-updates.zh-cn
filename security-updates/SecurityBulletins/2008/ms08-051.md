...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2000 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=e7c044d8-778a-4985-b25b-4f7f6e4abadd)  
(KB949007)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[MS06-058](https://go.microsoft.com/fwlink/?linkid=74173)
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2002 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=f8921074-7985-4d42-ac2b-d2f3b1d466ba)  
(KB948995)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=7a7c21f0-5e0e-4dee-9710-1ce3d565913f)  
(KB948988)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=7a7c21f0-5e0e-4dee-9710-1ce3d565913f)  
(KB948988)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=55fd618a-e9c5-4f1e-b9a5-b2e47ec98ef1)  
(KB951338)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<td style="border:1px solid black;">
[Microsoft Office PowerPoint 2007 Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=55fd618a-e9c5-4f1e-b9a5-b2e47ec98ef1)  
(KB951338)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office PowerPoint Viewer 2003](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=911c8872-dec8-4b8e-9708-93dcabd3e036) (KB949041)
</td>
<td style="border:1px solid black;">
不适用
</td>
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=84ce5d58-0010-4945-bce9-67a41f898f2f) (KB954038)
</td>
<td style="border:1px solid black;">
不适用
</td>
...
<tr>
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 1 的 Microsoft Office 兼容包](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=84ce5d58-0010-4945-bce9-67a41f898f2f) (KB954038)
</td>
<td style="border:1px solid black;">
不适用
</td>
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 949785](https://support.microsoft.com/kb/949785) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0120](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0120)。
...
-   如果 Office 2000 用户已安装并在使用 [Office 文档打开确认工具](https://www.microsoft.com/download/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f)，则在打开文档之前，系统将提示该用户**打开**、**保存**或**取消**。 Office 文档打开确认工具的功能包含在 Office XP 和更高版本的 Office 中。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0121](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0121)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1455](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1455)。
...
此更新通常写入运行应用程序所必需的相同文件和注册表设置。 这可触发不兼容并使安全更新的部署占用更多的时间。 通过使用[应用程序兼容性工具包 5.0](https://www.microsoft.com/download/details.aspx?familyid=24da89e9-b581-47b0-b45e-492dd6da2971&displaylang=en) 中包含的更新兼容性评估程序组件，您可以简化测试和验证对已安装程序进行的 Windows 更新。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/949785">Microsoft 知识库文章 949785</a></td>
</tr>  
<tr class="even">
...
-   [Reversemode.com](https://reversemode.com/) 的 Ruben Santamarta 与 [iDefense Labs](https://labs.idefense.com/) 合作报告了内存分配和计算漏洞（CVE-2008-0120 和 CVE-2008-0121）。  
-   [Venustech](https://www.venustech.com.cn/) 的 ADLab 报告了分析溢出漏洞 (CVE-2008-1455)。

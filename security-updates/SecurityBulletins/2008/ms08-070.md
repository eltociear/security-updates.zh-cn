...
**已知问题。** [Microsoft 知识库文章 932349](http://support.microsoft.com/kb/932349)介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
[Microsoft 知识库文章 932349](http://support.microsoft.com/kb/932349) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4252](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4252)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4253)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4254)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4255)。
...
-   **阻止 Windows 公共 AVI ActiveX 控件在 Internet Explorer 中运行**
    ...
    您可以通过在注册表中为控件设置 kill bit 来禁止尝试在 Internet Explorer 中实例化 COM 对象。 关于如何阻止控件在 Internet Explorer 中运行的信息，请参阅 [Microsoft 知识库文章 240797](http://support.microsoft.com/kb/240797)。这篇文章将告诉您如何在注册表中创建一个兼容性标志值以阻止 COM 对象在 Internet Explorer 中被实例化。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4256)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3704](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3704)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 在最初发布此安全公告时，此漏洞已被公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2008-3704](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3704)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/932349">Microsoft 知识库文章 932349</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/9323493">Microsoft 知识库文章 932349</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [VenusTech](http://www.venustech.com.cn/) 的 ADLab 报告了 DataGrid 控件内存损坏漏洞 (CVE-2008-4252)  
-   [VenusTech](http://www.venustech.com.cn/) 的 ADLab 报告了 FlexGrid 控件内存损坏漏洞 (CVE-2008-4253)  
-   [VenusTech](http://www.venustech.com.cn/) 的 ADLab 报告了 Hierarchical FlexGrid 控件内存损坏漏洞 (CVE-2008-4254)  
-   [Affiliated Computer Services](http://www.acs-inc.com/) 的 Jason Medeiros 报告了 Hierarchical FlexGrid 控件内存损坏漏洞 (CVE-2008-4254)  
-   [Secunia Research](http://secunia.com/) 的 Carsten Eiram 报告了 Hierarchical FlexGrid 控件内存损坏漏洞 (CVE-2008-4254)  
-   Mark Dowd 与 [McAfee Avert Labs](http://www.avertlabs.com/) 一起报告了 Windows 公共 AVI 分析溢出漏洞 (CVE-2008-4255)  
-   [Insomnia Security](http://www.insomniasec.com/) 的 Brett Moore 报告了 Windows 公共 AVI 分析溢出漏洞 (CVE-2008-4255)  
-   CHkr\_D591 与 [TippingPoint](http://www.tippingpoint.com/)和 [Zero Day Initiative](http://www.zerodayinitiative.com/)一起报告了 Windows 公共 AVI 分析溢出漏洞 (CVE-2008-4255)  
-   Michal Bucko 与 [CERT/CC](http://www.cert.org/) 一起报告了 Charts 控件内存损坏漏洞 (CVE-2008-4256)  
-   Symantec 的 [Security Intelligence Analysis Team](http://www.symantec.com/) 与我们合作，处理 Masked Edit 控件内存损坏漏洞 (CVE-2008-3704)

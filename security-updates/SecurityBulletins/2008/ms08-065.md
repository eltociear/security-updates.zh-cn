...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 951071](https://support.microsoft.com/kb/951071) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3479](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3479)。
...
-   **禁用消息队列服务：**
    ...
    -   按组策略：  
        ...
        **注意：** 您也可以参阅 Windows Server 2003 安全指南。 此指南包含有关如何禁用服务的信息。  
        ...
        [用来了解组策略功能部件设置的分步指南](https://technet.microsoft.com/en-us/library/bb742376.aspx)
...
**什么是 RPC？**    
Microsoft RPC 是分布式计算环境中的一种编程模型。 RPC 的目标是提供透明的通信以便客户端好象直接在与服务器进行通讯。 Microsoft 实施的 RPC 可与开放软件基金会（OSF）分布式计算环境 (DCE) RPC 兼容。 有关 RPC 的详细信息，请访问 [RPC MSDN 网站](https://msdn.microsoft.com/en-us/library/ms691207(vs.85).aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/951071">Microsoft 知识库文章 951071</a></td>
</tr>  
<tr class="even">
...
-   [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了 MSMQ 远程执行代码漏洞 (CVE-2008-3479)

...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 953155](https://support.microsoft.com/kb/953155) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1446](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1446)。
...
-   **运行 IIS 锁定工具 2.1**
    ...
    **变通办法的影响。**
    ...
    用户将无法通过“Internet 打印”连接到任何共享打印机。 另外，IIS 锁定工具用户将无法通过“Internet 打印”连接到任何共享打印机。 有关 IIS 锁定工具所做更改的完整列表，请参阅以下 [MSDN 文章](https://msdn.microsoft.com/en-us/library/aa302365.aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/953155">Microsoft 知识库文章 953155</a></td>
</tr>  
<tr class="even">
...
-   [CERT/CC](https://www.cert.org/) 报告了 IPP 服务整数溢出漏洞 (CVE-2008-1446)

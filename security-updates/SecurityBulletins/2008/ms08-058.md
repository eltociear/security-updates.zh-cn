...
<td style="border:1px solid black;">
[MS08-045](https://go.microsoft.com/fwlink/?linkid=122772)
</td>
</tr>
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 956390](https://support.microsoft.com/kb/956390) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2947)-2947。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3472](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3472)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3473](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3473)。
  
#### 事件处理跨域漏洞 (CVE-2008-3473) 的缓解因素
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3474](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3474)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3475](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3475)。
...
#### 未初始化的内存损坏漏洞 (CVE-2008-3475) 的常见问题
...
**此更新有什么作用？**    
此更新可修改调用已初始化或删除的对象时 Internet Explorer 处理错误的方式。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3476](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3476)。
  
#### HTML 对象内存损坏漏洞 (CVE-2008-3476) 的缓解因素
...
#### HTML 对象内存损坏漏洞 (CVE-2008-3476) 的变通办法
...
#### HTML 对象内存损坏漏洞 (CVE-2008-3476) 的常见问题
...
| Windows Server 2008（所有受支持的版本）                                                                   | 否      | 否                   | 请参阅下面的 **Windows Vista 和 Windows Server 2008 的备注** | 是                         |
...
<td style="border:1px solid black;">对于所有受支持的 Windows 2000 版本上的 Internet Explorer 5.01 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB956390-IE501SP4-20080820.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序<br />  
<br />  
对于所有受支持的 Windows 2000 版本上的 Internet Explorer 6 Service Pack 1：<br />
使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB956390-IE6SP1-20080820.120000$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/956390">Microsoft 知识库文章 956390</a></td>
</tr>  
<tr class="even">
...
使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstal\KB956390$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Internet Explorer 7 for Windows XP：<br />
使用控制面板中的“添加或删除程序”工具或者 %Windir%\ie7updates\KB956390-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;"><a href="https://support.microsoft.com/kb/953838">请参阅 Microsoft 知识库文章</a>956390</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
使用控制面板中的“添加或删除程序”工具或者 %Windir%\$NTUninstallKB956390$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/953838">Microsoft 知识库文章 956390</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 x64 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP Version 2003\SP2\KB956390\Filelist</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
-   David Bloom 报告了 HTML 元素跨域漏洞 (CVE-2008-3472)  
-   Gregory Rubin 报告了事件处理跨域漏洞 ( CVE-2008-3473 )  
-   [Ivan Fratric](https://ifsec.blogspot.com/) 与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了未初始化的内存损坏漏洞 (CVE-2008-3475)  
-   [n.runs](https://www.nruns.com/) 的 Thierry Zoller 报告了 HTML 对象内存损坏漏洞 (CVE-2008-3476)  
-   [Composica](https://www.composica.com/) 的 Lee Dagon 报告了跨域信息泄露漏洞 (CVE-2008-3474 )

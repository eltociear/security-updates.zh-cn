...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3476](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3476)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/956390">Microsoft 知识库文章 956390</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/953838">请参阅 Microsoft 知识库文章</a>956390</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/953838">Microsoft 知识库文章 956390</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [Ivan Fratric](http://ifsec.blogspot.com/) 与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，报告了未初始化的内存损坏漏洞 (CVE-2008-3475)  
-   [n.runs](http://www.nruns.com/) 的 Thierry Zoller 报告了 HTML 对象内存损坏漏洞 (CVE-2008-3476)  
-   [Composica](http://www.composica.com/) 的 Lee Dagon 报告了跨域信息泄露漏洞 (CVE-2008-3474 )

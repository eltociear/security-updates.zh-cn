---
TOCTitle: 'MS08-002'
Title: 'Microsoft 安全公告 MS08-002 - 重要'
ms:assetid: 'ms08-002'
ms:contentKeyID: 61237127
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-002(v=Security.10)'
---

Microsoft 安全公告 MS08-002 - 重要
==================================
...
这是用于 Windows 2000、Windows XP 和 Windows Server 2003 所有受支持版本的重要安全更新。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过验证传递给 LSASS API 的参数解决该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=7956632e-17d9-4876-8340-84fe3e43e5cc)                                                   | 特权提升     | 重要             | 无               |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=6a4cf182-8e36-490e-aefe-edb7b3a0df9c)                                                               | 特权提升     | 重要             | 无               |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=51fc657b-2b4a-4725-a744-d279e027c4a5)                 | 特权提升     | 重要             | 无               |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=12397b47-b18f-4d4d-b8d7-adec8ff310d5)                | 特权提升     | 重要             | 无               |
| [Windows Server 2003 x64 Edition 和 Windows 2003 Server x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=f19fd790-a4e6-4a8a-8077-d1bbfe37ecca)                         | 特权提升     | 重要             | 无               |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=0382a195-aa3d-409b-8a79-9fe61588d8a9) | 特权提升     | 重要             | 无               |
...
<tr class="header">
<th>受影响的软件</th>
<th>LSASS 绕过漏洞 - CVE-2007-5352</th>
<th>综合严重程度等级</th>
</tr>
</thead>
<tbody>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-5352](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5352)。
  
#### LSASS 绕过漏洞 (CVE-2007-5352) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### LSASS 绕过漏洞 (CVE-2007-5352) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   Microsoft 并未发现此漏洞的任何变通办法。
  
#### LSASS 绕过漏洞 (CVE-2007-5352) 的常见问题
  
**此漏洞的影响范围有多大？**    
本地安全机构子系统服务 (LSASS) 中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以使用提升的特权运行代码。 攻击者然后可以完全控制受影响的系统。
  
**造成漏洞的原因是什么？**    
LSASS 过程处理特制 LPC 请求的方式不正确。 当 LSASS 进程收到特制的 LCP 请求时，攻击者可能使用本地系统特权执行代码。
...
**此更新有什么作用？**    
此更新通过验证传递给 LSASS API 的参数，阻止访问无效地址而消除此漏洞。
...
| Windows Server 2003 x64 Edition 和 Windows 2003 Server x64 Edition Service Pack 2                         | 否      | 是       | 是        |  
...
<td style="border:1px solid black;">Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB943485$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
...
<br />  
对于 Windows XP 所有受支持的基于 x64 的版本：<br />  
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB943485$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关完整的文件清单，请参阅下一小节“<strong>文件信息</strong>”。</td>
...
<p>对于 Windows XP 所有受支持的基于 x64 的版本：</p>
...
| lsasrv.dll | 5.2.3790.3041 | 2007 年 11 月 9 日 | 07:12 | 1,566,208 | x64 | SP2GDR |
| lsasrv.dll | 5.2.3790.3041 | 2007 年 11 月 9 日 | 07:19 | 1,567,232 | x64 | SP2QFE |
...
| lsasrv.dll | 5.2.3790.3041 | 2007 年 11 月 8 日 | 07:45 | 815,616 | SP2GDR |
| lsasrv.dll | 5.2.3790.3041 | 2007 年 11 月 8 日 | 07:39 | 815,616 | SP2QFE |
...
| lsasrv.dll | 5.2.3790.3041 | 2007 年 11 月 9 日 | 07:07 | 2,163,712 | IA-64 | SP2GDR |
| lsasrv.dll | 5.2.3790.3041 | 2007 年 11 月 9 日 | 07:02 | 2,164,736 | IA-64 | SP2QFE |
...
-   [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 报告了 LSASS 绕过漏洞 (CVE-2007-5352)。

...
**已知问题。** [Microsoft 知识库文章 947081](http://support.microsoft.com/kb/947081) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法
...
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=33948">MS04-027</a></td>
</tr>  
<tr class="even">
...
[Microsoft 知识库文章 947081](http://support.microsoft.com/kb/947081) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-0216](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0216)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0105](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0105)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0108](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0108)。
...
对于 SMS 2.0 和 SMS 2003，SMS SUS 功能包（包含安全更新清单工具 (SUIT)）可由 SMS 用来检测安全更新。 请参阅 [Downloads for Systems Management Server 2.0](http://technet.microsoft.com/en-us/sms/bb676799.aspx)。
...
用于 Windows 95、Windows 98、Windows 98 SE 和 Windows Millennium Edition 的 Windows Installer 2.0 Redistributable 有关本公告中出现的术语（如“*修补程序*”）的详细信息，请参阅 [Microsoft 知识库文章 824684](http://support.microsoft.com/kb/824684)。
...
-   [VeriSign iDefense VCP](http://labs.idefense.com/) 报告了 Microsoft Works 转换器溢出漏洞 (CVE-2008-0108)。  
-   Damian Put 与 [VeriSign iDefense VCP](http://labs.idefense.com/) 合作，报告了 Microsoft Works 堆损坏漏洞 (CVE-2007-0216)。  
-   [IBM Internet Security Systems X-Force](http://xforce.iss.net/) 报告了 Microsoft Works 文件转换器索引表漏洞 (CVE-2008-0105)。

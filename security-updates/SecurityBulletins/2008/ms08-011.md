---
TOCTitle: 'MS08-011'
Title: 'Microsoft 安全公告 MS08-011 - 重要'
ms:assetid: 'ms08-011'
ms:contentKeyID: 61237136
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-011(v=Security.10)'
---
...
**已知问题。** [Microsoft 知识库文章 947081](https://support.microsoft.com/kb/947081) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=30c9c3fe-fb85-43d9-bbc3-0b30d3a20286">Microsoft Works 6 文件转换器</a><br />
(KB943973)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=33948">MS04-027</a></td>
</tr>  
<tr class="even">
...
**此更新如何解决本公告中讨论的漏洞？**    
此更新将受影响系统上 Works 文件转换器的易受攻击的版本替换为该转换器的不受影响的版本。 但是，在安装此更新之后，用户第一次尝试打开 .wps 文件时，系统将提示他们[从 Microsoft 下载中心下载 Microsoft Works 6 至 9 转换器](https://www.microsoft.com/download/details.aspx?familyid=bf41401e-70fa-465d-ae2e-cf44dbf05297&displaylang=en)。 Microsoft Works 6 至 9 转换器安装在系统上之后，系统不再提示用户安装 Microsoft Works 6 至 9 转换器。
...
[Microsoft 知识库文章 947081](https://support.microsoft.com/kb/947081) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
<tr class="header">  
<th>Office 套件及其他受影响软件</th>  
<th>Microsoft Works 文件转换器输入验证漏洞 - CVE-2007-0216</th>  
<th>Microsoft Works 文件转换器索引表漏洞 - CVE-2008-0105</th>  
<th>Microsoft Works 文件转换器字段长度漏洞 - CVE-2008-0108</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
<tr class="odd">
<td style="border:1px solid black;">Microsoft Office 2003 上的 Microsoft Works 6 文件转换器</td>
...
<tr class="even">
<td style="border:1px solid black;">Microsoft Works 8.0 上的 Microsoft Works 6 文件转换器</td>
...
<tr class="odd">
<td style="border:1px solid black;">Microsoft Works Suite 2005 上的 Microsoft Works 6 文件转换器</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
远程执行代码</td>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-0216](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0216)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0105](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0105)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0108](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0108)。
...
对于 SMS 2.0 和 SMS 2003，SMS SUS 功能包（包含安全更新清单工具 (SUIT)）可由 SMS 用来检测安全更新。 请参阅 [Downloads for Systems Management Server 2.0](https://technet.microsoft.com/en-us/sms/bb676799.aspx)。
...
用于 Windows 95、Windows 98、Windows 98 SE 和 Windows Millennium Edition 的 Windows Installer 2.0 Redistributable 有关本公告中出现的术语（如“*修补程序*”）的详细信息，请参阅 [Microsoft 知识库文章 824684](https://support.microsoft.com/kb/824684)。
...
-   [VeriSign iDefense VCP](https://labs.idefense.com/) 报告了 Microsoft Works 转换器溢出漏洞 (CVE-2008-0108)。  
-   Damian Put 与 [VeriSign iDefense VCP](https://labs.idefense.com/) 合作，报告了 Microsoft Works 堆损坏漏洞 (CVE-2007-0216)。  
-   [IBM Internet Security Systems X-Force](https://xforce.iss.net/) 报告了 Microsoft Works 文件转换器索引表漏洞 (CVE-2008-0105)。

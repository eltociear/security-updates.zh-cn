---
TOCTitle: 'MS08-034'
Title: 'Microsoft 安全公告 MS08-034 - 重要'
ms:assetid: 'ms08-034'
ms:contentKeyID: 61237158
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-034(v=Security.10)'
---
...
此安全更新可解决 Windows Internet 名称服务 (WINS) 中一个秘密报告的漏洞，该漏洞可能允许特权提升。 成功利用此漏洞的本地攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建新帐户。

对于 Microsoft Windows 2000 Server 和 Windows Server 2003 的所有受支持版本，此安全更新等级为“重要”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此更新通过验证 WINS 处理的网络数据包的数据结构来消除该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=aa8aa79f-c2cc-440c-9e5c-089143e6f814)                                            | 特权提升     | 重要         | [MS04-045](https://technet.microsoft.com/security/bulletin/ms04-045) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=08fc90d5-23aa-4327-8aef-16bc5170769d)                | 特权提升     | 重要         | [MS04-045](https://technet.microsoft.com/security/bulletin/ms04-045) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=71675ae8-d60a-4834-b358-2d8e761e62fc)                         | 特权提升     | 重要         | [MS04-045](https://technet.microsoft.com/security/bulletin/ms04-045) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=87affdc9-d9fe-413c-af30-f3d3b671ec72) | 特权提升     | 重要         | [MS04-045](https://technet.microsoft.com/security/bulletin/ms04-045) |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 948745](https://support.microsoft.com/kb/948745) 中找到文件信息详细资料。
...
内存覆盖漏洞 - CVE-2008-1451  
----------------------------
  
  
Windows 名称服务 (WINS) 中存在一个特权提升漏洞，WINS 没有充分验证特制 WINS 网络数据包内的数据结构。 该漏洞可能允许本地攻击者使用提升的特权运行代码。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 随后，攻击者可以安装程序；查看、更改或删除日期；或者创建新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1451](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1451)。
  
#### 内存覆盖漏洞 (CVE-2008-1451) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。
  
-   Microsoft 尚未发现此漏洞的任何缓解因素。
  
#### 内存覆盖漏洞 (CVE-2008-1451) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   Microsoft 并未发现此漏洞的任何变通办法。
  
#### 内存覆盖漏洞 (CVE-2008-1451) 的常见问题
  
**此漏洞的影响范围有多大？**    
WINS 中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以使用提升的特权运行代码。 攻击者然后可以完全控制受影响的系统。 详细信息，请访问 [WINS](https://technet2.microsoft.com/windowsserver/en/library/ea41036e-5cbf-427b-a34f-9e4d1d1519581033.mspx?mfr=true) Technet 文章。
  
**造成漏洞的原因是什么？**    
WINS 没有正确地验证特制 WINS 网络数据包内的数据结构。
  
**什么是 WINS？**  
WINS 是将 NetBIOS 名称转换为 TCP/IP 网络上的地址的一项服务。 虽然 NetBIOS 和 NetBIOS 名称可与 TCP/IP 以外的网络协议一起使用，但 Windows Internet 名称服务 (WINS) 是专为支持 TCP/IP 上的 NetBIOS (NetBT) 而设计的。 用户在其中访问具有 NetBIOS 名称的资源的任何环境都需要 WINS。 如果不在此类网络中使用 WINS，除非每个系统都含有自己的 Lmhosts 文件，否则无法使用其 NetBIOS 名称连接到远程网络资源，且可能无法建立文件和打印共享连接。
  
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建新帐户。
  
**攻击者如何利用此漏洞？**    
要利用此漏洞，本地攻击者必须向受影响的 WINS 服务发送特制数据包。
  
**受此漏洞威胁最大的系统有哪些？**    
Windows WINS 服务器受此漏洞的威胁。
  
**此更新有什么作用？**    
此更新通过验证 WINS 处理的网络数据包的数据结构来消除该漏洞。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Server Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB948745$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/948745">Microsoft 知识库文章 948745</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB948745$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/948745">Microsoft 知识库文章 948745</a></td>

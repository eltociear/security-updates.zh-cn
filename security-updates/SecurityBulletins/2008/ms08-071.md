---
TOCTitle: 'MS08-071'
Title: 'Microsoft 安全公告 MS08-071 - 严重'
ms:assetid: 'ms08-071'
ms:contentKeyID: 61237444
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-071(v=Security.10)'
---
...
此安全更新通过修改 GDI 验证文件大小参数和执行整数计算以阻止溢出的方式来消除此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=3b775fb1-1077-455d-af4a-4ccb5237974f)                                                                     | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2151fbba-c464-4d1e-82d4-5b096e82bed0)                                                                                 | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?familyid=2151fbba-c464-4d1e-82d4-5b096e82bed0)                                                                                 | 远程执行代码 | 严重         | 无                                                        |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=2247f6a5-aa33-4c68-9ea8-a63488d126d3)                 | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0c396796-0929-4cd2-99e8-3c0f7075a89e)                                  | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6d5c7d2f-1a82-4cdf-b3f2-b2c2390c6a64)                         | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=1edb62b4-3d0f-4891-b4b3-8f8bc4e7bdfe) | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows Vista 和 Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=cddf9cf6-bdeb-4429-823a-879387a428d7)                                                             | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=73dc3775-b6f0-40f1-bd36-6b5fb80eb2fa)                                     | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows Server 2008（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=bbed9e8b-e75e-44ef-ba1d-fd6f852c1f67)\*                                                                   | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows Server 2008（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=48aecf4c-1296-490d-ba37-a28e3ec19bd6)\*                                                              | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
| [Windows Server 2008（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=9bfe15cd-02ff-45cf-85c8-5ff1e6c1a871)                                                            | 远程执行代码 | 严重         | [MS08-021](https://go.microsoft.com/fwlink/?linkid=111955) |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 956802](https://support.microsoft.com/kb/956802) 中找到文件信息详细资料。
...
<tr class="header">
<th>受影响的软件</th>
<th>GDI 整数溢出漏洞 - CVE-2008-2249</th>
<th>GDI 堆溢出漏洞 - CVE-2008-3465</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
GDI 整数溢出漏洞 - CVE-2008-2249  
--------------------------------
  
  
GDI 处理整数计算的方式中存在一个远程执行代码漏洞。 如果用户打开特制的 WMF 图像文件，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2249](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2249)。
  
#### GDI 整数溢出漏洞 (CVE-2008-2249) 的缓解因素
...
#### GDI 整数溢出漏洞 (CVE-2008-2249) 的变通办法
...
-   涉及 OLE 呈现的某些方案可能会损坏。 当对象服务器处于不活动状态时通常会发生此情形。
...
#### GDI 整数溢出漏洞 (CVE-2008-2249) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
漏洞是由于 GDI 未正确处理特制的 WMF 图像文件中的格式错误的标题时缓冲区溢出造成的。
  
**什么是 GDI？**    
Microsoft Windows 图形设备接口 (GDI) 允许应用程序在视频显示和打印机上使用图形和格式化文本。 基于 Windows 的应用程序不直接访问图形硬件。 而是 GDI 代表应用程序与设备驱动程序进行交互。 有关 GDI 的详细信息，请访问 [Windows GDI 起始页](https://msdn.microsoft.com/en-us/library/ms536795.aspx)。
  
**什么是 Windows 图元文件 (WMF) 图像格式？**    
WMF 图像格式是一种 16 位图元文件格式，其中可以同时包含矢量信息和位图信息。 它非常适合 Windows 操作系统。
  
有关图像类型和格式的详细信息，请参阅 [Microsoft 知识库文章 320314](https://support.microsoft.com/kb/320314)。有关这些文件格式的其他信息，请访问 [MSDN 技术资源库网站](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/gdicpp/gdiplus/aboutgdiplus/imagesbitmapsandmetafiles/metafiles.asp)。
...
在电子邮件攻击情形中，攻击者可以通过向用户发送内嵌有特制 WMF 图像文件的电子邮件并诱使用户查看或预览该电子邮件来利用此漏洞。 攻击者还可以在 Office 文档中嵌入特制的 WMF 图像文件并诱使用户打开该文件。
  
在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用于尝试利用此漏洞的 WMF 图像文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问特制的网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。
  
**受此漏洞威胁最大的系统有哪些？**    
工作站和终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**    
此更新通过修改 GDI 执行整数计算以阻止溢出的方式来消除此漏洞。
...
GDI 堆溢出漏洞 - CVE-2008-3465  
------------------------------
  
  
GDI 处理 WMF 文件中文件大小参数的方式中存在一个远程执行代码漏洞。 如果第三方应用程序使用特定的 Microsoft API 复制特制的 WMF 图像文件，该漏洞可能允许远程执行代码。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3465](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3465)。
  
#### GDI 堆溢出漏洞 (CVE-2008-3465) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
#### GDI 堆溢出漏洞 (CVE-2008-3465) 的变通办法
...
#### GDI 堆溢出漏洞 (CVE-2008-3465) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
漏洞是由于 GDI 未正确处理特制的 EMF 图像文件中格式错误的文件大小参数时堆溢出造成的。
...
在 Windows Vista 和 Windows Server 2008 中，成功利用此漏洞的攻击者可能导致受影响的应用程序无响应。 必须重新启动，以便此应用程序恢复功能。
  
**攻击者如何利用此漏洞？**    
此漏洞需要第三方应用程序通过此 API 复制 WMF 文件。 根据第三方应用程序的行为，此漏洞可能会导致在登录用户的上下文中远程执行代码。
  
我们目前尚不知道使用 Microsoft 产品访问此漏洞的任何远程途径。
  
**如何确定第三方应用程序是否受到了影响？**  
如果第三方软件供应商的产品正在复制或可能复制 WMF 文件，建议用户与该供应商联系以确定他们是否受到影响。
  
**受此漏洞威胁最大的系统有哪些？**    
所有当前支持的 Windows 系统均受到威胁。
  
**此更新有什么作用？**    
此更新通过修改 GDI 处理文件大小参数以阻止缓冲区溢出的方式来消除此漏洞。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB956802$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/956802">Microsoft 知识库文章 956802</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\$NTUninstallKB956802$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/956802">Microsoft 知识库文章 956802</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB956802$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/956802">Microsoft 知识库文章 956802</a></td>
...
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Jun Mao 报告了 GDI 整数溢出漏洞 (CVE-2008-2249)。  
-   Juan Caballero 与 [Carnegie Mellon University 的 Bitblaze 小组和 UC Berkeley](https://bitblaze.cs.berkeley.edu/) 一起报告了 GDI 堆溢出漏洞 (CVE-2008-3465)
...
-   V1.1（2008 年 12 月 10 日）： 已更新“**严重等级和漏洞标识符**”表，对于 Microsoft Windows 2000 Service Pack 4、Windows XP Service Pack 2、Windows XP Service Pack 3、Windows XP Professional x64 Edition、Windows XP Professional x64 Edition Service Pack 2、Windows Server 2003 Service Pack 1、Windows Server 2003 Service Pack 2、Windows Server 2003 x64 Edition、Windows Server 2003 x64 Edition Service Pack 2、Windows Server 2003 SP1（用于基于 Itanium 的系统）和 Windows Server 2003 SP2（用于基于 Itanium 的系统），将 GDI 堆溢出漏洞 (CVE-2008-3465) 的安全影响列为“远程执行代码”。

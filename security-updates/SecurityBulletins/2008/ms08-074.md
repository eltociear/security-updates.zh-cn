...
**已知问题。** [Microsoft 知识库文章 959070](http://support.microsoft.com/kb/959070)介绍了客户在安装此安全更新时可能遇到的任何当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 959070](http://support.microsoft.com/kb/959070) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4265](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4265)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4264](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4264)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4266](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4266)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/959070">Microsoft 知识库文章 959070</a></td>
</tr>  
<tr class="even">
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Joshua J. Drake 报告了文件格式分析漏洞 (CVE-2008-4265)  
-   [signedness.org](http://www.signedness.org/) 的 Claes M Nyberg 报告了文件格式分析漏洞 (CVE-2008-4264)  
-   [Secunia](http://secunia.com/) 的 Dyon Balding 报告了 Excel 全局阵列内存损坏漏洞 (CVE-2008-4266)

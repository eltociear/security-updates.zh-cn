...
**已知问题。**  [Microsoft 知识库文章 953235](https://support.microsoft.com/kb/953235) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-003">MS08-003</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&amp;familyid=0a983ffb-4f5a-4b78-9bf5-813dcc5df8d3">ADAM</a><br />
(KB949269)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-003">MS08-003</a></td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=334252db-4a7a-4161-bb71-2a20c0b5bd93">ADAM</a><br />
(KB949269)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-003">MS08-003</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008（用于 32 位系统）\*</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=2981156e-2e2f-469e-91be-da127d50f3fc">AD LDS</a><br />
(KB949014)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008（用于基于 x64 的系统）\*</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=b5cfe6f4-c5ba-4be9-a6b8-9381c40c85aa">AD LDS</a><br />
(KB949014)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
...
Microsoft 获悉在 Microsoft Exchange Server 的 Exchange Management 控制台中尝试显示很大的邮箱列表时，定向到已安装此更新的服务器的 LDAP 查询可能失败。 有关此问题的详细信息，请参阅 [Microsoft 知识库文章 953235](https://support.microsoft.com/kb/953235) 的“已知问题”部分。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1445](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1445)。
...
-   **在外围防火墙处阻止 TCP 端口 389 和 3268**
    ...
    这些端口用于启动与受影响组件的连接。 将其阻止在企业防火墙处（入站和出站），有助于保护位于防火墙后面的系统免受利用此漏洞进行的攻击。 我们建议阻止所有来自 Internet 的未经请求的入站通信，以帮助防止可能使用其他端口进行的攻击。 有关端口的详细信息，请参阅 [TCP 和 UDP 端口分配](https://go.microsoft.com/fwlink/?linkid=21312)。
...
[ADAM](https://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true) 是一种轻型目录访问协议 (LDAP) 目录服务，作为 Windows XP 和 Windows Server 2003 的用户服务运行，而非作为系统服务运行。
  
**什么是 Active Directory 轻型目录服务 (AD LDS)？**  
[AD LDS](https://technet2.microsoft.com/windowsserver2008/en/library/6a3bedf7-9c5b-4ada-9a51-6b794adc9ab81033.mspx?mfr=true) 是一种轻型目录访问协议 (LDAP) 目录服务，作为 Windows Server 2008 的用户服务运行，而非作为系统服务运行。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/953235">Microsoft 知识库文章 953235</a></td>
</tr>  
<tr class="even">
...
-   [Securify](https://www.securify.com/) 的 Alex Matthews 报告了 Active Directory 漏洞 (CVE-2008-1445)。

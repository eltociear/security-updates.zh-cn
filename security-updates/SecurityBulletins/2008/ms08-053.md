...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=0cabfbc0-db5d-4a6a-a4cd-e6df89ac2b25">Windows Media Encoder 9 Series</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=57bcb3c2-49d3-4f18-8d03-36abd03d7403">Windows Media Encoder 9 Series</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=18efea9e-b103-46de-90d9-5e295854cec3">Windows Media Encoder 9 Series</a><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=ebc1737c-6e78-4244-a1b2-a56d031f16e9">Windows Media Encoder 9 Series x64 Edition</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=54ce1080-94cf-4e4f-8e09-a7dbab2757c5">Windows Media Encoder 9 Series</a></td>
<td style="border:1px solid black;">远程执行代码</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c83011cd-90b8-494c-9cad-fa055e101992">Windows Media Encoder 9 Series</a><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=d8f1b782-136b-443f-b5f2-63aa4d1fd94a">Windows Media Encoder 9 Series x64 Edition</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=99beebc4-553a-46f8-8245-e3d932306c93">Windows Media Encoder 9 Series</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=99beebc4-553a-46f8-8245-e3d932306c93">Windows Media Encoder 9 Series</a><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=54d1279a-7f26-4727-a39d-5505bcd4fc53">Windows Media Encoder 9 Series x64 Edition</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5434ca66-5a6b-4517-92fb-72dea0a172ec">Windows Media Encoder 9 Series</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5434ca66-5a6b-4517-92fb-72dea0a172ec">Windows Media Encoder 9 Series</a><br />
<br />
<a href="https://www.microsoft.com/download/details.aspx?familyid=e30f9427-26d0-4e86-b9b8-bc637c3b5734">Windows Media Encoder 9 Series x64 Edition</a></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
</tr>  
...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 954156](https://support.microsoft.com/kb/827562) 中找到文件信息详细资料。
  
**是否有任何产品作为捆绑包的一部分提供 Windows Media Encoder 9 Series？**  
是。 虽然 Windows Media Encoder 9 Series 并未随 Windows 附带提供，但是 Adobe Premier 6.5 高级 Windows Media 插件（测试版）会附带提供 Windows Media Encoder 9 的 32 位版本，该插件可从 [Microsoft 下载中心](https://www.microsoft.com/download/details.aspx?displaylang=en&familyid=fbcd4987-86c6-4fe0-8a6d-f19ddf89217e)下载。 安装了 Adobe Premier 6.5 高级 Windows Media 插件（测试版）的用户也应安装此更新。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-3008](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-3008)。
  
#### Windows Media Encoder 缓冲区溢出漏洞 (CVE-2008-3008) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   默认情况下，Windows Media Encoder 9 Series 不安装在任何 Windows 版本上。 Windows Media Encoder 9 Series 的 32 位版本可以安装在 x86 或 x64 系统上，必须从 Microsoft 下载中心的 [Windows Media Encoder 9 Series](https://www.microsoft.com/download/details.aspx?familyid=5691ba02-e496-465a-bba9-b2f1182cdf24) 中下载。 Windows Media Encoder 9 Series 的 64 位版本仅可以安装在基于 x64 的系统上，必须从 Microsoft 下载中心的 [Windows Media Encoder 9 Series](https://www.microsoft.com/download/details.aspx?familyid=cc41218d-7e37-4546-bf0b-1276959ee3ef) 中下载。 没有安装 Windows Media Encoder 9 Series 或 Windows Media Encoder 9 Series x64 Edition 的系统不容易受到攻击。  
...
-   **阻止 WMEX.DLL 在 Internet Explorer 中运行**
    ...
    **警告** 如果不正确地使用注册表编辑器，可能导致严重的问题，或许需要您重新安装操作系统。 Microsoft 不保证您可以解决因错误运用注册表编辑器而产生的问题。 使用注册表编辑器的风险由您自己承担。
    ...
    有关阻止控件在 Internet Explorer 中运行的详细步骤，请参阅 [Microsoft 知识库文章 240797](https://support.microsoft.com/kb/240797)。按照文中所述的步骤在注册表内创建一个 Compatibility Flags 值，以阻止 WMEX.DLL 在 Internet Explorer 中实例化。
...
-   **拒绝访问 WMEX.DLL**
    ...
    **如何撤消变通方法。**
    ...
    -   **Windows 2000、Windows XP 和 Windows Server 2003：**
        ...
        按照此知识库文章中所述步骤将文件配置为从父文件夹继承权限： [Microsoft 知识库文章 308419](https://support.microsoft.com/kb/308419)，或者从管理命令提示符中运行下列命令以删除“everyone”帐户 ACE：
...
Internet Explorer 7 包括 ActiveX 选择性加入功能，这意味着几乎所有 ActiveX 控件均默认为关闭。 用户可以访问以前安装的、尚未在 Internet 上使用的 ActiveX 控件之前，信息栏会对用户进行提示。 这使得用户能够逐步控制允许或拒绝访问。 有关此功能以及其他新功能的详细信息，请参阅 [Windows Internet Explorer 7 功能页面](https://www.microsoft.com/windows/ie/ie7/about/features/default.mspx)。
...
通过使用 Windows Server Update Services (WSUS)，管理员可以为 Windows 2000 操作系统和更高版本、Office XP 和更高版本、Exchange Server 2003 和更高版本、SQL Server 2000 和更高版本部署最新关键更新和安全更新。 有关如何使用 Windows Server Update Services 部署此安全更新的详细信息，请访问 [Windows Server Update Services 网站](https://go.microsoft.com/fwlink/?linkid=50120)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/827562">Microsoft 知识库文章 954156</a></td>
</tr>  
<tr class="even">
...
**注意** 有关 wusa.exe 安装程序的详细信息，请参阅 [Microsoft 知识库文章 197147](https://support.microsoft.com/kb/197147)。
...
-   Nguyen Minh Duc 和 Le Manh Tung 与 [Bach Khoa Internetwork Security Center (BKIS) Hanoi University of Technology (Vietnam)](https://security.bkis.vn/) 合作报告了 Windows Media Encoder 漏洞 (CVE-2008-3008)

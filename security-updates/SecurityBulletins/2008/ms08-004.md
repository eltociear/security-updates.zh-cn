...
|----------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=8ce9608b-7049-47cd-adc4-22a803877d33)             | 拒绝服务     | 重要         | MS08-001         |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=d7b9c3d1-9c23-4e05-bac6-d0b327feaf53) | 拒绝服务     | 重要         | MS08-001         |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0084](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0084)。
...
-   [Whitestein](https://www.whitestein.com/) Technologies 的 Tomas Potok、Martin Dominik、Martin Luptak 和 Eva Juhasova 报告了 Windows Vista TCP/IP 漏洞 (CVE-2008-0084)。

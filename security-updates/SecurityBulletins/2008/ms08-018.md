---
TOCTitle: 'MS08-018'
Title: 'Microsoft 安全公告 MS08-018 - 严重'
ms:assetid: 'ms08-018'
ms:contentKeyID: 61237143
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-018(v=Security.10)'
---
...
对于 Microsoft Project 2000 Service Release 1，此安全更新等级为“严重”，对于 Microsoft Project 2002 Service Pack 1 和 Microsoft Office Project 2003 Service Pack 2，此安全更新等级为“重要”。有关详细信息，请参阅本节中的“受影响和不受影响的软件”小节。

此安全更新通过修改 Microsoft Project 在打开 Project 文件时计算所需内存分配的方式来消除此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 950183](https://support.microsoft.com/kb/950183) 中找到文件信息详细资料。
...
<tr class="header">  
<th>受影响的软件</th>  
<th>Project 内存验证漏洞 CVE-2008-1088</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1088)。
  
#### Project 内存验证漏洞 (CVE-2008-1088) 的缓解因素
...
**攻击者如何利用此漏洞？**    
此漏洞需要用户使用 Microsoft Project 的受影响版本打开格式错误的 Project 文件。
...
**受此漏洞威胁最大的系统有哪些？**    
使用 Microsoft Project 的系统受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**    
此更新通过修改 Microsoft Project 在打开磁盘上的 Project 文件并装入内存时验证内存分配的方式来消除此漏洞。
...
**注意** 对于使用 MBSA 2.0.1、Microsoft Update 和 Windows Server Update Services 不支持的旧版软件的客户： 请访问 Microsoft Baseline Security Analyzer 并参考旧版产品支持部分，了解如何使用旧版工具创建全面的安全更新检测。
...
-   有关 Microsoft Office 2003 的受支持版本，请参阅[创建管理安装点](https://office.microsoft.com/en-us/ork2003/ha011401931033.aspx)。 要了解有关如何将客户计算机的来源从更新的管理安装点更改为 Office 2003 原始基线来源或 Service Pack 2 (SP2) 的详细信息，请参阅 Microsoft 知识库文章 902349。  
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/950183">Microsoft 知识库文章 950183</a></td>
</tr>  
<tr class="even">
...
| **/c:path** | 覆盖作者定义的安装命令。 指定 Setup.inf 或 .exe 文件的路径和名称。                                                                                 |  
| **/r:n**    | 安装后从不重新启动系统。                                                                                                                           |  
| **/r:i**    | 如果需要重新启动则提示用户重新启动 \\\\lca\\pdm\\TMGUIDE\\Trademark Usage, Bugging and Footnote Guidelines2.doc 系统，与 **/q:a** 一起使用时除外。 |  
| **/r:a**    | 安装后始终重新启动系统。                                                                                                                           |  
| **/r:s**    | 安装后在不提示用户的情况下重新启动系统。                                                                                                           |  
| **/n:v**    | 不进行版本检查 – 在任何早期版本上安装程序。                                                                                                        |
...
-   大韩民国的 [National Cyber Security Center](https://www.ncsc.go.kr/eng/) 报告了 Project 内存验证漏洞 (CVE-2008-1088)。

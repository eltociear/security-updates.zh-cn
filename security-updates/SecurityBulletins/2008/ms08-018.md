...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 950183](http://support.microsoft.com/kb/950183) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1088)。
...
-   有关 Microsoft Office 2003 的受支持版本，请参阅[创建管理安装点](http://office.microsoft.com/en-us/ork2003/ha011401931033.aspx)。 要了解有关如何将客户计算机的来源从更新的管理安装点更改为 Office 2003 原始基线来源或 Service Pack 2 (SP2) 的详细信息，请参阅 Microsoft 知识库文章 902349。  
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/950183">Microsoft 知识库文章 950183</a></td>
</tr>  
<tr class="even">
...
-   大韩民国的 [National Cyber Security Center](http://www.ncsc.go.kr/eng/) 报告了 Project 内存验证漏洞 (CVE-2008-1088)。

...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=afeef3ec-6160-4c1d-94bd-0bfce641d0a2)                                                                                 | 远程执行代码 | 严重         | 无               |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=15b7d1c4-4ef4-47b2-9e3b-22eafbdb90d8)                 | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=b7e725bf-7248-4119-aca5-b7d502c09cfc)                                  | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 x64 Edition 和 Windows 2003 Server x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=8af82f86-731c-46a0-a025-b62447e2af38)                         | 远程执行代码 | 重要         | 无               |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=bca224db-fe0e-411d-a948-1c776ce974f3) | 远程执行代码 | 重要         | 无               |
| [Windows Vista](https://www.microsoft.com/download/details.aspx?familyid=ba7a2b42-1c89-45e5-b8a6-049fa500c03a)                                                                                             | 远程执行代码 | 严重         | 无               |
| [Windows Vista x64 Edition](https://www.microsoft.com/download/details.aspx?familyid=45962232-af78-42cb-bfa0-9ce7de199585)                                                                                 | 远程执行代码 | 严重         | 无               |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0080](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0080)。
...
-   [COSEINC Vulnerability Research Lab](https://www.coseinc.com/) 的 Steven 报告了 WebDAV Mini-Redirector 堆溢出漏洞 (CVE-2008-0080)。

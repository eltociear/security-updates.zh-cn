---
TOCTitle: 'MS08-025'
Title: 'Microsoft 安全公告 MS08-025 - 重要'
ms:assetid: 'ms08-025'
ms:contentKeyID: 61237149
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-025(v=Security.10)'
---

Microsoft 安全公告 MS08-025 - 重要
==================================
...
此安全更新通过修改 Windows 内核验证从用户模式传递过来的输入的方式来解决此漏洞。 有关此漏洞的详细信息，请参阅下一节“**漏洞信息**”下面的“常见问题 (FAQ)”小节。

**建议。**  Microsoft 建议客户尽早应用此更新。

**已知问题。** [Microsoft 知识库文章 941693](https://support.microsoft.com/kb/941693) 介绍了客户在卸载此安全更新时可能遇到的当前已知问题。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=8db9f328-da0e-4fb8-96c4-6d368b47c224)                                                                     | 特权提升     | 重要         | 无               |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=0e937f65-abd0-46dd-8883-5bfd70ea1178)                                                                                 | 特权提升     | 重要         | 无               |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=a29bbd13-761f-44fa-8948-e1a8c244bd7a)                 | 特权提升     | 重要         | 无               |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=d3b855a6-4648-4771-826d-11a151828eac)                                  | 特权提升     | 重要         | 无               |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=320fd100-35e1-4345-9399-796393235cbc)                         | 特权提升     | 重要         | 无               |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=126426a7-be38-4327-89db-02d99d76589d) | 特权提升     | 重要         | 无               |
| [Windows Vista 和 Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=9640cd8b-d749-4ddd-8af9-b298cebed969)                                                             | 特权提升     | 重要         | 无               |
| [Windows Vista x64 Edition and Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=d56bb4fe-304e-45e0-95f2-fde2f47b2a04)                                    | 特权提升     | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=4497333c-9418-4b91-83dc-0155735421c0)                                                                     | 特权提升     | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=5aefc7a6-79a4-45a2-b534-35d0ec400dda)                                                                | 特权提升     | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=3080c26b-7456-41ef-8668-28f15bc7b8ce)                                                            | 特权提升     | 重要         | 无               |

与此安全更新相关的常见问题 (FAQ)
--------------------------------

**客户在卸载此安全更新时可能遇到哪些已知问题？**  
[Microsoft 知识库文章 941693](https://support.microsoft.com/kb/941693) 介绍了客户在卸载此安全更新时可能遇到的当前已知问题。 MS08-025（内核）和 MS08-021 (GDI) 提供的安全更新之间会共享二进制。 在安装这两个安全更新（MS08-025 和 MS08-021）并卸载 MS08-025（内核）提供的更新之后，MS08-021 (GDI) 提供的更新可能还原为容易受攻击的版本，这将导致向容易受攻击的系统重新提供 MS08-021 (GDI) 更新。

**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 941693](https://support.microsoft.com/kb/941693) 中找到文件信息详细资料。
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 内核漏洞 - CVE-2008-1084</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1084](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1084)。
  
#### Windows 内核漏洞 (CVE-2008-1084) 的缓解因素
  
攻击者必须拥有有效的登录凭据并能本地登录易受攻击的系统才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核漏洞 (CVE-2008-1084) 的变通方法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核漏洞 (CVE-2008-1084) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核未正确验证从用户模式传递给内核的输入。
...
**受此漏洞威胁最大的系统有哪些？**    
允许可能存在危险的用户本地登录的任何 Windows 系统均可能受到此漏洞的威胁。 Windows XP Service Pack 3 不受此漏洞的影响。
  
**此更新有什么作用？**    
此更新通过正确地验证用户模式回叫传递给 Windows 内核的参数来消除此漏洞。
...
**Windows 备注Vista** **Windows Server 2008** Microsoft 不支持在运行 Windows Vista 的计算机上安装 MBSA 2.0.1，但是您可以在受支持的操作系统上安装 MBSA 2.0.1，然后远程扫描基于 Windows Vista 的计算机。 有关 Windows Vista 的 MBSA 支持的其他信息，请访问 [MBSA 网站](https://go.microsoft.com/fwlink/?linkid=21134)。 请参阅 [Microsoft 知识库文章 931943](https://support.microsoft.com/kb/931943)： Windows Vista 的 Microsoft Baseline Security Analyzer (MBSA) 支持。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB941693Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/941693">Microsoft 知识库文章 941693</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB941693$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/941693">Microsoft 知识库文章 941693</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB941693$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/941693">Microsoft 知识库文章 941693</a></td>
...
-   [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 报告了 Windows 内核漏洞 (CVE-2008-1084)。

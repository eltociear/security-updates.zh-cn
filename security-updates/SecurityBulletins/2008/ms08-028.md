...
此安全更新也解决了 [Microsoft 安全通报 950627](https://technet.microsoft.com/security/advisory/950627) 中最初描述的漏洞。除了安装此更新之外，我们建议具有 Microsoft Word 的客户还安装 [Microsoft 安全公告 MS08-026： Microsoft Word 中的漏洞可能允许远程执行代码 (951207)](https://go.microsoft.com/fwlink/?linkid=117295) 中提供的更新以获得对这些类型攻击的攻击媒介的最新保护。
...
|----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------------------------------------------------|
| Microsoft Windows 2000 Service Pack 4              | [Microsoft Jet 4.0 数据库引擎](https://www.microsoft.com/download/details.aspx?familyid=0de12d09-e675-4cf0-bc6f-e42eeb4784a1)\* | 远程执行代码 | 严重         | [MS04-014](https://technet.microsoft.com/security/bulletin/ms04-014) |
| Windows XP Service Pack 2                          | [Microsoft Jet 4.0 数据库引擎](https://www.microsoft.com/download/details.aspx?familyid=3247433f-0aa9-49b8-9e40-c5463a95bcff)\* | 远程执行代码 | 严重         | 无                                                                  |
| Windows XP Professional x64 Edition                | [Microsoft Jet 4.0 数据库引擎](https://www.microsoft.com/download/details.aspx?familyid=4915ebc4-5e7b-493e-b8c4-321d40d9a701)\* | 远程执行代码 | 严重         | 无                                                                  |
| Windows Server 2003 Service Pack 1                 | [Microsoft Jet 4.0 数据库引擎](https://www.microsoft.com/download/details.aspx?familyid=86e3ed62-98f7-46ec-96ab-5e8c123b1288)\* | 远程执行代码 | 严重         | 无                                                                  |
| Windows Server 2003 x64 Edition                    | [Microsoft Jet 4.0 数据库引擎](https://www.microsoft.com/download/details.aspx?familyid=5dfc867b-74b7-4818-9fc2-d71e7c9d2e38)\* | 远程执行代码 | 严重         | 无                                                                  |
| Windows Server 2003 SP1（用于基于 Itanium 的系统） | [Microsoft Jet 4.0 数据库引擎](https://www.microsoft.com/download/details.aspx?familyid=3452119b-ba4c-4272-82ec-97396b2c2c3d)\* | 远程执行代码 | 严重         | 无                                                                  |
...
**此更新可防止通过其他应用程序的攻击吗？**  
是。 安装的应用程序可用作此漏洞的攻击媒介。 例如，可以从 Word 文件、从电子邮件或通过访问恶意网站打开 Jet 数据库文件。 应用此更新将阻止这些攻击。 但是，建议客户同时应用 [Microsoft 安全公告 MS08-026： Microsoft Word 中的漏洞可能允许远程执行代码 (951207)](https://go.microsoft.com/fwlink/?linkid=117295) 中提供的更新以完全阻止新发现的攻击媒介。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-6026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-6026)。
...
-   **阻止通过邮件基础结构处理 MDB 文件**
    ...
    **注意** 对于普通用户而言，所有 Jet 数据库文件应被视为不安全的文件类型，Microsoft 建议将通过电子邮件传输的数据库文件视为可疑文件。
    ...
    有关特定于使用 Forefront（以前称为 Antigen）的 Microsoft Exchange 客户的配置，请参阅 [Microsoft Forefront Server Security： 文件筛选](https://technet.microsoft.com/en-us/library/bb795068.aspx)获取更多信息。
  
    此信息已与 [Microsoft Security Response Alliance](https://www.microsoft.com/security/msra/default.mspx) 的成员共享。 要利用 MSRA 工具检测 MDB 文件，请与 MSRA 主页上列出的供应商联系。
...
虽然 .mdb 在不安全文件类型列表中，但是已发现新的攻击媒介，可以通过 Word 文件打开 Jet 数据库文件。 此更新将阻止当前攻击，并提供 Jet 数据库引擎的附加修补程序。 但是，建议客户同时应用 [Microsoft 安全公告 MS08-026： Microsoft Word 中的漏洞可能允许远程执行代码 (951207)](https://go.microsoft.com/fwlink/?linkid=117295) 中提供的更新以阻止新发现的攻击媒介。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露并统称为“Microsoft Jet 引擎 MDB 文件分析堆栈溢出漏洞”，还分配了常见漏洞和披露号码 [CVE 2007-6026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-6026)。
  
**此安全更新解决 Microsoft 安全通报 950627 中确定的问题吗？**    
是。 此安全更新的发布解决 [Microsoft 安全通报 950627](https://technet.microsoft.com/security/advisory/950627) 中标识为 CVE 2008-1092 的安全问题。在研究该问题之后，Microsoft 已确定这是与 [CVE-2007-6026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-6026) 相同的问题，因此已为此安全公告重新分类。
  
**在发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
是。 在发布此安全公告时，Microsoft 已收到有关此漏洞已被利用的信息。
  
**应用此安全更新有助于客户防止尝试利用此漏洞的已公开发布代码吗？**    
是。 此安全更新可消除目前被利用的漏洞。 已为解决的漏洞分配了常见漏洞和披露号码 [CVE-2007-6026](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-6026)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/950749">Microsoft 知识库文章 950749</a>。</td>
</tr>  
<tr class="even">
...
-   [CERT/CC](https://www.cert.org/) 报告了该问题 - CVE-2007-6026
-   [ISC/SANS](https://isc.sans.org/) 报告了该问题 - CVE-2007-6026
-   [TippingPoint DVLabs](https://dvlabs.tippingpoint.com/) 的 Aaron Portnoy 报告了该问题 - CVE-2007-6026

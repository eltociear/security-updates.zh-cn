---
TOCTitle: 'MS08-014'
Title: 'Microsoft 安全公告 MS08-014 - 严重'
ms:assetid: 'ms08-014'
ms:contentKeyID: 61237139
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-014(v=Security.10)'
---
...
对于 Microsoft Office Excel 2000 Service Pack 3，此安全更新的等级为“严重”；对于 Excel 2002 Service Pack 3、Excel 2003 Service Pack 2、Excel Viewer 2003、Excel 2007、用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包、Office 2004 for Mac 和 Office 2008 for Mac，此安全更新的等级为“重要”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过修改 Microsoft Excel 在打开 Excel 文件时执行验证的方式来消除这些漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。

此安全更新也解决了[Microsoft 安全通报 947563](https://technet.microsoft.com/security/advisory/947563) 中最初描述的漏洞。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=f7f90c30-1bfd-406b-a77f-612443e30185">Excel 2000 Service Pack 3</a><br />
(KB946979)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-044">MS07-044</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Microsoft Office XP Service Pack 3</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=907f96d5-d1e9-4471-b41c-3ac811e63038">Excel 2002 Service Pack 3</a><br />
(KB946976)</td>
<td style="border:1px solid black;">远程执行代码</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=296e5f2c-f594-41c8-a20a-3e4c40ae3948">Excel 2003 Service Pack 2</a><br />
(KB943985)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-044">MS07-044</a></td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e7634cb5-9531-4284-9554-4168fc488e0c">Excel 2007</a><br />
(KB946974)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-036">MS07-036</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=280bb2ac-b21a-46b5-8751-5a50fbebf107">Microsoft Office Excel Viewer 2003</a><br />
(KB943889)</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e9251d71-9098-4125-ae91-7d4c83ea58ad">用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包</a><br />
(KB947801)</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms08-013">MS08-013</a></td>
</tr>  
<tr class="even">
...
<tr class="header">  
<th>受影响的软件</th>  
<th>Excel 数据验证记录漏洞 - CVE-2008-0111</th>  
<th>Excel 文件导入漏洞 - CVE-2008-0112</th>  
<th>Excel 样式记录漏洞 - CVE-2008-0114</th>  
<th>Excel 公式分析漏洞 - CVE-2008-0115</th>  
<th>Excel 富文本验证漏洞 - CVE-2008-0116</th>  
<th>Excel 条件格式漏洞 - CVE-2008-0117</th>  
<th>宏验证漏洞 - CVE-2008-0081</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0111](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0111)。
  
#### Excel 数据验证记录漏洞 (CVE-2008-0111) 的缓解因素
...
#### Excel 数据验证记录漏洞 (CVE-2008-0111) 的变通办法
...
**造成漏洞的原因是什么？**  
Microsoft Excel 在将 Excel 文件加载到内存时未执行足够的数据验证。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 在将 Excel 文件从磁盘加载到内存时处理数据验证记录的方式来消除此漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0112](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0112)。
  
#### Excel 文件导入漏洞 (CVE-2008-0112) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在基于 Web 的攻击情形中，攻击者需要说服用户导入格式错误的 Excel 文件，该文件可能宿主在用于利用此漏洞的网站上。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须说服用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。  
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。  
-   此漏洞无法通过电子邮件自动加以利用。 用户必须打开电子邮件附件，以电子邮件为载体的攻击才会得逞。  
-   如果 Office 2000 用户安装并使用 [Office 文档打开确认工具](https://www.microsoft.com/download/details.aspx?familyid=8b5762d2-077f-4031-9ee6-c9538e9f2a2f)，则在打开文档之前，系统将提示该用户**打开**、**保存**或**取消**。 Office 文档打开确认工具的功能包含在 Office XP 和更高版本的 Office 中。
  
#### Excel 文件导入漏洞 (CVE-2008-0112) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Office 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。
  
#### Excel 文件导入漏洞 (CVE-2008-0112) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**  
Microsoft Excel 在将文件导入到 Excel 时未执行足够的数据验证。
  
**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可能以登录用户的身份运行任意代码。 如果用户使用管理用户权限登录，攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**攻击者如何利用此漏洞？**  
此漏洞需要用户使用 Microsoft Excel 的受影响版本导入格式错误的 Excel 文件。
  
在电子邮件攻击情形中，攻击者可以通过向用户发送格式错误的 Excel 文件并说服用户在 Excel 中导入该文件来利用此漏洞。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 在将 .slk 文件导入到 Excel 时验证文件数据的方式来消除此漏洞。 但是，在应用此更新之后，尝试导入格式错误的 .slk 文件仍可能导致 Excel 意外退出。 此行为不可利用。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0114](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0114)。
  
#### Excel 样式记录漏洞 (CVE-2008-0114) 的缓解因素
...
#### Excel 样式记录漏洞 (CVE-2008-0114) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**  
该漏洞是在打开特制 Excel 文件时验证样式记录信息过程中 Excel 中的内存处理错误引起的。 该错误可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 验证样式记录信息的方式来消除此漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0115](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0115)。
  
#### Excel 公式分析漏洞 (CVE-2008-0115) 的缓解因素
...
#### Excel 公式分析漏洞 (CVE-2008-0115) 的变通办法
...
#### Excel 公式分析漏洞 (CVE-2008-0115) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**  
该漏洞是由分析特制 Excel 文件中的公式信息时的内存计算错误引起的。 该错误可能以一种攻击者可以执行任意代码的方式来破坏系统内存。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 在将 Excel 文件加载到内存时验证公式信息的方式来消除此漏洞。
...
Excel 富文本验证漏洞 - CVE-2008-0116  
------------------------------------
  
  
Excel 在将应用程序数据加载到内存时处理富文本值的方式中存在一个远程执行代码漏洞。 攻击者可能通过发送格式错误的文件来利用该漏洞，该文件可能宿主在特制的或被破坏的网站上，或者是电子邮件附件。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0116](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0116)。
  
#### Excel 富文本验证漏洞 (CVE-2008-0116) 的缓解因素
...
#### Excel 富文本验证漏洞 (CVE-2008-0116) 的变通办法
...
#### Excel 富文本验证漏洞 (CVE-2008-0116) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**  
Microsoft Excel 在将应用程序数据加载到内存时未执行足够的数据验证。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 在加载特制的 Excel 文件时验证富文本数据的方式来消除此漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0117](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0117)。
  
#### Excel 条件格式漏洞 (CVE-2008-0117) 的缓解因素
...
#### Excel 条件格式漏洞 (CVE-2008-0117) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Office 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。
  
#### Excel 条件格式漏洞 (CVE-2008-0117) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**  
Microsoft Excel 未执行足够的条件格式值验证。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 在打开 Excel 文件时验证条件格式值的方式来消除此漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0081](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0081)。
  
#### 宏验证漏洞 (CVE-2008-0081) 的缓解因素
...
#### 宏验证漏洞 (CVE-2008-0081) 常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**  
Microsoft Excel 在加载特制 Excel 文件时验证宏信息的方式不正确。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 验证宏信息的方式来消除此漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 在最初发布此安全公告时，此漏洞已被公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2008-0081](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0081)。此漏洞最初是在 [Microsoft 安全通报 947563](https://technet.microsoft.com/security/advisory/947563) 中介绍的。
...
Microsoft 已为本月的安全更新提供了检测和部署指南。 此指南还将帮助 IT 专业人士了解如何可以使用各种工具帮助部署安全更新，例如 Windows Update、Microsoft Update、Office Update、Microsoft Baseline Security Analyzer (MBSA)、Office 检测工具、Microsoft Systems Management Server (SMS)、扩展安全更新清单工具以及企业更新扫描工具 (EST)。 有关详细信息，请参阅 [Microsoft 知识库文章 910723](https://support.microsoft.com/kb/910723)。
...
| 用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft 兼容包 | 是         |  
...
<tr class="odd">
<td style="border:1px solid black;">更新日志文件</td>
<td style="border:1px solid black;">用户可以使用 /log 开关启用详细日志记录。 有关详细信息，请参阅 <a href="https://support.microsoft.com/kb/912203">Microsoft 知识库文章 912203</a>。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">更多信息</td>
...
对于 Excel 兼容包所有受支持的版本：
  
| 文件名       | 版本           | 日期               | 时间  | 大小       |  
|--------------|----------------|--------------------|-------|------------|  
| Excelcnv.exe | 12.0.6300.5000 | 2007 年 12 月 7 日 | 14:50 | 14,712,344 |
...
要安装 Windows Installer 3.1，请访问以下 Microsoft 网站：
...
| 开关                          | 描述                                                                  |  
|-------------------------------|-----------------------------------------------------------------------|  
| /extract:\[**路径***\]*       | 将程序包的内容提取到路径文件夹。 如果不指定路径，则显示“浏览”对话框。 |  
...
**注意** 可以将这些开关组合到一个命令中。 为了保持向后兼容，此安全更新还支持以前版本的安装程序所使用的安装开关。 有关受支持的安装开关的详细信息，请参阅 [Microsoft 知识库文章 912203](https://support.microsoft.com/kb/912203)。有关安装程序的详细信息，请访问 [Microsoft TechNet 网站](https://go.microsoft.com/fwlink/?linkid=38951)。
...
从 [Microsoft Mactopia 网站](https://www.microsoft.com/mac/downloads.mspx?pid=mactopia_office2004&fid=632ec4b3-b998-4f22-b9d6-93c09c385479%20viewer)下载和安装 Microsoft Microsoft Office 2004 for Mac 11.4.1 更新合适的语言版本。
...
从 [Microsoft Mactopia 网站](https://www.microsoft.com/mac/downloads.mspx?pid=mactopia_office2004&fid=632ec4b3-b998-4f22-b9d6-93c09c385479%20viewer)下载和安装 Microsoft Microsoft Office 2008 for Mac 12.0.1 更新合适的语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Microsoft Office 2008 for Mac 12.0.1 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Microsoft Office 2008 for Mac 12.0.1 Update 卷窗口中双击 Microsoft Office 2008 for Mac 12.0.1 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2008 for Mac 12.0.1 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
-   [SAIC](https://www.saic.com/) 的 Mike Scott 报告了宏验证漏洞 (CVE-2008-0081)  
-   [VeriSign](https://www.verisign.com/) 的 Matt Richard 报告了宏验证漏洞 (CVE-2008-0081)  
-   [iDefense Labs](https://labs.idefense.com/) 的 Greg MacManus 报告了 Excel 数据验证记录漏洞 (CVE-2008-0111)  
-   [JFE Systems](https://www.jfe-systems.com/) 的 Yoshiya Sasaki 报告了 Excel 文件导入漏洞 (CVE-2008-0112)  
-   [Fortinet](https://www.fortinet.com/) 的 Bing Liu 报告了 Excel 样式记录漏洞 (CVE-2008-0114)  
-   [iDefense Labs](https://labs.idefense.com/) 报告了 Excel 公式分析漏洞 (CVE-2008-0115)  
-   [TippingPoint DVLabs](https://dvlabs.tippingpoint.com) 的 Cody Pierce 报告了 Excel 富文本验证漏洞 (CVE-2008-0116)  
-   [Websense Security Labs](https://www.websense.com/) 的 Moti Joseph 和 Dan Hubbard 报告了 Excel 条件格式漏洞 (CVE-2008-0117)

...
此安全更新也解决了[Microsoft 安全通报 947563](http://technet.microsoft.com/security/advisory/947563) 中最初描述的漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0111](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0111)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0112](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0112)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0114](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0114)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0115](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0115)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0116](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0116)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0117](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0117)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0081](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0081)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 在最初发布此安全公告时，此漏洞已被公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2008-0081](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0081)。此漏洞最初是在 [Microsoft 安全通报 947563](http://technet.microsoft.com/security/advisory/947563) 中介绍的。
...
<tr class="odd">
<td style="border:1px solid black;">更新日志文件</td>
<td style="border:1px solid black;">用户可以使用 /log 开关启用详细日志记录。 有关详细信息，请参阅 <a href="http://support.microsoft.com/kb/912203">Microsoft 知识库文章 912203</a>。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">更多信息</td>
...
从 [Microsoft Mactopia 网站](http://www.microsoft.com/mac/downloads.mspx?pid=mactopia_office2004&fid=632ec4b3-b998-4f22-b9d6-93c09c385479%20viewer)下载和安装 Microsoft Microsoft Office 2008 for Mac 12.0.1 更新合适的语言版本。
...
-   [SAIC](http://www.saic.com/) 的 Mike Scott 报告了宏验证漏洞 (CVE-2008-0081)  
-   [VeriSign](http://www.verisign.com/) 的 Matt Richard 报告了宏验证漏洞 (CVE-2008-0081)  
-   [iDefense Labs](http://labs.idefense.com/) 的 Greg MacManus 报告了 Excel 数据验证记录漏洞 (CVE-2008-0111)  
-   [JFE Systems](http://www.jfe-systems.com/) 的 Yoshiya Sasaki 报告了 Excel 文件导入漏洞 (CVE-2008-0112)  
-   [Fortinet](http://www.fortinet.com/) 的 Bing Liu 报告了 Excel 样式记录漏洞 (CVE-2008-0114)  
-   [iDefense Labs](http://labs.idefense.com/) 报告了 Excel 公式分析漏洞 (CVE-2008-0115)  
-   [TippingPoint DVLabs](http://dvlabs.tippingpoint.com) 的 Cody Pierce 报告了 Excel 富文本验证漏洞 (CVE-2008-0116)  
-   [Websense Security Labs](http://www.websense.com/) 的 Moti Joseph 和 Dan Hubbard 报告了 Excel 条件格式漏洞 (CVE-2008-0117)

---
TOCTitle: 'MS08-003'
Title: 'Microsoft 安全公告 MS08-003 - 重要'
ms:assetid: 'ms08-003'
ms:contentKeyID: 61237128
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-003(v=Security.10)'
---

Microsoft 安全公告 MS08-003 - 重要
==================================
...
这是 Microsoft Windows 2000 的重要安全更新，也是 Windows XP 和 Windows Server 2003 的中等安全更新。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过验证客户端 LDAP 请求来消除漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9df0875d-0466-4974-b4c0-1ecc777173b1">Active Directory</a><br />
(KB943484)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=93365">MS07-039</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows XP Professional Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=bff7dcb9-5d00-442e-b03c-ce923d213faa">ADAM</a><br />
(KB931374)</td>
<td style="border:1px solid black;">拒绝服务</td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition 和 Windows XP Professional Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=36e36e1a-ed0d-45a6-b707-766fabc01fbd">ADAM</a><br />
(KB931374)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=63d3d784-f057-4686-b85e-ab5fbab5a722">Active Directory</a><br />
(KB943484)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=93365">MS07-039</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=60781cf3-7c6d-4795-a9d0-bc18ee356e94">ADAM</a><br />
(KB931374)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=835d647a-dce6-476e-b7c4-928a67b0acfb">Active Directory</a><br />
(KB943484)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=93365">MS07-039</a></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5e97698d-8150-44f9-9d34-87a0db6ba5a7">ADAM</a><br />
(KB931374)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;">无</td>
...
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=eda8af09-1a4c-4163-a8bb-97dacdebeae4">Active Directory</a><br />
(KB943484)</td>
<td style="border:1px solid black;">拒绝服务</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;"><a href="https://go.microsoft.com/fwlink/?linkid=93365">MS07-039</a></td>
...
<tr class="header">  
<th>受影响的软件</th>  
<th>Active Directory 漏洞 - CVE-2008-0088</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
...
<tr class="even">
<td style="border:1px solid black;">安装在 Windows XP Professional Service Pack 2 上的 ADAM</td>
<td style="border:1px solid black;"><strong>中等 </strong><br />
拒绝服务</td>
<td style="border:1px solid black;"><strong>中等</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">Windows XP Professional x64 Edition 和 Windows XP Professional Edition Service Pack 2 上的 ADAM</td>
<td style="border:1px solid black;"><strong>中等 </strong><br />
拒绝服务</td>
<td style="border:1px solid black;"><strong>中等</strong></td>
</tr>  
...
Active Directory 漏洞 - CVE-2008-0088  
-------------------------------------
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0088](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0088)。
  
#### Active Directory 漏洞 (CVE-2008-0088) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
Microsoft 并未发现此漏洞的任何缓解因素。
  
#### Active Directory 漏洞 (CVE-2008-0088) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **在外围防火墙处阻止 TCP 端口 389 和 3268**
  
    这些端口用于启动与受影响组件的连接。 将其阻止在企业防火墙处（入站和出站），有助于保护位于防火墙后面的系统免受利用此漏洞进行的攻击。 我们建议阻止所有来自 Internet 的未经请求的入站通信，以帮助防止可能使用其他端口进行的攻击。 有关端口的详细信息，清参阅 TCP 和 UDP 端口分配网站。
...
#### Active Directory 漏洞 (CVE-2008-0088) 的常见问题
...
[ADAM](https://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true) 是一种轻型目录访问协议 (LDAP) 目录服务，作为用户服务运行，而非作为系统服务运行。
...
#### 带有 Active Directory 的 Windows 2000 Server (KB943484)
...
<td style="border:1px solid black;">Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstall kb943484$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
...
| 文件名     | 版本          | 日期                | 时间  | 大小      |
|------------|---------------|---------------------|-------|-----------|
| ntdsa.dll  | 5.0.2195.7147 | 2007 年 10 月 16 日 | 00:46 | 939,280   |
| sp3res.dll | 5.0.2195.7136 | 2007 年 5 月 27 日  | 18:26 | 6,258,688 |
...
<tr class="odd">
<td style="border:1px solid black;"><strong>包括在以后的 Service Pack 中</strong></td>
<td style="border:1px solid black;">此问题的更新不包含在以后的 Service Pack 或更新汇总中，因为这是一个可选组件</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>部署</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB931374$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关完整的文件清单，请参阅下一小节“<strong>文件信息</strong>”</td>
...
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 x64 版本 Windows XP：
<p>HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\Windows XP Version 2003\SP3\KB931374\Filelist</p></td>
</tr>
</tbody>
</table>

**注意：** Windows XP Home Service Pack 2、Windows XP Tablet Edition Service Pack 2 和 Windows XP Media Center Edition Service Pack 2 的受支持版本不受影响，因为它们不包括 ADAM 或 Active Directory 服务器组件。
...
| 文件名      | 版本          | 日期              | 时间  | 大小      | 文件夹 |
|-------------|---------------|-------------------|-------|-----------|--------|
| adamdsa.dll | 1.1.3790.4188 | 2008 年 1 月 6 日 | 17:35 | 1,631,744 | SP2GDR |
| adamdsa.dll | 1.1.3790.4188 | 2008 年 1 月 6 日 | 17:50 | 1,632,768 | SP2QFE |

对于 Windows XP 所有受支持的 64 位版本：

| 文件名      | 版本          | 日期               | 时间  | 大小      | CPU | 文件夹 |
|-------------|---------------|--------------------|-------|-----------|-----|--------|
| adamdsa.dll | 1.1.3790.3043 | 2008 年 1 月 10 日 | 15:48 | 2,953,216 | X64 | SP1GDR |
| adamdsa.dll | 1.1.3790.3043 | 2008 年 1 月 10 日 | 15:48 | 2,956,288 | X64 | SP1QFE |
| adamdsa.dll | 1.1.3790.4188 | 2008 年 1 月 10 日 | 16:02 | 2,957,824 | X64 | SP2GDR |
| adamdsa.dll | 1.1.3790.4188 | 2008 年 1 月 10 日 | 15:46 | 2,959,360 | X64 | SP2QFE |
...
#### 带 Active Directory 的 Windows Server 2003（所有版本）(KB943484)
...
<p>使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB943484$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关完整的文件清单，请参阅下一小节“<strong>文件信息</strong>”</td>
...
| 文件名       | 版本          | 日期                | 时间  | 大小      | 文件夹 |
|--------------|---------------|---------------------|-------|-----------|--------|
| ntdsa.dll    | 5.2.3790.3043 | 2007 年 11 月 13 日 | 21:33 | 1,515,520 | SP1GDR |
| ntdsa.dll    | 5.2.3790.3043 | 2007 年 11 月 13 日 | 22:03 | 1,524,224 | SP1QFE |
| w03a2409.dll | 5.2.3790.3057 | 2007 年 12 月 11 日 | 21:40 | 28,672    | SP1QFE |
| ntdsa.dll    | 5.2.3790.4188 | 2007 年 11 月 13 日 | 21:43 | 1,522,176 | SP2GDR |
| ntdsa.dll    | 5.2.3790.4188 | 2007 年 11 月 13 日 | 21:36 | 1,525,248 | SP2QFE |

对于 Windows Server 2003 所有受支持的基于 Itanium 的版本：

| 文件名        | 版本          | 日期                | 时间  | 大小      | CPU   | 文件夹      |
|---------------|---------------|---------------------|-------|-----------|-------|-------------|
| ntdsa.dll     | 5.2.3790.3043 | 2007 年 12 月 19 日 | 07:38 | 4,237,312 | IA-64 | SP1GDR      |
| wntdsa.dll    | 5.2.3790.3043 | 2007 年 12 月 19 日 | 07:38 | 1,515,520 | X86   | SP1GDR\\wow |
| ntdsa.dll     | 5.2.3790.3043 | 2007 年 12 月 19 日 | 07:38 | 4,257,280 | IA-64 | SP1QFE      |
| w03a2409.dll  | 5.2.3790.3057 | 2007 年 12 月 19 日 | 07:38 | 27,648    | IA-64 | SP1QFE      |
| wntdsa.dll    | 5.2.3790.3043 | 2007 年 12 月 19 日 | 07:38 | 1,524,224 | X86   | SP1QFE\\wow |
| ww03a2409.dll | 5.2.3790.3057 | 2007 年 12 月 19 日 | 07:38 | 28,672    | X86   | SP1QFE\\wow |
| ntdsa.dll     | 5.2.3790.4188 | 2007 年 12 月 19 日 | 07:47 | 4,253,184 | IA-64 | SP2GDR      |
| wntdsa.dll    | 5.2.3790.4188 | 2007 年 12 月 19 日 | 07:47 | 1,522,176 | X86   | SP2GDR\\wow |
| ntdsa.dll     | 5.2.3790.4188 | 2007 年 12 月 19 日 | 07:35 | 4,260,352 | IA-64 | SP2QFE      |
| wntdsa.dll    | 5.2.3790.4188 | 2007 年 12 月 19 日 | 07:35 | 1,525,248 | X86   | SP2QFE\\wow |

对于 Windows Server 2003 所有受支持的基于 x64 的版本：

| 文件名        | 版本          | 日期                | 时间  | 大小      | CPU | 文件夹      |
|---------------|---------------|---------------------|-------|-----------|-----|-------------|
| ntdsa.dll     | 5.2.3790.3043 | 2007 年 12 月 19 日 | 07:34 | 2,947,072 | X64 | SP1GDR      |
| wntdsa.dll    | 5.2.3790.3043 | 2007 年 12 月 19 日 | 07:34 | 1,515,520 | X86 | SP1GDR\\wow |
| ntdsa.dll     | 5.2.3790.3043 | 2007 年 12 月 19 日 | 07:34 | 2,968,576 | X64 | SP1QFE      |
| w03a2409.dll  | 5.2.3790.3057 | 2007 年 12 月 19 日 | 07:34 | 29,184    | X64 | SP1QFE      |
| wntdsa.dll    | 5.2.3790.3043 | 2007 年 12 月 19 日 | 07:34 | 1,524,224 | X86 | SP1QFE\\wow |
| ww03a2409.dll | 5.2.3790.3057 | 2007 年 12 月 19 日 | 07:34 | 28,672    | X86 | SP1QFE\\wow |
| ntdsa.dll     | 5.2.3790.4188 | 2007 年 12 月 19 日 | 07:47 | 2,967,040 | X64 | SP2GDR      |
| wntdsa.dll    | 5.2.3790.4188 | 2007 年 12 月 19 日 | 07:47 | 1,522,176 | X86 | SP2GDR\\wow |
| ntdsa.dll     | 5.2.3790.4188 | 2007 年 12 月 19 日 | 07:35 | 2,970,112 | X64 | SP2QFE      |
| wntdsa.dll    | 5.2.3790.4188 | 2007 年 12 月 19 日 | 07:35 | 1,525,248 | X86 | SP2QFE\\wow |
...
#### 带 ADAM 的 Windows Server 2003（所有版本）(KB931374)
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">对于 Windows Server 2003 所有受支持的基于 32 位和基于 x64 的版本：
<p>使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB931374$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">有关完整的文件清单，请参阅下一小节“<strong>文件信息</strong>”</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 所有受支持的 32 位版本、基于 x64 的版本：<br />
...
| 文件名      | 版本          | 日期                | 时间  | 大小      | 文件夹 |
|-------------|---------------|---------------------|-------|-----------|--------|
| adamdsa.dll | 1.1.3790.3043 | 2007 年 11 月 13 日 | 21:33 | 1,630,720 | SP1GDR |
| adamdsa.dll | 1.1.3790.3043 | 2007 年 11 月 13 日 | 22:03 | 1,631,232 | SP1QFE |
| adamdsa.dll | 1.1.3790.4188 | 2007 年 11 月 13 日 | 21:43 | 1,631,744 | SP2GDR |
| adamdsa.dll | 1.1.3790.4188 | 2007 年 11 月 13 日 | 21:36 | 1,632,768 | SP2QFE |
...
-   [SkyRecon](https://www.skyrecon.com/) 的 Thomas Garnier 报告了 Active Directory 漏洞 (CVE-2008-0088)。
...
-   V1.1（2008 年 2 月 13 日）： 公告经过更新，针对安装了 ADAM 的 Windows XP Professional 的所有受支持的 x64 版本在“注册表项验证”部分提供正确的 KB 编号。
-   

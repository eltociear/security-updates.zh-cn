...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-0088](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-0088)。
...
[ADAM](http://technet2.microsoft.com/windowsserver/en/library/29fb059e-544c-4577-bf7c-ba4b08df48431033.mspx?mfr=true) 是一种轻型目录访问协议 (LDAP) 目录服务，作为用户服务运行，而非作为系统服务运行。
...
-   [SkyRecon](http://www.skyrecon.com/) 的 Thomas Garnier 报告了 Active Directory 漏洞 (CVE-2008-0088)。

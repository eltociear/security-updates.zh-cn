---
TOCTitle: 'MS08-032'
Title: 'Microsoft 安全公告 MS08-032 - 警告'
ms:assetid: 'ms08-032'
ms:contentKeyID: 61237156
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms08-032(v=Security.10)'
---

Microsoft 安全公告 MS08-032 - 警告
==================================
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=cedfd988-232c-4cba-ac65-beb54b8946e0)                                                   | 远程执行代码 | 中等         | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=2d8957c2-e473-4dca-8d68-19fdaea36e26)                                                               | 远程执行代码 | 中等         | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows XP Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=2d8957c2-e473-4dca-8d68-19fdaea36e26)                                                               | 远程执行代码 | 中等         | 无                                                        |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=62874096-7d17-4116-9795-4756e2fb6dae)                 | 远程执行代码 | 中等         | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=dadead99-09cb-4f2b-850d-e98a627cb9f8)                | 远程执行代码 | 低           | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=84f9b533-b0cb-46d1-b4a8-5c9469abbd22)                         | 远程执行代码 | 低           | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=ac35ce19-d761-4529-9f55-1e1b5b2447ad) | 远程执行代码 | 低           | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows Vista 和 Windows Vista Service Pack 1](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=4af6575e-b061-45a6-b3d8-ecb32d76b2d3)                                           | 远程执行代码 | 中等         | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows Vista x64 Edition and Windows Vista x64 Edition Service Pack 1](https://www.microsoft.com/download/details.aspx?familyid=67576acb-9cb6-4c76-9a72-dc5e5556b658)                                    | 远程执行代码 | 中等         | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows Server 2008（用于 32 位系统）](https://www.microsoft.com/download/details.aspx?familyid=8a507fba-8c93-4952-91e4-98e9e7affbd2)\*                                                                   | 远程执行代码 | 低           | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows Server 2008（用于基于 x64 的系统）](https://www.microsoft.com/download/details.aspx?familyid=1a11499d-a008-407f-9084-a5189fa27015)\*                                                              | 远程执行代码 | 低           | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |
| [Windows Server 2008（用于基于 Itanium 的系统）](https://www.microsoft.com/download/details.aspx?familyid=59b1689c-e723-4d87-973e-4beac107a6f7)                                                            | 远程执行代码 | 低           | [MS08-023](https://go.microsoft.com/fwlink/?linkid=112366) |

\*对于 Windows Server 2008 的受支持版本，无论安装时是否使用“服务器核心”安装选项，严重等级相同。 有关该安装选项的详细信息，请参阅[服务器核心](https://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)。 注意，“服务器核心”安装选项不适用于某些 Windows Server 2008 版本；请参阅[比较“服务器核心”安装选项](https://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)。

**受影响软件备注** 对于此更新为其设置了 kill bit 的第三方控件，Microsoft 不会评定严重等级。 不过，kill bit 将被部署到所有平台中，包括不受 Microsoft 软件中的漏洞影响的平台。 另请参阅本节的“第三方 Kill Bit”小节。
...
<tr class="header">
<th>受影响的软件</th>
<th>Speech API 漏洞 - CVE-2007-0675</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
此控件从不在 Internet Explorer 中实例化。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-0675](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0675)。
  
#### Speech API 漏洞 (CVE-2007-0675) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   Windows Vista 的语音识别功能在默认情况下不启用。  
...
#### Speech API 漏洞 (CVE-2007-0675) 的变通方法
...
-   **阻止 COM 对象在 Internet Explorer 中运行**
    ...
    **注意** “Speech API 漏洞 (CVE-2007-0675) 的常见问题”小节的“此更新有什么作用？”之下介绍了类标识符和 ActiveX 对象所在的对应文件。 使用本部分中找到的类标识符替换下列 {XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX}。
...
#### Speech API 漏洞 (CVE-2007-0675) 的常见问题
  
**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以获得与登录用户相同的用户权限。 必须启用并配置 Windows Vista 中的语音识别功能，才能成功利用此漏洞。
  
如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
**造成漏洞的原因是什么？**  
激活并配置语音识别功能后，攻击者就可以通过用 Internet Explorer 播放音频文件来发出命令，从而执行任意代码。
  
**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
没有 UAC 关于管理员凭据的提示，就不可能通过使用语音命令让系统执行特权功能，如创建用户。 默认情况下，UAC 提示不能通过语音命令来操纵。 另外，其他障碍也会使攻击变得困难，这包括扬声器和麦克风位置、麦克风反馈以及语音的清晰度。
...
**为何此安全更新不包括 Windows** **Vista** **Service Pack 1？**  
此更新没有为 Windows Vista Service Pack 1 设置 kill bit，因为 CVE-2007-0675 描述的漏洞已在 Service Pack 更新中得到解决。
  
**什么是 SAPI？**  
SAPI 是供开发人员向应用程序添加语音识别和“文本到语音”功能的 Microsoft Speech Application Programming 界面。
  
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 CVE-2007-0675。大型安全社区还将它命名为“Vista 语音识别”。
...
-   BackWeb 已发布解决漏洞的[安全公告](https://go.microsoft.com/fwlink/?linkid=119280)和更新。 请参阅 [BackWeb](https://go.microsoft.com/fwlink/?linkid=119280)的安全公告了解详细信息和下载位置。 此 kill-bit 是应 ActiveX 控件所有者的请求而设置的。 如果用户需要获得此控件的支持，应与 [BackWeb](https://go.microsoft.com/fwlink/?linkid=119280) 联系。 此 ActiveX 控件的类标识符 (CLSIDs) 为：  
...
| XP Service Pack 2 和 Windows XP Service Pack 3                                                            | 是       |  
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB950760$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;">更新日志文件</td>
<td style="border:1px solid black;">Windows XP 和 Windows XP Professional<br />
的所有受支持版本：KB950760.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">更多信息</td>
<td style="border:1px solid black;">请参阅“<strong>检测和部署工具及指导</strong>”小节</td>
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">Windows XP 和 Windows XP Professional<br />
的所有受支持版本：使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB950760$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">Windows XP Service Pack 2 和 Windows XP Service Pack 3：<br />
...
使用控制面板中的“添加或删除程序”工具或者 %Windir%\\$NTUninstallKB950760$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">Windows Server 2003 所有受支持的版本：<br />

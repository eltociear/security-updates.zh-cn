...
**已知问题。** [Microsoft 知识库文章 957097](https://support.microsoft.com/kb/957097) 介绍了客户在安装此安全更新时可能遇到的任何当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](https://www.microsoft.com/download/details.aspx?familyid=44c971e6-96fc-4bba-8f4a-f9d46bda2b6c)                                                                     | 远程执行代码 | 重要         | [MS06-030](https://go.microsoft.com/fwlink/?linkid=62073) |
| [Windows XP Service Pack 2](https://www.microsoft.com/download/details.aspx?familyid=6f8ae0aa-fd68-4156-9016-bba00149793c)                                                                                 | 远程执行代码 | 重要         | [MS05-011](https://go.microsoft.com/fwlink/?linkid=36669) |
...
在安装此更新后，SQL 或 IIS 等应用程序在提出本地 NTLM 身份验证请求时可能失败，原因是 NTLM 将不同的命名约定视为远程条目，而非本地条目。 NTLM 是一个身份验证协议，该协议基于一个用于确定所提供凭据的真实性的质询/响应机制。 如果客户端在将对 NTLM 质询（由服务器发送）的正确响应发送回服务器之前计算响应并将其缓存在本地的“lsass”内存中，则本地身份验证可能失败。 如果 NTLM 的服务器代码发现收到的响应存在于本地的“lsass”缓存中，它会拒绝身份验证请求，将其视为重放攻击。 这将导致本地身份验证失败。 必须禁用反射保护，以便这些系统成功进行身份验证。 有关身份验证问题和命名约定的其它信息，请参阅[Microsoft 知识库文章 896861](https://support.microsoft.com/kb/896861)、[Microsoft 知识库文章 887993](https://support.microsoft.com/kb/887993) 和[Microsoft 知识库文章 926642](https://support.microsoft.com/kb/926642)。有关此安装问题的其它信息，包括禁用反射保护的详细步骤，请参阅 [Microsoft 知识库文章 957097](https://support.microsoft.com/kb/957097)。

**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 957097](https://support.microsoft.com/kb/957097) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4037](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4037)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2008-4037](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4037)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/957097">Microsoft 知识库文章 957097</a></td>
</tr>  
<tr class="even">

...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=93b3d0a3-2091-405e-8dd4-10f20dc2be7f">Windows 2000 Service Pack 4</a><br />
(KB943055)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5c331a3a-93e0-42e4-9cd1-4e32ebdda38d">Windows XP Service Pack 2</a><br />
(KB943055)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=e0a15967-7184-4194-8edb-81760e440604">Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2</a><br />
(KB943055)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=cfa0d5c6-a9b0-4c5c-a651-898e9f900799">Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2</a><br />
(KB943055)</td>
<td style="border:1px solid black;">远程执行代码</td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=a08e87dc-993b-493b-8af3-be6e98643aeb">Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2</a><br />
(KB943055)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=5a88522b-ee30-4deb-878b-598e852fd60e">Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）</a><br />
(KB943055)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">中等</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c67ec357-0f86-4f7d-9af0-d63d8b765f44">Windows Vista</a><br />
(KB943055)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=9137108f-e80b-46f1-b547-82da8fb058bf">Windows Vista x64 Edition</a><br />
(KB943055)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;">无</td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://www.microsoft.com/download/details.aspx?familyid=c96420a9-7436-4625-9649-75f1514b0fe3">Microsoft Visual Basic 6.0 Service Pack 6</a><br />
(KB946235)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">严重</td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms07-043">MS07-043</a></td>
...
Visual Basic 6.0 是唯一受此安全更新影响的开发平台。 此公告提供了下载 Visual Basic 6.0 Service Pack 更新的链接。使用 VB6 包和部署向导重新分发 oleaut32.dll 的开发人员应该确保他们通过下载本公告中提供的 Visual Basic 6.0 更新来更新其应用程序附带安装的 oleaut32.dll 的版本。 鼓励开发人员按照使用共享组件的推荐最佳方案执行操作。 有关使用共享组件的最佳做法的详细信息，请参阅关于独立应用程序的 [Microsoft 知识库文章 835322](https://support.microsoft.com/kb/835322)。
...
否，此安全更新替换并重新注册随操作系统提供的受影响的 OLE 组件。 如果第三方应用程序遵循建议的最佳实践，即将共享组件用作并列组件，那么它们也不会受到影响。 如果第三方应用程序没有遵循推荐的最佳方案，而是随其应用程序一起重新分发了 oleaut32.dll 的一个版本，则客户可能受到威胁。 [Microsoft 知识库文章 921503](https://support.microsoft.com/kb/921503) 也包含就某些客户希望手动检查已注册的受影响 OLE 组件而提供的说明。 鼓励客户联系第三方解决方案开发商以获取详细信息。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-0065](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0065)。
...
**注意** 有关受支持版本的完整列表，请参阅“技术支持生命周期索引”。 关于 Service Pack 的完整列表，请参阅[生命周期支持的 Service Pack](https://support.microsoft.com/gp/lifesupsps)。 有关技术支持生命周期策略的详细信息，请参阅 [Microsoft 技术支持生命周期](https://support.microsoft.com/lifecycle/)。
...
**注意** 有关受支持版本的完整列表，请参阅[技术支持生命周期索引](https://support.microsoft.com/gp/lifeselectindex/)。 关于 Service Pack 的完整列表，请参阅[生命周期支持的 Service Pack](https://support.microsoft.com/gp/lifesupsps)。 有关技术支持生命周期策略的详细信息，请参阅 [Microsoft 技术支持生命周期](https://support.microsoft.com/lifecycle/)。
...
**注意** 可以将这些开关组合到一个命令中。 为了保持向后兼容，此安全更新还支持以前版本的安装程序所使用的许多安装开关。 有关受支持的安装开关的详细信息，请参阅 [Microsoft 知识库文章 197147](https://support.microsoft.com/kb/197147)。
...
-   [IBM ISS X-Force](https://www.iss.net/) 的 Ryan Smith 和 Alex Wheeler 报告了 OLE 堆溢出漏洞 (CVE-2007-0065)。

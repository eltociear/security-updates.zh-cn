...
此安全更新也解决了[Microsoft 安全通报 953635](https://technet.microsoft.com/security/advisory/953635) 中最初描述的漏洞。
...
<td style="border:1px solid black;">
[Microsoft Word 2002 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=c7146dfc-e1be-4d13-877b-1d9bcacc4a64) (KB954463)
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<td style="border:1px solid black;">
[Microsoft Word 2003 Service Pack 2](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=13a37b76-9fec-426f-8176-3c95f934efe0) (KB954464)
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
<td style="border:1px solid black;">
[Microsoft Word 2003 Service Pack 3](https://www.microsoft.com/download/details.aspx?displaylang=zh-cn&familyid=13a37b76-9fec-426f-8176-3c95f934efe0) (KB954464)
</td>
<td style="border:1px solid black;">
远程执行代码
</td>
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 955048](https://support.microsoft.com/kb/955048) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2244](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 在最初发布此安全公告时，此漏洞已被公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2008-2244](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244)。此漏洞最初是在 [Microsoft 安全通报 953635](https://technet.microsoft.com/security/advisory/953635) 中介绍的。
  
**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
是。 在发布此安全公告时，Microsoft 已收到有关此漏洞已被利用的信息。
  
**应用此安全更新有助于客户防止尝试利用此漏洞的已公开发布代码吗？**    
是。 此安全更新可消除目前被利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2008-2244](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2244)。
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/955048">Microsoft 知识库文章 955048</a></td>
</tr>  
<tr class="even">
...
-   [ISC/SANS](https://isc.sans.org/) 报告了 Word 记录分析漏洞 (CVE-2008-2244)。

...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 950759](http://support.microsoft.com/kb/950759) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1442](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1442)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1544](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1544)。
...
**什么是同源策略？**  
同源策略 (SOP) 用于管理当天浏览器的访问控制。 它可以防止从某个来源加载的文档或脚本从其它来源获取或设置文档的属性，从而彻底隔离。 另请参阅 [JScript 博客: ECMAScript、Mashups 和安全性](http://blogs.msdn.com/jscript/archive/2007/11/29/ecmascript-mashups-and-security.aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/950759">Microsoft 知识库文章 950759</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/950759">请参阅 Microsoft 知识库文章 950759</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   一名匿名研究员和 Sebastian Apelt 与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 (CVE-2008-1442)。

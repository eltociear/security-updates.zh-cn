...
此安全更新也解决了 [Microsoft 安全通报 961051](https://technet.microsoft.com/security/advisory/961051) 中最初描述的漏洞。
...
**在哪里可以找到文件信息详细资料？**    
可以在 [Microsoft 知识库文章 960714](https://support.microsoft.com/kb/960714) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4844](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4844)。
...
-   默认情况下，Windows Vista 的 Internet Explorer 7 和 Internet Explorer 8 Beta 2 及更高版本中的[保护模式](https://www.microsoft.com/windows/windows-vista/features/ie7-protected-mode.aspx)可帮助防止用户及其系统进行恶意下载，方法是：限制关于启动另一程序的请求或者关于未经用户同意保存文件的请求。 这包括用户或者系统文件和设置。
...
-   **禁用 XML 数据岛** **功能**
    ...
    **如何撤消安全通报 961051 中介绍的变通办法**
    ...
    [Microsoft 安全通报 961051](https://technet.microsoft.com/security/advisory/961051) 介绍了此相同变通办法的手动注册表更改方法。 如果您使用了此方法，现在希望撤消此变通办法，请使用以下注册表文件：
...
<td style="border:1px solid black;">请参阅 <a href="https://support.microsoft.com/kb/960714">Microsoft 知识库文章 960714</a></td>
</tr>  
<tr class="even">

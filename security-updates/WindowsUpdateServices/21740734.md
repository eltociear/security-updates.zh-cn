...
> [!NOTE]
> You will need to use the <strong>sqlcmd</strong> utility. For more information about the <strong>sqlcmd</strong> utility, see <a href="https://go.microsoft.com/fwlink/?linkid=81183">sqlcmd Utility</a> (https://go.microsoft.com/fwlink/?LinkId=81183).

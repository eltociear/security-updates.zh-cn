...
ms:contentKeyID: 18125749
ms:mtpsurl: 'https://technet.microsoft.com/zh-cn/library/Cc720440(v=WS.10)'
---
...
| ![](images/Cc720440.Important(WS.10).gif)要点                                                                                                                                                                                                                           |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720440.note(WS.10).gif)注意                                                                                                                                       |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

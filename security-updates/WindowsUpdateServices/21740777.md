...
The adsutil IIS utility can be found on your server in the Inetpub\\AdminScripts directory. For more information about using adsutil.vbs, see [Using the Adsutil.vbs Administration Script](https://go.microsoft.com/fwlink/?linkid=162432) (https://go.microsoft.com/fwlink/?LinkId=162432).

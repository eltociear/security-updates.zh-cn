...
ms:contentKeyID: 21740766
ms:mtpsurl: 'https://technet.microsoft.com/zh-cn/library/Dd939890(v=WS.10)'
---
...
-   Check WSUSSetup.log for the following entry:
    ...
    ```
    Error IISCustomAction Command /Install FailedSystem.ArgumentException: Item has already been added. Key in dictionary: "enableasp.net"  Key being added: "enableasp.net"ss
    ```

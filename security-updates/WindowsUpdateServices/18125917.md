...
> [!NOTE]  
> If you do not want to use WSUSutil.exe to change the location of local WSUS update storage, you can also use NTFS functionality to add a partition to the current location of local WSUS update storage. For more information about NTFS, see [NTFS technical documentation](https://go.microsoft.com/fwlink/?linkid=79488) (https://go.microsoft.com/fwlink/?LinkId=79488).

...
The [WsusDBMaintenance](https://go.microsoft.com/fwlink/?linkid=87027) script (https://go.microsoft.com/fwlink/?LinkId=87027) allows you to re-index any version of the SUSDB database, either SQL Server 2005 or Windows Internal Database.

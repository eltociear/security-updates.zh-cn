...
ms:contentKeyID: 18126007
ms:mtpsurl: 'https://technet.microsoft.com/zh-cn/library/Cc708574(v=WS.10)'
---
...
| ![](images/Cc708574.note(WS.10).gif)注意                                                            |
|----------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc708574.Important(WS.10).gif)要点                                                                                                                                                                                                                                                                                  |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

...
-   If product documentation is installed on your local computer, in the [localhost directory](https://localhost/iishelp/iis/htm/adminsamples/adsutil.htm) at https://localhost/iishelp/iis/htm/adminsamples/adsutil.htm.
-   Otherwise, in the [online documentation](https://go.microsoft.com/fwlink/?linkid=77230) (https://go.microsoft.com/fwlink/?LinkID=77230).

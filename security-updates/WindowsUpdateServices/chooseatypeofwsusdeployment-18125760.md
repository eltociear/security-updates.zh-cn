...
ms:contentKeyID: 18125760
ms:mtpsurl: 'https://technet.microsoft.com/zh-cn/library/Cc720448(v=WS.10)'
---
...
| ![](images/Cc720448.note(WS.10).gif)注意                                           |
|-----------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720448.Important(WS.10).gif)要点                                                                                                                                                                                                                                                                                                                                                |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

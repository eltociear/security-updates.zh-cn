...
ms:contentKeyID: 18126026
ms:mtpsurl: 'https://technet.microsoft.com/zh-cn/library/Cc708595(v=WS.10)'
---
...
| ![](images/Cc708595.note(WS.10).gif)注意                                                                                 |
|-------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ![](images/Cc708595.Important(WS.10).gif)要点        |
|-----------------------------------------------------------------------------------|

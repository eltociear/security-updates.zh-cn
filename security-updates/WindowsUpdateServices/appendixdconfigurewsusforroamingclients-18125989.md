...
ms:contentKeyID: 18125989
ms:mtpsurl: 'https://technet.microsoft.com/zh-cn/library/Cc708563(v=WS.10)'
---
...
| ![](images/Cc708563.Important(WS.10).gif)要点 |
|----------------------------------------------------------------------------|
...
| ![](images/Cc708563.note(WS.10).gif)注意                                                                                                                                                                                                                                                                                                                                                   |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

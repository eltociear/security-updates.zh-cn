...
如果由于某些原因 WSUS SP1 安装程序失败，请手动还原备份数据库。有关还原 WSUS 数据库的说明，请参阅 [WSUS 操作指南](https://technet2.microsoft.com/windowsserver/en/library/05f2e884-ae62-4c90-9681-6c9f2f3c9fd91033.mspx)。

...
ms:contentKeyID: 18126034
ms:mtpsurl: 'https://technet.microsoft.com/zh-cn/library/Cc708604(v=WS.10)'
---
...
| ![](images/Cc708604.note(WS.10).gif)注意                    |
|------------------------------------------------------------------------------------------|
...
| ![](images/Cc708604.Important(WS.10).gif)要点                                                                         |  
|----------------------------------------------------------------------------------------------------------------------------------------------------|  

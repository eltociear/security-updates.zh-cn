...
此安全更新修复了 Adobe 安全公告 [APSB17-02](http://helpx.adobe.com/cn/security/products/flash-player/apsb17-02.html) 中描述的以下漏洞：
...
\*“替代的更新”列仅显示一系列被取代的更新中最新的更新。有关已替代更新的完整列表，请转到 [Microsoft 更新目录](http://catalog.update.microsoft.com/v7/site/home.aspx)，搜索更新知识库文章编号，然后查看更新详细信息（已替代更新的信息位于“程序包详细信息”选项卡中）。

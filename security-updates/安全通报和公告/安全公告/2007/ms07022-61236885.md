...
-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=b3599afb-7673-4ef6-a2b1-d77e39fd782c)
-   Microsoft Windows XP Service Pack 2 - [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=eeaee4a7-4858-4b6b-9c6d-a9f1eae19b51)
-   Microsoft Windows Server 2003、Microsoft Windows Server 2003 Service Pack 1 和 Microsoft 2003 Service pack 2 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=5e94a29c-7ec0-4459-92eb-d43b524fd6fd)
...
|---------------------------------------------------------------------------------------------------------|------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| 内核本地特权提升漏洞 - [CVE-2007-1206](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-1206) | 特权提升   | 重要                                  | 重要                                | 重要                          | 重要                                         | 重要                                         |
...
有关此问题的详细信息，请参阅 [Microsoft 知识库文章 931784](http://support.microsoft.com/kb/931784/)。[Microsoft 知识库文章 931784](http://support.microsoft.com/kb/931784/) 介绍了客户在安装此修订的安全更新时可能遇到的当前已知问题。
...
|-------------------------------------------------------------------------|---------------------------------------|-------------------------------------|-------------------------------|----------------------------------------------|----------------------------------------------|
| [**MS06-049**](http://technet.microsoft.com/security/bulletin/ms06-049) | 已取代                                | 不适用                              | 不适用                        | 不适用                                       | 不适用                                       |
...
**先决条件**
此安全更新需要 Windows XP Service Pack 2。有关如何获得最新的 Windows XP Service Pack 的详细信息，请参阅 Microsoft 知识库文章 322389。有关如何获得 Windows XP Professional Service Pack 2 的详细信息，请参阅[下载中心](http://www.microsoft.com/downloads/details.aspx?familyid=893fd6c0-6283-44c3-bb84-b2f0315b2ae6&displaylang=en)。
...
-   [eEye](http://www.eeye.com/) 报告了内核本地特权提升漏洞 (CVE-2007-1206)。

**获取其他安全更新：**

可从以下位置获得针对其他安全问题的更新：

-   [Microsoft 下载中心](http://go.microsoft.com/fwlink/?linkid=21129)提供了安全更新。 通过输入关键字“安全修补程序”可以非常方便地找到些更新。

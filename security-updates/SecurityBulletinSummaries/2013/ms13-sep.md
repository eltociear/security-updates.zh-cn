...
-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了 Microsoft Office 内存损坏漏洞 (CVE-2013-1315)
-   [Compass Security AG](https://www.csnc.ch/) 的 Alexandre Herzog 报告了 MAC 已禁用漏洞 (CVE-2013-1330)
-   Vulnerability Research Laboratory 的 Benjamin Kunz Mejri 报告了 SharePoint XSS 漏洞 (CVE-2013-3179)
-   [Google Security Team](https://www.google.com/) 的 Mateusz Jurczyk、Ivan Fratric 和 Ben Hawkes 报告了 Microsoft Word 中多个内存损坏漏洞（CVE-2013-3847、CVE-2013-3848、CVE-2013-3849、CVE-2013-3857 和 CVE-2013-3858）
...
-   Jose Antonio Vazquez Gonzalez 与 [HP's](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3201)
-   Jose Antonio Vazquez Gonzalez 与 [HP's](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3202)
-   Arthur Gerkis 与 [HP's](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3203)
-   [Google Security Team](https://www.google.com/) 的 Ivan Fratric 和 Ben Hawkes 报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3204)
-   [Corelan](https://www.corelangcv.com/) 的 Peter 'corelanc0d3r' Van Eeckhoutte 与 [HP's](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3205)
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Bo Qu 报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3205)
-   Arthur Gerkis 与 [HP's](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3206)
-   Arthur Gerkis 与 [HP's](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3207)
-   Arthur Gerkis 与 [HP's](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3208)
-   一名匿名研究人员与 [HP's](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3209)
-   Jose Antonio Vazquez Gonzalez 与 [HP's](https://www.hpenterprisesecurity.com/products)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 Internet Explorer 内存损坏漏洞 (CVE-2013-3845)
...
-   [Positive Technologies](https://www.ptsecurity.com/) 的 Timur Yunusov、Alexey Osipov 和 Ilya Karpov 报告了 XML 外部实体解析漏洞 (CVE-2013-3160)
-   [Google Security Team](https://www.google.com/) 的 Mateusz Jurczyk、Ivan Fratric 和 Ben Hawkes 报告了 Microsoft Word 中多个内存损坏漏洞（CVE-2013-3847、CVE-2013-3848、CVE-2013-3849、CVE-2013-3850、CVE-2013-3851、CVE-2013-3852、CVE-2013-3853、CVE-2013-3854、CVE-2013-3855、CVE-2013-3856、CVE-2013-3857 和 CVE-2013-3858）

**MS13-073**

-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了 Microsoft Office 内存损坏漏洞 (CVE-2013-1315)
-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了 Microsoft Office 内存损坏漏洞 (CVE-2013-3158)
-   [Positive Technologies](https://www.ptsecurity.com/) 的 Timur Yunusov、Alexey Osipov 和 Ilya Karpov 报告了 XML 外部实体解析漏洞 (CVE-2013-3159)

**MS13-074**

-   [Secunia SVCRP](https://secunia.com/) 的 Kaveh Ghaemmaghami 报告了 Access 内存损坏漏洞 (CVE-2013-3155)
-   [Secunia SVCRP](https://secunia.com/) 的 Kaveh Ghaemmaghami 报告了 Access 文件格式内存损坏漏洞 (CVE-2013-3156)
-   [Secunia SVCRP](https://secunia.com/) 的 Kaveh Ghaemmaghami 报告了 Access 内存损坏漏洞 (CVE-2013-3157)

**MS13-075**

-   [VulnHunt](https://www.vulnhunt.com/) 的 Wei Wang 报告了中文输入法漏洞 (CVE-2013-3859)

**MS13-076**

-   [Google Inc](https://www.google.com/) 的 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 报告了 Win32k 多重提取漏洞 (CVE-2013-1341)
-   [Google Inc](https://www.google.com/) 的 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 报告了 Win32k 多重提取漏洞 (CVE-2013-1342)
-   [Google Inc](https://www.google.com/) 的 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 报告了 Win32k 多重提取漏洞 (CVE-2013-1343)
-   [Google Inc](https://www.google.com/) 的 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 报告了 Win32k 多重提取漏洞 (CVE-2013-1344)
-   [Google Inc](https://www.google.com/) 的 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 报告了 Win32k 多重提取漏洞 (CVE-2013-3864)
-   [Google Inc](https://www.google.com/) 的 [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 报告了 Win32k 多重提取漏洞 (CVE-2013-3865)
-   [Qihoo 360 Security Center](https://www.360.cn/) 的 Guo Pengfei 报告了 Win32k 特权提升漏洞 (CVE-2013-3866)

**MS13-078**

-   [Positive Technologies](https://www.ptsecurity.com/) 的 Timur Yunusov 报告了 XML 泄露漏洞 (CVE-2013-3137)

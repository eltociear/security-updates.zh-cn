...
-   [FireEye](https://www.fireeye.com/) 的 Daniel Caseldenfor 报告了 Internet Explorer 释放后使用漏洞 (CVE-2013-1347)
...
-   [Context Information Security](https://www.contextis.com/) 的 James Forshaw 报告了 XML 数字签名欺骗漏洞 (CVE-2013-1336)

**MS13-042**

-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 与我们一起努力处理了多个 Microsoft Publisher 远程执行代码漏洞（CVE-2013-1316、CVE-2013-1317、CVE-2013-1318、CVE-2013-1319、CVE-2013-1320、CVE-2013-1321、CVE-2013-1322、CVE-2013-1323、CVE-2013-1327、CVE-2013-1328 和 CVE-2013-1329）

**MS13-043**

-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了 Word 形状损坏漏洞 (CVE-2013-1335)
...
-   [Gynvael Coldwind](https://gynvael.coldwind.pl/) 和 [Google Inc](https://www.google.com/) 的 [Mateusz "j00ru" Jurczyk](https://j00ru.vexillium.org/) 报告了 DirectX 图形内核子系统双重提取漏洞 (CVE-2013-1332)
-   [Qihoo 360 Security Center](https://www.360.cn/) 报告了 Win32k 缓冲区溢出漏洞 (CVE-2013-1333)
-   一名匿名研究员与 [iDefense VCP](https://labs.idefense.com/) 合作报告了 Win32k 窗口句柄漏洞 (CVE-2013-1334)

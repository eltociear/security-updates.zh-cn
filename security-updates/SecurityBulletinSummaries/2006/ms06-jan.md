...
|------------------|------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**图形呈现引擎中的漏洞可能允许远程执行代码 (912919)**](http://technet.microsoft.com/security/bulletin/ms06-001) |
...
|------------------|---------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**嵌入式 Web 字体中的漏洞可能允许远程执行代码 (908519)**](http://technet.microsoft.com/security/bulletin/ms06-002) |
...
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Outlook 和 Microsoft Exchange 中的 TNEF 解码漏洞可能允许远程执行代码 (902412)**](http://technet.microsoft.com/security/bulletin/ms06-003) |
| **摘要**         | 可能允许远程执行代码的图形呈现引擎中存在一个漏洞。                                                                                                     |
| **最高严重等级** | [严重](http://go.microsoft.com/fwlink/?linkid=21140)                                                                                                   |
| **漏洞的影响**   | 远程执行代码                                                                                                                                           |
...
-   [WebSense](http://websense.com/) 的 Dan Hubbard 与我们共同解决 [MS06-001](http://technet.microsoft.com/security/bulletin/ms06-001) 中描述的问题。  
-   eEye Digital Security 报告了 [MS06-002](http://technet.microsoft.com/security/bulletin/ms06-002) 中描述的问题。  
-   [NGS Software](http://www.ngssoftware.com/index.htm) 的 John Heasman 和 Mark Litchfield 报告了 [MS06-003](http://technet.microsoft.com/security/bulletin/ms06-003) 中描述的问题。

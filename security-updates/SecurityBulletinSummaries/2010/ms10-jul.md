...
对于 2010 年 7 月发布的安全公告，本公告摘要替代 2010 年 7 月 8 日最初发布的公告预先通知。有关公告预先通知服务的详细信息，请参阅 [Microsoft 安全公告预先通知](https://technet.microsoft.com/security/bulletin/advance)。

有关在 Microsoft 安全公告发布时如何收到自动通知的信息，请访问 [Microsoft 技术安全通知](https://go.microsoft.com/fwlink/?linkid=21163)。

Microsoft 将在 2010 年 7 月 14 日上午 11 点（美国和加拿大太平洋时间）进行网络广播，以解答客户关于这些公告的疑问。 [立即注册申请收听 7 月份安全公告网络广播](https://msevents.microsoft.com/cui/eventdetail.aspx?eventid=1032454299&culture=en-us)。 此日期之后，此网络广播按需提供。 有关详细信息，请参阅 [Microsoft 安全公告摘要和网络广播](https://technet.microsoft.com/security/bulletin/summary)。
...
<tbody>
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-042">MS10-042</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-043">MS10-043</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-044">MS10-044</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms10-045">MS10-045</a></td>
...
|---------------------------------------------------------------------|---------------------------------------|----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|----------------------------------------------|  
| [MS10-045](https://technet.microsoft.com/security/bulletin/ms10-045) | Microsoft Outlook SMB 附件漏洞        | [CVE-2010-0266](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0266) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现   | （无）                                       |  
| [MS10-044](https://technet.microsoft.com/security/bulletin/ms10-044) | Access ActiveX 控件漏洞               | [CVE-2010-0814](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0814) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现   | （无）                                       |  
| [MS10-044](https://technet.microsoft.com/security/bulletin/ms10-044) | ACCWIZ.dll 未初始化的变量漏洞         | [CVE-2010-1881](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1881) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现   | （无）                                       |  
| [MS10-042](https://technet.microsoft.com/security/bulletin/ms10-042) | 帮助中心 URL 验证漏洞                 | [CVE-2010-1885](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1885) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现   | **此漏洞当前正在 Internet 生态系统中被利用** |  
| [MS10-043](https://technet.microsoft.com/security/bulletin/ms10-043) | Canonical Display Driver 整数溢出漏洞 | [CVE-2009-3678](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-3678) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现 | （无）                                       |
...
<td style="border:1px solid black;">
[**MS10-042**](https://technet.microsoft.com/security/bulletin/ms10-042)
</td>
<td style="border:1px solid black;">
[**MS10-043**](https://technet.microsoft.com/security/bulletin/ms10-043)
</td>
</tr>
...
<td style="border:1px solid black;">
[**MS10-044**](https://technet.microsoft.com/security/bulletin/ms10-044)
</td>
<td style="border:1px solid black;">
[**MS10-045**](https://technet.microsoft.com/security/bulletin/ms10-045)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Adobe Systems, Inc.](https://www.reactive-systems.com/) 的 David Hansel 报告了 MS10-043 中描述的问题
-   一名匿名研究人员与 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作，报告了 MS10-044 中描述的问题
-   [IBM ISS X-Force](https://www.iss.net/) 的 Robert Freeman 报告了 MS10-044 中描述的问题
-   Yorick Koster，使用 [SSD/SecuriTeam Secure Disclosure](https://www.beyondsecurity.com/ssd.html) 程序报告了 MS10-045 中描述的问题

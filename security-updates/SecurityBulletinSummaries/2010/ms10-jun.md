...
对于 2010 年 6 月发布的安全公告，本公告摘要替代 2010 年 6 月 3 日最初发布的公告预先通知。有关公告预先通知服务的详细信息，请参阅 [Microsoft 安全公告预先通知](https://technet.microsoft.com/security/bulletin/advance)。
...
|---------------------------------------------------------------------|---------------------------------------|----------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|  
| [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) | Win32k 窗口创建漏洞                   | [CVE-2010-0485](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0485) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-039](https://technet.microsoft.com/security/bulletin/ms10-039) | Help.aspx XSS 漏洞                    | [CVE-2010-0817](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0817) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | 此漏洞最初在 [Microsoft 安全通报 983438](https://technet.microsoft.com/security/advisory/983438) 中报告。 |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel 对象堆栈溢出漏洞                | [CVE-2010-0822](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0822) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel 记录内存损坏漏洞                | [CVE-2010-0824](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0824) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel 记录内存损坏漏洞                | [CVE-2010-1245](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1245) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel RTD 内存损坏漏洞                | [CVE-2010-1246](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1246) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel 内存损坏漏洞                    | [CVE-2010-1247](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1247) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel HFPicture 内存损坏漏洞          | [CVE-2010-1248](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1248) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel 内存损坏漏洞                    | [CVE-2010-1249](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1249) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel EDG 内存损坏漏洞                | [CVE-2010-1250](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1250) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel ADO 对象漏洞                    | [CVE-2010-1253](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1253) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Mac Office Open XML 权限漏洞          | [CVE-2010-1254](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1254) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-035](https://technet.microsoft.com/security/bulletin/ms10-035) | 未初始化的内存损坏漏洞                | [CVE-2010-1259](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1259) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-035](https://technet.microsoft.com/security/bulletin/ms10-035) | 内存损坏漏洞                          | [CVE-2010-1262](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1262) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-036](https://technet.microsoft.com/security/bulletin/ms10-036) | COM 验证漏洞                          | [CVE-2010-1263](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1263) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-033](https://technet.microsoft.com/security/bulletin/ms10-033) | 媒体解压缩漏洞                        | [CVE-2010-1879](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1879) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 一致漏洞检测代码可能实现     | （无）                                                                                                   |  
| [MS10-035](https://technet.microsoft.com/security/bulletin/ms10-035) | 跨域信息泄露漏洞                      | [CVE-2010-0255](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0255) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | 此漏洞最初在 [Microsoft 安全通报 980088](https://technet.microsoft.com/security/advisory/980088) 中报告。 |  
| [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) | Win32k 数据验证不正确漏洞             | [CVE-2010-0484](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0484) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | （无）                                                                                                   |  
| [MS10-037](https://technet.microsoft.com/security/bulletin/ms10-037) | OpenType CFF 字体驱动程序内存损坏漏洞 | [CVE-2010-0819](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0819) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel 记录分析内存损坏漏洞            | [CVE-2010-0821](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0821) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel 内存损坏漏洞                    | [CVE-2010-0823](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0823) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel 记录堆栈损坏漏洞                | [CVE-2010-1251](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1251) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | （无）                                                                                                   |  
| [MS10-038](https://technet.microsoft.com/security/bulletin/ms10-038) | Excel 字符串变量漏洞                  | [CVE-2010-1252](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1252) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | （无）                                                                                                   |  
| [MS10-032](https://technet.microsoft.com/security/bulletin/ms10-032) | Win32k TrueType 字体分析漏洞          | [CVE-2010-1255](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1255) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | （无）                                                                                                   |  
| [MS10-040](https://technet.microsoft.com/security/bulletin/ms10-040) | IIS 身份验证内存损坏漏洞              | [CVE-2010-1256](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1256) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | （无）                                                                                                   |  
| [MS10-033](https://technet.microsoft.com/security/bulletin/ms10-033) | MJPEG 媒体解压缩漏洞                  | [CVE-2010-1880](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1880) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不一致漏洞检测代码可能实现   | （无）                                                                                                   |  
| [MS10-041](https://technet.microsoft.com/security/bulletin/ms10-041) | XML 签名 HMAC 截断身份验证绕过漏洞    | [CVE-2009-0217](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0217) | [**3**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 功能漏洞检测代码不太可能实现 | 这是欺骗和篡改漏洞                                                                                       |  
| [MS10-035](https://technet.microsoft.com/security/bulletin/ms10-035) | toStaticHTML 信息泄露漏洞             | [CVE-2010-1257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257) | [**3**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 功能漏洞检测代码不太可能实现 | 此漏洞也影响 [MS10-039](https://technet.microsoft.com/security/bulletin/ms10-039)                         |  
| [MS10-039](https://technet.microsoft.com/security/bulletin/ms10-039) | toStaticHTML 信息泄露漏洞             | [CVE-2010-1257](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1257) | [**3**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 功能漏洞检测代码不太可能实现 | 此漏洞也影响 [MS10-035](https://technet.microsoft.com/security/bulletin/ms10-035)                         |  
| [MS10-039](https://technet.microsoft.com/security/bulletin/ms10-039) | SharePoint 帮助页拒绝服务漏洞         | [CVE-2010-1264](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1264) | [**3**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 功能漏洞检测代码不太可能实现 | （无）                                                                                                   |
...
<sup>[1]</sup>严重等级不适用于此更新，因为此公告中讨论的漏洞不影响此软件。 然而，提供此更新以解决 [MS09-054](https://go.microsoft.com/fwlink/?linkid=163979) 发生的一个回归问题。有关详细信息，请参阅 [MS10-035](https://technet.microsoft.com/security/bulletin/ms10-035)。

**MS10-040 注释**

<sup>[1]</sup>该操作系统仅在安装了 “对身份验证的扩展保护”时才受影响。 请参阅 [Microsoft 知识库文章 973917。](https://support.microsoft.com/kb/973917)
...
<td style="border:1px solid black;">
[**MS10-038**](https://technet.microsoft.com/security/bulletin/ms10-038)
</td>
<td style="border:1px solid black;">
...
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Sebastien Renaud 报告了 MS10-032 中描述的问题
-   [Secunia Research](https://secunia.com/) 与我们合作，解决 MS10-032 中描述的问题
-   [Palo Alto Networks](https://www.paloaltonetworks.com/) 的 Yamata Li 报告了 MS10-033 中描述的两个问题
-   [NGS Software](https://www.ngssoftware.com/) 的 Shaun Colley 报告了 MS10-034 中描述的问题
-   Chris Ries of Carnegie Mellon University Computing Services 的 Chris Ries 报告了 MS10-034 中描述的问题
-   [Casaba Security](https://www.casabasecurity.com/) 的 Chris Weber 报告了 MS10-035 和 MS10-039 中描述的问题
-   [Mitsui Bussan Secure Directions, Inc.](https://www.mbsd.jp/) 的 Takeshi Terada 报告了 MS10-035 中描述的问题
-   [Google Inc.](https://www.google.com/) 的 Michal Zalewski 报告了 MS10-035 中描述的问题
-   [Matasano Security](https://www.matasano.com/) 的 Chris Rohlf 报告了 MS10-035 中描述的两个问题
-   Peter Vreugdenhil 与 [TippingPoint's](https://www.tippingpoint.com/)[Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 MS10-035 中描述的问题
-   [IBM ISS X-Force](https://www.iss.net/) 的 David Dewey 和 [Accuvant](https://www.accuvant.com/)（以前称 [VeriSign iDefense Labs](https://labs.idefense.com/)）的 Ryan Smith 与我们合作处理 MS10-036 中包括的纵深防御更改
-   Laserforce International 的 Chris Carton 与 [Secunia](https://secunia.com/) 一起报告了 MS10-037 中描述的问题
-   一名匿名研究人员与 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 一起报告了 MS10-038 中描述的问题
-   [VUPEN Vulnerability Research Team](https://www.vupen.com/) 的 Nicolas Joly 报告了 MS10-038 中描述的八个问题
-   [Fortinet's FortiGuard Labs](https://www.fortiguard.com/) 的 Bing Liu 报告了 MS10-038 中描述的问题
-   [Secunia](https://secunia.com/) 的 Carsten Eiram 报告了 MS10-038 中描述的两个问题
-   一名匿名研究人员与 [TippingPoint](https://www.tippingpoint.com/) 的 [Zero Day Initiative](https://www.zerodayinitiative.com/) 一起报告了 MS10-038 中描述的问题
...
-   [WhiteHat Security](https://www.whitehatsec.com) 的 Arian Evans 报告了 MS10-041 中通过纵深防御更改解决的绕过 ASP.NET 请求验证的问题

...
|------------------|------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Internet Explorer 的累积性安全更新 (905915)**](https://technet.microsoft.com/security/bulletin/ms05-054) |
...
|------------------|-------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Windows 内核中的漏洞可能允许特权提升 (908523)**](https://technet.microsoft.com/security/bulletin/ms05-055)            |
...
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms05-054"><strong>MS05-054</strong></a></td>
<td style="border:1px solid black;"><a href="https://technet.microsoft.com/security/bulletin/ms05-055"><strong>MS05-055</strong></a></td>
</tr>  
<tr class="even">
...
**<sup>[4]</sup>** 如果您使用 Windows XP 或 Windows Server 2003，则不必安装此更新。要获得更详细信息，请参阅相应的[安全公告](https://red-sec-01/sites/sec/msrc/private/templates/insert%20bulletin%20link)。
...
-   [Secunia](https://www.secunia.com/) 的 Andreas Sandblad 和 Jakob Balle 报告了 [MS05-054](https://go.microsoft.com/fwlink/?linkid=53511)中描述的一个问题。  
-   [CERT/CC](https://www.cert.org/) 的 Will Dormann 报告了 [MS05-054](https://technet.microsoft.com/security/bulletin/ms05-054) 中介绍的许多类标识符。  
-   [eEye Digital Security](https://eeye.com) 报告了 [MS05-055](https://technet.microsoft.com/security/bulletin/ms05-055) 中描述的一个问题。

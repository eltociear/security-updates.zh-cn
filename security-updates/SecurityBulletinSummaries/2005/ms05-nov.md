...
|------------------|-------------------------------------------------------------------------------------------------|
| **公告标题**     | [图形呈现引擎中的漏洞可能允许执行代码](http://technet.microsoft.com/security/bulletin/ms05-053) |
...
-   [Symantec Security Response](http://securityresponse.symantec.com/) 的 [Venustech AdDLab](http://www.venustech.com.cn/)、[eEye Digital Security](http://www.eeye.com/html/) 和 Peter Ferrie 报告了 [MS05-053](http://technet.microsoft.com/security/bulletin/ms05-053) 中描述的问题

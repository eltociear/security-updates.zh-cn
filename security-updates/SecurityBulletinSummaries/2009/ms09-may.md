...
对于 2009 年 5 月发布的安全公告，本公告摘要替代 2009 年 5 月 7 日最初发布的公告预先通知。有关公告预先通知服务的详细信息，请参阅 [Microsoft 安全公告预先通知](https://technet.microsoft.com/security/bulletin/advance)。

有关在 Microsoft 安全公告发布时如何收到自动通知的信息，请访问 [Microsoft 技术安全通知](https://go.microsoft.com/fwlink/?linkid=21163)。

Microsoft 将在 2009 年 5 月 13 日上午 11 点（美国和加拿大太平洋时间）进行网络广播，以解答客户关于这些公告的疑问。 [立即注册申请收听 5 月份安全公告网络广播](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?culture=en-us&eventid=1032395223)。 此日期之后，此网络广播按需提供。 有关详细信息，请参阅 [Microsoft 安全公告摘要和网络广播](https://technet.microsoft.com/security/bulletin/summary)。
...
|---------------------------------------------------------------------|-------------------------------------------------------------------|----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|------------------------------------------------|  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-0220](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0220) | [**2**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能的不一致漏洞检测代码         | （无）                                         |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-0221](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0221) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能的一致漏洞检测代码           | **此漏洞当前正在 Internet 生态系统中被利用。** |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-0222](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0222) | [**1**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 可能的一致漏洞检测代码           | **此漏洞当前正在 Internet 生态系统中被利用。** |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-0223](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0223) | [**3**](https://technet.microsoft.com/en-us/security/cc998259.aspx) - 不太可能被利用的功能漏洞检测代码 |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-0224](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0224) |                                                                                                       |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-0225](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0225) |                                                                                                       |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-0226](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0226) |                                                                                                       |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-0227](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0227) |                                                                                                       |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-0556](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0556) |                                                                                                       |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-1128](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1128) |                                                                                                       |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-1129](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1129) |                                                                                                       |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-1130](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1130) |                                                                                                       |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-1131](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1131) |                                                                                                       |                                                |  
| [MS09-017](https://technet.microsoft.com/security/bulletin/ms09-017) | Microsoft Office PowerPoint 中的漏洞可能允许远程执行代码 (967340) | [CVE-2009-1137](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1137) |                                                                                                       |                                                |
...
-   一位匿名研究人员与 [VeriSign iDefense Labs](https://labs.idefense.com/) 合作，报告了 MS09-017 中描述的两个问题
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 报告了 MS09-017 中描述的两个问题
-   [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 报告了 MS09-017 中描述的问题
-   [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Marsu Pilami 报告了 MS09-017 中描述的多个问题
-   [VUPEN Security](https://www.vupen.com/) 的 Nicolas Joly 报告了 MS09-017 中描述的问题
-   Marsu Pilami 与 [Zero Day Initiative](https://www.zerodayinitiative.com/) 合作报告了 MS09-017 中描述的问题
-   [team509](https://www.team509.com/) 的 Ling 和 Wushi 与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 以及 [VeriSign iDefense Labs](https://labs.idefense.com/) 的 Sean Larsson 合作，报告了 MS09-017 中描述的问题
-   [Secunia](https://secunia.com/) 的 Carsten H. Eiram 报告了 MS09-017 中描述的问题

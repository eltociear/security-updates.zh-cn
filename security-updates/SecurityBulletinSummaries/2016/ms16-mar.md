...
[更新管理安全指导](http://technet.microsoft.com/zh-cn/library/bb466251.aspx)提供 Microsoft 关于应用安全更新程序的最佳方案建议的其他信息。

**获取其他安全更新程序**

可从以下位置获得针对其他安全问题的更新程序：

-   [Microsoft 下载中心](http://go.microsoft.com/fwlink/?linkid=21129)提供了安全更新程序。 通过输入关键字“安全更新程序”可以非常方便地找到这些更新程序。
-   [Microsoft 更新](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-cn)提供了消费者平台的更新程序。
...
-   V2.2（2016 年 3 月 15 日）： 向 MS16-035 的执行摘要表添加了一个已知问题引用。有关更多信息，请参阅 [Microsoft 知识库文章 3135996](http://support.microsoft.com/zh-cn/kb/3135996)、[Microsoft 知识库文章 3136000](http://support.microsoft.com/zh-cn/kb/3136000) 和 [Microsoft 知识库文章 3149737](http://support.microsoft.com/zh-cn/kb/3149737)。

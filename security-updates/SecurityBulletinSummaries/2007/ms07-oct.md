...
对于 2007 年 10 月发布的安全公告，本公告摘要替代 2007 年 10 月 4 日最初发布的公告预先通知。有关公告预先通知服务的详细信息，请参阅 [Microsoft 安全公告预先通知](https://technet.microsoft.com/security/bulletin/advance)。

有关在 Microsoft 安全公告发布时如何收到自动通知的信息，请访问 [Microsoft 技术安全通知](https://go.microsoft.com/fwlink/?linkid=21163)。

Microsoft 将在 2007 年 10 月 10 日上午 11 点（美国和加拿大太平洋时间）进行网络广播，以解答客户关于这些公告的疑问。 [立即注册申请收听 10 月份安全公告网络广播](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032344692&eventcategory=4&culture=en-us&countrycode=us)。 此日期之后，此网络广播按需提供。 有关详细信息，请参阅 [Microsoft 安全公告摘要和网络广播](https://technet.microsoft.com/security/bulletin/summary)。
...
|------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Kodak 图像查看器中的漏洞可能允许远程执行代码 (923810)**](https://technet.microsoft.com/security/bulletin/ms07-055)                                                                                                                                                          |
...
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Outlook Express 和 Windows Mail 的安全更新 (941202)**](https://technet.microsoft.com/security/bulletin/ms07-056)                                     |
...
|------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Internet Explorer 的累积性安全更新 (939653)**](https://technet.microsoft.com/security/bulletin/ms07-057)                                                                                                                                |
...
|------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Word 中的漏洞可能允许远程执行代码 (942695)**](https://technet.microsoft.com/security/bulletin/ms07-060)                                                                                                     |
...
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**RPC 中的漏洞可能允许拒绝服务 (933729)**](https://technet.microsoft.com/security/bulletin/ms07-058)                                                |
...
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Windows SharePoint Services 3.0 和 Office SharePoint Server 2007 中的漏洞可能导致 SharePoint 站点中的特权提升 (942017)**](https://technet.microsoft.com/security/bulletin/ms07-059)                                                                                                                                       |
...
<td style="border:1px solid black;">
[**MS07-055**](https://technet.microsoft.com/security/bulletin/ms07-055)
</td>
<td style="border:1px solid black;">
[**MS07-056**](https://technet.microsoft.com/security/bulletin/ms07-056)
</td>
<td style="border:1px solid black;">
[**MS07-057**](https://technet.microsoft.com/security/bulletin/ms07-057)
</td>
<td style="border:1px solid black;">
[**MS07-060**](https://technet.microsoft.com/security/bulletin/ms07-060)
</td>
<td style="border:1px solid black;">
[**MS07-058**](https://technet.microsoft.com/security/bulletin/ms07-058)
</td>
<td style="border:1px solid black;">
...
安全更新可从 [Microsoft Update](https://go.microsoft.com/fwlink/?linkid=40747)、[Windows Update](https://go.microsoft.com/fwlink/?linkid=21130)和 [Office Update](https://go.microsoft.com/fwlink/?linkid=21135) 获得。 [Microsoft 下载中心](https://go.microsoft.com/fwlink/?linkid=21129)也提供了安全更新。 通过搜索关键字“安全修补程序”，可以非常方便地找到这些更新。
...
-   [Global 360](https://www.global360.com/products/g360_imaging/default.asp) 的 Rita Schappler 与我们合作处理 MS07-055 中描述的问题
-   [VeriSign iDefense Labs](https://www.idefense.com/) 的 Greg MacManus 报告了 MS07-056 中描述的问题
-   next.motion OHG 的 Pierre Geyer 报告了 MS07-057 中描述的问题
-   [Secunia Research](https://secunia.com/) 的 Carsten H. Eiram 报告了 MS07-057 中描述的问题
-   [Secunia Research](https://secunia.com/) 的 Jakob Balle 最初报告了 MS07-057 中描述的问题
-   [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了 MS07-058 中描述的问题

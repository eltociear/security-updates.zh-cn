---
TOCTitle: 'MS07-MAY'
Title: 'Microsoft 安全公告摘要 (2007 年 5 月)'
ms:assetid: 'ms07-may'
ms:contentKeyID: 61236908
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms07-may(v=Security.10)'
---
...
-   消费者可以访问[家庭安全](https://go.microsoft.com/fwlink/?linkid=85102)，也可以通过单击“最新的安全更新”访问此信息。
-   IT 专业人士可以访问 [TechNet 安全中心](https://www.microsoft.com/china/technet/security/default.mspx)。

**更新管理策略：** [安全修补程序管理指南](https://go.microsoft.com/fwlink/?linkid=21168)提供 Microsoft 关于应用安全更新的最佳实践建议的其他信息。

**IT 专业人员安全区域社区：** 了解如何提高安全性和优化 IT 基础结构，并在 [IT 专业人员安全社区](https://go.microsoft.com/fwlink/?linkid=21164)中就安全主题与其他 IT 专业人员展开讨论。

**Microsoft 安全通知服务：** 要在 Microsoft 安全公告发布时即刻接收自动的电子邮件通知，请订阅 [Microsoft 技术安全通知](https://go.microsoft.com/fwlink/?linkid=21163)。
...
|------------------|----------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Excel 中的漏洞可能允许远程执行代码 (934233)**](https://technet.microsoft.com/security/bulletin/ms07-023) |
| **摘要**         | 此更新解决了 Microsoft Excel 中的漏洞，该漏洞可能允许远程执行代码。                                                  |
...
|------------------|---------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Word 中的漏洞可能允许远程执行代码 (934232)**](https://technet.microsoft.com/security/bulletin/ms07-024) |
...
|------------------|-----------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Office 中的漏洞可能允许远程执行代码 (934873)**](https://technet.microsoft.com/security/bulletin/ms07-025) |
| **摘要**         | 此更新解决了 Microsoft Office 中的漏洞，该漏洞可能允许远程执行代码。                                                  |
| **最高严重等级** | [严重](https://go.microsoft.com/fwlink/?linkid=21140)                                                                  |
| **漏洞的影响**   | 远程执行代码                                                                                                          |
| **检测**         | Microsoft 基准安全分析器可以检测您的计算机系统是否需要此更新。 该更新可能要求重新启动。                               |
| **受影响的软件** | **Office**。 有关详细信息，请参阅“受影响的软件和下载位置”部分。                                                       |
...
|------------------|-------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Exchange 中的漏洞可能允许远程执行代码 (931832)**](https://technet.microsoft.com/security/bulletin/ms07-026) |
| **摘要**         | 此更新解决了 Microsoft Exchange 中的漏洞，该漏洞可能允许远程执行代码。                                                  |
| **最高严重等级** | [严重](https://go.microsoft.com/fwlink/?linkid=21140)                                                                    |
| **漏洞的影响**   | 远程执行代码                                                                                                            |
| **检测**         | Microsoft 基准安全分析器可以检测您的计算机系统是否需要此更新。 该更新可能要求重新启动。                                 |
...
|------------------|------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Internet Explorer 的累积性安全更新 (931768)**](https://technet.microsoft.com/security/bulletin/ms07-027) |
| **摘要**         | 此更新解决了 Internet Explorer 中的漏洞，该漏洞可能允许远程执行代码。                                      |
| **最高严重等级** | [严重](https://go.microsoft.com/fwlink/?linkid=21140)                                                       |
| **漏洞的影响**   | 远程执行代码                                                                                               |
| **检测**         | Microsoft 基准安全分析器可以检测您的计算机系统是否需要此更新。 该更新可能要求重新启动。                    |
| **受影响的软件** | **Internet Explorer**。 有关详细信息，请参阅“受影响的软件和下载位置”部分。                                 |

| 公告标识符       | Microsoft 安全公告 MS07-028                                                                                  |
|------------------|--------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**CAPICOM 中的漏洞可能允许远程执行代码 (931906)**](https://technet.microsoft.com/security/bulletin/ms07-028) |
| **摘要**         | 此更新解决了加密 API 组件对象模型 (CAPICOM) 中的漏洞，该漏洞可能允许远程执行代码。                           |
| **最高严重等级** | [严重](https://go.microsoft.com/fwlink/?linkid=21140)                                                         |
| **漏洞的影响**   | 远程执行代码                                                                                                 |
| **检测**         | Microsoft 基准安全分析器可以检测您的计算机系统是否需要此更新。 该更新可能要求重新启动。                      |
| **受影响的软件** | **CAPICOM、BizTalk**。 有关详细信息，请参阅“受影响的软件和下载位置”部分。                                    |

| 公告标识符       | Microsoft 安全公告 MS07-029                                                                                                   |
|------------------|-------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Windows DNS 服务器上 RPC 中的漏洞可能允许远程执行代码 (935966)**](https://technet.microsoft.com/security/bulletin/ms07-029) |
| **摘要**         | 此更新解决了 Windows DNS 服务器上 RPC 中的漏洞，该漏洞可能允许远程执行代码。                                                  |
| **最高严重等级** | [严重](https://go.microsoft.com/fwlink/?linkid=21140)                                                                          |
| **漏洞的影响**   | 远程执行代码                                                                                                                  |
| **检测**         | Microsoft 基准安全分析器可以检测您的计算机系统是否需要此更新。 此更新需要重新启动。                                           |
...
<tr class="even">
<td style="border:1px solid black;">用于 Windows XP Professional x64 Edition Service Pack 2 的 Internet Explorer 6</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">用于 Windows Server 2003 x64 Edition Service Pack 1 和 Windows Server 2003 x64 Edition Service Pack 2 的 Internet Explorer 6</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">用于 Windows XP Professional x64 Edition 的 Internet Explorer 7</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">用于 Windows XP Professional x64 Edition Service Pack 2 的 Internet Explorer 7</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">用于 Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2 的 Windows Internet Explorer 7</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">用于 Windows Server 2003 x64 Edition Service Pack 1 和 Windows Server 2003 x64 Edition Service Pack 2 的 Internet Explorer 7</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="even">
<td style="border:1px solid black;">Windows Vista 中的 Windows Internet Explorer 7</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">Windows Vista x64 Edition 中的 Windows Internet Explorer 7</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">带有 Exchange 2000 Post-Service Pack 3 更新汇总的 Exchange 2000 Server Service Pack 3：</td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;"></td>
...
Microsoft 提供安全更新的附加检测和部署指南。 此指南还将帮助 IT 专业人士了解如何可以使用各种工具帮助部署安全更新，例如 Windows Update、Microsoft Update、Office Update、Microsoft 基准安全分析器 (MBSA)、Office 检测工具、Microsoft Systems Management Server (SMS)、扩展安全更新清单工具以及企业更新扫描工具 (EST)。 有关详细信息，请参阅 [Microsoft 知识库文章 910723](https://support.microsoft.com/default.aspx?scid=kb;en-us;910723)。
...
-   Manuel Santamarina Suarez 与 [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了 [MS07-023](https://technet.microsoft.com/security/bulletin/ms07-023) 中描述的问题。  
-   [iDefense Labs](https://labs.idefense.com/) 的 Greg MacManus 报告了 [MS07-023](https://technet.microsoft.com/security/bulletin/ms07-023) 中描述的问题。  
-   [McAfee Avert Labs](https://www.avertlabs.com/) 的 Craig Schmugar 与我们一起处理了 [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024) 中描述的问题。  
-   [AV-Test](https://www.av-test.org/) 的 Andreas Marx 与我们一起处理了 [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024) 中描述的问题。  
-   Jun Mao 与 [iDefense Labs](https://labs.idefense.com/) 一起报告了 [MS07-024](https://technet.microsoft.com/security/bulletin/ms07-024) 中描述的问题。  
-   [Izecom](https://www.izecom.com/) 的 Martijn Brinkers 报告了 [MS07-026](https://technet.microsoft.com/security/bulletin/ms07-026) 中描述的问题。  
-   [Determina Security Research](https://www.determina.com/security.research) 的 Alexander Sotirov 报告了 [MS07-026](https://technet.microsoft.com/security/bulletin/ms07-026) 中描述的问题。  
-   Joxean Koret 与 [iDefense](https://labs.idefense.com/) Vulnerability Contributor Program 一起报告了 [MS07-026](https://technet.microsoft.com/security/bulletin/ms07-026) 中描述的问题。  
-   [TippingPoint](https://www.tippingpoint.com/) 和 [Zero Day Initiative](https://www.zerodayinitiative.com/) 报告了 [MS07-027](https://technet.microsoft.com/security/bulletin/ms07-027) 中描述的问题。  
-   [Secunia Research](https://secunia.com/) 的 JJ Reyes 报告了 [MS07-027](https://technet.microsoft.com/security/bulletin/ms07-027) 中描述的问题。  
-   [Fortinet Security Research](https://www.fortinet.com/) 的 cocoruder 报告了 [MS07-027](https://technet.microsoft.com/security/bulletin/ms07-027) 中描述的问题。  
-   [VigilantMinds Inc.](https://www.vigilantminds.com/) 的 Chris Ries 报告了 [MS07-028](https://technet.microsoft.com/security/bulletin/ms07-028) 中描述的问题  
-   [SANS ISC Handlers](https://isc.sans.org/) 的 Mark Hofman 与我们一起处理了 [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) 中描述的问题。  
-   Bill O'Malley 和 [Carnegie Mellon University 的 Information Security Office](https://www.cmu.edu/iso/) 与我们一起处理了 [MS07-029](https://technet.microsoft.com/security/bulletin/ms07-029) 中描述的问题。
...
-   Microsoft 在 Microsoft Update (MU) 和 Windows Server 更新服务 (WSUS) 上发布了六个**非安全**高优先级更新。  
-   Microsoft 在 Windows Update (WU) 和软件更新服务 (SUS) 上发布了一个**非安全**高优先级 Windows 更新。
...
-   [TechNet 安全中心](https://go.microsoft.com/fwlink/?linkid=21132)提供了有关 Microsoft 产品中安全性的其他信息。  

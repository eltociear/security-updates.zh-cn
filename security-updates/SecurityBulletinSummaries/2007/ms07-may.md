...
-   IT 专业人士可以访问 [TechNet 安全中心](http://www.microsoft.com/china/technet/security/default.mspx)。
...
|------------------|----------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Excel 中的漏洞可能允许远程执行代码 (934233)**](http://technet.microsoft.com/security/bulletin/ms07-023) |
...
|------------------|---------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Word 中的漏洞可能允许远程执行代码 (934232)**](http://technet.microsoft.com/security/bulletin/ms07-024) |
...
|------------------|-----------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Office 中的漏洞可能允许远程执行代码 (934873)**](http://technet.microsoft.com/security/bulletin/ms07-025) |
...
|------------------|-------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Microsoft Exchange 中的漏洞可能允许远程执行代码 (931832)**](http://technet.microsoft.com/security/bulletin/ms07-026) |
...
|------------------|------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Internet Explorer 的累积性安全更新 (931768)**](http://technet.microsoft.com/security/bulletin/ms07-027) |
...
|------------------|--------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**CAPICOM 中的漏洞可能允许远程执行代码 (931906)**](http://technet.microsoft.com/security/bulletin/ms07-028) |
...
|------------------|-------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Windows DNS 服务器上 RPC 中的漏洞可能允许远程执行代码 (935966)**](http://technet.microsoft.com/security/bulletin/ms07-029) |
...
-   Manuel Santamarina Suarez 与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 报告了 [MS07-023](http://technet.microsoft.com/security/bulletin/ms07-023) 中描述的问题。  
-   [iDefense Labs](http://labs.idefense.com/) 的 Greg MacManus 报告了 [MS07-023](http://technet.microsoft.com/security/bulletin/ms07-023) 中描述的问题。  
-   [McAfee Avert Labs](http://www.avertlabs.com/) 的 Craig Schmugar 与我们一起处理了 [MS07-024](http://technet.microsoft.com/security/bulletin/ms07-024) 中描述的问题。  
-   [AV-Test](http://www.av-test.org/) 的 Andreas Marx 与我们一起处理了 [MS07-024](http://technet.microsoft.com/security/bulletin/ms07-024) 中描述的问题。  
-   Jun Mao 与 [iDefense Labs](http://labs.idefense.com/) 一起报告了 [MS07-024](http://technet.microsoft.com/security/bulletin/ms07-024) 中描述的问题。  
-   [Izecom](http://www.izecom.com/) 的 Martijn Brinkers 报告了 [MS07-026](http://technet.microsoft.com/security/bulletin/ms07-026) 中描述的问题。  
-   [Determina Security Research](http://www.determina.com/security.research) 的 Alexander Sotirov 报告了 [MS07-026](http://technet.microsoft.com/security/bulletin/ms07-026) 中描述的问题。  
-   Joxean Koret 与 [iDefense](http://labs.idefense.com/) Vulnerability Contributor Program 一起报告了 [MS07-026](http://technet.microsoft.com/security/bulletin/ms07-026) 中描述的问题。  
-   [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 报告了 [MS07-027](http://technet.microsoft.com/security/bulletin/ms07-027) 中描述的问题。  
-   [Secunia Research](http://secunia.com/) 的 JJ Reyes 报告了 [MS07-027](http://technet.microsoft.com/security/bulletin/ms07-027) 中描述的问题。  
-   [Fortinet Security Research](http://www.fortinet.com/) 的 cocoruder 报告了 [MS07-027](http://technet.microsoft.com/security/bulletin/ms07-027) 中描述的问题。  
-   [VigilantMinds Inc.](http://www.vigilantminds.com/) 的 Chris Ries 报告了 [MS07-028](http://technet.microsoft.com/security/bulletin/ms07-028) 中描述的问题  
-   [SANS ISC Handlers](http://isc.sans.org/) 的 Mark Hofman 与我们一起处理了 [MS07-029](http://technet.microsoft.com/security/bulletin/ms07-029) 中描述的问题。  
-   Bill O'Malley 和 [Carnegie Mellon University 的 Information Security Office](http://www.cmu.edu/iso/) 与我们一起处理了 [MS07-029](http://technet.microsoft.com/security/bulletin/ms07-029) 中描述的问题。

...
对于 2007 年 11 月发布的安全公告，本公告摘要替代 2007 年 11 月 8 日最初发布的公告预先通知。有关公告预先通知服务的详细信息，请参阅 [Microsoft 安全公告预先通知](https://technet.microsoft.com/security/bulletin/advance)。

有关在 Microsoft 安全公告发布时如何收到自动通知的信息，请访问 [Microsoft 技术安全通知](https://go.microsoft.com/fwlink/?linkid=21163)。

Microsoft 将在 2007 年 11 月 14 日上午 11 点（美国和加拿大太平洋时间）进行网络广播，以解答客户关于这些公告的疑问。 [立即注册申请收听 11 月份安全公告网络广播](https://msevents.microsoft.com/cui/webcasteventdetails.aspx?eventid=1032344694&eventcategory=4&culture=en-us&countrycode=us)。 此日期之后，此网络广播按需提供。 有关详细信息，请参阅 [Microsoft 安全公告摘要和网络广播](https://technet.microsoft.com/security/bulletin/summary)。
...
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**Windows URI 处理中的漏洞可能允许远程执行代码 (943460)**](https://technet.microsoft.com/security/bulletin/ms07-061)                                                                                                                                                                                                                                                     |
...
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **公告标题**     | [**DNS 中的漏洞可能允许欺骗 (941672)**](https://technet.microsoft.com/security/bulletin/ms07-062)                                                                    |
...
-   [Secunia](https://corporate.secunia.com/) 的 Carsten H. Eiram 与我们一起处理了 MS07-061 中描述的问题
-   [Finjan](https://www.finjan.com/) 的 Aviv Raff 与我们一起处理了 MS07-061 中描述的问题
-   [GNUCITIZEN](https://www.gnucitizen.org/) 的 Petko Petkov 与我们一起处理了 MS07-061 中描述的问题
-   [Scanit](https://www.scanit.be/) 的 Alla Berzroutchko 报告了 MS07-062 中描述的问题
-   [Trusteer](https://www.trusteer.com/) 的 Amit Klein 报告了 MS07-062 中描述的问题

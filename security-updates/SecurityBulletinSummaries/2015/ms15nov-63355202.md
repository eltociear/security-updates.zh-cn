...
<td style="border:1px solid black;">
[**MS15-116**](https://technet.microsoft.com/zh-cn/library/security/ms15-116)
...
(3101360)  
（重要）  
Microsoft Access 2013 Service Pack 1（32 位版本）  
(3085584)  
（重要）  
...
(3054793)  
（重要）  
Microsoft OneNote 2013 Service Pack 1（32 位版本）  
(3101371)  
（重要）  
Microsoft PowerPoint 2013 Service Pack 1（32 位版本）  
(3101359)  
（重要）  
Microsoft Project 2013 Service Pack 1（32 位版本）  
(3101506)  
（重要）  
Microsoft Publisher 2013 Service Pack 1（32 位版本）  
(3085561)  
（重要）  
...
(3101360)  
（重要）  
Microsoft Access 2013 Service Pack 1（64 位版本）  
(3085584)  
（重要）  
...
(3054793)  
（重要）  
Microsoft OneNote 2013 Service Pack 1（64 位版本）  
(3101371)  
（重要）  
Microsoft PowerPoint 2013 Service Pack 1（64 位版本）  
(3101359)  
（重要）  
Microsoft Project 2013 Service Pack 1（64 位版本）  
(3101506)  
（重要）  
Microsoft Publisher 2013 Service Pack 1（64 位版本）  
(3085561)  
（重要）  
...
(3101514)  
（重要）  
Microsoft Access 2016（32 位版本）  
(2910978)  
（重要）  
Microsoft Excel 2016（32 位版本）  
(3101510)  
（重要）  
Microsoft OneNote 2016（32 位版本）  
(2920726)  
（重要）  
Microsoft PowerPoint 2016（32 位版本）  
(3101509)  
（重要）  
Microsoft Project 2016（32 位版本）  
(2920698)  
（重要）  
Microsoft Publisher 2016（32 位版本）  
(2920680)  
（重要）  
...
(3101514)  
（重要）  
Microsoft Access 2016（64 位版本）  
(2910978)  
（重要）  
Microsoft Excel 2016（64 位版本）  
(3101510)  
（重要）  
Microsoft OneNote 2016（64 位版本）  
(2920726)  
（重要）  
Microsoft PowerPoint 2016（64 位版本）  
(3101509)  
（重要）  
Microsoft Project 2016（64 位版本）  
(2920698)  
（重要）  
Microsoft Publisher 2016（64 位版本）  
(2920680)  
（重要）  
...
<td style="border:1px solid black;">
[**MS15-123**](https://technet.microsoft.com/zh-cn/library/security/ms15-123)
...
-   V1.0（2015 年 11 月 10 日）：已发布公告摘要。
-   V1.1（2015 年 11 月 11 日）：对于 MS15-115，添加了 KB3097877 的一个已知问题。Microsoft 正在查看某些用户的崩溃报告，当客户在安装 Windows 安全更新 3097877 后查看某些电子邮件时，可能出现崩溃。正在进行快速审核。
-   V2.0（2015 年 12 月 9 日）：对于 MS15-115，更新了 [Microsoft 知识库文章 3097877](https://support.microsoft.com/zh-cn/kb/3097877)，通知客户发布了适用于 Windows 7 和 Windows Server 2008 R2 的 3097877 更新，以更正原始更新可能导致某些应用程序意外退出的问题。已在 Windows 7 或 Windows Server 2008 R2 系统上安装该更新的客户应重新安装此更新。
-   V2.1（2015 年 12 月 9 日）：对于 MS15-122，修订了执行摘要以删除对此要求的引用，攻击者能够物理访问目标计算机来利用 CVE-2015-6095。此仅为信息变更。已成功安装此更新程序的客户无需采取任何措施。
-   V2.2（2015 年 12 月 17 日）：公告摘要经过修订，以向 MS15-116 和 MS15-123 的执行摘要表添加一个已知问题。在安装安全更新 3101496 后，“Lync”会显示在“联系人”列表的标题栏中。如果您已将 Skype for Business 用户界面配置为在 Lync 2013 (Skype for Business) 客户端中显示，则会出现此问题。Microsoft 正在研究此问题，并且将在获得更多信息之后在本文中添加这些信息。
-   V3.0（2016 年 2 月 9 日）：对于 MS15-118，修订的公告总结声明此次重新发布的 3098785 更新用于解决在[Microsoft 知识库文章 3318750](https://support.microsoft.com/zh-cn/kb/3318750)中讨论的已知问题，这些是运行 Windows 8.1、Windows RT 或 Windows Server 2012 R2 的客户在已经配备完全更新版的 .NET Framework 4.5.x 机器上安装 .NET Framework 4.6 时可能遇到的问题。Microsoft 建议客户扫描以下载新的更新，并安装重新发布的 3098785 更新。更多信息，请参阅 [Microsoft 知识库文章 3318750](https://support.microsoft.com/zh-cn/kb/3318750)。

*页面生成时间：08.02.2016 г. 17:24:00-08:00。*

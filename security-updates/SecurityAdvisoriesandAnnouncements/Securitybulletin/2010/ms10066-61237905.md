...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7ad0f2cf-03dc-49a0-a16e-17fed0c01cc6)                          | 远程执行代码 | 重要         | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3349b12b-621e-48bc-9c57-489c7a56920d) | 远程执行代码 | 重要         | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8b3004b-07db-4638-a9b7-224ff829081c)                 | 远程执行代码 | 重要         | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=612b2096-bd82-47ca-8b99-454c2f158d39)     | 远程执行代码 | 重要         | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=1f04f151-330a-4b6c-826e-76def35daa73) | 远程执行代码 | 重要         | [MS09-026](http://go.microsoft.com/fwlink/?linkid=150174) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2567](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2567)。
...
-   **在防火墙处阻止与 RPC 关联的端口**
    ...
    这些端口用于启动与 RPC 的连接。 将其阻止在防火墙处，有助于保护位于防火墙后面的系统免受利用此漏洞进行的攻击。 此外，还要确保阻止远程系统上任何其他特殊配置的 PRC 端口。 Microsoft 建议阻塞来自 Internet 的所有非法入站通信，以帮助防止可能利用其他端口进行的攻击。 有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](http://go.microsoft.com/fwlink/?linkid=21312)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/982802">Microsoft 知识库文章 982802</a></td>
</tr>  
<tr class="even">
...
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) 的 Yamata Li 报告了 RPC 内存损坏漏洞 (CVE-2010-2567)

...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0243](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0243)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/977896">Microsoft 知识库文章 977896</a></td>
</tr>  
<tr class="even">
...
-   [Core Security Technologies](http://www.coresecurity.com/) 的 Damian Frizza 报告了 MSO.DLL 缓冲区溢出漏洞 (CVE-2010-0243)

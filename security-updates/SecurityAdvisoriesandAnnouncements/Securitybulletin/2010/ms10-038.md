---
TOCTitle: 'MS10-038'
Title: 'Microsoft 安全公告 MS10-038 - 重要'
ms:assetid: 'ms10-038'
ms:contentKeyID: 61237877
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-038(v=Security.10)'
---

Microsoft 安全公告 MS10-038 - 重要
==================================
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 1 以及用于 Word、Excel 和 PowerPoint 2007 文件格式 的 Microsoft Office 兼容包 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7f89a734-cda4-4abb-9a10-f6dfe560e8d0)  
(KB982331)
</td>
<td style="border:1px solid black;">
不适用
...
<sup>[1]</sup>对于 Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2，除了安全更新程序包 KB982308 之外，客户还需要安装用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 1 和用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包 Service Pack 2 的安全更新 (KB982331)，以免受本公告中所描述的漏洞影响。
...
**MS10-036 还描述 Microsoft Office Excel 中的一个漏洞。 MS10-036 与此公告 (MS10-038) 有何关联？**  
此公告 [MS10-036](http://go.microsoft.com/fwlink/?linkid=190554) 中的 Microsoft Office Excel 2003 (KB982133) 和 Microsoft Office Excel 2007 (KB982308) 安全更新包还解决了本公告 MS10-038 中描述的漏洞。安装了Microsoft Office Excel 2003 或 Microsoft Office Excel 2007 的用户只需安装这些安全更新包一次。 此外，[MS10-036](http://go.microsoft.com/fwlink/?linkid=190554) 提供了相关的 Microsoft Office 更新（KB982311 或 KB982312），用户也必须安装以解决 [MS10-036](http://go.microsoft.com/fwlink/?linkid=190554) 中描述的漏洞。

**此更新为何消除了多个已报告的安全漏洞？**  
此更新之所以包含对某些漏洞的支持，是因为解决这些问题所需的修改位于相关的文件中。 客户只需安装此更新就可以了，而不用安装多个几乎相同的更新。

**此更新是否包含任何其他与安全性无关的功能更改？**  
是，Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2 的更新程序包 (KB982308) 包括 [Microsoft 知识库文章 981046](http://support.microsoft.com/kb/981046) 中描述的对 Excel 2007 的更改。
...
Microsoft Office Excel 2002 和更高版本具有下列内置功能：打开文档之前，系统将提示用户打开、保存或取消。 此缓解因素将该漏洞从“严重”降级为“重要”，因为该漏洞需要多次用户操作才能完成利用。
...
<table style="border:1px solid black;">
<caption>
<span id="bookmark_0"></span><span id="bookmark_1"></span>按受影响软件列出的漏洞严重等级和最大安全影响
</caption>
<tr class="thead">
<th>
受影响的软件
...
<th>
Excel 记录分析内存损坏漏洞 - CVE-2010-0821
</th>
<th>
Excel 对象堆栈溢出漏洞 - CVE-2010-0822
</th>
<th>
Excel 内存损坏漏洞 - CVE-2010-0823
</th>
<th>
Excel 记录内存损坏漏洞 - CVE-2010-0824
</th>
<th>
Excel 记录内存损坏漏洞 - CVE-2010-1245
</th>
<th>
Excel RTD 内存损坏漏洞 - CVE-2010-1246
</th>
<th>
Excel 内存损坏漏洞 - CVE-2010-1247
</th>
<th>
Excel HFPicture 内存损坏漏洞 - CVE-2010-1248
</th>
<th>
</th>
<th>
...
<tr>
<th style="border:1px solid black;" colspan="17">
Microsoft Office 套件和组件
</th>
</tr>
<tr>
...
<th>
Excel 内存损坏漏洞 - CVE-2010-1249
</th>
<th>
Excel EDG 内存损坏漏洞 - CVE-2010-1250
</th>
<th>
Excel 记录堆栈损坏漏洞 - CVE-2010-1251
</th>
<th>
Excel 字符串变量漏洞 - CVE-2010-1252
</th>
<th>
Excel ADO 对象漏洞 - CVE-2010-1253
</th>
<th>
Mac Office Open XML 权限漏洞 - CVE-2010-1254
</th>
<th>
综合严重等级
</th>
...
#### Excel 记录分析内存损坏漏洞 (CVE-2010-0821) 的缓解因素
...
#### Excel 记录分析内存损坏漏洞 (CVE-2010-0821) 的变通办法
...
-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 记录分析内存损坏漏洞 (CVE-2010-0821) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0822](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0822)。

#### Excel 对象堆栈溢出漏洞 (CVE-2010-0822) 的缓解因素
...
#### Excel 对象堆栈溢出漏洞 (CVE-2010-0822) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 对象堆栈溢出漏洞 (CVE-2010-0822) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0823](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0823)。

#### Excel 内存损坏漏洞 (CVE-2010-0823) 的缓解因素
...
#### Excel 内存损坏漏洞 (CVE-2010-0823) 的变通办法
...
#### Excel 内存损坏漏洞 (CVE-2010-0823) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成漏洞的原因是什么？**  
该漏洞是由 Microsoft Office Excel 在打开特制的 Excel 文件时分析 Excel 文件格式中格式错误的图表子流的方法所造成的。
...
**此更新有什么作用？**  
此更新通过更改 Microsoft Office Excel 分析特制的 Excel 文件中格式错误的图表子流的方法来解决漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0824](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0824)。

#### Excel 记录内存损坏漏洞 (CVE-2010-0824) 的缓解因素
...
#### Excel 记录内存损坏漏洞 (CVE-2010-0824) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 记录内存损坏漏洞 (CVE-2010-0824) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1245](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1245)。

#### Excel 记录内存损坏漏洞 (CVE-2010-1245) 的缓解因素
...
#### Excel 记录内存损坏漏洞 (CVE-2010-1245) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 记录内存损坏漏洞 (CVE-2010-1245) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1246](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1246)。

#### Excel RTD 内存损坏漏洞 (CVE-2010-1246) 的缓解因素
...
#### Excel RTD 内存损坏漏洞 (CVE-2010-1246) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel RTD 内存损坏漏洞 (CVE-2010-1246) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1247](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1247)。

#### Excel 内存损坏漏洞 (CVE-2010-1247) 的缓解因素
...
#### Excel 内存损坏漏洞 (CVE-2010-1247) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 内存损坏漏洞 (CVE-2010-1247) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1248](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1248)。

#### Excel HFPicture 内存损坏漏洞 (CVE-2010-1248) 的缓解因素
...
#### Excel HFPicture 内存损坏漏洞 (CVE-2010-1248) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel HFPicture 内存损坏漏洞 (CVE-2010-1248) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1249](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1249)。

#### Excel 内存损坏漏洞 (CVE-2010-1249) 的缓解因素
...
#### Excel 内存损坏漏洞 (CVE-2010-1249) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 内存损坏漏洞 (CVE-2010-1249) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1250](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1250)。

#### Excel EDG 内存损坏漏洞 (CVE-2010-1250) 的缓解因素
...
#### Excel EDG 内存损坏漏洞 (CVE-2010-1250) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel EDG 内存损坏漏洞 (CVE-2010-1250) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1251](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1251)。

#### Excel 记录堆栈损坏漏洞 (CVE-2010-1251) 的缓解因素
...
#### Excel 记录堆栈损坏漏洞 (CVE-2010-1251) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 记录堆栈损坏漏洞 (CVE-2010-1251) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1252](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1252)。

#### Excel 字符串变量漏洞 (CVE-2010-1252) 的缓解因素
...
#### Excel 字符串变量漏洞 (CVE-2010-1252) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   不要打开从不受信任来源或从受信任来源意外收到的 Excel 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 字符串变量漏洞 (CVE-2010-1252) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1253)。

#### Excel ADO 对象漏洞 (CVE-2010-1253) 的缓解因素
...
#### Excel ADO 对象漏洞 (CVE-2010-1253) 的变通办法
...
#### Excel ADO 对象漏洞 (CVE-2010-1253) 的常见问题
...
Open XML File Format Converter for Mac 安装方式本身存在一个特权提升漏洞。 在安装期间，Open XML File Format Converter for Mac 会以降低 /Applications 文件夹安全设置并允许访问此文件夹中所有文件的方式更改 /Applications 文件夹的文件系统 ACL。 要利用此漏洞，攻击者必须先登录到系统。 攻击者可以用恶意可执行文件替换 Open XML File Format Converter for Mac。 之后当管理员登录并运行 Open XML File Format Converter for Mac 时，可能会执行攻击者提供的代码，使得攻击者可以完全控制受影响的系统。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1254)。

#### Mac Office Open XML 权限漏洞 (CVE-2010-1254) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。
-   Open XML File Format Converter for Mac 未与任何版本的 Office for Mac 一起安装。 只能单独下载。
-   如果管理员在攻击者修改了安装之后执行 Open XML File Format Converter for Mac，攻击者只能在受影响的 Mac 计算机上获得高特权。 这不是直接特权提升，而应该是诱导式攻击。

#### Mac Office Open XML 权限漏洞 (CVE-2010-1254) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **将 /Applications 文件夹以及 Open XML File Format Converter for Mac 的所有者和组改为特权用户**
    ...
    **如何撤消变通方法。**
    ...
    将权限重置回 Open XML File Format Converter for Mac 安装设置的脆弱状态：
...
#### Mac Office Open XML 权限漏洞 (CVE-2010-1254) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成漏洞的原因是什么？**  
在安装期间，Office XML converter for Mac 应用程序会以降低 /Applications 文件夹安全设置的方式更改 /Applications 文件夹的文件系统 ACL。

**攻击者可能利用此漏洞执行什么操作？**  
攻击者可以用恶意可执行文件替换 Office XML Converter for Mac 应用程序。 之后当管理员登录并运行 Office XML Converter for Mac 应用程序时，可能会执行攻击者提供的代码，使得攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**攻击者如何利用此漏洞？**  
利用此漏洞，攻击者首先必须登录到系统并用恶意可执行文件替换 Office XML Converter for Mac。 之后当管理员登录并运行 Office XML Converter for Mac 应用程序时，可能会执行攻击者提供的代码。

**受此漏洞威胁最大的系统有哪些？**  
工作站和终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。

**此更新有什么作用？**  
此更新通过通过更正 Open XML File Format Converter for Mac 安装的方法，以使 /Applications 文件夹的默认安全设置不被更改来解决漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/982299">Microsoft 知识库文章 982299</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/982133">Microsoft 知识库文章 982133</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
#### Excel 2007（所有版本）、Excel Viewer 以及用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包（所有版本）
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Excel Viewer：<br />
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Excel 2007：<br />
请参阅 <a href="http://support.microsoft.com/kb/982308">Microsoft 知识库文章 982308</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Excel Viewer：<br />
请参阅 <a href="http://support.microsoft.com/kb/982333">Microsoft 知识库文章 982333</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包：<br />
请参阅 <a href="http://support.microsoft.com/kb/982331">Microsoft 知识库文章 982331</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
从 [Microsoft 下载中心](http://www.microsoft.com/downloads/details.aspx?familyid=16c71ab8-9284-407a-856a-93c67995f125)下载和安装 Microsoft Office 2004 for Mac 11.5.9 Update 的合适语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Microsoft Office 2004 for Mac 11.5.9 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Microsoft Office 2004 for Mac 11.5.9 Update 卷窗口中双击 Microsoft Office 2004 for Mac 11.5.9 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2004 for Mac 11.5.9 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
从 [Microsoft 下载中心](http://www.microsoft.com/downloads/details.aspx?familyid=d46255bd-6470-4106-9fe2-ea67acd3f1bd)下载和安装 Microsoft Office 2008 for Mac 12.2.5 Update 的合适语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Microsoft Office 2008 for Mac 12.2.5 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Microsoft Office 2008 for Mac 12.2.5 Update 卷窗口中双击 Microsoft Office 2008 for Mac 12.2.5 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Microsoft Office 2008 for Mac 12.2.5 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
从 [Microsoft 下载中心](http://www.microsoft.com/downloads/details.aspx?familyid=b6ca7b05-cf97-43a2-95eb-7b5caf7c1528)下载和安装 Open XML File Format Converter for Mac 1.1.5 Update 的合适语言版本。
  
-   退出包括病毒防护应用程序、所有 Microsoft Office 应用程序、Microsoft Messenger for Mac 和 Office Notifications 等任何正在运行的应用程序，因为它们可能会影响安装。  
-   在桌面上打开 Open XML File Format Converter for Mac 1.1.5 Update 卷。 可能已经为您执行了此步骤。  
-   要启动更新过程，请在 Open XML File Format Converter for Mac 1.1.5 Update 卷窗口中双击 Open XML File Format Converter for Mac 1.1.5 Update 应用程序，然后按照屏幕上的说明进行操作。  
-   如果成功完成安装，您便可以从硬盘中删除此安装程序。 要验证是否成功完成安装，请参阅下列“验证更新安装”标题。 要删除更新安装程序，请先将 Open XML File Format Converter for Mac 1.1.5 Update 卷拖到回收站中，然后再将您下载的文件拖到回收站中。
...
-   一名匿名研究人员与 [TippingPoint](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，报告了 Excel 记录分析内存损坏漏洞 (CVE-2010-0821)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 对象堆栈溢出漏洞 (CVE-2010-0822)  
-   [Fortinet's FortiGuard Labs](http://www.fortiguard.com/) 的 Bing Liu 报告了 Excel 内存损坏漏洞 (CVE-2010-0823)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 记录内存损坏漏洞 (CVE-2010-0824)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 记录内存损坏漏洞 (CVE-2010-1245)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel RTD 内存损坏漏洞 (CVE-2010-1246)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 内存损坏漏洞 (CVE-2010-1247)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel HFPicture 内存损坏漏洞 (CVE-2010-1248)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel 内存损坏漏洞 (CVE-2010-1249)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Nicolas Joly 报告了 Excel EDG 内存损坏漏洞 (CVE-2010-1250)  
-   [Secunia](http://secunia.com/) 的 Carsten Eiram 报告了 Excel 记录堆栈损坏漏洞 (CVE-2010-1251)  
-   [Secunia](http://secunia.com/) 的 Carsten Eiram 报告了 Excel 字符串变量漏洞 (CVE-2010-1252)  
-   一名匿名研究人员与 [TippingPoint](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，报告了 Excel ADO 对象漏洞 (CVE-2010-1253)  
-   Gilbert 的Gilbert Public Schools 的 Rick Glaspie 报告了 Mac Office Open XML 权限漏洞 (CVE-2010-1254)
...
-   V1.1（2010 年 6 月 9 日）： 删除了“摘要”中的已知问题表示。 此安全更新当前没有已知问题。

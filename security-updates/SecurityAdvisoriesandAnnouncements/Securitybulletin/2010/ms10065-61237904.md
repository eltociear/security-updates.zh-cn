...
**已知问题。** [Microsoft 知识库文章 2267960](http://support.microsoft.com/kb/2267960) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-1899](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-1899)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2730](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2730)。
...
-   安装 URL Rewrite 模块
    ...
    安装该模块时，无论是否使用，您都将受到保护。 有关 URL Rewrite 的信息，请参阅 [URL Rewrite](http://www.iis.net/download/urlrewrite)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2731](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2731)。
...
-   **安装和使用 URLScan**
    ...
    URLScan 有助于阻止因错误构建 URL 请求（包括本公告中解决的公开描述的问题）而产生的大量问题。 但是，URLScan 不会像缓解代码模块和下面的 global.asax 脚本一样面面俱到地保护您的系统。 有关 URLScan 的信息，请参阅 TechNet 文章 [UrlScan 安全工具](http://www.microsoft.com/technet/security/tools/urlscan.mspx)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-2731](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2731)。
...
<td style="border:1px solid black;">有关 Windows XP Service Pack 3 上的 Internet Information Services 5.1 ASP (KB2124261) 和 Windows XP Professional x64 Edition Service Pack 2 上的 Internet Information Services 6.0 ASP (KB2124261)，请参阅 <a href="http://support.microsoft.com/kb/2124261">Microsoft 知识库文章 2124261</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">有关 Windows XP Service Pack 3 上的 Internet Information Services 5.1 身份验证 (KB2290570)，请参阅 <a href="http://support.microsoft.com/kb/2290570">Microsoft 知识库文章 2290570</a></td>
</tr>  
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2124261">Microsoft 知识库文章 2124261</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
请参阅 <a href="http://support.microsoft.com/kb/2124261">Microsoft 知识库文章 2124261</a><br />  
<br />  
...
请参阅 <a href="http://support.microsoft.com/kb/2271195">Microsoft 知识库文章 2271195</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注意</strong> 没有用于验证此更新是否存在的注册表项。</td>

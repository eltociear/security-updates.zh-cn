...
|-----------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=73b3d681-26bb-49c1-849e-1f72484cb978) | 远程执行代码 | 严重         | 无               |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0478](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0478)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/980858">Microsoft 知识库文章 980858</a></td>
</tr>  
<tr class="even">
...
-   [CERT-LEXSI](http://cert.lexsi.com/) 的 Fabien Perigaud 报告了基于媒体服务堆栈的缓冲区溢出漏洞 (CVE-2010-0478)

...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=0553fc7c-deed-4594-a133-d621551310dc)                          | 特权提升     | 重要         | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1ad30596-bac6-4d48-8b15-0245960c443b) | 特权提升     | 重要         | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f94763e7-b1db-4043-aa79-d5be1a42307d)                 | 特权提升     | 重要         | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6fca5cab-7e11-4911-a6a8-f73f113b2963)     | 特权提升     | 重要         | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=e8f297e2-0dfd-421a-b598-a78199ad6baa) | 特权提升     | 重要         | [MS10-037](http://go.microsoft.com/fwlink/?linkid=190508) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2740](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2740)。
...
**什么是 OpenType 字体格式？**  
OpenType 是由 Microsoft 和 Adobe 联合开发的一种字体格式，作为 Apple 的 TrueType 字体格式的扩展。 OpenType 字体文件包含表格格式的数据，该数据包括 TrueType 或 PostScript 轮廓字体。 光栅器使用字体中包含的表格中的数据组合以呈现 TrueType 或 PostScript glyph 轮廓。 不管使用哪种轮廓格式，都可使用此支持数据中的部分数据；部分支持数据特定于 TrueType 或 PostScript。 有关详细信息，请参阅 [Microsoft Typography OpenType 常见问题。](http://www.microsoft.com/typography/opentypefaq.mspx)
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2741](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2741)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2279986">Microsoft 知识库文章 2279986</a></td>
</tr>  
<tr class="even">
...
-   [Siberas](http://www.siberas.de/) 的 Sebastian Apelt 报告了 OpenType 字体分析漏洞 (CVE-2010-2740)
-   [Core Security Technologies](http://www.coresecurity.com) 的 Diego Juarez 报告了 OpenType 字体验证漏洞 (CVE-2010-2741)

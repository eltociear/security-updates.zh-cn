---
TOCTitle: 'MS10-055'
Title: 'Microsoft 安全公告 MS10-055 - 严重'
ms:assetid: 'ms10-055'
ms:contentKeyID: 61237894
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-055(v=Security.10)'
---

Microsoft 安全公告 MS10-055 - 严重
==================================

Cinepak 编解码器中的漏洞可能允许远程执行代码 (982665)
-----------------------------------------------------

发布时间: 2010年8月10日 | 更新时间: 2010年8月12日
...
对于 Windows XP、Windows Vista 和 Windows 7 的所有受支持版本，此安全更新等级为“严重”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

通过纠正 Cinepak 代码解压缩媒体文件的方式，安全更新解决了漏洞问题。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。** [Microsoft 知识库文章 982665](http://support.microsoft.com/kb/982665) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=5ddb5e34-f97a-47c6-96c8-ba2ed06ccb77)                                                            | 远程执行代码 | 严重         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cff5d6e-11a5-40ed-92ac-e12d287919e6)                                   | 远程执行代码 | 严重         | 无               |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=60c81415-b61e-44a4-8dd9-cedec99eb70f)                         | 远程执行代码 | 严重         | 无               |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=469b732d-ca62-4a48-bb55-99f2ae4ddcf5) | 远程执行代码 | 严重         | 无               |
| [Windows 7（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=2e782ac9-b5d5-490e-a01a-7d4481eab224)                                                          | 远程执行代码 | 严重         | 无               |
| [Windows 7（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=24751193-592f-4c44-a8d6-f4112d4f011b)                                                     | 远程执行代码 | 严重         | 无               |
...
<p>Windows Server 2008 for 32-bit Systems and Windows Server 2008 for 32-bit Systems Service Pack 2</p></td>
</tr>
<tr class="even">
...
**Windows 7 Service Pack 1 试用版是否受此漏洞的影响？**    
Windows 7 Service Pack 1 试用版受本公告中所述的安全漏洞影响。 鼓励运行此试用版的客户下载并向其系统应用此更新。 安全更新可从 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 和 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 获得。 此安全更新也可以从 [Microsoft 下载中心](http://go.microsoft.com/fwlink/?linkid=21129)下载。
...
<tr class="header">  
<th>受影响的软件</th>  
<th>Cinepak 编码解码器解压缩漏洞 - CVE-2010-2553</th>  
<th>综合严重等级</th>  
</tr>  
</thead>  
<tbody>  
...
Cinepak 编码解码器解压缩漏洞 - CVE-2010-2553  
--------------------------------------------
  
   
Cinepak 编码解码器处理受支持格式文件的方式中存在一个远程执行代码漏洞。 如果用户打开特制的媒体文件，此漏洞可能允许执行代码。 如果用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2553)。
  
#### Cinepak 编码解码器解压缩漏洞 (CVE-2010-2553) 的缓解因素
...
#### Cinepak 编码解码器解压缩漏洞 (CVE-2010-2553) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **修改 iccvid.dll 的访问控制列表 (ACL)**
  
    修改 iccvid.dll 上的 ACL 以增加限制。
  
    对于 32 位版本的 Windows XP，通过命令提示符运行以下命令（需要管理特权）：  
    `cacls %WINDIR%\SYSTEM32\iccvid.DLL /E /P everyone:N`
  
    对于 64 位版本的 Windows XP，通过命令提示符运行以下命令（需要管理特权）：  
    ...
    **变通办法的影响。** 使用 Cinepak 编码解码器编码的媒体文件将无法在多媒体中播放。
...
-   **在 DirectShow 中禁用 Cinepac 编码文件的分析**
  
    在 DirectShow 中禁用使用 Cinepac 编码解码器编码的媒体文件分析。
    ...
    **使用交互方法**
    ...
    3.  在“**文件**”菜单上，单击“**导出**”。  
    4.  在“导出注册表文件”对话框中，键入 **Drivers32\_Backup.reg**，然后单击“**保存**”。  
        **注意** 默认情况下，此操作将在“我的文档”文件夹中创建此注册表项的备份。  
    5.  找到并选择字符串值，将 **vidc.cvid** 用作名称，**iccvid.dll** 用作数据。  
    6.  按键盘上的“**Delete**”键删除该注册表项。 当系统提示您通过“确认项删除”对话框删除注册表项时，单击“**是**”。
    ...
    **使用被管理的部署脚本**
    ...
    2.  接下来，将下列内容保存到扩展名为 .REG 的文件，例如 Disable\_Cinepak\_Parser.reg：  
        **对于 32 位 Windows 系统**：  
    ...
    **如何撤消变通方法。**
    ...
    1.  单击“**开始**”，单击“**运行**”，在“**打开**”框中键入 **Regedit**，然后单击“**确定**”。  
    2.  单击“**文件**”菜单并选择“**导入**”。  
    3.  在“导入注册表文件”对话框中，选择 **Drivers32\_Backup.reg**，然后单击“**打开**”。
...
#### Cinepak 编码解码器解压缩漏洞 (CVE-2010-2553) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以使用提升的特权在容易受攻击的系统上运行任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Microsoft Windows 中附带的 Cinepak 编码解码器未正确处理特制的媒体文件。
  
**什么是 Cinepak 编码解码器？**    
Cinepak 编码解码器是 Windows Media Player 支持的媒体编码器和解码器。 此编码解码器允许对媒体文件进行位流编码和解码。 Cinepak 使用以矢量量化为基础的图像压缩和帧差异。
  
**什么是编码解码器？**    
编码解码器是用于压缩或解压缩歌曲或视频等数字媒体文件的软件。 Windows Media Player 与其他程序使用编码解码器来播放和创建数字媒体文件。
  
编码解码器包含两个组件： 编码器和解码器。 编码器执行压缩（编码）功能，解码器执行解压缩（解码）功能。 一些编码解码器包含这两个组件，而另一些编码解码器则仅包含其中一个组件。
  
例如，当您将歌曲从音频 CD 传输到计算机后，Windows Media Player 在默认情况下会使用 Windows Media 音频编码解码器将歌曲压缩为紧凑的 WMA 文件。 当播放该 WMA 文件（或可能从网站以媒体流方式传输的任何 WMA 文件）时，播放器会使用 Windows Media 音频编码解码器对文件进行解压缩，以便可通过扬声器播放该音乐。
...
**此更新有什么作用？**    
通过纠正 Cinepak 编码解码器解压缩媒体文件的方式，更新解决了此问题。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB982665$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/982665">Microsoft 知识库文章 982665</a></td>
</tr>  
<tr class="even">
...
-   一名与 [Tipping Point](http://www.tippingpoint.com/) 的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作的匿名研究人员，报告了 Cinepak 编码解码器解压缩漏洞 (CVE-2010-2553)
...
-   V1.1（2010 年 8 月 12 日）：增加了基于32位系统 的Windows Server 2008 和Windows Server 2008 Service Pack 2 到不受影响的软件平台。"

---
TOCTitle: 'MS10-012'
Title: 'Microsoft 安全公告 MS10-012 - 重要'
ms:assetid: 'ms10-012'
ms:contentKeyID: 61237851
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-012(v=Security.10)'
---
...
对于管理员、企业安装或者想要手动安装此安全更新的最终用户，Microsoft 建议客户尽早应用此更新来更新管理软件或者利用 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 服务检查更新。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=267ce982-54a0-418f-ad52-e4963610f714)                                                                           | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=8f7adee3-e68e-41b3-b835-d84691774f31)                                                          | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=91ee57f2-81e5-49bd-bdfc-d3e385efc8a5)                                                              | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3d18cbc4-ac48-458c-8aa3-90708fd854ff)                                                                              | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7d63c95e-311a-446f-8852-dffd217a89f6)                                                                  | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=ee7f8cc4-f7fd-4dc7-808c-436204ee80cb)                                                              | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=16494dac-553a-4de9-b751-0d6b51cb43f0)                                     | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cec582b3-e37f-448e-a5c3-6abdcee9e57c) | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=597b2310-2cd8-4d0f-8248-781eb8b7450a)\*                   | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=67119fb6-e517-46f4-ab0b-2351cdc3d670)\*         | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f90fc0c8-babe-4224-be07-614ea7ddf102)   | 远程执行代码 | 重要         | [MS09-001](http://go.microsoft.com/fwlink/?linkid=132991) |
| [Windows 7（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=122fc003-0651-4ad2-a5c8-a21536defad8)                                                                                     | 远程执行代码 | 重要         | 无                                                        |
| [Windows 7（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=3e096468-db6c-45c6-bee5-eaeaa63500b5)                                                                                | 远程执行代码 | 重要         | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=dc757b6d-f0f8-4e71-ab6f-1417233eedf9)\*                                                                 | 远程执行代码 | 重要         | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=d5b0b1eb-24f3-47ec-aba1-c1b95400189e)                                                               | 远程执行代码 | 重要         | 无                                                        |
...
否。 Microsoft 安全公告 [MS10-006](http://go.microsoft.com/fwlink/?linkid=178850)“SMB 客户端中的漏洞可能允许远程执行代码”解决了不同的 SMB 组件。 此安全更新可独立于任何其他更新进行应用。

**如果我已经安装了 MS10-006 更新，还需要安装此更新吗？**  
是。 此安全公告更新解决了 Windows SMB 服务器组件中的漏洞，而 [MS10-006](http://go.microsoft.com/fwlink/?linkid=178850) 解决了 Windows SMB 客户端组件中的漏洞。
...
<tr class="header">
<th>受影响的软件</th>
<th>SMB 路径名溢出漏洞 - CVE-2010-0020</th>
<th>SMB 内存损坏漏洞 - CVE-2010-0021</th>
<th>SMB 空指针漏洞 - CVE-2010-022</th>
<th>SMB NTLM 身份验证缺少平均信息量漏洞 - CVE-2010-0231</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0020](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0020)。
...
SMB 内存损坏漏洞 - CVE-2010-0021  
--------------------------------
  
   
Microsoft 服务器消息块 (SMB) 协议软件处理特制 SMB 数据包的方式中存在一个拒绝服务漏洞。 利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过向运行 Server 服务的计算机发送特制网络消息来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0021](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0021)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0022)。
...
-   **禁用 SMB v2**
    ...
    **注意** 要使用自动化“**Microsoft 修复**”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 975517](http://support.microsoft.com/kb/975517)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0022)。
  
**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。
  
SMB NTLM 身份验证缺少平均信息量漏洞 - CVE-2010-0231  
---------------------------------------------------
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0231](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0231)。
...
| **部署**                         |                                                                                                                       |  
| 没有用户干预的安装               | Windows2000-KB971468-x86-enu /quiet                                                                                   |  
| 在不重新启动的情况下安装         | Windows2000-KB971468-x86-enu /norestart                                                                               |  
| 更新日志文件                     | KB971468.log                                                                                                          |  
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 971468](http://support.microsoft.com/kb/971468)                                          |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971468\\Filelist                             |
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB971468$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/971468">Microsoft 知识库文章 971468</a></td>
</tr>  
<tr class="even">
...
-   [Codenomicon](http://www.codenomicon.com/) 的 Joshua Morin 报告了 SMB 路径名溢出漏洞 (CVE-2010-0020)  
-   [BSI](http://www.bsi.bund.de/) 的 Florian Rienhardt 报告了 SMB 内存损坏漏洞 (CVE-2010-0021)  

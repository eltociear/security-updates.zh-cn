---
TOCTitle: 'MS10-080'
Title: 'Microsoft 安全公告 MS10-080 - 重要'
ms:assetid: 'ms10-080'
ms:contentKeyID: 61237919
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms10-080(v=Security.10)'
---



Microsoft 安全公告 MS10-080 - 重要
==================================

Microsoft Excel 中的漏洞可能允许远程执行代码 (2293211)
------------------------------------------------------
...
对于以下软件，此安全更新的等级为“重要”：Microsoft Excel 2002、Microsoft Excel 2003、Microsoft Excel 2007、Microsoft Office 2004 for Mac 和 Microsoft Office 2008 for Mac 的所有受支持版本；Open XML File Format Converter for Mac；Microsoft Office Excel Viewer 和 Microsoft Office Compatibility Pack 的所有受支持版本。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此更新通过更改 Microsoft Office Excel 分析特制 Excel 文件和特制 Lotus 1-2-3 文件的方式来消除这些漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。

**建议。** Microsoft 建议客户尽早应用此更新。

**已知问题。** [Microsoft 知识库文章 2293211](http://support.microsoft.com/kb/2293211) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<sup>[1]</sup>对于 Microsoft Excel 2007 Service Pack 2，除了安全更新程序包 KB2345035 之外，客户还需要安装用于 Word、Excel 和 PowerPoint 2007 文件格式 Service Pack 2 的 Microsoft Office 兼容包的安全更新 (KB2344875)，以免受本公告中所描述的漏洞影响。
...
**MS10-079** **还描述了** **Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac** **和** **Open XML File Format Converter for Mac** **中的漏洞。** **MS10-079** **与此公告** **(MS10-080)** **有何关联？**  
此公告 MS10-080 中的 Microsoft Office 2004 for Mac (KB2422343)、Microsoft Office 2008 for Mac (KB2422352) 和 Open XML File Format Converter for Mac (KB2422398) 安全更新程序包还解决了 MS10-079 中描述的漏洞。安装了 Microsoft Office 2004 for Mac、Microsoft Office 2008 for Mac 或 Open XML File Format Converter for Mac 的用户只需安装这些安全更新程序包一次。
...
<th style="border:1px solid black;">
Excel 记录分析整数溢出漏洞 - CVE-2010-3230
</th>
<th style="border:1px solid black;">
Excel 记录分析内存损坏漏洞 - CVE-2010-3231
</th>
<th style="border:1px solid black;">
Excel 文件格式分析漏洞 - CVE-2010-3232
</th>
<th style="border:1px solid black;">
Lotus 1-2-3 工作簿分析漏洞 - CVE-2010-3233
</th>
<th style="border:1px solid black;">
公式子流内存损坏漏洞 - CVE-2010-3234
</th>
<th style="border:1px solid black;">
公式 Biff 记录漏洞 - CVE-2010-3235
</th>
<th style="border:1px solid black;">
溢出数组漏洞 - CVE-2010-3236
</th>
<th style="border:1px solid black;">
</th>
<th style="border:1px solid black;">
...
<th style="border:1px solid black;">
合并单元格记录指针漏洞 - CVE-2010-3237
</th>
<th style="border:1px solid black;">
负值未来函数漏洞 - CVE-2010-3238
</th>
<th style="border:1px solid black;">
额外超出边界记录分析漏洞 - CVE-2010-3239
</th>
<th style="border:1px solid black;">
实时数据数组记录漏洞 - CVE-2010-3240
</th>
<th style="border:1px solid black;">
溢出内存写入分析漏洞 - CVE-2010-3241
</th>
<th style="border:1px solid black;">
Ghost 记录类型分析漏洞 - CVE-2010-3242
</th>
<th style="border:1px solid black;">
综合严重等级
</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3230](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3230)。

#### Excel 记录分析整数溢出漏洞 (CVE-2010-3230) 的缓解因素
...
#### Excel 记录分析整数溢出漏洞 (CVE-2010-3230) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **不要打开不受信任来源中的** **Microsoft Office** **文件**

    不要打开或保存从不受信任来源或从受信任来源意外收到的 Microsoft Office 文件。 当用户打开特制文件时，攻击者可以利用此漏洞。

#### Excel 记录分析整数溢出漏洞 (CVE-2010-3230) 的常见问题
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 验证记录信息的方式来消除此漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3231](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3231)。

#### Excel 记录分析内存损坏漏洞 (CVE-2010-3231) 的缓解因素
...
#### Excel 记录分析内存损坏漏洞 (CVE-2010-3231) 的变通办法
...
#### Excel 记录分析内存损坏漏洞 (CVE-2010-3231) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3232](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3232)。

#### Excel 文件格式分析漏洞 (CVE-2010-3232) 的缓解因素
...
#### Excel 文件格式分析漏洞 (CVE-2010-3232) 的变通办法
...
-   **使用** **Microsoft Office** **文件阻止策略禁止打开来自未知或不可信来源和位置的** **Office 2003** **以及较早版本的文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](http://support.microsoft.com/kb/922848) 所述配置特殊“例外目录”的用户在 Office 2003 或 Office 2007 中无法打开 Office 2003 文件或更早版本。
...
-   **当打开来自未知来源或不可信来源的文件时使用** **Microsoft Office Isolated Conversion Environment (MOICE)**
    ...
    **注意** 要使用自动化“**Microsoft** **修复**”解决方案来启用或禁用此变通办法，请参阅 Microsoft 知识库文章 935865。
...
#### Excel 文件格式分析漏洞 (CVE-2010-3232) 的常见问题
...
Microsoft Excel 处理特制 Lotus 1-2-3 工作簿文件 (.wk3) 的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3233](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3233)。

#### Lotus 1-2-3 工作簿分析漏洞 (CVE-2010-3233) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助。

-   此漏洞无法通过电子邮件自动加以利用。 用户必须打开电子邮件附件，以电子邮件为载体的攻击才会得逞。
-   成功利用此漏洞的攻击者可以获得与本地用户相同的用户权限。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。
-   在基于 Web 的攻击情形中，攻击者可能拥有一个网站，并在上面放置用来利用此漏洞的网页。 另外，接受或宿主用户提供的内容或广告的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 但是在所有情况下，攻击者无法强制用户访问这些网站。 相反，攻击者必须诱使用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站，然后诱使他们打开特制的 Lotus 1-2-3 文件。

#### Lotus 1-2-3 工作簿分析漏洞 (CVE-2010-3233) 的变通办法
...
#### Lotus 1-2-3 工作簿分析漏洞 (CVE-2010-3233) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
当 Microsoft Excel 分析特制的 Lotus 1-2-3 文件时，它可能以一种攻击者可以执行任意代码的方式来破坏系统内存。

**此漏洞在** **Microsoft Excel 2003 Service Pack 3** **上的等级为何是“中等”？**  
默认情况下，阻止在 Microsoft Excel 2003 Service Pack 3 中打开 Lotus 1-2-3 文件。此缓解因素降低了 CVE-2010-3233 在 Microsoft Excel 2003 Service Pack 3 上的严重等级。有关安装 Microsoft Office 2003 Service Pack 3 后被阻止的文件类型的详细信息，请参阅 [Microsoft 知识库文章 938810](http://support.microsoft.com/kb/938810/)。

**攻击者可能利用此漏洞执行什么操作？**  
成功利用此漏洞的攻击者可能以登录用户的身份运行任意代码。 如果用户使用管理用户权限登录，攻击者便可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

**攻击者如何利用此漏洞？**  
此漏洞需要用户打开受影响的 Microsoft Excel 版本的特制 Lotus 1-2-3 文件才能利用。

在电子邮件攻击情形中，攻击者可以通过向用户发送特制的 Lotus 1-2-3 文件并诱使用户打开该文件来利用此漏洞。

在基于 Web 的攻击情形中，攻击者必须拥有一个网站，其中包含用来试图利用此漏洞的 Lotus 1-2-3 文件。 另外，接受或宿主用户提供的内容的网站以及受到破坏的网站可能包含可能利用此漏洞的特制内容。 攻击者无法强迫用户访问特制的网站。 相反，攻击者必须诱使他们访问该网站，通常是让其单击指向攻击者网站的链接，然后诱使他们打开特制的 Lotus 1-2-3 文件。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3234](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3234)。

#### 公式子流内存损坏漏洞 (CVE-2010-3234) 的缓解因素
...
#### 公式子流内存损坏漏洞 (CVE-2010-3234) 的变通办法
...
#### 公式子流内存损坏漏洞 (CVE-2010-3234) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
当 Microsoft Excel 在打开特制 Excel 文件后验证公式信息时，内存处理错误可能会以攻击者可以执行任意代码的方式来损坏系统内存。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 验证公式信息的方式来消除此漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3235](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3235)。

#### 公式 Biff 记录漏洞 (CVE-2010-3235) 的缓解因素
...
#### 公式 Biff 记录漏洞 (CVE-2010-3235) 的变通办法
...
#### 公式 Biff 记录漏洞 (CVE-2010-3235) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3236](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3236)。

#### 溢出数组漏洞 (CVE-2010-3236) 的缓解因素
...
-   **使用** **Microsoft Office** **文件阻止策略禁止打开来自未知或不可信来源和位置的** **Office 2003** **以及较早版本的文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](http://support.microsoft.com/kb/922848) 所述配置特殊“例外目录”的用户在 Office 2003 中无法打开 Office 2003 文件或更早版本。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3237](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3237)。

#### 合并单元格记录指针漏洞 (CVE-2010-3237) 的缓解因素
...
#### 合并单元格记录指针漏洞 (CVE-2010-3237) 的变通办法
...
#### 合并单元格记录指针漏洞 (CVE-2010-3237) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3238](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3238)。

#### 负值未来函数漏洞 (CVE-2010-3238) 的缓解因素
...
#### 负值未来函数漏洞 (CVE-2010-3238) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全远程控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
当 Microsoft Excel 在打开特制 Excel 文件后验证二进制文件格式信息时，内存处理错误可能会以攻击者可以执行任意代码的方式来损坏系统内存。
...
**此更新有什么作用？**  
此更新通过修改 Microsoft Excel 验证二进制文件格式信息的方式来消除此漏洞。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3239](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3239)。

#### 额外超出边界记录分析漏洞 (CVE-2010-3239) 的缓解因素
...
#### 额外超出边界记录分析漏洞 (CVE-2010-3239) 的变通办法
...
#### 额外超出边界记录分析漏洞 (CVE-2010-3239) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3240](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3240)。

#### 实时数据数组记录漏洞 (CVE-2010-3240) 的缓解因素
...
#### 实时数据数组记录漏洞 (CVE-2010-3240) 的变通办法
...
-   **使用** **Microsoft Office** **文件阻止策略禁止打开来自未知或不可信来源和位置的** **Office 2003** **以及较早版本的文档**
    ...
    **变通办法的影响。** 配置了文件阻止策略但是尚未按照 [Microsoft 知识库文章 922848](http://support.microsoft.com/kb/922848) 所述配置特殊“例外目录”的用户在 Office 2007 中无法打开 Office 2003 文件或更早版本。
...
#### 实时数据数组记录漏洞 (CVE-2010-3240) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3241](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3241)。

#### 溢出内存写入分析漏洞 (CVE-2010-3241) 的缓解因素
...
#### 溢出内存写入分析漏洞 (CVE-2010-3241) 的变通办法
...
#### 溢出内存写入分析漏洞 (CVE-2010-3241) 的常见问题
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3242](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3242)。

#### Ghost 记录类型分析漏洞 (CVE-2010-3242) 的缓解因素
...
#### Ghost 记录类型分析漏洞 (CVE-2010-3242) 的变通办法
...
#### Ghost 记录类型分析漏洞 (CVE-2010-3242) 的常见问题
...
| Microsoft Excel Viewer Service Pack 2                                                  | 否      | 否                  | 是                  | 是                         |
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2345017">Microsoft 知识库文章 2345017</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2344893">Microsoft 知识库文章 2344893</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
#### Excel 2007（所有版本）和 Excel Viewer（所有版本）
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2007，请参阅 <a href="http://support.microsoft.com/kb/2345035">Microsoft 知识库文章 2345035</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Excel Viewer，请参阅 <a href="http://support.microsoft.com/kb/2345088">Microsoft 知识库文章 2345088</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于用于 Word、Excel 和 PowerPoint 2007 文件格式的 Microsoft Office 兼容包，请参阅 <a href="http://support.microsoft.com/kb/2344875">Microsoft 知识库文章 2344875</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Secunia](http://secunia.com/) 的 Alin Rad Pop 报告了 Excel 记录分析整数溢出漏洞 (CVE-2010-3230)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了 Excel 记录分析内存损坏漏洞 (CVE-2010-3231)  
-   Omair 报告了 Excel 文件格式分析漏洞 (CVE-2010-3232)  
-   [Secunia](http://secunia.com/) 的 Carsten H. Eiram 报告了 Lotus 1-2-3 工作簿分析漏洞 (CVE-2010-3233)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了公式子流内存损坏漏洞 (CVE-2010-3234)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了公式 Biff 记录漏洞 (CVE-2010-3235)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了溢出数组漏洞 (CVE-2010-3236)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了合并单元格记录指针漏洞 (CVE-2010-3237)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了负值未来函数漏洞 (CVE-2010-3238)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了额外超出边界记录分析漏洞 (CVE-2010-3239)  
-   [Secunia](http://secunia.com/)的 Alin Rad Pop 报告了额外超出边界记录分析漏洞 (CVE-2010-3239)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了实时数据数组记录漏洞 (CVE-2010-3240)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了溢出内存写入分析漏洞 (CVE-2010-3241)  
-   [VUPEN Vulnerability Research Team](http://www.vupen.com/) 的 Chaouki Bekrar 报告了 Ghost 记录类型分析漏洞 (CVE-2010-3242)  
-   [Secunia](http://secunia.com/) 的 Carsten H. Eiram 报告了 Ghost 记录类型分析漏洞 (CVE-2010-3242)

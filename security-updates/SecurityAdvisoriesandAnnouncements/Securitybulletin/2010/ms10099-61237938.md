...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=4d0ae558-a4f2-4048-b5fd-ba072ca35e48)                          | 特权提升     | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=238bb885-eae6-464a-bb3d-679025f1cb50) | 特权提升     | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c87af292-a068-4089-aab8-115c18b4b024)                 | 特权提升     | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e17b8878-d065-49cc-bdba-0f24cdf35ea3)     | 特权提升     | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=ad896d80-167f-4e8f-a448-cac93516f4d0) | 特权提升     | 重要         | 无               |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3963](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3963)。
...
**什么是 NDProxy？**    
NDPROXY 是一个系统提供的驱动程序，它将 WAN 小型端口驱动程序、调用管理程序和小型端口调用管理程序连接到电话服务应用程序接口 (TAPI) 服务。 有关其他信息，请参阅 MSDN 文章 [NDPROXY 概述](http://msdn.microsoft.com/en-us/library/ff568322(vs.85).aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2440591">Microsoft 知识库文章 2440591</a></td>
</tr>  
<tr class="even">
...
-   [Fortinet's FortiGuard Labs](http://www.fortiguard.com/) 的 Honggang Ren 报告了内核 NDProxy 缓冲区溢出漏洞 (CVE-2010-3963)

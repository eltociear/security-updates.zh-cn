...
此安全更新也解决了 [Microsoft 安全通报 981374](http://technet.microsoft.com/security/advisory/981374) 中最初描述的漏洞。漏洞 [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806) 不会影响 Windows 7、Windows Server 2008 R2 或 Internet Explorer 8。
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 980182](http://support.microsoft.com/kb/980182) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-026](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0267)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0488](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0488)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0489](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0489)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0490](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0490)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0491](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0491)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0492](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0492)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0494](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0494)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0805](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0805)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806)。
...
-   **使用自动化 Microsoft Fix It 为 Internet Explorer 启用 DEP**
    ...
    要使用自动 Microsoft Fix it 解决方案启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 980182](http://support.microsoft.com/kb/980182)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-0806](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0806)。[Microsoft 安全通报 981374](http://technet.microsoft.com/security/advisory/981374) 中介绍了该漏洞。

**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
是。 Microsoft 获悉尝试利用该漏洞的有限攻击。

**如果我应用了通报 981374 中提供的变通办法，是否需要在应用此更新之前撤消该变通办法？**  
如果应用了 [Microsoft 安全通报 981374](http://technet.microsoft.com/security/advisory/981374) 中提供的变通办法，您需要通过按照说明撤消“未初始化的内存损坏漏洞 (CVE-2010-0806) 的变通办法”一节中提供的变通办法来撤消该变通办法。如果使用 [Microsoft 安全通报 981374](http://technet.microsoft.com/security/advisory/981374) 中提供的“启用此修复”功能应用了 iepeers.dll 或 DEP 变通变法，您可以通过为 [Microsoft 知识库文章 980182](http://support.microsoft.com/kb/980182) 中的这些变通办法选择“禁用此修复”选项来撤消该变通办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0807](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0807)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/980182">Microsoft 知识库文章 980182</a></td>
</tr>  
<tr class="even">
...
-   [Secunia](http://secunia.com) 与我们一起处理了未初始化的内存损坏漏洞 (CVE-2010-0267)  
-   [Cyber Defense Institute Inc.](http://www.cyberdefense.jp/) 的 Daiki Fukumori 报告了 Post 编码信息泄露漏洞 (CVE-2010-0488)  
-   [Red Database Security](http://www.red-database-security.com/) 的 Alexander Kornbrust 报告了未初始化的内存损坏漏洞 (CVE-2010-0490)  
-   [iSIGHT Partners](http://www.isightpartners.com/) Global Vulnerability Partnership 的 Ivan Fratric 报告了未初始化的内存损坏漏洞 (CVE-2010-0490)  
-   [team509](http://www.team509.com/) 的 Wushi 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 HTML 对象内存损坏漏洞 (CVE-2010-0491)  
-   Simon Zuckerbraun 与 [TippingPoint 的](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 HTML 对象内存损坏漏洞 (CVE-2010-0492)  
-   [Context Information Security](http://www.contextis.co.uk/) 的 Paul Stone 报告了 HTML 元素跨域漏洞 (CVE-2010-0494)  
-   一名匿名研究员与 [TippingPoint 的](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了内存损坏漏洞 (CVE-2010-0805)  
-   [VenusTech](http://www.venustech.com.cn/) 的 ADLab 报告了未初始化的内存损坏漏洞 (CVE-2010-0806)  
-   [VenusTech](http://www.venustech.com.cn/) 的 ADLab 报告了 HTML 呈现内存损坏漏洞 (CVE-2010-0807)

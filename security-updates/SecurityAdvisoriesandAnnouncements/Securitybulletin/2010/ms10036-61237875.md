...
**已知问题。** [Microsoft 知识库文章 983235](http://support.microsoft.com/kb/983235) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
Microsoft 为安装了 Office XP 的 Windows XP 系统的用户提供 **Microsoft Fix it** 解决方案。 虽然这不是 Office 产品本身的代码修复，但是 **Microsoft Fix it** 解决方案提供防止此公告中所述漏洞的类似保护。 虽然应用程序兼容性风险降到最低，但是 Microsoft 建议用户在广泛地分布它之前测试此 **Microsoft Fix it** 解决方案。 有关下载位置和其他详细信息，请参阅 [Microsoft 知识库文章 983235](http://support.microsoft.com/kb/983235)。
...
此公告 MS10-036 中的 Microsoft Office Excel 2003 (KB982133) 和 Microsoft Office Excel 2007 (KB982308) 安全更新包还解决了 [MS10-038](http://go.microsoft.com/fwlink/?linkid=191053) 中描述的漏洞。安装了Microsoft Office Excel 2003 或 Microsoft Office Excel 2007 的用户只需安装这些安全更新包一次。 用户还必须安装此公告中提供相关 Microsoft Office 更新（KB982311 或 KB982312），才能免遭此公告 MS10-036 中描述的漏洞的攻击。

**此更新是否包含任何其他与安全性无关的功能更改？**  
此更新包含与安全性无关的功能更改。 有关详细信息，请参阅 [Microsoft 知识库文章 983632](http://support.microsoft.com/kb/983632)。
...
该缓解措施解决 [Microsoft 安全通报 (973882)](http://technet.microsoft.com/security/advisory/973882)和 [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) 中描述的 ATL 漏洞。该更改在默认情况下对所有受影响的平台启用，并将帮助防止 Microsoft Office 中加载的控件的 ATL 漏洞，包括不是由 Microsoft 创建的控件。
...
<td style="border:1px solid black;">Microsoft Office 2003 Service Pack 3：<br />
请参阅 <a href="http://support.microsoft.com/kb/982311">Microsoft 知识库文章 982311</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2003 Service Pack 3：<br />
请参阅 <a href="http://support.microsoft.com/kb/982133">Microsoft 知识库文章 982133</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2003 Service Pack 3：<br />
请参阅 <a href="http://support.microsoft.com/kb/982157">Microsoft 知识库文章 982157</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2003 Service Pack 3：<br />
请参阅 <a href="http://support.microsoft.com/kb/982122">Microsoft 知识库文章 982122</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2003 Service Pack 3：<br />
请参阅 <a href="http://support.microsoft.com/kb/982126">Microsoft 知识库文章 982126</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2003 Service Pack 3：<br />
请参阅 <a href="http://support.microsoft.com/kb/982134">Microsoft 知识库文章 982134</a></td>
</tr>
<tr class="odd">
...
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 2007 Microsoft Office System Service Pack 1 和 2007 Microsoft Office System Service Pack 2：<br />
请参阅 <a href="http://support.microsoft.com/kb/982312">Microsoft 知识库文章 982312</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Excel 2007 Service Pack 1 和 Microsoft Office Excel 2007 Service Pack 2：<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office PowerPoint 2007 Service Pack 1 和 Microsoft Office PowerPoint 2007 Service Pack 2：<br />
请参阅 <a href="http://support.microsoft.com/kb/982158">Microsoft 知识库文章 982158</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Publisher 2007 Service Pack 1 和 Microsoft Office Publisher 2007 Service Pack 2：<br />
请参阅 <a href="http://support.microsoft.com/kb/982124">Microsoft 知识库文章 982124</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Visio 2007 Service Pack 1 和 Microsoft Office Visio 2007 Service Pack 2：<br />
请参阅 <a href="http://support.microsoft.com/kb/982127">Microsoft 知识库文章 982127</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Microsoft Office Word 2007 Service Pack 1 和 Microsoft Office Word 2007 Service Pack 2：<br />
请参阅 <a href="http://support.microsoft.com/kb/982135">Microsoft 知识库文章 982135</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [IBM ISS X-Force](http://www.iss.net/) 的 David Dewey 和 [Accuvant](http://www.accuvant.com/)（以前称 [VeriSign iDefense Labs](http://labs.idefense.com/)）的 Ryan Smith 与我们合作处理此公告中解决的纵深防御更改。

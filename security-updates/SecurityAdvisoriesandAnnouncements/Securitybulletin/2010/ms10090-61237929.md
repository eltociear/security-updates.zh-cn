...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3346](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3346)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3348](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3348](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3348)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962)。
...
-   **使用用户定义的样式表覆盖网站** **CSS**
    ...
    **变通办法的影响。** 应用用户定义的 CSS 可能导致网站样式表出现问题。 如果您以前应用过此变通办法，在应用此安全更新之前必须撤消此变通办法。 使用 [Microsoft 知识库文章 2458511](http://support.microsoft.com/kb/2458511)中的自动化“**Microsoft** **修复**”解决方案以禁用此变通办法。
    ...
    **使用自动化“Microsoft** **修复”解决方案应用更改**
    ...
    要使用自动化“**Microsoft** **修复**”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 2458511](http://support.microsoft.com/kb/2458511)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962)。此漏洞最初是在 [Microsoft 安全通报 2458511](http://technet.microsoft.com/security/advisory/2458511) 中介绍的。

**在发布此安全公告时，Microsoft** **是否收到任何有关此漏洞已被利用的报告？**  
是。 Microsoft 获悉尝试利用此漏洞的主动攻击。

**应用此安全更新有助于客户防止尝试利用此漏洞的已公开发布代码吗？**  
是。 此安全更新可消除目前被利用的漏洞。 已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2010-3962](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3962)。

**如果我应用了**[**Microsoft** **安全通报** **2458511**](http://technet.microsoft.com/security/advisory/2458511)**中提供的变通办法，是否需要在应用此更新之前撤消变通办法？**  
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2416400">Microsoft 知识库文章 2416400</a></td>
</tr>  
<tr class="even">
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Aniway 报告了 HTML 对象内存损坏漏洞 (CVE-2010-3340)  
-   [VUPEN 漏洞调查小组](http://www.vupen.com/)的 Nicolas Joly 报告了 HTML 对象内存损坏漏洞 (CVE-2010-3343)  
-   Stephen Fewer 与 [TippingPoint 的](http://www.tippingpoint.com/) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 HTML 元素内存损坏漏洞 (CVE-2010-3345)  
-   [Peter Vreugdenhil](http://vreugdenhilresearch.nl/) 与 [TippingPoint](http://www.tippingpoint.com/)的 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 HTML 元素内存损坏漏洞 (CVE-2010-3346)  
-   [AZIA CO., LTD.](http://www.azia.jp) 的 Masatoshi Sato 报告了跨域信息泄露漏洞 (CVE-2010-3348)  
-   [Yosuke Hasegawa](http://utf-8.jp) 与我们一起努力处理了跨域信息泄露漏洞 (CVE-2010-3348)  
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Jose Antonio Vazquez Gonzalez 报告了未初始化的内存损坏漏洞 (CVE-2010-3962)

...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9dc3e1c2-2e9d-4d86-9fce-446c409ad613)                                                          | 欺骗         | 中等         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d872bd77-f491-4706-8ff5-081ac0bf3d6f)                                                              | 欺骗         | 中等         | 无               |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd007a6c-04b3-490c-aff4-d5af3e69d477)                                                                              | 欺骗         | 中等         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=19cfddfe-e8da-4564-9730-babfae4a3ebb)                                                                  | 欺骗         | 中等         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=916f1b09-e79e-4347-9fbc-c0cf07de397d)                                                              | 欺骗         | 中等         | 无               |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=196055a6-15d1-4da8-b33d-501e69bf5176)                                     | 欺骗         | 中等         | 无               |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c1d1622-1b67-438d-aae4-1a3954974a36) | 欺骗         | 中等         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=61ece7bc-e9fa-4ede-ba7d-9e5a4c64b9be)\*                   | 欺骗         | 中等         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=72e7c7ea-55ef-457b-a03a-49aa9dea2e84)\*         | 欺骗         | 中等         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8c48302c-a1d6-41bc-ad24-7ce7332d4842)   | 欺骗         | 中等         | 无               |

**\*服务器核心安装受到影响。** 此更新适用于所示 Windows Server 2008 的受支持版本（无论是否使用“服务器核心”安装选项进行安装），严重等级相同。 有关该安装选项的详细信息，请参阅 MSDN 文章，[服务器核心](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)。 注意，“服务器核心”安装选项不适用于某些 Windows Server 2008 版本；请参阅[比较“服务器核心”安装选项](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)。
...
-   **ISATAP 客户端上的潜在路由器列表 (PRL)：** PRL 使客户能够对传入的 ISATAP 隧道传输数据包执行源地址检查。 默认情况下，一旦安装此安全更新，PRL 就处于启用状态，可帮助解决 CVE-2010-0812 中描述的 ISATAP IPv6 源地址欺骗漏洞。有关 PRL 的详细信息，您可以在 [Microsoft 知识库文章 978338](http://support.microsoft.com/kb/978338) 中找到。
-   **ISATAP 接口上的邻居不可达检测 (NUD)：** NUD 用于验证是否可以到达附近的设备。 在发送 ISATAP 数据包之前，ISATAP 节点会执行 NUD。 默认情况下，NUD 处于禁用状态，需要由网络管理员手动配置。 有关 NUD 和如何启用它的详细信息，您可以在 [Microsoft 知识库文章 978338](http://support.microsoft.com/kb/978338) 中找到。
...
**注意** 默认情况下，虽然 PRL 在这些平台上已启用，但 NUD 仍处于禁用状态，它必须由网络管理员手动配置。 有关此功能的其他信息，请查阅 [Microsoft 知识库文章 978338](http://support.microsoft.com/kb/978338)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-0812](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-0812)。
...
**什么是 ISATAP？**    
站内自动隧道寻址协议 (ISATAP) 提供 IPv4 Intranet 内的 IPv6 连接。 有关 ISATAP 的信息，请参阅 [RFC5214： 站内自动隧道寻址协议 (ISATAP)](http://www.ietf.org/rfc/rfc5214.txt)，ISATAP 协议定义为协议类型 41。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/978338">Microsoft 知识库文章 978338</a></td>
</tr>  
<tr class="even">

...
**已知问题。** [Microsoft 知识库文章 2292970](http://support.microsoft.com/kb/2292970) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。 在当前已知问题和建议解决办法仅适用于此软件的特定版本时，此文章还提供其他文章的链接。
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=99e18990-75e9-497e-9b4f-5d7ef8656ab2">Microsoft Publisher 2010（32 位版本）</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=9b27ee11-e563-4152-9691-25eec1ee9966">Microsoft Publisher 2010（64 位版本）</a><br />
(KB2409055)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;">无</td>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2569](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2569)。
  
#### pubconv.dll 中的大小值堆损坏漏洞 (CVE-2010-2569) 的缓解因素
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2570](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2570)。
...
Pubconv.dll 中由于索引到数组无效而导致的内存损坏漏洞 - CVE-2010-2571  
--------------------------------------------------------------------
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-2571](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-2571)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3954](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3954)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3955](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3955)。
...
管理需要部署到组织中的服务器、台式机和移动系统的软件和安全更新。 有关详细信息，请参阅 [TechNet 更新管理中心](http://go.microsoft.com/fwlink/?linkid=69903)。 Microsoft TechNet 安全网站提供了有关 Microsoft 产品安全的详细信息。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2284692">Microsoft 知识库文章 2284692</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2284695">Microsoft 知识库文章 2284695</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2284697">Microsoft 知识库文章 2284697</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2409055">Microsoft 知识库文章 2409055</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [VUPEN 漏洞调查小组](http://www.vupen.com/)的 Chaouki Bekrar 报告了 pubconv.dll 中的大小值堆损坏漏洞 (CVE-2010-2569)  
-   [VUPEN 漏洞调查小组](http://www.vupen.com/)的 Chaouki Bekrar 报告了 pubconv.dll 中的堆溢出漏洞 (CVE-2010-2570)  
-   [VUPEN 漏洞调查小组](http://www.vupen.com/)的 Chaouki Bekrar 报告了 Pubconv.dll 中由于索引到数组无效而导致的内存损坏漏洞 (CVE-2010-2571)  
-   [VUPEN 漏洞调查小组](http://www.vupen.com/)的 Chaouki Bekrar 报告了 Microsoft Publisher 内存损坏漏洞 (CVE-2010-3954)  
-   [VUPEN 漏洞调查小组](http://www.vupen.com/)的 Chaouki Bekrar 报告了数组索引内存损坏漏洞 (CVE-2010-3955)

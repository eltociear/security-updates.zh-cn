...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6049c879-b81a-4d10-b96b-b2837cb24834)                          | 特权提升     | 重要         | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d690846c-5e0b-4216-84cd-d17e366dd16d) | 特权提升     | 重要         | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b31e18b0-da9f-4b3b-82c6-603e08b3b241)                 | 特权提升     | 重要         | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d73f0f1-6ec8-4304-a20e-345d8b6c225a)     | 特权提升     | 重要         | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=8fad4f77-7c89-4684-b957-9c00ced248d3) | 特权提升     | 重要         | [MS10-066](http://go.microsoft.com/fwlink/?linkid=197105) |
...
<tr class="header">
<th>受影响的软件</th>
<th>LPC 消息缓冲区溢出漏洞 - CVE-2010-3222</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
<tr class="odd">
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=?...?">Windows Server 2003 SP2（用于基于 Itanium 的系统）</a></td>
<td style="border:1px solid black;"><strong>重要</strong> <br />
特权提升</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>  
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222)。
...
**什么是 RPC？**  
远程过程调用 (RPC) 是一种进程间的通信机制 (IPC)，该机制可以实现不同过程中的数据交换和功能调用。 该过程可以在同一台计算机、局域网 (LAN) 或 Internet 上进行。 Microsoft RPC 机制使用其他 IPC 机制（如命名管道、NetBIOS 或 Winsock）在客户端和服务器之间建立通信。 利用 RPC，重要的程序逻辑和相关过程代码可以存在于不同的计算机上，这对分布式应用程序非常重要。 有关详细信息，请参阅 TechNet 文章，[什么是 RPC？](http://technet.microsoft.com/en-us/library/cc787851(ws.10).aspx)
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3222](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3222)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2360937">Microsoft 知识库文章 2360937</a></td>
</tr>  
<tr class="even">

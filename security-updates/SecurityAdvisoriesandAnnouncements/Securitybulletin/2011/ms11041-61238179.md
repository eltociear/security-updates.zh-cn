...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=035d5115-54b6-41d3-b9f0-890041ead178)                                                                  | 特权提升     | 重要         | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4aa8c003-0353-4a5b-8aea-c01a103af393)                                                                      | 特权提升     | 重要         | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=2e07b5fa-c9fa-495b-9352-c07ce46a7e8b)                                                                  | 特权提升     | 重要         | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a519a5d7-bfe3-4e53-99e9-d85f7e34237f)                                | 远程执行代码 | 严重         | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=cd8f3713-b408-4db6-aecd-7eed2176a715)\*             | 远程执行代码 | 严重         | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a61f888-c81e-4b8a-8932-2fe67df4b2ad)       | 远程执行代码 | 严重         | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=e7f52b13-5b3d-438c-ae14-86da50c8b67a)                                   | 远程执行代码 | 严重         | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b77e5be6-d3eb-4e3a-9be2-831578f0447c)\*       | 远程执行代码 | 严重         | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c00a33bc-c874-4693-b0f7-5034c5df9424) | 远程执行代码 | 严重         | [MS11-034](http://go.microsoft.com/fwlink/?linkid=211826) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1873](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1873)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2525694">Microsoft 知识库文章 2525694</a></td>
</tr>  
<tr class="odd">
...
-   [www.korosoft.net](http://www.korosoft.net/) 的 Koro 报告了 Win32k OTF 验证漏洞 (CVE-2011-1873)

...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010（32 位版本）](http://www.microsoft.com/downloads/details.aspx?familyid=3c8fd04a-9df6-4726-a9bc-811f49665981)  
(KB2584066)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1（32 位版本）](http://www.microsoft.com/downloads/details.aspx?familyid=3c8fd04a-9df6-4726-a9bc-811f49665981)  
(KB2584066)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[Microsoft Office 2010（64 位版本）](http://www.microsoft.com/downloads/details.aspx?familyid=85360dc1-99e7-4e3e-be6f-3795e8a8122f)  
(KB2584066)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Microsoft Office 2010 Service Pack 1（64 位版本）](http://www.microsoft.com/downloads/details.aspx?familyid=85360dc1-99e7-4e3e-be6f-3795e8a8122f)  
(KB2584066)
</td>
<td style="border:1px solid black;">
远程执行代码
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1980](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1980)。
...
-   **禁用从 WebDAV 和远程网络共享中加载库**
    ...
    **意** 参见 [Microsoft 知识库文章 2264107](http://support.microsoft.com/kb/2264107) 以部署一个变通办法工具，使客户能够禁用从远程网络或 WebDAV 共享加载库。可以配置该工具以禁止通过每个应用程序或全局系统进行非安全加载。
...
Office 文件验证是 Office 2003 和 2007 的安全加载项。Office 文件验证用于验证二进制文件格式文件是否符合 Microsoft Office 文件格式。如果用户不符合格式，则将向用户通知可能的安全风险。可以在[知识库文章 2501584](http://support.microsoft.com/kb/2501584) 中找到有关此加载项的更多信息。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1982](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1982)。
...
**注意** 对于使用不受最新版本的 MBSA、Microsoft Update 和 Windows Server Update Services 支持的旧版软件的客户，请访问 [Microsoft Baseline Security Analyzer](http://technet.microsoft.com/security/cc184924) 并参考旧版产品支持部分，了解如何使用旧版工具创建全面的安全更新检测。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2584052">Microsoft 知识库文章 2584052</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2584063">Microsoft 知识库文章 2584063</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2584066">Microsoft 知识库文章 2584066</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   Parvez Anwar 与 [Secunia Research](http://secunia.com/) 合作报告了 Office 组件不安全库加载漏洞 (CVE-2011-1980) 中描述的问题  
-   [CERT/CC](http://www.cert.org/) 的 David Warren 报告了 Office 未初始化的对象指针漏洞 (CVE-2011-1982)

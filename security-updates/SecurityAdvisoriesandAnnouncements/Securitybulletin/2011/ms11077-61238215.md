...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9157e677-ab3f-44b0-9735-192bc7421ba7)                                                                                           | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0f2444ac-61bd-47cf-9c1e-da86a2b0cfb5)                                                                  | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3bd62bf6-3400-4c03-95fe-148112b341e8)                                                                                  | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b73f4e87-9655-46d5-beb2-ea245dcd280d)                                                                      | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=a618cc19-5ebc-462e-a518-d9bfe41ed98e)                                                                  | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ff53d01b-97b7-40d2-af88-4978f1099a7c)                                                                                        | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=47322e11-f1cf-4f70-b939-8cac9bbfc2bc)                                                                            | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7c7498ee-eba4-44fd-8846-0b2e96c96705)\*                                                               | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=40386742-f397-402e-8810-63d3d6ba12a6)\*                                                          | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3633402b-96cb-4f36-b137-d07d1baf28c7)                                                        | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9e40bc26-f77f-4b57-9b3d-9d053c19ac56)                                             | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=219554e6-eb5a-42d0-90c0-42b4d0772cfd)                                   | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=39bd4cfb-fe61-41b8-a5a2-73a9e720fc72)\*       | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0d35c6d0-6d2d-42bf-a97f-4c5e01b1937e) | 远程执行代码 | 重要         | [MS11-054](http://go.microsoft.com/fwlink/?linkid=220172) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1985](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1985)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2002](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2002)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2003](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2003)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2011](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2011)。
...
TrueType 字体文件包括多种不同的信息供 TrueType 光栅器和操作系统软件使用，确保计算机屏幕上的显示字符或打印出来的字符与字体设计师的想法完全相同。有关详细信息，请参阅 MSDN 文章“[关于字体嵌入](http://msdn.microsoft.com/en-us/library/ms533034.aspx)”。“受影响的软件”表中列出的所有操作系统默认情况下都支持 EOT 字体呈现。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2567053">Microsoft 知识库文章 2567053</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2567053](http://support.microsoft.com/kb/2567053)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [BitDefender](http://www.bitdefender.com/) 的 Andrei Lutas 报告了 Win32k 空指针解除引用漏洞 (CVE-2011-1985)  
-   [Norman](http://www.norman.com/) 的 Tarjei Mandt 报告了 Win32k 空指针解除引用漏洞 (CVE-2011-1985)  
-   Maik Wellmann 报告了 Win32k TrueType 字体类型转换漏洞 (CVE-2011-2002)  
-   [CERT/CC](http://www.cert.org/) 的 Will Dormann 报告了字体库文件缓冲区溢出漏洞 (CVE-2011-2003)

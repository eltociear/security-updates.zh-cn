...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c2d4aa38-9241-465d-8d65-aba73e936d0f)                                                                            | 拒绝服务     | 重要         | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2db4098a-f4f9-4211-b55d-5d0df1409c43)                                                                | 拒绝服务     | 重要         | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=1934acfa-5637-4ae9-9e9a-fc7e58930b7a)                                                            | 拒绝服务     | 重要         | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ac2d5122-6f9b-46f5-9840-77aa7ff84308)\*                                                         | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5f605f6f-3854-403d-878b-637626aef78f)\*                                                    | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6a86e2cf-4e7d-4012-88c3-6957a3842dd3)\* | 远程执行代码 | 严重         | 无                                                        |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1966](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1966)。
...
**什么是 NAPTR DNS 资源记录？**    
命名权威指针 (NAPTR) DNS 资源记录 (RR) 允许使用 DNS 为各种资源名称（包括未采用域名语法的 URL）查找服务。有关 NAPTR 的详细信息，请参阅 [RFC-2915](http://www.ietf.org/rfc/rfc2915.txt)。
  
**什么是 DNS 资源记录？**    
DNS 资源记录 (RR) 标识域中的特殊资源。有关详细信息，请参阅 TechNet 文章 [DNS 的工作原理](http://technet.microsoft.com/en-us/library/dd197446(ws.10).aspx)。
  
**什么是 URI？**    
统一资源标识符 (URI) 是指用于通过网络处理或识别 Internet 中的资源的字符串。URL 是一个典型的 URI 示例，它引用网站等资源。有关 URI 的详细信息，请参阅 [RFC-2396](http://www.ietf.org/rfc/rfc2915.txt)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1970](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1970)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2562485">Microsoft 知识库文章 2562485</a></td>
</tr>  
<tr class="even">

...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=6bc1f0ac-223d-4b0b-86cd-2ba3863955c4)                          | 特权提升     | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d5ee6787-408d-4870-af70-9338158b161b) | 特权提升     | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8de0f2db-aa09-48cd-a13b-e26a973e9cdc)                 | 特权提升     | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8f208407-4bb3-41fe-b0d6-fc8a5e30e667)     | 特权提升     | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=ef140089-d022-4ee8-9cc4-7fb25295a39d) | 特权提升     | 重要         | 无               |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1974](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1974)。
...
**什么是远程访问服务 (RAS)？**    
远程访问服务 (RAS) 让用户能够通过电话线、Internet 或其他网络连接连接到远程计算机，这样，他们可以就像系统物理连接到远程网络一样进行工作。 RAS 使用户能够远程执行发送和接收电子邮件、以传真方式发送文档、检索文件以及在办公室打印机上打印文档等活动。 有关详细信息，请参阅 MSDN 文章“[RAS](http://msdn.microsoft.com/en-us/library/ff563285(v=vs.85).aspx) 体系结构概述 (NDIS 5.1)”。
...
**什么是 NDISTAPI 驱动程序？**    
NDISTAPI 驱动程序是 RAS 体系结构的一部分，将 NDISWAN 连接到 TAPI 服务。 电话应用程序实施 TAPI 服务，可以发出 TAPI 请求以设置、监控、终止线路和呼叫。 NDISTAPI 驱动程序将这些 TAPI 请求传递到 NDISWAN。 有关详细信息，请参阅 MSDN 文章“[NDISTAPI 概述 (NDIS 5.1)](http://msdn.microsoft.com/en-us/library/ff554813(v=vs.85).aspx)”。
  
**什么是 NDISWAN？**    
网络驱动程序接口标准广域网 (NDISWAN) 是一种系统提供的 NDIS 中间驱动程序，提供了数据压缩、加密、环回和 WAN 微型端口驱动程序使用的简单 PPP 帧等功能。 因此，WAN 微型端口驱动程序是仅实施特定于媒体的那些功能所必需的（例如，对于 ISDN 需要 Q931 信号）。 有关详细信息，请参阅 MSDN 文章 [NDISWAN 概述](http://msdn.microsoft.com/en-us/library/ff564653(v=vs.85).aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2566454">Microsoft 知识库文章 2566454</a></td>
</tr>  
<tr class="even">

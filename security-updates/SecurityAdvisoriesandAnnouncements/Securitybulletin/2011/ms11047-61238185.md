...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=24789423-72b7-48d1-bdc1-f0e5174d99bb)\* | 拒绝服务     | 重要         | [MS10-102](http://go.microsoft.com/fwlink/?linkid=205309) |
| [Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                                         | 拒绝服务     | 重要         | [MS10-102](http://go.microsoft.com/fwlink/?linkid=205309) |
| [Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c9c6c36d-a455-42f7-b7d4-9fb9824c07cb)\*                                           | 拒绝服务     | 重要         | 无                                                        |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1872](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1872)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2525835">Microsoft 知识库文章 2525835</a></td>
</tr>  
<tr class="odd">
...
-   [Core Security Technologies](http://www.coresecurity.com/) 的 Nicolas Economou 报告了 VMBus 持久 DoS 漏洞 (CVE-2011-1872)

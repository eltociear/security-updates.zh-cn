...
**建议。** 对于管理员、企业安装或者想要手动安装此安全更新的最终用户，Microsoft 建议客户使用更新管理软件尽早应用此更新或者利用 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747) 服务检查更新。

另请参阅本公告后面部分中的“**检测和部署工具及指导**”一节。

**已知问题。**[Microsoft 知识库文章 2633171](http://support.microsoft.com/kb/2633171) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=7a6fcf8d-8c7b-4882-90d3-02db79a75238)                                               | 特权提升     | 重要         | [MS10-047](http://go.microsoft.com/fwlink/?linkid=195812) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=281e5bd4-4582-4aa9-af88-518ad3152132)                                      | 特权提升     | 重要         | [MS10-021](http://go.microsoft.com/fwlink/?linkid=184814) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a6c7c960-768d-40d4-8fe5-7d59f48ead1d)                                            | 特权提升     | 重要         | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5a4443f8-fec8-42be-ad67-8475920f1460)\*                   | 特权提升     | 重要         | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=eb2bd108-5ef1-45be-9157-e7cbfc8afd2a) | 特权提升     | 重要         | [MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2018](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2018)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2633171">Microsoft 知识库文章 2633171</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2633171](http://support.microsoft.com/kb/2633171)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Matthew Jurczyk 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 Windows 内核异常处理程序漏洞 (CVE-2011-2018)

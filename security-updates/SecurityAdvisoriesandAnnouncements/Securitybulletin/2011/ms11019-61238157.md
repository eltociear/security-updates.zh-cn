...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f5378e7b-4619-4c42-9d9f-87b209c6d878)                                                                                     | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c01441da-8933-4f60-923b-d9b00db8ba3d)                                                            | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d46fe0bf-28c2-4696-87bc-dd3c8287fc28)                                                                            | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ca0fb4d3-7651-4760-83fa-b71c86cbe459)                                                                | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=87eb8b93-9829-45ec-9528-52787732044e)                                                            | 远程执行代码 | 严重         | 无                                                        |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=da8dd55d-6630-484e-836c-9feeab5cc311)                                                  | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=040f8b46-f458-4a72-a1b0-ad8a65a1194c)                          | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f8c9390a-5ca1-492a-9e35-a516de48deb5)\*                 | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b0cfd5e0-6de5-4863-b5e4-b223a0e36d72)\*       | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8eaf51cd-2f6e-4bbc-bc4f-9deed03649ac) | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715)                                                                                   | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0dcba089-19f7-46ca-9e52-24eaebad4715)                                                                     | 远程执行代码 | 严重         | 无                                                        |
| [Windows 7（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25)                                                                              | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b7fd356a-56d0-4638-8901-40acfa600f25)                                                                | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945)\*                                                               | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=27a3847b-695b-4f60-aea5-86b0dbe68945)\*                                                 | 远程执行代码 | 严重         | 无                                                        |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=1e7d3f21-bdbd-4826-855d-85422aa5f836)                                                             | 远程执行代码 | 严重         | [MS10-020](http://go.microsoft.com/fwlink/?linkid=184663) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1e7d3f21-bdbd-4826-855d-85422aa5f836)                                               | 远程执行代码 | 严重         | 无                                                        |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0654](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)。
...
-   **在防火墙处阻止 TCP 端口 138**
    ...
    此端口用于启动与受影响组件的连接。 将 UDP 端口 138 阻止在防火墙处，有助于保护位于防火墙后面的系统尝试利用此漏洞。 Microsoft 建议阻塞所有来自 Internet 的未经请求的入站通信，以帮助阻止可能使用其他端口进行的攻击。 有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](http://go.microsoft.com/fwlink/?linkid=21312)。
  
    **变通办法的影响。** 依赖计算机浏览器服务的应用程序无法运行。 这包括诸如“网上邻居”和 NET VIEW 命令之类的功能。
  
    **如何撤消变通方法。** 在防火墙处解除对 TCP 端口 138 的阻止。 有关端口的详细信息，请参阅 [TCP 和 UDP 端口分配](http://go.microsoft.com/fwlink/?linkid=21312)。
...
**什么是浏览器服务？ **  
浏览器服务维护计算机所在的域名或工作组名称的列表以及运行浏览器服务的计算机所服务的网络段上每台计算机使用的协议。 在每个网络段上，从段上运行浏览器服务的计算机组中选择一种主浏览器。 有关计算机浏览器服务的详细信息，请参阅 [Microsoft 知识库文章 188001](http://support.microsoft.com/kb/188001)。
  
**什么是通用 Internet 文件系统 (CIFS) 浏览器协议？**    
CIFS 浏览器协议定义下列对象发送和接收的消息：充当网络上可用服务的交换所的服务器；支持网络上可用服务（如打印或文件共享）的服务器；请求特定服务的详细信息的客户端。 在 CIFS 浏览器协议的上下文中，浏览是发现提供特殊服务的服务器的过程。 有关详细信息，请参阅 MSDN 文章 [\[MS-BRWS\]： 通用 Internet 文件系统 (CIFS) 浏览器协议规范](http://msdn.microsoft.com/en-us/library/cc224428(prot.10).aspx)。
  
**什么是主浏览器？**    
主浏览器负责收集主机或服务器宣告，这些宣告是由主浏览器的网络段上的每台服务器每 12 分钟作为数据报发送的。 主浏览器指示每个网络段的潜在浏览器成为备份浏览器。 给定网络段上的备份浏览器向相同段中的客户端计算机提供浏览列表。 有关计算机浏览器服务的详细信息，请参阅 [Microsoft 知识库文章 188001](http://support.microsoft.com/kb/188001)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-0654](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0654)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0660](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0660)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2511455">Microsoft 知识库文章 2511455</a></td>
</tr>  
<tr class="even">

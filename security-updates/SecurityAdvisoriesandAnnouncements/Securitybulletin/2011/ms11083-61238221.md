...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fc3fe87c-2493-431d-a904-dec9310f6042)                                                                                        | 严重         | 远程执行代码 | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=042c1a8f-834d-4eed-8a59-9e030ccc6d39)                                                                            | 严重         | 远程执行代码 | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79382bf2-d2cb-42ea-92dc-64f949353521)\*                                                               | 严重         | 远程执行代码 | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71ff3a89-d7ad-4dda-9e59-fab54b21bd5d)\*                                                          | 严重         | 远程执行代码 | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b1c0cb05-c284-49b1-ae4f-92813fdf520f)                                                        | 严重         | 远程执行代码 | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4ddb4c2a-bada-49b0-ad78-e07e7e11ced7)                                             | 严重         | 远程执行代码 | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=05eef5d7-acf6-46e4-abfc-dc83f0a7cae5)                                   | 严重         | 远程执行代码 | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=3f9f74a6-e984-4aab-837c-ef7286e7305f)\*       | 严重         | 远程执行代码 | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b20bfcbd-a515-4074-b56e-b82539fe5bad) | 严重         | 远程执行代码 | [MS11-064](http://go.microsoft.com/fwlink/?linkid=221808) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2013)。
...
-   **在外围防火墙处阻止未使用的** **UDP** **端口**
    ...
    在外围防火墙处阻止未使用的（封闭）UDP 端口有助于防止防火墙后面的系统尝试利用此漏洞。有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](http://go.microsoft.com/fwlink/?linkid=21312)。
...
**什么是** **UDP？    
**用户数据报协议 (UDP) 是 RFC 768“用户数据报协议 (UDP)”中定义的一项 TCP/IP 标准。UDP 由一些程序（而不是 TCP）用于在 TCP/IP 主机之间执行快速、轻型且不可靠的数据传输。UDP 提供了一种无连接的数据报服务，该服务可提供最大努力交付，这意味着 UDP 不保证交付或验证任何数据报的序列。需要可靠通信的源主机必须使用 TCP 或者提供其自己的序列和确认服务的程序。有关详细信息，请参阅 TechNet 文章[用户数据报协议 (UDP)](http://technet.microsoft.com/en-us/library/cc785220(ws.10).aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2588516">Microsoft 知识库文章 2588516</a></td>
</tr>  
<tr class="odd">

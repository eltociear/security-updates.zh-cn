---
TOCTitle: 'MS11-048'
Title: 'Microsoft 安全公告 MS11-048 - 重要'
ms:assetid: 'ms11-048'
ms:contentKeyID: 61238186
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-048(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS11-048 - 重要
==================================
...
该安全更新通过更正 SMB 协议软件处理特制 SMB 请求的方式解决了漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5f0007c3-8d11-4940-8766-1112e3777aae)                                                        | 拒绝服务     | 重要         | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fadf6f12-1f09-4d49-93b1-8fce01400b4f)                                | 拒绝服务     | 重要         | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8960dd62-7cf7-41cb-97b2-b082bd1750aa)\*                       | 拒绝服务     | 重要         | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0abc6908-ac6a-4da3-843a-af6841ccc1db)\*             | 拒绝服务     | 重要         | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=057f1356-9c70-4457-a1df-69334fdab467)       | 拒绝服务     | 重要         | [MS09-050](http://go.microsoft.com/fwlink/?linkid=163970) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=cf9e5ecd-68f7-4982-b4ed-be80859b757c)                                             | 拒绝服务     | 重要         | [MS11-020](http://go.microsoft.com/fwlink/?linkid=212236) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2707650a-604c-4044-acc4-07a30b5640d8)                                   | 拒绝服务     | 重要         | [MS11-020](http://go.microsoft.com/fwlink/?linkid=212236) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=f9824310-772d-4e1e-980e-11e2db3ac53e)\*       | 拒绝服务     | 重要         | [MS11-020](http://go.microsoft.com/fwlink/?linkid=212236) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0533d293-e186-4d39-a925-ab3d9ed46290) | 拒绝服务     | 重要         | [MS11-020](http://go.microsoft.com/fwlink/?linkid=212236) |
...
<tr class="header">
<th>受影响的软件</th>
<th>SMB 请求分析漏洞 - CVE-2011-1267</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
SMB 请求分析漏洞 - CVE-2011-1267  
--------------------------------
  
<span></span>  
Microsoft 服务器消息块 (SMB) 协议软件处理特制 SMB 请求的方式中存在一个拒绝服务漏洞。 利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过向运行 Server 服务的计算机发送特制网络消息来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-1267](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-1267)。
  
#### SMB 请求分析漏洞 (CVE-2011-1267) 的缓解因素
...
#### SMB 请求分析漏洞 (CVE-2011-1267) 的缓解办法
...
**此问题是否影响 SMBv1 或 SMBv2？**    
此漏洞影响 SMBv1 和 SMBv2 协议。
...
**此更新有什么作用？**    
该安全更新通过更正 SMB 协议软件处理特制 SMB 请求的方式解决了漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2536275">Microsoft 知识库文章 2536275</a></td>
</tr>  
<tr class="odd">

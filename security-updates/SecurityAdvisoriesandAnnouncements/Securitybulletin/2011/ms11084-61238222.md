...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=156c1bd9-55bc-482c-874b-61998d1ef153)                                             | 拒绝服务     | 中等         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=5c7db930-5495-43f0-928c-d586ac9e80d0)                                   | 拒绝服务     | 中等         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=5d810dae-5c52-4155-b5c2-163d27be6e78)\*\*\*   | 拒绝服务     | 中等         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=395819e2-1028-44b7-ace4-ca754b1a7543) | 拒绝服务     | 中等         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-2004](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-2004)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2617657">Microsoft 知识库文章 2617657</a></td>
</tr>  
<tr class="odd">
...
-   [CERT/CC](http://www.cert.org/) 的 Will Dormann 报告了 TrueType 字体分析漏洞 (CVE-2011-2004)

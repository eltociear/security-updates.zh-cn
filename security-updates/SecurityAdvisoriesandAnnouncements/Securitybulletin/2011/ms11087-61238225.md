...
此安全更新也解决了最初在 [Microsoft 安全通报 2639658](http://technet.microsoft.com/security/advisory/2639658) 中描述的漏洞。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=b01bb041-005c-48c4-a606-66aa264ba0fa)                                                                                           | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0a872cd2-5f4d-400c-a1c4-a2d194746fb6)                                                                  | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e84e6964-1580-41ef-9d3e-4d0c3ad4cb69)                                                                                  | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9d9f3667-3fd6-4948-83db-282783599f41)                                                                      | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=1ecf72cd-6732-4cf3-aa22-8caf15ea633e)                                                                  | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=7f69ec9d-43ad-4106-90ef-c191e7ec43af)                                                                                        | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ae1f1f86-6f13-4e1e-9f93-4f70b6c9927e)                                                                            | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=c4ba344d-dd0d-4cfb-81d9-d364d7f37e25)\*\*\*\*                                                         | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=058963f6-9654-41d0-86d2-f25a0c2ad416)\*\*\*\*                                                    | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=42cd1c33-11a7-4a29-ae85-f7272a626f91)                                                        | 远程执行代码 | 严重         | [MS11-077](http://go.microsoft.com/fwlink/?linkid=225915) |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0526727a-f2fb-4846-9b04-f1899f52f1f6)                                             | 远程执行代码 | 严重         | [MS11-084](http://go.microsoft.com/fwlink/?linkid=229245) |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=cfd42c42-1595-419a-bf04-b23b64663629)                                   | 远程执行代码 | 严重         | [MS11-084](http://go.microsoft.com/fwlink/?linkid=229245) |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d64a31ca-cccd-488a-98fd-c059b9e9e1ea)\*\*\*\* | 远程执行代码 | 严重         | [MS11-084](http://go.microsoft.com/fwlink/?linkid=229245) |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=b46f6da7-6d24-4262-8e55-3b657db39813) | 远程执行代码 | 严重         | [MS11-084](http://go.microsoft.com/fwlink/?linkid=229245) |
...
然而，在应用此安全更新之后，您应该从之前应用了该更新的系统中撤销变通办法“拒绝访问 T2EMBED.DLL”以便还原变通办法禁用的功能。要使用自动 Microsoft Fix it 解决方案禁用此变通办法，请参阅 [Microsoft 知识库文章 2639417](http://support.microsoft.com/kb/2639417)。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**Windows Developer Preview 是否受此问题的影响？**  
是的，更新 KB2639417 适用于 Windows Developer Preview 版本。鼓励 Windows Developer Preview 客户向其系统应用此更新。该更新在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2639417">Microsoft 知识库文章 2639417</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2639417](http://support.microsoft.com/kb/2639417)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">

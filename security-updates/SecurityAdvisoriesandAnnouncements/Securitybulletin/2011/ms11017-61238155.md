---
TOCTitle: 'MS11-017'
Title: 'Microsoft 安全公告 MS11-017 - 重要'
ms:assetid: 'ms11-017'
ms:contentKeyID: 61238155
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms11-017(v=Security.10)'
---
...
对于 Remote Desktop Connection 5.2 Client、Remote Desktop Connection 6.0 Client、Remote Desktop Connection 6.1 Client 和 Remote Desktop Connection 7.0 Client，此安全更新等级为“重要”。 有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过更正 Windows 远程桌面客户端加载外部库的方式来解决此漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。** [Microsoft 知识库文章 2508062](http://support.microsoft.com/kb/2508062) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
<tr>
<th colspan="5">
Remote Desktop Connection 6.0 Client 和 Remote Desktop Connection 6.1 Client
</th>
</tr>
...
| 操作系统                                                        | 组件                                 |
|-----------------------------------------------------------------|--------------------------------------|
| Windows XP Professional x64 Edition Service Pack 2              | Remote Desktop Connection 5.2 Client |
| Windows Server 2003 Service Pack 2                              | Remote Desktop Connection 5.2 Client |
| Windows Server 2003 x64 Edition Service Pack 2                  | Remote Desktop Connection 5.2 Client |
| Windows Server 2003 SP2（用于基于 Itanium 的系统）              | Remote Desktop Connection 5.2 Client |
...
<tr>
<td style="border:1px solid black;">
Windows XP Service Pack 3 上的 Remote Desktop Connection 5.2
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Service Pack 3 上的 Remote Desktop Connection 6.1
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows XP Professional x64 Edition Service Pack 2 上的 Remote Desktop Connection 6.0
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 上的 Remote Desktop Connection 6.0
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2003 Service Pack 2 上的 Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI)
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2003 x64 Edition Service Pack 2 上的 Remote Desktop Connection 6.0
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的 Remote Desktop Connection 6.1
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的 Remote Desktop Connection 6.1
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2 中的 Remote Desktop Connection 6.1\*\*
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2 中的 Remote Desktop Connection 6.1\*\*
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2 中的 Remote Desktop Connection 6.1
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows XP Service Pack 3 上的 Remote Desktop Connection 7.0
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的 Remote Desktop Connection 7.0
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的 Remote Desktop Connection 7.0
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows 7（用于 32 位系统）上的 Remote Desktop Connection 7.0
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows 7（用于基于 x64 的系统）上的 Remote Desktop Connection 7.0
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr>
<td style="border:1px solid black;">
Windows Server 2008 R2（用于基于 x64 的系统）上的 Remote Desktop Connection 7.0\*\*
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
Windows Server 2008 R2（用于基于 Itanium 的系统）上的 Remote Desktop Connection 7.0
</td>
<td style="border:1px solid black;">
**重要**   
远程执行代码
...
<span></span>
Windows 远程桌面客户端处理 DLL 文件加载的方式中存在一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。 那些帐户被配置为拥有较少系统用户权限的用户比具有管理用户权限的用户受到的影响要小。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)。

#### 远程桌面库加载不安全漏洞 (CVE-2011-0029) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：

-   要成功进行攻击，用户必须访问不受信任的远程文件系统位置或 WebDAV 共享并打开 .rdp 文件。
-   外围防火墙通常禁用文件共享协议服务器消息块 (SMB)。 这样可限制此漏洞的可能攻击媒介。

#### 远程桌面库加载不安全漏洞 (CVE-2011-0029) 的变通办法
...
#### 远程桌面库加载不安全漏洞 (CVE-2011-0029) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**造成此漏洞的原因是什么？**  
此漏洞是由于 Windows 远程桌面客户端不正确限制加载外部库使用的路径所导致的。

**什么是 Windows 远程桌面客户端？**  
Windows 中的远程桌面功能支持从另一台基于 Windows 的计算机访问用户计算机上的所有程序、资源以及附件。 连接上后，远程桌面将接管第一台计算机的鼠标和键盘，同时在屏幕上显示所发生的一切。
...
**攻击者如何利用此漏洞？**  
攻击者可能诱使用户打开与特制动态链接库 (DLL) 文件位于同一网络目录下的合法远程桌面配置文件 (.rdp)。 然后，在用户打开 .rdp 文件时，Windows 远程桌面客户端可能尝试加载 DLL 文件并执行其包含的任何代码。

在电子邮件攻击情形中，攻击者可能通过向用户发送合法的 .rdp 附件并诱使用户将此附件放在包含特制 DLL 文件的目录下并打开 .rdp 文件来利用此漏洞。 然后，在用户打开 .rdp 文件时，Windows 远程桌面客户端可能尝试加载 DLL 文件并执行其包含的任何代码。

在网络情形中，攻击者可能将合法的 .rdp 文件与特制 DLL 文件一起放在 UNC 或 WebDAV 位置上，然后诱使用户打开 .rdp 文件。

**受此漏洞威胁最大的系统有哪些？**  
此漏洞主要影响可能期望用户从不受信任的网络位置打开附件的工作站。 如果管理员允许用户登录服务器并运行程序，服务器同样可能面临风险。 不过，最佳做法是不要授予这样的权限。

**此更新有什么作用？**  
此更新通过更正 Windows 远程桌面客户端加载外部库的方式来解决此漏洞。

**此漏洞是否与 Microsoft 安全通报 2269637 有关？**  
是的，此更新解决的漏洞与 [Microsoft 安全通报 2269637](http://technet.microsoft.com/security/advisory/2269637) 中所述的影响应用程序如何加载外部库的漏洞类别有关。 此安全更新针对这种漏洞的特定实例。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配了常见漏洞和披露号码 [CVE-2011-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2011-0029)。
...
| Windows 7（用于 32 位系统）Service Pack 1                                                                     | 否      | 否                  | 是                  | 是                         |
...
<td style="border:1px solid black;">对于 Windows XP Service Pack 3 上的 Remote Desktop Connection 5.2：<br />
WindowsXP-KB2483618-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Service Pack 3 上的 Remote Desktop Connection 6.1：<br />
WindowsXP-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Service Pack 3 上的 Remote Desktop Connection 7.0：<br />
WindowsXP-KB2483614-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows XP Professional x64 Edition Service Pack 2 上的 Remote Desktop Connection 6.0：<br />
...
<td style="border:1px solid black;">对于 Remote Desktop Connection 5.2：<br />
KB2483618.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0 和 Remote Desktop Connection 6.1：<br />
KB2481109.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 7.0：<br />
KB2483614.log</td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;">对于 Remote Desktop Connection 5.2：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB2483618$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0 和 Remote Desktop Connection 6.1：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB2481109$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 7.0：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB2483614$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 5.2：<br />
请参阅 <a href="http://support.microsoft.com/kb/2483618">Microsoft 知识库文章 2483618</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0 和 Remote Desktop Connection 6.1：<br />
请参阅 <a href="http://support.microsoft.com/kb/2481109">Microsoft 知识库文章 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 7.0：<br />
请参阅 <a href="http://support.microsoft.com/kb/2483614">Microsoft 知识库文章 2483614</a></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2003 Service Pack 2 上的 Remote Desktop Connection 6.0：<br />
WindowsServer2003-KB2481109-x86-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 Service Pack 2 上的 Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI)：<br />
WindowsServer2003-KB2483619-x86-enu.exe /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 x64 Edition Service Pack 2 上的 Remote Desktop Connection 6.0：<br />
WindowsServer2003.WindowsXP-KB2481109-x64-enu.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">安装而不重新启动</td>
...
<tr class="odd">
<td style="border:1px solid black;">更新日志文件</td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0：<br />
KB2481109.log</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI)：<br />
KB2483619.log</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">更多信息</td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI)：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB2483619$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0：<br />
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0 Client Multilingual User Interface (MUI)：<br />
请参阅 <a href="http://support.microsoft.com/kb/2483619">Microsoft 知识库文章 2483619</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的 Remote Desktop Connection 6.1：<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Vista Service Pack 1 和 Windows Vista Service Pack 2 上的 Remote Desktop Connection 7.0：<br />
Windows6.0-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2 上的 Remote Desktop Connection 6.1：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Remote Desktop Connection 6.1：<br />
请参阅 <a href="http://support.microsoft.com/kb/2481109">Microsoft 知识库文章 2481109</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2008 所有受支持的 32 位版本上的 Remote Desktop Connection 6.1：<br />
Windows6.0-KB2481109-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 所有受支持的基于 x64 版本上的 Remote Desktop Connection 6.1：<br />
Windows6.0-KB2481109-x64.msu /quiet</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 所有受支持的基于 Itanium 版本上的 Remote Desktop Connection 6.1：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2481109">Microsoft 知识库文章 2481109</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注意</strong> 没有用于验证此更新是否存在的注册表项。</td>
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows 7 的原始发行版本的所有受支持的 32 位版本上的 Remote Desktop Connection 7.0：<br />
Windows6.1-KB2483614-x86.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows 7 的原始发行版本的所有受支持的基于 x64 的版本上的 Remote Desktop Connection 7.0：<br />
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2483614">Microsoft 知识库文章 2483614</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;"><strong>注意</strong> 没有用于验证此更新是否存在的注册表项。</td>
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">对于 Windows Server 2008 R2 的原始发行版本的所有受支持的基于 x64 的版本上的 Remote Desktop Connection 7.0：<br />
Windows6.1-KB2483614-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2008 R2 的原始发行版本的所有受支持的基于 Itanium 的版本上的 Remote Desktop Connection 7.0：<br />
...
-   [Versafe Anti Fraud](http://www.versafe-login.com/) 的 Eyal Gruner 报告了远程桌面库加载不安全漏洞 (CVE-2011-0029)
...
-   V1.1（2011 年 3 月 8 日）： 更正了 Systems Management Server 表中关于用于 Windows XP Service Pack 3 和 Windows Server 2003 Service Pack 2 的 SMS 2.0 和 SMS 2003（带 SUIT）的条目。这些只是信息更改。 没有更改安全更新文件或检测逻辑。  
-   V1.2（2011 年 3 月 9 日）： 更正了“**不受影响的软件**”中 Windows 7 和 Windows Server 2008 R2 的 service pack 1 版本的组件条目（从 Remote Desktop Connection 7.0 Client 更正为 Remote Desktop Connection 7.1 Client）。 这些只是信息更改。 没有更改安全更新文件或检测逻辑。  
-   V1.3（2011 年 4 月 13 日）： 针对 Windows Server 2003 受支持版本上的远程桌面连接 6.0 客户端以及 Windows Vista 受支持版本上的远程桌面连接 6.1 客户端更正了公告替代信息。 这仅仅是一个公告更改。 检测或安全更新文件未发生更改。  
-   V1.4（2011 年 4 月 15 日）： 针对 Windows Server 2003 受支持版本上的远程桌面连接 6.0 客户端以及 Windows Server 2008 受支持版本上的远程桌面连接 6.1 客户端更正了公告替代信息。 检测或安全更新文件未发生更改。  
-   V1.5（2011 年 5 月 4 日）： 针对 Windows XP Service Pack 3 受支持的版本上的远程桌面连接 5.2 客户端更正了公告替代信息。这仅仅是一个公告更改。 检测或安全更新文件未发生更改。

...
**已知问题。**[Microsoft 知识库文章 2484015](http://support.microsoft.com/kb/2484015) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[Microsoft .NET Framework 2.0 Service Pack 2 和 Microsoft .NET Framework 3.5](http://www.microsoft.com/downloads/details.aspx?familyid=1407aaec-b3e0-404c-b84f-0c8e808614c4)Service Pack 1  
(KB2449742)
</td>
<td style="border:1px solid black;">
远程执行代码
...
Microsoft 重新发布此公告是为了重新提供修补程序 KB979744 和安全更新 KB2446709 和 KB2449742，可解决会影响 SQL 和 Exchange 服务器的已知问题。[Microsoft 知识库文章 2540222](http://support.microsoft.com/kb/2540222) 中详细介绍了此问题。对于安装了修补程序 KB979744 的原始版本 (V1) 的客户，此更新将自动提供并安装安全更新和修补程序 KB979744 的新版本。已成功更新其系统但是没有安装修补程序 KB979744 的客户不需要重新安装此更新。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958)。
...
**发布此安全公告时，此漏洞是否已公开披露？**
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3958](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3958)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2484015">Microsoft 知识库文章 2484015</a></td>
</tr>  
<tr class="odd">

...
<td style="border:1px solid black;">
[**Microsoft Active Directory 联合身份验证服务信息泄漏漏洞 - CVE-2017-0043**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0043)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3217882)  
(3217882)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb3217882)  
(3217882)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012214)<span></span>（服务器核心安装）  
(4012214)  
纯安全补丁<sup>[1]</sup>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012217)<span></span>（服务器核心安装）  
(4012217)  
每月汇总补丁<sup>[1]</sup>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012213)<span></span>（服务器核心安装）  
(4012213)  
纯安全补丁<sup>[1]</sup>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4012216)<span></span>（服务器核心安装）  
(4012216)  
每月汇总补丁<sup>[1]</sup>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2016（用于基于 x64 的系统）](http://catalog.update.microsoft.com/v7/site/search.aspx?q=kb4013429)（服务器核心安装）<sup>[2]</sup>  
(4013429)
...
<td style="border:1px solid black;"><p><a href="http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2017-0043">CVE-2017-0043</a></p></td>

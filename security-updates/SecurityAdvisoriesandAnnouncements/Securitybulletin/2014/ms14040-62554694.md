...
<tr>
<td style="border:1px solid black;">
[Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=b016d54a-931d-4977-99ed-070c286425a0)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b97f96c-d4c7-4b38-b756-678802068678)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=13fdbd2f-2d06-402c-83af-ef35f58b2841)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=73672862-e8c4-4307-8009-945ac22b2f29)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=8d4dacd9-2482-4c5c-9d8f-def6551615da)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=617d2a37-c551-40b8-8707-05f2e2b01e68)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0b5ae77a-1e77-40e2-9a5f-b6638dd543c0)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6912589b-ccde-4716-87b8-2ab4b8d199a4)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows 8（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=b19c4548-8328-4aad-97d0-1208c4c2b850)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows 8（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=1148d26c-8346-41a8-b80a-01a24e7ca624)  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=9e28953a-541b-476e-8785-59608b699829)<sup>[1]</sup>  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=459566b1-93f1-48e0-9707-7247030ed023)<sup>[1]</sup>  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3b97f96c-d4c7-4b38-b756-678802068678)（服务器核心安装）  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=13fdbd2f-2d06-402c-83af-ef35f58b2841)（服务器核心安装）  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0b5ae77a-1e77-40e2-9a5f-b6638dd543c0)（服务器核心安装）  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012](http://www.microsoft.com/downloads/details.aspx?familyid=fc13e7a0-17c3-4c25-b6d5-e4940fa719ec)（服务器核心安装）  
(2961072)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2012 R2](http://www.microsoft.com/downloads/details.aspx?familyid=95096ff1-9f9e-4a57-b474-a7b0b014a2d1)（服务器核心安装）<sup>[1]</sup>  
(2961072)
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2014-1767](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2014-1767)。
...
该传输驱动程序界面 (TDI) 定义了出现在所有传输协议堆栈上边缘的内核模式网络界面。每个堆栈中最高级别的协议驱动程序支持用于更高级内核模式网络客户端的 TDI 界面。有关 TDI 组件的详细信息，请参阅 MSDN 文章“[传输驱动程序界面](http://msdn.microsoft.com/library/ff565685.aspx)”。
...
-   一名匿名研究人员与 [HP's](http://www.hpenterprisesecurity.com/products) [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了辅助功能驱动程序特权提升漏洞 (CVE-2014-1767)

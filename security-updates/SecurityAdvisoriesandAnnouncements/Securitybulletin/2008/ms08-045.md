...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 5.01 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=1557b93b-ecba-4f42-b89d-db0ee067d65b)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[MS08-031](http://go.microsoft.com/fwlink/?linkid=122772)
</td>
</tr>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6 Service Pack 1](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=aa780735-5928-4c46-89a4-63a814954796)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=69af2f30-138e-4b15-ab8d-4fce44cc0bc2)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=4780b89e-9735-4d3f-8def-34e7337ff604)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Microsoft Internet Explorer 6](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=0617a5dd-dce9-4de0-b0a0-ce38efe13524)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=8e2125c7-52cb-4052-82a3-2d3c6a953752)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=b3c2e2fd-1cb9-491b-937c-053dd59a65bf)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
<td style="border:1px solid black;">
[Windows Internet Explorer 7](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=13cba012-dd20-48f9-8e44-e4cb104c4cad)
</td>
<td style="border:1px solid black;">
**远程执行代码**
</td>
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 953838](http://support.microsoft.com/kb/953838) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2254](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2254)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2255](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2255)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2256](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2256)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2257](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2257) 和 [CVE-2008-2258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2258)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2259](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2259)。
...
\* SMS 2.0 和 SMS 2003 支持除 IE7 以外的所有其他受影响的 Internet Explorer 版本。有关详细信息，请参阅 [Microsoft 知识库文章 924178](http://support.microsoft.com/kb/924178)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/953838">Microsoft 知识库文章 953838</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/953838">请参阅 Microsoft 知识库文章 953838</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;"><a href="http://support.microsoft.com/kb/953838">请参阅 Microsoft 知识库文章</a>953838</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [Palo Alto Networks](http://www.paloaltonetworks.com/) 的 Yamata Li 报告了 HTML 对象内存损坏漏洞 CVE-2008-2254。  
-   [Google Security Team](http://www.google.com/) 的 Tavis Ormandy 报告了未初始化的内存损坏漏洞 CVE-2008-2256。  
-   Sam Thomas 与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 CVE-2008-2257。  
-   [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 报告了 HTML 对象内存损坏漏洞 CVE-2008-2258。

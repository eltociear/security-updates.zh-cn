...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|---------------------------------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=aa8aa79f-c2cc-440c-9e5c-089143e6f814)                                            | 特权提升     | 重要         | [MS04-045](http://technet.microsoft.com/security/bulletin/ms04-045) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=08fc90d5-23aa-4327-8aef-16bc5170769d)                | 特权提升     | 重要         | [MS04-045](http://technet.microsoft.com/security/bulletin/ms04-045) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71675ae8-d60a-4834-b358-2d8e761e62fc)                         | 特权提升     | 重要         | [MS04-045](http://technet.microsoft.com/security/bulletin/ms04-045) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=87affdc9-d9fe-413c-af30-f3d3b671ec72) | 特权提升     | 重要         | [MS04-045](http://technet.microsoft.com/security/bulletin/ms04-045) |
...
<span></span>
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 948745](http://support.microsoft.com/kb/948745) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1451](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1451)。
...
**此漏洞的影响范围有多大？**    
WINS 中存在一个特权提升漏洞。 成功利用此漏洞的攻击者可以使用提升的特权运行代码。 攻击者然后可以完全控制受影响的系统。 详细信息，请访问 [WINS](http://technet2.microsoft.com/windowsserver/en/library/ea41036e-5cbf-427b-a34f-9e4d1d1519581033.mspx?mfr=true) Technet 文章。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/948745">Microsoft 知识库文章 948745</a></td>
</tr>  
<tr class="even">

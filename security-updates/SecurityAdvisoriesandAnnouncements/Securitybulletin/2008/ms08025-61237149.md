...
**已知问题。** [Microsoft 知识库文章 941693](http://support.microsoft.com/kb/941693) 介绍了客户在卸载此安全更新时可能遇到的当前已知问题。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=8db9f328-da0e-4fb8-96c4-6d368b47c224)                                                                     | 特权提升     | 重要         | 无               |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e937f65-abd0-46dd-8883-5bfd70ea1178)                                                                                 | 特权提升     | 重要         | 无               |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=a29bbd13-761f-44fa-8948-e1a8c244bd7a)                 | 特权提升     | 重要         | 无               |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d3b855a6-4648-4771-826d-11a151828eac)                                  | 特权提升     | 重要         | 无               |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=320fd100-35e1-4345-9399-796393235cbc)                         | 特权提升     | 重要         | 无               |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=126426a7-be38-4327-89db-02d99d76589d) | 特权提升     | 重要         | 无               |
| [Windows Vista 和 Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=9640cd8b-d749-4ddd-8af9-b298cebed969)                                                             | 特权提升     | 重要         | 无               |
| [Windows Vista x64 Edition and Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d56bb4fe-304e-45e0-95f2-fde2f47b2a04)                                    | 特权提升     | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=4497333c-9418-4b91-83dc-0155735421c0)                                                                     | 特权提升     | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=5aefc7a6-79a4-45a2-b534-35d0ec400dda)                                                                | 特权提升     | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=3080c26b-7456-41ef-8668-28f15bc7b8ce)                                                            | 特权提升     | 重要         | 无               |
...
[Microsoft 知识库文章 941693](http://support.microsoft.com/kb/941693) 介绍了客户在卸载此安全更新时可能遇到的当前已知问题。 MS08-025（内核）和 MS08-021 (GDI) 提供的安全更新之间会共享二进制。 在安装这两个安全更新（MS08-025 和 MS08-021）并卸载 MS08-025（内核）提供的更新之后，MS08-021 (GDI) 提供的更新可能还原为容易受攻击的版本，这将导致向容易受攻击的系统重新提供 MS08-021 (GDI) 更新。

**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 941693](http://support.microsoft.com/kb/941693) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-1084](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-1084)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/941693">Microsoft 知识库文章 941693</a></td>
</tr>  
<tr class="even">
...
-   [SkyRecon](http://www.skyrecon.com/) 的 Thomas Garnier 报告了 Windows 内核漏洞 (CVE-2008-1084)。

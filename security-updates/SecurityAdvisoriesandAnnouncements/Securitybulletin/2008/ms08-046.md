...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=db455d17-435f-46d7-b2dd-5babb5a1eeb3)                                                   | 远程执行代码 | 严重         | 无               |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=d313f42c-f43f-48ea-82ef-3bc33077c7fa)                                                    | 远程执行代码 | 严重         | 无               |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3150c6b8-f50b-4b84-a7ce-c8daf77c080c)                 | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=828d8fdc-8534-4621-85a5-08aec255496f)                | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0a13776f-d543-41df-b904-d51e368c81cc)                         | 远程执行代码 | 严重         | 无               |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=9566493f-4260-4072-947a-527887d2cd63) | 远程执行代码 | 严重         | 无               |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 952954](http://support.microsoft.com/kb/952954) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2245](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2245)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/952954">Microsoft 知识库文章 952954</a></td>
</tr>  
<tr class="even">
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Jun Mao 报告了 Microsoft 颜色管理系统漏洞 (CVE-2008-2245)

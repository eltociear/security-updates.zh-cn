...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|------------------|------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=7956632e-17d9-4876-8340-84fe3e43e5cc)                                                   | 特权提升     | 重要             | 无               |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=6a4cf182-8e36-490e-aefe-edb7b3a0df9c)                                                               | 特权提升     | 重要             | 无               |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=51fc657b-2b4a-4725-a744-d279e027c4a5)                 | 特权提升     | 重要             | 无               |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=12397b47-b18f-4d4d-b8d7-adec8ff310d5)                | 特权提升     | 重要             | 无               |
| [Windows Server 2003 x64 Edition 和 Windows 2003 Server x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f19fd790-a4e6-4a8a-8077-d1bbfe37ecca)                         | 特权提升     | 重要             | 无               |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=0382a195-aa3d-409b-8a79-9fe61588d8a9) | 特权提升     | 重要             | 无               |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2007-5352](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-5352)。
...
-   [SkyRecon](http://www.skyrecon.com/) 的 Thomas Garnier 报告了 LSASS 绕过漏洞 (CVE-2007-5352)。

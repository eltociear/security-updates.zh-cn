...
<span></span>
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 958215](http://support.microsoft.com/kb/958215) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4258](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4258)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4259](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4259)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4260](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4260)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4261](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4261)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/958215">Microsoft 知识库文章 958215</a></td>
</tr>  
<tr class="even">
...
-   Brett Moore 与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 HTML 对象内存损坏漏洞 (CVE-2008-4259)  
-   [Casaba Security](http://www.casabasecurity.com/) 的 Chris Weber 报告了未初始化的内存损坏漏洞 (CVE-2008-4260)  
-   [Verisign iDefense Labs](http://labs.idefense.com/) 的 Jun Mao 报告了 HTML 呈现内存损坏漏洞 (CVE-2008-4261)。

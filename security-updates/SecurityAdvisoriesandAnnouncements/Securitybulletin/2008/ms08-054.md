...
|-------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| Windows XP Service Pack 2 和 Windows XP Service Pack 3                                    | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=d5891180-5dd1-49ec-bcc6-3030a544202c) | 远程执行代码 | 严重         | 无               |
| Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2 | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=caf8a45e-a9f8-4e91-98fd-87eddbeae64c) | 远程执行代码 | 严重         | 无               |
| Windows Vista 和 Windows Vista Service Pack 1                                             | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=2f4118fd-1ffb-46da-b922-cd4ca4f9d84e) | 远程执行代码 | 严重         | 无               |
| Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1                     | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=334352e7-d41f-494f-866d-f1f1745ffd17) | 远程执行代码 | 严重         | 无               |
| Windows Server 2008（用于 32 位系统）\*                                                   | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=72fc6028-6af4-44ec-8d2a-28c53807d6bc) | 远程执行代码 | 严重         | 无               |
| Windows Server 2008（用于基于 x64 的系统）\*                                              | [Windows Media Player 11](http://www.microsoft.com/downloads/details.aspx?familyid=3906512b-26db-473e-b522-3883ff34a21c) | 远程执行代码 | 严重         | 无               |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 954154](http://support.microsoft.com/kb/954154) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-2253](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-2253)。
...
-   此漏洞只能通过实时流协议 (RTSP) 被利用。 不允许来自 Internet 的 RTSP 入站的组织受此漏洞的威胁较小。 有关 RTSP 使用的端口的详细信息，请参阅 [Microsoft 知识库文章 827562](http://support.microsoft.com/kb/827562)。
...
**什么是服务器播放列表 (SSPL)？**    
SSPL 是指一个用于识别为客户端播放哪些内容、播放时间以及播放顺序的列表。 Windows Media 服务器的 SSPL 是一个 XML 文档。 有关 SSPL 的详细信息，请参阅[服务器播放列表](http://msdn.microsoft.com/en-us/library/ms753585(vs.85).aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/954154">Microsoft 知识库文章 954154</a></td>
</tr>  
<tr class="even">

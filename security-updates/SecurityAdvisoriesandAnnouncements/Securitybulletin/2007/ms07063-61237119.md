...
<tr class="header">
<th>受影响的软件</th>
<th>SMBv2 签名漏洞 - CVE-2007-5351</th>
<th>综合严重程度等级</th>
</tr>
</thead>
<tbody>
...
| 软件                        | MBSA 2.0.1                            |  
|-----------------------------|---------------------------------------|  
| Microsoft Vista             | 请参阅下列 **Windows** **Vista 备注** |  
| Microsoft Vista x64 Edition | 请参阅下列 **Windows** **Vista 备注** |
...
| 产品                        | SMS 2.0 | SMS 2003                              |  
|-----------------------------|---------|---------------------------------------|  
| Microsoft Vista             | 否      | 请参阅下列 **Windows** **Vista 备注** |  
| Microsoft Vista x64 Edition | 否      | 请参阅下列 **Windows** **Vista 备注** |

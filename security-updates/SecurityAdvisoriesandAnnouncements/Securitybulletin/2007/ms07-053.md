...
| Window Vista 上的基于 UNIX 的应用程序子系统                                                                      | 否         | 是  | 请参阅下列 **Windows** **Vista 备注** |  
| Windows Vista x64 Edition 上的基于 UNIX 的应用程序子系统                                                         | 否         | 是  | 请参阅下列 **Windows** **Vista 备注** |
...
| Window Vista 上的基于 UNIX 的应用程序子系统                                                                      | 是（用 EST） | 是（用 EST） 请参阅下面的 **Windows** **Vista 注释** |  
| Windows Vista x64 Edition 上的基于 UNIX 的应用程序子系统                                                         | 是（用 EST） | 是（用 EST） 请参阅下面的 **Windows** **Vista 注释** |

...
**我是第三方应用程序开发者并且我在我的应用程序中使用Crystal** **Reports。 我的应用程序是否容易受到攻击，如何进行更新？ **  
Visual Studio 是唯一受此安全更新影响的 Microsoft 开发平台。 本公告提供 Visual Studio 的受影响版本的下载更新链接。 如果您重新分发了“**文件信息**”小节中列出的任何文件，则应向客户发布应用程序的更新版本以及本安全更新中包含的这些文件的更新版本。

...
**关于 Windows** **备注** MBSA 2.0.1 在 Windows Vista 上不受支持，但是支持对运行 Windows Vista 的计算机执行远程扫描。 有关 Windows Vista 的 MBSA 支持的其他信息，请访问 [MBSA 网站](http://go.microsoft.com/fwlink/?linkid=21134)。 请参阅 [Microsoft 知识库文章 931943](http://support.microsoft.com/kb/931943)： Windows Vista 的 Microsoft Baseline Security Analyzer (MBSA) 支持。

...
-   Microsoft Windows 2000 Service Pack 4 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=7b1a81d5-1072-49d9-a24a-0e2630f62d8c)
-   Microsoft Windows XP Service Pack 2 - [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=e9b84661-25e3-4d38-95b1-8d3e7af565aa)
-   Microsoft Windows XP Professional x64 Edition - [下载此更新](http://www.microsoft.com/downloads/details.aspx?familyid=57c1b19f-3242-457c-bedf-d35a8efe525c)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 - [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=eaed6f59-801e-45d7-9518-469d0de13cad)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）- [下载此更新](http://www.microsoft.com/downloads/details.aspx?familyid=cd1b18ae-bc8d-4d73-847f-4fa7ca672c88)
-   Microsoft Windows Server 2003 x64 Edition - [下载此更新](http://www.microsoft.com/downloads/details.aspx?familyid=11f4f8f6-b8ce-4a5f-b7ed-8389ccc56473)
...
|--------------------------------------------------------------------------------------------------------|--------------|-----------------------------|---------------------------|-----------------------------------------------------------|
| OLE Dialog 内存损坏漏洞 - [CVE-2007-0026](http://cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2007-0026) | 远程执行代码 | 重要                        | 重要                      | 重要                                                      |
...
-   [Immunity, Inc.](http://www.immunityinc.com/) 的 Kostya Kortchinsky 和 [EADS Common Research Center](http://www.eads.net/) 的 Fabrice Desclaux 报告了 OLE 内存损坏漏洞 (CVE-2007-0026)。

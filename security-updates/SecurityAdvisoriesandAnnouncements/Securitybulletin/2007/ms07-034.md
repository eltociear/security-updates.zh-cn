...
**Microsoft 基准安全分析器和企业** **更新扫描工具 (EST)**
...
| Windows Vista 中的 Windows Mail                                                                                                         | 否         | 否                     | 请参阅下列 **Windows** **Vista 备注** |
| Windows Vista x64 Edition 中的 Windows Mail                                                                                             | 否         | 否                     | 请参阅下列 **Windows** **Vista 备注** |
...
| Windows Vista 中的 Windows Mail                                                                                                               | 否           | 请参阅下列 **Windows** **Vista 备注** |
| Windows Vista x64 Edition 中的 Windows Mail                                                                                                   | 否           | 请参阅下列 **Windows** **Vista 备注** |

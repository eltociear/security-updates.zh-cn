...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-0077](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0077)。
...
**发布此安全公告时，此漏洞是否已公开披露？**
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2013-0077](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0077)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2780091">Microsoft 知识库文章 2780091</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2780091](http://support.microsoft.com/kb/2780091)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Tencent Security Team](http://security.tencent.com/) 报告了媒体解压缩漏洞 (CVE-2013-0077)

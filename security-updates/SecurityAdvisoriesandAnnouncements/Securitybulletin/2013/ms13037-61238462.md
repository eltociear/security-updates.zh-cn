...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1297](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1297)。
...
**什么是 JSON？**
JSON (JavaScript Object Notation) 是一种开放的、基于文本的数据交换格式（请参阅 [RFC4627](http://www.ietf.org/rfc/rfc4627.txt)）。JSON 类似于 XML，人可识读、平台独立并具备各种实施可用性。根据 JSON 标准格式化的数据都是轻型数据，几乎适用于任何需要将应用程序转换成文本或将结构化信息存储为文本的情形。
...
| 漏洞标题                         | CVE 编号                                                                         |
|----------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer 释放后使用漏洞 | [CVE-2013-0811](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0811) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1306](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1306) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1307](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1307) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1308](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1308) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1309](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1309) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1310](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1310) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1311](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1311) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-1312](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1312) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-2551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-2551) |
| Internet Explorer 释放后使用漏洞 | [CVE-2013-3140](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3140) |
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2829530">Microsoft 知识库文章 2829530</a></td>
</tr>  
<tr class="even">
...
| **文件信息**     | 请参阅 [Microsoft 知识库文章 2829530](http://support.microsoft.com/kb/2829530)                                                     |

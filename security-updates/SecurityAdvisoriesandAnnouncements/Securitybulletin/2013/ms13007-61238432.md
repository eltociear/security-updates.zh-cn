...
**已知问题。**[Microsoft 知识库文章 2769327](http://support.microsoft.com/kb/2769327) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
**安全更新的哈希位于何处？**
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2769327](http://support.microsoft.com/kb/2769327)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-0005](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0005)。
...
-   **在防火墙中屏蔽 OData Web 应用程序端口**
    ...
    OData 端口通常宿主在 TCP 端口 80 和 443，但也可以宿主在其他非标准端口上。评估您的环境并在企业防火墙中屏蔽所有宿主 OData 服务的端口的入站和出站连接有助于保护系统遭受尝试利用此漏洞进行的攻击。我们建议阻止所有来自 Internet 的未经请求的入站通信，以帮助防止可能使用其他端口进行的攻击。有关端口的详细信息，请参阅 TechNet 文章 [TCP 和 UDP 端口分配](http://go.microsoft.com/fwlink/?linkid=21312)。

-   **要求对连接到 IIS 的客户进行身份验证**

    您可以在 IIS 中启用身份验证以阻止未经身份验证的攻击者利用此漏洞。有关如何在您的环境中实施身份验证的信息，请参阅 TechNet 文档中有关您的 IIS 版本部分。
    对于 IIS7，请参阅[在 IIS7 中配置身份验证](http://technet.microsoft.com/en-us/library/cc733010(v=ws.10).aspx)

    对于 IIS6.0，请参阅[IIS6.0 中的集成 Windows 身份验证](http://technet.microsoft.com/en-us/library/cc738016(v=ws.10).aspx)
...
**什么是 OData？**
开放数据 (OData) 协议是一种用于查询和更新数据的 Web 协议，它提供了一种方法来解锁数据并将其从当前应用程序中存在的资源中释放出来。OData 通过应用和构建 Web 技术（例如，[HTTP](http://www.w3.org/protocols/)、[Atom 发布协议](http://www.ietf.org/rfc/rfc4287.txt) (AtomPub) 和 [JSON](http://json.org/)）以提供对各种各样的应用程序、服务和存储中信息的访问来实现此目的。该协议是过去数年来面向各种产品实施 AtomPub 客户端和服务器的体验而产生的。OData 用于暴露和访问各种来源中的信息，包括但不限于关系数据库、文件系统、内容管理系统和传统网站。有关 OData 规范的详细信息，请参阅 [开放数据协议网站](http://www.odata.org/)。

**什么** **是** **管理 OData IIS 扩展** **Web** **服务？
**管理 OData IIS 扩展是一种框架，可通过 IIS 下运行的基于 OData 的 Web 服务轻松暴露 Windows PowerShell cmdlet。有关详细信息，请参阅[创建管理 OData IIS 扩展 Web 服务](http://msdn.microsoft.com/en-us/library/windows/desktop/hh880865(v=vs.85).aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2736416">Microsoft 知识库文章 2736416</a><br />
请参阅 <a href="http://support.microsoft.com/kb/2736428">Microsoft 知识库文章 2736428</a></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2736418">Microsoft 知识库文章 2736418</a><br />
请参阅 <a href="http://support.microsoft.com/kb/2736422">Microsoft 知识库文章 2736422</a><br />
请参阅 <a href="http://support.microsoft.com/kb/2736428">Microsoft 知识库文章 2736428</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2736693">Microsoft 知识库文章 2736693</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2736693">Microsoft 知识库文章 2736693</a><br />
请参阅 <a href="http://support.microsoft.com/kb/2753596">Microsoft 知识库文章 2753596</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">对于 Microsoft .NET Framework 3.5：<br />

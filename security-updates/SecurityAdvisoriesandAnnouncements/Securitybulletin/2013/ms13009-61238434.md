---
TOCTitle: 'MS13-009'
Title: 'Microsoft 安全公告 MS13-009 - 严重'
ms:assetid: 'ms13-009'
ms:contentKeyID: 61238434
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms13-009(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS13-009 - 严重
==================================

Internet Explorer 的累积性安全更新 (2792100)
--------------------------------------------

发布时间: 2013年2月12日 | 更新时间: 2013年5月14日
...
**已知问题。**[Microsoft 知识库文章 2792100](http://support.microsoft.com/kb/2792100) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS12-077](http://go.microsoft.com/fwlink/?linkid=268393) 中的 KB2761465 和 [MS13-008](http://go.microsoft.com/fwlink/?linkid=275222) 中的 KB2799329
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-077](http://go.microsoft.com/fwlink/?linkid=268393) 中的 KB2761465
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
**安** **全更新的**哈希位于何处？
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2792100](https://support.microsoft.com/kb/2792100)。
...
**此** **Internet Explorer 累积安全更新** **MS13-009 是否能** **解决额外安全公告 MS13-008** **中描述的漏洞？**
是。此 Internet Explorer 累积性安全更新可解决 [MS13-008](http://go.microsoft.com/fwlink/?linkid=275222) 中的漏洞。有关此更新取代以前哪些更新的详细信息，请参阅“**受影响和不受影响的软件**”小节中的“**取代的更新**”。

**适用于** **Windows 7 的** **Internet Explorer 10** **Release Preview** **是否受此公告中解决的漏洞的影响？**
是。KB2792100 更新适用于适用于 Windows 7（用于 32 位系统）Service Pack 1 和 Windows 7（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview。鼓励使用适用于 Windows 7（用于 32 位系统）Service Pack 1 和 Windows 7（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview 的客户向其系统应用更新。在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
<th>
Internet Explorer SetCapture 释放后使用漏洞 - CVE-2013-0018
</th>
<th>
Internet Explorer COmWindowProxy 释放后使用漏洞 - CVE-2013-0019
</th>
<th>
Internet Explorer CMarkup 释放后使用漏洞 - CVE-2013-0020
</th>
<th>
Internet Explorer vtable 释放后使用漏洞 - CVE-2013-0021
</th>
<th>
Internet Explorer LsGetTrailInfo 释放后使用漏洞 - CVE-2013-0022
</th>
<th>
Internet Explorer CDispNode 释放后使用漏洞 - CVE-2013-0023
</th>
</tr>
<tr>
...
<th>
Internet Explorer pasteHTML 释放后使用漏洞 - CVE-2013-0024
</th>
<th>
Internet Explorer SLayoutRun 释放后使用漏洞 - CVE-2013-0025
</th>
<th>
Internet Explorer InsertElement 释放后使用漏洞 - CVE-2013-0026
</th>
<th>
Internet Explorer CPasteCommand 释放后使用漏洞 - CVE-2013-0027
</th>
<th>
Internet Explorer CObjectElement 释放后使用漏洞 - CVE-2013-0028
</th>
<th>
Internet Explorer CHTML 释放后使用漏洞 - CVE-2013-0029
</th>
<th>
综合严重等级
</th>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0015)。

#### Shift JIS 字符编码 (CVE-2013-0015) 漏洞的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   在基于 Web 的攻击情形中，攻击者可能拥有一个旨在通过 Internet Explorer 利用这些漏洞的特制网站，然后诱使用户查看该网站。攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。这些网站可能包含可以利用此漏洞的特制内容。但是在所有情况下，攻击者无法强制用户查看由攻击者控制的内容。相反，攻击者必须诱使用户采取行动，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站，或者让用户打开通过电子邮件发送的附件。
...
#### Shift JIS 字符编码漏洞 (CVE-2013-0015) 的变通办法
...
#### Shift JIS 字符编码漏洞 (CVE-2013-0015) 的常见问题
...
| 漏洞标题                                        | CVE 编号                                                                         |
|-------------------------------------------------|----------------------------------------------------------------------------------|
| Internet Explorer SetCapture 释放后使用漏洞     | [CVE-2013-0018](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0018) |
| Internet Explorer COmWindowProxy 释放后使用漏洞 | [CVE-2013-0019](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0019) |
| Internet Explorer CMarkup 释放后使用漏洞        | [CVE-2013-0020](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0020) |
| Internet Explorer vtable 释放后使用漏洞         | [CVE-2013-0021](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0021) |
| Internet Explorer LsGetTrailInfo 释放后使用漏洞 | [CVE-2013-0022](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0022) |
| Internet Explorer CDispNode 释放后使用漏洞      | [CVE-2013-0023](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0023) |
| Internet Explorer pasteHTML 释放后使用漏洞      | [CVE-2013-0024](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0024) |
| Internet Explorer SLayoutRun 释放后使用漏洞     | [CVE-2013-0025](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0025) |
| Internet Explorer InsertElement 释放后使用漏洞  | [CVE-2013-0026](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0026) |
| Internet Explorer CPasteCommand 释放后使用漏洞  | [CVE-2013-0027](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0027) |
| Internet Explorer CObjectElement 释放后使用漏洞 | [CVE-2013-0028](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0028) |
| Internet Explorer CHTML 释放后使用漏洞          | [CVE-2013-0029](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0029) |

#### Internet Explorer 中的多个释放后使用漏洞的缓解因素
...
-   默认情况下，Microsoft Outlook、Microsoft Outlook Express 和 Windows Mail 的所有支持版本在“受限制的站点”区域中打开 HTML 电子邮件。“受限站点”区域（禁用脚本和 ActiveX 控件）可帮助降低攻击者使用这些漏洞执行恶意代码的风险。在基于 Web 的攻击情形中，如果用户单击电子邮件中的链接，他们可能仍然容易受到利用此漏洞的影响。
-   默认情况下，Windows Server 2003、Windows Server 2008、Windows Server 2008 R2 和 Windows Server 2012 上的 Internet Explorer 在一种称为“[增强安全配置](http://technet.microsoft.com/library/dd883248)”的受限模式下运行。此模式可缓解这些漏洞。有关 Internet Explorer 增强安全配置的详细信息，请参阅此漏洞的“常见问题解答”部分。

#### Internet Explorer 中的多个释放后使用漏洞的变通办法
...
#### Internet Explorer 中的多个释放后使用漏洞的常见问题
...
**攻击者如何利用** **这些漏洞？**
攻击者可能拥有一个旨在通过 Internet Explorer 利用这些漏洞的特制网站，然后诱使用户查看该网站。攻击者还可能利用受到破坏的网站以及接受或宿主用户提供的内容或广告的网站。这些网站可能包含可以利用此漏洞的特制内容。但是在所有情况下，攻击者无法强制用户查看由攻击者控制的内容。相反，攻击者必须诱使用户采取行动，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站，或者让用户打开通过电子邮件发送的附件。
...
<p>使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2792100$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie7updates\KB2792100-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie8updates\KB2792100-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2792100">Microsoft 知识库文章 2792100</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2792100$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows 8 所有受支持的 64 位版本的 Internet Explorer 10：<br />
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2792100](http://support.microsoft.com/kb/2792100)                                                                                           |
...
-   Masato Kinugawa 报告了 Shift JIS 字符编码漏洞 (CVE-2013-0015)  
-   [Omair](http://krash.in/) 与 [HP 的](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Internet Explorer SetCapture 释放后使用漏洞 (CVE-2013-0018)  
-   SkyLined 与 [HP 的](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Internet Explorer COmWindowProxy 释放后使用漏洞 (CVE-2013-0019)  
-   Arthur Gerkis 与 Exodus Intelligence 合作报告了 Internet Explorer CMarkup 释放后使用漏洞 (CVE-2013-0020)  
-   [Harmony Security](http://www.harmonysecurity.com) 的 Stephen Fewer 与 [HP 的](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CMarkup 释放后使用漏洞 (CVE-2013-0020)  
-   Tencent PC 经理报告了 Internet Explorer vtable 释放后使用漏洞 (CVE-2013-0021)  
-   [Omair](http://krash.in/) 报告了 Internet Explorer LsGetTrailInfo 释放后使用漏洞 (CVE-2013-0022)  
-   Arthur Gerkis 与 [HP 的](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CDispNode 释放后使用漏洞 (CVE-2013-0023)  
-   一名匿名研究人员与 [HP 的](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Internet Explorer pasteHTML 释放后使用漏洞 (CVE-2013-0024)  
-   [Security-Assessment.com](http://www.security-assessment.com) 的 Scott Bell 报告了 Internet Explorer SLayoutRun 释放后使用漏洞 (CVE-2013-0025)  
-   Yenteasy Security Research 的 Jose A Vazquez 与 Exodus Intelligence 合作报告了 Internet Explorer InsertElement 释放后使用漏洞 (CVE-2013-0026)  
-   IBM X-Force 的 Mark Yason 报告了 Internet Explorer queryCommand 释放后使用漏洞 (CVE-2013-0027)  
-   [Security-Assessment.com](http://www.security-assessment.com) 的 Scott Bell 报告了 Internet Explorer CObjectElement 释放后使用漏洞 (CVE-2013-0028)  
-   Yenteasy Security Research 的 Jose A Vazquez 与 [HP 的](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CObjectElement 释放后使用漏洞 (CVE-2013-0028)  
-   [Harmony Security](http://www.harmonysecurity.com) 的 Stephen Fewer 与 [HP 的](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CHTML 释放后使用漏洞 (CVE-2013-0029)  
-   [Aniway.Aniway@gmail.com](mailto:aniway.aniway@gmail.com) 与 [HP 的](http://www.hpenterprisesecurity.com/products)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Internet Explorer CHTML 释放后使用漏洞 (CVE-2013-0029)  
-   [NCC Group](http://www.nccgroup.com/) 的 Ollie Whitehouse 与我们一起努力处理了此公告中包括的其他纵深防御更改
...
-   V1.1（2013 年 2 月 12 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2792100 添加一个链接。此外，更正了 CVE-2013-0022 的严重等级。这仅仅是一个信息更改。  
-   V1.2（2013 年 5 月 14 日）： 修订此公告是为了宣布一个检测更改，从而纠正 Windows Server 2012 的一个提供问题。这只是检测更改。没有更改安全更新文件。已经成功更新了其系统的客户不需要执行任何操作。

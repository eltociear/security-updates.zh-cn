---
TOCTitle: 'MS13-018'
Title: 'Microsoft 安全公告 MS13-018 - 重要'
ms:assetid: 'ms13-018'
ms:contentKeyID: 61238443
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms13-018(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS13-018 - 重要
==================================

Windows TCP/IP 中的漏洞可能允许拒绝服务 (2790655)
-------------------------------------------------
...
对于 Windows Server 2008、Windows Server 2008 R2 和 Windows Server 2012 的所有受支持版本，此安全更新的等级为“严重”；对于 Windows Vista、Windows 7、Windows 8 和 Windows RT 的所有受支持版本，此安全更新的等级为“中等”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过更正 Windows TCP/IP 堆栈处理连接终止序列的方式来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。**[Microsoft 知识库文章 2790655](http://support.microsoft.com/kb/2790655) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS12-032](http://go.microsoft.com/fwlink/?linkid=246964) 中的 KB2688338
</td>
</tr>
...
**安全更新的哈希位于何处？**
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2790655](https://support.microsoft.com/kb/2790655)。
...
Windows TCP/IP 堆栈中存在一个拒绝服务漏洞，该漏洞可能导致目标系统停止响应和自动重新启动。当 TCP/IP 堆栈不正确地处理连接终止序列时，会导致该漏洞。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-0075](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0075)。

#### TCP FIN WAIT 漏洞 CVE-2013-0075) 的缓解因素

Microsoft 并未发现此漏洞的任何缓解因素

#### TCP FIN WAIT 漏洞 CVE-2013-0075) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### TCP FIN WAIT 漏洞 CVE-2013-0075) 的常见问题

**此漏洞的影响范围有多大？**
这是一个拒绝服务漏洞。

**造成此漏洞的原因是什么？**
当 Windows TCP/IP 堆栈不正确地处理连接终止序列时，会导致该漏洞。

**攻击者可能利用此漏洞执行什么操作？**
成功利用此漏洞的攻击者可能导致目标系统停止响应和自动重新启动。

**攻击者如何利用此** **漏洞？**
未经身份验证的攻击者可能通过向服务器发送特制的连接终止数据包来利用此漏洞。

**受此漏洞威胁最大的系统有哪些？**
服务器受此漏洞的威胁最大.

**此更新有什么作用？**
此更新通过更正 Windows TCP/IP 堆栈处理连接终止序列的方式来解决漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2790655">Microsoft 知识库文章 2790655</a></td>
</tr>  
<tr class="odd">
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2790655](http://support.microsoft.com/kb/2790655)                               |
...
-   V1.1（2013 年 2 月 12 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2790655 添加一个链接。

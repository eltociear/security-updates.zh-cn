...
**已知问题。**[Microsoft 知识库文章 2785220](http://support.microsoft.com/kb/2785220) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-0013](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-0013)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2785220">Microsoft 知识库文章 2785220</a></td>
</tr>  
<tr class="odd">
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2785220](http://support.microsoft.com/kb/2785220)                               |

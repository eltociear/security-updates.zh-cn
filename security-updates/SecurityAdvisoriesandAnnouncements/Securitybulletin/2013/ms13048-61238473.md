...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=156056db-7e3c-484c-b874-a0af7dd4064c)  
(2839229)
</td>
<td style="border:1px solid black;">
信息泄露
...
<tr>
<td style="border:1px solid black;">
[Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=a06d1aa7-2219-4885-a842-2874204860cb)  
(2839229)
</td>
<td style="border:1px solid black;">
信息泄露
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows 8（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=af4fb5f0-30bf-40b1-b36e-9e81148f6708)  
(2839229)
</td>
<td style="border:1px solid black;">
信息泄露
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=156056db-7e3c-484c-b874-a0af7dd4064c)（服务器核心安装）  
(2839229)
</td>
<td style="border:1px solid black;">
信息泄露
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-3136](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-3136)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2839229">Microsoft 知识库文章 2839229</a></td>
</tr>  
<tr class="odd">

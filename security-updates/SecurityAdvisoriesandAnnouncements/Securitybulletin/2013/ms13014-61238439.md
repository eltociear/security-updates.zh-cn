---
TOCTitle: 'MS13-014'
Title: 'Microsoft 安全公告 MS13-014 - 重要'
ms:assetid: 'ms13-014'
ms:contentKeyID: 61238439
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms13-014(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS13-014 - 重要
==================================

NFS 服务器中的漏洞可能允许拒绝服务 (2790978)
--------------------------------------------
...
该安全更新通过更正 NFS 服务器处理文件操作的方式来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**安** **全更新的**哈希位于何处？
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2790978](https://support.microsoft.com/kb/2790978)。
...
<span></span>
Windows NFS 服务器未能正确处理只读共享上的文件操作时，存在一个拒绝服务漏洞。成功利用此漏洞的攻击者可能导致受影响的系统停止响应和重新启动。

要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2013-1281](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2013-1281)。

#### 空解除引用漏洞 (CVE-2013-1281) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须对文件共享具有访问权限才能利用此漏洞。匿名用户无法利用此漏洞。
-   此漏洞仅影响启用了 NFS 角色的 Windows 服务器。

#### 空解除引用漏洞 (CVE-2013-1281) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 空解除引用漏洞 (CVE-2013-1281) 的常见问题

**此漏洞的影响范围有多大？**
这是一个拒绝服务漏洞。

**造成此漏洞的原因是什么？**
当 Microsoft NFS 服务器未能正确处理文件操作时，会导致此漏洞。

**什么是** **NFS？**
网络文件系统 (NFS) 是 [RFC 1094](http://www.ietf.org/rfc/rfc1094.txt?number=1094) 中定义的一种行业标准协议，它跨网络对共享文件提供透明的远程访问。网络文件系统 (NFS) 服务面向具有混合 Windows 和 UNIX 环境的企业提供文件共享解决方案。NFS 服务使用户能够使用 NFS 协议在运行 Windows 操作系统的计算机和基于 UNIX 的计算机之间传输文件。

**攻击者可能利用此漏洞执行什么操作？**
利用此漏洞的攻击者可能会导致受影响系统停止响应和重新启动。

**攻击者如何利用此** **漏洞？**
攻击者可能通过尝试重命名只读共享上的文件或文件夹来利用此漏洞。

**受此漏洞威胁最大的系统有哪些？**
启用了 NFS 服务器角色的服务器均受此漏洞威胁。

**此更新有什么作用？**
该更新通过更正 NFS 服务器处理文件操作的方式来解决漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2790978">Microsoft 知识库文章 2790978</a></td>
</tr>  
<tr class="odd">

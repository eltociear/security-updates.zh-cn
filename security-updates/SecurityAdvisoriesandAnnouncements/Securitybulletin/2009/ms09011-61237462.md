...
<span></span>
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 961373](http://support.microsoft.com/kb/961373) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0084](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0084)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/961373">Microsoft 知识库文章 961373</a></td>
</tr>  
<tr class="even">
...
-   [Kryptos Logic](http://www.kryptoslogic.com/) 的 Piotr Bania 报告了 MJPEG 解压缩漏洞 (CVE-2009-0084)

...
此安全更新与 Microsoft 安全公告 [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) 一起特别发布，描述了使用 Microsoft 活动模板库 (ATL) 的易受攻击版本开发的组件和控件中的漏洞。 作为一种纵深防御措施，对于使用 [Microsoft 安全通报 (973882)](http://technet.microsoft.com/security/advisory/973882) 和 Microsoft 安全公告 [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) 中所述的 ATL 的易受攻击版本开发的组件和控件，此 Internet Explorer 安全更新帮助减轻 Internet Explorer 中的已知攻击媒介的影响。
...
**已知问题。** [Microsoft 知识库文章 972260](http://support.microsoft.com/kb/972260) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法。
...
**为什么特别发布此安全更新？**  
特别发布此安全更新是为了解决 [Microsoft 安全通报 (973882)](http://technet.microsoft.com/security/advisory/973882)“Microsoft 活动模板库 (ATL) 中的漏洞可能允许远程执行代码”中披露的问题。

**此安全公告是否与同样特别发布的 MS09-035 相关？**  
是。 Microsoft 安全公告 [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) 描述了使用活动模板库 (ATL) 的易受攻击公共版本开发的组件和控件中的漏洞。 作为一种纵深防御措施，对于使用 [Microsoft 安全通报 (973882)](http://technet.microsoft.com/security/advisory/973882) 和 MS09-035 中所述的 ATL 版本开发的组件和控件，此安全更新 (MS09-034) 帮助减轻 Internet Explorer 中的已知攻击媒介的影响。

**此安全公告是否与 Microsoft 安全通报 973882 相关？**  
是。 [Microsoft 安全通报 (973882)](http://technet.microsoft.com/security/advisory/973882) 描述活动模板库 (ATL) 的公用和专用版本中的漏洞。 作为一种纵深防御措施，对于使用 [Microsoft 安全通报 (973882)](http://go.microsoft.com/fwlink/?linkid=158131) 和 MS09-035 中所述的 ATL 版本开发的组件和控件，此安全更新 (MS09-034) 减轻 Internet Explorer 中的已知攻击媒介的影响。此安全更新还解决 Internet Explorer 中的三个秘密报告的漏洞。
...
第一项纵深防御措施在默认情况下启用并修改基于 ATL 的 ActiveX 控件读取持久数据的方式。 第一项缓解措施是更改基于 ATL 的 ActiveX 控件读取持久数据的方式（通过检测有问题的特定调用模式）。 这样的一个示例是导致 [MS09-032](http://go.microsoft.com/fwlink/?linkid=157386)（7 月 14 日发布的安全更新之一）解决的 MSVidCtl.dll 漏洞利用的调用模式。  该缓解措施解决 [Microsoft 安全通报 (973882)](http://technet.microsoft.com/security/advisory/973882)和 [MS09-035](http://go.microsoft.com/fwlink/?linkid=158131) 中描述的 ATL 漏洞。该更改在默认情况下对所有受影响的平台启用，并将帮助防止 Internet Explorer 中加载的控件的 ATL 漏洞，包括不是由 Microsoft 创建的控件。

第二项纵深防御措施与第一项措施相关，但是提供更强的保护并增加应用程序兼容风险。 此纵深防御措施在默认情况下禁用，允许在各控件中调节 IPersistStream 和 IPersistStorage\* 接口的使用。 应用程序开发人员和最终用户可以选择对使用 [WebOC](http://msdn.microsoft.com/en-us/library/aa752040(vs.85).aspx) 的应用程序启用此措施，方式是使用新的功能控件注册表项 **FEATURE\_RESTRICT\_OBJECT\_DATA\_ATTRIBUTE**：
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 972260](http://support.microsoft.com/kb/972260) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1917](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1917)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1918](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1918)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1919](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1919)。
...
\*SMS 2.0 和 SMS 2003 支持除 Internet Explorer 7 和 Internet Explorer 8 以外的所有其他受影响的 Internet Explorer 版本。有关详细信息，请参阅 [Microsoft 知识库文章 924178](http://support.microsoft.com/kb/924178)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/972260">Microsoft 知识库文章 972260</a></td>
</tr>  
<tr class="even">
...
-   [VeriSign iDefense Labs](http://labs.idefense.com/) 的 Peter Vreugdenhil 报告了内存损坏漏洞 (CVE-2009-1917)  
-   [team509](http://www.team509.com/) 的 Wushi 和 Ling 与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 合作，报告了 HTML 对象内存损坏漏洞 (CVE-2009-1918)  
-   Peter Vreugdenhil 与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了未初始化的内存损坏漏洞 (CVE-2009-1919)

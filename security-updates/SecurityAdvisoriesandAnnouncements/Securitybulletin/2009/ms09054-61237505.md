...
此安全更新包括一处纵深防御更改，允许 WinINET 使用验证的扩展保护。 有关详细信息，请参阅 [Microsoft 安全通报 973811](http://technet.microsoft.com/security/advisory/973811)。

此更新还包括一处对 Windows 7 和 Windows Server 2008 R2 上的 Internet Explorer 8 的纵深防御更改以解决 [Microsoft 安全通报 973882](http://technet.microsoft.com/security/advisory/973882) 中披露的问题。 对于使用此通报中描述的 ATL 版本开发的组件和控件，这些更改减轻了 Internet Explorer 8 中的已知攻击媒介的影响。

**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 974455](http://support.microsoft.com/kb/974455) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1547](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1547)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2529)。
...
是。 [增强安全配置](http://go.microsoft.com/fwlink/?linkid=92039)是一组预先配置好的 Internet Explorer 设置，可以减小用户或管理员在服务器上下载并运行特制 Web 内容的可能性。 此缓解因素适用于未被添加到 Internet Explorer“受信任的站点”区域的网站。 另请参阅[管理 Internet Explorer 增强安全配置](http://go.microsoft.com/fwlink/?linkid=92055)。

**此更新有什么作用？**  
此更新修改了 Internet Explorer 验证参数的方式。

**发布此安全公告时，此漏洞是否已公开披露？**  
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-2529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2529)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2530)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2531](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2531)。
...
**注意** 从 2009 年 8 月 1 日起，Microsoft 将不再对 Office Update 和 Office Update 清单工具提供支持。 要继续获得 Microsoft Office 产品的最新更新，请使用 [Microsoft Update](http://go.microsoft.com/fwlink/?linkid=40747)。 有关详细信息，请参阅[关于 Office 更新：常见问题](http://office.microsoft.com/en-us/downloads/fx010402221033.aspx)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/974455">Microsoft 知识库文章 974455</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc.](http://www.google.com/) 的 Skylined 报告了数据流标题损坏漏洞 (CVE-2009-1547)  
-   [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 报告了未初始化的内存损坏漏洞 (CVE-2009-2530)  
-   eshu.co.uk 的 Sam Thomas 与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/)一起报告了 未初始化的内存损坏漏洞 (CVE-2009-2531)

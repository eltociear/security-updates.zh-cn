---
TOCTitle: 'MS09-001'
Title: 'Microsoft 安全公告 MS09-001 - 严重'
ms:assetid: 'ms09-001'
ms:contentKeyID: 61237452
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-001(v=Security.10)'
---
...
对于 Microsoft Windows 2000、Windows XP 和 Windows Server 2003 的所有受支持版本，此安全更新的等级为“严重”；对于 Windows Vista 和 Windows Server 2008 的所有受支持版本，此安全更新的等级为“中等”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。

此安全更新通过验证 SMB 数据包中的字段来消除该漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=e0678d14-c1b5-457a-8222-8e7682760ed4)                                                   | 远程执行代码 | 严重         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=eeafcdc5-df39-4b29-b6f1-7d32b64761e1)                                  | 远程执行代码 | 严重         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=26898401-f669-4542-ad93-199ed1fe9a2a)                 | 远程执行代码 | 严重         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=588ca8e8-38a9-47ed-9c41-09aaf1022e49)                | 远程执行代码 | 严重         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ee59441c-1e8f-4425-ae8d-dec14e7f13fb)                         | 远程执行代码 | 严重         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=caec9321-fa5b-42f0-9f26-61f673fe6eef) | 远程执行代码 | 严重         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows Vista 和 Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=9179c463-c10a-452a-990f-b7e37cdd889b)                                           | 远程执行代码 | 中等         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=6b26952e-b59d-4b0f-a52d-025e45ecd233)                                     | 远程执行代码 | 中等         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows Server 2008（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=7245b411-7c9e-41e5-9841-4c586336086c)\*                                                                   | 远程执行代码 | 中等         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows Server 2008（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=a241eaad-95a0-442b-978f-f21a6f0c7db4)\*                                                              | 远程执行代码 | 中等         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
| [Windows Server 2008（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=ab7c7015-20bb-4a0c-977a-969f4e2a5189)                                                            | 远程执行代码 | 中等         | [MS08-063](http://go.microsoft.com/fwlink/?linkid=127994) |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 958687](http://support.microsoft.com/kb/958687) 中找到文件信息详细资料。
...
<th style="border:1px solid black;">SMB 缓冲区溢出远程执行代码漏洞 - CVE-2008-4834</th>
<th style="border:1px solid black;">SMB 验证远程执行代码漏洞 - CVE-2008-4835</th>
<th style="border:1px solid black;">SMB 验证拒绝服务漏洞 - CVE-2008-4114</th>
...
SMB 缓冲区溢出远程执行代码漏洞 - CVE-2008-4834  
----------------------------------------------
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4834](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4834)。
  
#### SMB 缓冲区溢出远程执行代码漏洞 (CVE-2008-4834) 的缓解因素
...
-   Windows Vista 和 Windows Server 2008 不受此漏洞的影响。
  
#### SMB 缓冲区溢出远程执行代码漏洞 (CVE-2008-4834) 的变通办法
...
#### SMB 缓冲区溢出远程执行代码漏洞 (CVE-2008-4834) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个远程执行代码漏洞。 成功利用此漏洞的攻击者可以完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
该漏洞是由于在写入缓冲区之前，Microsoft 服务器消息块 (SMB) 协议软件没有充分验证缓冲区大小导致的。
...
**攻击者如何利用此漏洞？**    
攻击者可能试图通过创建特制的邮件并将其发送到受影响的系统来利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**    
带有 SMB 服务器服务的所有系统均会受此漏洞影响。 域控制器比工作站或其他服务器受此漏洞的威胁更大。
  
**此更新有什么作用？**    
此安全更新通过验证 SMB 数据包中的字段来消除该漏洞。
...
SMB 验证远程执行代码漏洞 - CVE-2008-4835  
----------------------------------------
  
  
Microsoft 服务器消息块 (SMB) 协议软件处理特制 SMB 数据包的方式中存在一个未经身份验证的远程执行代码漏洞。 利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过向运行 Server 服务的计算机发送特制网络消息来利用该漏洞。 成功利用此漏洞的攻击者可以完全控制系统。 利用此漏洞的大多数尝试会导致系统拒绝服务条件，但是远程执行代码在理论上是可行的。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4835](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4835)。
  
#### SMB 验证远程执行代码漏洞 (CVE-2008-4835) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。 在这种情况下，应阻止从 Internet 访问 SMB 端口。  
-   Windows Vista 和 Windows Server 2008 的所有受支持版本在默认情况下禁用文件共享，从而减少了这些平台受此漏洞攻击的风险。 这种默认配置（与较早的平台不同）减少了 Windows Vista 和 Windows Server 2008 的攻击面，因此对于这些平台，此漏洞的严重等级降为“中等”。
  
#### SMB 验证远程执行代码漏洞 (CVE-2008-4835) 的变通办法
...
#### SMB 验证远程执行代码漏洞 (CVE-2008-4835) 的常见问题
...
**受此漏洞威胁最大的系统有哪些？**    
带有 SMB 服务器服务的所有系统均会受此漏洞影响。 域控制器受此漏洞的威胁更大。
...
SMB 验证拒绝服务漏洞 - CVE-2008-4114  
------------------------------------
  
  
Microsoft 服务器消息块 (SMB) 协议软件处理特制 SMB 数据包的方式中存在一个拒绝服务漏洞。 利用该漏洞的尝试不要求进行身份验证，从而使攻击者可以通过向运行 Server 服务的计算机发送特制网络消息来利用该漏洞。 成功利用此漏洞的攻击者可能会导致计算机停止响应和重新启动。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2008-4114](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4114)。
  
#### SMB 验证拒绝服务漏洞 (CVE-2008-4114) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。 在这种情况下，应阻止从 Internet 访问 SMB 端口。  
-   Windows Vista 和 Windows Server 2008 的所有受支持版本在默认情况下禁用文件共享，从而减少了这些平台受此漏洞攻击的风险。 此默认配置与较早的平台相比有变化，减小了 Windows Vista 和 Windows Server 2008 的攻击面。
  
#### SMB 验证拒绝服务漏洞 (CVE-2008-4114) 的变通办法
...
#### SMB 验证拒绝服务漏洞 (CVE-2008-4114) 的常见问题
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2008-4114](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2008-4114)。
...
<td style="border:1px solid black;">Microsoft Windows 2000 Service Pack 4：<br />
使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB958687$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/958687">Microsoft 知识库文章 958687</a></td>
</tr>  
<tr class="even">
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“添加或删除程序”工具或 %Windir%\\$NTUninstallKB958687$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/958687">Microsoft 知识库文章 958687</a></td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\\$NTUninstallKB958687$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/958687">Microsoft 知识库文章 958687</a></td>
...
-   一名匿名研究人员与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 SMB 缓冲区溢出远程执行代码漏洞 (CVE-2008-4834)  
-   一名匿名研究人员与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 SMB 验证远程执行代码漏洞 (CVE-2008-4835)

---
TOCTitle: 'MS09-058'
Title: 'Microsoft 安全公告 MS09-058 - 重要'
ms:assetid: 'ms09-058'
ms:contentKeyID: 61237509
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-058(v=Security.10)'
---
...
此安全更新通过确保 Windows 内核正确截断 64 位值、确保 Windows 内核正确验证可执行程序中的数据和确保 Windows 内核清除错误情况下的异常来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=bdfa6583-28a2-4d6b-91d2-157a8518b664)                                 | 特权提升     | 重要         | [MS07-022](http://go.microsoft.com/fwlink/?linkid=85165)  |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=cece4c55-0756-4357-9d2d-6709e8426068)                | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5459b7d4-1fab-4a04-ab9d-b8323505c1e2)                    | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1e3f3842-f8fd-4969-a2cf-706db38d7580)                                    | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=95286b8d-4b53-4e6c-af59-e9e18fad3559)                        | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=faef714b-5f46-47f2-bea7-881df05a1bc0)                    | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Vista 和 Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=acf6f3e6-282e-4f05-9060-8d0ebb874b97)                         | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=acf6f3e6-282e-4f05-9060-8d0ebb874b97)                                          | 拒绝服务     | 中等         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=13a3fe0b-e300-4568-aa08-d586ab8d5434) | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=13a3fe0b-e300-4568-aa08-d586ab8d5434)                              | 拒绝服务     | 中等         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2008（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=71aec6f6-a36b-465e-8885-b094dfd30423)\*                               | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=71aec6f6-a36b-465e-8885-b094dfd30423)\*                 | 拒绝服务     | 中等         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2008（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=88f4189f-71fe-404a-869e-3f76692acf94)\*                          | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=88f4189f-71fe-404a-869e-3f76692acf94)\*            | 拒绝服务     | 中等         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2008（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c)                        | 特权提升     | 重要         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3e0f0b1c-ca5d-43fc-9770-73396a5f191c)          | 拒绝服务     | 中等         | [MS08-064](http://go.microsoft.com/fwlink/?linkid=128103) |
...
<tr class="header">
<th>受影响的软件</th>
<th>Windows 内核整数下溢漏洞 - CVE-2009-2515</th>
<th>Windows 内核空指针解除引用漏洞 - CVE-2009-2516</th>
<th>Windows 内核异常处理程序漏洞 - CVE-2009-2517</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
Windows 内核整数下溢漏洞 - CVE-2009-2515  
----------------------------------------
  
  
Windows 内核中存在特权提升漏洞的原因是由于不正确地将 64 位至截断为 32 位值。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2515)。
  
#### Windows 内核整数下溢漏洞 (CVE-2009-2515) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。  
-   在 32 位系统上，只有在系统使用物理地址扩展 (PAE) 时才触发此漏洞。
  
#### Windows 内核整数下溢漏洞 (CVE-2009-2515) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核整数下溢漏洞 (CVE-2009-2515) 的常见问题解答
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核不正确地将 64 位至截断为 32 位值。 这导致以后从另一值提取值时出现整数下溢。
  
**什么是 Windows 内核？**    
Windows 内核是操作系统的核心。 它提供设备管理和内存管理等系统级服务，为进程分配处理器时间，并管理错误处理。
  
**什么是物理地址扩展 (PAE)？**    
PAE 是 Intel 提供的内存地址扩展，它能够支持大多数 32 位 (IA-32) Intel Pentium Pro 和更高版本平台大于 4 GB 的物理内存。 尽管支持 PAE 内存通常与支持大于 4 GB 的 RAM 相关联，但在 Windows XP SP2、Windows Server 2003 和更高的 Windows 32 位版本上仍可以启用 PAE，以支持硬件增强的[数据执行保护 (DEP)](http://www.microsoft.com/technet/prodtechnol/winxppro/maintain/sp2mempr.mspx)。 有关 PAE 的详细信息，请参阅文章[物理地址扩展 - PAE 内存和 Windows](http://www.microsoft.com/whdc/system/platform/server/pae/paedrv.mspx)。
...
**此更新有什么作用？**    
此更新通过确保 Windows 内核正确地截断 64 位值来解决漏洞。
...
Windows 内核空指针解除引用漏洞 - CVE-2009-2516  
----------------------------------------------
  
  
Windows 内核中存在一个由于未充分验证从用户模式传递的某些数据而产生特权提升漏洞。 成功利用此漏洞的攻击者可以运行内核模式中的任意代码。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2516](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2516)。
  
#### Windows 内核空指针解除引用漏洞 (CVE-2009-2516) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须能够将特制的应用程序放在系统上才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核空指针解除引用漏洞 (CVE-2009-2516) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核空指针解除引用漏洞 (CVE-2009-2516) 的常见问答解答
  
**此漏洞的影响范围有多大？**    
这是一个特权提升漏洞。 成功利用此漏洞的攻击者可执行任意代码，并可完全控制受影响的系统。 攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
  
**造成漏洞的原因是什么？**    
Windows 内核未正确验证从用户模式传递的某些数据。
...
**攻击者如何利用此漏洞**    
要利用此漏洞，攻击者应首先将一个特制的应用程序放在目标系统上。 如果用户浏览该特制应用程序所在的目录，这便足以利用漏洞并完全控制受影响的系统。 用户不需要为此执行应用程序即可被控制。 用户只需浏览特制应用程序所在的目录即可。
  
攻击者还可以把特制应用程序放在网络共享上。 在此情况下，如果用户浏览网络共享，特制的应用程序即可导致系统停止响应并重新启动。 用户不需要为此执行应用程序即可被控制。 用户只需浏览特制应用程序所在的网络共享即可。
  
**受此漏洞威胁最大的系统有哪些？**    
工作站和终端服务器受到的威胁最大。 如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。 不过，最佳做法是不要授予这样的权限。
  
**此更新有什么作用？**    
此更新通过确保 Windows 内核正确地验证可执行程序中的数据来解决漏洞。
...
Windows 内核异常处理程序漏洞 - CVE-2009-2517  
--------------------------------------------
  
  
Windows 内核中存在拒绝服务漏洞的原因是由于内核处理特定异常的方式而导致。 攻击者可以通过运行导致系统重新启动的特制应用程序来利用该漏洞。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2517](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2517)。
  
#### Windows 内核异常处理程序漏洞 (CVE-2009-2517) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。 匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
  
#### Windows 内核异常处理程序漏洞 (CVE-2009-2517) 的变通办法
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### Windows 内核异常处理程序漏洞 (CVE-2009-2517) 的常见问题解答
...
**此更新有什么作用？**    
此更新通过确保 Windows 内核在错误情况下清除指针来解决漏洞。
...
| **部署**                         |                                                                                                                       |  
| 没有用户干预的安装               | Windows2000-kb971486-x86-enu /quiet                                                                                   |  
| 在不重新启动的情况下安装         | Windows2000-kb971486-x86-enu /norestart                                                                               |  
| 更新日志文件                     | kb971486.log                                                                                                          |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节                                                                                  |  
| **重新启动要求**                 |                                                                                                                       |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                                |  
| HotPatching                      | 不适用                                                                                                                |  
| **删除信息**                     | 使用控制面板中的“**添加或删除程序**”工具或 %Windir%\\$NTUninstallKB971486$\\Spuninst 文件夹中的 Spuninst.exe 实用程序 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 971486](http://support.microsoft.com/kb/971486)                                          |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB971486\\Filelist                             |
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”工具或 %Windir%\$NTUninstallKB971486$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/971486">Microsoft 知识库文章 971486</a></td>
</tr>  
<tr class="even">
...
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Updates\ Windows Server 2003\SP3\KB971486\Filelist</td>
</tr>
</tbody>
</table>
...
-   [Google Inc.](http://www.google.com/) 的 Tavis Ormandy 和 Neel Mehta 报告了 Windows 内核整数下溢漏洞 (CVE-2009-2515)  
-   [NSFocus Security Team](http://www.nsfocus.com/) 报告了 Windows 内核空指针解除引用漏洞 (CVE-2009-2516)  
-   [Google Inc.](http://www.google.com/) 的 Tavis Ormandy 和 Neel Mehta 报告了 Windows 内核异常处理程序漏洞 (CVE-2009-2517)

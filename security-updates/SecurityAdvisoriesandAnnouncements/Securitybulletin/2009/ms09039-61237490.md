...
|-----------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Server Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=b5b9228a-66c0-49e6-afde-cc2825a6851f)       | 远程执行代码 | 严重         | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=3a8d8ef9-ad41-4237-9cbb-daecfd8f216c)                 | 远程执行代码 | 严重         | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=e132d051-4444-4ef1-9b6f-2d7da9d2e88e)     | 远程执行代码 | 严重         | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=96c3f496-7b2f-4dbc-b484-216c9943c2b1) | 远程执行代码 | 严重         | [MS09-008](http://go.microsoft.com/fwlink/?linkid=139821) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1923](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1923)。
...
**什么是 WINS？**    
WINS 专门为支持 TCP/IP (NetBT) 上的 NetBIOS 而设计的协议。 用户在其中访问具有 NetBIOS 名称的资源的任何环境都需要 WINS。 如果不在此类网络中使用 WINS，除非您使用 Lmhosts 文件，否则无法使用其 NetBIOS 名称连接到远程网络资源，且可能无法建立文件和打印共享连接。 有关详细信息，请参阅 [WINS](http://technet.microsoft.com/en-us/library/cc784180.aspx) TechNet 文章。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1924](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1924)。
  
#### WINS 整数溢出漏洞 (CVE-2009-1924) 的缓解因素
  
缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。 以下缓解因素在您遇到的情形中可能会有所帮助：
  
-   在默认配置中，该攻击只能从受信任的 WINS 复制伙伴成功进行。 但是，如果注册表项“HKLM\\System\\CCS\\Services\\WINS\\Parameteres\\RplOnlyWCnfPnrs”被设为 0，那么网络上的任何人都可以利用该漏洞。 有关此注册表项及其用法的完整说明，请参阅 [KB251067](http://support.microsoft.com/kb/251067)。  
-   默认情况下，WINS 不会安装在任何受影响的操作系统版本上。 仅手动安装此组件的客户可能受到此问题的影响。  
-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。 按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。  
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 969883](http://support.microsoft.com/kb/969883)                                          |  
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969883">Microsoft 知识库文章 969883</a></td>
</tr>  
<tr class="even">
...
-   TippingPoint 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 报告了 WINS 堆溢出漏洞 (CVE-2009-1923)
-   [National University of Defense Technology](http://english.nudt.edu.cn/) 的 LiGen 报告了 WINS 整数溢出漏洞 (CVE-2009-1924)

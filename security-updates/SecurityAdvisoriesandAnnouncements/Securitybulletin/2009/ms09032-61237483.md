...
此安全更新也解决了 [Microsoft 安全通报 972890](http://technet.microsoft.com/security/advisory/972890) 中最初描述的漏洞。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=89d941f0-3f71-46e3-8096-716561396b72)                                                                           | 无           | None\*\*     | 无                                                        |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=24701af8-b87e-4e85-9463-f50755a1b6ad)                                                          | 远程执行代码 | 严重         | [MS08-032](http://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=2cbf3699-7f79-4006-99e9-0a4c0d394c48)                                                              | 远程执行代码 | 严重         | [MS08-032](http://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b0a458d6-c34c-41c7-964a-c130cfcb0d01)                                                                              | 远程执行代码 | 中等         | [MS08-032](http://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8b7a7bb0-80ef-4f25-bc70-3d0ac06007c5)                                                                  | 远程执行代码 | 中等         | [MS08-032](http://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=7be36edf-02af-402f-983a-f9ca8128b6b5)                                                              | 远程执行代码 | 中等         | [MS08-032](http://go.microsoft.com/fwlink/?linkid=116368) |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6c90240e-c201-4dad-9835-ea71e3527b45)                                     | 无           | None\*\*     | 无                                                        |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d2084e8d-212b-4c39-9163-a71ec6d1b1c7) | 无           | None\*\*     | 无                                                        |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2\*](http://www.microsoft.com/downloads/details.aspx?familyid=0194f994-5821-4fb9-b9e1-ed6af248c995)                   | 无           | None\*\*     | 无                                                        |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2\*](http://www.microsoft.com/downloads/details.aspx?familyid=4127b125-fdaa-489a-a80c-14b5647ac7e0)         | 无           | None\*\*     | 无                                                        |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4082c776-318c-4e0c-83fc-2f3f472c039a)   | 无           | None\*\*     | 无                                                        |
...
[Microsoft 安全通报 972890](http://technet.microsoft.com/security/advisory/972890)描述了阻止 Microsoft Video ActiveX 控件在 Internet Explorer 中运行的变通办法。 客户可以手动应用此变通办法，也可以自动使用 [Microsoft 知识库文章 972890](http://support.microsoft.com/kb/972890)中的“Microsoft 修复”解决方案来启用此变通办法。 使用任何一种方法应用此变通办法的客户不需要安装此安全更新。
...
在安装此更新之前，无论是手动应用此变通办法，还是自动使用 [Microsoft 知识库文章 972890](http://support.microsoft.com/kb/972890) 中的“Microsoft 修复”解决方案启用此变通办法，客户均不需要撤消 [Microsoft 安全通报 972890](http://technet.microsoft.com/security/advisory/972890) 中所述的变通办法。

**如果我安装此更新，然后撤消 Microsoft 安全通报 972890 中的变通办法，会发生什么情况？**  
在这种情况下，Windows Vista 和 Windows Server 2008 的客户安装此安全更新用于纵深防御，然后手动撤消 [Microsoft 安全通报 972890](http://technet.microsoft.com/security/advisory/972890) 中的变通办法，或者自动使用 [Microsoft 知识库文章 972890](http://support.microsoft.com/kb/972890) 中的“Microsoft 修复”解决方案禁用此变通办法。 这些客户将无法再阻止 Microsoft Video ActiveX 控件在 Internet Explorer 中运行，他们的系统也会很容易受到攻击。 此外，将不会再向这些系统提供此更新，因为未来的检测结果将使变通办法撤消的安装成功。

**ActiveX Kill Bit 的此累积性安全更新是否包含 Microsoft 安全通报 973472 中描述的 kill bit？ **
否，此更新不包含 [Microsoft 安全通报 973472](http://technet.microsoft.com/security/advisory/973472) 中描述的用于阻止 Office Web Components (OWC) 库在 Internet Explorer 中运行的 kill bit。要设置那些 kill bit，请遵循该通报的“变通办法”部分中的指导。

**ActiveX Kill Bit 的此累积性安全更新包含什么 kill bit？**  
ActiveX Kill Bit 的此累积性安全更新包含先前在 [MS08-023](http://technet.microsoft.com/security/bulletin/ms08-023)“ActiveX Kill Bit 的安全更新”、[MS08-032](http://technet.microsoft.com/security/bulletin/ms08-032)“ActiveX Kill Bit 的累积性安全更新”以及标题为“ActiveX Kill Bit 的更新汇总”的通报 [Microsoft 安全通报 953839](http://technet.microsoft.com/security/advisory/953839)、[Microsoft 安全通报 956391](http://technet.microsoft.com/security/advisory/956391)、[Microsoft 安全通报 960715](http://technet.microsoft.com/security/advisory/960715) 和 [Microsoft 安全通报 969898](http://technet.microsoft.com/security/advisory/969898) 中发布所有 kill bit。

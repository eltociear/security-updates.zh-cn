---
TOCTitle: 'MS09-056'
Title: 'Microsoft 安全公告 MS09-056 - 重要'
ms:assetid: 'ms09-056'
ms:contentKeyID: 61237507
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-056(v=Security.10)'
---
...
此安全更新通过将 CryptoAPI 修改为拒绝包含空终结符的证书名称，并正确验证 ASN.1 对象标识符来解决这些漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=52b9198d-b65f-467a-a5ab-141e23d64a86)                                                                           | 欺骗         | 重要         | [MS04-007](http://go.microsoft.com/fwlink/?linkid=20067) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=9c5ab624-e37b-418a-a919-d8f652b15679)                                                          | 欺骗         | 重要         | 无                                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ad29696d-4611-4a12-9dfa-74fa6866b759)                                                              | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=49e9cc53-cf17-4bc7-aaaa-92213167e1a9)                                                                              | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d170cef9-f5d2-4fcd-997b-e778ad5a6797)                                                                  | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=2ede1eb9-7f5f-411d-bbc3-5db46d80e0bb)                                                              | 欺骗         | 重要         | 无                                                       |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8b5a9a95-9439-40c8-acef-000b919daa04)                                     | 欺骗         | 重要         | 无                                                       |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4a60f789-1a4a-49a8-8d13-fda989ed40be) | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f9b487af-fe73-42a8-b240-d59c4321f95b)\*                   | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0d8a2a3e-d7d4-47fb-8364-16fce28e4d38)\*         | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8962f0b6-f346-4e88-9d83-4d15b699dd9d)   | 欺骗         | 重要         | 无                                                       |
| [Windows 7（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=ad6f06d5-27db-445d-a8b2-c42adc90afc0)                                                                                     | 欺骗         | 重要         | 无                                                       |
| [Windows 7（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=70cd0270-77e9-492a-82d9-798364640c10)                                                                                | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=ce78c019-ec08-4ec6-abec-334f5ec5cb76)\*                                                                 | 欺骗         | 重要         | 无                                                       |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=6442a77a-3c0d-4beb-b2d2-2885376c2135)                                                               | 欺骗         | 重要         | 无                                                       |
...
<tr class="header">
<th>受影响的软件</th>
<th>X.509 公用名中的空截断漏洞 - CVE-2009-2510</th>
<th>X.509 对象标识符中的整数溢出漏洞 - CVE-2009-2511</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
X.509 公用名中的空截断漏洞 - CVE-2009-2510  
------------------------------------------
  
<span></span>  
当分析 X.509 证书中的 ASN.1 信息时，Microsoft Windows CryptoAPI 组件中存在一个欺骗漏洞。 成功利用此漏洞的攻击者可模拟其他用户或系统。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2510](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510)。
  
#### X.509 公用名中的空截断漏洞的缓解因素 - CVE-2009-2510
  
Microsoft 并未发现此漏洞的任何缓解因素。
  
#### X.509 公用名中的空截断漏洞的变通方法 - CVE-2009-2510
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### X.509 公用名中的空截断漏洞的相关常见问题 - CVE-2009-2510
  
**此漏洞的影响范围有多大？**    
这是欺骗漏洞。 当攻击者结合其他特定的攻击（如 DNS 欺骗）时，可能会成功欺骗使用 CryptoAPI 的任何应用程序所在的网站的数字证书。
  
**造成漏洞的原因是什么？**    
Windows CryptoAPI 会错误地将空终结符分析为由对象标识符 (OID) 标识的任何值的末尾。 这会导致 CryptoAPI 仅分析部分实际值。 当此部分值对最终用户有意义时，就可能出现攻击者模拟其他用户或系统的情形。
  
**什么是 Windows CryptoAPI？**   
通过 CryptoAPI 提供的服务，应用程序开发人员可使用数字证书来添加数据、身份验证的加密/解密，并对基于 Windows 的应用程序中的 抽象语法表示法 1 (ASN.1) 进行编码和解码。 应用程序开发人员无需了解基本实施的详情便可使用 CryptoAPI 中的功能，这与无需了解特定的图形硬件配置便可使用图形库非常相似。 CryptoAPI 可与许多执行实际加密功能的加密服务提供程序协同工作
  
**什么是 ASN.1？**   
Abstract Syntax Notation 1 (ASN.1) 是 IT 行业中许多应用程序和设备所使用的一种数据标准，可以使用它来标准化和理解各种平台中的数据。 ASN.1 与任何特定的标准、编码方法、编程语言或硬件平台都没有直接的关系。 它仅仅是一种用于定义标准的语言；具体标准已写入 ASN.1。
  
有关 ASN.1 的更多信息可在 [Microsoft 知识库文章 252648](http://support.microsoft.com/kb/252648) 中找到。
...
**什么是对象标识符 (OID)？**   
对象标识符 (OID) 是由不同颁发机构颁发的数值，用于唯一地标识数据元素、语法及分布式应用程序的其他部分。 OID 存在于 OSI 应用程序、X.500 目录、SNMP 及其他强调唯一性的应用程序中。 OID 基于树状结构，在此结构中，一个高级颁发机构（如 ISO）将树的分支分配到子机构，然后由子机构进一步分配分支。
  
**什么是空终结符？**   
空终结符是数字为零的字符。 在某些编程语言中（如 C 语言），它将用作保留字符来标示字符串的结尾。
  
**攻击者可能利用此漏洞执行什么操作？**    
攻击者可模拟其他用户或系统。 利用 CryptoAPI 分析该数据的应用程序可能向用户返回信息，导致用户做出错误的信任选择。
  
**攻击者如何利用此漏洞**    
攻击者可通过诱使客户端信任的证书颁发机构签署公用名 (CN) 字段中包含空终结符的证书来滥用此漏洞。 然后，攻击者可建立流氓网站，向 Windows 计算机提供此证书。 此时，计算机会错误地分析公用名字段并向用户提供错误的信任信息。
  
**受此漏洞威胁最大的系统有哪些？**    
浏览 HTTPS 网站或将 X.509 用作证书（例如，用于保护电子邮件会话）的客户端受此漏洞的威胁最大。
  
**此更新有什么作用？**    
此安全更新通过将 CryptoAPI 修改为拒绝包含空终结符的证书名称来消除该漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-2510](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2510)。
  
**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**    
否。 在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已被公开用于攻击客户的信息，也没有看到任何发布的概念代码证明示例。
  
X.509 对象标识符中的整数溢出漏洞 - CVE-2009-2511  
------------------------------------------------
  
<span></span>  
当分析 X.509 证书中的 ASN.1 信息时，Microsoft Windows CryptoAPI 对象标识符中存在一个欺骗漏洞。 成功利用此漏洞的攻击者可模拟其他用户或系统。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2511](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511)。
  
#### X.509 对象标识符中的整数溢出漏洞的缓解因素 - CVE-2009-2511
  
Microsoft 并未发现此漏洞的任何缓解因素。
  
#### X.509 对象标识符中的整数溢出漏洞的变通方法 - CVE-2009-2511
  
Microsoft 并未发现此漏洞的任何变通办法。
  
#### X.509 对象标识符中的整数溢出漏洞的相关常见问题 - CVE-2009-2511
  
**此漏洞的影响范围有多大？**    
这是欺骗漏洞。 当攻击者结合其他特定的攻击（如 DNS 欺骗）时，可能会成功欺骗使用 CryptoAPI 的任何应用程序所在的网站的数字证书。
  
**造成漏洞的原因是什么？**    
当分析来自 X.509 证书的公用名 (CN) 等 ASN.1 对象标识符时，Windows CryptoAPI 存在一个整数溢出漏洞。 攻击者可生成一个会被 Windows CryptoAPI 错误分析的恶意证书，从而让攻击者可以模拟其他用户或系统。
...
**什么是对象标识符 (OID)？**    
对象标识符 (OID) 是由不同颁发机构颁发的唯一数值，用于唯一地标识数据元素、语法及分布式应用程序的其他部分。 OID 存在于 OSI 应用程序、X.500 目录、SNMP 及其他强调唯一性的应用程序中。 OID 基于树状结构，在此结构中，一个高级颁发机构（如 ISO）将树的分支分配到子机构，然后由子机构进一步分配分支。
  
**攻击者可能利用此漏洞执行什么操作？**    
攻击者可模拟其他用户或系统。 利用 CryptoAPI 分析该数据的应用程序可能向用户返回信息，导致用户做出错误的信任选择。
  
**攻击者如何利用此漏洞**    
攻击者可通过诱使客户端信任的证书颁发机构，签署包含错误格式对象标识符的证书来滥用此漏洞。 然后，攻击者可建立流氓网站，向 Windows 客户端提供此证书。 然后，此客户端应用程序会错误地分析公用名字段，并向用户提供错误的信任信息。
  
**受此漏洞威胁最大的系统有哪些？**    
浏览 HTTPS 网站或将 X.509 用作证书（例如，用于保护电子邮件会话）的客户端应用程序受此漏洞的威胁最大。
  
**此更新有什么作用？**    
此安全更新通过使 CryptoAPI 正确验证 ASN.1 对象标识符来消除漏洞。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-2511](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2511)。
...
| **部署**                         |                                                                                                                       |  
| 没有用户干预的安装               | Windows2000-kb974571-x86-enu /quiet                                                                                   |  
| 在不重新启动的情况下安装         | Windows2000-kb974571-x86-enu /norestart                                                                               |  
| 更新日志文件                     | kb974571.log                                                                                                          |  
| 更多信息                         | 请参阅“**检测和部署工具及指导**”小节                                                                                  |  
| **重新启动要求**                 |                                                                                                                       |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                                |  
| HotPatching                      | 不适用                                                                                                                |  
| **删除信息**                     | 使用控制面板中的**“添加或删除程序”**工具或 %Windir%\\$NTUninstallKB974571$\\Spuninst 文件夹中的 Spuninst.exe 实用程序 |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 974571](http://support.microsoft.com/kb/974571)                                          |  
| **注册表项验证**                 | HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Updates\\Windows 2000\\SP5\\KB974571\\Filelist                             |
...
<td style="border:1px solid black;">使用控制面板中的<strong>“添加或删除程序”</strong>工具或 %Windir%\\$NTUninstallKB974571$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/974571">Microsoft 知识库文章 974571</a></td>
</tr>  
<tr class="even">
...
<br />  
对于 Windows 7 所有受支持的基于 x64 的版本：<br />
...
-   [Citrix](http://www.citrix.com/) 的 Ian Wright 和 Jean-Luc Giraud 与我们合作解决 X.509 公用名中的空截断漏洞 (CVE-2009-2510)  
-   [IOActive](http://www.ioactive.com/) 的 Dan Kaminsky 报告了 X.509 公用名中的空截断漏洞 (CVE-2009-2510) 以及 X.509 对象标识符中的整数溢出漏洞 (CVE-2009-2511)

---
TOCTitle: 'MS09-059'
Title: 'Microsoft 安全公告 MS09-059 - 重要'
ms:assetid: 'ms09-059'
ms:contentKeyID: 61237510
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms09-059(v=Security.10)'
---
...
此安全更新通过为身份验证过程中使用的特定值集实施附加验证来解决漏洞。 有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。** [Microsoft 知识库文章 975467](http://support.microsoft.com/kb/975467) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。 本文还介绍了这些问题的建议解决办法
...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e997ea40-668e-40df-bd50-0ca53437b375)\*                                                        | 拒绝服务     | 重要         | 无               |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=17008892-7950-44c4-850d-002c8d73495f)\*                                                            | 拒绝服务     | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9dff4662-7771-4bdc-87ec-7899d79b3a55)\*                                                                            | 拒绝服务     | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8df7a2d9-2f97-4f18-84e8-415a1632cf09)\*                                                                | 拒绝服务     | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=83c77015-7f96-4c0d-bd56-60aef90ea2f8)\*                                                            | 拒绝服务     | 重要         | 无               |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=04ae306b-0d0d-4767-ab54-cc11aec477ed)                                     | 拒绝服务     | 重要         | 无               |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=58c995ca-f308-4e07-8e60-2e542384d95d) | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f2f617c2-f149-4e9b-bfdd-08ed0f3f99db)\*\*                 | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=deb84cb8-2ba3-47e3-9185-2bbc5b0a7e18)\*\*       | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=abc94857-37d8-4bb8-ad9e-46e687fca40e)   | 拒绝服务     | 重要         | 无               |
| [Windows 7（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=35b85783-90df-4f67-a3cb-02351432133e)                                                                                     | 拒绝服务     | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=97010f2c-6c10-4fda-84fd-6c8749968db5)                                                                                | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=597ac3a7-e02d-49a5-9b8e-d097e867acea)\*\*                                                               | 拒绝服务     | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=4aac0e3e-9b49-4a4a-ab17-707ff03b4d9b)                                                               | 拒绝服务     | 重要         | 无               |

\***<sup>[2]</sup>**该操作系统仅在安装了 KB968389“对身份验证的扩展保护”（请参阅 [Microsoft 安全通报 973811](http://support.microsoft.com/kb/973811)）时才受影响。 有关详细信息，请参阅**与此安全更新相关的常见问题 (FAQ)** 中的该条目。
...
**哪些系统会受到此漏洞的影响？ **
此漏洞影响 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 系统。 此外，还影响安装了实施扩展保护的 KB968389 非安全更新的 Windows XP 和 Windows Server 2003。

**如果我未安装过 KB968389，我的计算机是否容易受到攻击？** 
未安装 JB968389 的 Windows XP 和 Windows Server 2003 的受支持版本不受影响。 未安装 KB968389 的 Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本容易受到攻击。

**为什么我通过 Windows Update 或 Microsoft Update 只获得 KB968389？** 
如果您在此安全更新发布之后通过 Windows Update 或 Microsoft Update 获取 KB968389，将自动安装安全更新 KB975467。 成功安装 KB968389 之后，KB968389 和 MS09-059 安全更新 KB975467 将作为已安装的软件列出。

如果您在此安全更新发布之前安装 KB968389，Windows Update 和 Microsoft Update 将提供 KB975467 安全更新以解决该漏洞。
...
<tr class="header">
<th>受影响的软件</th>
<th>本地安全机构子系统服务整数溢出漏洞 - CVE-2009-2524</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
**\*该操作系统仅在安装了 KB968389“对身份验证的扩展保护”（请参阅** [**Microsoft 安全通报 973811**](http://support.microsoft.com/kb/973811)**）时才受影响。** 有关详细信息，请参阅**与此安全更新相关的常见问题 (FAQ)** 中的该条目。
  
**\*\*服务器核心安装受到影响。** 此更新适用于 Windows Server 2008 和 Windows Server 2008 R2 的受支持版本，严重等级相同，无论是否使用“服务器核心”安装选项进行了安装。 有关此安装选项的详细信息，请参阅 MSDN 文章[服务器核心](http://msdn.microsoft.com/en-us/library/ms723891(vs.85).aspx)和[适用于 Windows Server 2008 R2 的服务器核心](http://msdn.microsoft.com/en-us/library/ee391631(vs.85).aspx)。 注意，服务器核心安装选项不适用于 Windows Server 2008 和 Windows Server 2008 R2 的某些版本；请参阅[比较服务器核心安装选项](http://www.microsoft.com/windowsserver2008/en/us/compare-core-installation.aspx)。
  
本地安全机构子系统服务整数溢出漏洞 - CVE-2009-2524  
--------------------------------------------------
  
  
由于 NTLM 身份验证期间格式错误的数据包的处理不正确，Microsoft Windows 本地安全机构子系统服务 (LSASS) 中存在一个特权提升漏洞。 攻击者可能创建特制的匿名 NTLM 身份验证请求，从而可能导致 LSASS 服务中出现崩溃，之后重新启动计算机。
  
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2524](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2524)。
  
#### 本地安全机构子系统服务整数溢出漏洞 (CVE-2009-2524) 的缓解因素
  
Microsoft 并未发现此漏洞的任何缓解因素。
  
#### 本地安全机构子系统服务整数溢出漏洞 (CVE-2009-2524) 的变通办法
  
变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。 Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：
  
-   **从 Windows XP 或 Windows Server 2003 计算机卸载 KB968389**
  
    1.  依次单击**“开始**”、“**控制面板**”和“**添加或删除程序**”。  
    2.  选择**KB968389**，然后单击**卸载**。
  
    **变通办法的影响。**禁用此 KB 后，Windows XP 和 Windows Server 2003 计算机将不会从针对身份验证的扩展保护中受益。
  
    **如何撤销变通办法。**通过从 [Microsoft 知识库文章 936389](http://support.microsoft.com/default.aspx/kb/968389?wa=wsignin1.0) 下载适用于您操作系统的安装包来安装 KB968389。
...
#### 本地安全机构子系统服务整数溢出漏洞 (CVE-2009-2524) 的常见问题
  
**此漏洞的影响范围有多大？**    
这是一个拒绝服务漏洞。 特制的身份验证帧可能允许未经身份验证的攻击者导致服务器端 LSASS 进程停止响应并重新启动计算机。
  
**造成漏洞的原因是什么？**    
漏洞的存在是因为 LSASS 中的 Windows NTLM 实施在身份验证过程中无法正确处理特定格式错误的数据包所致。 特定格式错误的数据包可能导致 LSASS 过程中出现整数下溢。
  
**什么是 LSASS？**   
本地安全机构子系统服务 (LSASS) 提供一个用于管理本地安全、域身份验证和 Active Directory 服务进程的接口。 它处理客户端和服务器的身份验证。 它还包含一些用于支持 Active Directory 实用工具的功能。
...
**攻击者可能利用此漏洞执行什么操作？**    
成功利用此漏洞的攻击者可能导致受影响的系统自动重新启动。
  
**攻击者如何利用此漏洞**    
攻击者可通过在 NTLM 身份验证过程中发送一个恶意制造的数据包来利用此漏洞。
  
**受此漏洞威胁最大的系统有哪些？**    
允许客户端通过 NTLM 进行验证的服务器受此威胁。
  
**此更新有什么作用？**    
此更新可确保 LSASS 正确处理身份验证过程中所使用的特定值。
  
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 已公开披露此漏洞的有限相关信息。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-2524](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2524)。
...
<td style="border:1px solid black;">使用控制面板中的<strong>“添加或删除程序”</strong>工具或 %Windir%\$NTUninstallKB975467$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/975467">Microsoft 知识库文章 975467</a></td>
</tr>  
<tr class="even">
...
<strong>注意</strong> 通过停止本地安全机构子系统服务，安装更新，然后重新启动本地安全机构子系统服务，可避免 Windows Server 2003 重新启动系统。 如果在安装更新之前未停止本地安全颁发机构子系统服务，则仍需要重新启动系统。</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;">HotPatching</td>
...
<br />  
对于 Windows Server 2008 R2 所有受支持的基于 Itanium 的版本：<br />

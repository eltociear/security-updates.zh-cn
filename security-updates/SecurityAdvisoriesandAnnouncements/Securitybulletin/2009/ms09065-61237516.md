...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=45db8bb1-c81b-4d3f-a658-74f5fa445f81)                                                                           | 远程执行代码 | 严重         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=916abdad-44b7-4f9d-986a-0c3558fb8e06)                                                          | 远程执行代码 | 严重         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=1d0464c6-5ed8-4064-887e-618a2db09236)                                                              | 远程执行代码 | 严重         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5cd62750-e269-44ae-8c7c-c335e8545b9a)                                                                              | 远程执行代码 | 严重         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=04a7f817-f330-4003-8b25-d3e744905b12)                                                                  | 远程执行代码 | 严重         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=b95daac0-4c99-47a4-b0ca-9429997ea3d9)                                                              | 远程执行代码 | 严重         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Vista、Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=54562103-1d99-42d7-8f7f-c0cbcdce90db)                                     | 特权提升     | 重要         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Vista x64 Edition、Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=fcb87cc8-6fd7-4f16-93d6-552999462fb1) | 特权提升     | 重要         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=b97d48de-0f6d-4bca-b990-acf543fdb8b7)\*                   | 特权提升     | 重要         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=0e2b8607-10fa-406a-96a5-18290f479c48)\*         | 特权提升     | 重要         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=28eba3f3-99a5-424c-bc8d-a718c716699e)   | 特权提升     | 重要         | [MS09-025](http://go.microsoft.com/fwlink/?linkid=150248) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-1127](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1127)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2513](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2513)。
...
**什么是 GDI？**    
Microsoft Windows 图形设备接口 (GDI) 允许应用程序在视频显示和打印机上使用图形和格式化文本。 基于 Windows 的应用程序不直接访问图形硬件。 而是 GDI 代表应用程序与设备驱动程序进行交互。 有关 GDI 的详细信息，请参阅 MSDN 文章 [Windows GDI](http://msdn.microsoft.com/en-us/library/dd145203(vs.85).aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-2514](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-2514)。
...
-   **禁用对分析 Internet Explorer 中的嵌入字体的支持**
    ...
    **注意** 要使用自动化“Microsoft 修复”解决方案来启用或禁用此变通办法，请参阅 [Microsoft 知识库文章 969947](http://support.microsoft.com/kb/969947)。
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 969947](http://support.microsoft.com/kb/969947)                                          |  
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/969947">Microsoft 知识库文章 969947</a></td>
</tr>  
<tr class="even">
...
-   [Google Inc.](http://www.google.com/) 的 Tavis Ormandy 报告了 Win32k EOT 分析漏洞 (CVE-2009-2514)

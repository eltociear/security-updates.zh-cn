...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|-----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=98bb7d40-89a0-470a-8eb7-06f15072a635)                                                                     | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows XP Service Pack 2 和 Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=e09641ba-6cbe-4095-82b5-703d3a7dc33b)                                                    | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows XP Professional x64 Edition 和 Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d0d704c6-48c2-4907-b6c3-2455d7cf21c8)                 | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2003 Service Pack 1 和 Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f5cfb8da-e7cc-4183-8631-507c2a406500)                                  | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2003 x64 Edition 和 Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ecf75c70-8489-41ad-9759-3a07e13957be)                         | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2003 SP1（用于基于 Itanium 的系统）以及 Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=04be3d7e-7dda-4dca-887a-e7a8156ede1c) | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Vista 和 Windows Vista Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4b1aaaba-f355-4265-83c0-50b901856ced)                                                             | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Vista x64 Edition 和 Windows Vista x64 Edition Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0fcac480-d6db-4a94-8c7d-b7319282cf56)                                     | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2008（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=38851df2-4fb5-4d28-9d15-181c260cf8cf)\*                                                                   | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2008（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=ec15acc4-3e0f-4414-9383-61c122ff1382)\*                                                              | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
| [Windows Server 2008（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=eead6f93-10fd-4492-8137-481d9876a5fe)                                                            | 远程执行代码 | 严重         | [MS08-061](http://go.microsoft.com/fwlink/?linkid=121738) |
...
**在哪里可以找到文件信息详细资料？**  
可以在 [Microsoft 知识库文章 958690](http://support.microsoft.com/kb/958690) 中找到文件信息详细资料。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0081](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0081)。
...
**什么是 GDI？**    
Microsoft Windows 图形设备接口 (GDI) 允许应用程序在视频显示和打印机上使用图形和格式化文本。 基于 Windows 的应用程序不直接访问图形硬件。 而是 GDI 代表应用程序与设备驱动程序进行交互。 有关 GDI 的详细信息，请访问 [Windows GDI 起始页](http://msdn.microsoft.com/en-us/library/dd145203(vs.85).aspx)。
...
有关图像类型和格式的详细信息，请参阅 [Microsoft 知识库文章 320314](http://support.microsoft.com/kb/320314)。有关这些文件格式的其他信息，请访问 [MSDN 技术资源库网站](http://msdn2.microsoft.com/en-us/library/ms536391.aspx)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0082](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0082)。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0083](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0083)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/958690">Microsoft 知识库文章 958690</a></td>
</tr>  
<tr class="even">
...
-   Helmut Buhler (<http://home.arcor.de/clipboarder/>) 报告了 Windows 内核输入验证漏洞 (CVE-2009-0081)  
-   [SkyRecon](http://www.skyrecon.com/) 的 Thomas Garnier 报告了 Windows 内核句柄验证漏洞 (CVE-2009-0082)

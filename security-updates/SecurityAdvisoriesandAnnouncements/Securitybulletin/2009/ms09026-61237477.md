...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|----------------------------------------------------------|
| [Microsoft Windows 2000 Service Pack 4](http://www.microsoft.com/downloads/details.aspx?familyid=155a79c1-e5e4-4f62-b4b0-53aca59f20ac)                                                                         | 特权提升     | 重要         | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows XP Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40)                                                                                     | 特权提升     | 重要         | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=f033fa78-c451-44f8-aa6c-a49622c37f40)                                                                                     | 特权提升     | 重要         | 无                                                       |
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=20734b70-37f1-47dd-bc09-d56f93577a55)                                                            | 特权提升     | 重要         | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=62bb9e22-4f4b-4ffc-ba76-f626e94c79d5)                                                                            | 特权提升     | 重要         | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=888b8dd8-d76c-42f5-a377-1f1750d3cf56)                                                                | 特权提升     | 重要         | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=3084f46e-02b9-4d99-a7a1-033817f9bd9f)                                                            | 特权提升     | 重要         | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Vista](http://www.microsoft.com/downloads/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214)                                                                                                 | 特权提升     | 重要         | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Vista Service Pack 1 和 Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ca227c0-f2dd-429c-a542-e08e93527214)                                                  | 特权提升     | 重要         | 无                                                       |
| [Windows Vista x64 Edition](http://www.microsoft.com/downloads/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd)                                                                                     | 特权提升     | 重要         | [MS07-058](http://go.microsoft.com/fwlink/?linkid=91031) |
| [Windows Vista x64 Edition Service Pack 1 和 Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=188adafe-1feb-46ad-b237-a88d35104dcd)                          | 特权提升     | 重要         | 无                                                       |
| [Windows Server 2008（用于 32 位系统）和 Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=eaa26c6c-5bf7-4099-bb21-1e03de3a25ca)\*                 | 特权提升     | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 x64 的系统）和 Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=447aaa4f-946b-4f23-b151-dcf46ea9f80e)\*       | 特权提升     | 重要         | 无                                                       |
| [Windows Server 2008（用于基于 Itanium 的系统）和 Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=f33012b9-5d5b-4f72-8d49-a8e1c8bc1337) | 特权提升     | 重要         | 无                                                       |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2009-0568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568)。
...
IDL 文件为在客户端和服务器之间传输的信息指定一份网络合同。 保持该信息与操作环境相关的信息的不同，可使 IDL 文件移植到其他环境。 IDL 文件由两部分组成： [界面标题](http://msdn.microsoft.com/en-us/library/aa378711(vs.85).aspx)和[界面正文](http://msdn.microsoft.com/en-us/library/aa378710(vs.85).aspx)。
  
ACF 指定只影响本地性能（而非网络合同）的属性。 Microsoft RPC 允许您在一个 IDL 文件中结合 ACF 和 IDL 属性。 您也可以在一个 IDL 文件及其 ACF 中结合多个界面。 有关详细信息，请参阅 MSDN 文章，[IDL 和 ACF 文件](http://msdn.microsoft.com/en-us/library/aa378708(vs.85).aspx)。
  
**什么是进程间通信 (IPC)？**    
Microsoft Windows 操作系统提供机制以促进应用程序之间的通信和数据共享。 总的来说，这些机制启用的活动就称为进程间通信 (IPC)。 有些类型的 IPC 可以促进多个专业化过程之间的分工。 有些类型的 IPC 可以促进网络上计算机间的分工。 有关详细信息，请参阅 MSDN 文章 [进程间通信](http://msdn.microsoft.com/en-us/library/aa365574(vs.85).aspx)。
...
**发布此安全公告时，此漏洞是否已公开披露？**    
是。 此漏洞已公开披露。 已为此漏洞分配常见漏洞和披露号码 [CVE-2009-0568](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-0568)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/970238">Microsoft 知识库文章 970238。</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/??????">Microsoft 知识库文章 970238。</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>

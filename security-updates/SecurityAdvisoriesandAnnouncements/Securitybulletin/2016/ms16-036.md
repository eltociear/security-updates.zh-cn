---
TOCTitle: 'MS16-036'
Title: 'Microsoft 安全公告 MS16-036 - 严重'
ms:assetid: 'ms16-036'
ms:contentKeyID: 72464176
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms16-036(v=Security.10)'
---

MSRC ppDocument 模板

Microsoft 安全公告 MS16-036 - 严重
==================================

Adobe Flash Player 安全更新程序 (3144756)
-----------------------------------------
...
有关此更新程序的详细信息，请参阅 [Microsoft 知识库文章 3144756](https://support.microsoft.com/zh-cn/kb/3144756)。

漏洞信息
--------

此安全更新程序修复了 Adobe 安全公告 [APSB16-08](https://helpx.adobe.com/cn/security/products/flash-player/apsb16-08.html) 中描述的漏洞。
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/zh-cn/download/details.aspx?id=51482)  
(3144756)
...
<td style="border:1px solid black;">
[MS16-022](https://technet.microsoft.com/zh-cn/library/security/ms16-022) 中的 3135782
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/zh-cn/download/details.aspx?id=51481)  
(3144756)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/zh-cn/download/details.aspx?id=51483)  
(3144756)
...
<td style="border:1px solid black;">
[Adobe Flash Player](https://www.microsoft.com/zh-cn/download/details.aspx?id=51480)  
(3144756)
...
<sup>[2]</sup>适用于 Windows 10 更新的 Adobe FlashPlayer 更新程序通过 [Windows 更新](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-cn)或通过[Microsoft 更新目录](http://catalog.update.microsoft.com/v7/site/home.aspx)提供。

**注意** Windows Server Technical Preview 4 受到影响。综合严重等级为“严重”，影响等级为“中等”，远程执行代码。我们建议运行此操作系统的客户应用此更新程序（可通过 [Windows 更新](http://update.microsoft.com/microsoftupdate/v6/vistadefault.aspx?ln=zh-cn)获取此更新程序）。
...
-   **将您信任的站点添加到 Internet Explorer 的“受信任的站点”区域**
    ...
    **注意** 添加您相信不会在您的系统上执行恶意操作的任何站点。特别是，您可能需要添加两个站点：**\*.windowsupdate.microsoft.com** 和 **\*.update.microsoft.com**。这是为您提供更新程序的站点，它需要使用 ActiveX 控件来安装更新程序。
...
-   V1.0（2016 年 3 月 10 日）：公告已发布。

*页面生成时间：2016-03-10 13:50-08:00。*

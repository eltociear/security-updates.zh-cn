...
-   Microsoft Office 2000 Service Pack 3 – [下载此更新 (KB923274)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=e0c7e1e4-7859-4c7e-898e-1cf05014885b)
    ...
    -   Microsoft Word 2000
-   Microsoft Office XP Service Pack 3 – [下载此更新 (KB923273)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=958ee063-d88d-4e45-8555-4d1c4730f5c8)
    ...
    -   Microsoft Word 2002
-   Microsoft Office 2003 Service Pack 1 或 Service Pack 2 - [下载此更新 (KB923272)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=0d399f68-ec0d-4768-9846-b16b3dadf247)
...
-   Microsoft Project 2000 Service Release 1 - [下载此更新 (KB923274)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=266a9870-cd03-45ca-877b-b5ad2c873fe5)
-   Microsoft Project 2002 Service Pack 1 – [下载此更新 (KB923273)](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=a77dea18-d237-4bb0-9464-ce31b6ae52d6)
-   Microsoft Visio 2002 Service Pack 2 – [下载此更新 (KB923273)](http://www.microsoft.com/downloads/details.aspx?familyid=fd4b7660-0fc5-43e5-9683-b6dae96136bb)
-   Microsoft Office 2004 for Mac - [下载此更新 (KB924999)](http://www.microsoft.com/mac/)
-   Microsoft Office v. X for Mac - [下载此更新 (KB924998)](http://www.microsoft.com/mac/)
...
|----------------------------------------------------------------------------------------------------------------------|--------------|-----------------------|---------------------|-----------------------|----------------------------------------------------------------|
| Office 不正确的内存访问漏洞 - [CVE-2006-3434](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434)       | 远程执行代码 | 严重                  | 重要                | 重要                  | 重要                                                           |
| Office 格式错误的图表记录漏洞 - [CVE-2006-3650](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650)     | 远程执行代码 | 严重                  | 重要                | 重要                  | 重要                                                           |
| Office 格式错误的记录内存损坏漏洞 - [CVE-2006-3864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864) | 远程执行代码 | 严重                  | 重要                | 重要                  | 重要                                                           |
| Microsoft Office 智能标记分析漏洞 - [CVE-2006-3868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3868) | 远程执行代码 | 无                    | 重要                | 重要                  | 无                                                             |
...
**我正在更新管理安装点，发现存在两个 .msp。 为什么？**  修补程序检测逻辑的限制使我们有必要拥有两个单独的修补程序。 这些因为要更新的文件 mso.dll 承载的产品太多，如果我们针对所有产品使用单个 .MSP，则 MSP 中的检测逻辑对于我们的检测工具而言过大，以致于无法使用。 我们正积极地解决此限制。

**管理安装点列出了 mso.msp 和 pvmso.msp。我是否需要安装这两个程序包？**  是，mso.msp 针对大部分 Office 产品，例如 Word 和 Excel。 而 pvmso.msp 针对其他 Office 产品，例如 Visio、Project 和 OneNote。 为确保安全，您需要同时安装这两个程序包。
...
|-------------------------------------------------------------------------|-----------------------|-------------------------------------------------------------------------------|-----------------------|----------------------------------------------------------------|
| [**MS06-048**](http://technet.microsoft.com/security/bulletin/ms06-048) | 已替代                | 已替代                                                                        | 已替代                | 已替代                                                         |
...
1.  [下载 Office 2000](http://download.microsoft.com/download/5/a/a/5aa36269-5b5a-4597-b91d-a0e213f656e3/office2000-kb923274-fullfile-enu.exe) 和/或 [Project 2000 Service Pack 1](http://download.microsoft.com/download/0/0/f/00f68131-54bc-4e69-bfb7-fd66170cc33d/project2000-kb923274-fullfile-enu.exe) 的安全更新。
...
1.  [下载 Office XP](http://download.microsoft.com/download/4/8/4/4842fc39-5d06-4eeb-8293-ac84074106ac/officexp-kb923273-fullfile-enu.exe) 和/或 [Project 2002 Service Pack 1](http://download.microsoft.com/download/0/6/7/067865cf-7805-4933-bc3c-f9ed874e008e/officexp-kb923273-fullfile-enu.exe) 和/或 [Visio Service Pack 2](http://download.microsoft.com/download/e/3/0/e30ee874-8089-4bb9-bb44-a655e5e1017f/visio2002-kb923273-fullfile-enu.exe) 的安全更新。
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
1.  [下载 Office 2003 的安全更新。](http://download.microsoft.com/download/0/a/c/0ac9daa9-5d89-4613-a28e-de1e0c39c22d/office2003-kb923272-fullfile-enu.exe)
2.  单击“**将该程序保存到磁盘**”，然后单击“**确定**”。
3.  单击“**保存**”。
4.  在 Windows 资源管理器中，找到包括已保存文件的文件夹，然后双击这个已保存的文件。
5.  如果系统提示您安装更新，则单击“**是**”。
...
-   [Fortinet Inc.](http://www.fortinet.com/) 的 Dejun Meng 报告了 Office Office 不正确的内存访问漏洞 - [CVE-2006-3434](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3434)
-   Arnaud Dovi 与 [TippingPoint](http://www.tippingpoint.com/) 和 [Zero Day Initiative](http://www.zerodayinitiative.com/) 一起报告了 Office 格式错误的图表记录漏洞 - [CVE-2006-3650](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3650)
-   [Nevis Labs](http://www.nevisnetworks.com/) 的 Sowhat 报告了 Office 格式错误的记录内存损坏漏洞 - [CVE-2006-3864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-3864)

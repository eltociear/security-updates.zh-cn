...
**注意事项：** Microsoft 发布此更新是为了补充 [Microsoft 安全公告 MS06-021： Internet Explorer 的累积性安全更新 (916281)](http://technet.microsoft.com/security/bulletin/ms06-021) 中包含的更新。 我们建议您同时安装这两个更新程序，因为该公告中的安全更新可能暴露此漏洞或导致应用程序兼容性问题。
...
-   Microsoft Windows 2000 Service Pack 4 上的 Microsoft JScript 5.1 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=23e79abd-b1fe-4734-b3d3-fb53d286c06f)
-   安装在 Windows 2000 Service Pack 4 上的 Microsoft JScript 5.6 和 5.5 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=16dd21a1-c4ee-4eca-8b80-7bd1dfefb4f8)
-   Microsoft Windows XP Service Pack 1 和 Microsoft Windows XP Service Pack 2 上的 Microsoft JScript 5.6 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=d28c02be-cac3-4579-9b93-939fd5d3cde6)
-   Microsoft Windows XP Professional x64 Edition 上的 Microsoft JScript 5.6 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?familyid=2ee3dd28-7167-4a2c-941d-a236f8cc5c4b)
-   Microsoft Windows Server 2003 和 Microsoft Windows Server 2003 Service Pack 1 上的 Microsoft JScript 5.6 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?displaylang=zh-cn&familyid=8963ae25-2230-47fe-aece-49d7457d96d4)
-   Microsoft Windows Server 2003（用于基于 Itanium 的系统）和 Microsoft Windows Server 2003 SP1（用于基于 Itanium 的系统）上的 Microsoft JScript 5.6 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?familyid=7764c7dc-a7e4-4b91-95c2-ef7d4dce0a00)
-   Microsoft Windows Server 2003 x64 Edition 上的 Microsoft JScript 5.6 — [下载此更新](http://www.microsoft.com/downloads/details.aspx?familyid=bcf7ab2e-ee1c-45f9-8b1c-4b1cef683082)
...
|-------------------------------------------------------------------------------------------------------------------|--------------|-----------------------|--------------|---------------------------|---------------------------|---------------------|------------------------------------|
| Microsoft JScript 内存损坏漏洞 - [CVE-2006-1313](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-1313) | 远程执行代码 | 严重                  | 严重         | 严重                      | 严重                      | 中等                | 中等                               |
...
JScript 是 Microsoft 实现 ECMA 262 语言规格 (ECMAScript Edition 3) 的方式。 JScript 是一种解释型的、基于对象的脚本语言。 有关详细信息，请参阅[产品文档](http://msdn.microsoft.com/library/en-us/dnanchor/html/scriptinga.asp)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
否。 Microsoft 发布此更新是为了补充 [Microsoft 安全公告 MS06-021： Internet Explorer 的累积性安全更新 (916281)](http://technet.microsoft.com/security/bulletin/ms06-021) 中包含的更新。 建议同时安装这两个更新程序，因为该公告中的安全更新可能暴露此漏洞或导致应用程序兼容性问题。

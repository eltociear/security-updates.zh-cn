...
<td style="border:1px solid black;">
[MS11-083](http://go.microsoft.com/fwlink/?linkid=229071) 中的 KB2588516 由 KB2688338 替代
</td>
</tr>
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0174](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0174)。
...
**默认出站防火墙策略是什么？**
配置默认出站防火墙策略以允许来自主机的所有出站网络通信。为阻止不需要的出站网络通信，客户需要创建防火墙规则来阻止通信。有关添加出站防火墙规则的详细信息，请参阅 TechNet 文章[创建可阻止不需要的出站网络通信的规则](http://technet.microsoft.com/en-us/library/cc732306(v=ws.10).aspx)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0179](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179)。
...
**发布此安全公告时，此漏洞是否已公开披露？**
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-0179](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0179)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2688338">Microsoft 知识库文章 2688338</a></td>
</tr>  
<tr class="odd">
...
-   [INFIGO IS](http://www.infigo.hr/) 的 Bojan Zdrnja 报告了 Windows 防火墙绕过漏洞 (CVE-2012-0174)  
-   [Genesys Telecommunications](http://www.genesyslab.com/) 的 Anatoliy Glagolev 与我们合作处理了 TCP/IP 双重释放漏洞 (CVE-2012-0179)

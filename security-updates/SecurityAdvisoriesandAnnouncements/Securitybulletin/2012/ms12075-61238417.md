...
<td style="border:1px solid black;">
[MS12-055](http://go.microsoft.com/fwlink/?linkid=257907)中的 KB2731847 由 KB2761226 替代
</td>
</tr>
...
是。KB2761226 更新适用于 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。仅在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2530](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2530)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2553](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2553)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2897](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2897)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2761226">Microsoft 知识库文章 2761226</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2761226](http://support.microsoft.com/kb/2761226)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2761226](http://support.microsoft.com/kb/2761226)                                     |
...
-   [Google Inc](http://www.google.com) 的 Matthew Jurczyk 报告了 Windows 内核 win32k.sys 释放后使用漏洞 (CVE-2012-2553)  
-   [Documill](http://www.documill.com) 的 Eetu Luodemaa 和 Joni Vähämäki 与 Chromium Security Rewards Program 合作报告了 TrueType 字体分析漏洞 (CVE-2012-2897)

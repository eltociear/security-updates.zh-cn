...
**已知问题。**[Microsoft 知识库文章 2661637](http://support.microsoft.com/kb/2661637) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Service Pack 3](http://www.microsoft.com/downloads/details.aspx?familyid=32e5c9ad-b610-4afb-b6f0-bb0b5fbdd1f6) | 远程执行代码 | 重要         | 无               |
...
是的，此安全更新解决的 Indeo 编解码器不安全库加载漏洞 (CVE-2010-3138) 与 [Microsoft 安全通报 2269637](http://technet.microsoft.com/security/advisory/2269637) 中介绍的漏洞类别有关，其影响应用程序加载外部库的方式。此安全更新针对这种漏洞的特定实例。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2010-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138)。
...
**什么是 Indeo 编解码器？**  
Indeo 编解码器是为在 Windows Media Player 等应用程序中使用而将数字媒体文件解压缩的编解码器。有关编解码器的详细信息，请参阅 [编解码器： 常见问题](http://windows.microsoft.com/en-us/windows7/codecs-frequently-asked-questions)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2010-3138](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2010-3138)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2661637">Microsoft 知识库文章 2661637</a></td>
</tr>  
<tr class="even">

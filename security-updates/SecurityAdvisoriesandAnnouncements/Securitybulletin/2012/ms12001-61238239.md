...
**已知问题。**[Microsoft 知识库文章 2644615](http://support.microsoft.com/kb/2644615) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------|--------------|------------------|
| [Windows XP Professional x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=46386269-6e37-4710-bfef-cedfe60d881c)                                                                  | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2003 Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=9cdfc0fe-8f43-4e13-8a1f-2b48ff9ff472)                                                                                  | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2003 x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=4e5783aa-6847-404c-9b75-621fa14ebbb8)                                                                      | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2003 SP2（用于基于 Itanium 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=cdf8208c-d55b-428f-bdd3-26e291dfb08d)                                                                  | 安全功能绕过 | 重要         | 无               |
| [Windows Vista Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=44eeb0a2-ae17-4971-8a7e-e25b260c582c)                                                                                        | 安全功能绕过 | 重要         | 无               |
| [Windows Vista x64 Edition Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=79ceba86-59a1-4138-a5de-8df20ad81b02)                                                                            | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=5ab87c6c-5802-4454-bce4-12501e5b816d)\*                                                               | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=726ff17e-ac90-4832-91e7-46f71ad2f868)\*                                                          | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008（用于基于 Itanium 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ba2c3d57-1bdd-44f2-9233-86c7ea6f0ddb)                                                        | 安全功能绕过 | 重要         | 无               |
| [Windows 7（用于 32 位系统）和 Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=0ee22036-b7f4-40f5-8f40-a77e8faf48b2)                                             | 安全功能绕过 | 重要         | 无               |
| [Windows 7（用于基于 x64 的系统）和 Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=7444e20c-9821-4c91-9779-2728c537dd6a)                                   | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 x64 的系统）和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=4c73a16d-e9fa-48de-9dca-a6360ce3d029)\*       | 安全功能绕过 | 重要         | 无               |
| [Windows Server 2008 R2（用于基于 Itanium 的系统）和 Windows Server 2008 R2（用于基于 Itanium 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=1cc14ee8-f035-4bfc-bf38-33c6b9a2e776) | 安全功能绕过 | 重要         | 无               |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0001](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0001)。
...
-   只能使用由 Microsoft Visual C++ .NET 2003 编译的软件应用程序才能利用此漏洞。
    ...
    **注意** 有关如何确定编译特定的软件应用程序所使用的产品方面的帮助，请参阅 [Microsoft 知识库文章 2644615](http://support.microsoft.com/kb/2644615)。
...
-   **启用** **结构化异常处理覆盖保护 (SEHOP)**
    ...
    对于 Windows Vista、Windows 7、Windows Server 2008 以及 Windows Server 2008 R2 系统，请参阅 [如何在 Windows 操作系统中启用结构化异常处理覆盖保护 (SEHOP)](http://support.microsoft.com/kb/956607)，了解有关为现有应用程序启用 SEHOP 的说明。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2644615">Microsoft 知识库文章 2644615</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2644615](http://support.microsoft.com/kb/2644615)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Accuvant LABS](http://www.accuvant.com/) 的 Joshua J. Drake 报告了 Windows 内核 SafeSEH 绕过漏洞 (CVE-2012-0001)

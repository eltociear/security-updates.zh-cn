---
TOCTitle: 'MS12-069'
Title: 'Microsoft 安全公告 MS12-069 - 重要'
ms:assetid: 'ms12-069'
ms:contentKeyID: 61238411
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-069(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-069 - 重要
==================================

Kerberos 中的漏洞可能允许拒绝服务 (2743555)
-------------------------------------------

发布时间: 2012年10月9日 | 更新时间: 2013年5月29日
...
该安全更新通过更正 Microsoft Kerberos 实施处理特制会话的方式来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
<td style="border:1px solid black;">
[MS11-013](http://go.microsoft.com/fwlink/?linkid=208523) 中的 KB2425227 由 KB2743555 替代
</td>
</tr>
...
**安全更新的哈希位于何处？**
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 KB2743555](http://support.microsoft.com/kb/2743555)。
...
<th>
Kerberos 空解除引用漏洞 - CVE-2012-2551
</th>
<th>
综合严重等级
</th>
...
当 Microsoft Kerberos 实施无法正确处理特制会话时，存在一个拒绝服务漏洞。成功利用此漏洞的攻击者可能导致系统停止响应和重新启动。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2551](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2551)。

#### Kerberos 空解除引用漏洞 (CVE-2012-2551) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   采用防火墙最佳做法和标准的默认防火墙配置，有助于保护网络免受从企业外部发起的攻击。按照最佳做法，应使连接到 Internet 的系统所暴露的端口数尽可能少。

#### Kerberos 空解除引用漏洞 (CVE-2012-2551) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### Kerberos 空解除引用漏洞 (CVE-2012-2551) 的常见问题

**此漏洞的影响范围有多大？**
这是一个拒绝服务漏洞。利用此漏洞的攻击者可能导致重新启动受影响的系统。请注意，此漏洞不允许攻击者执行代码或提升其用户权限。

**造成此漏洞的原因是什么？**
当 Microsoft Windows 中的 Microsoft Kerberos 实施无法正确处理特制会话时，会导致该漏洞。
...
**攻击者如何利用此** **漏洞？**
远程攻击者可以通过向 Kerberos 服务器发送特制会话请求来利用此漏洞。

**受此漏洞威胁最大的系统有哪些？**
工作站和服务器受此漏洞的威胁最大。

**此更新有什么作用？**
该更新通过更正 Microsoft Kerberos 实施处理特制会话的方式来解决漏洞。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2743555">Microsoft 知识库文章 2743555</a></td>
</tr>  
<tr class="odd">
...
-   V1.1 （2013 年 5 月 29 日）： 针对基于 x64 位版本 Windows Server 2008 R2 更正了“受影响的软件”表中的更新取代条目，这仅仅是一个公告更改。检测逻辑或安全更新文件未发生更改。

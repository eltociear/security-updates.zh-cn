...
<td style="border:1px solid black;">
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539631 由 KB2633880 替代  
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 由 KB2633870 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539633 由 KB2633874 替代  
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 由 KB2633870 替代
</td>
</tr>
<tr>
...
<td style="border:1px solid black;">
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539634 由 KB2633879 替代  
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 由 KB2633870 替代
</td>
</tr>
<tr class="alternateRow">
...
<td style="border:1px solid black;">
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539635 由 KB2633873 替代  
[MS11-069](http://go.microsoft.com/fwlink/?linkid=221537) 中的 KB2539636 由 KB2633870 替代
</td>
</tr>
<tr>
...
|------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| Windows Developer Preview 上的 Microsoft .NET Framework 3.5                                          | [Microsoft 知识库文章 2633877](http://support.microsoft.com/kb/2633877) |
| Windows Developer Preview 上的 Microsoft .NET Framework 4.5                                          | [Microsoft 知识库文章 2633869](http://support.microsoft.com/kb/2633869) |
| Windows Server 2008、Windows 7 和 Windows Server 2008 R2 上的 Microsoft .NET Framework 4.5 Developer | [Microsoft 知识库文章 2638804](http://support.microsoft.com/kb/2638804) |
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0014](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0014)。
...
-   默认情况下，部分受信任的 ASP.NET 应用程序不被授予 Socket Permission。因此，在服务器端方案中，在信任级别为中等或更低级别的 ASP.NET 应用程序中无法利用此漏洞，除非管理员为这些应用程序明确授予了 SocketPermission。有关 ASP.NET 信任级别的详细信息，请参阅 MSDN 文章 [ASP.NET 信任级别和策略文件](http://msdn.microsoft.com/en-us/library/wyts434y.aspx)。
...
在 Web 主机情形中，成功利用此漏洞的攻击者可以获得与 Microsoft .NET 应用程序运行所在应用程序池的应用程序池标识关联服务帐户相同的权限。根据应用程序池隔离配置以及授予服务帐户的权限，攻击者可能能够控制 Web 服务器上的其他应用程序池，或者能够完全控制受影响的系统。有关应用程序池标识和配置的详细信息，请参阅 TechNet 文章“[配置应用程序池标识](http://technet.microsoft.com/en-us/library/cc781986(ws.10).aspx)”。
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。

**发布此安全公告时，Microsoft 是否收到任何有关此漏洞已被利用的报告？**  
否。在最初发布此安全公告时，Microsoft 未收到任何表明此漏洞已公开用于攻击用户的信息。

**应用此安全更新是否有助于客户防止可能会尝试利用此漏洞的已公开发布的代码？**  
是。此安全更新将消除可能使用已发布的概念证明代码利用的漏洞。已为消除的漏洞分配了常见漏洞和披露号码 [CVE-2012-0015](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0015)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2651026">Microsoft 知识库文章 2651026</a></td>
</tr>  
<tr class="odd">
...
-   [Sumatra](http://www.sumatra.nl/) 的 Jeroen Frijters 报告了 .NET Framework 不受管理的对象漏洞 (CVE-2012-0014)

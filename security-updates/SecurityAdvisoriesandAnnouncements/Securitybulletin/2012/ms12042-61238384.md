---
TOCTitle: 'MS12-042'
Title: 'Microsoft 安全公告 MS12-042 - 重要'
ms:assetid: 'ms12-042'
ms:contentKeyID: 61238384
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-042(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-042 - 重要
==================================
...
对于 Windows XP 和 Windows Server 2003 的所有 32 位版本、Windows 7（用于基于 x64 的系统）以及 Windows Server 2008 R2（用于基于 x64 的系统），此安全更新的等级为“重要”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

该安全更新通过更正 Windows 用户模式计划程序处理特定系统请求的方式以及 Windows 管理 BIOS ROM 的方式来解决漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[MS11-065](http://go.microsoft.com/fwlink/?linkid=232424) 中的 KB2633171 由 KB2707511 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-068](http://go.microsoft.com/fwlink/?linkid=223578) 中的 KB2556532 由 KB2709715 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<th>
用户模式计划程序内存损坏漏洞 - CVE-2012-0217
</th>
<th>
BIOS ROM 损坏漏洞 - CVE-2012-1515
</th>
<th>
综合严重等级
</th>
...
Windows 用户模式计划程序处理系统请求的方式中存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0217](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0217)。

#### 用户模式计划程序内存损坏漏洞 (CVE-2012-0217) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。
-   此漏洞仅影响 Windows 7 和 Windows Server 2008 R2 的 Intel 基于 x64 的版本。
-   带有基于 AMD 或 ARM 的 CPU 的系统不受此漏洞影响。

#### 用户模式计划程序内存损坏漏洞 (CVE-2012-0217) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 用户模式计划程序内存损坏漏洞 (CVE-2012-0217) 的常见问题

**此漏洞的影响范围有多大？**
这是一个特权提升漏洞。

**造成此漏洞的原因是什么？**
如果 Windows 用户模式计划程序不正确地处理特定系统，则会导致该漏洞。

**什么是** **用户模式计划程序 (UMS)？**
用户模式计划程序 (UMS) 是一种利用系统 API 的轻型机制，应用程序可以使用它计划自己的线程。在用户模式下，应用程序可以在 UMS 线程之间进行切换，而不必牵涉系统计划程序，如果某个 UMS 线程在内核中阻止，则应用程序能够重新获得处理器的控制权。
...
**此更新有什么作用？**
该更新通过更正 Windows 用户模式计划程序处理特定系统请求的方式来解决漏洞。
...
Windows 处理 BIOS 内存的方式中存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515)。

#### BIOS ROM 损坏漏洞 (CVE-2012-1515) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。匿名用户无法利用此漏洞，也无法以远程方式利用此漏洞。

#### BIOS ROM 损坏漏洞 (CVE-2012-1515) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### BIOS ROM 损坏漏洞 (CVE-2012-1515) 的常见问题

**此漏洞的影响范围有多大？**
这是一个特权提升漏洞。

**造成此漏洞的原因是什么？**
当 Windows 未正确地保护 BIOS ROM 时，会导致该漏洞。
...
**此更新有什么作用？**
该更新通过更正 Windows 管理 BIOS ROM 的方式来解决漏洞。

**发布此安全公告时，此漏洞是否已公开披露？**
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-1515](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1515)。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2707511$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2707511">Microsoft 知识库文章 2707511</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2707511$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2707511](http://support.microsoft.com/kb/2707511)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2709715">Microsoft 知识库文章 2709715</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
...
-   [Bromium](http://www.bromium.com/) 的 Rafal Wojtczuk 和 [SUSE](http://www.suse.com/) 的 Jan Beulich 报告了用户模式计划程序内存损坏漏洞 (CVE-2012-0217)

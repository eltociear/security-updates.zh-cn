...
<td style="border:1px solid black;">
[MS12-037](http://go.microsoft.com/fwlink/?linkid=249045) 中的 KB2699988 由 KB2719177 替代
</td>
</tr>
...
**安全更新的** **哈希** **位于何处？**
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2719177](http://support.microsoft.com/kb/2719177)。
...
是。KB2719177 更新适用于 Windows 8 Consumer Preview 和 Windows Server 2012 Consumer Preview。鼓励使用 Windows 8 Consumer Preview 和 Windows Server 2012 Consumer Preview 的客户向其系统应用更新。仅在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1522](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1522)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1524](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1524)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2719177">Microsoft 知识库文章 2719177</a></td>
</tr>  
<tr class="odd">
...
-   spa-s3c.blogspot.com 的 Jose A. Vazquez 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了缓存对象远程执行代码漏洞 (CVE-2012-1522)  
-   Omair 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了属性删除远程执行代码漏洞 (CVE-2012-1524)

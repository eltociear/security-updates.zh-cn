---
TOCTitle: 'MS12-068'
Title: 'Microsoft 安全公告 MS12-068 - 重要'
ms:assetid: 'ms12-068'
ms:contentKeyID: 61238410
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-068(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-068 - 重要
==================================

Windows 内核中的漏洞可能允许特权提升 (2724197)
----------------------------------------------
...
此安全更新解决了 Microsoft Windows 所有受支持的版本（Windows 8 和 Windows Server 2012 除外）中一个秘密报告的漏洞。对于 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“重要”。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。
...
<td style="border:1px solid black;">
[MS12-042](http://go.microsoft.com/fwlink/?linkid=252515) 中的 KB2707511 由 KB2724197 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS09-058](http://go.microsoft.com/fwlink/?linkid=162442) 中的 KB971486 由 KB2724197 替代
</td>
</tr>
<tr>
<th colspan="4" style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-098](http://go.microsoft.com/fwlink/?linkid=232424) 中的 KB2633171 由 KB2724197 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS12-042](http://go.microsoft.com/fwlink/?linkid=252515) 中的 KB2709715 由 KB2724197 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
**安** **全更新的**哈希位于何处？  
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2724197](http://support.microsoft.com/kb/2724197)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2529](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2529)。

#### Windows 整数溢出漏洞 (CVE-2012-2529) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### Windows 整数溢出漏洞 (CVE-2012-2529) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### Windows 整数溢出漏洞 (CVE-2012-2529) 的常见问题
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2724197$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2724197">Microsoft 知识库文章 2724197</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2724197$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2724197](http://support.microsoft.com/kb/2724197)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   一位匿名研究人员与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 Windows 整数溢出漏洞 (CVE-2012-2529)

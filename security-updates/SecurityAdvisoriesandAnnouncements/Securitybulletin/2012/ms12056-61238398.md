---
TOCTitle: 'MS12-056'
Title: 'Microsoft 安全公告 MS12-056 - 重要'
ms:assetid: 'ms12-056'
ms:contentKeyID: 61238398
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-056(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-056 - 重要
==================================

JScript 和 VBScript 引擎中的漏洞可能允许远程执行代码 (2706045)
--------------------------------------------------------------

发布时间: 2012年8月14日 | 更新时间: 2013年7月9日
...
对于 64 位 Windows 客户端上的 JScript 5.8 和 VBScript 5.8，此安全更新的等级为“重要”。对于 64 位 Windows 服务器上的 JScript 5.8 和 VBScript 5.8，此安全更新的等级为“低”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

该安全更新通过修改 JScript 和 VBScript 处理内存中对象的方式来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=e1b9a081-0329-4db6-b026-04a332cb0b4d">JScript 5.8 和 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> 中的 KB2510531 由 KB2706045 替代</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows Server 2003 x64 Edition Service Pack 2</td>
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=81f5d8a5-12e5-4227-ae6f-5aea6ffff2a5">JScript 5.8 和 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">远程执行代码</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=294a7eb4-c47f-449f-8931-262bec7d6ecc">JScript 5.8 和 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> 中的 KB2510531 由 KB2706045 替代</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=47b2e47f-30f1-48e8-a857-70df319011ef">JScript 5.8 和 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> 中的 KB2510531 由 KB2706045 替代</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=ece661be-4ddf-42cc-a62b-15ce53b9d74b">JScript 5.8 和 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">重要</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> 中的 KB2510531 由 KB2706045 替代</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=bbb876e6-a6b9-4193-be5e-d84390d30f1e">JScript 5.8 和 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> 中的 KB2510531 由 KB2706045 替代</td>
...
<td style="border:1px solid black;"><a href="http://www.microsoft.com/downloads/details.aspx?familyid=97004a96-0c83-421d-91a9-d55be32610c9">JScript 5.8 和 VBScript 5.8</a><br />
(KB2706045)</td>
<td style="border:1px solid black;">远程执行代码</td>
<td style="border:1px solid black;">低</td>
<td style="border:1px solid black;"><a href="http://go.microsoft.com/fwlink/?linkid=212243">MS11-031</a> 中的 KB2510531 由 KB2706045 替代</td>
...
**安全更新的哈希位于何处？**
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2706045](http://support.microsoft.com/kb/2706045)。
...
**此安全更新与 MS12-052** **有什么联系？**
此安全公告中所述的的 JavaScript 整数溢出远程执行代码漏洞 (CVE-2012-2523) 也由 [MS12-052](http://go.microsoft.com/fwlink/?linkid=255327) 解决。

对于其系统上安装了 Internet Explorer 8 的客户，请安装 KB2706045 更新以免遭 CVE-2012-2523 中描述的漏洞攻击。

对于其系统上安装了 Internet Explorer 9 的客户，请安装 [MS12-052](http://go.microsoft.com/fwlink/?linkid=255327) 中描述的 KB2722913 更新以免遭 CVE-2012-2523 中描述的漏洞攻击。

**如何确定我的系统上安装了哪个版本的 JScript 和 VBScript 脚本引擎？**
Internet Explorer 8、Internet Explorer 9 和 Internet Explorer 10 包括 JScript 5.8 和 VBScript 5.8 脚本引擎。KB2706045 更新程序包更新 JScript 和 VBScript 的 Internet Explorer 8 版本。MS12-052 中描述的 KB2722913 更新程序包更新 Internet Explorer 9 版本。Internet Explorer 10 版本已经是最新的，不需要此更新。"
...
<tr class="header">
<th>受影响的软件</th>
<th>JavaScript 整数溢出远程执行代码漏洞 - CVE-2012-2523</th>
<th>综合严重等级</th>
</tr>
</thead>
<tbody>
...
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008（用于基于 x64 的系统）Service Pack 2 上的 JScript 5.8 和 VBScript 5.8</td>
<td style="border:1px solid black;"><strong>低</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>低</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">Windows 7（64 位系统）上的 JScript 5.8 和 VBScript 5.8</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows 7（用于基于 x64 的系统）Service Pack 1 上的 JScript 5.8 和 VBScript 5.8</td>
<td style="border:1px solid black;"><strong>重要</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>重要</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2（64 位系统）上的 JScript 5.8 和 VBScript 5.8</td>
<td style="border:1px solid black;"><strong>低</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>低</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 上的 JScript 5.8 和 VBScript 5.8</td>
<td style="border:1px solid black;"><strong>低</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>低</strong></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;">Windows Server 2008 R2（Itanium 系统）上的 JScript 5.8 和 VBScript 5.8</td>
<td style="border:1px solid black;"><strong>低</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>低</strong></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;">Windows Server 2008 R2（用于基于 Itanium 的系统）上的 JScript 5.8 和 VBScript 5.8</td>
<td style="border:1px solid black;"><strong>低</strong><br />
远程执行代码</td>
<td style="border:1px solid black;"><strong>低</strong></td>
</tr>  
...
<span></span>  
执行复制操作过程中，JScript 和 VBScript 引擎计算内存中对象的大小的方式中存在一个远程执行代码漏洞。该漏洞可能以一种攻击者可以在当前用户的上下文中执行任意代码的方式损坏内存。如果当前用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。
...
**造成此漏洞的原因是什么？**  
当在执行复制操作过程中，JScript 引擎不正确地计算内存中对象的大小时，会导致该漏洞。
...
**受此漏洞威胁最大的系统有哪些？**  
频繁使用 Internet Explorer 8 和 Internet Explorer 9 的系统（如工作站或终端服务器）受此漏洞的威胁最大。
...
**此更新有什么作用？**  
该更新通过修改 JScript 和 VBScript 处理内存中对象的方式来解决漏洞。
...
<td style="border:1px solid black;">Windows XP 的所有受支持的基于 x64 的版本上的 JScript 5.8 和 VBScript 5.8：<br />
...
<td style="border:1px solid black;">对于 JScript 5.8 和 VBScript 5.8： KB2706045-IE8.log</td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;">对于 Windows XP 的所有受支持的基于 x64 的版本上的 JScript 5.8 和 VBScript 5.8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie8updates\KB2706045-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2706045">Microsoft 知识库文章 2706045</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">Windows Server 2003 的所有受支持的基于 x64 的版本上的 JScript 5.8 和 VBScript 5.8：<br />
IE8-WindowsServer2003.WindowsXP-KB2706045-x64-ENU.exe /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">安装而不重新启动</td>
...
<tr class="even">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">对于 Windows Server 2003 的所有受支持的基于 x64 的版本上的 JScript 5.8 和 VBScript 5.8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie8updates\KB2706045-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">Windows Vista 的所有受支持的基于 x64 的版本上的 JScript 5.8 和 VBScript 5.8：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">Windows Server 2008 的所有受支持的基于 x64 的版本上的 JScript 5.8 和 VBScript 5.8：<br />
IE8-Windows6.0-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;">安装而不重新启动</td>
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">Windows 7 的所有受支持的基于 x64 的版本上的 JScript 5.8 和 VBScript 5.8：<br />
...
<tr class="odd">
<td style="border:1px solid black;">没有用户干预的安装</td>
<td style="border:1px solid black;">Windows Server 2008 R2 的所有受支持的基于 x64 的版本上的 JScript 5.8 和 VBScript 5.8：<br />
Windows6.1-KB2706045-x64.msu /quiet</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">Windows Server 2008 R2 的所有受支持的基于 Itanium 的版本上的 JScript 5.8 和 VBScript 5.8：<br />
...
-   V1.1（2013 年 7 月 9 日）： 公告经过修订，宣布在 2706045 更新的 Windows Vista 程序包中的一个检测更改，以解决一个 Windows Update 重新提供问题。这只是检测更改。已经成功更新了其系统的客户不需要执行任何操作。

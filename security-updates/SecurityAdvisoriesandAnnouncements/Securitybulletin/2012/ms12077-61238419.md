---
TOCTitle: 'MS12-077'
Title: 'Microsoft 安全公告 MS12-077 - 严重'
ms:assetid: 'ms12-077'
ms:contentKeyID: 61238419
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-077(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-077 - 严重
==================================
...
对于 Windows 客户端上的 Internet Explorer 9 和 Internet Explorer 10，此安全更新的等级为“严重”；对于 Windows 服务器上的 Internet Explorer 9 和 Internet Explorer 10，此安全更新的等级为“中等”。对于 Internet Explorer 6、Internet Explorer 7 和 Internet Explorer 8，此安全更新没有安全等级。有关详细信息，请参阅本节中的“**受影响和不受影响的软件**”小节。
...
<td style="border:1px solid black;">
[MS12-063](http://go.microsoft.com/fwlink/?linkid=255505) 中的 KB2744842 由 KB2761465 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS12-071](http://go.microsoft.com/fwlink/?linkid=268299) 中的 KB2761451 由 KB2761465 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
**安** **全更新的**哈希位于何处？
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2761465](https://support.microsoft.com/kb/2761465)。
...
是。KB2761465 更新适用于 Windows 8 Release Preview 中的 Internet Explorer 10 和 Windows Server 2012 Release Candidate 中的 Internet Explorer 10。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。

**适用于** **Windows 7 和 Windows Server 2008 R2** **的 Internet Explorer 10** **是否** **受此漏洞中解决的漏洞影响？**
是。KB2761465 更新适用于适用于 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview。鼓励使用适用于 Windows 7（用于 32 位系统）Service Pack 1、Windows 7（用于基于 x64 的系统）Service Pack 1 和 Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1 的 Internet Explorer 10 Release Preview 的客户向其系统应用更新。在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
<th>
InjectHTMLStream 释放后使用漏洞 - CVE-2012-4781
</th>
<th>
CMarkup 释放后使用漏洞 - CVE-2012-4782
</th>
<th>
不正确的引用计数释放后使用漏洞 - CVE-2012-4787
</th>
<th>
综合严重等级
</th>
...
Internet Explorer 访问内存中已被删除的对象的方式中存在一个远程执行代码漏洞。该漏洞可能以一种攻击者可以在当前用户的上下文中执行任意代码的方式损坏内存。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4781](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4781)。

#### InjectHTMLStream 释放后使用漏洞 (CVE-2012-4781) 的缓解因素
...
#### InjectHTMLStream 释放后使用漏洞 (CVE-2012-4781) 的变通办法
...
#### InjectHTMLStream 释放后使用漏洞 (CVE-2012-4781) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4782](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4782)。

#### CMarkup 释放后使用漏洞 (CVE-2012-4782)　的缓解因素
...
#### CMarkup 释放后使用漏洞 (CVE-2012-4782)　的变通办法
...
#### CMarkup 释放后使用漏洞 (CVE-2012-4782)　的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4787](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4787)。

#### 不正确的引用计数释放后使用漏洞 (CVE-2012-4787) 的缓解因素
...
#### 不正确的引用计数释放后使用漏洞 (CVE-2012-4787) 的变通办法
...
#### 不正确的引用计数释放后使用漏洞 (CVE-2012-4787) 的常见问题
...
<p>使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2761465$\Spuninst 文件夹中的 Spuninst.exe 实用程序</p></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 7：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie7updates\KB2761465-IE7\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">适用于 Windows XP 的所有受支持版本的 Internet Explorer 8：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\ie8updates\KB2761465-IE8\spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2761465">Microsoft 知识库文章 2761465</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 6：<br />
使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2761465$\Spuninst 文件夹中“使用 Spuninst.exe 实用程序”内的 Spuninst.exe 实用程序</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">所有受支持的 32 位版本、基于 x64 版本和基于 Itanium 版本的 Windows Server 2003 上的 Internet Explorer 7：<br />
...
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2761465](http://support.microsoft.com/kb/2761465)                                                                                           |
...
-   [Rosario Valotta](https://sites.google.com/site/tentacoloviola) 报告了 InjectHTMLStream 释放后使用漏洞 (CVE-2012-4781)  
-   [Rosario Valotta](https://sites.google.com/site/tentacoloviola) 报告了 CMarkup 释放后使用漏洞 (CVE-2012-4782)  
-   [Google Inc](http://www.google.com) 的 Fermin J. Serna 报告了不正确的引用计数释放后使用漏洞 (CVE-2012-4787)

---
TOCTitle: 'MS12-078'
Title: 'Microsoft 安全公告 MS12-078 - 严重'
ms:assetid: 'ms12-078'
ms:contentKeyID: 61238420
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-078(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-078 - 严重
==================================

Windows 内核模式驱动程序中的漏洞可能允许远程执行代码 (2783534)
--------------------------------------------------------------
...
**已知问题**。[Microsoft 知识库文章 2783534](http://support.microsoft.com/kb/2783534) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS11-032](http://go.microsoft.com/fwlink/?linkid=212224) 中的 KB2507618 由 KB2753842 替代  
[MS12-075](http://go.microsoft.com/fwlink/?linkid=270856) 中的 KB2761226 由 KB2779030 替代
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=fedee43c-0065-42bf-9714-171b5b74f099)（服务器核心安装）  
(KB2753842)  
[Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=3dfa40ef-86a2-44a0-b523-f4a85c7ac82c)（服务器核心安装）  
(KB2779030)
</td>
<td style="border:1px solid black;">
特权提升
...
**为什么在 2012 年 12 月 20 日重新发布此公告？**  
**Microsoft 重新发布此公告是为了解决 KB2753842 更新中与 OpenType 字体 (OTF) 在应用原始更新后在应用程序中不能正确渲染相关的一个已知问题。已成功安装原始 KB2753842 更新的客户不会受到 CVE-2012-2556 中所描述的漏洞的攻击。但是，客户需要安装重新发布的 KB2753842 更新以解决 OpenType 字体不正确渲染的问题，并将受影响的二进制文件保持为最新。

**注意**不提供针对 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的重新发布程序包。Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 不在受支持范围。

**在哪里可以找到文件信息详细资料？**  
有关文件信息详细资料的位置，请参阅“**安全更新部署**”部分中的参考表。

**安** **全更新的**哈希位于何处？
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2783534](https://support.microsoft.com/kb/2783534)。

**Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 是否受此公告中解决的漏洞影响？**  
是。KB2753842 和 KB2779030 更新适用于 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。仅在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
以下严重等级假设漏洞的可能的最大影响。有关在安全公告发布 30 天内漏洞利用的安全等级和安全影响的可能性的信息，请参阅 [12 月份公告摘要](http://technet.microsoft.com/security/bulletin/ms12-dec)中的利用指数。有关详细信息，请参阅 [Microsoft 利用指数](http://technet.microsoft.com/en-us/security/cc998259.aspx)。
...
<th>
OpenType字体分析漏洞 - CVE-2012-2556
</th>
<th>
TrueType 字体分析漏洞 - CVE-2012-4786
</th>
<th>
综合严重等级
</th>
...
受影响的组件处理特制 OpenType 字体文件的方式中存在一个远程执行代码漏洞。如果用户打开特制的 OpenType 字体文件，该漏洞可能允许远程执行代码。成功利用此漏洞的攻击者可以完全控制受影响的系统。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-2556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556)。

#### OpenType 字体分析漏洞 (CVE-2012-2556) 的缓解因素
...
#### OpenType 字体分析漏洞 (CVE-2012-2556) 的变通办法
...
#### OpenType 字体分析漏洞 (CVE-2012-2556) 的常见问题

**此漏洞的影响范围有多大？**  
这是一个远程执行代码漏洞。

**造成此漏洞的原因是什么？**  
此漏洞是由于 OpenType 字体 (OTF) 驱动程序不正确地处理内存中的对象所导致的。
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-2556](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-2556)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4786](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4786)。

#### TrueType 字体分析漏洞 (CVE-2012-4786) 的缓解因素
...
#### TrueType 字体分析漏洞 (CVE-2012-4786) 的变通办法
...
#### TrueType 字体分析漏洞 (CVE-2012-4786) 的常见问题
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或下列文件夹中的 Spuninst.exe 实用程序： %Windir%\\$NTUninstallKB2753842-v2$\Spuninst<br />
%Windir%\\$NTUninstallKB2779030$\Spuninst</td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2753842">Microsoft 知识库文章 2753842</a> 和 <a href="http://support.microsoft.com/kb/2779030">Microsoft 知识库文章 2779030</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或下列文件夹中的 Spuninst.exe 实用程序： %Windir%\\$NTUninstallKB2753842-v2$\\Spuninst  
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2753842](http://support.microsoft.com/kb/2753842) 和 [Microsoft 知识库文章 2779030](http://support.microsoft.com/kb/2779030)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">要卸载 WUSA 安装的更新，请使用 /Uninstall 安装开关，或者单击“<strong>控制面板</strong>”，单击“<strong>系统和安全</strong>”，单击“<strong>Windows Update</strong>”，“<strong>安装的更新</strong>”并从更新列表中进行选择。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2753842">Microsoft 知识库文章 2753842</a> 和 <a href="http://support.microsoft.com/kb/2779030">Microsoft 知识库文章 2779030</a></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>删除信息</strong></td>
<td style="border:1px solid black;">要卸载 WUSA 安装的更新，请使用 /Uninstall 安装开关，或者单击“<strong>控制面板</strong>”，单击“<strong>系统和安全</strong>”，单击“<strong>Windows Update</strong>”，然后单击“<strong>安装的更新</strong>”，并从更新列表中进行选择。</td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2753842">Microsoft 知识库文章 2753842</a> 和 <a href="http://support.microsoft.com/kb/2779030">Microsoft 知识库文章 2779030</a></td>
...
| **部署**                         |                                                                                                                                                           |  
|                                  | 此安全更新仅通过 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 提供。                                                                    |  
| **重新启动要求**                 |                                                                                                                                                           |  
| 要求重新启动？                   | 是，应用此安全更新后必须重新启动系统。                                                                                                                    |  
| **删除信息**                     | 单击“**控制面板**”，单击“**系统和安全**”，然后在 “Windows Update”下单击“**安装的更新**”，并从更新列表中选择。                                             |  
| **文件信息**                     | 请参阅 [Microsoft 知识库文章 2753842](http://support.microsoft.com/kb/2753842) 和 [Microsoft 知识库文章 2779030](http://support.microsoft.com/kb/2779030) |
...
-   [Documill](http://www.documill.com) 的 Eetu Luodemaa 和 Joni Vähämäki 与 Chromium Security Rewards Program 合作报告了 Windows 字体分析漏洞 (CVE-2012-2556)
...
-   V1.1（2012 年 12 月 14 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2783534 添加一个链接。  
-   V2.0（2012 年 12 月 20 日）： 重新发布了更新 KB2753842 以解决在安装原始更新后，OpenType 字体不能正确渲染的问题。已成功安装原始更新 KB2753842 的客户需要安装重新发布的更新。

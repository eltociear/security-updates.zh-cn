---
TOCTitle: 'MS12-041'
Title: 'Microsoft 安全公告 MS12-041 - 重要'
ms:assetid: 'ms12-041'
ms:contentKeyID: 61238383
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-041(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-041 - 重要
==================================
...
该安全更新通过更正 Windows 内核模式驱动程序验证从用户模式传递的输入和处理 TrueType 字体加载的方式，并向线程创建机制引入附加运行时验证来解决漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[MS12-018](http://go.microsoft.com/fwlink/?linkid=235364) 中的 KB2641653 由 KB2709162 替代
</td>
</tr>
...
<th>
字符串 Atom 类名处理漏洞 - CVE-2012-1864
</th>
<th>
字符串 Atom 类名处理漏洞 - CVE-2012-1865
</th>
<th>
剪贴板格式 Atom 名称处理漏洞 - CVE-2012-1866
</th>
</tr>
<tr>
<td style="border:1px solid black;">
...
<th>
字体资源引用计数整数溢出漏洞 - CVE-2012-1867
</th>
<th>
Win32k.sys 争用条件漏洞 - CVE-2012-1868
</th>
<th>
综合严重等级
</th>
...
由于 Windows 内核模式驱动程序管理内核模式驱动程序对象的方式，存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1864](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1864)。

#### 字符串 Atom 类名处理漏洞 (CVE-2012-1864) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### 字符串 Atom 类名处理漏洞 (CVE-2012-1864) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 字符串 Atom 类名处理漏洞 (CVE-2012-1864) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1865](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1865)。

#### 字符串 Atom 类名处理漏洞 (CVE-2012-1865) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### 字符串 Atom 类名处理漏洞 (CVE-2012-1865) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 字符串 Atom 类名处理漏洞 (CVE-2012-1865) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1866](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1866)。

#### 剪贴板格式 Atom 名称处理漏洞 (CVE-2012-1866) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### 剪贴板格式 Atom 名称处理漏洞 (CVE-2012-1866) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 剪贴板格式 Atom 名称处理漏洞 (CVE-2012-1866) 的常见问题
...
由于 Windows 内核模式驱动程序在处理字体时未正确分配内存，存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1867](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1867)。

#### 字体资源引用计数整数溢出漏洞 (CVE-2012-1867) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### 字体资源引用计数整数溢出漏洞 (CVE-2012-1867) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### 字体资源引用计数整数溢出漏洞 (CVE-2012-1867) 的常见问题

**此漏洞的影响范围有多大？**
这是一个特权提升漏洞。

**造成此漏洞的原因是什么？**
当 Windows 内核模式驱动程序无法正确地处理 TrueType 字体加载时会导致该漏洞。
...
**此更新有什么作用？**
此更新通过更正 Windows 内核模式驱动程序处理 TrueType 字体加载的方式来解决此漏洞。
...
由于内核处理特定线程创建尝试的方式，Windows 内核中存在一个特权提升漏洞。成功利用此漏洞的攻击者可以运行内核模式中的任意代码。攻击者随后可安装程序；查看、更改或删除数据；或者创建拥有完全管理权限的新帐户。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1868](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1868)。

#### Win32k.sys 争用条件漏洞 (CVE-2012-1868) 的缓解因素

缓解是指一种设置、通用配置或者一般的最佳实践，它以默认状态存在，能够降低利用漏洞的严重性。以下缓解因素在您遇到的情形中可能会有所帮助：

-   攻击者必须拥有有效的登录凭据并能本地登录才能利用此漏洞。

#### Win32k.sys 争用条件漏洞 (CVE-2012-1868) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### Win32k.sys 争用条件漏洞 (CVE-2012-1868) 的常见问题

**此漏洞的影响范围有多大？**
这是一个特权提升漏洞。

**造成此漏洞的原因是什么？**
此漏洞是由于创建特定类型的线程时的争用条件造成的。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2709162$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2709162">Microsoft 知识库文章 2709162</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2709162$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2709162](http://support.microsoft.com/kb/2709162)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Azimuth Security](http://www.azimuthsecurity.com/) 的 Tarjei Mandt 报告了 字符串 Atom 类名处理漏洞 (CVE-2012-1864)  
-   [Azimuth Security](http://www.azimuthsecurity.com/) 的 Tarjei Mandt 报告了 Win32k.sys 争用条件漏洞 (CVE-2012-1865)  
-   [Azimuth Security](http://www.azimuthsecurity.com/) 的 Tarjei Mandt 报告了剪贴板格式 Atom 名称处理漏洞 (CVE-2012-1866)  
-   [Google Inc.](http://www.google.com) 的 [Mateusz "j00ru" Jurczyk](http://j00ru.vexillium.org) 报告了字体资源引用计数整数溢出漏洞 (CVE-2012-1867)

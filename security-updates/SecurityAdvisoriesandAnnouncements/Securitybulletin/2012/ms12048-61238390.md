...
<td style="border:1px solid black;">
[MS10-046](http://go.microsoft.com/fwlink/?linkid=197393) 中的 KB2286198 由 KB2691442 替代
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=6d873c5a-57dc-4792-942e-124ce1a4ec2b)（服务器核心安装）  
(KB2691442)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=d49e3e7e-910a-4069-b0b0-0987bb9fdde2)（服务器核心安装）  
(KB2691442)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=d16fa6b9-43aa-4d0f-a230-52664e972ab9)（服务器核心安装）  
(KB2691442)
</td>
<td style="border:1px solid black;">
远程执行代码
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=d16fa6b9-43aa-4d0f-a230-52664e972ab9)（服务器核心安装）  
(KB2691442)
</td>
<td style="border:1px solid black;">
远程执行代码
...
**安全更新的** **哈希位于**何处？
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2691442](http://support.microsoft.com/kb/2691442)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0175](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0175)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2691442">Microsoft 知识库文章 2691442</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2691442](http://support.microsoft.com/kb/2691442)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [IBM Security Systems - Application Security](http://blog.watchfire.com/) 的 Adi Cohen 报告了命令注入漏洞 (CVE-2012-0175)

...
<td style="border:1px solid black;">
[MS12-041](http://go.microsoft.com/fwlink/?linkid=251707) 中的 KB2709162 由 KB2718523 替代
</td>
</tr>
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=ed201422-7c65-4c20-a825-8cecab1aeebc)（服务器核心安装）  
(KB2718523)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=8e1a27c9-6495-4030-8a46-264afd78a5a1)（服务器核心安装）  
(KB2718523)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)（服务器核心安装）  
(KB2718523)
</td>
<td style="border:1px solid black;">
特权提升
...
<tr class="alternateRow">
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=73a9ff32-4009-4fd4-a82b-1e22c09d3087)（服务器核心安装）  
(KB2718523)
</td>
<td style="border:1px solid black;">
特权提升
...
**安** **全更新的**哈希位于何处？
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2718523](http://support.microsoft.com/kb/2718523)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890)。
...
**发布此安全公告时，此漏洞是否已公开披露？**
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-1890](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1890)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1893](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1893)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2718523">Microsoft 知识库文章 2718523</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2718523](http://support.microsoft.com/kb/2718523)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [Core Security Technologies](http://www.coresecurity.com/) 的 Nicolas Economou 报告了键盘布局漏洞 (CVE-2012-1890)  
-   [Qihoo 360 Security Center](http://www.360.cn/) 报告了键盘布局漏洞 (CVE-2012-1890)  
-   Neusoft Corporation 的 Lufeng Li 与 [Secunia Research](http://secunia.com/) 合作报告了 Win32k 错误类型处理漏洞 (CVE-2012-1893)

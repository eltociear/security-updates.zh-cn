...
<div>  
<br />  
此版本 Microsoft XML Core Services 与 MSXML4 的先前版本并行安装。请按照 <a href="http://support.microsoft.com/kb/2721691">Microsoft 知识库文章 2721691</a> 中的步骤删除安全更新。
</div></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;">对于 Windows XP 所有受支持版本上的 Microsoft XML Core Services 3.0：<br />
请参阅 <a href="http://support.microsoft.com/kb/2719985">Microsoft 知识库文章 2719985</a></td>
</tr>
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于安装在 Windows XP 所有受支持版本上的 Microsoft XML Core Services 4.0：<br />
请参阅 <a href="http://support.microsoft.com/kb/2721691">Microsoft 知识库文章 2721691</a></td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于所有 Windows XP Professional Service Pack 2 上的 Microsoft XML Core Services 6.0：<br />
请参阅 <a href="http://support.microsoft.com/kb/2721693">Microsoft 知识库文章 2721693</a></td>
</tr>
<tr class="even">
...
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于安装在 Windows Server 2003 所有受支持版本上的 Microsoft XML Core Services 4.0：<br />
此版本 Microsoft XML Core Services 与 MSXML4 的先前版本并行安装。请按照 <a href="http://support.microsoft.com/kb/2721691">Microsoft 知识库文章 2721691</a> 中的步骤删除安全更新。</td>
</tr>
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Windows Server 2003 所有受支持版本上的 Microsoft XML Core Services 6.0：<br />
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2687627">Microsoft 知识库文章 2687627</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2596856">Microsoft 知识库文章 2596856</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
-   [Google Security Team](http://www.google.com/)　与我们合作处理了　MSXML　未初始化的内存损坏漏洞　(CVE-2012-1889)  
-   [Qihoo 360 Security Center](http://www.360.cn/) 报告了　MSXML 未初始化的内存损坏漏洞 (CVE-2012-1889)

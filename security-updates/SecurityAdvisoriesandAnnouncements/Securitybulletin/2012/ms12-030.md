---
TOCTitle: 'MS12-030'
Title: 'Microsoft 安全公告 MS12-030 - 重要'
ms:assetid: 'ms12-030'
ms:contentKeyID: 61238372
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-030(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-030 - 重要
==================================

Microsoft Office 中的漏洞可能允许远程执行代码 (2663830)
-------------------------------------------------------

发布时间: 2012年5月8日 | 更新时间: 2012年5月9日
...
对于 Microsoft Excel 2003、Microsoft Excel 2007、Microsoft Office 2007、Microsoft Excel 2010、Microsoft Office 2010、Microsoft Office 2008 for Mac 和 Microsoft Office for Mac 2011 的所有受支持版本，此安全更新的等级为“重要”；对于 Microsoft Excel Viewer 和 Microsoft Office 兼容包的受支持版本，此安全更新的等级也为“重要”。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

此安全更新通过更正 Microsoft Excel 在打开特制 Excel 文件时验证数据的方式来解决这些漏洞。有关这些漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的“常见问题 (FAQ)”小节。
...
<td style="border:1px solid black;">
[MS11-096](http://go.microsoft.com/fwlink/?linkid=232696) 中的 KB2596954 由 KB2597086 替代
</td>
</tr>
...
<td style="border:1px solid black;">
[MS11-072](http://go.microsoft.com/fwlink/?linkid=225047) 中的 KB2553073 由 KB2597161 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](http://go.microsoft.com/fwlink/?linkid=225047) 中的 KB2553070 由 KB2597166 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](http://go.microsoft.com/fwlink/?linkid=225047) 中的 KB2553075 由 KB2596842 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-072](http://go.microsoft.com/fwlink/?linkid=225047) 中的 KB2553074 由 KB2597162 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
**此安全更新与 MS12-029 有什么联系？**  
本公告中提供的 Microsoft Office 2008 for Mac (KB2665346) 和 Microsoft Office for Mac 2011 (KB2665351) 安全更新程序包也可解决 [MS12-029](http://go.microsoft.com/fwlink/?linkid=248419) 安全公告中介绍的漏洞。

**为什么对 Excel 所有受影响的版本而言此更新的严重等级仅为“重要”？**  
Microsoft Excel 2002 和更高版本具有下列内置功能：打开文档之前，系统将提示用户打开、保存或取消。此缓解因素将漏洞从“严重”降级为“重要”，因为这些漏洞需要多次用户操作才能完成利用。

**漏洞的攻击媒介是通过 Microsoft Excel。为什么 这是 Microsoft Office 更新？**  
虽然本公告中描述的漏洞的攻击媒介仅通过 Microsoft Excel 的受影响版本，但 Microsoft Office 的共享组件中仍包含容易受到攻击的代码。其他 Microsoft Office 软件（包括 Microsoft Access、Microsoft Word 和 Microsoft PowerPoint 的一些受支持版本）包含容易受到攻击的 Microsoft Office 共享组件，但是由于它们不访问容易受到攻击的代码，因而不受此漏洞的影响。但是，由于存在容易受到攻击的代码，仍会提供此更新。

**此更新为何消除了多个已报告的安全漏洞？**  
此更新之所以包含对某些漏洞的支持，是因为解决这些问题所需的修改位于相关的文件中。客户只需安装此更新就可以了，而不用安装多个几乎相同的更新。

**为什么有多个更新程序包适用于 Microsoft Office 2007 Service Pack 2、Microsoft Office 2007 Service Pack 3、Microsoft Office 2010 和 Microsoft Office 2010 Service Pack 1？**  
由于 Microsoft Office 2007 和 Microsoft Office 2010 的组件化服务模型，解决本公告中描述的漏洞所需的更新是跨“**受影响的软件**”表中指明的不同更新程序包提供的。为防止受漏洞影响，这些更新都需要安装，但是不必按照任何特定顺序安装。
...
<th>
Excel 文件格式内存损坏漏洞 - CVE-2012-0141
</th>
<th>
OBJECTLINK 记录中的 Excel 文件格式内存损坏漏洞 - CVE-2012-0142
</th>
<th>
使用各种被修改字节的 Excel 内存损坏漏洞 - CVE-2012-0143
</th>
<th>
Excel SXLI 记录内存损坏漏洞 - CVE-2012-0184
</th>
<th>
Excel 合并单元格记录堆溢出漏洞 - CVE-2012-0185
</th>
<th>
Excel 系列记录分析类型不匹配漏洞 - CVE-2012-1847
</th>
<th>
综合严重等级
</th>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0141](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0141)。

#### Excel 文件格式内存损坏漏洞 (CVE-2012-0141) 的缓解因素
...
#### Excel 文件格式内存损坏漏洞 (CVE-2012-0141) 的变通办法
...
#### Excel 文件格式内存损坏漏洞 (CVE-2012-0141) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0142](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0142)。

#### OBJECTLINK 记录中的 Excel 文件格式内存损坏漏洞 (CVE-2012-0142) 的缓解因素
...
#### OBJECTLINK 记录中的 Excel 文件格式内存损坏漏洞 (CVE-2012-0142) 的变通办法
...
#### OBJECTLINK 记录中的 Excel 文件格式内存损坏漏洞 (CVE-2012-0142) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0143](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143)。

#### 使用各种被修改字节的 Excel 内存损坏漏洞 (CVE-2012-0143) 的缓解因素
...
#### 使用各种被修改字节的 Excel 内存损坏漏洞 (CVE-2012-0143) 的变通办法
...
-   **使用 Microsoft Office 文件阻止策略禁止打开来自未知或不可信来源和位置的 Office 2003 以及较早版本的文档。**
    ...
    **变通办法的影响。** 对于 Microsoft Office 2003，配置了文件阻止策略但是尚未配置特殊例外目录或将文件移动到可信位置的用户将无法打开 Office 2003 文件或更早版本。
...
#### 使用各种被修改字节的 Excel 内存损坏漏洞 (CVE-2012-0143) 的常见问题
...
**发布此安全公告时，此漏洞是否已公开披露？**  
是。此漏洞已公开披露。已为此漏洞分配了常见漏洞和披露号码 [CVE-2012-0143](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0143)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0184](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0184)。

#### Excel SXLI 记录内存损坏漏洞 (CVE-2012-0184) 的缓解因素
...
#### Excel SXLI 记录内存损坏漏洞 (CVE-2012-0184) 的变通办法
...
#### Excel SXLI 记录内存损坏漏洞 (CVE-2012-0184) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0185](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0185)。

#### Excel 合并单元格记录堆溢出漏洞 (CVE-2012-0185) 的缓解因素
...
#### Excel 合并单元格记录堆溢出漏洞 (CVE-2012-0185) 的变通办法

变通办法是指一种设置或配置更改，它不能从根本上纠正漏洞，但有助于在应用更新之前封堵已知的攻击源。Microsoft 已测试了以下变通方法，并在讨论中指明了变通方法是否会降低功能性：

-   **在 Excel 2007 中设置 Office 文件验证以禁止打开未通过文件验证的文件**

    **注意** 在应用此变通办法之前，必须为您的 Microsoft Office 版本启用 Office 文件验证。有关如何在 Microsoft Office 2007 中启用 Office 文件验证的信息，请参阅 TechNet 文章 [Office 2003 和 Office 2007 的 Office 文件验证](http://technet.microsoft.com/en-us/library/gg985445(office.12).aspx)。
...
#### Excel 合并单元格记录堆溢出漏洞 (CVE-2012-0185) 的常见问题
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1847](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1847)。

#### Excel 系列记录分析类型不匹配漏洞 (CVE-2012-1847) 的缓解因素
...
#### Excel 系列记录分析类型不匹配漏洞 （CVE-2012-1847) 的变通方法
...
#### Excel 系列记录分析类型不匹配漏洞 （CVE-2012-1847) 的常见问题解答
...
| Microsoft Office 2010 和 Microsoft Excel 2010 Service Pack 1（32 位版本）                                | 是   |
| Microsoft Office 2010 和 Microsoft Excel 2010 Service Pack 1（64 位版本）                                | 是   |
...
| Microsoft Office 2010 和 Microsoft Excel 2010 Service Pack 1（32 位版本）                                | 是                  | 是                         |
| Microsoft Office 2010 和 Microsoft Excel 2010 Service Pack 1（64 位版本）                                | 是                  | 是                         |
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2597086">Microsoft 知识库文章 2597086</a></td>
</tr>  
<tr class="even">
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">对于 Microsoft Excel 2007，请参阅 <a href="http://support.microsoft.com/kb/2597161">Microsoft 知识库文章 2597161</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office 2007，请参阅 <a href="http://support.microsoft.com/kb/2597969">Microsoft 知识库文章 2597969</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Excel Viewer，请参阅 <a href="http://support.microsoft.com/kb/2596842">Microsoft 知识库文章 2596842</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"></td>
<td style="border:1px solid black;">对于 Microsoft Office 兼容包，请参阅 <a href="http://support.microsoft.com/kb/2597162">Microsoft 知识库文章 2597162</a></td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
<tr class="even">
<td style="border:1px solid black;">更多信息</td>
<td style="border:1px solid black;">有关检测和部署，请参阅前面的部分“<strong>检测</strong> <strong>和部署工具及指导</strong>”。</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>重新启动要求</strong></td>
<td style="border:1px solid black;"></td>
...
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2597166">Microsoft 知识库文章 2597166</a> 和 <a href="http://support.microsoft.com/kb/2553371">Microsoft 知识库文章 2553371</a></td>
</tr>  
<tr class="even">
<td style="border:1px solid black;"><strong>注册表项验证</strong></td>
<td style="border:1px solid black;">不适用</td>
...
如果最新安装的更新版本号为 **14.2.2**，则说明此更新已成功安装。
...
-   [Omair](http://krash.in/) 报告了 Excel 文件格式内存损坏漏洞 (CVE-2012-0141)  
-   [Omair](http://krash.in/) 报告了 OBJECTLINK 记录中的 Excel 文件格式内存损坏漏洞 (CVE-2012-0142)  
-   Omair 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 Excel SXLI 记录内存损坏漏洞 (CVE-2012-0184)  
-   Sean Larsson 和 Jun Mao 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 Excel 合并单元格记录堆溢出漏洞 (CVE-2012-0185)  
-   Sean Larsson 和 Jun Mao 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 Excel 系列记录分析类型不匹配漏洞 (CVE-2012-1847)  
-   匿名研究员与 [TippingPoint's](http://www.tippingpoint.com/)[Zero Day Initiative](http://www.zerodayinitiative.com/) 合作报告了 Excel 系列记录分析类型不匹配漏洞 (CVE-2012-1847)
...
-   V1.1（2012 年 5 月 9 日）： 删除了“**摘要**”中对已知问题的错误引用并更新了 CVE-2012-1847 的标题。

...
仅当已安装并启用了可选[桌面体验功能](http://technet.microsoft.com/library/cc772567(v=ws.10))时，KB2727528 更新才适用于运行 Windows Server 2008 受支持版本的系统。安装并启用了桌面体验功能的 Windows Server 2008 客户将拥有 KB2727528 更新解决的容易受到攻击的组件，因此需要安装此安全更新。未安装桌面体验功能或安装了但未启用该功能的客户不会拥有容易受到攻击的组件，因此不被提供安全更新程序包 KB2727528。

**我正在运行 Windows Server 2008 R2。为什么不向我提供安全更新 KB2727528？**  
仅当已安装并启用了可选[桌面体验功能](http://technet.microsoft.com/library/cc772567)时，KB2727528 更新才适用于运行 Windows Server 2008 R2 受支持版本的系统。安装并启用了桌面体验功能的 Windows Server 2008 R2 客户将拥有 KB2727528 更新解决的容易受到攻击的组件，因此需要安装此安全更新。未安装桌面体验功能或安装了但未启用该功能的客户不会拥有容易受到攻击的组件，因此不被提供安全更新程序包 KB2727528。
...
是。KB2727528 更新适用于 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。此更新仅在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1527](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1527)。
...
**什么是公文包？**  
公文包是 Windows 中同步两个文件夹的内容的一项功能。公文包有助于用户在设备（如 USB 拇指驱动器）和计算机之间同步文件夹。有关详细信息，请参阅[使用公文包同步](http://windows.microsoft.com/en-us/windows7/sync-using-briefcase)。
...
若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-1528](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-1528)。
...
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2727528">Microsoft 知识库文章 2727528</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2727528](http://support.microsoft.com/kb/2727528)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   Tal Zeltzer 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 合作报告了 Windows 公文包整数下溢漏洞 (CVE-2012-1527)  
-   Tal Zeltzer 与 [VeriSign iDefense Labs](http://labs.idefense.com/) 报告了 Windows 公文包整数溢出漏洞 (CVE-2012-1528)

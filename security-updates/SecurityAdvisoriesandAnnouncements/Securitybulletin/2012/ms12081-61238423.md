---
TOCTitle: 'MS12-081'
Title: 'Microsoft 安全公告 MS12-081 - 严重'
ms:assetid: 'ms12-081'
ms:contentKeyID: 61238423
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-081(v=Security.10)'
---

Security Bulletin

Microsoft 安全公告 MS12-081 - 严重
==================================

Windows 文件处理组件中的漏洞可能允许远程执行代码 (2758857)
----------------------------------------------------------

发布时间: 2012年12月11日 | 更新时间: 2013年5月22日
...
对于 Windows XP、Windows Server 2003、Windows Vista、Windows Server 2008、Windows 7 和 Windows Server 2008 R2 的所有受支持版本，此安全更新的等级为“严重”。Windows 8、Windows Server 2012 和 Window RT 不受此漏洞的影响。有关详细信息，请参阅本节中“**受影响和不受影响的软件**”小节。

该安全更新通过修改 Windows 处理包含特制名称的文件的方式来解决漏洞。有关漏洞的详细信息，请参阅下一节“**漏洞信息**”下面特定漏洞条目的常见问题 (FAQ) 小节。
...
**已知问题。**[Microsoft 知识库文章 2758857](http://support.microsoft.com/kb/2758857) 介绍了客户在安装此安全更新时可能遇到的当前已知问题。本文还介绍了这些问题的建议解决办法。
...
<td style="border:1px solid black;">
[MS07-035](http://go.microsoft.com/fwlink/?linkid=91397) 中的 KB935839 由 KB2758857 替代
</td>
</tr>
<tr>
<th colspan="4">
...
<td style="border:1px solid black;">
[安全通报 2269637](http://technet.microsoft.com/security/advisory/2269637) 中的 KB2533623 由 KB2758857 替代
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;">
[MS11-063](http://go.microsoft.com/fwlink/?linkid=221864) 中的 KB2567680 由 KB2758857 替代
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
**安全更新的哈希位于何处？**
安全更新的 SHA1 和 SHA2 哈希可用于验证下载的安全更新程序包的真实性。有关与此更新相关的哈希信息，请参阅 [Microsoft 知识库文章 2758857](https://support.microsoft.com/kb/2758857)。

**Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 是否受此公告中解决的漏洞影响？**
是。KB2758857 更新适用于 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate。鼓励使用 Windows 8 Release Preview 和 Windows Server 2012 Release Candidate 的客户向其系统应用更新。仅在 [Windows Update](http://go.microsoft.com/fwlink/?linkid=21130) 上提供更新。
...
<span></span>
Microsoft Windows 分析文件名的方式中存在一个远程执行代码漏洞。该漏洞可能以一种攻击者可以在当前用户的上下文中执行任意代码的方式损坏内存。

若要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-4774](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4774)。

#### Windows 文件名分析漏洞 (CVE-2012-4774) 的缓解因素
...
#### Windows 文件名分析漏洞 (CVE-2012-4774) 的变通办法

Microsoft 并未发现此漏洞的任何变通办法。

#### Windows 文件名分析漏洞 (CVE-2012-4774) 的常见问题

**此漏洞的影响范围有多大？**
这是一个远程执行代码漏洞。

**造成此漏洞的原因是什么？**
当 Windows 无法正确处理特制文件或子文件夹名称，允许将数据复制到未正确分配的内存中时，会导致该漏洞。

**攻击者可能利用此漏洞执行什么操作？**
成功利用此漏洞的攻击者可以获得与当前用户相同的用户权限。如果当前用户使用管理用户权限登录，成功利用此漏洞的攻击者便可完全控制受影响的系统。攻击者可随后安装程序；查看、更改或删除数据；或者创建拥有完全用户权限的新帐户。

**攻击者如何利用此** **漏洞？**
攻击者可能通过诱使用户浏览到包含特制名称的文件或子文件夹的文件系统来利用此漏洞。

在网络攻击情形中，攻击者可能将具有特制文件名的文件放在网络共享、UNC 共享或 WebDAV 位置上，然后诱使用户浏览到该文件。

在电子邮件攻击情形中，攻击者可能通过将特制文件或子文件夹作为附件发送，并诱使用户浏览到包含附件的文件系统来利用此漏洞。

在基于 Web 的攻击情形中，攻击者必须拥有一个包含使用特制名称的文件的网站。攻击者无法强迫用户访问宿主该文件的网站。相反，攻击者必须诱使用户访问该网站，方法通常是让用户单击电子邮件或 Instant Messenger 消息中的链接以使用户链接到攻击者的网站。

**受此漏洞威胁最大的系统有哪些？**
工作站和终端服务器受到的威胁最大。如果管理员允许用户登录服务器并运行程序，服务器可能面临更大风险。不过，最佳做法是不要授予这样的权限。

**此更新有什么作用？**
该安全更新通过修改 Windows 处理包含特制名称的文件的方式来解决漏洞。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\$NTUninstallKB2758857$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2758857">Microsoft 知识库文章 2758857</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2758857$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2758857](http://support.microsoft.com/kb/2758857)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   [IOActive](http://ioactive.co.uk/) 的 Lucas Apa 报告了 Windows 文件名分析漏洞 (CVE-2012-4774)
...
-   V1.1 （2013 年 5 月 22 日）： 已在“摘要”中的“已知问题”下为 Microsoft 知识库文章 2758857 添加一个链接。

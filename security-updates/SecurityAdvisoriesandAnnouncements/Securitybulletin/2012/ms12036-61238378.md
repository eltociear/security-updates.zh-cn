---
TOCTitle: 'MS12-036'
Title: 'Microsoft 安全公告 MS12-036 - 严重'
ms:assetid: 'ms12-036'
ms:contentKeyID: 61238378
ms:mtpsurl: 'https://technet.microsoft.com/zh-CN/library/ms12-036(v=Security.10)'
---
...
发布时间: 2012年6月12日 | 更新时间: 2013年7月9日
...
<td style="border:1px solid black;">
[MS12-020](http://go.microsoft.com/fwlink/?linkid=232664) 中的 KB2621440 由 KB2685939 替代
</td>
</tr>
...
要在“常见漏洞和披露”列表中以标准条目查看此漏洞，请参阅 [CVE-2012-0173](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-0173)。

#### 远程桌面协议漏洞 (CVE-2012-0173) 的缓解因素
...
-   **在运行 Windows Vista、Windows 7、Windows Server 2008 和 Windows Server 2008 R2 的受支持版本的系统上启用网络级别身份验证**
    ...
    **
    注意** 要使用自动 **Microsoft 修复** 解决方案来启用此变通办法，请参阅 [Microsoft 知识库文章 2685939](http://support.microsoft.com/kb/2685939)。
...
<td style="border:1px solid black;">使用控制面板中的“<strong>添加或删除程序</strong>”项或 %Windir%\\$NTUninstallKB2685939$\Spuninst 文件夹中的 Spuninst.exe 实用程序</td>
</tr>  
<tr class="odd">
<td style="border:1px solid black;"><strong>文件信息</strong></td>
<td style="border:1px solid black;">请参阅 <a href="http://support.microsoft.com/kb/2685939">Microsoft 知识库文章 2685939</a></td>
</tr>  
<tr class="even">
...
<td style="border:1px solid black;" colspan="2">
使用控制面板中的“**添加或删除程序**”项或 %Windir%\\$NTUninstallKB2685939$\\Spuninst 文件夹中的 Spuninst.exe 实用程序
</td>
</tr>
<tr>
<td style="border:1px solid black;">
...
<td style="border:1px solid black;" colspan="2">
请参阅 [Microsoft 知识库文章 2685939](http://support.microsoft.com/kb/2685939)
</td>
</tr>
<tr class="alternateRow">
<td style="border:1px solid black;">
...
-   V1.1（2012 年 6 月 13 日）： 已在“**漏洞信息**”部分添加了一种变通办法，介绍如何在　Windows Vista、Windows 7、Windows Server 2008　和　Windows Server 2008 R2　上启用网络级别身份验证。  
-   V1.2（2012 年 7 月 10 日）： 删除了 MS11-065 作为　Windows XP Service Pack 3、Windows XP Professional x64 Edition Service Pack 2、Windows Server 2003 Service Pack 2、Windows Server 2003 x64 Edition Service Pack 2　和 Windows Server 2003 with SP2 （用于基于 Itanium　系统）的　KB2685939　更新替代的公告。这仅仅是一个信息更改。检测逻辑或更新文件未发生更改。  
-   V1.3（2013 年 7 月 9 日）： 公告经过修订，宣布在 2685939 更新的 Windows Vista 程序包中的一个检测更改，以解决一个 Windows Update 重新提供问题。这只是检测更改。已经成功更新了其系统的客户不需要执行任何操作。

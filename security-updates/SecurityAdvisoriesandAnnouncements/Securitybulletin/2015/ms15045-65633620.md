...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于 32 位系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=23b7e977-f77f-4603-ad1c-19a0b33a5a75)<sup>[1]</sup>  
(3046002)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008（用于基于 x64 的系统）Service Pack 2](http://www.microsoft.com/downloads/details.aspx?familyid=58ee189d-2d25-40c8-9709-21b0a3e8a160)<sup>[1]</sup>  
(3046002)
...
<tr>
<td style="border:1px solid black;">
[Windows 7（用于 32 位系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=5eddd68f-aa12-426d-aa13-a0b24efa79fa)  
(3046002)
...
<tr>
<td style="border:1px solid black;">
[Windows 7（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=2a1cf1ef-49cd-424d-83d6-69f0ff7fff06)  
(3046002)
...
<tr>
<td style="border:1px solid black;">
[Windows Server 2008 R2（用于基于 x64 的系统）Service Pack 1](http://www.microsoft.com/downloads/details.aspx?familyid=c3f6c7b4-315d-4271-a713-6f51dfbb9d61)<sup>[1]</sup>  
(3046002)
...
<tr>
<td style="border:1px solid black;">
[Windows 8（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=1007b5e1-5f60-41ab-8e38-b54a40094789)  
(3046002)
...
<tr>
<td style="border:1px solid black;">
[Windows 8（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=7f117093-a683-493d-9808-1bd2e55dea33)  
(3046002)
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1（用于 32 位系统）](http://www.microsoft.com/downloads/details.aspx?familyid=a564ce07-7ee5-4b8a-83a1-93ebf0116202)  
(3046002)
...
<tr>
<td style="border:1px solid black;">
[Windows 8.1（用于基于 x64 的系统）](http://www.microsoft.com/downloads/details.aspx?familyid=50969636-03c7-4729-a0bc-aa07f7abd5dd)  
(3046002)
...
<td style="border:1px solid black;">
[**Windows 日记本远程执行代码漏洞 - CVE-2015-1675**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1675)

</td>
<td style="border:1px solid black;">
[**Windows 日记本远程执行代码漏洞 - CVE-2015-1695**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1695)

</td>
<td style="border:1px solid black;" colspan="2">
[**Windows 日记本远程执行代码漏洞 - CVE-2015-1696**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1696)

</td>
<td style="border:1px solid black;">
[**Windows 日记本远程执行代码漏洞 - CVE-2015-1697**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1697)

</td>
<td style="border:1px solid black;">
[**Windows 日记本远程执行代码漏洞 - CVE-2015-1698**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1698)

</td>
<td style="border:1px solid black;">
[**Windows 日记本远程执行代码漏洞 - CVE-2015-1699**](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2015-1699)

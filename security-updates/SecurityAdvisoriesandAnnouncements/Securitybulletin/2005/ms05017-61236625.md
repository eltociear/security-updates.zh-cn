...
-   **在不需要消息队列服务时将其删除。**
    ...
    **变通办法的影响：**许多组织需要消息队列服务来执行重要的功能。 管理员不应该删除消息队列服务，除非他们完全了解这样做将对他们的环境产生哪些影响。 有关消息队列服务的详细信息，请参阅[消息队列服务产品文档](http://www.microsoft.com/windows2000/technologies/communications/msmq/default.asp)。

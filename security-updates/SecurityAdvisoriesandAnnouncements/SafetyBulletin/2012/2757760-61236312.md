...
我们正在积极与我们的 [Microsoft Active Protections Program (MAPP)](http://go.microsoft.com/fwlink/?linkid=215201) 合作伙伴合作，为他们提供可用来为客户提供更广泛保护的信息。此外，我们正在积极与伙伴合作，监视威胁状况并采取措施防止尝试利用此漏洞的恶意网站。

Microsoft 仍鼓励客户按照[Microsoft 安全中心](http://www.microsoft.com/security/pc-security/protect-pc.aspx)的指导启用防火墙、应用所有软件更新，并安装防病毒和反间谍软件。

**缓解因素：**

-   默认情况下，Windows Server 2003、Windows Server 2008 和 Windows Server 2008 R2 上的 Internet Explorer 在一种称为“[增强安全配置](http://technet.microsoft.com/library/dd883248.aspx)”的受限模式下运行。此模式可减轻此漏洞。
...
| 参考         | 标识                                                                             |
|--------------|----------------------------------------------------------------------------------|
| **CVE 参考** | [CVE-2012-4969](http://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2012-4969) |
...
Microsoft 修订此通报是为了宣布现已提供一项可防止利用此问题的 **Microsoft Fix it** 解决方案，“通过 Internet Explorer 中 ExecCommand 防止内存损坏”。请参阅 [Microsoft 知识库文章 2757760](http://support.microsoft.com/kb/2757760)以使用自动化 **Microsoft Fix it** 解决方案。
...
-   **应用 Microsoft Fix it 解决方案，“通过 Internet Explorer 中的** **ExecCommand** **防止内存损坏”，** **可防止利用此问题**
    ...
    请参阅 [Microsoft 知识库文章 2757760](http://support.microsoft.com/kb/2757760) 以使用自动化 **Microsoft Fix it** 解决方案来启用或禁用此变通方法。
...
-   **及时更新第三方软件**
    ...
    [可以从哪里获得 .Java 6 的最新版本？](http://java.com/en/download/faq/java_6.xml)

    [什么是 Java 更新？](http://java.com/en/download/help/java_update.xml)

    [为什么要从系统中卸载 Java 的较旧版本？](http://www.java.com/en/download/faq/remove_olderversions.xml)

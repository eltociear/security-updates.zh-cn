...
-   **Aurigma Image Uploader**。 Aurigma 发布了[通报](https://go.microsoft.com/fwlink/?linkid=122004)和一个可解决漏洞的更新。 有关详细信息，请参阅 Aurigma 发布的通报。 这些 kill-bit 是应 ActiveX 控件所有者的请求而设置的。 要求支持的客户应该与 Aurigma 联系。 此 ActiveX 控件的类标识符 (CLSID) 在此通报的**常见问题**部分中列出。
-   **HP Instant Support**。 [HP](https://www.hp.com/) 发布了 2 个通报（[(c01422264)](https://go.microsoft.com/fwlink/?linkid=122005) 和 [(c01439758)](https://go.microsoft.com/fwlink/?linkid=125347)），以及一个用于解决这些漏洞的更新。 请参阅 HP 的通报以了解详细信息和下载位置。 这些 kill-bit 是应 ActiveX 控件所有者的请求而设置的。 要求支持的客户应该与 [HP](https://www.hp.com/) 联系。 此 ActiveX 控件的类标识符 (CLSID) 在此通报的**常见问题**部分中列出。

有关安装此更新的详细信息，请参阅 [Microsoft 知识库文章 953839](https://support.microsoft.com/kb/953839)。
...
| 参考                     | 标识                                             |
|--------------------------|--------------------------------------------------|
| **Microsoft 知识库文章** | [953839](https://support.microsoft.com/kb/953839) |
...
否，为了进行自动更新，此更新并不取代 Microsoft 安全公告 [MS08-032](https://go.microsoft.com/fwlink/?linkid=116368) 中描述的 ActiveX Kill Bit 的累积性安全更新 (950760)。无论客户是否安装了此更新 (953839)，自动更新仍将为客户提供 MS08-032 更新。 但是，安装此更新 (953839) 的客户不需要安装 MS08-032 更新以通过 MS08-032 中设置的所有 kill bit 受到保护。
...
是，此更新也包括之前在 Microsoft 安全公告 [MS08-032](https://go.microsoft.com/fwlink/?linkid=116368) 中设置的 kill bit。
...
以下类标识符与 [Aurigma](https://www.aurigma.com/) 关于为容易受到攻击的类标识符列表设置 kill bit 的请求相关。 可以在 Aurigma 发布的[通报](https://go.microsoft.com/fwlink/?linkid=122004)中找到更多详细信息：
...
以下类标识符与 [HP](https://www.hp.com/) 关于为容易受到攻击的类标识符列表设置 kill bit 的请求相关。 进一步的详细信息可在 HP 发布的通报 [(c01422264)](https://go.microsoft.com/fwlink/?linkid=122005) 和 [(c01439758)](https://go.microsoft.com/fwlink/?linkid=125347) 中找到：
...
Microsoft 鼓励客户安装此更新。 客户如有兴趣了解有关此更新的详细信息，请阅读 [Microsoft 知识库文章 953839](https://support.microsoft.com/kb/953839)。

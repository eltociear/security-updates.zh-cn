...
Microsoft 已经完成对此漏洞的公众报告的调查。 我们已经发布了可以解决此问题的 [MS07-014](https://technet.microsoft.com/security/bulletin/ms07-014)。 有关此问题的详细信息（包括可用安全更新的下载链接），请查看 [MS07-014](https://technet.microsoft.com/security/bulletin/ms07-014)。解决的漏洞为 Word 格式错误的字符串漏洞 - [CVE-2006-5994](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5994)。

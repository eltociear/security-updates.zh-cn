...
Microsoft 已经完成对此漏洞的公众报告的调查。 我们已经发布了可以解决此问题的 [MS06-071](https://go.microsoft.com/fwlink/?linkid=77651)。 有关此问题的详细信息（包括可用安全更新的下载链接），请查看 [MS06-071](https://go.microsoft.com/fwlink/?linkid=77651)。解决的漏洞为 Microsoft XML 核心服务漏洞 - [CVE-2006-5745](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2006-5745)。

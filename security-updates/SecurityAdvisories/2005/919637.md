...
| 参考          | 标识                                                                         |
|---------------|------------------------------------------------------------------------------|
| **CERT 参考** | [VU\#446012](https://www.kb.cert.org/vuls/id/446012)                          |
| **CVE 参考**  | [2006-2492](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=can-2006-2492) |
...
有关启用或禁用 Word 作为电子邮件编辑器的详细信息，请参阅下列[网站](https://office.microsoft.com/en-us/assistance/hp052428491033.aspx)。
...
有关将注册表项和组策略配合使用的信息，请参阅[将管理模板文件与基于注册表的组策略配合使用](https://www.microsoft.com/technet/prodtechnol/windowsserver2003/technologies/management/gp/admtgp.mspx)和[分配注册表更改](https://msdn.microsoft.com/library/default.asp?url=/library/en-us/dnw2kmag01/html/distributingregistrychanges.asp)（页面可能为英文）。
...
5.  退出 Outlook。
6.  重新启动计算机。
7.  有关启用或禁用 Word 作为电子邮件编辑器的详细信息，请参阅下列[网站](https://office.microsoft.com/en-us/assistance/hp052428491033.aspx)。
...
-   认为他们已经受到攻击的客户应该联系当地的 FBI 办事处或在[网络欺诈申诉中心网站](https://www.ifccfbi.gov/index.asp)上进行投诉。 美国以外的客户应该联系其所在国家或地区的国家执行机构。
    所有客户应该应用 Microsoft 发布的最新安全更新，从而帮助确保其系统防止攻击企图。 已经启用了“自动更新”的客户将自动接收所有 Windows 更新。 有关安全更新的详细信息，请访问 [Microsoft 安全网站](https://www.microsoft.com/technet/security/advisory/www.microsoft.com/security)。

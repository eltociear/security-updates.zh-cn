...
-   **Cisco 无客户端 VPN** **解决方案** 下列类标识符与 Cisco 为易受攻击的 ActiveX 控件设置 kill bit 的要求相关。有关 Cisco 无客户端 VPN 解决方案 ActiveX 控件中的安全问题的详细信息，请参阅 Cisco 安全通报[Cisco ASA 5500 系列适应性安全产品无客户端 VPN ActiveX 控件远程执行代码漏洞](https://tools.cisco.com/security/center/content/ciscosecurityadvisory/cisco-sa-20120314-asaclient)。此 ActiveX 控件的类标识符 (CLSID) 在此通报的“**第三方 Kill bit**”部分中列出。
...
| 参考                     | 标识                                               |
|--------------------------|----------------------------------------------------|
| **Microsoft 知识库文章** | [2695962](https://support.microsoft.com/kb/2695962) |
...
Microsoft 鼓励客户安装此更新。客户如有兴趣了解有关此更新的详细信息，请阅读 [Microsoft 知识库文章 2695962](https://support.microsoft.com/kb/2695962)。

...
Microsoft 已经完成对此漏洞的公众报告的调查。 我们已发布 [MS09-028](https://go.microsoft.com/fwlink/?linkid=152887) 以解决此问题。 有关此问题的详细信息（包括可用安全更新的下载链接），请查看 [MS09-028](https://go.microsoft.com/fwlink/?linkid=152887)。解决的漏洞为 DirectX 空字节覆盖漏洞 - [CVE-2009-1537](https://www.cve.mitre.org/cgi-bin/cvename.cgi?name=cve-2009-1537)。
